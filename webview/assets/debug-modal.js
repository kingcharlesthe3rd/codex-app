...
import { m as ue } from "./chunk-8.js";
import { n as de } from "./rpc.js";
...
import { v as Oe } from "./use-plugins.js";
import { n as ke, s as Ae } from "./home-onboarding-assistant-tutorial-card.js";
import { t as je } from "./info.js";
import { t as Me } from "./with-window.js";
import { d as Ne, i as Pe, l as Fe, n as Ie, u as Le } from "./dialog-layout.js";
...
import { a as Ue, c as We, d as Ge, t as Ke } from "./mcp-capability-signals.js";
import { t as qe } from "./remote-connections-onboarding-signals.js";
import { r as Je, t as Ye } from "./dropdown.js";
import { t as Xe } from "./chevron.js";
import { t as Ze } from "./code-snippet.js";
import { t as Qe } from "./copy-button.js";
import { t as $e } from "./image-preview-dialog.js";
import { t as et } from "./toggle.js";
import { t as tt } from "./use-is-thread-realtime-enabled.js";
import { t as nt } from "./arrow-up-right-lg.js";
...
import { a as st, n as ct, t as lt } from "./app-server-notification-debug-signals.js";
import { a as ut, t as dt } from "./primary-runtime-query-keys.js";
import { i as ft, r as pt } from "./primary-runtime-install-state.js";
import { n as mt, t as ht } from "./hotkey-window-state.js";
import { o as gt, t as _t } from "./codex-mobile-setup-dialog.js";
import { a as vt, o as yt, s as bt } from "./use-debug-panel.js";
import { i as xt, r as St, t as Ct } from "./virtualized-turns.js";
function wt({ labels: e, projectlessThreadCwd: t, statuses: n, workspaceRoots: r }) {
  let i = new Map();
...
function Y(e) {
  ...
  t[19] === c
    ? (C = t[20])
    : ((C = c
        ? (0, J.jsx)(`span`, { className: `flex items-center gap-1`, onClick: Tt, children: c })
        : null),
      (t[19] = c),
      (t[20] = C));
  let w;
...
function X(e) {
  ...
  t[6] === r
    ...
    : ((c = (0, J.jsx)(Qe, {
        ...
        onCopy: () => {
          navigator?.clipboard?.writeText && navigator.clipboard.writeText(r).catch(Ot);
        },
      })),
      (t[6] = r),
      (t[7] = c));
...
function Ft(e) {
  ...
  t[11] === n.displayName
    ...
    : ((w = (0, J.jsx)(`span`, {
      ...
      (t[12] = w));
  let T;
  t[13] === m ? (T = t[14]) : ((T = (0, J.jsx)(an, { state: m })), (t[13] = m), (t[14] = T));
  let E;
  t[15] !== w || t[16] !== T
  ...
  let B;
  t[47] !== u || t[48] !== n
    ? ((B = u ? (0, J.jsx)(zt, { hostDetails: n }) : null), (t[47] = u), (t[48] = n), (t[49] = B))
    : (B = t[49]);
  let H;
  t[50] !== r || t[51] !== l
  ...
  let U;
  t[53] !== r || t[54] !== a
    ? ((U = (0, J.jsx)(Vt, { hostId: r, requests: a })), (t[53] = r), (t[54] = a), (t[55] = U))
    : (U = t[55]);
  let W;
  t[56] !== r || t[57] !== i
    ? ((W = (0, J.jsx)(Kt, { hostId: r, notifications: i })), (t[56] = r), (t[57] = i), (t[58] = W))
    : (W = t[58]);
  let G;
...
function zt(e) {
  let t = (0, K.c)(4),
    { hostDetails: n } = e,
    r;
  t[0] === n.lines ? (r = t[1]) : ((r = n.lines?.map(Bt)), (t[0] = n.lines), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
  ...
  return (0, J.jsx)(`div`, {
    ...
    children: (0, J.jsx)(Y, {
      ...
      children: (0, J.jsx)(`div`, {
        ...
        children:
          o.length === 0
            ? (0, J.jsx)($t, { message: `No in-memory threads for this manager yet` })
            : (0, J.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, J.jsx)(`div`, {
                    ...
                    children:
                      c.length === 0
                        ? (0, J.jsx)($t, { message: `No in-memory threads match this state` })
                        : c.map((t) =>
                            (0, J.jsxs)(
                              `div`,
                              {
                                      ...
                                      (0, J.jsx)(
                                        Wt,
                                        {
                                          ...
                                          onUnsubscribe: async (t) => {
                                            r(t);
                                            try {
                                              await v(`unsubscribe-thread-for-host`, {
                                                hostId: e,
                                                threadId: t,
                                              });
                                            } finally {
...
function Wt(e) {
  ...
  let S = `resume: ${n.resumeState}`,
    C;
  t[28] === S ? (C = t[29]) : ((C = (0, J.jsx)(Gt, { label: S })), (t[28] = S), (t[29] = C));
  let w = `stream: ${a?.role ?? `none`}`,
    T;
  t[30] === w ? (T = t[31]) : ((T = (0, J.jsx)(Gt, { label: w })), (t[30] = w), (t[31] = T));
  let E = `runtime: ${n.threadRuntimeStatus?.type ?? `none`}`,
    D;
  t[32] === E ? (D = t[33]) : ((D = (0, J.jsx)(Gt, { label: E })), (t[32] = E), (t[33] = D));
  let O = `turn: ${n.lastTurnStatus ?? `none`}`,
    k;
  t[34] === O ? (k = t[35]) : ((k = (0, J.jsx)(Gt, { label: O })), (t[34] = O), (t[35] = k));
  let A;
...
function Kt(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== s || t[4] !== a) {
    ...
    let y = o,
      b;
    (t[18] === y ? (b = t[19]) : ((b = y.filter(Xt)), (t[18] = y), (t[19] = b)), (d = b));
    let x;
    (t[20] !== y || t[21] !== a
      ...
      (m =
        e.length > 0
          ? (0, J.jsxs)(`select`, {
              ...
              children: [(0, J.jsx)(`option`, { value: ``, children: `All threads` }), e.map(Jt)],
            })
          : null),
      (t[0] = n),
      (t[1] = r),
  ...
  t[33] !== u || t[34] !== d.length || t[35] !== f
    ? ((x =
        f.length > 0
          ...
          : (0, J.jsx)($t, {
              message: d.length > 0 ? `Only hidden delta notifications recorded` : dn(u),
            })),
      (t[33] = u),
      (t[34] = d.length),
      (t[35] = f),
  ...
  t[25] === n.endedAtMs
    ...
    : ((h =
        n.endedAtMs == null
          ...
          : (0, J.jsxs)(`div`, { children: [`Ended: `, kt.format(n.endedAtMs)] })),
      (t[25] = n.endedAtMs),
      (t[26] = h));
  let g;
...
function tn(e) {
  ...
  t[0] === n.severity
    ? (r = t[1])
    : ((r = I(`group/notification bg-token-background rounded-lg border`, _n(n.severity))),
      (t[0] = n.severity),
      (t[1] = r));
  let i;
  t[2] === n.method
...
function an(e) {
  ...
  t[0] === n
    ? (r = t[1])
    : ((r = I(`rounded-full px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide`, vn(n))),
      (t[0] = n),
      (t[1] = r));
  let i;
  return (
        ...
        ? (0, J.jsxs)(`div`, {
            ...
            children: [
              (0, J.jsx)(`button`, {
                ...
                disabled: l == null,
                onClick: () => {
                  l != null && navigator.clipboard?.writeText(JSON.stringify(l, null, 2)).catch(wn);
                },
                children: `Copy JSON`,
              }),
              (0, J.jsxs)(`button`, {
    ...
    ? ((_ = n
        ? t == null
          ...
          : d && l == null
            ...
            : l == null
              ? (0, J.jsx)(Bn, { message: `Browser debug snapshot unavailable.` })
              : (0, J.jsx)(En, { onOpenOwner: m, openOwnerStatus: i, snapshot: l })
        : null),
      (e[10] = l),
      (e[11] = m),
      (e[12] = d),
...
function En(e) {
  ...
  t[21] === r
    ...
    : ((v =
      ...
      (t[22] = v));
  let y;
  t[23] === i.windows ? (y = t[24]) : ((y = i.windows.map(jn)), (t[23] = i.windows), (t[24] = y));
  let b;
  t[25] === y
    ? (b = t[26])
    : ((b = (0, J.jsx)(zn, {
  ...
  t[38] === i.pendingAttaches
    ? (T = t[39])
    : ((T = i.pendingAttaches.map(kn)), (t[38] = i.pendingAttaches), (t[39] = T));
  let E;
  t[40] === T
    ? (E = t[41])
    : ((E = (0, J.jsx)(zn, {
  ...
  t[46] === i.events
    ? (k = t[47])
    : ((k = i.events.slice().reverse().map(Dn)), (t[46] = i.events), (t[47] = k));
  let A;
  t[48] === k
    ? (A = t[49])
    : ((A = (0, J.jsx)(zn, {
...
function Nn(e) {
  ...
  let F;
  t[52] === r.bounds ? (F = t[53]) : ((F = Un(r.bounds)), (t[52] = r.bounds), (t[53] = F));
  let I;
  t[54] === F
    ? (I = t[55])
  ...
  t[64] === U
    ? (W = t[65])
    : ((W = (0, J.jsx)(X, { label: `Flags`, value: U })), (t[64] = U), (t[65] = W));
  ...
  t[72] === se
    ? (ce = t[73])
    : ((ce = (0, J.jsx)(X, { label: `Browser Use`, value: se })), (t[72] = se), (t[73] = ce));
...
function Pn(e) {
  ...
  return (
    t[25] !== n.conversationId || t[26] !== v || t[27] !== y
      ? ((b = (0, J.jsx)(Ln, { details: v, subtitle: y, title: n.conversationId })),
  ...
  createTable: (e) => {
    ((e.getHeaderGroups = Z(
      ...
      (e.getLeftHeaderGroups = Z(
        ...
        (t, n, r) =>
          $n(t, r?.map((e) => n.find((t) => t.id === e)).filter(Boolean) ?? [], e, `left`),
      ...
      (e.getRightHeaderGroups = Z(
        ...
        (t, n, r) =>
          $n(t, r?.map((e) => n.find((t) => t.id === e)).filter(Boolean) ?? [], e, `right`),
      ...
      (e.getFilterFn = () =>
        Kn(e.columnDef.filterFn)
          ...
          : e.columnDef.filterFn === `auto`
            ? e.getAutoFilterFn()
            : (t.options.filterFns?.[e.columnDef.filterFn] ?? dr[e.columnDef.filterFn])),
      (e.getCanFilter = () =>
    ...
    createColumn: (e, t) => {
      ((e.toggleGrouping = () => {
        ...
        (e.getAutoAggregationFn = () => {
          ...
          if (Object.prototype.toString.call(n) === `[object Date]`) return hr.extent;
        }),
        (e.getAggregationFn = () => {
          if (!e) throw Error();
...
var vr = {
  ...
  br = {
    ...
    getDefaultOptions: (e) => ({ onColumnPinningChange: Gn(`columnPinning`, e) }),
    createColumn: (e, t) => {
      ((e.pin = (n) => {
        let r = e
          .getLeafColumns()
    ...
    createTable: (e) => {
      ((e.setColumnPinning = (t) =>
        ...
        (e.resetColumnPinning = (t) =>
          e.setColumnPinning(t ? yr() : (e.initialState?.columnPinning ?? yr()))),
...
var Sr = { size: 150, minSize: 20, maxSize: 2 ** 53 - 1 },
  ...
  wr = {
    ...
    getInitialState: (e) => ({ columnSizing: {}, columnSizingInfo: Cr(), ...e }),
    getDefaultOptions: (e) => ({
    ...
    createColumn: (e, t) => {
      ((e.getSize = () => {
        ...
        return Math.min(
          Math.max(e.columnDef.minSize ?? Sr.minSize, n ?? e.columnDef.size ?? Sr.size),
        ...
        (e.getResizeHandler = (n) => {
          ...
          return (a) => {
            if (
              !r ||
              !i ||
              (a.persist == null || a.persist(), Dr(a) && a.touches && a.touches.length > 1)
            )
              return;
            let o = e.getSize(),
              s = e
    ...
    createTable: (e) => {
      ((e.setColumnSizing = (t) =>
        ...
        (e.resetHeaderSizeInfo = (t) => {
          e.setColumnSizingInfo(t ? Cr() : (e.initialState.columnSizingInfo ?? Cr()));
        }),
        (e.getTotalSize = () =>
...
var Or = {
  ...
  getDefaultOptions: (e) => ({ onColumnVisibilityChange: Gn(`columnVisibility`, e) }),
  createColumn: (e, t) => {
...
var Ar = {
  ...
  Mr = {
    ...
    getDefaultOptions: (e) => ({ onExpandedChange: Gn(`expanded`, e), paginateExpandedRows: !0 }),
    createTable: (e) => {
      let t = !1,
        n = !1;
  ...
  Ir = {
    getInitialState: (e) => ({ ...e, pagination: { ...Fr(), ...e?.pagination } }),
    ...
    createTable: (e) => {
      ((e.setRowSelection = (t) =>
        ...
        (e.getSelectedRowModel = Z(
          ...
          (t, n) => (Object.keys(t).length ? Vr(e, n) : { rows: [], flatRows: [], rowsById: {} }),
...
function Ur(e, t, n) {
  ...
  return (
    e.subRows.forEach((e) => {
      if (
        !(a && !i) &&
        (e.getCanSelect() && (Hr(e, t) ? (a = !0) : (i = !1)), e.subRows && e.subRows.length)
      ) {
        let n = Ur(e, t);
...
var Wr = /([0-9]+)/gm,
  Gr = (e, t, n) => $r(Qr(e.getValue(n)).toLowerCase(), Qr(t.getValue(n)).toLowerCase()),
  Kr = (e, t, n) => $r(Qr(e.getValue(n)), Qr(t.getValue(n))),
  qr = (e, t, n) => Zr(Qr(e.getValue(n)).toLowerCase(), Qr(t.getValue(n)).toLowerCase()),
      ...
      createColumn: (e, t) => {
        ((e.getAutoSortingFn = () => {
          ...
          for (let t of n) {
            ...
            if (Object.prototype.toString.call(n) === `[object Date]`) return ei.datetime;
            if (typeof n == `string` && ((r = !0), n.split(Wr).length > 1)) return ei.alphanumeric;
          }
          ...
          (e.getSortingFn = () => {
            ...
            return Kn(e.columnDef.sortingFn)
              ...
              : e.columnDef.sortingFn === `auto`
                ? e.getAutoSortingFn()
                : (t.options.sortingFns?.[e.columnDef.sortingFn] ?? ei[e.columnDef.sortingFn]);
          }),
          (e.toggleSorting = (n, r) => {
...
function ii() {
  return (e) =>
    Z(
      ...
      (e, t, n) => (!t.rows.length || (e !== !0 && !Object.keys(e ?? {}).length) || !n ? t : ai(t)),
...
function yi(e) {
  return e == null ? `default` : e > pi ? `danger` : e > fi ? `warning` : `default`;
}
function bi(e, t) {
...
function Oi() {
    ...
    ? ((_ = t
        ? u && l == null
          ...
          : l?.rootProcess == null
            ...
            : (0, J.jsx)(Ai, { onProcessDetailsClick: o, processes: f, rootProcess: l.rootProcess })
        : null),
      (e[8] = l),
      (e[9] = u),
      (e[10] = t),
  ...
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, J.jsx)(Pe, {
        ...
        subtitle: (0, J.jsx)(Le, { children: `The process ID and full command are shown below` }),
      })),
      (e[14] = b))
    : (b = e[14]);
  let x;
  ...
  let S;
  e[17] !== x || e[18] !== v
    ? ((S = (0, J.jsx)(Fe, { open: v, onOpenChange: y, size: `wide`, children: x })),
      (e[17] = x),
      (e[18] = v),
      (e[19] = S))
    : (S = e[19]);
    ...
    : ((d = (e) => {
        (r(null),
          g(t, l.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED, e)
            .then(() => {
              le.dispatchMessage(`global-dictation-force-lock-changed`, { enabled: e });
            })
            .catch((e) => {
              r(
...
function Xi() {
  ...
  e[0] === t
    ? (a = e[1])
    : ((a = { mutationFn: Zi, onSuccess: (e) => (t.setQueryData(ht, e.state), e) }),
      (e[0] = t),
      (e[1] = a));
  let o = se(a);
...
function oa() {
  ...
  if (
    ...
    e[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((E = (0, J.jsx)(Xe, { className: `icon-2xs opacity-70` })), (e[20] = E))
      : (E = e[20]);
    let D;
    e[21] === T
      ? (D = e[22])
...
function ha(e) {
  ...
  t[2] !== r || t[3] !== o.text || t[4] !== n
    ? ((s = r ? Da(n) : o.text), (t[2] = r), (t[3] = o.text), (t[4] = n), (t[5] = s))
    : (s = t[5]);
  let c = s,
...
function ka(e, t, n) {
  ...
  if (typeof e == `string`) return e.length <= ia ? e : ((t.truncated = !0), `${e.slice(0, ia)}…`);
  ...
  if (e instanceof Map)
    return Aa([...e.entries()], t, ([e, r]) => [ka(e, t, n + 1), ka(r, t, n + 1)]);
  ...
  return (
    r.length > na && ((t.truncated = !0), i.push([`…`, `${r.length - na} more`])),
    Object.fromEntries(i)
  );
}
function Aa(e, t, n) {
  let r = e.slice(0, na).map((e) => n(e));
  return (e.length > na && ((t.truncated = !0), r.push(`${e.length - na} more`)), r);
}
function ja(e) {
...
var Fa = 8,
  ...
  Ha = r({ code: u(), timeout_ms: s().optional(), title: s().optional() }).catchall(s());
function Ua(e) {
  let t = Wa(e);
...
function Ka({ conversationId: e, item: t, turnId: n }, r) {
  ...
  return (
    ...
    t.result != null &&
      ...
      i.push({ kind: `json`, label: `call[${r}].result`, value: qa(t.result, La) })),
    i
  );
}
function qa(e, t = Ia) {
...
function Ya(e, t) {
  ...
  return n == null
    ...
    : n.flatMap((e, n) => {
        ...
        if (r != null)
          return [
            { kind: `multiline`, label: `call[${t}].result.content[${n}]`, value: ao(r, Ra) },
          ];
        let i = Qa(e);
        return i == null
          ? []
...
function no(e, t) {
  ...
  return (
    ...
    r.push({ kind: `javascript`, label: `call[${t}].script`, value: io(n.code) }),
  ...
  po = ee(z, ({ get: e }) =>
    Ua(
      e(y, k)
        ...
        .reverse()
        .flatMap((t) =>
          (e(E, t) ?? oo).map((e) => ({ conversationId: t, items: e.items, turnId: e.turnId })),
        ),
    ),
  );
function mo(e) {
...
function ho() {
  ...
  return (
    e[0] === t.lines
      ? (n = e[1])
      : ((n = (0, J.jsx)(_o, { lines: t.lines })), (e[0] = t.lines), (e[1] = n)),
    n
  );
}
function go(e) {
  ...
  return (
    t[5] === a.lines
      ? (o = t[6])
      : ((o = (0, J.jsx)(_o, { lines: a.lines })), (t[5] = a.lines), (t[6] = o)),
    o
  );
}
function _o(e) {
...
function vo({ lines: e }) {
  let t = (0, q.useMemo)(() => e.map((e, t) => ({ line: e, lineKey: `${t}:${e.label}` })), [e]),
    [n, r] = (0, q.useState)({}),
    [i, a] = (0, q.useState)(null),
    ...
    { topOffsetsPx: d, bottomOffsetsPx: f, totalHeightPx: p } = Ct({ heightsPx: u, gapPx: 0 });
  l.current = n;
  let m = ze(() => {
  ...
  return (0, J.jsx)(`div`, {
    ...
    children: (0, J.jsx)(`div`, {
      ...
      children: (0, J.jsx)(`div`, {
        ...
        children: v.map((e) => (0, J.jsx)(yo, { entry: e, measureLineRef: _ }, e.lineKey)),
      }),
    }),
  });
}
var yo = (0, q.memo)(function (e) {
  ...
  return (
    t[2] !== n.lineKey || t[3] !== r || t[4] !== i
      ? ((a = (0, J.jsx)(`div`, { ref: r, "data-debug-line-key": n.lineKey, children: i })),
        (t[2] = n.lineKey),
        (t[3] = r),
        (t[4] = i),
        (t[5] = a))
...
function bo(e) {
  ...
  switch (n.kind) {
    ...
    case `image`: {
      let e;
      return (
        t[9] === n ? (e = t[10]) : ((e = (0, J.jsx)(Oo, { line: n })), (t[9] = n), (t[10] = e)), e
      );
    }
    case void 0: {
      let e;
...
function Do(e) {
  ...
  return (
    t[5] !== n || t[6] !== c
      ? ((l = (0, J.jsx)(xo, { label: n, children: c })), (t[5] = n), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
...
function Fo() {
  let e = (0, K.c)(38),
    ...
    [O, A] = (0, q.useState)(!1),
    j;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((j = { hostId: k }), (e[0] = j)) : (j = e[0]);
  let M = O && !0,
    N;
  e[1] === M
    ? (N = e[2])
    : ((N = { params: j, queryConfig: { enabled: M } }), (e[1] = M), (e[2] = N));
  ...
  e[7] === d.roles
    ? (ne = e[8])
    : ((ne = d.roles.length === 0 ? `none` : d.roles.join(`, `)), (e[7] = d.roles), (e[8] = ne));
  let re = ne,
    ae;
  e[9] !== G ||
  e[10] !== n ||
                      ...
                      (0, J.jsx)(
                        `button`,
                        {
                          ...
                          onClick: () => {
                            ...
                            x({ arm: e.value, assignedAtMs: Date.now(), experimentName: ot });
                          },
                          children: e.label,
                        },
                        e.value,
...
function Io({ downloadedBytes: e, errorMessage: t, phase: n, totalBytes: r }) {
  return [n, e == null ? null : r == null ? `${Lo(e)} downloaded` : `${Lo(e)} / ${Lo(r)}`, t]
    .filter(Boolean)
    .join(` · `);
}
function Lo(e) {
...
function Bo() {
  ...
  let _;
  e[6] !== d || e[7] !== p || e[8] !== h
    ? ((_ = (0, J.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [d, p, h] })),
      (e[6] = d),
      (e[7] = p),
      (e[8] = h),
      (e[9] = _))
    ...
    (e[14] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      (o =
        h && g.length === 0
          ...
          : h
            ? g.map((e) => (0, J.jsx)($o, { entry: e, query: n }, `${e.kind}:${e.name}`))
            : null),
      (e[0] = t),
      (e[1] = n),
      (e[2] = i),
...
function $o(e) {
  ...
  let s;
  t[3] !== i || t[4] !== a
    ? ((s = (0, J.jsx)(es, { label: i, tone: a })), (t[3] = i), (t[4] = a), (t[5] = s))
    : (s = t[5]);
  let c;
  return (
    t[6] !== o || t[7] !== s
      ? ((c = (0, J.jsx)(Ji, { title: o, status: s })), (t[6] = o), (t[7] = s), (t[8] = c))
      : (c = t[8]),
    c
  );
}
  ...
  e[10] !== r || e[11] !== t || e[12] !== d || e[13] !== l
    ? ((p = t
        ? l.length === 0
          ...
          : l.map((e) => (0, J.jsx)(rs, { includeHidden: r, label: d[e] ?? e, root: e }, e))
        : null),
      (e[10] = r),
      (e[11] = t),
      (e[12] = d),
...
function rs(e) {
  ...
  t[4] !== c || t[5] !== l
    ...
    : (u = t[6]);
  let d;
  t[7] === Symbol.for(`react.memo_cache_sentinel`) ? ((d = () => o(is)), (t[7] = d)) : (d = t[7]);
  let f;
  t[8] !== n || t[9] !== u
...
function ls(e) {
  ...
  t[13] === r
    ...
    : ((S = (e) => {
        ...
        (r.set(pt, t), le.dispatchMessage(`set-primary-runtime-install-release`, { release: t }));
      }),
      (t[13] = r),
      (t[14] = S));
  let C = S,
                  ...
                  onSelect: () => {
                    y.mutateAsync({ release: u }).catch((e) => {
                      (l(`Failed to trigger cron job`),
                        L.error(`Failed to trigger workspace runtime cron from debug page`, {
                          safe: { release: u },
                          sensitive: { error: e },
                        }));
                    });
          ...
          : (0, J.jsxs)(`div`, {
              ...
              children: [
                ...
                p?.disabledReason == null
                  ? null
                  : (0, J.jsx)(X, { label: `Disabled`, value: ms(p.disabledReason) }),
                (0, J.jsx)(X, { label: `Next cron`, value: ds(p?.nextRunAt ?? null) }),
                (0, J.jsx)(X, {
                  label: `Startup check`,
...
function gs() {
  let e = (0, K.c)(23),
    ...
    { data: a, isLoading: o } = he(l.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED),
    s = a === !0,
    c = i && s,
    u = o,
  ...
  let y;
  e[6] !== p || e[7] !== h || e[8] !== v
    ? ((y = (0, J.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [p, h, v] })),
      (e[6] = p),
      (e[7] = h),
      (e[8] = v),
      (e[9] = y))
  ...
  e[11] === t
    ...
    : ((x = (e) => {
        (r(null),
          g(t, l.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED, e).catch((e) => {
    ...
    w = async (e) => {
      if (!f) {
        ...
        try {
          ...
          L.error(`Failed to export logs`, { safe: { scope: e }, sensitive: { error: t } });
        } finally {
          p(!1);
        }
      }
    ...
    T = () => {
      (async () => {
        try {
          ...
          L.error(`Failed to open debug window`, { safe: {}, sensitive: { error: e } });
        }
      })();
    };
  return (0, J.jsxs)(`div`, {
          ...
          g
            ? (0, J.jsxs)(Y, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `flex flex-col py-1.5`,
                    children: (0, J.jsx)(X, { label: `App session ID`, value: S ?? `Unavailable` }),
                  }),
                  (0, J.jsxs)(`div`, {
...
function Os() {
  let e = (0, K.c)(25),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((t = Oe()), (e[0] = t)) : (t = e[0]);
  let n = t,
    r = R(),
    [i, a] = (0, q.useState)(As),
    o = i && (n === `dev` || n === `nightly`),
  ...
  e[1] === o
    ? (s = e[2])
    : ((s = { queryConfig: { enabled: o, intervalMs: _s } }), (e[1] = o), (e[2] = s));
  let { data: c, isLoading: l } = ie(`ambient-suggestions-generation-statuses`, s),
    u;
              ...
              (0, J.jsx)(
                Ji,
                {
                  ...
                  rightActions: (0, J.jsx)(`button`, {
                    ...
                    onClick: () => {
                      _.mutateAsync({ hostId: k, projectRoot: f(n) }).catch((e) => {
                        L.error(`Failed to refresh ambient suggestions from debug page`, {
                          safe: {},
