...
import { t as pt } from "./image-preview-dialog-Bb-vTCJ6.js";
import { t as mt } from "./code-snippet-B.js";
...
import { r as bt, t as xt } from "./browser-sidebar-comment-mode-coachmark-state-Dlb-N6Y8.js";
import { t as St } from "./workspace-directory-tree-C.js";
...
function $t(e) {
  let t = (0, K.c)(69),
    ...
    p = !!n.lines?.length,
    h;
  t[0] === o ? (h = t[1]) : ((h = o.filter(Nn)), (t[0] = o), (t[1] = h));
  let g = h.length,
  ...
  let S = x.length,
    C;
  t[6] === i ? (C = t[7]) : ((C = i.filter(en)), (t[6] = i), (t[7] = C));
  let T = C.length,
    E;
  t[8] !== r || t[9] !== s
    ? ((E = (e) => {
...
function ln(e) {
  ...
  let _;
  t[15] !== u || t[16] !== g
    ? ((_ = (0, J.jsxs)(`div`, { className: `min-w-0`, children: [u, g] })),
      (t[15] = u),
      (t[16] = g),
      (t[17] = _))
    : (_ = t[17]);
...
function ea(e) {
  ...
  let v;
  return (
    t[32] !== d || t[33] !== p || t[34] !== m || t[35] !== h || t[36] !== _
      ? ((v = (0, J.jsx)(d, { title: p, storageKey: m, variant: h, children: _ })),
        (t[32] = d),
        (t[33] = p),
        (t[34] = m),
        (t[35] = h),
...
function Aa() {
  ...
  e[3] === t
    ...
    : ((f = (e) => {
        (r(null),
          v(t, V.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED, e)
            .then(() => {
  ...
  Jo = s(u, ({ get: e }) =>
    To(
      e(T, p)
        ...
        .reverse()
        .flatMap((t) =>
          (e(g, t) ?? Ho).map((e) => ({ conversationId: t, items: e.items, turnId: e.turnId })),
        ),
    ),
  );
function Yo(e) {
            ...
            children: [
                  ...
                  (0, J.jsx)(
                    `button`,
                    {
                      ...
                      onClick: () => {
                        ...
                        (e.value === `workspace` && C(!1), s(e.value));
                      },
                      children: e.label,
                    },
                    e.value,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    ...
                    children: `Onboarding welcome pending: ${f ? `pending` : `off`} · Projectless completed: ${h ? `yes` : `no`} · Plugin checklist active: ${y ? `yes` : `no`} · Roles: ${ue}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
                    ...
                    onClick: () => {
                      (g(!1),
                        ...
                        C(!1),
                        (async () => {
                          (await v(t, `use-copilot-auth-if-available`, !1),
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-xs text-token-description-foreground`,
                    children: `Onboarding plugin checklist: ${y ? `active` : `inactive`}`,
                  }),
                  (0, J.jsxs)(`div`, {
                    className: `flex flex-wrap items-center gap-2`,
                    children: [
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-xs text-token-description-foreground`,
                    children: `Home onboarding tiles debug override: ${x ? `forced on` : `off`}`,
                  }),
                  (0, J.jsxs)(`div`, {
                    className: `flex flex-wrap items-center gap-2`,
                    children: [
                      ...
                      (0, J.jsx)(
                        `button`,
                        {
                          ...
                          onClick: () => {
                            ...
                            T({ arm: e.value, assignedAtMs: Date.now(), experimentName: yt });
                          },
                          children: e.label,
                        },
                        e.value,
...
function Ps() {
  ...
  e[4] === _
    ? (y = e[5])
    : ((y = (0, J.jsx)(X, { label: `Effective voice mode`, value: _ })), (e[4] = _), (e[5] = y));
  let b;
  e[6] !== m || e[7] !== g || e[8] !== y
    ? ((b = (0, J.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [m, g, y] })),
      (e[6] = m),
      (e[7] = g),
      (e[8] = y),
      (e[9] = b))
  ...
  e[11] === t
    ...
    : ((S = (e) => {
        (r(null),
          v(t, V.REALTIME_VOICE_MODE_DEBUG_DISABLED, e).catch((e) => {
...
function _c() {
  ...
  let y;
  e[6] !== p || e[7] !== h || e[8] !== _
    ? ((y = (0, J.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [p, h, _] })),
      (e[6] = p),
      (e[7] = h),
      (e[8] = _),
      (e[9] = y))
  ...
  e[11] === t
    ...
    : ((x = (e) => {
        (r(null),
          v(t, V.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED, e).catch((e) => {
