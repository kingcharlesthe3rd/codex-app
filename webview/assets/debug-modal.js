...
import { m as ue } from "./chunk-12.js";
import { n as de } from "./rpc-1.js";
import { c as fe, o as pe, s as me } from "./statsig.js";
import { t as he } from "./use-global-state.js";
import { t as ge } from "./use-auth-CI-WraL2.js";
import { a as _e } from "./setting-storage.js";
import { t as ve } from "./spinner.js";
import { t as ye } from "./link-external.js";
import { a as be, n as xe, s as Se, t as Ce } from "./mcp-capability-signals.js";
import {
  a as we,
  d as Te,
  f as Ee,
...
import { y as Ne } from "./use-plugins.js";
import { n as Pe, s as Fe } from "./home-onboarding-assistant-tutorial-card.js";
...
import { t as Ue } from "./use-stable-callback.js";
import { r as We } from "./modal-controller-state.js";
import { d as Ge, i as Ke, l as qe, n as Je, u as Ye } from "./dialog-layout.js";
import { t as Xe } from "./chevron-right.js";
import { t as Ze } from "./use-navigate-to-local-conversation.js";
import { n as Qe } from "./electron-menu-shortcuts.js";
import { t as $e } from "./remote-connections-onboarding-signals.js";
import { r as et, t as tt } from "./dropdown.js";
import { t as nt } from "./chevron.js";
import { t as rt } from "./code-snippet.js";
import { t as it } from "./copy-button.js";
import { t as at } from "./image-preview-dialog.js";
import { t as ot } from "./toggle.js";
import { t as st } from "./score-query-match.js";
import { t as ct } from "./use-is-thread-realtime-enabled.js";
import { a as lt, i as ut } from "./workspace-onboarding-experiment.js";
import { t as dt } from "./arrow-up-right-lg.js";
import { t as ft } from "./browser-sidebar-comment-mode-coachmark-state.js";
import { t as pt } from "./workspace-directory-tree.js";
import { a as mt, t as ht } from "./primary-runtime-query-keys.js";
import { i as gt, r as _t } from "./primary-runtime-install-state.js";
import { n as vt, t as yt } from "./hotkey-window-state.js";
import { m as bt, t as xt } from "./codex-mobile-setup-dialog.js";
import { a as St, o as Ct, s as wt } from "./use-debug-panel.js";
import { r as Tt, t as Et } from "./thread-virtualizer.js";
function Dt({ labels: e, projectlessThreadCwd: t, statuses: n, workspaceRoots: r }) {
  let i = new Map();
...
function Y(e) {
  ...
  t[19] === c
    ? (C = t[20])
    : ((C = c
        ? (0, J.jsx)(`span`, { className: `flex items-center gap-1`, onClick: Ot, children: c })
        : null),
      (t[19] = c),
      (t[20] = C));
  let w;
...
function At({ sourceThreadId: e }) {
  let [t, n] = (0, q.useState)(kt),
...
function X(e) {
  ...
  t[6] === r
    ...
    : ((c = (0, J.jsx)(it, {
        ...
        onCopy: () => {
          navigator?.clipboard?.writeText && navigator.clipboard.writeText(r).catch(jt);
        },
      })),
      (t[6] = r),
      (t[7] = c));
...
function jt() {}
var Mt = new Intl.DateTimeFormat(void 0, {
    fractionalSecondDigits: 3,
    hour: `2-digit`,
    minute: `2-digit`,
    second: `2-digit`,
  }),
  Nt = `debug-app-server-section`,
  Pt = [`resumed`, `resuming`, `needs_resume`],
  Ft = te(W, (e) => null);
function It() {
  let e = (0, K.c)(2),
    t = R(h),
...
function Lt(e) {
  let t = (0, K.c)(15),
    ...
    i = R(j),
    [a] = O(`host_config`),
    [o] = O(`remote_ssh_connections`),
    [s] = O(`remote_control_connections`),
    c;
...
function Rt(e) {
  let t = (0, K.c)(69),
    ...
    u = !!n.lines?.length,
    d;
  t[0] === a ? (d = t[1]) : ((d = a.filter(vn)), (t[0] = a), (t[1] = d));
  let f = d.length,
    p = B(Ft, r) ?? n.stateType === `local`,
    m = n.stateType === `local` ? `local` : s,
    h;
  t[2] === a ? (h = t[3]) : ((h = a.filter(Vt)), (t[2] = a), (t[3] = h));
  let g = h.length,
    _;
  t[4] === i ? (_ = t[5]) : ((_ = i.filter(Bt)), (t[4] = i), (t[5] = _));
  let v = _.length,
    y;
  t[6] === i ? (y = t[7]) : ((y = i.filter(zt)), (t[6] = i), (t[7] = y));
  let b = y.length,
    C;
  t[8] !== r || t[9] !== o
    ? ((C = (e) => {
        o.set(Ft, r, e.currentTarget.open);
      }),
      (t[8] = r),
      (t[9] = o),
      (t[10] = C))
  ...
  t[11] === n.displayName
    ...
    : ((w = (0, J.jsx)(`span`, {
      ...
      (t[12] = w));
  let T;
  t[13] === m ? (T = t[14]) : ((T = (0, J.jsx)(cn, { state: m })), (t[13] = m), (t[14] = T));
  let E;
  t[15] !== w || t[16] !== T
  ...
  let ne;
  t[47] !== u || t[48] !== n
    ? ((ne = u ? (0, J.jsx)(Ht, { hostDetails: n }) : null), (t[47] = u), (t[48] = n), (t[49] = ne))
    : (ne = t[49]);
  let z;
  t[50] !== r || t[51] !== l
    ? ((z = (0, J.jsx)(Kt, { hostId: r, threadStatusEntries: l })),
      (t[50] = r),
      (t[51] = l),
      (t[52] = z))
    : (z = t[52]);
  let V;
  t[53] !== r || t[54] !== a
    ? ((V = (0, J.jsx)(Wt, { hostId: r, requests: a })), (t[53] = r), (t[54] = a), (t[55] = V))
    : (V = t[55]);
  let re;
  t[56] !== r || t[57] !== i
    ? ((re = (0, J.jsx)(Yt, { hostId: r, notifications: i })),
      (t[56] = r),
      (t[57] = i),
      (t[58] = re))
    : (re = t[58]);
  let H;
  t[59] !== ne || t[60] !== z || t[61] !== V || t[62] !== re
    ? ((H = (0, J.jsx)(`div`, {
...
function Ht(e) {
  let t = (0, K.c)(4),
    { hostDetails: n } = e,
    r;
  t[0] === n.lines ? (r = t[1]) : ((r = n.lines?.map(Ut)), (t[0] = n.lines), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function Wt(e) {
  let t = (0, K.c)(16),
    ...
    [i, a] = (0, q.useState)(!1),
    o;
  t[0] === r ? (o = t[1]) : ((o = r.filter(vn)), (t[0] = r), (t[1] = o));
  let s = o,
    c = i ? s : r,
    l = r.length === 0,
    u;
...
function Gt(e) {
  return (0, J.jsx)(rn, { request: e }, e.id);
}
function Kt({ hostId: e, threadStatusEntries: t }) {
  let [n, r] = (0, q.useState)(null),
    [i, a] = (0, q.useState)(null),
    o = un(t),
    s = i != null && Pt.includes(i) ? i : null,
  ...
  return (0, J.jsx)(`div`, {
    ...
    children: (0, J.jsx)(Y, {
      ...
      children: (0, J.jsx)(`div`, {
        ...
        children:
          o.length === 0
            ? (0, J.jsx)(nn, { message: `No in-memory threads for this manager yet` })
            : (0, J.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, J.jsx)(`div`, {
                    ...
                    children:
                      c.length === 0
                        ? (0, J.jsx)(nn, { message: `No in-memory threads match this state` })
                        : c.map((t) =>
                            (0, J.jsxs)(
                              `div`,
                              {
                                      ...
                                      (0, J.jsx)(
                                        qt,
                                        {
                                          ...
                                          onUnsubscribe: async (t) => {
                                            r(t);
                                            try {
                                              await C(`unsubscribe-thread-for-host`, {
                                                hostId: e,
                                                threadId: t,
                                              });
                                            } finally {
...
function qt(e) {
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, J.jsx)(dt, { className: `icon-xs` })), (t[9] = f))
    : (f = t[9]);
  let p;
  t[10] === d
    ? (p = t[11])
  ...
  let x = `resume: ${n.resumeState}`,
    S;
  t[28] === x ? (S = t[29]) : ((S = (0, J.jsx)(Jt, { label: x })), (t[28] = x), (t[29] = S));
  let C = `stream: ${a?.role ?? `none`}`,
    w;
  t[30] === C ? (w = t[31]) : ((w = (0, J.jsx)(Jt, { label: C })), (t[30] = C), (t[31] = w));
  let T = `runtime: ${n.threadRuntimeStatus?.type ?? `none`}`,
    E;
  t[32] === T ? (E = t[33]) : ((E = (0, J.jsx)(Jt, { label: T })), (t[32] = T), (t[33] = E));
  let D = `turn: ${n.lastTurnStatus ?? `none`}`,
    O;
  t[34] === D ? (O = t[35]) : ((O = (0, J.jsx)(Jt, { label: D })), (t[34] = D), (t[35] = O));
  let k;
...
function Yt(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== s || t[4] !== a) {
    ...
    let y = o,
      b;
    (t[18] === y ? (b = t[19]) : ((b = y.filter($t)), (t[18] = y), (t[19] = b)), (d = b));
    let x;
    (t[20] !== y || t[21] !== a
      ? ((x = a ? y : y.filter(Qt)), (t[20] = y), (t[21] = a), (t[22] = x))
      : (x = t[22]),
      (f = x),
      (l = tn),
      (h = r.length === 0),
      ...
      (m =
        e.length > 0
          ? (0, J.jsxs)(`select`, {
              ...
              children: [(0, J.jsx)(`option`, { value: ``, children: `All threads` }), e.map(Zt)],
            })
          : null),
      (t[0] = n),
      (t[1] = r),
  ...
  t[33] !== u || t[34] !== d.length || t[35] !== f
    ? ((x =
        f.length > 0
          ...
          : (0, J.jsx)(nn, {
              message: d.length > 0 ? `Only hidden delta notifications recorded` : mn(u),
            })),
      (t[33] = u),
      (t[34] = d.length),
      (t[35] = f),
...
function Xt(e) {
  return (0, J.jsx)(an, { notification: e }, e.id);
}
function Zt(e) {
  return (0, J.jsx)(en, { threadId: e }, e);
}
function Qt(e) {
  return !e.isNoisy;
}
...
function en(e) {
  ...
  return (
    t[4] !== a || t[5] !== n
      ? ((s = (0, J.jsx)(`option`, { value: n, children: a })), (t[4] = a), (t[5] = n), (t[6] = s))
      : (s = t[6]),
    s
  );
}
...
function rn(e) {
  ...
  t[7] === n.startedAtMs
    ? (o = t[8])
    : ((o = Mt.format(n.startedAtMs)), (t[7] = n.startedAtMs), (t[8] = o));
  let s;
  t[9] === o ? (s = t[10]) : ((s = (0, J.jsx)(`div`, { children: o })), (t[9] = o), (t[10] = s));
  let c;
  t[11] === n ? (c = t[12]) : ((c = yn(n)), (t[11] = n), (t[12] = c));
  let l;
  ...
  t[25] === n.endedAtMs
    ...
    : ((h =
        n.endedAtMs == null
          ...
          : (0, J.jsxs)(`div`, { children: [`Ended: `, Mt.format(n.endedAtMs)] })),
      (t[25] = n.endedAtMs),
      (t[26] = h));
  let g;
  ...
  t[31] === n.paramsPreview
    ? (_ = t[32])
    : ((_ = (0, J.jsx)(on, { payload: n.paramsPreview, title: `Params` })),
      (t[31] = n.paramsPreview),
      (t[32] = _));
  let v;
  t[33] === n.resultPreview
    ...
    : ((v =
        n.resultPreview == null
          ? null
          : (0, J.jsx)(on, { payload: n.resultPreview, title: `Result` })),
      (t[33] = n.resultPreview),
      (t[34] = v));
  let y;
  t[35] === n.errorPreview
    ...
    : ((y =
        n.errorPreview == null
          ? null
          : (0, J.jsx)(on, { payload: n.errorPreview, title: `Error` })),
      (t[35] = n.errorPreview),
      (t[36] = y));
  let b;
...
function an(e) {
  ...
  t[0] === n.severity
    ? (r = t[1])
    : ((r = I(`group/notification bg-token-background rounded-lg border`, bn(n.severity))),
      (t[0] = n.severity),
      (t[1] = r));
  let i;
  t[2] === n.method
  ...
  t[9] === n.receivedAtMs
    ? (s = t[10])
    : ((s = Mt.format(n.receivedAtMs)), (t[9] = n.receivedAtMs), (t[10] = s));
  let c;
  t[11] === s
    ? (c = t[12])
    : ((c = (0, J.jsx)(`div`, {
  ...
  t[16] === n.paramsPreview
    ...
    : ((u = (0, J.jsx)(`div`, {
        className: `space-y-3 border-t border-token-border p-3`,
        children: (0, J.jsx)(on, { payload: n.paramsPreview, title: `Params` }),
      })),
      (t[16] = n.paramsPreview),
      (t[17] = u));
  let d;
...
function cn(e) {
  ...
  t[0] === n
    ? (r = t[1])
    : ((r = I(`rounded-full px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide`, xn(n))),
      (t[0] = n),
      (t[1] = r));
  let i;
  return (
...
function fn({ count: e, status: t }) {
  return `${t} (${e})`;
}
function pn(e) {
  return Pt.find((t) => t === e) ?? null;
}
function mn(e) {
  return e == null
...
var Sn = [`browser-debug-snapshot`],
  Cn = `debug-browser-tabs`,
  wn = 1e3,
  Tn = new Intl.DateTimeFormat(void 0, {
    fractionalSecondDigits: 3,
    hour: `2-digit`,
    minute: `2-digit`,
    second: `2-digit`,
...
function En() {
  ...
  e[1] === o
    ...
    : ((c = {
      ...
      (e[1] = o),
      (e[2] = c));
  let { data: l, isFetching: u, isLoading: d, refetch: f } = le(c),
    p;
  e[3] === f
    ? (p = e[4])
    : ((p = async (e) => {
        ...
        ? (0, J.jsxs)(`div`, {
            ...
            children: [
              (0, J.jsx)(`button`, {
                ...
                disabled: l == null,
                onClick: () => {
                  l != null && navigator.clipboard?.writeText(JSON.stringify(l, null, 2)).catch(Dn);
                },
                children: `Copy JSON`,
              }),
              (0, J.jsxs)(`button`, {
                ...
                children: [u ? (0, J.jsx)(ve, { className: `icon-2xs` }) : null, `Refresh`],
              }),
            ],
          })
        : null),
  ...
  e[10] !== l || e[11] !== m || e[12] !== d || e[13] !== n || e[14] !== i
    ? ((_ = n
        ? t == null
          ? (0, J.jsx)(Un, { message: `Browser debug service unavailable.` })
          : d && l == null
            ? (0, J.jsx)(Un, { message: `Loading Browser debug snapshot...` })
            : l == null
              ? (0, J.jsx)(Un, { message: `Browser debug snapshot unavailable.` })
              : (0, J.jsx)(kn, { onOpenOwner: m, openOwnerStatus: i, snapshot: l })
        : null),
      (e[10] = l),
      (e[11] = m),
      (e[12] = d),
...
function kn(e) {
  ...
  t[0] === i.capturedAtMs
    ? (a = t[1])
    : ((a = Tn.format(i.capturedAtMs)), (t[0] = i.capturedAtMs), (t[1] = a));
  let o;
  t[2] === a
    ? (o = t[3])
  ...
  t[21] === r
    ...
    : ((v =
      ...
      (t[22] = v));
  let y;
  t[23] === i.windows ? (y = t[24]) : ((y = i.windows.map(Pn)), (t[23] = i.windows), (t[24] = y));
  let b;
  t[25] === y
    ? (b = t[26])
    : ((b = (0, J.jsx)(Hn, {
  ...
  t[34] === i.sessionRoutes
    ? (C = t[35])
    : ((C = i.sessionRoutes.map(Nn)), (t[34] = i.sessionRoutes), (t[35] = C));
  let w;
  t[36] === C
    ? (w = t[37])
    : ((w = (0, J.jsx)(Hn, {
  ...
  t[38] === i.pendingAttaches
    ? (T = t[39])
    : ((T = i.pendingAttaches.map(Mn)), (t[38] = i.pendingAttaches), (t[39] = T));
  let E;
  t[40] === T
    ? (E = t[41])
    : ((E = (0, J.jsx)(Hn, {
  ...
  t[42] === i.openRequests
    ? (D = t[43])
    : ((D = i.openRequests.map(jn)), (t[42] = i.openRequests), (t[43] = D));
  let O;
  t[44] === D
    ? (O = t[45])
    : ((O = (0, J.jsx)(Hn, {
  ...
  t[46] === i.events
    ? (k = t[47])
    : ((k = i.events.slice().reverse().map(An)), (t[46] = i.events), (t[47] = k));
  let A;
  t[48] === k
    ? (A = t[49])
    : ((A = (0, J.jsx)(Hn, {
...
function An(e) {
  return (0, J.jsx)(zn, { event: e }, e.sequence);
}
function jn(e) {
  return (0, J.jsx)(
    Bn,
...
function Nn(e) {
  return (0, J.jsx)(Ln, { route: e }, `${e.windowId}:${e.conversationId}`);
}
function Pn(e) {
  return (0, J.jsx)(Fn, { window: e }, e.windowId);
}
function Fn(e) {
  let t = (0, K.c)(32),
    { window: n } = e,
  ...
  return (
    t[28] !== x || t[29] !== S || t[30] !== C
      ? ((w = (0, J.jsx)(Bn, { details: x, subtitle: S, title: C })),
        (t[28] = x),
        (t[29] = S),
        (t[30] = C),
        (t[31] = w))
...
function In(e) {
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, J.jsxs)(`span`, {
        ...
        children: [`Open owner`, (0, J.jsx)(dt, { className: `icon-2xs` })],
      })),
      (t[21] = h))
    : (h = t[21]);
  let g;
  ...
  let F;
  t[52] === r.bounds ? (F = t[53]) : ((F = Kn(r.bounds)), (t[52] = r.bounds), (t[53] = F));
  let I;
  t[54] === F
    ? (I = t[55])
  ...
  let L = `active=${r.active}`,
    ...
    te = `visible=${r.visible}`,
    R = `hasPage=${r.hasPage}`,
    ne = `loading=${r.isLoading}`,
    z = `restoring=${r.isRestoring}`,
    B = `suspended=${r.isSuspended}`,
    V;
  t[56] !== L ||
  t[57] !== ee ||
  t[58] !== te ||
  ...
  t[64] === re
    ? (H = t[65])
    : ((H = (0, J.jsx)(X, { label: `Flags`, value: re })), (t[64] = re), (t[65] = H));
  let U = `page=${r.isBrowserUsePage}`,
    W = `active=${r.isBrowserUseActive}`,
    ...
    se;
  t[66] !== U || t[67] !== W || t[68] !== ie || t[69] !== ae || t[70] !== oe
    ? ((se = [U, W, ie, ae, oe]),
      (t[66] = U),
      (t[67] = W),
      (t[68] = ie),
  ...
  t[72] === ce
    ? (le = t[73])
    : ((le = (0, J.jsx)(X, { label: `Browser Use`, value: ce })), (t[72] = ce), (t[73] = le));
  let G = `mount=${r.mountGeneration}`,
    ue = `last=${r.lastLifecycleSequence}`,
    de = `presented=${r.lastPresentedSequence}`,
    fe = `pendingAttach=${r.pendingAttachCount}`,
    pe;
  t[74] !== G || t[75] !== ue || t[76] !== de || t[77] !== fe
    ? ((pe = [G, ue, de, fe]), (t[74] = G), (t[75] = ue), (t[76] = de), (t[77] = fe), (t[78] = pe))
    : (pe = t[78]);
  let me = pe.join(` `),
    he;
  t[79] === me
  ...
  t[96] !== _e
    ? ((ve = (0, J.jsxs)(`div`, {
        ...
        children: [y, b, S, w, E, O, A, M, P, I, H, le, he, _e],
      })),
      (t[83] = y),
      (t[84] = b),
      (t[85] = S),
...
function Ln(e) {
  ...
  return (
    t[25] !== n.conversationId || t[26] !== v || t[27] !== y
      ? ((b = (0, J.jsx)(Bn, { details: v, subtitle: y, title: n.conversationId })),
...
function Rn(e) {
  ...
  return (
    t[19] !== f || t[20] !== p || t[21] !== m
      ? ((h = (0, J.jsx)(Bn, { details: f, subtitle: p, title: m })),
        (t[19] = f),
        (t[20] = p),
        (t[21] = m),
        (t[22] = h))
...
function zn(e) {
  ...
  t[2] === n.timestampMs
    ? (a = t[3])
    : ((a = Tn.format(n.timestampMs)), (t[2] = n.timestampMs), (t[3] = a));
  let o;
  ...
  return (
    t[28] !== n.message || t[29] !== y || t[30] !== b
      ? ((x = (0, J.jsx)(Bn, { details: y, subtitle: n.message, title: b })),
        (t[28] = n.message),
        (t[29] = y),
        (t[30] = b),
        (t[31] = x))
...
function Bn(e) {
  ...
  t[4] !== a || t[5] !== o
    ...
    : (s = t[6]);
  let c;
  t[7] === n ? (c = t[8]) : ((c = n.map(Vn)), (t[7] = n), (t[8] = c));
  let l;
  t[9] === c
    ? (l = t[10])
...
var gr = {
  ...
  getDefaultOptions: (e) => ({
    onColumnFiltersChange: Jn(`columnFilters`, e),
...
var vr = {
  ...
  yr = {
    ...
    getDefaultOptions: (e) => ({
      onGroupingChange: Jn(`grouping`, e),
...
var xr = {
    ...
    getDefaultOptions: (e) => ({ onColumnOrderChange: Jn(`columnOrder`, e) }),
    createColumn: (e, t) => {
      ((e.getIndex = Z(
        (e) => [Mr(t, e)],
  ...
  Cr = {
    ...
    getDefaultOptions: (e) => ({ onColumnPinningChange: Jn(`columnPinning`, e) }),
    createColumn: (e, t) => {
      ((e.pin = (n) => {
        let r = e
          .getLeafColumns()
...
var Tr = { size: 150, minSize: 20, maxSize: 2 ** 53 - 1 },
  ...
  Dr = {
    ...
    getDefaultOptions: (e) => ({
      ...
      onColumnSizingChange: Jn(`columnSizing`, e),
      onColumnSizingInfoChange: Jn(`columnSizingInfo`, e),
    }),
    createColumn: (e, t) => {
      ((e.getSize = () => {
...
var jr = {
  ...
  getDefaultOptions: (e) => ({ onColumnVisibilityChange: Jn(`columnVisibility`, e) }),
  createColumn: (e, t) => {
...
var Nr = {
  ...
  Pr = {
    ...
    getDefaultOptions: (e) => ({
      onGlobalFilterChange: Jn(`globalFilter`, e),
      globalFilterFn: `auto`,
  ...
  Fr = {
    ...
    getDefaultOptions: (e) => ({ onExpandedChange: Jn(`expanded`, e), paginateExpandedRows: !0 }),
    createTable: (e) => {
      let t = !1,
        n = !1;
  ...
  zr = {
    ...
    getDefaultOptions: (e) => ({ onPaginationChange: Jn(`pagination`, e) }),
    createTable: (e) => {
      let t = !1,
        n = !1;
  ...
  Vr = {
    ...
    getDefaultOptions: (e) => ({ onRowPinningChange: Jn(`rowPinning`, e) }),
    createRow: (e, t) => {
      ((e.pin = (n, r, i) => {
        let a = r
            ? e.getLeafRows().map((e) => {
  ...
  Hr = {
    ...
    getDefaultOptions: (e) => ({
      onRowSelectionChange: Jn(`rowSelection`, e),
...
function li(e, t) {
  return e ? (ui(e) ? q.createElement(e, t) : e) : null;
}
function ui(e) {
...
function ji() {
  ...
  let { data: l, isLoading: u } = ae(`child-processes`, c),
    d;
  e[2] === l?.processes
    ? (d = e[3])
    ...
    ? ((_ = t
        ? u && l == null
          ...
          : l?.rootProcess == null
            ...
            : (0, J.jsx)(Ni, { onProcessDetailsClick: o, processes: f, rootProcess: l.rootProcess })
        : null),
      (e[8] = l),
      (e[9] = u),
      (e[10] = t),
...
function Ni({ onProcessDetailsClick: e, processes: t, rootProcess: n }) {
  let r = (0, q.useMemo)(() => _i(n, t), [t, n]),
    i = (0, q.useMemo)(() => (r == null ? [] : [r]), [r]),
    a = pi({
      columns: (0, q.useMemo)(() => Pi(e), [e]),
      data: i,
      getCoreRowModel: oi(),
        ...
        (0, J.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, J.jsx)(`button`, {
              ...
              children: (0, J.jsx)(Ie, { className: `icon-xs` }),
            }),
          ],
        }),
    },
...
function Vi(e) {
  ...
  let h;
  t[29] !== l || t[30] !== d
    ? ((h = (0, J.jsx)(l, { lines: d })), (t[29] = l), (t[30] = d), (t[31] = h))
    : (h = t[31]);
  let _;
  return (
    t[32] !== u || t[33] !== f || t[34] !== p || t[35] !== m || t[36] !== h
      ? ((_ = (0, J.jsx)(u, { title: f, storageKey: p, variant: m, children: h })),
        (t[32] = u),
        (t[33] = f),
        (t[34] = p),
        (t[35] = m),
...
function Qi() {
  let e = (0, K.c)(15),
    ...
    { data: a, isLoading: o } = he(n.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED),
    s = a === !0,
  ...
  e[0] === c
    ...
    : ((l = (0, J.jsx)(`div`, {
        ...
        children: (0, J.jsx)(X, { label: `Lock override`, value: c }),
      })),
      (e[0] = c),
      (e[1] = l));
  let u;
  ...
  e[3] === t
    ...
    : ((d = (e) => {
        (i(null),
          A(t, n.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED, e)
            .then(() => {
...
function $i() {
  ...
  e[0] === t
    ? (a = e[1])
    : ((a = { mutationFn: ea, onSuccess: (e) => (t.setQueryData(yt, e.state), e) }),
      (e[0] = t),
      (e[1] = a));
  let o = V(a);
  ...
  e[2] === i.configuredHotkey
    ? (s = e[3])
    : ((s = i.configuredHotkey == null ? `Off` : Qe(i.configuredHotkey)),
      (e[2] = i.configuredHotkey),
      (e[3] = s));
  let c = s,
...
function la() {
  ...
  if (
    ...
    ((_ = n.filter((e) => Ea(e).includes(v) && Da(e).includes(y) && wa(e, s))),
      (p = _.slice(0, d)));
    let b = xa(p);
    ...
    e[16] === a
      ...
      : ((w = (0, J.jsx)(`input`, {
        ...
        (e[17] = w));
    let T;
    e[18] === s ? (T = e[19]) : ((T = Ta(s)), (e[18] = s), (e[19] = T));
    let E;
    e[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((E = (0, J.jsx)(nt, { className: `icon-2xs opacity-70` })), (e[20] = E))
      : (E = e[20]);
    let D;
    e[21] === T
      ? (D = e[22])
    ...
    e[24] === D
      ? (k = e[25])
      : ((k = (0, J.jsx)(tt, { align: `end`, triggerButton: D, children: O })),
        (e[24] = D),
        (e[25] = k));
    let A;
...
function ga(e) {
  let t = (0, K.c)(37),
    ...
    g;
  t[0] === h ? (g = t[1]) : ((g = I(`flex flex-col`, h)), (t[0] = h), (t[1] = g));
  let _;
  t[2] !== l || t[3] !== f || t[4] !== u
    ? ((_ = () => {
        let e = !l;
...
var Ra = 8,
  ...
  Ua = f({
    ...
    data: p(),
    mimeType: p().optional(),
    mime_type: p().optional(),
  }).catchall(d()),
  Wa = f({ type: a(`text`), text: p() }).catchall(d()),
  Ga = f({ code: p(), timeout_ms: d().optional(), title: d().optional() }).catchall(d());
function Ka(e) {
  let t = qa(e);
  ...
  go = z(W, ({ get: e }) =>
    Ka(
      e(v, y)
        ...
        .reverse()
        .flatMap((t) =>
          (e(b, t) ?? lo).map((e) => ({ conversationId: t, items: e.items, turnId: e.turnId })),
        ),
    ),
  );
function _o(e) {
  ...
  if (n != null) {
    ...
    return (
      t[0] === n
        ? (e = t[1])
        : ((e = (0, J.jsx)(yo, { conversationId: n })), (t[0] = n), (t[1] = e)),
      e
    );
  }
  let r;
...
function vo() {
  ...
  return (
    e[0] === t.lines
      ? (n = e[1])
      : ((n = (0, J.jsx)(bo, { lines: t.lines })), (e[0] = t.lines), (e[1] = n)),
    n
  );
}
function yo(e) {
  ...
  return (
    t[5] === a.lines
      ? (o = t[6])
      : ((o = (0, J.jsx)(bo, { lines: a.lines })), (t[5] = a.lines), (t[6] = o)),
    o
  );
}
function bo(e) {
...
function xo({ lines: e }) {
  let t = (0, q.useMemo)(
    ...
    [n, r] = (0, q.useState)({}),
    [i, a] = (0, q.useState)(null),
    [o, s] = (0, q.useState)(() => To(t.length)),
    c = (0, q.useRef)(null),
    l = (0, q.useRef)(n),
    u = Et({ entries: t, gapPx: 0, measuredHeightsByKey: n });
  l.current = n;
  let d = Ue(() => {
  ...
  return (0, J.jsx)(`div`, {
    ...
    children: (0, J.jsx)(`div`, {
      ...
      children: (0, J.jsx)(`div`, {
        ...
        children: h.map((e) => (0, J.jsx)(So, { entry: e, measureLineRef: m }, e.turnKey)),
      }),
    }),
  });
}
var So = (0, q.memo)(function (e) {
  let t = (0, K.c)(6),
    { entry: n, measureLineRef: r } = e,
    i;
  t[0] === n.line
    ? (i = t[1])
    : ((i = (0, J.jsx)(Co, { line: n.line })), (t[0] = n.line), (t[1] = i));
  let a;
  return (
...
function Co(e) {
  ...
  switch (n.kind) {
    ...
    case `image`: {
      let e;
      return (
        t[9] === n ? (e = t[10]) : ((e = (0, J.jsx)(Mo, { line: n })), (t[9] = n), (t[10] = e)), e
      );
    }
    case void 0: {
      let e;
...
function jo(e) {
  ...
  return (
    t[5] !== n || t[6] !== c
      ? ((l = (0, J.jsx)(wo, { label: n, children: c })), (t[5] = n), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
function Mo(e) {
  ...
  return (
    t[15] !== n.label || t[16] !== m
      ? ((h = (0, J.jsx)(wo, { label: n.label, children: m })),
        (t[15] = n.label),
        (t[16] = m),
        (t[17] = h))
      : (h = t[17]),
...
function zo() {
  let e = (0, K.c)(41),
    ...
    [j, M] = (0, q.useState)(!1),
    N;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((N = { hostId: y }), (e[0] = N)) : (N = e[0]);
  let P = j && !0,
    F;
  e[1] === P
    ? (F = e[2])
    : ((F = { params: N, queryConfig: { enabled: P } }), (e[1] = P), (e[2] = F));
  let L = ae(`workspace-root-options`, F).data?.roots.length ?? 0,
    te;
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = [
        ...
        { value: lt, label: `T5 Onboarding V2` },
      ]),
      (e[4] = z))
    : (z = e[4]);
  let B = z,
    ...
    ? ((ce = j
        ? (0, J.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, J.jsx)(`div`, {
                className: `text-xs text-token-description-foreground`,
                children: `Codex runtime: ${k == null ? `idle` : Bo(k)}`,
              }),
              (0, J.jsx)(`div`, {
                ...
                children: ne.map((e) =>
                  (0, J.jsx)(
                    `button`,
                    {
                      ...
                      onClick: () => {
                        (e.value === `workspace` && g(!1), o(e.value));
                      },
                      children: e.label,
                    },
                    e.value,
                  ...
                  (0, J.jsx)(`button`, {
                    ...
                    onClick: () => {
                      (u(!1),
                        ...
                        g(!1),
                        (async () => {
                          (await A(t, `use-copilot-auth-if-available`, !1),
                            await C(`logout`, { hostId: y }),
                            o(`welcome`),
                            c(!0),
                            u(!1),
                            p(!1),
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-xs text-token-description-foreground`,
                    children: `Workspace onboarding experiment: ${ie}`,
                  }),
                  (0, J.jsx)(`div`, {
                    className: `flex flex-wrap gap-2`,
                    children: B.map((e) =>
                      (0, J.jsx)(
                        `button`,
                        {
                          ...
                          onClick: () => {
                            ...
                            v({ arm: e.value, assignedAtMs: Date.now(), experimentName: ut });
                          },
                          children: e.label,
                        },
                        e.value,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, J.jsx)(`button`, {
                    ...
                    onClick: () => {
                      (E(!1), D(!1), i.updateUserAsync(i.getContext().user));
                    },
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Remote Connections home announcement: ${O ? `seen` : `unseen`}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
                    className: `rounded border border-token-border px-3 py-1 text-token-description-foreground hover:bg-token-foreground/5`,
...
function Bo({ downloadedBytes: e, errorMessage: t, phase: n, totalBytes: r }) {
  return [n, e == null ? null : r == null ? `${Vo(e)} downloaded` : `${Vo(e)} / ${Vo(r)}`, t]
    .filter(Boolean)
    .join(` · `);
}
function Vo(e) {
...
function Ho() {
  ...
  e[18] === a
    ? (_ = e[19])
    : ((_ = a ? (0, J.jsx)(ve, { className: `icon-2xs` }) : null), (e[18] = a), (e[19] = _));
  let v;
  ...
  return (
    e[0] === t
      ...
      : ((n = (0, J.jsx)(Y, {
          ...
          variant: `global`,
          children: (0, J.jsx)(Go, { productEvents: t }),
        })),
        (e[0] = t),
        (e[1] = n)),
    n
    ...
    `div`,
    {
      ...
      children: [
        (0, J.jsxs)(`div`, {
          ...
          children: [
            (0, J.jsx)(`span`, {
              className: I(`w-fit rounded-full px-2 py-0.5 text-xs font-medium`, Jo(e.status)),
              children: qo(e.status),
            }),
            (0, J.jsx)(`span`, {
              className: `text-token-description-foreground tabular-nums`,
              children: Yo(e.updatedTimestampMs),
            }),
            (0, J.jsx)(`span`, {
              className: `text-token-description-foreground`,
...
function Xo(e, t) {
  let n = [...e].reverse(),
    r = t.trim();
  return r.length === 0 ? n : n.filter((e) => Zo(e, r));
}
function Zo(e, t) {
  return st(Qo(e), t) > 0 || st($o(e), t) > 0 || st(e.event.type, t) > 0 || st(ns(e), t) > 0;
}
function Qo(e) {
  switch (e.event.type) {
    case `legacy`:
...
function is() {
  let e = (0, K.c)(23),
    ...
    a = pe(`2380644311`),
    o = ct(),
    { data: s, isLoading: c } = he(n.REALTIME_VOICE_MODE_DEBUG_DISABLED),
    l = s === !0,
    u = a ? `Enabled` : `Disabled`,
    d;
  e[0] === u
    ? (d = e[1])
    : ((d = (0, J.jsx)(X, { label: `Statsig gate`, value: u })), (e[0] = u), (e[1] = d));
  let f = l ? `Forcing off` : `Off`,
    p;
  e[2] === f
    ? (p = e[3])
    : ((p = (0, J.jsx)(X, { label: `Debug override`, value: f })), (e[2] = f), (e[3] = p));
  let m = o ? `Enabled` : `Disabled`,
    h;
  e[4] === m
    ? (h = e[5])
  ...
  let g;
  e[6] !== d || e[7] !== p || e[8] !== h
    ? ((g = (0, J.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [d, p, h] })),
      (e[6] = d),
      (e[7] = p),
      (e[8] = h),
      (e[9] = g))
  ...
  e[11] === t
    ...
    : ((v = (e) => {
        (i(null),
          A(t, n.REALTIME_VOICE_MODE_DEBUG_DISABLED, e).catch((e) => {
            i(e instanceof Error ? e.message : `Failed to update realtime voice override.`);
          }));
      }),
      (e[11] = t),
      (e[12] = v));
  let y;
  e[13] !== c || e[14] !== l || e[15] !== v
    ? ((y = (0, J.jsxs)(`div`, {
        className: `flex items-center justify-between gap-3 py-1.5`,
        children: [
          _,
...
s(p());
var ss = f({ dynamic_configs: l(p(), d()), feature_gates: l(p(), d()) }),
  cs = u([f({ is_user_in_experiment: r() }), f({ ue: a(!0) })]),
  ls,
  us = new Map();
function ds(e, t = ``) {
  if (!t.trim()) return [];
...
function ws(e) {
  ...
  return (
    t[8] !== r || t[9] !== s || t[10] !== c || t[11] !== l
      ? ((u = (0, J.jsx)(Zi, { title: s, subtitle: c, status: l, onClick: r })),
        (t[8] = r),
        (t[9] = s),
        (t[10] = c),
        (t[11] = l),
...
function Ts(e) {
  let t = (0, K.c)(7),
    ...
    s;
  t[0] !== i || t[1] !== a || t[2] !== o
    ? ((s = I(`inline-flex min-h-5 items-center rounded border px-2 text-xs`, i, a, o)),
      (t[0] = i),
      (t[1] = a),
      (t[2] = o),
      (t[3] = s))
...
function Es() {
  let e = (0, K.c)(18),
    ...
    [r, i] = (0, q.useState)(!1),
    a;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = { hostId: y }), (e[0] = a)) : (a = e[0]);
  let o;
  e[1] === t
    ? (o = e[2])
    : ((o = { params: a, queryConfig: { enabled: t } }), (e[1] = t), (e[2] = o));
  let { data: s } = ae(`workspace-root-options`, o),
    c;
...
function Os(e) {
  ...
  let f;
  t[8] !== n || t[9] !== u
    ? ((f = (0, J.jsx)(Zi, { title: u, subtitle: n, onClick: d })),
      (t[8] = n),
      (t[9] = u),
      (t[10] = f))
    : (f = t[10]);
  ...
  t[11] !== i || t[12] !== a || t[13] !== n
    ? ((p = a
        ? (0, J.jsx)(`div`, {
            className: `pb-1`,
            children: (0, J.jsx)(pt, { hostId: y, includeHidden: i, root: n }),
          })
        : null),
      (t[11] = i),
      (t[12] = a),
...
function Ps(e) {
  ...
  t[2] !== o || t[3] !== d
    ? ((f = {
      ...
      (t[4] = f))
    : (f = t[4]);
  let { data: p, isLoading: m, refetch: h } = le(f),
    g;
  t[5] !== n || t[6] !== a
    ? ((g = async (e) => {
        let { release: t } = e;
        return (await mt(a), n.runUpdateNow({ release: t }));
      }),
      (t[5] = n),
      (t[6] = a),
      (t[7] = g))
  ...
  t[8] === i
    ? (_ = t[9])
    : ((_ = (e) => {
        (l(Ls(e)), i.invalidateQueries({ queryKey: ht }));
      }),
      (t[8] = i),
      (t[9] = _));
  let v;
  ...
  t[13] === r
    ...
    : ((S = (e) => {
        ...
        (r.set(_t, t), H.dispatchMessage(`set-primary-runtime-install-release`, { release: t }));
      }),
      (t[13] = r),
      (t[14] = S));
  let C = S,
    ...
    ? ((w = o
        ? (0, J.jsx)(tt, {
            ...
            triggerButton: (0, J.jsxs)(`button`, {
              ...
              disabled: b,
              children: [
                b ? (0, J.jsx)(ve, { className: `icon-2xs` }) : null,
                `Cron`,
                (0, J.jsx)(nt, { className: `icon-2xs opacity-70` }),
              ],
            }),
            children: (0, J.jsxs)(`div`, {
              className: `flex min-w-[220px] flex-col gap-0.5`,
              children: [
                (0, J.jsx)(et.Title, { children: `Workspace runtime cron` }),
                (0, J.jsx)(et.Item, {
                ...
                (0, J.jsx)(et.Separator, {}),
                (0, J.jsx)(et.Title, { children: `Install flow` }),
                (0, J.jsxs)(`div`, {
          ...
          : (0, J.jsxs)(`div`, {
              ...
              children: [
                ...
                p?.disabledReason == null
                  ? null
                  : (0, J.jsx)(X, { label: `Disabled`, value: zs(p.disabledReason) }),
                (0, J.jsx)(X, { label: `Next cron`, value: Is(p?.nextRunAt ?? null) }),
                (0, J.jsx)(X, {
                  label: `Startup check`,
...
function Vs() {
  let e = (0, K.c)(23),
    t = ee(W),
    [r, i] = (0, q.useState)(null),
    a = _e(m.autoCleanupEnabled),
    { data: o, isLoading: s } = he(n.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED),
    c = o === !0,
    l = a && c,
    u = s,
  ...
  e[0] === d
    ? (f = e[1])
    : ((f = (0, J.jsx)(X, { label: `Worktrees setting`, value: d })), (e[0] = d), (e[1] = f));
  let p = c ? `Enabled` : `Disabled`,
    h;
  e[2] === p
    ? (h = e[3])
    : ((h = (0, J.jsx)(X, { label: `Source-build override`, value: p })), (e[2] = p), (e[3] = h));
  ...
  let v;
  e[6] !== f || e[7] !== h || e[8] !== _
    ? ((v = (0, J.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [f, h, _] })),
      (e[6] = f),
      (e[7] = h),
      (e[8] = _),
      (e[9] = v))
  ...
  e[11] === t
    ...
    : ((b = (e) => {
        (i(null),
          A(t, n.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED, e).catch((e) => {
            i(e instanceof Error ? e.message : `Failed to update worktree cleanup override.`);
          }));
      }),
      (e[11] = t),
      (e[12] = b));
  let x;
  e[13] !== u || e[14] !== c || e[15] !== b
    ? ((x = (0, J.jsxs)(`div`, {
        className: `flex items-center justify-between gap-3 py-1.5`,
        children: [
          y,
...
var Hs = 1e3,
  ...
  Gs = re(W, `is-packaged`, { staleTime: ce.FIVE_SECONDS });
function Ks(e) {
  let t = (0, K.c)(17),
    { onClose: n } = e,
    [r, i] = (0, q.useState)(Js),
...
function Ys({
  ...
  let s = ge(),
    ...
    v = h != null && a && c.allowDebugMenu(Ne()),
    y = m?.isPackaged === !1,
    b = e ?? null,
    x =
      typeof window < `u`
    ...
    children: [
      ...
      (0, J.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, J.jsx)(Le, {
            electron: !0,
            children: (0, J.jsx)(_o, { conversationId: b ?? void 0 }),
          }),
          b == null ? null : (0, J.jsx)(Vi, { conversationId: b }),
          l.map((e) => {
            ...
            return (0, J.jsx)(
              Y,
              {
                ...
                storageKey: t,
                variant: `selection`,
                children: (0, J.jsx)(Ri, { lines: e.lines }),
              },
              e.id,
            );
          }),
          ...
          null,
          (0, J.jsx)(It, {}),
          (0, J.jsx)(Le, { electron: !0, children: (0, J.jsx)(En, {}) }),
          (0, J.jsx)(ca, {}),
          (0, J.jsx)(Ho, {}),
          (0, J.jsx)(Cs, {}),
          (0, J.jsx)(Qs, {}),
          ...
          (0, J.jsx)(is, {}),
          y ? (0, J.jsx)(Qi, {}) : null,
          (0, J.jsx)(At, { sourceThreadId: b ?? void 0 }),
          y ? (0, J.jsx)(Vs, {}) : null,
          (0, J.jsx)($i, {}),
          (0, J.jsx)(Y, {
                              ...
                              children: [
                                ...
                                f
                                  ? (0, J.jsx)(`div`, {
                                      ...
                                      children: (0, J.jsx)(ve, { className: `icon-xxs` }),
                                    })
                                  : (0, J.jsx)(tt, {
                                      align: `end`,
                                      triggerButton: (0, J.jsxs)(`button`, {
...
function Qs() {
  let e = (0, K.c)(25),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((t = Ne()), (e[0] = t)) : (t = e[0]);
  let n = t,
    r = L(),
    [a, o] = (0, q.useState)(ec),
    s = a && (n === `dev` || n === `nightly`),
  ...
  e[1] === s
    ? (c = e[2])
    : ((c = { queryConfig: { enabled: s, intervalMs: Hs } }), (e[1] = s), (e[2] = c));
  let { data: l, isLoading: u } = ae(`ambient-suggestions-generation-statuses`, c),
    d;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((d = { hostId: y }), (e[3] = d)) : (d = e[3]);
  let f;
  e[4] === a
    ? (f = e[5])
    : ((f = { params: d, queryConfig: { enabled: a } }), (e[4] = a), (e[5] = f));
  let { data: p } = ae(`workspace-root-options`, f),
    m;
  e[6] === a ? (m = e[7]) : ((m = { queryConfig: { enabled: a } }), (e[6] = a), (e[7] = m));
  let { data: h } = ae(`projectless-thread-cwd`, m),
    g;
  e[8] === r
    ? (g = e[9])
    : ((g = {
        onSuccess: () => {
          (r.invalidateQueries({ queryKey: oe(`ambient-suggestions-generation-statuses`) }),
            r.invalidateQueries({ queryKey: oe(`ambient-suggestions`) }));
        },
      }),
      (e[8] = r),
      (e[9] = g));
  let _ = se(`ambient-suggestions-refresh`, g),
    v = l?.statuses,
    b,
    x,
    S;
              ...
              (0, J.jsx)(
                Zi,
                {
                  ...
                  rightActions: (0, J.jsx)(`button`, {
                    ...
                    onClick: () => {
                      _.mutateAsync({ hostId: y, projectRoot: i(n) }).catch((e) => {
