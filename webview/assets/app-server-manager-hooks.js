...
import { A as E, O as D } from "./sidebar-signals.js";
var O = class {
    constructor(e) {
      this.scope = e;
    }
    addManager(e) {
      ...
      (this.scope.set(t, (e) => (e.includes(n) ? e : [...e, n])),
        ...
        this.scope.set(c, n, l(e)),
        this.scope.set(o, (e) => e + 1));
    }
    ...
    getForHostId(e) {
      return this.scope.get(t).includes(e) ? this.scope.get(c, e) : null;
    }
    getImplForHostId(e) {
...
async function L({ scope: e, appServerRegistry: t, enabledRemoteHostIds: n, sortKey: r }) {
  return (
    await Promise.all(
      M(e, t).map((e) =>
        s(`refresh-recent-conversations-for-host`, { hostId: e.getHostId(), sortKey: r }),
      ),
    ),
...
function R({ scope: e, appServerRegistry: t, sortKey: n, refreshesInFlightHostIds: r }) {
  for (let i of M(e, t)) {
    ...
    i.hasFetchedRecentConversations ||
      r.has(e) ||
      (r.add(e),
      s(`refresh-recent-conversations-for-host`, { hostId: e, sortKey: n })
        .catch((t) => {
