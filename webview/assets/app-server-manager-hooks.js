...
import { _ as b, k as x, m as S, u as C } from "./vscode-api.js";
...
var O = class {
    ...
    getImplForHostId(e) {
      return this.scope.get(m).includes(e) ? this.scope.get(g, e) : null;
    }
...
async function L({ scope: e, appServerRegistry: t, enabledRemoteHostIds: n, sortKey: r }) {
  return (
    await Promise.all(
      M(e, t).map((e) =>
        p(`refresh-recent-conversations-for-host`, { hostId: e.getHostId(), sortKey: r }),
      ),
    ),
...
function R({ scope: e, appServerRegistry: t, sortKey: n, refreshesInFlightHostIds: r }) {
  for (let i of M(e, t)) {
    ...
    i.hasFetchedRecentConversations ||
      r.has(e) ||
      (r.add(e),
      p(`refresh-recent-conversations-for-host`, { hostId: e, sortKey: n })
        .catch((t) => {
          S.warning(`recent_conversations_refresh_failed`, {
...
function X(e) {
  ...
  t[15] !== s || t[16] !== u || t[17] !== n || t[18] !== p
    ? ((S = async () =>
        L({ scope: n, appServerRegistry: s, enabledRemoteHostIds: z(u), sortKey: p })),
      (t[15] = s),
      (t[16] = u),
      (t[17] = n),
      (t[18] = p),
