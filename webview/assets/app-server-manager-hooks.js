...
var O = class {
    ...
    addManager(e) {
      let t = e.getHostId();
      (this.scope.set(g, (e) => (e.includes(t) ? e : [...e, t])),
        this.scope.set(h, t, e),
        this.scope.set(m, t, p(e)),
        this.scope.set(d, (e) => e + 1));
    }
    ...
    deleteManager(e) {
      (this.scope.set(g, (t) => t.filter((t) => t !== e)),
        this.scope.set(m, e, null),
    ...
    getAll() {
      return this.scope.get(_);
    }
    getDefault() {
      return this.scope.get(v);
    }
    ...
    getForHostId(e) {
      return this.scope.get(g).includes(e) ? this.scope.get(m, e) : null;
    }
    getImplForHostId(e) {
      return this.scope.get(g).includes(e) ? this.scope.get(h, e) : null;
    }
...
async function L({ scope: e, appServerRegistry: t, enabledRemoteHostIds: n, sortKey: r }) {
  return (
    await Promise.all(
      M(e, t).map((e) =>
        l(`refresh-recent-conversations-for-host`, { hostId: e.getHostId(), sortKey: r }),
      ),
    ),
...
function R({ scope: e, appServerRegistry: t, sortKey: n, refreshesInFlightHostIds: r }) {
  for (let i of M(e, t)) {
    ...
    i.hasFetchedRecentConversations ||
      r.has(e) ||
      (r.add(e),
      l(`refresh-recent-conversations-for-host`, { hostId: e, sortKey: n })
        .catch((t) => {
...
function V() {
  ...
  let [i] = (0, A.useState)(n),
    o,
    s;
  return (
    e[2] === i
      ? ((o = e[3]), (s = e[4]))
      : ((o = (e) => i.addRegistryCallback(e)), (s = () => i), (e[2] = i), (e[3] = o), (e[4] = s)),
    (0, A.useSyncExternalStore)(o, s)
  );
}
function H(e) {
  let t = (0, k.c)(5),
...
function X(e) {
  ...
  let g = (0, A.useRef)(h),
    _,
    v;
  (t[3] !== s || t[4] !== u || t[5] !== m || t[6] !== e || t[7] !== o || t[8] !== p
    ? ((_ = () => {
        let t = () => {
          let t = z(u);
          (m.setQueryData(
            [e, p, u],
            I({ appServerRegistry: s, enabledRemoteHostIds: t, sortKey: p }),
          ),
            R({ scope: o, appServerRegistry: s, sortKey: p, refreshesInFlightHostIds: g.current }));
        };
        return (
          t(),
          P({
  ...
  t[11] !== u || t[12] !== e || t[13] !== p
    ...
    : (y = t[14]);
  let x;
  t[15] !== s || t[16] !== u || t[17] !== o || t[18] !== p
    ? ((x = async () =>
        L({ scope: o, appServerRegistry: s, enabledRemoteHostIds: z(u), sortKey: p })),
      (t[15] = s),
      (t[16] = u),
      (t[17] = o),
      (t[18] = p),
