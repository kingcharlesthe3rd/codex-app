...
var O = class {
    ...
    addManager(e) {
      let t = e.getHostId();
      (this.scope.set(_, (e) => (e.includes(t) ? e : [...e, t])),
        this.scope.set(g, t, e),
        this.scope.set(v, t, p(e)),
        this.scope.set(h, (e) => e + 1));
    }
    ...
    deleteManager(e) {
      (this.scope.set(_, (t) => t.filter((t) => t !== e)),
        this.scope.set(v, e, null),
        this.scope.set(g, e, null),
        u(this.scope, {
          error: null,
          hostId: e,
    ...
    getForHostId(e) {
      return this.scope.get(_).includes(e) ? this.scope.get(v, e) : null;
    }
    getImplForHostId(e) {
      return this.scope.get(_).includes(e) ? this.scope.get(g, e) : null;
    }
