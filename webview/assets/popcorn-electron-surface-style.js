...
import { Dt as E, Et as D } from "./workbook-1.js";
import {
  $ as ee,
  B as te,
  F as ne,
...
function xe(e) {
  let { children: t, id: n, items: r, strategy: i = De, disabled: a = !1 } = e,
    { active: o, dragOverlay: s, droppableRects: c, over: l, measureDroppableContainers: u } = ce(),
    d = le(Oe, n),
    f = s.rect !== null,
    p = (0, F.useMemo)(() => r.map((e) => (typeof e == `object` && `id` in e ? e.id : e)), [r]),
    m = o != null,
  ...
  return F.createElement(ke.Provider, { value: x }, t);
}
function Se(e) {
  ...
  return (
    P(() => {
      if (!t && n !== s.current && r.current) {
        let e = i.current;
        if (e) {
          let t = pe(r.current, { ignoreTransform: !0 }),
            n = {
              x: e.left - t.left,
              y: e.top - t.top,
...
function Ce(e) {
  let {
    ...
    S = (0, F.useMemo)(() => u.slice(u.indexOf(o)), [u, o]),
    {
      rect: C,
      node: w,
      isOver: T,
    ...
    }),
    {
      ...
      transform: A,
    } = de({ id: o, data: x, attributes: { ...Fe, ...n }, disabled: y.draggable }),
    oe = me(E, re),
    j = !!D,
    ce = j && !m && _e(f) && _e(g),
    le = !_ && O,
    pe = ce
      ? ((le && ce ? A : null) ??
        (s ?? v)({ rects: h, activeNodeRect: te, activeIndex: f, overIndex: g, index: b }))
      : null,
    M = _e(f) && _e(g) ? a({ id: o, items: u, activeIndex: f, overIndex: g }) : b,
    N = D?.id,
    P = (0, F.useRef)({ activeId: N, items: u, newIndex: M, containerId: d }),
    he = u !== P.current.items,
    ge = t({
      active: D,
      containerId: d,
      isDragging: O,
    ...
    ve = Se({ disabled: !ge, index: b, node: w, rect: C });
  return (
    (0, F.useEffect)(() => {
  ...
  function ye() {
    if (ve || (he && P.current.newIndex === b)) return Pe;
    if (!((le && !ue(ee)) || !l) && (j || ge))
      return se.Transition.toString({ ...l, property: Ne });
  }
}
function we(e, t) {
    ...
    ((F = t(b())),
      ...
      (Ee = (e) => {
        ...
        if (a === r) {
          let e = t[i];
          return e
            ? { x: r < i ? e.left + e.width - (o.left + o.width) : e.left - o.left, y: 0, ...Te }
            : null;
        }
        return a > r && a <= i
          ? { x: -o.width - s, y: 0, ...Te }
      ...
      (Ne = `transform`),
      (Pe = se.Transition.toString({ property: Ne, duration: 0, easing: `linear` })),
...
function at(e, t) {
  switch (t) {
    ...
    case `top-left`:
      return { fontFamily: L, left: e.left, top: e.top - R, transform: `translateY(-100%)` };
    case `top-right`:
      return {
        fontFamily: L,
        left: e.left + e.width,
...
function xt({ drawingId: e, screenshot: t, markerViewportPoint: n, viewportSize: r }) {
  return {
...
function Et({ stroke: e, projectPoint: t }) {
  ...
  if (n.length === 1) {
    let [t] = n;
    return t
      ? (0, z.jsx)(`circle`, { cx: t.x, cy: t.y, r: e.strokeWidth / 2, fill: e.color })
      : null;
  }
  return (0, z.jsx)(`path`, {
    d: gt(n),
    ...
    : (0, z.jsxs)(`svg`, {
        ...
        children: [
          ...
          (0, z.jsx)(`g`, {
            ...
            children: e.map((e, n) =>
              (0, z.jsx)(Et, { stroke: e, projectPoint: t }, `${n}-${e.points.length}`),
            ),
          }),
        ],
      });
...
function Nt({
  ...
  return (0, V.jsx)(`button`, {
    ...
    children: (0, V.jsxs)(`span`, {
      className: x(`flex min-w-0 items-center`, e ? `justify-start` : `w-full justify-center`),
      children: [
        a({
          className: x(
...
function Pt({ active: e, disabled: t = !1, onClick: n, testId: r = `popcorn-annotation-button` }) {
  return (0, V.jsx)(Nt, {
    active: e,
...
function Ft({ active: e, disabled: t = !1, onClick: n, testId: r = `popcorn-drawing-button` }) {
  return (0, V.jsx)(Nt, {
    active: e,
    disabled: t,
    onClick: n,
      ...
      (gn = (0, H.forwardRef)(function (
        {
          ...
          mode: u = `create`,
          onDelete: d,
          testId: f = `popcorn-annotation-editor`,
        },
        p,
      ) {
        let h = (0, H.useRef)(null),
          ...
          ),
          {
            ...
            middleware: [
              a(Kt + qt),
              m({ fallbackPlacements: [`left-start`], padding: Gt, ...(O ? { boundary: O } : {}) }),
              l({ padding: Gt, ...(O ? { boundary: O } : {}) }),
              S({
                padding: Gt,
                ...(O ? { boundary: O } : {}),
          ...
          le = b ? Jt : Yt,
          ue = j == null ? void 0 : j + (Jt - le) / 2 + qt,
          de = (0, H.useCallback)(
            (e) => {
              if (((h.current = e), A.setFloating(e), typeof p == `function`)) {
                p(e);
                return;
              }
              p && (p.current = e);
        ...
        if (
            ...
            let t = Bt(r),
              n =
                ...
                Lt({
                  ...
                  measureElement: y.current,
                  surfaceElement: v.current,
                });
            if (n !== b) {
              C(n);
              return;
          ...
          (0, H.useEffect)(() => {
            e && ce?.();
          }, [e?.height, e?.left, e?.top, e?.width, r, b, ce]),
          !e)
        )
          return null;
        let fe = (0, U.jsx)(`div`, {
          ...
          style: { position: se, left: oe ?? 0, top: ue ?? 0, width: Wt },
          onMouseDown: (e) => {
            e.stopPropagation();
          },
                      ...
                      children: (0, U.jsx)(`textarea`, {
                        ...
                        onKeyDown: (e) => {
                          ...
                          e.key === `Enter` &&
                            ...
                            (e.preventDefault(),
                            e.stopPropagation(),
                            s(E || e.metaKey || e.ctrlKey ? `saved` : `direct`, `keyboard`));
                        },
                        placeholder: `Describe a change or ask a question`,
                        rows: 1,
                        className: x(Qt, !b && `!overflow-hidden whitespace-nowrap`),
                        style: {
                  ...
                  E
                    ? (0, U.jsxs)(`div`, {
                        ...
                        className: x(
                          rn,
                          `justify-between`,
                          b ? `scale-100 opacity-100` : `pointer-events-none scale-95 opacity-0`,
                        ),
                        children: [
                          (0, U.jsx)(`button`, {
                            type: `button`,
        ...
        return n ? (0, Ut.createPortal)(fe, n) : fe;
      })));
  });
function vn(e, t, n) {
...
var K,
  ...
  Rn = e(() => {
    (ze(), ht(), kt(), wt(), Mt(), It(), _n(), An(), jn(), Mn(), Nn(), Fn(), Ln());
  });
function zn(e) {
...
var q,
  ...
  qn,
  Jn = e(() => {
    ((Kn = t(b())), (qn = typeof window > `u` ? Kn.useEffect : Kn.useLayoutEffect));
  });
function Yn(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
...
function sr({ open: e, onOpenChange: t, trigger: n, children: i }) {
  return (0, X.jsxs)(r, {
    open: e,
    onOpenChange: t,
    children: [
      (0, X.jsx)(h, { asChild: !0, children: n }),
      (0, X.jsx)(T, {
        children: (0, X.jsx)(p, {
          side: `bottom`,
          align: `end`,
          ...
          (0, X.jsxs)(`div`, {
            ...
            children: [
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`div`, {
                    className: x(`text-token-text-primary truncate font-medium`, Z),
                    children: e.author.displayName,
                  }),
                  h
                    ? (0, X.jsxs)(`div`, {
                        className: x(`text-token-description-foreground mt-0.5`, gr),
              ...
              n && !e.isDeleted
                ? (0, X.jsx)(sr, {
                    ...
                    trigger: (0, X.jsx)(`button`, {
                      ...
                      children: (0, X.jsx)(O, { className: `size-4` }),
                    }),
                    children: (0, X.jsxs)(`div`, {
                      ...
                      children: [
                        (0, X.jsxs)(cr, {
                          ...
                          children: [(0, X.jsx)(ae, { className: `size-4` }), `Edit`],
                        }),
                        (0, X.jsxs)(cr, {
                          destructive: !0,
                          onClick: () => {
                          ...
                          children: [(0, X.jsx)(ee, { className: `size-4` }), `Delete`],
                        }),
                      ],
                    }),
                  })
                    ...
                    n
                      ? (0, X.jsx)(sr, {
                          ...
                          trigger: (0, X.jsx)(`button`, {
                            ...
                            children: (0, X.jsx)(k, { className: `size-4` }),
                          }),
                      ...
                      children: [
                        ...
                        d
                          ? (0, X.jsxs)(cr, {
                              ...
                              children: [(0, X.jsx)(ee, { className: `size-4` }), `Delete thread`],
                            })
                          : null,
                      ],
                    }),
...
function pr({ open: e, onOpenChange: t, trigger: n, content: i }) {
  return (0, X.jsxs)(r, {
    open: e,
    onOpenChange: t,
    children: [
...
function Xr(e, t) {
  ...
  return n.length === 0 ? null : n.length === 1 ? (n[0] ?? null) : E(n);
}
function Zr(e, t) {
  if (e === t) return !0;
  if (e.length !== t.length) return !1;
...
function $r(e) {
  ...
  return (
    ...
    t.length === 0 ? e.initialCrdtState : t.length === 1 ? t[0] : E(t)
  );
}
function ei(e) {
  let t = Yr(e.externalCrdtUpdates);
