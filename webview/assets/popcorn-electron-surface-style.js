...
import { Dt as re, Et as k } from "./workbook-1.js";
import {
  $ as ie,
  B as ae,
  F as oe,
...
function be(e) {
  let { children: t, id: n, items: r, strategy: i = Te, disabled: a = !1 } = e,
    { active: o, dragOverlay: s, droppableRects: l, over: u, measureDroppableContainers: d } = c(),
    f = P(Ee, n),
    p = s.rect !== null,
    m = (0, I.useMemo)(() => r.map((e) => (typeof e == `object` && `id` in e ? e.id : e)), [r]),
    h = o != null,
    g = o ? m.indexOf(o.id) : -1,
  ...
  let S = (0, I.useMemo)(
    ...
    [g, f, x.draggable, x.droppable, b, m, _, l, p, i],
  );
  return I.createElement(De.Provider, { value: S }, t);
}
function xe(e) {
  ...
  return (
    N(() => {
      if (!t && n !== c.current && r.current) {
        let e = i.current;
        if (e) {
          let t = a(r.current, { ignoreTransform: !0 }),
            n = {
              x: e.left - t.left,
              y: e.top - t.top,
...
function Se(e) {
  let {
    ...
    S = f.indexOf(c),
    C = (0, I.useMemo)(
      () => ({ sortable: { containerId: p, index: S, items: f }, ...a }),
      [p, a, S, f],
    ),
    w = (0, I.useMemo)(() => f.slice(f.indexOf(c)), [f, c]),
    {
      rect: T,
      node: E,
      isOver: ee,
      ...
      resizeObserverConfig: { updateMeasurementsFor: w, ...u },
    }),
    {
      active: D,
      activatorEvent: O,
      ...
      transform: ce,
    } = i({ id: c, data: C, attributes: { ...Ne, ...n }, disabled: x.draggable }),
    le = fe(te, k),
    A = !!D,
    j = A && !g && ge(m) && ge(v),
    M = !y && ae,
    ue = j
      ? ((M && j ? ce : null) ??
        (l ?? b)({ rects: _, activeNodeRect: ne, activeIndex: m, overIndex: v, index: S }))
      : null,
    N = ge(m) && ge(v) ? s({ id: c, items: f, activeIndex: m, overIndex: v }) : S,
    P = D?.id,
  ...
  return (
    (0, I.useEffect)(() => {
      (A && F.current.newIndex !== N && (F.current.newIndex = N),
  ...
  function ve() {
    if (_e || (me && F.current.newIndex === S)) return Me;
    if (!((M && !pe(O)) || !d) && (A || he)) return de.Transition.toString({ ...d, property: je });
  }
}
function Ce(e, t) {
    ...
    ((I = t(n())),
      ...
      (we = (e) => {
        ...
        if (a === r) {
          let e = t[i];
          return e
            ? { x: r < i ? e.left + e.width - (o.left + o.width) : e.left - o.left, y: 0, ...L }
            : null;
        }
        return a > r && a <= i
          ? { x: -o.width - s, y: 0, ...L }
      ...
      (je = `transform`),
      (Me = de.Transition.toString({ property: je, duration: 0, easing: `linear` })),
...
function rt(e, t) {
  switch (t) {
    ...
    case `top-left`:
      return { fontFamily: z, left: e.left, top: e.top - ft, transform: `translateY(-100%)` };
    case `top-right`:
      return {
        fontFamily: z,
        left: e.left + e.width,
...
function ot({
  ...
  return (0, R.jsx)(`div`, {
    "data-testid": s,
    className: E(`pointer-events-none absolute box-border`),
    style: {
      left: e.left,
      top: e.top,
      width: e.width,
...
function bt({ drawingId: e, screenshot: t, markerViewportPoint: n, viewportSize: r }) {
  return {
...
function Tt({ stroke: e, projectPoint: t }) {
  ...
  if (n.length === 1) {
    let [t] = n;
    return t
      ? (0, B.jsx)(`circle`, { cx: t.x, cy: t.y, r: e.strokeWidth / 2, fill: e.color })
      : null;
  }
  return (0, B.jsx)(`path`, {
    d: ht(n),
    ...
    : (0, B.jsxs)(`svg`, {
        ...
        children: [
          ...
          (0, B.jsx)(`g`, {
            ...
            children: e.map((e, n) =>
              (0, B.jsx)(Tt, { stroke: e, projectPoint: t }, `${n}-${e.points.length}`),
            ),
          }),
        ],
      });
...
function Mt({
  ...
  return (0, V.jsx)(`button`, {
    ...
    style: e
      ? { backgroundColor: f, color: `var(--color-token-text-link-foreground, #339cff)` }
      : void 0,
    onClick: () => {
      (l(!e), n());
    },
    ...
    children: (0, V.jsxs)(`span`, {
      className: E(`flex min-w-0 items-center`, e ? `justify-start` : `w-full justify-center`),
      children: [
        a({
          className: E(
...
function Nt({ active: e, disabled: t = !1, onClick: n, testId: r = `popcorn-annotation-button` }) {
  return (0, V.jsx)(Mt, {
    active: e,
...
function Pt({ active: e, disabled: t = !1, onClick: n, testId: r = `popcorn-drawing-button` }) {
  return (0, V.jsx)(Mt, {
    active: e,
    disabled: t,
    onClick: n,
...
function Lt({ text: e, hasMultipleBlocks: t, measureElement: n, surfaceElement: r }) {
  let i = e.trim();
...
function Rt(e) {
  ...
  let n = e.querySelector(`[data-browser-comment-submit]`)?.getBoundingClientRect().width ?? on;
...
var H,
  ...
  _n = e(() => {
    (w(),
      ...
      ($t = { "--codex-chat-font-size": `13px`, fontSize: `var(--codex-chat-font-size, 13px)` }),
      ...
      (gn = (0, H.forwardRef)(function (
        ...
        let d = (0, H.useRef)(null),
          ...
          ),
          {
            ...
            middleware: [
              h(Kt + qt),
              p({ fallbackPlacements: [`left-start`], padding: Gt, ...(D ? { boundary: D } : {}) }),
              x({ padding: Gt, ...(D ? { boundary: D } : {}) }),
              ne({
                padding: Gt,
                ...(D ? { boundary: D } : {}),
        ...
        if (
            ...
            let t = Bt(r),
              n =
                ...
                Lt({
                  ...
                  measureElement: _.current,
                  surfaceElement: g.current,
                });
            if (n !== v) {
              y(n);
              return;
          ...
          (0, H.useEffect)(() => {
            e && A?.();
          }, [e?.height, e?.left, e?.top, e?.width, r, v, A]),
          !e)
        )
          return null;
        let N = (0, U.jsx)(`div`, {
          ...
          style: { position: le, left: ae ?? 0, top: M ?? 0, width: Wt },
          onMouseDown: (e) => {
            e.stopPropagation();
          },
          children: (0, U.jsx)(`form`, {
            ...
            style: $t,
            onSubmit: (e) => {
              (e.preventDefault(), T && o(w ? `saved` : `direct`, `button`));
            },
              ...
              children: (0, U.jsxs)(`div`, {
                ...
                children: [
                      ...
                      children: (0, U.jsx)(`textarea`, {
                        ...
                        onKeyDown: (e) => {
                          ...
                          e.key === `Enter` &&
                            ...
                            (e.preventDefault(),
                            e.stopPropagation(),
                            o(w || e.metaKey || e.ctrlKey ? `saved` : `direct`, `keyboard`));
                        },
                        placeholder: `Describe a change or ask a question`,
                        rows: 1,
                        className: E(Qt, !v && `!overflow-hidden whitespace-nowrap`),
                        style: {
                  ...
                  (0, U.jsx)(`span`, {
                    ...
                    "aria-hidden": `true`,
                    className: an,
                    style: { fontSize: `var(--codex-chat-font-size, 13px)`, lineHeight: `${Xt}px` },
                    children: r,
                  }),
                  w
                    ? (0, U.jsxs)(`div`, {
                        ...
                        className: E(
                          rn,
                          `justify-between`,
                          v ? `scale-100 opacity-100` : `pointer-events-none scale-95 opacity-0`,
                        ),
                        children: [
                          (0, U.jsx)(`button`, {
                            type: `button`,
                            ...
                            onClick: c,
                            children: (0, U.jsx)(ie, { className: `size-4` }),
                          }),
                          (0, U.jsxs)(`div`, {
                  ...
                  w
                    ...
                    : (0, U.jsx)(`div`, {
                        ...
                        children: (0, U.jsx)(`button`, {
                          ...
                          onClick: () => {
                            T && o(b ? `saved` : `direct`, `button`);
                          },
                          children: te
                            ? (0, U.jsx)(ce, { className: `size-4` })
                            : (0, U.jsx)(oe, { className: `size-4` }),
                        }),
                      }),
                ],
              }),
...
function yn(e) {
  let t = Math.min(wn, Math.max(1, e.containerWidth - W * 2)),
    ...
    r = En / 2 + Tn,
    i = vn(e.markerPoint.left - n / 2, W, Math.max(W, e.containerWidth - n - W)),
  ...
  return o + Cn <= e.containerHeight - W
    ...
    : { left: i, top: vn(a, W, Math.max(W, e.containerHeight - Cn - W)), maxWidth: t };
}
function bn({
  body: e,
  markerPosition: t,
...
var K,
  ...
  Rn = e(() => {
    (Le(), mt(), Ot(), Ct(), jt(), It(), _n(), An(), jn(), Mn(), Nn(), Fn(), Ln());
  });
function zn(e) {
    ...
    children: [
      ...
      (0, q.jsx)(d, {
        children: (0, q.jsx)(v, {
          ...
          children: t.map((e) => {
            if (e.kind === `separator`)
              return (0, q.jsx)(g, { className: `bg-token-border-light my-1 h-px` }, e.id);
            let t = e.icon;
            return (0, q.jsxs)(
              te,
              {
...
var q,
  ...
  qn,
  Jn = e(() => {
    ((Kn = t(n())), (qn = typeof window > `u` ? Kn.useEffect : Kn.useLayoutEffect));
  });
function Yn(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
...
function sr({ open: e, onOpenChange: t, trigger: n, children: r }) {
  return (0, X.jsxs)(u, {
    ...
    onOpenChange: t,
    children: [
      (0, X.jsx)(T, { asChild: !0, children: n }),
      (0, X.jsx)(b, {
        children: (0, X.jsx)(C, {
          side: `bottom`,
          align: `end`,
...
function lr({ label: e, active: t, count: n, onClick: r, interactive: i }) {
  ...
  return !i || !r
    ...
    : (0, X.jsx)(`button`, { type: `button`, className: a, onClick: r, children: `${e} ${n}` });
}
...
function dr({
  ...
  let [d, f] = (0, Y.useState)(!1),
    [p, m] = (0, Y.useState)(!1),
    h = (0, Y.useMemo)(() => ar(e.editedAt ?? e.createdAt), [e.createdAt, e.editedAt]),
    g = i.trim(),
          ...
          (0, X.jsxs)(`div`, {
            ...
            children: [
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`div`, {
                    className: E(`text-token-text-primary truncate font-medium`, Z),
                    children: e.author.displayName,
                  }),
                  h
                    ? (0, X.jsxs)(`div`, {
                        className: E(`text-token-description-foreground mt-0.5`, gr),
              ...
              n && !e.isDeleted
                ? (0, X.jsx)(sr, {
                    ...
                    trigger: (0, X.jsx)(`button`, {
                      ...
                      children: (0, X.jsx)(le, { className: `size-4` }),
                    }),
                    children: (0, X.jsxs)(`div`, {
                      ...
                      children: [
                        (0, X.jsxs)(cr, {
                          ...
                          children: [(0, X.jsx)(j, { className: `size-4` }), `Edit`],
                        }),
                        (0, X.jsxs)(cr, {
                          destructive: !0,
                          onClick: () => {
                          ...
                          children: [(0, X.jsx)(ie, { className: `size-4` }), `Delete`],
                        }),
                      ],
                    }),
                  })
            ...
            ? (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`textarea`, {
                    ...
                    onKeyDown: (e) => {
                      e.key !== `Enter` || e.shiftKey || (e.preventDefault(), g && s());
                    },
                  }),
                  (0, X.jsxs)(`div`, {
                    ...
                    n
                      ? (0, X.jsx)(sr, {
                          ...
                          trigger: (0, X.jsx)(`button`, {
                            ...
                            children: (0, X.jsx)(A, { className: `size-4` }),
                          }),
        ...
        children: [
          (0, X.jsxs)(`div`, {
            ...
            children: [
              ...
              T
                ? (0, X.jsx)(`div`, {
                    className: E(`text-token-description-foreground mt-1`, gr),
                    children: T,
                  })
                : null,
            ],
                      ...
                      children: [
                        ...
                        d
                          ? (0, X.jsxs)(cr, {
                              ...
                              children: [(0, X.jsx)(ie, { className: `size-4` }), `Delete thread`],
                            })
                          : null,
                      ],
                    }),
...
var Y,
  ...
  _r = e(() => {
    (w(),
      ...
      M(),
      (X = r()),
      (mr = new Intl.DateTimeFormat(void 0, { dateStyle: `medium`, timeStyle: `short` })),
      (hr = [`👍`, `❤️`, `👀`, `✅`]),
      ...
      (qr = class {
        ...
        #n = (e) => {
          ...
          if (e.ctrlKey) {
            ...
            let s = this.#i.screenToWorldPoint?.(this.#p, r.x, r.y) ?? J(this.#p, r.x, r.y);
        ...
        zoomTo(e, t) {
          ...
          this.setCamera(Zn(this.#p, r, i, e, this.#i.minZoom, this.#i.maxZoom), {
            settled: t?.settled,
          });
        }
        panByScroll(e, t) {
        ...
        #y(e) {
          return this.#i.clampCamera
            ? this.#i.clampCamera({ ...e, k: Yn(e.k, this.#i.minZoom, this.#i.maxZoom) })
            : Qn(
...
function Xr(e, t) {
  ...
  return n.length === 0 ? null : n.length === 1 ? (n[0] ?? null) : re(n);
}
function Zr(e, t) {
  if (e === t) return !0;
  if (e.length !== t.length) return !1;
...
function $r(e) {
  ...
  return (
    ...
    t.length === 0 ? e.initialCrdtState : t.length === 1 ? t[0] : re(t)
  );
}
function ei(e) {
  let t = Yr(e.externalCrdtUpdates);
  return {
    initialCrdtState: $r({ initialCrdtState: e.initialCrdtState, externalCrdtUpdates: t }),
...
function ii({ artifactLabel: e, controller: t, externalCrdtUpdates: n, onCrdtUpdate: r }) {
  let i = (0, Q.useRef)(0),
    a = (0, Q.useRef)(n ?? []),
      ...
      return (
        (async () => {
          ...
          try {
            ...
            if (r) return;
            s({ kind: `failed`, artifactLabel: e, errorMessage: ni(t, e), pendingUpdateCount: a });
          }
        })(),
        () => {
          r = !0;
