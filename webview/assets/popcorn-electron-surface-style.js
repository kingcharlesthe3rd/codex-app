...
function ye(e) {
  let { children: t, id: n, items: r, strategy: i = Te, disabled: a = !1 } = e,
    { active: o, dragOverlay: s, droppableRects: c, over: l, measureDroppableContainers: u } = b(),
    d = w(Ee, n),
    f = s.rect !== null,
  ...
  let S = (0, L.useMemo)(
    ...
    [h, d, x.draggable, x.droppable, y, p, g, c, f, i],
  );
  return L.createElement(De.Provider, { value: S }, t);
}
function be(e) {
...
function xe(e) {
  let {
    ...
    x = u.indexOf(o),
    S = (0, L.useMemo)(
      () => ({ sortable: { containerId: d, index: x, items: u }, ...i }),
      [d, i, x, u],
    ),
    w = (0, L.useMemo)(() => u.slice(u.indexOf(o)), [u, o]),
    {
      rect: T,
      node: D,
      isOver: ee,
    ...
    }),
    {
      ...
      transform: ce,
    } = y({ id: o, data: S, attributes: { ...Ne, ...n }, disabled: b.draggable }),
    le = ne(te, ie),
    N = !!O,
    ue = N && !m && he(f) && he(g),
    de = !_ && M,
    fe = ue
      ? ((de && ue ? ce : null) ??
        (s ?? v)({ rects: h, activeNodeRect: A, activeIndex: f, overIndex: g, index: x }))
      : null,
    P = he(f) && he(g) ? a({ id: o, items: u, activeIndex: f, overIndex: g }) : x,
    F = O?.id,
    ...
    ge = be({ disabled: !me, index: x, node: D, rect: T });
  return (
    (0, L.useEffect)(() => {
  ...
  function _e() {
    if (ge || (pe && I.current.newIndex === x)) return Me;
    if (!((de && !C(k)) || !l) && (N || me)) return re.Transition.toString({ ...l, property: je });
  }
}
function Se(e, t) {
...
var L,
  ...
  Pe = e(() => {
    ((L = t(v())),
      ...
      (je = `transform`),
      (Me = re.Transition.toString({ property: je, duration: 0, easing: `linear` })),
...
function ot({
  ...
  return (0, R.jsx)(`div`, {
    "data-testid": s,
    className: _(`pointer-events-none absolute box-border`),
    style: {
      left: e.left,
      top: e.top,
      width: e.width,
...
function Mt({
  ...
  return (0, V.jsx)(`button`, {
    ...
    children: (0, V.jsxs)(`span`, {
      className: _(`flex min-w-0 items-center`, e ? `justify-start` : `w-full justify-center`),
      children: [
        a({
          className: _(
      ...
      (gn = (0, H.forwardRef)(function (
        ...
        let v = (0, H.useRef)(null),
          ...
          ),
          {
            ...
            middleware: [
              i(Kt + qt),
              a({ fallbackPlacements: [`left-start`], padding: Gt, ...(O ? { boundary: O } : {}) }),
              d({ padding: Gt, ...(O ? { boundary: O } : {}) }),
              u({
                padding: Gt,
                ...(O ? { boundary: O } : {}),
          ...
          ce = (0, H.useCallback)(
            (e) => {
              if (((v.current = e), A.setFloating(e), typeof g == `function`)) {
                g(e);
                return;
              }
              g && (g.current = e);
        ...
        if (
          ...
          (0, H.useEffect)(() => {
            e && ae?.();
          }, [e?.height, e?.left, e?.top, e?.width, r, S, ae]),
          !e)
        )
          return null;
        let N = (0, U.jsx)(`div`, {
          ...
          children: (0, U.jsx)(`form`, {
            ...
            style: $t,
            onSubmit: (e) => {
              (e.preventDefault(), D && l(E ? `saved` : `direct`, `button`));
            },
                      ...
                      children: (0, U.jsx)(`textarea`, {
                        ...
                        onKeyDown: (e) => {
                          ...
                          e.key === `Enter` &&
                            ...
                            (e.preventDefault(),
                            e.stopPropagation(),
                            l(E || e.metaKey || e.ctrlKey ? `saved` : `direct`, `keyboard`));
                        },
                        placeholder: `Describe a change or ask a question`,
                        rows: 1,
                        className: _(Qt, !S && `!overflow-hidden whitespace-nowrap`),
                        style: {
                  ...
                  E
                    ? (0, U.jsxs)(`div`, {
                        ...
                        className: _(
                          rn,
                          `justify-between`,
                          S ? `scale-100 opacity-100` : `pointer-events-none scale-95 opacity-0`,
                        ),
                        children: [
                          (0, U.jsx)(`button`, {
                            type: `button`,
...
function Wn({ trigger: e, actions: t }) {
  return (0, q.jsxs)(D, {
    children: [
      (0, q.jsx)(k, { asChild: !0, children: e }),
      (0, q.jsx)(T, {
        children: (0, q.jsx)(O, {
...
var q,
  ...
  qn,
  Jn = e(() => {
    ((Kn = t(v())), (qn = typeof window > `u` ? Kn.useEffect : Kn.useLayoutEffect));
  });
function Yn(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
...
function sr({ open: e, onOpenChange: t, trigger: i, children: a }) {
  return (0, X.jsxs)(n, {
    open: e,
    onOpenChange: t,
    children: [
      (0, X.jsx)(o, { asChild: !0, children: i }),
      (0, X.jsx)(r, {
        children: (0, X.jsx)(c, {
          side: `bottom`,
          align: `end`,
          ...
          (0, X.jsxs)(`div`, {
            ...
            children: [
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`div`, {
                    className: _(`text-token-text-primary truncate font-medium`, Z),
                    children: e.author.displayName,
                  }),
                  h
                    ? (0, X.jsxs)(`div`, {
                        className: _(`text-token-description-foreground mt-0.5`, gr),
        ...
        children: [
          (0, X.jsxs)(`div`, {
            ...
            children: [
              ...
              E
                ? (0, X.jsx)(`div`, {
                    className: _(`text-token-description-foreground mt-1`, gr),
                    children: E,
                  })
                : null,
            ],
...
function pr({ open: e, onOpenChange: t, trigger: i, content: a }) {
  return (0, X.jsxs)(n, {
    open: e,
    onOpenChange: t,
    children: [
