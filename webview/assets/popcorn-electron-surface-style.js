...
import { a, c as o, l as s, n as c, o as l, s as u } from "./floating-ui.react-dom.js";
import { a as d, i as f, n as p, o as m, r as h, u as g } from "./dist-2.js";
import { q as _ } from "./workbook-1.js";
import {
  B as v,
  D as y,
  F as b,
...
import { a as D, i as O, n as k, r as A } from "./dist-10.js";
import {
  _ as ee,
  c as te,
  g as j,
...
var B = { scaleX: 1, scaleY: 1 },
  se = (e) => {
    ...
    if (a === r) {
      let e = t[i];
      return e
        ? { x: r < i ? e.left + e.width - (o.left + o.width) : e.left - o.left, y: 0, ...B }
        : null;
    }
    return a > r && a <= i
      ? { x: -o.width - s, y: 0, ...B }
...
function le(e) {
  let { children: t, id: n, items: r, strategy: i = H, disabled: a = !1 } = e,
    { active: o, dragOverlay: s, droppableRects: c, over: l, measureDroppableContainers: u } = te(),
    d = ee(U, n),
    f = s.rect !== null,
    p = (0, I.useMemo)(() => r.map((e) => (typeof e == `object` && `id` in e ? e.id : e)), [r]),
    m = o != null,
  ...
  return I.createElement(ce.Provider, { value: x }, t);
}
var ue = (e) => {
  ...
  fe = { duration: 200, easing: `ease` },
  pe = `transform`,
  me = P.Transition.toString({ property: pe, duration: 0, easing: `linear` }),
  he = { roleDescription: `sortable` };
function ge(e) {
  ...
  return (
    j(() => {
      if (!t && n !== s.current && r.current) {
        let e = i.current;
        if (e) {
          let t = re(r.current, { ignoreTransform: !0 }),
            n = {
              x: e.left - t.left,
              y: e.top - t.top,
...
function _e(e) {
  let {
    ...
    }),
    {
      ...
      transform: L,
    } = ne({ id: o, data: x, attributes: { ...he, ...n }, disabled: y.draggable }),
    ae = M(E, ee),
    z = !!D,
    oe = z && !m && R(f) && R(g),
    B = !_ && j,
    se = oe
      ...
      : null,
    V = R(f) && R(g) ? a({ id: o, items: u, activeIndex: f, overIndex: g }) : b,
    H = D?.id,
    U = (0, I.useRef)({ activeId: H, items: u, newIndex: V, containerId: d }),
    le = u !== U.current.items,
    _e = t({
      active: D,
      containerId: d,
      isDragging: j,
    ...
    W = ge({ disabled: !_e, index: b, node: w, rect: C });
  return (
    (0, I.useEffect)(() => {
      (z && U.current.newIndex !== V && (U.current.newIndex = V),
        d !== U.current.containerId && (U.current.containerId = d),
        u !== U.current.items && (U.current.items = u));
    }, [z, V, d, u]),
    (0, I.useEffect)(() => {
      if (H === U.current.activeId) return;
      if (H != null && U.current.activeId == null) {
        U.current.activeId = H;
        return;
      }
      let e = setTimeout(() => {
        U.current.activeId = H;
  ...
  function ye() {
    if (W || (le && U.current.newIndex === b)) return me;
    if (!((B && !N(O)) || !l) && (z || _e)) return P.Transition.toString({ ...l, property: pe });
  }
}
function ve(e, t) {
...
var be = 0.18,
  ...
  we = `rgb(${xe}, ${Se}, ${Ce})`,
  Te = `rgba(${xe}, ${Se}, ${Ce}, ${be})`,
  Ee = `var(--color-token-text-link-foreground, #339cff)`,
  De = `var(--color-token-interactive-bg-accent-muted-context, rgba(51, 156, 255, 0.18))`;
function Oe(e) {
  let t = e?.ownerDocument.defaultView;
  if (!e || !t) return we;
  let n = t.getComputedStyle(e);
  return Me(n, `--color-text-accent`) ?? Me(n, `--color-accent-blue`) ?? we;
}
function ke(e) {
  let t = Ne(e);
...
function Ae(e) {
  let t = Ne(e);
  return t ? `rgba(${t.r}, ${t.g}, ${t.b}, ${be})` : Te;
}
function je(e) {
...
function Ne(e) {
  ...
  let n = /^rgba?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)/i.exec(t);
  if (!n) return null;
  let r = n[1],
    i = n[2],
    a = n[3];
  return r == null || i == null || a == null ? null : { r: Number(r), g: Number(i), b: Number(a) };
}
function Pe(e) {
  if (e.length === 4) {
    let t = e[1],
...
var G = n(),
  Fe = `M12.6504 0.824799C6.21496 0.824799 0.825466 5.77554 0.825195 12.0885C0.825245 14.2375 1.46183 16.2421 2.55176 17.943L2.02148 20.235L1.99316 20.3756C1.77603 21.655 2.78945 22.7791 4.02832 22.7691L4.0791 22.8209L4.53418 22.7047L7.12305 22.0426C8.77593 22.8778 10.6577 23.3531 12.6504 23.3531C19.086 23.3531 24.4754 18.4014 24.4756 12.0885C24.4753 5.77554 19.0858 0.824799 12.6504 0.824799Z`,
  Ie = `<svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="${Fe}" fill="#0285FF" stroke="white" stroke-width="1.65"/></svg>`,
  K = `-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro", "Segoe UI", sans-serif`,
  Le = `data:image/svg+xml,${encodeURIComponent(Ie)}`;
`${Le}`;
var Re = `url("${Le}") 13 12, crosshair`,
  q = 6,
  ze = { color: `white` };
function Be(e) {
...
function Ve({
  ...
  let f = s != null || c != null || l != null || u != null || d != null,
    ...
    m = {
      ...
      width: 26,
      height: 26,
      transform: r ? `translate(-50%, -50%) scale(1.08)` : `translate(-50%, -50%)`,
    },
    h =
      e == null
        ? null
...
function Ue(e, t) {
  switch (t) {
    case `bottom-left`:
      return { fontFamily: K, left: e.left, top: e.top + e.height + q };
    case `bottom-right`:
      return {
        fontFamily: K,
        left: e.left + e.width,
        top: e.top + e.height + q,
        transform: `translateX(-100%)`,
      };
    case `top-left`:
      return { fontFamily: K, left: e.left, top: e.top - q, transform: `translateY(-100%)` };
    case `top-right`:
      return {
        fontFamily: K,
        left: e.left + e.width,
...
function Je(e) {
  ...
  return t
    ? e.length === 1
      ? `M ${t.x} ${t.y}`
      : e.reduce((e, t, n) => `${e}${n === 0 ? `` : ` `}${n === 0 ? `M` : `L`} ${t.x} ${t.y}`, ``)
    : ``;
}
function Ye(e) {
  let t = e[0];
...
function Xe(e) {
  return Ye(e.flatMap((e) => e.points));
}
function Ze(e, { paddingPx: t = 24, minSizePx: n = 96 } = {}) {
  let r = e.width + t * 2,
    i = e.height + t * 2,
    a = Math.max(n, r),
    o = Math.max(n, i);
  return { left: e.left - (a - e.width) / 2, top: e.top - (o - e.height) / 2, width: a, height: o };
}
function Qe(e, t) {
...
function $e({ drawingId: e, screenshot: t, markerViewportPoint: n, viewportSize: r }) {
  return {
...
async function et({
  ...
  if (typeof OffscreenCanvas > `u` || typeof OffscreenCanvas.prototype.convertToBlob != `function`)
    throw Error(`Popcorn drawing screenshot export requires OffscreenCanvas support.`);
  ...
  return { blob: await d.convertToBlob({ type: o }), width: l, height: u, mimeType: o };
}
function tt(e, t) {
  return e.points.map((e) => t(e)).filter((e) => e != null);
}
function nt({ stroke: e, projectPoint: t }) {
  let n = tt(e, t);
  if (n.length === 0) return null;
  if (n.length === 1) {
    let [t] = n;
    return t
      ? (0, G.jsx)(`circle`, { cx: t.x, cy: t.y, r: e.strokeWidth / 2, fill: e.color })
      : null;
  }
  return (0, G.jsx)(`path`, {
    d: Je(n),
...
function rt({ strokes: e, projectPoint: t, testId: n, clipBounds: r }) {
  let i = `popcorn-drawing-overlay-${(0, I.useId)().replace(/[:]/g, ``)}`;
  return e.length === 0
    ? null
    : (0, G.jsxs)(`svg`, {
        "data-testid": n,
        ...
        children: [
          ...
          (0, G.jsx)(`g`, {
            ...
            children: e.map((e, n) =>
              (0, G.jsx)(nt, { stroke: e, projectPoint: t }, `${n}-${e.points.length}`),
            ),
          }),
        ],
      });
...
var it = 0;
function at(e) {
  return ((it += 1), `${e}-${Date.now().toString(36)}-${it.toString(36)}`);
}
function ot({
  active: e,
  disabled: t = !1,
  ...
  (0, I.useEffect)(() => {
    ...
    (u(!1), f(!1));
    let t = c.current;
    typeof document < `u` && t != null && t === document.activeElement && t.blur();
  }, [e]);
  ...
  return (0, G.jsx)(`button`, {
    ...
    style: e
      ? { backgroundColor: p, color: `var(--color-token-text-link-foreground, #339cff)` }
      : void 0,
    onClick: () => {
      (u(!e), n());
    },
    ...
    children: (0, G.jsxs)(`span`, {
      className: i(`flex min-w-0 items-center`, e ? `justify-start` : `w-full justify-center`),
      children: [
        o({
          className: i(
...
function st({ active: e, disabled: t = !1, onClick: n, testId: r = `popcorn-annotation-button` }) {
  return (0, G.jsx)(ot, {
    active: e,
...
function ct({ active: e, disabled: t = !1, onClick: n, testId: r = `popcorn-drawing-button` }) {
  return (0, G.jsx)(ot, {
    active: e,
    disabled: t,
    onClick: n,
...
var lt = e(r()),
  ...
  _t = { "--codex-chat-font-size": `13px`, fontSize: `var(--codex-chat-font-size, 13px)` },
  vt = `pointer-events-none absolute inset-x-0 top-0 flex flex-col overflow-visible bg-transparent`,
  yt = `pointer-events-auto relative w-full overflow-hidden rounded-[22px] bg-token-dropdown-background shadow-md ring-1 ring-token-border-light transition-[height] duration-150 ease-out motion-reduce:transition-none [background-color:var(--color-token-dropdown-background,var(--color-token-main-surface-primary,white))]`,
  bt = `absolute left-4 min-w-0 overflow-hidden transition-[width,top,bottom] duration-150 ease-out motion-reduce:transition-none`,
  xt = `absolute right-3 bottom-2 left-2 flex origin-bottom-left items-center transition-[opacity,transform] duration-150 ease-out motion-reduce:transition-none`,
  St = `pointer-events-none absolute top-0 left-0 whitespace-pre text-[length:var(--codex-chat-font-size,13px)] leading-5 font-sans opacity-0`,
  Ct = 28,
  wt = 8,
  Tt = 16,
  Et = 8,
  Dt = 40,
  Ot = 12,
  kt = `browser-comment-popup-shake`,
  At = `popcorn-annotation-editor-shake-style`,
  jt = `
  ...
  Nt = (0, I.forwardRef)(function (
    ...
    let y = (0, I.useRef)(null),
      ...
      ),
      {
        ...
        middleware: [
          a(ft + pt),
          c({ fallbackPlacements: [`left-start`], padding: dt, ...(j ? { boundary: j } : {}) }),
          l({ padding: dt, ...(j ? { boundary: j } : {}) }),
          u({
            padding: dt,
            ...(j ? { boundary: j } : {}),
      ...
      L = C ? mt : J,
      ae = P == null ? void 0 : P + (mt - L) / 2 + pt,
      R = (0, I.useCallback)(
        (e) => {
          if (((y.current = e), N.setFloating(e), typeof _ == `function`)) {
            _(e);
            return;
          }
          _ && (_.current = e);
    ...
    if (
      ...
      (0, I.useLayoutEffect)(() => {
        ...
        let t = Lt(r),
          n =
            ...
            Pt({
              ...
              measureElement: S.current,
              surfaceElement: x.current,
            });
        if (n !== C) {
          E(n);
          return;
        ...
        if (n) {
          ((e.style.height = `0px`),
            (e.style.height = `${Math.min(Math.max(e.scrollHeight, t * Y), ht)}px`));
          return;
        }
        e.style.height = `${Y}px`;
      }, [k, C, r]),
      ...
      (0, I.useEffect)(() => {
        e && ie?.();
      }, [e?.height, e?.left, e?.top, e?.width, r, C, ie]),
      !e)
    )
      return null;
    let z = (0, G.jsx)(`div`, {
      ...
      style: { position: F, left: re ?? 0, top: ae ?? 0, width: ut },
      onMouseDown: (e) => {
        e.stopPropagation();
      },
      children: (0, G.jsx)(`form`, {
        ...
        style: _t,
        onSubmit: (e) => {
          (e.preventDefault(), A && p(k ? `saved` : `direct`, `button`));
        },
          ...
          children: (0, G.jsxs)(`div`, {
            ...
            children: [
              (0, G.jsx)(`div`, {
                className: i(
                  bt,
                  ee ? `top-2 bottom-11 w-[calc(100%-32px)]` : `top-2 bottom-2 w-[calc(100%-60px)]`,
                ),
                children: (0, G.jsx)(`div`, {
                  ...
                  children: (0, G.jsx)(`textarea`, {
                    ...
                    onKeyDown: (e) => {
                      ...
                      e.key === `Enter` &&
                        ...
                        (e.preventDefault(),
                        e.stopPropagation(),
                        p(k || e.metaKey || e.ctrlKey ? `saved` : `direct`, `keyboard`));
                    },
                    placeholder: `Describe a change or ask a question`,
                    rows: 1,
                    className: i(gt, !C && `!overflow-hidden whitespace-nowrap`),
                    style: {
              ...
              (0, G.jsx)(`span`, {
                ...
                "aria-hidden": `true`,
                className: St,
                style: { fontSize: `var(--codex-chat-font-size, 13px)`, lineHeight: `${Y}px` },
                children: r,
              }),
              k
                ? (0, G.jsxs)(`div`, {
                    ...
                    className: i(
                      xt,
                      `justify-between`,
                      C ? `scale-100 opacity-100` : `pointer-events-none scale-95 opacity-0`,
                    ),
                    children: [
                      (0, G.jsx)(`button`, {
                        type: `button`,
                        ...
                        onClick: h,
                        children: (0, G.jsx)(v, { className: `size-4` }),
                      }),
                      (0, G.jsxs)(`div`, {
              ...
              k
                ...
                : (0, G.jsx)(`div`, {
                    ...
                    children: (0, G.jsx)(`button`, {
                      ...
                      onClick: () => {
                        A && p(D ? `saved` : `direct`, `button`);
                      },
                      children: te
                        ? (0, G.jsx)(T, { className: `size-4` })
                        : (0, G.jsx)(w, { className: `size-4` }),
                    }),
                  }),
            ],
          }),
    ...
    return n ? (0, lt.createPortal)(z, n) : z;
  });
function Pt({ text: e, hasMultipleBlocks: t, measureElement: n, surfaceElement: r }) {
  let i = e.trim();
  if (i.length === 0) return !1;
  if (t) return !0;
  let a = Ft(r),
    o = It(e, n);
  return a == null || o == null ? i.length >= Dt : o + Ot > a;
}
function Ft(e) {
  if (e == null) return null;
  let t = e.getBoundingClientRect();
  if (t.width === 0) return null;
  let n = e.querySelector(`[data-browser-comment-submit]`)?.getBoundingClientRect().width ?? Ct;
  return t.width - Tt - Et - n - wt;
}
function It(e, t) {
...
function Rt(e) {
  ...
  let i = n.requestAnimationFrame(() => {
    (Mt.delete(e), e.classList.add(kt));
  });
  Mt.set(e, i);
}
function zt(e) {
  if (e.getElementById(At) != null) return;
  let t = e.createElement(`style`);
  ((t.id = At), (t.textContent = jt), e.head.appendChild(t));
}
var Bt = 32,
  Vt = 294,
  X = 16,
  Ht = 12,
  Ut = 26,
  Wt = `var(--color-token-dropdown-background, var(--color-token-main-surface-primary, white))`,
  Gt = `var(--color-token-foreground, var(--color-token-text-primary, rgb(38, 38, 38)))`,
  Kt = `var(--color-token-border-default, var(--color-token-border-light, rgba(13, 13, 13, 0.08)))`;
function qt(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
function Jt(e) {
  let t = Math.min(Vt, Math.max(1, e.containerWidth - X * 2)),
    n = Math.min(e.previewWidth && e.previewWidth > 0 ? e.previewWidth : t, t),
    r = Ut / 2 + Ht,
    i = qt(e.markerPoint.left - n / 2, X, Math.max(X, e.containerWidth - n - X)),
    a = e.markerPoint.top - r - Bt;
  if (a >= X) return { left: i, top: a, maxWidth: t };
  let o = e.markerPoint.top + r;
  return o + Bt <= e.containerHeight - X
    ? { left: i, top: o, maxWidth: t }
    : { left: i, top: qt(a, X, Math.max(X, e.containerHeight - Bt - X)), maxWidth: t };
}
function Yt({
  body: e,
  markerPosition: t,
...
function Zt(e) {
  ...
  return (
    ...
    { drawings: t, addPendingDrawing: a, dismissDrawing: r, dismissAllDrawings: i }
  );
}
var Qt = {
    "--text-base": `13px`,
...
function nn({ trigger: e, actions: t }) {
  return (0, G.jsxs)(d, {
    children: [
      (0, G.jsx)(g, { asChild: !0, children: e }),
      (0, G.jsx)(f, {
        children: (0, G.jsx)(p, {
          className: `border-token-border-light bg-token-bg-primary z-50 min-w-[160px] rounded-xl border p-1 shadow-lg`,
          children: t.map((e) => {
            if (e.kind === `separator`)
              return (0, G.jsx)(m, { className: `bg-token-border-light my-1 h-px` }, e.id);
            let t = e.icon;
            return (0, G.jsxs)(
              h,
              {
...
var rn = typeof window > `u` ? I.useEffect : I.useLayoutEffect,
  an = 1;
function on(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
...
function ln(e, t, n) {
  ...
  return { ...e, x: Math.min(0, Math.max(s, e.x)), y: Math.min(0, Math.max(c, e.y)) };
}
function un(e) {
...
function pn(e) {
  ...
  return {
    centerX: (n.x + r.x) / 2,
    centerY: (n.y + r.y) / 2,
    distance: Math.max(an, Math.hypot(i, a)),
  };
}
var mn = new Intl.DateTimeFormat(void 0, { dateStyle: `medium`, timeStyle: `short` }),
  hn = [`👍`, `❤️`, `👀`, `✅`],
  Q = `text-[length:var(--codex-chat-font-size,13px)] leading-5`,
  gn = `text-[11px] leading-4`;
function _n(e) {
  if (!e) return ``;
  let t = new Date(e);
  return Number.isNaN(t.getTime()) ? `` : mn.format(t);
}
function vn(e) {
  switch (e) {
    case `resolved`:
...
function yn({ open: e, onOpenChange: t, trigger: n, children: r }) {
  return (0, G.jsxs)(O, {
    open: e,
    onOpenChange: t,
    children: [
      (0, G.jsx)(D, { asChild: !0, children: n }),
      (0, G.jsx)(A, {
        children: (0, G.jsx)(k, {
          side: `bottom`,
          align: `end`,
...
function bn({ label: e, active: t, count: n, onClick: r, interactive: a }) {
  let o = i(
  ...
  return !a || !r
    ? (0, G.jsx)(`span`, { className: o, children: `${e} ${n}` })
    : (0, G.jsx)(`button`, { type: `button`, className: o, onClick: r, children: `${e} ${n}` });
}
function xn({ value: e, onChange: t, onSubmit: n }) {
  let r = e.trim();
  return (0, G.jsxs)(`div`, {
...
function Sn({
  ...
  let [f, p] = (0, I.useState)(!1),
    [m, h] = (0, I.useState)(!1),
    g = (0, I.useMemo)(() => _n(e.editedAt ?? e.createdAt), [e.createdAt, e.editedAt]),
    _ = a.trim(),
    y = (e) => t != null && e.includes(t);
  return (0, G.jsxs)(`div`, {
          ...
          (0, G.jsxs)(`div`, {
            ...
            children: [
              (0, G.jsxs)(`div`, {
                ...
                children: [
                  (0, G.jsx)(`div`, {
                    className: i(`text-token-text-primary truncate font-medium`, Q),
                    children: e.author.displayName,
                  }),
                  g
                    ? (0, G.jsxs)(`div`, {
                        className: i(`text-token-description-foreground mt-0.5`, gn),
                    ...
                    children: (0, G.jsxs)(`div`, {
                      ...
                      children: [
                        (0, G.jsxs)($, {
                          ...
                          children: [(0, G.jsx)(x, { className: `size-4` }), `Edit`],
                        }),
                        (0, G.jsxs)($, {
                          destructive: !0,
                          onClick: () => {
                          ...
                          children: [(0, G.jsx)(v, { className: `size-4` }), `Delete`],
                        }),
                      ],
                    }),
                  })
            ...
            ? (0, G.jsxs)(`div`, {
                ...
                children: [
                  (0, G.jsx)(`textarea`, {
                    ...
                    onKeyDown: (e) => {
                      e.key !== `Enter` || e.shiftKey || (e.preventDefault(), _ && c());
                    },
                  }),
                  (0, G.jsxs)(`div`, {
...
function Cn({
  ...
  let g = s && c != null,
    ...
    [O, k] = (0, I.useState)(``);
  (0, I.useEffect)(() => {
    E != null && !o.some((e) => e.id === E) && (D(null), k(``));
  }, [o, E]);
  let A = n === `resolved` ? [r, _n(a)].filter(Boolean).join(` · `) : null;
  return (0, G.jsxs)(`div`, {
        ...
        children: [
          (0, G.jsxs)(`div`, {
            ...
            children: [
              ...
              A
                ? (0, G.jsx)(`div`, {
                    className: i(`text-token-description-foreground mt-1`, gn),
                    children: A,
                  })
                : null,
            ],
                      ...
                      children: [
                        n === `resolved`
                          ? d
                            ? (0, G.jsxs)($, {
                                ...
                                children: [(0, G.jsx)(y, { className: `size-4` }), `Reopen thread`],
                              })
                            : null
                          : u
                            ? (0, G.jsxs)($, {
                        ...
                        f
                          ? (0, G.jsxs)($, {
                              ...
                              children: [(0, G.jsx)(v, { className: `size-4` }), `Delete thread`],
                            })
                          : null,
                      ],
                    }),
        ...
        children: o.map((e) => {
          ...
          return (0, G.jsx)(
            Sn,
            {
              ...
              onCommitEdit: () => {
                let t = O.trim();
                !t || !m || (m(e.id, t), D(null), k(``));
              },
              onCancelEdit: () => {
                (D(null), k(``));
              },
              onDelete: () => {
                (h?.(e.id), E === e.id && (D(null), k(``)));
              },
              onToggleReaction: (t) => {
                p?.(e.id, t);
              },
...
function wn({ open: e, onOpenChange: t, trigger: n, content: r }) {
  return (0, G.jsxs)(O, {
    open: e,
    onOpenChange: t,
    children: [
...
function kn(e) {
  ...
  return {
    visibleSize: n,
    halfVisibleSize: n / 2,
    hitRadius: Math.max(4, En / t),
    rotationBand: Math.max(6, Dn / t),
  };
}
function An(e) {
...
function Ln(e, t) {
  return Object.values(Pn(t)).every(
    (t) => t.x >= e.left && t.x <= e.left + e.width && t.y >= e.top && t.y <= e.top + e.height,
  );
}
function Rn(e, t, n) {
  let { hitRadius: r } = kn(n),
    i = Pn(e);
...
var Bn = 0.002,
  ...
  qn = 120;
function Jn(e, t) {
  return Math.abs(e.x - t.x) < 0.01 && Math.abs(e.y - t.y) < 0.01 && Math.abs(e.k - t.k) < 1e-4;
}
function Yn(e) {
  let t =
      e.deltaMode === WheelEvent.DOM_DELTA_LINE
        ...
        : e.deltaMode === WheelEvent.DOM_DELTA_PAGE
          ...
          : Bn,
    n = 2 ** (-e.deltaY * t * Un);
  return Math.max(Wn, Math.min(Gn, n));
}
function Xn(e, t, n) {
...
var Qn = class {
    ...
    #n = (e) => {
      ...
      if (e.ctrlKey) {
        let n = this.#a;
        if (!n) return;
        let r = fn(n, e.clientX, e.clientY),
          i = Yn(e),
          a = this.#p.k * i,
          o = this.#b(a);
        if (Xn(this.#p.k, a, o)) return;
        let s = this.#i.screenToWorldPoint?.(this.#p, r.x, r.y) ?? Z(this.#p, r.x, r.y);
    ...
    #r = (e) => {
      ...
      if (e.type === `pointerup` || e.type === `pointercancel` || e.type === `pointerleave`) {
        ...
        if ((this.#c?.pointerId === e.pointerId && (this.#c = null), this.#e.size >= 2)) {
          let e = pn(this.#e);
          if (!e) return;
          let t =
        ...
        ((this.#o = null),
          ...
          (this.#s = !1),
          (this.#c = null),
          (this.#d = performance.now() + Kn),
          this.#i.onCameraSettled?.(this.#p));
        return;
      }
      let n = fn(t, e.clientX, e.clientY);
      ...
      if (this.#e.has(e.pointerId)) {
        if ((this.#e.set(e.pointerId, n), e.type !== `pointermove` || this.#e.size < 2)) {
          if (
            e.type === `pointermove` &&
            this.#e.size === 1 &&
    ...
    setCamera(e, t) {
      ...
      ((this.#p = n), this.#h(), this.#i.requestDraw(), t?.settled && this.#i.onCameraSettled?.(n));
    }
    zoomTo(e, t) {
      let n = this.#a;
      if (!n) return;
      ...
      this.setCamera(cn(this.#p, r, i, e, this.#i.minZoom, this.#i.maxZoom), {
        settled: t?.settled,
      });
    }
    panByScroll(e, t) {
      this.setCamera({ ...this.#p, x: this.#p.x - e * this.#p.k, y: this.#p.y - t * this.#p.k });
    }
    #h() {
    ...
    #y(e) {
      return this.#i.clampCamera
        ? this.#i.clampCamera({ ...e, k: on(e.k, this.#i.minZoom, this.#i.maxZoom) })
        : ln(
            { ...e, k: on(e.k, this.#i.minZoom, this.#i.maxZoom) },
...
function tr(e, t) {
  ...
  return n.length === 0 ? null : n.length === 1 ? (n[0] ?? null) : _(n);
}
function nr(e, t) {
  if (e === t) return !0;
  if (e.length !== t.length) return !1;
...
function rr(e, t) {
  ...
  for (let n = 0; n < e.length; n += 1) {
    let r = e[n],
      i = t[n];
    if (!r || !i || !nr(r, i)) return !1;
  }
  return !0;
}
function ir(e) {
  let t = er(e.externalCrdtUpdates);
  return (
    e.initialCrdtState && e.initialCrdtState.length > 0 && t.unshift(e.initialCrdtState),
    t.length === 0 ? e.initialCrdtState : t.length === 1 ? t[0] : _(t)
  );
}
function ar(e) {
  let t = er(e.externalCrdtUpdates);
  return {
    initialCrdtState: ir({ initialCrdtState: e.initialCrdtState, externalCrdtUpdates: t }),
...
function cr({ initialCrdtState: e, externalCrdtUpdates: t }) {
  let n = (0, I.useRef)(null);
  n.current ??= ar({ initialCrdtState: e, externalCrdtUpdates: t });
  let r = n.current;
  return {
    initialCrdtState: r.initialCrdtState,
    externalCrdtUpdates: or({ bootstrapState: r, updates: t }),
  };
}
function lr({ artifactLabel: e, controller: t, externalCrdtUpdates: n, onCrdtUpdate: r }) {
  let i = (0, I.useRef)(0),
    a = (0, I.useRef)(n ?? []),
    [o, s] = (0, I.useState)(null),
    c = n ?? [];
  rr(a.current, c) || (a.current = c);
  let l = a.current;
  return (
    (0, I.useEffect)(() => {
    ...
    (0, I.useEffect)(() => {
      ...
      return (
        (async () => {
          ...
          s(a >= $n ? { kind: `restoring`, pendingUpdateCount: a } : null);
          try {
            let e = tr(n, i.current);
            if (r || (e && (await t.applyCrdtUpdate(e), r))) return;
            ((i.current = n.length), s(null));
          } catch (t) {
            if (r) return;
            s({ kind: `failed`, artifactLabel: e, errorMessage: sr(t, e), pendingUpdateCount: a });
          }
        })(),
        () => {
          r = !0;
...
function ur({ artifactLabel: e, restoreState: t }) {
  return t
    ? (0, G.jsx)(`div`, {
              ...
              ? (0, G.jsxs)(`div`, {
                  ...
                  children: [
                    (0, G.jsxs)(`div`, {
                      ...
                      children: [`Could not restore `, e.toLowerCase(), ` edits`],
                    }),
                    (0, G.jsxs)(`div`, {
                      children: [
                        t.errorMessage,
...
//# sourceMappingURL=popcorn-electron-surface-style.js.map
