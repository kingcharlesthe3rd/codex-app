...
import { nx as w, rx as T } from "./app-initial~app-main~new-thread-panel-page.js";
import {
  _u as E,
  gu as D,
  hu as ee,
...
import { Dt as M, Et as oe } from "./workbook-1.js";
import {
  $ as se,
  B as ce,
  F as le,
...
function ye(e) {
  let { children: t, id: n, items: r, strategy: i = Te, disabled: a = !1 } = e,
    { active: o, dragOverlay: s, droppableRects: l, over: u, measureDroppableContainers: d } = p(),
    m = f(Ee, n),
    h = s.rect !== null,
    g = (0, L.useMemo)(() => r.map((e) => (typeof e == `object` && `id` in e ? e.id : e)), [r]),
    _ = o != null,
    v = o ? g.indexOf(o.id) : -1,
    y = u ? g.indexOf(u.id) : -1,
    b = (0, L.useRef)(g),
    x = !ge(g, b.current),
    S = (y !== -1 && v === -1) || x,
    C = _e(a);
  ...
  let w = (0, L.useMemo)(
    ...
    [v, m, C.draggable, C.droppable, S, g, y, l, h, i],
  );
  return L.createElement(De.Provider, { value: w }, t);
}
function be(e) {
...
function xe(e) {
  let {
    ...
    T = m.indexOf(u),
    E = (0, L.useMemo)(
      () => ({ sortable: { containerId: g, index: T, items: m }, ...i }),
      [g, i, T, m],
    ),
    D = (0, L.useMemo)(() => m.slice(m.indexOf(u)), [m, u]),
    {
      rect: ee,
      node: te,
      isOver: O,
      ...
      resizeObserverConfig: { updateMeasurementsFor: D, ...f },
    }),
    {
      active: A,
      activatorEvent: j,
      ...
      transform: ce,
    } = l({ id: u, data: E, attributes: { ...Ne, ...n }, disabled: w.draggable }),
    le = s(k, ie),
    N = !!A,
    ue = N && !y && he(_) && he(x),
    de = !S && M,
    fe = ue
      ? ((de && ue ? ce : null) ??
        (d ?? C)({ rects: b, activeNodeRect: ne, activeIndex: _, overIndex: x, index: T }))
      : null,
    P = he(_) && he(x) ? c({ id: u, items: m, activeIndex: _, overIndex: x }) : T,
    F = A?.id,
    I = (0, L.useRef)({ activeId: F, items: m, newIndex: P, containerId: g }),
    pe = m !== I.current.items,
    me = t({
      active: A,
      containerId: g,
      isDragging: M,
    ...
    ge = be({ disabled: !me, index: T, node: te, rect: ee });
  return (
    (0, L.useEffect)(() => {
      (N && I.current.newIndex !== P && (I.current.newIndex = P),
        g !== I.current.containerId && (I.current.containerId = g),
        m !== I.current.items && (I.current.items = m));
    }, [N, P, g, m]),
    (0, L.useEffect)(() => {
  ...
  function _e() {
    if (ge || (pe && I.current.newIndex === T)) return Me;
    if (!((de && !h(j)) || !p) && (N || me)) return o.Transition.toString({ ...p, property: je });
  }
}
function Se(e, t) {
    ...
    ((L = t(n())),
      ...
      (we = (e) => {
        ...
        if (a === r) {
          let e = t[i];
          return e
            ? { x: r < i ? e.left + e.width - (o.left + o.width) : e.left - o.left, y: 0, ...Ce }
            : null;
        }
        return a > r && a <= i
          ? { x: -o.width - s, y: 0, ...Ce }
      ...
      (je = `transform`),
      (Me = o.Transition.toString({ property: je, duration: 0, easing: `linear` })),
...
function ot({
  ...
  return (0, R.jsx)(`div`, {
    "data-testid": s,
    className: w(`pointer-events-none absolute box-border`),
    style: {
      left: e.left,
      top: e.top,
      width: e.width,
...
function Mt({
  ...
  return (0, V.jsx)(`button`, {
    ...
    children: (0, V.jsxs)(`span`, {
      className: w(`flex min-w-0 items-center`, e ? `justify-start` : `w-full justify-center`),
      children: [
        a({
          className: w(
      ...
      (gn = (0, H.forwardRef)(function (
        ...
        let d = (0, H.useRef)(null),
          ...
          ),
          {
            ...
            middleware: [
              C(Kt + qt),
              g({ fallbackPlacements: [`left-start`], padding: Gt, ...(O ? { boundary: O } : {}) }),
              x({ padding: Gt, ...(O ? { boundary: O } : {}) }),
              S({
                padding: Gt,
                ...(O ? { boundary: O } : {}),
          ...
          ce = (0, H.useCallback)(
            (e) => {
              if (((d.current = e), j.setFloating(e), typeof u == `function`)) {
                u(e);
                return;
              }
              u && (u.current = e);
        ...
        if (
          ...
          (0, H.useEffect)(() => {
            e && ae?.();
          }, [e?.height, e?.left, e?.top, e?.width, r, h, ae]),
          !e)
        )
          return null;
        let N = (0, U.jsx)(`div`, {
          ...
          children: (0, U.jsx)(`form`, {
            ...
            style: $t,
            onSubmit: (e) => {
              (e.preventDefault(), D && o(E ? `saved` : `direct`, `button`));
            },
                      ...
                      children: (0, U.jsx)(`textarea`, {
                        ...
                        onKeyDown: (e) => {
                          ...
                          e.key === `Enter` &&
                            ...
                            (e.preventDefault(),
                            e.stopPropagation(),
                            o(E || e.metaKey || e.ctrlKey ? `saved` : `direct`, `keyboard`));
                        },
                        placeholder: `Describe a change or ask a question`,
                        rows: 1,
                        className: w(Qt, !h && `!overflow-hidden whitespace-nowrap`),
                        style: {
                  ...
                  E
                    ? (0, U.jsxs)(`div`, {
                        ...
                        className: w(
                          rn,
                          `justify-between`,
                          h ? `scale-100 opacity-100` : `pointer-events-none scale-95 opacity-0`,
                        ),
                        children: [
                          (0, U.jsx)(`button`, {
                            type: `button`,
...
function sr({ open: e, onOpenChange: t, trigger: n, children: r }) {
  return (0, X.jsxs)(ee, {
    ...
    onOpenChange: t,
    children: [
      (0, X.jsx)(D, { asChild: !0, children: n }),
      (0, X.jsx)(te, {
        children: (0, X.jsx)(O, {
          side: `bottom`,
          align: `end`,
          ...
          (0, X.jsxs)(`div`, {
            ...
            children: [
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`div`, {
                    className: w(`text-token-text-primary truncate font-medium`, Z),
                    children: e.author.displayName,
                  }),
                  h
                    ? (0, X.jsxs)(`div`, {
                        className: w(`text-token-description-foreground mt-0.5`, gr),
                    ...
                    children: (0, X.jsxs)(`div`, {
                      ...
                      children: [
                        (0, X.jsxs)(cr, {
                          ...
                          children: [(0, X.jsx)(P, { className: `size-4` }), `Edit`],
                        }),
                        (0, X.jsxs)(cr, {
                          destructive: !0,
                          onClick: () => {
                          ...
                          children: [(0, X.jsx)(se, { className: `size-4` }), `Delete`],
                        }),
                      ],
                    }),
                  })
...
function fr({
  ...
  let h = o && s != null,
    ...
    [C, T] = (0, Y.useState)(``);
  (0, Y.useEffect)(() => {
    x != null && !a.some((e) => e.id === x) && (S(null), T(``));
  }, [a, x]);
        ...
        children: [
          (0, X.jsxs)(`div`, {
            ...
            children: [
              ...
              E
                ? (0, X.jsx)(`div`, {
                    className: w(`text-token-description-foreground mt-1`, gr),
                    children: E,
                  })
                : null,
            ],
                      ...
                      children: [
                        ...
                        d
                          ? (0, X.jsxs)(cr, {
                              ...
                              children: [(0, X.jsx)(se, { className: `size-4` }), `Delete thread`],
                            })
                          : null,
                      ],
                    }),
        ...
        children: a.map((e) => {
          ...
          return (0, X.jsx)(
            dr,
            {
              ...
              onCommitEdit: () => {
                let t = C.trim();
                !t || !p || (p(e.id, t), S(null), T(``));
              },
              onCancelEdit: () => {
                (S(null), T(``));
              },
              onDelete: () => {
                (m?.(e.id), x === e.id && (S(null), T(``)));
              },
              onToggleReaction: (t) => {
                f?.(e.id, t);
              },
