...
import { Dt as j, Et as se } from "./workbook-1.js";
import {
  $ as ce,
  B as le,
  F as ue,
...
function be(e) {
  let { children: t, id: n, items: r, strategy: i = Ee, disabled: a = !1 } = e,
    { active: o, dragOverlay: s, droppableRects: c, over: l, measureDroppableContainers: d } = f(),
    p = u(De, n),
    m = s.rect !== null,
    h = (0, I.useMemo)(() => r.map((e) => (typeof e == `object` && `id` in e ? e.id : e)), [r]),
    g = o != null,
...
function Se(e) {
  let {
    ...
    }),
    {
      ...
      transform: le,
    } = a({ id: l, data: ee, attributes: { ...Pe, ...n }, disabled: w.draggable }),
    ue = i(O, A),
    M = !!k,
    de = M && !_ && ge(h) && ge(b),
    fe = !S && j,
    pe = de
      ? ((fe && de ? le : null) ??
        (u ?? C)({ rects: v, activeNodeRect: ie, activeIndex: h, overIndex: b, index: T }))
      : null,
    N = ge(h) && ge(b) ? c({ id: l, items: p, activeIndex: h, overIndex: b }) : T,
    P = k?.id,
  ...
  function ve() {
    ...
    if (!((fe && !y(re)) || !f) && (M || he)) return o.Transition.toString({ ...f, property: Me });
  }
}
function Ce(e, t) {
    ...
    ((I = t(n())),
      ...
      (Te = (e) => {
        ...
        if (a === r) {
          let e = t[i];
          return e
            ? { x: r < i ? e.left + e.width - (o.left + o.width) : e.left - o.left, y: 0, ...we }
            : null;
        }
        return a > r && a <= i
          ? { x: -o.width - s, y: 0, ...we }
      ...
      (Me = `transform`),
      (Ne = o.Transition.toString({ property: Me, duration: 0, easing: `linear` })),
...
function it(e, t) {
  switch (t) {
    ...
    case `top-left`:
      return { fontFamily: R, left: e.left, top: e.top - pt, transform: `translateY(-100%)` };
    case `top-right`:
      return {
        fontFamily: R,
        left: e.left + e.width,
...
function Nt({
  ...
  return (0, B.jsx)(`button`, {
    ...
    children: (0, B.jsxs)(`span`, {
      className: O(`flex min-w-0 items-center`, e ? `justify-start` : `w-full justify-center`),
      children: [
        a({
          className: O(
...
function Rt({ text: e, hasMultipleBlocks: t, measureElement: n, surfaceElement: r }) {
  let i = e.trim();
      ...
      (gn = (0, V.forwardRef)(function (
        ...
        let d = (0, V.useRef)(null),
          ...
          ),
          {
            ...
            middleware: [
              ae(qt + Jt),
              w({ fallbackPlacements: [`left-start`], padding: Kt, ...(C ? { boundary: C } : {}) }),
              ...
              children: (0, H.jsxs)(`div`, {
                ...
                children: [
                      ...
                      children: (0, H.jsx)(`textarea`, {
                        ...
                        onKeyDown: (e) => {
                          ...
                          e.key === `Enter` &&
                            ...
                            (e.preventDefault(),
                            e.stopPropagation(),
                            o(y || e.metaKey || e.ctrlKey ? `saved` : `direct`, `keyboard`));
                        },
                        placeholder: `Describe a change or ask a question`,
                        rows: 1,
                        className: O(Qt, !h && `!overflow-hidden whitespace-nowrap`),
                        style: {
                  ...
                  (0, H.jsx)(`span`, {
                    ...
                    "aria-hidden": `true`,
                    className: an,
                    style: { fontSize: `var(--codex-chat-font-size, 13px)`, lineHeight: `${U}px` },
                    children: r,
                  }),
                  y
                    ? (0, H.jsxs)(`div`, {
...
var K,
  ...
  Rn = e(() => {
    (Re(), ht(), kt(), wt(), Mt(), Lt(), _n(), An(), jn(), Mn(), Nn(), Fn(), Ln());
  });
function zn(e) {
    ...
    children: [
      ...
      (0, q.jsx)(b, {
        children: (0, q.jsx)(s, {
          ...
          children: t.map((e) => {
            if (e.kind === `separator`)
              return (0, q.jsx)(m, { className: `bg-token-border-light my-1 h-px` }, e.id);
            let t = e.icon;
            return (0, q.jsxs)(
              l,
              {
          ...
          (0, X.jsxs)(`div`, {
            ...
            children: [
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`div`, {
                    className: O(`text-token-text-primary truncate font-medium`, Z),
                    children: e.author.displayName,
                  }),
                  h
                    ? (0, X.jsxs)(`div`, {
                        className: O(`text-token-description-foreground mt-0.5`, gr),
                    ...
                    children: (0, X.jsxs)(`div`, {
                      ...
                      children: [
                        (0, X.jsxs)(cr, {
                          ...
                          children: [(0, X.jsx)(N, { className: `size-4` }), `Edit`],
                        }),
                        (0, X.jsxs)(cr, {
                          destructive: !0,
                          onClick: () => {
                          ...
                          children: [(0, X.jsx)(ce, { className: `size-4` }), `Delete`],
                        }),
                      ],
                    }),
                  })
                      ...
                      children: [
                        ...
                        d
                          ? (0, X.jsxs)(cr, {
                              ...
                              children: [(0, X.jsx)(ce, { className: `size-4` }), `Delete thread`],
                            })
                          : null,
                      ],
                    }),
