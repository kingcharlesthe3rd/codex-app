...
import { Dt as j, Et as se } from "./workbook-2.js";
import {
  $ as ce,
  B as le,
  F as ue,
...
function be(e) {
  let { children: t, id: n, items: r, strategy: i = Te, disabled: o = !1 } = e,
    { active: c, dragOverlay: l, droppableRects: u, over: d, measureDroppableContainers: f } = p(),
    m = s(Ee, n),
    h = l.rect !== null,
    g = (0, I.useMemo)(() => r.map((e) => (typeof e == `object` && `id` in e ? e.id : e)), [r]),
    _ = c != null,
...
function Se(e) {
  let {
    ...
    }),
    {
      ...
      transform: le,
    } = h({ id: l, data: ee, attributes: { ...Ne, ...n }, disabled: w.draggable }),
    ue = o(O, ae),
    M = !!k,
    de = M && !y && ge(_) && ge(x),
    fe = !S && j,
    pe = de
      ? ((fe && de ? le : null) ??
        (d ?? C)({ rects: b, activeNodeRect: re, activeIndex: _, overIndex: x, index: T }))
      : null,
    N = ge(_) && ge(x) ? s({ id: l, items: m, activeIndex: _, overIndex: x }) : T,
    P = k?.id,
  ...
  function ve() {
    ...
    if (!((fe && !c(A)) || !p) && (M || he)) return i.Transition.toString({ ...p, property: je });
  }
}
function Ce(e, t) {
...
var I,
  ...
  Pe = e(() => {
    ((I = t(r())),
      ...
      (je = `transform`),
      (Me = i.Transition.toString({ property: je, duration: 0, easing: `linear` })),
      ...
      (gn = (0, H.forwardRef)(function (
        ...
        let d = (0, H.useRef)(null),
          ...
          ),
          {
            ...
            middleware: [
              ne(Kt + qt),
              C({ fallbackPlacements: [`left-start`], padding: Gt, ...(E ? { boundary: E } : {}) }),
    ...
    children: [
      ...
      (0, q.jsx)(E, {
        children: (0, q.jsx)(b, {
          ...
          children: t.map((e) => {
            if (e.kind === `separator`)
              return (0, q.jsx)(v, { className: `bg-token-border-light my-1 h-px` }, e.id);
            let t = e.icon;
            return (0, q.jsxs)(
              g,
              {
...
var q,
  ...
  qn,
  Jn = e(() => {
    ((Kn = t(r())), (qn = typeof window > `u` ? Kn.useEffect : Kn.useLayoutEffect));
  });
function Yn(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
