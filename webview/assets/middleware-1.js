...
function l() {
  ...
  for (; e < 16; e++)
    ((t = c[o + e]),
      e == 6 ? (n += s[(t & 15) | 64]) : e == 8 ? (n += s[(t & 63) | 128]) : (n += s[t]),
      e & 1 && e > 1 && e < 11 && (n += `-`));
  return (o++, n);
}
var u = (function () {
      ...
      (e.prototype.flush = function () {
        if (this.logs.length > 1) {
          var e = this._logs.reduce(function (e, t) {
            ...
            return (e[a] && (a = `${a}-${Math.random()}`), i(i({}, e), ((n = {}), (n[a] = r), n)));
          }, {});
    ...
    return (
      ...
      (e.prototype.serialize = function () {
        return this.metrics.map(function (e) {
          return { m: e.metric, v: e.value, t: e.tags, k: d(e.type), e: e.timestamp };
        });
      }),
      e
    );
  ...
  C = function (e, t, n) {
    return {
      ...
      tags: i(
        ...
        { library: `analytics.js`, library_version: n === `web` ? `next-${y}` : `npm:next-${y}` },
      ),
    };
  };
function w(e) {
...
var T = (function () {
    function e(e) {
      ...
      if (
        ...
        var n = !1,
          r = function () {
            n || ((n = !0), t.flush().catch(w), (n = !1), setTimeout(r, t.flushTimer));
          };
        r();
      }
    }
    ...
    ((e.parse = function (e) {
      ...
      ((r[2] = parseInt(r[2], 10) || 1),
        ...
        r[4] === ` `
          ...
          : r[9] !== `Z` && r[10] && ((i = r[11] * 60 + r[12]), r[10] === `+` && (i = 0 - i)));
      var s = Date.UTC(r[1], r[2], r[3], r[5], r[6] + i, r[7], r[8]);
      return new Date(s);
    }),
      (e.is = function (e, n) {
        return typeof e != `string` || (n && /^\d{4}-\d{2}-\d{2}/.test(e) === !1) ? !1 : t.test(e);
      }));
  }),
  P = e((e) => {
    var t = /\d{13}/;
  ...
  R = e((e) => {
    ...
    function c(e, t) {
      ((t ||= {}),
        ...
        `timestamp` in e ? (e.timestamp = a.default(e.timestamp)) : (e.timestamp = new Date()),
      ...
      (l.traits = function (e) {
        ...
        for (var r in ((e ||= {}), n && (t.id = n), e))
          if (Object.prototype.hasOwnProperty.call(e, r)) {
            var i = this[r] == null ? this.proxy(`options.traits.` + r) : this[r]();
            if (i == null) continue;
            ((t[e[r]] = i), delete t[r]);
          }
        return t;
  ...
  U = e((e) => {
    ...
    ((l.action = function () {
      ...
      (l.age = function () {
        ...
        if (t != null) return t;
        if (e instanceof Date) return new Date().getFullYear() - e.getFullYear();
      }),
      (l.avatar = function () {
        var e = this.traits();
        return r.default(e, `avatar`) || r.default(e, `photoUrl`) || r.default(e, `avatarUrl`);
      }),
      (l.position = function () {
        var e = this.traits();
  ...
  W = e((e) => {
    ...
    function l(e) {
      if (
        e &&
        (typeof e == `number` ||
          (typeof e == `string` && ((e = e.replace(/\$/g, ``)), (e = parseFloat(e)), !isNaN(e))))
      )
        return e;
    }
  }),
...
function Z(e, r, a) {
  return n(this, void 0, void 0, function () {
            ...
            case 1:
              return (
                ...
                !n &&
                  o !== null &&
                  ((o = o),
                  (o.integrations = i(i({}, r.integrations), ((s = {}), (s[e] = !1), s)))),
                [2, o]
              );
          }
        });
    ...
    return t(this, function (e) {
      switch (e.label) {
        case 0:
          ((s = X(r, { clone: !0, traverse: !1 }).rawEvent()), (c = 0), (l = a), (e.label = 1));
        case 1:
...
//# sourceMappingURL=middleware-1.js.map
