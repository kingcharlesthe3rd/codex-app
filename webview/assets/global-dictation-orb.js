...
async function N(e, t, n, r) {
  ...
  try {
    ((W = e),
      await o.systemPermissions?.requestMicrophoneAccess().catch(() => {}),
    ...
    if (
      ...
      try {
        if ((await e.start(i), s.pendingStreamingSession !== e)) return;
        ((s.pendingStreamingSession = null),
          H === s && !s.isStopping ? (s.streamingSession = e) : e.close());
      } catch {
        s.pendingStreamingSession === e && ((s.pendingStreamingSession = null), e.close());
      }
    }
  } catch (n) {
    throw (
      ...
      W === e && (W = null),
      G === e && (G = null),
      a.dispatchMessage(`global-dictation-failed`, { sessionId: e, stage: `recording` }),
      n
    );
  }
}
  ...
  try {
    ...
    if (e.chunks.length === 0 || Date.now() - e.startedAtMs < V) {
      (e.streamingSession?.close(),
        a.dispatchMessage(`global-dictation-completed`, { sessionId: e.sessionId, text: `` }));
      return;
    }
    ((t = {
...
async function L(e, t, n = null) {
  ...
  (U === e && (U = null),
    a.dispatchMessage(`global-dictation-completed`, { sessionId: e.sessionId, text: r }));
}
...
function z(e, t, n, r) {
  ((U = r),
    t(n),
    a.dispatchMessage(`global-dictation-failed`, { sessionId: e, stage: `transcription` }));
}
function B(e) {
...
function ee(e) {
  ...
  t[7] !== i || t[8] !== s
    ? ((j = () => {
        ((x.current = null), f(null), i?.(null), _(null), y(!1), m(`idle`), s?.(!1));
      }),
      (t[7] = i),
      (t[8] = s),
      (t[9] = j))
  ...
  (t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (e) => {
      ...
      (t[22] = B))
    : ((z = t[21]), (B = t[22])),
    d(`global-dictation-stop`, B, z));
  let V, H;
  (t[23] !== i || t[24] !== s || t[25] !== c
    ? ((V = () => {
        let e = !0;
        return (
          c &&
            queueMicrotask(() => {
              e && a.dispatchMessage(`global-dictation-pet-renderer-ready`, { ready: !0 });
            }),
          () => {
            e = !1;
            let t = x.current;
            (t != null && P(t),
              i?.(null),
              s?.(!1),
              c && a.dispatchMessage(`global-dictation-pet-renderer-ready`, { ready: !1 }));
          }
        );
      }),
      (H = [i, s, c]),
  ...
  let U = p === `error` && v,
    W;
  t[28] !== u || t[29] !== A || t[30] !== U || t[31] !== p
    ? ((W = (e) => {
        if ((e.stopPropagation(), p === `listening` && u != null)) {
          a.dispatchMessage(`global-dictation-stop-requested`, { sessionId: u });
          return;
        }
        if (U) {
          A();
        ...
        p === `error` &&
          u != null &&
          a.dispatchMessage(`global-dictation-dismiss`, { sessionId: u });
      }),
      (t[28] = u),
      (t[29] = A),
      (t[30] = U),
  ...
  let K;
  return (
    t[33] !== v || t[34] !== h || t[35] !== G || t[36] !== p || t[37] !== C
      ? ((K = (0, $.jsx)(te, {
          canRetryError: v,
          errorMessage: h,
          onClick: G,
...
function te(e) {
  let t = (0, Z.c)(40),
    { canRetryError: n, errorMessage: i, onClick: a, status: o, waveformCanvasRef: s } = e,
    c = g(),
    u = o === `transcribing`,
    d = o === `error` && n,
    f;
  ...
  t[10] === o
    ...
    : ((h = _(
        ...
        o === `listening`
          ? _(`cursor-interaction text-white`, Y.recordingOrb)
  ...
  t[12] !== o || t[13] !== s
    ? ((v =
        o === `listening`
          ? (0, $.jsx)(`canvas`, { ref: s, className: `size-10 text-white`, "aria-hidden": `true` })
          : null),
      (t[12] = o),
      (t[13] = s),
      (t[14] = v))
  ...
  t[15] === u
    ? (y = t[16])
    : ((y = u ? (0, $.jsx)(m, { className: `icon-sm` }) : null), (t[15] = u), (t[16] = y));
  let b;
  t[17] === d
    ? (b = t[18])
    : ((b = d ? (0, $.jsx)(A, { className: `icon-sm` }) : null), (t[17] = d), (t[18] = b));
  let x;
  t[19] !== n || t[20] !== o
    ? ((x = o === `error` && !n ? (0, $.jsx)(l, { className: `icon-sm` }) : null),
      (t[19] = n),
      (t[20] = o),
      (t[21] = x))
    : (x = t[21]);
...
var Z,
  ...
  $,
  ne = e(() => {
    ((Z = c()), u(), (Q = t(v(), 1)), i(), f(), x(), k(), n(), h(), j(), q(), X(), ($ = p()));
  });
