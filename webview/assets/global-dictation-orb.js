...
async function N(e, t, n, r) {
  ...
  try {
    ...
    throw (
      ...
      W === e && (W = null),
      G === e && (G = null),
      o.dispatchMessage(`global-dictation-failed`, { sessionId: e, stage: `recording` }),
      n
    );
  }
}
  ...
  try {
    ...
    if (e.chunks.length === 0 || Date.now() - e.startedAtMs < V) {
      (e.streamingSession?.close(),
        o.dispatchMessage(`global-dictation-completed`, { sessionId: e.sessionId, text: `` }));
      return;
    }
    ((t = {
...
async function L(e, t, n = null) {
  ...
  (U === e && (U = null),
    o.dispatchMessage(`global-dictation-completed`, { sessionId: e.sessionId, text: r }));
}
...
function z(e, t, n, r) {
  ((U = r),
    t(n),
    o.dispatchMessage(`global-dictation-failed`, { sessionId: e, stage: `transcription` }));
}
function B(e) {
...
function ee(e) {
  ...
  t[7] !== i || t[8] !== c
    ? ((M = () => {
        ((b.current = null), f(null), i?.(null), _(null), y(!1), m(`idle`), c?.(!1));
      }),
      (t[7] = i),
      (t[8] = c),
      (t[9] = M))
  ...
  (t[23] !== i || t[24] !== c || t[25] !== l
    ? ((V = () => {
        ...
        return (
          l &&
            queueMicrotask(() => {
              e && o.dispatchMessage(`global-dictation-pet-renderer-ready`, { ready: !0 });
            }),
          () => {
            e = !1;
            let t = b.current;
            (t != null && P(t),
              i?.(null),
              c?.(!1),
              l && o.dispatchMessage(`global-dictation-pet-renderer-ready`, { ready: !1 }));
          }
        );
      }),
      (H = [i, c, l]),
  ...
  t[28] !== d || t[29] !== A || t[30] !== U || t[31] !== p
    ? ((W = (e) => {
        if ((e.stopPropagation(), p === `listening` && d != null)) {
          o.dispatchMessage(`global-dictation-stop-requested`, { sessionId: d });
          return;
        }
        if (U) {
          A();
...
function te(e) {
  ...
  t[15] === l
    ? (y = t[16])
    : ((y = l ? (0, $.jsx)(c, { className: `icon-sm` }) : null), (t[15] = l), (t[16] = y));
  let x;
  t[17] === u
    ? (x = t[18])
    : ((x = u ? (0, $.jsx)(b, { className: `icon-sm` }) : null), (t[17] = u), (t[18] = x));
  let S;
  t[19] !== n || t[20] !== a
    ? ((S = a === `error` && !n ? (0, $.jsx)(f, { className: `icon-sm` }) : null),
      (t[19] = n),
      (t[20] = a),
      (t[21] = S))
    : (S = t[21]);
...
var Z,
  ...
  $,
  ne = e(() => {
    ((Z = i()), u(), (Q = t(r(), 1)), m(), l(), O(), y(), p(), n(), M(), q(), X(), ($ = a()));
  });
