...
function ee(e) {
  ...
  t[7] !== i || t[8] !== c
    ? ((M = () => {
        ((b.current = null), p(null), i?.(null), _(null), y(!1), h(`idle`), c?.(!1));
      }),
      (t[7] = i),
      (t[8] = c),
      (t[9] = M))
        ...
        return (
          ...
          () => {
            ...
            (t != null && P(t),
              i?.(null),
              c?.(!1),
              l && a.dispatchMessage(`global-dictation-pet-renderer-ready`, { ready: !1 }));
          }
        );
      }),
      (H = [i, c, l]),
  ...
  t[28] !== f || t[29] !== A || t[30] !== U || t[31] !== m
    ? ((W = (e) => {
        if ((e.stopPropagation(), m === `listening` && f != null)) {
          a.dispatchMessage(`global-dictation-stop-requested`, { sessionId: f });
          return;
        }
        if (U) {
          A();
...
function te(e) {
  ...
  t[15] === c
    ? (h = t[16])
    : ((h = c ? (0, $.jsx)(x, { className: `icon-sm` }) : null), (t[15] = c), (t[16] = h));
  let g;
  t[17] === u
    ? (g = t[18])
    : ((g = u ? (0, $.jsx)(l, { className: `icon-sm` }) : null), (t[17] = u), (t[18] = g));
  let _;
  t[19] !== n || t[20] !== a
    ? ((_ = a === `error` && !n ? (0, $.jsx)(T, { className: `icon-sm` }) : null),
      (t[19] = n),
      (t[20] = a),
      (t[21] = _))
    : (_ = t[21]);
...
var Z,
  ...
  $,
  ne = e(() => {
    ((Z = i()), A(), (Q = t(o(), 1)), E(), S(), v(), c(), C(), n(), M(), q(), X(), ($ = r()));
  });
