...
async function N(e, t, n, i) {
  ...
  try {
    ...
    throw (
      ...
      W === e && (W = null),
      G === e && (G = null),
      r.dispatchMessage(`global-dictation-failed`, { sessionId: e, stage: `recording` }),
      n
    );
  }
}
function P(e) {
  ...
  t.isStopping ||
    ...
    r.dispatchMessage(`global-dictation-recording-stopped`, { sessionId: e }),
    F(t));
}
async function F(e) {
  let t = null;
  try {
    ...
    if (e.chunks.length === 0 || Date.now() - e.startedAtMs < V) {
      (e.streamingSession?.close(),
        r.dispatchMessage(`global-dictation-completed`, { sessionId: e.sessionId, text: `` }));
      return;
    }
    ((t = {
...
async function L(e, t, n = null) {
  let i = await k({
    transcript: n == null ? await C(e.audio) : await R(n, e.audio),
    cleanupEnabled: t,
  });
  (U === e && (U = null),
    r.dispatchMessage(`global-dictation-completed`, { sessionId: e.sessionId, text: i }));
}
...
function z(e, t, n, i) {
  ((U = i),
    t(n),
    r.dispatchMessage(`global-dictation-failed`, { sessionId: e, stage: `transcription` }));
}
function B(e) {
...
function ee(e) {
  ...
  t[7] !== a || t[8] !== c
    ? ((j = () => {
        ((b.current = null), f(null), a?.(null), g(null), y(!1), m(`idle`), c?.(!1));
      }),
      (t[7] = a),
      (t[8] = c),
      (t[9] = j))
  ...
  (t[23] !== a || t[24] !== c || t[25] !== l
    ? ((V = () => {
        ...
        return (
          l &&
            queueMicrotask(() => {
              e && r.dispatchMessage(`global-dictation-pet-renderer-ready`, { ready: !0 });
            }),
          () => {
            e = !1;
            let t = b.current;
            (t != null && P(t),
              a?.(null),
              c?.(!1),
              l && r.dispatchMessage(`global-dictation-pet-renderer-ready`, { ready: !1 }));
          }
        );
      }),
      (H = [a, c, l]),
  ...
  t[28] !== d || t[29] !== A || t[30] !== U || t[31] !== p
    ? ((W = (e) => {
        if ((e.stopPropagation(), p === `listening` && d != null)) {
          r.dispatchMessage(`global-dictation-stop-requested`, { sessionId: d });
          return;
        }
        if (U) {
          A();
        ...
        p === `error` &&
          d != null &&
          r.dispatchMessage(`global-dictation-dismiss`, { sessionId: d });
      }),
      (t[28] = d),
      (t[29] = A),
      (t[30] = U),
...
function te(e) {
  ...
  t[10] === a
    ...
    : ((h = f(
        ...
        a === `listening`
          ? f(`cursor-interaction text-white`, Y.recordingOrb)
  ...
  t[15] === l
    ? (b = t[16])
    : ((b = l ? (0, $.jsx)(c, { className: `icon-sm` }) : null), (t[15] = l), (t[16] = b));
  let x;
  t[17] === u
    ? (x = t[18])
    : ((x = u ? (0, $.jsx)(y, { className: `icon-sm` }) : null), (t[17] = u), (t[18] = x));
  let S;
  t[19] !== n || t[20] !== a
    ? ((S = a === `error` && !n ? (0, $.jsx)(p, { className: `icon-sm` }) : null),
      (t[19] = n),
      (t[20] = a),
      (t[21] = S))
    : (S = t[21]);
...
var Z,
  ...
  $,
  ne = e(() => {
    ((Z = n()), u(), (Q = t(i(), 1)), m(), l(), S(), b(), d(), s(), j(), q(), X(), ($ = a()));
  });
