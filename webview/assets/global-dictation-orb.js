...
import { i as u, n as d, r as f, t as p } from "./transcribe-audio.js";
import { t as m } from "./regenerate.js";
import { t as h } from "./x.js";
import { n as g } from "./rpc-Hf-fxjh7.js";
import { o as _ } from "./statsig.js";
import { n as v, t as y } from "./use-recording-waveform.js";
import { t as b } from "./dictation-error-message.js";
var x = 250,
  S = null,
  C = null,
  w = null,
...
async function D(e, t, n, r) {
  if (S?.sessionId === e || w === e) return;
  ((C = null), S != null && O(S.sessionId));
  let a = null;
  try {
    ((w = e),
      await g.systemPermissions?.requestMicrophoneAccess().catch(() => {}),
      (a = await v({ channelCount: 1 })),
    ...
    if (
      ...
      try {
        ...
        ((o.pendingStreamingSession = null),
          S === o && !o.isStopping ? (o.streamingSession = e) : e.close());
      } catch {
...
async function k(e) {
  ...
  try {
    ...
    if (e.chunks.length === 0 || Date.now() - e.startedAtMs < x) {
    ...
    ((t = {
      ...
      await j(t, e.cleanupEnabled, e.streamingSession));
  } catch (n) {
    N(e.sessionId, e.controls.onTranscriptionFailed, n, t);
  }
}
async function A(e, t) {
  ...
  try {
    ...
    throw (N(e, n.onTranscriptionFailed, t, n), t);
  } finally {
    E === e && (E = null);
  }
}
async function j(e, t, n = null) {
  let r = await d({
    transcript: n == null ? await p(e.audio) : await M(n, e.audio),
    cleanupEnabled: t,
  });
  (C === e && (C = null),
...
function R(e) {
  let t = (0, F.c)(39),
    { onActiveSessionIdChange: n, registerNativePetRenderer: r, onVisibilityChange: s } = e,
    c = r === void 0 ? !0 : r,
    l = o(),
    d = _(`1025755912`),
    f = _(u),
    [p, m] = (0, I.useState)(null),
    [h, g] = (0, I.useState)(`idle`),
    [v, x] = (0, I.useState)(null),
    [S, C] = (0, I.useState)(!1),
    w = (0, I.useRef)(null),
    T;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = { variant: `compact` }), (t[0] = T))
    : (T = t[0]);
  let {
      waveformCanvasRef: E,
  ...
  t[1] === l
    ...
    : ((N = (e, t) => {
        let n = b(l, e, t);
        (x(n.message), C(n.canRetry), g(`error`));
      }),
      (t[1] = l),
      (t[2] = N));
  let P = N,
  ...
  t[7] !== n || t[8] !== s
    ? ((V = () => {
        ((w.current = null), m(null), n?.(null), x(null), C(!1), g(`idle`), s?.(!1));
      }),
      (t[7] = n),
      (t[8] = s),
      (t[9] = V))
  ...
  t[18] !== j
    ...
    : (U = t[19]);
  let W;
  (t[20] === Symbol.for(`react.memo_cache_sentinel`) ? ((W = []), (t[20] = W)) : (W = t[20]),
    a(`global-dictation-start`, U, W));
  let G, K;
  (t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (e) => {
        (x(null), C(!1), g(`transcribing`), O(e.sessionId));
      }),
      (G = []),
      (t[21] = G),
      (t[22] = K))
    : ((G = t[21]), (K = t[22])),
    a(`global-dictation-stop`, K, G));
  let q, J;
  (t[23] !== n || t[24] !== s || t[25] !== c
    ? ((q = () => {
        ...
        return (
          c &&
            queueMicrotask(() => {
              e && i.dispatchMessage(`global-dictation-pet-renderer-ready`, { ready: !0 });
            }),
          () => {
            e = !1;
            let t = w.current;
            (t != null && O(t),
              n?.(null),
              s?.(!1),
              c && i.dispatchMessage(`global-dictation-pet-renderer-ready`, { ready: !1 }));
          }
        );
      }),
      (J = [n, s, c]),
  ...
  let Y = h === `error` && S,
    X;
  t[28] !== p || t[29] !== B || t[30] !== Y || t[31] !== h
    ? ((X = (e) => {
        if ((e.stopPropagation(), h === `listening` && p != null)) {
          i.dispatchMessage(`global-dictation-stop-requested`, { sessionId: p });
          return;
        }
        if (Y) {
          B();
        ...
        h === `error` &&
          p != null &&
          i.dispatchMessage(`global-dictation-dismiss`, { sessionId: p });
      }),
      (t[28] = p),
      (t[29] = B),
      (t[30] = Y),
    ...
    : (X = t[32]);
  let Z = X;
  if (h === `idle`) return null;
  let Q;
  return (
    t[33] !== S || t[34] !== v || t[35] !== Z || t[36] !== h || t[37] !== E
      ? ((Q = (0, L.jsx)(z, {
          canRetryError: S,
          errorMessage: v,
          onClick: Z,
...
function z(e) {
  let t = (0, F.c)(41),
    { canRetryError: n, errorMessage: r, onClick: i, status: a, waveformCanvasRef: u } = e,
    d = o(),
    f = a === `transcribing`,
    p = a === `error` && n,
    g;
  ...
  let _ = g,
    v =
      a === `listening`
        ? `cursor-interaction bg-token-error-foreground text-white`
        : `bg-token-dropdown-background text-token-text-secondary`,
    y = a === `error` && `cursor-interaction`,
    b;
  t[10] !== v || t[11] !== y
    ? ((b = c(
        `no-drag pointer-events-auto flex size-10 shrink-0 items-center justify-center rounded-full border border-white/25 shadow-lg shadow-black/20`,
        v,
        y,
      )),
      (t[10] = v),
  ...
  t[13] !== a || t[14] !== u
    ? ((x =
        a === `listening`
          ? (0, L.jsx)(`canvas`, { ref: u, className: `h-4 w-5 text-white`, "aria-hidden": `true` })
          : null),
      (t[13] = a),
      (t[14] = u),
      (t[15] = x))
  ...
  t[16] === f
    ? (S = t[17])
    : ((S = f ? (0, L.jsx)(l, { className: `icon-sm` }) : null), (t[16] = f), (t[17] = S));
  let C;
  t[18] === p
    ? (C = t[19])
    : ((C = p ? (0, L.jsx)(m, { className: `icon-sm` }) : null), (t[18] = p), (t[19] = C));
  let w;
  t[20] !== n || t[21] !== a
    ? ((w = a === `error` && !n ? (0, L.jsx)(h, { className: `icon-sm` }) : null),
      (t[20] = n),
      (t[21] = a),
      (t[22] = w))
    : (w = t[22]);
  ...
  t[25] === f
    ...
    : ((E = f
      ...
      (t[25] = f),
      (t[26] = E));
  let D = a === `error` && r != null ? r : null,
    O;
  t[27] !== E || t[28] !== D || t[29] !== T
    ? ((O = (0, L.jsxs)(`span`, { className: `sr-only`, children: [T, E, D] })),
      (t[27] = E),
      (t[28] = D),
      (t[29] = T),
      (t[30] = O))
...
export { O as i, A as n, D as r, R as t };
