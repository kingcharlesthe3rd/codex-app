...
import { i } from "./lib-1.js";
import { t as a } from "./globe.js";
import { t as o } from "./building.js";
import { t as s } from "./lock.js";
import { n as c } from "./appgen-access.js";
e(t());
var l = n(),
  u = (e) =>
    (0, l.jsx)(`svg`, {
...
function f(e) {
  ...
  let i;
  t[3] === n ? (i = t[4]) : ((i = c(n)), (t[3] = n), (t[4] = i));
  let { accessMode: f, groupCount: p, userCount: m } = i;
  switch (f) {
    case `admins_only`:
    case `custom`: {
      let e;
      return (
        t[5] !== p || t[6] !== r || t[7] !== m
          ? ((e = m > 0 || p > 0 ? (0, l.jsx)(u, { ...r }) : (0, l.jsx)(s, { ...r })),
            (t[5] = p),
            (t[6] = r),
            (t[7] = m),
            (t[8] = e))
    ...
    case `workspace_all`: {
      let e;
      return (
        t[9] === r ? (e = t[10]) : ((e = (0, l.jsx)(o, { ...r })), (t[9] = r), (t[10] = e)), e
      );
    }
    case `public`: {
      let e;
      return (
        t[11] === r ? (e = t[12]) : ((e = (0, l.jsx)(a, { ...r })), (t[11] = r), (t[12] = e)), e
      );
    }
  }
}
...
function y({ accessMode: e, groupCount: t, userCount: n }) {
  switch (e) {
    case `admins_only`:
    case `custom`:
      return n > 0 && t > 0
...
export { f as i, _ as n, v as r, g as t };
//# sourceMappingURL=appgen-access-state-messages.js.map
