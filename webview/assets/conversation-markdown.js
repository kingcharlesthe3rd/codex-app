...
import "./app-scope.js";
import { Ar as e, li as t, oi as n, ra as r } from "./app-server-manager-signals.js";
...
import { F as a, M as o, P as s } from "./rpc-1.js";
import "./statsig.js";
import "./request.js";
...
function m(n, r, a, o) {
  let s = [],
    c = n.cwd == null ? a : W(n.cwd),
    l =
      o == null
        ? void 0
        : (t) =>
            e({
              cwd: n.cwd ?? (r == null ? null : i(r)),
  ...
  let k = [],
    { renderableAgentItems: A } = re({
      agentItems: p,
      isTurnInProgress: n.status === `in_progress`,
