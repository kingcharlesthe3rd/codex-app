...
function y({ cwd: e = null, projectlessOutputDirectory: t = null, title: n, turns: r }) {
  let i = [],
    a = U(e);
...
function b(e, t, i, a) {
  let o = [],
            ...
            }),
    {
      ...
      c == null
        ? e.items
        : e.items.map((e) =>
            e.type === `assistant-message` ? { ...e, content: d(e.content, c) } : e,
          ),
      e.status,
    );
  ...
  let O = [],
    ...
    A = ne({
      units: oe({
        units: ee({ units: re(k), isActivitySliceClosed: u != null, conversationDetailLevel: Q }),
      }),
  ...
  (S != null && P(O, x(S, s)), C != null && P(O, x(C, s)), w != null && P(O, x(w, s)));
