...
function _(e, t) {
  ...
  let O = [],
    ...
    A = ee({
      units: o({
        units: ne({ units: ie(k), isActivitySliceClosed: a != null, conversationDetailLevel: u }),
      }),
...
function C(e) {
  let t = Object.entries(e.changes).flatMap(([e, t]) => {
    ...
    let i = Ae(r);
    return [I(`${ke(t.type)} ${J(e)} +${i.additions} -${i.deletions}`, Y(`diff`, r))];
  });
  return t.length === 0
    ? null
    : t.join(`
...
function le(e, t) {
  ...
  return Object.entries(e.changes).flatMap(([e, t]) => {
    ...
    let a = Ae(i);
    return [`${ue(t.type)} ${be(e, r)} (+${a.additions} -${a.deletions})`];
  });
}
function ue(e) {
  switch (e) {
