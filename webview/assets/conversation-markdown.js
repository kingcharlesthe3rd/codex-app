...
function fe(e, n, r, i) {
  let a = [],
            ...
            }),
    {
      ...
      personalityChangedItems: oe,
      forkedFromConversationItems: ce,
      ...
      c == null
        ? e.items
        : e.items.map((e) =>
            e.type === `assistant-message` ? { ...e, content: s(e.content, c) } : e,
          ),
      e.status,
    );
  for (let e of de) N(a, g(e, o));
  for (let e of l) N(a, pe(e, o));
  for (let e of fe) N(a, g(e, o));
  let T = [],
    { renderableAgentItems: E } = se({
      agentItems: d,
      isTurnInProgress: e.status === `in_progress`,
      isAnyNonAgentItemInProgress: p(u) || p(v),
    }),
    D = ne({
      units: ue({
        units: re({ units: ae(E), isActivitySliceClosed: u != null, conversationDetailLevel: Q }),
      }),
      isActivitySliceClosed: u != null,
    });
  for (let e of D) N(T, he(e, o));
  for (let e of te) N(T, g(e, o));
  h != null && N(T, g(h, o));
  for (let e of f) N(T, g(e, o));
  for (let e of m) N(T, g(e, o));
...
`),
    ...
    u != null && N(a, y(u, { pathContext: o })));
  for (let e of ie) N(a, g(e, o));
  for (let e of oe) N(a, g(e, o));
  for (let e of ce) N(a, g(e, o));
  return a.length === 0
    ? null
    : a.join(`
