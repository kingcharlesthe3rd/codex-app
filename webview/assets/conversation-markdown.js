...
function ue({ cwd: e = null, projectlessOutputDirectory: t = null, title: n, turns: r }) {
  let i = [],
    a = H(e);
  ...
  let a = [],
            ...
            }),
    {
      ...
      s == null
        ? e.items
        : e.items.map((e) =>
            e.type === `assistant-message` ? { ...e, content: d(e.content, s) } : e,
          ),
      e.status,
    );
  for (let e of ue) N(a, _(e, o));
  for (let e of c) N(a, fe(e, o));
  for (let e of de) N(a, _(e, o));
  let E = [],
    { renderableAgentItems: D } = se({
      agentItems: u,
      isTurnInProgress: e.status === `in_progress`,
      isAnyNonAgentItemInProgress: ce(l) || ce(y),
    }),
    O = le({
      units: ie({
        units: re({ units: te(D), isActivitySliceClosed: l != null, conversationDetailLevel: Q }),
      }),
      isActivitySliceClosed: l != null,
    });
  for (let e of O) N(E, me(e, o));
  for (let e of f) N(E, _(e, o));
  h != null && N(E, _(h, o));
  for (let e of p) N(E, _(e, o));
  for (let e of m) N(E, _(e, o));
  (v != null && N(E, _(v, o)), y != null && N(E, _(y, o)), x != null && N(E, _(x, o)));
  for (let e of S) N(E, _(e, o));
  for (let e of C) N(E, _(e, o));
  (w != null && N(E, _(w, o)),
    T != null && N(E, _(T, o)),
    E.length > 0 &&
      a.push(
...
`),
    ...
    l != null && N(a, b(l, { pathContext: o })));
  for (let e of g) N(a, _(e, o));
  for (let e of ae) N(a, _(e, o));
  for (let e of oe) N(a, _(e, o));
  return a.length === 0
    ? null
    : a.join(`
...
function fe(e, t) {
  let n = v(e, { pathContext: t });
  return n == null ? null : F(n);
}
function v(e, { escapeDetailsTags: t = !1, pathContext: n = $ } = {}) {
  let r = [],
...
function x(e) {
  ...
  return (
    t.push(Ve(e)),
    N(t, O(e.automaticApprovalReviews)),
    P(
      `Ran ${K(n)}`,
      t.join(`
...
`)
  ...
  let n = e.result.content.map(E).filter((e) => e.length > 0).join(`
...
`),
    ...
    return P(
      n,
      e.units.map((e) => he(e, t)).filter((e) => e != null).join(`
...
function k(e, t) {
  return e.kind !== `entry` || e.entry.kind !== `item`
    ...
    : e.entry.item.type === `exec`
      ? [`Ran ${G(ve(e.entry.item))}`, ..._e(e.entry.item.automaticApprovalReviews)]
      : e.entry.item.type === `patch`
        ? [...ye(e.entry.item, t), ..._e(e.entry.item.automaticApprovalReviews)]
        : [];
}
function _e(e) {
  return e == null
...
function ye(e, t) {
  ...
  return Object.entries(e.changes).flatMap(([e, t]) => {
    ...
    let a = Be(r);
    return [`${be(t.type)} ${Ae(e, n)} (+${a.additions} -${a.deletions})`];
  });
}
function be(e) {
  switch (e) {
...
`),
  ...
  return e.entry.kind === `exploration` ? xe(e.entry, t) : _(e.entry.item, t);
}
function xe(e, t) {
  let n = e.items
    .map((e) => Se(e, t))
...
export { ue as renderConversationMarkdown };
