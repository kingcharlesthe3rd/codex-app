...
import {
  ...
  t as re,
  u as ie,
} from "./split-items-into-render-groups-CtEE-Zkg.js";
var l = /::git-[a-z-]+\{[^}\n]*\}/g,
  u = `STEPS_PROSE`,
...
function C(e) {
  let t = Object.entries(e.changes).flatMap(([e, t]) => {
    ...
    let r = Ae(n);
    return [I(`${ke(t.type)} ${J(e)} +${r.additions} -${r.deletions}`, Y(`diff`, n))];
  });
  return t.length === 0
    ? null
    : t.join(`
...
function U(t, n, r) {
  ...
  let i = e(t),
    a = e(n);
  return i === a ? r : i.startsWith(`${a}/`) ? `${r}/${t.slice(n.length + 1)}` : null;
}
function W(e) {
  if (e == null) return d;
  let t = Se(e);
