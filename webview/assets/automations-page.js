...
import { Bt as c, U as l, r as u } from "./use-host-config.js";
import { Ea as d, M as f, at as p, f as m, st as h, tt as g } from "./thread-context-inputs.js";
import { A as _, h as v, r as y, s as b } from "./vscode-api.js";
import { i as x, r as S } from "./react.js";
import "./isEqual.js";
import { Bi as C, ai as w, t as T } from "./src.js";
import "./react-dom.js";
import { i as E, l as D, r as O, s as k } from "./lib-1.js";
import { t as A } from "./clsx.js";
import "./proxy.js";
import "./app-shell-state.js";
import { t as j } from "./app-shell-0b-x_r3Z.js";
...
import { t as te } from "./tooltip-B.js";
...
import { _ as ce, f as le, m as ue } from "./chunk-13.js";
import "./parse-directives.js";
import "./platform.js";
import "./persisted-signal.js";
import { c as de } from "./app-server-manager-hooks-D4-J16ZL.js";
import "./invalidate-queries-and-broadcast.js";
import { C as fe } from "./config-queries.js";
import "./selectable-remote-connections-signal.js";
import "./remote-connection-visibility.js";
import "./sidebar-signals.js";
import "./use-auth.js";
import "./use-global-state.js";
import { n as pe } from "./model-queries.js";
import { t as me } from "./use-model-settings.js";
import "./config.js";
...
import "./codex-api.js";
import { t as he } from "./use-debounced-value.js";
...
import { t as ge } from "./document-search.js";
import "./file.js";
...
import "./folder.js";
import "./json-2.js";
import { t as V } from "./notebook.js";
...
import { f as Ce } from "./sidebar-project-group-signals.js";
import "./sidebar-project-groups.js";
import "./_defineProperty.js";
import "./run-command.js";
import { t as we } from "./use-register-command-T-86rz-c.js";
import "./use-skills.js";
import "./initial-route-atom.js";
import { n as Te } from "./use-start-new-conversation.js";
import "./sites-color.js";
import "./composer-suggestion-list.js";
import { t as G } from "./use-navigate-to-local-conversation.js";
...
import { c as Ee } from "./links.js";
import { n as De } from "./thinking-shimmer.js";
import {
  a as Oe,
  c as ke,
  d as Ae,
...
import { t as ze } from "./unselected-circle.js";
import { t as q } from "./use-automation-history-items.js";
import { t as Be } from "./chat.js";
import { r as Ve, t as He } from "./dropdown.js";
import "./globe.js";
import "./three-dots.js";
import { t as Ue } from "./format-relative-date-time.js";
import "./worktree.js";
import { t as We } from "./archive.js";
import "./popover.js";
import { c as J, h as Ge, o as Ke } from "./automation-schedule.js";
import {
  C as qe,
  S as Je,
  a as Ye,
...
import "./conversation-starter-card-D5-kwyZS.js";
...
import { t as bt } from "./more-menu-trigger.js";
import { t as xt } from "./large-empty-state.js";
import { n as St } from "./settings-row.js";
import { t as Ct } from "./toolbar-breadcrumb.js";
import { t as wt } from "./animated-icon.js";
import "./tasks.js";
import "./star.js";
import { t as Tt } from "./worktree-environment-dropdown.js";
import { n as Et, t as Dt } from "./selectable-list-row.js";
import { t as Ot } from "./play-outline.js";
import { n as kt, t as Z } from "./sectioned-page.js";
var Q = r(),
  At = e(t(), 1);
function jt(e) {
  return { conversationId: w(e), hostId: u, source: `automation_history` };
}
function Mt(e) {
  return e.status !== `ARCHIVED` && e.status !== `IN_PROGRESS` && e.threadId != null;
}
async function Nt({ archiveThread: e, items: t }) {
  let n = t.filter(Mt).map((e) => e.threadId),
    r = await Promise.all(
      n.map(async (t) => {
        try {
          return (await e(t), !0);
          ...
          return (
            v.warning(`automation_history_archive_failed`, {
              safe: {},
...
function Pt(e) {
  ...
  t[0] === n
    ? (r = t[1])
    : ((r = A(`heading-xl font-normal text-token-foreground`, n)), (t[0] = n), (t[1] = r));
  let i;
...
function Ft(e) {
  ...
  let m;
  t[5] !== o || t[6] !== f
    ? ((m = (0, $.jsx)(Ve.Item, { LeftIcon: N, disabled: f, onSelect: o, children: p })),
      (t[5] = o),
      (t[6] = f),
      (t[7] = m))
    : (m = t[7]);
  ...
  t[10] === h
    ? (v = t[11])
    : ((v = (0, $.jsx)(Ve.Item, { LeftIcon: We, disabled: h, onSelect: g, children: _ })),
      (t[10] = h),
      (t[11] = v));
  let y;
  ...
  t[16] !== n || t[17] !== c || t[18] !== a
    ? ((b = (0, $.jsx)(It, { count: n, open: c, onConfirm: a, onOpenChange: l })),
      (t[16] = n),
      (t[17] = c),
      (t[18] = a),
      (t[19] = b))
  ...
  return (
    t[20] !== y || t[21] !== b
      ? ((x = (0, $.jsxs)($.Fragment, { children: [y, b] })), (t[20] = y), (t[21] = b), (t[22] = x))
      : (x = t[22]),
    x
  );
}
function It(e) {
  ...
  let l;
  t[7] !== s || t[8] !== c
    ? ((l = (0, $.jsx)(_e, { children: (0, $.jsx)(ve, { title: s, subtitle: c }) })),
      (t[7] = s),
      (t[8] = c),
      (t[9] = l))
    : (l = t[9]);
  ...
  t[13] === u
    ? (f = t[14])
    : ((f = (0, $.jsx)(M, { color: `ghost`, type: `button`, onClick: u, children: d })),
      (t[13] = u),
      (t[14] = f));
  let p;
  t[15] === n
  ...
  let m;
  t[17] !== f || t[18] !== p
    ? ((m = (0, $.jsx)(_e, { children: (0, $.jsxs)(xe, { children: [f, p] }) })),
      (t[17] = f),
      (t[18] = p),
      (t[19] = m))
    : (m = t[19]);
  ...
  t[20] !== o || t[21] !== l || t[22] !== m
    ? ((h = (0, $.jsxs)(be, { as: `form`, onSubmit: o, children: [l, m] })),
      (t[20] = o),
      (t[21] = l),
      (t[22] = m),
      (t[23] = h))
  ...
  return (
    t[24] !== a || t[25] !== r || t[26] !== h
      ? ((g = (0, $.jsx)(ye, { open: r, onOpenChange: a, size: `compact`, children: h })),
        (t[24] = a),
        (t[25] = r),
        (t[26] = h),
        (t[27] = g))
...
function zt({ automation: e, intl: t, formatRootLabel: n, threadLabelById: r }) {
  let i = t.formatMessage({
    ...
    a = Ke({ rrule: e.rrule, intl: t, fallbackMessage: i }) ?? i;
  return {
    workspaceLabel: C(e)
      ? (() => {
      ...
      : (() => {
          let r = e.cwds.map((e) => (n ? n(e) : T({ root: e, labels: {} })));
          return r.length > 0 ? t.formatList(r, { type: `conjunction` }) : null;
        })(),
    scheduleLabel: a,
  };
}
function Bt({ automations: e, intl: t, formatRootLabel: n, threadLabelById: r }) {
  let i = new Map();
  for (let a of e)
    i.set(a.id, zt({ automation: a, intl: t, formatRootLabel: n, threadLabelById: r }));
  return i;
}
function Vt(e) {
  let t = (0, Q.c)(69),
  ...
  if (c && v) {
    ...
    (t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(`span`, {
          ...
          children: (0, $.jsx)(`span`, { className: `size-2 rounded-full bg-token-charts-green` }),
        })),
        (t[0] = e))
      : (e = t[0]),
      (b = e));
    ...
    (t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(ee, { className: `icon-sm shrink-0 text-token-description-foreground` })),
        (t[1] = e))
      : (e = t[1]),
      (b = e));
  } else if (v) {
    let e = o ? `bg-token-text-link-foreground` : `bg-token-description-foreground`,
      n;
    t[2] === e ? (n = t[3]) : ((n = A(`size-2 rounded-full`, e)), (t[2] = e), (t[3] = n));
    let r;
    (t[4] === n
      ? (r = t[5])
      : ((r = (0, $.jsx)(`span`, {
          className: `icon-sm flex shrink-0 items-center justify-center`,
          children: (0, $.jsx)(`span`, { className: n }),
        })),
        (t[4] = n),
        (t[5] = r)),
      (b = r));
    ...
    (t[6] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(`span`, {
          className: `icon-sm flex shrink-0 items-center justify-center`,
          children: (0, $.jsx)(`span`, {
            className: `h-3.5 w-3.5 rounded-full bg-token-text-link-foreground`,
          }),
        })),
        (t[6] = e))
      : (e = t[6]),
    ...
    (t[7] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(mt, { className: `icon-sm shrink-0 text-token-description-foreground` })),
        (t[7] = e))
      : (e = t[7]),
      (b = e));
  } else {
    let e;
    (t[8] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(ze, { className: `icon-sm shrink-0 text-token-description-foreground` })),
        (t[8] = e))
      : (e = t[8]),
      (b = e));
  }
  let x;
  t[9] !== l || t[10] !== a
    ? ((x = a && !l ? (0, $.jsx)(`span`, { children: a }) : null),
      (t[9] = l),
      (t[10] = a),
      (t[11] = x))
    : (x = t[11]);
  ...
  let C;
  t[15] !== x || t[16] !== S
    ? ((C = (0, $.jsxs)(`span`, { className: `inline-flex items-center gap-2`, children: [x, S] })),
      (t[15] = x),
      (t[16] = S),
      (t[17] = C))
    : (C = t[17]);
  ...
  t[21] !== w || t[22] !== y
    ? ((E = (0, $.jsx)(`span`, {
        id: y,
        className: `text-right whitespace-nowrap group-focus-within:opacity-0 group-hover:opacity-0`,
        children: w,
      })),
      (t[21] = w),
      (t[22] = y),
  ...
  t[27] === d
    ? (O = t[28])
    : ((O = d
        ? (0, $.jsx)(ee, { className: `icon-sm` })
        : (0, $.jsx)(Ot, { className: `icon-sm` })),
      (t[27] = d),
      (t[28] = O));
  let j;
  t[29] !== u || t[30] !== D || t[31] !== O
    ? ((j = (0, $.jsx)(Ht, { disabled: u, label: Ut.runNow, onClick: D, children: O })),
      (t[29] = u),
      (t[30] = D),
      (t[31] = O),
      (t[32] = j))
  ...
  t[36] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, $.jsx)(H, { className: `icon-sm` })), (t[36] = N))
    : (N = t[36]);
  let te;
  t[37] === M
    ? (te = t[38])
    : ((te = (0, $.jsx)(Ht, { label: Ut.edit, onClick: M, children: N })),
      (t[37] = M),
      (t[38] = te));
  let P;
  t[39] !== n || t[40] !== l || t[41] !== h
    ? ((P =
        !l && h != null
          ? (0, $.jsx)(Ht, {
              label: Ut.pause,
    ...
    ? ((F =
        l && g != null
          ? (0, $.jsx)(Ht, {
              ...
              children: (0, $.jsx)(Y, { className: `icon-sm` }),
            })
          : null),
      (t[43] = n),
      (t[44] = l),
  ...
  t[47] !== n || t[48] !== _
    ? ((ne =
        _ == null
          ...
          : (0, $.jsx)(Ht, {
              ...
              children: (0, $.jsx)(X, { className: `icon-sm` }),
            })),
      (t[47] = n),
      (t[48] = _),
      (t[49] = ne))
    : (ne = t[49]);
  let re;
  t[50] !== te || t[51] !== P || t[52] !== F || t[53] !== ne || t[54] !== j
    ? ((re = (0, $.jsxs)(`span`, {
...
function Ht(e) {
  let t = (0, Q.c)(16),
    ...
    l = D(),
    u;
  t[0] === a ? (u = t[1]) : ((u = (0, $.jsx)(k, { ...a })), (t[0] = a), (t[1] = u));
  ...
  return (
    t[13] !== u || t[14] !== m
      ? ((h = (0, $.jsx)(te, { tooltipContent: u, children: m })),
        (t[13] = u),
        (t[14] = m),
        (t[15] = h))
      : (h = t[15]),
  ...
  let t = (0, Q.c)(19),
    {
      ...
      runningAutomationIds: a,
      selectedAutomationId: o,
      runNowPendingAutomationId: s,
      onSelectAutomation: c,
      onRunAutomationNow: l,
      onPauseAutomation: u,
      onResumeAutomation: d,
      onDeleteAutomation: f,
    } = e,
    p = D(),
    m;
  if (
    ...
    let e = n.filter(qt),
      ...
      y;
    t[13] !== _ || t[14] !== v
      ? ((y = [_, v].flatMap(Gt)), (t[13] = _), (t[14] = v), (t[15] = y))
      : (y = t[15]);
    let b = y,
      x;
    t[16] === p
                    ...
                    return (0, $.jsx)(
                      `div`,
                      {
                        ...
                        children: (0, $.jsx)(Vt, {
                          ...
                          hasUnreadRuns: i?.includes(e.id) === !0,
                          compactStatusDots: !0,
                          isInProgress: a.includes(e.id),
                          isPaused: !1,
                          isRunNowDisabled: g,
                          isRunNowPending: s === e.id,
                          isSelected: o === e.id,
                          onSelect: c,
                          onRunAutomationNow: l,
                          onPauseAutomation: u,
...
async function Jt({ queryClient: e, threadId: t }) {
  (await c(`unarchive-conversation`, { hostId: u, conversationId: w(t) }),
    await e.invalidateQueries({ queryKey: y(`inbox-items`, { limit: 200 }) }));
}
var Yt = `automation-form`;
function Xt() {
  let e = (0, Q.c)(7),
    t = o(Ge),
    { items: n, unreadRunCounts: r } = q(),
    i = t.data,
    a = t.isLoading,
    s;
  e[0] === i?.items ? (s = e[1]) : ((s = i?.items ?? []), (e[0] = i?.items), (e[1] = s));
  let c = r?.automationIds,
    l;
  return (
    e[2] !== n || e[3] !== a || e[4] !== s || e[5] !== c
      ? ((l = (0, $.jsx)(Zt, {
          automations: s,
...
function Zt({
  ...
  let c = a(s),
    ...
    A = le().state,
    [ee, N] = ce(),
    [te, P] = (0, At.useState)(!1),
    [ne, re] = (0, At.useState)(`codex`),
    [B, ue] = (0, At.useState)(!1),
    fe = (0, At.useRef)(null),
    [ge, V] = (0, At.useState)(() => lt),
    H = ee.get(`automationId`),
    U = ee.get(`automationMode`) ?? A?.automationMode,
    Se = U === `create` || U === `create-templates`,
    W = U === `create-templates`,
    G = H == null ? null : (e.find((e) => e.id === H) ?? null),
    Ee = S(at),
    De = x(at),
    Oe = x(tt),
    ke = x(Ye),
    { data: Ae } = pe(),
    Me = me({ hostId: u, cwd: null }),
    Ne = Ee != null && ((U === `create` && G == null) || (G != null && Ee.id === G.id)) ? Ee : null,
    K = it({
      draft:
        (Ne != null && Xe(ge) ? nt({ seed: Ne, targetAutomation: G, models: Ae?.models }) : null) ??
        (G != null && ge.id !== G.id ? Ze(G, Ae?.models) : ge),
      modelSettings: Me,
    }),
    { targetThreadId: Pe } = K,
    Fe = Pe == null ? null : w(Pe),
    Ie = i(g, Fe),
    Le = i(h, Fe),
    Re = i(p, Fe),
    ze = o(vt),
        ...
        let n = it({
          draft:
            G != null && t.id !== G.id
              ? Ze(G, Ae?.models)
              : Ne != null && Xe(t)
                ? nt({ seed: Ne, targetAutomation: G, models: Ae?.models })
                : t,
          modelSettings: Me,
        });
    ...
    { data: Be } = o(m),
    { data: Ve } = de(),
    He = new Map((Ve ?? []).map((e) => [String(e.id), l(e) ?? String(e.id)])),
    Ue = new Set((Ve ?? []).filter(d).map((e) => String(e.id))),
    We = Array.from(
      new Set(
        t.flatMap((e) =>
    ...
    qe = (e) =>
      e === `~`
        ...
        : T({ root: e, labels: Be?.labels ?? {} }),
    Qe = Bt({ automations: e, intl: f, formatRootLabel: qe, threadLabelById: He }),
    $e = [...e].sort((e, t) => {
      let n = e.nextRunAt ?? 1 / 0,
        r = t.nextRunAt ?? 1 / 0;
      return n === r ? e.name.localeCompare(t.name) : n - r;
    }),
    { trimmedName: et, trimmedPrompt: rt, canSave: st } = ot(K),
    dt = st && !(H != null && G == null && r),
    ft = Je(K),
    pt = H != null && G != null,
    mt = H != null && G == null && !r,
    Y =
      pt && st && ft != null && K.status !== `DELETED`
        ? ut({ draft: K, name: et, prompt: rt, status: K.status, rrule: ft })
        : null,
    X = he(Y, 600),
    ht = gn(fe.current, Y),
    gt = Y != null && G != null && !yn(G, Y),
    _t = () => {
      (De(null), Oe(!1));
    },
    bt = ({ automationId: e, automationMode: t, replace: n = !1 }) => {
      let r = new URLSearchParams(ee);
      if (
        (e == null ? r.delete(`automationId`) : r.set(`automationId`, e),
        t == null ? r.delete(`automationMode`) : r.set(`automationMode`, t),
        n)
      ) {
        N(r, { replace: !0, state: null });
        return;
      }
      N(r, { state: null });
    },
    ...
    St = () => {
      (re(`manual`), xt(), _t(), bt({ automationMode: `create` }));
    },
    Ct = () => {
      (xt(), _t(), bt({ automationMode: `create-templates` }));
    },
    wt = () => {
      (re(`codex`), je({ intl: f, startNewConversation: O }));
    },
    Tt = (e) => {
      (q(Ze(e, Ae?.models)), _t(), bt({ automationId: e.id }));
    },
    Et = (e) => {
      (q(Ze(e, Ae?.models)), _t(), P(!0));
    },
    Dt = () => {
      (_t(), bt({ replace: !0 }), xt());
    },
    Ot = () => {
      E.invalidateQueries({ queryKey: y(`list-automations`) });
    },
    kt = b(`automation-create`, {
      onSuccess: (e) => {
        (v.logProductEvent(L, {
          action: I.CODEX_AUTOMATION_ACTION_CREATED,
          source: R.CODEX_AUTOMATION_SOURCE_MANUAL_PAGE,
          success: !0,
          ...J(e.item),
        }),
          Ot(),
          Ne != null && ke({ directiveKey: Ne.directiveKey, automationId: e.item.id }),
          Dt(),
          se(c, ie, {}));
      },
      onError: (e, t) => {
        (v.logProductEvent(L, {
          ...
          success: !1,
          ...J(t),
          failureReason: z.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
        }),
          c
            .get(F)
            .danger(
    ...
    Z = b(`automation-update`, {
      onMutate: (e) => {
        let t = y(`list-automations`),
          n = E.getQueryData(t),
          r = K.id === e.id ? K.status : null;
        return (
          E.setQueryData(t, (t) =>
            t == null
              ? t
      ...
      onSuccess: (e) => {
        (v.logProductEvent(L, {
          action: I.CODEX_AUTOMATION_ACTION_UPDATED,
          source: R.CODEX_AUTOMATION_SOURCE_MANUAL_PAGE,
          success: !0,
          ...J(e.item),
        }),
          (fe.current = null),
          E.setQueryData(y(`list-automations`), (t) =>
        ...
        v.logProductEvent(L, {
          ...
          failureReason:
            ...
            `Automation does not exist in the app and could not be updated. It may have been deleted manually by the user.`
              ? z.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION
              : z.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
        });
        let r = _n(n);
        fe.current = hn(t);
        let i = r?.previousDraftStatus;
        (r?.previousAutomations != null &&
          E.setQueryData(y(`list-automations`), r.previousAutomations),
          i != null && K.id === t.id && q((e) => ({ ...e, status: i })),
          ue(!1),
          c
            .get(F)
            .danger(
    ...
    Q = b(`automation-delete`, {
      onSuccess: (t, n) => {
        let r = t.item ?? e.find((e) => e.id === n.id) ?? null;
        if (
          (v.logProductEvent(L, {
            action: I.CODEX_AUTOMATION_ACTION_DELETED,
            source: R.CODEX_AUTOMATION_SOURCE_MANUAL_PAGE,
            success: t.success,
            ...(r == null ? {} : J(r)),
            ...vn({ status: t.status, success: t.success }),
          }),
          !t.success)
        ) {
          (Ot(),
        ...
        (E.setQueryData(y(`list-automations`), (e) =>
    ...
    jt = b(`automation-run-now`, {
      onSuccess: (t, n) => {
        let r = e.find((e) => e.id === n.id) ?? null;
        (v.logProductEvent(L, {
          action: I.CODEX_AUTOMATION_ACTION_RUN_NOW,
          source: R.CODEX_AUTOMATION_SOURCE_MANUAL_PAGE,
          success: t.success,
          ...(r == null ? {} : J(r)),
        }),
    ...
    Mt = (e) => {
      if ((e.preventDefault(), dt && !(K.kind === `cron` && K.model == null))) {
        if (K.id != null) {
          if (K.status === `DELETED`) return;
          (ue(!0), Z.mutate(ut({ draft: K, name: et, prompt: rt, status: K.status, rrule: ft })));
          return;
        }
        kt.mutate(ct({ draft: K, name: et, prompt: rt, rrule: ft }));
      }
    },
    Nt = (e, t) => {
      Z.mutate(mn(e, t));
  ...
  return (
    ...
    (0, At.useEffect)(() => {
      !pt ||
        ...
        Q.isPending ||
        (ue(!0), Z.mutate(Y));
    }, [dt, kt.isPending, X, Q.isPending, Y, ht, gt, pt, B, Z, Z.isPending]),
    (0, $.jsxs)($.Fragment, {
      children: [
        (0, $.jsx)(j.Header, {
          children: (0, $.jsx)(Qt, {
            automationName: pt ? K.name : null,
            isDeletingAutomation: Q.isPending,
            isPaused: K.status === `PAUSED`,
            isRetrySavePending: B || Z.isPending,
            isRunNowPending: jt.isPending,
            isSaveRetryVisible: ht,
            isShowingDetail: pt,
            showTemplatesButton: e.length === 0 && !r,
            createMenuSelection: ne,
            onBackToAutomations: Dt,
            onCreateAutomationClick: St,
            onCreateAutomationWithCodex: wt,
            onDeleteAutomation: () => {
              P(!0);
            },
            onPauseAutomation: () => {
              K.id == null ||
                ft == null ||
                (q((e) => ({ ...e, status: `PAUSED` })),
                Z.mutate(ut({ draft: K, name: et, prompt: rt, status: `PAUSED`, rrule: ft })));
            },
            onRetrySave: () => {
              Y == null || Z.isPending || B || (ue(!0), Z.mutate(Y));
            },
            onResumeAutomation: () => {
              K.id == null ||
                ft == null ||
                (q((e) => ({ ...e, status: `ACTIVE` })),
                Z.mutate(ut({ draft: K, name: et, prompt: rt, status: `ACTIVE`, rrule: ft })));
            },
            onRunNow: () => {
              if (K.id == null) return;
              let e = K.kind === `heartbeat` && Pe != null ? Ie : null;
              jt.mutate({
                id: K.id,
                collaborationMode: e,
                permissions: K.kind === `heartbeat` && Fe != null ? yt(Le, Re, ze?.[Fe]) : null,
              });
            },
            onTemplatesClick: Ct,
          }),
            ...
            (0, $.jsx)(`div`, {
              ...
              children: pt
                ? (0, $.jsx)(rn, {
                    ...
                    setDraft: q,
                    canSave: dt,
                    isSaving: kt.isPending || Z.isPending,
                    isSavePending: B,
                    selectedAutomation: G,
                    roots: Ge,
                    formatRootLabel: qe,
                    workspaceGroups: Ke,
                ...
                : mt
                  ? (0, $.jsx)(en, { onBackToAutomations: Dt })
                  : e.length === 0
                    ? (0, $.jsx)(tn, {
                        isLoading: r,
...
function Qt(e) {
  ...
  t[9] === E
    ? (O = t[10])
    : ((O = (0, $.jsx)(`div`, { className: `min-w-0 text-base`, children: E })),
      (t[9] = E),
      (t[10] = O));
  let A;
  t[11] !== C ||
...
function tn(e) {
    ...
    return (
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsxs)(`div`, {
            ...
            children: [
              (0, $.jsx)(wt, { animation: `automation`, size: `sm` }),
              (0, $.jsx)(k, {
  ...
  t[10] === l
    ? (f = t[11])
    : ((f = (0, $.jsxs)(M, { color: `outline`, size: `medium`, onClick: l, children: [u, d] })),
      (t[10] = l),
      (t[11] = f));
  let p;
  t[12] !== i || t[13] !== r
  ...
  t[17] === p
    ? (g = t[18])
    : ((g = (0, $.jsxs)(M, { color: `outline`, size: `medium`, onClick: p, children: [m, h] })),
      (t[17] = p),
      (t[18] = g));
  let _;
  t[19] !== i || t[20] !== r
...
function an(e) {
  ...
  let h;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = { onPointerDownOutside: on }), (t[2] = h))
    : (h = t[2]);
  let g;
  t[3] !== o ||
  t[4] !== r ||
...
function sn(e) {
  let t = (0, Q.c)(171),
    ...
    { data: ee } = i(fe, o(f)),
    N = re(`1488233300`),
    { options: P, hasPinnedThreads: F } = Re(r.targetThreadId),
    I = ee?.config.sandbox_mode === `read-only`,
    L = ee?.config.sandbox_mode === `danger-full-access`,
    R;
  t[0] !== s || t[1] !== r || t[2] !== l
    ? ((R = s || l ? null : (0, $.jsx)(Ae, { draft: r, action: `create` })),
      (t[0] = s),
      (t[1] = r),
      (t[2] = l),
      (t[3] = R))
    : (R = t[3]);
  let z = R,
    ie = r.name.length > 0 || r.prompt.length > 0,
    B;
  t[4] !== m || t[5] !== p || t[6] !== h
    ? ((B = _t({ workspaceGroups: h, roots: p, formatRootLabel: m })),
      (t[4] = m),
      (t[5] = p),
      (t[6] = h),
      (t[7] = B))
  ...
  let ae = B,
    oe = b?.nextRunAt ?? null,
    se;
  t[8] !== r.status || t[9] !== S || t[10] !== oe
    ? ((se = qe({ intl: S, nextRunAt: oe, status: r.status })),
      (t[8] = r.status),
      (t[9] = S),
      (t[10] = oe),
      (t[11] = se))
  ...
  t[12] !== S || t[13] !== b
    ? ((le =
        b?.lastRunAt == null
          ...
          : bn({ timestamp: b.lastRunAt, intl: S })),
      (t[12] = S),
      (t[13] = b),
      (t[14] = le))
    : (le = t[14]);
  ...
  let ge = he,
    V = r.kind === `heartbeat`,
    H;
  t[19] === r ? (H = t[20]) : ((H = ft(r)), (t[19] = r), (t[20] = H));
  let U = H,
    ve;
  t[21] === r ? (ve = t[22]) : ((ve = Qe(r)), (t[21] = r), (t[22] = ve));
  let ye = ve,
    W = !V && !U && ye === `worktree` && r.cwds.length === 1 ? r.cwds[0] : null,
    Ce;
  t[23] !== N || t[24] !== b
    ? ((Ce =
        b == null ? rt({ allowThreadDestination: N }) : C(b) ? [`thread`] : [`local`, `worktree`]),
      (t[23] = N),
      (t[24] = b),
      (t[25] = Ce))
    : (Ce = t[25]);
  let we = Ce,
    Te;
  t[26] === W ? (Te = t[27]) : ((Te = { hostId: u, workspaceRoot: W }), (t[26] = W), (t[27] = Te));
  let { environments: G, isLoading: Ee, error: De } = pt(Te),
    je;
  t[28] !== b || t[29] !== a
    ? ((je = (e) => {
        (b != null && C(b) !== (e === `thread`)) || a((t) => $e(t, e));
      }),
      (t[28] = b),
      (t[29] = a),
      (t[30] = je))
  ...
  t[33] === a
    ? (q = t[34])
    : ((q = (e) => {
        a((t) => ({ ...t, localEnvironmentConfigPath: e }));
      }),
      (t[33] = a),
      (t[34] = q));
  let Be = q,
    Ve;
  t[35] !== r.localEnvironmentConfigPath || t[36] !== W || t[37] !== w
    ? ((Ve = () => {
        if (W == null) {
          w(`/settings/local-environments`);
          return;
        }
        let e = new URLSearchParams({ workspaceRoot: W });
        (r.localEnvironmentConfigPath != null && e.set(`configPath`, r.localEnvironmentConfigPath),
          w(`/settings/local-environments?${e.toString()}`));
      }),
      (t[35] = r.localEnvironmentConfigPath),
      (t[36] = W),
      (t[37] = w),
      (t[38] = Ve))
    : (Ve = t[38]);
  ...
  t[39] === a
    ? (Ue = t[40])
    : ((Ue = (e) => {
        a((t) => dt({ draft: t, threadId: e.threadId, title: e.title }));
      }),
      (t[39] = a),
      (t[40] = Ue));
  let We = Ue,
  ...
  t[43] === a
    ? (Ke = t[44])
    : ((Ke = (e, t) => {
        a((n) => ({ ...n, model: e, reasoningEffort: t }));
      }),
      (t[43] = a),
      (t[44] = Ke));
  let Je = Ke,
  ...
  t[45] === Ye
    ? (Xe = t[46])
    : ((Xe = A(`min-h-0 flex-1 overflow-hidden`, Ye)), (t[45] = Ye), (t[46] = Xe));
  let Ze;
  t[47] !== j ||
  t[48] !== r.name ||
  t[49] !== ie ||
  ...
  t[54] !== x
    ? ((Ze = T
                ...
                (0, $.jsxs)(`div`, {
                  ...
                  children: [
                    ie
                      ...
                      : null,
                    (0, $.jsx)(Oe, { isReadOnlySandbox: I, isDangerFullAccess: L }),
                    x,
                  ],
                }),
              ],
      ...
      (t[55] = Ze))
    : (Ze = t[55]);
  let tt = T ? `!pt-0 h-full overflow-hidden` : `overflow-y-auto`,
    nt;
  t[56] === tt ? (nt = t[57]) : ((nt = A(`min-h-0 flex-1`, tt)), (t[56] = tt), (t[57] = nt));
  let it = T && `h-full flex-1 flex-row items-stretch gap-0`,
    at;
  t[58] === it
    ? (at = t[59])
    : ((at = A(`flex min-h-0 flex-col gap-6`, it)), (t[58] = it), (t[59] = at));
  let ot = T && `overflow-y-auto p-panel pb-8`,
    st;
  t[60] === ot
    ? (st = t[61])
    : ((st = A(`min-h-0 min-w-0 flex flex-1 justify-center`, ot)), (t[60] = ot), (t[61] = st));
  let ct;
  t[62] !== r.name || t[63] !== T || t[64] !== g
    ? ((ct = T
        ? (0, $.jsx)(`div`, {
            className: `px-3`,
            children: (0, $.jsx)(`div`, {
  ...
  let lt = T && `pl-3 pb-8`,
    ut;
  t[66] === lt ? (ut = t[67]) : ((ut = A(lt)), (t[66] = lt), (t[67] = ut));
  let mt;
  t[68] === N
    ? (mt = t[69])
    : ((mt = N ? [`cron`, `heartbeat`] : [`cron`]), (t[68] = N), (t[69] = mt));
  let Y;
  t[70] !== s ||
  t[71] !== r ||
  t[72] !== m ||
  ...
  let X;
  t[83] !== ut || t[84] !== Y
    ? ((X = (0, $.jsx)(`div`, { className: ut, children: Y })),
      (t[83] = ut),
      (t[84] = Y),
      (t[85] = X))
    : (X = t[85]);
  ...
  let vt;
  t[89] !== st || t[90] !== ht
    ? ((vt = (0, $.jsx)(`div`, { className: st, children: ht })),
      (t[89] = st),
      (t[90] = ht),
      (t[91] = vt))
    : (vt = t[91]);
  ...
  t[93] !== we ||
  t[94] !== r.cwds ||
  t[95] !== r.localEnvironmentConfigPath ||
  t[96] !== r.model ||
  t[97] !== r.reasoningEffort ||
  t[98] !== r.scheduleConfig ||
  t[99] !== r.status ||
  t[100] !== r.targetThreadId ||
  t[101] !== m ||
  t[102] !== K ||
  t[103] !== Be ||
  t[104] !== Je ||
  ...
  t[126] !== ae
          ...
          ? (0, $.jsxs)(ln, {
              ...
              children: [
                ...
                (0, $.jsx)(St, {
                  ...
                  variant: `compact`,
                  children: (0, $.jsx)(fn, { status: r.status }),
                }),
                (0, $.jsx)(St, {
                  label: S.formatMessage({
                ...
                V
                  ? (0, $.jsx)(St, {
                      ...
                      variant: `compact`,
                      children: (0, $.jsx)(ke, {
                        selectedThreadId: r.targetThreadId,
                        options: P,
                        hasPinnedThreads: F,
                        align: `end`,
                        className: `!text-base`,
                        ...
                        ye === `worktree` && W != null
                          ? (0, $.jsx)(St, {
                              ...
                              children: (0, $.jsx)(Tt, {
                                ...
                                isLoading: Ee,
                                hasError: De != null,
                                selectedConfigPath: r.localEnvironmentConfigPath,
                                onSelectConfigPath: Be,
                                onOpenSettings: He,
                              }),
                            })
                          : null,
                ...
                (0, $.jsx)(St, {
                  ...
                  variant: `compact`,
                  children: (0, $.jsx)(Ne, {
                    scheduleMode: r.scheduleConfig.mode,
                    scheduleConfig: r.scheduleConfig,
                    align: `end`,
                    className: `!text-base`,
                    showIcon: !1,
                    intervalStyle: V ? `heartbeat` : `default`,
                    onUpdateScheduleDraft: Ge,
                  }),
                }),
                V
                  ? null
                ...
                V
                  ...
                  : (0, $.jsx)($.Fragment, {
                      children: (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(un, { automationId: b.id, formatRootLabel: m }),
                      }),
                    }),
              ],
            })
    ...
    : (yt = t[127]);
  let bt;
  t[128] !== at || t[129] !== vt || t[130] !== yt
    ? ((bt = (0, $.jsxs)(`div`, { className: at, children: [vt, yt] })),
      (t[128] = at),
      (t[129] = vt),
      (t[130] = yt),
      (t[131] = bt))
    : (bt = t[131]);
  let xt;
  t[132] !== j || t[133] !== nt || t[134] !== bt
    ? ((xt = (0, $.jsx)(j, { className: nt, children: bt })),
      (t[132] = j),
      (t[133] = nt),
      (t[134] = bt),
      (t[135] = xt))
  ...
  t[141] !== r.cwds ||
  t[142] !== r.model ||
  t[143] !== r.reasoningEffort ||
  t[144] !== r.scheduleConfig ||
  t[145] !== r.targetThreadId ||
  t[146] !== K ||
  t[147] !== Je ||
  t[148] !== ze ||
  t[149] !== Ge ||
  ...
  let wt;
  return (
    t[165] !== O || t[166] !== Xe || t[167] !== Ze || t[168] !== xt || t[169] !== Ct
      ? ((wt = (0, $.jsxs)(O, { className: Xe, children: [Ze, xt, Ct] })),
        (t[165] = O),
        (t[166] = Xe),
        (t[167] = Ze),
        (t[168] = xt),
...
function ln(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = A(`border-token-border flex h-full w-96 shrink-0 self-stretch flex-col`, n)),
      (t[0] = n),
      (t[1] = i));
  let a;
  t[2] === r
...
function un({ automationId: e, formatRootLabel: t }) {
  let n = D(),
    r = a(s),
    [i, o] = (0, At.useState)(!1),
    u = G(),
    { data: f } = de(),
    { items: p, isLoading: m, markRead: h, markUnread: g } = q(),
    _ = new Map((f ?? []).map((e) => [String(e.id), l(e)])),
    v = new Set((f ?? []).filter(d).map((e) => String(e.id))),
    b = p.filter((t) => t.automationId === e).sort((e, t) => t.createdAt - e.createdAt),
    x = b.some((e) => e.readAt == null),
    S = b.filter(Mt).length,
    C = async (e) => {
      try {
        await Jt({ queryClient: r.queryClient, threadId: e });
      } catch {
        r.get(F).danger(
          n.formatMessage({
    ...
    T = async (e) => {
      await c(`archive-conversation`, jt(e));
    },
    E = () => {
      r.queryClient.invalidateQueries({ queryKey: y(`inbox-items`, { limit: 200 }) });
    },
    O = async (e) => {
      try {
        (await T(e), E());
    ...
    A = async () => {
      if (!(S === 0 || i)) {
        o(!0);
        try {
          let { failedCount: e, succeededCount: t } = await Nt({ items: b, archiveThread: T });
          if ((E(), e === 0)) {
            r.get(F).success(
              n.formatMessage(
                {
    ...
    (j =
      m && b.length === 0
        ? (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(ee, { className: `icon-sm text-token-description-foreground` }),
          })
        : b.length === 0
          ? (0, $.jsx)(`div`, {
          ...
          : (0, $.jsx)(`div`, {
              ...
              children: b.map((e) =>
                (0, $.jsx)(
                  ...
                  {
                    item: e,
                    conversationTitle: e.threadId == null ? null : (_.get(e.threadId) ?? null),
                    formatRootLabel: t,
                    isRunning: e.threadId != null && v.has(e.threadId),
                    onArchive: O,
                    onMarkRead: h,
                    onMarkUnread: g,
                    onUnarchive: (e) => {
  ...
  let l = D(),
    ...
    S = r
      ...
      : g
        ...
        : h
          ? (0, $.jsx)(We, { className: `icon-xs shrink-0 text-token-disabled-foreground` })
          : (0, $.jsx)(`span`, {
      ...
      children: (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, $.jsxs)(`div`, {
              className: A(`flex min-w-0 flex-1 items-center gap-2`, b && `opacity-50`),
              children: [
                (0, $.jsx)(`div`, {
                ...
                (0, $.jsx)(`div`, {
                  ...
                  children: (0, $.jsx)(`span`, {
                    ...
                    children: (0, $.jsx)(Ue, { dateString: new Date(e.createdAt).toISOString() }),
                  }),
                }),
              ],
            }),
    ...
    i =
      n === `ACTIVE`
        ...
        : n === `PAUSED`
          ...
          : `bg-token-charts-red`,
    a;
  t[0] === i ? (a = t[1]) : ((a = A(`size-2 rounded-full`, i)), (t[0] = i), (t[1] = a));
  let o;
...
function pn(e) {
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, $.jsx)(X, { className: `icon-sm` })), (t[11] = g))
    : (g = t[11]);
  let _;
...
function vn({ status: e, success: t }) {
  let n;
  if (
    (e === `deleted`
      ? (n = B.CODEX_AUTOMATION_DELETE_STATUS_DELETED)
      : e === `not_found` && (n = B.CODEX_AUTOMATION_DELETE_STATUS_NOT_FOUND),
    t || e === `deleted`)
  )
  ...
  switch (e) {
    case `not_found`:
      return {
        deleteStatus: n,
        failureReason: z.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION,
      };
    case `invalid_id`:
      return { failureReason: z.CODEX_AUTOMATION_FAILURE_REASON_INVALID_ID };
    case `store_unavailable`:
      return { failureReason: z.CODEX_AUTOMATION_FAILURE_REASON_STORAGE_UNAVAILABLE };
    case `state_cleanup_failed`:
      return { failureReason: z.CODEX_AUTOMATION_FAILURE_REASON_STATE_CLEANUP_FAILED };
    case `remove_failed`:
      return { failureReason: z.CODEX_AUTOMATION_FAILURE_REASON_REMOVE_FAILED };
  }
}
function yn(e, t) {
  return t.status === `DELETED` ? !1 : gn(mn(e, t.status), t);
}
function bn({ timestamp: e, intl: t }) {
  let n = new Date(e),
    r = xn(n, new Date()),
...
export { Xt as AutomationsLayoutPage };
