...
import { k as c, r as l, s as u } from "./vscode-api.js";
import { i as d, r as f } from "./react.js";
import "./isEqual.js";
import { Lr as p, gi as m, mi as h, t as g, vi as _ } from "./src-4.js";
import {
  B as v,
  K as y,
  W as b,
...
import "./react-dom.js";
import { c as ee, n as te, o as w } from "./lib-1.js";
import {
  A as T,
  D as E,
  I as D,
...
import { t as R } from "./context-menu.js";
import "./rpc-2.js";
import { o as re } from "./statsig-DoZ-0xit.js";
import "./request.js";
import "./platform.js";
...
import { w as V } from "./config-queries-BHYT-TjG.js";
...
import "./clock.js";
import "./core.esm.js";
import { _ as se, f as ce, m as le } from "./chunk-8.js";
...
function Mt({ automation: e, intl: t, formatRootLabel: n, threadLabelById: r }) {
  ...
  return {
    workspaceLabel: _(e)
      ...
      : (() => {
          let r = e.cwds.map((e) => (n ? n(e) : g({ root: e, labels: {} })));
...
function Vt({ automations: e, unreadAutomationIds: t, isAutomationsLoading: n }) {
  let r = a(s),
    ...
    { data: qe } = o(B),
    { data: Je } = z(),
    Ye = new Map((Je ?? []).map((e) => [String(e.id), x(e) ?? String(e.id)])),
    Xe = qe?.roots ?? [],
    Ze = o(ye),
    Qe = (e) =>
      e === `~`
        ...
        : g({ root: e, labels: qe?.labels ?? {} }),
    $e = Nt({ automations: e, intl: m, formatRootLabel: Qe, threadLabelById: Ye }),
    et = [...e].sort((e, t) => {
    ...
    wt = () => {
      S.invalidateQueries({ queryKey: l(`list-automations`) });
    },
    Tt = u(`automation-create`, {
      onSuccess: (e) => {
        (h.logProductEvent(T, {
    ...
    Y = u(`automation-update`, {
      onMutate: (e) => {
        let t = l(`list-automations`),
          n = S.getQueryData(t),
      ...
      onSuccess: (e) => {
        (h.logProductEvent(T, {
          ...
          (oe.current = null),
          S.setQueryData(l(`list-automations`), (t) =>
      ...
      onError: (e, t, n) => {
        ...
        (i?.previousAutomations != null &&
          S.setQueryData(l(`list-automations`), i.previousAutomations),
    ...
    Et = u(`automation-delete`, {
      onSuccess: (t, n) => {
        ...
        (S.setQueryData(l(`list-automations`), (e) =>
                  ...
                  : e.length === 0
                    ...
                    : (0, $.jsx)(Ft, {
                        ...
                        onRunAutomationNow: (e) => {
                          if (_(e)) {
                            let t = p(e.targetThreadId),
                              n = r.get(v, t);
                            if (n == null) return;
                            X.mutate({
                              id: e.id,
                              collaborationMode: n,
                              permissions: _t(r.get(y, t), r.get(b, t), Ke?.[t]),
                            });
                            return;
                          }
...
function Xt(e) {
  ...
  let se = oe,
    ...
    ue;
  t[4] !== f || t[5] !== d || t[6] !== p
    ? ((ue = ht({ workspaceGroups: p, roots: d, formatRootLabel: f })),
      (t[4] = f),
      (t[5] = d),
      (t[6] = p),
      (t[7] = ue))
  ...
  t[12] !== T || t[13] !== x
    ? ((he =
        x?.lastRunAt == null
          ...
          : pn({ timestamp: x.lastRunAt, intl: T })),
      (t[12] = T),
      (t[13] = x),
      (t[14] = he))
    : (he = t[14]);
  ...
  t[23] !== N || t[24] !== x
    ? ((Oe =
        x == null ? Pe({ allowThreadDestination: N }) : _(x) ? [`thread`] : [`local`, `worktree`]),
      (t[23] = N),
      (t[24] = x),
      (t[25] = Oe))
    : (Oe = t[25]);
  ...
  t[26] === De
    ? (Ne = t[27])
    : ((Ne = { hostId: S, workspaceRoot: De }), (t[26] = De), (t[27] = Ne));
  let { environments: Fe, isLoading: Ie, error: Le } = et(Ne),
    K;
  t[28] !== x || t[29] !== a
    ? ((K = (e) => {
        (x != null && _(x) !== (e === `thread`)) || a((t) => Ae(t, e));
      }),
      (t[28] = x),
      (t[29] = a),
      (t[30] = K))
  ...
  t[43] !== D?.models || t[44] !== a
    ? ((Ze = (e) => {
        a((t) => ({
          ...t,
          model: e,
          reasoningEffort: m({ model: h(D?.models ?? [], e), reasoningEffort: t.reasoningEffort }),
        }));
      }),
      (t[43] = D?.models),
      (t[44] = a),
                  ...
                  : (0, $.jsxs)($.Fragment, {
                      children: [
                        ...
                        (0, $.jsx)(`div`, {
                          ...
                          children: (0, $.jsx)(en, { automationId: x.id, formatRootLabel: f }),
                        }),
                      ],
                    }),
              ],
