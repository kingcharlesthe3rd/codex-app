...
import { _ as A, f as ne, m as j } from "./chunk-8.js";
import "./known-app-icon.js";
import "./branch.js";
import "./github-mark.js";
import "./google-drive.js";
import "./notion.js";
import { r as M, t as re } from "./product-logger.js";
import "./rpc.js";
import { o as N } from "./statsig.js";
import "./request.js";
import { c as P } from "./app-server-manager-hooks-DfDI-9lO.js";
import "./use-global-state.js";
import "./invalidate-queries-and-broadcast.js";
import { u as ie } from "./thread-context-inputs.js";
import { C as F } from "./config-queries.js";
...
import { t as ae } from "./use-debounced-value.js";
...
import { a as le, i as ue, l as de, n as fe, r as pe, t as me } from "./dialog-layout.js";
...
import { u as _e } from "./sidebar-project-group-signals.js";
import "./pinned-threads-query.js";
import "./sidebar-project-groups-Bs-6klyU.js";
import "./_defineProperty.js";
import { t as ve } from "./use-register-command-D7-mciT3.js";
...
import "./globe.js";
import "./popover.js";
import { t as Te } from "./archive.js";
...
import { t as ke } from "./notebook.js";
...
import { t as K } from "./automation-queries.js";
import "./use-is-background-subagents-enabled-B.js";
import "./local-environments.js";
import { r as je } from "./local-environment-selection.js";
import "./laptop.js";
import "./sortBy.js";
...
import {
  ...
  t as Xe,
  u as Ze,
} from "./automation-dialog-CF-eu0qk.js";
import { c as q, o as Qe } from "./automation-schedule.js";
import {
  S as $e,
  a as et,
  b as tt,
...
import { t as wt } from "./settings-host-dropdown.js";
import { n as Tt, t as Et } from "./sectioned-page.js";
var Z = e(v()),
  Q = k(),
  $ = y();
function Dt(e) {
  ...
  t[0] === n
    ? (r = t[1])
    : ((r = b(`heading-xl font-normal text-token-foreground`, n)), (t[0] = n), (t[1] = r));
  let i;
...
function kt({ automation: e, intl: n, formatRootLabel: i, threadLabelById: a }) {
...
function At({ automations: e, intl: t, formatRootLabel: n, threadLabelById: r }) {
  let i = new Map();
  for (let a of e)
    i.set(a.id, kt({ automation: a, intl: t, formatRootLabel: n, threadLabelById: r }));
  return i;
}
function jt(e) {
  let t = (0, Q.c)(87),
  ...
  t[3] !== o || t[4] !== s
    ? ((T = o
        ? (0, $.jsx)(z, { className: `icon-sm shrink-0 text-token-description-foreground` })
        : s
          ? (0, $.jsx)(ge, { className: `icon-sm shrink-0 text-token-description-foreground` })
  ...
  t[8] === O
    ? (k = t[9])
    : ((k = b(`flex shrink-0 items-center text-base text-token-description-foreground`, O)),
      (t[8] = O),
      (t[9] = k));
  let A;
  ...
  t[14] === ne
    ? (j = t[15])
    : ((j = b(`relative inline-flex justify-end`, ne)), (t[14] = ne), (t[15] = j));
  let M;
  ...
  t[28] === l
    ? (I = t[29])
    : ((I = l ? (0, $.jsx)(z, { className: `icon-sm` }) : (0, $.jsx)(Ct, { className: `icon-sm` })),
      (t[28] = l),
      (t[29] = I));
  let ae;
  ...
  let be = H,
    xe;
  return (
    t[80] !== r || t[81] !== S || t[82] !== u || t[83] !== te || t[84] !== be || t[85] !== D
      ? ((xe = (0, $.jsx)(St, {
          ariaLabel: r,
...
function Rt({ automations: e, isAutomationsLoading: n }) {
  let i = T(C),
    ...
    W = qe(U?.models),
    Te =
      xe != null && ((ge === `create` && H == null) || (H != null && xe.id === H.id)) ? xe : null,
    G = lt({
      draft:
        (Te != null && tt(B) ? st({ seed: Te, targetAutomation: H, models: U?.models }) : null) ??
        (H != null && B.id !== H.id ? nt(H, U?.models) : B),
      modelSettings: W,
    }),
    { targetThreadId: Ee } = G,
    ...
    Le = At({ automations: e, intl: s, formatRootLabel: Ie, threadLabelById: Ne }),
    Re = [...e].sort((e, t) => {
    ...
    bt = D(`automation-create`, {
      onSuccess: (e) => {
        (h.trackStructuredEvent(o, {
          ...
          J(),
          Te != null && we({ directiveKey: Te.directiveKey, automationId: e.item.id }),
          _t(),
    ...
    St = (e) => {
      if ((e.preventDefault(), He && !(G.kind === `cron` && G.model == null))) {
        if (G.id != null) {
          ...
          (oe(!0), Y.mutate(ht({ draft: G, name: ze, prompt: Be, status: G.status, rrule: Ue })));
          return;
        }
          ...
          children: (0, $.jsx)(zt, {
            ...
            onPauseAutomation: () => {
              G.id == null ||
                Ue == null ||
                (K((e) => ({ ...e, status: `PAUSED` })),
                Y.mutate(ht({ draft: G, name: ze, prompt: Be, status: `PAUSED`, rrule: Ue })));
            },
            onRetrySave: () => {
            ...
            onResumeAutomation: () => {
              G.id == null ||
                Ue == null ||
                (K((e) => ({ ...e, status: `ACTIVE` })),
                Y.mutate(ht({ draft: G, name: ze, prompt: Be, status: `ACTIVE`, rrule: Ue })));
            },
            onRunNow: () => {
              if (G.id == null) return;
              ...
              X.mutate({
                id: G.id,
                collaborationMode: e,
                permissions: G.kind === `heartbeat` && De != null ? yt(ke, Ae?.[De]) : null,
              });
            },
            onTemplatesClick: at,
          }),
...
function Ht(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, $.jsx)(Y, { animation: `automation`, showFallbackWhileLoading: !1, size: `fill` })),
      (t[3] = s))
    : (s = t[3]);
  let c;
  ...
  t[10] === l
    ? (f = t[11])
    : ((f = (0, $.jsxs)(R, { color: `outline`, size: `medium`, onClick: l, children: [u, d] })),
      (t[10] = l),
      (t[11] = f));
  let p;
  t[12] !== i || t[13] !== r
  ...
  t[17] === p
    ? (g = t[18])
    : ((g = (0, $.jsxs)(R, { color: `outline`, size: `medium`, onClick: p, children: [m, h] })),
      (t[17] = p),
      (t[18] = g));
  let _;
  t[19] !== i || t[20] !== r
  ...
  t[24] === _
    ? (b = t[25])
    : ((b = (0, $.jsxs)(R, { color: `outline`, size: `medium`, onClick: _, children: [v, y] })),
      (t[24] = _),
      (t[25] = b));
  let x;
  return (
...
function qt(e) {
  ...
  let De = Ee,
    ke = !W && !G && De === `worktree` && o.cwds.length === 1 ? o.cwds[0] : null,
    Ae;
  r[23] !== P || r[24] !== S
    ? ((Ae =
        S == null ? ct({ allowThreadDestination: P }) : t(S) ? [`thread`] : [`local`, `worktree`]),
      (r[23] = P),
      (r[24] = S),
      (r[25] = Ae))
    : (Ae = r[25]);
  ...
  r[43] !== O?.models || r[44] !== s
    ? ((ut = (e) => {
        s((t) => ({
          ...t,
          model: e,
          reasoningEffort: i({ model: n(O?.models ?? [], e), reasoningEffort: t.reasoningEffort }),
        }));
      }),
      (r[43] = O?.models),
      (r[44] = s),
  ...
  r[48] === mt
    ? (ht = r[49])
    : ((ht = b(`min-h-0 flex-1 overflow-hidden`, mt)), (r[48] = mt), (r[49] = ht));
  let vt;
  r[50] !== M ||
  r[51] !== o.name ||
  r[52] !== he ||
                ...
                (0, $.jsxs)(`div`, {
                  ...
                  children: [
                    he
                      ...
                      : null,
                    (0, $.jsx)(Ke, { isReadOnlySandbox: ce, isDangerFullAccess: B }),
                    C,
                  ],
                }),
              ],
  ...
  let yt = k ? `!pt-0 h-full overflow-hidden` : `overflow-y-auto`,
    bt;
  r[59] === yt ? (bt = r[60]) : ((bt = b(`min-h-0 flex-1`, yt)), (r[59] = yt), (r[60] = bt));
  let Y = k && `h-full flex-1 flex-row items-stretch gap-0`,
    X;
  r[61] === Y ? (X = r[62]) : ((X = b(`flex min-h-0 flex-col gap-6`, Y)), (r[61] = Y), (r[62] = X));
  let St = k && `overflow-y-auto p-panel pb-8`,
    Ct;
  r[63] === St
    ? (Ct = r[64])
    : ((Ct = b(`min-h-0 min-w-0 flex flex-1 justify-center`, St)), (r[63] = St), (r[64] = Ct));
  let Tt;
                  ...
                  : (0, $.jsxs)($.Fragment, {
                      children: [
                        ...
                        (0, $.jsx)(`div`, {
                          ...
                          children: (0, $.jsx)(Zt, { automationId: S.id, formatRootLabel: p }),
                        }),
                      ],
                    }),
              ],
  ...
  let Lt;
  return (
    r[171] !== ne || r[172] !== ht || r[173] !== vt || r[174] !== Pt || r[175] !== Ft
...
function Xt(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = b(`border-token-border flex h-full w-96 shrink-0 self-stretch flex-col`, n)),
      (t[0] = n),
      (t[1] = i));
  let a;
  t[2] === r
...
function Zt(e) {
  let t = (0, Q.c)(26),
    ...
    u;
  t[0] === a ? (u = t[1]) : ((u = new Map((a ?? []).map($t))), (t[0] = a), (t[1] = u));
  let d = u,
    f,
    p,
    m;
      ...
      if (s && a.length === 0) {
        ...
        (t[15] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, $.jsx)(`div`, {
              ...
              children: (0, $.jsx)(z, { className: `icon-sm text-token-description-foreground` }),
            })),
            (t[15] = e))
          : (e = t[15]),
          (m = e));
...
function en(e) {
  ...
  t[7] !== u || t[8] !== f || t[9] !== d
    ? ((v = f
        ...
        : d
          ...
          : u
            ? (0, $.jsx)(Te, { className: `icon-xs shrink-0 text-token-disabled-foreground` })
            : (0, $.jsx)(B, { className: `icon-xs shrink-0 text-token-disabled-foreground` })),
      (t[7] = u),
      (t[8] = f),
      (t[9] = d),
      (t[10] = v))
  ...
  let P;
  t[46] !== C || t[47] !== N
    ? ((P = (0, $.jsx)(H, { items: C, children: N })), (t[46] = C), (t[47] = N), (t[48] = P))
    : (P = t[48]);
  let ie = P;
  if (!u) return ie;
  let F;
    ...
    i =
      n === `ACTIVE`
        ...
        : n === `PAUSED`
          ...
          : `bg-token-charts-red`,
    a;
  t[0] === i ? (a = t[1]) : ((a = b(`size-2 rounded-full`, i)), (t[0] = i), (t[1] = a));
  let o;
...
function nn(e) {
  ...
  t[16] === a
    ? (v = t[17])
    : ((v = a ? (0, $.jsx)(z, { className: `icon-xs` }) : (0, $.jsx)(Ct, { className: `icon-xs` })),
      (t[16] = a),
      (t[17] = v));
  let y;
...
function cn({ status: e, success: t }) {
  ...
  switch (e) {
    ...
    case `store_unavailable`:
      return { failureReason: p.CODEX_AUTOMATION_FAILURE_REASON_STORAGE_UNAVAILABLE };
    case `state_cleanup_failed`:
      return { failureReason: p.CODEX_AUTOMATION_FAILURE_REASON_STATE_CLEANUP_FAILED };
    case `remove_failed`:
