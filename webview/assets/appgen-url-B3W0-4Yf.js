...
import { R as t, d as n, f as r, t as i } from "./app-scope.js";
import { n as a } from "./fuse.js";
import { _ as o, l as s, u as c } from "./vscode-api.js";
import {
  Bi as l,
  Ji as u,
  Ki as d,
...
import { Dn as v } from "./app-server-manager-signals.js";
import { t as y } from "./request.js";
var b = e(v(), 1);
function ee(e) {
  return e == null
...
var E = p([`admins_only`, `workspace_all`, `custom`, `public`]),
  D = t(),
  O = [`appgen`, `projects`],
  k = [`appgen`, `project`],
  A = [`appgen`, `screenshot`],
  j = [`appgen`, `environment`],
  te = [`appgen`, `access-groups`],
  M = m({ id: d(), name: d(), size: l() }),
  N = m({
    project_id: d(),
    access_mode: E,
    allowed_account_user_ids: g(d()),
    allowed_workspace_group_ids: g(d()),
    allowed_tenant_group_ids: g(d()),
    revision: l(),
    updated_at: d(),
  }),
  P = N.extend({
    allowed_groups: g(M),
    allowed_users: g(m({ account_user_id: d(), email: d().nullable(), name: d().nullable() })),
  }),
  F = m({
    auth_client_id: d().nullable(),
    created_at: d(),
    current_live_url: d().nullable(),
    current_preview_url: d().nullable(),
    description: d().nullable(),
    id: d(),
    latest_version_number: l(),
    screenshot_url: d().nullable(),
    slug: d(),
    status: p([`active`, `archived`, `suspended`]),
    title: d(),
    updated_at: d(),
  }),
  I = F.extend({ access_mode: E.nullable(), access_policy: N.nullable() }),
  L = m({ cursor: d().nullable().optional(), items: g(I) }),
  R = F.extend({ access_mode: E.nullable(), access_policy: P.nullable() }),
  z = m({
    entries: g(m({ is_secret: h(), key: d(), type: f(`envvar`), value: d().nullable() })),
    project_id: d(),
    revision: l(),
    updated_at: d().nullable(),
  }),
  B = m({
    tenant_groups: g(M),
    tenant_id: d().nullable(),
    workspace_account_id: d().nullable(),
    workspace_groups: g(M),
  }),
  V = _([
    m({ error: m({}).passthrough(), id: l(), jsonrpc: f(`2.0`) }),
    m({
      id: l(),
      jsonrpc: f(`2.0`),
      result: m({ isError: h().optional(), structuredContent: u().optional() }),
    }),
  ]);
function H() {
  let e = (0, D.c)(1),
...
function q(e) {
  ...
  t[0] === e
    ...
    : ((r = async () => {
        ...
        let { body: t } = await s.getInstance().get(e.replace(/^\/api\/codex(?=\/|$)/u, `/wham`));
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== i
      ? ((a = { enabled: n, queryFn: r, queryKey: i, staleTime: c.INFINITE }),
        (t[3] = n),
        (t[4] = r),
        (t[5] = i),
        (t[6] = a))
    ...
    onSuccess: async (t, n, r, { client: i }) => {
      (i.setQueryData(O, (t) =>
        ...
        await Promise.all([
          ...
          i.invalidateQueries({ queryKey: [...j, e], refetchType: `none` }),
        ]));
    },
  }));
...
//# sourceMappingURL=appgen-url-B3W0-4Yf.js.map
