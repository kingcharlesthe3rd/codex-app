...
var g = class extends c {
  ...
  x = ({ client: e, children: t }) => (
    ...
    (0, v.jsx)(y.Provider, { value: e, children: t })
  ),
  S = _.createContext(!1),
  C = () => _.useContext(S);
S.Provider;
...
var T = _.createContext(w()),
  ...
  k = ({ result: e, errorResetBoundary: t, throwOnError: n, query: r, suspense: i }) =>
    e.isError &&
    !t.isReset() &&
    !e.isFetching &&
    r &&
  ...
  j = (e, t) => e.isLoading && e.isFetching && !t,
  M = (e, t) => e?.suspense && t.isPending,
  N = (e, t, n) =>
...
function P(e, t, n) {
  ...
  if (
    (_.useSyncExternalStore(
      _.useCallback(
        (e) => {
          let t = f ? c.subscribe(u.batchCalls(e)) : l;
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !p &&
      j(d, r) &&
      (s ? N(o, c, i) : a.getQueryCache().get(o.queryHash)?.promise)?.catch(l).finally(() => {
        c.updateResult();
      }),
...
function I(e, t) {
  let n = b(t),
    [r] = _.useState(() => new g(n, e));
  _.useEffect(() => {
    r.setOptions(e);
  }, [r, e]);
  let i = _.useSyncExternalStore(
      _.useCallback((e) => r.subscribe(u.batchCalls(e)), [r]),
      () => r.getCurrentResult(),
      () => r.getCurrentResult(),
    ),
    a = _.useCallback(
      (e, t) => {
        r.mutate(e, t).catch(l);
      },
      [r],
    );
  if (i.error && s(r.options.throwOnError, [i.error])) throw i.error;
...
function ee(e, t) {
  let n = e.source,
    r = t.location.origin;
  if (!(n == null || n === t) || (n === t && r !== `` && r !== L && e.origin !== r)) return null;
  let i = e.data;
  return typeof i != `object` || !i || !te(i) ? null : i;
}
function te(e) {
...
function V(e, t, n) {
  re({ level: e, message: t, ...(n == null ? {} : { tags: ie(n) }) });
}
function ie(e) {
...
function se(e, t, n) {
  ...
  return m(e, () => ({ ...s, queryFn: () => Q(t, i, a, void 0, o), queryKey: Z(t, i, r) }));
}
function ce(e, t, n) {
  return f(e, (e) => {
    let r = n?.(e),
...
function le(...e) {
  ...
  let {
    ...
    b;
  t[4] !== u || t[5] !== a || t[6] !== n
    ? ((b = Z(n, a, u)), (t[4] = u), (t[5] = a), (t[6] = n), (t[7] = b))
    : (b = t[7]);
  let x;
  t[8] !== a || t[9] !== c || t[10] !== n
    ? ((x = async () =>
