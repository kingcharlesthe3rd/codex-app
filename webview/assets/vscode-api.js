...
function P(e, t, n) {
  ...
  (o.getDefaultOptions().queries?._experimental_beforeQuery?.(c),
    ...
    D(c, i),
    O(i));
  let l = !o.getQueryCache().get(c.queryHash),
    [d] = _.useState(() => new t(o, c)),
  ...
  if (
    (_.useSyncExternalStore(
      _.useCallback(
        (e) => {
          let t = p ? d.subscribe(u.batchCalls(e)) : s;
  ...
  return (
    ...
    c.experimental_prefetchInRender &&
      !a &&
      j(f, r) &&
      (l ? N(c, d, i) : o.getQueryCache().get(c.queryHash)?.promise)?.catch(s).finally(() => {
        d.updateResult();
      }),
...
function se(e, t, n) {
  ...
  return d(e, () => ({ ...s, queryFn: () => Q(t, i, a, void 0, o), queryKey: Z(t, i, r) }));
}
function ce(e, t, n) {
  return f(e, (e) => {
    let r = n?.(e),
