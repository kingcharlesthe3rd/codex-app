...
var y = class extends c {
  ...
  w = ({ client: e, children: t }) => (
    ...
    (0, x.jsx)(S.Provider, { value: e, children: t })
  ),
  T = b.createContext(!1),
  E = () => b.useContext(T);
T.Provider;
...
var te = b.createContext(ee()),
  ...
  A = ({ result: e, errorResetBoundary: t, throwOnError: n, query: r, suspense: a }) =>
    e.isError &&
    !t.isReset() &&
    !e.isFetching &&
    r &&
  ...
  M = (e, t) => e.isLoading && e.isFetching && !t,
...
function F(e, t, n) {
  ...
  let c = !a.getQueryCache().get(o.queryHash),
    [l] = b.useState(() => new t(a, o)),
    d = l.getOptimisticResult(o),
    f = !r && e.subscribed !== !1;
  if (
    (b.useSyncExternalStore(
      b.useCallback(
        (e) => {
          let t = f ? l.subscribe(u.batchCalls(e)) : s;
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !h &&
      M(d, r) &&
      (c ? P(o, l, i) : a.getQueryCache().get(o.queryHash)?.promise)?.catch(s).finally(() => {
        l.updateResult();
      }),
...
function L(e, t) {
  let n = C(t),
    [r] = b.useState(() => new y(n, e));
  b.useEffect(() => {
    r.setOptions(e);
  }, [r, e]);
  let a = b.useSyncExternalStore(
      b.useCallback((e) => r.subscribe(u.batchCalls(e)), [r]),
      () => r.getCurrentResult(),
      () => r.getCurrentResult(),
    ),
    o = b.useCallback(
  ...
  if (a.error && i(r.options.throwOnError, [a.error])) throw a.error;
...
function re(e, t) {
  let n = e.source,
    r = t.location.origin;
  if (!(n == null || n === t) || (n === t && r !== `` && r !== ne && e.origin !== r)) return null;
  let i = e.data;
  return typeof i != `object` || !i || !ie(i) ? null : i;
}
function ie(e) {
...
function V(e, t, n) {
  oe({ level: e, message: t, ...(n == null ? {} : { tags: se(n) }) });
}
function se(e) {
...
var H,
  ...
  G = class e {
    ...
    dispatchMessage(e, t) {
      if (U == null) throw Error(`VS Code API is unavailable`);
      U.postMessage({ ...t, type: e });
    }
    deliverMessage(e, t) {
...
function ce(e, t, n) {
  ...
  r[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = G.getInstance()), (r[2] = o))
    : (o = r[2]);
  let s = o,
    c = (0, b.useEffectEvent)(t),
    l;
  r[3] !== c || r[4] !== e
    ? ((l = () => {
  ...
  Y = class e {
    ...
    constructor() {
      ((this.onFetchResponse = this.onFetchResponse.bind(this)),
        G.getInstance().subscribe(`fetch-response`, (e) => {
          this.onFetchResponse(e);
        }),
        G.getInstance().subscribe(`fetch-upload-progress`, (e) => {
        ...
        G.getInstance().subscribe(`fetch-stream-event`, (e) => {
          this.onFetchStreamEvent(e);
        }),
        G.getInstance().subscribe(`fetch-stream-error`, (e) => {
          this.onFetchStreamError(e);
        }),
        G.getInstance().subscribe(`fetch-stream-complete`, (e) => {
          ...
          case `success`:
            try {
              e.status >= 200 && e.status < 300
                ...
                : t.reject(new J(e.bodyJsonString, e.status));
            } catch (e) {
              t.reject(
                e instanceof Error
                  ? e
            ...
            break;
          case `error`:
            t.reject(new J(e.error, e.status, e.errorCode));
            break;
        }
    }
    ...
    async put(e, t, n, r, i) {
      return this.sendRequest(`PUT`, e, { body: t, headers: n, signal: r, onUploadProgress: i });
    }
    stream(e, t, n = {}) {
      ...
      return (
        ...
        G.getInstance().dispatchMessage(`fetch-stream`, {
          requestId: r,
          url: t,
          method: e,
          headers: n.headers,
          body: n.body,
          ...(n.format == null ? {} : { format: n.format }),
        }),
        r
      );
    }
    cancelStream(e) {
      G.getInstance().dispatchMessage(`cancel-fetch-stream`, { requestId: e });
    }
    async sendRequest(e, t, n) {
      let r = crypto.randomUUID(),
        i = {
          ...
          headers: n?.headers,
          body: n?.body,
          ...(n?.onUploadProgress == null ? {} : { reportUploadProgress: !0 }),
        };
      return new Promise((e, t) => {
        let a = () => {
          (this.pendingRequests.delete(r),
            n?.signal?.removeEventListener(`abort`, a),
            G.getInstance().dispatchMessage(`cancel-fetch`, { requestId: r }),
        ...
        try {
          G.getInstance().dispatchMessage(`fetch`, i);
        } catch (e) {
...
function ue(e, t, n) {
  ...
  return f(e, () => ({ ...s, queryFn: () => Q(t, i, a, void 0, o), queryKey: Z(t, i, r) }));
}
function de(e, t, n) {
  return p(e, (e) => {
    let r = n?.(e),
...
function fe(...e) {
  ...
  let {
    ...
    x;
  t[4] !== u || t[5] !== a || t[6] !== n
    ? ((x = Z(n, a, u)), (t[4] = u), (t[5] = a), (t[6] = n), (t[7] = x))
    : (x = t[7]);
  let S;
  t[8] !== a || t[9] !== c || t[10] !== n
    ? ((S = async () =>
        (await Y.getInstance().post(`vscode://codex/${n}`, JSON.stringify(a), $(c))).body),
      (t[8] = a),
      (t[9] = c),
      (t[10] = n),
      (t[11] = S))
  ...
  t[12] === y
    ? (w = t[13])
    : ((w = y === void 0 ? {} : { initialData: y }), (t[12] = y), (t[13] = w));
  let T;
  t[14] === s
    ? (T = t[15])
    : ((T = s === void 0 ? {} : { placeholderData: s }), (t[14] = s), (t[15] = T));
  let E;
  return (
    t[16] !== p ||
    t[17] !== m ||
...
async function Q(e, t, n, r, i) {
  let a = (await Y.getInstance().post(`vscode://codex/${e}`, JSON.stringify(t), $(i), r)).body;
  return n ? n(a) : a;
}
function me(e, t) {
  let n = (0, W.c)(6),
  ...
  n[0] !== r || n[1] !== e
    ? ((i = async (t) =>
        (await Y.getInstance().post(`vscode://codex/${e}`, JSON.stringify(t), $(r))).body),
      (n[0] = r),
      (n[1] = e),
      (n[2] = i))
    : (i = n[2]);
