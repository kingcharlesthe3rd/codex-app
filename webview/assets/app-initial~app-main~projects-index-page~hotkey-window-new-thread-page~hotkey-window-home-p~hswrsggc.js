...
var Dt,
  ...
  Pt = e(() => {
    (I(),
      ...
      a(),
      (Dt = W(b, () => !0)),
      (Ot = W(b, ({ get: e }) => e(Dt) && e(j, e(ze)).kind === `local`)),
      (kt = W(b, ({ get: e }) => e(_e, `824038554`) || e(_e, `12346831`))),
      (At = W(b, ({ get: e }) => {
        let t = e(fe, e(ze)).data?.config,
          n = e(_e, `4114442250`);
      ...
      (jt = W(b, ({ get: e }) =>
        e(At) ? e(M).filter((t) => e(C, t.hostId) === `connected`) : [],
      )),
      (Mt = W(b, ({ get: e }) => e(jt).length > 0)),
      (Nt = H(b, ({ localProjectActionsEnabled: e }, { get: t }) => {
        let n = t(Mt),
          r = t(st);
        return r === `project` && !e && n ? `connection` : r;
      })));
  });
function Ft({ projectSidebarEnabled: e, organizeMode: t, showProjectsTitle: n, showRecent: r }) {
  return e
    ? r
      ? (0, J.jsx)(m, {
...
function It({ projectSidebarEnabled: e, organizeMode: t, showProjectsTitle: n, showRecent: r }) {
  return e
    ? r
      ? `All chats`
      : t === `connection`
...
function Rt(e, t) {
  return e
    ...
    .sort((e, n) => {
      let r = Vt(e.group.threadKeys, t)[0]?.at ?? -1 / 0,
        i = Vt(n.group.threadKeys, t)[0]?.at ?? -1 / 0;
...
function Vt(e, t) {
  return Bt(e, t).map((e) => e.task);
}
function Ht({ defaultProjectLabel: e, projectLabel: t, repositoryLabel: n }) {
...
function Ut({
  ...
  if (t.kind === `local`)
    return { isProjectless: !1, label: (t.conversation.cwd ? L(t.conversation.cwd) : ``) || e };
  if (t.kind === `remote`)
  ...
  return { isProjectless: !1, label: o ? L(o) : e };
}
var J,
  Wt = e(() => {
    (_(), Ze(), (J = B()));
...
function Kt({ items: e, projectlessThreadIds: t }) {
  return e.filter((e) => {
    switch (e.task.kind) {
      case `local`:
        return (
...
var Xt,
  ...
  pn = e(() => {
    (I(),
      ...
      Ze(),
      (Xt = []),
      (Zt = W(b, ({ get: e }) => e(yt).data?.threadIds ?? Xt)),
      (Qt = W(b, ({ get: e }) => {
        let t = U(e, P.THREAD_PROJECT_ASSIGNMENTS),
          n = U(e, P.PROJECTLESS_THREAD_IDS);
        return e(Ge, {
          threadKeys: e(ae),
          enabled: !0,
      ...
      ($t = H(b, (e, { get: t }) => t(Qt).find((t) => t.threadKeys.includes(e)) ?? null)),
      (en = H(b, (e, { get: t }) => {
        let n = t(o, e);
        return n?.kind === `local`
          ? U(t, P.THREAD_PROJECT_ASSIGNMENTS)?.[n.conversation.id]
          : void 0;
      })),
      (tn = W(b, ({ get: e }) => qt(e(Qt)))),
      (nn = H(b, (e, { get: t }) => {
        let n = pe(e);
        switch (n?.kind) {
          case `pending-worktree`:
            return t(i, n.pendingWorktreeId)?.isPinned === !0;
          case `local`:
          case `remote`: {
            let n = dt(e);
            return n != null && t(Zt).includes(n);
          }
          case void 0:
            return !1;
        }
      ...
      (rn = H(b, (e, { get: t }) => {
        let n = ie(e);
        return n != null && t($e).automationThreadIds.has(n);
      })),
      (an = H(b, (e, { get: t }) => {
        let n = ie(e);
        return n == null ? null : (t($e).automationDisplayNames.get(n) ?? null);
      })),
      (on = H(
        b,
        (e, { get: t }) => {
          ...
          let r = U(t, P.PROJECTLESS_THREAD_IDS);
          return Ut({
            chatLabel: t(Ct).formatMessage({
      ...
      (ln = H(b, (e, { get: t }) => {
        let n = t(o, e);
        return n?.kind === `local`
          ? Ue({ cwd: n.conversation.cwd ?? null, assignment: t(en, e) })
          : null;
      })),
      (un = H(b, (e, { get: t }) => {
        let n = t($t, e),
        ...
        if (
          ...
          t(en, e)?.pendingCoreUpdate !== !0
        ) {
          let n = r.conversation.gitInfo.originUrl,
            a = t(ln, e);
          (n != null && (i = qe(n)?.repoName ?? null),
            i == null && a != null && !Ce(a) && (i = L(a)));
        }
        return Ht({
          defaultProjectLabel: n?.path == null ? i : L(n.path),
          projectLabel: n?.label ?? null,
          repositoryLabel: i,
        });
      })),
      (dn = H(b, (e, { get: t }) =>
        e == null ? null : (U(t, P.THREAD_WORKSPACE_ROOT_HINTS)?.[e] ?? null),
      )),
      (fn = H(b, (e, { get: t }) =>
        e == null ? null : (U(t, P.SIDEBAR_THREAD_METADATA)?.[e]?.labelColor ?? null),
      )));
  });
function mn(e, t) {
...
function _n({ get: e, threadKeys: t, pinnedThreadIds: n }) {
  ...
  let r = new Set(t),
    i = [];
  for (let n of t) pe(n)?.kind === `pending-worktree` && e(nn, n) && i.push(n);
  for (let e of n) {
    let t = p(be(e));
    if (r.has(t)) {
      i.push(t);
...
var vn,
  ...
  wn = e(() => {
    (I(),
      ...
      (xn = new WeakMap()),
      (Sn = W(b, ({ get: e, scope: t }) => {
        let n = hn(xn.get(t.node) ?? bn, _n({ get: e, threadKeys: e(ae), pinnedThreadIds: e(Zt) }));
...
function X(e) {
  ...
  return (
    t[0] !== n || t[1] !== i
      ? ((a = i ? (0, Nn.jsx)(An, { className: n }) : (0, Nn.jsx)(ut, { className: n })),
        (t[0] = n),
        (t[1] = i),
        (t[2] = a))
      : (a = t[2]),
...
function Fn(e) {
  ...
  if (
    ...
    (t[18] === v
      ...
      t[20] !== b || t[21] !== c
        ...
        : (O = t[22]),
      (S = h.Section),
      (E = `flex max-h-[calc((1lh+var(--padding-row-y)*2)*5)] flex-col overflow-y-auto text-sm [--edge-fade-distance:1.5rem]`),
      (D = C.map((e) => {
        let t = i[e.projectId] ?? null,
          r = (0, Z.jsx)(X, { className: `icon-xs`, isRemoteProject: e.projectKind === `remote` }),
          s = e.repositoryData?.rootFolder,
          c = s != null && s !== e.label,
          l = n.get(e.label) ?? [],
          u = l.length > 1 && e.path != null ? De(e.path, l) : null;
        return (0, Z.jsx)(
          `div`,
          {
            className: `flex flex-col`,
            children: (0, Z.jsxs)(T, {
              RightIcon: a.includes(e.projectId) ? Re : void 0,
              tooltipText: u ?? void 0,
              tooltipAlign: `center`,
              onSelect: (t) => {
                (_ && t.preventDefault(), o(e.projectId));
              },
              children: [
                (0, Z.jsx)(h.ItemIcon, {
                  size: `xs`,
                  children:
                    t == null
                      ? r
                      : (0, Z.jsx)(Be, { appearance: t, className: `size-4`, fallbackIcon: r }),
                }),
                (0, Z.jsxs)(`div`, {
      ...
      (t[15] = D),
      (t[16] = O));
  } else ((S = t[11]), (C = t[12]), (w = t[13]), (E = t[14]), (D = t[15]), (O = t[16]));
  let k;
  t[23] !== g || t[24] !== C.length
    ? ((k =
        C.length === 0
          ? (0, Z.jsx)(`div`, {
    ...
    : (k = t[25]);
  let A;
  t[26] !== S || t[27] !== E || t[28] !== D || t[29] !== k
    ? ((A = (0, Z.jsxs)(S, { className: E, children: [D, k] })),
      (t[26] = S),
      (t[27] = E),
      (t[28] = D),
      (t[29] = k),
                    ...
                    children: (0, Z.jsxs)(Z.Fragment, {
                      children: [
                        ...
                        d
                          ...
                          : null,
                        y ? (0, Z.jsx)(T, { LeftIcon: oe, onSelect: l, children: c }) : null,
                      ],
                    }),
                  }),
                ],
  ...
  let M;
  return (
    t[39] !== n || t[40] !== O || t[41] !== A || t[42] !== j
      ? ((M = (0, Z.jsxs)(Z.Fragment, { children: [O, A, n, j] })),
        (t[39] = n),
        (t[40] = O),
        (t[41] = A),
        (t[42] = j),
...
var In,
  ...
  Bn = e(() => {
    (I(),
      ...
      (zn = W(b, ({ get: e }) => {
        let t = e(ae),
          n = e(Ge, { threadKeys: t, enabled: !0 }).groups,
          r = new Map(e(Cn, t).map((e) => [e.task.key, e]));
        return zt(e(nt), n, r);
      })));
  }),
  Vn,
...
function Wn(e) {
  ...
  t[0] === s
    ...
    : ((d = s.formatMessage({
      ...
      (t[1] = d));
  let f = d,
    p = u && q.projectClearAvailable,
    m = u && `hover:bg-token-list-hover-background`,
    h;
  t[2] !== p || t[3] !== m
    ? ((h = G(`group/project-selector relative inline-flex shrink-0 rounded-full`, p, m)),
      (t[2] = p),
      (t[3] = m),
      (t[4] = h))
    : (h = t[4]);
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, qn.jsx)(Hn, { "aria-hidden": !0, className: `size-4` })), (t[12] = w))
    : (w = t[12]);
  let T;
  ...
  t[18] !== f || t[19] !== T || t[20] !== y
    ? ((E = (0, qn.jsx)(ne, { disabled: y, tooltipContent: f, children: T })),
      (t[18] = f),
      (t[19] = T),
      (t[20] = y),
      (t[21] = E))
...
var Gn,
  ...
  qn,
  Jn = e(() => {
    ((Gn = re()), ue(), (Kn = t(K(), 1)), _(), R(), Un(), mt(), (qn = B()));
  });
function Yn(e) {
  let t = (0, Qn.c)(22),
    n,
  ...
  t[0] === e
    ...
    : (({
      ...
      (t[8] = l));
  let u;
  t[9] === i ? (u = t[10]) : ((u = G(q.externalFooterItem, `min-w-0`, i)), (t[9] = i), (t[10] = u));
  let d;
...
function Xn(e) {
  ...
  t[0] === r
    ? (c = t[1])
    : ((c = G(q.externalFooterItem, `flex min-w-0 items-center gap-1`, r)), (t[0] = r), (t[1] = c));
  let l;
...
function Zn(e) {
  let t = (0, Qn.c)(26),
    ...
    c = ee(`2700454473`) ? `icon-xs` : `icon-2xs`,
  ...
  bb0: switch (a) {
    ...
    case `chevron`: {
      ...
      t[3] === c
        ...
        : ((e = G(
          ...
          (t[4] = e));
      let n;
      (t[5] === e ? (n = t[6]) : ((n = (0, Q.jsx)(se, { className: e })), (t[5] = e), (t[6] = n)),
        (v = n));
      break bb0;
    }
    case `collapsible-chevron`: {
      ...
      t[7] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = G(q.secondaryChevron, q.externalFooterItemChevron, `inline-flex`)), (t[7] = e))
        : (e = t[7]);
      let n;
      t[8] === c
        ? (n = t[9])
        : ((n = G(c, `shrink-0 text-token-input-placeholder-foreground`)), (t[8] = c), (t[9] = n));
      let r;
      (t[10] === n
        ? (r = t[11])
        : ((r = (0, Q.jsx)(`span`, { className: e, children: (0, Q.jsx)(se, { className: n }) })),
          (t[10] = n),
          (t[11] = r)),
        (v = r));
    }
  ...
  t[20] !== m
    ? ((b =
        n != null || o != null
          ? (0, Q.jsxs)(`span`, {
              className: G(
                q.externalFooterItemText,
                n != null && q.externalFooterItemTextWithCategoryLabel,
              ...
              children: [
                n == null
                  ...
                  : (0, Q.jsx)(`span`, {
                      className: G(
                        q.externalFooterItemCategoryLabel,
                ...
                (0, Q.jsx)(ft, {
                  ...
                  children: (0, Q.jsx)(`span`, {
                    ref: g,
                    className: G(
                      q.externalFooterItemValueContent,
                      `block max-w-full min-w-0 truncate`,
                      _ && q.externalFooterItemValueOverflowing,
                    ),
...
var Qn,
  ...
  Q,
  er = e(() => {
    ((Qn = re()), ue(), ($n = t(K(), 1)), Je(), Ne(), c(), vt(), A(), ht(), mt(), (Q = B()));
  });
function tr({
  ...
  let v = ce(b),
    ...
    O = ee(`2700454473`),
    A = O,
    j = O ? `icon-xs` : `icon-2xs`,
    M = (0, rr.useRef)(!1),
    N = u(zn).filter((e) => (e.projectKind === `local` ? t : i)),
    F = Tt(),
    te = D && !F,
    re = r(),
    ie = e !== void 0,
    ae = !F,
    { selectedRemoteProject: oe, selectedRemoteProjectId: ue } = Me(),
    { remoteConnections: fe } = Ie(),
    pe = pt(fe),
    { data: me, isLoading: ge } = u(Le),
    { data: _e } = k(P.PROJECT_APPEARANCES),
    be = le(_e),
    xe = i && re && !F && pe.length > 0,
    Se = (e) => {
      Pe(v, d, {});
      let t = N.find((t) => t.projectId === e);
      if (t == null) return;
      if ((St(v, t), t.projectKind === `remote`)) {
        Ke(v, { projectId: t.projectId, projectKind: `remote` });
        return;
      }
      let n = tt.select(v, t);
      s?.(n);
    ...
    I = (e) => {
      M.current && ((M.current = !1), e.preventDefault(), we());
    },
    Ee = () => {
      (Pe(v, de, {}), E({ setActive: !0 }));
    },
    De = () => {
      (Pe(v, d, {}), St(v, null), Ke(v, null), s?.(null));
    },
    L = me?.roots?.[0] ?? null;
  ie ? (L = e) : i && (L = ue ?? L);
  let R = L == null ? null : (be[L] ?? null),
    ke = L == null && ae && !0,
    je = ae && L != null,
    Ne = l ?? x,
    Fe = (e) => {
    ...
    z = n && c === `home` && N.length === 0 && !F;
  if (!ie && ge && me == null && !z && ue == null) return null;
  let B =
      L == null
        ? null
        : nr({ activeProjectId: L, groups: N, remoteConnections: fe, selectedRemoteProject: oe }),
    V =
      B?.hostDisplayName == null
        ? (B?.label ?? B?.path ?? null)
        : `${B.label} · ${B.hostDisplayName}`,
    Re =
      B?.label ??
      (ke
        ? (0, $.jsx)(m, {
    ...
    Ue = te
      ? (0, $.jsx)(h.Item, { LeftIcon: f, onSelect: Te, children: H })
      : (0, $.jsxs)(h.FlyoutSubmenuItem, {
          LeftIcon: f,
          label: H,
          children: [
            (0, $.jsx)(h.Item, {
        ...
        children: (0, $.jsxs)(Ae, {
          ...
          children: [
            (0, $.jsx)(`span`, {
              ...
              "data-project-selector-icon": je || void 0,
              children: ke
                ? (0, $.jsx)(En, { className: G(j, `shrink-0`) })
                : R == null
                  ? (0, $.jsx)(X, {
                      className: G(j, `shrink-0`),
                      isRemoteProject: B?.projectKind === `remote`,
                    })
                  : (0, $.jsx)(Be, {
                      appearance: R,
                      className: `size-4`,
            ...
            o
              ? null
              : (0, $.jsx)(`span`, { className: `max-w-[240px] truncate text-left`, children: He }),
            (0, $.jsx)(se, { className: G(j, `shrink-0 text-token-input-placeholder-foreground`) }),
          ],
        }),
      }),
    Ge = `always`;
  A && B != null
    ? (Ge = `trigger-overflows`)
    : !A && B == null && (Ge = `visibility-target-hidden`);
  let qe = A ? (V ?? ze) : ze,
    Je = () =>
      (0, $.jsx)(ne, {
        open: !Ne && w,
        ...
        children: (0, $.jsx)(Yn, {
          ...
          indicator: `none`,
          value: (0, $.jsx)(`span`, { "data-tooltip-visibility-target": !0, children: Re }),
      ...
      (0, $.jsxs)(`button`, {
        ...
        children: [
          (0, $.jsx)(`span`, {
            ...
            children: (0, $.jsx)(`span`, { className: `min-w-0 truncate`, children: He }),
          }),
          (0, $.jsx)(se, {
  ...
  let Xe = (0, $.jsx)(he, {
    ...
    onCloseAutoFocus: I,
    side: `top`,
    align: c === `hero` ? `center` : `start`,
    disabled: a,
    triggerButton: _ ?? (c === `hero` ? Ye() : c === `home` ? Je() : We()),
    contentWidth: `workspace`,
    contentMaxHeight: `tall`,
    children: (0, $.jsx)(Fn, {
      groups: N,
      projectAppearances: be,
      selectedProjectIds: L ? [L] : [],
      onSelectProjectId: Se,
      projectlessActionLabel: (0, $.jsx)(m, {
        id: `composer.localCwdDropdown.clearProject`,
        defaultMessage: `Don't work in a project`,
        description: `Menu item that clears the selected project and starts projectless chats`,
      }),
      onSelectProjectless: je ? De : void 0,
      footerItems: n ? Ue : null,
      onAddRemoteProject: xe ? Ee : void 0,
      children: null,
    }),
  });
  return c !== `hero` && je && _ == null
    ? (0, $.jsx)(Wn, { disabled: a, menuOpen: Ne, onClearProject: De, children: Xe })
    : Xe;
}
function nr({ activeProjectId: e, groups: t, remoteConnections: n, selectedRemoteProject: r }) {
