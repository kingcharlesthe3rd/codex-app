...
function Lt({ projectSidebarEnabled: e, organizeMode: t, showProjectsTitle: n, showRecent: r }) {
  return e
    ? r
      ? (0, q.jsx)(R, {
...
function Gt({
  ...
  if (t.kind === `local`)
    return { isProjectless: !1, label: (t.conversation.cwd ? j(t.conversation.cwd) : ``) || e };
  if (t.kind === `remote`)
...
function Zt(e, t) {
  ...
  let r = e(re, t);
  return r == null ? !1 : r === 0 ? n === `resuming` : e(fe, t) === `inProgress`;
}
var Qt,
  $t,
  en,
  ...
  mn = e(() => {
    (o(),
      ...
      (J = p(B, (e, { get: t }) => t(en).find((t) => t.threadKeys.includes(e)) ?? null)),
      (tn = p(B, (e, { get: t }) => {
        let n = t(U, e);
        return n?.kind === `local`
      ...
      (pn = p(B, (e, { get: t }) =>
        e == null ? null : (F(t, h.SIDEBAR_THREAD_METADATA)?.[e]?.labelColor ?? null),
      )));
  });
function hn(e, t) {
...
var yn,
  ...
  Tn = e(() => {
    (o(),
      ...
      (yn = []),
      (bn = []),
      (xn = { allSidebarThreadKeys: bn, pinnedThreadKeys: bn, unpinnedThreadKeys: bn }),
      (Sn = new WeakMap()),
      (Cn = g(B, ({ get: e, scope: t }) => {
        let n = gn(Sn.get(t.node) ?? xn, vn({ get: e, threadKeys: e(Ye), pinnedThreadIds: e($t) }));
...
function En(e, t) {
  let n = `~`;
  return (
    t != null && (n = t.projectKind === `remote` ? t.path : We.getThreadStartCwd(t)),
    e.set(Dn, n),
    n
  );
}
...
function X(e) {
  ...
  return (
    t[0] !== n || t[1] !== i
      ? ((a = i ? (0, Ln.jsx)(Pn, { className: n }) : (0, Ln.jsx)(ut, { className: n })),
        (t[0] = n),
        (t[1] = i),
        (t[2] = a))
      : (a = t[2]),
...
function zn(e) {
  ...
  if (
    ...
    (t[18] === h
              ...
              children: [
                (0, Z.jsx)(K.ItemIcon, {
                  ...
                  children:
                    t == null
                      ? r
                      : (0, Z.jsx)(Fe, { appearance: t, className: `size-4`, fallbackIcon: r }),
                }),
                (0, Z.jsxs)(`div`, {
      ...
      (t[15] = C),
      (t[16] = w));
  } else ((y = t[11]), (b = t[12]), (x = t[13]), (S = t[14]), (C = t[15]), (w = t[16]));
  let T;
                    ...
                    children: (0, Z.jsxs)(Z.Fragment, {
                      children: [
                        ...
                        d
                          ...
                          : null,
                        g ? (0, Z.jsx)(G, { LeftIcon: De, onSelect: l, children: c }) : null,
                      ],
                    }),
                  }),
                ],
...
function Jn(e) {
  ...
  let f = d,
    ...
    h;
  t[2] !== p || t[3] !== m
    ? ((h = V(`group/project-selector relative inline-flex shrink-0 rounded-full`, p, m)),
      (t[2] = p),
      (t[3] = m),
      (t[4] = h))
    : (h = t[4]);
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, Zn.jsx)(Kn, { "aria-hidden": !0, className: `size-4` })), (t[12] = T))
    : (T = t[12]);
  let E;
...
function $n(e) {
  ...
  t[0] === e
    ...
    : (({
      ...
      (t[8] = l));
  let u;
  t[9] === i ? (u = t[10]) : ((u = V(b.externalFooterItem, `min-w-0`, i)), (t[9] = i), (t[10] = u));
  let d;
...
function er(e) {
  ...
  t[0] === r
    ? (c = t[1])
    : ((c = V(b.externalFooterItem, `flex min-w-0 items-center gap-1`, r)), (t[0] = r), (t[1] = c));
  let l;
  ...
  bb0: switch (a) {
    ...
    case `chevron`: {
      ...
      t[3] === c
        ...
        : ((e = V(
          ...
          (t[4] = e));
      let n;
      (t[5] === e ? (n = t[6]) : ((n = (0, Q.jsx)(Pe, { className: e })), (t[5] = e), (t[6] = n)),
        (y = n));
      break bb0;
    }
    case `collapsible-chevron`: {
      ...
      t[7] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = V(b.secondaryChevron, b.externalFooterItemChevron, `inline-flex`)), (t[7] = e))
        : (e = t[7]);
      let n;
      t[8] === c
        ? (n = t[9])
        : ((n = V(c, `shrink-0 text-token-input-placeholder-foreground`)), (t[8] = c), (t[9] = n));
      let r;
      (t[10] === n
        ? (r = t[11])
        : ((r = (0, Q.jsx)(`span`, { className: e, children: (0, Q.jsx)(Pe, { className: n }) })),
          (t[10] = n),
          (t[11] = r)),
        (y = r));
    }
...
var nr,
  ...
  Q,
  ir = e(() => {
    ((nr = r()), H(), (rr = t(i(), 1)), Oe(), _e(), Ne(), St(), D(), _(), C(), (Q = n()));
  });
function ar({
  ...
  let I =
      M == null
        ? null
        : or({ activeProjectId: M, groups: O, remoteConnections: ue, selectedRemoteProject: ae }),
    L =
      ...
      (0, $.jsx)(pe, {
        ...
        children: (0, $.jsxs)(me, {
          ...
          children: [
            ...
            o
              ? null
              : (0, $.jsx)(`span`, { className: `max-w-[240px] truncate text-left`, children: Ne }),
            (0, $.jsx)(Pe, { className: V(E, `shrink-0 text-token-input-placeholder-foreground`) }),
          ],
        }),
      }),
    W = `always`;
  T && I != null ? (W = `trigger-overflows`) : !T && I == null && (W = `visibility-target-hidden`);
  let Le = T ? (L ?? je) : je,
    G = () =>
      (0, $.jsx)(pe, {
        open: !Ee && y,
        ...
        children: (0, $.jsx)($n, {
          ...
          indicator: `none`,
          value: (0, $.jsx)(`span`, { "data-tooltip-visibility-target": !0, children: z }),
      ...
      (0, $.jsxs)(`button`, {
        ...
        children: [
          (0, $.jsx)(`span`, {
            ...
            children: (0, $.jsx)(`span`, { className: `min-w-0 truncate`, children: Ne }),
          }),
          (0, $.jsx)(Pe, {
  ...
  return u !== `hero` && F && p == null
    ? (0, $.jsx)(Jn, { disabled: i, menuOpen: Ee, onClearProject: Te, children: Be })
    : Be;
}
function or({ activeProjectId: e, groups: t, remoteConnections: n, selectedRemoteProject: r }) {
