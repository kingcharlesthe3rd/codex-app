...
import { f as r, r as i } from "./chunk-34.js";
import "./chunk-93.js";
import { D as a, T as o } from "./runtime.worker-2.js";
import "./chunk-42.js";
import "./chunk-38.js";
import "./chunk-94.js";
import "./chunk-80.js";
...
var b = h.pie,
  ...
  T = {
    ...
    addSection: t(({ label: t, value: n }) => {
      ...
      S.has(t) || (S.set(t, n), e.debug(`added new section: ${t}, with value: ${n}`));
    }, `addSection`),
...
` + t,
        ...
        (j
          ...
          j
            ...
            .attr(`x`, 22)
            .attr(`y`, 14)
            .text((e) => (l.getShowData() ? `${e.label} [${e.value}]` : e.label)));
        let M =
            512 +
            Math.max(
              ...j
...
export { A as diagram };
//# sourceMappingURL=pieDiagram-3.js.map
