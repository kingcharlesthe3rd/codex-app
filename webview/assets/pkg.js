  ...
  function d(n) {
    if (n.length !== 0) {
      ...
      return _e(`https://${e}/b`, {
        ...
        method: `post`,
        body: JSON.stringify({ writeKey: r, batch: o, sentAt: new Date().toISOString() }),
        priority: t?.priority,
      }).then(function (e) {
                      ...
                      return r(i, void 0, void 0, function () {
                        ...
                        return l(this, function (o) {
                          switch (o.label) {
                            ...
                            case 1:
                              return ((i = o.sent()), (a = i instanceof M), a || n.push(r), [2]);
                          }
                        });
                      });
                    },
        ...
        return l(this, function (a) {
          switch (a.label) {
            case 0:
              return ((e = !0), [4, on(n, t)]);
            case 1:
              return ((r = a.sent()), (e = !1), t.todo > 0 && i(e, r, n, i), [2]);
          }
        });
      });
    }, Math.random() * 5e3);
...
function ln(e, t, n) {
  ...
  var i = t?.apiKey ?? ``,
    ...
    p = f && `strategy` in f && f.strategy === `batching` ? Zt(c, f.config) : tn(f?.config);
  function m(i) {
    return r(this, void 0, void 0, function () {
      var r, c;
      ...
      (Z = (function (e) {
        ...
        function t(t, n, r, i, a) {
          ...
          return (
            ...
            (s._user = i ?? new W(o({ persist: !l, storage: n?.storage }, n?.user), c).load()),
            (s._group = a ?? new Dt(o({ persist: !l, storage: n?.storage }, n?.group), c).load()),
                ...
                return (
                  ...
                  [
                    ...
                    this._dispatch(s, o).then(function (e) {
                      return (c.emit(`track`, r, e.event.properties, e.event.options), e);
                    }),
                  ]
                );
              });
            ...
            return r(this, void 0, void 0, function () {
              ...
              return l(this, function (l) {
                return (
                  ...
                  (o = n[3]),
                  (s = n[4]),
                  (c = this.eventFactory.page(r, i, a, o, this.integrations, t)),
                  [
                    2,
              ...
              return l(this, function (l) {
                return (
                  ...
                  [
                    ...
                    this._dispatch(s, o).then(function (e) {
                      return (
                        c.emit(`identify`, e.event.userId, e.event.traits, e.event.options), e
                      );
                    }),
                  ]
                );
            ...
            return r(this, void 0, void 0, function () {
              ...
              return l(this, function (l) {
                return (
                  ...
                  (o = n[3]),
                  (s = n[4]),
                  (c = this.eventFactory.screen(r, i, a, o, this.integrations, t)),
                  [
                    2,
                    this._dispatch(c, s).then(function (e) {
                ...
                switch (i.label) {
                  case 0:
                    return [
                      4,
                      n(
                        () => import(`./auto-track-B.js`),
                        __vite__mapDeps([0, 1, 2, 3, 4]),
                        import.meta.url,
                      ),
                    ];
                  case 1:
                    return ((t = i.sent()), [2, (r = t.link).call.apply(r, c([this], e, !1))]);
                }
              });
            });
          }),
            ...
            return r(this, void 0, void 0, function () {
              ...
              return l(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return ((t = i.sent()), [2, (r = t.form).call.apply(r, c([this], e, !1))]);
                }
              });
            });
          }),
  ...
  return r(this, void 0, void 0, function () {
    ...
    return l(this, function (c) {
      switch (c.label) {
        ...
        case 9:
          throw ((s = c.sent()), console.error(`Failed to create PluginFactory`, e), s);
        case 10:
          return [2];
      }
    });
              ...
              return r(f, void 0, void 0, function () {
                ...
                return l(this, function (l) {
                  switch (l.label) {
                    ...
                    case 3:
                      return (
                        (r = d), r ? ((f = n[e.name]), [4, r(o(o({}, e.settings), f))]) : [3, 5]
                      );
                    case 4:
                      ((p = l.sent()),
                    ...
                    n(
                      () =>
                        import(`./ajs-destination.js`).then(function (n) {
                          return n.ajsDestinations(e, t, i.integrations, a, p, s);
                        }),
          ...
          case 5:
            return (
              ...
              Te.initRemoteMetrics(
                o(o({}, s.metrics), { host: h?.apiHost ?? s.metrics?.host, protocol: h?.protocol }),
              ),
              [4, Gn(e.writeKey, s, f, t, p, m, n)]
            );
          case 6:
            return (
              (g = l.sent()), (f.initialized = !0), f.emit(`initialize`, e, t), [4, Wn(f, r, n)]
            );
          case 7:
            return (l.sent(), [2, [f, g]]);
        }
