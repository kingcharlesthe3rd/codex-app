    ...
    (o(),
      ...
      (F = function (e, t) {
        ...
        (e.type === `page` &&
          ...
          (e.properties = i(i(i({}, t), e.properties), e.name ? { name: e.name } : {}))),
          (n.page = i(i(i({}, t), r), n.page)));
      }));
  }),
  Xe = e(() => {
    (Ke(), Ye());
...
var ft = e(() => {
  ...
  ht = e(() => {
    (o(),
      ...
      (mt = (function () {
        function e(t) {
          (t === void 0 && (t = e.defaults), (this.options = i(i({}, e.defaults), t)));
        }
        return (
  ...
  Ot = e(() => {
    (o(),
        ...
        return (
          ...
          (e.prototype.identify = function (e, t) {
            if (!this.options.disable) {
              t ??= {};
              var n = this.id();
              ((n === null || n === e) && (t = i(i({}, this.traits()), t)),
                e && this.id(e),
                this.traits(t));
            }
          }),
      ...
      (Dt = (function (e) {
        ...
        function t(t, n) {
          t === void 0 && (t = Et);
          var r = e.call(this, i(i({}, Et), t), n) || this;
  ...
  return s(this, void 0, void 0, function () {
    ...
    return r(this, function (r) {
      switch (r.label) {
        ...
        case 3:
          return ((i = r.sent()), t.reject(i), [3, 4]);
        case 4:
          return [2];
      }
    });
...
var jt,
      ...
      (Mt = function (e, t) {
        return s(void 0, void 0, void 0, function () {
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                ((n = 0), (i = t.getAndRemove(`addSourceMiddleware`)), (r.label = 1));
              case 1:
                return n < i.length ? ((a = i[n]), [4, G(e, a).catch(console.error)]) : [3, 4];
              case 2:
                (r.sent(), (r.label = 3));
              case 3:
                return (n++, [3, 1]);
      ...
      (Nt = function (e, t) {
        return s(void 0, void 0, void 0, function () {
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                ((n = 0), (i = t.getAndRemove(`register`)), (r.label = 1));
              case 1:
                return n < i.length ? ((a = i[n]), [4, G(e, a).catch(console.error)]) : [3, 4];
              case 2:
                (r.sent(), (r.label = 3));
  ...
  Kt = e(() => {
    (o(),
      (Gt = function (e) {
        return i({ "Content-Type": `text/plain` }, typeof e == `function` ? e() : e);
      }));
  });
function qt(e) {
                  ...
                  (M.system().log(`error`, `Error sending batch`, r),
                    e <= (t?.maxRetries ?? 10) &&
                      ...
                      n.map(function (t) {
                        if (`_metadata` in t) {
                          var n = t;
                          n._metadata = i(i({}, n._metadata), { retryCount: e });
                        }
                      }),
                      m(e + 1)));
                }),
  ...
  function h(e, i) {
    return s(this, void 0, void 0, function () {
      ...
      return r(this, function (r) {
        return (
          n.push(i),
          (e = n.length >= o || Jt(n) || (t?.keepalive && Yt(n))),
          [2, e || a ? f() : m()]
        );
      });
    });
...
function rn(e, t, n, r, a) {
  ...
  (s.length > 0 && (t._metadata = { failedInitializations: s }),
    a != null &&
      (a.attempts > 1 && (t._metadata = i(i({}, t._metadata), { retryCount: a.attempts })),
      a.attempts++));
  var c = [],
    l = [];
  for (var u in r) {
                    ...
                    function () {
                      return s(i, void 0, void 0, function () {
                        ...
                        return r(this, function (r) {
                          switch (r.label) {
                            case 0:
                              return ((i = t.pop()), i ? [4, _(i, e)] : [2]);
                            case 1:
                              return ((a = r.sent()), (o = a instanceof M), o || n.push(i), [2]);
                          }
                        });
                      });
                    },
        ...
        return r(this, function (r) {
          switch (r.label) {
            case 0:
              return ((e = !0), [4, on(n, t)]);
            case 1:
              return ((a = r.sent()), (e = !1), t.todo > 0 && i(e, a, n, i), [2]);
          }
        });
      });
    }, Math.random() * 5e3);
          ...
          : (o.add(i),
            ...
            a.getAttempts(i) >= a.maxAttempts
              ...
              : [
                  2,
                  p
                    .dispatch(`${d}/${s}`, rn(e, l, t, n, i))
                    .then(function () {
                      return i;
                    })
                    .catch(function (e) {
                      if ((i.log(`error`, `Error sending event`, e), e.name === `RateLimitError`)) {
      ...
      (Z = (function (e) {
        ...
        function t(t, n, r, a, o) {
          ...
          return (
            ...
            (s._user = a ?? new W(i({ persist: !l, storage: n?.storage }, n?.user), c).load()),
            (s._group = o ?? new Dt(i({ persist: !l, storage: n?.storage }, n?.group), c).load()),
            ...
            return s(this, void 0, void 0, function () {
              ...
              return r(this, function (r) {
                switch (r.label) {
                  ...
                  case 1:
                    return ((t = r.sent()), [2, (i = t.link).call.apply(i, a([this], e, !1))]);
                }
              });
            });
          }),
            ...
            return s(this, void 0, void 0, function () {
              ...
              return r(this, function (r) {
                switch (r.label) {
                  ...
                  case 1:
                    return ((t = r.sent()), [2, (i = t.form).call.apply(i, a([this], e, !1))]);
                }
              });
            });
          }),
                        ...
                        return s(t, void 0, void 0, function () {
                          ...
                          return r(this, function (r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return (
                                  (t = r.sent().sourceMiddlewarePlugin),
                                  (i = {}),
...
function Tn(e, t, n) {
  var r = new V(n ? [] : [new mt(xn())]),
    a = r.get(`s:context.referrer`),
    o = Sn(e) ?? a;
  o && (t && (t.referrer = i(i({}, t.referrer), o)), r.set(`s:context.referrer`, o));
}
var $,
  En,
  Dn,
      ...
      switch (r.label) {
        case 0:
          ...
          ((a = e.url.split(`/`)),
            ...
            (r.label = 1));
        case 1:
          return (r.trys.push([1, 3, , 5]), [4, ie(s.replace(n, i))]);
        case 2:
          return (r.sent(), [3, 5]);
        case 3:
          return (r.sent(), [4, ie(e.url.replace(n, i))]);
        case 4:
          return (r.sent(), [3, 5]);
        case 5:
          return [3, 8];
        case 6:
          return [4, ie(e.url.replace(n, i))];
        case 7:
          (r.sent(), (r.label = 8));
        case 8:
          return typeof window[e.libraryName] == `function` ? [2, window[e.libraryName]] : [3, 10];
        case 9:
          throw ((c = r.sent()), console.error(`Failed to create PluginFactory`, e), c);
        case 10:
          return [2];
      }
    });
                  ...
                  switch (r.label) {
                    ...
                    case 1:
                      return (
                        ...
                        d ? [3, 3] : [4, Mn(e, a?.obfuscate)]
                      );
                    case 2:
                      ((d = r.sent()), (r.label = 3));
                    case 3:
                      return (
                        (s = d), s ? ((f = n[e.name]), [4, s(i(i({}, e.settings), f))]) : [3, 5]
                      );
                    case 4:
                      ((p = r.sent()),
                ...
                return r(this, function (r) {
                  switch (r.label) {
                    ...
                    case 1:
                      ((t = r.sent()), (r.label = 2));
                    case 2:
                      return (r.trys.push([2, 5, , 6]), [4, this.ready()]);
                    case 3:
                      if (!r.sent())
        ...
        switch (E.label) {
                    ...
                    n(
                      () =>
                        import(`./ajs-destination.js`).then(function (n) {
                          return n.ajsDestinations(e, t, i.integrations, o, p, l);
                        }),
                  ...
                  n(
                    () =>
                      import(`./schema-filter.js`).then(function (e) {
                        return e.schemaFilter(o.plan?.track, t);
                      }),
          ...
          case 11:
            return (
              ...
              [
                4,
                Nn(t, i.integrations, y, o, p, f).catch(function (e) {
          ...
          case 12:
            return (
              ...
              S ? [3, 14] : ((w = (C = x).push), [4, ln(i, y[`Segment.io`], t.integrations)])
            );
          case 13:
            (w.apply(C, [E.sent()]), (E.label = 14));
          case 14:
            return [4, i.register.apply(i, a(a([], x, !1), d, !1))];
          case 15:
                    ...
                    n(
                      () =>
                        import(`./remote-middleware.js`).then(function (e) {
                          ...
                          return s(ee, void 0, void 0, function () {
                            var e, a;
                            return r(this, function (r) {
                              switch (r.label) {
                                case 0:
                                  return [4, n(T, t, o.obfuscate)];
                                case 1:
                                  return (
                                    (e = r.sent()),
                                    (a = e.map(function (e) {
    ...
    s(this, void 0, void 0, function () {
      ...
      return r(this, function (r) {
        switch (r.label) {
          case 0:
            return t.disable === !0
              ...
              : (t.globalAnalyticsKey && ne(t.globalAnalyticsKey),
                ...
                (o = qn()),
                (s = e.cdnURL ?? re()),
                (a = e.cdnSettings) == null ? [3, 1] : ((l = a), [3, 3]));
          case 1:
          ...
          case 4:
            if (((u = r.sent()), u)) return [2, [new Q(), M.system()]];
            r.label = 5;
          case 5:
            return (
              (d = c.integrations[`Segment.io`]?.retryQueue ?? !0),
              (t = i({ retryQueue: d }, t)),
              (f = new Z(i(i({}, e), { cdnSettings: c, cdnURL: s }), t)),
              Rn(f),
              (p = e.plugins ?? []),
              (m = e.classicIntegrations ?? []),
              (h = t.integrations?.[`Segment.io`]),
              Te.initRemoteMetrics(
                i(i({}, c.metrics), { host: h?.apiHost ?? c.metrics?.host, protocol: h?.protocol }),
              ),
              [4, Gn(e.writeKey, c, f, t, p, m, n)]
            );
          case 6:
            return (
              (g = r.sent()), (f.initialized = !0), f.emit(`initialize`, e, t), [4, Wn(f, o, n)]
            );
          case 7:
            return (r.sent(), [2, [f, g]]);
        }
