    ...
    (a(),
      ...
      (F = function (e, t) {
        ...
        (e.type === `page` &&
          ...
          (e.properties = l(l(l({}, t), e.properties), e.name ? { name: e.name } : {}))),
...
var ft = e(() => {
  ...
  ht = e(() => {
    (a(),
      ...
      (mt = (function () {
        function e(t) {
          (t === void 0 && (t = e.defaults), (this.options = l(l({}, e.defaults), t)));
        }
        return (
...
var jt,
  ...
  Kt = e(() => {
    (a(),
      (Gt = function (e) {
        return l({ "Content-Type": `text/plain` }, typeof e == `function` ? e() : e);
      }));
  });
function qt(e) {
                  ...
                  (M.system().log(`error`, `Error sending batch`, i),
                    e <= (t?.maxRetries ?? 10) &&
                      ...
                      n.map(function (t) {
                        if (`_metadata` in t) {
                          var n = t;
                          n._metadata = l(l({}, n._metadata), { retryCount: e });
                        }
                      }),
                      m(e + 1)));
                }),
...
function rn(e, t, n, r, i) {
  ...
  (o.length > 0 && (t._metadata = { failedInitializations: o }),
    i != null &&
      (i.attempts > 1 && (t._metadata = l(l({}, t._metadata), { retryCount: i.attempts })),
      i.attempts++));
  var s = [],
    c = [];
  for (var u in r) {
      ...
      (Z = (function (e) {
        ...
        function t(t, n, r, i, a) {
          ...
          return (
            ...
            (o._user = i ?? new W(l({ persist: !c, storage: n?.storage }, n?.user), s).load()),
            (o._group = a ?? new Dt(l({ persist: !c, storage: n?.storage }, n?.group), s).load()),
            ...
            return o(this, void 0, void 0, function () {
              ...
              return i(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return ((t = i.sent()), [2, (r = t.link).call.apply(r, s([this], e, !1))]);
                }
              });
            });
          }),
            ...
            return o(this, void 0, void 0, function () {
              ...
              return i(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return ((t = i.sent()), [2, (r = t.form).call.apply(r, s([this], e, !1))]);
                }
              });
            });
          }),
...
function Tn(e, t, n) {
  var r = new V(n ? [] : [new mt(xn())]),
    ...
    a = Sn(e) ?? i;
  a && (t && (t.referrer = l(l({}, t.referrer), a)), r.set(`s:context.referrer`, a));
}
var $,
  En,
  Dn,
              ...
              return o(f, void 0, void 0, function () {
                ...
                return i(this, function (i) {
                  switch (i.label) {
                    ...
                    case 3:
                      return (
                        (o = d), o ? ((f = n[e.name]), [4, o(l(l({}, e.settings), f))]) : [3, 5]
                      );
                    case 4:
                      ((p = i.sent()),
                    ...
                    n(
                      () =>
                        import(`./ajs-destination.js`).then(function (n) {
                          return n.ajsDestinations(e, t, r.integrations, a, p, l);
                        }),
          ...
          case 5:
            return (
              ...
              Te.initRemoteMetrics(
                l(l({}, s.metrics), { host: h?.apiHost ?? s.metrics?.host, protocol: h?.protocol }),
              ),
