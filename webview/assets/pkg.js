    ...
    (i(),
      ...
      (F = function (e, n) {
        ...
        var r = e.context,
          i;
        (e.type === `page` &&
          ((i = e.properties && qe(e.properties, Object.keys(n))),
          (e.properties = t(t(t({}, n), e.properties), e.name ? { name: e.name } : {}))),
          (r.page = t(t(t({}, n), i), r.page)));
      }));
  }),
  Xe = e(() => {
    (Ke(), Ye());
...
var ft = e(() => {
  ...
  ht = e(() => {
    (i(),
      ...
      (mt = (function () {
        function e(n) {
          (n === void 0 && (n = e.defaults), (this.options = t(t({}, e.defaults), n)));
        }
        return (
  ...
  Ot = e(() => {
    (i(),
        ...
        function e(e, n) {
          ...
          ((this.options = {}),
            (this.id = function (e) {
              ...
              var t = r.identityStore.getAndSync(r.idKey);
              e !== void 0 &&
                (r.identityStore.set(r.idKey, e),
                e !== t && t !== null && e !== null && r.anonymousId(null));
              var n = r.identityStore.getAndSync(r.idKey);
              if (n) return n;
              var i = r.legacyUserStore.get(U.cookie.oldKey);
              return i ? (typeof i == `object` ? i.id : i) : null;
            }),
            (this.anonymousId = function (e) {
              if (r.options.disable) return null;
              if (e === void 0) {
                var t = r.identityStore.getAndSync(r.anonKey) ?? r.legacySIO()?.[0];
                if (t) return t;
              }
              return e === null
                ? (r.identityStore.set(r.anonKey, null), r.identityStore.getAndSync(r.anonKey))
                : (r.identityStore.set(r.anonKey, e ?? v()), r.identityStore.getAndSync(r.anonKey));
            }),
            (this.traits = function (e) {
              if (!r.options.disable)
                return (
                  e === null && (e = {}),
                  e && r.traitsStore.set(r.traitsKey, e ?? {}),
                  r.traitsStore.get(r.traitsKey) ?? {}
                );
            }),
            (this.options = t(t({}, U), e)),
            ...
            (this.legacyUserStore = this.createStorage(this.options, n, function (e) {
              return e === z.Cookie;
            })),
            (this.traitsStore = this.createStorage(this.options, n, function (e) {
              return e !== z.Cookie;
            })));
        ...
        return (
          ...
          (e.prototype.identify = function (e, n) {
            if (!this.options.disable) {
              n ??= {};
              var r = this.id();
              ((r === null || r === e) && (n = t(t({}, this.traits()), n)),
                e && this.id(e),
                this.traits(n));
            }
          }),
      ...
      (Dt = (function (e) {
        ...
        function n(n, r) {
          n === void 0 && (n = Et);
          var i = e.call(this, t(t({}, Et), n), r) || this;
      ...
      switch (i.label) {
        case 0:
          return (
            ...
            t.called
              ? [2, void 0]
              : ((t.called = !0), (n = e[t.method].apply(e, t.args)), kt(n) ? [4, n] : [3, 2])
          );
        case 1:
          (i.sent(), (i.label = 2));
        case 2:
...
var jt,
      ...
      (Mt = function (e, t) {
        return o(void 0, void 0, void 0, function () {
          ...
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                ((n = 0), (r = t.getAndRemove(`addSourceMiddleware`)), (a.label = 1));
              case 1:
                return n < r.length ? ((i = r[n]), [4, G(e, i).catch(console.error)]) : [3, 4];
              case 2:
                (a.sent(), (a.label = 3));
              case 3:
                return (n++, [3, 1]);
  ...
  Kt = e(() => {
    (i(),
      (Gt = function (e) {
        return t({ "Content-Type": `text/plain` }, typeof e == `function` ? e() : e);
      }));
  });
function qt(e) {
  ...
  function d(t) {
    if (t.length !== 0) {
      ...
      return _e(`https://${e}/b`, {
        ...
        keepalive: n?.keepalive || i,
        headers: Gt(n?.headers),
        method: `post`,
        body: JSON.stringify({ writeKey: r, batch: a, sentAt: new Date().toISOString() }),
        priority: n?.priority,
      }).then(function (e) {
        ...
        return a(this, function (a) {
          return r.length
            ? ((i = r),
              ...
              [
                2,
                d(i)?.catch(function (a) {
                  (M.system().log(`error`, `Error sending batch`, a),
                    e <= (n?.maxRetries ?? 10) &&
                      (a.name === `RateLimitError` && (u = a.retryTimeout),
                      r.push.apply(r, i),
                      r.map(function (n) {
                        if (`_metadata` in n) {
                          var r = n;
                          r._metadata = t(t({}, r._metadata), { retryCount: e });
                        }
                      }),
                      m(e + 1)));
                }),
  ...
  function h(e, t) {
    return o(this, void 0, void 0, function () {
      ...
      return a(this, function (a) {
        return (
          r.push(t),
          (e = r.length >= c || Jt(r) || (n?.keepalive && Yt(r))),
          [2, e || i ? f() : m()]
        );
      });
    });
...
function rn(e, n, r, i, a) {
  ...
  (delete n.options,
    (n.writeKey = r?.apiKey),
    (n.userId = n.userId || o.id()),
    (n.anonymousId = n.anonymousId || o.anonymousId()),
    (n.sentAt = new Date()));
  var s = e.queue.failedInitializations || [];
  (s.length > 0 && (n._metadata = { failedInitializations: s }),
    a != null &&
      (a.attempts > 1 && (n._metadata = t(t({}, n._metadata), { retryCount: a.attempts })),
      a.attempts++));
  var c = [],
    l = [];
  for (var u in i) {
  ...
  for (var f = 0, p = r?.unbundledIntegrations || []; f < p.length; f++) {
    var m = p[f];
    l.includes(m) || l.push(m);
  }
  var h = r?.maybeBundledConfigIds ?? {},
    g = [];
  return (
    ...
    r?.addBundledMetadata !== !1 &&
      (n._metadata = t(t({}, n._metadata), {
        bundled: c.sort(),
        unbundled: l.sort(),
        bundledIds: g,
      })),
                      ...
                      return o(r, void 0, void 0, function () {
                        ...
                        return a(this, function (a) {
                          switch (a.label) {
                            ...
                            case 1:
                              return ((i = a.sent()), (o = i instanceof M), o || n.push(r), [2]);
                          }
                        });
                      });
                    },
        ...
        return a(this, function (a) {
          switch (a.label) {
            case 0:
              return ((e = !0), [4, on(n, t)]);
            case 1:
              return ((i = a.sent()), (e = !1), t.todo > 0 && r(e, i, n, r), [2]);
          }
        });
      });
    }, Math.random() * 5e3);
...
function ln(e, t, n) {
  window.addEventListener(`pagehide`, function () {
    (i.push.apply(i, Array.from(s)), s.clear());
  });
  var r = t?.apiKey ?? ``,
            ...
            i.getAttempts(r) >= i.maxAttempts
              ...
              : [
                  ...
                  p
                    ...
                    .catch(function (e) {
                      if ((r.log(`error`, `Error sending event`, e), e.name === `RateLimitError`)) {
      ...
      (Z = (function (e) {
        ...
        function i(n, r, i, a, o) {
          ...
          ((s = e.call(this) || this),
            ...
            (s.addIntegration = Y));
          var c = r?.cookie,
            l = r?.disableClientPersistence ?? !1;
          ((s.queue = i ?? fn(`${n.writeKey}:event-queue`, r?.retryQueue, l)),
            (s.settings = new hn(n, s.queue)));
          var u = r?.storage;
          return (
            (s._universalStorage = s.createStore(l, u, c)),
            (s._user = a ?? new W(t({ persist: !l, storage: r?.storage }, r?.user), c).load()),
            (s._group = o ?? new Dt(t({ persist: !l, storage: r?.storage }, r?.group), c).load()),
        ...
        return (
          (i.prototype.createStore = function (e, t, n) {
            return e
              ? new V([new R()])
              : t && bt(t)
            ...
            return o(this, void 0, void 0, function () {
              ...
              return a(this, function (a) {
                return (
                  ...
                  (o = n[2]),
                  (s = n[3]),
                  (c = this.eventFactory.track(r, i, o, this.integrations, t)),
                  [
                    2,
                    this._dispatch(c, s).then(function (e) {
                      return (l.emit(`track`, r, e.event.properties, e.event.options), e);
                    }),
                  ]
                );
              });
            ...
            return o(this, void 0, void 0, function () {
              ...
              return a(this, function (a) {
                return (
                  ...
                  (s = n[3]),
                  (c = n[4]),
                  (l = this.eventFactory.page(r, i, o, s, this.integrations, t)),
                  [
                    2,
                    this._dispatch(l, c).then(function (e) {
                      return (u.emit(`page`, r, i, e.event.properties, e.event.options), e);
                    }),
                  ]
                );
              });
            ...
            return o(this, void 0, void 0, function () {
              ...
              return a(this, function (a) {
                return (
                  ...
                  (o = n[2]),
                  (s = n[3]),
                  (c = this.eventFactory.alias(r, i, o, this.integrations, t)),
                  [
                    2,
                    this._dispatch(c, s).then(function (e) {
            ...
            return o(this, void 0, void 0, function () {
              ...
              return a(this, function (a) {
                return (
                  ...
                  (s = n[3]),
                  (c = n[4]),
                  (l = this.eventFactory.screen(r, i, o, s, this.integrations, t)),
                  [
                    2,
                    this._dispatch(l, c).then(function (e) {
                      return (u.emit(`screen`, r, i, e.event.properties, e.event.options), e);
                    }),
                  ]
                );
              });
            ...
            return o(this, void 0, void 0, function () {
              ...
              return a(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return ((t = i.sent()), [2, (r = t.link).call.apply(r, n([this], e, !1))]);
                }
              });
            });
          }),
          (i.prototype.trackLink = function () {
            var e = [...arguments];
            return o(this, void 0, void 0, function () {
              var t, r;
              return a(this, function (i) {
          ...
          (i.prototype.trackSubmit = function () {
            var e = [...arguments];
            return o(this, void 0, void 0, function () {
              var t, r;
              return a(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return ((t = i.sent()), [2, (r = t.form).call.apply(r, n([this], e, !1))]);
                }
              });
            });
          }),
          (i.prototype.trackForm = function () {
            var e = [...arguments];
            return o(this, void 0, void 0, function () {
              var t, r;
              return a(this, function (i) {
          ...
          (i.prototype.deregister = function () {
            var e = [...arguments];
            return o(this, void 0, void 0, function () {
              var t,
                n,
          ...
          (i.prototype._dispatch = function (e, t) {
            return o(this, void 0, void 0, function () {
              var n;
                              ...
                              case 1:
                                return (
                                  ...
                                  this.queue.plugins.forEach(function (e) {
                                    if (e.type === `destination`) return (n[e.name] = !0);
                                  }),
                                  (r = t(e, n)),
                                  [4, this.register(r)]
                                );
          ...
          (i.prototype.addDestinationMiddleware = function (e) {
          ...
          (i.prototype.queryString = function (e) {
            return o(this, void 0, void 0, function () {
              var t;
              return a(this, function (n) {
                switch (n.label) {
          ...
          Object.defineProperty(i.prototype, `failedInitializations`, {
            get: function () {
          ...
          Object.defineProperty(i.prototype, `plugins`, {
            get: function () {
          ...
          Object.defineProperty(i.prototype, `Integrations`, {
            get: function () {
              return (
                console.warn(X),
                this.queue.plugins
...
function Tn(e, n, r) {
  var i = new V(r ? [] : [new mt(xn())]),
    a = i.get(`s:context.referrer`),
    o = Sn(e) ?? a;
  o && (n && (n.referrer = t(t({}, n.referrer), o)), i.set(`s:context.referrer`, o));
}
var $,
  En,
  Dn,
      ...
      switch (a.label) {
        case 0:
          ...
          ((i = e.url.split(`/`)),
            ...
            (a.label = 1));
        case 1:
          return (a.trys.push([1, 3, , 5]), [4, ie(s.replace(n, r))]);
        case 2:
          return (a.sent(), [3, 5]);
        case 3:
          return (a.sent(), [4, ie(e.url.replace(n, r))]);
        case 4:
          return (a.sent(), [3, 5]);
        case 5:
          return [3, 8];
        ...
        case 9:
          throw ((c = a.sent()), console.error(`Failed to create PluginFactory`, e), c);
        case 10:
          return [2];
      }
    });
              ...
              return o(f, void 0, void 0, function () {
                ...
                return a(this, function (a) {
                  switch (a.label) {
                    ...
                    case 3:
                      return (
                        (o = d), o ? ((f = r[e.name]), [4, o(t(t({}, e.settings), f))]) : [3, 5]
                      );
                    case 4:
                      ((p = a.sent()),
                  ...
                  switch (i.label) {
                    case 0:
                      return this.action[e]
                        ? ((t = n), this.type === `destination` ? [4, this.transform(n)] : [3, 2])
                        : [2, n];
                    case 1:
                      ((t = i.sent()), (i.label = 2));
                    case 2:
                    ...
                    case 3:
                      ...
                      return (
                        k(n, { integrationName: this.action.name, methodName: e, type: `action` }),
                        [4, this.action[e](t)]
                      );
                    case 4:
                      return (i.sent(), [3, 6]);
        ...
        switch (E.label) {
                    ...
                    l(
                      () =>
                        import(`./routing-middleware.js`).then(function (e) {
                          return e.tsubMiddleware(t.middlewareSettings.routingRules);
                        }),
                      __vite__mapDeps([9, 1]),
                      import.meta.url,
                    ),
            ...
            return (
              ...
              Vn(t) || c.length > 0
                ? [
                    ...
                    l(
                      () =>
                        import(`./ajs-destination.js`).then(function (n) {
                          return n.ajsDestinations(e, t, r.integrations, i, p, c);
                        }),
                  ...
                  l(
                    () =>
                      import(`./schema-filter.js`).then(function (e) {
                        return e.schemaFilter(i.plan?.track, t);
                      }),
          ...
          case 11:
            return (
              ...
              [
                4,
                Nn(t, r.integrations, y, i, p, f).catch(function (e) {
          ...
          case 12:
            return (
              ...
              S ? [3, 14] : ((w = (C = x).push), [4, ln(r, y[`Segment.io`], t.integrations)])
            );
          case 13:
            (w.apply(C, [E.sent()]), (E.label = 14));
          case 14:
            return [4, r.register.apply(r, n(n([], x, !1), d, !1))];
          case 15:
            ...
            return (
              ...
              Object.entries(t.enabledMiddleware ?? {}).some(function (e) {
                ...
                ? [
                    ...
                    l(
                      () =>
                        import(`./remote-middleware-C.js`).then(function (e) {
    ...
    o(this, void 0, void 0, function () {
      ...
      return a(this, function (a) {
        switch (a.label) {
          ...
          case 4:
            if (((u = a.sent()), u)) return [2, [new Q(), M.system()]];
            a.label = 5;
          case 5:
            return (
              (d = c.integrations[`Segment.io`]?.retryQueue ?? !0),
              (n = t({ retryQueue: d }, n)),
              (f = new Z(t(t({}, e), { cdnSettings: c, cdnURL: s }), n)),
              Rn(f),
              (p = e.plugins ?? []),
              (m = e.classicIntegrations ?? []),
              (h = n.integrations?.[`Segment.io`]),
              Te.initRemoteMetrics(
                t(t({}, c.metrics), { host: h?.apiHost ?? c.metrics?.host, protocol: h?.protocol }),
              ),
              [4, Gn(e.writeKey, c, f, n, p, m, r)]
            );
          case 6:
            return (
              (g = a.sent()), (f.initialized = !0), f.emit(`initialize`, e, n), [4, Wn(f, o, r)]
            );
          case 7:
            return (a.sent(), [2, [f, g]]);
        }
      ...
      (Jn = function (e, t) {
        return o(void 0, void 0, void 0, function () {
          return a(this, function (n) {
            switch (n.label) {
              case 0:
                return t.includes(`ajs_`) ? [4, e.queryString(t).catch(console.error)] : [3, 2];
              case 1:
                (n.sent(), (n.label = 2));
              case 2:
                return [2];
