...
function ln(e, t, n) {
  window.addEventListener(`pagehide`, function () {
    (i.push.apply(i, Array.from(o)), o.clear());
  });
  var r = t?.apiKey ?? ``,
            ...
            return c(this, void 0, void 0, function () {
              ...
              return a(this, function (a) {
                switch (a.label) {
                  ...
                  case 1:
                    return ((r = a.sent()), [2, (i = r.link).call.apply(i, n([this], e, !1))]);
                }
              });
            });
          }),
            ...
            return c(this, void 0, void 0, function () {
              ...
              return a(this, function (a) {
                switch (a.label) {
                  ...
                  case 1:
                    return ((r = a.sent()), [2, (i = r.form).call.apply(i, n([this], e, !1))]);
                }
              });
            });
          }),
        ...
        case 0:
          return (
            ...
            (d = (e.remotePlugins ?? []).map(function (e) {
              return c(f, void 0, void 0, function () {
                var c, d, f, p, m, h, g;
                return a(this, function (a) {
                  switch (a.label) {
                    case 0:
                    ...
                    case 3:
                      return (
                        (c = d), c ? ((f = n[e.name]), [4, c(r(r({}, e.settings), f))]) : [3, 5]
                      );
                    case 4:
                      ((p = a.sent()),
        ...
        switch (E.label) {
                    ...
                    t(
                      () =>
                        import(`./routing-middleware.js`).then(function (e) {
                          return e.tsubMiddleware(r.middlewareSettings.routingRules);
                        }),
                      __vite__mapDeps([9, 1]),
                      import.meta.url,
                    ),
                    ...
                    t(
                      () =>
                        import(`./ajs-destination.js`).then(function (t) {
                          return t.ajsDestinations(e, r, i.integrations, o, p, l);
                        }),
          ...
          case 11:
            return (
              ...
              [
                4,
                Nn(r, i.integrations, y, o, p, f).catch(function (e) {
          ...
          case 12:
            return (
              ...
              S ? [3, 14] : ((w = (C = x).push), [4, ln(i, y[`Segment.io`], r.integrations)])
            );
          case 13:
            (w.apply(C, [E.sent()]), (E.label = 14));
          case 14:
            return [4, i.register.apply(i, n(n([], x, !1), d, !1))];
          case 15:
                    ...
                    t(
                      () =>
                        import(`./remote-middleware.js`).then(function (e) {
                          ...
                          return c(ee, void 0, void 0, function () {
                            var e, n;
                            return a(this, function (a) {
                              switch (a.label) {
                                case 0:
                                  return [4, t(T, r, o.obfuscate)];
                                case 1:
                                  return (
                                    (e = a.sent()),
                                    (n = e.map(function (e) {
        ...
        switch (a.label) {
          ...
          case 5:
            return (
              ...
              (t = r({ retryQueue: d }, t)),
              (f = new Z(r(r({}, e), { cdnSettings: c, cdnURL: s }), t)),
              Rn(f),
              (p = e.plugins ?? []),
          ...
          case 6:
            return (
              (g = a.sent()), (f.initialized = !0), f.emit(`initialize`, e, t), [4, Wn(f, o, n)]
            );
          case 7:
            return (a.sent(), [2, [f, g]]);
        }
