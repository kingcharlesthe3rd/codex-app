const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "./auto-track-DBG1-Gtc.js",
      "./callback.js",
      "./middleware-1.js",
      "./middleware.js",
      "./chunk.js",
      "./tslib.es6.js",
      "./query-string-B8-zqHQq.js",
      "./helpers-D.js",
      "./gracefulDecodeURIComponent.js",
      "./routing-middleware-Dgm-cLkU.js",
      "./ajs-destination.js",
      "./metric-helpers.js",
...
import { a as b, i as x, n as S, r as C, t as w } from "./helpers-D.js";
...
import { a as se, c as ce, o as le, r as ue, s as de, t as fe } from "./load-script-CGHs-PpL.js";
var pe = function (e, t) {
  ...
  Ce = (function () {
    ...
    return (
      ...
      (e.prototype.page = function (e, t, n, r, i) {
        ...
        var a = { type: `page`, properties: o({}, n), options: o({}, r), integrations: o({}, i) };
        return (
          e !== null &&
            ((a.category = e), (a.properties = a.properties ?? {}), (a.properties.category = e)),
          t !== null && (a.name = t),
      ...
      (e.prototype.screen = function (e, t, n, r, i) {
        ...
        var a = { type: `screen`, properties: o({}, n), options: o({}, r), integrations: o({}, i) };
        return (
          e !== null && (a.category = e),
          t !== null && (a.name = t),
          this.normalize(o(o({}, this.baseEvent()), a))
      ...
      (e.prototype.alias = function (e, t, n, r) {
        ...
        var i = { userId: e, type: `alias`, options: o({}, n), integrations: o({}, r) };
        return (
      ...
      (e.prototype.normalize = function (e) {
        ...
        var r = o(o({}, n), e.options?.integrations),
          ...
          c = e.options,
          l = t(e, [`options`]),
          u = o(o(o(o({ timestamp: new Date() }, l), { context: a, integrations: r }), s), {
  ...
  De = (function (e) {
    ...
    return (
                ...
                return (
                  ...
                  (r = function (n) {
                    (o.failedInitializations.push(t.name),
                      ...
                      e.log(`warn`, `Failed to load destination`, { plugin: t.name, error: n }),
        ...
        return r(this, void 0, void 0, function () {
          ...
          return n(this, function (n) {
            switch (n.label) {
              case 0:
                return (
                  n.trys.push([0, 3, , 4]), t.unload ? [4, Promise.resolve(t.unload(e, i))] : [3, 2]
                );
              case 1:
                (n.sent(), (n.label = 2));
              case 2:
              ...
              case 3:
                return (
                  (r = n.sent()),
                  e.log(`warn`, `Failed to unload destination`, { plugin: t.name, error: r }),
                  [3, 4]
                );
              case 4:
                return [2];
      ...
      (t.prototype.enqueuRetry = function (e, t) {
        return !(e instanceof u) || e.retry ? this.queue.pushWithBackoff(t) : !1;
      }),
      (t.prototype.flush = function () {
        return r(this, void 0, void 0, function () {
          ...
          return n(this, function (n) {
            switch (n.label) {
              case 0:
                if (this.queue.length === 0 || ((e = this.queue.pop()), !e)) return [2, []];
              ...
              case 3:
                return (
                  ...
                  r || (e.setFailedDelivery({ reason: t }), this.emit(`flush`, e, !1)),
                  [2, []]
                );
              case 4:
                return [2, [e]];
      ...
      (t.prototype.availableExtensions = function (e) {
        var t = we(
            this.plugins.filter(function (t) {
              var n;
              if (t.type !== `destination` && t.name !== `Segment.io`) return !0;
              var r = void 0;
              return (
          ...
          s = o === void 0 ? [] : o,
          c = t.after;
        return { before: r, enrichment: a, destinations: s, after: c === void 0 ? [] : c };
      }),
...
var F = function (e) {
  return function () {
    for (
      var t = [...arguments], n = {}, r = [`callback`, `options`, `traits`, `id`], i = 0, a = t;
      i < a.length;
      i++
    ) {
      var o = a[i],
      ...
      if (((s === `traits` || s === `options`) && (o == null || x(o)) && (n[s] = o), S(o))) {
        n.callback = o;
        break;
      }
    }
...
var Ie = function (e, t) {
  ...
  ze = function (e) {
    var t = e.c,
      ...
      a = e.r,
      o = e.t;
    return { path: t ? Re(t) : n, referrer: a, search: r, title: o, url: t ? Ie(t, r) : Le(i) };
  },
  Be = function () {
...
var I = function (e, t) {
    ...
    (e.type === `page` &&
      ...
      (e.properties = o(o(o({}, t), e.properties), e.name ? { name: e.name } : {}))),
...
var Xe = 365,
  Ze = (function () {
    function e(t) {
      (t === void 0 && (t = e.defaults), (this.options = o(o({}, e.defaults), t)));
    }
    return (
      Object.defineProperty(e, `defaults`, {
        get: function () {
          return { maxage: Xe, domain: Ye(window.location.href), path: `/`, sameSite: `Lax` };
        },
        enumerable: !1,
        configurable: !0,
      }),
...
var K = {
  ...
  nt = (function () {
    function e(e, t) {
      ...
      ((this.options = {}),
        ...
        (this.anonymousId = function (e) {
          ...
          return e === null
            ...
            : (n.identityStore.set(n.anonKey, e ?? p()), n.identityStore.getAndSync(n.anonKey));
        }),
      ...
      (r && typeof r == `object` && (r.id && this.id(r.id), r.traits && this.traits(r.traits)),
        L(this));
    }
    return (
  ...
  st = function (e, t) {
    return r(void 0, void 0, void 0, function () {
      ...
      return n(this, function (n) {
        switch (n.label) {
          case 0:
            ((r = 0), (i = t.getAndRemove(`addSourceMiddleware`)), (n.label = 1));
          case 1:
            return r < i.length ? ((a = i[r]), [4, Y(e, a).catch(console.error)]) : [3, 4];
          case 2:
            (n.sent(), (n.label = 3));
          case 3:
            return (r++, [3, 1]);
      ...
      switch (n.label) {
        case 0:
          return (
            ...
            t.called
              ? [2, void 0]
              : ((t.called = !0), (r = e[t.method].apply(e, t.args)), at(r) ? [4, r] : [3, 2])
          );
        case 1:
          (n.sent(), (n.label = 2));
        case 2:
...
var mt = (function () {
  ...
  _t = function (e) {
    return o({ "Content-Type": `text/plain` }, typeof e == `function` ? e() : e);
  },
  vt = 500,
  yt = 64;
function bt(e) {
                  ...
                  (s.system().log(`error`, `Error sending batch`, n),
                    e <= (i?.maxRetries ?? 10) &&
                      ...
                      a.map(function (t) {
                        if (`_metadata` in t) {
                          var n = t;
                          n._metadata = o(o({}, n._metadata), { retryCount: e });
                        }
                      }),
                      h(e + 1)));
                }),
...
function Et(e, t, n, r, i) {
  ...
  (s.length > 0 && (t._metadata = { failedInitializations: s }),
    i != null &&
      (i.attempts > 1 && (t._metadata = o(o({}, t._metadata), { retryCount: i.attempts })),
      i.attempts++));
  var c = [],
    l = [];
  for (var u in r) {
                      ...
                      return r(a, void 0, void 0, function () {
                        ...
                        return n(this, function (n) {
                          switch (n.label) {
                            ...
                            case 1:
                              return ((a = n.sent()), (o = a instanceof s), o || i.push(r), [2]);
                          }
                        });
                      });
                    },
        ...
        return n(this, function (n) {
          switch (n.label) {
            case 0:
              return ((e = !0), [4, Dt(i, t)]);
            case 1:
              return ((r = n.sent()), (e = !1), t.todo > 0 && a(e, r, i, a), [2]);
          }
        });
      });
    }, Math.random() * 5e3);
...
function At(e, t, i) {
  ...
  var a = t?.apiKey ?? ``,
    ...
    p = f && `strategy` in f && f.strategy === `batching` ? wt(l, f.config) : Tt(f?.config);
  function m(a) {
    return r(this, void 0, void 0, function () {
      var r, l;
      return n(this, function (n) {
...
var Nt = (function () {
  function e(e, t) {
    ((this.timeout = 300),
      ...
      (this.cdnSettings = e.cdnSettings ?? { integrations: { "Segment.io": { apiKey: `` } } }),
...
var Pt = (function (t) {
    ...
    function c(e, n, r, i, a) {
      ...
      return (
        ...
        (s._user = i ?? new nt(o({ persist: !l, storage: n?.storage }, n?.user), c).load()),
        (s._group = a ?? new it(o({ persist: !l, storage: n?.storage }, n?.group), c).load()),
      ...
      (c.prototype.createStore = function (e, t, n) {
        return e
          ...
          : t && $e(t)
            ...
            : new W(G([H.LocalStorage, { name: H.Cookie, settings: n }, H.Memory]));
      }),
          ...
          return n(this, function (n) {
            return (
              ...
              [
                2,
                this._dispatch(c, s).then(function (e) {
                  return (l.emit(`identify`, e.event.userId, e.event.traits, e.event.options), e);
                }),
              ]
            );
          });
            ...
            switch (n.label) {
              case 0:
                return [
                  4,
                  e(
                    () => import(`./auto-track-DBG1-Gtc.js`),
                    __vite__mapDeps([0, 1]),
                    import.meta.url,
                  ),
                ];
              case 1:
                return ((r = n.sent()), [2, (a = r.link).call.apply(a, i([this], t, !1))]);
            }
          });
        });
      }),
        ...
        return r(this, void 0, void 0, function () {
          ...
          return n(this, function (n) {
            switch (n.label) {
              ...
              case 1:
                return ((r = n.sent()), [2, (a = r.form).call.apply(a, i([this], t, !1))]);
            }
          });
        });
      }),
                          ...
                          case 1:
                            return (
                              ...
                              this.queue.plugins.forEach(function (e) {
                                if (e.type === `destination`) return (i[e.name] = !0);
                              }),
                              (a = r(t, i)),
                              [4, this.register(a)]
                            );
      ...
      (c.prototype.addDestinationMiddleware = function (e) {
        ...
        return (
          this.queue.plugins.filter(We).forEach(function (n) {
            (e === `*` || n.name.toLowerCase() === e.toLowerCase()) && n.addMiddleware.apply(n, t);
          }),
              ...
              case 0:
                return this.options.useQueryString === !1
                  ...
                  : [
                      4,
                      e(
                        () => import(`./query-string-B8-zqHQq.js`),
...
function Ht(e, t, n) {
  var r = new W(n ? [] : [new Ze(Rt())]),
    ...
    a = zt(e) ?? i;
  a && (t && (t.referrer = o(o({}, t.referrer), a)), r.set(`s:context.referrer`, a));
}
var Ut = function (e) {
    try {
    ...
    function e() {
      ...
      ((this.name = `Page Enrichment`),
        ...
        (this.enrich = function (t) {
          ...
          var o = Vt();
          (o && (n.amp = { id: o }), Ht(i, n, e.instance.options.disableClientPersistence ?? !1));
          try {
            ...
            switch (n.label) {
              ...
              case 1:
                return (
                  (t = n.sent()),
                  t === null &&
                    e.cancel(new u({ retry: !1, reason: `dropped by destination middleware` })),
                  [2, new s(t)]
                );
            }
          });
              ...
              switch (n.label) {
                case 0:
                  return this.action[e]
                    ? ((t = i), this.type === `destination` ? [4, this.transform(i)] : [3, 2])
                    : [2, i];
                case 1:
                  ((t = n.sent()), (n.label = 2));
                case 2:
                ...
                case 3:
                  ...
                  return (
                    A(i, { integrationName: this.action.name, methodName: e, type: `action` }),
                    [4, this.action[e](t)]
                  );
                case 4:
                  return (n.sent(), [3, 6]);
          ...
          return n(this, function (n) {
            switch (n.label) {
              ...
              case 1:
                return (
                  n.trys.push([1, 3, , 4]),
                  A(e, { integrationName: this.action.name, methodName: `load`, type: `action` }),
  ...
  return r(this, void 0, void 0, function () {
    ...
    return n(this, function (n) {
      switch (n.label) {
        ...
        case 9:
          throw ((c = n.sent()), console.error(`Failed to create PluginFactory`, e), c);
        case 10:
          return [2];
      }
    });
              ...
              return r(p, void 0, void 0, function () {
                ...
                return n(this, function (n) {
                  switch (n.label) {
                    ...
                    case 3:
                      return (
                        (r = f), r ? ((p = i[e.name]), [4, r(o(o({}, e.settings), p))]) : [3, 5]
                      );
                    case 4:
                      ((m = n.sent()),
...
function tn(e) {
  return It().NODE_ENV !== `test` && (e.middlewareSettings?.routingRules?.length ?? 0) > 0;
}
function nn(e, t) {
  (ut(e, t), lt(e, t));
}
        ...
        switch (D.label) {
            ...
            return (
              ...
              tn(a)
                ? [
                    ...
                    e(
                      () =>
                        import(`./routing-middleware-Dgm-cLkU.js`).then(function (e) {
                          return e.tsubMiddleware(a.middlewareSettings.routingRules);
                        }),
                      __vite__mapDeps([9, 4]),
                      import.meta.url,
                    ),
                    ...
                    e(
                      () =>
                        import(`./ajs-destination.js`).then(function (e) {
                          return e.ajsDestinations(t, a, o.integrations, s, p, l);
                        }),
          ...
          case 12:
            return (
              ...
              S ? [3, 14] : ((w = (C = x).push), [4, At(o, y[`Segment.io`], a.integrations)])
            );
          case 13:
        ...
        switch (n.label) {
          ...
          case 5:
            return (
              ...
              m.initRemoteMetrics(
                o(o({}, l.metrics), { host: _?.apiHost ?? l.metrics?.host, protocol: _?.protocol }),
              ),
              [4, sn(e.writeKey, l, p, t, h, g, i)]
            );
          case 6:
            return (
              (v = n.sent()), (p.initialized = !0), p.emit(`initialize`, e, t), [4, rn(p, r, i)]
            );
          case 7:
            return (n.sent(), [2, [p, v]]);
        }
