const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./middleware-1.js",
      "./query-string.js",
      "./gracefulDecodeURIComponent-D8d-fEjj.js",
...
import { n as ee, t as E } from "./gracefulDecodeURIComponent-D8d-fEjj.js";
import {
  c as te,
  d as ne,
  i as re,
    ...
    (l(),
      ...
      (F = function (e, t) {
        ...
        (e.type === `page` &&
          ...
          (e.properties = s(s(s({}, t), e.properties), e.name ? { name: e.name } : {}))),
          (n.page = s(s(s({}, t), r), n.page)));
      }));
  }),
  Xe = e(() => {
    (Ke(), Ye());
...
var ft = e(() => {
  ...
  ht = e(() => {
    (l(),
      ...
      (mt = (function () {
        function e(t) {
          (t === void 0 && (t = e.defaults), (this.options = s(s({}, e.defaults), t)));
        }
        return (
  ...
  Ot = e(() => {
    (l(),
        ...
        return (
          ...
          (e.prototype.identify = function (e, t) {
            if (!this.options.disable) {
              t ??= {};
              var n = this.id();
              ((n === null || n === e) && (t = s(s({}, this.traits()), t)),
                e && this.id(e),
                this.traits(t));
            }
          }),
      ...
      (Dt = (function (e) {
        ...
        function t(t, n) {
          t === void 0 && (t = Et);
          var r = e.call(this, s(s({}, Et), t), n) || this;
...
var jt,
      ...
      (Mt = function (e, t) {
        return o(void 0, void 0, void 0, function () {
          ...
          return i(this, function (i) {
            switch (i.label) {
              case 0:
                ((n = 0), (r = t.getAndRemove(`addSourceMiddleware`)), (i.label = 1));
              case 1:
                return n < r.length ? ((a = r[n]), [4, G(e, a).catch(console.error)]) : [3, 4];
              case 2:
                (i.sent(), (i.label = 3));
              case 3:
                return (n++, [3, 1]);
  ...
  Kt = e(() => {
    (l(),
      (Gt = function (e) {
        return s({ "Content-Type": `text/plain` }, typeof e == `function` ? e() : e);
      }));
  });
function qt(e) {
  ...
  function d(n) {
    if (n.length !== 0) {
      ...
      return _e(`https://${e}/b`, {
        ...
        method: `post`,
        body: JSON.stringify({ writeKey: i, batch: o, sentAt: new Date().toISOString() }),
        priority: t?.priority,
      }).then(function (e) {
                  ...
                  (M.system().log(`error`, `Error sending batch`, i),
                    e <= (t?.maxRetries ?? 10) &&
                      ...
                      n.map(function (t) {
                        if (`_metadata` in t) {
                          var n = t;
                          n._metadata = s(s({}, n._metadata), { retryCount: e });
                        }
                      }),
                      m(e + 1)));
                }),
  ...
  function h(e, r) {
    return o(this, void 0, void 0, function () {
      ...
      return i(this, function (i) {
        return (
          n.push(r),
          (e = n.length >= c || Jt(n) || (t?.keepalive && Yt(n))),
          [2, e || a ? f() : m()]
        );
      });
    });
...
function rn(e, t, n, r, i) {
  ...
  (o.length > 0 && (t._metadata = { failedInitializations: o }),
    i != null &&
      (i.attempts > 1 && (t._metadata = s(s({}, t._metadata), { retryCount: i.attempts })),
      i.attempts++));
  var c = [],
    l = [];
  for (var u in r) {
                      ...
                      return o(r, void 0, void 0, function () {
                        ...
                        return i(this, function (i) {
                          switch (i.label) {
                            ...
                            case 1:
                              return ((a = i.sent()), (o = a instanceof M), o || n.push(r), [2]);
                          }
                        });
                      });
                    },
        ...
        return i(this, function (i) {
          switch (i.label) {
            case 0:
              return ((e = !0), [4, on(n, t)]);
            case 1:
              return ((a = i.sent()), (e = !1), t.todo > 0 && r(e, a, n, r), [2]);
          }
        });
      });
    }, Math.random() * 5e3);
    ...
    (l(),
      ...
      (Z = (function (e) {
        ...
        function n(t, n, r, i, a) {
          ...
          ((o.queue = r ?? fn(`${t.writeKey}:event-queue`, n?.retryQueue, l)),
            (o.settings = new hn(t, o.queue)));
          var u = n?.storage;
          return (
            (o._universalStorage = o.createStore(l, u, c)),
            (o._user = i ?? new W(s({ persist: !l, storage: n?.storage }, n?.user), c).load()),
            (o._group = a ?? new Dt(s({ persist: !l, storage: n?.storage }, n?.group), c).load()),
            ...
            return o(this, void 0, void 0, function () {
              ...
              return i(this, function (i) {
                return (
                  ...
                  (s = n[3]),
                  (c = n[4]),
                  (l = this.eventFactory.page(r, a, o, s, this.integrations, t)),
                  [
                    2,
                    this._dispatch(l, c).then(function (e) {
                      return (u.emit(`page`, r, a, e.event.properties, e.event.options), e);
                    }),
                  ]
                );
              });
            ...
            return o(this, void 0, void 0, function () {
              ...
              return i(this, function (i) {
                return (
                  ...
                  (s = n[3]),
                  (c = n[4]),
                  (l = this.eventFactory.screen(r, a, o, s, this.integrations, t)),
                  [
                    2,
                    this._dispatch(l, c).then(function (e) {
                      return (u.emit(`screen`, r, a, e.event.properties, e.event.options), e);
                    }),
                  ]
                );
              });
            ...
            return o(this, void 0, void 0, function () {
              ...
              return i(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return ((n = i.sent()), [2, (r = n.link).call.apply(r, c([this], e, !1))]);
                }
              });
            });
          }),
            ...
            return o(this, void 0, void 0, function () {
              ...
              return i(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return ((n = i.sent()), [2, (r = n.form).call.apply(r, c([this], e, !1))]);
                }
              });
            });
          }),
                        ...
                        return o(n, void 0, void 0, function () {
                          ...
                          return i(this, function (i) {
                            switch (i.label) {
                              ...
                              case 1:
                                return (
                                  (n = i.sent().sourceMiddlewarePlugin),
                                  (r = {}),
...
function Tn(e, t, n) {
  var r = new V(n ? [] : [new mt(xn())]),
    ...
    a = Sn(e) ?? i;
  a && (t && (t.referrer = s(s({}, t.referrer), a)), r.set(`s:context.referrer`, a));
}
var $,
  En,
  Dn,
  ...
  return o(this, void 0, void 0, function () {
    ...
    return i(this, function (i) {
      switch (i.label) {
        ...
        case 9:
          throw ((c = i.sent()), console.error(`Failed to create PluginFactory`, e), c);
        case 10:
          return [2];
      }
    });
              ...
              return o(f, void 0, void 0, function () {
                ...
                return i(this, function (i) {
                  switch (i.label) {
                    ...
                    case 3:
                      return (
                        (o = d), o ? ((f = n[e.name]), [4, o(s(s({}, e.settings), f))]) : [3, 5]
                      );
                    case 4:
                      ((p = i.sent()),
    ...
    o(this, void 0, void 0, function () {
      ...
      return i(this, function (E) {
        switch (E.label) {
                    ...
                    t(
                      () =>
                        import(`./ajs-destination.js`).then(function (t) {
                          return t.ajsDestinations(e, n, r.integrations, a, p, l);
                        }),
          ...
          case 14:
            return [4, r.register.apply(r, c(c([], x, !1), d, !1))];
          case 15:
        ...
        switch (i.label) {
          case 0:
            return t.disable === !0
              ...
              : (t.globalAnalyticsKey && ne(t.globalAnalyticsKey),
                ...
                (a = qn()),
                (o = e.cdnURL ?? re()),
                (r = e.cdnSettings) == null ? [3, 1] : ((l = r), [3, 3]));
          case 1:
          ...
          case 5:
            return (
              ...
              (t = s({ retryQueue: d }, t)),
              (f = new Z(s(s({}, e), { cdnSettings: c, cdnURL: o }), t)),
              Rn(f),
              (p = e.plugins ?? []),
              (m = e.classicIntegrations ?? []),
              (h = t.integrations?.[`Segment.io`]),
              Te.initRemoteMetrics(
                s(s({}, c.metrics), { host: h?.apiHost ?? c.metrics?.host, protocol: h?.protocol }),
              ),
              [4, Gn(e.writeKey, c, f, t, p, m, n)]
            );
          case 6:
            return (
              (g = i.sent()), (f.initialized = !0), f.emit(`initialize`, e, t), [4, Wn(f, a, n)]
            );
          case 7:
            return (i.sent(), [2, [f, g]]);
        }
