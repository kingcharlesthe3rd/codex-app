...
import { cn as l, n as u } from "./use-host-config-C.js";
import {
  $ as d,
  A as f,
  Et as p,
...
import { A, r as j } from "./vscode-api.js";
import { i as M } from "./react.js";
import "./isEqual.js";
import { _n as N } from "./src-1.js";
import "./client.js";
import "./react-dom.js";
import { l as P, s as F } from "./lib-1.js";
import { t as I } from "./clsx.js";
import { t as L } from "./proxy.js";
import { G as R, T as z, a as B } from "./app-shell-state.js";
...
import "./chevron.js";
import { t as ie } from "./clock-Cid-cc8u.js";
import "./warning.js";
import "./waveform.js";
import "./markdown-to-search-text.js";
import "./shiki-highlight-provider-gate.js";
import { a as ae, i as oe, n as se, t as ce } from "./local-conversation-turn.js";
import "./core.esm.js";
import "./katex-1.js";
import "./marked.esm.js";
import "./pdf-1.js";
import "./product-logger.js";
import { a as H, f as le, g as ue } from "./chunk-13.js";
import "./parse-directives.js";
import { p as U } from "./thread-side-panel-tabs-2.js";
import "./platform.js";
import { d as de, f as W } from "./persisted-signal.js";
...
import { i as fe } from "./models-and-reasoning-efforts.js";
...
import { c as pe } from "./apps-queries.js";
import "./uniq.js";
...
import { Yt as ge } from "./review-navigation-model.js";
...
import { t as _e } from "./project-context-signal.js";
...
import { t as ye } from "./format-model-display-name.js";
...
import { f as be, t as xe } from "./composer.js";
import "./local-environment-create-route.js";
import "./upgrade-plan-dialog-launcher.js";
import { r as Se } from "./composer-suggestion-list-JT-G56TZ.js";
import { f as Ce } from "./heartbeat-automation-eligibility.js";
...
import { t as Te } from "./animations.js";
import "./chat.js";
import "./folders.js";
import "./dropdown.js";
...
import { n as Ee, r as De } from "./local-task-row.js";
...
import { i as Oe } from "./thread-actions.js";
import { i as ke, n as Ae, t as je } from "./popover.js";
import { t as Me } from "./get-attached-heartbeat-automation-for-thread.js";
...
import { n as Ne } from "./sidebar-task-pr-chip-signals.js";
import "./automation-schedule.js";
import { C as Pe, a as Fe, d as Ie, i as Le, o as Re } from "./automation-shared.js";
import "./request-user-input-auto-resolution.js";
import { t as G } from "./use-is-background-subagents-enabled.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import "./settings-host-context.js";
import "./use-git-current-branch.js";
import { t as ze } from "./pin-filled.js";
import "./pin.js";
...
import { o as Be } from "./above-composer-panel-row.js";
...
import { n as He, r as Ue, t as We } from "./review-runtime-bridge.js";
...
import { t as Ge } from "./right-panel-composer-overlay-DGO3-ZX5.js";
import { t as Ke } from "./workspace-file-command-menu-bridge.js";
...
import { a as qe } from "./open-artifact-side-panel-tab.js";
...
import { i as Je, n as Ye, o as Xe, r as Ze, s as Qe, t as $e } from "./use-debug-panel.js";
import "./header.js";
import "./thread-scroll-controller-context-value.js";
import "./thread-scroll-layout.js";
import { n as et, t as tt } from "./local-conversation-stream-role-product-event.js";
...
import { n as gt, r as J, t as _t } from "./split-items-into-render-groups.js";
import "./worktree-paths.js";
import { t as vt } from "./thread-overflow-menu.js";
import "./primary-runtime-install-status-message-9X-UzhFS.js";
import "./plan-summary-item-content.js";
import "./robot.js";
import { t as yt } from "./thread-app-shell-chrome-2.js";
...
function xt(e) {
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = (0, Z.jsx)(ke, { asChild: !0, children: a })), (t[0] = a), (t[1] = o));
  let s;
  ...
  return (
    t[5] !== r || t[6] !== i || t[7] !== o || t[8] !== l
      ? ((u = (0, Z.jsxs)(je, { open: r, onOpenChange: i, children: [o, l] })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = o),
        (t[8] = l),
...
function wt(e) {
  let t = (0, Y.c)(42),
    ...
    h = A(),
    g;
  t[0] === c ? (g = t[1]) : ((g = c ? N(c) : null), (t[0] = c), (t[1] = g));
  let _ = ht(g, u(i(O, n)).id),
    v;
  t[2] === p ? (v = t[3]) : ((v = { canPin: p }), (t[2] = p), (t[3] = v));
  let { isPinned: y } = Oe(n, v),
    b;
  if (t[4] !== n || t[5] !== h) {
    let e = h.getQueryData(j(`list-automations`));
    ((b = e == null ? null : Me({ automations: e.items, conversationId: n })),
      (t[4] = n),
      (t[5] = h),
      (t[6] = b));
  } else b = t[6];
  let x = b,
    ...
    [C, w] = (0, X.useState)(!1),
    T;
  t[7] !== x || t[8] !== n || t[9] !== m || t[10] !== S || t[11] !== C
    ? ((T =
        n == null
          ? null
          : (0, Z.jsx)(Ee, {
              conversationId: n,
              hasAttachedHeartbeatAutomation: x != null,
              heartbeatAutomationTooltipContent:
                x == null ? null : (0, Z.jsx)(Q, { automation: x }),
              hideProjectMetadata: m,
              hoverCardSections: S == null ? void 0 : [S.hoverCardSection],
              shouldFetchHoverBranch: C,
            })),
      (t[7] = x),
      (t[8] = n),
      (t[9] = m),
  ...
  t[13] === y
    ...
    : ((D = y
        ? (0, Z.jsx)(`span`, {
            "aria-hidden": !0,
            className: `flex h-5 shrink-0 items-center justify-center text-token-description-foreground`,
            children: (0, Z.jsx)(ze, { className: `icon-xs` }),
          })
        : null),
      (t[13] = y),
      (t[14] = D));
  ...
  t[15] === o
    ? (k = t[16])
    : ((k = (0, Z.jsx)(`span`, { className: `min-w-0 truncate`, children: o })),
      (t[15] = o),
      (t[16] = k));
  let M;
  t[17] !== E || t[18] !== k
  ...
  t[23] !== P || t[24] !== s
    ...
    : (F = t[25]);
  let I;
  t[26] === x ? (I = t[27]) : ((I = (0, Z.jsx)(Tt, { automation: x })), (t[26] = x), (t[27] = I));
  let L;
  t[28] !== p ||
  t[29] !== _ ||
  t[30] !== n ||
  ...
  t[35] !== o
    ...
    : (L = t[36]);
  let R;
  t[37] === Symbol.for(`react.memo_cache_sentinel`) ? ((R = null), (t[37] = R)) : (R = t[37]);
  let z;
  return (
...
function Tt(e) {
  ...
  t[0] !== n || t[1] !== i || t[2] !== a || t[3] !== o
    ? ((s = () => {
        (a(null), o(Ie({ directiveKey: `thread-header-${n.id}`, automation: n })), i(!0));
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a),
  ...
  let c = s,
    l;
  t[5] === n ? (l = t[6]) : ((l = (0, Z.jsx)(Q, { automation: n })), (t[5] = n), (t[6] = l));
  let u;
  t[7] === r
    ? (u = t[8])
    : ((u = r.formatMessage({
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Z.jsx)(ie, { className: `icon-xs` })), (t[9] = d))
    : (d = t[9]);
  let f;
  t[10] !== c || t[11] !== u
    ? ((f = (0, Z.jsx)(ee, {
  ...
  return (
    t[13] !== l || t[14] !== f
      ? ((p = (0, Z.jsx)(re, { tooltipContent: l, delayOpen: !0, children: f })),
        (t[13] = l),
        (t[14] = f),
        (t[15] = p))
      : (p = t[15]),
...
function Q(e) {
  ...
  t[0] !== n.nextRunAt || t[1] !== n.status || t[2] !== r
    ? ((i = Pe({ intl: r, nextRunAt: n.nextRunAt, status: n.status })),
      (t[0] = n.nextRunAt),
      (t[1] = n.status),
      (t[2] = r),
      (t[3] = i))
...
function Et(e) {
  ...
  t[8] === u
    ? (d = t[9])
    : ((d = I(`icon-2xs text-current transition-transform duration-300`, u)),
      (t[8] = u),
      (t[9] = d));
  let f;
  t[10] === d
    ...
    : ((f = (0, Z.jsx)(`span`, {
        ...
        children: (0, Z.jsx)(te, { className: d, "aria-hidden": !0 }),
      })),
      (t[10] = d),
      (t[11] = f));
  let p;
  ...
  return (
    t[34] !== w || t[35] !== p
      ? ((T = (0, Z.jsxs)(Be, { children: [p, w] })), (t[34] = w), (t[35] = p), (t[36] = T))
      : (T = t[36]),
    T
  );
}
...
function kt(e) {
  let t = (0, Y.c)(30),
    { conversationId: n, cwd: r, expanded: a, hostId: o, isInProgress: s, onExpandedChange: c } = e,
    l = G(),
    u = i(T, n),
    d = i(E, n),
    f;
  t[0] === o ? (f = t[1]) : ((f = { hostId: o }), (t[0] = o), (t[1] = f));
  let { data: p } = pe(f),
    m = p === void 0 ? Ot : p,
    h = u?.turnId ?? null,
    g;
  bb0: {
    ...
    if (t[2] !== d || t[3] !== h) {
      ...
      (t[5] === h
        ? (n = t[6])
        : ((n = (e) => `turnId` in e.params && e.params.turnId === h), (t[5] = h), (t[6] = n)),
        (e = d.filter(n)),
        (t[2] = d),
        (t[3] = h),
        (t[4] = e));
  ...
  bb1: {
    ...
    let e;
    (t[7] !== l || t[8] !== u || t[9] !== v
      ? ((e = _(u, v, { isBackgroundSubagentsEnabled: l })),
        (t[7] = l),
        (t[8] = u),
        (t[9] = v),
        (t[10] = e))
  ...
  bb2: {
    ...
    let e;
    (t[11] !== s || t[12] !== b
      ? ((e = At({ isInProgress: s, latestTurnState: b })), (t[11] = s), (t[12] = b), (t[13] = e))
      : (e = t[13]),
      (x = e));
  }
  let S = x;
  ...
  t[14] !== u || t[15] !== S
    ? ((C =
        S == null
          ...
          : (0, Z.jsx)(ae, {
              ...
              workedDurationMs: u.durationMs ?? null,
    ...
    : (C = t[16]);
  let w;
  t[17] !== m || t[18] !== n || t[19] !== r || t[20] !== o || t[21] !== u || t[22] !== b
    ? ((w = (0, Z.jsx)(ce, {
        conversationId: n,
        hostId: o,
  ...
  let D;
  return (
    t[24] !== a || t[25] !== s || t[26] !== c || t[27] !== C || t[28] !== w
      ? ((D = (0, Z.jsx)(Et, {
          expanded: a,
          headerLabel: C,
          isTurnInProgress: s,
...
function At({ isInProgress: e, latestTurnState: t }) {
  let n = Mt(t.items),
    { agentItems: r, assistantItem: i, proposedPlanItem: a } = _t(se(t.items), t.status),
    { renderableAgentItems: o } = gt({
      agentItems: r,
      isTurnInProgress: e,
      isAnyNonAgentItemInProgress: J(i) || J(a),
    }),
    s = jt(o);
  return e && n != null
    ? {
...
function $(e) {
  ...
  return (
    t[0] !== a || t[1] !== o
      ? ((c = (0, Z.jsx)(We, { lastTurnCwd: o, lastTurnDiff: a })),
        (t[0] = a),
        (t[1] = o),
        (t[2] = c))
      : (c = t[2]),
...
function Pt(e) {
  let t = (0, Y.c)(41),
    ...
    m = s(R),
    h;
  (t[0] === a ? (h = t[1]) : ((h = (e) => U(a, e)), (t[0] = a), (t[1] = h)), He(h));
  let g = p && m,
    _ = g && f?.tabId === de.DIFF && d.kind === `git`,
    v = !g,
    y = f?.tabId ?? null,
    b;
  t[2] !== g || t[3] !== y
    ? ((b = ft({ activeTabId: y, isRightPanelExpanded: g })), (t[2] = g), (t[3] = y), (t[4] = b))
    : (b = t[4]);
  let x = b,
  ...
  t[5] !== c || t[6] !== a
    ? ((w = (e) => {
        ut(a, { backgroundAgent: e, hostId: c, TabComponent: pt });
      }),
      (t[5] = c),
      (t[6] = a),
      (t[7] = w))
  ...
  let D;
  t[9] !== n || t[10] !== _
    ? ((D = _ ? (0, Z.jsx)(Nt, { conversationId: n }) : null), (t[9] = n), (t[10] = _), (t[11] = D))
    : (D = t[11]);
  let k;
  t[12] === n
    ? (k = t[13])
    : ((k = (0, Z.jsx)($, { conversationId: n })), (t[12] = n), (t[13] = k));
  let A;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, Z.jsx)(V.MainContentLayout, { layout: `thread-edge-scroll` })), (t[14] = A))
    : (A = t[14]);
  let j;
  t[15] === n
    ? (j = t[16])
    : ((j = (0, Z.jsx)(V.Header, { children: (0, Z.jsx)(Lt, { conversationId: n }) })),
      (t[15] = n),
      (t[16] = j));
  let M;
  t[17] !== n || t[18] !== v || t[19] !== r
    ? ((M = (0, Z.jsx)(`div`, {
    ...
    : (M = t[20]);
  let N;
  t[21] !== n || t[22] !== l.display_name
    ? ((N = (0, Z.jsx)(yt, {
        browserHostDisplayName: l.display_name,
        conversationId: n,
        threadType: `local`,
      })),
      (t[21] = n),
  ...
  t[24] === T
    ? (P = t[25])
    : ((P = (0, Z.jsx)(Ft, { onOpenBackgroundAgent: T })), (t[24] = T), (t[25] = P));
  let F;
  t[26] !== n || t[27] !== x || t[28] !== r
    ? ((F = x ? (0, Z.jsx)(Rt, { conversationId: n, startRealtime: r }, n) : null),
      (t[26] = n),
      (t[27] = x),
      (t[28] = r),
      (t[29] = F))
  ...
  return (
    t[38] !== S || t[39] !== I
      ? ((L = (0, Z.jsx)(be, { value: S, children: I })), (t[38] = S), (t[39] = I), (t[40] = L))
      : (L = t[40]),
    L
  );
}
          ...
          children:
            c.displayMode === `overlay`
              ? (0, Z.jsx)(xt, {
                  ...
                  trigger: (0, Z.jsx)(K.HeaderButton, { label: u, pressed: c.isPopoverOpen }),
                  children: (0, Z.jsx)(It, { onOpenBackgroundAgent: n }),
                })
              : (0, Z.jsx)(K.HeaderButton, {
                  label: f,
                  pressed: a,
                  onClick: () => {
                    r.set(z, !a);
...
function It(e) {
  ...
  return (
    t[0] !== r || t[1] !== n
      ? ((i = (0, Z.jsx)(ot, { ...r, onOpenBackgroundAgent: n })),
        (t[0] = r),
        (t[1] = n),
        (t[2] = i))
      : (i = t[2]),
...
function Lt(e) {
  let t = (0, Y.c)(33),
    ...
    h = i(w, n),
    g;
  t[0] === h ? (g = t[1]) : ((g = fe(h) ? h : null), (t[0] = h), (t[1] = g));
  let _ = g,
    v = l(i(p, n)),
    y = v?.parentThreadId == null,
    b = a ? v : null,
    x = i(m, n) === `projectless`,
    T = b?.parentThreadId ?? null,
    E = b == null ? null : mt({ agentNickname: b.agentNickname, conversationId: n }),
    D;
  t[2] !== n || t[3] !== E || t[4] !== T
    ? ((D =
        T != null && E != null
          ? (0, Z.jsxs)(`span`, {
              ...
              children: [
                (0, Z.jsx)(Se, { className: `icon-2xs`, seed: n, "aria-hidden": !0 }),
    ...
    : (D = t[5]);
  let O = D,
    A = b?.agentRole == null || b.agentRole === `default` ? null : `(${b.agentRole})`,
    j;
  t[6] === A
    ? (j = t[7])
    : ((j =
  ...
  t[18] !== u
    ? ((L = async () => {
        if (!s) return null;
        let { visibleTurnEntries: e } = r.get(rt, {
          conversationId: n,
  ...
  let R = L,
    z = s ? n : null,
    B;
  t[20] !== O || t[21] !== P || t[22] !== M
    ? ((B =
        O == null && M == null && P == null
          ? null
          : (0, Z.jsxs)(Z.Fragment, { children: [O, M, P] })),
      (t[20] = O),
      (t[21] = P),
      (t[22] = M),
      (t[23] = B))
...
function Rt(e) {
  let t = (0, Y.c)(13),
    ...
    o = i(f, n),
    s;
  t[0] === o ? (s = t[1]) : ((s = o ? N(o) : null), (t[0] = o), (t[1] = s));
  let c = s,
    l = i(h, n) ?? !1;
  (i(v, n), i(b, n));
  let u = l || !1,
  ...
  if (!d) return null;
  let g;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((g = () => m(!1)), (t[2] = g)) : (g = t[2]);
  let _;
  t[3] !== n || t[4] !== c || t[5] !== a || t[6] !== u || t[7] !== p
    ? ((_ = (0, Z.jsx)(kt, {
        conversationId: n,
        cwd: c,
        expanded: p,
  ...
  Bt = a(W, ({ get: e, scope: t }) => {
    ...
    return {
      ...
      lines: [
        ...
        { label: `model`, value: e(C, n) ?? `unknown` },
        { label: `reasoning`, value: e(w, n) ?? `unknown` },
        { label: `rolloutPath`, value: e(D, n) ?? `unknown` },
        { label: `resumeState`, value: e(y, n) ?? `unknown` },
        { label: `cwd`, value: e(f, n) ?? `unknown` },
...
function Vt() {
  let { conversationId: e } = ue(),
    { state: t } = le(),
    n = i(k, e ?? null),
    r = i(f, e ?? null),
    a = Je(),
    { isResuming: o } = st(null),
    { canOpenThreadInNewWindow: s, openThreadInNewWindow: c } = Ce({ conversationId: e ?? null }),
    l = (0, X.useRef)(e ?? null),
    u = (0, X.useRef)(!1),
    d = (0, X.useRef)(null);
  if (
    (l.current !== (e ?? null) && ((l.current = e ?? null), (u.current = !1), (d.current = null)),
    n && (u.current = !0),
    r != null && (d.current = r),
    ve(`openThreadInNewWindow`, c, { enabled: s }),
    !e)
  )
    return (0, Z.jsx)(H, { to: `/` });
  if (u.current && !n && !o)
  ...
  let p =
    o || !n
      ? (0, Z.jsx)(we, { debugName: `LocalConversationPage` })
      : (0, Z.jsx)(Pt, { conversationId: e, startRealtime: t?.startRealtime === !0 });
  return (0, Z.jsxs)(Z.Fragment, {
    children: [
      (0, Z.jsx)(tt, { conversationId: e }),
      a ? (0, Z.jsx)(Ht, {}) : null,
      (0, Z.jsx)(et, { conversationId: e }),
      (0, Z.jsx)(Ke, {}),
      (0, Z.jsx)(Ue.Surface, {}),
      p,
    ],
