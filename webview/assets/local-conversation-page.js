...
import { n as rr, t as ir } from "./app-initial~app-main~local-conversation-page.js";
import {
  a as ar,
  c as or,
  i as sr,
...
import { n as Zr, r as Qr, t as $r } from "./thread-app-shell-chrome-1.js";
...
function ti(e, t, n) {
  ...
  let r = yt(e),
    i = yt(t),
    a = Ae(i) || Qe(i),
    o = V.default.posix.relative(a ? i.toLowerCase() : i, a ? r.toLowerCase() : r);
  if (o === `..` || o.startsWith(`..${V.default.posix.sep}`) || V.default.posix.isAbsolute(o))
    return e;
  let s =
      o === ``
        ? ``
        : r
            ...
            .slice(-o.split(V.default.posix.sep).length)
            .join(V.default.posix.sep),
    c = yt(V.default.posix.join(n, s));
  return Qe(n) ? `//${c.replace(/^\/+/, ``)}` : c;
}
var V,
  ni = e(() => {
    ((V = t(Ie(), 1)), k(), qt(), lt(), sn(), Et(), nt());
  });
function ri(e) {
  let t = (0, ii.c)(14),
    { conversationId: n } = e,
  ...
  (t[0] !== r || t[1] !== i || t[2] !== a
    ? ((s = () => {
        i == null ||
          a == null ||
          (ei(r, { sourceWorkspaceRoot: i, targetWorkspaceRoot: a }), r.set(Oe, null));
      }),
      (c = [r, i, a]),
      (t[0] = r),
      (t[1] = i),
...
var ii,
  H,
  ai = e(() => {
    ((ii = I()), x(), (H = t($e(), 1)), Lt(), Yt(), D(), tn(), Se(), Pt(), ni());
  });
function oi(e) {
  let t = (0, li.c)(10),
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = (0, U.jsx)(Le, { asChild: !0, children: a })), (t[0] = a), (t[1] = o));
  let s;
  ...
  return (
    t[5] !== r || t[6] !== i || t[7] !== o || t[8] !== l
      ? ((u = (0, U.jsxs)(et, { open: r, onOpenChange: i, children: [o, l] })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = o),
        (t[8] = l),
...
function pi(e) {
  let t = (0, W.c)(32),
    ...
    g = Pe(),
    _;
  t[0] === d ? (_ = t[1]) : ((_ = d ? te(d) : null), (t[0] = d), (t[1] = _));
  let y = xr(_, v(P(E, n)).id),
    b;
  if (t[2] !== n || t[3] !== g) {
    let e = g.getQueryData(l(`list-automations`));
    ((b = e == null ? null : qn({ automations: e.items, conversationId: n })),
      (t[2] = n),
      (t[3] = g),
      (t[4] = b));
  } else b = t[4];
  ...
  t[10] === c
    ? (C = t[11])
    : ((C = (0, G.jsx)(`span`, { className: `min-w-0 truncate`, children: c })),
      (t[10] = c),
      (t[11] = C));
  let w;
  t[12] !== C || t[13] !== u
    ...
    : (w = t[14]);
  let T;
  t[15] === x ? (T = t[16]) : ((T = (0, G.jsx)(mi, { automation: x })), (t[15] = x), (t[16] = T));
  let D;
  t[17] !== m ||
  t[18] !== y ||
  t[19] !== n ||
  ...
  t[24] !== c
    ...
    : (D = t[25]);
  let O;
  t[26] === Symbol.for(`react.memo_cache_sentinel`) ? ((O = null), (t[26] = O)) : (O = t[26]);
  let k;
  return (
    t[27] !== S || t[28] !== w || t[29] !== T || t[30] !== D
      ? ((k = (0, G.jsx)(`div`, {
...
function mi(e) {
  ...
  t[0] !== n.id || t[1] !== n.name || t[2] !== i
    ? ((a = () => {
        Kt({ scope: i, automationId: n.id, title: n.name });
      }),
      (t[0] = n.id),
      (t[1] = n.name),
      (t[2] = i),
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, G.jsx)(Nt, { className: `icon-xs` })), (t[8] = l))
    : (l = t[8]);
  let u;
  t[9] !== o || t[10] !== c
    ? ((u = (0, G.jsx)(Ke, {
  ...
  return (
    t[12] !== s || t[13] !== u
      ? ((d = (0, G.jsx)(it, { tooltipContent: s, delayOpen: !0, children: u })),
        (t[12] = s),
        (t[13] = u),
        (t[14] = d))
      : (d = t[14]),
...
function hi(e) {
  ...
  t[0] !== n.nextRunAt || t[1] !== n.status || t[2] !== r
    ? ((i = gn({ intl: r, nextRunAt: n.nextRunAt, status: n.status })),
      (t[0] = n.nextRunAt),
      (t[1] = n.status),
      (t[2] = r),
      (t[3] = i))
...
function _i(e) {
  ...
  t[8] === u
    ? (d = t[9])
    : ((d = rt(`icon-2xs text-current transition-transform duration-300`, u)),
      (t[8] = u),
      (t[9] = d));
  let f;
  t[10] === d
    ...
    : ((f = (0, K.jsx)(`span`, {
        ...
        children: (0, K.jsx)(Ve, { className: d, "aria-hidden": !0 }),
      })),
      (t[10] = d),
      (t[11] = f));
  let p;
  ...
  let m = n ? `auto` : 0,
    ...
    _;
  t[17] !== m || t[18] !== g
    ? ((_ = { height: m, opacity: g }), (t[17] = m), (t[18] = g), (t[19] = _))
    : (_ = t[19]);
  let v = n ? `overflow-visible` : `overflow-hidden`,
    y = n ? `auto` : `none`,
    b;
  t[20] === y ? (b = t[21]) : ((b = { pointerEvents: y }), (t[20] = y), (t[21] = b));
  let x;
  t[22] === o
    ? (x = t[23])
    : ((x = [{ key: `latest-turn-preview`, node: o }]), (t[22] = o), (t[23] = x));
  let S;
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = { preview: `18rem`, expanded: `18rem`, collapsed: `0px` }), (t[24] = S))
    : (S = t[24]);
  let C = n ? `expanded` : `collapsed`,
    w;
  t[25] !== n || t[26] !== x || t[27] !== C
    ? ((w = (0, K.jsx)(Ct, {
        items: x,
  ...
  return (
    t[34] !== T || t[35] !== p
      ? ((E = (0, K.jsxs)(Rn, { children: [p, T] })), (t[34] = T), (t[35] = p), (t[36] = E))
      : (E = t[36]),
    E
  );
}
...
function bi(e) {
  ...
  bb1: {
    ...
    let e;
    (t[7] !== c || t[8] !== l || t[9] !== _
      ? ((e = y(l, _, { isBackgroundSubagentsEnabled: c })),
        (t[7] = c),
        (t[8] = l),
        (t[9] = _),
        (t[10] = e))
  ...
  bb2: {
    ...
    let e;
    (t[11] !== o || t[12] !== b
      ? ((e = xi({ isInProgress: o, latestTurnState: b })), (t[11] = o), (t[12] = b), (t[13] = e))
      : (e = t[13]),
      (x = e));
  }
  let S = x;
  ...
  t[14] !== l || t[15] !== S
    ? ((C =
        S == null
          ...
          : (0, q.jsx)(Ft, {
              ...
              workedDurationMs: qe(l) ? null : (l.durationMs ?? null),
    ...
    : (C = t[16]);
  let w;
  t[17] !== p || t[18] !== n || t[19] !== r || t[20] !== a || t[21] !== l || t[22] !== b
    ? ((w = (0, q.jsx)(Rt, {
        conversationId: n,
        hostId: a,
  ...
  let T;
  return (
    t[24] !== i || t[25] !== o || t[26] !== s || t[27] !== C || t[28] !== w
      ? ((T = (0, q.jsx)(_i, {
          expanded: i,
          headerLabel: C,
          isTurnInProgress: o,
...
function xi({ isInProgress: e, latestTurnState: t }) {
  let n = Ci(t.items),
    { agentItems: r, assistantItem: i, proposedPlanItem: a } = At(wt(t.items), t.status),
    { renderableAgentItems: o } = ln({
      agentItems: r,
      isTurnInProgress: e,
      isAnyNonAgentItemInProgress: pn(i) || pn(a),
    }),
    s = Si(o);
  return e && n != null
    ? {
...
function Oi(e) {
  ...
  return (
    t[0] !== i || t[1] !== a
      ? ((o = (0, Ai.jsx)(kn, { lastTurnCwd: a, lastTurnDiff: i })),
        (t[0] = i),
        (t[1] = a),
        (t[2] = o))
      : (o = t[2]),
...
function Bi(e) {
  ...
  let s;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Y.jsx)(Je, { className: `icon-xs` })), (t[2] = s))
    : (s = t[2]);
  let c;
  t[3] !== i || t[4] !== o
    ? ((c = (0, Y.jsx)(`button`, {
  ...
  t[6] === n
    ? (l = t[7])
    : ((l = (0, Y.jsx)(kt, { seed: n, className: `size-6`, "aria-hidden": !0 })),
      (t[6] = n),
      (t[7] = l));
  let u;
  t[8] === r
...
async function Hi(
  ...
  (r != null &&
    ...
    ee.openTab(e, Pi, {
      icon: (0, Wi.jsx)(Nn, { className: `icon-sm` }),
      id: `subagents:${n}`,
      title: e
        .get(fn)
        .formatMessage({
...
async function Ui(e, { hostId: t, parentConversationId: r, selectedConversationId: i }) {
  if (i === r) return !1;
  let a = new Set(),
    o = i,
    s = 0;
  for (; o !== r; ) {
    ...
    let r = s < 2;
    if (
      ((r || !e.get(n, o) || e.get(ne, o) == null) &&
        (await ye(`hydrate-background-threads`, { hostId: t, includeTurns: r, threadIds: [o] })),
      !e.get(n, o))
    )
      return !1;
    let i = e.get(ne, o);
  ...
  return (
    await ye(`hydrate-background-threads`, { hostId: t, includeTurns: !0, threadIds: [r] }), !0
  );
}
var Wi,
  Gi = e(() => {
    (L(), O(), lt(), Pn(), rn(), Vi(), (Wi = R()));
  });
function Ki({ conversationId: e }) {
  ...
  wn((e) => en(t, e));
  let c = o && s,
    l = c && a?.tabId === C.DIFF && i.kind === `git`,
    u = !c,
    d = jr({ activeTabId: a?.tabId ?? null, isRightPanelExpanded: c }),
    [f, p] = (0, Qi.useState)(null),
    m = tt((r) => {
  ...
  return (0, X.jsx)(Bn, {
    ...
    children: (0, X.jsxs)(`div`, {
      ...
      children: [
        ...
        l ? (0, X.jsx)(Mi, { conversationId: e }) : null,
        (0, X.jsx)(Oi, { conversationId: e }),
        (0, X.jsx)(z.MainContentLayout, { layout: `thread-edge-scroll` }),
        (0, X.jsx)(z.Header, { children: (0, X.jsx)(Yi, { conversationId: e }) }),
        (0, X.jsx)(`div`, { className: `h-full min-h-0`, children: h }),
        (0, X.jsx)($r, {
        ...
        null,
        (0, X.jsx)(qi, { onOpenBackgroundAgent: m }),
        d ? (0, X.jsx)(Xi, { conversationId: e }, e) : null,
      ],
    }),
  });
}
...
function Yi({ conversationId: e }) {
  let t = N(p),
    ...
    f = r ? u : null,
    m = P(Ce, e) === `projectless`,
    h = P(_, e),
    g = P($n, at(u?.parentThreadId ?? e)),
    v = m ? null : (g?.projectId ?? h),
    y = v == null ? null : zn(h ?? v, g?.label),
    b = Zn(v ?? ``),
    x =
      y == null
        ? null
    ...
    S = f?.parentThreadId ?? null,
    C = f == null ? null : Wr({ agentNickname: f.agentNickname, conversationId: e }),
    w =
      S != null && C != null
        ? (0, X.jsxs)(`span`, {
            className: `ml-1 flex shrink-0 items-center gap-1 font-medium`,
            children: [
              (0, X.jsx)(Ze, { className: `icon-2xs`, seed: e, "aria-hidden": !0 }),
              (0, X.jsx)(`span`, { children: C }),
            ],
          })
        : null,
    T = f?.agentRole == null || f.agentRole === `default` ? null : `(${f.agentRole})`,
    E =
      T == null
        ? null
        : (0, X.jsx)(`span`, {
      ...
      S == null || o == null
        ...
        : (0, X.jsxs)(`span`, {
            ...
            children: [
              ...
              l == null
                ? null
                : (0, X.jsxs)(X.Fragment, { children: [` (`, (0, X.jsx)(zt, { effort: l }), `)`] }),
            ],
          }),
    O = P(s, e);
  return (0, X.jsx)(pi, {
    ...
    title: a,
    titleSuffix:
      w == null && E == null && D == null ? null : (0, X.jsxs)(X.Fragment, { children: [w, E, D] }),
    projectIcon:
      b == null
        ? x
        : (0, X.jsx)(dt, { appearance: b, className: `size-5 [&>svg]:size-5`, fallbackIcon: x }),
    projectHoverCardContent: g == null ? null : (0, X.jsx)(Qn, { group: g }),
    projectName: y,
    cwd: h,
    getConversationMarkdown: async () => {
      if (!i) return null;
      let { visibleTurnEntries: n } = t.get(Mr, {
        conversationId: e,
        isBackgroundSubagentsEnabled: r,
      });
      return Or({
        cwd: h,
        isBackgroundSubagentsEnabled: r,
        projectlessOutputDirectory: O,
        title: a,
        visibleTurnEntries: n,
      });
    },
    canPin: d,
    hideForkActions: m,
...
function Xi(e) {
  let t = (0, Zi.c)(16),
    ...
    o = P(_, r),
    s;
  t[0] === o ? (s = t[1]) : ((s = o ? te(o) : null), (t[0] = o), (t[1] = s));
  let c = s,
    l = P(ft, r),
    u = P(mt, r) ?? !1;
  (P(Ye, r), P(d, r));
  ...
  if (!p) return null;
  let g;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((g = () => h(!1)), (t[2] = g)) : (g = t[2]);
  let v;
  t[3] === i ? (v = t[4]) : ((v = re(i) ?? void 0), (t[3] = i), (t[4] = v));
  let y;
  t[5] !== r || t[6] !== c || t[7] !== a || t[8] !== f || t[9] !== m
    ? ((y = (0, X.jsx)(bi, {
        conversationId: r,
        cwd: c,
        expanded: m,
...
function ta({ conversationId: e }) {
  let t = P(n, e),
    ...
    a = ce(`567837310`),
    o = ar(),
    { isResuming: s } = Vr(a ? e : null),
    { canOpenThreadInNewWindow: c, openThreadInNewWindow: l } = tr({ conversationId: e }),
    u = (0, Q.useRef)(e),
    d = (0, Q.useRef)(!1),
    f = (0, Q.useRef)(null);
  if (
    (u.current !== e && ((u.current = e), (d.current = !1), (f.current = null)),
    t && (d.current = !0),
    r != null && (f.current = r),
    ie(`openThreadInNewWindow`, l, { enabled: c }),
    d.current && !t && !s)
  )
    return (0, $.jsx)(i, {
      to: `/`,
  ...
  let p =
    s || !t
      ? (0, $.jsx)(Jt, { debugName: `LocalConversationPage` })
...
function na(e) {
  ...
  if (i != null) {
    ...
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(z.MainContentLayout, { layout: `thread-edge-scroll` })), (t[0] = e))
      : (e = t[0]);
    let n;
    t[1] === i.title
      ? (n = t[2])
      : ((n = (0, $.jsx)(z.Header, { children: (0, $.jsx)(bn, { start: i.title }) })),
        (t[1] = i.title),
        (t[2] = n));
    let a;
    t[3] !== r || t[4] !== i.status
      ? ((a = (0, $.jsx)(`div`, {
          ...
          children:
            i.status === `creating`
              ? (0, $.jsx)(Jt, { debugName: `PendingProjectlessLocalConversationPage` })
              : (0, $.jsxs)(`div`, {
  ...
  if (a == null) {
    ...
    return (
      t[9] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsx)(Jt, { debugName: `PendingClientLocalConversationPage` })), (t[9] = e))
        : (e = t[9]),
      e
    );
  }
...
function ra(e) {
  let t = (0, Z.c)(9),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(z.MainContentLayout, { layout: `thread-edge-scroll` })),
      (o = (0, $.jsx)(z.Header, {})),
      (t[0] = a),
      (t[1] = o))
    : ((a = t[0]), (o = t[1]));
    ...
    (oa = m(M, ({ get: e, scope: t }) => {
      ...
      return {
        ...
        lines: [
          ...
          { label: `model`, value: e(ht, n) ?? `unknown` },
          { label: `reasoning`, value: e(bt, n) ?? `unknown` },
          { label: `rolloutPath`, value: e(le, n) ?? `unknown` },
          { label: `resumeState`, value: e(ae, n) ?? `unknown` },
          { label: `cwd`, value: e(_, n) ?? `unknown` },
