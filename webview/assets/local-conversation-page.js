...
import "./isEqual.js";
import { pn as N } from "./src-2.js";
import "./client.js";
import "./react-dom.js";
import { l as P, s as F } from "./lib.js";
...
import { r as W, t as re } from "./dropdown.js";
import "./search.js";
...
import { i as q } from "./models-and-reasoning-efforts.js";
...
import "./katex-3.js";
import "./pdf.js";
import { a as Ce, f as we, g as Te } from "./chunk-9.js";
...
import { n as De, u as Oe } from "./app-shell-tab-controller.js";
import "./browser-sidebar-manager.js";
import { t as ke } from "./local-conversation-title-signals.js";
import { Yt as Ae } from "./review-navigation-model.js";
...
import { t as je } from "./project-context-signal.js";
...
import { t as Me } from "./use-register-command-m.js";
...
import { c as Ne } from "./reasoning-minimal.js";
...
import { p as Pe, t as Fe } from "./composer.js";
import "./upgrade-plan-dialog-launcher.js";
import { l as Ie } from "./use-composer-top-menu-max-height.js";
import { A as Le } from "./interrupted-turn-state.js";
...
import { t as Re } from "./loading-page.js";
...
import { C as Ke, a as qe, d as Je, i as Ye, o as Xe } from "./automation-shared.js";
import "./chat.js";
import "./folders.js";
...
import { i as Ze } from "./thread-actions.js";
import { i as Qe, n as $e, t as et } from "./popover.js";
import "./face.js";
import { a as tt, o as nt } from "./profile-dropdown.js";
import "./archive.js";
...
import { i as rt, n as it, r as at, t as ot } from "./review-runtime-bridge.js";
import "./gh-pull-request-status-query.js";
import "./automation-schedule.js";
import { t as st } from "./get-attached-heartbeat-automation-for-thread.js";
import { t as ct } from "./use-is-background-subagents-enabled.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import "./settings-host-context.js";
import "./use-git-current-branch.js";
import { t as lt } from "./pin-filled.js";
import "./pin.js";
...
import { l as ut } from "./above-composer-panel-row.js";
...
import { t as dt } from "./model-and-reasoning-effort-translations.js";
...
import { i as ft, n as pt, o as mt, r as ht, s as gt, t as _t } from "./use-debug-panel.js";
import "./header-1.js";
import "./thread-scroll-controller-context-value.js";
import "./thread-scroll-layout.js";
import { n as vt, t as yt } from "./local-conversation-stream-role-product-event.js";
...
import { n as bt, r as xt, t as St } from "./split-items-into-render-groups.js";
import "./worktree-paths.js";
import "./primary-runtime-install-status-message.js";
import "./plan-summary-item-content.js";
import "./robot.js";
import { t as Ct } from "./thread-app-shell-chrome-1.js";
...
function wt(e) {
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = (0, $.jsx)(Qe, { asChild: !0, children: a })), (t[0] = a), (t[1] = o));
  let s;
  ...
  return (
    t[5] !== r || t[6] !== i || t[7] !== o || t[8] !== l
      ? ((u = (0, $.jsxs)(et, { open: r, onOpenChange: i, children: [o, l] })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = o),
        (t[8] = l),
...
function Dt(e) {
  let t = (0, Q.c)(48),
    {
      ...
      markdownParentConversationId: c,
      title: l,
      titleSuffix: u,
      cwd: d,
      canPin: f,
    ...
    y = A(),
    b;
  t[0] === d ? (b = t[1]) : ((b = d ? N(d) : null), (t[0] = d), (t[1] = b));
  let x = xe(b, O(r(w, n)).id),
    S;
  t[2] === h ? (S = t[3]) : ((S = { canPin: h }), (t[2] = h), (t[3] = S));
  let { isPinned: C } = Ze(n, S),
    T = o(Be),
    E = o(Ve),
    D = o(ze),
    k;
  t[4] !== h || t[5] !== n || t[6] !== D
    ? ((k = !h || n == null ? null : D.find((e) => e.threadIds.includes(n))?.emoji || null),
      (t[4] = h),
      (t[5] = n),
      (t[6] = D),
      (t[7] = k))
  ...
  let M = k,
    F;
  t[8] !== M || t[9] !== C
    ? ((F = C ? (0, $.jsx)(lt, { className: `icon-xs` }) : M), (t[8] = M), (t[9] = C), (t[10] = F))
    : (F = t[10]);
  let L = F,
    R = n != null && T && E ? He(_, { threadId: n, isPinned: C, sections: D })[0]?.submenu : null,
    z = I(
      `flex h-5 shrink-0 items-center justify-center text-sm leading-none`,
      C ? `text-token-description-foreground` : `text-[var(--vscode-foreground)]`,
    ),
    B;
  if (t[11] !== n || t[12] !== y) {
    let e = y.getQueryData(j(`list-automations`));
    ((B = e == null ? null : st({ automations: e.items, conversationId: n })),
      (t[11] = n),
      (t[12] = y),
      (t[13] = B));
  } else B = t[13];
  let V = B,
    ...
    U;
  t[14] !== V || t[15] !== n || t[16] !== g || t[17] !== H || t[18] !== ee
    ? ((U =
        n == null
          ? null
          : (0, $.jsx)(tt, {
              conversationId: n,
              hasAttachedHeartbeatAutomation: V != null,
              heartbeatAutomationTooltipContent:
                V == null ? null : (0, $.jsx)(At, { automation: V }),
              hideProjectMetadata: g,
              hoverCardSections: H == null ? void 0 : [H.hoverCardSection],
  ...
  let ne = U,
    W =
      L == null
        ? null
        : R == null
          ? (0, $.jsx)(`span`, { "aria-hidden": !0, className: z, children: L })
          : (0, $.jsx)(re, {
              triggerButton: (0, $.jsx)(`button`, {
                type: `button`,
                "aria-label": v.formatMessage(Ge.moveTo),
                className: I(z, `cursor-interaction hover:text-token-foreground`),
                children: L,
              }),
              align: `start`,
  ...
  t[20] === l
    ? (G = t[21])
    : ((G = (0, $.jsx)(`span`, { className: `min-w-0 truncate`, children: l })),
      (t[20] = l),
      (t[21] = G));
  let K;
  t[22] !== ne || t[23] !== te || t[24] !== G
    ? ((K = (0, $.jsx)(nt, {
        align: `start`,
        hoverCardContent: ne,
        onOpenChange: te,
  ...
  t[29] !== q || t[30] !== u
    ...
    : (J = t[31]);
  let Y;
  t[32] === V ? (Y = t[33]) : ((Y = (0, $.jsx)(kt, { automation: V })), (t[32] = V), (t[33] = Y));
  let X;
  t[34] !== h ||
  t[35] !== x ||
  t[36] !== n ||
  ...
  t[41] !== l
    ...
    : (X = t[42]);
  let ie;
  t[43] === Symbol.for(`react.memo_cache_sentinel`) ? ((ie = null), (t[43] = ie)) : (ie = t[43]);
  let ae;
  return (
    t[44] !== J || t[45] !== Y || t[46] !== X
      ? ((ae = (0, $.jsx)(`div`, {
...
function Ot(e) {
  return e.type === `separator`
    ? (0, $.jsx)(W.Separator, {}, e.id)
    : (0, $.jsx)(
        W.Item,
        {
          disabled: e.enabled === !1,
          onSelect: e.onSelect,
          children: e.message ? (0, $.jsx)(F, { ...e.message, values: e.messageValues }) : e.id,
        },
        e.id,
      );
}
function kt(e) {
  ...
  t[0] !== n || t[1] !== i || t[2] !== a || t[3] !== o
    ? ((s = () => {
        (a(null), o(Je({ directiveKey: `thread-header-${n.id}`, automation: n })), i(!0));
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a),
  ...
  let c = s,
    l;
  t[5] === n ? (l = t[6]) : ((l = (0, $.jsx)(At, { automation: n })), (t[5] = n), (t[6] = l));
  let u;
  t[7] === r
    ? (u = t[8])
    : ((u = r.formatMessage({
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)(J, { className: `icon-xs` })), (t[9] = d))
    : (d = t[9]);
  let f;
  t[10] !== c || t[11] !== u
    ? ((f = (0, $.jsx)(H, {
  ...
  return (
    t[13] !== l || t[14] !== f
      ? ((p = (0, $.jsx)(U, { tooltipContent: l, delayOpen: !0, children: f })),
        (t[13] = l),
        (t[14] = f),
        (t[15] = p))
      : (p = t[15]),
...
function At(e) {
  ...
  t[0] !== n.nextRunAt || t[1] !== n.status || t[2] !== r
    ? ((i = Ke({ intl: r, nextRunAt: n.nextRunAt, status: n.status })),
      (t[0] = n.nextRunAt),
      (t[1] = n.status),
      (t[2] = r),
      (t[3] = i))
...
function jt(e) {
  ...
  t[10] === d
    ...
    : ((f = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(ee, { className: d, "aria-hidden": !0 }),
      })),
      (t[10] = d),
      (t[11] = f));
  let p;
  ...
  return (
    t[34] !== w || t[35] !== p
      ? ((T = (0, $.jsxs)(ut, { children: [p, w] })), (t[34] = w), (t[35] = p), (t[36] = T))
      : (T = t[36]),
    T
  );
}
...
function Pt(e) {
  let t = (0, Q.c)(30),
    { conversationId: n, cwd: i, expanded: a, hostId: o, isInProgress: s, onExpandedChange: c } = e,
    l = ct(),
    u = r(p, n),
    d = r(y, n),
    f;
  ...
  bb1: {
    ...
    let e;
    (t[7] !== l || t[8] !== u || t[9] !== v
      ? ((e = b(u, v, { isBackgroundSubagentsEnabled: l })),
        (t[7] = l),
        (t[8] = u),
        (t[9] = v),
        (t[10] = e))
  ...
  bb2: {
    ...
    let e;
    (t[11] !== s || t[12] !== S
      ? ((e = Ft({ isInProgress: s, latestTurnState: S })), (t[11] = s), (t[12] = S), (t[13] = e))
      : (e = t[13]),
      (C = e));
  }
  let w = C;
  ...
  t[14] !== u || t[15] !== w
    ? ((T =
        w == null
          ? void 0
          : (0, $.jsx)(le, {
              collapsedMessageCount: w.collapsedMessageCount,
              workedDurationMs: u.durationMs ?? null,
              workedForItem: w.workedForItem,
    ...
    : (T = t[16]);
  let E;
  t[17] !== h || t[18] !== n || t[19] !== i || t[20] !== o || t[21] !== u || t[22] !== S
    ? ((E = (0, $.jsx)(fe, {
        conversationId: n,
        hostId: o,
  ...
  let D;
  return (
    t[24] !== a || t[25] !== s || t[26] !== c || t[27] !== T || t[28] !== E
      ? ((D = (0, $.jsx)(jt, {
          expanded: a,
          headerLabel: T,
          isTurnInProgress: s,
...
function Ft({ isInProgress: e, latestTurnState: t }) {
  let n = Lt(t.items),
    { agentItems: r, assistantItem: i, proposedPlanItem: a } = St(ye(t.items), t.status),
    { renderableAgentItems: o } = bt({
      agentItems: r,
      isTurnInProgress: e,
      isAnyNonAgentItemInProgress: xt(i) || xt(a),
    }),
    s = It(o);
  return e && n != null
    ? {
...
function Rt(e) {
  ...
  return (
    t[0] !== a || t[1] !== s
      ? ((c = (0, $.jsx)(ot, { lastTurnCwd: s, lastTurnDiff: a })),
        (t[0] = a),
        (t[1] = s),
        (t[2] = c))
      : (c = t[2]),
...
function Bt(e) {
  let t = (0, Q.c)(40),
    ...
    p = o(R),
    m;
  (t[0] === s ? (m = t[1]) : ((m = (e) => ne(s, e)), (t[0] = s), (t[1] = m)), at(m));
  let h = f && p,
    g = h && d?.tabId === Oe.DIFF && u.kind === `git`,
    _ = !h,
    v = d?.tabId ?? null,
    y;
  t[2] !== h || t[3] !== v
    ? ((y = se({ activeTabId: v, isRightPanelExpanded: h })), (t[2] = h), (t[3] = v), (t[4] = y))
    : (y = t[4]);
  let b = y,
  ...
  t[5] !== c || t[6] !== s
    ? ((C = (e) => {
        _e(s, { backgroundAgent: e, hostId: c, TabComponent: ve });
      }),
      (t[5] = c),
      (t[6] = s),
      (t[7] = C))
  ...
  let T = te(C),
    E;
  t[8] !== n || t[9] !== g
    ? ((E = g ? (0, $.jsx)(zt, { conversationId: n }) : null), (t[8] = n), (t[9] = g), (t[10] = E))
    : (E = t[10]);
  let D;
  t[11] === n
    ? (D = t[12])
    : ((D = (0, $.jsx)(Rt, { conversationId: n })), (t[11] = n), (t[12] = D));
  let k;
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, $.jsx)(V.MainContentLayout, { layout: `thread-edge-scroll` })), (t[13] = k))
    : (k = t[13]);
  let A;
  t[14] === n
    ? (A = t[15])
    : ((A = (0, $.jsx)(V.Header, { children: (0, $.jsx)(Ut, { conversationId: n }) })),
      (t[14] = n),
      (t[15] = A));
  let j;
  t[16] !== n || t[17] !== _ || t[18] !== i
    ? ((j = (0, $.jsx)(`div`, {
  ...
  t[23] === T
    ? (N = t[24])
    : ((N = (0, $.jsx)(Vt, { onOpenBackgroundAgent: T })), (t[23] = T), (t[24] = N));
  let P;
  t[25] !== n || t[26] !== b || t[27] !== i
    ? ((P = b ? (0, $.jsx)(Wt, { conversationId: n, startRealtime: i }, n) : null),
      (t[25] = n),
      (t[26] = b),
      (t[27] = i),
      (t[28] = P))
  ...
  return (
    t[37] !== x || t[38] !== F
      ? ((I = (0, $.jsx)(Pe, { value: x, children: F })), (t[37] = x), (t[38] = F), (t[39] = I))
      : (I = t[39]),
    I
  );
}
          ...
          children:
            c.displayMode === `overlay`
              ? (0, $.jsx)(wt, {
                  ...
                  trigger: (0, $.jsx)(Y.HeaderButton, { label: u, pressed: c.isPopoverOpen }),
                  children: (0, $.jsx)(Ht, { onOpenBackgroundAgent: n }),
                })
              : (0, $.jsx)(Y.HeaderButton, {
                  label: f,
                  pressed: s,
                  onClick: () => {
                    r.set(z, !s);
...
function Ht(e) {
  ...
  return (
    t[0] !== r || t[1] !== n
      ? ((i = (0, $.jsx)(X, { ...r, onOpenBackgroundAgent: n })),
        (t[0] = r),
        (t[1] = n),
        (t[2] = i))
      : (i = t[2]),
...
function Ut(e) {
  let t = (0, Q.c)(33),
    ...
    f = r(_, n),
    p;
  t[0] === f ? (p = t[1]) : ((p = q(f) ? f : null), (t[0] = f), (t[1] = p));
  let m = p,
    g = C(r(T, n)),
    y = g?.parentThreadId == null,
    b = o ? g : null,
    x = r(S, n) === `projectless`,
    w = b?.parentThreadId ?? null,
    E = b == null ? null : ue({ agentNickname: b.agentNickname, conversationId: n }),
    O;
  t[2] !== n || t[3] !== E || t[4] !== w
    ? ((O =
        w != null && E != null
          ? (0, $.jsxs)(`span`, {
              ...
              children: [
                (0, $.jsx)(Ie, { className: `icon-2xs`, seed: n, "aria-hidden": !0 }),
  ...
  t[18] !== l
    ? ((L = async () => {
        if (!c) return null;
        let { visibleTurnEntries: e } = i.get(he, {
          conversationId: n,
  ...
  let R = L,
    z = c ? n : null,
    B;
  t[20] !== k || t[21] !== P || t[22] !== M
    ? ((B =
        k == null && M == null && P == null
          ? null
          : (0, $.jsxs)($.Fragment, { children: [k, M, P] })),
      (t[20] = k),
      (t[21] = P),
      (t[22] = M),
      (t[23] = B))
  ...
  return (
    ...
    t[31] !== l
      ? ((V = (0, $.jsx)(Dt, {
          conversationId: z,
          markdownParentConversationId: w,
          title: l,
          titleSuffix: B,
          cwd: F,
...
function Wt(e) {
  ...
  if (!h) return null;
  let y;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((y = () => _(!1)), (t[2] = y)) : (y = t[2]);
  let b;
  t[3] !== n || t[4] !== c || t[5] !== a || t[6] !== p || t[7] !== g
    ? ((b = (0, $.jsx)(Pt, {
        conversationId: n,
        cwd: c,
        expanded: g,
  ...
  Kt = i(Ee, ({ get: e, scope: t }) => {
    ...
    return {
      ...
      lines: [
        ...
        { label: `model`, value: e(h, n) ?? `unknown` },
        { label: `reasoning`, value: e(_, n) ?? `unknown` },
        { label: `rolloutPath`, value: e(x, n) ?? `unknown` },
        { label: `resumeState`, value: e(E, n) ?? `unknown` },
        { label: `cwd`, value: e(v, n) ?? `unknown` },
...
function qt() {
  let { conversationId: e } = Te(),
    { state: t } = we(),
    n = r(d, e ?? null),
    i = r(v, e ?? null),
    a = ft(),
    { isResuming: o } = de(null),
    { canOpenThreadInNewWindow: s, openThreadInNewWindow: c } = Le({ conversationId: e ?? null }),
    l = (0, Z.useRef)(e ?? null),
    u = (0, Z.useRef)(!1),
    f = (0, Z.useRef)(null);
  if (
    (l.current !== (e ?? null) && ((l.current = e ?? null), (u.current = !1), (f.current = null)),
    n && (u.current = !0),
    i != null && (f.current = i),
    Me(`openThreadInNewWindow`, c, { enabled: s }),
    !e)
  )
    return (0, $.jsx)(Ce, { to: `/` });
  if (u.current && !n && !o)
    return (0, $.jsx)(Ce, {
      to: `/`,
      replace: !0,
      state: { focusComposerNonce: Date.now(), prefillCwd: f.current },
    });
  let p =
    o || !n
      ? (0, $.jsx)(Re, { debugName: `LocalConversationPage` })
      : (0, $.jsx)(Bt, { conversationId: e, startRealtime: t?.startRealtime === !0 });
  return (0, $.jsxs)($.Fragment, {
    children: [
      (0, $.jsx)(yt, { conversationId: e }),
      a ? (0, $.jsx)(Jt, {}) : null,
      (0, $.jsx)(vt, { conversationId: e }),
      (0, $.jsx)(We, {}),
      (0, $.jsx)(rt.Surface, {}),
      p,
    ],
...
export { qt as LocalConversationPage };
