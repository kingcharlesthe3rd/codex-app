...
import { Ct as Ut, wt as Wt } from "./app-initial~app-main~automations-page.js";
import {
  Sn as Gt,
  xn as Kt,
...
import { n as qn, t as Jn } from "./app-initial~app-main~local-conversation-page-D.js";
import {
  a as Yn,
  i as Xn,
  n as Zn,
...
import { n as Zr, r as Qr, t as $r } from "./thread-app-shell-chrome.js";
...
function ti(e, t, n) {
  ...
  let s =
    ...
    c = bt(V.default.posix.join(n, s));
  return _(n) ? `//${c.replace(/^\/+/, ``)}` : c;
}
var V,
  ni = e(() => {
    ((V = t(c(), 1)), l(), ae(), w(), ie(), le(), vt());
  });
function ri(e) {
  let t = (0, ii.c)(14),
    { conversationId: n } = e,
  ...
  (t[0] !== r || t[1] !== i || t[2] !== a
    ? ((l = () => {
        i == null ||
          a == null ||
          (ei(r, { sourceWorkspaceRoot: i, targetWorkspaceRoot: a }), r.set(Dt, null));
      }),
      (u = [r, i, a]),
      (t[0] = r),
      (t[1] = i),
...
var ii,
  H,
  ai = e(() => {
    ((ii = g()), d(), (H = t(f(), 1)), pe(), Ce(), N(), Se(), Tt(), Zt(), ni());
  });
function oi(e) {
  let t = (0, li.c)(10),
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = (0, U.jsx)(Re, { asChild: !0, children: a })), (t[0] = a), (t[1] = o));
  let s;
  ...
  return (
    t[5] !== r || t[6] !== i || t[7] !== o || t[8] !== l
      ? ((u = (0, U.jsxs)(Ve, { open: r, onOpenChange: i, children: [o, l] })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = o),
        (t[8] = l),
...
function pi(e) {
  let t = (0, W.c)(32),
    ...
    v = h(),
    y;
  t[0] === d ? (y = t[1]) : ((y = d ? b(d) : null), (t[0] = d), (t[1] = y));
  let x = xr(y, nt(o(Pt, n)).id),
    S;
  if (t[2] !== n || t[3] !== v) {
    let e = v.getQueryData(p(`list-automations`));
    ((S = e == null ? null : Kn({ automations: e.items, conversationId: n })),
      (t[2] = n),
      (t[3] = v),
      (t[4] = S));
  } else S = t[4];
  ...
  t[10] === l
    ? (T = t[11])
    : ((T = (0, G.jsx)(`span`, { className: `min-w-0 truncate`, children: l })),
      (t[10] = l),
      (t[11] = T));
  let E;
  t[12] !== T || t[13] !== u
    ...
    : (E = t[14]);
  let D;
  t[15] === C ? (D = t[16]) : ((D = (0, G.jsx)(mi, { automation: C })), (t[15] = C), (t[16] = D));
  let O;
  t[17] !== g ||
  t[18] !== x ||
  t[19] !== n ||
  ...
  t[24] !== l
    ...
    : (O = t[25]);
  let k;
  t[26] === Symbol.for(`react.memo_cache_sentinel`) ? ((k = null), (t[26] = k)) : (k = t[26]);
  let A;
  return (
    t[27] !== w || t[28] !== E || t[29] !== D || t[30] !== O
      ? ((A = (0, G.jsx)(`div`, {
...
function mi(e) {
  ...
  t[0] !== n.id || t[1] !== n.name || t[2] !== i
    ? ((a = () => {
        Jt({ scope: i, automationId: n.id, title: n.name });
      }),
      (t[0] = n.id),
      (t[1] = n.name),
      (t[2] = i),
  ...
  let o = a,
    c;
  t[4] === n ? (c = t[5]) : ((c = (0, G.jsx)(hi, { automation: n })), (t[4] = n), (t[5] = c));
  let l;
  t[6] === r
    ? (l = t[7])
    : ((l = r.formatMessage({
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, G.jsx)(fn, { className: `icon-xs` })), (t[8] = u))
    : (u = t[8]);
  let d;
  t[9] !== o || t[10] !== l
    ? ((d = (0, G.jsx)(Fe, {
  ...
  return (
    t[12] !== c || t[13] !== d
      ? ((f = (0, G.jsx)($e, { tooltipContent: c, delayOpen: !0, children: d })),
        (t[12] = c),
        (t[13] = d),
        (t[14] = f))
      : (f = t[14]),
...
function hi(e) {
  ...
  t[0] !== n.nextRunAt || t[1] !== n.status || t[2] !== r
    ? ((i = Yt({ intl: r, nextRunAt: n.nextRunAt, status: n.status })),
      (t[0] = n.nextRunAt),
      (t[1] = n.status),
      (t[2] = r),
      (t[3] = i))
...
function _i(e) {
  ...
  t[8] === u
    ? (d = t[9])
    : ((d = Ke(`icon-2xs text-current transition-transform duration-300`, u)),
      (t[8] = u),
      (t[9] = d));
  let f;
  t[10] === d
    ...
    : ((f = (0, K.jsx)(`span`, {
        ...
        children: (0, K.jsx)(je, { className: d, "aria-hidden": !0 }),
      })),
      (t[10] = d),
      (t[11] = f));
  let p;
  ...
  return (
    t[34] !== w || t[35] !== p
      ? ((T = (0, K.jsxs)(jn, { children: [p, w] })), (t[34] = w), (t[35] = p), (t[36] = T))
      : (T = t[36]),
    T
  );
}
var vi,
  K,
  yi = e(() => {
    ((vi = g()), Be(), Ie(), P(), Xt(), ke(), ze(), Nn(), (K = v()));
  });
function bi(e) {
  let t = (0, wi.c)(30),
    { conversationId: n, cwd: r, expanded: i, hostId: a, isInProgress: s, onExpandedChange: c } = e,
    l = T(),
    u = o(wt, n),
    d = o(Et, n),
    f;
  ...
  bb1: {
    ...
    let e;
    (t[7] !== l || t[8] !== u || t[9] !== _
      ? ((e = xt(u, _, { isBackgroundSubagentsEnabled: l })),
        (t[7] = l),
        (t[8] = u),
        (t[9] = _),
        (t[10] = e))
  ...
  bb2: {
    ...
    let e;
    (t[11] !== s || t[12] !== y
      ? ((e = xi({ isInProgress: s, latestTurnState: y })), (t[11] = s), (t[12] = y), (t[13] = e))
      : (e = t[13]),
      (b = e));
  }
  let x = b;
  if (u == null || y == null) return null;
  let S;
  t[14] !== u || t[15] !== x
    ? ((S =
        x == null
          ...
          : (0, q.jsx)(hn, {
              ...
              workedDurationMs: Ct(u) ? null : (u.durationMs ?? null),
    ...
    : (S = t[16]);
  let C;
  t[17] !== m || t[18] !== n || t[19] !== r || t[20] !== a || t[21] !== u || t[22] !== y
    ? ((C = (0, q.jsx)(rn, {
        conversationId: n,
        hostId: a,
  ...
  let w;
  return (
    t[24] !== i || t[25] !== s || t[26] !== c || t[27] !== S || t[28] !== C
      ? ((w = (0, q.jsx)(_i, {
          expanded: i,
          headerLabel: S,
          isTurnInProgress: s,
...
function xi({ isInProgress: e, latestTurnState: t }) {
  let n = Ci(t.items),
    { agentItems: r, assistantItem: i, proposedPlanItem: a } = Qt(qt(t.items), t.status),
...
function Oi(e) {
  ...
  return (
    t[0] !== i || t[1] !== a
      ? ((s = (0, Ai.jsx)(er, { lastTurnCwd: a, lastTurnDiff: i })),
        (t[0] = i),
        (t[1] = a),
        (t[2] = s))
      : (s = t[2]),
...
function Bi(e) {
  ...
  let s;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Y.jsx)(et, { className: `icon-xs` })), (t[2] = s))
    : (s = t[2]);
  let c;
  t[3] !== i || t[4] !== o
    ? ((c = (0, Y.jsx)(`button`, {
  ...
  t[6] === n
    ? (l = t[7])
    : ((l = (0, Y.jsx)(en, { seed: n, className: `size-6`, "aria-hidden": !0 })),
      (t[6] = n),
      (t[7] = l));
  let u;
  t[8] === r
...
async function Ui(e, { hostId: t, parentConversationId: n, selectedConversationId: r }) {
  ...
  for (; a !== n; ) {
    ...
    let n = o < 2;
    if (
      ((n || !e.get(M, a) || e.get(ot, a) == null) &&
        (await Vt(`hydrate-background-threads`, { hostId: t, includeTurns: n, threadIds: [a] })),
      !e.get(M, a))
    )
      return !1;
    let r = e.get(ot, a);
  ...
  return (
    await Vt(`hydrate-background-threads`, { hostId: t, includeTurns: !0, threadIds: [n] }), !0
  );
}
var Wi,
  Gi = e(() => {
...
function Ki({ conversationId: e }) {
  ...
  Xn((e) => $t(t, e));
  let u = c && l,
    d = u && a?.tabId === ut.DIFF && i.kind === `git`,
    f = !u,
    p = jr({ activeTabId: a?.tabId ?? null, isRightPanelExpanded: u }),
    [m, h] = (0, Qi.useState)(null),
    g = Gt((r) => {
  ...
  return (0, X.jsx)(An, {
    ...
    children: (0, X.jsxs)(`div`, {
      ...
      children: [
        ...
        d ? (0, X.jsx)(Mi, { conversationId: e }) : null,
        (0, X.jsx)(Oi, { conversationId: e }),
        (0, X.jsx)(j.MainContentLayout, { layout: `thread-edge-scroll` }),
        (0, X.jsx)(j.Header, { children: (0, X.jsx)(Yi, { conversationId: e }) }),
        (0, X.jsx)(`div`, { className: `h-full min-h-0`, children: _ }),
        (0, X.jsx)($r, {
        ...
        null,
        (0, X.jsx)(qi, { onOpenBackgroundAgent: g }),
        p ? (0, X.jsx)(Xi, { conversationId: e }, e) : null,
      ],
    }),
  });
}
...
function Yi({ conversationId: e }) {
  let t = s(a),
    ...
    u = un(l) ? l : null,
    d = yt(o(Bt, e)),
    f = d?.parentThreadId == null,
    p = n ? d : null,
    m = o(pt, e) === `projectless`,
    h = o(R, e),
    g = o(En, Ne(d?.parentThreadId ?? e)),
    _ = m ? null : (g?.projectId ?? h),
    v = _ == null ? null : kn(h ?? _, g?.label),
    y = Rn(_ ?? ``),
    b =
      v == null
        ? null
    ...
    x = p?.parentThreadId ?? null,
    C = p == null ? null : Wr({ agentNickname: p.agentNickname, conversationId: e }),
    w =
      x != null && C != null
        ? (0, X.jsxs)(`span`, {
            className: `ml-1 flex shrink-0 items-center gap-1 font-medium`,
            children: [
              (0, X.jsx)(S, { className: `icon-2xs`, seed: e, "aria-hidden": !0 }),
              (0, X.jsx)(`span`, { children: C }),
            ],
          })
        : null,
    E = p?.agentRole == null || p.agentRole === `default` ? null : `(${p.agentRole})`,
    D =
      E == null
        ? null
        : (0, X.jsx)(`span`, {
      ...
      x == null || c == null
        ...
        : (0, X.jsxs)(`span`, {
            ...
            children: [
              ...
              u == null
                ? null
                : (0, X.jsxs)(X.Fragment, { children: [` (`, (0, X.jsx)(bn, { effort: u }), `)`] }),
            ],
          }),
    k = o(It, e);
  return (0, X.jsx)(pi, {
    conversationId: r ? e : null,
    markdownParentConversationId: x,
    title: i,
    titleSuffix:
      w == null && D == null && O == null ? null : (0, X.jsxs)(X.Fragment, { children: [w, D, O] }),
    projectIcon:
      y == null
        ? b
        : (0, X.jsx)(qe, { appearance: y, className: `size-5 [&>svg]:size-5`, fallbackIcon: b }),
    projectHoverCardContent: g == null ? null : (0, X.jsx)(In, { group: g }),
    projectName: v,
    cwd: h,
...
function Xi(e) {
  let t = (0, Zi.c)(16),
    ...
    a = o(R, n),
    c;
  t[0] === a ? (c = t[1]) : ((c = a ? b(a) : null), (t[0] = a), (t[1] = c));
  let l = c,
    u = o(Oe, n),
    d = o(rt, n) ?? !1;
  (o(ht, n), o(kt, n));
  ...
  let _;
  t[3] === r ? (_ = t[4]) : ((_ = At(r) ?? void 0), (t[3] = r), (t[4] = _));
  let v;
  t[5] !== n || t[6] !== l || t[7] !== i || t[8] !== f || t[9] !== m
    ? ((v = (0, X.jsx)(bi, {
        conversationId: n,
        cwd: l,
        expanded: m,
...
function ta({ conversationId: e }) {
  let t = o(M, e),
    ...
    { canOpenThreadInNewWindow: s, openThreadInNewWindow: c } = Ln({ conversationId: e }),
    l = (0, Q.useRef)(e),
    u = (0, Q.useRef)(!1),
    d = (0, Q.useRef)(null);
  if (
    (l.current !== e && ((l.current = e), (u.current = !1), (d.current = null)),
    t && (u.current = !0),
    n != null && (d.current = n),
    Pe(`openThreadInNewWindow`, c, { enabled: s }),
    u.current && !t && !a)
  )
    return (0, $.jsx)(st, {
      to: `/`,
  ...
  let f =
    a || !t
      ? (0, $.jsx)(Hn, { debugName: `LocalConversationPage` })
...
function na(e) {
  ...
  if (i != null) {
    ...
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(j.MainContentLayout, { layout: `thread-edge-scroll` })), (t[0] = e))
      : (e = t[0]);
    let n;
    t[1] === i.title
      ? (n = t[2])
      : ((n = (0, $.jsx)(j.Header, { children: (0, $.jsx)(ir, { start: i.title }) })),
        (t[1] = i.title),
        (t[2] = n));
    let a;
    t[3] !== r || t[4] !== i.status
      ? ((a = (0, $.jsx)(`div`, {
          ...
          children:
            i.status === `creating`
              ? (0, $.jsx)(Hn, { debugName: `PendingProjectlessLocalConversationPage` })
              : (0, $.jsxs)(`div`, {
  ...
  if (a == null) {
    ...
    return (
      t[9] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsx)(Hn, { debugName: `PendingClientLocalConversationPage` })), (t[9] = e))
        : (e = t[9]),
      e
    );
  }
  ...
  return (
    t[10] !== a.hostId || t[11] !== a.id
      ? ((s = (0, $.jsx)(ra, { hostId: a.hostId, pendingWorktreeId: a.id })),
        (t[10] = a.hostId),
        (t[11] = a.id),
        (t[12] = s))
      : (s = t[12]),
...
function ra(e) {
  let t = (0, Z.c)(9),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(j.MainContentLayout, { layout: `thread-edge-scroll` })),
      (o = (0, $.jsx)(j.Header, {})),
      (t[0] = a),
      (t[1] = o))
    : ((a = t[0]), (o = t[1]));
    ...
    (oa = r(I, ({ get: e, scope: t }) => {
      ...
      return {
        ...
        lines: [
          ...
          { label: `model`, value: e(dt, n) ?? `unknown` },
          { label: `reasoning`, value: e(St, n) ?? `unknown` },
          { label: `rolloutPath`, value: e(Ot, n) ?? `unknown` },
          { label: `resumeState`, value: e(Nt, n) ?? `unknown` },
          { label: `cwd`, value: e(R, n) ?? `unknown` },
