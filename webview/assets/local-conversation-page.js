const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./codex.js",
      "./settings.cog.js",
      "./split-items-into-render-groups-CtEE-Zkg.js",
      "./clsx.js",
...
import { l as Te } from "./thread-side-panel-tabs-1.js";
...
import { f as Ze } from "./at-mention-list-1.js";
...
import { n as mt, r as ht, t as gt } from "./split-items-into-render-groups-CtEE-Zkg.js";
import "./worktree-paths.js";
import "./primary-runtime-install-status-message.js";
import "./plan-summary-item-content.js";
import { t as _t } from "./thread-app-shell-chrome-1.js";
var Z = q(),
  Q = e(w()),
  $ = T(),
  vt = (e) =>
...
function yt(e) {
  ...
  let D = T,
    O;
  n[8] !== D || n[9] !== x
    ? ((O = x ? (0, $.jsx)(re, { className: `icon-xs` }) : D), (n[8] = D), (n[9] = x), (n[10] = O))
    : (O = n[10]);
  let k = O,
    A = r != null && S && C ? Ne(m, { threadId: r, isPinned: x, sections: w })[0]?.submenu : null,
    ee = ie(
  ...
  let L = I,
    R =
      k == null
        ? null
        : A == null
          ? (0, $.jsx)(`span`, { "aria-hidden": !0, className: ee, children: k })
          : (0, $.jsx)(ze, {
              triggerButton: (0, $.jsx)(`button`, {
                type: `button`,
                "aria-label": h.formatMessage(Ie.moveTo),
                className: ie(ee, `cursor-interaction hover:text-token-foreground`),
                children: k,
              }),
              align: `start`,
...
function Mt(e) {
  ...
  t[23] === S
    ? (k = t[24])
    : ((k = (0, $.jsx)(Nt, { onOpenBackgroundAgent: S })), (t[23] = S), (t[24] = k));
  let A;
  t[25] !== n || t[26] !== _ || t[27] !== r
    ? ((A = _ ? (0, $.jsx)(Rt, { conversationId: n, startRealtime: r }, n) : null),
      (t[25] = n),
      (t[26] = _),
      (t[27] = r),
      (t[28] = A))
  ...
  return (
    t[37] !== v || t[38] !== j
      ? ((M = (0, $.jsx)(we, { value: v, children: j })), (t[37] = v), (t[38] = j), (t[39] = M))
      : (M = t[39]),
    M
  );
}
...
function Lt({ conversationId: e }) {
  let t = W(oe),
    ...
    _ = m == null ? null : O({ agentNickname: m.agentNickname, conversationId: e }),
    y =
      g != null && _ != null
        ? (0, $.jsxs)(`span`, {
            className: `ml-1 flex shrink-0 items-center gap-1 font-medium`,
            children: [
              (0, $.jsx)(Ze, { className: `icon-2xs`, seed: e, "aria-hidden": !0 }),
              (0, $.jsx)(`span`, { children: _ }),
            ],
          })
        : null,
    b = m?.agentRole == null || m.agentRole === `default` ? null : `(${m.agentRole})`,
    w =
      b == null
        ? null
        : (0, $.jsx)(`span`, {
      ...
      g == null || s == null
        ...
        : (0, $.jsxs)(`span`, {
            ...
            children: [
              ...
              l == null
                ? null
                : (0, $.jsxs)($.Fragment, { children: [` (`, (0, $.jsx)(xe, { effort: l }), `)`] }),
            ],
          }),
    E = G(f, e);
  return (0, $.jsx)(yt, {
    ...
    title: o,
    titleSuffix:
      y == null && w == null && T == null ? null : (0, $.jsxs)($.Fragment, { children: [y, w, T] }),
    cwd: E,
    getConversationMarkdown: async () => {
      ...
      let { visibleTurnEntries: n } = t.get(P, {
        ...
        s = n.map(({ requests: e, turn: t }) => r(t, e, { isBackgroundSubagentsEnabled: i }));
