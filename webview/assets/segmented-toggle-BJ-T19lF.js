...
import { t as i } from "./tooltip-B.js";
var a = t(),
  o = e();
function s(e) {
  let t = (0, a.c)(29),
    ...
    y;
  t[0] === s ? (y = t[1]) : ((y = s === void 0 ? [] : s), (t[0] = s), (t[1] = y));
  let b = y,
    ...
    D;
  t[2] !== d || t[3] !== E
    ? ((D = n(E, `items-center gap-0.5`, d)), (t[2] = d), (t[3] = E), (t[4] = D))
    : (D = t[4]);
  let O;
  if (
    t[5] !== f ||
                ...
                i,
                {
                  ...
                  children: (0, o.jsx)(
                    r,
                    {
                      ...
                      disabled: a,
                      className: n(S ? `flex-1 justify-center` : void 0, f),
                      children: e.label,
                    },
                    e.id,
                  ),
...
export { s as t };
//# sourceMappingURL=segmented-toggle-BJ-T19lF.js.map
