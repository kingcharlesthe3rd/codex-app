...
function _(e) {
  let t = (0, x.c)(24),
    ...
    u;
  t[0] === e
    ? ((n = t[1]), (i = t[2]), (a = t[3]), (c = t[4]), (l = t[5]), (u = t[6]))
    : (({
        children: i,
        className: a,
        contentClassName: c,
      ...
      (t[5] = l),
      (t[6] = u));
  let d = u === void 0 ? `secondary` : u,
    f;
  t[7] === a ? (f = t[8]) : ((f = o(`w-[240px] justify-between`, a)), (t[7] = a), (t[8] = f));
  let p;
  t[9] === c
    ? (p = t[10])
    : ((p = o(`flex min-w-0 flex-1 items-center gap-1.5`, c)), (t[9] = c), (t[10] = p));
  let m;
  t[11] !== i || t[12] !== p
    ? ((m = (0, S.jsx)(`span`, { className: p, children: i })),
      (t[11] = i),
      (t[12] = p),
      (t[13] = m))
    : (m = t[13]);
  ...
  t[14] === n
    ? (h = t[15])
    : ((h = o(`icon-2xs shrink-0 text-token-input-placeholder-foreground`, n)),
      (t[14] = n),
      (t[15] = h));
  let g;
  t[16] === h ? (g = t[17]) : ((g = (0, S.jsx)(s, { className: h })), (t[16] = h), (t[17] = g));
  let _;
  return (
    t[18] !== d || t[19] !== l || t[20] !== f || t[21] !== m || t[22] !== g
      ? ((_ = (0, S.jsxs)(r, { color: d, size: `toolbar`, className: f, ...l, children: [m, g] })),
        (t[18] = d),
        (t[19] = l),
        (t[20] = f),
        (t[21] = m),
...
function v(e) {
  ...
  let i;
  return (t[2] === r ? (i = t[3]) : ((i = (0, S.jsx)(u, { ...r })), (t[2] = r), (t[3] = i)), i);
}
function y(e) {
  let t = (0, x.c)(26),
    { slug: n } = e;
