...
import { Yc as r, el as i } from "./app-initial~app-main~onboarding-page.js";
import {
  RC as a,
  zC as o,
...
function _(e) {
  ...
  t[0] === e
    ...
    : (({
      ...
      (t[5] = s),
      (t[6] = c));
  let l = c === void 0 ? `secondary` : c,
    u;
  t[7] === i ? (u = t[8]) : ((u = d(`w-[240px] justify-between`, i)), (t[7] = i), (t[8] = u));
  let f;
  t[9] === o
    ? (f = t[10])
    : ((f = d(`flex min-w-0 flex-1 items-center gap-1.5`, o)), (t[9] = o), (t[10] = f));
  let m;
  t[11] !== r || t[12] !== f
    ? ((m = (0, S.jsx)(`span`, { className: f, children: r })),
      (t[11] = r),
      (t[12] = f),
      (t[13] = m))
    : (m = t[13]);
  ...
  t[14] === n
    ? (h = t[15])
    : ((h = d(`icon-2xs shrink-0 text-token-input-placeholder-foreground`, n)),
      (t[14] = n),
      (t[15] = h));
  let g;
  t[16] === h ? (g = t[17]) : ((g = (0, S.jsx)(p, { className: h })), (t[16] = h), (t[17] = g));
  let _;
  return (
    t[18] !== l || t[19] !== s || t[20] !== u || t[21] !== m || t[22] !== g
      ? ((_ = (0, S.jsxs)(a, { color: l, size: `toolbar`, className: u, ...s, children: [m, g] })),
        (t[18] = l),
        (t[19] = s),
        (t[20] = u),
        (t[21] = m),
...
function v(e) {
  ...
  let i;
  return (t[2] === r ? (i = t[3]) : ((i = (0, S.jsx)(c, { ...r })), (t[2] = r), (t[3] = i)), i);
}
function y(e) {
  let t = (0, x.c)(26),
    { slug: n } = e;
...
export { C as a, y as i, v as n, m as o, b as r, g as s, _ as t };
//# sourceMappingURL=app-initial~app-main~page~remote-conversation-page~new-thread-panel-page~settings-page~appg~ibjpfz58.js.map
