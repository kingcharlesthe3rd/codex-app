...
import { a as t, o as n } from "./_baseFor-1.js";
import {
  C as r,
  F as i,
  P as a,
...
import { n as fe, t as pe } from "./merge-3.js";
import { n as me, t as he } from "./src-1.js";
import { t as ge } from "./dist-3.js";
import { i as d, n as f, r as _e } from "./chunk-49.js";
import { A as ve, L as ye, f as be, m as p, r as m, s as h } from "./chunk-87.js";
function g(e, t) {
...
function x(e, t, n) {
  ...
  (d.info(`our points`, r), t !== `start_left` && t !== `start_right` && r.reverse());
  let i = z(r, 25 + e),
    a = 10 + e * 0.5,
...
`,
        ...
        for (let t of e) {
          if (n) {
            ...
            if (e < r) r -= e;
              ...
              if (i > 0 && i < 1)
                return { x: R((1 - i) * n.x + i * t.x, 5), y: R((1 - i) * n.y + i * t.y, 5) };
            }
          }
          n = t;
        }
      ...
      (B = f((e, t, n) => {
        (d.info(`our points ${JSON.stringify(t)}`), t[0] !== n && (t = t.reverse()));
        let r = z(t, 25),
          i = e ? 10 : 5,
          ...
          return (
            r.forEach((e, o) => {
              let s = T(`${e} `, n),
                c = T(a, n);
              if (s > t) {
                let { hyphenatedStrings: r, remainingWord: o } = q(e, t, `-`, n);
                (i.push(a, ...r), (a = o));
        ...
        (e, t) => {
          ...
          for (let e of o) {
            ...
            for (let r of s) {
              let o = W();
              o.text = r || `​`;
              let s = G(u, o).style(`font-size`, a).style(`font-weight`, i).style(`font-family`, e),
