...
import { c as k } from "./katex-1.js";
import { F as A, I as j, h as M, lt as N, o as P, v as F } from "./vscode-api.js";
import { c as I, o as L } from "./lib-2.js";
import { m as R } from "./chunk-12.js";
import { t as z } from "./persisted-signal-CweW-bgN.js";
import { o as ee } from "./statsig.js";
import { t as B } from "./request.js";
import { t as V } from "./use-is-dark.js";
import { C as H, S as te, o as ne, w as re, x as U } from "./mention-item.js";
...
import { a as le, i as ue, l as G, n as de, r as fe, s as pe, t as me } from "./inline-mentions.js";
import { t as he } from "./copy-to-clipboard.js";
import { t as ge } from "./chevron-right.js";
import { s as _e, t as ve } from "./external-markdown-link.js";
import { t as ye } from "./checkbox.js";
import { t as be } from "./badge-Bpp-zYoJ.js";
import { t as xe } from "./chat.js";
import { t as Se } from "./code-snippet.js";
...
function Mt(e, t = ``) {
  ...
  for (let r of e.matchAll(At)) {
    let i = r.index + r[1].length,
      a = `${t}${e.slice(0, i)}`;
    (a.length > 0 && !/\s$/.test(a)) || jt.test(a) || n.push({ content: r[2], index: i });
  }
  return n.length === 0 ? null : n;
}
function Nt({ content: e, key: t }) {
  return (0, Q.jsxs)(Z.Fragment, { children: [e, Pt({ content: e })] }, t);
}
function Pt({ content: e, key: t }) {
  return (0, Q.jsx)(
    `span`,
    {
      "aria-hidden": !0,
...
var It = [
    ...
    { getMatches: Mt, render: Nt },
  ],
  Lt = [{ matches: Ft, render: Pt }];
function Rt(e) {
  let t = It.flatMap(
...
function zt({ content: e, inlineCode: t, precedingText: n }) {
  let r = Lt.filter(({ matches: t }) => t(e, n));
  return r.length === 0
    ? t
    : (0, Q.jsxs)(Q.Fragment, {
        children: [
...
function Vt({
  ...
  if (d != null && S(d))
    return (0, Q.jsx)(
      le,
      { className: e, reference: i(d), cwd: n, hostId: a, onOpen: s, openInSidePanel: c },
      o,
    );
  let f = Ut(t);
  if (f != null) {
  ...
  return de(t)
    ? (0, Q.jsx)(pe, { label: fe(t) }, o)
    : zt({ content: t, inlineCode: u, precedingText: l });
}
function Ht(e) {
...
function Wt(e) {
  ...
  return (
    t[24] !== r || t[25] !== a || t[26] !== s || t[27] !== d
      ? ((f = (0, Q.jsx)(Kt, { content: r, language: a, renderImmediately: s, renderVisible: d })),
        (t[24] = r),
        (t[25] = a),
        (t[26] = s),
        (t[27] = d),
...
function Kt(e) {
  ...
  if (t[0] !== e) {
    ...
    ((n = r ? i.renderVisible() : (0, Q.jsx)(qt, { ...i })), (t[0] = e), (t[1] = n));
  } else n = t[1];
  return n;
}
function qt(e) {
...
var Yt = e(ae(), 1),
  Xt = /^data:(?:image|video)\//i,
  Zt = `img.shields.io`,
  Qt = `/badge/`;
function $t(e) {
  return !Xt.test(e) && !t(e) ? `image` : (en(e)?.startsWith(`video/`) ?? !1) ? `video` : `image`;
}
function en(e) {
...
function tn(e) {
  ...
  return t.protocol !== `https:` || t.hostname !== Zt || !t.pathname.startsWith(Qt)
    ? null
...
function rn({ contentsBase64: e, mimeType: t, path: n }) {
  return `data:${t ?? en(n) ?? `application/octet-stream`};base64,${e}`;
}
function an(e) {
...
var sn = new Set([`openai.com`, `chatgpt.com`, `chat.com`]),
  cn = 500;
function ln(e, t) {
  let n = (0, X.c)(3),
    r = fn(e, cn),
...
function dn(e, t) {
  let n = (0, X.c)(15),
    r = e == null,
    i;
  n[0] !== r || n[1] !== e ? ((i = !r && un(e)), (n[0] = r), (n[1] = e), (n[2] = i)) : (i = n[2]);
  let a = i,
    o,
    s;
  n[3] === e
...
var pn = `my-3 block h-auto rounded-md object-contain shadow-md`,
  mn = D(pn, `border border-token-border`),
  hn = `max-h-[12.5rem] max-w-[12.5rem]`,
  gn = `max-h-[10rem] w-auto max-w-full`,
  _n = `data-markdown-image-preview-trigger`;
function vn(e) {
  let t = (0, X.c)(80),
    {
      allowWide: n,
    ...
    T = tn(S),
    E;
  t[0] === S ? (E = t[1]) : ((E = $t(S)), (t[0] = S), (t[1] = E));
  let O = E,
    k = O === `video`,
    A;
  t[2] === S ? (A = t[3]) : ((A = S.startsWith(`//`)), (t[2] = S), (t[3] = A));
  let j = C != null && !A,
    M = ln(S, T == null && w && O === `image` && !j && on(S)),
    N = T == null && w && !j && an(S) && M.safeUrl == null && !M.isPending,
    F = j && k ? ce(C) : null,
    L = !k && j,
  ...
  let ee = R?.contentsBase64 ?? null,
    B =
      ...
      F ??
      (L && ee != null
        ? rn({ contentsBase64: ee, mimeType: R?.mimeType ?? null, path: C ?? S })
        : S),
    V = r ?? ``,
    H = j && !k,
    te = j && k && F == null,
  ...
  if (k) {
    let e = p
      ...
      n;
    t[32] !== a || t[33] !== e
      ? ((n = D(pn, e, a)), (t[32] = a), (t[33] = e), (t[34] = n))
      : (n = t[34]);
    let r;
    t[35] === B
      ? (r = t[36])
  ...
  t[50] !== V || t[51] !== B || t[52] !== u
    ? ((q = (e) => {
        y(bn({ fallbackItem: { src: B, alt: V }, root: u.current, trigger: e.currentTarget }));
      }),
      (t[50] = V),
      (t[51] = B),
      (t[52] = u),
  ...
  t[54] !== p || t[55] !== m || t[56] !== a || t[57] !== c || t[58] !== H
    ? ((J = D(
        mn,
        c === `scrollable` ? `max-h-none !max-w-none w-auto` : p && H ? gn : [hn, `h-auto w-auto`],
        m && G.imageEnter,
        a,
      )),
      (t[54] = p),
...
function bn({ fallbackItem: e, root: t, trigger: n }) {
  let r = t == null ? [] : Array.from(t.querySelectorAll(`[${_n}="true"]`)),
    i = [],
    a = null;
  for (let e of r) {
...
function Cn(e, t) {
  ...
  let n = Z.Children.toArray(e).filter(
    (e) => !((typeof e == `string` && xn.test(e)) || ((0, Z.isValidElement)(e) && e.type === `br`)),
  );
...
function wn({
  ...
  let u = {
    ...
    p({ children: t }) {
      ...
      if (n != null && n.length > 1 && n.every((e) => $t(e.props.src ?? ``) === `image`))
        return (0, Q.jsx)(`p`, {
    ...
    ol({ children: e, className: t, start: n }) {
      return (t?.includes(`contains-task-list`) ?? !1) && Dn(e)
...
function En({
  ...
  return function ({ href: o, children: s, [ft]: c }) {
    let l = typeof c == `string` ? c.trim() : Sn(s).trim();
    if (o != null) {
      let e = ue({
        cwd: t ?? null,
        hostId: n,
  ...
  return {
    ...
    renderInlineTokens(e, t, n = this.decorateText) {
      ...
      return r.allowBasicHtml === !0
        ? In(e, t, r)
        : e.map((n, i) => Rn(n, `${t}-${n.type}-${i}`, r, Xn(e, i)));
    },
  }.renderTokens(e);
}
function In(e, t, n) {
  ...
  for (let i = 0; i < e.length; i += 1) {
    let a = e[i],
      o = n.allowBasicHtml === !0 ? Vn(a) : null,
      s = o == null ? null : Hn(e, i + 1, o);
    if (o != null && s != null) {
      let a = e.slice(i + 1, s),
        c = `${t}-${o}-${i}`;
      (r.push(Bn(o, In(a, c, n), c, a)), (i = s));
      continue;
    }
    r.push(Rn(a, `${t}-${a.type}-${i}`, n, Xn(e, i)));
  }
  return r;
}
function Ln(e, t) {
  return e.map((e, n) => Rn(e, `${e.type}-${n}`, t));
}
function Rn(e, t, n, r = ``) {
  if (Kn(e)) return On(e, t, n);
  if (qn(e)) return wt(e, t);
  if (!Jn(e)) return `raw` in e && typeof e.raw == `string` ? e.raw : ``;
  switch (e.type) {
    case `space`:
      return null;
    case `hr`:
    ...
    case `table`:
      return Nn(e, t, n);
    case `html`:
      return zn(e.raw, t, n.allowBasicHtml === !0);
    case `def`:
      return null;
  }
}
...
function Bn(e, t, n, r) {
  switch (e) {
    ...
    case `sub`:
      return Wn(r) ? (0, Q.jsx)(`span`, { children: t }, n) : (0, Q.jsx)(`sub`, { children: t }, n);
    case `sup`:
...
function Un(e, t) {
  return Yn(e) && e.raw.trim().toLowerCase() === `</${t}>`;
}
function Wn(e) {
  return e.some((e) =>
    e.type === `image` && `href` in e && typeof e.href == `string` && tn(e.href) != null
      ? !0
      : `tokens` in e && Array.isArray(e.tokens) && Wn(e.tokens),
  );
}
function Gn(e) {
  return (
...
function er({
  ...
  let d = r == null && t ? Rt(u) : null;
  if (!i && r == null && d == null) return u;
  let f = r ?? nr({ decorations: d, segmentText: (e) => (i ? ar(e, l) : [e]), text: u });
  return !i && f.length === 1 && f[0]?.kind === `text` && f[0].segments[0] === u
    ? u
    : rr({
        cwd: e,
...
function tr({ decorateText: e = !0, segmenter: t, text: n }) {
  return nr({ decorations: e ? Rt(n) : null, segmentText: (e) => ar(e, t), text: n });
}
function nr({ decorations: e, segmentText: t, text: n }) {
...
function rr({
  ...
  for (let t of s) {
    if (t.kind === `text`) {
      (c.push(...ir({ fadeText: n, fadeSegmentStartIndex: l, segments: t.segments })),
        (l += t.segments.length));
      continue;
    }
    let s = t.render({
...
function ir({ fadeText: e, fadeSegmentStartIndex: t, segments: n }) {
  return e
    ? n.map((e, n) => {
        let r = t + n;
...
function fr(e) {
  ...
  if (n != null) return n;
  let r = pr(t);
  return r.length === 0 ? `file` : (dr.get(r) ?? `file`);
}
function pr(e) {
  let t = e.lastIndexOf(`.`);
...
function mr(e) {
  ...
  if (t[0] !== l || t[1] !== o || t[2] !== a || t[3] !== i) {
    ((p = br(a)), (d = br(o)), (f = vr(i)));
    let e = yr(f),
      n = fr(i),
      r = e.length === 0 ? hr(n, l) : null;
    m = gr(l, p, d, _r(n));
    let s =
      m == null
        ? null
...
function Sr({ cwd: e, hostId: t = _, openFileLinksInSidePanel: n = !1 }) {
  return {
    [w]({ attributes: r }) {
      return (0, Q.jsx)(mr, {
        cwd: e ?? null,
        hostId: t,
        path: xr(r, `path`),
        lineRangeStart: xr(r, `lineRangeStart`) ?? xr(r, `line_range_start`),
        lineRangeEnd: xr(r, `lineRangeEnd`) ?? xr(r, `line_range_end`),
        openInSidePanel: n,
      });
    },
  };
...
function Er() {
  return {
    [a]({ attributes: e, rawText: t }) {
      return (0, Q.jsx)(Tr, { title: xr(e, `title`) ?? ``, prompt: t ?? `` });
    },
  };
}
function Dr({ cwd: e, enableInlineDil: t, hostId: n, openFileLinksInSidePanel: r }) {
  return { ...Sr({ cwd: e, hostId: n, openFileLinksInSidePanel: r }), ...Er(), ...Cr(), ...wr() };
}
function Or({
  allowWideBlocks: e,
  conversationId: t,
...
function jr(e) {
  let t = (0, X.c)(5),
    n;
  t[0] === e ? (n = t[1]) : ((n = (0, Q.jsx)(Nr, { ...e })), (t[0] = e), (t[1] = n));
  let r;
  return (
...
function Nr(e) {
  ...
  t[19] !== n || t[20] !== D || t[21] !== o
    ? ((O = v(kr(n, D), o)), (t[19] = n), (t[20] = D), (t[21] = o), (t[22] = O))
    : (O = t[22]);
  let k = O,
    A;
  t[23] === b ? (A = t[24]) : ((A = Ar(b)), (t[23] = b), (t[24] = A));
  let j = A,
    M;
  t[25] !== i || t[26] !== D || t[27] !== c || t[28] !== d
    ? ((M = Dr({ cwd: i, enableInlineDil: D, hostId: c, openFileLinksInSidePanel: d })),
      (t[25] = i),
      (t[26] = D),
      (t[27] = c),
      (t[28] = d),
...
function Lr(e, t) {
  ...
  return (Rr(e, t, n), { textByToken: n.textByToken });
}
function Rr(e, t, n, r = !0) {
  for (let i of e) zr(i, t, n, r);
}
function zr(e, t, n, r) {
  if (Ur(e)) {
    let i = Br(e.text, t, r);
    (n.textByToken.set(e, { parts: i, startIndex: n.segmentCount }), (n.segmentCount += Hr(i)));
    return;
  }
  if (`tokens` in e && Array.isArray(e.tokens)) {
    Rr(e.tokens, t, n, r && e.type !== `link`);
    return;
  }
  if (e.type === `list`) {
    Rr(e.items, t, n, r);
  ...
  if (e.type === `table`) {
    for (let i of e.header) Rr(i.tokens, t, n, r);
    for (let i of e.rows) for (let e of i) Rr(e.tokens, t, n, r);
  }
}
function Br(e, t, n) {
  let r = Vr(t),
    ...
    a = r.get(i);
  if (a != null) return a;
  let o = tr({ decorateText: n, segmenter: t, text: e });
  if ((r.set(i, o), r.size > Pr)) {
...
var Wr = /\[([^\]\n]+)\]\(([^)\n]+)$/,
  ...
  Kr = /^\s/;
function qr(e) {
  if (e.length === 0 || (e.includes("`") && ri(e))) return e;
  if (e.includes("```") && ni(e)) return Jr(e);
  let t = e.includes(`![`) ? Yr(e) : e;
  return ((t = t.includes(`](`) ? Xr(t) : t), (t = Zr(t, `**`)), (t = Zr(t, `*`)), t);
}
function Jr(e) {
  return e.endsWith(`
`)
...
function Yr(e) {
  return e.replace(Gr, (e, t) => t);
}
function Xr(e) {
  let t = e.match(Wr);
  return t ? (S(t[2]) || l(t[2]) != null ? e.replace(Wr, `$1`) : `${e})`) : e;
}
function Zr(e, t) {
  if (!e.includes(t) || Qr(e, t) % 2 == 0) return e;
  let n = $r(e, t);
  if (n < 0) return e;
...
function Qr(e, t) {
  ...
  for (let r = 0; r <= e.length - t.length; ) {
    if (e.startsWith(t, r) && !ei(e, r) && !ti(e, r, t)) {
      ((n += 1), (r += t.length));
      continue;
    }
    r += 1;
...
function $r(e, t) {
  for (let n = e.length - t.length; n >= 0; --n)
    if (e.startsWith(t, n) && !ei(e, n) && !ti(e, n, t)) return n;
  return -1;
}
function ei(e, t) {
  let n = 0;
...
function ci(e, t, n) {
  ...
  let s = o == null ? v(e, t) : [...o, ...v(e.slice(a.length), t)];
  if ((r.set(e, s), r.size > ai)) {
    let e = r.keys().next().value;
    typeof e == `string` && r.delete(e);
  }
  return s;
...
`,
      ...
      u = l.trimStart();
    if (
      (n != null && u.length > 0 && di(l) ? ((t = n), (n = null)) : u.length > 0 && (n = null),
      fi(u) ? (i = !i) : !i && pi(u) ? (r += 1) : !i && r > 0 && mi(u) && --r,
...
function hi(e) {
  let t = (0, X.c)(5),
    n;
  t[0] === e ? (n = t[1]) : ((n = (0, Q.jsx)(_i, { ...e })), (t[0] = e), (t[1] = n));
  let r;
  return (
    t[2] !== e.children || t[3] !== n
      ? ((r = (0, Q.jsx)(oe, {
...
function _i(e) {
  ...
  let S = m === void 0 ? !1 : m,
    ...
    O = ee(`2957382457`),
    k;
  t[20] === Symbol.for(`react.memo_cache_sentinel`) ? ((k = oi()), (t[20] = k)) : (k = t[20]);
  let A = k,
    j;
  try {
    let e;
  ...
  let P = N,
    F;
  t[27] === x ? (F = t[28]) : ((F = Ar(x)), (t[27] = x), (t[28] = F));
  let I = F,
    L;
  t[29] !== l || t[30] !== P
    ? ((L = l ? Lr(P, M) : void 0), (t[29] = l), (t[30] = P), (t[31] = L))
    : (L = t[31]);
  let R = L,
    z;
  t[32] !== i || t[33] !== O || t[34] !== c || t[35] !== f
    ? ((z = Dr({ cwd: i, enableInlineDil: O, hostId: c, openFileLinksInSidePanel: f })),
      (t[32] = i),
      (t[33] = O),
      (t[34] = c),
      (t[35] = f),
...
export { jr as n, ot as r, hi as t };
