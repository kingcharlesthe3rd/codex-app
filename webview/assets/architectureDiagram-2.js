import { i as e, r as t, t as n } from "./src-6.js";
import { r, s as i } from "./chunk-34.js";
import "./chunk-93.js";
import { $ as a, it as o } from "./runtime.worker-2.js";
import "./chunk-42.js";
import "./chunk-38.js";
import "./chunk-94.js";
import "./chunk-80.js";
...
import { t as y } from "./chunk-10.js";
import "./dist-5.js";
import { a as b, i as x, n as S, r as C } from "./chunk-127.js";
import { t as w } from "./chunk-14.js";
import { t as T } from "./mermaid-parser.core-5.js";
import { t as E } from "./cytoscape.esm-1.js";
var D = a((e, t) => {
    (function (n, r) {
                ...
                if (
                  ...
                  (this.labelWidth &&
                    (this.labelPosHorizontal == `left`
                      ? ((this.rect.x -= this.labelWidth), this.setWidth(t + this.labelWidth))
                      : this.labelPosHorizontal == `center` && this.labelWidth > t
                        ? ((this.rect.x -= (this.labelWidth - t) / 2),
                          this.setWidth(this.labelWidth))
                        : this.labelPosHorizontal == `right` && this.setWidth(t + this.labelWidth)),
                    this.labelHeight &&
          ...
          ((f.prototype.getNodes = function () {
            ...
            (f.prototype.remove = function (e) {
              ...
              if (e instanceof s) {
                ...
                for (var n = t.edges.slice(), r, i = n.length, a = 0; a < i; a++)
                  ((r = n[a]),
                    r.isInterGraph ? this.graphManager.remove(r) : r.source.owner.remove(r));
          ...
          ((a.prototype.addRoot = function () {
            ...
            (a.prototype.add = function (e, t, n, r, i) {
              if (n == null && r == null && i == null) {
                ...
                if ((this.edges.push(n), !(n.source != null && n.target != null)))
            ...
            (a.prototype.calcInclusionTreeDepths = function (e, t) {
              ...
              for (var n, r = e.getNodes(), i = r.length, a = 0; a < i; a++)
                ((n = r[a]),
                  ...
                  n.child != null && this.calcInclusionTreeDepths(n.child, t + 1));
            }),
            (a.prototype.includesInvalidEdge = function () {
              for (var e, t = [], n = this.edges.length, r = 0; r < n; r++)
                ((e = this.edges[r]), this.isOneAncestorOfOther(e.source, e.target) && t.push(e));
          ...
          ((i.calcSeparationAmount = function (e, t, n, r) {
            ...
            (i.getIntersection = function (e, t, n, i) {
              ...
              return (
                ...
                (b = d * u - l * f),
                (x = h * v - g * _),
                x === 0 ? null : ((p = (_ * b - v * y) / x), (m = (g * y - h * b) / x), new r(p, m))
              );
            }),
          ...
          ((i.prototype.getWorldOrgX = function () {
            ...
            (i.prototype.transformX = function (e) {
              var t = 0,
                n = this.lworldExtX;
              return (
                n != 0 && (t = this.ldeviceOrgX + ((e - this.lworldOrgX) * this.ldeviceExtX) / n), t
              );
            }),
            (i.prototype.transformY = function (e) {
              var t = 0,
                n = this.lworldExtY;
              return (
                n != 0 && (t = this.ldeviceOrgY + ((e - this.lworldOrgY) * this.ldeviceExtY) / n), t
              );
            }),
            (i.prototype.inverseTransformX = function (e) {
              var t = 0,
                n = this.ldeviceExtX;
              return (
                n != 0 && (t = this.lworldOrgX + ((e - this.ldeviceOrgX) * this.lworldExtX) / n), t
              );
            }),
            (i.prototype.inverseTransformY = function (e) {
              var t = 0,
                n = this.ldeviceExtY;
              return (
                n != 0 && (t = this.lworldOrgY + ((e - this.ldeviceOrgY) * this.lworldExtY) / n), t
              );
            }),
        ...
        function (e, t, n) {
          ...
          ((l.prototype.initParameters = function () {
            ...
            (l.prototype.calcIdealEdgeLengths = function () {
              for (
                var e, t, n, r, i, s, c, l = this.getGraphManager().getAllEdges(), u = 0;
                u < l.length;
                u++
              )
                ((e = l[u]),
                  ...
                  e.isInterGraph &&
                    ...
                    (e.idealLength +=
                      ...
                      (r.getInclusionTreeDepth() + i.getInclusionTreeDepth() - 2 * n))));
            }),
            ...
            (l.prototype.calcRepulsionForces = function () {
              ...
              if (this.useFRGridVariant)
                for (
                  ...
                  ((i = s[n]), this.calculateRepulsionForceOfANode(i, c, e, t), c.add(i));
              else
                for (n = 0; n < s.length; n++)
                  for (i = s[n], r = n + 1; r < s.length; r++)
                    ((o = s[r]), i.getOwner() == o.getOwner() && this.calcRepulsionForce(i, o));
            }),
            ...
            (l.prototype.calcSpringForce = function (e, t) {
              var n = e.getSource(),
                ...
                o,
                s;
              if (this.uniformLeafNodeSizes && n.getChild() == null && r.getChild() == null)
            ...
            (l.prototype.calcRepulsionForce = function (e, t) {
              ...
              if (n.intersects(r)) {
                ...
                (this.uniformLeafNodeSizes && e.getChild() == null && t.getChild() == null
                  ? ((l = r.getCenterX() - n.getCenterX()), (u = r.getCenterY() - n.getCenterY()))
                  : (s.getIntersection(n, r, o), (l = o[2] - o[0]), (u = o[3] - o[1])),
                  Math.abs(l) < a.MIN_REPULSION_DIST && (l = c.sign(l) * a.MIN_REPULSION_DIST),
                  Math.abs(u) < a.MIN_REPULSION_DIST && (u = c.sign(u) * a.MIN_REPULSION_DIST),
                  (d = l * l + u * u),
                  (f = Math.sqrt(d)),
                  (p =
            ...
            (l.prototype.calculateRepulsionForceOfANode = function (e, t, n, i) {
              if ((this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && n) || i) {
                var o = new Set();
                e.surrounding = [];
                for (var s, c = this.grid, l = e.startX - 1; l < e.finishX + 2; l++)
                  for (var u = e.startY - 1; u < e.finishY + 2; u++)
                    if (!(l < 0 || u < 0 || l >= c.length || u >= c[0].length)) {
                      for (var d = 0; d < c[l][u].length; d++)
                        if (
                          ((s = c[l][u][d]),
                          !(e.getOwner() != s.getOwner() || e == s) && !t.has(s) && !o.has(s))
                        ) {
                          var f =
          ...
          ((r.multMat = function (e, t) {
            ...
            (r.multL = function (e, t, n) {
              for (var r = [], i = [], a = [], o = 0; o < t[0].length; o++) {
                for (var s = 0, c = 0; c < t.length; c++) s += -0.5 * t[c][o] * e[c];
                i[o] = s;
              }
          ...
          ((r.svd = function (e) {
              ...
              if (l < c) {
                ...
                if (
                  ...
                  for (var S = l + 1; S < this.n; S++)
                    for (var C = -n[S] / n[l + 1], w = l + 1; w < this.m; w++) e[w][S] += C * i[w];
                }
            ...
            for (var te = E - 1, H = 0, ne = 2 ** -52, re = 2 ** -966; E > 0;) {
              var U = void 0,
                W = void 0;
              for (U = E - 2; U >= -1 && U !== -1; U--)
                if (Math.abs(n[U]) <= re + ne * (Math.abs(this.s[U]) + Math.abs(this.s[U + 1]))) {
                  n[U] = 0;
                  break;
                }
              if (U === E - 2) W = 4;
              ...
              switch ((U++, W)) {
                case 1:
                  ...
                  for (var q = E - 2; q >= U; q--) {
                    ...
                    if (
                      ((this.s[q] = J),
                      q !== U && ((K = -ae * n[q - 1]), (n[q - 1] = Y * n[q - 1])),
                      o)
                    )
                      for (var X = 0; X < this.n; X++)
                        ((J = Y * this.V[X][q] + ae * this.V[X][E - 1]),
                          (this.V[X][E - 1] = -ae * this.V[X][q] + Y * this.V[X][E - 1]),
                          (this.V[X][q] = J));
                  }
                  break;
                case 2:
                  ...
                  for (var Z = U; Z < E; Z++) {
                    var se = r.hypot(this.s[Z], oe),
                      ce = this.s[Z] / se,
                      le = oe / se;
                    if (((this.s[Z] = se), (oe = -le * n[Z]), (n[Z] = ce * n[Z]), a))
                      for (var ue = 0; ue < this.m; ue++)
                        ((se = ce * this.U[ue][Z] + le * this.U[ue][U - 1]),
                          (this.U[ue][U - 1] = -le * this.U[ue][Z] + ce * this.U[ue][U - 1]),
                          (this.U[ue][Z] = se));
                  }
                  break;
                case 3:
                  var de = Math.max(
                      Math.max(
                        Math.max(
                          Math.max(Math.abs(this.s[E - 1]), Math.abs(this.s[E - 2])),
                          Math.abs(n[E - 2]),
                        ),
                        Math.abs(this.s[U]),
                      ),
                  ...
                  (function (e, t) {
                    ...
                    ((ye = Math.sqrt(_e * _e + ve)), _e < 0 && (ye = -ye), (ye = ve / (_e + ye)));
                    ...
                    if (
                      ...
                      for (var we = 0; we < this.n; we++)
                        (($ = Se * this.V[we][Q] + Ce * this.V[we][Q + 1]),
                          (this.V[we][Q + 1] = -Ce * this.V[we][Q] + Se * this.V[we][Q + 1]),
                          (this.V[we][Q] = $));
                    if (
                      (($ = r.hypot(be, xe)),
                      (Se = be / $),
                      ...
                      for (var Te = 0; Te < this.m; Te++)
                        (($ = Se * this.U[Te][Q] + Ce * this.U[Te][Q + 1]),
                          (this.U[Te][Q + 1] = -Ce * this.U[Te][Q] + Se * this.U[Te][Q + 1]),
                          (this.U[Te][Q] = $));
                  }
                  ((n[E - 2] = be), (H += 1));
                  break;
                case 4:
                  if (this.s[U] <= 0 && ((this.s[U] = this.s[U] < 0 ? -this.s[U] : 0), o))
                    for (var Ee = 0; Ee <= te; Ee++) this.V[Ee][U] = -this.V[Ee][U];
                  for (; U < te && !(this.s[U] >= this.s[U + 1]);) {
                    var De = this.s[U];
                    if (((this.s[U] = this.s[U + 1]), (this.s[U + 1] = De), o && U < this.n - 1))
            ...
            765: (e, t, n) => {
              ...
              ((x.prototype.newGraphManager = function () {
                    ...
                    if (this.growTreeIterations % 10 == 0)
                      if (this.prunedNodesAll.length > 0) {
                        ...
                        (this.graphManager.setAllNodesToApplyGravitation(t),
                          ...
                          this.updateGrid(),
                          c.PURE_INCREMENTAL
                            ? (this.coolingFactor = u.DEFAULT_COOLING_FACTOR_INCREMENTAL / 2)
                ...
                (x.prototype.initConstraintVariables = function () {
                  ...
                  var i = function t(n) {
                    for (var r = n.getChild().getNodes(), i, a = 0, o = 0; o < r.length; o++)
                      ((i = r[o]),
                        i.getChild() == null
                  ...
                  if (this.constraints.fixedNodeConstraint) {
                    ...
                    for (var t = this.graphManager.getAllNodes(), r, n = 0; n < t.length; n++)
                  ...
                  if (this.constraints.relativePlacementConstraint) {
                    ...
                    if (
                      ...
                      if (this.constraints.alignmentConstraint.vertical)
                        for (
                          var l = this.constraints.alignmentConstraint.vertical, n = 0;
                          n < l.length;
                          n++
                        )
                          (this.dummyToNodeForVerticalAlignment.set(`dummy` + n, []),
                            l[n].forEach(function (t) {
                              (o.set(t, `dummy` + n),
                                e.dummyToNodeForVerticalAlignment.get(`dummy` + n).push(t),
                                e.fixedNodeSet.has(t) && e.fixedNodesOnHorizontal.add(`dummy` + n));
                            }));
                      if (this.constraints.alignmentConstraint.horizontal)
                        for (
                          var u = this.constraints.alignmentConstraint.horizontal, n = 0;
                          n < u.length;
                          n++
                        )
                          (this.dummyToNodeForHorizontalAlignment.set(`dummy` + n, []),
                            u[n].forEach(function (t) {
                              (s.set(t, `dummy` + n),
                                e.dummyToNodeForHorizontalAlignment.get(`dummy` + n).push(t),
                                e.fixedNodeSet.has(t) && e.fixedNodesOnVertical.add(`dummy` + n));
                            }));
                    }
                        ...
                        this.constraints.relativePlacementConstraint.forEach(function (t) {
                          if (t.left) {
                            ...
                            (e.nodesInRelativeHorizontal.includes(n) ||
                              ...
                              e.nodeToRelativeConstraintMapHorizontal.set(n, []),
                              e.dummyToNodeForVerticalAlignment.has(n)
                                ? e.nodeToTempPositionMapHorizontal.set(
                                    n,
                                    e.idToNodeMap
                                      .get(e.dummyToNodeForVerticalAlignment.get(n)[0])
                                      .getCenterX(),
                                  )
                                : e.nodeToTempPositionMapHorizontal.set(
                                    n,
                              ...
                              e.nodesInRelativeHorizontal.includes(r) ||
                                ...
                                e.nodeToRelativeConstraintMapHorizontal.set(r, []),
                                e.dummyToNodeForVerticalAlignment.has(r)
                                  ? e.nodeToTempPositionMapHorizontal.set(
                                      r,
                                      e.idToNodeMap
                                        .get(e.dummyToNodeForVerticalAlignment.get(r)[0])
                                        .getCenterX(),
                                    )
                                  : e.nodeToTempPositionMapHorizontal.set(
                                      r,
                            ...
                            (e.nodesInRelativeVertical.includes(i) ||
                              ...
                              e.nodesInRelativeVertical.includes(a) ||
                                ...
                                e.nodeToRelativeConstraintMapVertical.set(a, []),
                                e.dummyToNodeForHorizontalAlignment.has(a)
                                  ? e.nodeToTempPositionMapVertical.set(
                                      a,
                                      e.idToNodeMap
                                        .get(e.dummyToNodeForHorizontalAlignment.get(a)[0])
                                        .getCenterY(),
                                    )
                                  : e.nodeToTempPositionMapVertical.set(
                                      a,
                          ...
                          return (
                            e.forEach(function (s, c) {
                              if (!a.has(c)) {
                                ((n[o] = []), (r[o] = !1));
                                var l = c;
                                for (i.push(l), a.add(l), n[o].push(l); i.length != 0;)
                                  ((l = i.shift()),
                                    t.has(l) && (r[o] = !0),
                ...
                (x.prototype.updateDisplacements = function () {
                  ...
                  if (
                    ...
                    if (this.constraints.alignmentConstraint.vertical)
                      for (
                        var t = this.constraints.alignmentConstraint.vertical, n = 0;
                        n < t.length;
                        n++
                      ) {
                        ...
                        for (var a = r / t[n].length, i = 0; i < t[n].length; i++)
                          this.idToNodeMap.get(t[n][i]).displacementX = a;
                      }
                    if (this.constraints.alignmentConstraint.horizontal)
                      for (
                        var o = this.constraints.alignmentConstraint.horizontal, n = 0;
                        n < o.length;
                        n++
                      ) {
                        ...
                        for (var l = s / o[n].length, i = 0; i < o[n].length; i++)
                    ...
                    if (c.RELAX_MOVEMENT_ON_CONSTRAINTS)
                        ...
                        this.nodesInRelativeHorizontal.forEach(function (t) {
                          if (!e.fixedNodesOnHorizontal.has(t)) {
                            ...
                            ((n = e.dummyToNodeForVerticalAlignment.has(t)
                              ? e.idToNodeMap.get(e.dummyToNodeForVerticalAlignment.get(t)[0])
                                  .displacementX
                              : e.idToNodeMap.get(t).displacementX),
                              e.nodeToRelativeConstraintMapHorizontal.get(t).forEach(function (r) {
                                if (r.right) {
                                  var i =
                                    e.nodeToTempPositionMapHorizontal.get(r.right) -
                                  ...
                                  var i =
                                    e.nodeToTempPositionMapHorizontal.get(t) -
                                    e.nodeToTempPositionMapHorizontal.get(r.left) +
                                    n;
                                  i < r.gap && (n += r.gap - i);
                                }
                              }),
                              ...
                              e.dummyToNodeForVerticalAlignment.has(t)
                                ? e.dummyToNodeForVerticalAlignment.get(t).forEach(function (t) {
                        ...
                        this.nodesInRelativeVertical.forEach(function (t) {
                          if (!e.fixedNodesOnHorizontal.has(t)) {
                            ...
                            ((n = e.dummyToNodeForHorizontalAlignment.has(t)
                              ? e.idToNodeMap.get(e.dummyToNodeForHorizontalAlignment.get(t)[0])
                                  .displacementY
                              : e.idToNodeMap.get(t).displacementY),
                              e.nodeToRelativeConstraintMapVertical.get(t).forEach(function (r) {
                                if (r.bottom) {
                                  var i =
                                    e.nodeToTempPositionMapVertical.get(r.bottom) -
                                  ...
                                  var i =
                                    e.nodeToTempPositionMapVertical.get(t) -
                                    e.nodeToTempPositionMapVertical.get(r.top) +
                                    n;
                                  i < r.gap && (n += r.gap - i);
                                }
                              }),
                              ...
                              e.dummyToNodeForHorizontalAlignment.has(t)
                                ? e.dummyToNodeForHorizontalAlignment.get(t).forEach(function (t) {
                      ...
                      for (var n = 0; n < this.componentsOnHorizontal.length; n++) {
                        ...
                        if (this.fixedComponentsOnHorizontal[n])
                          ...
                          for (var d = 0, f = 0, i = 0; i < u.length; i++)
                            if (this.dummyToNodeForVerticalAlignment.has(u[i])) {
                              var p = this.dummyToNodeForVerticalAlignment.get(u[i]);
                              ((d += p.length * this.idToNodeMap.get(p[0]).displacementX),
                                (f += p.length));
                      ...
                      for (var n = 0; n < this.componentsOnVertical.length; n++) {
                        ...
                        if (this.fixedComponentsOnVertical[n])
                          ...
                          for (var d = 0, f = 0, i = 0; i < u.length; i++)
                            if (this.dummyToNodeForHorizontalAlignment.has(u[i])) {
                              var p = this.dummyToNodeForHorizontalAlignment.get(u[i]);
                              ((d += p.length * this.idToNodeMap.get(p[0]).displacementY),
                                (f += p.length));
                ...
                (x.prototype.positionNodesRadially = function (e) {
                  for (
                    ...
                    s % n == 0 &&
                      ((a = 0), (i = r), s != 0 && (i += c.DEFAULT_COMPONENT_SEPERATION), (r = 0));
                    var l = e[s],
                ...
                (x.prototype.fillCompexOrderByDFS = function (e) {
                  for (var t = 0; t < e.length; t++) {
                    var n = e[t];
                    (n.getChild() != null && this.fillCompexOrderByDFS(n.getChild().getNodes()),
                  ...
                  ((this.tiledMemberPack = []),
                    Object.keys(e).forEach(function (r) {
                      ...
                      if (
                        ...
                        i.setCenter(n.tiledMemberPack[r].centerX, n.tiledMemberPack[r].centerY),
                        (i.labelMarginLeft = 0),
                        (i.labelMarginTop = 0),
                        c.NODE_DIMENSIONS_INCLUDE_LABELS)
                      ) {
                ...
                (x.prototype.findPlaceforPrunedNode = function (e) {
                  var t,
                    n,
                    r = e[0];
                  if (((n = r == e[1].source ? e[1].target : e[1].source), c.PURE_INCREMENTAL))
                    r.setCenter(
                    ...
                    if (o > 0)
                      for (var d = i; d <= a; d++)
                        l[0] += this.grid[d][o - 1].length + this.grid[d][o].length - 1;
                    if (a < this.grid.length - 1)
                      for (var d = o; d <= s; d++)
                        l[1] += this.grid[a + 1][d].length + this.grid[a][d].length - 1;
                    if (s < this.grid[0].length - 1)
                      for (var d = i; d <= a; d++)
                        l[2] += this.grid[d][s + 1].length + this.grid[d][s].length - 1;
                    if (i > 0)
                      for (var d = o; d <= s; d++)
                        l[3] += this.grid[i - 1][d].length + this.grid[i][d].length - 1;
                    for (var f = g.MAX_VALUE, p, m, h = 0; h < l.length; h++)
                      l[h] < f ? ((f = l[h]), (p = 1), (m = h)) : l[h] == f && p++;
                    if (p == 3 && f == 0)
                      l[0] == 0 && l[1] == 0 && l[2] == 0
                        ? (t = 1)
                        : l[0] == 0 && l[1] == 0 && l[3] == 0
            ...
            991: (e, t, n) => {
              ...
              ((a.prototype.calculateDisplacement = function () {
                ...
                (a.prototype.propogateDisplacementToChildren = function (e, t) {
                  for (var n = this.getChild().getNodes(), r, i = 0; i < n.length; i++)
                    ((r = n[i]),
                      r.getChild() == null
            ...
            902: (e, t, n) => {
              ...
              ((c.handleConstraints = function (e) {
                ...
                ((t.fixedNodeConstraint = e.constraints.fixedNodeConstraint),
                  ...
                  (t.relativePlacementConstraint = e.constraints.relativePlacementConstraint));
                for (
                  var n = new Map(),
                    c = new Map(),
                    l = [],
                ...
                var h = function (e, t) {
                        ...
                        o.forEach(function (e) {
                          ...
                          if (
                            ...
                            (r.forEach(function (e) {
                              t == `horizontal`
                                ? (f.set(e, c.has(e) ? l[c.get(e)] : i.get(e)), (a += f.get(e)))
                                : (f.set(e, c.has(e) ? u[c.get(e)] : i.get(e)), (a += f.get(e)));
                            }),
                              (a /= r.length),
                              e.forEach(function (e) {
                                n.has(e) || f.set(e, a);
                  ...
                  v = function (e) {
                    ...
                    if (
                      ...
                      for (var a = 0; a < c.size; a++) ((l[a] = -1 * l[a]), (u[a] = -1 * u[a]));
                    ...
                    return (
                      e.forEach(function (a, o) {
                        if (!r.has(o)) {
                          t[i] = [];
                          var s = o;
                          for (n.push(s), r.add(s), t[i].push(s); n.length != 0;)
                            ((s = n.shift()),
                  ...
                  b = function (e) {
                    ...
                    return (
                      ...
                      e.forEach(function (e, n) {
                        e.forEach(function (e) {
                          (t.get(n).push(e),
                            t.get(e.id).push({ id: n, gap: e.gap, direction: e.direction }));
                        });
                      }),
                      t
                    );
                ...
                if (
                    ...
                    (t.relativePlacementConstraint.forEach(function (e) {
                      e.left
                        ? (D.has(e.left)
                            ...
                            : D.set(e.left, [{ id: e.right, gap: e.gap, direction: `horizontal` }]),
                          D.has(e.right) || D.set(e.right, []))
                        : (D.has(e.top)
                            ? D.get(e.top).push({ id: e.bottom, gap: e.gap, direction: `vertical` })
                            : D.set(e.top, [{ id: e.bottom, gap: e.gap, direction: `vertical` }]),
                          ...
                          var n = t.alignmentConstraint.vertical,
                            i = function (t) {
                              ...
                              var a = new Set(
                                ...
                                o = void 0;
                              ((o = a.size > 0 ? l[c.get(a.values().next().value)] : g(i).x),
                          ...
                          var o = t.alignmentConstraint.horizontal,
                            s = function (t) {
                              ...
                              var i = new Set(
                                ...
                                a = void 0;
                              ((a = i.size > 0 ? l[c.get(i.values().next().value)] : g(n).y),
                    ...
                    if (A < O.size / 2) (v(t.relativePlacementConstraint), (w = !1), (T = !1));
                      ...
                      (k[j].forEach(function (e, t) {
                        ((C[t] = [l[c.get(e)], u[c.get(e)]]),
                          (S[t] = []),
                          I.has(e) ? (S[t][0] = I.get(e)) : (S[t][0] = l[c.get(e)]),
                          L.has(e) ? (S[t][1] = L.get(e)) : (S[t][1] = u[c.get(e)]));
                      }),
                        (w = !0));
                    }
                  }
                  if (w) {
                    for (
                      var R = void 0, z = o.transpose(S), B = o.transpose(C), V = 0;
                      V < z.length;
                      V++
                    )
                        ...
                        var G = t.alignmentConstraint.vertical,
                          ie = function (e) {
                            ...
                            var n = new Set(
                              ...
                              i = void 0;
                            ((i = n.size > 0 ? l[c.get(n.values().next().value)] : g(t).x),
                              t.forEach(function (e) {
                                E.has(e) || (l[c.get(e)] = i);
                              }));
                          },
                        ...
                        var q = t.alignmentConstraint.horizontal,
                          J = function (e) {
                            ...
                            var n = new Set(
                              ...
                              i = void 0;
                            ((i = n.size > 0 ? u[c.get(n.values().next().value)] : g(t).y),
                              t.forEach(function (e) {
                                E.has(e) || (u[c.get(e)] = i);
                              }));
                          },
                        ...
                        w = function (t) {
                          D.get(t).forEach(function (r) {
                            ...
                            r.direction == `horizontal`
                              ? ((i = e.get(t) ? e.get(t) : t),
                                (a = e.get(r.id)
                                  ? { id: e.get(r.id), gap: r.gap, direction: r.direction }
                                  : r),
                                S.has(i) ? S.get(i).push(a) : S.set(i, [a]),
                                S.has(a.id) || S.set(a.id, []))
                              : ((i = n.get(t) ? n.get(t) : t),
                                (a = n.get(r.id)
                                  ? { id: n.get(r.id), gap: r.gap, direction: r.direction }
                                  : r),
              ...
              548: (e, t, n) => {
                ...
                ((a.getTopMostNodes = function (e) {
                  ...
                  (a.calcBoundingBox = function (e, t, n, r) {
                    ...
                    var g = {};
                    return (
                      (g.topLeftX = i), (g.topLeftY = o), (g.width = a - i), (g.height = s - o), g
                    );
                  }),
                    ...
                    var v = function (e) {
                            ...
                            if (c.randomize)
                              if (!d.isParent())
                                p = t.add(
                                  new a(
                                    i.graphManager,
                                    new o(h[m.get(d.id())] - v.w / 2, g[m.get(d.id())] - v.h / 2),
                              ...
                              p = t.add(
                                new a(
                                  i.graphManager,
                                  new o(d.position(`x`) - v.w / 2, d.position(`y`) - v.h / 2),
                                  new s(parseFloat(v.w), parseFloat(v.h)),
                                ),
                              );
                      ...
                      S = function (t, n, r) {
                        ...
                        e.idealEdgeLength != null &&
                          (a > 0
                            ? (u.DEFAULT_EDGE_LENGTH = l.DEFAULT_EDGE_LENGTH = i / a)
                            : v(e.idealEdgeLength)
                              ? (u.DEFAULT_EDGE_LENGTH = l.DEFAULT_EDGE_LENGTH = 50)
                              : (u.DEFAULT_EDGE_LENGTH = l.DEFAULT_EDGE_LENGTH = e.idealEdgeLength),
                      ...
                      C = function (e, t) {
                        (t.fixedNodeConstraint &&
                          (e.constraints.fixedNodeConstraint = t.fixedNodeConstraint),
                          t.alignmentConstraint &&
                            (e.constraints.alignmentConstraint = t.alignmentConstraint),
                          t.relativePlacementConstraint &&
                            (e.constraints.relativePlacementConstraint =
                              t.relativePlacementConstraint));
                      };
                    (e.nestingFactor != null &&
                      (u.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = l.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                        e.nestingFactor),
                      e.gravity != null &&
                        (u.DEFAULT_GRAVITY_STRENGTH = l.DEFAULT_GRAVITY_STRENGTH = e.gravity),
                      e.numIter != null && (u.MAX_ITERATIONS = l.MAX_ITERATIONS = e.numIter),
                      e.gravityRange != null &&
                        (u.DEFAULT_GRAVITY_RANGE_FACTOR = l.DEFAULT_GRAVITY_RANGE_FACTOR =
                          e.gravityRange),
                      e.gravityCompound != null &&
                        (u.DEFAULT_COMPOUND_GRAVITY_STRENGTH = l.DEFAULT_COMPOUND_GRAVITY_STRENGTH =
                          e.gravityCompound),
                      ...
                      e.tilingCompareBy != null && (u.TILING_COMPARE_BY = e.tilingCompareBy),
                      ...
                      (u.DEFAULT_INCREMENTAL = l.DEFAULT_INCREMENTAL = c.DEFAULT_INCREMENTAL = !0),
                      (u.PURE_INCREMENTAL = !e.randomize),
                      (c.DEFAULT_UNIFORM_LEAF_NODE_SIZES = e.uniformNodeDimensions),
                      e.step == `transformed` &&
                    ...
                    r(e, [
                      {
                        ...
                        value: function () {
                            ...
                            if (f) {
                              ...
                              if (
                                ...
                                l.forEach(function (e) {
                                  var t = e.boundingBox();
                                  u.push({ x: t.x1 + t.w / 2, y: t.y1 + t.h / 2 });
                                }),
                                t.randomize &&
                                  l.forEach(function (e) {
                                    ((t.eles = e), i.push(s(t)));
                                ...
                                if (t.tile) {
                                  var h = new Map(),
                                    ...
                                    _ = [],
                                    v = 0,
                                    y = { nodeIndexes: h, xCoords: g, yCoords: _ },
                                    b = [];
                                  if (
                                    (l.forEach(function (e, t) {
                                      e.edges().length == 0 &&
                                        (e.nodes().forEach(function (t, n) {
                                          (m.merge(e.nodes()[n]),
                                            t.isParent() ||
                                              (y.nodeIndexes.set(e.nodes()[n].id(), v++),
                                              y.xCoords.push(e.nodes()[0].position().x),
                                              y.yCoords.push(e.nodes()[0].position().y)));
                                        }),
                                        b.push(t));
                                    }),
                                    m.length > 1)
                                    ...
                                    var x = m.boundingBox();
                                    (u.push({ x: x.x1 + x.w / 2, y: x.y1 + x.h / 2 }),
                                      l.push(m),
                                      i.push(y));
                                    for (var S = b.length - 1; S >= 0; S--)
                                      (l.splice(b[S], 1), i.splice(b[S], 1), u.splice(b[S], 1));
                                  }
                                }
                              ...
                              if (l.length > 1) {
                                ...
                                l.forEach(function (e, n) {
                                  var r = void 0;
                                  if (
                                    (t.quality == `draft` && (r = i[n].nodeIndexes),
                                          ...
                                          if (t.quality == `draft`) {
                                            ...
                                            if (c.isParent()) {
                                              ...
                                              (f.push(m.topLeftX + m.width / 2),
                                                f.push(m.topLeftY + m.height / 2));
                                            } else
                                              (f.push(i[n].xCoords[u]), f.push(i[n].yCoords[u]));
                                            if (l.isParent()) {
                                              ...
                                              (p.push(h.topLeftX + h.width / 2),
                                                p.push(h.topLeftY + h.height / 2));
                                            } else
                                              (p.push(i[n].xCoords[d]), p.push(i[n].yCoords[d]));
                                            s.edges.push({
                                              startX: f[0],
                                              startY: f[1],
                                              endX: p[0],
                              ...
                              if ((u.push({ x: O.x1 + O.w / 2, y: O.y1 + O.h / 2 }), t.randomize)) {
                                var k = s(t);
                                i.push(k);
                              }
                              t.quality == `default` || t.quality == `proof`
                                ? (a.push(c(t, i[0])), o.relocateComponent(u[0], a[0], t))
                            ...
                            if (t.quality == `default` || t.quality == `proof`) {
                                  ...
                                  o.labelHeight &&
                                    (o.labelPosVertical == `top`
                                      ...
                                      : o.labelPosVertical == `bottom` &&
                                        (r.y -= o.labelHeight / 2))),
                                (r ??= { x: e.position(`x`), y: e.position(`y`) }),
                                { x: r.x, y: r.y }
                              );
                            } else {
                              var c = void 0;
                              return (
                                i.forEach(function (t) {
                                  ...
                                  n != null && (c = { x: t.xCoords[n], y: t.yCoords[n] });
                                }),
                                (c ??= { x: e.position(`x`), y: e.position(`y`) }),
                                { x: c.x, y: c.y }
                              );
                            }
                          };
                          if (t.quality == `default` || t.quality == `proof` || t.randomize) {
                            ...
                            ((t.eles = r.not(M)),
                              r.nodes().not(`:parent`).not(M).layoutPositions(e, t, A),
                              j.length > 0 &&
                ...
                e.exports = {
                  spectralLayout: function (e) {
                    var t = e.cy,
                      ...
                      D = function (e, t, n) {
                        for (
                          var r = [], i = 0, a = 0, o = 0, s = void 0, c = [], u = 0, f = 1, p = 0;
                          p < y;
                          p++
                        )
                          c[p] = b;
                        for (r[a] = e, c[e] = 0; a >= i;) {
                          ...
                          for (var m = d[o], _ = 0; _ < m.length; _++)
                            ((s = l.get(m[_])), c[s] == b && ((c[s] = c[o] + 1), (r[++a] = s)));
                          g[o][t] = c[o] * w;
                        }
                        if (n) {
                      ...
                      k = function () {
                        for (
                          ...
                          for (var l = 0; l < T; l++)
                            ((s[c][l] = 0),
                              c == l && (s[c][l] = t[c] / (t[c] * t[c] + o / (t[c] * t[c]))));
                        }
                        v = i.multMat(i.multMat(r, s), i.transpose(n));
                      },
                      A = function () {
                        for (
                          var e = void 0, t = void 0, n = [], r = [], a = [], o = [], s = 0;
                          s < y;
                          s++
                        )
                        ...
                        for (c = 0, u = x; ;) {
                          ...
                          if (
                            ((o = i.minusOp(o, i.multCons(a, i.dotProduct(a, o)))),
                    ...
                    (s.forEach(function (e) {
                      for (var t = e.children().intersection(n); t.nodes(`:childless`).length == 0;)
                      ...
                      o.forEach(function (e) {
                        var t = void 0;
                        ((t = e.isParent() ? l.get(u.get(e.id())) : l.get(e.id())),
                          e
                            .neighborhood()
                            .nodes()
                            .forEach(function (r) {
                              n.intersection(e.edgesWith(r)).length > 0 &&
                                (r.isParent() ? d[t].push(u.get(r.id())) : d[t].push(r.id()));
                            }));
                      }));
                    var B = function (e) {
                        var n = l.get(e),
                    ...
                    if (y > 2) {
                      ...
                      return (
                        e.quality == `draft` || e.step == `all`
                          ? (O(C), k(), A(), (U = { nodeIndexes: l, xCoords: f, yCoords: p }))
                          : (l.forEach(function (e, n) {
                      ...
                      return ((U = { nodeIndexes: l, xCoords: f, yCoords: p }), U);
                    }
                  },
                };
              },
  ...
  G = class {
    ...
    addService({ id: e, icon: t, in: n, title: r, iconText: i }) {
      if (this.registeredIds[e] !== void 0)
        throw Error(`The service id [${e}] is already in use by another ${this.registeredIds[e]}`);
      if (n !== void 0) {
    ...
    addJunction({ id: e, in: t }) {
      if (this.registeredIds[e] !== void 0)
        throw Error(`The junction id [${e}] is already in use by another ${this.registeredIds[e]}`);
      if (t !== void 0) {
    ...
    addGroup({ id: e, icon: t, in: n, title: r }) {
      if (this.registeredIds?.[e] !== void 0)
        throw Error(`The group id [${e}] is already in use by another ${this.registeredIds[e]}`);
      if (n !== void 0) {
      ...
      ((this.registeredIds[e] = `group`), (this.groups[e] = { id: e, icon: t, title: r, in: n }));
    }
    getGroups() {
    ...
    getDataStructures() {
      if (this.dataStructures === void 0) {
        let e = {},
          ...
          r = Object.keys(n)[0],
          i = { [r]: 1 },
          a = Object.keys(n).reduce((e, t) => (t === r ? e : { ...e, [t]: 1 }), {}),
          o = t((e) => {
            let t = { [e]: [0, 0] },
              r = [e];
            for (; r.length > 0;) {
        ...
        this.dataStructures = { adjList: n, spatialMaps: s, groupAlignments: e };
      }
...
`,
  ...
  J = t(
    (e) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e}</g>`,
    `wrapIcon`,
  ),
  Y = {
    ...
    await Promise.all(
      t.edges().map(async (t) => {
        let {
          ...
          E = a + 4;
        if (
          (f && (F(u) ? (y += u === `L` ? -E : E) : (b += u === `T` ? -E : E + 18)),
          _ && (F(m) ? (w += m === `L` ? -E : E) : (T += m === `T` ? -E : E + 18)),
          !f &&
          ...
          if (v) {
            let e = L(u, m) ? `XY` : F(u) ? `X` : `Y`,
              n = 0;
            n =
              e === `X` ? Math.abs(y - w) : e === `Y` ? Math.abs(b - T) / 1.5 : Math.abs(y - w) / 2;
            let r = t.append(`g`);
            if (
              (await S(
                r,
    ...
    await Promise.all(
      t.nodes().map(async (t) => {
        ...
        if (s.type === `group`) {
          ...
          if (s.icon) {
            let e = p.append(`g`);
            (e.html(`<g>${await C(s.icon, { height: i, width: i, fallbackPrefix: Y.prefix })}</g>`),
              e.attr(`transform`, `translate(` + (m + o + 1) + `, ` + (g + o + 1) + `)`),
              (m += i),
              (g += a / 2 - 1 - 2));
          }
          if (s.label) {
            ...
            (await S(
              e,
              s.label,
              { useHtmlLabels: !1, width: l, classes: `architecture-service-label` },
              h(),
            ),
              e
                .attr(`dy`, `1em`)
              ...
              e.attr(`transform`, `translate(` + (m + o + 4) + `, ` + (g + o + 2) + `)`));
          }
    ...
    for (let a of n) {
      ...
      if (a.title) {
        ...
        (await S(
          e,
          a.title,
          { useHtmlLabels: !1, width: o * 1.5, classes: `architecture-service-label` },
          i,
        ),
          e
            .attr(`dy`, `1em`)
      ...
      let s = n.append(`g`);
      if (a.icon)
        s.html(`<g>${await C(a.icon, { height: o, width: o, fallbackPrefix: Y.prefix })}</g>`);
      else if (a.iconText) {
        s.html(`<g>${await C(`blank`, { height: o, width: o, fallbackPrefix: Y.prefix })}</g>`);
        let e = s
            .append(`g`)
...
function le(e, t) {
  t.nodes().map((t) => {
    ...
    n.type !== `group` &&
      ((n.x = t.position().x),
      (n.y = t.position().y),
      e.getElementById(n.id).attr(`transform`, `translate(` + (n.x || 0) + `,` + (n.y || 0) + `)`));
  });
}
t(le, `positionNodes`);
function ue(e, t) {
  e.forEach((e) => {
    t.add({
      group: `nodes`,
      data: { type: `group`, id: e.id, icon: e.icon, label: e.title, parent: e.in },
      classes: `node-group`,
    });
  });
}
  ...
  e.forEach((e) => {
    let {
      ...
      f = {
        ...
        sourceGroup: a,
        sourceEndpoint:
          s === `L` ? `0 50%` : s === `R` ? `100% 50%` : s === `T` ? `50% 0` : `50% 100%`,
        target: r,
        targetDir: c,
        targetArrow: o,
        targetGroup: l,
          ...
          if (l) {
            ...
            Object.entries(c).forEach(([e, a]) => {
              ...
              d &&
                !s[c] &&
                (o.push(c),
                r.push({ [A[e]]: d, [A[N(e)]]: l, gap: 1.5 * n.getConfigField(`iconSize`) }));
            });
          }
        }
      }
...
function me(r, i, a, o, s, { spatialMaps: c, groupAlignments: l }) {
  return new Promise((u) => {
    let d = n(`body`).append(`div`).attr(`id`, `cy`).attr(`style`, `display:none`),
      f = E({
      ...
      h = f.layout({
        ...
        idealEdgeLength(e) {
          let [t, n] = e.connectedNodes(),
            { parent: r } = U(t),
            { parent: i } = U(n);
          return r === i ? 1.5 * s.getConfigField(`iconSize`) : 0.5 * s.getConfigField(`iconSize`);
        },
        edgeElasticity(e) {
          let [t, n] = e.connectedNodes(),
            { parent: r } = U(t),
    ...
    (h.one(`layoutstop`, () => {
      function e(e, t, n, r) {
        let i,
          ...
          { x: o, y: s } = e,
          { x: c, y: l } = t;
        ((a = (r - s + ((o - n) * (s - l)) / (o - c)) / Math.sqrt(1 + ((s - l) / (o - c)) ** 2)),
  ...
  renderer: {
    draw: t(async (e, t, n, r) => {
      ...
      (await ae(f, h, i, t),
        await X(m, h, i, t),
        le(i, h),
        l(void 0, d, i.getConfigField(`padding`), i.getConfigField(`useMaxWidth`)));
    }, `draw`),
  },
  styles: q,
};
export { he as diagram };
//# sourceMappingURL=architectureDiagram-2.js.map
