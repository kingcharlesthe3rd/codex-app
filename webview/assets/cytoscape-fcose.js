          ...
          ((r.svd = function (e) {
            ...
            for (var ne = E - 1, V = 0, re = 2 ** -52, ie = 2 ** -966; E > 0;) {
              var H = void 0,
                U = void 0;
              for (H = E - 2; H >= -1 && H !== -1; H--)
                if (Math.abs(n[H]) <= ie + re * (Math.abs(this.s[H]) + Math.abs(this.s[H + 1]))) {
                  n[H] = 0;
                  break;
                }
              if (H === E - 2) U = 4;
              ...
              switch ((H++, U)) {
                case 1:
                  ...
                  for (var K = E - 2; K >= H; K--) {
                    ...
                    if (
                      ((this.s[K] = oe),
                      K !== H && ((G = -se * n[K - 1]), (n[K - 1] = q * n[K - 1])),
                      o)
                    )
                      for (var J = 0; J < this.n; J++)
                        ((oe = q * this.V[J][K] + se * this.V[J][E - 1]),
                          (this.V[J][E - 1] = -se * this.V[J][K] + q * this.V[J][E - 1]),
                          (this.V[J][K] = oe));
                  }
                  break;
                case 2:
                  ...
                  for (var Y = H; Y < E; Y++) {
                    var le = r.hypot(this.s[Y], ce),
                      ue = this.s[Y] / le,
                      de = ce / le;
                    if (((this.s[Y] = le), (ce = -de * n[Y]), (n[Y] = ue * n[Y]), a))
                      for (var fe = 0; fe < this.m; fe++)
                        ((le = ue * this.U[fe][Y] + de * this.U[fe][H - 1]),
                          (this.U[fe][H - 1] = -de * this.U[fe][Y] + ue * this.U[fe][H - 1]),
                          (this.U[fe][Y] = le));
                  }
                  break;
                case 3:
                  ...
                  (function (e, t) {
                    ...
                    ((xe = Math.sqrt(ye * ye + be)), ye < 0 && (xe = -xe), (xe = be / (ye + xe)));
                    ...
                    if (
                      ...
                      for (var we = 0; we < this.n; we++)
                        ((Z = Q * this.V[we][X] + $ * this.V[we][X + 1]),
                          (this.V[we][X + 1] = -$ * this.V[we][X] + Q * this.V[we][X + 1]),
                          (this.V[we][X] = Z));
                    if (
                      ((Z = r.hypot(Se, Ce)),
                      (Q = Se / Z),
                      ...
                      for (var Te = 0; Te < this.m; Te++)
                        ((Z = Q * this.U[Te][X] + $ * this.U[Te][X + 1]),
                          (this.U[Te][X + 1] = -$ * this.U[Te][X] + Q * this.U[Te][X + 1]),
                          (this.U[Te][X] = Z));
                  }
                  ((n[E - 2] = Se), (V += 1));
                  break;
                case 4:
                  if (this.s[H] <= 0 && ((this.s[H] = this.s[H] < 0 ? -this.s[H] : 0), o))
                    for (var Ee = 0; Ee <= ne; Ee++) this.V[Ee][H] = -this.V[Ee][H];
                  for (; H < ne && !(this.s[H] >= this.s[H + 1]);) {
                    var De = this.s[H];
                    if (((this.s[H] = this.s[H + 1]), (this.s[H + 1] = De), o && H < this.n - 1))
            ...
            902: (e, t, n) => {
              ...
              ((c.handleConstraints = function (e) {
                ...
                if (
                    ...
                    if (A < O.size / 2) (v(t.relativePlacementConstraint), (w = !1), (T = !1));
                      ...
                      (k[j].forEach(function (e, t) {
                        ((C[t] = [l[c.get(e)], u[c.get(e)]]),
                          (S[t] = []),
                          te.has(e) ? (S[t][0] = te.get(e)) : (S[t][0] = l[c.get(e)]),
                          F.has(e) ? (S[t][1] = F.get(e)) : (S[t][1] = u[c.get(e)]));
                      }),
                        (w = !0));
                    }
                  }
                  if (w) {
                    for (
                      var I = void 0, L = o.transpose(S), R = o.transpose(C), z = 0;
                      z < L.length;
                      z++
                    )
                ...
                coseLayout: function (e, t) {
                  ...
                  var v = function (e) {
                    ...
                    S = function (t, n, r) {
                      ...
                      e.idealEdgeLength != null &&
                        ...
                        (u.MIN_REPULSION_DIST = l.MIN_REPULSION_DIST = l.DEFAULT_EDGE_LENGTH / 10),
                  ...
                  (e.nestingFactor != null &&
                    ...
                    e.initialEnergyOnIncremental != null &&
                      (u.DEFAULT_COOLING_FACTOR_INCREMENTAL = l.DEFAULT_COOLING_FACTOR_INCREMENTAL =
                    ...
                    e.step == `all` &&
                      ...
                      (u.ENFORCE_CONSTRAINTS = !0),
                      (u.APPLY_LAYOUT = !0)),
                    e.fixedNodeConstraint || e.alignmentConstraint || e.relativePlacementConstraint
                  ...
                  r(e, [
                    {
                      ...
                      value: function () {
                        ...
                        if (
                          (n.layoutUtilities &&
                            t.packComponents &&
                            ((d = n.layoutUtilities(`get`)), (d ||= n.layoutUtilities()), (f = !0)),
                          r.nodes().length > 0)
                        )
                          if (f) {
                              ...
                              t.nodeDimensionsIncludeLabels &&
                                (o.labelWidth &&
                                  (o.labelPosHorizontal == `left`
                                    ? (r.x += o.labelWidth / 2)
                                    : o.labelPosHorizontal == `right` && (r.x -= o.labelWidth / 2)),
                                o.labelHeight &&
                  ...
                  if (y > 2) {
                    ...
                    return (
                      e.quality == `draft` || e.step == `all`
                        ? (O(C), k(), A(), (H = { nodeIndexes: l, xCoords: f, yCoords: p }))
                        : (l.forEach(function (e, n) {
                    ...
                    return ((H = { nodeIndexes: l, xCoords: f, yCoords: p }), H);
                  }
                },
              };
            },
