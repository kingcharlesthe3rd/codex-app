...
function _(e) {
      ...
      return (
        ...
        (k.inFlight = (async () => {
          try {
            ...
            ((k.failedAtMs = Date.now()), !l && !r && u(`failed`));
          } finally {
            k.inFlight = null;
          }
        })()),
  ...
  let p = (0, b.useMemo)(
    () =>
      !e || n || a == null || a.rolloutCountWithCompletedTurns < 1 || a.estimatedSavedMs < S
        ? null
        : {
            threadCountLabel: y(t, a.rolloutCountWithCompletedTurns),
            savedDuration: v(t, a.estimatedSavedMs),
          },
    [e, t, n, a],
  );
  return !e || n
    ...
    : p == null || a == null
      ? { estimate: null, estimateStatus: c, isEstimateFreshForAnnouncement: !1 }
      : { estimate: p, estimateStatus: c, isEstimateFreshForAnnouncement: h(a.computedAtMs) };
}
function v(e, t) {
...
var b,
  ...
  A = e(() => {
    (a(),
      ...
      (E = 3600 * 1e3),
      (D = 1440 * 60 * 1e3),
      (O = s(`fast-mode-personalized-estimate`, null)),
