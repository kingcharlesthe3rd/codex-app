...
function _(e) {
  ...
  ((0, b.useEffect)(() => {
    ...
    (0, b.useEffect)(() => {
      ...
      if (
        ...
        (k.failedAtMs != null && a - k.failedAtMs < E)
      )
        return;
      let l = !1;
      return (
        ...
        (k.inFlight = (async () => {
          try {
            let e = await r(`fast-mode-rollout-metrics`, {
            ...
            ((k.failedAtMs = Date.now()), !l && !i && u(`failed`));
          } finally {
            k.inFlight = null;
          }
        })()),
  ...
  let m = (0, b.useMemo)(
    () =>
      !e || n || s == null || s.rolloutCountWithCompletedTurns < 1 || s.estimatedSavedMs < S
        ? null
        : {
  ...
  return !e || n
    ...
    : m == null || s == null
      ? { estimate: null, estimateStatus: l, isEstimateFreshForAnnouncement: !1 }
      : { estimate: m, estimateStatus: l, isEstimateFreshForAnnouncement: h(s.computedAtMs) };
}
function v(e, t) {
  ...
  return r > 0 && i > 0
    ? e.formatMessage(x.durationHoursAndMinutes, { hoursLabel: a, minutesLabel: o })
    : r > 0
      ? a
      : o;
}
function y(e, t) {
  return e.formatMessage(t === 1 ? x.threadCountOne : x.threadCountOther, { count: t });
}
var b,
  x,
  S,
  ...
  A = e(() => {
    (o(),
      ...
      (E = 3600 * 1e3),
      (D = 1440 * 60 * 1e3),
      (O = c(`fast-mode-personalized-estimate`, null)),
...
//# sourceMappingURL=app-initial~app-main~new-thread-panel-page~home-announcements~upgrade-plan-dialog.js.map
