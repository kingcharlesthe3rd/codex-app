...
import { do as f } from "./app-server-manager-signals.js";
...
import { a as O, m as k, n as A, p as j } from "./chunk-8.js";
import { a as M, d as N, o as P } from "./statsig.js";
...
import { t as re } from "./chats.js";
import { a as ie, n as ae, r as oe } from "./use-is-plugins-enabled.js";
import { c as se, m as ce, v as le } from "./use-plugins.js";
...
import { n as ve, o as V, r as ye } from "./plugins-availability.js";
...
import { t as K } from "./settings-shared.js";
import { t as Ae } from "./settings-host-context.js";
import { t as je } from "./more-menu-trigger.js";
import {
  a as Me,
  c as Ne,
  d as Pe,
...
import { t as Ue } from "./browser-use.js";
import { n as We, t as Ge } from "./browser-use-elevated-risk-learn-more-url-C.js";
import { t as Ke } from "./plugin-uninstall-dialog.js";
var Z = E(),
  Q = e(p(), 1),
  $ = m(),
...
function et(e) {
  let t = (0, Z.c)(3),
    { kind: n } = e,
    r;
  return (t[1] === n ? (r = t[2]) : ((r = (0, $.jsx)(tt, { kind: n })), (t[1] = n), (t[2] = r)), r);
}
function tt(e) {
  let t = (0, Z.c)(17),
    { kind: n } = e,
        ...
        return (
          (async () => {
            try {
              if (
                (t != null &&
                  (await t({ mountId: r, type: `browser-settings-webview-mounted` }), (o = !0)),
                c)
              ) {
                u();
                return;
...
function nt(e) {
  ...
  t[4] === i
    ? (s = t[5])
    : ((s = (0, $.jsxs)(z, { color: `ghost`, size: `toolbar`, onClick: i, children: [a, o] })),
      (t[4] = i),
      (t[5] = s));
  let c, l;
      ...
      : ((i = (0, $.jsx)(ue, {
          ...
          children: (0, $.jsxs)(X, {
            children: [
              r,
              (0, $.jsx)(X.Content, {
                children: (0, $.jsx)(Y, { children: (0, $.jsx)(st, { hostId: t }) }),
              }),
            ],
          }),
        })),
...
function st(e) {
  ...
  t[6] === h
    ? (g = t[7])
    : ((g = (0, $.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [m, h] })),
      (t[6] = h),
      (t[7] = g));
  let _;
  t[8] === r
  ...
  t[12] !== f || t[13] !== _ || t[14] !== y || t[15] !== x
    ? ((w = (0, $.jsx)(G, { ariaLabel: _, checked: f, disabled: y, onChange: x })),
      (t[12] = f),
      (t[13] = _),
      (t[14] = y),
      (t[15] = x),
...
function _t(e) {
  ...
  if (
    ...
    let e;
    (t[22] !== r || t[23] !== u || t[24] !== g || t[25] !== D || t[26] !== o || t[27] !== b
      ? ((e = (e) =>
          (0, $.jsx)(
            xt,
            {
              ...
              onToggleInstalledPluginEnabled: (e, t) => {
                b({ pluginId: e.plugin.id, pluginDisplayName: V(e), enabled: t });
              },
              onUninstallPlugin: T,
            },
            e.plugin.plugin.id,
  ...
  t[34] === f
    ...
    : ((N = (e) => {
      ...
      (t[35] = N));
  let P;
  t[36] !== p || t[37] !== m || t[38] !== h || t[39] !== _ || t[40] !== o || t[41] !== N
    ? ((P = (0, $.jsx)(fe, {
        hostId: o,
        isInstalling: h,
...
function yt(e) {
  ...
  t[0] === n.icon
    ? (i = t[1])
    : ((i = n.icon ?? (0, $.jsx)(ne, { className: `icon-md text-token-text-secondary` })),
      (t[0] = n.icon),
      (t[1] = i));
  let a;
  t[2] === i
  ...
  t[16] === u
    ? (d = t[17])
    : ((d = (0, $.jsx)(G, { ariaLabel: u, checked: !1, disabled: !0, onChange: bt })),
      (t[16] = u),
      (t[17] = d));
  let f;
  return (
  ...
  if (
    ...
    let x =
        ...
        (0, $.jsx)(I, {
          ...
          fallback: (0, $.jsx)(ne, { className: `icon-md text-token-text-secondary` }),
        }),
      S;
    t[18] !== y || t[19] !== x
    ...
    if (!n.enabled) {
      ...
      return (
        e[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(O, { to: `/settings/browser-use`, replace: !0 })), (e[5] = t))
          : (t = e[5]),
        t
      );
    }
...
function Dt() {
  ...
  e[1] !== a || e[2] !== r.availablePlugins
    ? ((o = St(r.availablePlugins, i, a)), (e[1] = a), (e[2] = r.availablePlugins), (e[3] = o))
    : (o = e[3]);
  let s = o,
    c;
  ...
  e[14] !== s || e[15] !== h
    ? ((T =
        s == null && Kt(h)
          ? [
              {
                description: (0, $.jsx)(b, { ...R.restrictedAvailabilityDescription }),
                icon: (0, $.jsx)(Ue, { className: `h-full w-full text-token-foreground` }),
    ...
    : ((O = y
        ? (0, $.jsxs)(X, {
            children: [
              ...
              (0, $.jsx)(X.Content, { children: (0, $.jsx)(Y, { children: (0, $.jsx)(Ot, {}) }) }),
            ],
          })
        : null),
      (e[22] = y),
    ...
    : ((k = S
        ? (0, $.jsxs)(X, {
            children: [
              ...
              (0, $.jsx)(X.Content, { children: (0, $.jsx)(Y, { children: (0, $.jsx)(kt, {}) }) }),
            ],
          })
        : null),
      (e[24] = S),
    ...
    : ((A = v
        ? (0, $.jsxs)(X, {
            children: [
              ...
              (0, $.jsx)(X.Content, {
                children: (0, $.jsxs)(Y, { children: [(0, $.jsx)(Lt, {}), (0, $.jsx)(It, {})] }),
              }),
            ],
          })
        : null),
    ...
    ? ((j = w
        ? (0, $.jsxs)(X, {
            children: [
              ...
              (0, $.jsx)(X.Content, {
                children: (0, $.jsxs)(Y, {
                  children: [x ? (0, $.jsx)(At, {}) : null, C ? (0, $.jsx)(Ut, {}) : null],
                }),
              }),
            ],
          })
  ...
  let N;
  return (
    e[34] !== k || e[35] !== A || e[36] !== j || e[37] !== M || e[38] !== D || e[39] !== O
...
function jt(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, $.jsx)(z, { color: `secondary`, onClick: o, size: `toolbar`, children: s })),
      (t[4] = o),
      (t[5] = c));
  let l;
  return (
...
function Pt({ hostId: e }) {
  ...
  return {
    extensions: Ft({ gateEnabled: a.extensionsEnabled, inAppBrowser: t, isStatsigLoading: n }),
    passwordManager: Ft({ gateEnabled: r || i, inAppBrowser: t, isStatsigLoading: n }),
    siteSettings: Ft({ gateEnabled: a.siteSettingsEnabled, inAppBrowser: t, isStatsigLoading: n }),
  };
}
...
function It() {
  ...
  let o = a,
    s;
  e[2] === r ? (s = e[3]) : ((s = o.find((e) => e.id === r) ?? o[0]), (e[2] = r), (e[3] = s));
  let c = s,
    l,
    u;
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
...
function Ut() {
  ...
  e[19] === A
    ? (j = e[20])
    : ((j = (0, $.jsx)(`span`, { className: `truncate`, children: A })), (e[19] = A), (e[20] = j));
  let N;
  e[21] !== k || e[22] !== j
    ? ((N = (0, $.jsx)(K, { className: `w-[152px]`, disabled: k, children: j })),
      (e[21] = k),
      (e[22] = j),
      (e[23] = N))
    : (N = e[23]);
...
function Wt() {
  ...
  e[11] === v
    ? (S = e[12])
    : ((S = (0, $.jsx)(`span`, { className: `truncate`, children: v })), (e[11] = v), (e[12] = S));
  let w;
  e[13] !== _ || e[14] !== S
    ? ((w = (0, $.jsx)(K, { className: `w-[152px]`, disabled: _, children: S })),
      (e[13] = _),
      (e[14] = S),
      (e[15] = w))
    : (w = e[15]);
...
function qt(e) {
  let t = (0, Z.c)(37),
    ...
    m;
  t[0] !== n || t[1] !== c || t[2] !== a
    ? ((m = c == null ? [] : Qt(c, a, n)), (t[0] = n), (t[1] = c), (t[2] = a), (t[3] = m))
    : (m = t[3]);
  let h = m,
...
function Yt(e) {
  ...
  t[7] === f
    ...
    : ((m = (e) => {
      ...
      (t[8] = m));
  let h;
  t[9] !== r || t[10] !== s ? ((h = ft(s, r)), (t[9] = r), (t[10] = s), (t[11] = h)) : (h = t[11]);
  let g;
  t[12] !== r || t[13] !== s
  ...
  let _;
  t[15] !== h || t[16] !== g
    ? ((_ = (0, $.jsx)(B, { children: (0, $.jsx)(me, { title: h, subtitle: g }) })),
      (t[15] = h),
      (t[16] = g),
      (t[17] = _))
    : (_ = t[17]);
  ...
  return (
    t[48] !== o || t[49] !== j || t[50] !== p
      ? ((M = (0, $.jsx)(he, { open: o, onOpenChange: p, size: `compact`, children: j })),
        (t[48] = o),
        (t[49] = j),
        (t[50] = p),
        (t[51] = M))
...
function Xt(e) {
  ...
  let w;
  t[21] !== S || t[22] !== C
    ? ((w = (0, $.jsx)(B, { children: (0, $.jsx)(me, { title: S, subtitle: C }) })),
      (t[21] = S),
      (t[22] = C),
      (t[23] = w))
    : (w = t[23]);
  ...
  t[26] === d
    ? (D = t[27])
    : ((D = (0, $.jsx)(z, { color: `ghost`, disabled: d, onClick: E, children: T })),
      (t[26] = d),
      (t[27] = D));
  let O;
  t[28] === p
  ...
  let A;
  t[31] !== d || t[32] !== O
    ? ((A = (0, $.jsx)(z, { color: `danger`, loading: d, onClick: O, children: k })),
      (t[31] = d),
      (t[32] = O),
      (t[33] = A))
    : (A = t[33]);
  ...
  let M;
  t[37] !== j || t[38] !== w
    ? ((M = (0, $.jsxs)(ge, { children: [w, j] })), (t[37] = j), (t[38] = w), (t[39] = M))
    : (M = t[39]);
  let N;
  t[40] !== M || t[41] !== h
    ? ((N = (0, $.jsx)(he, { open: h, onOpenChange: g, size: `compact`, children: M })),
      (t[40] = M),
      (t[41] = h),
      (t[42] = N))
    : (N = t[42]);
...
function Zt(e) {
  ...
  if (o.length === 0) {
    let e;
    t[0] !== i || t[1] !== s ? ((e = gt(s, i)), (t[0] = i), (t[1] = s), (t[2] = e)) : (e = t[2]);
    let n;
    return (
      t[3] === e
        ? (n = t[4])
