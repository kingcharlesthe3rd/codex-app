...
import { f as l, m as u } from "./vscode-api.js";
import {
  B as d,
  Cr as f,
  E as p,
...
import { Si as k, ls as A } from "./app-server-manager-signals.js";
import { c as j, n as M, o as N } from "./lib-1.js";
import { t as P } from "./clsx.js";
import { t as F } from "./button.js";
import { a as I, i as L } from "./setting-storage.js";
import { t as ee } from "./spinner.js";
import { t as R } from "./check-md.js";
import { t as te } from "./chevron-right.js";
import { t as ne } from "./tooltip.js";
import { a as re } from "./statsig-DoZ-0xit.js";
import { c as ie } from "./config-queries-BHYT-TjG.js";
import { r as z } from "./toast-signal.js";
import { a as ae, m as oe, n as se, p as ce } from "./chunk-8.js";
import { t as le } from "./connector-logo.js";
import { t as ue } from "./route-scope.js";
import { O as de } from "./mention-item.js";
import { t as fe } from "./apps.js";
import { t as pe } from "./chats.js";
import { a as me, n as he, r as ge } from "./use-is-plugins-enabled.js";
import { c as _e, m as ve, y as ye } from "./use-plugins.js";
import { t as be } from "./with-window.js";
import { n as xe, r as Se } from "./use-resolved-theme-variant.js";
import { o as Ce } from "./plugin-detail-route-utils.js";
import { n as we, t as Te } from "./use-plugin-install-flow.js";
import { t as Ee } from "./settings.cog.js";
import { a as B, d as De, i as V, l as H, n as Oe, r as ke, u as Ae } from "./dialog-layout.js";
import { n as je } from "./use-start-new-conversation.js";
import { n as Me, t as Ne } from "./plugin-prefill-prompt.js";
import { l as Pe } from "./bundled-plugin-auto-install-preference.js";
import { r as U, t as W } from "./dropdown.js";
import { t as Fe } from "./trash.js";
import { t as Ie } from "./chevron.js";
import { t as Le } from "./plus.js";
import { t as Re } from "./settings-host-context.js";
import { s as ze } from "./check-plugin-availability.js";
import { t as Be } from "./toggle.js";
import { t as Ve } from "./shield-exclamation.js";
...
import { n as et, r as tt } from "./plugins-availability.js";
import { n as K } from "./settings-row.js";
import { n as q, t as J } from "./settings-group.js";
import { t as nt } from "./settings-empty-state.js";
import { t as rt } from "./use-home-directory.js";
import { t as it } from "./browser-use.js";
import { n as at, t as ot } from "./browser-use-elevated-risk-learn-more-url-Cd-YYd6a.js";
import { t as st } from "./plugin-uninstall-dialog.js";
var ct = `browser_use_full_cdp_access`,
  Y = r(),
  X = e(t(), 1),
  Z = n(),
  lt = {
...
function ut() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(pt, { kind: `extensions` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function dt() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(pt, { kind: `passwordManager` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function ft() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(pt, { kind: `siteSettings` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function pt(e) {
  let t = (0, Y.c)(3),
    { kind: n } = e,
    r;
  return (t[1] === n ? (r = t[2]) : ((r = (0, Z.jsx)(mt, { kind: n })), (t[1] = n), (t[2] = r)), r);
}
function mt(e) {
  let t = (0, Y.c)(20),
    { kind: n } = e,
  ...
  t[3] === c
    ...
    : ((l = async (e) => {
      ...
      (t[3] = c),
      (t[4] = l));
  let d = (0, X.useEffectEvent)(l),
    f;
  t[5] !== n || t[6] !== d || t[7] !== a.partition || t[8] !== a.url || t[9] !== s
    ? ((f = () => {
        let e = i.current;
        if (e == null) return;
        let t = window.electronBridge?.sendMessageFromView,
          ...
          f = () => {
            !o ||
              ...
              t({ mountId: r, type: `browser-settings-webview-unmounted` }).catch((e) => {
                u.warning(`Failed to unmount browser settings webview`, {
                  safe: { kind: n },
                  sensitive: { error: e },
                });
              }));
        ...
        return (
          (async () => {
            try {
              ...
              let t = e;
              u.error(`Failed to mount browser settings webview`, {
                safe: { kind: n },
                sensitive: { error: t },
              });
            }
      ...
      ? ((g = (0, Z.jsxs)(`div`, {
          ...
          children: [
            (0, Z.jsxs)(`div`, {
              ...
              children: [
                (0, Z.jsx)(`div`, { "aria-hidden": !0, className: `draggable absolute inset-0` }),
                (0, Z.jsx)(ht, {}),
              ],
            }),
            (0, Z.jsx)(`div`, {
...
function ht() {
  ...
  e[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Z.jsx)(te, { className: `icon-xs text-token-text-secondary` })), (e[7] = s))
    : (s = e[7]);
  let c;
  e[8] === n
    ? (c = e[9])
...
function vt() {
  let e = (0, Y.c)(3),
    { selectedHostId: t } = Re(),
    n = A(t).kind === `local`;
  if (!f.isInternal(ye()) || !n) return null;
  let r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(J.Header, {
        title: (0, Z.jsx)(N, {
      ...
      : ((i = (0, Z.jsx)(be, {
          ...
          children: (0, Z.jsxs)(J, {
            children: [
              r,
              (0, Z.jsx)(J.Content, {
                children: (0, Z.jsx)(q, { children: (0, Z.jsx)(yt, { hostId: t }) }),
              }),
            ],
          }),
        })),
...
function yt(e) {
  let t = (0, Y.c)(23),
    { hostId: n } = e,
    r = j(),
    { data: a, isLoading: o } = s(Qe),
    c;
  t[0] === n ? (c = t[1]) : ((c = { hostId: n }), (t[0] = n), (t[1] = c));
  let { data: l, isPending: u } = i(ie, c),
    d;
  t[2] === n ? (d = t[3]) : ((d = { hostId: n }), (t[2] = n), (t[3] = d));
  let f = $e(d),
    p = l?.requirements?.featureRequirements?.[ct] === !1,
    m = o || u,
    h = a?.fullCdpAccessEnabled === !0 && !m && !p,
    g;
    ...
    ? ((g = (0, Z.jsxs)(`div`, {
        ...
        children: [
          (0, Z.jsxs)(`span`, {
            ...
            children: [
              (0, Z.jsx)(Ve, { className: `icon-xs shrink-0` }),
              (0, Z.jsx)(N, {
  ...
  t[9] === v
    ? (y = t[10])
    : ((y = (0, Z.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [_, v] })),
      (t[9] = v),
      (t[10] = y));
  let b;
  t[11] === r
  ...
  t[13] === f
    ...
    : ((S = (e) => {
      ...
      (t[14] = S));
  let C;
  t[15] !== h || t[16] !== b || t[17] !== x || t[18] !== S
    ? ((C = (0, Z.jsx)(Be, { ariaLabel: b, checked: h, disabled: x, onChange: S })),
      (t[15] = h),
      (t[16] = b),
      (t[17] = x),
      (t[18] = S),
  ...
  return (
    t[20] !== C || t[21] !== y
      ? ((w = (0, Z.jsx)(K, { label: g, description: y, control: C })),
        (t[20] = C),
        (t[21] = y),
        (t[22] = w))
      : (w = t[22]),
...
function At(e, t) {
  let n = new Set();
  for (let r of t) {
    for (let t of Pt(e, r, `allowed`)) n.add(t);
    for (let t of Pt(e, r, `denied`)) n.add(t);
  }
  return [...n]
    ...
    .map((t) => ({
      origin: t,
      values: {
        origin: Nt(e, `origin`, t),
        download: Nt(e, `download`, t),
        upload: Nt(e, `upload`, t),
        fullCdp: Nt(e, `fullCdp`, t),
      },
    }));
}
function jt(e, t) {
...
function Mt({ nextValues: e, origin: t, resources: n, values: r }) {
  return n.flatMap((n) => {
    let i = r[n],
      a = e[n];
    if (a === i) return [];
...
function Nt(e, t, n) {
  return Pt(e, t, `denied`).includes(n)
    ? `denied`
    : Pt(e, t, `allowed`).includes(n)
      ? `allowed`
      : `default`;
}
function Pt(e, t, n) {
...
var Ft = [`allowed`, `denied`],
  It = [`default`, `allowed`, `denied`],
  Lt = { origin: `origin`, download: `download`, upload: `upload`, fullCdp: `fullCdp` },
  Rt = { download: `default`, upload: `default`, fullCdp: `default` },
  zt = { origin: `default`, ...Rt };
function Bt() {
  let e = (0, Y.c)(7),
    { selectedHostId: t } = Re(),
    { data: n, isError: r, isLoading: a } = s(Qe),
    o;
  e[0] === t ? (o = e[1]) : ((o = { hostId: t }), (e[0] = t), (e[1] = o));
  let { data: c, isError: l, isPending: u } = i(ie, o),
    d = n?.fullCdpAccessEnabled === !0,
    f = r || (d && l),
    p = a || (d && u),
    m = d && !l && !u && c?.requirements?.featureRequirements?.browser_use_full_cdp_access !== !1,
    h;
  return (
    e[2] !== f || e[3] !== m || e[4] !== p || e[5] !== n
      ? ((h = (0, Z.jsx)(Vt, {
          originsConfig: n,
          isError: f,
...
function Vt(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = () => {
      ...
      (h = (0, Z.jsx)(Le, { className: `icon-xs` })),
      (g = (0, Z.jsx)(N, {
  ...
  t[11] === _
    ? (b = t[12])
    : ((b = (0, Z.jsx)(J.Header, { actions: _, title: v, subtitle: y })), (t[11] = _), (t[12] = b));
  let x;
          ...
          children: n
            ...
            : i || f == null
              ...
              : f.length === 0
                ...
                : (0, Z.jsx)(Ht, { rows: f, onCustomize: l, visibleResources: d }),
        }),
      })),
      (t[13] = n),
      (t[14] = i),
  ...
  let S;
  t[18] !== o || t[19] !== d
    ? ((S = (0, Z.jsx)(Jt, { open: o, visibleResources: d, onOpenChange: s })),
      (t[18] = o),
      (t[19] = d),
      (t[20] = S))
    : (S = t[20]);
  ...
  return (
    t[24] !== x || t[25] !== S || t[26] !== C || t[27] !== b
      ? ((w = (0, Z.jsxs)(J, { className: `gap-2`, children: [b, x, S, C] })),
        (t[24] = x),
        (t[25] = S),
        (t[26] = C),
        (t[27] = b),
...
function Ut(e) {
  let t = (0, Y.c)(25),
    ...
    a;
  t[0] !== r || t[1] !== i ? ((a = jt(r, i)), (t[0] = r), (t[1] = i), (t[2] = a)) : (a = t[2]);
  let o = a,
    s;
  t[3] === r.origin
    ? (s = t[4])
  ...
  t[15] !== n || t[16] !== r || t[17] !== i
    ? ((d = (0, Z.jsx)(Wt, { row: r, visibleResources: i, onCustomize: n })),
      (t[15] = n),
      (t[16] = r),
      (t[17] = i),
      (t[18] = d))
    : (d = t[18]);
  let f;
  t[19] === r ? (f = t[20]) : ((f = (0, Z.jsx)(Kt, { row: r })), (t[19] = r), (t[20] = f));
  let p;
  return (
...
function Wt({ onCustomize: e, row: t, visibleResources: n }) {
  let r = o(c),
    i = j(),
    [a, s] = (0, X.useState)(!1),
    l = qe(),
  ...
  return (0, Z.jsx)(W, {
    ...
    triggerButton: (0, Z.jsxs)(G, {
      ...
      children: [
        (0, Z.jsx)(`span`, {
          ...
          children:
            u === `custom`
              ? (0, Z.jsx)(Ee, { className: `icon-xs text-token-text-secondary` })
              : (0, Z.jsx)(Q, { value: u }),
        }),
        (0, Z.jsx)(`span`, { className: `truncate`, children: Xt(u) }),
      ],
    }),
    children: (0, Z.jsxs)(`div`, {
      ...
      children: [
          ...
          (0, Z.jsx)(
            U.Item,
            {
              ...
              children: (0, Z.jsxs)(`div`, {
                ...
                children: [
                  (0, Z.jsx)(Q, { value: e }),
                  (0, Z.jsx)(`span`, { className: `truncate`, children: Xt(e) }),
                ],
              }),
            },
            e,
        ...
        (0, Z.jsx)(U.Separator, {}),
        (0, Z.jsx)(U.Item, {
          RightIcon: u === `custom` ? R : void 0,
          onSelect: e,
          children: (0, Z.jsxs)(`div`, {
            className: `flex min-w-0 items-center gap-2`,
            children: [
              (0, Z.jsx)(Ee, { className: `icon-xs shrink-0 text-token-text-secondary` }),
              (0, Z.jsx)(N, {
...
function Q(e) {
  let t = (0, Y.c)(6),
    ...
    o;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((o = P(`size-2 shrink-0 rounded-full`, r, i, a)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a),
      (t[3] = o))
...
function Gt(e) {
  let t = (0, Y.c)(21),
    ...
    s = `${r} ${o}`,
    c;
  t[0] === a ? (c = t[1]) : ((c = (0, Z.jsx)(Q, { value: a })), (t[0] = a), (t[1] = c));
  let l;
  t[2] === a ? (l = t[3]) : ((l = Zt(a)), (t[2] = a), (t[3] = l));
  let u;
  t[4] !== l || t[5] !== o
        ...
        (0, Z.jsx)(
          U.Item,
          {
            ...
            children: (0, Z.jsxs)(`div`, {
              ...
              children: [
                (0, Z.jsx)(Q, { value: e }),
                (0, Z.jsx)(`span`, { className: `truncate`, children: Zt(e) }),
              ],
            }),
          },
          e,
  ...
  return (0, Z.jsxs)(Z.Fragment, {
    children: [
      (0, Z.jsx)(F, {
        ...
        size: `icon`,
        children: (0, Z.jsx)(Fe, { className: `icon-2xs` }),
      }),
      (0, Z.jsx)(H, {
        open: r,
        onOpenChange: i,
...
function qt({ onOpenChange: e, row: t, visibleResources: n }) {
  let r = o(c),
    [i, a] = (0, X.useState)(t.values),
    [s, l] = (0, X.useState)(!1),
    u = qe(),
    d = async () => {
      if (!s) {
        ...
        try {
          (await u.mutateAsync(
            Mt({ nextValues: i, origin: t.origin, resources: n, values: t.values }),
          ),
            e(!1));
        } catch {
          r.get(z).danger(Qt());
          ...
          children: (0, Z.jsx)(q, {
            ...
            children: n.map((e) => {
              ...
              return (0, Z.jsx)(
                K,
                {
                  label: (0, Z.jsx)(`span`, { id: t, children: Yt(e) }),
                  control: (0, Z.jsx)(Gt, {
                    disabled: s,
                    labelId: t,
                    value: i[e],
...
function Jt({ onOpenChange: e, open: t, visibleResources: n }) {
  let r = o(c),
    i = j(),
    [a, s] = (0, X.useState)(``),
    [l, u] = (0, X.useState)(`allowed`),
    [d, f] = (0, X.useState)(Rt),
    [p, m] = (0, X.useState)(!1),
    [h, g] = (0, X.useState)(!1),
    _ = qe(),
    ...
    x = async () => {
      ...
      if (!(t.length === 0 || h)) {
        ...
        try {
          (await _.mutateAsync(
            Mt({ nextValues: { ...d, origin: l }, origin: t, resources: n, values: zt }),
          ),
            b(),
            e(!1));
        } catch {
              ...
              children: [
                ...
                (0, Z.jsx)(W, {
                  ...
                  triggerButton: (0, Z.jsxs)(G, {
                    ...
                    children: [
                      (0, Z.jsx)(Q, { value: l }),
                      (0, Z.jsx)(`span`, { id: y, className: `truncate`, children: Xt(l) }),
                    ],
                  }),
...
function $t(e) {
  ...
  let { pendingPluginId: x, setPluginEnabled: S } = tt(b),
    C;
  t[7] === o ? (C = t[8]) : ((C = { hostId: o }), (t[7] = o), (t[8] = C));
  let { pendingUninstallPluginId: w, uninstallPlugin: T } = et(C),
  ...
  if (A === 0) {
    ...
    return (
      t[12] === n
        ? (e = t[13])
        : ((e = (0, Z.jsx)(q, { children: (0, Z.jsx)(nt, { children: n }) })),
          (t[12] = n),
          (t[13] = e)),
      e
    );
          ...
          (0, Z.jsx)(
            rn,
            {
              ...
              onToggleInstalledPluginEnabled: (e, t) => {
                S({ pluginId: e.plugin.id, pluginDisplayName: Pe(e), enabled: t });
              },
              onUninstallPlugin: D,
            },
            e.plugin.plugin.id,
  ...
  let M;
  t[29] === l ? (M = t[30]) : ((M = l.map(en)), (t[29] = l), (t[30] = M));
  let N;
  t[31] !== j || t[32] !== M
    ? ((N = (0, Z.jsxs)(q, { className: `overflow-hidden`, children: [j, M] })),
      (t[31] = j),
      (t[32] = M),
      (t[33] = N))
    : (N = t[33]);
...
function tn(e) {
  ...
  t[0] === n.icon
    ? (i = t[1])
    : ((i = n.icon ?? (0, Z.jsx)(fe, { className: `icon-md text-token-text-secondary` })),
      (t[0] = n.icon),
      (t[1] = i));
  let a;
  t[2] === i
  ...
  t[16] === u
    ? (d = t[17])
    : ((d = (0, Z.jsx)(Be, { ariaLabel: u, checked: !1, disabled: !0, onChange: nn })),
      (t[16] = u),
      (t[17] = d));
  let f;
  return (
  ...
  if (
    ...
    let y =
        ...
        (0, Z.jsx)(le, {
          ...
          fallback: (0, Z.jsx)(fe, { className: `icon-md text-token-text-secondary` }),
        }),
      b;
    t[18] !== v || t[19] !== y
...
function an(e, t, n) {
  ...
  return (
    ...
    r.find((e) => ze(n, e.marketplacePath)) ??
    null
  );
}
var on = `browser-browsing-data-options`,
  sn = [`cookies`, `siteData`, `cache`],
  cn = a(ue, null);
function ln() {
  let e = (0, Y.c)(14),
    t = o(ue),
  ...
  if (r != null) {
    ...
    if (!i.enabled && !a) {
      ...
      return (
        e[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, Z.jsx)(ae, { to: `/settings/browser-use`, replace: !0 })), (e[5] = t))
          : (t = e[5]),
        t
      );
    }
    n !== r && t.set(cn, r);
    let o;
    return (e[6] === r ? (o = e[7]) : ((o = vn(r)), (e[6] = r), (e[7] = o)), o);
  }
  n != null && t.set(cn, null);
  let d;
...
function dn() {
  ...
  e[1] !== i || e[2] !== r.availablePlugins
    ? ((a = an(r.availablePlugins, D, i)), (e[1] = i), (e[2] = r.availablePlugins), (e[3] = a))
    : (a = e[3]);
  let o = a,
    s;
  ...
  let g = ge(h),
    ...
    y = f.siteSettings.enabled,
    b = f.extensions.enabled,
    x = m.available || g.available,
    S = y || x,
    C;
  e[14] !== o || e[15] !== m
    ? ((C =
        o == null && Mn(m)
          ? [
              {
                description: (0, Z.jsx)(N, { ...de.restrictedAvailabilityDescription }),
                icon: (0, Z.jsx)(it, { className: `h-full w-full text-token-foreground` }),
                id: `browser-use-unavailable`,
                title: (0, Z.jsx)(N, { ...de.label }),
              },
            ]
          : []),
      (e[14] = o),
  ...
  let w = C,
    T;
  e[17] !== c || e[18] !== r || e[19] !== t || e[20] !== w
    ? ((T = (0, Z.jsx)(J, {
        children: (0, Z.jsx)(J.Content, {
          children: (0, Z.jsx)(jn, {
            browserUsePlugins: c,
            pluginsQuery: r,
            selectedHostId: t,
            unavailableBrowserUsePlugins: w,
          }),
        }),
      })),
      (e[17] = c),
    ...
    : ((E = v
        ? (0, Z.jsxs)(J, {
            children: [
              ...
              (0, Z.jsx)(J.Content, { children: (0, Z.jsx)(q, { children: (0, Z.jsx)(pn, {}) }) }),
            ],
          })
        : null),
      (e[22] = v),
    ...
    : ((O = b
        ? (0, Z.jsxs)(J, {
            children: [
              ...
              (0, Z.jsx)(J.Content, { children: (0, Z.jsx)(q, { children: (0, Z.jsx)(mn, {}) }) }),
            ],
          })
        : null),
      (e[24] = b),
    ...
    : ((k = _
        ? (0, Z.jsxs)(J, {
            children: [
              ...
              (0, Z.jsx)(J.Content, {
                children: (0, Z.jsxs)(q, { children: [(0, Z.jsx)(Cn, {}), (0, Z.jsx)(Sn, {})] }),
              }),
            ],
          })
        : null),
    ...
    ? ((A = S
        ? (0, Z.jsxs)(J, {
            children: [
              ...
              (0, Z.jsx)(J.Content, {
                children: (0, Z.jsxs)(q, {
                  children: [y ? (0, Z.jsx)(hn, {}) : null, x ? (0, Z.jsx)(kn, {}) : null],
                }),
              }),
            ],
          })
  ...
  e[32] === x
    ...
    : ((j = x
        ? (0, Z.jsxs)(Z.Fragment, {
            children: [(0, Z.jsx)(fn, { surface: `inAppBrowser` }), (0, Z.jsx)(vt, {})],
          })
        : null),
      (e[32] = x),
      (e[33] = j));
  let M;
  return (
    e[34] !== O || e[35] !== k || e[36] !== A || e[37] !== j || e[38] !== T || e[39] !== E
      ? ((M = (0, Z.jsxs)(Z.Fragment, { children: [T, E, O, k, A, j] })),
        (e[34] = O),
        (e[35] = k),
        (e[36] = A),
        (e[37] = j),
...
function fn(e) {
  ...
  return (
    t[8] === s
      ? (c = t[9])
      : ((c = (0, Z.jsxs)(Z.Fragment, {
          children: [
            (0, Z.jsx)(be, { electron: !0, children: f.isInternal(ye()) ? (0, Z.jsx)(Bt, {}) : s }),
            (0, Z.jsx)(be, { browser: !0, chromeExtension: !0, extension: !0, children: s }),
          ],
        })),
        (t[8] = s),
        (t[9] = c)),
...
function gn(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, Z.jsx)(F, { color: `secondary`, onClick: o, size: `toolbar`, children: s })),
      (t[4] = o),
      (t[5] = c));
  let l;
  return (
    t[6] !== n || t[7] !== r || t[8] !== c
      ? ((l = (0, Z.jsx)(K, { label: r, description: n, control: c })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = c),
        (t[9] = l))
...
function bn() {
  let e = (0, Y.c)(13),
    ...
    a = i(k, x),
    o = t.data === !0 && n.data === !0,
    s = t.isLoading || n.isLoading,
    c;
  e[0] !== o || e[1] !== s
    ? ((c = { enabled: o, isLoading: s }), (e[0] = o), (e[1] = s), (e[2] = c))
    : (c = e[2]);
  let l = t.data === !0 && r.data === !0,
    u = t.isLoading || r.isLoading,
    f;
  e[3] !== l || e[4] !== u
    ? ((f = { enabled: l, isLoading: u }), (e[3] = l), (e[4] = u), (e[5] = f))
    : (f = e[5]);
  let p = t.data === !0 && a.data === !0,
    m = t.isLoading || a.isLoading,
    g;
  e[6] !== p || e[7] !== m
    ? ((g = { enabled: p, isLoading: m }), (e[6] = p), (e[7] = m), (e[8] = g))
    : (g = e[8]);
  let _;
  return (
    e[9] !== c || e[10] !== f || e[11] !== g
      ? ((_ = { extensions: c, passwordManager: f, siteSettings: g }),
        (e[9] = c),
        (e[10] = f),
        (e[11] = g),
        (e[12] = _))
...
function xn({ featureEnabled: e, inAppBrowser: t, isFeatureLoading: n }) {
  return { enabled: t.enabled && !t.isLoading && e, isLoading: t.isLoading || n };
}
function Sn() {
  let e = (0, Y.c)(14),
    t = o(c),
    n = I(p.annotationScreenshotsMode),
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = {
        id: `always`,
    ...
    ? ((m = (0, Z.jsx)(`div`, {
        ...
        children: a.map((e) => {
          ...
          return (0, Z.jsx)(
            ...
            {
              allowWrap: !0,
              RightIcon: r ? R : void 0,
              onSelect: () => {
                L(t, p.annotationScreenshotsMode, e.id);
              },
  ...
  let e = o(c),
    ...
    l = async (t, n) => {
      if (!s) {
        i(t);
        try {
          (await a.mutateAsync(n), e.get(z).success(Dn(t)));
        } catch {
          e.get(z).danger(On(t));
        } finally {
          i(null);
...
function wn(e) {
  let t = (0, Y.c)(17),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = Tn(a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] === o
    ? (s = t[3])
    : ((s = (0, Z.jsx)(`div`, {
  ...
  t[4] !== a || t[5] !== i
    ...
    : (c = t[6]);
  let l;
  t[7] === a ? (l = t[8]) : ((l = En(a)), (t[7] = a), (t[8] = l));
  let u;
...
function kn() {
  let e = (0, Y.c)(35),
    t = o(c),
    { data: n, isLoading: r } = s(Qe),
    i = n?.approvalMode,
    a = Ge(),
    { value: u } = re(ot),
    d;
  e[0] === u ? (d = e[1]) : ((d = at(u)), (e[0] = u), (e[1] = d));
  let f = d,
    p;
  e[2] === f
    ? (p = e[3])
    : ((p = (e) => {
        (e.preventDefault(), l.dispatchMessage(`open-in-browser`, { url: f }));
      }),
      (e[2] = f),
      (e[3] = p));
  let m = p,
  ...
  e[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = [
        _,
        {
          ...
          elevatedRiskDisclaimer: (0, Z.jsx)(N, {
  ...
  let j;
  e[21] !== O || e[22] !== A
    ? ((j = (0, Z.jsx)(G, { className: `w-[152px]`, disabled: O, children: A })),
      (e[21] = O),
      (e[22] = A),
      (e[23] = j))
    : (j = e[23]);
  ...
  return (
    e[32] !== P || e[33] !== E
      ? ((F = (0, Z.jsx)(K, { label: T, description: E, control: P })),
        (e[32] = P),
        (e[33] = E),
        (e[34] = F))
      : (F = e[34]),
...
function An() {
  ...
  let C;
  e[13] !== b || e[14] !== S
    ? ((C = (0, Z.jsx)(G, { className: `w-[152px]`, disabled: b, children: S })),
      (e[13] = b),
      (e[14] = S),
      (e[15] = C))
    : (C = e[15]);
    ...
    (t[5] === o
      ...
      : ((e = (e) => ({
          ...
          onTryInChat: () => {
            o({
              prefillPrompt: Ne({
                defaultPrompt: Me(e.plugin.interface?.defaultPrompt),
                pluginDisplayName: Pe(e),
                pluginId: e.plugin.id,
              }),
              startInSidebar: !0,
...
function $(e) {
  let t = (0, Y.c)(37),
    ...
    u = o(c),
    { data: d, isLoading: f } = s(Qe),
    [p, m] = (0, X.useState)(!1),
    h = Je(),
    g = Xe(),
    _;
  t[0] !== n || t[1] !== d || t[2] !== a
    ? ((_ = d == null ? [] : Ln(d, a, n)), (t[0] = n), (t[1] = d), (t[2] = a), (t[3] = _))
    : (_ = t[3]);
  let v = _,
  ...
  let C;
  t[12] !== n || t[13] !== a
    ? ((C = bt(a, n)), (t[12] = n), (t[13] = a), (t[14] = C))
    : (C = t[14]);
  let w;
  t[15] !== n || t[16] !== a || t[17] !== l
    ? ((w = xt(a, n, l)), (t[15] = n), (t[16] = a), (t[17] = l), (t[18] = w))
    : (w = t[18]);
  let T;
  t[19] !== C || t[20] !== w
    ? ((T = (0, Z.jsx)(J.Header, { actions: S, title: C, subtitle: w })),
      (t[19] = C),
      (t[20] = w),
      (t[21] = T))
    : (T = t[21]);
    ...
    ? ((E = (0, Z.jsx)(J.Content, {
        children: (0, Z.jsx)(q, {
          children: f
            ...
            : (0, Z.jsx)(Fn, { kind: n, origins: v, resource: a }),
        }),
      })),
      (t[22] = f),
      (t[23] = n),
...
function Nn(e) {
  let t = (0, Y.c)(4),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(Le, { className: `icon-xs` })),
      (i = (0, Z.jsx)(N, {
        id: `settings.browserUse.domains.add`,
        defaultMessage: `Add`,
        description: `Button label to add a browser use domain`,
...
function Pn(e) {
  ...
  t[7] === f
    ...
    : ((m = (e) => {
      ...
      (t[8] = m));
  let h;
  t[9] !== r || t[10] !== s ? ((h = wt(s, r)), (t[9] = r), (t[10] = s), (t[11] = h)) : (h = t[11]);
  let g;
  t[12] !== r || t[13] !== s
    ? ((g = Tt(s, r)), (t[12] = r), (t[13] = s), (t[14] = g))
    : (g = t[14]);
  let _;
  t[15] !== h || t[16] !== g
    ? ((_ = (0, Z.jsx)(B, { children: (0, Z.jsx)(V, { title: h, subtitle: g }) })),
      (t[15] = h),
      (t[16] = g),
      (t[17] = _))
    : (_ = t[17]);
  ...
  let O;
  t[40] !== w || t[41] !== D
    ? ((O = (0, Z.jsx)(B, { children: (0, Z.jsxs)(ke, { children: [w, D] }) })),
      (t[40] = w),
      (t[41] = D),
      (t[42] = O))
    : (O = t[42]);
  ...
  t[43] !== x || t[44] !== O || t[45] !== m || t[46] !== _
    ? ((k = (0, Z.jsxs)(Oe, { as: `form`, onSubmit: m, children: [_, x, O] })),
      (t[43] = x),
      (t[44] = O),
      (t[45] = m),
      (t[46] = _),
  ...
  return (
    t[48] !== o || t[49] !== k || t[50] !== p
      ? ((A = (0, Z.jsx)(H, { open: o, onOpenChange: p, size: `compact`, children: k })),
        (t[48] = o),
        (t[49] = k),
        (t[50] = p),
        (t[51] = A))
...
function Fn(e) {
  ...
  t[14] !== n || t[15] !== i || t[16] !== y
    ? ((b = Et(i, n, y)), (t[14] = n), (t[15] = i), (t[16] = y), (t[17] = b))
    : (b = t[17]);
  let x;
  t[18] !== n || t[19] !== i
    ? ((x = Dt(i, n)), (t[18] = n), (t[19] = i), (t[20] = x))
    : (x = t[20]);
  let S;
  t[21] !== b || t[22] !== x
    ? ((S = (0, Z.jsx)(B, { children: (0, Z.jsx)(V, { title: b, subtitle: x }) })),
      (t[21] = b),
      (t[22] = x),
      (t[23] = S))
    : (S = t[23]);
  ...
  t[26] === p
    ? (T = t[27])
    : ((T = (0, Z.jsx)(F, { color: `ghost`, disabled: p, onClick: w, children: C })),
      (t[26] = p),
      (t[27] = T));
  let E;
  t[28] === h
  ...
  let O;
  t[31] !== p || t[32] !== E
    ? ((O = (0, Z.jsx)(F, { color: `danger`, loading: p, onClick: E, children: D })),
      (t[31] = p),
      (t[32] = E),
      (t[33] = O))
    : (O = t[33]);
  let k;
  t[34] !== T || t[35] !== O
    ? ((k = (0, Z.jsx)(B, { children: (0, Z.jsxs)(ke, { children: [T, O] }) })),
      (t[34] = T),
      (t[35] = O),
      (t[36] = k))
    : (k = t[36]);
  let A;
  t[37] !== k || t[38] !== S
    ? ((A = (0, Z.jsxs)(Oe, { children: [S, k] })), (t[37] = k), (t[38] = S), (t[39] = A))
    : (A = t[39]);
  let M;
  t[40] !== A || t[41] !== _
    ? ((M = (0, Z.jsx)(H, { open: _, onOpenChange: v, size: `compact`, children: A })),
      (t[40] = A),
      (t[41] = _),
      (t[42] = M))
    : (M = t[42]);
  ...
  return (
    t[43] !== M || t[44] !== g
      ? ((P = (0, Z.jsxs)(Z.Fragment, { children: [g, M] })), (t[43] = M), (t[44] = g), (t[45] = P))
      : (P = t[45]),
    P
  );
}
function In(e) {
  ...
  if (o.length === 0) {
    let e;
    t[0] !== i || t[1] !== s ? ((e = Ot(s, i)), (t[0] = i), (t[1] = s), (t[2] = e)) : (e = t[2]);
    let n;
    return (
      t[3] === e
        ? (n = t[4])
