...
import { dt as bt, lt as xt } from "./app-initial~app-main~automations-page.js";
import {
  d as St,
  f as Ct,
  p as wt,
...
import { n as Kn, t as qn } from "./plugin-uninstall-dialog-m.js";
function Jn(e) {
  let t = (0, Yn.c)(6),
    { service: n } = e,
    r = p(H);
  if (!He(`1834314516`)) return null;
  let i = n ?? je.browserProfileImport;
  ...
  return (
    t[4] === a
      ? (s = t[5])
      : ((s = (0, Xn.jsx)(R, { color: `secondary`, size: `toolbar`, onClick: a, children: o })),
        (t[4] = a),
        (t[5] = s)),
    s
  );
...
function ar(e) {
  ...
  let y = v,
    b,
    x;
  t[3] !== n || t[4] !== i.search || t[5] !== s?.params
    ? ((b = hr({ kind: n, search: i.search, siteSettingsRoutePath: s?.params[`*`] ?? null })),
      (x = _r(n, b)),
      (t[3] = n),
      (t[4] = i.search),
      (t[5] = s?.params),
    ...
    : ((b = t[6]), (x = t[7]));
  let S = x,
    C = f?.initialUrl === b ? f : null,
    w = C?.url ?? b,
    T = m?.url === w ? m.title : null,
    E;
  t[8] !== w || t[9] !== n ? ((E = Ar(n, w)), (t[8] = w), (t[9] = n), (t[10] = E)) : (E = t[10]);
  let D = E,
    O = qe(Be()),
    k;
  t[11] === r
    ...
    ? ((F = () => {
          ...
          m = () => {
            !i ||
              ...
              t({ mountId: r, type: `browser-settings-webview-unmounted` }).catch((e) => {
                a.warning(`Failed to unmount browser settings webview`, {
                  safe: { kind: n },
                  sensitive: { error: e },
                });
              }));
          };
        ((u.current = Er(n, b)), (d.current = null));
        let g = (e) => {
            let t = s;
            t != null &&
              Sr(t).then((n) => {
                o || s !== t || xr(t, b) !== e || h(n == null ? null : { title: n, url: e });
              });
          },
          v = () => {
            if (s == null || o) return;
            let e = vr(s, b),
              t = f != null && e.url === S ? { ...e, url: f } : e,
              r = d.current,
              i = Dr(u.current ?? Er(n, b), t.url, r);
          ...
          C = () => {
            if ((v(), s == null || f == null)) return;
            let e = f;
            ((f = null),
              Or({ sourceUrl: S, targetUrl: e, webview: s }).catch((t) => {
                a.warning(`Failed to open initial browser settings URL`, {
                  safe: { kind: n },
        ...
        return (
          (async () => {
            try {
              ...
              ((s = document.createElement(`webview`)),
                ...
                s.setAttribute(`aria-label`, y),
                s.setAttribute(`partition`, _.partition),
                s.setAttribute(`src`, S),
                s.addEventListener(`dom-ready`, C));
              for (let e of x) s.addEventListener(e, v);
              ((l.current = s), e.append(s), v());
            } catch (e) {
              let t = e;
              a.error(`Failed to mount browser settings webview`, {
                safe: { kind: n },
                sensitive: { error: t },
              });
            }
          ...
          () => {
            ...
            for (let e of x) s?.removeEventListener(e, v);
    ...
    ? ((ne = (e) => {
      ...
      (re = (e) => {
        ...
        return (
          (u.current = s),
          (d.current = e),
          p(Tr({ history: s, initialUrl: b, url: i, webview: t })),
          Or({ sourceUrl: o, targetUrl: i, webview: t }).catch((e) => {
            a.warning(`Failed to navigate browser settings webview`, {
              safe: { kind: n },
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (0, K.jsx)(`div`, { "aria-hidden": !0, className: `draggable absolute inset-0` })),
      (t[46] = oe))
    : (oe = t[46]);
  let se = C?.canGoBack === !0 || D != null,
    ce = C?.canGoForward ?? !1,
    le;
  t[47] !== D || t[48] !== o || t[49] !== ne
    ? ((le = () => {
        let e = l.current;
        if (!(u.current?.preferHistoryControls === !0 && ne(-1))) {
          if (e != null && yr(e)) {
            e.goBack?.();
            return;
          }
  ...
  t[51] === ne
    ...
    : ((ue = () => {
        ...
        (u.current?.preferHistoryControls === !0 && ne(1)) || ne(1);
      }),
      (t[51] = ne),
      (t[52] = ue));
  let de;
  t[53] !== A || t[54] !== M || t[55] !== se || t[56] !== ce || t[57] !== le || t[58] !== ue
    ? ((de = (0, K.jsx)(`div`, {
    ...
    ? ((b =
        u == null
          ? (0, K.jsx)(`span`, {
              ...
              children: (0, K.jsx)(V, { ...c.breadcrumbLabel }),
            })
          : (0, K.jsxs)(K.Fragment, {
              children: [
                (0, K.jsx)(sr, { onClick: a, children: (0, K.jsx)(V, { ...c.breadcrumbLabel }) }),
                (0, K.jsx)(cr, {}),
...
function cr() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, K.jsx)(ut, { className: `icon-xs text-token-text-secondary` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
...
function fr(e, t) {
  ...
  if (t != null) return t;
  let r = Mr(n);
  return r == null ? Nr(n) : (0, K.jsx)(V, { ...r });
}
function pr(e) {
  mr(e) && e.destroy();
}
...
function hr({ kind: e, search: t, siteSettingsRoutePath: n }) {
  let r = Lr[e];
  return e === `siteSettings` ? (D(new URLSearchParams(t).get(`site`)) ?? gr(n) ?? r.url) : r.url;
}
function gr(e) {
...
function _r(e, t) {
  return e === `siteSettings` && jr(t) === `siteDetails` ? y : t;
}
function vr(e, t) {
...
function Er(e, t) {
  return e !== `siteSettings` || jr(t) == null
    ...
    : { entries: [y, t], index: 1, preferHistoryControls: !0 };
}
function Dr(e, t, n) {
...
function Br(e) {
  let t = (0, Vr.c)(25),
    { hostId: n } = e,
    r = gt(),
    { data: i, isLoading: a } = h(_e),
    o;
  t[0] === n ? (o = t[1]) : ((o = { hostId: n }), (t[0] = n), (t[1] = o));
  let { data: s, isPending: c } = S(Ze, o),
    l;
  t[2] === n ? (l = t[3]) : ((l = { hostId: n }), (t[2] = n), (t[3] = l));
  let u = Se(l),
    d = s?.requirements?.featureRequirements?.[ct],
    f;
  t[4] === d ? (f = t[5]) : ((f = ze(d)), (t[4] = d), (t[5] = f));
  let p = f,
    m = a || c,
    g = i?.fullCdpAccessEnabled === !0 && !m && !p,
    _;
  ...
  t[17] !== g || t[18] !== C || t[19] !== w || t[20] !== x
    ? ((T = (0, q.jsx)(Rt, { ariaLabel: x, checked: g, disabled: C, onChange: w })),
      (t[17] = g),
      (t[18] = C),
      (t[19] = w),
      (t[20] = x),
  ...
  return (
    t[22] !== T || t[23] !== b
      ? ((E = (0, q.jsx)(L, { label: _, description: b, control: T })),
        (t[22] = T),
        (t[23] = b),
        (t[24] = E))
      : (E = t[24]),
...
function oi() {
  let e = (0, bi.c)(12),
    { selectedHostId: t } = Te(),
    { data: n, isError: r, isLoading: i } = h(_e),
    a;
  e[0] === t ? (a = e[1]) : ((a = { hostId: t }), (e[0] = t), (e[1] = a));
  let { data: o, isError: s, isPending: c } = S(Ze, a),
  ...
  e[2] !== o?.requirements?.featureRequirements || e[3] !== s || e[4] !== c || e[5] !== l
    ? ((f =
        l && !s && !c && !ze(o?.requirements?.featureRequirements?.browser_use_full_cdp_access)),
...
function si(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = () => {
      ...
      (h = (0, X.jsx)(Kt, { className: `icon-xs` })),
      (g = (0, X.jsx)(V, {
  ...
  t[11] === _
    ? (b = t[12])
    : ((b = (0, X.jsx)(G.Header, { actions: _, title: v, subtitle: y })), (t[11] = _), (t[12] = b));
  let x;
  ...
  return (
    t[24] !== x || t[25] !== S || t[26] !== C || t[27] !== b
      ? ((w = (0, X.jsxs)(G, { className: `gap-2`, children: [b, x, S, C] })),
        (t[24] = x),
        (t[25] = S),
        (t[26] = C),
        (t[27] = b),
  ...
  return (0, X.jsx)(qt, {
    ...
    triggerButton: (0, X.jsxs)(Fn, {
      ...
      children: [
        (0, X.jsx)(`span`, {
          ...
          children:
            c === `custom`
              ? (0, X.jsx)(dn, { className: `icon-xs text-token-text-secondary` })
              : (0, X.jsx)(di, { value: c }),
        }),
    ...
    children: (0, X.jsxs)(`div`, {
      ...
      children: [
        ...
        (0, X.jsx)(Vt.Separator, {}),
        (0, X.jsx)(Vt.Item, {
          RightIcon: c === `custom` ? ot : void 0,
          onSelect: e,
          children: (0, X.jsxs)(`div`, {
            className: `flex min-w-0 items-center gap-2`,
            children: [
              (0, X.jsx)(dn, { className: `icon-xs shrink-0 text-token-text-secondary` }),
              (0, X.jsx)(V, {
...
function di(e) {
  let t = (0, bi.c)(6),
    ...
    o;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((o = Ct(`size-2 shrink-0 rounded-full`, r, i, a)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a),
      (t[3] = o))
...
function Di(e) {
  ...
  let { pendingPluginId: x, setPluginEnabled: S } = Pt(b),
    C;
  t[7] === o ? (C = t[8]) : ((C = { hostId: o }), (t[7] = o), (t[8] = C));
  let { pendingUninstallPluginId: w, uninstallPlugin: T } = $t(C),
            ...
            ? (0, Z.jsx)(
                L,
                {
                  ...
                  icon: (0, Z.jsx)(`span`, {
                    ...
                    children:
                      e.icon ?? (0, Z.jsx)(un, { className: `icon-md text-token-text-secondary` }),
                  }),
                  label: (0, Z.jsx)(`span`, {
                ...
                ji,
                {
                  ...
                  onToggleInstalledPluginEnabled: (t, n) => {
                    S({
                      ...
                      pluginDisplayName: e.displayName ?? an(t),
                      enabled: n,
                    });
                  },
                  onUninstallPlugin: D,
  ...
  let N;
  t[31] !== j || t[32] !== M
    ? ((N = (0, Z.jsxs)(W, { className: `overflow-hidden`, children: [j, M] })),
      (t[31] = j),
      (t[32] = M),
      (t[33] = N))
    : (N = t[33]);
  ...
  let te;
  return (
    t[53] !== I || t[54] !== ee || t[55] !== N
      ? ((te = (0, Z.jsxs)(Z.Fragment, { children: [N, I, ee] })),
        (t[53] = I),
        (t[54] = ee),
        (t[55] = N),
        (t[56] = te))
...
function ki(e) {
  ...
  t[0] === n.icon
    ? (i = t[1])
    : ((i = n.icon ?? (0, Z.jsx)(un, { className: `icon-md text-token-text-secondary` })),
      (t[0] = n.icon),
      (t[1] = i));
  let a;
  t[2] === i
  ...
  t[16] === u
    ? (d = t[17])
    : ((d = (0, Z.jsx)(Rt, { ariaLabel: u, checked: !1, disabled: !0, onChange: Ai })),
      (t[16] = u),
      (t[17] = d));
  let f;
  return (
...
function ji(e) {
  ...
  if (
    ...
    let e = i.displayName ?? an(i.plugin),
    ...
    let y =
        ...
        (0, Z.jsx)(Ht, {
          ...
          fallback: (0, Z.jsx)(un, { className: `icon-md text-token-text-secondary` }),
        }),
      b;
    t[18] !== v || t[19] !== y
            ...
            children: [
              i.showManageActions === !0
                ? (0, Z.jsx)(`div`, {
                    ...
                    children: (0, Z.jsxs)(qt, {
                      align: `end`,
                      contentWidth: `sm`,
                      triggerButton: (0, Z.jsx)(fe, {
    ...
    if (r === `downloads` && !l) {
      ...
      return (
        e[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(Qe, { to: `/settings/browser-use`, replace: !0 })), (e[4] = t))
          : (t = e[4]),
        t
      );
    }
    ...
    if (!i.enabled && !a) {
      ...
      return (
        e[6] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(Qe, { to: `/settings/browser-use`, replace: !0 })), (e[6] = t))
          : (t = e[6]),
        t
      );
    }
...
function zi() {
  ...
  e[1] !== i || e[2] !== r.availablePlugins
    ? ((a = Fi(r.availablePlugins, A, i)), (e[1] = i), (e[2] = r.availablePlugins), (e[3] = a))
    : (a = e[3]);
  let o = a,
    s;
  ...
  e[14] !== o || e[15] !== m
    ? ((E =
        o == null && ua(m)
          ? [
              {
                description: (0, $.jsx)(V, { ...nn.restrictedAvailabilityDescription }),
                icon: (0, $.jsx)(ve, { className: `h-full w-full text-token-foreground` }),
                id: `browser-use-unavailable`,
                title: (0, $.jsx)(V, { ...nn.label }),
              },
            ]
          : []),
      (e[14] = o),
        ...
        ? (0, $.jsxs)(G, {
            children: [
              ...
              (0, $.jsx)(G.Content, {
                children: (0, $.jsxs)(W, {
                  children: [
                    _ ? (0, $.jsx)(Cn, { electron: !0, children: (0, $.jsx)(Zi, {}) }) : null,
                    (0, $.jsx)($i, {}),
  ...
  e[32] !== _ || e[33] !== f.downloads
    ? ((N =
        !_ || !f.downloads.enabled
          ? null
          : (0, $.jsx)(Cn, { electron: !0, children: (0, $.jsx)(Bi, {}) })),
      (e[32] = _),
      (e[33] = f.downloads),
      (e[34] = N))
    : (N = e[34]);
  ...
  return (
    ...
    e[46] !== O ||
    e[47] !== k
      ? ((I = (0, $.jsxs)($.Fragment, { children: [O, k, j, M, N, P, F] })),
        (e[41] = j),
        (e[42] = M),
        (e[43] = N),
        (e[44] = P),
...
function Bi() {
  let e = p(H),
    ...
    [r, i] = (0, _a.useState)(!1),
    a = je?.downloads,
    o = lt(_.downloadDirectory),
    s = lt(_.promptForDownloadLocation);
  if (a == null) return null;
  let c = async () => {
    i(!0);
    try {
      let t = await a.chooseDownloadDirectory();
      t != null && (await dt(e, _.downloadDirectory, t));
    } catch {
      e.get(z).danger(
        t.formatMessage({
          ...
          children: [
            ...
            (0, $.jsx)(L, {
              ...
              control: (0, $.jsx)(Rt, {
                ...
                checked: s,
                onChange: (t) => {
                  dt(e, _.promptForDownloadLocation, t);
                },
              }),
            }),
            (0, $.jsx)(L, {
...
function Vi(e) {
  ...
  let s = o,
    c;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(Cn, { electron: !0, children: (0, $.jsx)(oi, {}) })), (t[8] = c))
    : (c = t[8]);
  let l;
  return (
    t[9] === s
      ...
      : ((l = (0, $.jsxs)($.Fragment, {
          children: [
            c,
            (0, $.jsx)(Cn, { browser: !0, chromeExtension: !0, extension: !0, children: s }),
          ],
        })),
        (t[9] = s),
        (t[10] = l)),
...
function qi(e) {
  ...
  return (
    t[6] !== n || t[7] !== r || t[8] !== c
      ? ((l = (0, $.jsx)(L, { label: r, description: n, control: c })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = c),
        (t[9] = l))
...
function Xi() {
  let e = (0, Q.c)(14),
    t = p(H),
    n = lt(_.annotationScreenshotsMode),
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = {
        id: `always`,
    ...
    ? ((d = (0, $.jsx)(`div`, {
        ...
        children: a.map((e) => {
          ...
          return (0, $.jsx)(
            ...
            {
              allowWrap: !0,
              RightIcon: r ? ot : void 0,
              onSelect: () => {
                dt(t, _.annotationScreenshotsMode, e.id);
              },
...
function Zi() {
  ...
  e[2] === n
    ? (a = e[3])
    : ((a = (0, $.jsx)(Fn, { children: (0, $.jsx)(Qi, { target: n }) })), (e[2] = n), (e[3] = a));
  let o;
  e[4] !== t || e[5] !== n
    ? ((o = xa.map((e) =>
        (0, $.jsx)(
          Vt.Item,
          {
            onSelect: () => {
              n !== e &&
                (dt(t, v.openLinkInTargetPreference, e),
                at(t, st, { setting: `web_url`, previousDestination: n, selectedDestination: e }));
            },
            RightIcon: n === e ? ot : void 0,
            children: (0, $.jsx)(`span`, {
              className: `text-sm`,
...
function $i() {
  let e = (0, Q.c)(10),
    t = p(H),
    n = lt(v.openLocalUrlInTargetPreference),
    r,
    i;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(V, {
  ...
  e[2] === n
    ? (a = e[3])
    : ((a = (0, $.jsx)(Fn, { children: (0, $.jsx)(ea, { target: n }) })), (e[2] = n), (e[3] = a));
  let o;
  e[4] !== t || e[5] !== n
    ? ((o = xa.map((e) =>
        (0, $.jsx)(
          Vt.Item,
          {
            onSelect: () => {
              n !== e &&
                (dt(t, v.openLocalUrlInTargetPreference, e),
                at(t, st, {
                  setting: `local_url`,
  ...
  let t = p(H),
    ...
    l = async (e, n) => {
      if (!s) {
        a(e);
        try {
          (await o.mutateAsync(n), t.get(z).success(aa(e)));
        } catch {
          t.get(z).danger(oa(e));
        } finally {
          a(null);
...
function sa() {
  ...
  e[2] === c
    ? (l = e[3])
    : ((l = (e) => {
        Jt({ event: e, href: c, initiator: `open_in_browser_bridge` });
      }),
      (e[2] = c),
      (e[3] = l));
  let u = l,
  ...
  e[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = [
        m,
        {
          ...
          elevatedRiskDisclaimer: (0, $.jsx)(V, {
  ...
  let k;
  e[21] !== E || e[22] !== O
    ? ((k = (0, $.jsx)(Fn, { className: `w-[152px]`, disabled: E, children: O })),
      (e[21] = E),
      (e[22] = O),
      (e[23] = k))
    : (k = e[23]);
  ...
  return (
    e[32] !== j || e[33] !== w
      ? ((M = (0, $.jsx)(L, { label: C, description: w, control: j })),
        (e[32] = j),
        (e[33] = w),
        (e[34] = M))
      : (M = e[34]),
...
function ca() {
  ...
  let S;
  e[13] !== y || e[14] !== x
    ? ((S = (0, $.jsx)(Fn, { className: `w-[152px]`, disabled: y, children: x })),
      (e[13] = y),
      (e[14] = x),
      (e[15] = S))
    : (S = e[15]);
  let C;
  e[16] !== m || e[17] !== i || e[18] !== d
    ? ((C = (0, $.jsx)(`div`, {
        className: `flex flex-col`,
        children: c.map((e) => {
          let t = e.id === i;
    ...
    (t[5] === o
      ...
      : ((e = (e) => ({
          ...
          onTryInChat: () => {
            o({
              prefillPrompt: vn({
                defaultPrompt: yn(e.plugin.interface?.defaultPrompt),
                pluginDisplayName: an(e),
                pluginId: e.plugin.id,
              }),
              startInSidebar: !0,
...
function da(e) {
  let t = (0, Q.c)(37),
    ...
    s = p(H),
    { data: c, isLoading: l } = h(_e),
    [u, d] = (0, _a.useState)(!1),
    f = se(),
    m = me(),
    g;
  t[0] !== n || t[1] !== c || t[2] !== a
    ? ((g = c == null ? [] : ga(c, a, n)), (t[0] = n), (t[1] = c), (t[2] = a), (t[3] = g))
    : (g = t[3]);
  let _ = g,
    v = a === `origins` ? f.isPending : m.isPending,
    y;
  t[4] !== m || t[5] !== f || t[6] !== n || t[7] !== _ || t[8] !== a || t[9] !== s
    ? ((y = async (e) => {
        let t = e.trim();
  ...
  let w;
  t[19] !== S || t[20] !== C
    ? ((w = (0, $.jsx)(G.Header, { actions: x, title: S, subtitle: C })),
      (t[19] = S),
      (t[20] = C),
      (t[21] = w))
    : (w = t[21]);
  let T;
  t[22] !== l || t[23] !== n || t[24] !== _ || t[25] !== a
    ? ((T = (0, $.jsx)(G.Content, {
        children: (0, $.jsx)(W, {
          children: l
            ? (0, $.jsxs)(`div`, {
    ...
    : (T = t[26]);
  let E;
  t[27] !== b || t[28] !== u || t[29] !== v || t[30] !== n || t[31] !== a
    ? ((E = (0, $.jsx)(pa, {
        kind: n,
        isSaving: v,
        open: u,
...
function pa(e) {
  ...
  let _;
  t[15] !== h || t[16] !== g
    ? ((_ = (0, $.jsx)(U, { children: (0, $.jsx)(kn, { title: h, subtitle: g }) })),
      (t[15] = h),
      (t[16] = g),
      (t[17] = _))
    : (_ = t[17]);
  ...
  let O;
  t[40] !== w || t[41] !== D
    ? ((O = (0, $.jsx)(U, { children: (0, $.jsxs)(Dn, { children: [w, D] }) })),
      (t[40] = w),
      (t[41] = D),
      (t[42] = O))
    : (O = t[42]);
  ...
  t[43] !== x || t[44] !== O || t[45] !== m || t[46] !== _
    ? ((k = (0, $.jsxs)(An, { as: `form`, onSubmit: m, children: [_, x, O] })),
      (t[43] = x),
      (t[44] = O),
      (t[45] = m),
      (t[46] = _),
  ...
  return (
    t[48] !== o || t[49] !== k || t[50] !== p
      ? ((A = (0, $.jsx)(Sn, { open: o, onOpenChange: p, size: `compact`, children: k })),
        (t[48] = o),
        (t[49] = k),
        (t[50] = p),
        (t[51] = A))
...
function ma(e) {
  ...
  t[14] !== n || t[15] !== i || t[16] !== v
    ? ((y = Yr(i, n, v)), (t[14] = n), (t[15] = i), (t[16] = v), (t[17] = y))
    : (y = t[17]);
  let b;
  t[18] !== n || t[19] !== i
    ? ((b = Xr(i, n)), (t[18] = n), (t[19] = i), (t[20] = b))
    : (b = t[20]);
  let x;
  t[21] !== y || t[22] !== b
    ? ((x = (0, $.jsx)(U, { children: (0, $.jsx)(kn, { title: y, subtitle: b }) })),
      (t[21] = y),
      (t[22] = b),
      (t[23] = x))
    : (x = t[23]);
  ...
  t[26] === d
    ? (w = t[27])
    : ((w = (0, $.jsx)(R, { color: `ghost`, disabled: d, onClick: C, children: S })),
      (t[26] = d),
      (t[27] = w));
  let T;
  t[28] === m
  ...
  let D;
  t[31] !== d || t[32] !== T
    ? ((D = (0, $.jsx)(R, { color: `danger`, loading: d, onClick: T, children: E })),
      (t[31] = d),
      (t[32] = T),
      (t[33] = D))
    : (D = t[33]);
  ...
  let k;
  t[37] !== O || t[38] !== x
    ? ((k = (0, $.jsxs)(An, { children: [x, O] })), (t[37] = O), (t[38] = x), (t[39] = k))
    : (k = t[39]);
  let A;
  t[40] !== k || t[41] !== g
    ? ((A = (0, $.jsx)(Sn, { open: g, onOpenChange: _, size: `compact`, children: k })),
      (t[40] = k),
      (t[41] = g),
      (t[42] = A))
    : (A = t[42]);
  ...
  return (
    t[43] !== A || t[44] !== h
      ? ((j = (0, $.jsxs)($.Fragment, { children: [h, A] })), (t[43] = A), (t[44] = h), (t[45] = j))
      : (j = t[45]),
    j
  );
}
