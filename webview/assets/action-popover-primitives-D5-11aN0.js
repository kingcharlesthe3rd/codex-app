...
import { jt as o } from "./use-host-config.js";
import { $n as s, Xn as c } from "./thread-context-inputs.js";
import { A as l, _ as u, r as d } from "./vscode-api.js";
import { _n as f } from "./src-3.js";
...
function C(e) {
  let t = (0, S.c)(31),
    { cwd: n, hostConfig: r, onErrorMessage: o, showErrorToast: m } = e,
    h = m === void 0 ? !1 : m,
    g = i(a),
    _ = l(),
    y = p(),
    b;
  t[0] === r ? (b = t[1]) : ((b = c(r)), (t[0] = r), (t[1] = b));
  let x = b,
    C = n ?? ``,
    w;
  t[2] !== x || t[3] !== C
    ? ((w = [`git`, `init-repo`, x, C]), (t[2] = x), (t[3] = C), (t[4] = w))
    : (w = t[4]);
  let T;
  t[5] !== n || t[6] !== r
    ? ((T = async () => {
    ...
    : (T = t[7]);
  let E;
  t[8] !== n || t[9] !== x || t[10] !== y || t[11] !== _ || t[12] !== g
    ? ((E = async () => {
        g.get(v).success(
          y.formatMessage({
        ...
        let e = [_.invalidateQueries({ queryKey: d(`git-origins`) })];
        (n != null && e.push(_.invalidateQueries({ queryKey: [`git`, `metadata`, x, n] })),
          await Promise.all(e));
      }),
      (t[8] = n),
      (t[9] = x),
  ...
  let j = A,
    ...
    N;
  return (
    t[27] !== j || t[28] !== k.isPending || t[29] !== M
      ? ((N = {
...
function E(e) {
  ...
  let a;
  t[4] === r ? (a = t[5]) : ((a = m(`gap-3`, r)), (t[4] = r), (t[5] = a));
  let o;
  return (
    t[6] !== n || t[7] !== i || t[8] !== a
...
function D(e) {
  ...
  t[0] === a
    ? (l = t[1])
    : ((l = m(`flex items-start justify-between`, a)), (t[0] = a), (t[1] = l));
  let u;
  t[2] === c
    ? (u = t[3])
    : ((u = m(`flex h-9 w-9 items-center justify-center rounded-xl`, c)), (t[2] = c), (t[3] = u));
  let d;
  t[4] !== n || t[5] !== u
    ? ((d = (0, T.jsx)(`span`, { className: u, children: n })), (t[4] = n), (t[5] = u), (t[6] = d))
    : (d = t[6]);
  let f;
  t[7] === o
    ? (f = t[8])
  ...
  return (
    t[9] !== l || t[10] !== d || t[11] !== f
      ? ((p = (0, T.jsxs)(`div`, { className: l, children: [d, f] })),
        (t[9] = l),
        (t[10] = d),
        (t[11] = f),
        (t[12] = p))
...
function O(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = m(`text-token-foreground heading-dialog font-semibold`, r)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
...
function k(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = m(`text-token-description-foreground flex flex-col gap-3`, r)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
      ? ((a = (0, T.jsx)(`div`, { className: i, children: n })), (t[2] = n), (t[3] = i), (t[4] = a))
...
function A(e) {
  ...
  if (t[0] !== i || t[1] !== n || t[2] !== r) {
    ...
    (t[8] === i
      ? (c = t[9])
      : ((c = m(`flex flex-1 items-center justify-between gap-2`, i)), (t[8] = i), (t[9] = c)),
      (l = (0, T.jsx)(y, { electron: !0, children: u(`medium`) })),
      (a = y),
      (o = !0),
      (s = u(`toolbar`)),
      (t[0] = i),
  ...
  t[10] !== a || t[11] !== o || t[12] !== s
    ? ((u = (0, T.jsx)(a, { extension: o, children: s })),
      (t[10] = a),
      (t[11] = o),
      (t[12] = s),
      (t[13] = u))
  ...
  return (
    t[14] !== c || t[15] !== l || t[16] !== u
      ? ((d = (0, T.jsxs)(`div`, { className: c, children: [l, u] })),
        (t[14] = c),
        (t[15] = l),
        (t[16] = u),
        (t[17] = d))
...
function j(e) {
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = m(`grid grid-cols-[minmax(0,1fr)_auto] items-center gap-x-6`, a)),
      (t[0] = a),
      (t[1] = o));
  let s;
  t[2] === n
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = (0, T.jsx)(`span`, { className: `min-w-0`, children: r })), (t[4] = r), (t[5] = c));
  let l;
  t[6] !== s || t[7] !== c
    ? ((l = (0, T.jsxs)(`div`, { className: `flex min-w-0 items-center gap-2`, children: [s, c] })),
      (t[6] = s),
      (t[7] = c),
      (t[8] = l))
    : (l = t[8]);
  let u;
  t[9] === i ? (u = t[10]) : ((u = i ?? (0, T.jsx)(`span`, {})), (t[9] = i), (t[10] = u));
  let d;
  return (
    t[11] !== o || t[12] !== l || t[13] !== u
      ? ((d = (0, T.jsxs)(`div`, { className: o, children: [l, u] })),
        (t[11] = o),
        (t[12] = l),
        (t[13] = u),
        (t[14] = d))
...
function M(e) {
  ...
  t[0] === o
    ? (s = t[1])
    : ((s = m(`grid grid-cols-[auto_minmax(0,1fr)] items-center gap-x-6`, o)),
      (t[0] = o),
      (t[1] = s));
  let c;
  t[2] === n
  ...
  t[4] !== r || t[5] !== c
    ...
    : (l = t[6]);
  let u;
  t[7] === a ? (u = t[8]) : ((u = m(`min-w-0 truncate text-right`, a)), (t[7] = a), (t[8] = u));
  let d;
  t[9] !== u || t[10] !== i
    ? ((d = (0, T.jsx)(`div`, { className: u, children: i })), (t[9] = u), (t[10] = i), (t[11] = d))
    : (d = t[11]);
  let f;
  return (
    t[12] !== s || t[13] !== l || t[14] !== d
      ? ((f = (0, T.jsxs)(`div`, { className: s, children: [l, d] })),
        (t[12] = s),
        (t[13] = l),
        (t[14] = d),
        (t[15] = f))
...
function N(e) {
  let t = (0, S.c)(8),
    ...
    s;
  t[0] === o ? (s = t[1]) : ((s = m(`rounded-lg p-2`, o)), (t[0] = o), (t[1] = s));
  let c;
  return (
...
function F(e) {
  let t = (0, S.c)(15),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = m(`flex flex-col gap-2`, a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] === n
    ? (s = t[3])
    : ((s = (0, T.jsx)(`div`, { className: `text-token-description-foreground`, children: n })),
      (t[2] = n),
      (t[3] = s));
  let c;
  if (t[4] !== r || t[5] !== i) {
  ...
  t[9] === c
    ? (l = t[10])
    : ((l = (0, T.jsx)(`div`, { className: `flex flex-col gap-2`, children: c })),
      (t[9] = c),
      (t[10] = l));
  let u;
  return (
    t[11] !== o || t[12] !== s || t[13] !== l
      ? ((u = (0, T.jsxs)(`div`, { className: o, children: [s, l] })),
        (t[11] = o),
        (t[12] = s),
        (t[13] = l),
        (t[14] = u))
...
function I(e) {
  ...
  t[3] === a
    ? (u = t[4])
    : ((u = m(`vertical-scroll-fade-mask max-h-64 overflow-y-auto [--edge-fade-distance:2rem]`, a)),
      (t[3] = a),
      (t[4] = u));
  let d;
  t[5] !== r || t[6] !== u
    ? ((d = (0, T.jsx)(`div`, { className: u, children: r })), (t[5] = r), (t[6] = u), (t[7] = d))
    : (d = t[7]);
  let f;
  return (
    t[8] !== i || t[9] !== o || t[10] !== d
...
//# sourceMappingURL=action-popover-primitives-D5-11aN0.js.map
