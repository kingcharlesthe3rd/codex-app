...
import { A as a, n as o, r as s, s as c } from "./vscode-api.js";
import "./isEqual.js";
import "./src-3.js";
import "./react-dom.js";
import { l, s as u } from "./lib-1.js";
...
import { r as f, t as p } from "./tooltip-B.js";
import "./x.js";
import "./rpc-1.js";
...
import { t as _ } from "./pencil.js";
import { i as v, n as y, t as b } from "./command-menu-state.js";
import { a as x, d as S, i as C, l as w, n as T, r as E, u as D } from "./dialog-layout.js";
import {
  _ as O,
  a as k,
  i as A,
...
import { r as I, s as L } from "./command-keybindings.js";
import "./links.js";
import { t as R } from "./keyboard.js";
import { t as z } from "./trash-DL-ar7Ww.js";
import { i as B } from "./settings-shared.js";
import { t as te } from "./score-query-match.js";
import { t as V } from "./undo.js";
import { t as H } from "./settings-content-layout.js";
import { a as U, i as ne, n as re, t as ie } from "./keyboard-shortcuts-search-input.js";
import { t as ae } from "./settings-surface.js";
import { t as oe } from "./settings-group.js";
import { t as se } from "./hotkey-window-state.js";
import { n as ce, r as le, t as ue } from "./keyboard-event-accelerator-AI-jxMPG.js";
var W = r(),
  G = e(t(), 1),
  K = n(),
  de = F.filter(P);
...
function fe() {
  let e = (0, W.c)(72),
    ...
    C = m(`2380644311`),
    w = m(`4100906017`),
    T = b(o, `switchToMode1`) > 0,
    [E, D] = (0, G.useState)(``),
    [k, A] = (0, G.useState)(!1),
    [j, N] = (0, G.useState)(null),
    P;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((P = {}), (e[0] = P)) : (P = e[0]);
  let [F, z] = (0, G.useState)(P),
    [V, re] = (0, G.useState)(!1),
    [ce, le] = (0, G.useState)(null),
    { data: q } = i(I),
    fe;
  e[1] !== f || e[2] !== r
    ? ((fe = {
      ...
      (e[3] = fe))
    : (fe = e[3]);
  let J = c(`set-codex-command-keybinding`, fe),
    xe;
  e[4] !== f || e[5] !== r
    ? ((xe = {
        onSuccess: (e) => {
          ...
          (r.setQueryData(t, e),
            Promise.all([t, se, s(`global-dictation-hotkey-state`)].map((e) => f(e))));
        },
      }),
      (e[4] = f),
      (e[5] = r),
      (e[6] = xe))
    : (xe = e[6]);
  let Y = c(`reset-codex-command-keybindings`, xe),
    De,
    X;
  if (
    e[7] !== t ||
    ...
    let r;
    e[21] !== _ || e[22] !== x || e[23] !== S || e[24] !== C || e[25] !== w || e[26] !== T
      ? ((r = (e) =>
          ne(e.id, {
            modeSwitchAvailable: T,
            isGlobalDictationEnabled: _,
            isHotkeyWindowEnabled: x,
            isProcessManagerEnabled: S,
            isRealtimeConversationEnabled: C,
            isVoiceInputEnabled: w,
          })),
        (e[21] = _),
        (e[22] = x),
        (e[23] = S),
    ...
    let i;
    (e[28] !== t || e[29] !== o
      ? ((i = (e) => ({ command: e, title: U(e, t, y(o, e.id)).title })),
        (e[28] = t),
        (e[29] = o),
        (e[30] = i))
      : (i = e[30]),
      (X = de.filter(r).map(i).sort(he)));
    let a = E.trim();
    ((De =
      a.length === 0
        ? X
        : X.filter((e) => {
            let { command: r, title: i } = e,
              s = U(r, t, y(o, r.id)).description;
            return k
              ? L(r.id, q, n).some((e) => {
                  let { label: t } = e;
                  return ve(t, a);
                })
              : [r.id, i, s].some((e) => te(e, a) > 0);
          })),
      (e[7] = t),
      (e[8] = _),
      (e[9] = x),
  ...
  e[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ke = (0, K.jsx)(B, { slug: `keyboard-shortcuts` })), (e[31] = ke))
    : (ke = e[31]);
  let Z;
  e[32] !== t || e[33] !== k || e[34] !== q || e[35] !== n || e[36] !== E || e[37] !== X
    ? ((Z =
        q == null
          ? null
          : (0, K.jsx)(ie, {
              autoFocus: k,
              isSearchingByKeystrokes: k,
              trailingContent: (0, K.jsx)(p, {
                tooltipContent: (0, K.jsx)(u, {
                ...
                children: (0, K.jsx)(d, {
                  ...
                  children: (0, K.jsx)(R, { className: `icon-sm` }),
                }),
              }),
              value: E,
              onKeyDown: k
                ? (e) => {
                    ...
                    if (t != null) {
                      let e = M(t, n === `macOS`, n === `linux`),
                        r = E.length === 0 ? e : `${E} ${e}`;
                      D(
                        E.length > 0 &&
                          X.some((e) => {
                            let { command: t } = e;
                            return L(t.id, q, n).some((e) => {
                              let { label: t } = e;
                              return ve(t, r);
                            });
                          })
          ...
          : (0, K.jsxs)(`table`, {
              ...
              children: [
                (0, K.jsxs)(`colgroup`, {
                  children: [
                    (0, K.jsx)(`col`, {}),
                    (0, K.jsx)(`col`, { className: `w-64` }),
                    (0, K.jsx)(`col`, { className: `w-32` }),
                  ],
                }),
                (0, K.jsx)(`thead`, {
                  ...
                  children: [
                    ...
                    Oe.map((e, r) => {
                      let { command: i, title: a } = e,
                        s = U(i, t, y(o, i.id)).description,
                        c = L(i.id, q, n),
                        l = q.bindings.some((e) => e.command === i.id),
                        u = Te({
                          commandId: i.id,
                          hasCustomBinding: l,
                          platform: n,
                        ...
                        d = j?.commandId === i.id && j.mode === `append`,
                        f = c.length === 0 ? [null] : c,
                        m = d && c.length > 0 ? [...c, null] : f;
                      return (0, K.jsx)(
                        G.Fragment,
                        {
                          children: m.map((e, d) => {
                            ...
                            m.length === 1
                              ...
                              : f
                                ? (h = `px-4 pt-2 pb-0.5`)
                                : d === m.length - 1 && (h = `px-4 pt-0.5 pb-2`);
                            let g =
                              j?.commandId === i.id &&
                              (j.mode === `append`
                                ? e == null && d === c.length
                                : j.accelerator === (e?.accelerator ?? null));
                            return (0, K.jsxs)(
                              `tr`,
                              {
                                className:
                                ...
                                children: [
                                  ...
                                  (0, K.jsx)(`td`, {
                                    ...
                                    children: g
                                      ? (0, K.jsx)(_e, {
                                          allowsBareModifiers: ee(i),
                                          allowsSequences: i.kind === `webview`,
                                          commandTitle: a,
                                          conflictingCommandTitle: j.conflictingCommandTitle,
                                          onCancel: () => {
                                            N(null);
                                          },
                                          onCapture: (r) => {
                                            if (e != null && be(e.accelerator, r, n === `macOS`)) {
                                              N(null);
                                              return;
                                            }
                                            let a = ye({
                                            ...
                                            ((s =
                                              j.mode === `append`
                                                ...
                                                : e == null
                                                  ...
                                                  : {
                                                      type: `replace`,
                                                      previousAccelerator: e.accelerator,
                                                      accelerator: r,
                                                    }),
                                              Ee({
                                                commandId: i.id,
                                                intl: t,
                                                setCommandKeybinding: J,
                                                setErrorByCommandId: z,
                                                update: s,
                                              }).finally(() => {
                                                N((e) => (e === j ? null : e));
                                              }));
                                      ...
                                      : (0, K.jsxs)(`div`, {
                                          ...
                                          children: [
                                            (0, K.jsx)(Se, { shortcutLabel: e?.label ?? null }),
                                            (0, K.jsx)(we, {
                                              canAppend: !O(i),
                                              commandTitle: a,
                                              hasShortcut: e != null,
  ...
  let Ae;
  e[50] !== Q || e[51] !== $
    ? ((Ae = (0, K.jsxs)(ae, { className: `overflow-hidden`, children: [Q, $] })),
      (e[50] = Q),
      (e[51] = $),
      (e[52] = Ae))
    : (Ae = e[52]);
  let je;
  e[53] !== q || e[54] !== Y.isPending
    ? ((je =
        q != null && q.bindings.length > 0
          ? (0, K.jsx)(`div`, {
    ...
    : (je = e[55]);
  let Me;
  e[56] !== Z || e[57] !== Ae || e[58] !== je
    ? ((Me = (0, K.jsx)(oe, { children: (0, K.jsxs)(oe.Content, { children: [Z, Ae, je] }) })),
      (e[56] = Z),
      (e[57] = Ae),
      (e[58] = je),
      (e[59] = Me))
  ...
  e[61] !== t || e[62] !== Y
    ? ((Pe = async () => {
        le(null);
        try {
          (await Y.mutateAsync(void 0), re(!1));
        } catch (e) {
          let n = e;
          le(
            n instanceof Error
    ...
    : (Pe = e[63]);
  let Fe;
  e[64] !== V || e[65] !== ce || e[66] !== Y.isPending || e[67] !== Pe
    ? ((Fe = (0, K.jsx)(ge, {
        error: ce,
  ...
  return (
    e[69] !== Me || e[70] !== Fe
      ? ((Ie = (0, K.jsxs)(H, { title: ke, children: [Me, Fe] })),
        (e[69] = Me),
        (e[70] = Fe),
        (e[71] = Ie))
      : (Ie = e[71]),
...
function ge(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, K.jsx)(S, { className: `sr-only`, children: c })),
      (h = (0, K.jsx)(D, { className: `sr-only`, children: f })),
      (t[4] = m),
      (t[5] = h))
    : ((m = t[4]), (h = t[5]));
  let g;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, K.jsx)(x, { children: (0, K.jsx)(C, { title: c, subtitle: f }) })), (t[6] = g))
    : (g = t[6]);
  let _;
  t[7] === n
    ? (_ = t[8])
    : ((_ =
        n == null
          ? null
          : (0, K.jsx)(x, { className: `text-token-error-foreground`, children: n })),
      (t[7] = n),
      (t[8] = _));
  let v;
  t[9] === a
  ...
  t[12] === v
    ? (b = t[13])
    : ((b = (0, K.jsx)(d, { color: `secondary`, onClick: v, children: y })),
      (t[12] = v),
      (t[13] = b));
  let O;
  ...
  t[15] === r
    ? (k = t[16])
    : ((k = (0, K.jsx)(d, { color: `danger`, loading: r, type: `submit`, children: O })),
      (t[15] = r),
      (t[16] = k));
  let A;
  t[17] !== b || t[18] !== k
    ? ((A = (0, K.jsx)(x, { children: (0, K.jsxs)(E, { children: [b, k] }) })),
      (t[17] = b),
      (t[18] = k),
      (t[19] = A))
    : (A = t[19]);
  let j;
  t[20] !== A || t[21] !== p || t[22] !== _
    ? ((j = (0, K.jsxs)(T, { as: `form`, onSubmit: p, children: [m, h, g, _, A] })),
      (t[20] = A),
      (t[21] = p),
      (t[22] = _),
      (t[23] = j))
...
function _e(e) {
  ...
  t[1] === c
    ? (C = t[2])
    : ((C = (e) => {
        ((m.current += 1), (h.current = null), S(), c(e));
      }),
      (t[1] = c),
      (t[2] = C));
  let w = C,
  ...
  t[3] === s
    ? (T = t[4])
    : ((T = () => {
        ((m.current += 1), (h.current = null), S(), s());
      }),
      (t[3] = s),
      (t[4] = T));
  let E = T,
  ...
  t[8] === w
    ...
    : ((k = async (e) => {
        try {
          let { hotkey: t } = await o(`global-dictation-capture-fn-hotkey`);
          t != null && m.current === e && w(t);
        } catch {}
      }),
      (t[8] = w),
      (t[9] = k));
  let j = (0, G.useEffectEvent)(k),
    N;
  t[10] !== n || t[11] !== j || t[12] !== p
    ? ((N = () => {
        if (!(!n || p !== `macOS`))
          return (
            (m.current += 1),
  ...
  let H;
  t[41] !== B || t[42] !== V
    ? ((H = (0, K.jsxs)(`div`, { className: `flex items-center gap-2`, children: [B, V] })),
      (t[41] = B),
      (t[42] = V),
      (t[43] = H))
    : (H = t[43]);
...
function ye({
  ...
  for (let o of de)
    if (o.id !== t && !j(o.id, t) && L(o.id, r, i).some((t) => xe(t.accelerator, e, i === `macOS`)))
      return U(o, n, y(a, o.id)).title;
  return null;
}
function be(e, t, n) {
  return M(e, n) === M(t, n);
      ...
      : ((r = (0, K.jsx)(`span`, {
          ...
          children:
            n == null
              ...
              : (0, K.jsx)(f, { className: `!px-2 !py-1 !text-sm`, keysLabel: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
...
function Ce(e) {
  ...
  t[6] !== m || t[7] !== i || t[8] !== a || t[9] !== s
    ? ((_ = i
        ? (0, K.jsx)(p, {
            ...
            children: (0, K.jsx)(d, {
              ...
              disabled: a,
              onClick: s,
              children: (0, K.jsx)(z, { className: `icon-xs` }),
            }),
          })
        : null),
      (t[6] = m),
    ...
    : (_ = t[10]);
  let v;
  t[11] !== r || t[12] !== a || t[13] !== c || t[14] !== g || t[15] !== o
    ? ((v =
        o && r
          ? (0, K.jsx)(p, {
              tooltipContent: g,
              children: (0, K.jsx)(d, {
                ...
                disabled: a,
                onClick: c,
                children: (0, K.jsx)(V, { className: `icon-xs` }),
              }),
            })
          : null),
      (t[11] = r),
...
function we(e) {
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, K.jsx)(_, { className: `icon-xs` })), (t[18] = y))
    : (y = t[18]);
  let b;
  t[19] !== a || t[20] !== f || t[21] !== m || t[22] !== h || t[23] !== v
    ? ((b = (0, K.jsx)(d, {
        "aria-label": f,
  ...
  return (
    t[25] !== f || t[26] !== b
      ? ((x = (0, K.jsx)(p, { tooltipContent: f, children: b })),
        (t[25] = f),
        (t[26] = b),
        (t[27] = x))
      : (x = t[27]),
...
function Te({ commandId: e, hasCustomBinding: t, platform: n, shortcutEntries: r }) {
  if (!t) return null;
  let i = N({ commandId: e, isMacOS: n === `macOS` }),
...
export { q as KeyboardShortcutsSettings };
