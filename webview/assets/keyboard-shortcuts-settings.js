...
import { k as a, n as o, r as s, s as c } from "./vscode-api.js";
import "./isEqual.js";
import "./src-4.js";
import "./react-dom.js";
import { c as l, o as u } from "./lib-1.js";
...
import "./rpc-2.js";
import { o as m } from "./statsig-DoZ-0xit.js";
import "./platform.js";
...
import { a as v, d as y, i as b, l as x, n as S, r as C, u as w } from "./dialog-layout.js";
import {
  _ as T,
  a as E,
  b as D,
...
import { r as ee, s as P } from "./command-keybindings.js";
import "./links.js";
import { t as F } from "./trash.js";
import "./chevron.js";
import { t as I } from "./keyboard.js";
import { t as L } from "./undo-C.js";
...
import { a as V, i as H, n as U, s as W, t as te } from "./keyboard-shortcuts-search-input.js";
import { n as ne, t as re } from "./settings-group.js";
import { t as ie } from "./hotkey-window-state.js";
...
function ce() {
  ...
  e[4] !== o || e[5] !== r
    ? ((ce = {
        onSuccess: (e) => {
          ...
          (r.setQueryData(t, e),
            Promise.all([t, ie, s(`global-dictation-hotkey-state`)].map((e) => o(e))));
        },
      }),
      (e[4] = o),
      (e[5] = r),
  ...
  if (
    ...
    (e[23] === t
      ? (i = e[24])
      : ((i = (e) => ({ command: e, title: W(e, t) })), (e[23] = t), (e[24] = i)),
      (Z = se.filter(r).map(i).sort(de)));
    let a = b.trim();
    ((_e =
      a.length === 0
        ? Z
        : Z.filter((e) => {
            let { command: r, title: i } = e,
              o = N(r) ? t.formatMessage(V[r.descriptionIntlId]) : ``;
            return S
              ? P(r.id, G, n).some((e) => {
                  let { label: t } = e;
                  return me(t, a);
                })
              : [r.id, i, o].some((e) => z(e, a) > 0);
          })),
      (e[7] = t),
      (e[8] = f),
      (e[9] = _),
  ...
  e[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((we = (0, J.jsx)(R, { slug: `keyboard-shortcuts` })), (e[25] = we))
    : (we = e[25]);
  let Q;
  e[26] !== t || e[27] !== S || e[28] !== G || e[29] !== n || e[30] !== b || e[31] !== Z
    ? ((Q =
        G == null
          ? null
          : (0, J.jsx)(te, {
                  ...
                  children: [
                    ...
                    Ce.map((e, r) => {
                      let { command: i, title: a } = e,
                        o = N(i) ? t.formatMessage(V[i.descriptionIntlId]) : null,
                        s = P(i.id, G, n),
                      ...
                      return (0, J.jsx)(
                        q.Fragment,
                        {
                          children: f.map((e, u) => {
                            let d = u === 0,
                              p = `px-4 pt-1 pb-2`;
                            f.length === 1 ? (p = `px-4 py-2`) : d && (p = `px-4 pt-2 pb-1`);
                            let m =
                              w?.commandId === i.id &&
                              (w.mode === `append`
                                ? e == null && u === s.length
                              ...
                              `tr`,
                              {
                                ...
                                children: [
                                  ...
                                  (0, J.jsx)(`td`, {
                                    ...
                                    children: m
                                      ? (0, J.jsx)(pe, {
                                          allowsBareModifiers: j(i),
                                          allowsSequences: i.kind === `webview`,
                                          commandTitle: a,
                                          conflictingCommandTitle: w.conflictingCommandTitle,
                                          onCancel: () => {
                                            T(null);
                                          },
                                          onCapture: (r) => {
                                            if (e != null && ge(e.accelerator, r, n === `macOS`)) {
                                              T(null);
                                              return;
                                            }
                                            let a = he({
                                      ...
                                      : (0, J.jsxs)(`div`, {
                                          ...
                                          children: [
                                            (0, J.jsx)(ve, { shortcutLabel: e?.label ?? null }),
                                            (0, J.jsx)(be, {
                                              canAppend: !k(i),
                                              commandTitle: a,
                                              hasShortcut: e != null,
  ...
  let De;
  e[43] !== Te || e[44] !== Ee
    ? ((De = (0, J.jsxs)(ne, { className: `overflow-hidden`, children: [Te, Ee] })),
      (e[43] = Te),
      (e[44] = Ee),
      (e[45] = De))
    : (De = e[45]);
  let Oe;
  e[46] !== G || e[47] !== X.isPending
    ? ((Oe =
    ...
    : (Oe = e[48]);
  let ke;
  e[49] !== Q || e[50] !== De || e[51] !== Oe
    ? ((ke = (0, J.jsx)(re, { children: (0, J.jsxs)(re.Content, { children: [Q, De, Oe] }) })),
      (e[49] = Q),
      (e[50] = De),
      (e[51] = Oe),
      (e[52] = ke))
  ...
  e[54] !== t || e[55] !== X
    ...
    : (je = e[56]);
  let $;
  e[57] !== A || e[58] !== L || e[59] !== X.isPending || e[60] !== je
    ? (($ = (0, J.jsx)(fe, {
        error: L,
...
function fe(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, J.jsx)(y, { className: `sr-only`, children: c })),
      (h = (0, J.jsx)(w, { className: `sr-only`, children: f })),
      (t[4] = m),
      (t[5] = h))
    : ((m = t[4]), (h = t[5]));
  let g;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, J.jsx)(v, { children: (0, J.jsx)(b, { title: c, subtitle: f }) })), (t[6] = g))
    : (g = t[6]);
  let _;
  t[7] === n
    ? (_ = t[8])
    : ((_ =
        n == null
          ? null
          : (0, J.jsx)(v, { className: `text-token-error-foreground`, children: n })),
      (t[7] = n),
      (t[8] = _));
  let T;
  t[9] === a
  ...
  t[12] === T
    ? (D = t[13])
    : ((D = (0, J.jsx)(d, { color: `secondary`, onClick: T, children: E })),
      (t[12] = T),
      (t[13] = D));
  let O;
  ...
  t[15] === r
    ? (k = t[16])
    : ((k = (0, J.jsx)(d, { color: `danger`, loading: r, type: `submit`, children: O })),
      (t[15] = r),
      (t[16] = k));
  let A;
  t[17] !== D || t[18] !== k
    ? ((A = (0, J.jsx)(v, { children: (0, J.jsxs)(C, { children: [D, k] }) })),
      (t[17] = D),
      (t[18] = k),
      (t[19] = A))
    : (A = t[19]);
  ...
  t[20] !== A || t[21] !== p || t[22] !== _
    ? ((j = (0, J.jsxs)(S, { as: `form`, onSubmit: p, children: [m, h, g, _, A] })),
      (t[20] = A),
      (t[21] = p),
      (t[22] = _),
      (t[23] = j))
...
function pe(e) {
  ...
  let U;
  t[41] !== B || t[42] !== H
    ? ((U = (0, J.jsxs)(`div`, { className: `flex items-center gap-2`, children: [B, H] })),
      (t[41] = B),
      (t[42] = H),
      (t[43] = U))
    : (U = t[43]);
...
function he({ accelerator: e, commandId: t, intl: n, keymapState: r, platform: i }) {
  for (let a of se)
    if (a.id !== t && P(a.id, r, i).some((t) => _e(t.accelerator, e, i === `macOS`)))
      return W(a, n);
  return null;
}
function ge(e, t, n) {
      ...
      : ((r = (0, J.jsx)(`span`, {
          ...
          children:
            n == null
              ...
              : (0, J.jsx)(f, { className: `!px-2 !py-1 !text-sm`, keysLabel: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
    ...
    ? ((_ = i
        ? (0, J.jsx)(p, {
            ...
            children: (0, J.jsx)(d, {
              ...
              disabled: a,
              onClick: s,
              children: (0, J.jsx)(F, { className: `icon-xs` }),
            }),
          })
        : null),
      (t[6] = m),
...
function be(e) {
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, J.jsx)(_, { className: `icon-xs` })), (t[18] = y))
    : (y = t[18]);
  let b;
  ...
  return (
    t[25] !== f || t[26] !== b
      ? ((x = (0, J.jsx)(p, { tooltipContent: f, children: b })),
        (t[25] = f),
        (t[26] = b),
        (t[27] = x))
      : (x = t[27]),
...
function xe({ commandId: e, hasCustomBinding: t, platform: n, shortcutEntries: r }) {
  if (!t) return null;
  let i = O({ commandId: e, isMacOS: n === `macOS` }),
