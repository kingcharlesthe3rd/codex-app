...
import { i as Pe, n as Fe, r as Ie, t as Le } from "./keyboard-event-accelerator.js";
function Re() {
  let e = (0, Z.c)(1),
    t;
  return (
  ...
  let e = N(),
    ...
    U = u(`reset-codex-command-keybindings`, {
      onSuccess: (e) => {
        ...
        (n.setQueryData(t, e),
          Promise.all([t, te, f(`global-dictation-hotkey-state`)].map((e) => i(e))));
      },
    }),
    W = Ze.filter((e) =>
      F(e.id, {
                          ...
                          children: [
                            ...
                            K.map(({ command: n, title: i }, a) => {
                              let o = H(n, e, q(r, n.id)).description,
                                ...
                                u = S?.commandId === n.id && S.mode === `append`,
                                d = s.length === 0 ? [null] : s,
                                ...
                                Q.Fragment,
                                {
                                  children: f.map((u, d) => {
                                    ...
                                    let h =
                                      ...
                                      (S.mode === `append`
                                        ? u == null && d === s.length
                                        : S.accelerator === (u?.accelerator ?? null));
                                    return (0, $.jsxs)(
                                      `tr`,
                                      {
                                        className:
...
function Be(e) {
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(J, { children: (0, $.jsx)(he, { title: c, subtitle: u }) })), (t[6] = m))
    : (m = t[6]);
  let h;
  t[7] === n
    ? (h = t[8])
    : ((h =
        n == null
          ? null
          : (0, $.jsx)(J, { className: `text-token-error-foreground`, children: n })),
      (t[7] = n),
      (t[8] = h));
  let g;
  t[9] === a
  ...
  t[15] === r
    ? (b = t[16])
    : ((b = (0, $.jsx)(w, { color: `danger`, loading: r, type: `submit`, children: y })),
      (t[15] = r),
      (t[16] = b));
  let x;
  t[17] !== v || t[18] !== b
  ...
  t[20] !== x || t[21] !== d || t[22] !== h
    ? ((S = (0, $.jsxs)(ge, { as: `form`, onSubmit: d, children: [f, p, m, h, x] })),
      (t[20] = x),
      (t[21] = d),
      (t[22] = h),
      (t[23] = S))
      ...
      : ((r = (0, $.jsx)(`span`, {
          ...
          children:
            n == null
              ...
              : (0, $.jsx)(A, { className: `!px-2 !py-1 !text-sm`, keysLabel: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
