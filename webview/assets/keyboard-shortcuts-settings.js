...
import { Fu as te, Pu as ne } from "./app-initial~app-main~onboarding-page.js";
import {
  Jn as re,
  Jt as ie,
  Yn as ae,
...
function Be() {
  let e = g(),
    ...
    { data: N } = A(ve),
    P = v(`set-codex-command-keybinding`, {
      onSuccess: (e, { commandId: t }) => {
        let r = a(`codex-command-keymap-state`);
        n.setQueryData(r, e);
        let i = [r];
        (t === `hotkeyWindow` && i.push(fe),
          (t === `globalDictationHold` || t === `globalDictationToggle`) &&
            i.push(a(`global-dictation-hotkey-state`)),
          Promise.all(i.map((e) => o(e))));
      },
    }),
    F = v(`reset-codex-command-keybindings`, {
      onSuccess: (e) => {
        let t = a(`codex-command-keymap-state`);
        (n.setQueryData(t, e),
          Promise.all([t, fe, a(`global-dictation-hotkey-state`)].map((e) => o(e))));
      },
    }),
    L = $.filter((e) =>
      ue(e.id, {
        modeSwitchAvailable: f,
        isGlobalDictationEnabled: s,
        isHotkeyWindowEnabled: c,
        isProcessManagerEnabled: u,
        isRestrictedCommandEnabled: !1,
        isVoiceInputEnabled: d,
      }),
    )
      .map((t) => ({ command: t, title: K(t, e, C(r, t.id)).title }))
      .sort((e, t) => pe(e.command, t.command)),
    z = p.trim(),
    V =
      z.length === 0
        ? L
        : L.filter(({ command: n, title: i }) => {
            let a = K(n, e, C(r, n.id)).description;
            return h
              ? q(n.id, N, t).some(({ label: e }) => We(e, z))
              : [n.id, i, a].some((e) => B(e, z) > 0);
          });
  return (0, Q.jsxs)(de, {
    title: (0, Q.jsx)(ge, { slug: `keyboard-shortcuts` }),
    children: [
      (0, Q.jsx)(Pe, {
        children: (0, Q.jsxs)(Pe.Content, {
          children: [
            N == null
              ...
              : (0, Q.jsx)(me, {
                  autoFocus: h,
                  isSearchingByKeystrokes: h,
                  trailingContent: (0, Q.jsx)(H, {
                    ...
                    children: (0, Q.jsx)(R, {
                      ...
                      children: (0, Q.jsx)(re, { className: `icon-sm` }),
                    }),
                  }),
                  value: p,
                  onKeyDown: h
                    ? (e) => {
                        ...
                        if (n != null) {
                          let e = J(n, t === `macOS`, t === `linux`),
                            r = p.length === 0 ? e : `${p} ${e}`;
                          m(
                            p.length > 0 &&
                              L.some(({ command: e }) =>
                                q(e.id, N, t).some(({ label: e }) => We(e, r)),
                              )
                              ? r
                              : e,
                          );
                        ...
                        (0, Q.jsxs)(`tbody`, {
                          children: [
                            ...
                            V.map(({ command: n, title: i }, a) => {
                              let o = K(n, e, C(r, n.id)).description,
                                s = q(n.id, N, t),
                                c = N.bindings.some((e) => e.command === n.id),
                                l = Ze({
                                  commandId: n.id,
                                  hasCustomBinding: c,
                                  platform: t,
                                                  ...
                                                  onCapture: (i) => {
                                                    ...
                                                    ((o =
                                                      ...
                                                      Y({
                                                        commandId: n.id,
                                                        intl: e,
                                                        setCommandKeybinding: P,
                                                        setErrorByCommandId: E,
                                                        update: o,
                                                      }).finally(() => {
                                                        x((e) => (e === b ? null : e));
                                                      }));
      ...
      (0, Q.jsx)(Ve, {
        ...
        onConfirm: async () => {
          M(null);
          try {
            (await F.mutateAsync(void 0), k(!1));
          } catch (t) {
            M(
              t instanceof Error
                ? t.message
...
function Ve(e) {
  let t = (0, X.c)(28),
    { error: n, isPending: i, onConfirm: a, onOpenChange: o, open: s } = e,
    c;
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Q.jsx)(p, { className: `sr-only`, children: u })),
      (g = (0, Q.jsx)(D, { className: `sr-only`, children: f })),
      (t[4] = h),
      (t[5] = g))
    : ((h = t[4]), (g = t[5]));
  let _;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, Q.jsx)(G, { children: (0, Q.jsx)(r, { title: u, subtitle: f }) })), (t[6] = _))
    : (_ = t[6]);
  let v;
  t[7] === n
    ? (v = t[8])
  ...
  t[12] === y
    ? (x = t[13])
    : ((x = (0, Q.jsx)(R, { color: `secondary`, onClick: y, children: b })),
      (t[12] = y),
      (t[13] = x));
  let S;
  ...
  t[15] === i
    ? (C = t[16])
    : ((C = (0, Q.jsx)(R, { color: `danger`, loading: i, type: `submit`, children: S })),
      (t[15] = i),
      (t[16] = C));
  let w;
  t[17] !== x || t[18] !== C
    ? ((w = (0, Q.jsx)(G, { children: (0, Q.jsxs)(T, { children: [x, C] }) })),
      (t[17] = x),
      (t[18] = C),
      (t[19] = w))
    : (w = t[19]);
  let O;
  t[20] !== w || t[21] !== m || t[22] !== v
    ? ((O = (0, Q.jsxs)(ee, { as: `form`, onSubmit: m, children: [h, g, _, v, w] })),
      (t[20] = w),
      (t[21] = m),
      (t[22] = v),
      (t[23] = O))
...
function He(e) {
  ...
  t[1] === s
    ? (x = t[2])
    : ((x = (e) => {
        ((f.current += 1), (p.current = null), b(), s(e));
      }),
      (t[1] = s),
      (t[2] = x));
  let S = x,
  ...
  t[3] === o
    ? (C = t[4])
    : ((C = () => {
        ((f.current += 1), (p.current = null), b(), o());
      }),
      (t[3] = o),
      (t[4] = C));
  let w = C,
  ...
  t[10] !== n || t[11] !== k || t[12] !== d
    ...
    : (A = t[13]);
  let j;
  (t[14] !== n || t[15] !== d ? ((j = [n, d]), (t[14] = n), (t[15] = d), (t[16] = j)) : (j = t[16]),
    (0, Z.useEffect)(A, j));
  let M, N;
  ...
  t[29] !== i || t[30] !== u
    ...
    : (L = t[31]);
  let z;
  t[32] !== w || t[33] !== P || t[34] !== F || t[35] !== I || t[36] !== L
    ? ((z = (0, Q.jsx)(`input`, {
...
function Xe(e) {
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Q.jsx)(V, { className: `icon-xs` })), (t[18] = h))
    : (h = t[18]);
  let _;
  ...
  return (
    t[25] !== u || t[26] !== _
      ? ((v = (0, Q.jsx)(H, { tooltipContent: u, children: _ })),
        (t[25] = u),
        (t[26] = _),
        (t[27] = v))
      : (v = t[27]),
...
function Ze({ commandId: e, hasCustomBinding: t, platform: n, shortcutEntries: r }) {
  if (!t) return null;
  let i = we({ commandId: e, isMacOS: n === `macOS` }),
