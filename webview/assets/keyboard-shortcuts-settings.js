...
import { a as _, d as v, i as y, l as b, n as x, r as S, u as C } from "./dialog-layout.js";
import {
  _ as w,
  a as T,
  b as E,
...
import { r as ee, s as N } from "./command-keybindings.js";
import "./links.js";
  ...
  e[4] !== u || e[5] !== s
    ? ((ce = {
        onSuccess: (e) => {
          ...
          (s.setQueryData(t, e),
            Promise.all([t, ie, l(`global-dictation-hotkey-state`)].map((e) => u(e))));
        },
      }),
      (e[4] = u),
      (e[5] = s),
                  ...
                  children: [
                    ...
                    Ce.map((e, r) => {
                      let { command: i, title: a } = e,
                        o = M(i) ? t.formatMessage(V[i.descriptionIntlId]) : null,
                        s = N(i.id, G),
...
function fe(e) {
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, J.jsx)(_, { children: (0, J.jsx)(y, { title: l, subtitle: d }) })), (t[6] = g))
    : (g = t[6]);
  let w;
  t[7] === n
    ? (w = t[8])
    : ((w =
        n == null
          ? null
          : (0, J.jsx)(_, { className: `text-token-error-foreground`, children: n })),
      (t[7] = n),
      (t[8] = w));
  let T;
  t[9] === o
  ...
  t[20] !== A || t[21] !== f || t[22] !== w
    ? ((j = (0, J.jsxs)(x, { as: `form`, onSubmit: f, children: [p, m, g, w, A] })),
      (t[20] = A),
      (t[21] = f),
      (t[22] = w),
      (t[23] = j))
...
function pe(e) {
  ...
  t[10] !== n || t[11] !== M || t[12] !== f
    ...
    : (ee = t[13]);
  let N;
  (t[14] !== n || t[15] !== f ? ((N = [n, f]), (t[14] = n), (t[15] = f), (t[16] = N)) : (N = t[16]),
    (0, q.useEffect)(ee, N));
  let P, F;
...
function he({ accelerator: e, commandId: t, intl: n, isMacOS: r, keymapState: i }) {
  for (let a of se)
    if (a.id !== t && N(a.id, i).some((t) => _e(t.accelerator, e, r))) return W(a, n);
  return null;
}
function ge(e, t, n) {
  return j(e, n) === j(t, n);
...
function be(e) {
  let t = (0, K.c)(28),
    { canAppend: n, commandTitle: i, hasShortcut: a, isPending: o, onStartCapture: s } = e,
    c = r(),
    [l, u] = (0, q.useState)(!1),
    d;
  if (!a) {
