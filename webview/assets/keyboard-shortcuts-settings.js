...
import { t as L } from "./undo-BZSd-eDz.js";
...
function ce() {
  ...
  if (
    ...
    (e[22] === t
      ? (r = e[23])
      : ((r = (e) => ({ command: e, title: W(e, t) })), (e[22] = t), (e[23] = r)),
      ...
      i.length === 0
        ...
        : Z.filter((e) => {
            let { command: n, title: r } = e,
              a = N(n) ? t.formatMessage(V[n.descriptionIntlId]) : ``;
            return S
              ? P(n.id, G).some((e) => {
                  let { label: t } = e;
                  return me(t, i);
                  ...
                  children: [
                    ...
                    Ce.map((e, r) => {
                      let { command: i, title: a } = e,
                        ...
                        l = xe({ commandId: i.id, hasCustomBinding: c, shortcutEntries: s }),
  ...
  e[52] !== t || e[53] !== X
    ...
    : (je = e[54]);
  let $;
  e[55] !== A || e[56] !== L || e[57] !== X.isPending || e[58] !== je
    ? (($ = (0, J.jsx)(fe, {
        error: L,
...
function he({ accelerator: e, commandId: t, intl: n, isMacOS: r, keymapState: i }) {
  for (let a of se)
    if (a.id !== t && P(a.id, i).some((t) => _e(t.accelerator, e, r))) return W(a, n);
  return null;
}
function ge(e, t, n) {
  return M(e, n) === M(t, n);
