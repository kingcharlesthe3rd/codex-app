  ...
  let e = G(),
    ...
    I = f(`reset-codex-command-keybindings`, {
      onSuccess: (e) => {
        ...
        (n.setQueryData(t, e),
          Promise.all([t, Pe, a(`global-dictation-hotkey-state`)].map((e) => i(e))));
      },
    }),
    L = $.filter((e) =>
      se(e.id, {
...
function Ve(e) {
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, Q.jsx)(R, { children: (0, Q.jsx)(te, { title: c, subtitle: u }) })), (t[6] = m))
    : (m = t[6]);
  let h;
  t[7] === n
    ? (h = t[8])
    : ((h =
        n == null
          ? null
          : (0, Q.jsx)(R, { className: `text-token-error-foreground`, children: n })),
      (t[7] = n),
      (t[8] = h));
  let g;
  t[9] === a
  ...
  t[15] === r
    ? (b = t[16])
    : ((b = (0, Q.jsx)(P, { color: `danger`, loading: r, type: `submit`, children: y })),
      (t[15] = r),
      (t[16] = b));
  let x;
  t[17] !== v || t[18] !== b
  ...
  t[20] !== x || t[21] !== d || t[22] !== h
    ? ((S = (0, Q.jsxs)(L, { as: `form`, onSubmit: d, children: [f, p, m, h, x] })),
      (t[20] = x),
      (t[21] = d),
      (t[22] = h),
      (t[23] = S))
...
function He(e) {
  ...
  t[10] !== n || t[11] !== O || t[12] !== u
    ...
    : (k = t[13]);
  let A;
  (t[14] !== n || t[15] !== u ? ((A = [n, u]), (t[14] = n), (t[15] = u), (t[16] = A)) : (A = t[16]),
    (0, Z.useEffect)(k, A));
  let j, M;
  ...
  let V;
  t[41] !== R || t[42] !== B
    ? ((V = (0, Q.jsxs)(`div`, { className: `flex items-center gap-2`, children: [R, B] })),
      (t[41] = R),
      (t[42] = B),
      (t[43] = V))
    : (V = t[43]);
...
function Ge({
  ...
  for (let o of $)
    if (o.id !== t && !m(o.id, t) && D(o.id, r, i).some((t) => qe(t.accelerator, e, i === `macOS`)))
      ...
      : ((r = (0, Q.jsx)(`span`, {
          ...
          children:
            n == null
              ...
              : (0, Q.jsx)(U, { className: `!px-2 !py-1 !text-sm`, keysLabel: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
