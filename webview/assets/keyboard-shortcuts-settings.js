...
import { r as f, t as p } from "./tooltip.js";
import "./x.js";
import "./rpc-2.js";
import { o as m } from "./statsig.js";
import "./platform.js";
import { t as h } from "./invalidate-queries-and-broadcast.js";
import { a as g, d as _, i as v, l as y, n as b, r as x, u as S } from "./dialog-layout-B.js";
import "./with-window.js";
import { t as C } from "./undo.js";
import "./use-os-info.js";
import { t as w } from "./use-platform.js";
import { t as T } from "./pencil.js";
import "./chevron.js";
import { i as E, n as D, t as O } from "./command-menu-state.js";
import {
  _ as k,
  a as A,
  i as j,
...
import { r as L, s as R } from "./command-keybindings.js";
import "./links-p.js";
import { t as z } from "./trash.js";
import { t as B } from "./keyboard.js";
...
import { n as ce, r as W, t as le } from "./keyboard-event-accelerator.js";
var G = i(),
  K = e(t(), 1),
  q = n(),
  ue = I.filter(F);
...
function J() {
  ...
  e[1] !== f || e[2] !== i
    ? ((de = {
        onSuccess: (e, t) => {
          let { commandId: n } = t,
            r = s(`codex-command-keymap-state`);
          i.setQueryData(r, e);
          let a = [r];
      ...
      (e[3] = de))
    : (de = e[3]);
  let J = c(`set-codex-command-keybinding`, de),
    _e;
  e[4] !== f || e[5] !== i
    ? ((_e = {
        onSuccess: (e) => {
      ...
      (e[6] = _e))
    : (_e = e[6]);
  let Y = c(`reset-codex-command-keybindings`, _e),
    Ee,
    X;
  if (
    e[7] !== t ||
    ...
    let r;
    e[20] !== g || e[21] !== _ || e[22] !== v || e[23] !== y || e[24] !== b
      ? ((r = (e) =>
          ne(e.id, {
            modeSwitchAvailable: b,
            isGlobalDictationEnabled: g,
            isHotkeyWindowEnabled: _,
            isProcessManagerEnabled: v,
            isVoiceInputEnabled: y,
          })),
        (e[20] = g),
        (e[21] = _),
        (e[22] = v),
    ...
    let i;
    (e[26] !== t || e[27] !== o
      ? ((i = (e) => ({ command: e, title: U(e, t, D(o, e.id)).title })),
        (e[26] = t),
        (e[27] = o),
        (e[28] = i))
      : (i = e[28]),
      (X = ue.filter(r).map(i).sort(me)));
    let a = x.trim();
    ((Ee =
      a.length === 0
        ? X
        : X.filter((e) => {
            let { command: r, title: i } = e,
              s = U(r, t, D(o, r.id)).description;
            return C
              ? R(r.id, W, n).some((e) => {
                  let { label: t } = e;
                  return ve(t, a);
                })
              : [r.id, i, s].some((e) => V(e, a) > 0);
          })),
      (e[7] = t),
      (e[8] = g),
      (e[9] = _),
  ...
  e[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Oe = (0, q.jsx)(te, { slug: `keyboard-shortcuts` })), (e[29] = Oe))
    : (Oe = e[29]);
  let Z;
  e[30] !== t || e[31] !== C || e[32] !== W || e[33] !== n || e[34] !== x || e[35] !== X
    ? ((Z =
        W == null
          ? null
          : (0, q.jsx)(ie, {
              ...
              onKeyDown: C
                ? (e) => {
                    ...
                    if (t != null) {
                      let e = N(t, n === `macOS`, n === `linux`),
                        r = x.length === 0 ? e : `${x} ${e}`;
                      S(
                        x.length > 0 &&
                          X.some((e) => {
                            let { command: t } = e;
                            return R(t.id, W, n).some((e) => {
                              let { label: t } = e;
                              return ve(t, r);
                            });
                          })
                  ...
                  children: [
                    ...
                    De.map((e, r) => {
                      let { command: i, title: a } = e,
                        s = U(i, t, D(o, i.id)).description,
                        c = R(i.id, W, n),
                        l = W.bindings.some((e) => e.command === i.id),
                        u = we({
                          commandId: i.id,
                          hasCustomBinding: l,
                          platform: n,
                        ...
                        d = A?.commandId === i.id && A.mode === `append`,
                        f = c.length === 0 ? [null] : c,
                        p = d && c.length > 0 ? [...c, null] : f;
                      return (0, q.jsx)(
                        K.Fragment,
                        {
                          children: p.map((e, d) => {
                            ...
                            p.length === 1
                              ...
                              : f
                                ? (m = `px-4 pt-2 pb-0.5`)
                                : d === p.length - 1 && (m = `px-4 pt-0.5 pb-2`);
                            let h =
                              A?.commandId === i.id &&
                              (A.mode === `append`
                                ? e == null && d === c.length
                                : A.accelerator === (e?.accelerator ?? null));
                            return (0, q.jsxs)(
                              `tr`,
                              {
                                className:
                                  ...
                                  (0, q.jsx)(`td`, {
                                    ...
                                    children: h
                                      ? (0, q.jsx)(ge, {
                                          ...
                                          commandTitle: a,
                                          conflictingCommandTitle: A.conflictingCommandTitle,
                                          onCancel: () => {
                                            j(null);
                                          },
                                          onCapture: (r) => {
                                      ...
                                      : (0, q.jsxs)(`div`, {
                                          ...
                                          children: [
                                            (0, q.jsx)(xe, { shortcutLabel: e?.label ?? null }),
                                            (0, q.jsx)(Ce, {
                                              canAppend: !k(i),
                                              commandTitle: a,
                                              hasShortcut: e != null,
  ...
  let Ae;
  e[48] !== Q || e[49] !== ke
    ? ((Ae = (0, q.jsxs)(ae, { className: `overflow-hidden`, children: [Q, ke] })),
      (e[48] = Q),
      (e[49] = ke),
      (e[50] = Ae))
    : (Ae = e[50]);
  let $;
  e[51] !== W || e[52] !== Y.isPending
    ? (($ =
        W != null && W.bindings.length > 0
          ? (0, q.jsx)(`div`, {
  ...
  let je;
  e[54] !== Z || e[55] !== Ae || e[56] !== $
    ? ((je = (0, q.jsx)(oe, { children: (0, q.jsxs)(oe.Content, { children: [Z, Ae, $] }) })),
      (e[54] = Z),
      (e[55] = Ae),
      (e[56] = $),
      (e[57] = je))
  ...
  e[59] !== t || e[60] !== Y
    ? ((Ne = async () => {
        ce(null);
        try {
          (await Y.mutateAsync(void 0), z(!1));
        } catch (e) {
          let n = e;
          ce(
            n instanceof Error
    ...
    : (Ne = e[61]);
  let Pe;
  e[62] !== I || e[63] !== re || e[64] !== Y.isPending || e[65] !== Ne
    ? ((Pe = (0, q.jsx)(he, {
        error: re,
  ...
  return (
    e[67] !== je || e[68] !== Pe
      ? ((Fe = (0, q.jsxs)(H, { title: Oe, children: [je, Pe] })),
        (e[67] = je),
        (e[68] = Pe),
        (e[69] = Fe))
      : (Fe = e[69]),
...
function he(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, q.jsx)(_, { className: `sr-only`, children: c })),
      (h = (0, q.jsx)(S, { className: `sr-only`, children: f })),
      (t[4] = m),
      (t[5] = h))
    : ((m = t[4]), (h = t[5]));
  let C;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (0, q.jsx)(g, { children: (0, q.jsx)(v, { title: c, subtitle: f }) })), (t[6] = C))
    : (C = t[6]);
  let w;
  t[7] === n
    ? (w = t[8])
    : ((w =
        n == null
          ? null
          : (0, q.jsx)(g, { className: `text-token-error-foreground`, children: n })),
      (t[7] = n),
      (t[8] = w));
  let T;
  t[9] === a
  ...
  t[12] === T
    ? (D = t[13])
    : ((D = (0, q.jsx)(d, { color: `secondary`, onClick: T, children: E })),
      (t[12] = T),
      (t[13] = D));
  let O;
  ...
  t[15] === r
    ? (k = t[16])
    : ((k = (0, q.jsx)(d, { color: `danger`, loading: r, type: `submit`, children: O })),
      (t[15] = r),
      (t[16] = k));
  let A;
  t[17] !== D || t[18] !== k
    ? ((A = (0, q.jsx)(g, { children: (0, q.jsxs)(x, { children: [D, k] }) })),
      (t[17] = D),
      (t[18] = k),
      (t[19] = A))
    : (A = t[19]);
  let j;
  t[20] !== A || t[21] !== p || t[22] !== w
    ? ((j = (0, q.jsxs)(b, { as: `form`, onSubmit: p, children: [m, h, C, w, A] })),
      (t[20] = A),
      (t[21] = p),
      (t[22] = w),
      (t[23] = j))
...
function ge(e) {
  ...
  t[1] === c
    ? (S = t[2])
    : ((S = (e) => {
        ((m.current += 1), (h.current = null), x(), c(e));
      }),
      (t[1] = c),
      (t[2] = S));
  let C = S,
  ...
  t[3] === s
    ? (T = t[4])
    : ((T = () => {
        ((m.current += 1), (h.current = null), x(), s());
      }),
      (t[3] = s),
      (t[4] = T));
  let E = T,
  ...
  t[10] !== n || t[11] !== A || t[12] !== p
    ...
    : (M = t[13]);
  let P;
  (t[14] !== n || t[15] !== p ? ((P = [n, p]), (t[14] = n), (t[15] = p), (t[16] = P)) : (P = t[16]),
    (0, K.useEffect)(M, P));
  let ee, F;
  (t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = () => () => {
        (_.current != null && clearTimeout(_.current), (g.current = null));
      }),
      (F = []),
      (t[17] = ee),
      (t[18] = F))
  ...
  let H;
  t[41] !== B || t[42] !== V
    ? ((H = (0, q.jsxs)(`div`, { className: `flex items-center gap-2`, children: [B, V] })),
      (t[41] = B),
      (t[42] = V),
      (t[43] = H))
    : (H = t[43]);
...
function ye({
  ...
  for (let o of ue)
    if (o.id !== t && !M(o.id, t) && R(o.id, r, i).some((t) => Y(t.accelerator, e, i === `macOS`)))
      return U(o, n, D(a, o.id)).title;
  return null;
}
function be(e, t, n) {
  return N(e, n) === N(t, n);
      ...
      : ((r = (0, q.jsx)(`span`, {
          ...
          children:
            n == null
              ...
              : (0, q.jsx)(f, { className: `!px-2 !py-1 !text-sm`, keysLabel: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
        ...
        o && r
          ? (0, q.jsx)(p, {
              ...
              children: (0, q.jsx)(d, {
                ...
                disabled: a,
                onClick: c,
                children: (0, q.jsx)(C, { className: `icon-xs` }),
              }),
            })
          : null),
      (t[11] = r),
...
function Ce(e) {
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, q.jsx)(T, { className: `icon-xs` })), (t[18] = v))
    : (v = t[18]);
  let y;
  t[19] !== a || t[20] !== f || t[21] !== m || t[22] !== h || t[23] !== _
    ? ((y = (0, q.jsx)(d, {
        "aria-label": f,
  ...
  return (
    t[25] !== f || t[26] !== y
      ? ((b = (0, q.jsx)(p, { tooltipContent: f, children: y })),
        (t[25] = f),
        (t[26] = y),
        (t[27] = b))
      : (b = t[27]),
...
function we({ commandId: e, hasCustomBinding: t, platform: n, shortcutEntries: r }) {
  if (!t) return null;
  let i = P({ commandId: e, isMacOS: n === `macOS` }),
...
export { de as KeyboardShortcutsSettings };
