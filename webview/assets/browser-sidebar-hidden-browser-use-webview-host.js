...
import { Er as o } from "./thread-context-inputs.js";
import "./vscode-api.js";
import "./isEqual.js";
import { ei as s, hi as c } from "./src.js";
import "./react-dom.js";
import "./lib-1.js";
...
import { t as h } from "./browser-sidebar-manager.js";
import { r as g, t as _ } from "./app-shell-tab-controller.js";
import "./focus-composer.js";
import "./thread-panel-state.js";
import { i as v } from "./thread-browser-panel-tabs.js";
import { t as y } from "./browser-sidebar-webview-B.js";
var b = r(),
  x = e(t(), 1),
  S = n();
function C(e) {
  ...
  let F = (0, x.useSyncExternalStore)(N, P, w),
    ...
    L = (A && j) || F > 0,
    R;
  t[6] !== m || t[7] !== h || t[8] !== r || t[9] !== I || t[10] !== L
    ? ((R = new Set(v(r, { bottom: m, right: h }, { bottom: I, right: L }))),
      (t[6] = m),
      (t[7] = h),
      (t[8] = r),
      (t[9] = I),
  ...
  if (t[12] !== n || t[13] !== r || t[14] !== z) {
    ...
    bb0: {
      ...
      let i = n.split(`\0`).map(c).filter(e);
      if (i.length === 0) {
        V = null;
        break bb0;
      }
...
function E(e) {
  let t = (0, b.c)(8),
    ...
    o;
  t[0] !== n || t[1] !== r
    ? ((o = () => h.getSnapshot(r, n)), (t[0] = n), (t[1] = r), (t[2] = o))
    : (o = t[2]);
  let c = (0, x.useSyncExternalStore)(h.subscribe, o, D);
  if (c != null && c.tabType !== s.WEB) return null;
