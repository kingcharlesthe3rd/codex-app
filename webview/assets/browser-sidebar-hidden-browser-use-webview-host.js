...
import { eo as k } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~pull-requests-page~plug~kmtatxxf.js";
function A(e) {
  let t = (0, F.c)(25),
  ...
  t[0] === m
    ? ((_ = t[1]), (x = t[2]))
    : ((_ = (e) => m.on(`change`, e)), (x = () => m.get()), (t[0] = m), (t[1] = _), (t[2] = x));
...
var F, I, L;
e(() => {
  ((F = r()), a(), l(), (I = t(i(), 1)), D(), p(), _(), m(), k(), x(), T(), (L = n()));
})();
