...
import { Zi as D } from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~projects-index-page~app~iy8s9c2d.js";
import { Cu as O, Su as k } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
function A(e) {
  let t = (0, F.c)(25),
  ...
  t[0] === v
    ? ((b = t[1]), (S = t[2]))
    : ((b = (e) => v.on(`change`, e)), (S = () => v.get()), (t[0] = v), (t[1] = b), (t[2] = S));
  ...
  t[3] === E
    ? ((O = t[4]), (k = t[5]))
    : ((O = (e) => E.on(`change`, e)), (k = () => E.get()), (t[3] = E), (t[4] = O), (t[5] = k));
  ...
  if (t[12] !== r || t[13] !== i || t[14] !== a || t[15] !== B) {
    ...
    bb0: {
      ...
      (t[20] !== i || t[21] !== a
        ? ((o = (e) =>
            (0, L.jsx)(N, { browserTabId: e, conversationId: i, persistedTabsEnabled: a }, e)),
          (t[20] = i),
          (t[21] = a),
          (t[22] = o))
        : (o = t[22]),
    ...
    ((t[12] = r), (t[13] = i), (t[14] = a), (t[15] = B), (t[16] = V), (t[17] = H));
  } else ((V = t[16]), (H = t[17]));
...
var F, I, L;
e(() => {
  ((F = c()), i(), r(), (I = t(o(), 1)), E(), p(), S(), C(), T(), v(), O(), (L = l()));
})();
