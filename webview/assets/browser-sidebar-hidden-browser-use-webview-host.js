...
import { ni as o } from "./app-server-manager-signals.js";
import "./vscode-api.js";
import "./isEqual.js";
import { $r as s, Rr as c } from "./src-2.js";
import "./react-dom.js";
import "./lib.js";
...
import { i as v } from "./thread-browser-panel-tabs-CU-ZDBn5.js";
...
function C(e) {
  let t = (0, b.c)(23),
    { browserUseTabIdsKey: n, conversationId: a } = e,
    c = r(o, a),
    m = i(g.activeTab$),
    _ = i(h.activeTab$),
    y = i(f),
  ...
  let F = (0, x.useSyncExternalStore)(N, P, w),
    ...
    L = (A && j) || F > 0,
    R;
  t[6] !== m || t[7] !== _ || t[8] !== a || t[9] !== I || t[10] !== L
    ? ((R = new Set(v(a, { bottom: m, right: _ }, { bottom: I, right: L }))),
      (t[6] = m),
      (t[7] = _),
      (t[8] = a),
      (t[9] = I),
  ...
  if (t[12] !== n || t[13] !== a || t[14] !== z) {
    ...
    bb0: {
      ...
      (t[19] === a
        ? (i = t[20])
        : ((i = (e) => (0, S.jsx)(E, { browserTabId: e, conversationId: a }, e)),
          (t[19] = a),
          (t[20] = i)),
        (B = r.map(i)));
    }
    ((t[12] = n), (t[13] = a), (t[14] = z), (t[15] = B), (t[16] = V));
  } else ((B = t[15]), (V = t[16]));
