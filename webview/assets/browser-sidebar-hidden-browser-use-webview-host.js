...
import "./isEqual.js";
import { Mr as o, qr as s } from "./src-4.js";
import { bi as c } from "./app-server-manager-signals.js";
import "./react-dom.js";
import "./lib-1.js";
...
import { t as y } from "./browser-sidebar-webview-ClG6-uOl.js";
var b = r(),
  x = e(t(), 1),
  S = n();
function C(e) {
...
function E(e) {
  let t = (0, b.c)(8),
    ...
    s;
  t[0] !== n || t[1] !== r
    ? ((s = () => _.getSnapshot(r, n)), (t[0] = n), (t[1] = r), (t[2] = s))
    : (s = t[2]);
  let c = (0, x.useSyncExternalStore)(O, s, D);
  if (c != null && c.tabType !== o.WEB) return null;
