...
import { Dr as n, E as r, Qi as i } from "./app-server-manager-signals.js";
...
import { _ as ne, g as D } from "./use-plugins.js";
...
import { f as A } from "./inline-mentions-C8jF-sc9.js";
import { t as j } from "./workspace-file-context-menu.js";
import { t as ae } from "./copy.js";
import { t as M } from "./image-preview-dialog.js";
import { t as N } from "./pull-request-open.js";
import { a as P, c as oe, i as se, n as ce, o as le, r as ue } from "./prompt-editor.js";
import { n as de } from "./attachment-remove-button.js";
import { c as fe, l as pe, n as F, r as I, t as me } from "./mention-metadata-syncer.js";
import { t as he } from "./use-enter-behavior.js";
import { d as L } from "./hooks-settings-model.js";
import { t as R } from "./at-mention-list.js";
import { i as z } from "./use-composer-controller.js";
import { t as B } from "./anchored-autocomplete-overlay.js";
import { t as ge } from "./use-autocomplete-overlay-placement.js";
...
function be(e) {
  ...
  t[6] === s
    ? (d = t[7])
    : ((d = (0, W.jsx)(T, { "aria-label": s, color: `ghost`, size: `icon`, children: u })),
      (t[6] = s),
      (t[7] = d));
  let f;
  return (
...
function Se(e, t) {
  return (0, W.jsxs)(
    `li`,
    {
      className: `contents`,
      children: [
        (0, W.jsx)(`span`, { className: `text-token-text-secondary`, children: we(e.kind) }),
        (0, W.jsx)(`span`, {
...
function Oe(e) {
  ...
  t[0] !== o || t[1] !== n
    ? ((s = { text: n, collapsedLineCount: o, fallbackFontSizePx: 13 }),
      ...
      (t[2] = s))
    : (s = t[2]);
  let { setTextContentMeasurementRef: c, collapseState: l, handleToggleExpansion: u } = V(s),
    f;
  t[3] !== l || t[4] !== o
    ? ((f = l === `collapsed` ? { ...De, maxHeight: `${o}lh`, WebkitLineClamp: o } : void 0),
      (t[3] = l),
      (t[4] = o),
      (t[5] = f))
    : (f = t[5]);
  ...
  t[6] !== r || t[7] !== i || t[8] !== c || t[9] !== f || t[10] !== n
    ? ((p = (0, W.jsx)(`div`, {
        ...
        children: (0, W.jsx)(ve, { ref: c, cwd: r, hostId: i, style: f, text: n }),
      })),
      (t[6] = r),
      (t[7] = i),
      (t[8] = c),
        ...
        l === `uncollapsible`
          ...
          : (0, W.jsxs)(`button`, {
              ...
              children: [
                ...
                (0, W.jsx)(k, { className: l === `expanded` ? `icon-2xs rotate-180` : `icon-2xs` }),
              ],
            })),
      (t[12] = l),
      (t[13] = u),
  ...
  return (
    t[15] !== p || t[16] !== m
      ? ((h = (0, W.jsxs)(`div`, { className: `flex flex-col items-end gap-1`, children: [p, m] })),
        (t[15] = p),
        (t[16] = m),
        (t[17] = h))
      : (h = t[17]),
...
function Me(e) {
  ...
  let l;
  t[2] !== a || t[3] !== i || t[4] !== r
    ? ((l = Ae({ intl: a, sentAtMs: r, now: i == null ? new Date() : new Date(i) })),
      (t[2] = a),
      (t[3] = i),
      (t[4] = r),
      (t[5] = l))
...
function q(e) {
  ...
  let Te = we,
    Ee;
  t[12] !== L || t[13] !== B || t[14] !== G || t[15] !== O || t[16] !== F || t[17] !== k
    ? ((Ee = () => {
        (O != null &&
          k != null &&
          B.submitCodexAnalyticsEvent?.({
  ...
  t[21] !== o || t[22] !== A || t[23] !== ge || t[24] !== V || t[25] !== j
    ? ((Ae = V
        ? (0, W.jsx)(Oe, { text: ge, cwd: A ?? null, hostId: j, collapsedLineCount: o })
        : (0, W.jsx)(`div`, {
  ...
  t[42] === Fe
    ? (X = t[43])
    : ((X = s(`flex flex-row-reverse items-center gap-1`, Fe)), (t[42] = Fe), (t[43] = X));
  let Ie;
  t[44] !== h || t[45] !== g
    ? ((Ie =
        h == null
          ...
          ? (0, W.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, W.jsxs)(`div`, {
                  ...
                  children: [
                    _ == null ? null : (0, W.jsx)(be, { stats: _, threadDetailLevel: v }),
                    me
                      ? (0, W.jsx)(S, {
  ...
  t[82] !== Ve ||
  t[83] !== He
    ? (($ = (0, W.jsxs)(`div`, { className: X, children: [Ie, Z, Le, Re, ze, Q, Be, Ve, He] })),
      (t[74] = X),
      (t[75] = Ie),
      (t[76] = Z),
      (t[77] = Le),
...
function J(e) {
  ...
  return (
    t[5] !== r || t[6] !== i
      ? ((a = (0, W.jsx)(`span`, { className: i, ...r })), (t[5] = r), (t[6] = i), (t[7] = a))
      : (a = t[7]),
    a
  );
}
...
function Z(e) {
  let t = (0, H.c)(7),
    ...
    a;
  if (t[0] !== n || t[1] !== r) {
    let e = X.default.ansiToJson(Fe(ze(n)), { json: !0, remove_empty: !0, use_classes: !0 });
...
function Q(e) {
  ...
  return (
    t[11] !== n || t[12] !== h
      ? ((g = (0, W.jsx)(O, { getItems: h, children: n })), (t[11] = n), (t[12] = h), (t[13] = g))
      : (g = t[13]),
    g
  );
}
function Be(e) {
  let t = (0, H.c)(25),
    ...
    [u, d] = (0, U.useState)(!1),
    f;
  t[0] === n ? (f = t[1]) : ((f = () => (D(n) == null ? n : null)), (t[0] = n), (t[1] = f));
...
function Ve(e) {
  ...
  let _ = g,
    y;
  t[5] !== _ || t[6] !== s
    ? ((y = [`local-user-appshot-screenshot-data-url`, s, _]), (t[5] = _), (t[6] = s), (t[7] = y))
    : (y = t[7]);
  let b;
  t[8] !== _ || t[9] !== s || t[10] !== o
    ? ((b = () => ne(_, s, o)), (t[8] = _), (t[9] = s), (t[10] = o), (t[11] = b))
    : (b = t[11]);
  let x = _ != null,
    S;
  t[12] !== y || t[13] !== b || t[14] !== x
    ? ((S = { queryKey: y, queryFn: b, enabled: x, gcTime: 1 / 0, staleTime: h.INFINITE }),
      (t[12] = y),
      (t[13] = b),
      (t[14] = x),
      (t[15] = S))
  ...
  let re;
  t[20] !== T || t[21] !== E
    ? ((re = { params: T, queryConfig: E, select: He }), (t[20] = T), (t[21] = E), (t[22] = re))
    : (re = t[22]);
...
function $(e) {
  ...
  t[20] === f
    ? (p = t[21])
    : ((p = (0, W.jsx)(`span`, { className: `inline-flex max-w-full`, children: f })),
      (t[20] = f),
      (t[21] = p));
  let m;
  return (
...
export { Q as a, Me as c, Ue as i, be as l, Be as n, Z as o, $ as r, q as s, Ve as t };
