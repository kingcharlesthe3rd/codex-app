...
import { vt as l } from "./use-host-config-C.js";
import { I as u, Ir as d, V as f, j as p } from "./thread-context-inputs.js";
import { A as m, h, l as g, n as _, o as v, s as y, u as b, v as ee } from "./vscode-api.js";
import { Aa as x, Ta as S } from "./src-1.js";
...
import { t as Ae } from "./image-preview-dialog.js";
import { t as je } from "./copy.js";
import { i as Me } from "./use-composer-controller.js";
import { t as Ne } from "./at-mention-list.js";
import { t as Pe } from "./anchored-autocomplete-overlay.js";
import { n as Fe } from "./prompt-editor-DCa--dg4.js";
  ...
  t[0] !== oe || t[1] !== ae || t[2] !== S || t[3] !== V || t[4] !== w
    ? ((de = () => {
        (S != null &&
          ...
          navigator.clipboard.writeText(d(V)).then(() => {
    ...
    ? ((De =
        f == null
          ...
          : (0, $.jsxs)(`div`, {
              ...
              children: [p, (0, $.jsx)(st, { children: f })],
            })),
      (t[56] = f),
      (t[57] = p),
      (t[58] = De))
...
function qt(e) {
  ...
  let l = o(Se, c),
    ...
    d;
  t[3] === u ? (d = t[4]) : ((d = le(u)), (t[3] = u), (t[4] = d));
  let p = d,
    h;
  t[5] !== p || t[6] !== s
