...
import { Z as i, _ as a, a as o, o as s, s as c } from "./app-scope-CWE-zIhQ.js";
import { vt as l } from "./use-host-config.js";
import { A as u, B as d, F as f, Fr as p } from "./thread-context-inputs.js";
import { A as m, h, l as g, n as _, o as v, s as y, u as b, v as ee } from "./vscode-api.js";
import { Aa as x, Ta as S } from "./src-3.js";
import { l as C, n as w, r as T, s as E } from "./lib-1.js";
...
import { n as F } from "./base64.js";
import { t as I } from "./request.js";
import { t as L } from "./chevron.js";
import { t as te } from "./warning.js";
import { t as R } from "./v4.js";
import { r as ne } from "./product-logger.js";
import { f as re, h as z, m as B } from "./persisted-signal.js";
import { a as V, t as H } from "./open-workspace-file.js";
import { n as ie } from "./use-webview-execution-target.js";
import { t as ae } from "./use-service-tier-settings.js";
import { n as U, t as W } from "./prompt-text.js";
import { t as G } from "./use-collaboration-mode.js";
import { c as oe } from "./use-permissions-mode.js";
import { t as se } from "./thread-detail-level.js";
import { t as K } from "./browser-sidebar-availability.js";
import { _ as ce, g as le } from "./use-plugins.js";
import { r as ue } from "./app-shell-tab-controller.js";
import { t as de } from "./download.js";
import { t as fe } from "./pencil.js";
import { m as pe } from "./inline-mentions.js";
import { t as me } from "./workspace-file-context-menu.js";
import { r as q, t as he } from "./dropdown.js";
import { t as ge } from "./pull-request-open.js";
import { a as _e, c as J, i as ve, n as ye, r as be, t as xe } from "./composer-controller.js";
import {
  _ as Y,
  b as Se,
  g as Ce,
...
import { t as ke } from "./use-enter-behavior.js";
import { d as X } from "./hooks-settings-model.js";
import { t as Ae } from "./image-preview-dialog-Bb-vTCJ6.js";
import { t as je } from "./copy.js";
import { i as Me } from "./use-composer-controller.js";
import { t as Ne } from "./at-mention-list-1.js";
import { t as Pe } from "./anchored-autocomplete-overlay.js";
import { n as Fe } from "./prompt-editor.js";
import { n as Ie } from "./thread-right-panel-state.js";
import { t as Le } from "./annotate.js";
import { t as Re } from "./use-autocomplete-overlay-placement.js";
import { t as ze } from "./use-measured-text-collapse.js";
import { t as Be } from "./hooks.js";
import { t as Ve } from "./user-formatted-text.js";
import { n as He } from "./hooks-settings-copy.js";
var Z = i(),
  Q = e(n(), 1),
  $ = r();
function Ue(e) {
  ...
  let s = o,
    c;
  t[2] !== a || t[3] !== n
    ? ((c = a ? (0, $.jsx)(Ke, { stats: n }) : (0, $.jsx)(We, { stats: n })),
      (t[2] = a),
      (t[3] = n),
      (t[4] = c))
    : (c = t[4]);
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(Be, { className: `icon-xs` })), (t[5] = l))
    : (l = t[5]);
  let u;
  t[6] === s
    ? (u = t[7])
    : ((u = (0, $.jsx)(O, { "aria-label": s, color: `ghost`, size: `icon`, children: l })),
      (t[6] = s),
      (t[7] = u));
  let d;
  return (
...
function We(e) {
  ...
  t[2] === n.count
    ...
    : ((a = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(w, { value: n.count }),
      })),
      (t[2] = n.count),
      (t[3] = a));
  let o;
        ...
        n.blockedCount > 0
          ? (0, $.jsxs)($.Fragment, {
              children: [
                ...
                (0, $.jsx)(`span`, {
                  className: `text-right text-token-text-primary`,
                  children: (0, $.jsx)(w, { value: n.blockedCount }),
                }),
              ],
            })
          : null),
        ...
        n.errorCount > 0
          ? (0, $.jsxs)($.Fragment, {
              children: [
                ...
                (0, $.jsx)(`span`, {
                  className: `text-right text-token-text-primary`,
                  children: (0, $.jsx)(w, { value: n.errorCount }),
                }),
              ],
            })
          : null),
...
function Ge(e, t) {
  return (0, $.jsxs)(
    `li`,
    {
      className: `contents`,
      children: [
        (0, $.jsx)(`span`, { className: `text-token-text-secondary`, children: Je(e.kind) }),
        (0, $.jsx)(`span`, {
...
function qe(e, t) {
  return (0, $.jsx)(
    `span`,
    { className: Ye(e.tone), children: e.text },
...
function Xe(e) {
  return (0, $.jsx)(E, {
    ...
    values: { source: X([e]) ?? `unknown` },
  });
}
var Ze = 20,
  Qe = { display: `-webkit-box`, overflow: `hidden`, WebkitBoxOrient: `vertical` };
function $e(e) {
  let t = (0, Z.c)(22),
    ...
    d;
  t[0] !== u || t[1] !== l
    ? ((d = u ? (z(l.value) ?? void 0) : void 0), (t[0] = u), (t[1] = l), (t[2] = d))
    : (d = t[2]);
  let f = d,
    p;
  t[3] !== o || t[4] !== n
    ? ((p = { text: n, collapsedLineCount: o, fallbackFontSizePx: 13 }),
      (t[3] = o),
      (t[4] = n),
      (t[5] = p))
    : (p = t[5]);
  let { setTextContentMeasurementRef: m, collapseState: h, handleToggleExpansion: g } = ze(p),
    _;
  t[6] !== h || t[7] !== o
    ? ((_ = h === `collapsed` ? { ...Qe, maxHeight: `${o}lh`, WebkitLineClamp: o } : void 0),
      (t[6] = h),
      (t[7] = o),
      (t[8] = _))
    : (_ = t[8]);
  let v;
  t[9] !== r || t[10] !== f || t[11] !== i || t[12] !== m || t[13] !== _ || t[14] !== n
    ? ((v = (0, $.jsx)(`div`, {
        className: `text-size-chat relative w-full min-w-0`,
        children: (0, $.jsx)(Ve, {
          ref: m,
          cwd: r,
          externalLinkContextMenuConversationId: f,
          hostId: i,
          style: _,
          text: n,
        }),
        ...
        h === `uncollapsible`
          ...
          : (0, $.jsxs)(`button`, {
              ...
              children: [
                ...
                (0, $.jsx)(L, { className: h === `expanded` ? `icon-2xs rotate-180` : `icon-2xs` }),
              ],
            })),
      (t[16] = h),
      (t[17] = g),
  ...
  return (
    t[19] !== v || t[20] !== y
      ? ((b = (0, $.jsxs)(`div`, { className: `flex flex-col items-end gap-1`, children: [v, y] })),
        (t[19] = v),
        (t[20] = y),
        (t[21] = b))
      : (b = t[21]),
...
var et = 7;
function tt({ intl: e, sentAtMs: t, now: n }) {
  let r = new Date(t),
    i = nt(r, n);
  return i === 0
...
function rt(e) {
  ...
  t[0] === n
    ? (o = t[1])
    : ((o = D(`text-xs text-token-text-tertiary`, n)), (t[0] = n), (t[1] = o));
  let s;
  t[2] !== a || t[3] !== i || t[4] !== r
    ? ((s = tt({ intl: a, sentAtMs: r, now: i == null ? new Date() : new Date(i) })),
      (t[2] = a),
      (t[3] = i),
      (t[4] = r),
      (t[5] = s))
...
function it({ cwd: e, hostId: t, initialMessage: n, onCancel: r, onDraftChange: i, onSubmit: a }) {
  let o = C(),
    { enterBehavior: s } = ke(),
    c = (0, Q.useRef)(null),
    [l] = (0, Q.useState)(() => {
  ...
  let u = (0, Q.useMemo)(() => {
    ...
    d = be(l),
    f = ye(l),
    p = Re({ anchorRef: c, isActive: d.ui?.active ?? !1 }),
    m = Re({ anchorRef: c, isActive: f.ui?.active ?? !1 }),
    [h, g] = (0, Q.useState)(!1),
    _ = (0, Q.useEffectEvent)(() => {
      i(l.getText());
    });
  (0, Q.useEffect)(() => Me(l.view, _), [l]);
  let v = async () => {
    if (!h) {
      g(!0);
      try {
        ...
        (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(ve, {
            ...
            onSuggestionHandler: (e) => {
              _e(e, { onAtMention: d.handleMentionEvent, onSkillMention: f.handleMentionEvent });
            },
            onSubmit: () => {
              v();
            },
...
function ot(e) {
  let t = (0, Z.c)(93),
    {
      ...
      hookStats: m,
      threadDetailLevel: h,
      referencesPriorConversation: g,
      reviewMode: _,
      pullRequestFixMode: v,
      autoResolveSync: y,
      hasExternalAttachments: b,
      commentCount: ee,
      onEditMessage: x,
      threadId: S,
      turnId: w,
    ...
    B = l(n),
    V = B.trim(),
    H = x != null && w != null && !B.startsWith(`PLEASE IMPLEMENT THIS PLAN:`),
    [ie, ae] = (0, Q.useState)(!1),
    U = o(at, w),
    W = H && U != null,
    G = C(),
    oe = c(ne),
    se = B.startsWith(`PLEASE IMPLEMENT THIS PLAN:`)
      ? G.formatMessage({
    ...
    ue = ce || d != null || !N,
    de;
  t[0] !== oe || t[1] !== ae || t[2] !== S || t[3] !== V || t[4] !== w
    ? ((de = () => {
        (S != null &&
          w != null &&
          ...
          navigator.clipboard.writeText(p(V)).then(() => {
            (ae(!0), setTimeout(() => ae(!1), 1500));
          }));
      }),
      (t[0] = oe),
      (t[1] = ae),
  ...
  let ge = he,
    _e;
  t[12] !== U || t[13] !== oe || t[14] !== q || t[15] !== S || t[16] !== V || t[17] !== w
    ? ((_e = () => {
        (S != null &&
          w != null &&
          oe.submitCodexAnalyticsEvent?.({
  ...
  let ye = ve,
    be;
  t[21] !== i || t[22] !== T || t[23] !== se || t[24] !== K || t[25] !== k
    ? ((be = K
        ? (0, $.jsx)($e, { text: se, cwd: T ?? null, hostId: k, collapsedLineCount: i })
        : (0, $.jsx)(`div`, {
      ...
      ? ((n = ie
          ...
          : (0, $.jsx)(j, {
              ...
              children: (0, $.jsx)(O, {
                ...
                onClick: pe,
                children: (0, $.jsx)(je, { className: `icon-xs` }),
              }),
            })),
        (t[44] = pe),
        (t[45] = G),
        ...
        : le
          ? (0, $.jsx)(`div`, {
              ...
              "aria-label": H
                ...
                : void 0,
              onKeyDown: H ? ye : void 0,
              onDoubleClick: H ? J : void 0,
              children: xe,
            })
          : null),
      (t[27] = H),
  ...
  let Ce = Se,
    we;
  t[48] !== N || t[49] !== Y || t[50] !== K || t[51] !== W || t[52] !== Ce
    ? ((we =
        N && K && !W
          ? (0, $.jsxs)(`div`, {
  ...
  t[54] === Te
    ? (Ee = t[55])
    : ((Ee = D(`flex flex-row-reverse items-center gap-1`, Te)), (t[54] = Te), (t[55] = Ee));
  let De;
  t[56] !== d || t[57] !== f
    ? ((De =
        d == null
          ...
          : (0, $.jsxs)(`div`, {
              ...
              children: [f, (0, $.jsx)(st, { children: d })],
            })),
      (t[56] = d),
      (t[57] = f),
      (t[58] = De))
          ...
          ? (0, $.jsxs)(`div`, {
              ...
              children: [
                r == null
                  ...
                  : (0, $.jsx)(`span`, {
                      className: `opacity-0 group-focus-within:opacity-100 group-hover:opacity-100`,
                      children: (0, $.jsx)(rt, { sentAtMs: r }),
                    }),
                (0, $.jsxs)(`div`, {
                  className: `flex items-center gap-1`,
                  children: [
                    m == null ? null : (0, $.jsx)(Ue, { stats: m, threadDetailLevel: h }),
                    Y,
                    H
                      ? (0, $.jsx)(j, {
                          tooltipContent: (0, $.jsx)(E, {
  ...
  t[87] !== Me ||
  t[88] !== Ne
    ? ((Pe = (0, $.jsxs)(`div`, { className: Ee, children: [De, Oe, ke, X, Ae, Me, Ne] })),
      (t[81] = Ee),
      (t[82] = De),
      (t[83] = Oe),
      (t[84] = ke),
...
function st(e) {
  ...
  t[3] === n
    ? (i = t[4])
    : ((i = D(`text-token-description-foreground text-xs`, n)), (t[3] = n), (t[4] = i));
  let a;
  return (
    t[5] !== r || t[6] !== i
      ? ((a = (0, $.jsx)(`span`, { className: i, ...r })), (t[5] = r), (t[6] = i), (t[7] = a))
      : (a = t[7]),
    a
  );
}
...
function ft(e) {
  let t = (0, Z.c)(7),
    ...
    a;
  if (t[0] !== n || t[1] !== r) {
    let e = ut.default.ansiToJson(lt(ht(n)), { json: !0, remove_empty: !0, use_classes: !0 });
    ((i = r), (a = e.map(pt)), (t[0] = n), (t[1] = r), (t[2] = i), (t[3] = a));
  } else ((i = t[2]), (a = t[3]));
  let o;
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, $.jsx)(`code`, { className: i, children: a })),
        (t[4] = i),
        (t[5] = a),
        (t[6] = o))
      : (o = t[6]),
...
function pt(e, t) {
  return (0, $.jsx)(
    `span`,
    {
      className: D(e.fg != null && `${e.fg}-fg`, e.bg != null && `${e.bg}-bg`),
      style: mt(e),
      children: e.content,
    },
    `${t}-${e.content}`,
...
function gt(e) {
  let t = (0, Z.c)(14),
    ...
    f = s(re),
    p;
  t[0] !== r || t[1] !== i || t[2] !== a || t[3] !== o || t[4] !== c || t[5] !== d || t[6] !== u
    ? ((p = { column: r, cwd: i, endLine: a, hostId: o, line: c, openInSidePanel: d, path: u }),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a),
      (t[3] = o),
  ...
  let m = p,
    h;
  t[8] !== m || t[9] !== f
    ? ((h = () => me(f, m)), (t[8] = m), (t[9] = f), (t[10] = h))
    : (h = t[10]);
  let g;
  return (
    t[11] !== n || t[12] !== h
      ? ((g = (0, $.jsx)(M, { getItems: h, children: n })), (t[11] = n), (t[12] = h), (t[13] = g))
      : (g = t[13]),
    g
  );
}
...
function Ot({ alt: e, attachmentSrc: t, referrerPolicy: n, src: r, downloadSrc: i = r }) {
  let a = s(re),
    c = B(a.value),
    l = m(),
    u = C(),
    ...
    p = ie(c),
    { activeMode: h } = G(c),
    { agentMode: g, shouldSendPermissionOverrides: _ } = oe({
      conversationId: c,
      hostId: p.hostId,
    }),
    { serviceTierSettings: v } = ae(c),
    [y, b] = (0, Q.useState)(!1),
    ee = t.trim().length > 0 && c != null && p.cwd != null,
    x = jt(r, e),
    S = le(t),
    w = async (e) => {
      if (!(!ee || c == null || p.cwd == null)) {
        b(!0);
        try {
          await kt({
            scope: a,
            ...
            shouldSendPermissionOverrides: _,
            activeCollaborationMode: h,
            prompt: u.formatMessage(
              {
                id: `imageSidePanel.resizePrompt`,
                defaultMessage: `Make the aspect ratio {aspectRatio}`,
                description: `Instruction sent when the user resizes an image from the image side panel.`,
              },
              { aspectRatio: e },
            ),
          });
        } catch (e) {
          a.get(N).danger(Te(e, u));
        } finally {
          b(!1);
        }
      }
    ...
    D = async (e) => {
      if ((e.preventDefault(), S == null)) {
        if (await wt({ downloadSrc: i, suggestedFilename: x })) return;
        T();
        return;
      }
      let t = await ce(S, f, l);
      if (t == null) {
        T();
        return;
      }
      (await wt({ downloadSrc: t, suggestedFilename: x })) || T();
    };
  return (0, $.jsxs)(`div`, {
    className: `flex h-full min-h-0 flex-col bg-token-bg-primary`,
    children: [
      (0, $.jsx)(`div`, {
      ...
      (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsxs)(`div`, {
          className: `flex h-12 w-fit items-center gap-1.5 rounded-full bg-token-editor-background/95 py-1 pr-2 pl-1.5 shadow-[0_0_52.5px_rgba(0,0,0,0.05)] ring-1 ring-black/5 backdrop-blur-sm`,
          children: [
            (0, $.jsxs)(O, {
              color: `ghostActive`,
              disabled: !0,
              ...
              children: [
                ...
                (0, $.jsx)(E, {
                  ...
                  description: `Disabled toolbar action for commenting on the current image.`,
                }),
              ],
            }),
            (0, $.jsx)(he, {
              ...
              children: Dt.map(({ icon: e, label: t, ratio: n }) =>
                (0, $.jsx)(
                  q.Item,
                  {
                    LeftIcon: e,
                    ...
                    children: (0, $.jsxs)(`span`, {
                      ...
                      children: [
                        (0, $.jsx)(E, { ...t }),
                        (0, $.jsx)(`span`, { className: `text-token-text-tertiary`, children: n }),
                      ],
                    }),
                  },
                  n,
            ...
            (0, $.jsx)(`a`, {
              className: `no-drag flex aspect-square h-token-button-composer cursor-interaction items-center justify-center gap-1 rounded-full border border-token-border border-transparent p-0 whitespace-nowrap !text-token-foreground select-none visited:!text-token-foreground hover:bg-token-list-hover-background hover:!text-token-foreground focus:!text-token-foreground focus:outline-none`,
              href: i,
              download: x,
...
async function kt({
  ...
  await Ee({
    scope: e,
    manager: f(e, t) ?? e.get(u),
    hostId: n,
    context: At({ attachmentSrc: r, prompt: l }),
...
function At({ attachmentSrc: e, prompt: t }) {
  return {
    prompt: t,
    addedFiles: [],
    fileAttachments: [],
...
function jt(e, t) {
  let n = Mt(e),
    r = t.trim().length > 0 ? t.trim() : (n ?? `image`);
  return Nt(r) == null ? `${r}.${Nt(n ?? e) ?? `png`}` : r;
}
function Mt(e) {
  if (e.startsWith(`data:`)) return null;
  let t = e.split(/[?#]/, 1)[0].split(/[\\/]/).at(-1);
...
function Nt(e) {
  let t = e.match(/\.([a-z0-9]+)$/i)?.[1] ?? /^data:image\/([a-z0-9.+-]+)[;,]/i.exec(e)?.[1];
  return t == null ? null : t.toLowerCase() === `jpeg` ? `jpg` : t.toLowerCase();
}
function Pt(e, { title: t, ...n }) {
  return P(e, `120995366`)
    ? (ue.openTab(e, Ot, {
        icon: (0, Q.createElement)(_t, { className: `icon-xs shrink-0` }),
...
var Ft = S({ base64: x(), contentType: x().optional() });
function It(e) {
...
function Rt(e, t) {
  ...
  n[5] !== e || n[6] !== t
    ? ((o = async () => {
        ...
        try {
          ...
          let a = t == null ? await Ht(n) : await t.getDownloadRequest(n);
  ...
  let s;
  n[8] !== r || n[9] !== a || n[10] !== o
    ? ((s = { enabled: r, queryKey: a, queryFn: o, staleTime: b.FIVE_MINUTES }),
      (n[8] = r),
      (n[9] = a),
      (n[10] = o),
      (n[11] = s))
    : (s = n[11]);
  let { data: c, isLoading: l, isError: u, refetch: d } = ee(s),
  ...
  (n[12] === c
    ...
    : ((m = () => {
        ...
        let e = null,
          t = window.setTimeout(() => {
            ((e = URL.createObjectURL(c)), p({ blob: c, objectUrl: e }));
          }, 0);
        return () => {
          (window.clearTimeout(t), e != null && Bt(e));
        };
      }),
      (g = [c]),
      (n[12] = c),
      ...
      (n[14] = g)),
    (0, Q.useEffect)(m, g));
  let _ = f != null && f.blob === c ? f.objectUrl : null,
    v = l || (c != null && _ == null),
    y;
  n[15] === d
    ? (y = n[16])
  ...
  let x;
  return (
    n[17] !== u || n[18] !== _ || n[19] !== v || n[20] !== y
      ? ((x = { src: _, isLoading: v, isError: u, refetch: y }),
        (n[17] = u),
        (n[18] = _),
        (n[19] = v),
        (n[20] = y),
...
async function zt(e, t) {
  let { body: n } = await g.getInstance().get(e.downloadUrl, e.requestHeaders, t),
    r = Ft.parse(n),
    i = atob(r.base64),
    a = new Uint8Array(i.length);
  for (let e = 0; e < i.length; e++) a[e] = i.charCodeAt(e);
  return new Blob([a], { type: r.contentType || `application/octet-stream` });
}
function Bt(e) {
  e.startsWith(`blob:`) === !0 &&
    window.setTimeout(() => {
...
async function Ht(e) {
  return {
    downloadUrl: Ut(
      await I.safeGet(`/files/download/{file_id}`, { parameters: { path: { file_id: e } } }),
    ),
  };
}
function Ut(e) {
...
function Gt(e) {
  let t = (0, Z.c)(49),
    ...
    _ = o(d, r) ?? `local`,
    v = It(n) ? n : ``,
    { isError: y, src: b } = Rt(v, i),
    [ee, x] = (0, Q.useState)(!1),
    S = a ?? ee,
    w = c ?? x,
    T;
  t[0] !== v.length || t[1] !== n
    ? ((T = () => (v.length > 0 || le(n) != null ? null : n)),
      (t[0] = v.length),
      (t[1] = n),
      (t[2] = T))
    : (T = t[2]);
  let [D, O] = (0, Q.useState)(T),
    A = v.length > 0 ? b : D,
    j;
  t[3] === p
    ? (j = t[4])
  ...
  let I = F,
    L;
  t[9] !== _ || t[10] !== v.length || t[11] !== g || t[12] !== n
    ? ((L = () => {
  ...
  let te;
  if (
    (t[14] !== _ || t[15] !== v || t[16] !== g || t[17] !== n
      ? ((te = [_, v, g, n]), (t[14] = _), (t[15] = v), (t[16] = g), (t[17] = n), (t[18] = te))
      : (te = t[18]),
    (0, Q.useEffect)(L, te),
    v.length > 0 && y)
  ) {
    ...
    return (
      t[22] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(k, { className: `icon-xs` }),
          })),
          (t[22] = e))
        : (e = t[22]),
      e
  ...
  let R;
  t[23] !== P || t[24] !== A || t[25] !== h || t[26] !== w || t[27] !== n
    ? ((R = (e) => {
        if (
          Pt(h, {
            alt: P,
...
function Kt(e) {
  ...
  return (
    t[8] === o
      ? (s = t[9])
      : ((s = (0, $.jsx)($.Fragment, { children: o })), (t[8] = o), (t[9] = s)),
    s
  );
}
function qt(e) {
  ...
  t[0] !== n.bundleIdentifier || t[1] !== n.imageName
    ...
    : (c = t[2]);
  let l = o(Se, c),
    u = n.imageDataUrl ?? n.imagePath,
    f;
  t[3] === u ? (f = t[4]) : ((f = le(u)), (t[3] = u), (t[4] = f));
  let p = f,
    h;
  t[5] !== p || t[6] !== s
  ...
  let g;
  t[8] !== p || t[9] !== s || t[10] !== a
    ? ((g = () => ce(p, s, a)), (t[8] = p), (t[9] = s), (t[10] = a), (t[11] = g))
    : (g = t[11]);
  let _ = p != null,
    y;
  t[12] !== h || t[13] !== g || t[14] !== _
    ? ((y = { queryKey: h, queryFn: g, enabled: _, gcTime: 1 / 0, staleTime: b.INFINITE }),
      (t[12] = h),
      (t[13] = g),
      (t[14] = _),
      (t[15] = y))
    : (y = t[15]);
  let x = ee(y),
    S = p == null ? (u ?? null) : (x.data ?? null),
    w;
  t[16] === n.bundleIdentifier
    ? (w = t[17])
    : ((w = { bundleId: n.bundleIdentifier }), (t[16] = n.bundleIdentifier), (t[17] = w));
  let T = n.bundleIdentifier.length > 0,
    E;
  t[18] === T
    ? (E = t[19])
    : ((E = { enabled: T, staleTime: b.INFINITE, refetchOnWindowFocus: !1 }),
      (t[18] = T),
      (t[19] = E));
  let D;
  t[20] !== w || t[21] !== E
    ? ((D = { params: w, queryConfig: E, select: Jt }), (t[20] = w), (t[21] = E), (t[22] = D))
    : (D = t[22]);
  let O = v(`native-desktop-app-by-bundle-id`, D).data?.appPath ?? null,
    A;
  t[23] === O ? (A = t[24]) : ((A = { appPath: O }), (t[23] = O), (t[24] = A));
  let { iconSmall: j } = pe(A),
    M = n.appIconDataUrl ?? l,
    N;
  t[25] === i
    ? (N = t[26])
    : ((N = i.formatMessage({
...
function Yt(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== o || t[4] !== a) {
    ...
    t[15] !== a
      ...
      (t[8] = d),
      (t[9] = f));
  } else ((c = t[5]), (l = t[6]), (u = t[7]), (d = t[8]), (f = t[9]));
  let p = d ? l : void 0,
    m;
  t[17] !== c || t[18] !== n.path || t[19] !== u || t[20] !== f || t[21] !== p
    ? ((m = (0, $.jsx)(c, { filename: f, resourcePath: n.path, lineInfo: u, onClick: p })),
      (t[17] = c),
      (t[18] = n.path),
      (t[19] = u),
      (t[20] = f),
  ...
  t[23] === h
    ? (g = t[24])
    : ((g = (0, $.jsx)(`span`, { className: `inline-flex max-w-full`, children: h })),
      (t[23] = h),
      (t[24] = g));
  let _;
  return (
...
function Zt(e) {
  ...
  return (
    t[3] === i
      ? (a = t[4])
      : ((a = (0, $.jsx)(Y, { Icon: te, children: i })), (t[3] = i), (t[4] = a)),
    a
  );
}
function Qt(e) {
