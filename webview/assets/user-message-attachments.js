...
import { _ as l, k as u, l as d, m as f, o as p, s as m, u as h } from "./vscode-api.js";
import { Ki as g, Vi as _ } from "./src-4.js";
import { Aa as v, Br as y, D as ee } from "./app-server-manager-signals.js";
import { c as b, o as x, t as S } from "./lib-1.js";
...
import { t as M } from "./warning.js";
import { t as N } from "./route-scope.js";
import { n as P, t as F } from "./prompt-text.js";
import { t as I } from "./thread-detail-level.js";
import { _ as te, g as ne } from "./use-plugins.js";
import { t as L } from "./pencil.js";
import { u as R } from "./inline-mentions.js";
import { t as z } from "./workspace-file-context-menu.js";
import { t as B } from "./chevron.js";
import { t as re } from "./copy-D.js";
import { t as ie } from "./image-preview-dialog.js";
import { t as ae } from "./pull-request-open.js";
import { i as V, n as H, o as oe, r as se, t as U } from "./composer-controller.js";
import { n as W } from "./attachment-remove-button.js";
import { a as G, i as K, n as ce, r as q, t as le } from "./mention-metadata-syncer.js";
...
function Fe(e) {
  let t = (0, X.c)(93),
    {
      ...
      hookStats: f,
      threadDetailLevel: p,
      referencesPriorConversation: m,
      reviewMode: h,
      pullRequestFixMode: g,
      autoResolveSync: _,
    ...
    ae = v(n),
    V = ae.trim(),
    H = E != null && A != null && !ae.startsWith(`PLEASE IMPLEMENT THIS PLAN:`),
    [oe, se] = (0, Z.useState)(!1),
    U = a(Pe, A),
    W = H && U != null,
    G = b(),
    K = c(C),
    ce = ae.startsWith(`PLEASE IMPLEMENT THIS PLAN:`)
      ? G.formatMessage({
    ...
    de = le || u != null || !F,
    fe;
  t[0] !== K || t[1] !== se || t[2] !== k || t[3] !== V || t[4] !== A
    ? ((fe = () => {
        (k != null &&
          A != null &&
          ...
          navigator.clipboard.writeText(y(V)).then(() => {
  ...
  let ge = he,
    _e;
  t[12] !== U || t[13] !== K || t[14] !== J || t[15] !== k || t[16] !== V || t[17] !== A
    ? ((_e = () => {
        (k != null &&
          A != null &&
          K.submitCodexAnalyticsEvent?.({
    ...
    ? ((ke =
        u == null
          ...
          : (0, Q.jsxs)(`div`, {
              ...
              children: [d, (0, Q.jsx)(Ie, { children: u })],
            })),
      (t[56] = u),
      (t[57] = d),
      (t[58] = ke))
          ...
          ? (0, Q.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, Q.jsxs)(`div`, {
                  ...
                  children: [
                    f == null ? null : (0, Q.jsx)(ye, { stats: f, threadDetailLevel: p }),
                    $,
                    H
                      ? (0, Q.jsx)(O, {
                          tooltipContent: (0, Q.jsx)(x, {
...
var Ke = _({ base64: g(), contentType: g().optional() }),
  qe = [`file`, `image-src`],
  Je = new WeakSet();
function Ye(e) {
...
function Qe(e, t) {
  ...
  n[5] !== e || n[6] !== t
    ? ((o = async () => {
        let n = Xe(e),
          ...
          i = at(e);
        try {
          f.debug(`Image asset download diagnostic: started`, {
            safe: { pointerScheme: i, resolverKind: r },
            sensitive: { assetPointer: e, fileId: n },
          });
          let a = t == null ? await ot(n) : await t.getDownloadRequest(n);
          f.debug(`Image asset download diagnostic: URL resolved`, {
            safe: { pointerScheme: i, resolverKind: r },
            sensitive: { downloadUrl: a.downloadUrl, fileId: n },
          });
          let { body: o } = await d.getInstance().get(a.downloadUrl, a.requestHeaders),
            s = Ke.parse(o);
          return (
            f.debug(`Image asset download diagnostic: bytes fetched`, {
              safe: {
          ...
          let a = t;
          throw (
            f.warning(`Image asset download failed`, {
              safe: { pointerScheme: i, resolverKind: r },
  ...
  let s;
  n[8] !== r || n[9] !== a || n[10] !== o
    ? ((s = { enabled: r, queryKey: a, queryFn: o, staleTime: h.FIVE_MINUTES }),
      (n[8] = r),
      (n[9] = a),
      (n[10] = o),
      (n[11] = s))
    : (s = n[11]);
  let { data: c, isLoading: p, isError: m, refetch: g } = l(s),
    _ = c ?? null,
    v;
  n[12] === g
    ? (v = n[13])
  ...
  let y;
  return (
    n[14] !== m || n[15] !== p || n[16] !== _ || n[17] !== v
      ? ((y = { src: _, isLoading: p, isError: m, refetch: v }),
        (n[14] = m),
        (n[15] = p),
        (n[16] = _),
        (n[17] = v),
...
function lt(e) {
  let t = (0, X.c)(42),
    ...
    m = a(ee, r) ?? `local`,
    h = Ye(n) ? n : ``,
    { isError: g, src: _ } = Qe(h, i),
    [v, y] = (0, Z.useState)(!1),
    S = o ?? v,
    C = s ?? y,
    w;
  t[0] !== h.length || t[1] !== n
    ? ((w = () => (h.length > 0 || ne(n) != null ? null : n)),
      (t[0] = h.length),
      (t[1] = n),
      (t[2] = w))
    : (w = t[2]);
  ...
  let P = N,
    F;
  t[9] !== m || t[10] !== h.length || t[11] !== p || t[12] !== n
    ? ((F = () => {
  ...
  let I;
  if (
    (t[14] !== m || t[15] !== h || t[16] !== p || t[17] !== n
      ? ((I = [m, h, p, n]), (t[14] = m), (t[15] = h), (t[16] = p), (t[17] = n), (t[18] = I))
      : (I = t[18]),
    (0, Z.useEffect)(F, I),
    h.length > 0 && g)
  ) {
...
function dt(e) {
  ...
  let d = a(W, c),
    ...
    m;
  t[3] === f ? (m = t[4]) : ((m = ne(f)), (t[3] = f), (t[4] = m));
  let g = m,
    _;
  t[5] !== g || t[6] !== s
    ? ((_ = [`local-user-appshot-screenshot-data-url`, s, g]), (t[5] = g), (t[6] = s), (t[7] = _))
    : (_ = t[7]);
  let v;
  t[8] !== g || t[9] !== s || t[10] !== o
    ? ((v = () => te(g, s, o)), (t[8] = g), (t[9] = s), (t[10] = o), (t[11] = v))
    : (v = t[11]);
  let y = g != null,
    x;
  t[12] !== _ || t[13] !== v || t[14] !== y
    ? ((x = { queryKey: _, queryFn: v, enabled: y, gcTime: 1 / 0, staleTime: h.INFINITE }),
      (t[12] = _),
      (t[13] = v),
      (t[14] = y),
      (t[15] = x))
  ...
  t[18] === T
    ? (D = t[19])
    : ((D = { enabled: T, staleTime: h.INFINITE, refetchOnWindowFocus: !1 }),
      (t[18] = T),
      (t[19] = D));
  let O;
  t[20] !== w || t[21] !== D
    ...
    : (O = t[22]);
  let k = p(`native-desktop-app-by-bundle-id`, O).data?.appPath ?? null,
    A;
  t[23] === k ? (A = t[24]) : ((A = { appPath: k }), (t[23] = k), (t[24] = A));
  let { iconSmall: j } = R(A),
    M = n.appIconDataUrl ?? d,
    N;
  t[25] === i
    ? (N = t[26])
    : ((N = i.formatMessage({
...
function ht(e) {
  ...
  return (
    t[3] === i
      ? (a = t[4])
      : ((a = (0, Q.jsx)(K, { Icon: M, children: i })), (t[3] = i), (t[4] = a)),
    a
  );
}
function gt(e) {
