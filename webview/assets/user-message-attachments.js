...
import { _ as i, a, o, s, z as c } from "./app-scope.js";
import { O as l, Za as u, fi as d } from "./app-server-manager-signals.js";
import { A as f, h as p, l as m, o as h, s as g, u as _, v } from "./vscode-api.js";
import { ha as y, ua as b } from "./src-2.js";
import { l as x, n as S, s as C } from "./lib.js";
...
import { r as te } from "./product-logger.js";
import { d as k } from "./statsig.js";
import { t as A } from "./request.js";
import { t as j } from "./appshot-icon-cache.js";
import { t as M } from "./browser-sidebar-availability.js";
import { _ as N, g as ne } from "./use-plugins.js";
import { t as P } from "./pencil.js";
import { r as F } from "./use-composer-controller.js";
import { a as I, t as L } from "./open-workspace-file.js";
import { t as re } from "./chevron.js";
import { t as R } from "./warning.js";
import { i as z, t as ie } from "./route-scope.js";
import { n as B, t as V } from "./prompt-text.js";
import { t as H } from "./thread-detail-level.js";
import { n as U } from "./app-shell-tab-controller.js";
import { m as ae } from "./inline-mentions.js";
import { t as W } from "./workspace-file-context-menu.js";
import { t as oe } from "./copy.js";
import { t as G } from "./image-preview-dialog.js";
import { t as K } from "./pull-request-open.js";
import { i as se, n as ce, r as q, s as le, t as ue } from "./composer-controller.js";
import { a as de, i as fe, n as pe, r as me, t as J } from "./mention-metadata-syncer-Cux3-DQM.js";
import { t as he } from "./use-enter-behavior.js";
import { d as ge } from "./hooks-settings-model.js";
import { t as _e } from "./at-mention-list-1.js";
import { t as Y } from "./anchored-autocomplete-overlay.js";
import { n as ve } from "./prompt-editor.js";
import { n as ye } from "./thread-right-panel-state.js";
import { t as be } from "./use-autocomplete-overlay-placement.js";
import { t as xe } from "./use-measured-text-collapse.js";
import { t as X } from "./hooks.js";
import { t as Se } from "./user-formatted-text.js";
import { n as Ce } from "./hooks-settings-copy.js";
var Z = c(),
  Q = e(n(), 1),
  $ = r();
function we(e) {
  ...
  let s = o,
    c;
  t[2] !== a || t[3] !== n
    ? ((c = a ? (0, $.jsx)(De, { stats: n }) : (0, $.jsx)(Te, { stats: n })),
      (t[2] = a),
      (t[3] = n),
      (t[4] = c))
    : (c = t[4]);
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(X, { className: `icon-xs` })), (t[5] = l))
    : (l = t[5]);
  let u;
  t[6] === s
    ? (u = t[7])
    : ((u = (0, $.jsx)(T, { "aria-label": s, color: `ghost`, size: `icon`, children: l })),
      (t[6] = s),
      (t[7] = u));
  let d;
  return (
...
function Te(e) {
  ...
  t[2] === n.count
    ...
    : ((a = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(S, { value: n.count }),
      })),
      (t[2] = n.count),
      (t[3] = a));
  let o;
        ...
        n.blockedCount > 0
          ? (0, $.jsxs)($.Fragment, {
              children: [
                ...
                (0, $.jsx)(`span`, {
                  className: `text-right text-token-text-primary`,
                  children: (0, $.jsx)(S, { value: n.blockedCount }),
                }),
              ],
            })
          : null),
        ...
        n.errorCount > 0
          ? (0, $.jsxs)($.Fragment, {
              children: [
                ...
                (0, $.jsx)(`span`, {
                  className: `text-right text-token-text-primary`,
                  children: (0, $.jsx)(S, { value: n.errorCount }),
                }),
              ],
            })
          : null),
...
function Ee(e, t) {
  return (0, $.jsxs)(
    `li`,
    {
      className: `contents`,
      children: [
        (0, $.jsx)(`span`, { className: `text-token-text-secondary`, children: ke(e.kind) }),
        (0, $.jsx)(`span`, {
...
function Oe(e, t) {
  return (0, $.jsx)(
    `span`,
    { className: Ae(e.tone), children: e.text },
...
var Me = 20,
  Ne = { display: `-webkit-box`, overflow: `hidden`, WebkitBoxOrient: `vertical` };
function Pe(e) {
  let t = (0, Z.c)(22),
  ...
  let f = d,
    p;
  t[3] !== c || t[4] !== n
    ? ((p = { text: n, collapsedLineCount: c, fallbackFontSizePx: 13 }),
      (t[3] = c),
      (t[4] = n),
      (t[5] = p))
    : (p = t[5]);
  let { setTextContentMeasurementRef: m, collapseState: h, handleToggleExpansion: g } = xe(p),
    _;
  t[6] !== h || t[7] !== c
    ? ((_ = h === `collapsed` ? { ...Ne, maxHeight: `${c}lh`, WebkitLineClamp: c } : void 0),
      (t[6] = h),
      (t[7] = c),
      (t[8] = _))
    : (_ = t[8]);
        ...
        h === `uncollapsible`
          ...
          : (0, $.jsxs)(`button`, {
              ...
              children: [
                ...
                (0, $.jsx)(re, {
                  className: h === `expanded` ? `icon-2xs rotate-180` : `icon-2xs`,
                }),
              ],
            })),
      (t[16] = h),
...
var Fe = 7;
function Ie({ intl: e, sentAtMs: t, now: n }) {
  let r = new Date(t),
    i = Le(r, n);
  return i === 0
...
function Re(e) {
  ...
  t[0] === n
    ? (o = t[1])
    : ((o = w(`text-xs text-token-text-tertiary`, n)), (t[0] = n), (t[1] = o));
  let s;
  t[2] !== a || t[3] !== i || t[4] !== r
    ? ((s = Ie({ intl: a, sentAtMs: r, now: i == null ? new Date() : new Date(i) })),
      (t[2] = a),
      (t[3] = i),
      (t[4] = r),
      (t[5] = s))
...
function ze({ cwd: e, hostId: t, initialMessage: n, onCancel: r, onDraftChange: i, onSubmit: a }) {
  let o = x(),
    { enterBehavior: s } = he(),
    c = (0, Q.useRef)(null),
    [l] = (0, Q.useState)(() => {
  ...
  let u = (0, Q.useMemo)(() => {
    ...
    d = q(l),
    f = ce(l),
    p = be({ anchorRef: c, isActive: d.ui?.active ?? !1 }),
    m = be({ anchorRef: c, isActive: f.ui?.active ?? !1 }),
    [h, g] = (0, Q.useState)(!1),
    _ = (0, Q.useEffectEvent)(() => {
      i(l.getText());
    });
  (0, Q.useEffect)(() => F(l.view, _), [l]);
  let v = async () => {
    if (!h) {
      g(!0);
      try {
...
function Ve(e) {
  let t = (0, Z.c)(93),
    ...
    B = u(n),
    V = B.trim(),
    H = ee != null && k != null && !B.startsWith(`PLEASE IMPLEMENT THIS PLAN:`),
    [U, ae] = (0, Q.useState)(!1),
    W = a(Be, k),
    G = H && W != null,
    K = x(),
    se = s(te),
    ce = B.startsWith(`PLEASE IMPLEMENT THIS PLAN:`)
      ? K.formatMessage({
    ...
    de = le || f != null || !N,
    fe;
  t[0] !== se || t[1] !== ae || t[2] !== O || t[3] !== V || t[4] !== k
    ? ((fe = () => {
        (O != null &&
          k != null &&
          se.submitCodexAnalyticsEvent?.({
            action: `copy`,
            eventKind: `action`,
  ...
  let ge = he,
    _e;
  t[12] !== W || t[13] !== se || t[14] !== J || t[15] !== O || t[16] !== V || t[17] !== k
    ? ((_e = () => {
        (O != null &&
          k != null &&
          se.submitCodexAnalyticsEvent?.({
  ...
  t[21] !== i || t[22] !== A || t[23] !== ce || t[24] !== q || t[25] !== j
    ? ((be = q
        ? (0, $.jsx)(Pe, { text: ce, cwd: A ?? null, hostId: j, collapsedLineCount: i })
        : (0, $.jsx)(`div`, {
  ...
  if (
    ...
    let e = w(
      ...
      n;
    (t[44] !== pe || t[45] !== K || t[46] !== U
      ? ((n = U
          ? (0, $.jsx)(D, {
              tooltipContent: (0, $.jsx)(C, {
              ...
              children: (0, $.jsx)(T, {
                ...
                children: (0, $.jsx)(E, { className: `icon-xs` }),
              }),
            })
          : (0, $.jsx)(D, {
              tooltipContent: (0, $.jsx)(C, {
      ...
      (Se = G
        ...
        : ue
          ? H
            ...
            : (0, $.jsx)(`div`, { "data-user-message-bubble": !0, className: e, children: xe })
          : null),
      (t[27] = H),
      (t[28] = A),
      (t[29] = W),
  ...
  let Ce = Se,
    Te;
  t[48] !== N || t[49] !== X || t[50] !== q || t[51] !== G || t[52] !== Ce
    ? ((Te =
        N && q && !G
          ? (0, $.jsxs)(`div`, {
  ...
  t[54] === Ee
    ? (De = t[55])
    : ((De = w(`flex flex-row-reverse items-center gap-1`, Ee)), (t[54] = Ee), (t[55] = De));
  let Oe;
  t[56] !== f || t[57] !== p
    ? ((Oe =
        f == null
          ...
          : (0, $.jsxs)(`div`, {
              ...
              children: [p, (0, $.jsx)(He, { children: f })],
            })),
      (t[56] = f),
      (t[57] = p),
      (t[58] = Oe))
          ...
          ? (0, $.jsxs)(`div`, {
              ...
              children: [
                r == null
                  ...
                  : (0, $.jsx)(`span`, {
                      className: `opacity-0 group-focus-within:opacity-100 group-hover:opacity-100`,
                      children: (0, $.jsx)(Re, { sentAtMs: r }),
                    }),
                (0, $.jsxs)(`div`, {
                  className: `flex items-center gap-1`,
                  children: [
                    m == null ? null : (0, $.jsx)(we, { stats: m, threadDetailLevel: h }),
                    X,
                    H
                      ? (0, $.jsx)(D, {
                          tooltipContent: (0, $.jsx)(C, {
  ...
  t[87] !== Ne ||
  t[88] !== Fe
    ? ((Ie = (0, $.jsxs)(`div`, { className: De, children: [Oe, ke, Ae, je, Me, Ne, Fe] })),
      (t[81] = De),
      (t[82] = Oe),
      (t[83] = ke),
      (t[84] = Ae),
...
function He(e) {
  ...
  t[3] === n
    ? (i = t[4])
    : ((i = w(`text-token-description-foreground text-xs`, n)), (t[3] = n), (t[4] = i));
  let a;
  return (
    t[5] !== r || t[6] !== i
...
function qe(e) {
  let t = (0, Z.c)(7),
    ...
    a;
  if (t[0] !== n || t[1] !== r) {
    let e = Ge.default.ansiToJson(We(Xe(n)), { json: !0, remove_empty: !0, use_classes: !0 });
    ((i = r), (a = e.map(Je)), (t[0] = n), (t[1] = r), (t[2] = i), (t[3] = a));
  } else ((i = t[2]), (a = t[3]));
  let o;
  return (
    t[4] !== i || t[5] !== a
...
function Je(e, t) {
  return (0, $.jsx)(
    `span`,
    {
      className: w(e.fg != null && `${e.fg}-fg`, e.bg != null && `${e.bg}-bg`),
      style: Ye(e),
      children: e.content,
    },
    `${t}-${e.content}`,
...
function Ze(e) {
  let t = (0, Z.c)(14),
    ...
    f = o(ie),
    p;
  t[0] !== r || t[1] !== i || t[2] !== a || t[3] !== s || t[4] !== c || t[5] !== d || t[6] !== u
    ? ((p = { column: r, cwd: i, endLine: a, hostId: s, line: c, openInSidePanel: d, path: u }),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a),
      (t[3] = s),
  ...
  let m = p,
    h;
  t[8] !== m || t[9] !== f
    ? ((h = () => W(f, m)), (t[8] = m), (t[9] = f), (t[10] = h))
    : (h = t[10]);
  let g;
  return (
    t[11] !== n || t[12] !== h
      ? ((g = (0, $.jsx)(O, { getItems: h, children: n })), (t[11] = n), (t[12] = h), (t[13] = g))
      : (g = t[13]),
    g
  );
}
...
function $e(e) {
  let t = (0, Z.c)(4),
    { alt: n, referrerPolicy: r, src: i } = e,
    a;
  return (
    t[0] !== n || t[1] !== r || t[2] !== i
      ? ((a = (0, $.jsx)(`div`, {
...
function et(e, { title: t, ...n }) {
  return k(e, `120995366`)
    ? (U.openTab(e, $e, {
        icon: (0, Q.createElement)(Qe, { className: `icon-xs shrink-0` }),
...
var tt = b({ base64: y(), contentType: y().optional() });
function nt(e) {
...
function it(e, t) {
  ...
  n[5] !== e || n[6] !== t
    ? ((o = async () => {
        let n = rt(e),
          ...
          i = st(e);
        try {
          p.debug(`Image asset download diagnostic: started`, {
            safe: { pointerScheme: i, resolverKind: r },
            sensitive: { assetPointer: e, fileId: n },
          });
          let a = t == null ? await ct(n) : await t.getDownloadRequest(n);
          p.debug(`Image asset download diagnostic: URL resolved`, {
            safe: { pointerScheme: i, resolverKind: r },
            sensitive: { downloadUrl: a.downloadUrl, fileId: n },
          });
          let o = await at(a);
          return (
            p.debug(`Image asset download diagnostic: bytes fetched`, {
              safe: { pointerScheme: i, resolverKind: r },
              sensitive: { fileId: n },
            }),
            o
          ...
          let a = t;
          throw (
            p.warning(`Image asset download failed`, {
              safe: { pointerScheme: i, resolverKind: r },
  ...
  let s;
  n[8] !== r || n[9] !== a || n[10] !== o
    ? ((s = { enabled: r, queryKey: a, queryFn: o, staleTime: _.FIVE_MINUTES }),
      (n[8] = r),
      (n[9] = a),
      (n[10] = o),
      (n[11] = s))
    : (s = n[11]);
  let { data: c, isLoading: l, isError: u, refetch: d } = v(s),
  ...
  (n[12] === c
    ...
    : ((h = () => {
        ...
        let e = null,
          t = window.setTimeout(() => {
            ((e = URL.createObjectURL(c)), m({ blob: c, objectUrl: e }));
          }, 0);
        return () => {
          (window.clearTimeout(t), e != null && ot(e));
        };
      }),
      (g = [c]),
      (n[12] = c),
      ...
      (n[14] = g)),
    (0, Q.useEffect)(h, g));
  let y = f != null && f.blob === c ? f.objectUrl : null,
    b = l || (c != null && y == null),
    x;
  n[15] === d
    ? (x = n[16])
  ...
  let S;
  return (
    n[17] !== u || n[18] !== y || n[19] !== b || n[20] !== x
      ? ((S = { src: y, isLoading: b, isError: u, refetch: x }),
        (n[17] = u),
        (n[18] = y),
        (n[19] = b),
        (n[20] = x),
...
async function at(e, t) {
  let { body: n } = await m.getInstance().get(e.downloadUrl, e.requestHeaders, t),
    r = tt.parse(n),
    i = atob(r.base64),
...
async function ct(e) {
  return {
    downloadUrl: lt(
      await A.safeGet(`/files/download/{file_id}`, { parameters: { path: { file_id: e } } }),
    ),
  };
}
function lt(e) {
...
function dt(e) {
  let t = (0, Z.c)(48),
    ...
    _ = a(l, r) ?? `local`,
    v = nt(n) ? n : ``,
    { isError: y, src: b } = it(v, i),
    [S, w] = (0, Q.useState)(!1),
    T = s ?? S,
    E = c ?? w,
    D;
  t[0] !== v.length || t[1] !== n
    ? ((D = () => (v.length > 0 || ne(n) != null ? null : n)),
      (t[0] = v.length),
      (t[1] = n),
      (t[2] = D))
    : (D = t[2]);
  let [O, te] = (0, Q.useState)(D),
    k = v.length > 0 ? b : O,
    A;
  t[3] === m
    ? (A = t[4])
  ...
  if (
    (t[14] !== _ || t[15] !== v || t[16] !== g || t[17] !== n
      ? ((re = [_, v, g, n]), (t[14] = _), (t[15] = v), (t[16] = g), (t[17] = n), (t[18] = re))
      : (re = t[18]),
    (0, Q.useEffect)(L, re),
    v.length > 0 && y)
  ) {
  ...
  let R;
  t[23] !== P || t[24] !== k || t[25] !== h || t[26] !== E
    ? ((R = (e) => {
        if (et(h, { alt: P, referrerPolicy: `no-referrer`, src: k, title: P })) {
          e?.preventDefault();
          return;
        }
        e ?? E(!0);
...
function pt(e) {
  ...
  let u = a(j, c),
    ...
    p;
  t[3] === d ? (p = t[4]) : ((p = ne(d)), (t[3] = d), (t[4] = p));
  let m = p,
    g;
  t[5] !== m || t[6] !== s
    ? ((g = [`local-user-appshot-screenshot-data-url`, s, m]), (t[5] = m), (t[6] = s), (t[7] = g))
    : (g = t[7]);
  let y;
  t[8] !== m || t[9] !== s || t[10] !== o
    ? ((y = () => N(m, s, o)), (t[8] = m), (t[9] = s), (t[10] = o), (t[11] = y))
    : (y = t[11]);
  let b = m != null,
    S;
  t[12] !== g || t[13] !== y || t[14] !== b
    ? ((S = { queryKey: g, queryFn: y, enabled: b, gcTime: 1 / 0, staleTime: _.INFINITE }),
      (t[12] = g),
      (t[13] = y),
      (t[14] = b),
      (t[15] = S))
    : (S = t[15]);
  let C = v(S),
    w = m == null ? (d ?? null) : (C.data ?? null),
    T;
  t[16] === n.bundleIdentifier
    ? (T = t[17])
    : ((T = { bundleId: n.bundleIdentifier }), (t[16] = n.bundleIdentifier), (t[17] = T));
  let E = n.bundleIdentifier.length > 0,
    D;
  t[18] === E
    ? (D = t[19])
    : ((D = { enabled: E, staleTime: _.INFINITE, refetchOnWindowFocus: !1 }),
      (t[18] = E),
      (t[19] = D));
  let O;
  t[20] !== T || t[21] !== D
    ? ((O = { params: T, queryConfig: D, select: mt }), (t[20] = T), (t[21] = D), (t[22] = O))
    : (O = t[22]);
  let te = h(`native-desktop-app-by-bundle-id`, O).data?.appPath ?? null,
    k;
  t[23] === te ? (k = t[24]) : ((k = { appPath: te }), (t[23] = te), (t[24] = k));
  let { iconSmall: A } = ae(k),
    M = n.appIconDataUrl ?? u,
    P;
  t[25] === i
    ? (P = t[26])
    : ((P = i.formatMessage({
...
function ht(e) {
  ...
  let p;
  t[17] !== c || t[18] !== n.path || t[19] !== l || t[20] !== u || t[21] !== f
    ? ((p = (0, $.jsx)(c, { filename: f, resourcePath: n.path, lineInfo: u, onClick: l })),
      (t[17] = c),
      (t[18] = n.path),
      (t[19] = l),
      (t[20] = u),
  ...
  t[23] === m
    ? (h = t[24])
    : ((h = (0, $.jsx)(`span`, { className: `inline-flex max-w-full`, children: m })),
      (t[23] = m),
      (t[24] = h));
  let _;
  return (
...
function _t(e) {
  ...
  return (
    t[3] === i
      ? (a = t[4])
      : ((a = (0, $.jsx)(fe, { Icon: R, children: i })), (t[3] = i), (t[4] = a)),
    a
  );
}
function vt(e) {
