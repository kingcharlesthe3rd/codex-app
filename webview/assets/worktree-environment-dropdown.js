...
function E(e) {
  ...
  if (
    ...
    let e = C(o),
      l;
    (t[25] === m ? (l = t[26]) : ((l = m ? x(m) : null), (t[25] = m), (t[26] = l)), (F = l));
    let u = o.find((e) => x(e.configPath) === F) ?? null,
      d = !s && !c;
    P = e && E ? o.filter((t) => x(t.configPath) !== x(e.configPath)) : o;
    let f = ie({ isLoading: s, selectedEnvironment: u });
    ...
    t[28] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (v = t[28]);
    let b;
    t[29] === r ? (b = t[30]) : ((b = p(`whitespace-nowrap`, r)), (t[29] = r), (t[30] = b));
    let k = i == null ? `secondary` : `sm`,
      A;
    t[31] === T
      ? (A = t[32])
      : ((A = T ? (0, j.jsx)(ee, { className: `icon-xs` }) : null), (t[31] = T), (t[32] = A));
    let K = s ? `pending` : `collapsible-chevron`,
      q;
    (t[33] === i ? (q = t[34]) : ((q = p(`max-w-40`, i)), (t[33] = i), (t[34] = q)),
      t[35] !== f || t[36] !== b || t[37] !== k || t[38] !== A || t[39] !== K || t[40] !== q
        ? ((B = (0, j.jsx)(h, {
            tooltipContent: g,
            children: (0, j.jsx)(ne, {
              categoryLabel: v,
      ...
      t[43] !== _ || t[44] !== m || t[45] !== d
        ? ((H = d
            ? (0, j.jsx)(y.Item, {
                RightIcon: m == null ? a : void 0,
                onClick: () => {
                  (_(null), M(!1));
                },
                children: (0, j.jsx)(n, {
      ...
      (U =
        E && e
          ? (0, j.jsx)(y.Item, {
              RightIcon: F != null && x(e.configPath) === F ? a : void 0,
              onClick: () => {
                (_(e.configPath), M(!1));
              },
  ...
  t[53] !== m
    ? ((K = s
        ? (0, j.jsx)(`div`, {
            ...
            children: (0, j.jsx)(g, { className: `icon-xxs` }),
          })
        : c
          ? (0, j.jsx)(y.Message, {
              compact: !0,
  ...
  t[64] === Y
    ...
    : ((Z = (0, j.jsx)(y.Section, {
        ...
        children: (0, j.jsx)(y.Item, { LeftIcon: u, onClick: Y, children: X }),
      })),
      (t[64] = Y),
      (t[65] = Z));
  let Q;
