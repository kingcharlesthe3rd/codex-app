...
function E(e) {
  ...
  if (
    ...
    let e = ne(i),
      a;
    (t[25] === g ? (a = t[26]) : ((a = g ? f(g) : null), (t[25] = g), (t[26] = a)), (F = a));
    ...
    t[28] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (b = t[28]);
    let x;
    t[29] === n ? (x = t[30]) : ((x = h(`whitespace-nowrap`, n)), (t[29] = n), (t[30] = x));
    ...
    let K = s ? `pending` : `collapsible-chevron`,
      q;
    (t[33] === r ? (q = t[34]) : ((q = h(`max-w-40`, r)), (t[33] = r), (t[34] = q)),
      t[35] !== p || t[36] !== x || t[37] !== k || t[38] !== A || t[39] !== K || t[40] !== q
        ? ((B = (0, j.jsx)(o, {
            tooltipContent: _,
            children: (0, j.jsx)(C, {
              categoryLabel: b,
