...
import { n as ne, r as re } from "./composer-footer.js";
import { I as c } from "./rpc.js";
import { t as ie } from "./chevron.js";
import { t as l } from "./link-external.js";
import { t as ae } from "./settings.cog.js";
import { r as u, t as oe } from "./dropdown.js";
import { o as se } from "./local-environment-selection.js";
import { t as ce } from "./star.js";
var d = r(),
  f = e(t(), 1),
  p = n();
function m(e) {
  ...
  if (
    ...
    let e = se(m),
      l;
    (t[26] === S ? (l = t[27]) : ((l = S ? c(S) : null), (t[26] = S), (t[27] = l)), (F = l));
    let d = m.find((e) => c(e.configPath) === F) ?? null,
      f = !h && !_;
    P = e && A ? m.filter((t) => c(t.configPath) !== c(e.configPath)) : m;
    let v = le({ isLoading: h, selectedEnvironment: d });
    ((N = oe), (L = j), (R = M), (z = E), (B = D));
    let y;
    t[28] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (y = t[28]);
    let b;
    t[29] === n ? (b = t[30]) : ((b = ee(`whitespace-nowrap`, n)), (t[29] = n), (t[30] = b));
    let x;
    t[31] === O
      ? (x = t[32])
      : ((x = O ? (0, p.jsx)(ae, { className: `icon-xs` }) : null), (t[31] = O), (t[32] = x));
    let w;
    t[33] !== k || t[34] !== v || t[35] !== r
      ? ((w = k
          ? null
          : (0, p.jsx)(ne, {
              collapse: r == null ? `secondary` : `sm`,
              className: ee(`max-w-40 truncate whitespace-nowrap`, r),
              children: v,
            })),
        (t[33] = k),
        (t[34] = v),
    ...
    (t[37] === h
      ? (T = t[38])
      : ((T = h
          ? (0, p.jsx)(a, { className: `icon-xs text-token-input-placeholder-foreground` })
          : (0, p.jsx)(re, {
              children: (0, p.jsx)(ie, {
        ...
        (t[37] = h),
        (t[38] = T)),
      t[39] !== b || t[40] !== x || t[41] !== w || t[42] !== T
        ? ((V = (0, p.jsx)(s, {
            tooltipContent: y,
            children: (0, p.jsxs)(te, {
              className: b,
              size: `composerSm`,
              color: `ghost`,
              children: [x, w, T],
      ...
      t[45] !== C || t[46] !== S || t[47] !== f
        ? ((U = f
            ? (0, p.jsx)(u.Item, {
                RightIcon: S == null ? o : void 0,
                onClick: () => {
                  (C(null), M(!1));
                },
                children: (0, p.jsx)(i, {
      ...
      (W =
        A && e
          ? (0, p.jsx)(u.Item, {
              RightIcon: F != null && c(e.configPath) === F ? o : void 0,
              onClick: () => {
                (C(e.configPath), M(!1));
              },
  ...
  t[55] !== S
    ? ((K = h
        ? (0, p.jsx)(`div`, {
            ...
            children: (0, p.jsx)(a, { className: `icon-xxs` }),
          })
        : _
          ? (0, p.jsx)(u.Message, {
              compact: !0,
  ...
  t[66] === Y
    ...
    : ((Z = (0, p.jsx)(u.Section, {
        ...
        children: (0, p.jsx)(u.Item, { LeftIcon: l, onClick: Y, children: X }),
      })),
      (t[66] = Y),
      (t[67] = Z));
  let Q;
  t[68] !== I || t[69] !== q || t[70] !== Z || t[71] !== G
