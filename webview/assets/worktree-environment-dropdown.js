...
import { F as c } from "./rpc-Hf-fxjh7.js";
import { r as l, t as ne } from "./dropdown.js";
import { t as u } from "./link-external.js";
import { n as re, r as ie } from "./composer-footer.js";
import { t as ae } from "./chevron.js";
import { t as oe } from "./settings.cog.js";
import { t as se } from "./star.js";
import { n as ce } from "./local-environments.js";
var d = r(),
  f = e(t(), 1),
  p = n();
function m(e) {
  ...
  if (
    ...
    let e = ce(m),
      u;
    (t[26] === S ? (u = t[27]) : ((u = S ? c(S) : null), (t[26] = S), (t[27] = u)), (F = u));
    ...
    t[31] === O
      ? (x = t[32])
      : ((x = O ? (0, p.jsx)(oe, { className: `icon-xs` }) : null), (t[31] = O), (t[32] = x));
    let w;
  ...
  t[66] === Y
    ...
    : ((Z = (0, p.jsx)(l.Section, {
        ...
        children: (0, p.jsx)(l.Item, { LeftIcon: u, onClick: Y, children: X }),
      })),
      (t[66] = Y),
      (t[67] = Z));
  let Q;
