...
import { Fo as i } from "./app-server-manager-signals.js";
import { o as a } from "./lib-1.js";
...
import { r as u, t as ae } from "./dropdown.js";
import { t as oe } from "./chevron.js";
import { t as se } from "./star.js";
import { n as ce } from "./local-environments-e.js";
var d = r(),
  f = e(t(), 1),
  p = n();
function m(e) {
  ...
  if (
    ...
    let e = ce(m),
      l;
    (t[26] === S ? (l = t[27]) : ((l = S ? i(S) : null), (t[26] = S), (t[27] = l)), (F = l));
    let d = m.find((e) => i(e.configPath) === F) ?? null,
      f = !h && !_;
    P = e && A ? m.filter((t) => i(t.configPath) !== i(e.configPath)) : m;
    let v = le({ isLoading: h, selectedEnvironment: d });
    ((N = ae), (L = j), (R = M), (z = E), (B = D));
    let y;
    ...
    t[31] === O
      ? (x = t[32])
      : ((x = O ? (0, p.jsx)(ie, { className: `icon-xs` }) : null), (t[31] = O), (t[32] = x));
    let w;
    ...
    (t[37] === h
      ? (T = t[38])
      : ((T = h
          ? (0, p.jsx)(o, { className: `icon-xs text-token-input-placeholder-foreground` })
          : (0, p.jsx)(re, {
              children: (0, p.jsx)(oe, {
      ...
      (W =
        A && e
          ? (0, p.jsx)(u.Item, {
              RightIcon: F != null && i(e.configPath) === F ? s : void 0,
              onClick: () => {
                (C(e.configPath), M(!1));
              },
  ...
  t[55] !== S
    ? ((K = h
        ? (0, p.jsx)(`div`, {
            ...
            children: (0, p.jsx)(o, { className: `icon-xxs` }),
          })
        : _
          ? (0, p.jsx)(u.Message, {
              compact: !0,
          ...
          : P.length > 0
            ? (0, p.jsx)(`div`, {
                ...
                children: P.map((e) => {
                  let t = S != null && i(e.configPath) === F;
                  return (0, p.jsx)(
                    u.Item,
                    {
                      RightIcon: t ? s : void 0,
                      onClick: () => {
                        (C(e.configPath), M(!1));
                      },
