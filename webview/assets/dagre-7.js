...
import { a as e } from "./flatten-CNrC-h2I.js";
import "./src-2.js";
import { n as t } from "./union.js";
import { t as n } from "./clone-D.js";
import "./dist-5.js";
  ...
  F = r((e, t) => {
    ...
    (e.nodes().forEach(function (t) {
      e.children(t).length > 0 &&
        (i.warn(`Cluster identified`, t, ` Replacement id in edges: `, N(t, e, t)),
        T.set(t, j(t, e)),
    ...
    (e.edges().forEach(function (t) {
      ...
      (i.warn(`Edge ` + t.v + ` -> ` + t.w + `: ` + JSON.stringify(t)),
        i.warn(`Edge ` + t.v + ` -> ` + t.w + `: ` + JSON.stringify(e.edge(t))));
      let r = t.v,
        a = t.w;
      if (
        (i.warn(`Fix XXX`, w, `ids:`, t.v, t.w, `Translating: `, w.get(t.v), ` --- `, w.get(t.w)),
        w.get(t.v) || w.get(t.w))
      ) {
        if (
        ...
        (i.warn(`Fix Replacing with XXX`, r, a, t.name), e.setEdge(r, a, n, t.name));
      }
    }),
    ...
    for (let r of n)
      if (
        ...
        w.get(r)?.clusterData?.dir &&
          ((n = w.get(r).clusterData.dir), i.warn(`Fixing dir`, w.get(r).clusterData.dir, n));
...
Parent cluster`,
            ...
            t.setNode(s.id, n),
            t.parent(e) || (i.trace(`Setting parent`, e, s.id), t.setParent(e, s.id, n)));
        }
        if ((i.info(`(Insert) Node XXX` + e + `: ` + JSON.stringify(t.node(e))), r?.clusterNode)) {
          ...
          t.children(e).length > 0
            ? (i.trace(`Cluster - the non recursive path XBX`, e, r.id, r, r.width, `Graph:`, t),
              i.trace(N(r.id, t)),
      ...
      await r(async () => {
        let e = t.edges().map(async function (e) {
          ...
          (i.info(`Edge ` + e.v + ` -> ` + e.w + `: ` + JSON.stringify(e)),
            ...
            i.info(`Fix`, w, `ids:`, e.v, e.w, `Translating: `, w.get(e.v), w.get(e.w)),
            await v(C, n));
        });
        await Promise.all(e);
      }, `processEdges`)(),
      ...
      await Promise.all(
        R(t).map(async function (e) {
          ...
          if (
            ...
            (i.info(`A pure cluster node XBX1`, e, n.id, n.x, n.y, n.width, n.height, t.parent(e)),
              (n.height += D),
              t.node(n.parentId));
            let r = n?.padding / 2 || 0,
