...
import { Tn as I, wn as L } from "./app-initial~app-main~automations-page.js";
import { n as R, t as z } from "./avatar-mascot-button.js";
import {
  h as B,
  p as V,
...
import { n as le, t as ue } from "./global-dictation-orb.js";
import {
  gt as de,
  ht as fe,
  mt as J,
...
function ze(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = d({ height: 54, left: 0, top: 0, width: 345 }, a)), (t[1] = u))
    : (u = t[1]);
  let f = u,
    p;
  t[2] === r ? (p = t[3]) : ((p = s(r)), (t[2] = r), (t[3] = p));
  let m;
...
function Ke({
  ...
  let G = F(),
    ae = ie?.type === `native-surface` ? ie.id : void 0,
    oe = ie?.type === `native-surface` || (ie?.type === `native-root` && m),
    se = ie != null,
    K = (0, Q.useRef)(!1),
    ce = (0, Q.useRef)(!1),
    q = (0, Q.useRef)(null),
    ...
    Ce = _.length > 1 && c,
    we = h ?? Ce,
    Te = l.tray == null || ie?.type === `native-root` ? void 0 : Math.max(0, l.tray.height),
    Ee = () => {
  ...
  let ke =
    r == null
      ...
      : (0, $.jsx)(z, {
          ...
          resizeHandle: p == null ? void 0 : { ariaLabel: G.formatMessage(_t.resizeMascot), ...p },
    ...
    children: (0, $.jsxs)(`section`, {
      ...
      children: [
        ...
        (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsxs)(`div`, {
            className: w(`relative w-max`, m && ae == null && `overflow-hidden`),
            ...
            children: [
              ...
              (0, $.jsx)(`div`, {
                children: (0, $.jsx)(qe, {
                  ...
                  trayMaxHeight: Te,
                  onDismissNotification: v === 1 || c ? N : void 0,
                  onNotificationExpansionChange: M,
                  onRunNotificationControl: P,
                  onRunNotificationAction: I,
                  onSubmitQuestionOption: L,
                  onQuickChatEditorActiveChange: (e) => {
                    ((ce.current = e), R?.(e), e ? Ee() : De());
                  },
                  onQuickChatDraftChange: B,
                  onTrayAnimationFrame: H,
...
function qe(e) {
  let t = (0, pt.c)(61),
    {
      ...
      onTrayAnimationFrame: E,
      onQuickChatEditorActiveChange: D,
      onQuickChatDraftChange: O,
      onQuickChatPointerEnter: k,
      onQuickChatPointerLeave: A,
  ...
  t[0] !== d || t[1] !== f || t[2] !== y || t[3] !== g
    ...
    : (L = t[4]);
  let R = L,
    z = x && a == null ? `true` : void 0,
    B = x && a == null && `invisible`,
    V;
  t[5] === B
    ? (V = t[6])
    : ((V = w(`absolute top-0 left-1/2 -translate-x-1/2`, B)), (t[5] = B), (t[6] = V));
  let te = x && a == null ? !0 : void 0,
    H;
  t[7] !== a ||
  t[8] !== s ||
  t[9] !== b ||
  ...
  t[19] !== I
    ...
    : (H = t[20]);
  let U;
  t[21] === H ? (U = t[22]) : ((U = (0, $.jsx)(j, { children: H })), (t[21] = H), (t[22] = U));
  let W;
  t[23] !== z || t[24] !== V || t[25] !== te || t[26] !== U
    ? ((W = (0, $.jsx)(`div`, {
        className: `relative h-10 w-[344px] shrink-0`,
        children: (0, $.jsx)(`div`, { "aria-hidden": z, className: V, inert: te, children: U }),
      })),
      (t[23] = z),
      (t[24] = V),
      (t[25] = te),
  ...
  let ne = W,
    re;
  t[28] !== R || t[29] !== ne
    ? ((re = (0, $.jsxs)($.Fragment, { children: [R, ne] })),
      (t[28] = R),
      (t[29] = ne),
      (t[30] = re))
    : (re = t[30]);
...
function Je(e) {
  ...
  t[0] === u
    ? (T = t[1])
    : ((T = u ? { duration: 0 } : { duration: 0.18, ease: [0.16, 1, 0.3, 1] }),
      (t[0] = u),
      (t[1] = T));
  let E = T;
  if (r != null) {
  ...
  t[25] !== n?.[0]?.notificationListAriaLabel || t[26] !== C
    ? ((D = n?.[0]?.notificationListAriaLabel ?? C.formatMessage(_t.notificationList)),
  ...
  t[28] === O
    ? (k = t[29])
    : ((k = w(`relative w-[345px] max-w-full shrink-0`, O)), (t[28] = O), (t[29] = k));
  let A;
...
function Ye(e) {
  ...
  if (
    ...
    let e = new Map(f.map(Xe)),
      F =
        f.length > 1 && (o || d)
          ? r.viewportRect.height
          : (r.slots[0]?.presentationRect.height ?? 0),
      z;
    t[35] !== r.slots[0]?.presentationRect || t[36] !== F || t[37] !== c || t[38] !== f.length
      ? ((z = c ? F : s(f.length, r.slots[0]?.presentationRect.height)),
      ...
      : (z = t[39]);
    let B = z;
    t[40] !== n?.[0]?.notificationListAriaLabel || t[41] !== E
      ? ((P = n?.[0]?.notificationListAriaLabel ?? E.formatMessage(_t.notificationList)),
        (t[40] = n?.[0]?.notificationListAriaLabel),
        (t[41] = E),
        (t[42] = P))
      : (P = t[42]);
    let V = i == null && `overflow-hidden`;
    (t[43] === V
      ? (I = t[44])
      : ((I = w(`relative w-[345px] max-w-full shrink-0`, V)), (t[43] = V), (t[44] = I)),
      (L = `notification-stack-visible-layout`),
      (R = `list`),
      t[45] === B ? (O = t[46]) : ((O = { height: B }), (t[45] = B), (t[46] = O)),
      t[47] !== o || t[48] !== g
        ? ((k =
            o && g != null
              ? (e) => {
          ...
          (t[49] = k))
        : (k = t[49]));
    let te = l ? `bottom-0` : `top-0`;
    (t[50] === te ? (D = t[51]) : ((D = w(`absolute inset-x-0`, te)), (t[50] = te), (t[51] = D)),
      (A = `true`),
      (j = `notification-stack-backing-layout`),
      t[52] === F ? (M = t[53]) : ((M = { height: F }), (t[52] = F), (t[53] = M)),
      (N = r.slots.map((t) => {
        let { itemId: s, presentationRect: c, slotId: l, zIndex: g } = t,
          E = e.get(s);
        if (E == null) return null;
        let D = n?.[f.indexOf(E)],
          O = !o && l !== `activity-slot-0`;
        ...
        return (0, $.jsx)(
          ee.div,
          {
            ...
            className: w(`absolute`, O && `pointer-events-none`, k && `invisible`),
            inert: k || void 0,
            style: {
            ...
            onUpdate: v,
            children: (0, $.jsx)(Qe, {
              canExpandActivityStack: !o && l === `activity-slot-0` && f.length > 1,
              copy: D,
              ...
              notificationFollowUp: p,
              publishesFollowUpVisibility: h,
              isExpanded: b == null ? void 0 : a.includes(E.id),
              onAnimationFrame: v,
    ...
    ((D = t[24]),
      ...
      (R = t[34]));
  let z;
  t[54] !== D || t[55] !== A || t[56] !== j || t[57] !== M || t[58] !== N
    ? ((z = (0, $.jsx)(`div`, {
        className: D,
...
function Ze({
  ...
  let m = u(n),
    ...
    P = async (e) => {
      if (!(e.length === 0 || b || f == null)) {
        ...
        try {
          ...
          D(g.formatMessage(_t.quickChatError));
        } finally {
          x(!1);
        }
      }
    ...
    I = a.supportState,
    {
      ...
      onTranscriptInsert: (e) => {
        let t = oe(T, e);
        t !== T && (N(t), v.current?.focus());
      },
      onTranscriptSend: (e) => {
        let t = oe(T, e);
        (N(t), P(t.trim()));
      },
      getSurroundingText: () => T,
      onStartError: (e) => {
        (m.get(B).danger(q(g, `start`, e).message),
          i.error(`[AvatarOverlay] unable to start dictation`, {
            safe: {},
            sensitive: { error: e },
          }));
      },
      onTranscribeError: (e) => {
        (m.get(B).danger(q(g, `transcription`, e).message),
          i.error(`[AvatarOverlay] dictation failed`, { safe: {}, sensitive: { error: e } }));
      },
      onUnsupported: () => {
        m.get(B).danger(
          g.formatMessage({
  ...
  let ne = async (e) => {
    (e.preventDefault(), e.stopPropagation(), !(R || z) && (await P(O)));
  };
  return (0, $.jsxs)(Be, {
    emptyWidth: k,
    nativeMaterialAttached: t,
    ...
    onBlurCapture: (e) => {
      ...
      (t instanceof Node && e.currentTarget.contains(t)) || ((y.current = !1), o?.(!1));
    },
    onPointerDown: () => {
      ((y.current = !0), o?.(!0));
    },
    ...
    children: [
      (0, $.jsx)(`input`, {
        ref: v,
        "aria-label": g.formatMessage(_t.quickChat),
        className: w(
        ...
        placeholder: e
          ? g.formatMessage(_t.startNewTaskPlaceholder)
          : g.formatMessage(_t.askPlaceholder),
        value: T,
        onChange: (e) => {
      ...
      (0, $.jsx)(ee.div, {
        ...
        children: W
          ? (0, $.jsx)(ie, {
              ...
              color: `secondary`,
              idleIcon: (0, $.jsx)(K, { className: `icon-sm` }),
              isDictating: R,
              isVisible: !0,
              isTranscribing: z,
              canRetryDictation: L,
          ...
          : (0, $.jsx)(_, {
              "aria-label": g.formatMessage(_t.sendQuickChat),
              className: `size-7 shrink-0 !bg-[#636363] !text-white enabled:hover:!bg-[#636363] disabled:opacity-100 electron:!rounded-full`,
              color: `secondary`,
              disabled: O.length === 0 || b,
              loading: b,
              size: `icon`,
              type: `submit`,
              children: b ? null : (0, $.jsx)(te, { className: `icon-sm` }),
            }),
      }),
      E == null ? null : (0, $.jsx)(`span`, { className: `sr-only`, role: `alert`, children: E }),
    ],
  });
}
function Qe(e) {
  let t = (0, pt.c)(154),
    ...
    D;
  t[0] !== C || t[1] !== u || t[2] !== r
    ? ((D = r ?? Ne({ intl: C, notification: u })), (t[0] = C), (t[1] = u), (t[2] = r), (t[3] = D))
    : (D = t[3]);
  let O = D,
    k = ye(u),
    M = u.waitingRequest,
    ...
    [R, z] = (0, Q.useState)(!1),
    B = (0, Q.useRef)(L),
    [V, H] = (0, Q.useState)(void 0),
    [U, W] = (0, Q.useState)(``),
    [re, ie] = (0, Q.useState)(!1),
    G = o || re,
    ae = (0, Q.useRef)(null),
    oe = (0, Q.useRef)(void 0),
    se = u.kind === `activity` && n && g != null,
    K = se || (u.kind !== `activity` && (g != null || u.action != null)),
    ce = u.controlTarget != null && b != null,
    q = u.isLoading && ce,
    le = R || L,
    ue = M != null && `actions` in M && M.actions.length > 0,
    de = ce && V !== void 0 && V === u.turnKey,
    fe = d?.notificationId === u.id && d.turnKey === u.turnKey ? d : null,
    J = d !== void 0,
    Y = ce && (J ? fe != null : de),
    ...
    ge = f && Y,
    _e = c && !a && ce,
    ve = M != null || Y || (G && (q || M != null)),
    be;
  t[4] !== z || t[5] !== M
    ? ((be = (e) => {
        if ((oe.current?.(), (oe.current = void 0), e == null || M == null)) return;
        let t = () => {
          let t = Array.from(
  ...
  (t[20] === de
    ...
    : ((X = () => {
      ...
      (t[21] = X),
      (t[22] = je)),
    h(`avatar-overlay-keyboard-interaction-ready`, X, je));
  let Me = Re,
    Z,
    Pe,
    Fe;
  ...
  let Ie = K ? `button` : void 0,
    Le = se ? O.expandNotificationStackAriaLabel : K ? O.actionAriaLabel : void 0,
    ze = q ? `pr-[88px]` : M == null ? `pr-[58px]` : `pr-[13px]`,
  ...
  t[29] !== K || t[30] !== u || t[31] !== g || t[32] !== x
    ? ((Ue = () => {
      ...
      (t[34] = We))
    : ((Ue = t[33]), (We = t[34]));
  let Ge = u.kind !== `activity` && `font-bold`,
    Ke = M != null && `pr-[38px]`,
    qe = M != null && L ? `break-words whitespace-pre-wrap` : `truncate`,
    Je = u.kind === `activity` && (s ? `text-[#5F6B7A]` : `text-token-text-secondary`),
    Ye = u.kind !== `activity` && (s ? `text-[#1A1A1A]` : `text-token-foreground`),
    Xe;
  t[35] !== Ge || t[36] !== Ke || t[37] !== qe || t[38] !== Je || t[39] !== Ye
    ? ((Xe = w(`text-[13px] leading-[17px]`, Ge, Ke, qe, Je, Ye)),
      (t[35] = Ge),
      (t[36] = Ke),
      (t[37] = qe),
      (t[38] = Je),
  ...
  let Qe;
  t[44] !== L || t[45] !== M
    ? ((Qe = M == null ? void 0 : { maxHeight: L ? ht : mt }),
      (t[44] = L),
      (t[45] = M),
      (t[46] = Qe))
    : (Qe = t[46]);
  let et = u.kind === `activity` && `hidden`,
    tt = s ? `text-[#5F6B7A]` : `text-token-text-secondary`,
    nt = M == null && `truncate`,
    rt = M != null && (L ? `overflow-y-auto overscroll-contain` : `overflow-hidden`),
    it;
  t[47] !== et || t[48] !== tt || t[49] !== nt || t[50] !== rt
    ? ((it = w(`text-[13px] leading-[17px]`, et, tt, nt, rt)),
      (t[47] = et),
      (t[48] = tt),
      (t[49] = nt),
      (t[50] = rt),
  ...
  t[52] === E
    ? (at = t[53])
    : ((at = E ? { duration: 0 } : { duration: 0.18, ease: [0.23, 1, 0.32, 1] }),
      (t[52] = E),
      (t[53] = at));
  let ot;
  t[54] !== O.patchSummary ||
  ...
  t[76] !== st
    ? ((ct = (0, $.jsxs)(ee.div, {
      ...
      (t[77] = ct))
    : (ct = t[77]);
  let lt = O.statusIconAriaLabel,
    ft = k.iconType,
    vt = ve && `opacity-0`,
    yt;
  t[78] === vt
    ? (yt = t[79])
    : ((yt = w(`relative flex h-8 w-[31px] items-center justify-center`, vt)),
      (t[78] = vt),
      (t[79] = yt));
  let xt = M?.kind === `question` ? (0, $.jsx)(pe, { className: k.iconClassName }) : dt(k),
    St;
  t[80] !== yt || t[81] !== xt
    ...
    : (St = t[82]);
  let Ct;
  t[83] !== O.statusIconAriaLabel || t[84] !== k || t[85] !== St
    ? ((Ct = (0, $.jsx)(`span`, {
        role: `img`,
        "aria-label": lt,
    ...
    ? ((wt =
        q && !Y
          ? (0, $.jsxs)(`div`, {
              ...
              children: [
                (0, $.jsx)(_, {
                  "aria-label": C.formatMessage(_t.replyNotification, { title: u.title }),
                  className: w(
                    bt,
                  ...
                  color: `ghost`,
                  size: `icon`,
                  title: C.formatMessage(_t.replyNotification, { title: u.title }),
                  onClick: () => {
                    (W(``),
                      H(u.turnKey),
                      J && b?.(u, { type: `open-follow-up` }),
                      _e &&
                ...
                (0, $.jsx)(_, {
                  "aria-label": C.formatMessage(_t.stopNotification, { title: u.title }),
                  className: w(
                    bt,
                  ...
                  color: `ghost`,
                  size: `icon`,
                  title: C.formatMessage(_t.stopNotification, { title: u.title }),
                  onClick: () => {
                    (W(``), H(void 0), b?.(u, { type: `stop` }));
                  },
                  children: (0, $.jsx)(ne, {
    ...
    ? ((Tt =
        M != null && (le || ue)
          ? (0, $.jsx)(`div`, {
              ...
              children: (0, $.jsx)(_, {
                "aria-expanded": L,
                "aria-label": L ? O.collapseNotificationAriaLabel : O.expandNotificationAriaLabel,
                className: w(
                  `size-8 !rounded-full`,
                  s
                ...
                onClick: () => {
                  L && z(!0);
                  let e = !L;
                  ((B.current = e), y == null ? I(e) : y(u.id, e));
                },
                children: (0, $.jsx)(ee.span, {
                  animate: { rotate: L ? 0 : -90 },
                  transition: E ? { duration: 0 } : { duration: 0.16, ease: [0.23, 1, 0.32, 1] },
                  children: (0, $.jsx)(T, { className: `size-5` }),
                }),
              }),
            })
          : null),
    ...
    ? ((Et =
        Y || _e
          ? (0, $.jsxs)(ee.form, {
              ...
              exit: a ? void 0 : { height: 0, marginBottom: 0, opacity: 0, y: E ? 0 : -2 },
              initial: a || _e ? !1 : { height: 0, marginBottom: 0, opacity: 0, y: E ? 0 : -2 },
              transition:
                a || E
                  ? { duration: 0 }
                  : {
              ...
              onSubmit: (e) => {
                ...
                let t = U.trim();
                t.length > 0 &&
                  (J || (W(``), H(void 0)), b?.(u, { type: `submit-follow-up`, prompt: t }));
              },
              children: [
                (0, $.jsx)(`input`, {
                  ref: ae,
  ...
  let Dt;
  t[128] !== p || t[129] !== Et
    ? ((Dt = (0, $.jsx)(j, { onExitComplete: p, children: Et })),
      (t[128] = p),
      (t[129] = Et),
      (t[130] = Dt))
    : (Dt = t[130]);
  ...
  switch (s.kind) {
    case `question`: {
      let e = n ? `break-words whitespace-pre-wrap` : `truncate`,
        o;
      t[2] === e ? (o = t[3]) : ((o = w(`min-w-0 pr-[38px]`, e)), (t[2] = e), (t[3] = o));
      let c;
      t[4] !== s.prompt || t[5] !== o
        ? ((c = (0, $.jsx)(`div`, {
            className: o,
...
function nt(e) {
  let t = (0, pt.c)(5),
    ...
    a;
  t[0] === i ? (a = t[1]) : ((a = w(`min-w-0 pr-[38px]`, i)), (t[0] = i), (t[1] = a));
  let o;
  return (
    t[2] !== a || t[3] !== r
      ? ((o = (0, $.jsx)(`div`, {
...
function dt(e) {
  switch (e.iconType) {
    ...
    case `clock`:
      return (0, $.jsx)(fe, { className: e.iconClassName });
    case `spinner`:
      return (0, $.jsx)(y, { Icon: je, className: `size-7` });
    case `warning`:
      return (0, $.jsx)(Y, { className: e.iconClassName });
  }
}
function ft(e, t) {
  let n = e.tray;
...
//# sourceMappingURL=avatar-overlay-native-frame-D.js.map
