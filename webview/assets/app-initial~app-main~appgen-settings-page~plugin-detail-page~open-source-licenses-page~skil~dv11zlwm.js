...
function a(e) {
  let t = (0, c.c)(6),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = r(`flex flex-col`, a)), (t[0] = a), (t[1] = o));
  let s;
  return (
    t[2] !== n || t[3] !== i || t[4] !== o
...
function o(e) {
  ...
  let p = f
    ...
    m;
  t[1] !== o || t[2] !== p ? ((m = r(p, o)), (t[1] = o), (t[2] = p), (t[3] = m)) : (m = t[3]);
  let h = u === `none` ? `gap-0` : `gap-1`,
    g;
  t[4] === h ? (g = t[5]) : ((g = r(`flex min-w-0 flex-1 flex-col`, h)), (t[4] = h), (t[5] = g));
  let _;
  t[6] === n
    ? (_ = t[7])
    : ((_ = n
...
function s(e) {
  let t = (0, c.c)(5),
    ...
    a;
  t[0] === i ? (a = t[1]) : ((a = r(`flex flex-col gap-1.5`, i)), (t[0] = i), (t[1] = a));
  let o;
  return (
    t[2] !== n || t[3] !== a
...
var c,
  ...
  u,
  d = e(() => {
    ((c = n()), i(), (l = t()), (u = Object.assign(a, { Header: o, Content: s })));
  });
