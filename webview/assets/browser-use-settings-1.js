...
import { n as Ln, t as Rn } from "./settings-empty-state.js";
import { n as zn, t as Bn } from "./use-home-directory.js";
import { a as Vn, o as Hn } from "./plugin-detail-page-utils.js";
import { n as Un, r as Wn, t as Gn } from "./browser-use-elevated-risk-learn-more-url.js";
import { n as Kn, t as qn } from "./plugin-uninstall-dialog.js";
function Jn(e) {
  let t = (0, Yn.c)(6),
    { service: n } = e,
    r = m(s);
  if (!zt(`1834314516`)) return null;
  let i = n ?? Vt.browserProfileImport;
  ...
  return (
    t[4] === a
      ? (c = t[5])
      : ((c = (0, Xn.jsx)(R, { color: `secondary`, size: `toolbar`, onClick: a, children: o })),
        (t[4] = a),
        (t[5] = c)),
    c
  );
...
function Qn() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, K.jsx)(ir, { kind: `contactInfo` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function $n() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, K.jsx)(ir, { kind: `downloads` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function er() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, K.jsx)(ir, { kind: `extensions` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function tr() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, K.jsx)(ir, { kind: `history` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function nr() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, K.jsx)(ir, { kind: `passwordManager` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function rr() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, K.jsx)(ir, { kind: `siteSettings` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function ir(e) {
  let t = (0, Fr.c)(3),
    { kind: n } = e,
    r;
  return (t[1] === n ? (r = t[2]) : ((r = (0, K.jsx)(ar, { kind: n })), (t[1] = n), (t[2] = r)), r);
}
function ar(e) {
  let t = (0, Fr.c)(71),
    { kind: n } = e,
    ...
    [m, h] = (0, Ir.useState)(null),
    g = Lr[n],
    _;
  t[0] !== r || t[1] !== g.webviewLabel
    ? ((_ = r.formatMessage(g.webviewLabel)), (t[0] = r), (t[1] = g.webviewLabel), (t[2] = _))
    : (_ = t[2]);
  let v = _,
    y,
    b;
  t[3] !== n || t[4] !== a.search || t[5] !== s?.params
    ? ((y = hr({ kind: n, search: a.search, siteSettingsRoutePath: s?.params[`*`] ?? null })),
      (b = _r(n, y)),
      (t[3] = n),
      (t[4] = a.search),
      (t[5] = s?.params),
  ...
  let x = b,
    ...
    T;
  t[8] !== C || t[9] !== n ? ((T = Ar(n, C)), (t[8] = C), (t[9] = n), (t[10] = T)) : (T = t[10]);
  let E = T,
    D = fe(se()),
    O;
  t[11] === r
  ...
  t[15] === D
    ...
    : ((M = async (e) => {
        ...
        return t == null
          ? !1
          : (await t({ mountId: e, themeVariant: D, type: `browser-settings-webview-mounted` }),
            !0);
      }),
      (t[15] = D),
      (t[16] = M));
  let N = (0, Ir.useEffectEvent)(M),
    ee;
  t[17] !== y || t[18] !== n || t[19] !== N || t[20] !== g.partition || t[21] !== v || t[22] !== x
    ? ((ee = () => {
        let e = c.current;
        if (e == null) return;
        let t = window.electronBridge?.sendMessageFromView,
          ...
          m = () => {
            !a ||
              ...
              t({ mountId: r, type: `browser-settings-webview-unmounted` }).catch((e) => {
                i.warning(`Failed to unmount browser settings webview`, {
                  safe: { kind: n },
                  sensitive: { error: e },
                });
              }));
          };
        ((u.current = Er(n, y)), (d.current = null));
        let _ = (e) => {
            let t = s;
            t != null &&
              Sr(t).then((n) => {
                o || s !== t || xr(t, y) !== e || h(n == null ? null : { title: n, url: e });
              });
          },
          b = () => {
            if (s == null || o) return;
            let e = vr(s, y),
              t = f != null && e.url === x ? { ...e, url: f } : e,
              r = d.current,
              i = Dr(u.current ?? Er(n, y), t.url, r);
            (r != null && i.index === r && i.entries[r] === t.url && (d.current = null),
              (u.current = i));
            let a = wr(t, i);
            (_(a.url),
              p((e) =>
                e != null &&
                e.initialUrl === a.initialUrl &&
                e.url === a.url &&
                e.canGoBack === a.canGoBack &&
                e.canGoForward === a.canGoForward
                  ? e
                  : a,
              ));
          },
          S = [`did-navigate`, `did-navigate-in-page`, `did-stop-loading`],
          C = () => {
            if ((b(), s == null || f == null)) return;
            let e = f;
            ((f = null),
              Or({ sourceUrl: x, targetUrl: e, webview: s }).catch((t) => {
                i.warning(`Failed to open initial browser settings URL`, {
                  safe: { kind: n },
        ...
        return (
          (async () => {
            try {
              ...
              ((s = document.createElement(`webview`)),
                (s.className = `no-drag h-full w-full bg-token-main-surface-primary`),
                s.setAttribute(`aria-label`, v),
                s.setAttribute(`partition`, g.partition),
                s.setAttribute(`src`, x),
                s.addEventListener(`dom-ready`, C));
              for (let e of S) s.addEventListener(e, b);
              ((l.current = s), e.append(s), b());
            } catch (e) {
              let t = e;
              i.error(`Failed to mount browser settings webview`, {
                safe: { kind: n },
                sensitive: { error: t },
              });
            }
          ...
          () => {
            ((o = !0),
              l.current === s && ((l.current = null), (u.current = null), (d.current = null)),
              s?.removeEventListener(`dom-ready`, C));
            for (let e of S) s?.removeEventListener(e, b);
            (s?.remove(), s != null && pr(s), m());
          }
        );
      }),
      (t[17] = y),
  ...
  (t[24] !== y || t[25] !== n || t[26] !== g || t[27] !== v || t[28] !== x
    ? ((P = [y, n, g, v, x]),
      ...
      (t[29] = P))
    : (P = t[29]),
    (0, Ir.useLayoutEffect)(ee, P));
  let F, I;
  (t[30] !== n || t[31] !== D
    ? ((I = () => {
        let e = window.electronBridge?.sendMessageFromView;
        e?.({ themeVariant: D, type: `browser-settings-webview-theme-changed` }).catch((e) => {
          i.warning(`Failed to sync browser settings webview theme`, {
            safe: { kind: n },
            sensitive: { error: e },
          });
        });
      ...
      (t[33] = I))
    : ((F = t[32]), (I = t[33])),
    (0, Ir.useLayoutEffect)(I, F));
  let L, te;
  t[34] !== y || t[35] !== n
    ? ((L = (e) => {
        let t = u.current;
        return t == null ? !1 : te(t.index + e);
      }),
      (te = (e) => {
        let t = l.current,
          r = u.current;
        ...
        return (
          (u.current = s),
          (d.current = e),
          p(Tr({ history: s, initialUrl: y, url: a, webview: t })),
          Or({ sourceUrl: o, targetUrl: a, webview: t }).catch((e) => {
            i.warning(`Failed to navigate browser settings webview`, {
              safe: { kind: n },
              sensitive: { error: e, targetUrl: a },
            });
          }),
          !0
        );
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (0, K.jsx)(`div`, { "aria-hidden": !0, className: `draggable absolute inset-0` })),
      (t[46] = ae))
    : (ae = t[46]);
  let oe = S?.canGoBack === !0 || E != null,
    ce = S?.canGoForward ?? !1,
    le;
  t[47] !== E || t[48] !== o || t[49] !== L
    ? ((le = () => {
        let e = l.current;
  ...
  t[51] === L
    ...
    : ((ue = () => {
      ...
      (t[52] = ue));
  let pe;
  t[53] !== k || t[54] !== j || t[55] !== oe || t[56] !== ce || t[57] !== le || t[58] !== ue
    ? ((pe = (0, K.jsx)(`div`, {
...
function or(e) {
  let t = (0, Fr.c)(27),
    ...
    l;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((l = lr({ currentPageTitle: n, currentUrl: r, kind: i })),
      (t[0] = n),
      (t[1] = r),
      (t[2] = i),
      (t[3] = l))
  ...
  t[9] === f
    ? (m = t[10])
    : ((m = (0, K.jsx)(sr, { onClick: f, children: p })), (t[9] = f), (t[10] = m));
  let h;
  ...
  t[15] === g
    ? (v = t[16])
    : ((v = (0, K.jsx)(sr, { onClick: g, children: _ })), (t[15] = g), (t[16] = v));
  let y;
    ...
    ? ((b =
        u == null
          ? (0, K.jsx)(`span`, {
              ...
              children: (0, K.jsx)(H, { ...c.breadcrumbLabel }),
            })
          : (0, K.jsxs)(K.Fragment, {
              children: [
                (0, K.jsx)(sr, { onClick: a, children: (0, K.jsx)(H, { ...c.breadcrumbLabel }) }),
                (0, K.jsx)(cr, {}),
                (0, K.jsx)(`span`, { className: `text-token-text-primary`, children: u }),
              ],
            })),
      (t[18] = a),
...
function cr() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, K.jsx)(we, { className: `icon-xs text-token-text-secondary` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function lr({ currentPageTitle: e, currentUrl: t, kind: n }) {
  let r = Lr[n];
  return ur(r, t) ? null : n === `siteSettings` ? (fr(t, e) ?? e) : e;
}
function ur(e, t) {
  return e.rootUrls.some((e) => dr(e) === dr(t));
}
function dr(e) {
...
function fr(e, t) {
  ...
  if (t != null) return t;
  let r = Mr(n);
  return r == null ? Nr(n) : (0, K.jsx)(H, { ...r });
}
function pr(e) {
  mr(e) && e.destroy();
}
...
function hr({ kind: e, search: t, siteSettingsRoutePath: n }) {
  let r = Lr[e];
  return e === `siteSettings` ? (S(new URLSearchParams(t).get(`site`)) ?? gr(n) ?? r.url) : r.url;
}
function gr(e) {
...
function _r(e, t) {
  return e === `siteSettings` && jr(t) === `siteDetails` ? p : t;
}
function vr(e, t) {
  return { canGoBack: yr(e), canGoForward: br(e), initialUrl: t, url: xr(e, t) };
}
function yr(e) {
  try {
...
function Tr({ history: e, initialUrl: t, url: n, webview: r }) {
  return wr({ ...vr(r, t), url: n }, e);
}
function Er(e, t) {
  return e !== `siteSettings` || jr(t) == null
    ? { entries: [t], index: 0, preferHistoryControls: e === `siteSettings` }
    : { entries: [p, t], index: 1, preferHistoryControls: !0 };
}
function Dr(e, t, n) {
...
async function Or({ sourceUrl: e, targetUrl: t, webview: n }) {
  if (!(t === `chrome://settings/content` && jr(e) != null && (await kr(n)))) {
    if (n.loadURL != null) {
      await n.loadURL(t);
      return;
    }
...
function Ar(e, t) {
  return e === `siteSettings`
    ? jr(t) == null
      ? dr(t) === dr(`chrome://settings/content`)
...
function zr() {
  let e = (0, Vr.c)(3),
    { selectedHostId: t } = nn();
  if (xt(t).kind !== `local`) return null;
  let n;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((n = (0, q.jsx)(W.Header, {
        title: (0, q.jsx)(H, {
      ...
      : ((r = (0, q.jsx)(tt, {
          ...
          children: (0, q.jsxs)(W, {
            children: [
              n,
              (0, q.jsx)(W.Content, {
                children: (0, q.jsx)(G, { children: (0, q.jsx)(Br, { hostId: t }) }),
              }),
            ],
          }),
        })),
...
function Br(e) {
  let t = (0, Vr.c)(25),
    { hostId: n } = e,
    r = Ft(),
    { data: i, isLoading: a } = ne(rn),
    o;
  t[0] === n ? (o = t[1]) : ((o = { hostId: n }), (t[0] = n), (t[1] = o));
  let { data: s, isPending: c } = l(Gt, o),
    u;
  t[2] === n ? (u = t[3]) : ((u = { hostId: n }), (t[2] = n), (t[3] = u));
  let d = mn(u),
    f = s?.requirements?.featureRequirements?.[It],
    p;
  t[4] === f ? (p = t[5]) : ((p = Bt(f)), (t[4] = f), (t[5] = p));
  let m = p,
    h = a || c,
    g = i?.fullCdpAccessEnabled === !0 && !h && !m,
    _;
    ...
    ? ((_ = (0, q.jsxs)(`div`, {
        ...
        children: [
          (0, q.jsxs)(`span`, {
            ...
            children: [
              (0, q.jsx)(Pn, { className: `icon-xs shrink-0` }),
              (0, q.jsx)(H, {
  ...
  t[11] === y
    ? (b = t[12])
    : ((b = (0, q.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [v, y] })),
      (t[11] = y),
      (t[12] = b));
  let x;
  t[13] === r
  ...
  t[15] === d
    ...
    : ((C = (e) => {
      ...
      (t[16] = C));
  let w;
  t[17] !== g || t[18] !== S || t[19] !== C || t[20] !== x
    ? ((w = (0, q.jsx)($e, { ariaLabel: x, checked: g, disabled: S, onChange: C })),
      (t[17] = g),
      (t[18] = S),
      (t[19] = C),
      (t[20] = x),
  ...
  return (
    t[22] !== w || t[23] !== b
      ? ((T = (0, q.jsx)(U, { label: _, description: b, control: w })),
        (t[22] = w),
        (t[23] = b),
        (t[24] = T))
      : (T = t[24]),
...
function ei(e, t) {
  let n = new Set();
  for (let r of t) {
    for (let t of ii(e, r, `allowed`)) n.add(t);
    for (let t of ii(e, r, `denied`)) n.add(t);
  }
  return [...n]
    ...
    .map((t) => ({
      origin: t,
      values: {
        origin: ri(e, `origin`, t),
        download: ri(e, `download`, t),
        upload: ri(e, `upload`, t),
        fullCdp: ri(e, `fullCdp`, t),
      },
    }));
}
function ti(e, t) {
...
function ni({ nextValues: e, origin: t, resources: n, values: r }) {
  return n.flatMap((n) => {
    let i = r[n],
      a = e[n];
    if (a === i) return [];
...
function ri(e, t, n) {
  return ii(e, t, `denied`).includes(n)
    ? `denied`
    : ii(e, t, `allowed`).includes(n)
      ? `allowed`
      : `default`;
}
function ii(e, t, n) {
...
function oi() {
  let e = (0, bi.c)(12),
    { selectedHostId: t } = nn(),
    { data: n, isError: r, isLoading: i } = ne(rn),
    a;
  e[0] === t ? (a = e[1]) : ((a = { hostId: t }), (e[0] = t), (e[1] = a));
  let { data: o, isError: s, isPending: c } = l(Gt, a),
    u = n?.fullCdpAccessEnabled === !0,
    d = r || (u && s),
    f = i || (u && c),
    p;
  e[2] !== o?.requirements?.featureRequirements || e[3] !== s || e[4] !== c || e[5] !== u
    ? ((p =
        u && !s && !c && !Bt(o?.requirements?.featureRequirements?.browser_use_full_cdp_access)),
  ...
  let m = p,
    h;
  return (
    e[7] !== d || e[8] !== m || e[9] !== f || e[10] !== n
      ? ((h = (0, X.jsx)(si, {
          originsConfig: n,
          isError: d,
          isFullCdpAccessEnabled: m,
          isLoading: f,
        })),
        (e[7] = d),
        (e[8] = m),
...
function si(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = () => {
      ...
      (h = (0, X.jsx)(Ue, { className: `icon-xs` })),
      (g = (0, X.jsx)(H, {
  ...
  t[11] === _
    ? (b = t[12])
    : ((b = (0, X.jsx)(W.Header, { actions: _, title: v, subtitle: y })), (t[11] = _), (t[12] = b));
  let x;
          ...
          children: n
            ...
            : i || f == null
              ...
              : f.length === 0
                ...
                : (0, X.jsx)(ci, { rows: f, onCustomize: l, visibleResources: d }),
        }),
      })),
      (t[13] = n),
      (t[14] = i),
  ...
  let S;
  t[18] !== o || t[19] !== d
    ? ((S = (0, X.jsx)(hi, { open: o, visibleResources: d, onOpenChange: s })),
      (t[18] = o),
      (t[19] = d),
      (t[20] = S))
    : (S = t[20]);
  ...
  return (
    t[24] !== x || t[25] !== S || t[26] !== C || t[27] !== b
      ? ((w = (0, X.jsxs)(W, { className: `gap-2`, children: [b, x, S, C] })),
        (t[24] = x),
        (t[25] = S),
        (t[26] = C),
        (t[27] = b),
...
function ci(e) {
  ...
  return (
    t[8] === a
      ? (s = t[9])
      : ((s = (0, X.jsxs)(X.Fragment, { children: [a, o] })), (t[8] = a), (t[9] = s)),
    s
  );
}
function li(e) {
  let t = (0, bi.c)(25),
    ...
    a;
  t[0] !== r || t[1] !== i ? ((a = ti(r, i)), (t[0] = r), (t[1] = i), (t[2] = a)) : (a = t[2]);
  let o = a,
    s;
  t[3] === r.origin
    ? (s = t[4])
  ...
  t[15] !== n || t[16] !== r || t[17] !== i
    ? ((d = (0, X.jsx)(ui, { row: r, visibleResources: i, onCustomize: n })),
      (t[15] = n),
      (t[16] = r),
      (t[17] = i),
      (t[18] = d))
    : (d = t[18]);
  let f;
  t[19] === r ? (f = t[20]) : ((f = (0, X.jsx)(pi, { row: r })), (t[19] = r), (t[20] = f));
  let p;
  return (
...
function ui({ onCustomize: e, row: t, visibleResources: n }) {
  let r = m(s),
    i = Ft(),
    [a, o] = (0, Y.useState)(!1),
    c = un(),
  ...
  return (0, X.jsx)(Ke, {
    ...
    triggerButton: (0, X.jsxs)(yn, {
      ...
      children: [
        (0, X.jsx)(`span`, {
          ...
          children:
            l === `custom`
              ? (0, X.jsx)(he, { className: `icon-xs text-token-text-secondary` })
              : (0, X.jsx)(di, { value: l }),
        }),
        (0, X.jsx)(`span`, { className: `truncate`, children: _i(l) }),
      ],
    }),
    children: (0, X.jsxs)(`div`, {
      ...
      children: [
          ...
          (0, X.jsx)(
            it.Item,
            {
              ...
              children: (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(di, { value: e }),
                  (0, X.jsx)(`span`, { className: `truncate`, children: _i(e) }),
                ],
              }),
            },
            e,
        ...
        (0, X.jsx)(it.Separator, {}),
        (0, X.jsx)(it.Item, {
          RightIcon: l === `custom` ? je : void 0,
          onSelect: e,
          children: (0, X.jsxs)(`div`, {
            className: `flex min-w-0 items-center gap-2`,
            children: [
              (0, X.jsx)(he, { className: `icon-xs shrink-0 text-token-text-secondary` }),
              (0, X.jsx)(H, {
...
function di(e) {
  let t = (0, bi.c)(6),
    ...
    o;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((o = nt(`size-2 shrink-0 rounded-full`, r, i, a)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a),
      (t[3] = o))
  ...
  let s;
  return (
    t[4] === o ? (s = t[5]) : ((s = (0, X.jsx)(`span`, { className: o })), (t[4] = o), (t[5] = s)),
    s
  );
}
function fi(e) {
  let t = (0, bi.c)(21),
    ...
    s = `${r} ${o}`,
    c;
  t[0] === a ? (c = t[1]) : ((c = (0, X.jsx)(di, { value: a })), (t[0] = a), (t[1] = c));
  let l;
  t[2] === a ? (l = t[3]) : ((l = vi(a)), (t[2] = a), (t[3] = l));
  let u;
  t[4] !== l || t[5] !== o
        ...
        (0, X.jsx)(
          it.Item,
          {
            ...
            children: (0, X.jsxs)(`div`, {
              ...
              children: [
                (0, X.jsx)(di, { value: e }),
                (0, X.jsx)(`span`, { className: `truncate`, children: vi(e) }),
              ],
            }),
          },
          e,
  ...
  return (0, X.jsxs)(X.Fragment, {
    children: [
      (0, X.jsx)(R, {
        ...
        size: `icon`,
        children: (0, X.jsx)(pn, { className: `icon-2xs` }),
      }),
      (0, X.jsx)(ft, {
        open: r,
        onOpenChange: i,
...
function mi({ onOpenChange: e, row: t, visibleResources: n }) {
  let r = m(s),
    ...
    u = async () => {
      if (!o) {
        ...
        try {
          (await l.mutateAsync(
            ni({ nextValues: i, origin: t.origin, resources: n, values: t.values }),
          ),
            e(!1));
        } catch {
          r.get(B).danger(yi());
          ...
          children: (0, X.jsx)(gt, {
            ...
            subtitle: (0, X.jsx)(Pe, {
              ...
              children: (0, X.jsxs)(`div`, {
                className: `flex flex-col gap-1`,
                children: [
                  (0, X.jsx)(`span`, { className: `text-token-text-primary`, children: t.origin }),
                  (0, X.jsx)(H, {
          ...
          children: (0, X.jsx)(G, {
            ...
            children: n.map((e) => {
              ...
              return (0, X.jsx)(
                U,
                {
                  label: (0, X.jsx)(`span`, { id: t, children: gi(e) }),
                  control: (0, X.jsx)(fi, {
                    disabled: o,
                    labelId: t,
                    value: i[e],
...
function hi({ onOpenChange: e, open: t, visibleResources: n }) {
  let r = m(s),
    i = Ft(),
    [a, o] = (0, Y.useState)(``),
    ...
    x = async () => {
      ...
      if (!(t.length === 0 || h)) {
        ...
        try {
          (await _.mutateAsync(
            ni({ nextValues: { ...u, origin: c }, origin: t, resources: n, values: Ti }),
          ),
            b(),
            e(!1));
        } catch {
              ...
              children: [
                ...
                (0, X.jsx)(Ke, {
                  ...
                  triggerButton: (0, X.jsxs)(yn, {
                    ...
                    children: [
                      (0, X.jsx)(di, { value: c }),
                      (0, X.jsx)(`span`, { id: y, className: `truncate`, children: _i(c) }),
                    ],
                  }),
...
var bi,
  ...
  Ei = e(() => {
    ((bi = N()),
      ...
      (X = I()),
      (xi = [`allowed`, `denied`]),
      (Si = [`default`, `allowed`, `denied`]),
      (Ci = { origin: `origin`, download: `download`, upload: `upload`, fullCdp: `fullCdp` }),
      (wi = { download: `default`, upload: `default`, fullCdp: `default` }),
      (Ti = { origin: `default`, ...wi }));
  });
function Di(e) {
  let t = (0, Mi.c)(57),
    {
  ...
  let { pendingPluginId: x, setPluginEnabled: S } = Ie(b),
    C;
  t[7] === o ? (C = t[8]) : ((C = { hostId: o }), (t[7] = o), (t[8] = C));
  let { pendingUninstallPluginId: w, uninstallPlugin: T } = Ee(C),
    [E, D] = (0, Ni.useState)(null),
    ...
    return (
      t[9] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsx)(`div`, {
            ...
            children: (0, Z.jsx)(ye, { className: `icon-xs` }),
          })),
          (t[9] = e))
        : (e = t[9]),
      e
  ...
  if (A === 0) {
    ...
    return (
      t[12] === n
        ? (e = t[13])
        : ((e = (0, Z.jsx)(G, { children: (0, Z.jsx)(Rn, { children: n }) })),
          (t[12] = n),
          (t[13] = e)),
      e
    );
            ...
            ? (0, Z.jsx)(
                U,
                {
                  ...
                  icon: (0, Z.jsx)(`span`, {
                    ...
                    children:
                      e.icon ?? (0, Z.jsx)(On, { className: `icon-md text-token-text-secondary` }),
                  }),
                  label: (0, Z.jsx)(`span`, {
                ...
                ji,
                {
                  ...
                  onToggleInstalledPluginEnabled: (t, n) => {
                    S({
                      ...
                      pluginDisplayName: e.displayName ?? mt(t),
                      enabled: n,
                    });
                  },
                  onUninstallPlugin: D,
  ...
  let M;
  t[29] === l ? (M = t[30]) : ((M = l.map(Oi)), (t[29] = l), (t[30] = M));
  let N;
  t[31] !== j || t[32] !== M
    ? ((N = (0, Z.jsxs)(G, { className: `overflow-hidden`, children: [j, M] })),
      (t[31] = j),
      (t[32] = M),
      (t[33] = N))
    : (N = t[33]);
  ...
  let L;
  return (
    t[53] !== F || t[54] !== I || t[55] !== N
      ? ((L = (0, Z.jsxs)(Z.Fragment, { children: [N, F, I] })),
        (t[53] = F),
        (t[54] = I),
        (t[55] = N),
        (t[56] = L))
...
function ki(e) {
  ...
  t[0] === n.icon
    ? (i = t[1])
    : ((i = n.icon ?? (0, Z.jsx)(On, { className: `icon-md text-token-text-secondary` })),
      (t[0] = n.icon),
      (t[1] = i));
  let a;
  t[2] === i
  ...
  t[16] === u
    ? (d = t[17])
    : ((d = (0, Z.jsx)($e, { ariaLabel: u, checked: !1, disabled: !0, onChange: Ai })),
      (t[16] = u),
      (t[17] = d));
  let f;
  return (
...
function ji(e) {
  ...
  if (
    ...
    let e = i.displayName ?? mt(i.plugin),
    ...
    let y =
        ...
        (0, Z.jsx)(ve, {
          ...
          fallback: (0, Z.jsx)(On, { className: `icon-md text-token-text-secondary` }),
        }),
      b;
    t[18] !== v || t[19] !== y
...
function Fi(e, t, n) {
  ...
  return (
    ...
    r.find((e) => L(e.marketplaceName)) ??
    r.find((e) => e.marketplaceName === `openai-curated`) ??
    r.find((e) => Hn(n, e.marketplacePath)) ??
    null
  );
}
var Ii = e(() => {
...
function Li() {
  ...
  if (r != null) {
    if (r === `downloads` && !l) {
      ...
      return (
        e[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(wt, { to: `/settings/browser-use`, replace: !0 })), (e[4] = t))
          : (t = e[4]),
        t
      );
    }
    ...
    if (!i.enabled && !a) {
      ...
      return (
        e[6] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(wt, { to: `/settings/browser-use`, replace: !0 })), (e[6] = t))
          : (t = e[6]),
        t
      );
    }
    n !== r && t.set(Sa, r);
    let s;
    return (e[7] === r ? (s = e[8]) : ((s = Yi(r)), (e[7] = r), (e[8] = s)), s);
  }
  n != null && t.set(Sa, null);
  let u;
  ...
  e[10] === c.available
    ...
    : ((d = c.available
        ? (0, $.jsx)(H, {
            ...
            values: { computerUseSettingsLink: Ri },
          })
        : void 0),
      (e[10] = c.available),
      (e[11] = d));
...
function zi() {
  ...
  e[1] !== i || e[2] !== r.availablePlugins
    ? ((a = Fi(r.availablePlugins, ee, i)), (e[1] = i), (e[2] = r.availablePlugins), (e[3] = a))
    : (a = e[3]);
  let o = a,
    s;
  ...
  e[14] !== o || e[15] !== m
    ? ((E =
        o == null && ua(m)
          ? [
              {
                description: (0, $.jsx)(H, { ...pe.restrictedAvailabilityDescription }),
                icon: (0, $.jsx)(Mn, { className: `h-full w-full text-token-foreground` }),
                id: `browser-use-unavailable`,
                title: (0, $.jsx)(H, { ...pe.label }),
              },
            ]
          : []),
      (e[14] = o),
        ...
        ? (0, $.jsxs)(W, {
            children: [
              ...
              (0, $.jsx)(W.Content, {
                children: (0, $.jsxs)(G, {
                  children: [
                    _ ? (0, $.jsx)(tt, { electron: !0, children: (0, $.jsx)(Zi, {}) }) : null,
                    (0, $.jsx)($i, {}),
                    (0, $.jsx)(ta, { includeHistory: f.history.enabled }),
                    f.history.enabled ? (0, $.jsx)(Gi, {}) : null,
                    (0, $.jsx)(Xi, {}),
                  ],
                }),
              }),
    ...
    ? ((A = x
        ? (0, $.jsxs)(W, {
            children: [
              ...
              (0, $.jsx)(W.Content, {
                children: (0, $.jsxs)(G, {
                  children: [y ? (0, $.jsx)(Hi, {}) : null, b ? (0, $.jsx)(Ui, {}) : null],
                }),
              }),
            ],
          })
    ...
    : ((j = C
        ? (0, $.jsxs)(W, {
            children: [
              ...
              (0, $.jsx)(W.Content, { children: (0, $.jsx)(G, { children: (0, $.jsx)(Wi, {}) }) }),
            ],
          })
        : null),
      (e[30] = C),
  ...
  e[32] !== _ || e[33] !== f.downloads
    ? ((M =
        !_ || !f.downloads.enabled
          ? null
          : (0, $.jsx)(tt, { electron: !0, children: (0, $.jsx)(Bi, {}) })),
      (e[32] = _),
      (e[33] = f.downloads),
      (e[34] = M))
    : (M = e[34]);
  let N;
  e[35] !== T || e[36] !== w || e[37] !== S
    ? ((N = T
        ? (0, $.jsxs)(W, {
            children: [
              (0, $.jsx)(W.Header, {
              ...
              (0, $.jsx)(W.Content, {
                children: (0, $.jsxs)(G, {
                  children: [S ? (0, $.jsx)(Ki, {}) : null, w ? (0, $.jsx)(sa, {}) : null],
                }),
              }),
            ],
          })
  ...
  e[39] === w
    ...
    : ((P = w
        ? (0, $.jsxs)($.Fragment, {
            children: [(0, $.jsx)(Vi, { surface: `inAppBrowser` }), (0, $.jsx)(zr, {})],
          })
        : null),
      (e[39] = w),
      (e[40] = P));
  ...
  return (
    ...
    e[46] !== O ||
    e[47] !== k
      ? ((F = (0, $.jsxs)($.Fragment, { children: [O, k, A, j, M, N, P] })),
        (e[41] = A),
        (e[42] = j),
        (e[43] = M),
        (e[44] = N),
...
function Bi() {
  let e = m(s),
    ...
    [r, i] = (0, _a.useState)(!1),
    a = Vt?.downloads,
    o = Fe(M.downloadDirectory),
    c = Fe(M.promptForDownloadLocation);
  if (a == null) return null;
  let l = async () => {
    i(!0);
    try {
      let t = await a.chooseDownloadDirectory();
      t != null && (await Te(e, M.downloadDirectory, t));
    } catch {
      e.get(B).danger(
        t.formatMessage({
          ...
          children: [
            ...
            (0, $.jsx)(U, {
              ...
              control: (0, $.jsx)($e, {
                ...
                checked: c,
                onChange: (t) => {
                  Te(e, M.promptForDownloadLocation, t);
                },
              }),
            }),
            (0, $.jsx)(U, {
...
function Vi(e) {
  ...
  t[0] === n
    ? ((r = t[1]), (i = t[2]), (a = t[3]))
    : ((r = (0, $.jsx)(da, { kind: `denied`, surface: n })),
      (i = (0, $.jsx)(da, { kind: `allowed`, surface: n })),
      (a =
        n === `googleChrome`
          ? (0, $.jsxs)($.Fragment, {
              children: [
                (0, $.jsx)(da, { kind: `denied`, resource: `downloads`, surface: n }),
                (0, $.jsx)(da, { kind: `allowed`, resource: `downloads`, surface: n }),
                (0, $.jsx)(da, { kind: `denied`, resource: `uploads`, surface: n }),
                (0, $.jsx)(da, { kind: `allowed`, resource: `uploads`, surface: n }),
              ],
            })
          : null),
      (t[0] = n),
  ...
  let o;
  t[4] !== r || t[5] !== i || t[6] !== a
    ? ((o = (0, $.jsxs)($.Fragment, { children: [r, i, a] })),
      (t[4] = r),
      (t[5] = i),
      (t[6] = a),
      (t[7] = o))
  ...
  let s = o,
    c;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(tt, { electron: !0, children: (0, $.jsx)(oi, {}) })), (t[8] = c))
    : (c = t[8]);
  let l;
  return (
    t[9] === s
      ...
      : ((l = (0, $.jsxs)($.Fragment, {
          children: [
            c,
            (0, $.jsx)(tt, { browser: !0, chromeExtension: !0, extension: !0, children: s }),
          ],
        })),
        (t[9] = s),
        (t[10] = l)),
...
function qi(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, $.jsx)(R, { color: `secondary`, onClick: o, size: `toolbar`, children: s })),
      (t[4] = o),
      (t[5] = c));
  let l;
  return (
    t[6] !== n || t[7] !== r || t[8] !== c
      ? ((l = (0, $.jsx)(U, { label: r, description: n, control: c })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = c),
        (t[9] = l))
...
function Xi() {
  let e = (0, Q.c)(14),
    t = m(s),
    n = Fe(M.annotationScreenshotsMode),
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = {
        id: `always`,
  ...
  let a = i,
    o;
  e[2] === n ? (o = e[3]) : ((o = a.find((e) => e.id === n) ?? a[0]), (e[2] = n), (e[3] = o));
  let c = o,
    l,
    u;
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    ? ((f = (0, $.jsx)(`div`, {
        ...
        children: a.map((e) => {
          ...
          return (0, $.jsx)(
            ...
            {
              allowWrap: !0,
              RightIcon: r ? je : void 0,
              onSelect: () => {
                Te(t, M.annotationScreenshotsMode, e.id);
              },
...
function Zi() {
  ...
  e[2] === n
    ? (a = e[3])
    : ((a = (0, $.jsx)(yn, { children: (0, $.jsx)(Qi, { target: n }) })), (e[2] = n), (e[3] = a));
  let o;
  e[4] !== t || e[5] !== n
    ? ((o = xa.map((e) =>
        (0, $.jsx)(
          it.Item,
          {
            onSelect: () => {
              n !== e &&
                (Te(t, ie.openLinkInTargetPreference, e),
                St(t, Wt, { setting: `web_url`, previousDestination: n, selectedDestination: e }));
            },
            RightIcon: n === e ? je : void 0,
            children: (0, $.jsx)(`span`, {
              className: `text-sm`,
              children: (0, $.jsx)(Qi, { target: e }),
            }),
          },
          e,
        ),
...
function $i() {
  let e = (0, Q.c)(10),
    t = m(s),
    n = Fe(ie.openLocalUrlInTargetPreference),
    r,
    i;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(H, {
  ...
  e[2] === n
    ? (a = e[3])
    : ((a = (0, $.jsx)(yn, { children: (0, $.jsx)(ea, { target: n }) })), (e[2] = n), (e[3] = a));
  let o;
  e[4] !== t || e[5] !== n
    ? ((o = xa.map((e) =>
        (0, $.jsx)(
          it.Item,
          {
            onSelect: () => {
              n !== e &&
                (Te(t, ie.openLocalUrlInTargetPreference, e),
                St(t, Wt, {
                  setting: `local_url`,
...
function ta({ includeHistory: e }) {
  let t = m(s),
    [n, r] = (0, _a.useState)(!1),
    [i, a] = (0, _a.useState)(null),
    o = Zt(),
    c = o.isPending,
    l = e ? ba : ya,
    u = async (e, n) => {
      if (!c) {
        a(e);
        try {
          (await o.mutateAsync(n), t.get(B).success(aa(e)));
        } catch {
          t.get(B).danger(oa(e));
        } finally {
          a(null);
...
function na(e) {
  let t = (0, Q.c)(17),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = ra(a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] === o
    ? (s = t[3])
    : ((s = (0, $.jsx)(`div`, {
  ...
  t[4] !== a || t[5] !== i
    ...
    : (c = t[6]);
  let l;
  t[7] === a ? (l = t[8]) : ((l = ia(a)), (t[7] = a), (t[8] = l));
  let u;
...
function sa() {
  let e = (0, Q.c)(35),
    t = m(s),
    { data: n, isLoading: r } = ne(rn),
    i = n?.approvalMode,
    a = Yt(),
    { value: o } = Rt(Gn),
    c;
  e[0] === o ? (c = e[1]) : ((c = Un(o)), (e[0] = o), (e[1] = c));
  let l = c,
    u;
  e[2] === l
    ? (u = e[3])
    : ((u = (e) => {
        Ze({ event: e, href: l, initiator: `open_in_browser_bridge` });
      }),
      (e[2] = l),
      (e[3] = u));
  let d = u,
  ...
  e[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = [
        h,
        {
          ...
          elevatedRiskDisclaimer: (0, $.jsx)(H, {
  ...
  let _ = g,
    v;
  e[9] === i ? (v = e[10]) : ((v = _.find((e) => e.id === i) ?? _[0]), (e[9] = i), (e[10] = v));
  let y = v,
    b = a.isPending,
    x;
  e[11] !== i || e[12] !== b || e[13] !== t || e[14] !== a
    ? ((x = async (e) => {
        if (!(e === i || b))
          try {
  ...
  e[19] === D
    ? (O = e[20])
    : ((O = (0, $.jsx)(`span`, { className: `truncate`, children: D })), (e[19] = D), (e[20] = O));
  let k;
  e[21] !== E || e[22] !== O
    ? ((k = (0, $.jsx)(yn, { className: `w-[152px]`, disabled: E, children: O })),
      (e[21] = E),
      (e[22] = O),
      (e[23] = k))
    : (k = e[23]);
  let A;
  e[24] !== i || e[25] !== S || e[26] !== b
    ? ((A = (0, $.jsx)(`div`, {
        className: `flex flex-col`,
        children: _.map((e) => {
          let t = e.id === i;
  ...
  return (
    e[32] !== j || e[33] !== w
      ? ((M = (0, $.jsx)(U, { label: C, description: w, control: j })),
        (e[32] = j),
        (e[33] = w),
        (e[34] = M))
      : (M = e[34]),
...
function ca() {
  ...
  let l = c,
    u;
  e[2] === i ? (u = e[3]) : ((u = l.find((e) => e.id === i) ?? l[0]), (e[2] = i), (e[3] = u));
  let d = u,
    f = a.isPending,
    p;
  e[4] !== i || e[5] !== f || e[6] !== t || e[7] !== a
    ? ((p = async (e) => {
        if (!(e === i || f))
          try {
            await a.mutateAsync(e);
  ...
  e[11] === b
    ? (x = e[12])
    : ((x = (0, $.jsx)(`span`, { className: `truncate`, children: b })), (e[11] = b), (e[12] = x));
  let S;
  e[13] !== y || e[14] !== x
    ? ((S = (0, $.jsx)(yn, { className: `w-[152px]`, disabled: y, children: x })),
      (e[13] = y),
      (e[14] = x),
      (e[15] = S))
    : (S = e[15]);
  let C;
  e[16] !== h || e[17] !== i || e[18] !== f
    ? ((C = (0, $.jsx)(`div`, {
        className: `flex flex-col`,
        children: l.map((e) => {
          let t = e.id === i;
    ...
    (t[5] === o
      ...
      : ((e = (e) => ({
          ...
          onTryInChat: () => {
            o({
              prefillPrompt: gn({
                defaultPrompt: vn(e.plugin.interface?.defaultPrompt),
                pluginDisplayName: mt(e),
                pluginId: e.plugin.id,
              }),
              startInSidebar: !0,
...
function da(e) {
  let t = (0, Q.c)(37),
    ...
    c = m(s),
    { data: l, isLoading: u } = ne(rn),
    [d, f] = (0, _a.useState)(!1),
    p = sn(),
    h = Jt(),
    g;
  t[0] !== n || t[1] !== l || t[2] !== a
    ? ((g = l == null ? [] : ga(l, a, n)), (t[0] = n), (t[1] = l), (t[2] = a), (t[3] = g))
    : (g = t[3]);
  let _ = g,
    v = a === `origins` ? p.isPending : h.isPending,
    y;
  t[4] !== h || t[5] !== p || t[6] !== n || t[7] !== _ || t[8] !== a || t[9] !== c
    ? ((y = async (e) => {
        let t = e.trim();
        if (t.length === 0 || _.includes(t)) return !0;
        try {
          return (
            a === `origins`
              ? await p.mutateAsync({ kind: n, origin: t })
              : await h.mutateAsync({
                  kind: n,
                  origin: t,
                  transferKind: a === `downloads` ? `download` : `upload`,
                }),
            c.get(B).success(Gr(a, n)),
            !0
          );
        } catch {
          return (
  ...
  let S;
  t[12] !== n || t[13] !== a
    ? ((S = Ur(a, n)), (t[12] = n), (t[13] = a), (t[14] = S))
    : (S = t[14]);
  let C;
  t[15] !== n || t[16] !== a || t[17] !== o
    ? ((C = Wr(a, n, o)), (t[15] = n), (t[16] = a), (t[17] = o), (t[18] = C))
    : (C = t[18]);
  let w;
  t[19] !== S || t[20] !== C
    ? ((w = (0, $.jsx)(W.Header, { actions: x, title: S, subtitle: C })),
      (t[19] = S),
      (t[20] = C),
      (t[21] = w))
    : (w = t[21]);
  let T;
  t[22] !== u || t[23] !== n || t[24] !== _ || t[25] !== a
    ? ((T = (0, $.jsx)(W.Content, {
        children: (0, $.jsx)(G, {
          children: u
            ? (0, $.jsxs)(`div`, {
            ...
            : (0, $.jsx)(ma, { kind: n, origins: _, resource: a }),
        }),
      })),
      (t[22] = u),
      (t[23] = n),
    ...
    : (T = t[26]);
  let E;
  t[27] !== b || t[28] !== d || t[29] !== v || t[30] !== n || t[31] !== a
    ? ((E = (0, $.jsx)(pa, {
        kind: n,
        isSaving: v,
        open: d,
  ...
  let D;
  return (
    t[33] !== E || t[34] !== w || t[35] !== T
      ? ((D = (0, $.jsxs)(W, { children: [w, T, E] })),
        (t[33] = E),
        (t[34] = w),
        (t[35] = T),
        (t[36] = D))
...
function pa(e) {
  ...
  t[7] === f
    ...
    : ((m = (e) => {
      ...
      (t[8] = m));
  let h;
  t[9] !== r || t[10] !== s ? ((h = qr(s, r)), (t[9] = r), (t[10] = s), (t[11] = h)) : (h = t[11]);
  let g;
  t[12] !== r || t[13] !== s
    ? ((g = Jr(s, r)), (t[12] = r), (t[13] = s), (t[14] = g))
    : (g = t[14]);
  let _;
  t[15] !== h || t[16] !== g
    ? ((_ = (0, $.jsx)(z, { children: (0, $.jsx)(gt, { title: h, subtitle: g }) })),
      (t[15] = h),
      (t[16] = g),
      (t[17] = _))
    : (_ = t[17]);
  ...
  let O;
  t[40] !== w || t[41] !== D
    ? ((O = (0, $.jsx)(z, { children: (0, $.jsxs)(dt, { children: [w, D] }) })),
      (t[40] = w),
      (t[41] = D),
      (t[42] = O))
    : (O = t[42]);
  ...
  t[43] !== x || t[44] !== O || t[45] !== m || t[46] !== _
    ? ((k = (0, $.jsxs)(Ve, { as: `form`, onSubmit: m, children: [_, x, O] })),
      (t[43] = x),
      (t[44] = O),
      (t[45] = m),
      (t[46] = _),
  ...
  return (
    t[48] !== o || t[49] !== k || t[50] !== p
      ? ((A = (0, $.jsx)(ft, { open: o, onOpenChange: p, size: `compact`, children: k })),
        (t[48] = o),
        (t[49] = k),
        (t[50] = p),
        (t[51] = A))
...
function ma(e) {
  let t = (0, Q.c)(46),
    ...
    a = m(s),
    o = Ft(),
    [c, l] = (0, _a.useState)(null),
    u = cn(),
    d = on(),
    f = i === `origins` ? u.isPending : d.isPending,
    p;
  t[0] !== n || t[1] !== c || t[2] !== d || t[3] !== u || t[4] !== i || t[5] !== a
    ? ((p = async () => {
        if (c != null)
          try {
            (i === `origins`
              ? await u.mutateAsync({ kind: n, origin: c })
              : await d.mutateAsync({
                  kind: n,
                  origin: c,
  ...
  let h = p,
    g;
  t[7] !== o || t[8] !== f || t[9] !== n || t[10] !== r || t[11] !== i
    ? ((g = (0, $.jsx)(ha, {
        kind: n,
        intl: o,
        isSaving: f,
  ...
  t[14] !== n || t[15] !== i || t[16] !== y
    ? ((b = Yr(i, n, y)), (t[14] = n), (t[15] = i), (t[16] = y), (t[17] = b))
    : (b = t[17]);
  let x;
  t[18] !== n || t[19] !== i
    ? ((x = Xr(i, n)), (t[18] = n), (t[19] = i), (t[20] = x))
    : (x = t[20]);
  let S;
  t[21] !== b || t[22] !== x
    ? ((S = (0, $.jsx)(z, { children: (0, $.jsx)(gt, { title: b, subtitle: x }) })),
      (t[21] = b),
      (t[22] = x),
      (t[23] = S))
    : (S = t[23]);
  ...
  t[26] === f
    ? (T = t[27])
    : ((T = (0, $.jsx)(R, { color: `ghost`, disabled: f, onClick: w, children: C })),
      (t[26] = f),
      (t[27] = T));
  let E;
  t[28] === h
  ...
  let O;
  t[31] !== f || t[32] !== E
    ? ((O = (0, $.jsx)(R, { color: `danger`, loading: f, onClick: E, children: D })),
      (t[31] = f),
      (t[32] = E),
      (t[33] = O))
    : (O = t[33]);
  let k;
  t[34] !== T || t[35] !== O
    ? ((k = (0, $.jsx)(z, { children: (0, $.jsxs)(dt, { children: [T, O] }) })),
      (t[34] = T),
      (t[35] = O),
      (t[36] = k))
    : (k = t[36]);
  let A;
  t[37] !== k || t[38] !== S
    ? ((A = (0, $.jsxs)(Ve, { children: [S, k] })), (t[37] = k), (t[38] = S), (t[39] = A))
    : (A = t[39]);
  let j;
  t[40] !== A || t[41] !== _
    ? ((j = (0, $.jsx)(ft, { open: _, onOpenChange: v, size: `compact`, children: A })),
      (t[40] = A),
      (t[41] = _),
      (t[42] = j))
    : (j = t[42]);
  ...
  return (
    t[43] !== j || t[44] !== g
      ? ((M = (0, $.jsxs)($.Fragment, { children: [g, j] })), (t[43] = j), (t[44] = g), (t[45] = M))
      : (M = t[45]),
    M
  );
}
function ha(e) {
  ...
  if (o.length === 0) {
    let e;
    t[0] !== i || t[1] !== s ? ((e = Zr(s, i)), (t[0] = i), (t[1] = s), (t[2] = e)) : (e = t[2]);
    let n;
    return (
      t[3] === e
        ? (n = t[4])
          ...
          (0, $.jsx)(
            U,
            {
              ...
              control: (0, $.jsx)(R, {
                ...
                size: `icon`,
                children: (0, $.jsx)(pn, { className: `icon-2xs` }),
              }),
            },
            e,
          )),
...
var Q,
  ...
  Ca = e(() => {
    ((Q = N()),
      ...
      Ht(),
      ($ = I()),
      (va = `browser-browsing-data-options`),
      (ya = [`cookies`, `siteData`, `cache`, `downloads`]),
      (ba = [...ya, `history`]),
      (xa = [`in-app-browser`, `external-browser`]),
      (Sa = w(Nt, null)));
  });
export {
  Pi as _,
