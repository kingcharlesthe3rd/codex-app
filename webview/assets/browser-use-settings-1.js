...
import { _n as on, hn as sn } from "./app-initial~app-main~automations-page.js";
import {
  Ft as cn,
  H as ln,
  It as un,
...
import { n as Un, r as Wn, t as Gn } from "./browser-use-elevated-risk-learn-more-url-Y.js";
import { n as Kn, t as qn } from "./plugin-uninstall-dialog.js";
function Jn(e) {
  let t = (0, Yn.c)(6),
    { service: n } = e,
    r = z(y);
  if (!me(`1834314516`)) return null;
  ...
  return (
    t[4] === a
      ? (s = t[5])
      : ((s = (0, Xn.jsx)(B, { color: `secondary`, size: `toolbar`, onClick: a, children: o })),
        (t[4] = a),
        (t[5] = s)),
    s
  );
...
function ar(e) {
  ...
  t[0] !== r || t[1] !== h.webviewLabel
    ? ((g = r.formatMessage(h.webviewLabel)), (t[0] = r), (t[1] = h.webviewLabel), (t[2] = g))
    : (g = t[2]);
  let _ = g,
    v,
    y;
  t[3] !== n || t[4] !== i.search || t[5] !== o?.params
    ? ((v = hr({ kind: n, search: i.search, siteSettingsRoutePath: o?.params[`*`] ?? null })),
      (y = _r(n, v)),
      (t[3] = n),
      (t[4] = i.search),
      (t[5] = o?.params),
  ...
  let b = y,
    ...
    w;
  t[8] !== S || t[9] !== n ? ((w = Ar(n, S)), (t[8] = S), (t[9] = n), (t[10] = w)) : (w = t[10]);
  let E = w,
    D = bn(yn()),
    O;
  t[11] === r
  ...
  let N = (0, Ir.useEffectEvent)(M),
    P;
  t[17] !== v || t[18] !== n || t[19] !== N || t[20] !== h.partition || t[21] !== _ || t[22] !== b
    ? ((P = () => {
        let e = s.current;
        if (e == null) return;
        let t = window.electronBridge?.sendMessageFromView,
          ...
          p = () => {
            !i ||
              ...
              t({ mountId: r, type: `browser-settings-webview-unmounted` }).catch((e) => {
                T.warning(`Failed to unmount browser settings webview`, {
                  safe: { kind: n },
                  sensitive: { error: e },
                });
              }));
          };
        ((l.current = Er(n, v)), (u.current = null));
        let g = (e) => {
            let t = o;
            t != null &&
              Sr(t).then((n) => {
                a || o !== t || xr(t, v) !== e || m(n == null ? null : { title: n, url: e });
              });
          },
          y = () => {
            if (o == null || a) return;
          ...
          S = () => {
            ...
            let e = d;
            ((d = null),
              Or({ sourceUrl: b, targetUrl: e, webview: o }).catch((t) => {
                T.warning(`Failed to open initial browser settings URL`, {
                  safe: { kind: n },
        ...
        return (
          (async () => {
            try {
              ...
              let t = e;
              T.error(`Failed to mount browser settings webview`, {
                safe: { kind: n },
                sensitive: { error: t },
              });
            }
    ...
    ? ((R = (e) => {
      ...
      (ne = (e) => {
        ...
        return (
          (l.current = o),
          (u.current = e),
          f(Tr({ history: o, initialUrl: v, url: i, webview: t })),
          Or({ sourceUrl: a, targetUrl: i, webview: t }).catch((e) => {
            T.warning(`Failed to navigate browser settings webview`, {
              safe: { kind: n },
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (0, K.jsx)(`div`, { "aria-hidden": !0, className: `draggable absolute inset-0` })),
      (t[46] = ae))
    : (ae = t[46]);
  let oe = x?.canGoBack === !0 || E != null,
    se = x?.canGoForward ?? !1,
    ce;
  t[47] !== E || t[48] !== a || t[49] !== R
    ? ((ce = () => {
        let e = c.current;
        if (!(l.current?.preferHistoryControls === !0 && R(-1))) {
          if (e != null && yr(e)) {
            e.goBack?.();
            return;
          }
  ...
  t[51] === R
    ...
    : ((le = () => {
        ...
        (l.current?.preferHistoryControls === !0 && R(1)) || R(1);
      }),
      (t[51] = R),
      (t[52] = le));
  let ue;
  t[53] !== k || t[54] !== j || t[55] !== oe || t[56] !== se || t[57] !== ce || t[58] !== le
    ? ((ue = (0, K.jsx)(`div`, {
    ...
    ? ((b =
        u == null
          ? (0, K.jsx)(`span`, {
              ...
              children: (0, K.jsx)(S, { ...c.breadcrumbLabel }),
            })
          : (0, K.jsxs)(K.Fragment, {
              children: [
                (0, K.jsx)(sr, { onClick: a, children: (0, K.jsx)(S, { ...c.breadcrumbLabel }) }),
                (0, K.jsx)(cr, {}),
...
function cr() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, K.jsx)($e, { className: `icon-xs text-token-text-secondary` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
...
function fr(e, t) {
  ...
  if (t != null) return t;
  let r = Mr(n);
  return r == null ? Nr(n) : (0, K.jsx)(S, { ...r });
}
function pr(e) {
  mr(e) && e.destroy();
}
...
function hr({ kind: e, search: t, siteSettingsRoutePath: n }) {
  let r = Lr[e];
  return e === `siteSettings` ? (k(new URLSearchParams(t).get(`site`)) ?? gr(n) ?? r.url) : r.url;
}
function gr(e) {
...
function _r(e, t) {
  return e === `siteSettings` && jr(t) === `siteDetails` ? re : t;
}
function vr(e, t) {
...
function Er(e, t) {
  return e !== `siteSettings` || jr(t) == null
    ...
    : { entries: [re, t], index: 1, preferHistoryControls: !0 };
}
function Dr(e, t, n) {
...
function Br(e) {
  let t = (0, Vr.c)(25),
    { hostId: r } = e,
    i = L(),
    { data: a, isLoading: o } = Ae(Mn),
    s;
  t[0] === r ? (s = t[1]) : ((s = { hostId: r }), (t[0] = r), (t[1] = s));
  let { data: c, isPending: l } = Oe(De, s),
    u;
  t[2] === r ? (u = t[3]) : ((u = { hostId: r }), (t[2] = r), (t[3] = u));
  let d = wn(u),
    f = c?.requirements?.featureRequirements?.[n],
    p;
  t[4] === f ? (p = t[5]) : ((p = Ke(f)), (t[4] = f), (t[5] = p));
  let m = p,
    h = o || l,
    g = a?.fullCdpAccessEnabled === !0 && !h && !m,
    _;
    ...
    ? ((_ = (0, q.jsxs)(`div`, {
        ...
        children: [
          (0, q.jsxs)(`span`, {
            ...
            children: [
              (0, q.jsx)(hn, { className: `icon-xs shrink-0` }),
              (0, q.jsx)(S, {
  ...
  t[15] === d
    ...
    : ((w = (e) => {
      ...
      (t[16] = w));
  let T;
  t[17] !== g || t[18] !== C || t[19] !== w || t[20] !== x
    ? ((T = (0, q.jsx)(Ie, { ariaLabel: x, checked: g, disabled: C, onChange: w })),
      (t[17] = g),
      (t[18] = C),
      (t[19] = w),
      (t[20] = x),
  ...
  return (
    t[22] !== T || t[23] !== b
      ? ((E = (0, q.jsx)(U, { label: _, description: b, control: T })),
        (t[22] = T),
        (t[23] = b),
        (t[24] = E))
      : (E = t[24]),
...
function oi() {
  let e = (0, bi.c)(12),
    { selectedHostId: t } = en(),
    { data: n, isError: r, isLoading: i } = Ae(Mn),
    a;
  e[0] === t ? (a = e[1]) : ((a = { hostId: t }), (e[0] = t), (e[1] = a));
  let { data: o, isError: s, isPending: c } = Oe(De, a),
  ...
  e[2] !== o?.requirements?.featureRequirements || e[3] !== s || e[4] !== c || e[5] !== l
    ? ((f =
        l && !s && !c && !Ke(o?.requirements?.featureRequirements?.browser_use_full_cdp_access)),
...
function si(e) {
  ...
  t[11] === v
    ? (x = t[12])
    : ((x = (0, X.jsx)(G.Header, { actions: v, title: y, subtitle: b })), (t[11] = v), (t[12] = x));
  let C;
  t[13] !== n || t[14] !== i || t[15] !== p || t[16] !== f
    ? ((C = (0, X.jsx)(G.Content, {
        children: (0, X.jsx)(W, {
          children: n
            ? (0, X.jsx)(`div`, {
            ...
            : i || p == null
              ...
              : p.length === 0
                ...
                : (0, X.jsx)(ci, { rows: p, onCustomize: u, visibleResources: f }),
        }),
      })),
      (t[13] = n),
      (t[14] = i),
  ...
  let w;
  t[18] !== o || t[19] !== f
    ? ((w = (0, X.jsx)(hi, { open: o, visibleResources: f, onOpenChange: c })),
      (t[18] = o),
      (t[19] = f),
      (t[20] = w))
    : (w = t[20]);
  ...
  let E;
  return (
    t[24] !== C || t[25] !== w || t[26] !== T || t[27] !== x
      ? ((E = (0, X.jsxs)(G, { className: `gap-2`, children: [x, C, w, T] })),
        (t[24] = C),
        (t[25] = w),
        (t[26] = T),
        (t[27] = x),
  ...
  return (0, X.jsx)(Ve, {
    ...
    triggerButton: (0, X.jsxs)(ln, {
      ...
      children: [
        (0, X.jsx)(`span`, {
          ...
          children:
            c === `custom`
              ? (0, X.jsx)(N, { className: `icon-xs text-token-text-secondary` })
              : (0, X.jsx)(di, { value: c }),
        }),
    ...
    children: (0, X.jsxs)(`div`, {
      ...
      children: [
        ...
        (0, X.jsx)(kt.Separator, {}),
        (0, X.jsx)(kt.Item, {
          RightIcon: c === `custom` ? je : void 0,
          onSelect: e,
          children: (0, X.jsxs)(`div`, {
            className: `flex min-w-0 items-center gap-2`,
            children: [
              (0, X.jsx)(N, { className: `icon-xs shrink-0 text-token-text-secondary` }),
              (0, X.jsx)(S, {
...
function di(e) {
  let t = (0, bi.c)(6),
    ...
    o;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((o = pt(`size-2 shrink-0 rounded-full`, r, i, a)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a),
      (t[3] = o))
              ...
              children: [
                ...
                (0, X.jsx)(Ve, {
                  ...
                  triggerButton: (0, X.jsxs)(ln, {
                    ...
                    children: [
                      (0, X.jsx)(di, { value: s }),
                      (0, X.jsx)(`span`, { id: v, className: `truncate`, children: _i(s) }),
                    ],
                  }),
...
function Di(e) {
  ...
  t[2] !== a.forceReload || t[3] !== o
    ? ((f = { forceReloadPlugins: a.forceReload, hostId: o }),
      (t[2] = a.forceReload),
      (t[3] = o),
      (t[4] = f))
    : (f = t[4]);
  let {
      ...
      connectRequiredApp: m,
      handleRequiredAppConnected: h,
      handleRequiredAppOAuthStarted: g,
      installPlugin: _,
      isInstalling: v,
      openPluginInstall: y,
      session: b,
  ...
  let { pendingPluginId: S, setPluginEnabled: C } = Ht(x),
    w;
  t[7] === o ? (w = t[8]) : ((w = { hostId: o }), (t[7] = o), (t[8] = w));
  let { pendingUninstallPluginId: T, uninstallPlugin: E } = Nt(w),
    [D, O] = (0, Ni.useState)(null),
    k = v && b.kind !== `closed` ? b.plugin.plugin.id : null,
    A = S ?? k ?? T,
    j = i.length + l.length;
  if (a.isLoading && j === 0) {
    let e;
    return (
      t[9] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsx)(`div`, {
            ...
            children: (0, Z.jsx)(_t, { className: `icon-xs` }),
          })),
          (t[9] = e))
        : (e = t[9]),
      e
  ...
  if (j === 0) {
    ...
    return (
      t[12] === n
        ? (e = t[13])
        : ((e = (0, Z.jsx)(W, { children: (0, Z.jsx)(Rn, { children: n }) })),
          (t[12] = n),
          (t[13] = e)),
      e
    );
            ...
            ? (0, Z.jsx)(
                U,
                {
                  ...
                  icon: (0, Z.jsx)(`span`, {
                    ...
                    children:
                      e.icon ?? (0, Z.jsx)(Tt, { className: `icon-md text-token-text-secondary` }),
                  }),
                  label: (0, Z.jsx)(`span`, {
                ...
                ji,
                {
                  ...
                  onToggleInstalledPluginEnabled: (t, n) => {
                    C({
                      ...
                      pluginDisplayName: e.displayName ?? d(t),
                      enabled: n,
                    });
                  },
                  onUninstallPlugin: O,
  ...
  t[47] !== F
    ? ((L = (0, Z.jsx)(pn, {
        hostId: o,
        isInstalling: v,
        onConnectRequiredApp: m,
        onInstall: _,
        onRequiredAppConnected: h,
        onRequiredAppOAuthStarted: g,
        onViewDetails: F,
        onOpenChange: I,
        session: b,
      })),
  ...
  let te;
  return (
    t[53] !== L || t[54] !== ee || t[55] !== P
      ? ((te = (0, Z.jsxs)(Z.Fragment, { children: [P, L, ee] })),
        (t[53] = L),
        (t[54] = ee),
        (t[55] = P),
        (t[56] = te))
...
function ki(e) {
  ...
  t[0] === n.icon
    ? (i = t[1])
    : ((i = n.icon ?? (0, Z.jsx)(Tt, { className: `icon-md text-token-text-secondary` })),
      (t[0] = n.icon),
      (t[1] = i));
  let a;
  t[2] === i
  ...
  t[16] === u
    ? (d = t[17])
    : ((d = (0, Z.jsx)(Ie, { ariaLabel: u, checked: !1, disabled: !0, onChange: Ai })),
      (t[16] = u),
      (t[17] = d));
  let f;
  return (
...
function ji(e) {
  ...
  if (
    ...
    let e = i.displayName ?? d(i.plugin),
      g = i.plugin.plugin.installed;
    m = `group flex min-h-[60px] items-center gap-3 p-2.5 text-sm hover:bg-token-foreground/5 max-sm:flex-wrap`;
    let _;
    t[13] !== i.plugin || t[14] !== o
      ? ((_ = () => {
        ...
        (t[15] = _))
      : (_ = t[15]);
    let v = i.showIconBorder === !1 ? `border-0` : `border border-token-border-default`,
      y;
    t[16] === v
      ? (y = t[17])
      : ((y = pt(
    ...
    let b =
        ...
        (0, Z.jsx)(At, {
          ...
          fallback: (0, Z.jsx)(Tt, { className: `icon-md text-token-text-secondary` }),
        }),
      x;
    t[18] !== y || t[19] !== b
    ...
    (t[26] !== C || t[27] !== w
      ...
      (t[11] = m),
      (t[12] = h));
  } else ((u = t[8]), (f = t[9]), (p = t[10]), (m = t[11]), (h = t[12]));
  let g;
  t[33] !== u || t[34] !== f || t[35] !== p
    ? ((g = (0, Z.jsxs)(`div`, { className: u, children: [f, p] })),
      (t[33] = u),
      (t[34] = f),
      (t[35] = p),
      (t[36] = g))
...
function Li() {
  ...
  let s = Qt(a),
    c;
  e[2] === i ? (c = e[3]) : ((c = { hostId: i }), (e[2] = i), (e[3] = c));
  let l = C(c),
    u = me(`1834314516`);
  if (r != null) {
    if (r === `downloads` && !u) {
      ...
      return (
        e[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(o, { to: `/settings/browser-use`, replace: !0 })), (e[4] = t))
          : (t = e[4]),
        t
      );
    }
    ...
    if (!i.enabled && !a) {
      ...
      return (
        e[6] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(o, { to: `/settings/browser-use`, replace: !0 })), (e[6] = t))
          : (t = e[6]),
        t
      );
    }
    n !== r && t.set(Sa, r);
    let c;
    return (e[7] === r ? (c = e[8]) : ((c = Yi(r)), (e[7] = r), (e[8] = c)), c);
  }
...
function zi() {
  ...
  e[14] !== o || e[15] !== m
    ? ((O =
        o == null && ua(m)
          ? [
              {
                description: (0, $.jsx)(S, { ...Pe.restrictedAvailabilityDescription }),
                icon: (0, $.jsx)(Zt, { className: `h-full w-full text-token-foreground` }),
                id: `browser-use-unavailable`,
                title: (0, $.jsx)(S, { ...Pe.label }),
              },
            ]
          : []),
      (e[14] = o),
        ...
        ? (0, $.jsxs)(G, {
            children: [
              ...
              (0, $.jsx)(G.Content, {
                children: (0, $.jsxs)(W, {
                  children: [
                    _ ? (0, $.jsx)(Bt, { electron: !0, children: (0, $.jsx)(Zi, {}) }) : null,
                    (0, $.jsx)($i, {}),
    ...
    : ((N = T
        ? (0, $.jsxs)(G, {
            children: [
              ...
              (0, $.jsx)(G.Content, { children: (0, $.jsx)(W, { children: (0, $.jsx)(Wi, {}) }) }),
            ],
          })
        : null),
      (e[30] = T),
  ...
  e[32] !== _ || e[33] !== f.downloads
    ? ((P =
        !_ || !f.downloads.enabled
          ? null
          : (0, $.jsx)(Bt, { electron: !0, children: (0, $.jsx)(Bi, {}) })),
      (e[32] = _),
      (e[33] = f.downloads),
      (e[34] = P))
    : (P = e[34]);
  ...
  return (
    ...
    e[46] !== A ||
    e[47] !== j
      ? ((L = (0, $.jsxs)($.Fragment, { children: [A, j, M, N, P, F, I] })),
        (e[41] = M),
        (e[42] = N),
        (e[43] = P),
        (e[44] = F),
...
function Bi() {
  let e = z(y),
    ...
    [r, i] = (0, _a.useState)(!1),
    a = ie?.downloads,
    o = ge(Ye.downloadDirectory),
    s = ge(Ye.promptForDownloadLocation);
  if (a == null) return null;
  let c = async () => {
    i(!0);
    try {
      let t = await a.chooseDownloadDirectory();
      t != null && (await Lt(e, Ye.downloadDirectory, t));
    } catch {
      e.get(V).danger(
        t.formatMessage({
          ...
          children: [
                ...
                children: [
                  ...
                  o == null
                    ...
                    : (0, $.jsx)(B, {
                        ...
                        size: `toolbar`,
                        onClick: () => {
                          Lt(e, Ye.downloadDirectory, null);
                        },
                        children: (0, $.jsx)(S, {
            ...
            (0, $.jsx)(U, {
              ...
              control: (0, $.jsx)(Ie, {
                ...
                checked: s,
                onChange: (t) => {
                  Lt(e, Ye.promptForDownloadLocation, t);
                },
              }),
            }),
            (0, $.jsx)(U, {
...
function Vi(e) {
  ...
  let s = o,
    c;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(Bt, { electron: !0, children: (0, $.jsx)(oi, {}) })), (t[8] = c))
    : (c = t[8]);
  let l;
  return (
    t[9] === s
      ...
      : ((l = (0, $.jsxs)($.Fragment, {
          children: [
            c,
            (0, $.jsx)(Bt, { browser: !0, chromeExtension: !0, extension: !0, children: s }),
          ],
        })),
        (t[9] = s),
        (t[10] = l)),
...
function qi(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, $.jsx)(B, { color: `secondary`, onClick: o, size: `toolbar`, children: s })),
      (t[4] = o),
      (t[5] = c));
  let l;
  return (
...
function Xi() {
  let e = (0, Q.c)(14),
    t = z(y),
    n = ge(Ye.annotationScreenshotsMode),
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = {
        id: `always`,
  ...
  e[6] === s.label
    ...
    : ((u = (0, $.jsx)(ln, {
        className: `w-[168px]`,
        children: (0, $.jsx)(`span`, { className: `truncate`, children: s.label }),
      })),
      (e[6] = s.label),
      (e[7] = u));
  let d;
        ...
        children: a.map((e) => {
          ...
          return (0, $.jsx)(
            kt.Item,
            {
              ...
              onSelect: () => {
                Lt(t, Ye.annotationScreenshotsMode, e.id);
              },
...
function Zi() {
  ...
  e[2] === n
    ? (a = e[3])
    : ((a = (0, $.jsx)(ln, { children: (0, $.jsx)(Qi, { target: n }) })), (e[2] = n), (e[3] = a));
  let o;
  e[4] !== t || e[5] !== n
    ? ((o = xa.map((e) =>
        (0, $.jsx)(
          kt.Item,
          {
            onSelect: () => {
              n !== e &&
                (Lt(t, ft.openLinkInTargetPreference, e),
                te(t, Ot, { setting: `web_url`, previousDestination: n, selectedDestination: e }));
            },
...
function $i() {
  let e = (0, Q.c)(10),
    t = z(y),
    n = ge(ft.openLocalUrlInTargetPreference),
    r,
    i;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(S, {
  ...
  e[2] === n
    ? (a = e[3])
    : ((a = (0, $.jsx)(ln, { children: (0, $.jsx)(ea, { target: n }) })), (e[2] = n), (e[3] = a));
  let o;
  e[4] !== t || e[5] !== n
    ? ((o = xa.map((e) =>
        (0, $.jsx)(
          kt.Item,
          {
            onSelect: () => {
              n !== e &&
                (Lt(t, ft.openLocalUrlInTargetPreference, e),
                te(t, Ot, {
                  setting: `local_url`,
  ...
  let t = z(y),
    ...
    l = async (e, n) => {
      if (!s) {
        a(e);
        try {
          (await o.mutateAsync(n), t.get(V).success(aa(e)));
        } catch {
          t.get(V).danger(oa(e));
        } finally {
          a(null);
...
function sa() {
  let e = (0, Q.c)(35),
    t = z(y),
    { data: n, isLoading: r } = Ae(Mn),
    i = n?.approvalMode,
    a = Dn(),
    { value: o } = I(Gn),
    s;
  e[0] === o ? (s = e[1]) : ((s = Un(o)), (e[0] = o), (e[1] = s));
  let c = s,
    l;
  e[2] === c
    ? (l = e[3])
    : ((l = (e) => {
        Me({ event: e, href: c, initiator: `open_in_browser_bridge` });
      }),
      (e[2] = c),
      (e[3] = l));
  let u = l,
  ...
  e[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = [
        p,
        {
          ...
          elevatedRiskDisclaimer: (0, $.jsx)(S, {
  ...
  let k;
  e[21] !== E || e[22] !== O
    ? ((k = (0, $.jsx)(ln, { className: `w-[152px]`, disabled: E, children: O })),
      (e[21] = E),
      (e[22] = O),
      (e[23] = k))
    : (k = e[23]);
  let A;
  e[24] !== i || e[25] !== x || e[26] !== v
    ? ((A = (0, $.jsx)(`div`, {
        className: `flex flex-col`,
        children: h.map((e) => {
          let t = e.id === i;
...
function ca() {
  ...
  e[11] === v
    ? (b = e[12])
    : ((b = (0, $.jsx)(`span`, { className: `truncate`, children: v })), (e[11] = v), (e[12] = b));
  let x;
  e[13] !== _ || e[14] !== b
    ? ((x = (0, $.jsx)(ln, { className: `w-[152px]`, disabled: _, children: b })),
      (e[13] = _),
      (e[14] = b),
      (e[15] = x))
    : (x = e[15]);
    ...
    (t[5] === o
      ...
      : ((e = (e) => ({
          ...
          onTryInChat: () => {
            o({
              prefillPrompt: cn({
                defaultPrompt: un(e.plugin.interface?.defaultPrompt),
...
function da(e) {
  ...
  let w;
  t[19] !== x || t[20] !== C
    ? ((w = (0, $.jsx)(G.Header, { actions: b, title: x, subtitle: C })),
      (t[19] = x),
      (t[20] = C),
      (t[21] = w))
    : (w = t[21]);
...
function pa(e) {
  ...
  t[7] === f
    ...
    : ((h = (e) => {
      ...
      (t[8] = h));
  let g;
  t[9] !== r || t[10] !== s ? ((g = qr(s, r)), (t[9] = r), (t[10] = s), (t[11] = g)) : (g = t[11]);
  let _;
  t[12] !== r || t[13] !== s
    ? ((_ = Jr(s, r)), (t[12] = r), (t[13] = s), (t[14] = _))
    : (_ = t[14]);
  let v;
  t[15] !== g || t[16] !== _
    ? ((v = (0, $.jsx)(H, { children: (0, $.jsx)(p, { title: g, subtitle: _ }) })),
      (t[15] = g),
      (t[16] = _),
      (t[17] = v))
    : (v = t[17]);
  ...
  let A;
  t[40] !== E || t[41] !== k
    ? ((A = (0, $.jsx)(H, { children: (0, $.jsxs)(ve, { children: [E, k] }) })),
      (t[40] = E),
      (t[41] = k),
      (t[42] = A))
    : (A = t[42]);
  let j;
  t[43] !== C || t[44] !== A || t[45] !== h || t[46] !== v
    ? ((j = (0, $.jsxs)(zt, { as: `form`, onSubmit: h, children: [v, C, A] })),
      (t[43] = C),
      (t[44] = A),
      (t[45] = h),
      (t[46] = v),
  ...
  let M;
  return (
    t[48] !== o || t[49] !== j || t[50] !== m
      ? ((M = (0, $.jsx)(be, { open: o, onOpenChange: m, size: `compact`, children: j })),
        (t[48] = o),
        (t[49] = j),
        (t[50] = m),
        (t[51] = M))
...
function ma(e) {
  ...
  let v = s ?? ``,
    b;
  t[14] !== n || t[15] !== i || t[16] !== v
    ? ((b = Yr(i, n, v)), (t[14] = n), (t[15] = i), (t[16] = v), (t[17] = b))
    : (b = t[17]);
  let x;
  t[18] !== n || t[19] !== i
  ...
  let C;
  t[21] !== b || t[22] !== x
    ? ((C = (0, $.jsx)(H, { children: (0, $.jsx)(p, { title: b, subtitle: x }) })),
      (t[21] = b),
      (t[22] = x),
      (t[23] = C))
    : (C = t[23]);
  ...
  t[26] === d
    ? (E = t[27])
    : ((E = (0, $.jsx)(B, { color: `ghost`, disabled: d, onClick: T, children: w })),
      (t[26] = d),
      (t[27] = E));
  let D;
  t[28] === m
  ...
  let k;
  t[31] !== d || t[32] !== D
    ? ((k = (0, $.jsx)(B, { color: `danger`, loading: d, onClick: D, children: O })),
      (t[31] = d),
      (t[32] = D),
      (t[33] = k))
    : (k = t[33]);
  ...
  let j;
  t[37] !== A || t[38] !== C
    ? ((j = (0, $.jsxs)(zt, { children: [C, A] })), (t[37] = A), (t[38] = C), (t[39] = j))
    : (j = t[39]);
  let M;
  t[40] !== j || t[41] !== g
    ? ((M = (0, $.jsx)(be, { open: g, onOpenChange: _, size: `compact`, children: j })),
      (t[40] = j),
      (t[41] = g),
      (t[42] = M))
    : (M = t[42]);
  ...
  return (
    t[43] !== M || t[44] !== h
      ? ((N = (0, $.jsxs)($.Fragment, { children: [h, M] })), (t[43] = M), (t[44] = h), (t[45] = N))
      : (N = t[45]),
    N
  );
}
          ...
          (0, $.jsx)(
            U,
            {
              ...
              control: (0, $.jsx)(B, {
                ...
                size: `icon`,
                children: (0, $.jsx)(ne, { className: `icon-2xs` }),
              }),
            },
            e,
          )),
