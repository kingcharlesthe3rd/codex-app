...
function q(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, j.jsx)(M, { className: `absolute inset-0 size-full` })), (t[0] = _))
    : (_ = t[0]);
  let v;
  t[1] === s
    ? (v = t[2])
    : ((v = (0, j.jsxs)(j.Fragment, {
        children: [
          _,
          (0, j.jsx)(`span`, {
  ...
  let y = v,
    ...
    S;
  t[3] !== b || t[4] !== x
    ? ((S = { color: p, height: 30, left: b, top: x, width: 30 }),
      (t[3] = b),
      (t[4] = x),
      (t[5] = S))
    : (S = t[5]);
