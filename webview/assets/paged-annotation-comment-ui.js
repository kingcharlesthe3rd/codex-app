...
function z(e) {
  ...
  t[0] !== a || t[1] !== o || t[2] !== s || t[3] !== l
    ? ((u = { backgroundColor: S, borderColor: x, height: a, left: o, top: s, width: l }),
      (t[0] = a),
      (t[1] = o),
      (t[2] = s),
      (t[3] = l),
...
function B(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, g.jsx)(_, { className: `absolute inset-0 size-full` })), (t[0] = y))
    : (y = t[0]);
  let b;
  t[1] === s
    ? (b = t[2])
...
function H(e) {
  let t = (0, c.c)(14),
    ...
    s;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((s = U({ layer: r, pageSize: i, point: a })), (t[0] = r), (t[1] = i), (t[2] = a), (t[3] = s))
    : (s = t[3]);
  let l = s;
...
function U({ layer: e, pageSize: t, point: n }) {
  ...
  let { height: r, width: i } = D(e),
    ...
    u = o - c - j;
  if (u >= 16) return { left: l, maxWidth: s, top: u, transform: `translateX(-50%)` };
  let d = o + c;
  return d + j <= r - 16
...
export { C as a, O as c, z as i, E as l, H as n, w as o, B as r, T as s, R as t, f as u };
