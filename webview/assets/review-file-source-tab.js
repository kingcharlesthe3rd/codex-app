...
import { Hn as i, Ia as a, do as o, po as s } from "./app-server-manager-signals.js";
...
import { t as ke } from "./react-dom.js";
import {
  G as Ae,
  U as P,
  V as je,
...
import { t as ze } from "./product-logger.js";
import { o as Be } from "./statsig.js";
import { t as Ve } from "./use-is-dark.js";
import { n as He } from "./window-zoom-context.js";
import { i as Ue, t as We } from "./route-scope.js";
import { t as Ge } from "./button.js";
import { a as Ke, i as qe, n as Je, o as Ye, r as Xe, t as Ze } from "./open-workspace-file.js";
import { t as Qe } from "./proxy.js";
import { V as $e, d as et, f as tt, p as nt, rt, x as it } from "./app-shell-state.js";
import { _ as at, r as ot, u as st } from "./app-shell.js";
import {
  D as ct,
  T as lt,
  _ as ut,
...
import { n as Lt, r as Rt } from "./thread-context.js";
...
import { n as Ut } from "./thread-panel-state-fkSg-C_s.js";
import { t as Wt } from "./use-stable-callback.js";
import { n as Gt } from "./use-resize-observer.js";
import { t as Kt } from "./check-md.js";
import { t as qt } from "./chevron-right.js";
import { o as Jt } from "./mcp-capability-signals.js";
import { r as Yt, t as Xt } from "./dropdown.js";
import { t as Zt } from "./three-dots.js";
import { t as Qt } from "./copy-to-clipboard.js";
import { n as $t } from "./get-file-icon.js";
import { t as en } from "./json.js";
import { t as tn } from "./image-square.js";
import { d as nn } from "./inline-mentions-C8jF-sc9.js";
import { o as rn } from "./workspace-file-context-menu.js";
import { n as an, r as on } from "./code-snippet.js";
import { t as sn } from "./copy.js";
...
import { t as Nn } from "./history.js";
import { n as Pn, t as Fn } from "./mcp-capability-file-viewer-frame.js";
  ...
  Rn = class {
    ...
    constructor(e = { theme: gt }, t, n) {
      ((this.options = e),
        ...
        n?.isWorkingPool() !== !0 && (this.highlighter = ve(e.theme ?? gt) ? ie() : void 0));
    }
    setOptions(e) {
      this.options = e;
    }
    ...
    renderPartialHTML(e, t = !1) {
      return he(t ? ge({ tagName: `code`, children: e, properties: { "data-code": `` } }) : e);
    }
    async initializeHighlighter() {
      return ((this.highlighter = await j(De(this.computedLang, this.options))), this.highlighter);
    }
...
var Vn = [],
  ...
  Un = class {
    ...
    setOptions(e) {
      e != null && ((this.options = e), this.interactionManager.setOptions(Ce(e)));
    }
    mergeOptions(e) {
      this.options = { ...this.options, ...e };
    }
    ...
    applyHeaderToDOM(e, t) {
      ...
      if (a != null) {
        let e = a(n) ?? void 0;
        ((this.headerCustom = this.upsertHeaderSlotElement(t, this.headerCustom, mt, e)),
          this.headerPrefix?.remove(),
          this.headerMetadata?.remove(),
          (this.headerPrefix = void 0),
          (this.headerMetadata = void 0));
        ...
        let e = i?.(n) ?? void 0,
          r = o?.(n) ?? void 0;
        ((this.headerPrefix = this.upsertHeaderSlotElement(t, this.headerPrefix, ft, e)),
          (this.headerMetadata = this.upsertHeaderSlotElement(t, this.headerMetadata, xt, r)),
          this.headerCustom?.remove(),
          (this.headerCustom = void 0));
      }
    }
    ...
    applyPreNodeAttributes(e, { totalLines: t }) {
      ...
      fe(i, this.appliedPreAttributes) || (Ee(e, i), (this.appliedPreAttributes = i));
    }
    applyErrorToDOM(e, t) {
      this.cleanupErrorWrapper();
...
` +
    ...
    function nc(e, t, n, r, a) {
      ...
      if (((o = vi(o, n)), Xl === null ? (Xl = [o]) : Xl.push(o), X !== 4 && (X = 2), t === null))
        return !0;
      ((r = vi(r, n)), (n = t));
      do {
        switch (n.tag) {
    ...
    function mc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((ao(t), a))
          ...
          if (((r = K), r !== null && ((s = nt(r, n)), s !== 0 && s !== o.retryLane)))
    ...
    function Cc(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (((s = K), s !== null && ((r = nt(s, n)), r !== 0 && r !== l.retryLane)))
      ...
      switch ((ji(t), t.tag)) {
        ...
        case 27:
          if ((he(t), (n = ue.current), (a = t.type), e !== null && t.stateNode != null))
            ...
            ((e = ce.current), Bi(t) ? Ri(t, e) : ((e = ff(a, r, n)), (t.stateNode = e), Pc(t)));
          }
          return (U(t), null);
        case 5:
        ...
        case 4:
          return (pe(), e === null && Sd(t.stateNode.containerInfo), U(t), null);
        case 10:
...
function Qn({
  ...
  return (0, I.jsxs)(I.Fragment, {
    children: [
      ...
      i != null && a?.map((e, t) => (0, I.jsx)(`div`, { slot: O(e), children: i(e) }, t)),
      l != null && (0, I.jsx)(`div`, { slot: `gutter-utility-slot`, style: we, children: l(c) }),
    ],
  });
}
var L = e(l(), 1),
...
function tr({ options: e, hasCustomHeader: t, hasGutterRenderUtility: n }) {
  return n || t
    ? { ...e, renderCustomHeader: t ? ce : void 0, renderGutterUtility: n ? ce : void 0 }
    : e;
}
function nr({
  file: e,
...
function Ar({
  ...
  a == null ||
    a.length === 0 ||
    jr({ activeMatchId: t, fileDiffElement: n, query: e.query, sourceMatches: a }) ||
    _r({ target: n, query: e.query, maxMatches: a.length, includeShadowRoots: !0 }).matches.forEach(
      (e, n) => {
        let r = a[n];
        r != null && (dr({ element: e, matchId: r.id }), r.id === t && e.classList.add(ir));
      },
    );
}
function jr({ activeMatchId: e, fileDiffElement: t, query: n, sourceMatches: r }) {
  ...
  for (let r of i.values()) {
    a = !0;
    let i = pr({ container: t, lineNumber: r.lineNumber, side: r.side, includeShadowRoots: !0 });
    i != null &&
      ((o = !0),
      _r({
        target: i,
        ...
        let i = r.matches[n];
        i != null && (dr({ element: t, matchId: i.id }), i.id === e && t.classList.add(ir));
      }));
  }
...
function Mr(e) {
  ...
  t[14] !== r || t[15] !== i || t[16] !== o || t[17] !== c
    ? ((m = (0, I.jsx)(Nr, { labels: r, line: i, onOpenBlameLink: o, repositoryWebUrl: c })),
      (t[14] = r),
      (t[15] = i),
      (t[16] = o),
      (t[17] = c),
...
function Nr(e) {
  ...
  let l = c,
    u;
  t[5] !== r || t[6] !== a ? ((u = Lr(r, a)), (t[5] = r), (t[6] = a), (t[7] = u)) : (u = t[7]);
  let d = u,
    f;
  t[8] !== r || t[9] !== a ? ((f = Rr(r, a)), (t[8] = r), (t[9] = a), (t[10] = f)) : (f = t[10]);
  let p = f,
    m;
  t[11] === r.authorTime
    ? (m = t[12])
  ...
  t[15] !== l || t[16] !== r || t[17] !== i
    ? ((_ = l == null ? Vr(r) : (0, I.jsx)(Fr, { link: l, onOpenBlameLink: i })),
      (t[15] = l),
      (t[16] = r),
      (t[17] = i),
      (t[18] = _))
  ...
  t[25] !== d || t[26] !== r.commitSha || t[27] !== i
    ? ((b = d == null ? r.commitSha.slice(0, 8) : (0, I.jsx)(Fr, { link: d, onOpenBlameLink: i })),
      (t[25] = d),
      (t[26] = r.commitSha),
      (t[27] = i),
      (t[28] = b))
...
function Lr(e, t) {
  return Ur(e.commitSha)
    ? zr(t, `commit/${encodeURIComponent(e.commitSha)}`, e.commitSha.slice(0, 8))
    : null;
}
function Rr(e, t) {
  let n = Gr(e.summary);
        ...
        (s = e.map((t, n) => {
          ...
          return (0, I.jsxs)(
            `li`,
            {
              ...
              children: [
                (0, I.jsx)(`span`, {
                  className: Oe(`whitespace-nowrap`, r && `font-medium text-token-text-primary`),
                  children: t,
                }),
                r
                  ? null
...
var ui = 250;
function di({ contextId: e, getFiles: t, preserveScrollBeforeResultClear: n, scrollAdapter: r }) {
  return {
    domain: `diff`,
    contextId: e,
    ...
    async ensureVisible(t, n) {
      ...
      let i = r.getFileContainer(t.path),
        a = ur(t);
      if ((i == null ? null : fr({ container: i, matchId: a, includeShadowRoots: !0 })) == null) {
        if (
          n?.signal?.aborted ||
          (n?.signal == null
...
function fi(e, t) {
  ...
  for (let s of t)
    for (let t of s.hunks) {
      ...
      let { offsets: l, totalMatches: u, isCapped: d } = St(c, n, ui - r.length);
      ((i += u), d && (o = !0));
    ...
    getFiles: () => [
      {
        path: n,
        hunks: [
          { hunkId: `source`, lineMapping: `contiguous`, lineEnd: yi(e), lineStart: 1, text: e },
        ],
      },
    ],
    scrollAdapter: {
...
function wi(e) {
  let t = (0, R.c)(5),
    { type: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = (0, I.jsx)(Ti, { type: n })), (t[0] = n), (t[1] = r));
  let i;
...
function Ei() {
  let e = (0, R.c)(31),
    ...
    u = F(Rt),
    d;
  e[0] === t.value ? (d = e[1]) : ((d = Ue(t.value)), (e[0] = t.value), (e[1] = d));
  let f = d,
  ...
  bb0: {
    ...
    (e[6] !== l || e[7] !== s || e[8] !== n || e[9] !== t
      ? ((r = dn({ comments: [...n, ...(t ?? [])], filePaths: s.map(Di), workspaceRoot: l })),
        (e[6] = l),
        (e[7] = s),
        (e[8] = n),
        (e[9] = t),
    ...
    ? ((x = (e) => {
        s.some((t) => t.path === e) &&
          requestAnimationFrame(() => {
            (Nt(t, e), !n && Oi(e)?.scrollIntoView({ behavior: `auto`, block: `start` }));
          });
      }),
      (e[11] = s),
      (e[12] = n),
...
function Mi(e) {
  let t = Me(We),
    ...
    u = at(l);
  !n && u.get() !== l && u.set(l);
  let { isMounted: d, opacity: f, animatedSize: p } = ot({ animation: r, size: u, isVisible: s }),
    m = (0, L.useCallback)(
      (e) => {
        if (e < rt(ji)) {
          it(t, !1);
...
function Li(e) {
  let t = (0, R.c)(47),
    ...
    u;
  t[0] !== n || t[1] !== o
    ? ((u = { params: { hostId: n, path: o } }), (t[0] = n), (t[1] = o), (t[2] = u))
    : (u = t[2]);
  ...
  if (t[3] !== p || t[4] !== o) {
    let e = Ke(o);
    ((m = p && e != null && Ye(e.importKind)), (t[3] = p), (t[4] = o), (t[5] = m));
  } else m = t[5];
  let h = m,
    g;
  ...
  if (ee != null) {
    let e;
    (t[16] === ee ? (e = t[17]) : ((e = (0, I.jsx)(wi, { type: ee })), (t[16] = ee), (t[17] = e)),
      (D = e));
  } else if (d && d.sizeBytes != null && d.sizeBytes > B) {
    let e;
    (t[18] === d.sizeBytes
      ? (e = t[19])
      : ((e = (0, I.jsx)(Xi, { sizeBytes: d.sizeBytes })), (t[18] = d.sizeBytes), (t[19] = e)),
      (D = e));
  } else if (C != null && T && b) {
    te = !0;
    let e;
    ...
    (t[24] !== w || t[25] !== n || t[26] !== o || t[27] !== _
      ? ((e = (0, I.jsx)(Ui, { gitBlameFeatureEnabled: w, hostId: n, path: o, previewKind: _ })),
        (t[24] = w),
        (t[25] = n),
        (t[26] = o),
        (t[27] = _),
...
function zi() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, I.jsx)(Mn, { className: `icon-lg text-token-text-secondary` })), (e[0] = t))
    : (t = e[0]);
  let n;
...
function Vi(e) {
  ...
  t[21] !== d || t[22] !== l
    ? ((ne = function (e) {
        e.preventDefault();
        let t = !d;
        (l.set(vt, t), t && ze(l, { eventName: `codex_file_viewer_git_blame_enabled` }), h(!1));
      }),
      (t[21] = d),
      (t[22] = l),
      (t[23] = ne))
  ...
  t[42] !== O || t[43] !== f || t[44] !== x || t[45] !== o
    ? ((de = o ? (0, I.jsx)(Yt.Item, { onSelect: O, LeftIcon: f ? en : tn, children: x }) : null),
      (t[42] = O),
      (t[43] = f),
      (t[44] = x),
      (t[45] = o),
  ...
  t[47] !== te || t[48] !== s || t[49] !== y || t[50] !== p
    ? ((fe = s ? (0, I.jsx)(Yt.Item, { onSelect: te, LeftIcon: p ? an : on, children: y }) : null),
      (t[47] = te),
      (t[48] = s),
      (t[49] = y),
      (t[50] = p),
...
function Hi(e) {
  ...
  if (u == null) {
    ...
    return (
      t[3] !== d || t[4] !== f
        ? ((e = (0, I.jsx)(Zi, { isError: d, isLoading: f })), (t[3] = d), (t[4] = f), (t[5] = e))
        : (e = t[5]),
      e
    );
  }
...
function Ui(e) {
  ...
  switch (a) {
    ...
    case `markdown`: {
      let e;
      t[6] !== n || t[7] !== r || t[8] !== i
        ? ((e = (0, I.jsx)(Hi, { gitBlameFeatureEnabled: n, hostId: r, path: i })),
          (t[6] = n),
          (t[7] = r),
          (t[8] = i),
          (t[9] = e))
...
function Wi(e) {
  let t = (0, R.c)(11),
    ...
    a;
  t[0] !== r || t[1] !== i
    ? ((a = { params: { hostId: r, path: i } }), (t[0] = r), (t[1] = i), (t[2] = a))
    : (a = t[2]);
...
function Gi({
  ...
  let we = (0, L.useMemo)(
    ...
    Te = (0, L.useMemo)(
      () => ({ cacheKey: `review-file-source:${zt(a)}:${zt(l)}:${zt(e)}`, contents: e, name: l }),
      [e, a, l],
    ),
    {
      annotations: Ee,
...
function Xi(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (r = t[0]);
  let i;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((i = ta(B)), (t[1] = i)) : (i = t[1]);
  let a;
...
function ia(e, t, n = {}) {
  ...
  let S = h.openTab(e, na, {
    ...(t == null ? {} : { contextMenuItems: (e) => Tn(e, { cwd: v, hostId: g, path: t }) }),
    defaultState: Sn,
    ...
    props: {
      ...
      onSelectFile: (n, r) => {
        (ia(e, n, { controller: h, hostId: g, isPreview: t == null ? !1 : r?.isPreview }),
          t ?? h.closeTab(e, _));
      },
    ...
    onMove: (n, r) => ({
      props: {
        ...
        workspaceRoot: m ?? null,
        onSelectFile: (n, i) => {
          (ia(e, n, { controller: r, hostId: g, isPreview: t == null ? !1 : i?.isPreview }),
            t ?? r.closeTab(e, _));
        },
        ...(l == null ? {} : { initialLine: l }),
        ...(i == null ? {} : { initialEndLine: i }),
  ...
  (u && h.resetTabState(e, S), t ?? it(e, !0, { animate: !1 }), On(e, e.get(h.tabs$)));
}
export {
  li as a,
  Dr as c,
