...
import { R as i, a, g as o, h as s, t as c } from "./app-scope.js";
var l = t((e) => {
      ...
      tryFetchUpdatedFallbackInfo(e, n, r, i) {
        return t(this, void 0, void 0, function* () {
          ...
          try {
            ...
            return (
              (t = this._errorBoundary) == null || t.logError(`tryFetchUpdatedFallbackInfo`, e), !1
            );
          }
        });
      }
  ...
  N = t((e) => {
      ...
      (e.NetworkCore = class {
        ...
        post(e, n) {
          return t(this, void 0, void 0, function* () {
            ...
            return (
              this._tryEncodeBody(t), yield this._tryToCompressBody(t), this._sendRequest(t, n)
            );
          });
        }
        get(e) {
        ...
        _sendRequest(n, r) {
          return t(this, void 0, void 0, function* () {
            var t, a;
            if (!P(n)) return (r && (r.path = `network_invalid_sdk_key`), null);
        ...
        _tryToCompressBody(e) {
          return t(this, void 0, void 0, function* () {
            let t = e.body;
            if (!(typeof t != `string` || !F(e, this._options)))
              try {
        ...
        _getInternalRequestArgs(e, t) {
          ...
          return (`data` in t && ne(r, t.data), r);
        }
      }));
    var P = (e) => (e.sdkKey ? !0 : (i.Log.warn(`Unable to make request without an SDK key`), !1)),
      ne = (e, t) => {
    ...
    function R(e, t, n, r) {
      let i = (0, f._getWindowSafe)(),
        ...
        d = z(t, i?.location?.origin),
        p = e.urlConfig.customUrl != null,
        m = e.fallbackUrl != null,
        h = V(r, [250, 1e3, 5e3, 1e4]),
        g = V(B(e.body), [16384, 65536, 262144, 1048576]),
  ...
  L = t((e) => {
    ...
    e.EventLogger = class e {
      ...
      _normalizeEvent(e) {
        ...
        return (
          n && (t.statsigMetadata = { currentPage: n }), Object.assign(Object.assign({}, e), t)
        );
      }
    };
  }),
  ...
  xe = t((e) => {
    ...
    e.default = class e extends n.StatsigClientBase {
      ...
      initializeAsync(e) {
        return t(this, void 0, void 0, function* () {
          return (
            (this._initializePromise ||= this._initializeAsyncImpl(e)), this._initializePromise
          );
        });
      }
      updateUserSync(e, t) {
  ...
  Q = o(c, (e) => !1, {
    onMount: (e, t) => {
      ...
      return (
        ...
        t.set(Z, (e) => (e.includes(n) ? e : [...e, n])),
        () => {
          t.set(Z, (e) => e.filter((e) => e !== n));
        }
      );
    },
  });
...
function $() {
  return (Ze(), (0, ze.useStatsigClient)());
}
function We() {
  return $().client;
}
...
//# sourceMappingURL=statsig-DoZ-0xit.js.map
