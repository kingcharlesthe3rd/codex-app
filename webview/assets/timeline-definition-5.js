...
import { i as n, n as r, r as i, t as a } from "./chunk-50.js";
import { a as o, o as s, s as c, t as l } from "./dist-1.js";
import { K as u, a as d, b as f, k as p, o as m } from "./chunk-48.js";
      ...
      var e = r(function (e, t, n, r) {
        ...
        u = {
          ...
          table: [
            ...
            e(t, [2, 7], { 1: [2, 1] }),
            e(t, [2, 3]),
            { 9: 18, 11: n, 12: i, 14: a, 16: o, 17: s, 18: 14, 19: 15, 20: c, 21: l },
            e(t, [2, 5]),
            e(t, [2, 6]),
            e(t, [2, 8]),
            { 13: [1, 19] },
...
` +
    ...
    (j = r(function (e, t, n) {
      let r = { id: S++, section: x, type: x, task: e, score: t || 0, events: n ? [n] : [] };
      T.push(r);
    }, `addTask`)),
    (M = r(function (e) {
    ...
    (R = r(function (e, n) {
      ...
      return (r(c, `ambivalent`), n.score > 3 ? o(a) : n.score < 3 ? s(a) : c(a), i);
    }, `drawFace`)),
    (z = r(function (e, t) {
    ...
    (W = r(function (e, t, n) {
      ...
      ((a.x = t.x),
        ...
        (a.ry = 3),
        L(i, a),
        J(n)(t.task, i, a.x, a.y, a.width, a.height, { class: `task` }, n, t.colour));
    }, `drawTask`)),
    (G = r(function (e, t) {
      L(e, {
        x: t.startx,
    ...
    (X = r(function (e, t, n, r) {
      let i = (n % I) - 1,
        a = e.append(`g`);
      ((t.section = i),
        a.attr(`class`, (t.class ? t.class + ` ` : ``) + `timeline-node ` + (`section-` + i)));
      let o = a.append(`g`),
        s = a.append(`g`),
        c = s
          .append(`text`)
    ...
    (te = r(function (e, t, r, i) {
      ...
      let s = a.securityLevel,
        c;
      s === `sandbox` && (c = h(`#i` + t));
      let l = h(s === `sandbox` ? c.nodes()[0].contentDocument.body : `body`).select(`#` + t);
      l.append(`g`);
      let d = i.db.getTasks(),
      ...
      m.forEach(function (e) {
        let t = { number: S, descr: e, section: S, width: 150, padding: 20, maxHeight: g },
      ...
      for (let [e, t] of d.entries()) {
        let r = { number: e, descr: t, section: t.section, width: 150, padding: 20, maxHeight: _ },
        ...
        (t.events.length > 0 && (o += (t.events.length - 1) * 10), (T = Math.max(T, o)));
      }
    ...
    ($ = r(function (e, t, r, i, a, o, s, c, l, u, d) {
      for (let c of t) {
        let t = { descr: c.task, section: r, number: r, width: 150, padding: 20, maxHeight: o };
        n.debug(`taskNode`, t);
    ...
    (ne = r(function (e, t, r, i, a, o) {
      ...
      a += 100;
      for (let c of t) {
        let t = { descr: c, section: r, number: r, width: 150, padding: 20, maxHeight: 50 };
        n.debug(`eventNode`, t);
...
//# sourceMappingURL=timeline-definition-5.js.map
