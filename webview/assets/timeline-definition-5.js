...
import { n, r, t as i } from "./chunk-61.js";
import { i as a, o, r as s } from "./invert.js";
import { G as c, a as l, b as u, o as d } from "./chunk-60.js";
var f = (function () {
  var e = n(function (e, t, n, r) {
    ...
    u = {
      ...
      table: [
        ...
        e(t, [2, 7], { 1: [2, 1] }),
        e(t, [2, 3]),
        { 9: 18, 11: r, 12: i, 14: a, 16: o, 17: s, 18: 14, 19: 15, 20: c, 21: l },
        e(t, [2, 5]),
        e(t, [2, 6]),
        e(t, [2, 8]),
        { 13: [1, 19] },
...
var h = ``,
  ...
  T = n(function (e, t, n) {
    let r = { id: g++, section: h, type: h, task: e, score: t || 0, events: n ? [n] : [] };
    y.push(r);
  }, `addTask`),
  E = n(function (e) {
  ...
  M = n(function (e, r) {
    ...
    return (n(c, `ambivalent`), r.score > 3 ? o(a) : r.score < 3 ? s(a) : c(a), i);
  }, `drawFace`),
  N = n(function (e, t) {
  ...
  R = n(function (e, t, n) {
    ...
    ((a.x = t.x),
      ...
      (a.ry = 3),
      j(i, a),
      H(n)(t.task, i, a.x, a.y, a.width, a.height, { class: `task` }, n, t.colour));
  }, `drawTask`),
  z = n(function (e, t) {
    j(e, {
      x: t.startx,
...
var G = n(function (e, t, n, r) {
  ...
  Y = n(function (t, n, i, a) {
    ...
    let l = o.securityLevel,
      d;
    l === `sandbox` && (d = e(`#i` + n));
    let f = e(l === `sandbox` ? d.nodes()[0].contentDocument.body : `body`).select(`#` + n);
    f.append(`g`);
    let p = a.db.getTasks(),
    ...
    for (let [e, t] of p.entries()) {
      let n = { number: e, descr: t, section: t.section, width: 150, padding: 20, maxHeight: _ },
      ...
      (t.events.length > 0 && (a += (t.events.length - 1) * 10), (T = Math.max(T, a)));
    }
  ...
  X = n(function (e, t, n, i, a, o, s, c, l, u, d) {
    for (let c of t) {
      let t = { descr: c.task, section: n, number: n, width: 150, padding: 20, maxHeight: o };
      r.debug(`taskNode`, t);
  ...
  Z = n(function (e, t, n, i, a, o) {
    ...
    a += 100;
    for (let c of t) {
      let t = { descr: c, section: n, number: n, width: 150, padding: 20, maxHeight: 50 };
      r.debug(`eventNode`, t);
