...
import { n as Nt, t as Pt } from "./app-initial~app-main~appgen-library-page-B4-cMcQI.js";
...
import { n as pn, t as mn } from "./appgen-share-dialog-1.js";
...
function xn(e) {
  ...
  t[6] === u
    ? (d = t[7])
    : ((d = W(`pointer-events-none relative z-[1] flex min-w-0 items-center`, u)),
      (t[6] = u),
      (t[7] = d));
  let f;
  t[8] !== n || t[9] !== i || t[10] !== a
          ...
          ? (0, K.jsxs)(K.Fragment, {
              children: [
                ...
                (0, K.jsx)(zt, {
                  className: `pointer-events-none relative z-[1]`,
                  hideWhenCompact: !0,
                  children: (0, K.jsx)(dt, { dateString: n.modifiedAt }),
                }),
                    ...
                    children: [
                      (0, K.jsxs)(`span`, {
                        ...
                        children: [
                          ...
                          (0, K.jsx)(dt, { dateString: n.modifiedAt }),
                        ],
                      }),
                      r == null
                        ? null
...
function Sn(e) {
  ...
  t[2] === o
    ? (s = t[3])
    : ((s = W(`pointer-events-none relative z-[1] flex min-w-0 items-center`, o)),
      (t[2] = o),
      (t[3] = s));
  let c;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, K.jsx)(se, { className: `icon-sm` })), (t[4] = c))
    : (c = t[4]);
  let l;
  t[5] === r
    ? (l = t[6])
...
function Cn(e) {
  ...
  t[5] !== o || t[6] !== s
    ...
    : (c = t[7]);
  let { src: l } = y(a ? n.cloudFile.id : ``, c),
    u;
  return (
    t[8] !== n || t[9] !== l || t[10] !== i
      ? ((u =
...
function Tn(e) {
  let t = e.lastIndexOf(`.`);
  return _e(t === -1 ? e : e.slice(0, t), { style: `sentence` });
}
function En(e) {
  let t = (0, Dn.c)(9),
    { fileType: n } = e;
...
var Dn,
  K,
  On = e(() => {
    ((Dn = r()), Le(), we(), dn(), ft(), z(), T(), ye(), bn(), Rt(), (K = n()));
  }),
  kn,
  An = e(() => {
    (a(),
      ...
      Ee(),
      h(),
      (kn = _(De, ({ modifiedAt: e, path: t, size: n }) => ({
        queryFn: async () => {
          let e = oe.libraryFiles;
...
function jn(e) {
  ...
  if (t[0] !== n.file.name) {
    ...
    ((d = _e(e === -1 ? n.file.name : n.file.name.slice(0, e), { style: `sentence` })),
      (t[0] = n.file.name),
      (t[1] = d));
  } else d = t[1];
  let f = d,
  ...
  t[5] !== o || t[6] !== n.file.name
    ...
    : (h = t[7]);
  let g;
  t[8] === Symbol.for(`react.memo_cache_sentinel`) ? ((g = W(Zt, `z-0`)), (t[8] = g)) : (g = t[8]);
  let _;
  t[9] !== n || t[10] !== i
  ...
  t[15] === y
    ? (b = t[16])
    : ((b = W(`pointer-events-none relative z-[1] flex min-w-0 items-center`, y)),
      (t[15] = y),
      (t[16] = b));
  let x;
          ...
          ? (0, q.jsxs)(q.Fragment, {
              children: [
                ...
                (0, q.jsx)(zt, {
                  className: `pointer-events-none relative z-[1]`,
                  hideWhenCompact: !0,
                  children: (0, q.jsx)(dt, { dateString: n.modifiedAt }),
                }),
              ],
            })
          : (0, q.jsx)(qt, {
                    ...
                    children: [
                      (0, q.jsxs)(`span`, {
                        ...
                        children: [
                          ...
                          (0, q.jsx)(dt, { dateString: n.modifiedAt }),
                        ],
                      }),
                      (0, q.jsx)(`span`, {
                        className: `hidden group-hover/file-row:inline-flex`,
...
function Vn(e) {
  ...
  if (t[0] !== s || t[1] !== n.image.name || t[2] !== o) {
    ...
    ((l = _e(e === -1 ? n.image.name : n.image.name.slice(0, e), { style: `sentence` })),
      (c = cn),
      (d = `group/image-row`),
      (f = o),
      (u = s.formatMessage(
  ...
  let p;
  t[8] === Symbol.for(`react.memo_cache_sentinel`) ? ((p = W(Zt, `z-0`)), (t[8] = p)) : (p = t[8]);
  let m;
  t[9] !== n || t[10] !== i
  ...
  t[15] === g
    ? (_ = t[16])
    : ((_ = W(`pointer-events-none relative z-[1] flex min-w-0 items-center`, g)),
      (t[15] = g),
      (t[16] = _));
  let v;
  t[17] === o
          ...
          ? (0, J.jsxs)(J.Fragment, {
              children: [
                ...
                (0, J.jsx)(zt, {
                  className: `pointer-events-none relative z-[1]`,
                  hideWhenCompact: !0,
                  children: (0, J.jsx)(dt, { dateString: n.modifiedAt }),
                }),
              ],
            })
          : (0, J.jsx)(qt, {
                ...
                children: [
                  ...
                  (0, J.jsxs)(Vt, {
                    ...
                    children: [
                      ...
                      (0, J.jsx)(dt, { dateString: n.modifiedAt }),
                    ],
                  }),
                ],
              }),
  ...
  return (
    ...
    t[47] !== f ||
    t[48] !== h
      ? ((T = (0, J.jsxs)(c, { className: d, viewMode: f, children: [h, S, C, w] })),
        (t[42] = c),
        (t[43] = S),
        (t[44] = C),
        (t[45] = w),
    ...
    ? ((c =
        o == null
          ...
          : (0, Y.jsx)(`button`, {
              ...
              className: W(Zt, `peer/appgen-row`),
              onClick: (e) => {
                nt({ event: e, href: o, initiator: `mcp_app_resource` });
              },
              type: `button`,
            })),
      (t[0] = a),
                  ...
                  children: [
                    ...
                    (0, Y.jsxs)(`span`, {
                      ...
                      children: [
                        ...
                        o == null
                          ? null
                          : (0, Y.jsx)(Xe, { className: `icon-2xs`, ExternalIcon: Ge, href: o }),
                      ],
                    }),
                  ],
                }),
        ...
        i === `list`
          ? (0, Y.jsxs)(Y.Fragment, {
              children: [
                ...
                (0, Y.jsx)(zt, {
                  hideWhenCompact: !0,
                  children: (0, Y.jsx)(dt, { dateString: r.updated_at }),
                }),
                (0, Y.jsx)(Kt, {
                  projectId: r.id,
...
function Kn(e) {
  ...
  t[0] === n
    ? (a = t[1])
    : ((a = W(Gn(n), n === `list` ? `size-full` : `h-auto w-[72%]`)), (t[0] = n), (t[1] = a));
  let o;
  t[2] !== i || t[3] !== a
...
function qn(e) {
  let t = (0, Jn.c)(22),
    ...
    l;
  t[0] !== r || t[1] !== c
    ? ((l = () => kt(c, mn, { projectId: r })), (t[0] = r), (t[1] = c), (t[2] = l))
    : (l = t[2]);
  let u;
  t[3] === n
    ? (u = t[4])
    : ((u = (0, Y.jsx)(re, { className: `icon-xs shrink-0`, accessPolicy: n, "aria-hidden": !0 })),
      (t[3] = n),
      (t[4] = u));
  let d = U,
    f = M(s),
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (g = t[16]);
  let _;
  t[17] === a ? (_ = t[18]) : ((_ = (0, Y.jsx)(dt, { dateString: a })), (t[17] = a), (t[18] = _));
  let v;
  return (
    t[19] !== h || t[20] !== _
      ? ((v = (0, Y.jsxs)(`div`, {
...
function tr(e) {
  let t = (0, cr.c)(41),
    ...
    _ = l === void 0 ? !0 : l,
    { data: v, isError: y, isLoading: b } = c($n),
    { data: x, isError: S, isLoading: C } = c(Zn),
    w = _ && (o === `sites` || (o === `all` && s === `all`)),
    T = _ && (o === `files` || o === `all`),
    E = _ && (o === `images` || (o === `all` && s === `all`)),
    D;
  ...
  t[12] !== n || t[13] !== o || t[14] !== s || t[15] !== h
    ...
    : (se = t[16]);
  let I = se,
    ce = (!w || !k || A) && (i == null || !i.hasNextPage || i.hasLoadError);
  if (ae) {
    let e;
    return (
  ...
  if (ie.length === 0) {
    ...
    if (ce) {
      let e;
      return (
        t[19] !== o || t[20] !== I || t[21] !== u
          ? ((e = I ? (0, X.jsx)(ar, {}) : (0, X.jsx)(rr, { contentType: o, onCreate: u })),
            (t[19] = o),
            (t[20] = I),
            (t[21] = u),
            (t[22] = e))
  ...
  let L = (w && M) || (T && y) || (E && S) || i?.hasLoadError === !0,
    le = (w && k && !A) || i?.hasNextPage === !0,
    R = j || i?.isFetchingNextPage === !0,
    ue;
  t[23] !== i || t[24] !== O || t[25] !== k || t[26] !== A || t[27] !== w
    ? ((ue = () =>
        Promise.all([
          ...(w && k && !A ? [O()] : []),
...
function rr(e) {
  ...
  t[0] === n
    ...
    : ((i =
        n === `files`
          ? (0, X.jsx)(ut, { className: `icon-lg text-token-foreground` })
          : n === `images`
            ? (0, X.jsx)(F, { className: `icon-lg text-token-foreground` })
            : (0, X.jsx)(Me, { className: `icon-lg text-token-foreground` })),
      (t[0] = n),
      (t[1] = i));
  let a;
  t[2] === n
...
function or(e) {
  let t = (0, cr.c)(35),
    ...
    m;
  t[0] === p ? (m = t[1]) : ((m = W(`grid`, p)), (t[0] = p), (t[1] = m));
  let h;
  t[2] === f
    ? (h = t[3])
    : ((h =
  ...
  switch (r.kind) {
    ...
    case `image`: {
      ...
      t[17] === r.image.desktopPath
        ? (e = t[18])
        : ((e = bt(r.image.desktopPath)), (t[17] = r.image.desktopPath), (t[18] = e));
      let n;
      return (
...
function pr(e) {
  ...
  t[7] === r.image.desktopPath
    ? (l = t[8])
    : ((l = bt(r.image.desktopPath)), (t[7] = r.image.desktopPath), (t[8] = l));
  let u;
  ...
  t[13] === r.image.desktopPath
    ? (f = t[14])
    : ((f = bt(r.image.desktopPath)), (t[13] = r.image.desktopPath), (t[14] = f));
  let p;
...
function hr(e) {
  let t = (0, yr.c)(21),
    { item: n, onClose: r } = e,
    { data: i, isError: a } = d(Sr, n.file.path),
    o = i?.previewPath,
    s,
    c;
  (t[0] === o
    ...
    : ((s = () => {
        if (o != null)
          return () => {
            oe.libraryFiles?.releaseFilePreview({ previewPath: o });
          };
      }),
      (c = [o]),
      (t[0] = o),
  ...
  let p;
  t[13] !== n.file || t[14] !== o
    ? ((p = o == null ? void 0 : { file: ur(n.file), kind: `file` }),
      (t[13] = n.file),
      (t[14] = o),
      (t[15] = p))
    : (p = t[15]);
...
function _r(e) {
  ...
  let p;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, Z.jsx)(xe, { "aria-hidden": !0, className: `icon-xs` })), (t[7] = p))
    : (p = t[7]);
  let m;
  t[8] !== o || t[9] !== f
    ? ((m = (0, Z.jsx)(fe, {
  ...
  let v = r == null ? `h-full` : `h-[calc(100%_-_var(--right-panel-composer-overlay-reserve,0px))]`,
    y;
  t[19] === v ? (y = t[20]) : ((y = W(`min-h-0`, v)), (t[19] = v), (t[20] = y));
  let b;
  t[21] !== i || t[22] !== y
    ? ((b = (0, Z.jsx)(`div`, {
...
function Rr(e) {
  ...
  let c;
  t[4] !== a || t[5] !== o
    ? ((c = (0, Q.jsx)(G.Item, { RightIcon: a, onSelect: o, children: s })),
      (t[4] = a),
      (t[5] = o),
      (t[6] = c))
    : (c = t[6]);
  let l = n === `private` ? H : void 0,
    u;
  ...
  let g;
  t[16] !== p || t[17] !== m
    ? ((g = (0, Q.jsx)(G.Item, { RightIcon: p, onSelect: m, children: h })),
      (t[16] = p),
      (t[17] = m),
      (t[18] = g))
    : (g = t[18]);
...
function zr(e) {
  ...
  let p;
  t[7] !== u || t[8] !== d
    ? ((p = (0, Q.jsx)(G.Item, { LeftIcon: Pt, RightIcon: u, onSelect: d, children: f })),
      (t[7] = u),
      (t[8] = d),
      (t[9] = p))
    : (p = t[9]);
  let m = n === `sites` ? H : void 0,
    h;
  ...
  let _;
  t[13] !== m || t[14] !== h
    ? ((_ = (0, Q.jsx)(G.Item, { LeftIcon: gt, RightIcon: m, onSelect: h, children: g })),
      (t[13] = m),
      (t[14] = h),
      (t[15] = _))
    : (_ = t[15]);
  let v = n === `images` ? H : void 0,
    y;
  ...
  t[19] !== o || t[20] !== v || t[21] !== y
    ? ((x = (0, Q.jsx)(G.Item, { LeftIcon: o, RightIcon: v, onSelect: y, children: b })),
      (t[19] = o),
      (t[20] = v),
      (t[21] = y),
      (t[22] = x))
    : (x = t[22]);
  let S = n === `all` && r === `document` ? H : void 0,
    C;
  ...
  let T;
  t[26] !== S || t[27] !== C
    ? ((T = (0, Q.jsx)(G.Item, { LeftIcon: ze, RightIcon: S, onSelect: C, children: w })),
      (t[26] = S),
      (t[27] = C),
      (t[28] = T))
    : (T = t[28]);
  let E = n === `all` && r === `spreadsheet` ? H : void 0,
    D;
  ...
  let O;
  t[32] !== E || t[33] !== D
    ? ((O = (0, Q.jsx)(G.Item, { LeftIcon: Ue, RightIcon: E, onSelect: D, children: ee })),
      (t[32] = E),
      (t[33] = D),
      (t[34] = O))
    : (O = t[34]);
  let k = n === `all` && r === `presentation` ? H : void 0,
    A;
  t[35] === c ? (A = t[36]) : ((A = () => c(`presentation`)), (t[35] = c), (t[36] = A));
  let j;
  ...
  let M;
  t[38] !== k || t[39] !== A
    ? ((M = (0, Q.jsx)(G.Item, { LeftIcon: et, RightIcon: k, onSelect: A, children: j })),
      (t[38] = k),
      (t[39] = A),
      (t[40] = M))
    : (M = t[40]);
  let N = n === `all` && r === `pdf` ? H : void 0,
    P;
  t[41] === c ? (P = t[42]) : ((P = () => c(`pdf`)), (t[41] = c), (t[42] = P));
  let te;
  ...
  let ne;
  t[44] !== N || t[45] !== P
    ? ((ne = (0, Q.jsx)(G.Item, { LeftIcon: We, RightIcon: N, onSelect: P, children: te })),
      (t[44] = N),
      (t[45] = P),
      (t[46] = ne))
    : (ne = t[46]);
  ...
  return (
    ...
    t[52] !== ne ||
    t[53] !== p
      ? ((F = (0, Q.jsxs)(Q.Fragment, { children: [l, p, _, x, T, O, M, ne] })),
        (t[47] = _),
        (t[48] = x),
        (t[49] = T),
        (t[50] = O),
...
function Ur(e) {
  let t = (0, oi.c)(133),
    ...
    d = ge(),
    [f, m] = (0, si.useState)(``),
    { scrollContainerRef: h, showTitleInToolbar: _, titleRef: v } = Bt(),
    [y, b] = (0, si.useState)(`list`),
    [S, C] = (0, si.useState)(`all`),
    [T, E] = (0, si.useState)(`all`),
    [D, O] = (0, si.useState)(`all`),
    [A, j] = (0, si.useState)(null),
    [M, N] = (0, si.useState)(0),
    P;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((P = []), (t[0] = P)) : (P = t[0]);
  let [te, F] = (0, si.useState)(P),
    re = (0, si.useRef)(null),
    ie = c && (T === `sites` || (T === `all` && D === `all`)),
    ae = c && (T === `files` || T === `all`),
    oe = c && (T === `images` || (T === `all` && D === `all`)),
    se;
  t[1] !== T || t[2] !== D ? ((se = ti(T, D)), (t[1] = T), (t[2] = D), (t[3] = se)) : (se = t[3]);
  let I = se,
    ce;
  t[4] === f ? (ce = t[5]) : ((ce = f.trim()), (t[4] = f), (t[5] = ce));
  let L = ct(ce, 300),
    le;
  t[6] !== T || t[7] !== L || t[8] !== D
    ? ((le = [`appgen-library-cloud-files`, T, D, L]),
      (t[6] = T),
      (t[7] = L),
      (t[8] = D),
      (t[9] = le))
    : (le = t[9]);
  let R;
  t[10] !== I || t[11] !== n || t[12] !== L
    ? ((R = (e) => {
        let { pageParam: t } = e;
        if (n == null || I === void 0) throw Error(`Cloud Library files are unavailable`);
        return n.search({ categories: I, cursor: t, limit: ci, query: L });
      }),
      (t[10] = I),
      (t[11] = n),
      (t[12] = L),
      (t[13] = R))
    : (R = t[13]);
  let de = n != null && I !== void 0,
    pe;
  t[14] !== le || t[15] !== R || t[16] !== de
    ? ((pe = {
        queryKey: le,
  ...
  (t[22] === l
    ...
    : ((ye = () => () => {
      ...
      (t[23] = ye),
      (t[24] = be)),
    (0, si.useLayoutEffect)(ye, be));
  let xe;
  t[25] !== l || t[26] !== H || t[27] !== _e
    ? ((xe = () => {
        tn(l, _e, { type: `create`, setSelectedMode: H });
      }),
      (t[25] = l),
      (t[26] = H),
      (t[27] = _e),
  ...
  t[29] !== l || t[30] !== _e
    ? ((Ce = (e) => {
        tn(l, _e, { type: `create-asset`, assetType: e });
      }),
      (t[29] = l),
      (t[30] = _e),
      (t[31] = Ce))
  ...
  t[32] !== l || t[33] !== _e
    ? ((Ee = (e, t, n) => {
        tn(l, _e, { type: `edit`, liveUrl: n, projectId: e, projectTitle: t });
      }),
      (t[32] = l),
      (t[33] = _e),
      (t[34] = Ee))
  ...
  t[45] !== B || t[46] !== V
    ? ((Ie = (e) => {
        if (!(!B || !vt(e.dataTransfer))) {
          if ((e.preventDefault(), e.stopPropagation(), V)) {
            e.dataTransfer.dropEffect = `none`;
            return;
          }
          ((e.dataTransfer.dropEffect = `copy`), N(Xr));
        }
      }),
      (t[45] = B),
      (t[46] = V),
  ...
  if (
    ...
    ((Ve = (t) => {
      if (!B || !vt(t.dataTransfer) || (t.preventDefault(), t.stopPropagation(), N(0), V)) return;
    ...
    let e = async (e) => {
      ...
      for (let [o, s] of e.entries()) {
        ...
        try {
          let t = await i(s);
          if (
            ((r += 1), e != null && $t({ contentType: T, file: e, fileFilter: D, searchQuery: L }))
          ) {
            (a.push(t.fileId),
              F((n) => n.map((n) => (n.id === e.id ? { ...n, uploadedFileId: t.fileId } : n))));
            continue;
          }
          e != null && F((t) => t.filter((t) => t.id !== e.id));
        } catch {
          ((n += 1), F((t) => t.filter((t) => t.id !== e?.id)));
        }
      }
      let o = a.length === 0;
      if (a.length > 0) {
        ...
        for (let t = 0; t < ui; t += 1) {
          let t = await z.refetch(),
            ...
            s = i ? e : n;
          if (
            (F((e) => e.filter((e) => e.uploadedFileId == null || !s.has(e.uploadedFileId))), i)
          ) {
            o = !0;
            break;
          }
  ...
  t[82] === Xe
    ? (Qe = t[83])
    : ((Qe = (0, $.jsx)(Dt, { extension: !0, children: Xe })), (t[82] = Xe), (t[83] = Qe));
  let $e;
  t[84] === Xe
    ? ($e = t[85])
    : (($e = (0, $.jsx)(Dt, {
        ...
        chromeExtension: !0,
        electron: !0,
        children: (0, $.jsx)(k.Header, { children: Xe }),
      })),
      (t[84] = Xe),
      (t[85] = $e));
  let et;
  t[86] !== a || t[87] !== Fe || t[88] !== A
    ? ((et =
        A == null
          ? null
          : (0, $.jsx)(k.RightPanelOutlet, {
              children: (0, $.jsx)(pr, { cloudPreviewRenderer: a, item: A, onClose: Fe }),
            })),
      (t[86] = a),
      (t[87] = Fe),
      (t[88] = A),
  ...
  t[113] !== y
    ...
    : (at = t[114]);
  let ot;
  t[115] !== h || t[116] !== rt || t[117] !== it || t[118] !== at || t[119] !== v
    ? ((ot = (0, $.jsx)(Ft, {
  ...
  t[121] === M
    ? (st = t[122])
    : ((st = M > 0 ? (0, $.jsx)(ii, {}) : null), (t[121] = M), (t[122] = st));
  let lt;
  return (
    t[123] !== W ||
    t[124] !== Be ||
...
function ei(e) {
  let t = pt(e, { includeDirectories: !1 });
...
function ri(e) {
  let t = (0, oi.c)(34),
    ...
    p = Te(),
    m;
  t[0] === d ? (m = t[1]) : ((m = { enabled: d }), (t[0] = d), (t[1] = m));
  let { isFetchingNextPage: h, isLoading: g, isRefetching: _, refetch: v } = pe(m),
    { isLoading: y, isRefetching: b } = c($n),
    { isLoading: x, isRefetching: C } = c(Zn),
    w = _ || b || C || n?.isRefetching === !0,
    T;
  t[2] === p
    ? (T = t[3])
    : ((T = p.formatMessage({
  ...
  t[4] === s
    ...
    : ((D = s
      ...
      (t[4] = s),
      (t[5] = D));
  let ee = (d && g) || (l && y) || (u && x) || n?.isLoading === !0 || w || h,
    O;
  t[6] !== n || t[7] !== v || t[8] !== f || t[9] !== l || t[10] !== u || t[11] !== d
    ? ((O = () => {
        Promise.all([
          ...(d ? [v()] : []),
          ...(l ? [f.query.invalidate($n)] : []),
          ...(u ? [f.query.invalidate(Zn)] : []),
  ...
  t[13] === w
    ? (k = t[14])
    : ((k = w ? null : (0, $.jsx)(S, { className: `icon-xs` })), (t[13] = w), (t[14] = k));
  let A;
  t[15] !== w || t[16] !== E || t[17] !== ee || t[18] !== O || t[19] !== k
    ? ((A = (0, $.jsx)(fe, {
        "aria-label": E,
        color: `ghost`,
        disabled: ee,
  ...
  let j;
  t[21] !== E || t[22] !== A
    ? ((j = (0, $.jsx)(de, { tooltipContent: E, children: A })),
      (t[21] = E),
      (t[22] = A),
      (t[23] = j))
    : (j = t[23]);
  ...
  return (
    t[31] !== N || t[32] !== D
      ? ((P = (0, $.jsx)(Pe, { start: D, trailing: N })), (t[31] = N), (t[32] = D), (t[33] = P))
      : (P = t[33]),
    P
  );
}
function ii() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsx)(ne, { className: `size-12` }),
      })),
      (e[0] = t))
    : (t = e[0]);
  let n;
...
function ai(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(U, {
      ...
      (s = (0, $.jsx)(Re, { "aria-hidden": !0, className: `icon-xs text-token-text-secondary` })),
      (t[2] = o),
      (t[3] = s))
    : ((o = t[2]), (s = t[3]));
  let c;
  ...
  t[7] === r
    ? (u = t[8])
    : ((u = (0, $.jsx)(G.Item, { LeftIcon: gt, onSelect: r, children: l })),
      (t[7] = r),
      (t[8] = u));
  let d;
  ...
  t[12] === d
    ? (p = t[13])
    : ((p = (0, $.jsx)(G.Item, { LeftIcon: ze, onSelect: d, children: f })),
      (t[12] = d),
      (t[13] = p));
  let m;
  ...
  t[17] === m
    ? (g = t[18])
    : ((g = (0, $.jsx)(G.Item, { LeftIcon: Ue, onSelect: m, children: h })),
      (t[17] = m),
      (t[18] = g));
  let _;
  ...
  t[22] === _
    ? (y = t[23])
    : ((y = (0, $.jsx)(G.Item, { LeftIcon: et, onSelect: _, children: v })),
      (t[22] = _),
      (t[23] = y));
  let b;
  ...
  t[27] === b
    ? (S = t[28])
    : ((S = (0, $.jsx)(G.Item, { LeftIcon: We, onSelect: b, children: x })),
      (t[27] = b),
      (t[28] = S));
  let C;
  ...
  t[32] === C
    ? (T = t[33])
    : ((T = (0, $.jsx)(G.Item, { LeftIcon: F, onSelect: C, children: w })),
      (t[32] = C),
      (t[33] = T));
  let E;
  return (
