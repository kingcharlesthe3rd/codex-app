...
import { _ as i, u as a } from "./vscode-api.js";
...
import { f as p } from "./apps-queries.js";
import { y as m } from "./mention-item-B.js";
import { t as h } from "./x.js";
import { m as g } from "./use-plugins.js";
import { s as _, t as v } from "./use-native-apps.electron.js";
import { n as y } from "./get-file-icon.js";
import { n as b } from "./use-skills.js";
import { t as x } from "./image-preview-dialog.js";
import { t as S } from "./attachment-remove-button.js";
import { n as C } from "./use-composer-controller.js";
...
function k(e) {
  ...
  if (
    ...
    (t[38] === I.accessibilityText
      ? (x = t[39])
      : ((x = I.accessibilityText?.trim() ?? ``), (t[38] = I.accessibilityText), (t[39] = x)),
      (F = x),
      (R = F.length > 0),
      (z = k && R),
      (V = P > 0 ? P - 1 : null),
...
function N(e) {
  ...
  let C;
  t[20] !== n || t[21] !== a || t[22] !== p
    ? ((C = a ?? (n == null ? null : (0, O.jsx)(n, { className: l(p ? `size-6` : `icon-2xs`) }))),
      (t[20] = n),
      (t[21] = a),
      (t[22] = p),
      (t[23] = C))
  ...
  t[32] !== g || t[33] !== p || t[34] !== s || t[35] !== c
    ? ((k =
        ...
        (0, O.jsx)(`div`, {
          ...
          "aria-label": c,
          children: (0, O.jsx)(h, {
            className: l(p ? `icon-xxs` : `icon-2xs text-token-foreground`),
          }),
        })),
      (t[32] = g),
      (t[33] = p),
...
function P(e, t, n) {
  return o({
    ...
    queryFn: () => d.fileAttachments.countFolderFiles({ folderPath: e, hostId: t }),
...
function re(e) {
      ...
      if (
        ...
        t[28] === b
          ...
          : ((s = (0, O.jsx)(`span`, {
              ...
              children: (0, O.jsx)(b, { className: `size-6` }),
            })),
            (t[28] = b),
            (t[29] = s));
        let l = o != null,
        ...
        t[37] !== o || t[38] !== D
          ? ((g = o
              ? (0, O.jsx)(S, { className: `top-1 right-1 z-20`, ariaLabel: D, onRemove: o })
              : null),
            (t[37] = o),
            (t[38] = D),
            (t[39] = g))
        ...
        (t[44] !== y || t[45] !== a || t[46] !== i
          ? ((x = (0, O.jsx)(F, { folderPath: i, hostId: a, children: y })),
            (t[44] = y),
            (t[45] = a),
            (t[46] = i),
            (t[47] = x))
  ...
  let te;
  return (
    t[55] !== b || t[56] !== g || t[57] !== u || t[58] !== o || t[59] !== D || t[60] !== M
      ? ((te = (0, O.jsx)(N, {
          Icon: b,
          onClick: u,
          onRemove: o,
...
function F(e) {
  let t = (0, E.c)(14),
    { children: n, folderPath: r, hostId: a } = e,
    [o, s] = (0, D.useState)(!1),
    c;
  t[0] !== r || t[1] !== a || t[2] !== o
    ? ((c = P(r, a, o)), (t[0] = r), (t[1] = a), (t[2] = o), (t[3] = c))
    : (c = t[3]);
  let { data: l } = i(c),
    d,
    f,
...
//# sourceMappingURL=mention-metadata-syncer-Bc-bkkFL.js.map
