...
import { G as n, T as r, U as i, X as a, j as o, q as s } from "./app-scope-CWE-zIhQ.js";
import {
  A as c,
  C as l,
  D as u,
    ...
    #u(e, t) {
      return t
        ? ((!this.#a || this.#t !== this.#s || t !== this.#o) &&
            ((this.#o = t), (this.#s = this.#t), (this.#a = n(this.#a, t(e)))),
          this.#a)
        : e;
    }
    #d(e) {
      ...
      return (
        e.forEach((e) => {
          let i = this.#e.defaultQueryOptions(e),
            a = t.get(i.queryHash);
          a
            ? n.push({ defaultedQueryOptions: i, observer: a })
            : n.push({ defaultedQueryOptions: i, observer: new r(this.#e, i) });
        }),
        n
      );
    }
...
function S({ queries: e, ...t }, n) {
  ...
  (y.forEach((e) => {
    ...
    d(v));
  let [S] = x.useState(() => new b(a, y, t)),
    [C, w, T] = S.getOptimisticResult(y, t.combine),
    E = !s && t.subscribed !== !1;
  (x.useSyncExternalStore(
    x.useCallback((e) => (E ? S.subscribe(o.batchCalls(e)) : i), [S, E]),
    () => S.getCurrentResult(),
    () => S.getCurrentResult(),
  ),
    x.useEffect(() => {
