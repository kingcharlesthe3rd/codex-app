...
import { D as n, F as r, L as i, N as a, O as o, P as s } from "./app-scope.js";
import {
  C as c,
  D as l,
  E as u,
    ...
    #u(e, t) {
      return t
        ? ((!this.#a || this.#t !== this.#s || t !== this.#o) &&
            ((this.#o = t), (this.#s = this.#t), (this.#a = s(this.#a, t(e)))),
          this.#a)
        : e;
    }
    #d(e) {
      ...
      return (
        e.forEach((e) => {
          let i = this.#e.defaultQueryOptions(e),
            a = t.get(i.queryHash);
          a
            ? r.push({ defaultedQueryOptions: i, observer: a })
            : r.push({ defaultedQueryOptions: i, observer: new n(this.#e, i) });
        }),
        r
      );
    }
...
function S({ queries: e, ...t }, r) {
  ...
  (y.forEach((e) => {
    ...
    f(v));
  let [S] = x.useState(() => new b(i, y, t)),
    [C, w, T] = S.getOptimisticResult(y, t.combine),
    E = !s && t.subscribed !== !1;
  (x.useSyncExternalStore(
    x.useCallback((e) => (E ? S.subscribe(o.batchCalls(e)) : a), [S, E]),
    () => S.getCurrentResult(),
    () => S.getCurrentResult(),
  ),
    x.useEffect(() => {
  ...
  let D = C.some((e, t) => g(y[t], e))
    ? C.flatMap((e, t) => {
        let r = y[t];
        if (r) {
          let t = new n(i, r);
          if (g(r, e)) return p(r, t, v);
          d(e, s) && p(r, t, v);
        }
        return [];
      })
