import { y as e } from "./app-scope.js";
import "./app-server-manager-signals.js";
import { A as t, h as n, n as r, r as i } from "./vscode-api.js";
import { n as a } from "./react.js";
import { pn as o } from "./src-2.js";
import { t as s } from "./request.js";
import { t as c } from "./invalidate-queries-and-broadcast.js";
import { a as l } from "./apps-queries.js";
import { t as u } from "./codex-api-error.js";
async function d({ hostId: e, queryClient: t, refreshAppsList: n }) {
  let a = t.getQueryData([`apps`, `list`, e]),
    s = await n();
  return f({ previousApps: a, nextApps: s })
    ? (await r(`ambient-suggestions-refresh`, {
        params: { hostId: e, projectRoot: o(`~`), mode: `first-plugin-connect` },
      }),
      await Promise.all([
        t.invalidateQueries({ queryKey: i(`ambient-suggestions`) }),
        t.invalidateQueries({ queryKey: i(`ambient-suggestions-refresh`) }),
      ]),
      s)
    : s;
}
...
function g() {
  ...
  return async ({ fullRedirectUrl: t }) => {
    ...
    try {
      ...
      n.error(`Failed to finish app OAuth callback`, { safe: {}, sensitive: { error: e } });
...
//# sourceMappingURL=app-connect-oauth-DZ-_I6sG.js.map
