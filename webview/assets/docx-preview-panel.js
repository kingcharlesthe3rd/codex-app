...
function Ye({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? (e.selectionKind == null ? y(e.rect) : G(e)) : e.point;
  return {
    sessionId:
      o.mode === `edit`
...
function at(e) {
  ...
  return (
    t[36] !== v || t[37] !== x
      ? ((C = (0, q.jsxs)(q.Fragment, { children: [v, x] })), (t[36] = v), (t[37] = x), (t[38] = C))
      : (C = t[38]),
    C
  );
}
...
function st(e) {
  ...
  if (n.kind === `region`) {
    ...
    t[0] !== n || t[1] !== i
      ...
      : (e = t[2]);
    let o;
    t[3] === n.rect ? (o = t[4]) : ((o = y(n.rect)), (t[3] = n.rect), (t[4] = o));
    let s;
...
function Tt(e) {
  ...
  t[36] !== L || t[37] !== B || t[38] !== j || t[39] !== T
    ? ((Ne = L == null ? null : Pe({ anchor: L, editorScale: j, layer: T, pageSize: B })),
      (t[36] = L),
      (t[37] = B),
      (t[38] = j),
      (t[39] = T),
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((qe = () => {
        typeof window > `u` ||
          ee({ animationFrameRef: de, animationWindow: window, editorWrapper: ue.current });
      }),
      (t[49] = qe))
    : (qe = t[49]);
  let Je = qe,
  ...
  t[59] !== q || t[60] !== U || t[61] !== T
    ...
    : (lt = t[62]);
  let ft;
  (t[63] !== B.height || t[64] !== B.width || t[65] !== j || t[66] !== U || t[67] !== T
  ...
  (t[77] !== i || t[78] !== T || t[79] !== gt
    ...
    (0, J.useEffect)(ht, _t));
  let vt;
  t[81] !== E || t[82] !== F || t[83] !== i || t[84] !== T || t[85] !== v || t[86] !== K
    ? ((vt = () => {
        if (i || T == null) return;
  ...
  (t[92] !== i || t[93] !== T
    ...
    (0, J.useEffect)(bt, xt));
  let St;
  t[95] !== E || t[96] !== F || t[97] !== i || t[98] !== T || t[99] !== v || t[100] !== K
    ? ((St = (e) => {
  ...
  t[113] !== i || t[114] !== v || t[115] !== oe || t[116] !== x || t[117] !== S
    ? ((Mt = (e, t) => {
        (Ae(
          oe,
          { artifactTabId: x, artifactType: `document`, importKind: `docx`, threadId: S },
  ...
  t[171] !== C
    ? ((Q = (e, t) => {
        ...
        if (F != null) {
          ...
          (s((e) =>
            e.map((e) =>
              nt(e) === F ? { ...e, content: [{ content_type: `text`, text: u }] } : e,
            ),
          ),
            We());
          return;
        ...
        let d = Xe({ anchor: E, pageCount: g, pageNumber: _, pageSize: D ?? v }),
          f = l({
  ...
  let Jt;
  t[175] === i ? (Jt = t[176]) : ((Jt = i ? { cursor: b } : void 0), (t[175] = i), (t[176] = Jt));
  let Yt, Xt;
  ...
  t[186] !== F || t[187] !== Oe || t[188] !== T
    ? ((Qt = Oe == null || F != null ? null : (0, Y.jsx)(ot, { comment: Oe, layer: T })),
      (t[186] = F),
      (t[187] = Oe),
      (t[188] = T),
      (t[189] = Qt))
  ...
  t[190] !== E || t[191] !== F || t[192] !== k || t[193] !== v
    ...
    : ($t = t[194]);
  let en;
  t[195] !== He || t[196] !== E || t[197] !== X || t[198] !== v || t[199] !== O || t[200] !== w
    ? ((en =
        O != null && E == null
          ? (0, Y.jsxs)(Y.Fragment, {
              children: [
  ...
  t[205] !== E || t[206] !== D || t[207] !== o || t[208] !== v || t[209] !== w
    ? ((nn =
        E == null ? null : (0, Y.jsx)(st, { anchor: E, label: o, pageSize: D ?? v, zoomScale: w })),
      (t[205] = E),
      (t[206] = D),
      (t[207] = o),
      (t[208] = v),
...
function jt(e) {
  ...
  let {
    ...
    ce;
  t[7] === _.value ? (ce = t[8]) : ((ce = pe(_.value)), (t[7] = _.value), (t[8] = ce));
  let le = ce,
    de;
  t[9] === le ? (de = t[10]) : ((de = le ?? ge({ entrypoint: `home` })), (t[9] = le), (t[10] = de));
  let fe = de,
    E = f(se, fe),
    D;
  t[11] !== fe || t[12] !== _
  ...
  let O = D,
    ...
    A;
  t[14] !== E || t[15] !== l
    ? ((k = B(E, l).filter(Mt)), (A = Me(k)), (t[14] = E), (t[15] = l), (t[16] = k), (t[17] = A))
    : ((k = t[16]), (A = t[17]));
  let _e = A,
    {
      handleTouchCancel: j,
  ...
  t[28] === oe
    ? (H = t[29])
    : ((H = (0, Q.jsx)(`div`, { ref: oe, "aria-hidden": !0, className: `hidden` })),
      (t[28] = oe),
      (t[29] = H));
  let Pe;
  t[30] !== m ||
                ...
                m === `default` && !g
                  ? (0, Q.jsxs)(Q.Fragment, {
                      children: [
                        ...
                        (0, Q.jsx)(be, { hostId: o, onBeforeOpen: s, path: l, showLabel: !0 }),
                      ],
                    })
                  : null,
              ],
