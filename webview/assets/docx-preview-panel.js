...
import { i as Ae, r as je, t as R } from "./artifact-analytics.js";
import { a as Me, n as z, r as Ne } from "./artifact-annotation-comment.js";
import { n as B, t as Pe } from "./artifact-preview-status.js";
var V = e(() => {});
function Fe({ anchor: e, editorScale: t, layer: r, pageSize: i }) {
  return e.kind === `region` && e.selectionKind != null
    ? me({ editorScale: t, layer: r, pageSize: i, rect: e.rect })
    : n({
        editorScale: t,
        layer: r,
...
function U({ clientRects: e, pageElement: t, pageSize: n }) {
...
function Le({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = [];
  for (let i of Ue(e)) {
    let e = U({ clientRects: [i], pageElement: t, pageSize: n });
    e != null && r.push(e);
  }
  return r;
}
...
function Ye({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? (e.selectionKind == null ? k(e.rect) : W(e)) : e.point;
  return {
    sessionId:
      o.mode === `edit`
...
function at(e) {
  let t = (0, ct.c)(39),
    { comment: n, isSelected: r, onEdit: a, onPreviewChange: o, zoomScale: s } = e,
    c = ee(),
    l,
    u,
    d,
  ...
  if (t[0] !== n || t[1] !== c) {
    ...
    bb0: {
      ...
      let r;
      (t[10] === n ? (r = t[11]) : ((r = nt(n)), (t[10] = n), (t[11] = r)), (d = r));
      let i;
      (t[12] !== n.position.line || t[13] !== c
        ? ((i = c.formatMessage(
            {
        ...
        : (i = t[14]),
        (u = i),
        (p = l.kind === `region` ? k(l.rect) : l.point));
    }
    ((t[0] = n),
      (t[1] = c),
      (t[2] = l),
      ...
      (t[6] = p),
      (t[7] = m));
  } else ((l = t[2]), (u = t[3]), (d = t[4]), (f = t[5]), (p = t[6]), (m = t[7]));
  if (m !== Symbol.for(`react.early_return_sentinel`)) return m;
  let h = p,
    g;
  t[15] !== d || t[16] !== o
    ? ((g = () => o(d)), (t[15] = d), (t[16] = o), (t[17] = g))
    : (g = t[17]);
  let _ = g,
    v;
  t[18] === o ? (v = t[19]) : ((v = () => o(null)), (t[18] = o), (t[19] = v));
  let y = v,
    b;
  t[20] !== l || t[21] !== f
    ? ((b =
        l.kind === `region`
          ? l.selectionKind == null
            ? (0, q.jsx)(i, {
                pageSize: f,
                rect: l.rect,
  ...
  return (
    t[36] !== b || t[37] !== S
      ? ((te = (0, q.jsxs)(q.Fragment, { children: [b, S] })),
        (t[36] = b),
        (t[37] = S),
        (t[38] = te))
      : (te = t[38]),
...
function st(e) {
  let t = (0, ct.c)(18),
    { anchor: n, label: r, pageSize: a, zoomScale: o } = e;
  if (n.kind === `region`) {
    let e;
    t[0] !== n || t[1] !== a
      ? ((e =
      ...
      : (e = t[2]);
    let s;
    t[3] === n.rect ? (s = t[4]) : ((s = k(n.rect)), (t[3] = n.rect), (t[4] = s));
    let c;
    t[5] !== r || t[6] !== a || t[7] !== s || t[8] !== o
      ? ((c = (0, q.jsx)(w, {
          draft: !0,
    ...
    return (
      t[10] !== e || t[11] !== c
        ? ((l = (0, q.jsxs)(q.Fragment, { children: [e, c] })),
          (t[10] = e),
          (t[11] = c),
          (t[12] = l))
        : (l = t[12]),
  ...
  let s;
  return (
    t[13] !== n.point || t[14] !== r || t[15] !== a || t[16] !== o
      ? ((s = (0, q.jsx)(w, {
          draft: !0,
          draftTestId: `artifact-docx-comment-draft-marker`,
          label: r,
...
function ut({ pageElement: e, pageSize: t }) {
  ...
  let a = Array.from(i.getClientRects()),
    o = U({ clientRects: a, pageElement: e, pageSize: t });
  if (o == null) return null;
  let s = Le({ clientRects: a, pageElement: e, pageSize: t });
  return {
    askForEditAnchor: Re({ clientRects: a, pageElement: e, pageSize: t, selection: n }) ?? void 0,
...
function ft({
  ...
  let o = U({ clientRects: [a.element.getBoundingClientRect()], pageElement: t, pageSize: n });
  if (o == null) return null;
...
function Tt(e) {
  let t = (0, Ot.c)(244),
    ...
    [O, fe] = (0, J.useState)(null),
    [k, pe] = (0, J.useState)(null),
    [me, he] = (0, J.useState)(null),
    A = 1 / (Math.max(T, 2 ** -52) / 0.9),
    [_e, ve] = (0, J.useState)(``),
    ...
    Ee;
  if (t[0] !== n || t[1] !== v || t[2] !== b) {
    let e;
    (t[4] !== v || t[5] !== b
      ? ((e = (e) => e.localArtifactAnnotationContext?.path === b && Qe(e) === v),
        (t[4] = v),
        (t[5] = b),
        (t[6] = e))
      : (e = t[6]),
  ...
  let Oe = Ee,
    F;
  t[7] !== Oe || t[8] !== xe
    ? ((F = xe == null ? null : (Oe.find((e) => nt(e) === xe) ?? null)),
      (t[7] = Oe),
      (t[8] = xe),
      (t[9] = F))
    : (F = t[9]);
  let I = F,
    ...
    R,
    Me;
  t[10] !== Oe || t[11] !== D || t[12] !== O || t[13] !== N || t[14] !== y
    ? ((R = N == null ? null : (Oe.find((e) => nt(e) === N) ?? null)),
      (ke = R == null ? null : et(R)),
      (L = D ?? ke),
      (Me = D == null ? ((R == null ? null : ($e(R) ?? y)) ?? y) : (O ?? y)),
      (t[10] = Oe),
      (t[11] = D),
      (t[12] = O),
      (t[13] = N),
  ...
  let B = Ne,
    Pe;
  t[36] !== L || t[37] !== z || t[38] !== A || t[39] !== E
    ? ((Pe = L == null ? null : Fe({ anchor: L, editorScale: A, layer: E, pageSize: z })),
      (t[36] = L),
      (t[37] = z),
      (t[38] = A),
      (t[39] = E),
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ue = () => {
        (de(null), fe(null), pe(null), he(null), ve(``), P(null), Te(!1));
      }),
      (t[47] = Ue))
    : (Ue = t[47]);
  let We = Ue,
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((qe = () => {
        typeof window > `u` ||
          De({ animationFrameRef: le, animationWindow: window, editorWrapper: ce.current });
      }),
      (t[49] = qe))
    : (qe = t[49]);
  let Je = qe,
    rt;
  t[50] !== B || t[51] !== _e || t[52] !== we
    ? ((rt = () =>
        B == null
          ? !1
          : B.target.mode === `create` && _e.trim().length > 0
            ? we
              ? (We(), !0)
              : (Te(!0), Je(), !1)
            : (We(), !0)),
  ...
  let K = rt,
    ct;
  t[54] !== L || t[55] !== z || t[56] !== A || t[57] !== E
    ? ((ct = () => {
        if (L == null) return;
        let e = Fe({ anchor: L, editorScale: A, layer: E, pageSize: z });
        e != null && te(ce.current, e);
      }),
      (t[54] = L),
      (t[55] = z),
      (t[56] = A),
  ...
  t[59] !== q || t[60] !== H || t[61] !== E
    ...
    : (lt = t[62]);
  let ft;
  (t[63] !== z.height || t[64] !== z.width || t[65] !== A || t[66] !== H || t[67] !== E
    ? ((ft = [z.height, z.width, A, H, E]),
      (t[63] = z.height),
      (t[64] = z.width),
      (t[65] = A),
      (t[66] = H),
  ...
  t[69] !== E?.ownerDocument || t[70] !== K
    ? ((pt = (e) => {
        let t = e.target;
        (t instanceof Node && ce.current?.contains(t)) ||
          (e.preventDefault(),
          e.stopPropagation(),
          K() &&
  ...
  let mt = (0, J.useEffectEvent)(pt),
    ht;
  t[72] !== B?.target.mode || t[73] !== mt || t[74] !== s || t[75] !== E
    ? ((ht = () => {
        if (s || B?.target.mode !== `create` || E == null) return;
        let e = E.ownerDocument,
          t = (e) => {
            mt(e);
          };
      ...
      (t[76] = ht))
    : (ht = t[76]);
  let gt = B?.target.mode,
    _t;
  (t[77] !== s || t[78] !== E || t[79] !== gt
    ? ((_t = [gt, s, E]), (t[77] = s), (t[78] = E), (t[79] = gt), (t[80] = _t))
    : (_t = t[80]),
    (0, J.useEffect)(ht, _t));
  let vt;
  t[81] !== D || t[82] !== N || t[83] !== s || t[84] !== E || t[85] !== y || t[86] !== K
    ? ((vt = () => {
        if (s || E == null) return;
        let e = E.parentElement;
        if (e == null) return;
        let t = ut({ pageElement: e, pageSize: y });
        if (t == null) {
          pe(null);
          return;
        }
        ((D != null || N != null) && !K()) ||
          (pe(t), de(null), fe(null), ve(``), P(null), Se(null), Te(!1));
      }),
      (t[81] = D),
      (t[82] = N),
      (t[83] = s),
  ...
  let xt;
  (t[92] !== s || t[93] !== E
    ? ((xt = [s, E]), (t[92] = s), (t[93] = E), (t[94] = xt))
    : (xt = t[94]),
    (0, J.useEffect)(bt, xt));
  let St;
  t[95] !== D || t[96] !== N || t[97] !== s || t[98] !== E || t[99] !== y || t[100] !== K
    ? ((St = (e) => {
        if (s || E == null || e.defaultPrevented) return;
        let t = e.target;
  ...
  let Tt;
  (t[106] !== s || t[107] !== E
    ? ((Tt = [s, E]), (t[106] = s), (t[107] = E), (t[108] = Tt))
    : (Tt = t[108]),
    (0, J.useEffect)(wt, Tt));
  let At;
  t[109] !== s || t[110] !== E || t[111] !== y
    ? ((At = (e, t, n) => {
  ...
  let jt = At,
    Mt;
  t[113] !== s || t[114] !== y || t[115] !== ie || t[116] !== S || t[117] !== C
    ? ((Mt = (e, t) => {
        (je(
          ie,
  ...
  let X = Mt,
    Nt;
  t[119] !== D || t[120] !== N || t[121] !== X || t[122] !== y || t[123] !== k
    ? ((Nt = (e, t) => {
        if (D != null || N != null || !x(e)) return;
        let n = ut({ pageElement: t, pageSize: y }) ?? (k?.selectionKind === `text` ? null : k);
  ...
  let It;
  (t[129] !== s || t[130] !== E
    ? ((It = [s, E]), (t[129] = s), (t[130] = E), (t[131] = It))
    : (It = t[131]),
    (0, J.useEffect)(Ft, It));
  let Lt;
  ...
  let Bt = zt,
    Vt;
  t[140] !== D || t[141] !== j || t[142] !== N || t[143] !== jt || t[144] !== y
    ? ((Vt = (e) => {
        if (j == null) {
          if (D != null || N != null) {
            he(null);
  ...
  t[152] !== K
    ? ((Ut = (e) => {
        ...
        (X(i, `annotation_mode_pointer`), M(null));
      }),
      (t[146] = D),
      (t[147] = j),
      (t[148] = jt),
  ...
  t[154] !== jt || t[155] !== Rt
    ? ((Z = (e) => {
        if (ue.current) {
          ((ue.current = !1), e.preventDefault(), e.stopPropagation());
          return;
        }
        let t = jt(e.clientX, e.clientY, !0);
  ...
  t[171] !== w
    ? ((Q = (e, t) => {
        ...
        if (N != null) {
          ...
          (d((e) =>
            e.map((e) =>
              nt(e) === N ? { ...e, content: [{ content_type: `text`, text: a }] } : e,
            ),
          ),
            We());
          return;
        }
        if (D == null || a.length === 0) return;
        let c = Xe({ anchor: D, pageCount: _, pageNumber: v, pageSize: O ?? y }),
          u = re({
        ...
        (Ae(
          ...
          { artifactTabId: S, artifactType: `document`, importKind: `docx`, threadId: C },
          {
            ...
            annotationTargetKind: c.target.type,
  ...
  let Jt;
  t[175] === s ? (Jt = t[176]) : ((Jt = s ? { cursor: c } : void 0), (t[175] = s), (t[176] = Jt));
  let Yt, Xt;
      ...
      ? ((e = (e) =>
          (0, Y.jsx)(
            at,
            {
              ...
              isSelected: nt(e) === N,
              onEdit: (e) => {
                (de(null), fe(null), ve(``), Te(!1), Se(null), he(null), P(e));
              },
              onPreviewChange: Se,
              zoomScale: T,
            },
  ...
  let Qt;
  t[186] !== N || t[187] !== I || t[188] !== E
    ? ((Qt = I == null || N != null ? null : (0, Y.jsx)(ot, { comment: I, layer: E })),
      (t[186] = N),
      (t[187] = I),
      (t[188] = E),
      (t[189] = Qt))
    : (Qt = t[189]);
  let $t;
  t[190] !== D || t[191] !== N || t[192] !== me || t[193] !== y
    ? (($t =
        me != null && D == null && N == null
          ? (0, Y.jsx)(it, {
              paddingPx: 4,
              pageSize: y,
              rect: me.rect,
    ...
    : ($t = t[194]);
  let en;
  t[195] !== G || t[196] !== D || t[197] !== X || t[198] !== y || t[199] !== k || t[200] !== T
    ? ((en =
        k != null && D == null
          ? (0, Y.jsxs)(Y.Fragment, {
              children: [
  ...
  t[202] !== j || t[203] !== y
    ...
    : (tn = t[204]);
  let nn;
  t[205] !== D || t[206] !== O || t[207] !== l || t[208] !== y || t[209] !== T
    ? ((nn =
        D == null ? null : (0, Y.jsx)(st, { anchor: D, label: l, pageSize: O ?? y, zoomScale: T })),
      (t[205] = D),
      (t[206] = O),
      (t[207] = l),
      (t[208] = y),
          ...
          : (0, Y.jsx)(`div`, {
              ...
              children: (0, Y.jsx)(
                Ce,
                {
                  ...
                  onCancel: We,
                  onDelete: (e) => {
                    (d((t) => t.filter((t) => nt(t) !== e)), We());
                  },
                  onEscape: We,
                  onBodyChange: B.target.mode === `create` ? Ke : void 0,
...
function jt(e) {
  ...
  t[1] === v
    ...
    : ((C = (e) => {
        let t = y.current;
        t != null && zt(e, t, x, v) && (y.current = null);
      }),
      (t[1] = v),
      (t[2] = C));
  let w = C,
    re;
  t[3] !== n || t[4] !== _ || t[5] !== w
    ? ((re = { bytes: n, onPagesRendered: w, renderAsync: _ }),
      (t[3] = n),
      (t[4] = _),
      (t[5] = w),
      (t[6] = re))
    : (re = t[6]);
  let {
      bodyContainerElementRef: T,
      bodyContainerRef: E,
      loadState: se,
      pageElements: le,
      styleContainerRef: ue,
      totalPages: D,
    } = X(re),
    de;
  t[7] === ee.value ? (de = t[8]) : ((de = _e(ee.value)), (t[7] = ee.value), (t[8] = de));
  let O = de,
    fe;
  t[9] === O ? (fe = t[10]) : ((fe = O ?? N({ entrypoint: `home` })), (t[9] = O), (t[10] = fe));
  let k = fe,
    pe = ce(Oe, k),
    me;
  t[11] !== k || t[12] !== ee
  ...
  (t[21] === Ae
    ? ((je = t[22]), (R = t[23]))
    : ((je = () => ({ navigateToPage: Ae })), (R = [Ae]), (t[21] = Ae), (t[22] = je), (t[23] = R)),
    (0, Z.useImperativeHandle)(u, je, R));
  let Me, Pe;
  (t[24] !== l || t[25] !== A
    ? ((Me = () => () => {
        (te(),
  ...
  t[28] === ue
    ? (V = t[29])
    : ((V = (0, Q.jsx)(`div`, { ref: ue, "aria-hidden": !0, className: `hidden` })),
      (t[28] = ue),
      (t[29] = V));
  let Fe;
  t[30] !== m ||
            ...
            rightContent: (0, Q.jsxs)(`div`, {
              ...
              children: [
                (0, Q.jsx)(he, {
                  ...
                  fitOption: { selected: Ce, onSelect: Se },
                }),
                m === `default` && !g
                  ? (0, Q.jsxs)(Q.Fragment, {
                      children: [
                        (0, Q.jsx)(ie, { hostId: o, path: l }),
                        (0, Q.jsx)(s, { hostId: o, onBeforeOpen: c, path: l, showLabel: !0 }),
                      ],
                    })
                  : null,
              ],
  ...
  let H;
  t[42] !== E || t[43] !== Te
    ? ((H = ke(E, Te)), (t[42] = E), (t[43] = Te), (t[44] = H))
    : (H = t[44]);
  let Ie = I ? Kt : `hidden`,
    U;
  t[45] !== ye ||
  ...
  t[72] !== F
    ...
    : (Le = t[73]);
  let W;
  t[74] === se ? (W = t[75]) : ((W = B(se)), (t[74] = se), (t[75] = W));
  let Re;
  return (
    t[76] !== V || t[77] !== Fe || t[78] !== U || t[79] !== Le || t[80] !== W
      ? ((Re = (0, Q.jsxs)(`section`, {
          className: `flex h-full min-h-0 flex-col bg-token-side-bar-background`,
          children: [V, Fe, U, Le, W],
        })),
        (t[76] = V),
        (t[77] = Fe),
        (t[78] = U),
...
function X(e) {
  ...
  let C = te,
    w;
  return (
    t[11] !== l || t[12] !== f || t[13] !== S || t[14] !== C || t[15] !== m
      ? ((w = {
  ...
  return {
    ...
    handleWheel: (e) => {
      e.ctrlKey &&
        ...
        a((t) => ({
          kind: `percentage`,
          zoomPercent: f(t.kind === `percentage` ? t.zoomPercent : o, e.deltaY),
        })));
    },
