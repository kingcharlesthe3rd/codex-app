const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./docx-preview.js", "./chunk-Bj-mKKzh.js"]),
) => i.map((i) => d[i]);
import { s as e } from "./chunk-Bj-mKKzh.js";
import { Hr as t, Ur as n, Yr as r } from "./src-2.js";
...
import { F as l, f as u, lt as d } from "./vscode-api.js";
...
import "./arrow-up.js";
import { i as v, o as y, r as b } from "./browser-sidebar-comment-light-dismiss.js";
import "./sortBy.js";
...
import { n as x } from "./arrow-rotate-ccw.js";
...
import { n as O, r as ae } from "./artifact-annotation-comment.js";
import { t as k } from "./artifact-preview-status.js";
import {
  a as A,
  c as oe,
  d as se,
...
var pe = d(),
  me = e(c(), 1),
  L = e(a(), 1);
function he({ anchor: e, editorScale: t, layer: n, pageSize: r }) {
  return e.kind === `region` && e.selectionKind != null
    ? se({ editorScale: t, layer: n, pageSize: r, rect: e.rect })
    : j({
        editorScale: t,
        layer: n,
        markerPoint: e.kind === `region` ? F(e.rect) : e.point,
        pageSize: r,
      });
}
function ge(e, t) {
...
function _e({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = [];
  for (let i of Ce(e)) {
    let e = R({ clientRects: [i], pageElement: t, pageSize: n });
    e != null && r.push(e);
  }
  return r;
}
...
function z({ clientRects: e, pageElement: t, pageSize: n, selection: r }) {
...
function ye({ clientX: e, clientY: t, pageElement: n, pageSize: r }) {
...
function we({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? (e.selectionKind == null ? F(e.rect) : ve(e)) : e.point;
  return {
    sessionId:
      o.mode === `edit`
...
function Te({ anchor: e, pageCount: t, pageNumber: n, pageSize: r }) {
  return e.kind === `region`
    ? e.selectionKind == null
      ? {
          target: {
            type: `document-page-region`,
            anchorPoint: F(e.rect),
            pageCount: t,
            pageNumber: n,
            pageSize: r,
            rect: e.rect,
...
function je(e) {
  ...
  if (t[0] !== n || t[1] !== o) {
    ...
    bb0: {
      ...
      let e;
      if (
        (t[8] === n ? (e = t[9]) : ((e = Oe(n)), (t[8] = n), (t[9] = e)),
        (u = e),
        s == null || u == null)
      ) {
        p = null;
      ...
      let r;
      (t[10] === n ? (r = t[11]) : ((r = G(n)), (t[10] = n), (t[11] = r)), (l = r));
      let i;
      (t[12] !== n.position.line || t[13] !== o
        ...
        : (i = t[14]),
        (c = i),
        (d = s.kind === `region` ? F(s.rect) : s.point));
    }
    ((t[0] = n),
      (t[1] = o),
      (t[2] = s),
      ...
      (t[6] = d),
      (t[7] = p));
  } else ((s = t[2]), (c = t[3]), (l = t[4]), (u = t[5]), (d = t[6]), (p = t[7]));
...
function Me(e) {
  ...
  if (t[0] !== n) {
    ...
    bb0: {
      let e = ke(n);
      if (((i = Oe(n)), e == null || i == null)) {
        o = null;
        break bb0;
      }
      a = e.kind === `region` ? F(e.rect) : e.point;
    }
  ...
  let s = a,
    c;
  t[4] === n ? (c = t[5]) : ((c = G(n)), (t[4] = n), (t[5] = c));
  let l;
  t[6] === n ? (l = t[7]) : ((l = Ae(n)), (t[6] = n), (t[7] = l));
  let u;
  return (
...
function Ne(e) {
  ...
  if (n.kind === `region`) {
    ...
    t[0] !== n || t[1] !== i
      ...
      : (e = t[2]);
    let a;
    t[3] === n.rect ? (a = t[4]) : ((a = F(n.rect)), (t[3] = n.rect), (t[4] = a));
    let o;
    t[5] !== r || t[6] !== i || t[7] !== a
      ? ((o = (0, K.jsx)(A, {
          draft: !0,
...
function Fe({ pageElement: e, pageSize: t }) {
  ...
  if (n == null || n.isCollapsed || n.rangeCount === 0 || !He(n, e)) return null;
  let r = Ge(n.toString());
  if (r.length === 0) return null;
  let i = n.getRangeAt(0);
  if (!e.contains(i.commonAncestorContainer)) return null;
  let a = Array.from(i.getClientRects()),
    o = R({ clientRects: a, pageElement: e, pageSize: t });
  if (o == null) return null;
  let s = _e({ clientRects: a, pageElement: e, pageSize: t }),
    c = z({ clientRects: a, pageElement: e, pageSize: t, selection: n });
  return {
...
function J({
  ...
  let o = R({ clientRects: [a.element.getBoundingClientRect()], pageElement: t, pageSize: n });
  if (o == null) return null;
  let s = e ? Ue(a.element) : ``,
    c = e ? Y({ element: a.element, nearbyText: s, selectionKind: a.selectionKind }) : null,
    l =
...
function Ue(e) {
  let t = [];
  return (We(e, t), Ge(t.join(` `)));
}
function We(e, t) {
  if (e.nodeType === Node.TEXT_NODE) {
    let n = Ge(e.textContent ?? ``);
    n.length > 0 && t.push(n);
    return;
  }
  for (let n of e.childNodes) We(n, t);
}
function Ge(e) {
...
function qe(e) {
  let n = (0, pe.c)(230),
    ...
    C = ee === void 0 ? 1 : ee,
    w = f(),
    [T, te] = (0, L.useState)(null),
    ne = (0, L.useRef)(null),
    re = (0, L.useRef)(null),
    ie = (0, L.useRef)(!1),
    [E, D] = (0, L.useState)(null),
    [O, ae] = (0, L.useState)(null),
    [k, A] = (0, L.useState)(null),
    [se, j] = (0, L.useState)(null),
    M = 1 / Math.max(C, 2 ** -52),
    [N, F] = (0, L.useState)(``),
    [I, me] = (0, L.useState)(null),
    [R, _e] = (0, L.useState)(null),
    [ve, z] = (0, L.useState)(null),
    [ye, B] = (0, L.useState)(!1),
    Ce;
  if (n[0] !== r || n[1] !== _ || n[2] !== x) {
    let e;
    (n[4] !== _ || n[5] !== x
      ? ((e = (e) => e.localArtifactAnnotationContext?.path === x && De(e) === _),
        (n[4] = _),
        (n[5] = x),
        (n[6] = e))
      : (e = n[6]),
  ...
  let V = Ce,
    H;
  n[7] !== V || n[8] !== ve
    ? ((H = ve == null ? null : (V.find((e) => G(e) === ve) ?? null)),
      (n[7] = V),
      (n[8] = ve),
      (n[9] = H))
    : (H = n[9]);
  let U = H,
    ...
    J,
    Le;
  n[10] !== V || n[11] !== E || n[12] !== O || n[13] !== R || n[14] !== y
    ? ((J = R == null ? null : (V.find((e) => G(e) === R) ?? null)),
      (Pe = J == null ? null : ke(J)),
      (W = E ?? Pe),
      (Le = E == null ? ((J == null ? null : (Oe(J) ?? y)) ?? y) : (O ?? y)),
      (n[10] = V),
      (n[11] = E),
      (n[12] = O),
      (n[13] = R),
  ...
  let X = Re,
    ze;
  n[36] !== W || n[37] !== Y || n[38] !== M || n[39] !== T
    ? ((ze = W == null ? null : he({ anchor: W, editorScale: M, layer: T, pageSize: Y })),
      (n[36] = W),
      (n[37] = Y),
      (n[38] = M),
      (n[39] = T),
  ...
  n[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((qe = () => {
        (D(null), ae(null), A(null), j(null), F(``), _e(null), B(!1));
      }),
      (n[45] = qe))
    : (qe = n[45]);
  let Z = qe,
  ...
  n[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Qe = () => {
        typeof window > `u` ||
          b({ animationFrameRef: re, animationWindow: window, editorWrapper: ne.current });
      }),
      (n[47] = Qe))
    : (Qe = n[47]);
  let $e = Qe,
    et;
  n[48] !== X || n[49] !== N || n[50] !== ye
    ? ((et = () =>
        X == null
          ? !1
  ...
  let Q = et,
    tt;
  n[52] !== W || n[53] !== Y || n[54] !== M || n[55] !== T
    ? ((tt = () => {
        if (W == null) return;
        let e = he({ anchor: W, editorScale: M, layer: T, pageSize: Y });
        e != null && fe(ne.current, e);
      }),
      (n[52] = W),
      (n[53] = Y),
      (n[54] = M),
      ...
      (n[56] = tt))
    : (tt = n[56]);
  let nt = (0, L.useEffectEvent)(tt),
    rt;
  n[57] !== nt || n[58] !== Ve || n[59] !== T
    ? ((rt = () => {
        if (!Ve || T == null) return;
    ...
    : (rt = n[60]);
  let it;
  (n[61] !== Y.height || n[62] !== Y.width || n[63] !== M || n[64] !== Ve || n[65] !== T
  ...
  n[67] !== T?.ownerDocument || n[68] !== Q
    ? ((at = (e) => {
      ...
      (n[67] = T?.ownerDocument),
      (n[68] = Q),
      (n[69] = at))
    : (at = n[69]);
  let ot = (0, L.useEffectEvent)(at),
    st;
  n[70] !== X?.target.mode || n[71] !== ot || n[72] !== a || n[73] !== T
    ? ((st = () => {
        if (a || X?.target.mode !== `create` || T == null) return;
        let e = T.ownerDocument,
          t = (e) => {
            ot(e);
          };
  ...
  let ct = X?.target.mode,
    lt;
  (n[75] !== a || n[76] !== T || n[77] !== ct
    ? ((lt = [ct, a, T]), (n[75] = a), (n[76] = T), (n[77] = ct), (n[78] = lt))
    : (lt = n[78]),
    (0, L.useEffect)(st, lt));
  let ut;
  n[79] !== E || n[80] !== R || n[81] !== a || n[82] !== T || n[83] !== y || n[84] !== Q
    ? ((ut = () => {
        if (a || T == null) return;
        let e = T.parentElement;
        if (e == null) return;
        let t = Fe({ pageElement: e, pageSize: y });
        if (t == null) {
          A(null);
          return;
        }
        ((E != null || R != null) && !Q()) ||
          (A(t), D(null), ae(null), F(``), _e(null), z(null), B(!1));
      }),
      (n[79] = E),
      (n[80] = R),
      (n[81] = a),
      ...
      (n[85] = ut))
    : (ut = n[85]);
  let dt = (0, L.useEffectEvent)(ut),
    ft;
  n[86] !== a || n[87] !== T || n[88] !== dt
    ? ((ft = () => {
        if (T == null || a) return;
        let e = T.parentElement;
        if (e == null) return;
  ...
  let pt;
  (n[90] !== a || n[91] !== T
    ? ((pt = [a, T]), (n[90] = a), (n[91] = T), (n[92] = pt))
    : (pt = n[92]),
    (0, L.useEffect)(ft, pt));
  let mt;
  n[93] !== E || n[94] !== R || n[95] !== a || n[96] !== T || n[97] !== y || n[98] !== Q
    ? ((mt = (e) => {
      ...
      (n[99] = mt))
    : (mt = n[99]);
  let ht = (0, L.useEffectEvent)(mt),
    gt;
  n[100] !== a || n[101] !== T || n[102] !== ht
    ? ((gt = () => {
        if (T == null || a) return;
        let e = T.parentElement;
        if (e == null) return;
  ...
  let _t;
  (n[104] !== a || n[105] !== T
    ? ((_t = [a, T]), (n[104] = a), (n[105] = T), (n[106] = _t))
    : (_t = n[106]),
    (0, L.useEffect)(gt, _t));
  let vt;
  n[107] !== a || n[108] !== T || n[109] !== y
    ? ((vt = (e, t, n) => {
  ...
  n[111] === y
    ? (bt = n[112])
    : ((bt = (e) => {
        (D(e), ae(y), A(null), j(null), F(``), _e(null), z(null), B(!1));
      }),
      (n[111] = y),
      (n[112] = bt));
  let $ = bt,
    xt;
  n[113] !== E || n[114] !== R || n[115] !== $ || n[116] !== y || n[117] !== k
    ? ((xt = (e, t) => {
        if (E != null || R != null || !le(e)) return;
        let n = Fe({ pageElement: t, pageSize: y }) ?? (k?.selectionKind === `text` ? null : k);
      ...
      (n[118] = xt))
    : (xt = n[118]);
  let St = (0, L.useEffectEvent)(xt),
    Ct;
  n[119] !== a || n[120] !== T || n[121] !== St
    ? ((Ct = () => {
        if (T == null || a) return;
        let e = T.parentElement;
        if (e == null) return;
  ...
  let wt;
  (n[123] !== a || n[124] !== T
    ? ((wt = [a, T]), (n[123] = a), (n[124] = T), (n[125] = wt))
    : (wt = n[125]),
    (0, L.useEffect)(Ct, wt));
  let Tt;
  n[126] !== E || n[127] !== R || n[128] !== $ || n[129] !== Q
    ? ((Tt = (e) => {
        ((E != null || R != null) && !Q()) || $(e);
      }),
      (n[126] = E),
  ...
  let Ot = Dt,
    kt;
  n[134] !== E || n[135] !== I || n[136] !== R || n[137] !== yt || n[138] !== y
    ? ((kt = (e) => {
        if (I == null) {
          if (E != null || R != null) {
            j(null);
  ...
  n[146] !== Q
    ? ((jt = (e) => {
        if (I == null || e.pointerId !== I.pointerId) return;
        let t = ge(e, y) ?? I.current;
        (e.preventDefault(),
          e.stopPropagation(),
          e.currentTarget.hasPointerCapture(e.pointerId) &&
            e.currentTarget.releasePointerCapture(e.pointerId));
        let n = { ...I, current: t, clientCurrent: { x: e.clientX, y: e.clientY } },
          r = be(n),
          i = xe(n, r);
        if (((ie.current = r), !r)) {
          let t = yt(e.clientX, e.clientY, !0);
          if (t != null) {
            ((ie.current = !0), me(null), Et(t));
            return;
          }
        }
  ...
  n[161] !== S
    ? ((Ft = (e, n) => {
        let { submitDirectly: r } = n === void 0 ? {} : n,
          a = r === void 0 ? !1 : r,
          s = e.body.trim();
        if (R != null) {
          if (s.length === 0) return;
          (c((e) =>
            e.map((e) => (G(e) === R ? { ...e, content: [{ content_type: `text`, text: s }] } : e)),
          ),
            Z());
          return;
        }
        if (E == null || s.length === 0) return;
        let l = t({
          artifactKind: `document`,
          body: s,
          label: Ee(E, _),
          line: o,
          metadata: Te({ anchor: E, pageCount: g, pageNumber: _, pageSize: O ?? y }),
          path: x,
          title: S,
        });
        (a
    ...
    : (Ft = n[162]);
  let It = Ft,
    Lt = a ? `pointer-events-auto` : `pointer-events-none`,
    Rt;
  n[163] === Lt
    ? (Rt = n[164])
    : ((Rt = s(`absolute inset-0 z-[3]`, Lt)), (n[163] = Lt), (n[164] = Rt));
  let zt;
  n[165] === a ? (zt = n[166]) : ((zt = a ? { cursor: oe } : void 0), (n[165] = a), (n[166] = zt));
  let Bt, Vt;
  n[167] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Bt = () => {
        (me(null), j(null));
      }),
      (Vt = () => j(null)),
      ...
      : ((e = (e) =>
          (0, K.jsx)(
            je,
            {
              ...
              isSelected: G(e) === R,
              onEdit: (e) => {
                (D(null), ae(null), F(``), B(!1), z(null), j(null), _e(e));
              },
              onPreviewChange: z,
            },
            G(e),
  ...
  let Ut;
  n[174] !== R || n[175] !== U || n[176] !== T
    ? ((Ut = U == null || R != null ? null : (0, K.jsx)(Me, { comment: U, layer: T })),
      (n[174] = R),
      (n[175] = U),
      (n[176] = T),
      (n[177] = Ut))
    : (Ut = n[177]);
  let Wt;
  n[178] !== E || n[179] !== R || n[180] !== se || n[181] !== y
    ? ((Wt =
        se != null && E == null && R == null
          ? (0, K.jsx)(q, {
              paddingPx: 4,
              pageSize: y,
              rect: se.rect,
    ...
    : (Wt = n[182]);
  let Gt;
  n[183] !== Ge || n[184] !== E || n[185] !== $ || n[186] !== y || n[187] !== k || n[188] !== C
    ? ((Gt =
        k != null && E == null
          ? (0, K.jsxs)(K.Fragment, {
              children: [
  ...
  n[190] !== I || n[191] !== y
    ...
    : (Kt = n[192]);
  let qt;
  n[193] !== E || n[194] !== O || n[195] !== o || n[196] !== y
    ? ((qt = E == null ? null : (0, K.jsx)(Ne, { anchor: E, label: o, pageSize: O ?? y })),
      (n[193] = E),
      (n[194] = O),
      (n[195] = o),
      (n[196] = y),
...
function Q(e) {
  let t = (0, pe.c)(79),
    { annotationsEnabled: n, bytes: i, hostId: a, path: o, title: s } = e,
    c = n === void 0 ? !0 : n,
    u = f(),
    d = l(h),
    g = (0, L.use)(et),
    v;
  t[0] !== i || t[1] !== g
    ? ((v = { bytes: i, renderAsync: g }), (t[0] = i), (t[1] = g), (t[2] = v))
    : (v = t[2]);
  let {
      bodyContainerElementRef: b,
      bodyContainerRef: S,
      loadState: C,
      pageElements: w,
  ...
  t[3] === d.value
    ? (A = t[4])
    : ((A = m(d.value) ?? r(`new-conversation`)), (t[3] = d.value), (t[4] = A));
  let oe = A,
    [se, j] = x(oe),
    [N, ce] = (0, L.useState)(!1),
    ...
    F;
  t[5] !== se || t[6] !== o
    ? ((P = O(se, o).filter(nt)), (F = ae(P)), (t[5] = se), (t[6] = o), (t[7] = P), (t[8] = F))
    : ((P = t[7]), (F = t[8]));
  let I = F,
    {
      handleTouchCancel: de,
      handleTouchEnd: fe,
      handleTouchMove: he,
      handleTouchStart: ge,
      handleWheel: R,
      fitToWidth: _e,
      isZoomToFitSelected: ve,
      previewStyle: z,
      resizeRef: ye,
      setZoomPercent: be,
      zoomPercent: xe,
    ...
    Se;
  t[9] !== b || t[10] !== D
    ? ((Se = { containerRef: b, pageSelector: $e, totalPages: D }),
      (t[9] = b),
      (t[10] = D),
      (t[11] = Se))
    : (Se = t[11]);
  let { currentPage: B, goToNextPage: Ce, goToPreviousPage: V } = M(Se),
    H = C === `ready`,
    U;
  t[12] === u
    ? (U = t[13])
  ...
  t[20] === te
    ? (Oe = t[21])
    : ((Oe = (0, K.jsx)(`div`, { ref: te, "aria-hidden": !0, className: `hidden` })),
      (t[20] = te),
      (t[21] = Oe));
  let ke;
  t[22] !== W ||
            ...
            rightContent: (0, K.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, K.jsx)(ee, {
                  ...
                  zoomPercent: xe,
                  zoomOptions: ie,
                  onZoomPercentChange: be,
                  fitOption: { selected: ve, onSelect: _e },
                }),
                (0, K.jsx)(E, { hostId: a, path: o }),
                (0, K.jsx)(re, { hostId: a, path: o, showLabel: !0 }),
              ],
            }),
          })
        : null),
  ...
  let Ae;
  t[40] !== S || t[41] !== ye
    ? ((Ae = _(S, ye)), (t[40] = S), (t[41] = ye), (t[42] = Ae))
    : (Ae = t[42]);
  let G = H ? Xe : `hidden`,
    q;
  t[43] !== de ||
  ...
  t[69] !== xe
    ...
    : (je = t[70]);
  let Me;
  t[71] === C ? (Me = t[72]) : ((Me = k(C)), (t[71] = C), (t[72] = Me));
  let Ne;
  return (
    t[73] !== Oe || t[74] !== ke || t[75] !== q || t[76] !== je || t[77] !== Me
      ? ((Ne = (0, K.jsxs)(`section`, {
          className: `flex h-full min-h-0 flex-col bg-token-side-bar-background`,
          children: [Oe, ke, q, je, Me],
        })),
        (t[73] = Oe),
        (t[74] = ke),
        (t[75] = q),
...
function rt(e) {
  let t = (0, pe.c)(16),
    ...
    o = (0, L.useRef)(0),
    s = (0, L.useRef)(!1),
    [c, l] = (0, L.useState)(r == null ? `error` : `loading`),
    u;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((u = []), (t[0] = u)) : (u = t[0]);
  let [d, f] = (0, L.useState)(u),
    [p, m] = (0, L.useState)(0),
    h;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = () => {
        let e = i.current,
          t = a.current;
        e == null || t == null || (ot({ bodyContainer: e, styleContainer: t }), f([]), m(0));
      }),
      (t[1] = h))
    : (h = t[1]);
  let g = h,
  ...
  t[2] !== n || t[3] !== r
    ? ((_ = () => {
        ...
        ((o.current = c),
          l(`loading`),
          at({ bytes: n, bodyContainer: e, renderAsync: r, styleContainer: t }).then((n) => {
            if (o.current !== c) return;
            if (!n) {
              (ot({ bodyContainer: e, styleContainer: t }), l(`error`));
              return;
            }
            let r = lt(e);
...
function it(e) {
  let t = (0, L.useRef)(null),
    ...
    [i, a] = (0, L.useState)({ kind: `fit-width` }),
    o =
      i.kind === `fit-width`
        ? (ct({ bodyContainer: e.current, bodyContainerWidth: n, zoomPercent: Qe }) ?? Qe)
        : i.zoomPercent,
    s = g((e) => {
  ...
  return {
    fitToWidth: () => {
      let t = i.kind === `fit-width` ? null : ut(e.current);
      ct({ bodyContainer: e.current, bodyContainerWidth: n, zoomPercent: o }) != null &&
        (a({ kind: `fit-width` }),
        t != null &&
...
async function at({ bytes: e, bodyContainer: t, renderAsync: n, styleContainer: r }) {
  try {
    return (await n(e, t, r, { className: Z, renderAltChunks: !1, useBase64URL: !0 }), pt(r), !0);
  } catch {
    return !1;
  }
}
function ot({ bodyContainer: e, styleContainer: t }) {
  (e.replaceChildren(), t.replaceChildren());
}
function st(e) {
  return e.replace(/\.docx$/i, ``);
}
function ct({ bodyContainer: e, bodyContainerWidth: t, zoomPercent: n }) {
  if (e == null) return null;
  let r = e.querySelector($e);
...
function lt(e) {
  return Array.from(e.querySelectorAll($e));
}
function ut(e) {
  if (e == null) return null;
  let t = lt(e);
