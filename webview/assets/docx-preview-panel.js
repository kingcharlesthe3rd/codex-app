...
import "./isEqual.js";
import { Ir as s, Lr as c, Ur as l } from "./src-2.js";
import { t as u } from "./preload-helper.js";
import { t as d } from "./react-dom.js";
import { l as f } from "./lib.js";
...
import { i as h, t as g } from "./route-scope.js";
...
import { n as _ } from "./use-resize-observer.js";
import "./keyboard-modifier-state.js";
import { t as v } from "./use-merged-ref.js";
...
import { t as y } from "./use-diff-comments-BZ-Z0SS7.js";
import { r as b } from "./right-panel-composer-overlay-scroll-reserve.js";
import "./use-workspace-file-search.js";
import "./at-mention-list-2.js";
import "./mcp-capability-client.js";
import "./prompt-editor.js";
import { i as x, r as S } from "./browser-sidebar-comment-light-dismiss.js";
...
import { n as ne, r as re } from "./artifact-analytics.js";
import { n as ie, r as ae } from "./artifact-annotation-comment.js";
...
var he = e(d(), 1),
  ge = a(),
  F = e(t(), 1);
function _e({ anchor: e, editorScale: t, layer: n, pageSize: r }) {
  return e.kind === `region` && e.selectionKind != null
    ? j({ editorScale: t, layer: n, pageSize: r, rect: e.rect })
    : ce({
        editorScale: t,
        layer: n,
        markerPoint: e.kind === `region` ? N(e.rect) : e.point,
        pageSize: r,
      });
}
function ve(e, t) {
...
function L({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = [];
  for (let i of B(e)) {
    let e = I({ clientRects: [i], pageElement: t, pageSize: n });
    e != null && r.push(e);
  }
  return r;
}
function R(e) {
  return e.askForEditAnchor?.point ?? H(e.rect);
}
function ye({ clientRects: e, pageElement: t, pageSize: n, selection: r }) {
...
function be({ clientX: e, clientY: t, pageElement: n, pageSize: r }) {
...
function Te({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? (e.selectionKind == null ? N(e.rect) : R(e)) : e.point;
  return {
    sessionId:
      o.mode === `edit`
...
function Ee({ anchor: e, pageCount: t, pageNumber: n, pageSize: r }) {
  return e.kind === `region`
    ? e.selectionKind == null
      ? {
          target: {
            type: `document-page-region`,
            anchorPoint: N(e.rect),
            pageCount: t,
            pageNumber: n,
            pageSize: r,
            rect: e.rect,
...
function Ne(e) {
  ...
  if (t[0] !== n || t[1] !== s) {
    ...
    bb0: {
      ...
      let e;
      if (
        (t[8] === n ? (e = t[9]) : ((e = ke(n)), (t[8] = n), (t[9] = e)),
        (d = e),
        c == null || d == null)
      ) {
        m = null;
      ...
      let r;
      (t[10] === n ? (r = t[11]) : ((r = W(n)), (t[10] = n), (t[11] = r)), (u = r));
      let i;
      (t[12] !== n.position.line || t[13] !== s
        ...
        : (i = t[14]),
        (l = i),
        (p = c.kind === `region` ? N(c.rect) : c.point));
    }
    ((t[0] = n),
      (t[1] = s),
      (t[2] = c),
      ...
      (t[6] = p),
      (t[7] = m));
  } else ((c = t[2]), (l = t[3]), (u = t[4]), (d = t[5]), (p = t[6]), (m = t[7]));
  if (m !== Symbol.for(`react.early_return_sentinel`)) return m;
  let h = p,
    g;
  t[15] !== u || t[16] !== a
    ? ((g = () => a(u)), (t[15] = u), (t[16] = a), (t[17] = g))
    : (g = t[17]);
  let _ = g,
    v;
  t[18] === a ? (v = t[19]) : ((v = () => a(null)), (t[18] = a), (t[19] = v));
  let y = v,
    b;
  t[20] !== c || t[21] !== d
    ? ((b =
  ...
  return (
    t[36] !== b || t[37] !== S
      ? ((C = (0, G.jsxs)(G.Fragment, { children: [b, S] })), (t[36] = b), (t[37] = S), (t[38] = C))
      : (C = t[38]),
    C
  );
}
function Pe(e) {
  ...
  if (t[0] !== n) {
    ...
    bb0: {
      let e = Ae(n);
      if (((i = ke(n)), e == null || i == null)) {
        o = null;
        break bb0;
      }
      a = e.kind === `region` ? N(e.rect) : e.point;
    }
  ...
  let s = a,
    c;
  t[4] === n ? (c = t[5]) : ((c = W(n)), (t[4] = n), (t[5] = c));
  let l;
  t[6] === n ? (l = t[7]) : ((l = je(n)), (t[6] = n), (t[7] = l));
  let u;
  return (
...
function Fe(e) {
  ...
  if (n.kind === `region`) {
    ...
    t[0] !== n || t[1] !== i
      ...
      : (e = t[2]);
    let o;
    t[3] === n.rect ? (o = t[4]) : ((o = N(n.rect)), (t[3] = n.rect), (t[4] = o));
    let s;
    ...
    return (
      t[10] !== e || t[11] !== s
        ? ((c = (0, G.jsxs)(G.Fragment, { children: [e, s] })),
          (t[10] = e),
          (t[11] = s),
          (t[12] = c))
        : (c = t[12]),
...
function Ie(e) {
  ...
  if (i.selectionKind === `text`) {
    ...
    return (
      t[10] === o
        ? (s = t[11])
        : ((s = (0, G.jsx)(G.Fragment, { children: o })), (t[10] = o), (t[11] = s)),
      s
    );
  }
...
function Le({ pageElement: e, pageSize: t }) {
  let n = e.ownerDocument.getSelection();
  if (n == null || n.isCollapsed || n.rangeCount === 0 || !We(n, e)) return null;
  let r = X(n.toString());
  if (r.length === 0) return null;
  let i = n.getRangeAt(0);
  if (!e.contains(i.commonAncestorContainer)) return null;
  let a = Array.from(i.getClientRects()),
    o = I({ clientRects: a, pageElement: e, pageSize: t });
  if (o == null) return null;
  let s = L({ clientRects: a, pageElement: e, pageSize: t }),
    c = ye({ clientRects: a, pageElement: e, pageSize: t, selection: n });
  return {
...
function ze({
  ...
  let o = I({ clientRects: [a.element.getBoundingClientRect()], pageElement: t, pageSize: n });
  if (o == null) return null;
  let s = e ? Y(a.element) : ``,
    c = e ? Ve({ element: a.element, nearbyText: s, selectionKind: a.selectionKind }) : null,
    l =
...
function Y(e) {
  let t = [];
  return (Ge(e, t), X(t.join(` `)));
}
function Ge(e, t) {
  if (e.nodeType === Node.TEXT_NODE) {
    let n = X(e.textContent ?? ``);
    n.length > 0 && t.push(n);
    return;
  }
  for (let n of e.childNodes) Ge(n, t);
}
function X(e) {
...
function qe(e) {
  let t = (0, ge.c)(244),
    ...
    te = r(i),
    O = f(),
    [k, ie] = (0, F.useState)(null),
    ae = (0, F.useRef)(null),
    oe = (0, F.useRef)(null),
    A = (0, F.useRef)(!1),
    [j, ce] = (0, F.useState)(null),
    [M, N] = (0, F.useState)(null),
    [P, he] = (0, F.useState)(null),
    [I, L] = (0, F.useState)(null),
    R = 1 / (Math.max(D, 2 ** -52) / 0.9),
    [ye, be] = (0, F.useState)(``),
    [z, B] = (0, F.useState)(null),
    [V, H] = (0, F.useState)(null),
    [we, U] = (0, F.useState)(null),
    [Ie, ze] = (0, F.useState)(!1),
    Be;
  if (t[0] !== n || t[1] !== y || t[2] !== C) {
    let e;
    (t[4] !== y || t[5] !== C
      ? ((e = (e) => e.localArtifactAnnotationContext?.path === C && Oe(e) === y),
        (t[4] = y),
        (t[5] = C),
        (t[6] = e))
      : (e = t[6]),
  ...
  let Ve = Be,
    He;
  t[7] !== Ve || t[8] !== we
    ? ((He = we == null ? null : (Ve.find((e) => W(e) === we) ?? null)),
      (t[7] = Ve),
      (t[8] = we),
      (t[9] = He))
    : (He = t[9]);
  let Ue = He,
    ...
    J,
    We;
  t[10] !== Ve || t[11] !== j || t[12] !== M || t[13] !== V || t[14] !== b
    ? ((J = V == null ? null : (Ve.find((e) => W(e) === V) ?? null)),
      (q = J == null ? null : Ae(J)),
      (K = j ?? q),
      (We = j == null ? ((J == null ? null : (ke(J) ?? b)) ?? b) : (M ?? b)),
      (t[10] = Ve),
      (t[11] = j),
      (t[12] = M),
      (t[13] = V),
  ...
  let X = Ge,
    qe;
  t[36] !== K || t[37] !== Y || t[38] !== R || t[39] !== k
    ? ((qe = K == null ? null : _e({ anchor: K, editorScale: R, layer: k, pageSize: Y })),
      (t[36] = K),
      (t[37] = Y),
      (t[38] = R),
      (t[39] = k),
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((rt = () => {
        (ce(null), N(null), he(null), L(null), be(``), H(null), ze(!1));
      }),
      (t[47] = rt))
    : (rt = t[47]);
  let it = rt,
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = () => {
        typeof window > `u` ||
          S({ animationFrameRef: oe, animationWindow: window, editorWrapper: ae.current });
      }),
      (t[49] = st))
    : (st = t[49]);
  let ct = st,
    lt;
  t[50] !== X || t[51] !== ye || t[52] !== Ie
    ? ((lt = () =>
        X == null
          ? !1
          : X.target.mode === `create` && ye.trim().length > 0
            ? Ie
              ? (it(), !0)
              : (ze(!0), ct(), !1)
            : (it(), !0)),
  ...
  let Q = lt,
    ut;
  t[54] !== K || t[55] !== Y || t[56] !== R || t[57] !== k
    ? ((ut = () => {
        if (K == null) return;
        let e = _e({ anchor: K, editorScale: R, layer: k, pageSize: Y });
        e != null && me(ae.current, e);
      }),
      (t[54] = K),
      (t[55] = Y),
      (t[56] = R),
      ...
      (t[58] = ut))
    : (ut = t[58]);
  let dt = (0, F.useEffectEvent)(ut),
    ft;
  t[59] !== dt || t[60] !== Xe || t[61] !== k
    ? ((ft = () => {
        if (!Xe || k == null) return;
        let e = k.ownerDocument,
          t = e.defaultView,
          n = () => {
            dt();
          };
    ...
    : (ft = t[62]);
  let pt;
  (t[63] !== Y.height || t[64] !== Y.width || t[65] !== R || t[66] !== Xe || t[67] !== k
    ? ((pt = [Y.height, Y.width, R, Xe, k]),
      (t[63] = Y.height),
      (t[64] = Y.width),
      (t[65] = R),
      (t[66] = Xe),
  ...
  t[69] !== k?.ownerDocument || t[70] !== Q
    ? ((mt = (e) => {
        ...
        (t instanceof Node && ae.current?.contains(t)) ||
          ...
          e.stopPropagation(),
          Q() &&
            (t instanceof Node ? t.ownerDocument : k?.ownerDocument)
              ?.getSelection()
              ?.removeAllRanges());
      }),
      (t[69] = k?.ownerDocument),
      (t[70] = Q),
      (t[71] = mt))
    : (mt = t[71]);
  let ht = (0, F.useEffectEvent)(mt),
    gt;
  t[72] !== X?.target.mode || t[73] !== ht || t[74] !== c || t[75] !== k
    ? ((gt = () => {
        if (c || X?.target.mode !== `create` || k == null) return;
        let e = k.ownerDocument,
          t = (e) => {
            ht(e);
          };
      ...
      (t[76] = gt))
    : (gt = t[76]);
  let _t = X?.target.mode,
    vt;
  (t[77] !== c || t[78] !== k || t[79] !== _t
    ? ((vt = [_t, c, k]), (t[77] = c), (t[78] = k), (t[79] = _t), (t[80] = vt))
    : (vt = t[80]),
    (0, F.useEffect)(gt, vt));
  let yt;
  t[81] !== j || t[82] !== V || t[83] !== c || t[84] !== k || t[85] !== b || t[86] !== Q
    ? ((yt = () => {
        if (c || k == null) return;
        let e = k.parentElement;
        if (e == null) return;
        let t = Le({ pageElement: e, pageSize: b });
        if (t == null) {
          he(null);
          return;
        }
        ((j != null || V != null) && !Q()) ||
          (he(t), ce(null), N(null), be(``), H(null), U(null), ze(!1));
      }),
      (t[81] = j),
      (t[82] = V),
      (t[83] = c),
      ...
      (t[87] = yt))
    : (yt = t[87]);
  let bt = (0, F.useEffectEvent)(yt),
    xt;
  t[88] !== c || t[89] !== k || t[90] !== bt
    ? ((xt = () => {
        if (k == null || c) return;
        let e = k.parentElement;
        if (e == null) return;
  ...
  let St;
  (t[92] !== c || t[93] !== k
    ? ((St = [c, k]), (t[92] = c), (t[93] = k), (t[94] = St))
    : (St = t[94]),
    (0, F.useEffect)(xt, St));
  let Ct;
  t[95] !== j || t[96] !== V || t[97] !== c || t[98] !== k || t[99] !== b || t[100] !== Q
    ? ((Ct = (e) => {
        if (c || k == null || e.defaultPrevented) return;
        let t = e.target;
        if (t instanceof Node && k.contains(t)) return;
      ...
      (t[101] = Ct))
    : (Ct = t[101]);
  let wt = (0, F.useEffectEvent)(Ct),
    Tt;
  t[102] !== c || t[103] !== k || t[104] !== wt
    ? ((Tt = () => {
        if (k == null || c) return;
        let e = k.parentElement;
        if (e == null) return;
  ...
  let Et;
  (t[106] !== c || t[107] !== k
    ? ((Et = [c, k]), (t[106] = c), (t[107] = k), (t[108] = Et))
    : (Et = t[108]),
    (0, F.useEffect)(Tt, Et));
  let Dt;
  t[109] !== c || t[110] !== k || t[111] !== b
    ? ((Dt = (e, t, n) => {
  ...
  let Ot = Dt,
    kt;
  t[113] !== c || t[114] !== b || t[115] !== te || t[116] !== w || t[117] !== T
    ? ((kt = (e, t) => {
        (ne(
          te,
          { artifactTabId: w, artifactType: `document`, importKind: `docx`, threadId: T },
          { annotationModeEnabled: c, startSource: t },
        ),
          ce(e),
          N(b),
          he(null),
  ...
  let $ = kt,
    At;
  t[119] !== j || t[120] !== V || t[121] !== $ || t[122] !== b || t[123] !== P
    ? ((At = (e, t) => {
        if (j != null || V != null || !ue(e)) return;
        let n = Le({ pageElement: t, pageSize: b }) ?? (P?.selectionKind === `text` ? null : P);
        n != null && (e.preventDefault(), e.stopPropagation(), $(n, `ask_codex_shortcut`));
      }),
      (t[119] = j),
      (t[120] = V),
      (t[121] = $),
      ...
      (t[124] = At))
    : (At = t[124]);
  let jt = (0, F.useEffectEvent)(At),
    Mt;
  t[125] !== c || t[126] !== k || t[127] !== jt
    ? ((Mt = () => {
        if (k == null || c) return;
        let e = k.parentElement;
        if (e == null) return;
  ...
  let Nt;
  (t[129] !== c || t[130] !== k
    ? ((Nt = [c, k]), (t[129] = c), (t[130] = k), (t[131] = Nt))
    : (Nt = t[131]),
    (0, F.useEffect)(Mt, Nt));
  let Pt;
  t[132] !== j || t[133] !== V || t[134] !== $ || t[135] !== Q
    ? ((Pt = (e) => {
        ((j != null || V != null) && !Q()) || $(e, `annotation_mode_pointer`);
      }),
      (t[132] = j),
      (t[133] = V),
      (t[134] = $),
  ...
  t[137] !== c || t[138] !== b
    ? ((It = (e) => {
        if (!c || !e.isPrimary || e.pointerType === `touch` || e.button !== 0) return;
        let t = ve(e, b);
        t != null &&
          ((A.current = !1),
          e.preventDefault(),
  ...
  let Lt = It,
    Rt;
  t[140] !== j || t[141] !== z || t[142] !== V || t[143] !== Ot || t[144] !== b
    ? ((Rt = (e) => {
        if (z == null) {
          if (j != null || V != null) {
            L(null);
          ...
          L(Ot(e.clientX, e.clientY, !1));
          return;
        }
        if (e.pointerId !== z.pointerId) return;
        let t = ve(e, b);
        t != null &&
          (e.preventDefault(),
          e.stopPropagation(),
  ...
  t[152] !== Q
    ? ((Bt = (e) => {
        if (z == null || e.pointerId !== z.pointerId) return;
        let t = ve(e, b) ?? z.current;
        (e.preventDefault(),
          e.stopPropagation(),
          e.currentTarget.hasPointerCapture(e.pointerId) &&
            e.currentTarget.releasePointerCapture(e.pointerId));
        let n = { ...z, current: t, clientCurrent: { x: e.clientX, y: e.clientY } },
          r = xe(n),
          i = Se(n, r);
        if (((A.current = r), !r)) {
          let t = Ot(e.clientX, e.clientY, !0);
          if (t != null) {
            ((A.current = !0), B(null), Ft(t));
            return;
          }
        }
        if (j != null && i.kind === `point`) {
          (Q(), B(null));
          return;
        }
        ($(i, `annotation_mode_pointer`), B(null));
      }),
      (t[146] = j),
      (t[147] = z),
      (t[148] = Ot),
  ...
  t[154] !== Ot || t[155] !== Ft
    ? ((Ht = (e) => {
        if (A.current) {
          ((A.current = !1), e.preventDefault(), e.stopPropagation());
          return;
        }
        let t = Ot(e.clientX, e.clientY, !0);
        t != null && (e.preventDefault(), e.stopPropagation(), Ft(t));
      }),
      (t[154] = Ot),
      (t[155] = Ft),
      (t[156] = Ht))
  ...
  t[171] !== E
    ? ((Wt = (e, t) => {
        ...
        if (V != null) {
          ...
          (u((e) =>
            e.map((e) => (W(e) === V ? { ...e, content: [{ content_type: `text`, text: i }] } : e)),
          ),
            it());
          return;
        }
        if (j == null || i.length === 0) return;
        let d = Ee({ anchor: j, pageCount: v, pageNumber: y, pageSize: M ?? b }),
          f = s({
    ...
    : (Wt = t[172]);
  let Gt = Wt,
    Kt = c ? `pointer-events-auto` : `pointer-events-none`,
    qt;
  t[173] === Kt
    ? (qt = t[174])
    : ((qt = p(`absolute inset-0 z-[3]`, Kt)), (t[173] = Kt), (t[174] = qt));
  let Jt;
  t[175] === c ? (Jt = t[176]) : ((Jt = c ? { cursor: se } : void 0), (t[175] = c), (t[176] = Jt));
  let Yt, Xt;
      ...
      ? ((e = (e) =>
          (0, G.jsx)(
            Ne,
            {
              ...
              isSelected: W(e) === V,
              onEdit: (e) => {
                (ce(null), N(null), be(``), ze(!1), U(null), L(null), H(e));
              },
              onPreviewChange: U,
              zoomScale: D,
            },
  ...
  let Qt;
  t[186] !== V || t[187] !== Ue || t[188] !== k
    ? ((Qt = Ue == null || V != null ? null : (0, G.jsx)(Pe, { comment: Ue, layer: k })),
      (t[186] = V),
      (t[187] = Ue),
      (t[188] = k),
      (t[189] = Qt))
    : (Qt = t[189]);
  let $t;
  t[190] !== j || t[191] !== V || t[192] !== I || t[193] !== b
    ? (($t =
    ...
    : ($t = t[194]);
  let en;
  t[195] !== nt || t[196] !== j || t[197] !== $ || t[198] !== b || t[199] !== P || t[200] !== D
    ? ((en =
        P != null && j == null
          ? (0, G.jsxs)(G.Fragment, {
              children: [
                P.selectionKind === `text`
                  ? null
                  : (0, G.jsx)(Me, {
                      bordered: !0,
                      paddingPx: 4,
  ...
  t[202] !== z || t[203] !== b
    ...
    : (tn = t[204]);
  let nn;
  t[205] !== j || t[206] !== M || t[207] !== l || t[208] !== b || t[209] !== D
    ? ((nn =
        j == null ? null : (0, G.jsx)(Fe, { anchor: j, label: l, pageSize: M ?? b, zoomScale: D })),
      (t[205] = j),
      (t[206] = M),
      (t[207] = l),
      (t[208] = b),
          ...
          : (0, G.jsx)(`div`, {
              ...
              children: (0, G.jsx)(
                x,
                {
                  ...
                  onCancel: it,
                  onDelete: (e) => {
                    (u((t) => t.filter((t) => W(t) !== e)), it());
                  },
                  onEscape: it,
                  onBodyChange: X.target.mode === `create` ? ot : void 0,
                  onLightDismissibilityChange: Ke,
                  onMounted: Ke,
                  onDirectSubmit: (e) => {
                    Gt(e, { submitDirectly: !0 });
                  },
                  onSubmit: Gt,
                },
                X.sessionId,
...
var Z = `codex-docx-preview`,
  Xe = `h-full min-h-0 overflow-auto bg-token-side-bar-background overscroll-contain`,
  Ze = `
  .${Z}-wrapper {
    min-height: 100%;
    display: flex;
...
function nt(e) {
  let t = (0, ge.c)(76),
    { bytes: n, hostId: i, onBeforeOpen: a, path: o, ref: s, tabId: c, title: u } = e,
    d = r(g),
    f = (0, F.use)(tt),
    p = m(),
    _ = (0, F.useRef)(null),
  ...
  t[1] === p
    ...
    : ((w = (e) => {
        let t = _.current;
        t != null && ut(e, t, b, p) && (_.current = null);
      }),
      (t[1] = p),
      (t[2] = w));
  let T = w,
    E;
  t[3] !== n || t[4] !== f || t[5] !== T
    ? ((E = { bytes: n, onPagesRendered: T, renderAsync: f }),
      (t[3] = n),
      (t[4] = f),
      (t[5] = T),
      (t[6] = E))
  ...
  let {
      ...
      loadState: re,
      pageElements: A,
      styleContainerRef: se,
      totalPages: j,
    } = it(E),
    ce;
  t[7] === d.value ? (ce = t[8]) : ((ce = h(d.value)), (t[7] = d.value), (t[8] = ce));
  let M = ce,
    le;
  t[9] === M ? (le = t[10]) : ((le = M ?? l(`new-conversation`)), (t[9] = M), (t[10] = le));
  let ue = le,
    [de, fe] = y(ue),
    N,
    P;
  t[11] !== de || t[12] !== o
    ? ((N = ie(de, o).filter(rt)), (P = ae(N)), (t[11] = de), (t[12] = o), (t[13] = N), (t[14] = P))
    : ((N = t[13]), (P = t[14]));
  let pe = P,
    {
      handleTouchCancel: me,
      handleTouchEnd: _e,
      handleTouchMove: ve,
      handleTouchStart: I,
      handleWheel: L,
      fitToWidth: R,
      isZoomToFitSelected: ye,
      previewStyle: be,
      resizeRef: xe,
      setZoomPercent: Se,
      zoomPercent: Ce,
  ...
  (t[18] === V
    ? ((H = t[19]), (we = t[20]))
    : ((H = () => ({ navigateToPage: V })), (we = [V]), (t[18] = V), (t[19] = H), (t[20] = we)),
    (0, F.useImperativeHandle)(s, H, we));
  let U, Te;
  (t[21] !== o || t[22] !== fe
    ? ((U = () => () => {
        (S(),
          fe((e) => {
            let t = e.filter((e) => !pt(e, o));
  ...
  t[25] === se
    ? (Ee = t[26])
    : ((Ee = (0, G.jsx)(`div`, { ref: se, "aria-hidden": !0, className: `hidden` })),
      (t[25] = se),
      (t[26] = Ee));
  let De;
  t[27] !== R ||
            ...
            rightContent: (0, G.jsxs)(`div`, {
              ...
              children: [
                (0, G.jsx)(C, {
                  ...
                  fitOption: { selected: ye, onSelect: R },
                }),
                (0, G.jsx)(O, { hostId: i, path: o }),
                (0, G.jsx)(D, { hostId: i, onBeforeOpen: a, path: o, showLabel: !0 }),
              ],
            }),
          })
        : null),
  ...
  let Oe;
  t[37] !== ne || t[38] !== xe
    ? ((Oe = v(ne, xe)), (t[37] = ne), (t[38] = xe), (t[39] = Oe))
    : (Oe = t[39]);
  let ke = z ? Xe : `hidden`,
    Ae;
  t[40] !== me ||
  ...
  t[66] !== Ce
    ...
    : (je = t[67]);
  let W;
  t[68] === re ? (W = t[69]) : ((W = oe(re)), (t[68] = re), (t[69] = W));
  let Me;
  return (
    t[70] !== Ee || t[71] !== De || t[72] !== Ae || t[73] !== je || t[74] !== W
      ? ((Me = (0, G.jsxs)(`section`, {
          className: `flex h-full min-h-0 flex-col bg-token-side-bar-background`,
          children: [Ee, De, Ae, je, W],
        })),
        (t[70] = Ee),
        (t[71] = De),
        (t[72] = Ae),
...
function it(e) {
  let t = (0, ge.c)(17),
    ...
    s = (0, F.useRef)(0),
    c = (0, F.useRef)(!1),
    [l, u] = (0, F.useState)(i == null ? `error` : `loading`),
    d;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((d = []), (t[0] = d)) : (d = t[0]);
  let [f, p] = (0, F.useState)(d),
    [m, h] = (0, F.useState)(0),
    g;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = () => {
        let e = a.current,
          t = o.current;
        e == null || t == null || (st({ bodyContainer: e, styleContainer: t }), p([]), h(0));
      }),
      (t[1] = g))
    : (g = t[1]);
  let _ = g,
  ...
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((v = () => {
        ...
        ((s.current = l),
          u(`loading`),
          ot({ bytes: n, bodyContainer: e, renderAsync: i, styleContainer: t }).then((n) => {
            if (s.current !== l) return;
            if (!n) {
              (st({ bodyContainer: e, styleContainer: t }), u(`error`));
              return;
            }
            let i = Q(e);
  ...
  let T = w,
    E;
  return (
    t[11] !== l || t[12] !== f || t[13] !== C || t[14] !== T || t[15] !== m
      ? ((E = {
...
function at(e) {
  let t = (0, F.useRef)(null),
    ...
    [i, a] = (0, F.useState)({ kind: `fit-width` }),
    o =
      i.kind === `fit-width`
        ? (lt({ bodyContainer: e.current, bodyContainerWidth: n, zoomPercent: Qe }) ?? Qe)
        : i.zoomPercent,
    s = _((e) => {
  ...
  return {
    fitToWidth: () => {
      let t = i.kind === `fit-width` ? null : dt(e.current);
...
async function ot({ bytes: e, bodyContainer: t, renderAsync: n, styleContainer: r }) {
  try {
    return (await n(e, t, r, { className: Z, renderAltChunks: !1, useBase64URL: !0 }), mt(r), !0);
  } catch {
    return !1;
  }
}
function st({ bodyContainer: e, styleContainer: t }) {
...
function Q(e) {
  return Array.from(e.querySelectorAll(et));
}
function ut(e, t, n, r) {
...
function mt(e) {
  ...
  ((t.textContent = Ze), e.appendChild(t));
}
export { nt as DocxPreviewPanel };
