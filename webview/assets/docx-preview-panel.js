...
import "./isEqual.js";
import { Ar as o, Cr as s, wr as c } from "./src-1.js";
import { t as l } from "./preload-helper.js";
import { t as u } from "./react-dom.js";
import { c as d } from "./lib.js";
...
import { i as p, t as m } from "./route-scope.js";
...
import { t as g } from "./use-merged-ref.js";
...
import { t as _ } from "./use-diff-comments.js";
import { r as v } from "./right-panel-composer-overlay-scroll-reserve.js";
...
import { i as y, r as b } from "./browser-sidebar-comment-light-dismiss.js";
...
import { n as re, r as D } from "./artifact-annotation-comment.js";
import { t as ie } from "./artifact-preview-status.js";
import {
  a as O,
  c as ae,
  d as k,
...
function I(e, t) {
  ...
  return n.width <= 0 || n.height <= 0
    ? null
    : {
        x: H(((e.clientX - n.left) / n.width) * t.width, 0, t.width),
        y: H(((e.clientY - n.top) / n.height) * t.height, 0, t.height),
      };
}
function L({ clientRects: e, pageElement: t, pageSize: n }) {
  ...
  let a = H(((i.left - r.left) / r.width) * n.width, 0, n.width),
    o = H(((i.top - r.top) / r.height) * n.height, 0, n.height),
    s = H(((i.right - r.left) / r.width) * n.width, 0, n.width),
    c = H(((i.bottom - r.top) / r.height) * n.height, 0, n.height);
  return s <= a || c <= o ? null : { x: a, y: o, width: s - a, height: c - o };
}
function R({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = [];
  for (let i of U(e)) {
    let e = L({ clientRects: [i], pageElement: t, pageSize: n });
    e != null && r.push(e);
  }
  return r;
}
function z(e) {
  return e.askForEditAnchor?.point ?? _e(e.rect);
}
function B({ clientRects: e, pageElement: t, pageSize: n, selection: r }) {
...
function V({ clientX: e, clientY: t, pageElement: n, pageSize: r }) {
  let i = n.getBoundingClientRect();
  return {
    x: H(((e - i.left) / i.width) * r.width, 0, r.width),
    y: H(((t - i.top) / i.height) * r.height, 0, r.height),
  };
}
function me(e) {
  return (
...
function be({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? (e.selectionKind == null ? M(e.rect) : z(e)) : e.point;
  return {
    sessionId:
      o.mode === `edit`
...
function ke(e) {
  ...
  if (t[0] !== n || t[1] !== s) {
    ...
    bb0: {
      ...
      let e;
      if (
        (t[8] === n ? (e = t[9]) : ((e = we(n)), (t[8] = n), (t[9] = e)),
        (f = e),
        c == null || f == null)
      ) {
        m = null;
      ...
      let r;
      (t[10] === n ? (r = t[11]) : ((r = De(n)), (t[10] = n), (t[11] = r)), (u = r));
      let i;
      (t[12] !== n.position.line || t[13] !== s
        ...
        : (i = t[14]),
        (l = i),
        (p = c.kind === `region` ? M(c.rect) : c.point));
    }
    ((t[0] = n),
      (t[1] = s),
      (t[2] = c),
...
function Ae(e) {
  ...
  let s = a,
    c;
  t[4] === n ? (c = t[5]) : ((c = De(n)), (t[4] = n), (t[5] = c));
  let l;
  t[6] === n ? (l = t[7]) : ((l = Ee(n)), (t[6] = n), (t[7] = l));
  let u;
  return (
...
function je(e) {
  ...
  if (n.kind === `region`) {
    ...
    t[0] !== n || t[1] !== i
      ...
      : (e = t[2]);
    let o;
    t[3] === n.rect ? (o = t[4]) : ((o = M(n.rect)), (t[3] = n.rect), (t[4] = o));
    let s;
...
function Me({ pageElement: e, pageSize: t }) {
  let n = e.ownerDocument.getSelection();
  if (n == null || n.isCollapsed || n.rangeCount === 0 || !X(n, e)) return null;
  let r = Ve(n.toString());
  if (r.length === 0) return null;
  let i = n.getRangeAt(0);
  if (!e.contains(i.commonAncestorContainer)) return null;
  let a = Array.from(i.getClientRects()),
    o = L({ clientRects: a, pageElement: e, pageSize: t });
  if (o == null) return null;
  let s = R({ clientRects: a, pageElement: e, pageSize: t }),
    c = B({ clientRects: a, pageElement: e, pageSize: t, selection: n });
  return {
...
function Pe({
  ...
  let o = L({ clientRects: [a.element.getBoundingClientRect()], pageElement: t, pageSize: n });
  if (o == null) return null;
  let s = e ? ze(a.element) : ``,
    c = e ? q({ element: a.element, nearbyText: s, selectionKind: a.selectionKind }) : null,
    l =
...
function ze(e) {
  let t = [];
  return (Be(e, t), Ve(t.join(` `)));
}
function Be(e, t) {
  if (e.nodeType === Node.TEXT_NODE) {
    let n = Ve(e.textContent ?? ``);
    n.length > 0 && t.push(n);
    return;
  }
  for (let n of e.childNodes) Be(n, t);
}
function Ve(e) {
...
function Ue(e) {
  let t = (0, fe.c)(236),
    ...
    w = C === void 0 ? 1 : C,
    T = d(),
    [E, ee] = (0, F.useState)(null),
    te = (0, F.useRef)(null),
    ne = (0, F.useRef)(null),
    re = (0, F.useRef)(!1),
    [D, ie] = (0, F.useState)(null),
    [O, k] = (0, F.useState)(null),
    [A, j] = (0, F.useState)(null),
    [M, N] = (0, F.useState)(null),
    P = 1 / (Math.max(w, 2 ** -52) / 0.9),
    [L, R] = (0, F.useState)(``),
    [z, B] = (0, F.useState)(null),
    [V, H] = (0, F.useState)(null),
    [U, W] = (0, F.useState)(null),
    [_e, ve] = (0, F.useState)(!1),
    ye;
  if (t[0] !== n || t[1] !== _ || t[2] !== x) {
    let e;
    (t[4] !== _ || t[5] !== x
      ? ((e = (e) => e.localArtifactAnnotationContext?.path === x && Ce(e) === _),
        (t[4] = _),
        (t[5] = x),
        (t[6] = e))
      : (e = t[6]),
  ...
  let K = ye,
    Pe;
  t[7] !== K || t[8] !== U
    ? ((Pe = U == null ? null : (K.find((e) => De(e) === U) ?? null)),
      (t[7] = K),
      (t[8] = U),
      (t[9] = Pe))
    : (Pe = t[9]);
  let Fe = Pe,
    ...
    J,
    Le;
  t[10] !== K || t[11] !== D || t[12] !== O || t[13] !== V || t[14] !== v
    ? ((J = V == null ? null : (K.find((e) => De(e) === V) ?? null)),
      (Ie = J == null ? null : Te(J)),
      (q = D ?? Ie),
      (Le = D == null ? ((J == null ? null : (we(J) ?? v)) ?? v) : (O ?? v)),
      (t[10] = K),
      (t[11] = D),
      (t[12] = O),
      (t[13] = V),
  ...
  let X = Re,
    ze;
  t[36] !== q || t[37] !== Y || t[38] !== P || t[39] !== E
    ? ((ze = q == null ? null : pe({ anchor: q, editorScale: P, layer: E, pageSize: Y })),
      (t[36] = q),
      (t[37] = Y),
      (t[38] = P),
      (t[39] = E),
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Xe = () => {
        (ie(null), k(null), j(null), N(null), R(``), H(null), ve(!1));
      }),
      (t[47] = Xe))
    : (Xe = t[47]);
  let Ze = Xe,
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((et = () => {
        typeof window > `u` ||
          b({ animationFrameRef: ne, animationWindow: window, editorWrapper: te.current });
      }),
      (t[49] = et))
    : (et = t[49]);
  let tt = et,
    nt;
  t[50] !== X || t[51] !== L || t[52] !== _e
    ? ((nt = () =>
        X == null
          ? !1
          : X.target.mode === `create` && L.trim().length > 0
            ? _e
              ? (Ze(), !0)
              : (ve(!0), tt(), !1)
            : (Ze(), !0)),
  ...
  let Q = nt,
    rt;
  t[54] !== q || t[55] !== Y || t[56] !== P || t[57] !== E
    ? ((rt = () => {
        if (q == null) return;
        let e = pe({ anchor: q, editorScale: P, layer: E, pageSize: Y });
        e != null && de(te.current, e);
      }),
      (t[54] = q),
      (t[55] = Y),
      (t[56] = P),
      ...
      (t[58] = rt))
    : (rt = t[58]);
  let it = (0, F.useEffectEvent)(rt),
    at;
  t[59] !== it || t[60] !== Ve || t[61] !== E
    ? ((at = () => {
        if (!Ve || E == null) return;
    ...
    : (at = t[62]);
  let ot;
  (t[63] !== Y.height || t[64] !== Y.width || t[65] !== P || t[66] !== Ve || t[67] !== E
    ? ((ot = [Y.height, Y.width, P, Ve, E]),
      (t[63] = Y.height),
      (t[64] = Y.width),
      (t[65] = P),
      (t[66] = Ve),
  ...
  t[69] !== E?.ownerDocument || t[70] !== Q
    ? ((st = (e) => {
      ...
      (t[71] = st))
    : (st = t[71]);
  let ct = (0, F.useEffectEvent)(st),
    lt;
  t[72] !== X?.target.mode || t[73] !== ct || t[74] !== i || t[75] !== E
    ? ((lt = () => {
        if (i || X?.target.mode !== `create` || E == null) return;
        let e = E.ownerDocument,
          t = (e) => {
            ct(e);
          };
      ...
      (t[76] = lt))
    : (lt = t[76]);
  let ut = X?.target.mode,
    dt;
  (t[77] !== i || t[78] !== E || t[79] !== ut
    ? ((dt = [ut, i, E]), (t[77] = i), (t[78] = E), (t[79] = ut), (t[80] = dt))
    : (dt = t[80]),
    (0, F.useEffect)(lt, dt));
  let ft;
  t[81] !== D || t[82] !== V || t[83] !== i || t[84] !== E || t[85] !== v || t[86] !== Q
    ? ((ft = () => {
        if (i || E == null) return;
        let e = E.parentElement;
        if (e == null) return;
        let t = Me({ pageElement: e, pageSize: v });
        if (t == null) {
          j(null);
          return;
        }
        ((D != null || V != null) && !Q()) ||
          (j(t), ie(null), k(null), R(``), H(null), W(null), ve(!1));
      }),
      (t[81] = D),
      (t[82] = V),
      (t[83] = i),
      ...
      (t[87] = ft))
    : (ft = t[87]);
  let pt = (0, F.useEffectEvent)(ft),
    mt;
  t[88] !== i || t[89] !== E || t[90] !== pt
    ? ((mt = () => {
        if (E == null || i) return;
        let e = E.parentElement;
        if (e == null) return;
  ...
  let ht;
  (t[92] !== i || t[93] !== E
    ? ((ht = [i, E]), (t[92] = i), (t[93] = E), (t[94] = ht))
    : (ht = t[94]),
    (0, F.useEffect)(mt, ht));
  let gt;
  t[95] !== D || t[96] !== V || t[97] !== i || t[98] !== E || t[99] !== v || t[100] !== Q
    ? ((gt = (e) => {
        if (i || E == null || e.defaultPrevented) return;
        let t = e.target;
      ...
      (t[101] = gt))
    : (gt = t[101]);
  let _t = (0, F.useEffectEvent)(gt),
    vt;
  t[102] !== i || t[103] !== E || t[104] !== _t
    ? ((vt = () => {
        if (E == null || i) return;
        let e = E.parentElement;
        if (e == null) return;
  ...
  let yt;
  (t[106] !== i || t[107] !== E
    ? ((yt = [i, E]), (t[106] = i), (t[107] = E), (t[108] = yt))
    : (yt = t[108]),
    (0, F.useEffect)(vt, yt));
  let bt;
  ...
  t[113] === v
    ? (St = t[114])
    : ((St = (e) => {
        (ie(e), k(v), j(null), N(null), R(``), H(null), W(null), ve(!1));
      }),
      (t[113] = v),
      (t[114] = St));
  let $ = St,
    Ct;
  t[115] !== D || t[116] !== V || t[117] !== $ || t[118] !== v || t[119] !== A
    ? ((Ct = (e, t) => {
        if (D != null || V != null || !se(e)) return;
        let n = Me({ pageElement: t, pageSize: v }) ?? (A?.selectionKind === `text` ? null : A);
  ...
  let Et;
  (t[125] !== i || t[126] !== E
    ? ((Et = [i, E]), (t[125] = i), (t[126] = E), (t[127] = Et))
    : (Et = t[127]),
    (0, F.useEffect)(Tt, Et));
  let Dt;
  t[128] !== D || t[129] !== V || t[130] !== $ || t[131] !== Q
    ? ((Dt = (e) => {
        ((D != null || V != null) && !Q()) || $(e);
      }),
      (t[128] = D),
  ...
  let At = kt,
    jt;
  t[136] !== D || t[137] !== z || t[138] !== V || t[139] !== xt || t[140] !== v
    ? ((jt = (e) => {
        if (z == null) {
          if (D != null || V != null) {
            N(null);
  ...
  t[148] !== Q
    ? ((Nt = (e) => {
        ...
        let n = { ...z, current: t, clientCurrent: { x: e.clientX, y: e.clientY } },
          ...
          i = he(n, r);
        if (((re.current = r), !r)) {
          let t = xt(e.clientX, e.clientY, !0);
          if (t != null) {
            ((re.current = !0), B(null), Ot(t));
            return;
          }
        }
  ...
  t[150] !== xt || t[151] !== Ot
    ? ((Ft = (e) => {
        ...
        let t = xt(e.clientX, e.clientY, !0);
        t != null && (e.preventDefault(), e.stopPropagation(), Ot(t));
      }),
      (t[150] = xt),
      (t[151] = Ot),
      (t[152] = Ft))
  ...
  t[163] !== S
    ? ((Lt = (e, t) => {
        ...
        if (V != null) {
          ...
          (c((e) =>
            e.map((e) =>
              De(e) === V ? { ...e, content: [{ content_type: `text`, text: l }] } : e,
            ),
          ),
            Ze());
          return;
        }
        if (D == null || l.length === 0) return;
        let u = s({
          artifactKind: `document`,
          body: l,
          label: Se(D, _),
          line: o,
          metadata: xe({ anchor: D, pageCount: g, pageNumber: _, pageSize: O ?? v }),
          path: x,
          title: S,
        });
        (i
    ...
    : (Lt = t[164]);
  let Rt = Lt,
    zt = i ? `pointer-events-auto` : `pointer-events-none`,
    Bt;
  t[165] === zt
    ? (Bt = t[166])
    : ((Bt = f(`absolute inset-0 z-[3]`, zt)), (t[165] = zt), (t[166] = Bt));
  let Vt;
  t[167] === i ? (Vt = t[168]) : ((Vt = i ? { cursor: ae } : void 0), (t[167] = i), (t[168] = Vt));
  let Ht, Ut;
      ...
      ? ((e = (e) =>
          (0, G.jsx)(
            ke,
            {
              ...
              isSelected: De(e) === V,
              onEdit: (e) => {
                (ie(null), k(null), R(``), ve(!1), W(null), N(null), H(e));
              },
              onPreviewChange: W,
              zoomScale: w,
            },
  ...
  let Gt;
  t[178] !== V || t[179] !== Fe || t[180] !== E
    ? ((Gt = Fe == null || V != null ? null : (0, G.jsx)(Ae, { comment: Fe, layer: E })),
      (t[178] = V),
      (t[179] = Fe),
      (t[180] = E),
      (t[181] = Gt))
    : (Gt = t[181]);
  let Kt;
  t[182] !== D || t[183] !== V || t[184] !== M || t[185] !== v
    ? ((Kt =
        M != null && D == null && V == null
          ? (0, G.jsx)(Oe, {
              paddingPx: 4,
              pageSize: v,
              rect: M.rect,
    ...
    : (Kt = t[186]);
  let qt;
  t[187] !== Ye || t[188] !== D || t[189] !== $ || t[190] !== v || t[191] !== A || t[192] !== w
    ? ((qt =
        A != null && D == null
          ? (0, G.jsxs)(G.Fragment, {
              children: [
                A.selectionKind === `text`
                  ? null
                  : (0, G.jsx)(Oe, {
                      bordered: !0,
                      paddingPx: 4,
  ...
  t[194] !== z || t[195] !== v
    ...
    : (Jt = t[196]);
  let Yt;
  t[197] !== D || t[198] !== O || t[199] !== o || t[200] !== v || t[201] !== w
    ? ((Yt =
        D == null ? null : (0, G.jsx)(je, { anchor: D, label: o, pageSize: O ?? v, zoomScale: w })),
      (t[197] = D),
      (t[198] = O),
      (t[199] = o),
      (t[200] = v),
          ...
          : (0, G.jsx)(`div`, {
              ...
              children: (0, G.jsx)(
                y,
                {
                  ...
                  onCancel: Ze,
                  onDelete: (e) => {
                    (c((t) => t.filter((t) => De(t) !== e)), Ze());
                  },
                  onEscape: Ze,
                  onBodyChange: X.target.mode === `create` ? $e : void 0,
                  onLightDismissibilityChange: He,
                  onMounted: He,
                  onDirectSubmit: (e) => {
                    Rt(e, { submitDirectly: !0 });
                  },
                  onSubmit: Rt,
                },
                X.sessionId,
...
var Z = `codex-docx-preview`,
  Ke = `h-full min-h-0 overflow-auto bg-token-side-bar-background overscroll-contain`,
  qe = `
  .${Z}-wrapper {
    min-height: 100%;
    display: flex;
...
function Ze(e) {
  let t = (0, fe.c)(62),
    { bytes: n, hostId: r, onBeforeOpen: a, path: s, title: c } = e,
    l = i(m),
    u = (0, F.use)(Xe),
    d;
  t[0] !== n || t[1] !== u
    ? ((d = { bytes: n, renderAsync: u }), (t[0] = n), (t[1] = u), (t[2] = d))
    : (d = t[2]);
  let {
      bodyContainerElementRef: f,
      bodyContainerRef: h,
      loadState: v,
      pageElements: y,
      styleContainerRef: b,
  ...
  t[3] === l.value
    ? (C = t[4])
    : ((C = p(l.value) ?? o(`new-conversation`)), (t[3] = l.value), (t[4] = C));
  let w = C,
    [ne, O] = _(w),
    ae,
    k;
  t[5] !== ne || t[6] !== s
    ? ((ae = re(ne, s).filter(Qe)), (k = D(ae)), (t[5] = ne), (t[6] = s), (t[7] = ae), (t[8] = k))
    : ((ae = t[7]), (k = t[8]));
  let A = k,
    {
      handleTouchCancel: j,
  ...
  t[13] === b
    ? (B = t[14])
    : ((B = (0, G.jsx)(`div`, { ref: b, "aria-hidden": !0, className: `hidden` })),
      (t[13] = b),
      (t[14] = B));
  let V;
  t[15] !== M ||
            ...
            rightContent: (0, G.jsxs)(`div`, {
              ...
              children: [
                (0, G.jsx)(x, {
                  ...
                  zoomPercent: I,
                  zoomOptions: ee,
                  onZoomPercentChange: pe,
                  fitOption: { selected: N, onSelect: M },
                }),
                (0, G.jsx)(te, { hostId: r, path: s }),
                (0, G.jsx)(E, { hostId: r, onBeforeOpen: a, path: s, showLabel: !0 }),
              ],
            }),
          })
        : null),
  ...
  let me;
  t[25] !== h || t[26] !== de
    ? ((me = g(h, de)), (t[25] = h), (t[26] = de), (t[27] = me))
    : (me = t[27]);
  let he = L ? Ke : `hidden`,
    ge;
  t[28] !== j ||
  ...
  t[52] !== I
    ...
    : (H = t[53]);
  let U;
  t[54] === v ? (U = t[55]) : ((U = ie(v)), (t[54] = v), (t[55] = U));
  let W;
  return (
    t[56] !== ge || t[57] !== H || t[58] !== U || t[59] !== B || t[60] !== V
      ? ((W = (0, G.jsxs)(`section`, {
...
function $e(e) {
  let t = (0, fe.c)(16),
    ...
    o = (0, F.useRef)(0),
    s = (0, F.useRef)(!1),
    [c, l] = (0, F.useState)(r == null ? `error` : `loading`),
    u;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((u = []), (t[0] = u)) : (u = t[0]);
  let [d, f] = (0, F.useState)(u),
    [p, m] = (0, F.useState)(0),
    h;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = () => {
        let e = i.current,
          t = a.current;
        e == null || t == null || (nt({ bodyContainer: e, styleContainer: t }), f([]), m(0));
      }),
      (t[1] = h))
    : (h = t[1]);
  let g = h,
  ...
  t[2] !== n || t[3] !== r
    ? ((_ = () => {
        ...
        ((o.current = c),
          l(`loading`),
          tt({ bytes: n, bodyContainer: e, renderAsync: r, styleContainer: t }).then((n) => {
            if (o.current !== c) return;
            if (!n) {
              (nt({ bodyContainer: e, styleContainer: t }), l(`error`));
              return;
            }
            let r = it(e);
  ...
  let w = C,
    T;
  return (
    t[10] !== c || t[11] !== d || t[12] !== S || t[13] !== w || t[14] !== p
      ? ((T = {
...
function et(e) {
  let t = (0, F.useRef)(null),
    ...
    o =
      i.kind === `fit-width`
        ? (rt({ bodyContainer: e.current, bodyContainerWidth: n, zoomPercent: Je }) ?? Je)
        : i.zoomPercent,
    s = h((e) => {
    ...
    l = (e) => {
      a({ kind: `percentage`, zoomPercent: S(e) });
    };
  return {
    fitToWidth: () => {
      let t = i.kind === `fit-width` ? null : at(e.current);
      rt({ bodyContainer: e.current, bodyContainerWidth: n, zoomPercent: o }) != null &&
        (a({ kind: `fit-width` }),
        t != null &&
    ...
    handleWheel: (e) => {
      e.ctrlKey &&
        ...
        a((t) => ({
          kind: `percentage`,
          zoomPercent: ne(t.kind === `percentage` ? t.zoomPercent : o, e.deltaY),
        })));
    },
...
async function tt({ bytes: e, bodyContainer: t, renderAsync: n, styleContainer: r }) {
  try {
    return (await n(e, t, r, { className: Z, renderAltChunks: !1, useBase64URL: !0 }), ct(r), !0);
  } catch {
    return !1;
  }
}
function nt({ bodyContainer: e, styleContainer: t }) {
  (e.replaceChildren(), t.replaceChildren());
}
function Q(e) {
  return e.replace(/\.docx$/i, ``);
}
function rt({ bodyContainer: e, bodyContainerWidth: t, zoomPercent: n }) {
  if (e == null) return null;
  let r = e.querySelector(Ye);
  ...
  return !Number.isFinite(l) || l <= 0 ? null : S(Math.round((s / l) * 100));
}
function it(e) {
  return Array.from(e.querySelectorAll(Ye));
}
function at(e) {
  if (e == null) return null;
  let t = it(e);
...
function ct(e) {
  ...
  ((t.textContent = qe), e.appendChild(t));
}
export { Ze as DocxPreviewPanel };
