...
import { Gr as t, Kr as n, Qr as r } from "./src-2.js";
...
import { r as y } from "./right-panel-composer-overlay-scroll-reserve.js";
...
function ye({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = [];
  for (let i of B(e)) {
...
function L({ clientRects: e, pageElement: t, pageSize: n, selection: r }) {
...
function R({ clientX: e, clientY: t, pageElement: n, pageSize: r }) {
...
function Te({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? (e.selectionKind == null ? N(e.rect) : be(e)) : e.point;
  return {
    sessionId:
      o.mode === `edit`
...
function Me(e) {
  ...
  if (t[0] !== n || t[1] !== o) {
    ...
    bb0: {
      ...
      let r;
      (t[10] === n ? (r = t[11]) : ((r = W(n)), (t[10] = n), (t[11] = r)), (l = r));
      let i;
      (t[12] !== n.position.line || t[13] !== o
        ...
        : (i = t[14]),
        (c = i),
        (d = s.kind === `region` ? N(s.rect) : s.point));
    }
    ((t[0] = n),
      (t[1] = o),
      (t[2] = s),
  ...
  return (
    t[35] !== y || t[36] !== x
      ? ((S = (0, G.jsxs)(G.Fragment, { children: [y, x] })), (t[35] = y), (t[36] = x), (t[37] = S))
      : (S = t[37]),
    S
  );
}
...
function Pe(e) {
  ...
  if (n.kind === `region`) {
    ...
    t[0] !== n || t[1] !== i
      ...
      : (e = t[2]);
    let a;
    t[3] === n.rect ? (a = t[4]) : ((a = N(n.rect)), (t[3] = n.rect), (t[4] = a));
    let o;
    t[5] !== r || t[6] !== i || t[7] !== a
      ? ((o = (0, G.jsx)(A, {
          draft: !0,
    ...
    return (
      t[9] !== e || t[10] !== o
        ? ((s = (0, G.jsxs)(G.Fragment, { children: [e, o] })),
          (t[9] = e),
          (t[10] = o),
          (t[11] = s))
        : (s = t[11]),
...
function Fe({ pageElement: e, pageSize: t }) {
  ...
  let s = ye({ clientRects: a, pageElement: e, pageSize: t }),
    c = L({ clientRects: a, pageElement: e, pageSize: t, selection: n });
  return {
...
function qe(e) {
  let n = (0, he.c)(230),
    ...
    C = ee === void 0 ? 1 : ee,
    w = f(),
    [T, te] = (0, F.useState)(null),
    ne = (0, F.useRef)(null),
    re = (0, F.useRef)(null),
    ie = (0, F.useRef)(!1),
    [E, D] = (0, F.useState)(null),
    [O, ae] = (0, F.useState)(null),
    [k, A] = (0, F.useState)(null),
    [j, se] = (0, F.useState)(null),
    M = 1 / Math.max(C, 2 ** -52),
    [ce, N] = (0, F.useState)(``),
    [P, ge] = (0, F.useState)(null),
    [I, ye] = (0, F.useState)(null),
    [be, L] = (0, F.useState)(null),
    [R, z] = (0, F.useState)(!1),
    B;
  if (n[0] !== r || n[1] !== _ || n[2] !== y) {
    let e;
    (n[4] !== _ || n[5] !== y
      ? ((e = (e) => e.localArtifactAnnotationContext?.path === y && Oe(e) === _),
        (n[4] = _),
        (n[5] = y),
        (n[6] = e))
      : (e = n[6]),
  ...
  let V = B,
    we;
  n[7] !== V || n[8] !== be
    ? ((we = be == null ? null : (V.find((e) => W(e) === be) ?? null)),
      (n[7] = V),
      (n[8] = be),
      (n[9] = we))
    : (we = n[9]);
  let H = we,
    ...
    J,
    Le;
  n[10] !== V || n[11] !== E || n[12] !== O || n[13] !== I || n[14] !== v
    ? ((J = I == null ? null : (V.find((e) => W(e) === I) ?? null)),
      (q = J == null ? null : Ae(J)),
      (U = E ?? q),
      (Le = E == null ? ((J == null ? null : (ke(J) ?? v)) ?? v) : (O ?? v)),
      (n[10] = V),
      (n[11] = E),
      (n[12] = O),
      (n[13] = I),
  ...
  let X = Re,
    ze;
  n[36] !== U || n[37] !== Y || n[38] !== M || n[39] !== T
    ? ((ze = U == null ? null : _e({ anchor: U, editorScale: M, layer: T, pageSize: Y })),
      (n[36] = U),
      (n[37] = Y),
      (n[38] = M),
      (n[39] = T),
  ...
  n[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((qe = () => {
        (D(null), ae(null), A(null), se(null), N(``), ye(null), z(!1));
      }),
      (n[45] = qe))
    : (qe = n[45]);
  let Z = qe,
  ...
  let $e = Qe,
    et;
  n[48] !== X || n[49] !== ce || n[50] !== R
    ? ((et = () =>
        X == null
          ? !1
          : X.target.mode === `create` && ce.trim().length > 0
            ? R
              ? (Z(), !0)
              : (z(!0), $e(), !1)
            : (Z(), !0)),
  ...
  let Q = et,
    tt;
  n[52] !== U || n[53] !== Y || n[54] !== M || n[55] !== T
    ? ((tt = () => {
        if (U == null) return;
        let e = _e({ anchor: U, editorScale: M, layer: T, pageSize: Y });
        e != null && me(ne.current, e);
      }),
      (n[52] = U),
      (n[53] = Y),
      (n[54] = M),
  ...
  (n[75] !== a || n[76] !== T || n[77] !== ct
    ...
    (0, F.useEffect)(st, lt));
  let ut;
  n[79] !== E || n[80] !== I || n[81] !== a || n[82] !== T || n[83] !== v || n[84] !== Q
    ? ((ut = () => {
        if (a || T == null) return;
        let e = T.parentElement;
        if (e == null) return;
        let t = Fe({ pageElement: e, pageSize: v });
        if (t == null) {
          A(null);
          return;
        }
        ((E != null || I != null) && !Q()) ||
          (A(t), D(null), ae(null), N(``), ye(null), L(null), z(!1));
      }),
      (n[79] = E),
      (n[80] = I),
      (n[81] = a),
  ...
  (n[90] !== a || n[91] !== T
    ...
    (0, F.useEffect)(ft, pt));
  let mt;
  n[93] !== E || n[94] !== I || n[95] !== a || n[96] !== T || n[97] !== v || n[98] !== Q
    ? ((mt = (e) => {
  ...
  n[111] === v
    ? (bt = n[112])
    : ((bt = (e) => {
        (D(e), ae(v), A(null), se(null), N(``), ye(null), L(null), z(!1));
      }),
      (n[111] = v),
      (n[112] = bt));
  let $ = bt,
    xt;
  n[113] !== E || n[114] !== I || n[115] !== $ || n[116] !== v || n[117] !== k
    ? ((xt = (e, t) => {
        if (E != null || I != null || !ue(e)) return;
        let n = Fe({ pageElement: t, pageSize: v }) ?? (k?.selectionKind === `text` ? null : k);
  ...
  let Ot = Dt,
    kt;
  n[134] !== E || n[135] !== P || n[136] !== I || n[137] !== yt || n[138] !== v
    ? ((kt = (e) => {
        if (P == null) {
          if (E != null || I != null) {
            se(null);
  ...
  n[161] !== x
    ? ((Ft = (e, n) => {
        ...
        if (I != null) {
          ...
          (c((e) =>
            e.map((e) => (W(e) === I ? { ...e, content: [{ content_type: `text`, text: s }] } : e)),
          ),
            Z());
          return;
        }
        ...
        let l = t({
          ...
          label: De(E, _),
          line: o,
          metadata: Ee({ anchor: E, pageCount: g, pageNumber: _, pageSize: O ?? v }),
          path: y,
          title: x,
        });
        (a
      ...
      : ((e = (e) =>
          (0, G.jsx)(
            Me,
            {
              ...
              isSelected: W(e) === I,
              onEdit: (e) => {
                (D(null), ae(null), N(``), z(!1), L(null), se(null), ye(e));
              },
              onPreviewChange: L,
            },
            W(e),
  ...
  let Ut;
  n[174] !== I || n[175] !== H || n[176] !== T
    ? ((Ut = H == null || I != null ? null : (0, G.jsx)(Ne, { comment: H, layer: T })),
      (n[174] = I),
      (n[175] = H),
      (n[176] = T),
      (n[177] = Ut))
    : (Ut = n[177]);
  let Wt;
  n[178] !== E || n[179] !== I || n[180] !== j || n[181] !== v
    ? ((Wt =
        j != null && E == null && I == null
          ? (0, G.jsx)(K, {
              paddingPx: 4,
              pageSize: v,
              rect: j.rect,
    ...
    : (Wt = n[182]);
  let Gt;
  n[183] !== Ge || n[184] !== E || n[185] !== $ || n[186] !== v || n[187] !== k || n[188] !== C
    ? ((Gt =
        k != null && E == null
          ? (0, G.jsxs)(G.Fragment, {
              children: [
  ...
  n[190] !== P || n[191] !== v
    ...
    : (Kt = n[192]);
  let qt;
  n[193] !== E || n[194] !== O || n[195] !== o || n[196] !== v
    ? ((qt = E == null ? null : (0, G.jsx)(Pe, { anchor: E, label: o, pageSize: O ?? v })),
      (n[193] = E),
      (n[194] = O),
      (n[195] = o),
      (n[196] = v),
...
function Q(e) {
  let t = (0, he.c)(77),
    { bytes: n, hostId: i, path: a, title: o } = e,
    s = f(),
    c = l(h),
    u = (0, F.use)(et),
    d;
  ...
  t[3] === c.value
    ? (te = t[4])
    : ((te = m(c.value) ?? r(`new-conversation`)), (t[3] = c.value), (t[4] = te));
  let D = te,
    [A, oe] = v(D),
    [j, se] = (0, F.useState)(!1),
    ...
    de;
  t[5] !== A || t[6] !== a
    ? ((ue = O(A, a).filter(nt)), (de = ae(ue)), (t[5] = A), (t[6] = a), (t[7] = ue), (t[8] = de))
    : ((ue = t[7]), (de = t[8]));
  let fe = de,
    {
      handleTouchCancel: N,
    ...
    xe;
  t[9] !== g || t[10] !== w
    ? ((xe = { containerRef: g, pageSelector: $e, totalPages: w }),
      (t[9] = g),
      (t[10] = w),
      (t[11] = xe))
    : (xe = t[11]);
  let { currentPage: Se, goToNextPage: Ce, goToPreviousPage: z } = M(xe),
    B = b === `ready`,
    V;
  t[12] === s
    ? (V = t[13])
  ...
  t[20] === C
    ? (De = t[21])
    : ((De = (0, G.jsx)(`div`, { ref: C, "aria-hidden": !0, className: `hidden` })),
      (t[20] = C),
      (t[21] = De));
  let Oe;
  t[22] !== we ||
            ...
            rightContent: (0, G.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, G.jsx)(ee, {
                  ...
                  zoomPercent: R,
                  zoomOptions: ie,
                  onZoomPercentChange: L,
                  fitOption: { selected: I, onSelect: ve },
                }),
                (0, G.jsx)(E, { hostId: i, path: a }),
                (0, G.jsx)(re, { hostId: i, path: a, showLabel: !0 }),
              ],
            }),
          })
        : null),
  ...
  let ke;
  t[39] !== y || t[40] !== be
    ? ((ke = _(y, be)), (t[39] = y), (t[40] = be), (t[41] = ke))
    : (ke = t[41]);
  let Ae = B ? Xe : `hidden`,
    je;
  t[42] !== N ||
  ...
  t[67] !== R
    ...
    : (W = t[68]);
  let K;
  t[69] === b ? (K = t[70]) : ((K = k(b)), (t[69] = b), (t[70] = K));
  let Me;
  return (
    t[71] !== Oe || t[72] !== je || t[73] !== W || t[74] !== K || t[75] !== De
      ? ((Me = (0, G.jsxs)(`section`, {
          className: `flex h-full min-h-0 flex-col bg-token-side-bar-background`,
          children: [De, Oe, je, W, K],
        })),
        (t[71] = Oe),
        (t[72] = je),
        (t[73] = W),
