...
import "./isEqual.js";
import { $r as s, Qr as c } from "./src-1.js";
...
import "./platform.js";
import { S as m, f as h, h as g } from "./persisted-signal.js";
...
import { t as v } from "./use-merged-ref-BRG4-SOQ.js";
import "./minus.js";
import "./dropdown.js";
import "./globe.js";
...
import { i as ne, r as re } from "./browser-sidebar-comment-light-dismiss.js";
import "./arrow-rotate-ccw.js";
import "./link.js";
import { n as ie, r as ae } from "./artifact-analytics.js";
import { n as oe, r as se } from "./artifact-annotation-comment.js";
...
var _e = e(u(), 1),
  ve = r(),
  N = e(t(), 1);
function ye({ anchor: e, editorScale: t, layer: n, pageSize: r }) {
...
function P(e, t) {
  ...
  return n.width <= 0 || n.height <= 0
    ? null
    : {
        x: B(((e.clientX - n.left) / n.width) * t.width, 0, t.width),
        y: B(((e.clientY - n.top) / n.height) * t.height, 0, t.height),
      };
}
function F({ clientRects: e, pageElement: t, pageSize: n }) {
  ...
  let a = B(((i.left - r.left) / r.width) * n.width, 0, n.width),
    o = B(((i.top - r.top) / r.height) * n.height, 0, n.height),
    s = B(((i.right - r.left) / r.width) * n.width, 0, n.width),
    c = B(((i.bottom - r.top) / r.height) * n.height, 0, n.height);
...
function L(e) {
  return e.askForEditAnchor?.point ?? we(e.rect);
}
...
function z({ clientX: e, clientY: t, pageElement: n, pageSize: r }) {
  let i = n.getBoundingClientRect();
  return {
    x: B(((e - i.left) / i.width) * r.width, 0, r.width),
    y: B(((t - i.top) / i.height) * r.height, 0, r.height),
  };
}
function be(e) {
  return (
...
function Ee({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? (e.selectionKind == null ? j(e.rect) : L(e)) : e.point;
  return {
    sessionId:
      o.mode === `edit`
...
function De({ anchor: e, pageCount: t, pageNumber: n, pageSize: r }) {
...
function Pe(e) {
  ...
  if (t[0] !== n || t[1] !== s) {
    ...
    bb0: {
      ...
      let e;
      if (
        (t[8] === n ? (e = t[9]) : ((e = Ae(n)), (t[8] = n), (t[9] = e)),
        (f = e),
        c == null || f == null)
      ) {
        m = null;
      ...
      let r;
      (t[10] === n ? (r = t[11]) : ((r = U(n)), (t[10] = n), (t[11] = r)), (u = r));
      let i;
      (t[12] !== n.position.line || t[13] !== s
        ...
        : (i = t[14]),
        (l = i),
        (p = c.kind === `region` ? j(c.rect) : c.point));
    }
    ((t[0] = n),
      (t[1] = s),
      (t[2] = c),
      ...
      (t[6] = p),
      (t[7] = m));
  } else ((c = t[2]), (l = t[3]), (u = t[4]), (f = t[5]), (p = t[6]), (m = t[7]));
  ...
  return (
    t[36] !== b || t[37] !== S
      ? ((C = (0, W.jsxs)(W.Fragment, { children: [b, S] })), (t[36] = b), (t[37] = S), (t[38] = C))
      : (C = t[38]),
    C
  );
}
function Fe(e) {
  ...
  let s = a,
    c;
  t[4] === n ? (c = t[5]) : ((c = U(n)), (t[4] = n), (t[5] = c));
  let l;
  t[6] === n ? (l = t[7]) : ((l = Me(n)), (t[6] = n), (t[7] = l));
  let u;
  return (
...
function Ie(e) {
  ...
  if (n.kind === `region`) {
    ...
    t[0] !== n || t[1] !== i
      ...
      : (e = t[2]);
    let o;
    t[3] === n.rect ? (o = t[4]) : ((o = j(n.rect)), (t[3] = n.rect), (t[4] = o));
    let s;
    ...
    return (
      t[10] !== e || t[11] !== s
        ? ((c = (0, W.jsxs)(W.Fragment, { children: [e, s] })),
          (t[10] = e),
          (t[11] = s),
          (t[12] = c))
        : (c = t[12]),
...
function G(e) {
  ...
  if (i.selectionKind === `text`) {
    ...
    return (
      t[10] === o
        ? (s = t[11])
        : ((s = (0, W.jsx)(W.Fragment, { children: o })), (t[10] = o), (t[11] = s)),
      s
    );
  }
...
function qe(e) {
  let t = (0, ve.c)(244),
    ...
    te = i(a),
    E = d(),
    [D, oe] = (0, N.useState)(null),
    se = (0, N.useRef)(null),
    ce = (0, N.useRef)(null),
    O = (0, N.useRef)(!1),
    [k, ue] = (0, N.useState)(null),
    [A, j] = (0, N.useState)(null),
    [M, _e] = (0, N.useState)(null),
    [F, I] = (0, N.useState)(null),
    L = 1 / (Math.max(T, 2 ** -52) / 0.9),
    [R, z] = (0, N.useState)(``),
    [B, Ce] = (0, N.useState)(null),
    [V, we] = (0, N.useState)(null),
    [Te, H] = (0, N.useState)(null),
    [G, ze] = (0, N.useState)(!1),
    Be;
  if (t[0] !== n || t[1] !== y || t[2] !== x) {
    let e;
    (t[4] !== y || t[5] !== x
      ? ((e = (e) => e.localArtifactAnnotationContext?.path === x && ke(e) === y),
        (t[4] = y),
        (t[5] = x),
        (t[6] = e))
      : (e = t[6]),
  ...
  let Ve = Be,
    He;
  t[7] !== Ve || t[8] !== Te
    ? ((He = Te == null ? null : (Ve.find((e) => U(e) === Te) ?? null)),
      (t[7] = Ve),
      (t[8] = Te),
      (t[9] = He))
    : (He = t[9]);
  let Ue = He,
    ...
    J,
    We;
  t[10] !== Ve || t[11] !== k || t[12] !== A || t[13] !== V || t[14] !== b
    ? ((J = V == null ? null : (Ve.find((e) => U(e) === V) ?? null)),
      (q = J == null ? null : je(J)),
      (K = k ?? q),
      (We = k == null ? ((J == null ? null : (Ae(J) ?? b)) ?? b) : (A ?? b)),
      (t[10] = Ve),
      (t[11] = k),
      (t[12] = A),
      (t[13] = V),
  ...
  let X = Ge,
    qe;
  t[36] !== K || t[37] !== Y || t[38] !== L || t[39] !== D
    ? ((qe = K == null ? null : ye({ anchor: K, editorScale: L, layer: D, pageSize: Y })),
      (t[36] = K),
      (t[37] = Y),
      (t[38] = L),
      (t[39] = D),
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((rt = () => {
        (ue(null), j(null), _e(null), I(null), z(``), we(null), ze(!1));
      }),
      (t[47] = rt))
    : (rt = t[47]);
  let it = rt,
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = () => {
        typeof window > `u` ||
          re({ animationFrameRef: ce, animationWindow: window, editorWrapper: se.current });
      }),
      (t[49] = st))
    : (st = t[49]);
  let ct = st,
    lt;
  t[50] !== X || t[51] !== R || t[52] !== G
    ? ((lt = () =>
        X == null
          ? !1
          : X.target.mode === `create` && R.trim().length > 0
            ? G
              ? (it(), !0)
              : (ze(!0), ct(), !1)
            : (it(), !0)),
  ...
  let Q = lt,
    ut;
  t[54] !== K || t[55] !== Y || t[56] !== L || t[57] !== D
    ? ((ut = () => {
        if (K == null) return;
        let e = ye({ anchor: K, editorScale: L, layer: D, pageSize: Y });
        e != null && ge(se.current, e);
      }),
      (t[54] = K),
      (t[55] = Y),
      (t[56] = L),
      ...
      (t[58] = ut))
    : (ut = t[58]);
  let dt = (0, N.useEffectEvent)(ut),
    ft;
  t[59] !== dt || t[60] !== Xe || t[61] !== D
    ? ((ft = () => {
        if (!Xe || D == null) return;
    ...
    : (ft = t[62]);
  let pt;
  (t[63] !== Y.height || t[64] !== Y.width || t[65] !== L || t[66] !== Xe || t[67] !== D
    ? ((pt = [Y.height, Y.width, L, Xe, D]),
      (t[63] = Y.height),
      (t[64] = Y.width),
      (t[65] = L),
      (t[66] = Xe),
    ...
    (0, N.useEffect)(ft, pt));
  let mt;
  t[69] !== D?.ownerDocument || t[70] !== Q
    ? ((mt = (e) => {
        let t = e.target;
        (t instanceof Node && se.current?.contains(t)) ||
          (e.preventDefault(),
          e.stopPropagation(),
          Q() &&
      ...
      (t[69] = D?.ownerDocument),
      (t[70] = Q),
      (t[71] = mt))
    : (mt = t[71]);
  let ht = (0, N.useEffectEvent)(mt),
    gt;
  t[72] !== X?.target.mode || t[73] !== ht || t[74] !== s || t[75] !== D
    ? ((gt = () => {
        if (s || X?.target.mode !== `create` || D == null) return;
        let e = D.ownerDocument,
          t = (e) => {
            ht(e);
          };
  ...
  let _t = X?.target.mode,
    vt;
  (t[77] !== s || t[78] !== D || t[79] !== _t
    ? ((vt = [_t, s, D]), (t[77] = s), (t[78] = D), (t[79] = _t), (t[80] = vt))
    : (vt = t[80]),
    (0, N.useEffect)(gt, vt));
  let yt;
  t[81] !== k || t[82] !== V || t[83] !== s || t[84] !== D || t[85] !== b || t[86] !== Q
    ? ((yt = () => {
        if (s || D == null) return;
        ...
        ((k != null || V != null) && !Q()) ||
          (_e(t), ue(null), j(null), z(``), we(null), H(null), ze(!1));
      }),
      (t[81] = k),
      (t[82] = V),
      (t[83] = s),
      ...
      (t[87] = yt))
    : (yt = t[87]);
  let bt = (0, N.useEffectEvent)(yt),
    xt;
  t[88] !== s || t[89] !== D || t[90] !== bt
    ? ((xt = () => {
        if (D == null || s) return;
        let e = D.parentElement;
        if (e == null) return;
  ...
  let St;
  (t[92] !== s || t[93] !== D
    ? ((St = [s, D]), (t[92] = s), (t[93] = D), (t[94] = St))
    : (St = t[94]),
    (0, N.useEffect)(xt, St));
  let Ct;
  t[95] !== k || t[96] !== V || t[97] !== s || t[98] !== D || t[99] !== b || t[100] !== Q
    ? ((Ct = (e) => {
        if (s || D == null || e.defaultPrevented) return;
        let t = e.target;
        if (t instanceof Node && D.contains(t)) return;
      ...
      (t[101] = Ct))
    : (Ct = t[101]);
  let wt = (0, N.useEffectEvent)(Ct),
    Tt;
  t[102] !== s || t[103] !== D || t[104] !== wt
    ? ((Tt = () => {
        if (D == null || s) return;
        let e = D.parentElement;
        if (e == null) return;
  ...
  let Et;
  (t[106] !== s || t[107] !== D
    ? ((Et = [s, D]), (t[106] = s), (t[107] = D), (t[108] = Et))
    : (Et = t[108]),
    (0, N.useEffect)(Tt, Et));
  let Dt;
  t[109] !== s || t[110] !== D || t[111] !== b
    ? ((Dt = (e, t, n) => {
        if (!s || D == null) return null;
  ...
  let Ot = Dt,
    kt;
  t[113] !== s || t[114] !== b || t[115] !== te || t[116] !== S || t[117] !== C
    ? ((kt = (e, t) => {
        (ie(
          te,
          { artifactTabId: S, artifactType: `document`, importKind: `docx`, threadId: C },
          { annotationModeEnabled: s, startSource: t },
        ),
          ue(e),
          j(b),
          _e(null),
  ...
  let $ = kt,
    At;
  t[119] !== k || t[120] !== V || t[121] !== $ || t[122] !== b || t[123] !== M
    ? ((At = (e, t) => {
        if (k != null || V != null || !fe(e)) return;
        let n = Le({ pageElement: t, pageSize: b }) ?? (M?.selectionKind === `text` ? null : M);
      ...
      (t[124] = At))
    : (At = t[124]);
  let jt = (0, N.useEffectEvent)(At),
    Mt;
  t[125] !== s || t[126] !== D || t[127] !== jt
    ? ((Mt = () => {
        if (D == null || s) return;
        let e = D.parentElement;
        if (e == null) return;
  ...
  let Nt;
  (t[129] !== s || t[130] !== D
    ? ((Nt = [s, D]), (t[129] = s), (t[130] = D), (t[131] = Nt))
    : (Nt = t[131]),
    (0, N.useEffect)(Mt, Nt));
  let Pt;
  t[132] !== k || t[133] !== V || t[134] !== $ || t[135] !== Q
    ? ((Pt = (e) => {
        ((k != null || V != null) && !Q()) || $(e, `annotation_mode_pointer`);
      }),
      (t[132] = k),
      (t[133] = V),
      (t[134] = $),
  ...
  t[137] !== s || t[138] !== b
    ? ((It = (e) => {
        if (!s || !e.isPrimary || e.pointerType === `touch` || e.button !== 0) return;
        let t = P(e, b);
        t != null &&
          ((O.current = !1),
          e.preventDefault(),
  ...
  let Lt = It,
    Rt;
  t[140] !== k || t[141] !== B || t[142] !== V || t[143] !== Ot || t[144] !== b
    ? ((Rt = (e) => {
        if (B == null) {
          if (k != null || V != null) {
            I(null);
  ...
  t[152] !== Q
    ? ((Bt = (e) => {
        ...
        let t = P(e, b) ?? B.current;
        (e.preventDefault(),
          e.stopPropagation(),
          e.currentTarget.hasPointerCapture(e.pointerId) &&
            e.currentTarget.releasePointerCapture(e.pointerId));
        let n = { ...B, current: t, clientCurrent: { x: e.clientX, y: e.clientY } },
          r = be(n),
          i = xe(n, r);
        if (((O.current = r), !r)) {
          let t = Ot(e.clientX, e.clientY, !0);
          if (t != null) {
            ((O.current = !0), Ce(null), Ft(t));
            return;
          }
        }
        ...
        ($(i, `annotation_mode_pointer`), Ce(null));
      }),
      (t[146] = k),
      (t[147] = B),
      (t[148] = Ot),
  ...
  t[154] !== Ot || t[155] !== Ft
    ? ((Ht = (e) => {
        if (O.current) {
          ((O.current = !1), e.preventDefault(), e.stopPropagation());
          return;
        }
        let t = Ot(e.clientX, e.clientY, !0);
  ...
  t[171] !== w
    ? ((Wt = (e, t) => {
        ...
        if (V != null) {
          ...
          (u((e) =>
            e.map((e) => (U(e) === V ? { ...e, content: [{ content_type: `text`, text: a }] } : e)),
          ),
            it());
          return;
        }
        if (k == null || a.length === 0) return;
        let d = De({ anchor: k, pageCount: v, pageNumber: y, pageSize: A ?? b }),
          f = c({
    ...
    : (Wt = t[172]);
  let Gt = Wt,
    Kt = s ? `pointer-events-auto` : `pointer-events-none`,
    qt;
  t[173] === Kt
    ? (qt = t[174])
    : ((qt = f(`absolute inset-0 z-[3]`, Kt)), (t[173] = Kt), (t[174] = qt));
  let Jt;
  t[175] === s ? (Jt = t[176]) : ((Jt = s ? { cursor: le } : void 0), (t[175] = s), (t[176] = Jt));
  let Yt, Xt;
      ...
      ? ((e = (e) =>
          (0, W.jsx)(
            Pe,
            {
              ...
              isSelected: U(e) === V,
              onEdit: (e) => {
                (ue(null), j(null), z(``), ze(!1), H(null), I(null), we(e));
              },
              onPreviewChange: H,
              zoomScale: T,
            },
  ...
  let Qt;
  t[186] !== V || t[187] !== Ue || t[188] !== D
    ? ((Qt = Ue == null || V != null ? null : (0, W.jsx)(Fe, { comment: Ue, layer: D })),
      (t[186] = V),
      (t[187] = Ue),
      (t[188] = D),
      (t[189] = Qt))
    : (Qt = t[189]);
  let $t;
  t[190] !== k || t[191] !== V || t[192] !== F || t[193] !== b
    ? (($t =
        F != null && k == null && V == null
          ? (0, W.jsx)(Ne, {
              paddingPx: 4,
              pageSize: b,
              rect: F.rect,
    ...
    : ($t = t[194]);
  let en;
  t[195] !== nt || t[196] !== k || t[197] !== $ || t[198] !== b || t[199] !== M || t[200] !== T
    ? ((en =
        M != null && k == null
          ? (0, W.jsxs)(W.Fragment, {
              children: [
                M.selectionKind === `text`
                  ? null
                  : (0, W.jsx)(Ne, {
                      bordered: !0,
                      paddingPx: 4,
  ...
  t[202] !== B || t[203] !== b
    ...
    : (tn = t[204]);
  let nn;
  t[205] !== k || t[206] !== A || t[207] !== l || t[208] !== b || t[209] !== T
    ? ((nn =
        k == null ? null : (0, W.jsx)(Ie, { anchor: k, label: l, pageSize: A ?? b, zoomScale: T })),
      (t[205] = k),
      (t[206] = A),
      (t[207] = l),
      (t[208] = b),
...
function nt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ie = () => {
        re.current != null && (window.cancelAnimationFrame(re.current), (re.current = null));
      }),
      (t[0] = ie))
    : (ie = t[0]);
  let ae = ie,
  ...
  t[1] === D
    ...
    : ((O = (e) => {
        let t = ne.current;
        t != null && ut(e, t, re, D) && (ne.current = null);
      }),
      (t[1] = D),
      (t[2] = O));
  let le = O,
    k;
  t[3] !== n || t[4] !== te || t[5] !== le
    ? ((k = { bytes: n, onPagesRendered: le, renderAsync: te }),
      (t[3] = n),
      (t[4] = te),
      (t[5] = le),
      (t[6] = k))
  ...
  let {
    ...
    j;
  t[7] === C.value ? (j = t[8]) : ((j = g(C.value)), (t[7] = C.value), (t[8] = j));
  let M = j,
    he;
  t[9] === M ? (he = t[10]) : ((he = M ?? m({ entrypoint: `home` })), (t[9] = M), (t[10] = he));
  let ge = he,
    [ye, P] = E(ge),
    F,
    I;
  t[11] !== ye || t[12] !== l
    ? ((F = oe(ye, l).filter(rt)), (I = se(F)), (t[11] = ye), (t[12] = l), (t[13] = F), (t[14] = I))
    : ((F = t[13]), (I = t[14]));
  let L = I,
    {
      handleTouchCancel: R,
  ...
  (t[18] === Oe
    ? ((ke = t[19]), (Ae = t[20]))
    : ((ke = () => ({ navigateToPage: Oe })),
      (Ae = [Oe]),
      (t[18] = Oe),
      (t[19] = ke),
      (t[20] = Ae)),
    (0, N.useImperativeHandle)(u, ke, Ae));
  let je, Me;
  (t[21] !== l || t[22] !== P
    ? ((je = () => () => {
        (ae(),
          P((e) => {
            let t = e.filter((e) => !pt(e, l));
  ...
  t[25] === pe
    ? (U = t[26])
    : ((U = (0, W.jsx)(`div`, { ref: pe, "aria-hidden": !0, className: `hidden` })),
      (t[25] = pe),
      (t[26] = U));
  let Ne;
  t[27] !== _ ||
  ...
  t[37] !== H
    ? ((Ne = Ee
        ? (0, W.jsx)(T, {
            artifactType: `DOC`,
            hideMetadata: _ === `standalone`,
            title: ct(f),
            centerContent: null,
            rightContent: (0, W.jsxs)(`div`, {
              ...
              children: [
                (0, W.jsx)(ee, {
                  ...
                  fitOption: { selected: Ce, onSelect: B },
                }),
                _ === `default` && !x
                  ? (0, W.jsxs)(W.Fragment, {
                      children: [
                        (0, W.jsx)(w, { hostId: s, path: l }),
                        (0, W.jsx)(S, { hostId: s, onBeforeOpen: c, path: l, showLabel: !0 }),
                      ],
                    })
                  : null,
              ],
  ...
  let Pe;
  t[39] !== A || t[40] !== we
    ? ((Pe = v(A, we)), (t[39] = A), (t[40] = we), (t[41] = Pe))
    : (Pe = t[41]);
  let Fe = Ee ? Xe : `hidden`,
    Ie;
  t[42] !== R ||
  ...
  t[69] !== H
    ...
    : (G = t[70]);
  let Le;
  t[71] === de ? (Le = t[72]) : ((Le = ce(de)), (t[71] = de), (t[72] = Le));
  let Re;
  return (
    t[73] !== U || t[74] !== Ne || t[75] !== Ie || t[76] !== G || t[77] !== Le
      ? ((Re = (0, W.jsxs)(`section`, {
          className: `flex h-full min-h-0 flex-col bg-token-side-bar-background`,
          children: [U, Ne, Ie, G, Le],
        })),
        (t[73] = U),
        (t[74] = Ne),
        (t[75] = Ie),
...
function it(e) {
  let t = (0, ve.c)(17),
    ...
    s = (0, N.useRef)(0),
    c = (0, N.useRef)(!1),
    [l, u] = (0, N.useState)(i == null ? `error` : `loading`),
    d;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((d = []), (t[0] = d)) : (d = t[0]);
  let [f, p] = (0, N.useState)(d),
    [m, h] = (0, N.useState)(0),
    g;
  ...
  let ee = w,
    T;
  return (
    t[11] !== l || t[12] !== f || t[13] !== C || t[14] !== ee || t[15] !== m
      ? ((T = {
          bodyContainerElementRef: a,
          bodyContainerRef: C,
          loadState: l,
          pageElements: f,
          styleContainerRef: ee,
          totalPages: m,
        }),
        (t[11] = l),
        (t[12] = f),
...
function at(e) {
  let t = (0, N.useRef)(null),
    ...
    [i, a] = (0, N.useState)({ kind: `fit-width` }),
    o =
      i.kind === `fit-width`
  ...
  return {
    ...
    handleWheel: (e) => {
      e.ctrlKey &&
        ...
        a((t) => ({
          kind: `percentage`,
          zoomPercent: b(t.kind === `percentage` ? t.zoomPercent : o, e.deltaY),
        })));
    },
