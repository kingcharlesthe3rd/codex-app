...
import { i as ke, r as Ae, t as z } from "./artifact-analytics.js";
import { a as je, n as B, r as Me } from "./artifact-annotation-comment.js";
import { n as V, t as Ne } from "./artifact-preview-status.js";
var H = e(() => {});
...
function Ye({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? (e.selectionKind == null ? j(e.rect) : G(e)) : e.point;
  return {
    sessionId:
      o.mode === `edit`
...
function at(e) {
  ...
  return (
    t[36] !== v || t[37] !== b
      ? ((x = (0, q.jsxs)(q.Fragment, { children: [v, b] })), (t[36] = v), (t[37] = b), (t[38] = x))
      : (x = t[38]),
    x
  );
}
...
function ft({
  ...
  let o = W({ clientRects: [a.element.getBoundingClientRect()], pageElement: t, pageSize: n });
  if (o == null) return null;
...
function Tt(e) {
  ...
  t[36] !== R || t[37] !== B || t[38] !== O || t[39] !== w
    ? ((Ne = R == null ? null : Pe({ anchor: R, editorScale: O, layer: w, pageSize: B })),
      (t[36] = R),
      (t[37] = B),
      (t[38] = O),
      (t[39] = w),
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((qe = () => {
        typeof window > `u` ||
          _e({ animationFrameRef: ae, animationWindow: window, editorWrapper: ie.current });
      }),
      (t[49] = qe))
    : (qe = t[49]);
  let Je = qe,
  ...
  t[59] !== q || t[60] !== U || t[61] !== w
    ...
    : (lt = t[62]);
  let ft;
  (t[63] !== B.height || t[64] !== B.width || t[65] !== O || t[66] !== U || t[67] !== w
  ...
  (t[77] !== a || t[78] !== w || t[79] !== gt
    ...
    (0, J.useEffect)(ht, _t));
  let vt;
  t[81] !== T || t[82] !== A || t[83] !== a || t[84] !== w || t[85] !== _ || t[86] !== K
    ? ((vt = () => {
        if (a || w == null) return;
  ...
  (t[92] !== a || t[93] !== w
    ...
    (0, J.useEffect)(bt, xt));
  let St;
  t[95] !== T || t[96] !== A || t[97] !== a || t[98] !== w || t[99] !== _ || t[100] !== K
    ? ((St = (e) => {
  ...
  t[119] !== T || t[120] !== A || t[121] !== X || t[122] !== _ || t[123] !== E
    ? ((Nt = (e, t) => {
        ...
        let n = ut({ pageElement: t, pageSize: _ }) ?? (E?.selectionKind === `text` ? null : E);
  ...
  t[171] !== x
    ? ((Q = (e, t) => {
        ...
        if (A != null) {
          ...
          (c((e) =>
            e.map((e) =>
              nt(e) === A ? { ...e, content: [{ content_type: `text`, text: o }] } : e,
            ),
          ),
            We());
          return;
        ...
        let l = Xe({ anchor: T, pageCount: m, pageNumber: g, pageSize: le ?? _ }),
          u = h({
  ...
  let Jt;
  t[175] === a ? (Jt = t[176]) : ((Jt = a ? { cursor: ve } : void 0), (t[175] = a), (t[176] = Jt));
  let Yt, Xt;
  ...
  t[186] !== A || t[187] !== L || t[188] !== w
    ? ((Qt = L == null || A != null ? null : (0, Y.jsx)(ot, { comment: L, layer: w })),
      (t[186] = A),
      (t[187] = L),
      (t[188] = w),
      (t[189] = Qt))
  ...
  t[190] !== T || t[191] !== A || t[192] !== fe || t[193] !== _
    ...
    : ($t = t[194]);
  let en;
  t[195] !== He || t[196] !== T || t[197] !== X || t[198] !== _ || t[199] !== E || t[200] !== S
    ? ((en =
        E != null && T == null
          ? (0, Y.jsxs)(Y.Fragment, {
              children: [
  ...
  t[205] !== T || t[206] !== le || t[207] !== s || t[208] !== _ || t[209] !== S
    ? ((nn =
        T == null
          ? null
          : (0, Y.jsx)(st, { anchor: T, label: s, pageSize: le ?? _, zoomScale: S })),
      (t[205] = T),
      (t[206] = le),
      (t[207] = s),
      (t[208] = _),
...
function jt(e) {
  ...
  let {
    ...
    O;
  t[7] === g.value ? (O = t[8]) : ((O = me(g.value)), (t[7] = g.value), (t[8] = O));
  let he = O,
    k;
  t[9] === he ? (k = t[10]) : ((k = he ?? ge({ entrypoint: `home` })), (t[9] = he), (t[10] = k));
  let _e = k,
    ve = i(y, _e),
    ye;
  t[11] !== _e || t[12] !== g
  ...
  let be = ye,
    ...
    j;
  t[14] !== ve || t[15] !== u
    ? ((A = B(ve, u).filter(Mt)), (j = Me(A)), (t[14] = ve), (t[15] = u), (t[16] = A), (t[17] = j))
    : ((A = t[16]), (j = t[17]));
  let M = j,
    {
  ...
  (t[21] === ke
    ? ((Ae = t[22]), (z = t[23]))
    : ((Ae = () => ({ navigateToPage: ke })), (z = [ke]), (t[21] = ke), (t[22] = Ae), (t[23] = z)),
  ...
  t[28] === fe
    ? (H = t[29])
    : ((H = (0, Q.jsx)(`div`, { ref: fe, "aria-hidden": !0, className: `hidden` })),
      (t[28] = fe),
      (t[29] = H));
  let Pe;
  t[30] !== m ||
                ...
                m === `default` && !ee
                  ? (0, Q.jsxs)(Q.Fragment, {
                      children: [
                        ...
                        (0, Q.jsx)(re, { hostId: c, onBeforeOpen: l, path: u, showLabel: !0 }),
                      ],
                    })
                  : null,
              ],
  ...
  return {
    ...
    handleWheel: (e) => {
      e.ctrlKey &&
        ...
        a((t) => ({
          kind: `percentage`,
          zoomPercent: ie(t.kind === `percentage` ? t.zoomPercent : o, e.deltaY),
        })));
    },
