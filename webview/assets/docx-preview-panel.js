...
import { i as Ae, r as je, t as R } from "./artifact-analytics-CH-vpyjW.js";
import { a as Me, n as z, r as Ne } from "./artifact-annotation-comment.js";
import { n as B, t as Pe } from "./artifact-preview-status-JB-mmcBf.js";
var V = e(() => {});
function Fe({ anchor: e, editorScale: t, layer: n, pageSize: r }) {
  return e.kind === `region` && e.selectionKind != null
    ? ye({ editorScale: t, layer: n, pageSize: r, rect: e.rect })
    : ge({
        editorScale: t,
        layer: n,
...
function Ye({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? (e.selectionKind == null ? j(e.rect) : W(e)) : e.point;
  return {
    sessionId:
      o.mode === `edit`
...
function Tt(e) {
  let t = (0, Ot.c)(244),
    ...
    [ce, ue] = (0, J.useState)(null),
    [D, de] = (0, J.useState)(null),
    [ge, O] = (0, J.useState)(null),
    k = 1 / (Math.max(C, 2 ** -52) / 0.9),
    [_e, A] = (0, J.useState)(``),
    [j, ye] = (0, J.useState)(null),
    [M, xe] = (0, J.useState)(null),
  ...
  let Ee = Te,
    De;
  t[7] !== Ee || t[8] !== N
    ? ((De = N == null ? null : (Ee.find((e) => nt(e) === N) ?? null)),
      (t[7] = Ee),
      (t[8] = N),
      (t[9] = De))
    : (De = t[9]);
  let I = De,
    ...
    R,
    Me;
  t[10] !== Ee || t[11] !== E || t[12] !== ce || t[13] !== M || t[14] !== v
    ? ((R = M == null ? null : (Ee.find((e) => nt(e) === M) ?? null)),
      (ke = R == null ? null : et(R)),
      (L = E ?? ke),
      (Me = E == null ? ((R == null ? null : ($e(R) ?? v)) ?? v) : (ce ?? v)),
      (t[10] = Ee),
      (t[11] = E),
      (t[12] = ce),
      (t[13] = M),
  ...
  let B = Ne,
    Pe;
  t[36] !== L || t[37] !== z || t[38] !== k || t[39] !== T
    ? ((Pe = L == null ? null : Fe({ anchor: L, editorScale: k, layer: T, pageSize: z })),
      (t[36] = L),
      (t[37] = z),
      (t[38] = k),
      (t[39] = T),
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ue = () => {
        (se(null), ue(null), de(null), O(null), A(``), xe(null), F(!1));
      }),
      (t[47] = Ue))
    : (Ue = t[47]);
  let We = Ue,
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((qe = () => {
        typeof window > `u` ||
          be({ animationFrameRef: ae, animationWindow: window, editorWrapper: re.current });
      }),
      (t[49] = qe))
    : (qe = t[49]);
  let Je = qe,
    rt;
  t[50] !== B || t[51] !== _e || t[52] !== Ce
    ? ((rt = () =>
        B == null
          ? !1
  ...
  let K = rt,
    ct;
  t[54] !== L || t[55] !== z || t[56] !== k || t[57] !== T
    ? ((ct = () => {
        if (L == null) return;
        let e = Fe({ anchor: L, editorScale: k, layer: T, pageSize: z });
        e != null && pe(re.current, e);
      }),
      (t[54] = L),
      (t[55] = z),
      (t[56] = k),
  ...
  t[59] !== q || t[60] !== H || t[61] !== T
    ...
    : (lt = t[62]);
  let ft;
  (t[63] !== z.height || t[64] !== z.width || t[65] !== k || t[66] !== H || t[67] !== T
    ? ((ft = [z.height, z.width, k, H, T]),
      (t[63] = z.height),
      (t[64] = z.width),
      (t[65] = k),
      (t[66] = H),
  ...
  let mt = (0, J.useEffectEvent)(pt),
    ht;
  t[72] !== B?.target.mode || t[73] !== mt || t[74] !== i || t[75] !== T
    ? ((ht = () => {
        if (i || B?.target.mode !== `create` || T == null) return;
        let e = T.ownerDocument,
          t = (e) => {
            mt(e);
          };
  ...
  (t[77] !== i || t[78] !== T || t[79] !== gt
    ...
    (0, J.useEffect)(ht, _t));
  let vt;
  t[81] !== E || t[82] !== M || t[83] !== i || t[84] !== T || t[85] !== v || t[86] !== K
    ? ((vt = () => {
        if (i || T == null) return;
        ...
        ((E != null || M != null) && !K()) ||
          (de(t), se(null), ue(null), A(``), xe(null), P(null), F(!1));
      }),
      (t[81] = E),
      (t[82] = M),
      (t[83] = i),
  ...
  (t[92] !== i || t[93] !== T
    ...
    (0, J.useEffect)(bt, xt));
  let St;
  t[95] !== E || t[96] !== M || t[97] !== i || t[98] !== T || t[99] !== v || t[100] !== K
    ? ((St = (e) => {
  ...
  let jt = At,
    Mt;
  t[113] !== i || t[114] !== v || t[115] !== te || t[116] !== b || t[117] !== x
    ? ((Mt = (e, t) => {
        (je(
          te,
  ...
  let X = Mt,
    Nt;
  t[119] !== E || t[120] !== M || t[121] !== X || t[122] !== v || t[123] !== D
    ? ((Nt = (e, t) => {
        if (E != null || M != null || !he(e)) return;
        let n = ut({ pageElement: t, pageSize: v }) ?? (D?.selectionKind === `text` ? null : D);
  ...
  let Bt = zt,
    Vt;
  t[140] !== E || t[141] !== j || t[142] !== M || t[143] !== jt || t[144] !== v
    ? ((Vt = (e) => {
        if (j == null) {
          if (E != null || M != null) {
            O(null);
  ...
  t[171] !== S
    ? ((Q = (e, t) => {
        ...
        if (M != null) {
          ...
          (l((e) =>
            e.map((e) =>
              nt(e) === M ? { ...e, content: [{ content_type: `text`, text: u }] } : e,
            ),
          ),
            We());
          return;
        ...
        let d = Xe({ anchor: E, pageCount: g, pageNumber: _, pageSize: ce ?? v }),
          f = a({
  ...
  t[173] === Kt
    ? (qt = t[174])
    : ((qt = le(`absolute inset-0 z-[3]`, Kt)), (t[173] = Kt), (t[174] = qt));
  let Jt;
  t[175] === i ? (Jt = t[176]) : ((Jt = i ? { cursor: ve } : void 0), (t[175] = i), (t[176] = Jt));
  let Yt, Xt;
      ...
      ? ((e = (e) =>
          (0, Y.jsx)(
            at,
            {
              ...
              isSelected: nt(e) === M,
              onEdit: (e) => {
                (se(null), ue(null), A(``), F(!1), P(null), O(null), xe(e));
              },
              onPreviewChange: P,
              zoomScale: C,
            },
  ...
  let Qt;
  t[186] !== M || t[187] !== I || t[188] !== T
    ? ((Qt = I == null || M != null ? null : (0, Y.jsx)(ot, { comment: I, layer: T })),
      (t[186] = M),
      (t[187] = I),
      (t[188] = T),
      (t[189] = Qt))
    : (Qt = t[189]);
  let $t;
  t[190] !== E || t[191] !== M || t[192] !== ge || t[193] !== v
    ? (($t =
        ge != null && E == null && M == null
          ? (0, Y.jsx)(it, {
              paddingPx: 4,
              pageSize: v,
              rect: ge.rect,
    ...
    : ($t = t[194]);
  let en;
  t[195] !== G || t[196] !== E || t[197] !== X || t[198] !== v || t[199] !== D || t[200] !== C
    ? ((en =
        D != null && E == null
          ? (0, Y.jsxs)(Y.Fragment, {
              children: [
  ...
  t[202] !== j || t[203] !== v
    ...
    : (tn = t[204]);
  let nn;
  t[205] !== E || t[206] !== ce || t[207] !== o || t[208] !== v || t[209] !== C
    ? ((nn =
        E == null
          ? null
          : (0, Y.jsx)(st, { anchor: E, label: o, pageSize: ce ?? v, zoomScale: C })),
      (t[205] = E),
      (t[206] = ce),
      (t[207] = o),
      (t[208] = v),
...
function jt(e) {
  ...
  t[1] === S
    ...
    : ((ie = (e) => {
        let t = ee.current;
        t != null && zt(e, t, C, S) && (ee.current = null);
      }),
      (t[1] = S),
      (t[2] = ie));
  let ae = ie,
    se;
  t[3] !== r || t[4] !== x || t[5] !== ae
    ? ((se = { bytes: r, onPagesRendered: ae, renderAsync: x }),
      (t[3] = r),
      (t[4] = x),
      (t[5] = ae),
      (t[6] = se))
  ...
  let {
    ...
    me;
  t[7] === y.value ? (me = t[8]) : ((me = i(y.value)), (t[7] = y.value), (t[8] = me));
  let he = me,
    ge;
  t[9] === he ? (ge = t[10]) : ((ge = he ?? oe({ entrypoint: `home` })), (t[9] = he), (t[10] = ge));
  let O = ge,
    k = ce(Ee, O),
    _e;
  t[11] !== O || t[12] !== y
  ...
  let A = _e,
    ...
    j;
  t[14] !== k || t[15] !== u
    ? ((ve = z(k, u).filter(Mt)), (j = Ne(ve)), (t[14] = k), (t[15] = u), (t[16] = ve), (t[17] = j))
    : ((ve = t[16]), (j = t[17]));
  let ye = j,
    {
      handleTouchCancel: M,
  ...
  (t[21] === Ae
    ...
    (0, Z.useImperativeHandle)(d, je, R));
  let Me, Pe;
  (t[24] !== u || t[25] !== A
    ? ((Me = () => () => {
        (re(),
  ...
  t[28] === fe
    ? (V = t[29])
    : ((V = (0, Q.jsx)(`div`, { ref: fe, "aria-hidden": !0, className: `hidden` })),
      (t[28] = fe),
      (t[29] = V));
  let Fe;
  t[30] !== h ||
            ...
            rightContent: (0, Q.jsxs)(`div`, {
              ...
              children: [
                (0, Q.jsx)(T, {
                  ...
                  fitOption: { selected: F, onSelect: Ce },
                }),
                h === `default` && !v
                  ? (0, Q.jsxs)(Q.Fragment, {
                      children: [
                        (0, Q.jsx)(te, { hostId: c, path: u }),
                        (0, Q.jsx)(_, { hostId: c, onBeforeOpen: l, path: u, showLabel: !0 }),
                      ],
                    })
                  : null,
              ],
  ...
  let H;
  t[42] !== ue || t[43] !== Te
    ? ((H = ke(ue, Te)), (t[42] = ue), (t[43] = Te), (t[44] = H))
    : (H = t[44]);
  let Ie = Oe ? Kt : `hidden`,
    U;
  t[45] !== M ||
  ...
  t[72] !== I
    ...
    : (Le = t[73]);
  let W;
  t[74] === D ? (W = t[75]) : ((W = B(D)), (t[74] = D), (t[75] = W));
  let Re;
  return (
...
function Nt(e) {
  let t = (0, Z.useRef)(null),
    ...
    l = (e) => {
      a({ kind: `percentage`, zoomPercent: m(e) });
    };
  return {
    fitToWidth: () => {
...
function Lt({ bodyContainer: e, bodyContainerWidth: t, zoomPercent: n }) {
  ...
  return !Number.isFinite(l) || l <= 0 ? null : m(Math.round((s / l) * 100));
}
function Rt(e) {
