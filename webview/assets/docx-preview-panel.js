...
import { Mr as t, Nr as n, zr as r } from "./src-C.js";
...
import { G as l, X as u, wt as d } from "./setting-storage.js";
...
import "./tooltip.js";
import { i as f, t as p } from "./route-scope.js";
...
import { t as h } from "./use-merged-ref.js";
...
import { n as v } from "./arrow-rotate-ccw.js";
...
import { n as ne, r as O } from "./artifact-annotation-comment.js";
import { t as re } from "./artifact-preview-status.js";
import {
  c as k,
  i as A,
  l as j,
...
function le(e) {
  let n = (0, oe.c)(115),
    ...
    T = (0, I.useRef)(null),
    ee = (0, I.useRef)(null),
    [E, te] = (0, I.useState)(null),
    [D, ne] = (0, I.useState)(``),
    [O, re] = (0, I.useState)(null),
    [k, j] = (0, I.useState)(null),
    [M, P] = (0, I.useState)(null),
    [ae, R] = (0, I.useState)(!1),
    le;
  if (n[0] !== r || n[1] !== v || n[2] !== b) {
    let e;
    (n[4] !== v || n[5] !== b
      ? ((e = (e) => e.localArtifactAnnotationContext?.path === b && ve(e) === v),
        (n[4] = v),
        (n[5] = b),
        (n[6] = e))
      : (e = n[6]),
  ...
  let V = le,
    ...
    J,
    Y;
  n[7] !== V || n[8] !== k || n[9] !== M || n[10] !== a
    ? ((J = a ? V : []),
      (q = M == null ? null : (J.find((e) => G(e) === M) ?? null)),
      (K = k == null ? null : (J.find((e) => G(e) === k) ?? null)),
      (Y = K == null ? null : H(K)),
      (n[7] = V),
      (n[8] = k),
      (n[9] = M),
  ...
  let Q = ye,
    be;
  n[32] !== Z || n[33] !== C || n[34] !== y
    ? ((be = Z == null ? null : W({ anchor: Z, layer: C, pageSize: y })),
      (n[32] = Z),
      (n[33] = C),
      (n[34] = y),
      (n[35] = be))
  ...
  n[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((De = () => {
        typeof window > `u` ||
          _({ animationFrameRef: ee, animationWindow: window, editorWrapper: T.current });
      }),
      (n[40] = De))
    : (De = n[40]);
  let Oe = De,
    ke;
  n[41] !== Q || n[42] !== D || n[43] !== ae
    ? ((ke = () =>
        Q == null
          ? !1
          : Q.target.mode === `create` && D.trim().length > 0
            ? ae
              ? ($(), !0)
              : (R(!0), Oe(), !1)
            : ($(), !0)),
  ...
  n[45] !== a || n[46] !== y
    ? ((je = (e) => {
        ...
        t != null &&
          ...
          P(null),
          re({ pointerId: e.pointerId, start: t, current: t }));
      }),
      (n[45] = a),
      (n[46] = y),
      (n[47] = je))
  ...
  n[48] !== O || n[49] !== y
    ? ((Ne = (e) => {
        ...
        t != null &&
          (e.preventDefault(),
          e.stopPropagation(),
          re((n) => (n == null || n.pointerId !== e.pointerId ? n : { ...n, current: t })));
      }),
      (n[48] = O),
      (n[49] = y),
      (n[50] = Ne))
  ...
  let Pe = Ne,
    Fe;
  n[51] !== E || n[52] !== O || n[53] !== y || n[54] !== Ae
    ? ((Fe = (e) => {
        if (O == null || e.pointerId !== O.pointerId) return;
        let t = he(e, y) ?? O.current;
        (e.preventDefault(),
          e.stopPropagation(),
          e.currentTarget.hasPointerCapture(e.pointerId) &&
            e.currentTarget.releasePointerCapture(e.pointerId));
        let n = ge({ ...O, current: t });
        if (E != null && n.kind === `point`) {
          (Ae(), re(null));
          return;
        }
        (te(n), ne(``), j(null), R(!1), re(null));
      }),
      (n[51] = E),
      (n[52] = O),
      (n[53] = y),
  ...
  n[64] !== x
    ? ((Le = (e) => {
        ...
        if (k != null) {
          ...
          (c((e) =>
            e.map((e) => (G(e) === k ? { ...e, content: [{ content_type: `text`, text: n }] } : e)),
          ),
            $());
          return;
        }
        E == null ||
          ...
          (c((e) => [
            ...
            t({
              ...
              label: B(E, v),
              line: o,
              metadata: me({ anchor: E, pageCount: h, pageNumber: v, pageSize: y }),
              path: b,
              title: x,
            }),
          ]),
    ...
    : (Le = n[65]);
  let Re = Le,
    ze = !a && `pointer-events-none`,
    Be;
  n[66] === ze
    ? (Be = n[67])
    : ((Be = s(`absolute inset-0 z-[3]`, ze)), (n[66] = ze), (n[67] = Be));
  let Ve;
  n[68] === a ? (Ve = n[69]) : ((Ve = a ? { cursor: N } : void 0), (n[68] = a), (n[69] = Ve));
  let He;
  ...
  let We;
  n[76] !== k || n[77] !== q || n[78] !== C
    ? ((We = q == null || k != null ? null : (0, L.jsx)(fe, { comment: q, layer: C })),
      (n[76] = k),
      (n[77] = q),
      (n[78] = C),
      (n[79] = We))
  ...
  n[80] !== O || n[81] !== y
    ...
    : (Ge = n[82]);
  let Ke;
  n[83] !== E || n[84] !== o || n[85] !== y
    ? ((Ke = E == null ? null : (0, L.jsx)(pe, { anchor: E, label: o, pageSize: y })),
      (n[83] = E),
      (n[84] = o),
      (n[85] = y),
      (n[86] = Ke))
  ...
  n[97] !== m
    ? ((qe =
        Z == null || xe == null || Q == null || typeof document > `u`
          ? null
          : (0, se.createPortal)(
              (0, L.jsx)(`div`, {
                ref: T,
                className: ie,
                style: { left: xe.x, top: xe.y, height: F, width: 294 },
                onPointerDown: ue,
                onTouchCancel: (e) => {
                  (e.stopPropagation(), u?.());
                },
                ...
                children: (0, L.jsx)(
                  g,
                  {
                    ...
                    onCancel: $,
                    onDelete: (e) => {
                      (c((t) => t.filter((t) => G(t) !== e)), $());
                    },
                    onDirectSubmit: Re,
                    onEscape: $,
                    onBodyChange: Q.target.mode === `create` ? Ee : void 0,
                    onLightDismissibilityChange: ce,
                    onMounted: ce,
                    onSubmit: Re,
                  },
                  Q.sessionId,
...
function de(e) {
  ...
  if (t[0] !== n || t[1] !== o) {
    ...
    bb0: {
      ...
      let r;
      (t[10] === n ? (r = t[11]) : ((r = G(n)), (t[10] = n), (t[11] = r)), (u = r));
      let i;
      (t[12] !== n.position.line || t[13] !== o
        ...
        : (i = t[14]),
        (c = i),
        (f = s.kind === `region` ? j(s.rect) : s.point));
    }
    ((t[0] = n),
      (t[1] = o),
      (t[2] = s),
      ...
      (t[6] = f),
      (t[7] = p));
  } else ((s = t[2]), (c = t[3]), (u = t[4]), (d = t[5]), (f = t[6]), (p = t[7]));
  ...
  let v = _,
    y;
  t[20] !== s.kind || t[21] !== s.rect || t[22] !== d
    ? ((y =
        s.kind === `region`
          ? (0, L.jsx)(A, {
              pageSize: d,
  ...
  let b;
  t[24] !== u || t[25] !== i
    ? ((b = () => i(u)), (t[24] = u), (t[25] = i), (t[26] = b))
    : (b = t[26]);
  let x;
  t[27] !== n.position.line ||
  t[28] !== c ||
  t[29] !== v ||
  t[30] !== r ||
  t[31] !== d ||
  ...
  return (
    t[36] !== y || t[37] !== x
      ? ((S = (0, L.jsxs)(L.Fragment, { children: [y, x] })), (t[36] = y), (t[37] = x), (t[38] = S))
      : (S = t[38]),
    S
  );
}
...
function pe(e) {
  ...
  if (n.kind === `region`) {
    ...
    t[0] !== n.rect || t[1] !== i
      ...
      : (e = t[2]);
    let a;
    t[3] === n.rect ? (a = t[4]) : ((a = j(n.rect)), (t[3] = n.rect), (t[4] = a));
    let o;
    t[5] !== r || t[6] !== i || t[7] !== a
      ? ((o = (0, L.jsx)(P, {
          draft: !0,
    ...
    return (
      t[9] !== e || t[10] !== o
        ? ((s = (0, L.jsxs)(L.Fragment, { children: [e, o] })),
          (t[9] = e),
          (t[10] = o),
          (t[11] = s))
        : (s = t[11]),
...
function z({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? j(e.rect) : e.point;
  return {
    sessionId:
      o.mode === `edit`
...
function me({ anchor: e, pageCount: t, pageNumber: n, pageSize: r }) {
...
function he(e, t) {
  ...
  return n.width <= 0 || n.height <= 0
    ? null
    : {
        x: K(((e.clientX - n.left) / n.width) * t.width, 0, t.width),
        y: K(((e.clientY - n.top) / n.height) * t.height, 0, t.height),
      };
}
function ge(e) {
  let t = _e(e.start, e.current);
...
function B(e, t) {
  return e.kind === `region` ? `Page ${t} region` : `Page ${t} point`;
}
function ve(e) {
  let t = e.localArtifactAnnotationMetadata?.target;
  return t?.type === `document-page-point` || t?.type === `document-page-region`
    ? t.pageNumber
    : null;
}
function V(e) {
...
function W({ anchor: e, layer: t, pageSize: n }) {
  return k({ layer: t, markerPoint: e.kind === `region` ? j(e.rect) : e.point, pageSize: n });
}
function G(e) {
...
var q = `codex-docx-preview`,
  J = `h-full min-h-0 overflow-auto bg-token-side-bar-background overscroll-contain`,
  Y = `
  .${q}-wrapper {
    min-height: 100%;
    display: flex;
...
function Q(e) {
  let t = (0, oe.c)(68),
    ...
    l;
  t[0] !== n || t[1] !== c
    ? ((l = { bytes: n, renderAsync: c }), (t[0] = n), (t[1] = c), (t[2] = l))
    : (l = t[2]);
  let {
      bodyContainerElementRef: d,
      bodyContainerRef: m,
      loadState: g,
      pageElements: _,
      styleContainerRef: y,
  ...
  t[3] === s.value
    ? (S = t[4])
    : ((S = f(s.value) ?? r(`new-conversation`)), (t[3] = s.value), (t[4] = S));
  let w = S,
    [D, k] = v(w),
    A,
    j;
  t[5] !== D || t[6] !== a
    ? ((A = ne(D, a).filter(be)), (j = O(A)), (t[5] = D), (t[6] = a), (t[7] = A), (t[8] = j))
    : ((A = t[7]), (j = t[8]));
  let M = j,
    {
      handleTouchCancel: N,
    ...
    me;
  t[9] !== d || t[10] !== x
    ? ((me = { containerRef: d, pageSelector: Z, totalPages: x }),
      (t[9] = d),
      (t[10] = x),
      (t[11] = me))
    : (me = t[11]);
  let { currentPage: he, goToNextPage: ge, goToPreviousPage: _e } = ae(me),
    B = g === `ready`,
    ve,
    V;
  (t[12] !== a || t[13] !== k
  ...
  t[16] === y
    ? (H = t[17])
    : ((H = (0, L.jsx)(`div`, { ref: y, "aria-hidden": !0, className: `hidden` })),
      (t[16] = y),
      (t[17] = H));
  let U;
  t[18] !== he ||
  ...
  t[29] !== z
    ? ((U = B
        ? (0, L.jsx)(T, {
            artifactType: `DOC`,
            title: $(o),
            centerContent: (0, L.jsx)(C, {
              currentPage: he,
              onNextPage: ge,
              onPreviousPage: _e,
              totalPages: x,
            }),
            rightContent: (0, L.jsxs)(`div`, {
              ...
              children: [
                (0, L.jsx)(b, {
                  ...
                  fitOption: { selected: ue, onSelect: ce },
                }),
                (0, L.jsx)(te, { hostId: i, path: a }),
                (0, L.jsx)(ee, { hostId: i, path: a, showLabel: !0 }),
              ],
            }),
          })
        : null),
  ...
  let W;
  t[31] !== m || t[32] !== fe
    ? ((W = h(m, fe)), (t[31] = m), (t[32] = fe), (t[33] = W))
    : (W = t[33]);
  let G = B ? J : `hidden`,
    K;
  t[34] !== N ||
  ...
  t[58] !== z
    ...
    : (q = t[59]);
  let Y;
  t[60] === g ? (Y = t[61]) : ((Y = re(g)), (t[60] = g), (t[61] = Y));
  let X;
  return (
    t[62] !== K || t[63] !== q || t[64] !== Y || t[65] !== H || t[66] !== U
      ? ((X = (0, L.jsxs)(`section`, {
...
function xe(e) {
  let t = (0, oe.c)(16),
    ...
    o = (0, I.useRef)(0),
    s = (0, I.useRef)(!1),
    [c, l] = (0, I.useState)(r == null ? `error` : `loading`),
    u;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((u = []), (t[0] = u)) : (u = t[0]);
  let [d, f] = (0, I.useState)(u),
    [p, m] = (0, I.useState)(0),
    h;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = () => {
        let e = i.current,
          t = a.current;
        e == null || t == null || (we({ bodyContainer: e, styleContainer: t }), f([]), m(0));
      }),
      (t[1] = h))
    : (h = t[1]);
  let g = h,
  ...
  t[2] !== n || t[3] !== r
    ? ((_ = () => {
        ...
        ((o.current = c),
          l(`loading`),
          Ce({ bytes: n, bodyContainer: e, renderAsync: r, styleContainer: t }).then((n) => {
            if (o.current !== c) return;
            if (!n) {
              (we({ bodyContainer: e, styleContainer: t }), l(`error`));
              return;
            }
            let r = Ee(e);
...
function Se(e) {
  let t = (0, I.useRef)(null),
    ...
    [i, a] = (0, I.useState)({ kind: `fit-width` }),
    o =
      i.kind === `fit-width`
        ? (Te({ bodyContainer: e.current, bodyContainerWidth: n, zoomPercent: X }) ?? X)
        : i.zoomPercent,
    s = m((e) => {
    ...
    l = (e) => {
      a({ kind: `percentage`, zoomPercent: x(e) });
    };
  return {
    fitToWidth: () => {
      let t = i.kind === `fit-width` ? null : De(e.current);
      Te({ bodyContainer: e.current, bodyContainerWidth: n, zoomPercent: o }) != null &&
        (a({ kind: `fit-width` }),
        t != null &&
...
async function Ce({ bytes: e, bodyContainer: t, renderAsync: n, styleContainer: r }) {
  try {
    return (await n(e, t, r, { className: q, renderAltChunks: !1, useBase64URL: !0 }), Ae(r), !0);
  } catch {
    return !1;
  }
}
function we({ bodyContainer: e, styleContainer: t }) {
  (e.replaceChildren(), t.replaceChildren());
}
function $(e) {
  return e.replace(/\.docx$/i, ``);
}
function Te({ bodyContainer: e, bodyContainerWidth: t, zoomPercent: n }) {
  ...
  return !Number.isFinite(l) || l <= 0 ? null : x(Math.round((s / l) * 100));
}
function Ee(e) {
...
function Ae(e) {
  ...
  ((t.textContent = Y), e.appendChild(t));
}
