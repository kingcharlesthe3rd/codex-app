...
function V() {
  ...
  g(`toggleSidebar`, i);
  let o;
  (e[2] === n ? (o = e[3]) : ((o = [n]), (e[2] = n), (e[3] = o)), l(`toggle-sidebar`, i, o));
}
var H,
  U = e(() => {
    ((H = n()), s(), E(), u(), i(), P());
...
function ue(e) {
  ...
  t[4] === n
    ? (c = t[5])
    : ((c = (e) => {
        (e.preventDefault(), n(), I.appUpdates?.installUpdate());
      }),
      (t[4] = n),
      (t[5] = c));
  let l, u;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, K.jsx)(T, { className: `sr-only`, children: i })),
      (u = (0, K.jsx)(w, { className: `sr-only`, children: o })),
      (t[6] = l),
      (t[7] = u))
    : ((l = t[6]), (u = t[7]));
  let f;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, K.jsx)(S, { children: (0, K.jsx)(x, { title: i, subtitle: o }) })), (t[8] = f))
    : (f = t[8]);
  let p;
  ...
  t[10] === n
    ? (h = t[11])
    : ((h = (0, K.jsx)(y, { color: `secondary`, onClick: n, children: p })),
      (t[10] = n),
      (t[11] = h));
  let g;
  ...
  t[13] === h
    ? (v = t[14])
    : ((v = (0, K.jsx)(S, { children: (0, K.jsxs)(ie, { children: [h, g] }) })),
      (t[13] = h),
      (t[14] = v));
  let b;
  t[15] !== v || t[16] !== c
    ? ((b = (0, K.jsxs)(d, { as: `form`, onSubmit: c, children: [l, u, f, v] })),
      (t[15] = v),
      (t[16] = c),
      (t[17] = b))
    : (b = t[17]);
...
function pe(e) {
  ...
  let v;
  return (
    t[20] !== p || t[21] !== s || t[22] !== u || t[23] !== g || t[24] !== _
      ? ((v = (0, Q.jsxs)(`button`, {
          "aria-label": p,
...
var Z,
  Q,
  me = e(() => {
    ((Z = n()), s(), k(), b(), re(), f(), X(), (Q = c()));
  }),
  $,
  he = e(() => {
    (s(), i(), ($ = r(t, null)));
  });
export { X as a, le as c, me as i, U as l, $ as n, J as o, pe as r, W as s, he as t, V as u };
