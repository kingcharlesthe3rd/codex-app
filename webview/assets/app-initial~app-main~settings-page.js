...
function H() {
  ...
  f(`toggleSidebar`, i);
  let o;
  (e[2] === n ? (o = e[3]) : ((o = [n]), (e[2] = n), (e[3] = o)), b(`toggle-sidebar`, i, o));
}
var U,
  W = e(() => {
    ((U = E()), s(), l(), F(), r(), y());
...
function le(e) {
  ...
  t[4] === r
    ? (d = t[5])
    : ((d = (e) => {
        (e.preventDefault(), r(), m.appUpdates?.installUpdate());
      }),
      (t[4] = r),
      (t[5] = d));
  let f, p;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, q.jsx)(c, { className: `sr-only`, children: a })),
      (p = (0, q.jsx)(x, { className: `sr-only`, children: l })),
      (t[6] = f),
      (t[7] = p))
    : ((f = t[6]), (p = t[7]));
  let h;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, q.jsx)(M, { children: (0, q.jsx)(n, { title: a, subtitle: l }) })), (t[8] = h))
    : (h = t[8]);
  let g;
  ...
  t[10] === r
    ? (_ = t[11])
    : ((_ = (0, q.jsx)(D, { color: `secondary`, onClick: r, children: g })),
      (t[10] = r),
      (t[11] = _));
  let y;
  ...
  t[13] === _
    ? (b = t[14])
    : ((b = (0, q.jsx)(M, { children: (0, q.jsxs)(v, { children: [_, y] }) })),
      (t[13] = _),
      (t[14] = b));
  let S;
  t[15] !== b || t[16] !== d
    ? ((S = (0, q.jsxs)(P, { as: `form`, onSubmit: d, children: [f, p, h, b] })),
      (t[15] = b),
      (t[16] = d),
      (t[17] = S))
    : (S = t[17]);
...
var Y,
  X = e(() => {
    ((Y = E()), s(), A(), O(), te(), h(), r(), oe(), ue(), fe());
  });
function pe(e) {
  let t = (0, Z.c)(26),
    n;
  t[0] === e ? (n = t[1]) : ((n = e === void 0 ? {} : e), (t[0] = e), (t[1] = n));
  let { overrideAppUpdateLifecycleState: r } = n,
    i = d(),
    a = w(V),
    o = J(),
    s = w(I),
    ...
    case `ready`: {
      ...
      (t[4] === i
        ...
        : ((e = i.formatMessage({
            ...
            defaultMessage: `Update`,
            description: `Button label that installs a downloaded desktop app update`,
          })),
          (t[4] = i),
          (t[5] = e)),
        (p = e));
              ...
              : i.formatMessage(
                  {
                    ...
                    description: `Button label while a desktop app update is downloading with progress`,
                  },
  ...
  let m;
  t[11] !== p || t[12] !== c || t[13] !== f || t[14] !== i
    ? ((m = c === `downloading` && f != null ? i.formatNumber(f / 100, { style: `percent` }) : p),
      (t[11] = p),
      (t[12] = c),
      (t[13] = f),
      (t[14] = i),
  ...
  let v;
  return (
    t[20] !== p || t[21] !== o || t[22] !== l || t[23] !== g || t[24] !== _
      ? ((v = (0, Q.jsxs)(`button`, {
          "aria-label": p,
...
var Z,
  Q,
  me = e(() => {
    ((Z = E()), s(), p(), z(), se(), _(), X(), (Q = j()));
  }),
  $,
  he = e(() => {
    (s(), r(), ($ = g(a, null)));
  });
export { X as a, ce as c, me as i, W as l, $ as n, J as o, pe as r, G as s, he as t, H as u };
//# sourceMappingURL=app-initial~app-main~settings-page.js.map
