...
import { f as a, p as o } from "./vscode-api.js";
import { l as s } from "./lib-1.js";
import { t as c } from "./clsx.js";
import { t as l } from "./spinner.js";
import { o as u } from "./statsig.js";
import { n as d } from "./electron-menu-shortcuts.js";
import { n as f } from "./use-hotkey.js";
import { i as p } from "./command-keybindings.js";
import { t as m } from "./progression-donut-BTBWT-Q8.js";
import { t as h } from "./image-preview-dialog-Bb-vTCJ6.js";
import { t as g } from "./attachment-remove-button.js";
var _ = e(t()),
  v = n(),
  y = (e) =>
    (0, v.jsx)(`svg`, {
...
function x(e) {
  let t = (0, b.c)(46),
    {
      ...
      loadingPercentage: u,
      previewEnabled: d,
      previewPortalContainer: f,
      onPreviewCloseAutoFocus: p,
      onPreviewOpenChange: y,
      previewItems: x,
      previewIndex: S,
      compact: C,
    } = e,
    w = i === void 0 ? `Attachment image` : i,
    T = o === void 0 ? !1 : o,
    E = d === void 0 ? !0 : d,
    D = S === void 0 ? 0 : S,
    O = C === void 0 ? !1 : C,
  ...
  let F = P,
    I;
  t[3] !== w || t[4] !== n
    ? ((I = { alt: w, src: n }), (t[3] = w), (t[4] = n), (t[5] = I))
    : (I = t[5]);
  let L = I,
    R;
  t[6] !== L || t[7] !== x ? ((R = x ?? [L]), (t[6] = L), (t[7] = x), (t[8] = R)) : (R = t[8]);
  let z = R,
    B = z[M] ?? L,
    V = M > 0 ? M - 1 : null,
    H = M + 1 < z.length ? M + 1 : null,
    U;
  if (
    t[9] !== w ||
    t[10] !== O ||
    ...
    let e =
      ...
      i = T || u != null,
      o = O ? `size-[54px]` : `size-20`,
      s = E ? `cursor-interaction` : `cursor-default`,
      d;
    t[20] !== o || t[21] !== s
      ? ((d = c(
    ...
    t[23] !== F || t[24] !== E
      ? ((f = E
          ? (e) => {
              (e.key === `Enter` || e.key === ` `) && (e.preventDefault(), F(!0));
            }
          : void 0),
        (t[23] = F),
        (t[24] = E),
    ...
    let p;
    t[26] !== w || t[27] !== n
      ? ((p = (0, v.jsx)(`img`, { src: n, alt: w, className: `size-full object-cover` })),
        (t[26] = w),
        (t[27] = n),
        (t[28] = p))
      : (p = t[28]);
    let h =
        ...
        (0, v.jsx)(`span`, {
          ...
          "aria-valuemin": 0,
          "aria-valuemax": 100,
          "aria-valuenow": u === 0 ? void 0 : u,
          children:
            u == null || u === 0
              ? (0, v.jsx)(l, { className: `size-6 text-token-text-secondary` })
              : (0, v.jsx)(m, { className: `text-white`, percent: u, size: 24, strokeWidth: 2 }),
        }),
      _;
    (t[29] !== p || t[30] !== h
      ? ((_ = (0, v.jsxs)(`span`, {
...
var S = `[data-codex-terminal]`,
  C = `input,textarea,[contenteditable]:not([contenteditable='false' i])`;
function w() {
  return i(p, `composer.startDictation`);
}
function T() {
  let e = (0, b.c)(2),
    t = w();
...
function E({ composerInput: e, focusedElement: t, isActiveComposer: n }) {
  return n && (e.contains(t) || t?.closest(C) == null);
}
function D(e) {
  let t = (0, b.c)(31),
    {
  ...
  let T = C,
    E;
  t[2] !== n || t[3] !== m || t[4] !== i || t[5] !== l || t[6] !== d
    ? ((E = () => (!n || i || (m != null && O(l, m)) ? !1 : d == null || d())),
      (t[2] = n),
      (t[3] = m),
      (t[4] = i),
      (t[5] = l),
  ...
  let D = E,
    k;
  t[8] !== D || t[9] !== r || t[10] !== h || t[11] !== T
    ? ((k = (e) => {
        !h ||
          !D() ||
          ((v.current = e.sessionId),
          a.dispatchMessage(`global-dictation-in-app-started`, { sessionId: e.sessionId }),
          !(r || x.current) && T());
      }),
      (t[8] = D),
      (t[9] = r),
    ...
    : (k = t[12]);
  let A;
  (t[13] === Symbol.for(`react.memo_cache_sentinel`) ? ((A = []), (t[13] = A)) : (A = t[13]),
    o(`global-dictation-in-app-start`, k, A));
  let j;
  t[14] !== h || t[15] !== c
    ? ((j = (e) => {
        !h || v.current !== e.sessionId || ((v.current = null), c(`insert`));
      }),
      (t[14] = h),
      (t[15] = c),
      (t[16] = j))
    : (j = t[16]);
  let M;
  (t[17] === Symbol.for(`react.memo_cache_sentinel`) ? ((M = []), (t[17] = M)) : (M = t[17]),
    o(`global-dictation-in-app-stop`, j, M));
  let N = g ?? ``,
    P = n && g != null,
    F = m ?? void 0,
    I;
  t[18] !== D || t[19] !== r || t[20] !== T
    ? ((I = (e) => {
        if ((e.preventDefault(), e.stopPropagation(), !D() || r || x.current)) {
          y.current = !1;
          return;
        }
        ((y.current = !0), T());
  ...
  t[22] === c
    ...
    : ((L = (e) => {
        (e.preventDefault(),
          e.stopPropagation(),
          !(!y.current || v.current != null) && ((y.current = !1), c(`insert`)));
      }),
      (t[22] = c),
      (t[23] = L));
  let R;
  (t[24] !== l || t[25] !== F || t[26] !== I || t[27] !== L || t[28] !== N || t[29] !== P
    ? ((R = {
        accelerator: N,
        enabled: P,
        ignoreWithin: F,
...
export { y as a, x as i, D as n, T as r, E as t };
//# sourceMappingURL=use-dictation-hotkey.js.map
