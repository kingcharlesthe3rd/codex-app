...
import { $ as r, it as i } from "./runtime.worker-CnG-97Cx.js";
import { t as a } from "./cytoscape.esm-2.js";
var o = r((e, t) => {
    (function (n, r) {
                  ...
                  (this.labelWidth > t &&
                    ...
                    this.labelHeight > n &&
                      (this.labelPos == `center`
                        ...
                        : this.labelPos == `top` && (this.rect.y -= this.labelHeight - n),
        ...
        function (e, t, n) {
          ...
          ((l.prototype.initParameters = function () {
            ...
            (l.prototype.calcIdealEdgeLengths = function () {
              for (
                var e, t, n, r, i, s, c = this.getGraphManager().getAllEdges(), l = 0;
                l < c.length;
                l++
              )
                ((e = c[l]),
            ...
            (l.prototype.calcRepulsionForce = function (e, t) {
              ...
              if (n.intersects(r)) {
                ...
                (this.uniformLeafNodeSizes && e.getChild() == null && t.getChild() == null
                  ...
                  (d = l * l + u * u),
                  (f = Math.sqrt(d)),
                  (p = (this.repulsionConstant * e.noOfChildren * t.noOfChildren) / d),
                  (m = (p * l) / f),
                  (h = (p * u) / f),
                  (e.repulsionForceX -= m),
                  (e.repulsionForceY -= h),
          ...
          ((a.prototype.move = function () {
            ...
            (a.prototype.propogateDisplacementToChildren = function (e, t) {
              for (var n = this.getChild().getNodes(), r, i = 0; i < n.length; i++)
                ((r = n[i]),
                  r.getChild() == null
                    ? (r.moveBy(e, t), (r.displacementX += e), (r.displacementY += t))
          ...
          ((v.prototype.newGraphManager = function () {
            ...
            (v.prototype.calculateNodesToApplyGravitationTo = function () {
              var e = [],
                ...
                i;
              for (i = 0; i < r; i++)
                ((t = n[i]), t.updateConnected(), t.isConnected || (e = e.concat(t.getNodes())));
              return e;
            }),
            ...
            (v.prototype.findPlaceforPrunedNode = function (e) {
              ...
              if (o > 0)
                for (var u = i; u <= a; u++)
                  c[0] += this.grid[u][o - 1].length + this.grid[u][o].length - 1;
              if (a < this.grid.length - 1)
                for (var u = o; u <= s; u++)
                  c[1] += this.grid[a + 1][u].length + this.grid[a][u].length - 1;
              if (s < this.grid[0].length - 1)
                for (var u = i; u <= a; u++)
                  c[2] += this.grid[u][s + 1].length + this.grid[u][s].length - 1;
              if (i > 0)
                for (var u = o; u <= s; u++)
                  c[3] += this.grid[i - 1][u].length + this.grid[i][u].length - 1;
              ...
              t == 0
                ? r.setCenter(
                    n.getCenterX(),
                    n.getCenterY() - n.getHeight() / 2 - l.DEFAULT_EDGE_LENGTH - r.getHeight() / 2,
                  )
                : t == 1
                  ? r.setCenter(
                      n.getCenterX() + n.getWidth() / 2 + l.DEFAULT_EDGE_LENGTH + r.getWidth() / 2,
                      n.getCenterY(),
                    )
                  : t == 2
                    ? r.setCenter(
          ...
          function (e, t, n) {
            ...
            var p = function (e) {
              (e.nodeRepulsion != null &&
                ...
                e.numIter != null && (a.MAX_ITERATIONS = i.MAX_ITERATIONS = e.numIter),
                e.gravityRange != null &&
            ...
            ((f.prototype.run = function () {
                  ...
                  (n.eles.nodes().positions(function (e, t) {
                    if ((typeof e == `number` && (e = t), !e.isParent())) {
                      for (
                        ...
                        r == null &&
                        ((r = u[i.data(`parent`)] || u[`DummyCompound_` + i.data(`parent`)]),
                        (u[n] = r),
                        (i = i.parent()[0]),
                        i != null);
                      );
              ...
              return (
                ...
                this.options.animate !== `during` &&
                  (i.options.eles.nodes().not(`:parent`).layoutPositions(i, i.options, m),
                  (e = !1)),
                this
              );
            }),
              ...
              (f.prototype.processChildrenList = function (e, t, n) {
                for (var r = t.length, i = 0; i < r; i++) {
                  ...
                  if (
                    ((u =
                      a.outerWidth() != null && a.outerHeight() != null
                        ? e.add(
                            new s(
                              n.graphManager,
                              new c(a.position(`x`) - d.w / 2, a.position(`y`) - d.h / 2),
                    ...
                    var f = a.boundingBox({ includeLabels: !0, includeNodes: !1 }).w,
                      p = a.boundingBox({ includeLabels: !0, includeNodes: !1 }).h,
                      m = a.css(`text-halign`);
...
function l(e, t) {
  e.forEach((e) => {
    ...
    (Object.keys(e).forEach((t) => {
      [`id`, `label`, `height`, `width`, `padding`, `x`, `y`].includes(t) || (n[t] = e[t]);
    }),
      t.add({ group: `nodes`, data: n, position: { x: e.x ?? 0, y: e.y ?? 0 } }));
  });
}
t(l, `addNodes`);
function u(e, t) {
...
function d(t) {
  return new Promise((r) => {
    let i = n(`body`).append(`div`).attr(`id`, `cy`).attr(`style`, `display:none`),
      o = a({
...
async function m(t, n) {
  ...
  try {
    ...
    let n = await d(t),
      ...
      i = p(n);
    return (
      e.debug(`Layout completed: ${r.length} nodes, ${i.length} edges`), { nodes: r, edges: i }
    );
  } catch (t) {
      ...
      await Promise.all(
        e.nodes.map(async (t) => {
          if (t.isGroup) {
            ...
            let n = { ...t };
            u[t.id] = n;
            let r = await o(_, t, { config: e.config, dir: e.direction || `TB` }),
              i = r.node().getBBox();
            ((n.width = i.width),
              (n.height = i.height),
              (n.domId = r),
...
export { g as render };
//# sourceMappingURL=cose-bilkent-5.js.map
