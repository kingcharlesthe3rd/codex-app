...
import { Gu as g, Wu as _ } from "./app-initial~app-main~onboarding-page.js";
import {
  Nt as v,
  Pt as y,
  Qs as b,
...
function N() {
  let e = (0, F.c)(8),
    ...
    [a] = f(D),
    o;
  e[0] === t ? (o = e[1]) : ((o = v(t)), (e[0] = t), (e[1] = o));
  let { data: s, isError: c, isFetching: u, isPending: m } = d(o);
  if (m || n == null) return null;
  let h;
  return (
    e[2] !== c || e[3] !== u || e[4] !== s || e[5] !== n.status || e[6] !== a
      ? ((h = (0, L.jsx)(P, {
          isMfaSetupRequiredError: c,
          isMfaSetupRequiredFetching: u,
          mfaSetupRequired: s,
          remoteControlStatus: n.status,
          setupStepDebugOverride: a,
        })),
        (e[2] = c),
        (e[3] = u),
        (e[4] = s),
...
function P(e) {
  ...
  if (
    ...
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, L.jsx)(_.MainContentLayout, { layout: `full-bleed` })), (t[0] = e))
      : (e = t[0]);
    let r;
    t[1] !== n || t[2] !== i || t[3] !== a
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, L.jsx)(_.MainContentLayout, { layout: `full-bleed` })), (t[10] = l))
    : (l = t[10]);
  let u;
  return (
    t[11] === s
