import{s as e}from"./chunk-Cq_f4orQ.js";import{R as t,s as n}from"./app-scope-DbsKKT7R.js";import{js as r,nt as i}from"./app-server-manager-signals-Coif6OOI.js";import{_ as a,k as o,m as s,n as c,r as l,u as ee}from"./vscode-api-B47PzOKa.js";import{$n as u,Qn as d,Xn as f,_t as p,at as m,cr as h,fr as g,it as _,or as v,sr as y,ur as te}from"./src-B2PlTT4D.js";import{N as b}from"./rpc-ByJrNKRv.js";import{o as ne}from"./statsig-DDfKhM_I.js";import{t as re}from"./invalidate-queries-and-broadcast-COTFeohn.js";import{d as ie}from"./thread-context-inputs-D1JJ8POE.js";import{n as ae}from"./use-auth-BHpTBC0P.js";import{t as oe}from"./use-codex-home-D6dcWdO0.js";import{i as se,n as ce,r as le,t as ue}from"./use-is-plugins-enabled-C2u3hkmC.js";function de(){return window.electronBridge?.getBuildFlavor?.()||`prod`}var x=`<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`].map(e=>`data:image/svg+xml,${encodeURIComponent(e)}`);function M(e){let t=0;for(let n=0;n<e.length;n+=1)t=(t*31+e.charCodeAt(n))%j.length;return j[t]??``}var N=e(g(),1),P={".svg":`image/svg+xml`,".png":`image/png`,".jpg":`image/jpeg`,".jpeg":`image/jpeg`,".webp":`image/webp`,".gif":`image/gif`,".avif":`image/avif`};async function F(e,t,n){let r=I(e);if(r==null)return null;try{let e={path:r,hostId:t},i=await n.fetchQuery({queryFn:({signal:t})=>c(`read-file-binary`,{params:e,signal:t}),queryKey:l(`read-file-binary`,e),retry:!1,gcTime:1/0,staleTime:ee.INFINITE});return i.contentsBase64?`data:${L(r)};base64,${i.contentsBase64}`:null}catch(e){return s.warning(`Failed to inline local image`,{safe:{},sensitive:{error:e,resolvedImagePath:r}}),null}}function I(e){if(e==null)return null;let t=e.trim();if(t.length===0)return null;let n=t.toLowerCase();if(n.startsWith(`data:`)||n.startsWith(`http:`)||n.startsWith(`https:`)||n.startsWith(`file:`)||n.startsWith(`vscode-resource:`)||n.startsWith(`vscode-webview:`)||n.startsWith(`vscode-file:`))return null;let r=te(t);return v(r)?r:null}function L(e){return P[N.default.extname(e).toLowerCase()]??`application/octet-stream`}var me=t(),R=[`plugins`],z=`openai-curated-marketplaces-hidden`,B=4,he=[],ge=[],_e=[],ve=[],ye=[],V=[],be=[_],xe=[_,m],H=`computer-use`,U=`.tmp/marketplaces/openai-internal-testing`,W=[`datadog`,`statsig`],G=new Set([`codex-official`,f,_,m,`openai-primary-runtime`].map(Ue));function K(e){return{...Ze(e.summary),description:e.summary.interface?.shortDescription??e.description??null,displayName:e.summary.interface?.displayName??null,marketplaceDisplayName:null,marketplaceName:e.marketplaceName,plugin:e.summary,keywords:e.summary.keywords,...Ce({marketplaceName:e.marketplaceName,marketplacePath:e.marketplacePath})}}function q({marketplacePath:e,remoteMarketplaceName:t}){if(e!=null&&t!=null)throw Error(`plugin marketplace request requires one marketplace source`);if(e!=null)return{marketplacePath:e};if(t!=null)return{remoteMarketplaceName:t};throw Error(`plugin marketplace request requires a marketplace source`)}function J(e){return e.marketplacePath??`remote:${e.remoteMarketplaceName}`}function Se(e){return e.filter(e=>{let t=$(e).toLowerCase();return!W.some(e=>t===e||t.startsWith(`${e}-`))})}function Y(e){return e.marketplacePath==null?Z(e.plugin):e.plugin.name}function X(e){return e.marketplacePath==null?Z(e.plugin):e.plugin.id}function Z(e){if(e.remotePluginId==null)throw Error(`remote plugin ${e.id} is missing remotePluginId`);return e.remotePluginId}function Q(e){return{...q(e),pluginName:Y(e)}}function Ce({marketplaceName:e,marketplacePath:t}){return t==null?{marketplacePath:null,remoteMarketplaceName:e}:{marketplacePath:t,remoteMarketplaceName:null}}function we(e,t,s){let c=(0,me.c)(53),l;c[0]===e?l=c[1]:(l={hostId:e},c[0]=e,c[1]=l);let u=ue(l)&&(s?.enabled??!0),d=s?.additionalMarketplaceKinds??_e,f=s?.installSuggestionPluginNames??null,p=ne(`4218407052`),m=pe(ae(e)?.authMethod??null),h=ve;m?h=xe:p&&(h=be);let g=Ae({additionalMarketplaceKinds:d,includeRemoteCatalog:s?.includeRemoteCatalog??!0,includeVerticalCatalog:!p}),_=re(),v=o(),y=n(ie),te=oe(e),b=n(i),x;c[2]!==e||c[3]!==b?(x=b.includes(e),c[2]=e,c[3]=b,c[4]=x):x=c[4];let S=x,C=u&&S,w;c[5]!==e||c[6]!==C?(w={enabled:C,hostId:e},c[5]=e,c[6]=C,c[7]=w):w=c[7];let T=se(w),E;c[8]===e?E=c[9]:(E={hostId:e},c[8]=e,c[9]=E);let D=ce(E),O;c[10]===e?O=c[11]:(O={hostId:e},c[10]=e,c[11]=O);let k=le(O),fe=t===void 0,A=qe({codexHome:te,hostId:e,rootsOverrideCwd:t,workspaceRoots:y.data?.roots}),j=u&&S&&(t!==void 0||y.isFetched),M;c[12]===Symbol.for(`react.memo_cache_sentinel`)?(M=de(),c[12]=M):M=c[12];let N=M,P=f==null?je(e,A,g,p,m):Oe(e,A,_e,f,p,m),F;c[13]!==N||c[14]!==h||c[15]!==e||c[16]!==f||c[17]!==g||c[18]!==v||c[19]!==A?(F=async()=>{if(f!=null){let t=await r(`send-cli-request-for-host`,{hostId:e,method:`plugin/installed`,params:{...A.length>0?{cwds:A}:{},installSuggestionPluginNames:f}}),n=Ne(t.marketplaces,h),i=Xe(n);return{featuredPluginIds:he,marketplaceLoadErrors:t.marketplaceLoadErrors,marketplaces:Ge(n),plugins:await Ke({hostId:e,plugins:i,queryClient:v})}}let t=await r(`list-plugins`,g==null?{hostId:e,...A.length>0?{cwds:A}:{}}:{hostId:e,...A.length>0?{cwds:A}:{},marketplaceKinds:g}),n=Ne(t.marketplaces,h),i=Xe(n),a=N==null?i:He({buildFlavor:N,plugins:i}),o=Se(t.featuredPluginIds).filter(e=>!h.some(t=>e.endsWith(`@${t}`)));return{featuredPluginIds:N==null?o:Ve({buildFlavor:N,featuredPluginIds:o}),marketplaceLoadErrors:t.marketplaceLoadErrors,marketplaces:Ge(n),plugins:await Ke({hostId:e,plugins:a,queryClient:v})}},c[13]=N,c[14]=h,c[15]=e,c[16]=f,c[17]=g,c[18]=v,c[19]=A,c[20]=F):F=c[20];let I;c[21]!==j||c[22]!==P||c[23]!==F?(I={queryKey:P,queryFn:F,enabled:j,staleTime:ee.FIVE_MINUTES,gcTime:1/0},c[21]=j,c[22]=P,c[23]=F,c[24]=I):I=c[24];let L=a(I);if(!u||!S){let e;return c[25]===Symbol.for(`react.memo_cache_sentinel`)?(e={availablePlugins:V,featuredPluginIds:he,installedPlugins:V,marketplaceLoadErrors:ge,marketplaces:ye,errorMessage:null,isLoading:!1,isFetching:!1,refetch:Ee,forceReload:Te},c[25]=e):e=c[25],e}let z,B,H,U;c[26]!==T.available||c[27]!==k.available||c[28]!==D.available||c[29]!==L.data?.featuredPluginIds||c[30]!==L.data?.plugins?(z={isComputerUseAvailable:T.available,isExternalBrowserUseAvailable:k.available,isInAppBrowserUseAvailable:D.available},B=L.data?.plugins??V,H=Fe({plugins:B,...z}),U=Pe({featuredPluginIds:L.data?.featuredPluginIds??he,...z}),c[26]=T.available,c[27]=k.available,c[28]=D.available,c[29]=L.data?.featuredPluginIds,c[30]=L.data?.plugins,c[31]=z,c[32]=B,c[33]=H,c[34]=U):(z=c[31],B=c[32],H=c[33],U=c[34]);let W;c[35]===B?W=c[36]:(W=Ie(B),c[35]=B,c[36]=W);let G=L.data?.marketplaceLoadErrors??ge,K=L.data?.marketplaces??ye,q=L.error?String(L.error.message):null,J=fe&&y.isLoading||L.isLoading||D.isLoading||k.isLoading||T.isLoading,Y=fe&&y.isFetching||L.isFetching||T.isFetching,X;c[37]!==z||c[38]!==L?(X=async()=>{let e=(await L.refetch()).data?.plugins??V;return{availablePlugins:Fe({plugins:e,...z}),installedPlugins:Ie(e)}},c[37]=z,c[38]=L,c[39]=X):X=c[39];let Z;c[40]===_?Z=c[41]:(Z=()=>_(R),c[40]=_,c[41]=Z);let Q;return c[42]!==H||c[43]!==U||c[44]!==W||c[45]!==G||c[46]!==K||c[47]!==q||c[48]!==J||c[49]!==Y||c[50]!==X||c[51]!==Z?(Q={availablePlugins:H,featuredPluginIds:U,installedPlugins:W,marketplaceLoadErrors:G,marketplaces:K,errorMessage:q,isLoading:J,isFetching:Y,refetch:X,forceReload:Z},c[42]=H,c[43]=U,c[44]=W,c[45]=G,c[46]=K,c[47]=q,c[48]=J,c[49]=Y,c[50]=X,c[51]=Z,c[52]=Q):Q=c[52],Q}async function Te(){}async function Ee(){return{availablePlugins:V,installedPlugins:V}}function De(e){let t=(0,me.c)(10),{enabled:n,hostId:i,marketplaceKind:o}=e,s=n===void 0?!0:n,c;t[0]===i?c=t[1]:(c={hostId:i},t[0]=i,t[1]=c);let l=ue(c),u,d;t[2]!==i||t[3]!==o?(u=[...R,`marketplace-kind`,i,o],d=async()=>Xe((await r(`list-plugins`,{hostId:i,marketplaceKinds:[o]})).marketplaces),t[2]=i,t[3]=o,t[4]=u,t[5]=d):(u=t[4],d=t[5]);let f=s&&l,p;return t[6]!==u||t[7]!==d||t[8]!==f?(p={queryKey:u,queryFn:d,enabled:f,staleTime:ee.FIVE_MINUTES},t[6]=u,t[7]=d,t[8]=f,t[9]=p):p=t[9],a(p)}function Oe(e,t,n=_e,r=null,i=!1,a=!1){return r==null?je(e,t,Ae({additionalMarketplaceKinds:n,includeRemoteCatalog:!0,includeVerticalCatalog:!i}),i,a):ke([...R,e,t,`installed`,r,`curated-marketplace`,Me(i)],a)}function ke(e,t){return t?[...e,z]:e}function Ae({additionalMarketplaceKinds:e,includeRemoteCatalog:t,includeVerticalCatalog:n}){return t&&!n&&e.length===0?null:n?[`local`,`vertical`,...e]:[`local`,...e]}function je(e,t,n,r,i){let a=Me(r);return ke(n==null?[...R,e,t,`curated-marketplace`,a]:[...R,e,t,`marketplace-kinds`,n,`curated-marketplace`,a],i)}function Me(e){return e?m:_}function Ne(e,t){return t.length===0?e:e.filter(e=>!t.includes(e.name))}function Pe({featuredPluginIds:e,...t}){return e.filter(e=>Le(e,t))}function Fe({plugins:e,...t}){return e.filter(e=>Le(e.plugin.id,t))}function Ie(e){return e.filter(e=>e.plugin.installed)}function Le(e,{isComputerUseAvailable:t,isExternalBrowserUseAvailable:n,isInAppBrowserUseAvailable:r}){return!(!r&&Re(e)||!n&&ze(e)||!t&&Be(e))}function Re(e){let t=$(e);return t===`browser`||t===`browser-use`}function ze(e){let t=$(e);return t===`chrome`||t===`chrome-dev`||t===`chrome-internal`}function Be(e){return $(e)===H}function $(e){return e.split(`@`)[0]}function Ve({buildFlavor:e,featuredPluginIds:t}){let n=d(e);return t.filter(e=>{let t=p(e);return t==null?!0:!u(t)||t===n})}function He({buildFlavor:e,plugins:t}){let n=d(e);return t.filter(e=>!u(e.marketplaceName)||e.marketplaceName===n)}function Ue(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function We(e){return G.has(Ue(e))}function Ge(e){let t=new Map;for(let n of e){let e=`${n.name}\u0000${n.path??``}`;if(t.has(e))continue;let r=We(n.name);t.set(e,{displayName:n.interface?.displayName??null,isBuiltIn:r,name:n.name,path:n.path,pluginCount:n.plugins.length})}return Array.from(t.values()).sort((e,t)=>{let n=e.displayName?.trim()||e.name,r=t.displayName?.trim()||t.name;return n.localeCompare(r)})}async function Ke({hostId:e,plugins:t,queryClient:n}){let r=[...t];async function i(a){let o=t[a];if(o==null)return;let[s,c]=await Promise.all([F(o.composerIconPath,e,n),F(o.logoPath,e,n)]);(s!=null||c!=null)&&(r[a]={...o,composerIconPath:s??o.composerIconPath,logoPath:c??o.logoPath,plugin:o.plugin.interface?{...o.plugin,interface:{...o.plugin.interface,...s==null?{}:{composerIcon:s},...c==null?{}:{logo:c}}}:o.plugin}),await i(a+B)}return await Promise.all(Array.from({length:Math.min(B,t.length)},(e,t)=>i(t))),r}function qe({codexHome:e,hostId:t,rootsOverrideCwd:n,workspaceRoots:r}){let i=t===`local`&&e!=null?b(e,U):null;return Je([...typeof n==`string`?[n]:n??r??[],...i==null?[]:[i]],e)}function Je(e,t){return Array.from(new Set(e.map(e=>e.trim()).filter(e=>v(e)&&Ye(e,t))))}function Ye(e,t){return t==null?!0:y(t)||h(t)?y(e)||h(e):e.startsWith(`/`)&&!e.startsWith(`//`)}function Xe(e){let t=new Map;for(let n of e)for(let e of n.plugins)t.has(e.id)||t.set(e.id,{...Ze(e),description:e.interface?.shortDescription??null,displayName:e.interface?.displayName??null,marketplaceDisplayName:n.interface?.displayName??null,marketplaceName:n.name,plugin:e,keywords:e.keywords,...Ce({marketplaceName:n.name,marketplacePath:n.path})});return Array.from(t.values())}function Ze(e){let t=O(e);if(t!=null)return{composerIconPath:t,logoPath:t};let n=e.interface?.composerIcon??e.interface?.composerIconUrl??null,r=e.interface?.logo??e.interface?.logoUrl??null;if(n!=null||r!=null)return{composerIconPath:n,logoPath:r};let i=M(e.id);return{composerIconPath:i,logoPath:i}}export{F as _,q as a,X as c,Be as d,ze as f,I as g,De as h,J as i,Z as l,we as m,K as n,Q as o,Re as p,Ze as r,Y as s,R as t,We as u,pe as v,de as y};
//# sourceMappingURL=use-plugins-BseDp1AO.js.map