...
import { Fa as t } from "./app-server-manager-signals.js";
  ...
  let Nt = ec((e) => {
    ...
    It = ec(
      (e, { restoreTreeFocus: n = !0, targetOffset: r = `live-overlay` } = {}) => {
        ...
        return (
          (A.current = !0), As(i, a, s, l, u, d), T.current(), (Oe.current = n ? e : null), !0
        );
      },
      [t, s, c, H, h],
    ),
...
function eu(e) {
  ...
  let ue = le,
    de = (0, N.useRef)(null),
    fe;
  n[12] === l ? (fe = n[13]) : ((fe = Array.from(l ?? [])), (n[12] = l), (n[13] = fe));
  ...
  n[14] === S
    ? (ve = n[15])
    : ((ve = () => {
        S?.({ expandedPaths: pe.current, scrollTop: ge.current, selectedPath: _e.current });
      }),
      (n[14] = S),
      (n[15] = ve));
  let ye = v(ve),
  ...
  n[89] !== Re || n[90] !== ze || n[91] !== He
    ? ((Ue = (0, P.jsx)(y, { awaitBeforeOpen: !1, getItems: Re, onBeforeOpen: ze, children: He })),
      (n[89] = Re),
      (n[90] = ze),
      (n[91] = He),
      (n[92] = Ue))
...
function au({ cwd: e, fallbackOpenTargets: t, hostId: n, queryClient: r, targetPath: i }) {
  ...
  return {
    ...
    primaryTarget: ee({ preferredTarget: l, targets: s, availableTargets: c, mode: u }),
    visibleTargets: C({ targets: s, availableTargets: c, includeHiddenTargets: !0, mode: u }),
  };
}
function ou({ cwd: e, hostId: t, queryClient: n, targetPath: r }) {
  if (r != null)
    return n.prefetchQuery({
      ...
      queryFn: () => l(`open-in-targets`, { params: { cwd: e, hostId: t, path: r } }),
...
function hu(e) {
  let t = (0, Zl.c)(23),
    { autoFocus: n, inputId: r, inputRef: i, onQueryChange: o, searchQuery: c } = e,
  ...
  t[1] === l
    ? (f = t[2])
    : ((f = (0, P.jsx)(`label`, { className: `sr-only`, htmlFor: l, children: d })),
      (t[1] = l),
      (t[2] = f));
  let h;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (h = t[3]);
  let g;
  t[4] === o ? (g = t[5]) : ((g = (e) => o(e.target.value)), (t[4] = o), (t[5] = g));
  let _;
  t[6] === u
    ? (_ = t[7])
    : ((_ = u.formatMessage({
      ...
      (t[7] = _));
  let v;
  t[8] !== n || t[9] !== l || t[10] !== i || t[11] !== c || t[12] !== g || t[13] !== _
    ? ((v = (0, P.jsx)(`input`, {
        autoFocus: n,
        id: l,
        ref: i,
