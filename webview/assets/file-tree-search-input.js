...
import { A as i, n as a, r as o, s, u as c } from "./vscode-api.js";
import { l, r as u, s as d } from "./lib.js";
import { t as f } from "./button.js";
import { t as p } from "./use-stable-callback.js";
import { t as m } from "./context-menu.js";
import { t as h } from "./x.js";
import { k as g } from "./rpc-Hf-fxjh7.js";
import { t as _ } from "./search.js";
import { t as v } from "./use-platform.js";
import { i as y, n as b, r as x, t as S } from "./iconResolver.js";
import { t as C } from "./store-tmKc-0Lx.js";
import { n as w, r as ee } from "./use-resolved-theme-variant.js";
import { t as T } from "./open-target-context-menu-items.js";
import { n as E, r as D } from "./open-target-selection.js";
import { t as O } from "./copy-to-clipboard.js";
import { n as k, t as A } from "./use-target-apps.js";
var j = `file-tree-container`,
  M = `data-file-tree-style`,
  N = `data-file-tree-unsafe-css`,
  P = `data-file-tree-scrollbar-measure`,
  F = `data-file-tree-scrollbar-gutter-measured`,
  te = `--trees-scrollbar-gutter-measured`,
  ne = `header`,
  re = `context-menu`,
  ie = `context-menu-trigger`,
  I = {
...
function ae(e, t) {
  if (typeof e == `number`) return { itemHeight: t ?? I.default.itemHeight, factor: e };
  let n = I[e ?? `default`];
  return { itemHeight: t ?? n.itemHeight, factor: n.factor };
}
var oe = I.default.itemHeight,
  se = `@layer base, theme, unsafe;
...
function fe(e) {
  ...
  return (n.remove(), de.set(e, i), i);
}
function pe(e, t) {
  if (!e.isConnected) return;
  let n = fe(t);
  if (n == null) return;
  let r = t.querySelector(`style[${F}]`),
    i = r instanceof HTMLStyleElement ? r : document.createElement(`style`);
  (r instanceof HTMLStyleElement || (i.setAttribute(F, ``), t.appendChild(i)),
    (i.textContent = `:host { ${te}: ${n}px; }`));
}
var L;
function me(e) {
  if (
    ...
    L ?? ((L = new CSSStyleSheet()), L.replaceSync(le(se)));
    let t = !1;
    try {
      ((e.adoptedStyleSheets = [L]), (t = !0));
    } catch {}
    if (t) {
      e.querySelector(`style[${M}]`)?.remove();
      return;
    }
  }
  if (e.querySelector(`style[data-file-tree-style]`) == null) {
    let t = document.createElement(`style`);
    (t.setAttribute(M, ``), (t.textContent = le(se)), e.prepend(t));
  }
}
function R(e, t) {
  (he(e, t), me(t), pe(e, t));
...
if (typeof HTMLElement < `u` && customElements.get(`file-tree-container`) == null) {
  ...
  if ((customElements.define(j, e), typeof document < `u`))
    for (let e of Array.from(document.querySelectorAll(j)))
      e instanceof HTMLElement && R(e, e.shadowRoot ?? e.attachShadow({ mode: `open` }));
}
var ge = (e) => (e.startsWith(`f::`) ? e.slice(3) : e);
function _e(e) {
  let t = e.lastIndexOf(`/`);
  return t < 0
...
function Te(e, t) {
  ...
  for (let n of e) if (be(n) && (t.directoryPath === n || t.directoryPath.startsWith(n))) return !0;
  return !1;
}
function B(e, t) {
  return t.kind === `root` || t.directoryPath == null ? xe(e) : t.directoryPath;
}
function Ee(e, t) {
  let n = e
    .map((e) => {
...
function Oe(e, t, n) {
  ...
  if (!De(C.preparePaths(r, n == null ? {} : { sort: n }), a))
...
function Me(e, t, n = !1) {
  ...
  switch (t.operation) {
    ...
    case `cleanup`:
      return e;
    case `remove`:
      return je(e, t.path) ? (n ? e : null) : e;
    case `move`:
      return Ae(e, t.from, t.to);
    case `batch`: {
      let r = e;
      for (let e of t.events) if (((r = Me(r, e, n)), r == null)) return null;
      return r;
    }
  }
}
...
function Pe(e) {
  switch (e.operation) {
    case `add`:
      return { ...Ne(e), operation: `add`, path: e.path };
    case `remove`:
      return { ...Ne(e), operation: `remove`, path: e.path, recursive: e.recursive };
    case `move`:
      return { ...Ne(e), from: e.from, operation: `move`, to: e.to };
  }
}
function Fe(e) {
  return {
...
var Ke = (e) => {
  ...
  qe = Symbol(`FILE_TREE_RENAME_VIEW`),
  Je = 512,
  Ye = 512;
function Xe(e) {
...
function Qe(e, t, n) {
  ...
  return {
    focusedIndex: Ze(e.paths.length, r, t),
    getParentIndex: e.getParentIndex,
    paths: e.paths,
    posInSetByIndex: e.posInSetByIndex,
    setSizeByIndex: e.setSizeByIndex,
...
var $e = class {
    ...
    constructor(e) {
      let {
        ...
        u = Oe({ paths: s, preparedInput: c }, `constructor`, l.sort);
      ((this.#e = l),
    ...
    scrollToPath(e, t) {
      ...
      r < 0 ||
        (this.#Me(r) != null &&
          ...
          (this.#L = { id: (this.#R += 1), offset: Xe(t?.offset), visibleIndex: r }),
          this.#De()));
    }
    ...
    getVisibleRows(e, t) {
      ...
      if (r < n) return [];
      let i = r - n + 1;
      if (this.#F == null && !this.#l && r >= this.#b.length && i <= Ye) {
        let e = [];
        for (let t = n; t <= r; t += 1) {
    ...
    setDragTarget(e) {
      ...
      let n = e;
      if (n != null) {
        let e = we(t.draggedPaths, n);
        (Te(t.draggedPaths, n) || this.#r?.canDrop?.(e) === !1) && (n = null);
      }
      Ce(t.target, n) || ((this.#i = { ...t, target: n }), this.#De());
    }
    cancelDrag() {
    ...
    completeDrag() {
      ...
      let n = we(e.draggedPaths, t);
      if (Te(e.draggedPaths, t) || this.#r?.canDrop?.(n) === !1) return (this.#De(), !1);
      let r = Ee(e.draggedPaths, t);
    ...
    startRenaming(e = this.#c ?? ``, t = {}) {
      ...
      for (let e of Re(r)) this.#H.isExpanded(e) || this.#H.expand(e);
      return (
        this.#ae([r], r, !1),
    ...
    #q() {
      ...
      if (((this.#T = null), (this.#E = ``), (this.#D = !1), t)) {
        this.remove(e, Ve(e) ? { recursive: !0 } : void 0);
        return;
      }
      (this.#Pe(e), this.#De());
    }
    #J() {
      ...
      let t = Ve(e),
        n = ye({ files: this.#H.list(), isFolder: t, nextBasename: this.#E, path: We(e) });
      ...
      (this.#_?.({
        ...
        this.move(Ge(n.sourcePath, t), Ge(n.destinationPath, t)));
    }
    #Y(e) {
    ...
    resetPaths(e, t = {}) {
      let n = this.#H.list().length,
        r = this.#G,
        i = Oe({ paths: e, preparedInput: t.preparedInput }, `resetPaths`, this.#e.sort),
    ...
    #de() {
      ...
      for (let t of this.#ue()) {
        e.add(t);
        for (let n of Re(t)) e.add(n);
      }
      return ((this.#m = [...e].sort()), this.#m);
    }
    #fe() {
      return ((this.#g ??= this.#ue().map(He)), this.#g);
    }
    #pe() {
      return ((this.#f ??= this.#de().filter((e) => e.endsWith(`/`))), this.#f);
    }
    #me() {
      return ((this.#p ??= this.#pe().map(He)), this.#p);
    }
    #he() {
    ...
    #_e(e) {
      ...
      if (e) for (let e of this.#B) for (let n of Re(e)) t.add(n);
      this.#ve(t);
    }
    #ve(e) {
      this.#W = !0;
    ...
    #Ee() {
      ...
      for (let e of r) {
        ...
        for (let t of Re(e)) (l.add(t), c?.add(t));
      }
    ...
    #ke(e) {
      for (let t of Re(e)) this.#H.isExpanded(t) || this.#H.expand(t);
    ...
    #je(e, t = !0) {
      ...
      this.#U = n;
      let r = Qe(
        this.#H.getVisibleTreeProjectionData(t ? void 0 : Math.min(n, Je)),
        e,
    ...
    #Le(e) {
      ...
      let n = Me(this.#c, e, !0),
        ...
        o = [...new Set(r)];
      return (Le(this.#B, o) || ((this.#B = new Set(o)), (this.#V += 1)), (this.#z = a), n);
    }
    #Re() {
      return this.#H.on(`*`, (e) => {
        if (this.#W) return;
        (e.canonicalChanged && (this.#d.clear(), this.#he()),
          this.#i != null && ke(e) && (this.#i = null));
        let t = ke(e) ? this.#Le(e) : this.#c,
...
function gt(e, t, n) {
  ...
  return (
    arguments.length > 2 && (o.children = arguments.length > 3 ? mt.call(arguments, 2) : n),
    K(e, o, r, i, null)
  );
}
...
function vt(e, t) {
  if (t == null) return e.__ ? vt(e.__, e.__i + 1) : null;
...
function bt(e) {
  ((8 & e.__g || !(e.__g |= 8) || !H.push(e) || U++) && ot == V.debounceRendering) ||
    ((ot = V.debounceRendering) || queueMicrotask)(xt);
}
function xt() {
  for (var e, t, n, r, i, a, o, s, c = 1; H.length; )
    (H.length > c && H.sort(W),
      (e = H.shift()),
      (c = H.length),
      8 & e.__g &&
...
function St(e, t, n, r, i, a, o, s, c, l, u, d) {
  var f,
    p,
    m,
    h,
    ...
    y = (r && r.__k) || ft,
    b = t.length;
  for (c = Ct(n, t, y, c, b), f = 0; f < b; f++)
    (m = n.__k[f]) != null &&
      ((p = m.__i == -1 ? dt : y[m.__i] || dt),
      (m.__i = f),
      (_ = kt(e, m, p, i, a, o, s, c, l, u, d)),
      (h = m.__e),
      m.ref && p.ref != m.ref && (p.ref && Pt(p.ref, null, m), u.push(m.ref, m.__c || h, m)),
      g == null && h != null && (g = h),
...
function Ct(e, t, n, r, i) {
  ...
  if (d)
    for (a = 0; a < u; a++)
      (s = n[a]) != null && !(2 & s.__u) && (s.__e == r && (r = vt(s)), Ft(s, s));
  return r;
}
function wt(e, t, n, r) {
  var i, a;
  if (typeof e.type == `function`) {
    for (i = e.__k, a = 0; i && a < i.length; a++) i[a] && ((i[a].__ = e), (t = wt(i[a], t, n, r)));
    return t;
  }
  e.__e != t &&
    (r && (t && e.type && !t.parentNode && (t = vt(e)), n.insertBefore(e.__e, t || null)),
    (t = e.__e));
  do t &&= t.nextSibling;
  ...
  n: if (t == `style`)
    ...
    ((a = t != (t = t.replace(st, `$1`))),
      ...
      n
        ? r
          ? (n.l = r.l)
          : ((n.l = ct), e.addEventListener(t, a ? ut : lt, a))
        : e.removeEventListener(t, a ? ut : lt, a));
  else {
    ...
    try {
      if (
        ...
        n.__c
          ...
          : (y
              ? (t.__c = f = new j(v, x))
              : ((t.__c = f = new _t(v, x)), (f.constructor = j), (f.render = It)),
            b && b.sub(f),
            (f.props = v),
            (f.state ||= {}),
            (f.context = x),
        ...
        y &&
          ...
          (f.__s == f.state && (f.__s = ht({}, f.__s)),
          ht(f.__s, j.getDerivedStateFromProps(v, f.__s))),
        (m = f.props),
        (h = f.state),
        (f.__v = t),
        p)
      ...
      if (((f.context = x), (f.props = v), (f.__P = e), (f.__g &= -5), (C = V.__r), (w = 0), y)) {
        for (
          f.state = f.__s,
            f.__g &= -9,
            C && C(t),
        ...
        while (8 & f.__g && ++w < 25);
      ((f.state = f.__s),
        f.getChildContext != null && (r = ht({}, r, f.getChildContext())),
        y && !p && f.getSnapshotBeforeUpdate != null && (g = f.getSnapshotBeforeUpdate(m, h)),
        (T = d),
        d != null && d.type === q && d.key == null && (T = Mt(d.props.children)),
        (s = St(e, pt(T) ? T : [T], t, n, r, i, a, o, s, c, l, u)),
        (t.__u &= -161),
      ...
      if (((t.__v = null), c || a != null))
        if (e.then) {
          for (E = 0, D = !1, t.__u |= c ? 160 : 128, t.__c.__z = [], O = 0; O < a.length; O++)
            (k = a[O]) == null ||
              D ||
              (k.nodeType == 8 && k.data == `$s`
                ? (E > 0 && t.__c.__z.push(k), E++, (a[O] = null))
                : k.nodeType == 8 && k.data == `/$s`
                  ? (--E > 0 && t.__c.__z.push(k), (D = E === 0), (s = a[O]), (a[O] = null))
                  : E > 0 && (t.__c.__z.push(k), (a[O] = null)));
          if (!D) {
          ...
          for (A = a.length; A--; ) G(a[A]);
          At(t);
        }
      else ((t.__e = n.__e), (t.__k = n.__k), e.then || At(t));
      V.__e(e, t, n);
    }
  else s = t.__e = Nt(n.__e, t, n, r, i, a, o, c, l, u);
  return ((d = V.diffed) && d(t), 128 & t.__u ? void 0 : s);
}
function At(e) {
  (e && e.__c && (e.__c.__g |= 4), e && e.__k && e.__k.forEach(At));
}
function jt(e, t, n) {
...
function Mt(e) {
  return typeof e != `object` || !e || (e.__b && e.__b > 0) ? e : pt(e) ? e.map(Mt) : ht({}, e);
}
function Nt(e, t, n, r, i, a, o, s, c, l) {
  ...
  if (e == null) {
    ...
    ((e = l.createElementNS(i, b, y.is && y)), (s &&= (V.__m && V.__m(t, a), !1)), (a = null));
  }
  if (b == null) v === y || (s && e.data == y) || (e.data = y);
  else {
    if (((a &&= mt.call(e.childNodes)), (v = n.props || dt), !s && a != null))
        ...
        u == `children`
          ...
          : u == `dangerouslySetInnerHTML`
            ...
            : u == `value`
              ...
              : u == `checked`
                ? (g = m)
                : (s && typeof m != `function`) || (v[u] === m && !_) || Dt(e, u, m, v[u], i));
    if (d)
      ...
      for (u = a.length; u--; ) G(a[u]);
    s ||
      ((u = `value`),
      b == `progress` && h == null
        ? e.removeAttribute(`value`)
        : h == null || (h === e[u] && (b !== `progress` || h)) || Dt(e, u, h, v[u], i),
      (u = `checked`),
      g != null && g != e[u] && Dt(e, u, g, v[u], i));
  }
  return e;
}
function Pt(e, t, n) {
...
function Ft(e, t, n) {
  ...
  if (
    ...
    (r = e.ref) && ((r.current && r.current != e.__e) || Pt(r, null, t)),
    (r = e.__c) != null)
  ) {
  ...
  if ((r = e.__k))
    for (i = 0; i < r.length; i++) r[i] && Ft(r[i], t, n || typeof e.type != `function`);
  (n || G(e.__e), e.__e && e.__e.__l && (e.__e.__l = null), (e.__e = e.__c = e.__ = null));
}
function It(e, t, n) {
...
function Lt(e, t) {
  ...
  (t == document && (t = document.documentElement),
    ...
    kt(
      ...
      dt,
      t.namespaceURI,
      r ? null : t.firstChild ? mt.call(t.childNodes) : null,
      i,
...
((V = {
  ...
  (_t.prototype.setState = function (e, t) {
    var n = this.__s != null && this.__s != this.state ? this.__s : (this.__s = ht({}, this.state));
    (typeof e == `function` && (e = e(ht({}, n), this.props)),
      e && ht(n, e),
      e != null && this.__v && (t && this._sb.push(t), bt(this)));
  }),
  (_t.prototype.forceUpdate = function (e) {
    this.__v && ((this.__g |= 4), e && this.__h.push(e), bt(this));
  }),
  (_t.prototype.render = q),
  (H = []),
  (U = 0),
  (W = function (e, t) {
    return e.__v.__b - t.__v.__b;
  }),
  (st = /(PointerCapture)$|Capture$/i),
  (ct = 0),
  (lt = Ot(!1)),
  (ut = Ot(!0)));
var zt = 0;
...
function Ut({
  ...
  "use no memo";
  let c = `#${e.replace(/^#/, ``)}`,
    { width: l, height: u, viewBox: d } = Ht[e] ?? { width: Bt, height: Vt },
    f = r ?? l,
    p = i ?? u,
    m = a ?? d ?? `0 0 ${l} ${u}`,
...
function Xt({ children: e, marker: t, variant: n = `default` }) {
  "use no memo";
  let r = n === `fade`;
  return J(`div`, {
    "aria-hidden": !0,
...
function Qt({ children: e, mode: t = `truncate`, marker: n = `…`, variant: r = `default`, ...i }) {
  "use no memo";
  let a = J(Zt, { mode: t, children: e }, `content`),
    o = J(Xt, { marker: n, mode: t, variant: r }, `marker`),
...
function $t({ children: e, ...t }) {
  "use no memo";
  return J(Qt, { mode: `truncate`, ...t, children: e });
}
function en({ children: e, ...t }) {
  "use no memo";
  return J(Qt, { mode: `fruncate`, ...t, children: e });
}
function tn({
  children: e,
  contents: t,
  ...
  if (Array.isArray(t)) {
    ...
    ((c = J($t, { ...s, children: t[0] })), (l = J(en, { ...s, children: t[1] })));
  } else {
    if (typeof e != `string`)
      return (console.error(`MiddleTruncate: children must be a string`), null);
    if (e.length === 0) return J(`div`, { className: a, style: o });
    if (e.length < i)
      return J(n === `end` ? en : $t, { ...s, className: a, style: o, children: e });
    let t = null,
      u = null,
      d = null;
    if (typeof r == `string`)
      r === `center` ? (t = Wt) : r === `extension` ? (t = Gt) : r === `leaf-path` && (t = Kt);
    else if (typeof r == `number`) ((t = qt), (u = r));
    else if (Array.isArray(r)) {
      let [e, n] = r;
      ((d = n), e === `last` ? (t = Jt) : e === `first` && (t = Yt));
    ...
    (h && (_.marker = ``),
      g && (v.marker = ``),
      (c = J($t, { ...s, ..._, children: f })),
      (l = J(en, { ...s, ...v, children: p })));
  }
  return J(`div`, {
    "data-truncate-group-container": `middle`,
    className: a,
...
var nn = { endIndex: -1, startIndex: -1 };
function rn(e, t, n) {
  return Math.min(Math.max(e, t), n);
}
function an(e, t) {
  return e < 0 || t < e ? nn : { endIndex: t, startIndex: e };
}
function on(e) {
  return e.startIndex < 0 || e.endIndex < e.startIndex;
}
function sn(e, t) {
  return on(e) ? 0 : (e.endIndex - e.startIndex + 1) * t;
}
function cn(e, t, n) {
  if (t <= 0) return -1;
  let r = t * n;
...
function pn(e, t, n) {
  ...
  for (let r = 0; r < e.length; r += 1) {
    ...
    let s = t + r * n,
      c = dn(o, Math.min(e.length - 1, Math.floor(s / n))),
      l = null;
    for (; c >= 0; ) {
      let t = o[c],
...
function mn(e, t) {
  let n = t.totalRowCount ?? e.length,
    ...
    o = Math.max(0, r - i),
    s = rn(t.scrollTop, 0, o),
    c = t.stickyRows ?? pn(e, s, t.itemHeight),
    l = c.reduce((e, n) => Math.max(e, n.top + t.itemHeight), 0),
    u = Math.min(r, s + l),
    d = Math.max(0, i - l),
    f = Math.max(0, r - u),
    p = cn(s, n, t.itemHeight),
    m = cn(u, n, t.itemHeight),
    h = l <= 0 || p < 0 || p >= n ? -1 : p,
    g = h === -1 ? -1 : Math.min(n - 1, m - 1),
    _ = h === -1 || g < h ? 0 : g - h + 1,
    v = d <= 0 || m >= n ? nn : an(m, ln(u + d, n, t.itemHeight)),
    y = g + 1,
    b = on(v) ? nn : an(Math.max(y, v.startIndex - a), Math.min(n - 1, v.endIndex + a)),
    x = sn(b, t.itemHeight);
  return {
    ...
    window: {
      endIndex: b.endIndex,
      height: x,
      offsetTop: on(b) ? 0 : b.startIndex * t.itemHeight,
      startIndex: b.startIndex,
    },
  };
}
var hn = { added: `A`, deleted: `D`, ignored: null, modified: `M`, renamed: `R`, untracked: `U` },
  gn = {
...
function jn({ ariaLabel: e, isFlattened: t = !1, ref: n, value: r, onBlur: i, onInput: a }) {
  return J(`input`, {
    ref: n,
      ...
      ((r.__ = [
        ...
        function (e) {
          var t = r.__N ? r.__N[0] : r.__[0],
            n = r.t(t, e);
          Ln(t, n) || ((r.__N = [n, r.__[1]]), r.__c.setState({}));
        },
      ]),
      (r.__c = Y),
      !Y.__f))
    ...
    var i = function (e, t, n) {
      ...
      return (
        i.forEach(function (e) {
          if (e.__N) {
            var t = e.__[0];
            ((e.__ = e.__N), (e.__N = void 0), Ln(t, e.__[0]) || (o = !0));
          }
        }),
...
function Yn(e, t) {
  var n = Kn(Pn++, 3);
  !X.__s && ir(n.__H, t) && ((n.__ = e), (n.u = t), Y.__H.__h.push(n));
}
function Xn(e, t) {
  var n = Kn(Pn++, 4);
  !X.__s && ir(n.__H, t) && ((n.__ = e), (n.u = t), Y.__h.push(n));
}
function Z(e) {
  return (
    (Rn = 5),
...
function Zn(e, t) {
  var n = Kn(Pn++, 7);
  return (ir(n.__H, t) && ((n.__ = e()), (n.__H = t), (n.__h = e)), n.__);
}
function Qn(e, t) {
  return (
    (Rn = 8),
...
function $n() {
  for (var e; (e = zn.shift()); )
    if (e.__P && e.__H)
      try {
        (e.__H.__h.forEach(nr), e.__H.__h.forEach(rr), (e.__H.__h = []));
      } catch (t) {
...
((X.__b = function (e) {
  ...
  (X.__ = function (e, t) {
    (e && t.__k && t.__k.__m && (e.__m = t.__k.__m), Gn && Gn(e, t));
  }),
  (X.__r = function (e) {
    (Vn && Vn(e), (Pn = 0));
    var t = (Y = e.__c).__H;
    (t &&
      (Fn === Y
        ...
        : (t.__h.forEach(nr), t.__h.forEach(rr), (t.__h = []), (Pn = 0))),
      (Fn = Y));
  }),
  (X.diffed = function (e) {
    Hn && Hn(e);
    ...
    (t &&
      t.__H &&
      (t.__H.__h.length &&
        ((zn.push(t) !== 1 && In === X.requestAnimationFrame) ||
          ((In = X.requestAnimationFrame) || tr)($n)),
            ...
            q,
            {
              children: [
                J(`span`, {
                  ...
                  children: a && t != null ? t : J($t, { children: e.name }),
                }),
                i < r.length - 1 ? ` / ` : ``,
              ],
            },
...
function ur({
  ...
  let o = e.getVisibleCount(),
    ...
    l = mn(c, {
      ...
      overscan: n,
      scrollTop: r,
      stickyRows: s == null ? void 0 : lr(s, r, t, o),
      totalRowCount: o,
      viewportHeight: a,
    }),
...
function xr(e, t) {
  if (e != null) {
    let t = hn[e];
    return t == null ? null : { text: t, title: gn[e] };
  }
  return t ? { icon: { name: `file-tree-icon-dot`, width: 6, height: 6 }, title: _n } : null;
}
function Sr(e, t, n) {
...
function Or(e, t) {
  return (t && Dr(e)) || ((e.ctrlKey || e.metaKey) && wr(e))
    ? !0
    : e.key === `ArrowDown` ||
        e.key === `ArrowLeft` ||
        e.key === `ArrowRight` ||
...
function zr(e, t) {
  return { kind: e.kind, name: cr(e), path: t };
}
function Br(e) {
  ...
  let n =
    typeof e.icon == `string`
      ...
      : Hr(e.icon.name)
        ...
        : e.icon;
  return J(`span`, { title: e.title, children: J(Ut, { ...n }) });
}
function Wr(e) {
  e != null &&
    xn(
  ...
  return J(q, {
    children: [
      ...
      J(`div`, {
        ...
        children:
          e.kind === `directory`
            ? J(Ut, { ...t(`file-tree-icon-chevron`) })
            : J(Ut, { ...t(`file-tree-icon-file`, u) }),
      }),
      J(`div`, {
        "data-item-section": `content`,
        children: e.isFlattened
          ? or(e, c, a)
          : (c ?? J(tn, { minimumLength: 5, split: `extension`, children: e.name })),
      }),
      i
        ? J(`div`, { "data-item-section": `decoration`, children: r == null ? null : Ur(r, t) })
        : null,
      s ? J(`div`, { "data-item-section": `git`, children: Ur(o, t) }) : null,
      n
        ? J(`div`, {
            "data-item-section": `action`,
            children: l
              ? J(`span`, {
                  "aria-hidden": `true`,
                  "data-item-action-affordance": `decorative`,
                  children: J(Ut, { ...t(`file-tree-icon-ellipsis`) }),
                })
              : null,
          })
        : null,
...
function Kr(e, t, n, r = {}) {
  let {
      ...
      contextMenuButtonVisibility: ee,
    ...
    N = sr(t),
    { isParked: P = !1, mode: F = `flow`, style: te } = r,
    ne = F === `sticky`,
    re = _?.get(N) ?? null ?? Sr(t.ancestorPaths, v, y),
    ie = t.kind === `directory` && (b?.has(N) ?? !1),
    I = k(t, N),
    ae = xr(re, ie),
    oe = S && w,
    se = I != null || x || oe,
    ...
    pe = {
      ...Mn({
        ariaLabel: cr(t),
        domId: t.isFocused ? Vr(h, N, P) : void 0,
        extraStyle: te,
        features: {
          actionLaneEnabled: oe,
          contextMenuButtonVisibility: oe ? ee : null,
          contextMenuEnabled: S,
          ...
          ? (e) => {
              ...
              S &&
                ...
                T &&
                  ...
                  A(t, N, { anchorRect: Mr(e.clientX, e.clientY), source: `right-click` })));
            }
          : void 0,
      onFocus: ne
        ? void 0
      ...
      onKeyDown: ne ? void 0 : M,
      ref: (e) => {
        D(N, e);
      },
    };
  return !ne && le
    ? J(`div`, { ...pe, children: fe })
    : J(`button`, {
        ...pe,
        type: `button`,
        draggable: u && !P,
...
function Jr({
  ...
  let _ = Z(null),
    ...
    A = Z(!1),
    j = Z(null);
  j.current !== t && ((A.current = !1), (j.current = t));
  let M = Z(!1),
    N = Z(null),
    P = Z(null),
    F = Z(!1),
  ...
  let Ke =
    ...
    Je = e?.contextMenu?.triggerMode ?? (Ke ? `right-click` : `both`),
    Ye = Je === `both` || Je === `button`,
    Xe = e?.contextMenu?.buttonVisibility ?? `when-needed`,
    Ze = Je === `both` || Je === `right-click`;
  Xn(() => {
    let e = C.current;
    if (e == null) return;
    let t = (e) => {
        ...
        ((Me.current = t), be(t), Ce(t == null ? null : `pointer`));
      },
      n = (e) => {
  ...
  let Qe = Qn((e, t) => {
    ...
    tt = Qn((e) => Fr(e, E.current, T.current), []),
    nt = n != null || r != null || i != null,
    { resolveIcon: rt } = Zn(() => S(a), [a]),
    it = t[qe](),
    V = it.getPath(),
    at = V != null,
    H = t.isSearchOpen(),
    ...
    U = t.getFocusedPath(),
    W = t.getFocusedIndex(),
    st = t.getScrollRequest(),
    ct = t.isDragAndDropEnabled(),
    lt = t.getDragSession(),
    ut = Zn(() => (lt == null ? null : new Set(lt.draggedPaths)), [lt]),
    dt = lt?.target ?? null,
    ft = lt?.primaryPath ?? null,
    pt = Br(o),
    { overlayHeight: mt, overlayRows: ht, snapshot: G, visibleRows: gt } = He,
    K = G.physical.viewportHeight,
    q = Zn(
      () => ({ end: G.window.endIndex, start: G.window.startIndex }),
      [G.window.endIndex, G.window.startIndex],
    ),
    _t = ht,
    vt = G.sticky.rows,
    yt = G.physical.totalHeight,
    bt = G.sticky.height,
    xt = Zn(() => new Set(vt.map((e) => sr(e.row))), [vt]),
    St = W >= 0 && W >= q.start && W <= q.end,
    Ct = Qn((e, t) => u?.({ item: zr(e, t), row: e }) ?? null, [u]),
    wt = Qn((e) => (xn(e == null ? null : (T.current.get(e) ?? null)) ? !0 : xn(C.current)), []),
    Tt = Qn(
      (e) => {
  ...
  Ot.current = kt;
  let At = Qn((e) => {
      let t = e == null ? null : Nr(C.current, e);
      Se((e) => (e === t ? e : t));
    }, []),
    jt = Qn(
      (e, n, r) => {
        ...
        if (a?.dataset.fileTreeStickyRow === `true`) {
          let e = w.current;
          (Fe(n, e?.scrollTop ?? null), (M.current = !0), ve((e) => (e === n ? e : n)));
        }
        (i.focus(),
          At(a),
          (Dt.current = !0),
        ...
        if (l) {
          if (t.isSearchOpen()) {
            ...
            ((te.current =
              W < 0 || e == null
                ? null
                : Math.max(0, Math.min(W * s - e.scrollTop, Math.max(0, t - s)))),
              (F.current = !0));
          }
          t.startRenaming(e) !== !1 && (Ce(`focus`), ge((e) => e + 1));
        }
      },
      [t, W, s, l, K],
    ),
    Nt = Qn(
      (e, { restoreTreeFocus: n = !0, targetOffset: r = `live-overlay` } = {}) => {
        ...
        return (
          (M.current = !0), On(i, a, s, l, u, d), D.current(), (Oe.current = n ? e : null), !0
        );
      },
      [t, s, c, K, h],
    ),
    Pt = () => y.current === !0 || R.current != null || fe.current === !0,
    Ft = (e) =>
    ...
    Lt = () => {
      (se.current != null && (clearTimeout(se.current), (se.current = null)), (ae.current = null));
    },
    Rt = () => {
      (le.current?.remove(), (le.current = null));
    },
    zt = () => {
      (It(I.current), (I.current = null), (ce.current = null));
    },
    Bt = (e) => {
      let t = C.current?.getRootNode();
      if (t instanceof ShadowRoot) {
        t.append(e);
        return;
      }
    ...
    Vt = () => {
      (de.current?.(),
        ...
        (me.current = null),
        L.current != null &&
          (L.current.setAttribute(`draggable`, `true`),
          L.current.style.removeProperty(`touch-action`),
          (L.current = null)),
        Rt(),
        Lt(),
        zt(),
    ...
    Ht = (e, n) => {
      let r = C.current?.getRootNode(),
        i = _r(hr(r instanceof ShadowRoot ? r : document, e, n));
    ...
    Gt = () => {
      ...
      (o !== n.scrollTop && ((n.scrollTop = o), D.current()),
        Wt(Ht(e.clientX, e.clientY)),
        (I.current = Ft(Gt)));
    },
    Kt = (e, t) => {
      ((ce.current = { clientX: e, clientY: t }), (I.current ??= Ft(Gt)));
    },
    qt = (e, n, r) => {
      let i = e.currentTarget;
      if (i != null) {
        if ((Vt(), Rt(), Lt(), zt(), t.startDrag(r) === !1)) {
          e.preventDefault();
          return;
        }
        if (
    ...
    Jt = () => {
      (Rt(), Lt(), zt(), (ue.current = null), t.cancelDrag());
    },
    Yt = (e, n, r) => {
      if (R.current != null || fe.current) return;
      let i = e.touches[0],
        a = e.currentTarget;
      if (i == null || a == null) return;
      ((me.current = { clientX: i.clientX, clientY: i.clientY }),
        (L.current = a),
        ...
        (R.current = setTimeout(() => {
          ...
          let c = (e) => {
              ...
              (n != null &&
                ...
                Wt(Ht(t.clientX, t.clientY)),
                Kt(t.clientX, t.clientY));
            },
            l = (e) => {
              let n = e.changedTouches[0];
              (n != null && Ht(n.clientX, n.clientY), t.completeDrag(), Vt());
            },
            u = () => {
              (t.cancelDrag(), Vt());
            };
    ...
    Xt = (e) => {
      if (B != null) {
        ...
        kr.has(e.key) && (e.preventDefault(), e.stopPropagation());
        return;
      }
      if (it.isActive()) {
        if (e.key === `Escape`) it.cancel();
        else if (e.key === `Enter`) it.commit();
        else return;
        (Ce(`focus`), ge((e) => e + 1), e.preventDefault(), e.stopPropagation());
        return;
      }
      if (l && e.key === `F2`) {
        (Mt(U ?? void 0), e.preventDefault(), e.stopPropagation());
        return;
      }
      if (H) {
        if (e.key === `Escape`) ((F.current = !1), (te.current = null), t.closeSearch());
        else if (e.key === `Enter`) {
          ...
          ((te.current =
            W < 0 || n == null
              ? null
              : Math.max(0, Math.min(W * s - n.scrollTop, Math.max(0, r - s)))),
            (F.current = !0),
            t.closeSearch());
      ...
      let n = Ke && Dr(e),
        r = Or(e, Ke),
        i = r && C.current != null ? Sn(C.current) : null,
        a = r ? new Set(Ir(C.current)) : new Set(),
      ...
      if (e.shiftKey && e.key === `ArrowDown`) t.extendSelectionFromFocused(1);
        ...
        let e = t.getVisibleRows(d, d)[0] ?? null,
          n = Fr(u, E.current, T.current);
        e == null || n == null ? (y = !1) : jt(e, u);
      } else if ((e.ctrlKey || e.metaKey) && wr(e)) t.toggleFocusedSelection();
      ...
      let b = t.getFocusedPath(),
        ...
        S = g && b !== u,
        ee = n && c && o === u && b === u;
      if ((h || ee) && b != null && ((S && x) || ee))
        (Fe(b, v?.scrollTop ?? null), (M.current = !0), ve((e) => (e === b ? e : b)));
      else {
        let t = e.key === `ArrowUp` && h && b !== u;
        b != null && (t || (_ && b === u))
          ? (Ie(b, Rr(C.current, v, i, u, s, bt, K)),
            (M.current = !0),
            ve((e) => (e === b ? e : b)))
          : Pe();
      }
  ...
  (Xn(() => {
    ...
    Xn(() => {
      let e = x.current;
      switch (
        An({ hasRenderedInput: e != null, previousRenamingPath: P.current, renamingPath: V })
      ) {
        case `reset`:
          P.current = null;
          return;
        case `reveal-canonical`:
          V != null && Nt(V, { restoreTreeFocus: !1, targetOffset: `live-overlay` });
          return;
        case `ignore`:
          return;
        case `focus-input`:
          e != null && ((Oe.current = null), (P.current = V), xn(e), e.select());
          return;
      }
    }, [q.end, q.start, V, Nt, xt]),
    Xn(() => {
      let e = C.current;
      if (e == null) return;
      let t = null,
        ...
        r = () => {
          let t = Sn(e)?.dataset.itemPath ?? null;
          ve((e) => (e === t ? e : t));
        },
        i = () => {
          (n(), (M.current = !0), r());
      ...
      let o = !1,
        ...
        m = () => {
          if (
            (a(),
            n.scrollTop > 0 && f(),
            De.current != null && y.current && Ot.current(),
            Ne.current === !0)
          ) {
            y.current = !1;
            return;
      ...
      let S =
        typeof ResizeObserver < `u`
          ? new ResizeObserver((e) => {
              ((O.current = (e[0] == null ? null : Tn(e[0])) ?? Cn(n, g)), a());
            })
          : null;
      return (
        S?.observe(n),
  ...
  let Zt = Zn(() => (B == null ? null : `${B.path}::${B.source}`), [B]);
  (Xn(() => {
    if (Zt == null) {
      m?.clearSlotContent(re);
      return;
    }
    let t = De.current;
    if (t == null) return;
    ...
    let r = {
        anchorElement: n,
        anchorRect: t.anchorRect ?? jr(n.getBoundingClientRect()),
        close: (e) => {
          Ot.current(e?.restoreFocus ?? !0);
        },
        restoreFocus: () => {
          Dt.current && Et.current(De.current?.path ?? null);
        },
      },
      i = e?.contextMenu?.render?.(t.item, r) ?? null;
    return (
      m?.setSlotContent(re, i),
      e?.contextMenu?.onOpen?.(t.item, r),
      Wr(i),
      queueMicrotask(() => {
        i == null || !i.isConnected || (document.activeElement === i && Wr(i));
      }),
      () => {
        m?.clearSlotContent(re);
      }
    ...
    Xn(() => {
      B != null && t.getItem(B.path) == null && kt();
    }, [kt, B, t]),
    Xn(() => {
      if (B == null) return;
      let e = C.current?.getRootNode(),
        t = e instanceof ShadowRoot ? e.host : C.current,
        n = (e) => {
          let n = e.target;
          n instanceof Node &&
            (Ar(e) || (_.current?.contains(n) !== !0 && t?.contains(n) !== !0 && kt()));
        },
        r = (e) => {
    ...
    Xn(() => {
      ...
      let r = U == null ? null : (T.current.get(U) ?? null),
        i = Sn(n),
        ...
        S = !1,
        E = !1;
      if (st != null && st.id !== k.current) {
        k.current = st.id;
        let n = st.visibleIndex,
          r = t.getVisibleRows(n, n)[0] ?? null;
        if (r != null) {
          let t = h ? Math.max(0, Math.min(r.ancestorPaths.length * s, Math.max(0, K - s))) : bt;
          ((S = !0), (E = Dn(e, n, s, K, yt, st.offset, t)));
        }
        t.clearScrollRequest(st.id);
      }
      let O = !S && l && On(e, W, s, K, yt, u),
        A = !S && d != null && d === U && On(e, W, s, K, yt, bt),
        j = !S && m != null && m.path === U && On(e, W, s, K, yt, m.viewportOffset),
        P = !S && g != null && g.path === U && e.scrollTop !== g.scrollTop;
      if (
        (P && (e.scrollTop = g.scrollTop),
        (P || E || A || j || O || (v && y && d !== U && !b && En(e, W, s, K, bt))) && D.current(),
        S)
      ) {
        N.current = U;
        return;
      ...
      if (r == null) {
        (l && W >= 0 && (On(e, W, s, K, yt, u), D.current()), (N.current = U));
        return;
      }
      ((y || l || d === U || p === U || m?.path === U || g?.path === U || a == null || a !== U) &&
        (xn(r),
        d === U && (Oe.current = null),
        p === U && (ke.current = null),
        m?.path === U && (Ae.current = null),
        g?.path === U && (je.current = null),
        (F.current = !1),
        (te.current = null)),
        (N.current = U));
    }, [t, W, U, St, s, at, H, q, K, f, st, h, bt, yt, gt]));
  let Qt = W >= 0 && W >= G.visible.startIndex && W <= G.visible.endIndex,
    $t = U != null && _t.some((e) => sr(e.row) === U),
    en = Qt || $t,
    tn = Ye && M.current === !0 && en ? U : null,
    nn = z === `pointer` ? ye : null,
    rn = B?.path ?? Me.current ?? nn ?? tn ?? ye,
    an = B?.source === `right-click`;
  Xn(() => {
    (y.current && B == null) || At(tt(rn));
  }, [B, tt, q, K, we, _t, rn, At, gt]);
  let on = Qn((e) => {
      if (y.current || Ar(e)) return;
      let t = e.target;
        ...
        i =
          n instanceof HTMLElement
            ...
            : r instanceof HTMLElement
              ...
              : null;
      (i != null && Ce((e) => (e === `pointer` ? e : `pointer`)), be((e) => (e === i ? e : i)));
    }, []),
    sn = Qn(() => {
      be(null);
    }, []);
  Xn(() => {
    ...
    return (
      ...
      () => {
        (window.removeEventListener(`dragend`, e), Vt(), t.cancelDrag());
      }
    );
  }, [t, ct]);
  let cn = (e) => {
      if (!ct || t.getDragSession() == null || fe.current) return;
      let n = _r(e.target instanceof HTMLElement ? e.target : null);
      (t.setDragTarget(n),
        Wt(t.getDragSession()?.target ?? null),
        Kt(e.clientX, e.clientY),
    ...
    ln = (e) => {
      ...
      (n instanceof Node && C.current?.contains(n) === !0) || (Lt(), zt(), t.setDragTarget(null));
    },
    un = (e) => {
      !ct ||
    ...
    dn = G.window.height,
    fn = G.window.offsetTop,
    pn = Math.min(0, K - dn),
    mn = Math.min(0, K - dn - bt),
    hn = _e === U || F.current,
    gn = U != null && hn && !St && W >= 0 ? (gt[W] ?? t.getVisibleRows(W, W)[0] ?? null) : null,
    _n = gn == null ? null : kn(W, s, q, dn),
    vn = ue.current,
    yn = ft != null && vn != null && vn.path === ft && vn.index >= q.start && vn.index <= q.end,
    bn = ft != null && vn != null && vn.path === ft && !yn && vn.path !== gn?.path ? vn : null,
    jn = bn == null ? null : kn(bn.index, s, q, dn),
    Mn = Er(
      (W >= 0 ? (gt[W] ?? t.getVisibleRows(W, W)[0] ?? null) : null)?.ancestorPaths.at(-1) ?? null,
    ),
    Pn = H && U != null ? Vr(o, U, !St) : void 0,
    Y = B?.path ?? (H ? U : _e),
    Fn = B?.path ?? ye,
    In = tt(rn),
    Ln = Ke && Ye && !an && !at && In != null && xe != null && rn != null,
    Rn = Ke && (Ln || B != null),
    zn = B?.anchorRect,
    X = zn == null && In != null && xe != null && (B != null || Ln) ? xe : null,
    Bn =
      zn == null
        ? X == null
          ? void 0
          : { top: `${X}px` }
        : { left: `${zn.left}px`, position: `fixed`, right: `auto`, top: `${zn.top}px` },
    Vn = an ? { opacity: `0` } : void 0,
    Hn = Qn(
      (e, n, r, i) => {
        let a = Nn({
        ...
        let l = e.currentTarget instanceof HTMLElement ? e.currentTarget : null,
          u = n.index >= G.visible.startIndex && n.index <= G.visible.endIndex,
          d = i === `flow` && u && l != null && l.dataset.itemParked !== `true`;
        (t.focusMountedPathFromInput(c),
          d && ((M.current = !0), ve((e) => (e === c ? e : c)), Ce(`focus`)),
          o && t.toggleMountedDirectoryFromInput(c),
          a.closeSearch && t.closeSearch(),
          a.revealCanonical && Nt(c, { targetOffset: `sticky-parents` }));
      },
      [t, H, G.visible.endIndex, G.visible.startIndex, Nt],
    ),
    Un = () => {
      if (y.current || !Ye || rn == null || In == null) return;
      let e = t.getItem(rn);
      e != null &&
        (At(In),
        (Dt.current = !0),
        Ee({
          ...
          item: {
            ...
            name: In.getAttribute(`aria-label`) ?? rn,
            path: e.getPath(),
          },
          path: e.getPath(),
          source: `button`,
    ...
    Wn = {
      contextHoverPath: Fn,
      contextMenuButtonTriggerEnabled: Ye,
      contextMenuButtonVisibility: Xe,
      contextMenuEnabled: Ke,
      contextMenuRightClickEnabled: Ze,
      contextMenuTriggerMode: Je,
      controller: t,
      directoriesWithGitChanges: i,
      dragAndDropEnabled: ct,
      draggedPathSet: ut,
      dragTarget: dt,
      gitLaneActive: nt,
      gitStatusByPath: n,
      ...
      registerButton: Qe,
      registerRenameInput: et,
      renameView: it,
      renderDecorationForRow: Ct,
      resolveIcon: rt,
      shouldSuppressContextMenu: Pt,
      visualFocusPath: Y,
    },
    Gn = { ...Wn, registerButton: $e };
  return J(`div`, {
    ref: C,
    id: pt,
    "data-file-tree-context-menu-button-visibility": Ke && Ye ? Xe : void 0,
    "data-file-tree-context-menu-trigger-mode": Ke ? Je : void 0,
    "data-file-tree-has-context-menu-action-lane": Ke && Ye ? `true` : void 0,
    "data-file-tree-has-git-lane": nt ? `true` : void 0,
    "data-file-tree-virtualized-root": `true`,
    onDragLeave: ct ? ln : void 0,
    onDragOver: ct ? cn : void 0,
    onDrop: ct ? un : void 0,
    onKeyDown: Xt,
    onPointerLeave: Ke ? sn : void 0,
    onPointerOver: Ke ? on : void 0,
    role: `tree`,
    tabIndex: -1,
    style: { outline: `none`, position: `relative` },
    children: [
      J(`style`, { "data-file-tree-guide-style": `true`, dangerouslySetInnerHTML: { __html: Mn } }),
      J(`slot`, { name: ne, "data-type": `header-slot` }),
      f
        ? J(`div`, {
            "data-file-tree-search-container": !0,
            "data-open": H ? `true` : `false`,
            children: J(`input`, {
              ref: ee,
              "aria-activedescendant": Pn,
              "aria-controls": pt,
              placeholder: `Search…`,
        ...
        children: [
          ...
          J(`div`, {
            ...
            children: [
              ...
              J(`div`, {
                "data-file-tree-virtualized-sticky": `true`,
                style: { height: `${dn}px`, top: `${pn}px`, bottom: `${mn}px` },
                children: [
                  qr(Wn, q, xt),
                  gn != null && _n != null
                    ? Kr(Wn, gn, `parked:${gn.path}`, {
                        isParked: !0,
                        style: {
                          left: `0`,
                          opacity: `0`,
                          pointerEvents: ft === gn.path ? `none` : void 0,
                          position: `absolute`,
                          right: `0`,
                          top: `${_n}px`,
                        },
        ...
        ? J(`div`, {
            ...
            children: [
              J(`button`, {
                ...
                "aria-label": `Options`,
                "aria-haspopup": `menu`,
                "aria-expanded": B == null ? `false` : `true`,
                "data-visible": Ln ? `true` : `false`,
                onMouseDown: (e) => {
                  e.preventDefault();
                },
                onClick: (e) => {
                  if ((e.preventDefault(), e.stopPropagation(), B != null)) {
                    kt();
                    return;
                  }
                  Un();
                ...
                tabIndex: -1,
                style: Vn,
                children: J(Ut, { ...rt(`file-tree-icon-ellipsis`) }),
              }),
              B == null ? null : J(`slot`, { name: re }),
            ],
          })
        : null,
      B == null
...
var $r = class {
  ...
  ci = new Set([`draggable`, `spellcheck`]);
function li(e) {
  e.__g === void 0 ? (e[ni] = !0) : (e.__g |= 8);
}
function ui(e) {
  e.__g === void 0 ? (e[ni] = !1) : (e.__g &= -9);
}
function di(e) {
  return e.__g === void 0 ? !0 === e[ni] : !!(8 & e.__g);
}
var fi = /["&<]/;
function pi(e) {
  if (e.length === 0 || !1 === fi.test(e)) return e;
...
function _i(e) {
  ...
  for (var n in e) {
    var r = e[n];
    if (r != null && r !== ``) {
      var i = n[0] == `-` ? n : mi[n] || (mi[n] = n.replace(gi, `-$&`).toLowerCase()),
        a = `;`;
      (typeof r != `number` || i.startsWith(`--`) || hi.has(i) || (a = `px;`),
        (t = t + i + `:` + r + a));
    }
  }
  return t || void 0;
...
function yi(e, t) {
  return { __v: e, context: t, props: e.props, setState: vi, forceUpdate: vi, __d: !0, __h: [] };
}
function bi(e, t, n) {
  if (!e.s) {
    if (n instanceof xi) {
      if (!n.s) return void (n.o = bi.bind(null, e, t));
      (1 & t && (t = n.s), (n = n.v));
    }
    if (n && n.then) return void n.then(bi.bind(null, e, t), bi.bind(null, e, 2));
    ((e.s = t), (e.v = n));
    let r = e.o;
    r && r(e);
  }
      ...
      (e.prototype.then = function (t, n) {
        ...
        return (
          (this.o = function (e) {
            try {
              var i = e.v;
              1 & e.s ? bi(r, 1, t ? t(i) : i) : n ? bi(r, 1, n(i)) : bi(r, 2, i);
            } catch (e) {
              bi(r, 2, e);
            }
          }),
...
function Mi(e, t) {
  var n,
    ...
    i = !0;
  return (
    e[ei] ? ((i = !1), ((n = e[ei]).state = n[ri])) : (n = new r(e.props, t)),
    (e[ei] = n),
    (n.__v = e),
    (n.props = e.props),
    (n.context = t),
    ...
    r.getDerivedStateFromProps
      ? (n.state = Oi({}, n.state, r.getDerivedStateFromProps(n.props, n.state)))
      : i && n.componentWillMount
        ? (n.componentWillMount(), (n.state = n[ri] === n.state ? n.state : n[ri]))
...
function Ni(e, t, n, r, i, a, o) {
  if (e == null || !0 === e || !1 === e || e === ki) return ki;
  var s = typeof e;
  if (s != `object`) return s == `function` ? ki : s == `string` ? pi(e) : e + ki;
  if (Di(e)) {
    var c,
      l = ki;
    i[ti] = e;
      ...
      if (f != null && typeof f != `boolean`) {
        ...
        typeof m == `string`
          ...
          : ((c ||= Array(u)),
            l && c.push(l),
            (l = ki),
            Di(m) ? (p = c).push.apply(p, m) : c.push(m));
      }
    }
    return c ? (l && c.push(l), c) : l;
  }
  if (e.constructor !== void 0) return ki;
  ((e.__ = i), Si && Si(e));
  var h = e.type,
    g = e.props;
  if (typeof h == `function`) {
    ...
    if (h === q) {
      if (`tpl` in g) {
        for (var x = ki, S = 0; S < g.tpl.length; S++)
          if (((x += g.tpl[S]), g.exprs && S < g.exprs.length)) {
            var C = g.exprs[S];
            if (C == null) continue;
            typeof C != `object` || (C.constructor !== void 0 && !Di(C))
              ? (x += C)
              : (x += Ni(C, t, n, r, e, a, o));
          }
        return x;
      }
      if (`UNSTABLE_comment` in g) return `<!--` + pi(g.UNSTABLE_comment) + `-->`;
      v = g.children;
    } else {
      ...
      var ee = h.prototype && typeof h.prototype.render == `function`;
      if (ee) ((v = Mi(e, b)), (y = e[ei]));
      else {
        e[ei] = y = yi(e, b);
        for (var T = 0; di(y) && T++ < 25; ) {
          (ui(y), wi && wi(e));
          try {
            v = h.call(y, g, b);
          } catch (t) {
      ...
      if (
        (y.getChildContext != null && (t = Oi({}, t, y.getChildContext())),
        ee && V.errorBoundaries && (h.getDerivedStateFromError || y.componentDidCatch))
      ) {
        v =
          v != null && v.type === q && v.key == null && v.props.tpl == null ? v.props.children : v;
        try {
          return Ni(v, t, n, r, e, a, !1);
        } catch (i) {
          return (
            h.getDerivedStateFromError && (y[ri] = h.getDerivedStateFromError(i)),
            y.componentDidCatch && y.componentDidCatch(i, Ei),
            di(y)
              ? ((v = Mi(e, t)),
                (y = e[ei]).getChildContext != null && (t = Oi({}, t, y.getChildContext())),
                Ni(
                  (v =
                    v != null && v.type === q && v.key == null && v.props.tpl == null
                      ? v.props.children
                      : v),
                  t,
                  n,
    ...
    v = v != null && v.type === q && v.key == null && v.props.tpl == null ? v.props.children : v;
    try {
      var E = Ni(v, t, n, r, e, a, o);
      return (
        Ci && Ci(e),
        V.unmount && V.unmount(e),
        e._suspended
      ...
      return i.then(function i() {
        try {
          var s = Ni(v, t, n, r, e, a, o);
          return e._suspended ? Ai + s + ji : s;
        } catch (e) {
  ...
  for (var M in g) {
    var N = g[M];
    if (typeof (N = Fi(N) ? N.value : N) != `function` || M === `class` || M === `className`) {
      switch (M) {
        case `children`:
          k = N;
          continue;
        ...
        case `httpEquiv`:
          ...
          break;
        default:
          if (ai.test(M)) M = M.replace(ai, `$1:$2`).toLowerCase();
          else {
            if (ii.test(M)) continue;
            (M[4] !== `-` && !ci.has(M)) || N == null
              ? n
                ? si.test(M) &&
                  (M = M === `panose1` ? `panose-1` : M.replace(/([A-Z])/g, `-$1`).toLowerCase())
                : oi.test(M) && (M = M.toLowerCase())
              : (N += ki);
          }
      }
      N != null &&
        ...
        (A =
          !0 === N || N === ki
            ? A + ` ` + M
            : A + ` ` + M + `="` + (typeof N == `string` ? pi(N) : N + ki) + `"`);
    }
  }
  if (ii.test(h)) throw Error(h + ` is not a valid HTML tag name in ` + A + `>`);
  if (
    (j ||
      (typeof k == `string`
        ? (j = pi(k))
        : k != null &&
          !1 !== k &&
          !0 !== k &&
          (j = Ni(k, t, h === `svg` || (h !== `foreignObject` && n), r, e, a, o))),
    Ci && Ci(e),
    Ti && Ti(e),
    !j && Pi.has(h))
  )
  ...
  var P = `</` + h + `>`,
    F = A + `>`;
  return Di(j) ? [F].concat(j, [P]) : typeof j == `string` ? F + j + P : [F, j, P];
}
var Pi = new Set([
  `area`,
  `base`,
...
var Ii = 0;
function Li(e) {
  return e != null && e.length > 0 ? e : ((Ii += 1), `pst_ft_${Ii}`);
}
function Ri({ initialVisibleRowCount: e, itemHeight: t }) {
  return e == null ? 420 : Math.max(0, e) * (t ?? oe);
}
function zi(e) {
...
var Hi = class {
    ...
    unmount() {
      (this.#b != null &&
        (Qr(this.#b), delete this.#b.dataset.fileTreeVirtualizedWrapper, (this.#b = void 0)),
        this.#l.clearAll(),
        this.#l.setHost(null),
        this.#f != null &&
    ...
    setComposition(e) {
      this.#e = e;
      let t = this.#T();
      t != null && (this.#O(), Xr(t.wrapper, this.#w()));
    }
    setGitStatus(e) {
      this.#p = it(e, this.#p);
      let t = this.#T();
      t != null && Xr(t.wrapper, this.#w());
    }
    setIcons(e) {
      this.#m = e;
      let t = this.#T();
      t != null && (this.#E(t.host, t.wrapper), Xr(t.wrapper, this.#w()));
    }
    ...
    #O() {
      ...
      if (e != null) {
        this.#l.setSlotContent(ne, e());
        return;
      }
      this.#l.setSlotHtml(ne, this.#e?.header?.html ?? null);
    }
    #k(e) {
      let t = Vi(e).find((e) => Bi(e)),
        n = zi(x(b(this.#m).set));
      n != null &&
    ...
    #M(e) {
      ...
      (this.#g?.parentNode === e && this.#_ === this.#h) ||
        ...
        this.#g.setAttribute(N, ``),
        this.#g.parentNode !== e && e.appendChild(this.#g),
        (this.#g.textContent = ue(this.#h)),
        (this.#_ = this.#h));
    }
    #N(e) {
  ...
  Q = e(t(), 1),
  $ = n(),
  Ui = typeof window > `u` ? Q.useEffect : Q.useLayoutEffect;
function Wi(e, t, n) {
  let r = e == null ? null : (0, $.jsx)(`div`, { slot: ne, children: e }),
    i =
      t != null && n != null
        ? (0, $.jsx)(`div`, { slot: re, children: t(n.item, n.context) })
        : null;
  return r == null && i == null ? null : (0, $.jsxs)($.Fragment, { children: [r, i] });
}
function Gi(e, t) {
...
function Ji({ header: e, id: t, model: n, preloadedData: r, renderContextMenu: i, ...a }) {
  ...
  let f = i != null,
    ...
    h = u.current,
    g = (0, Q.useMemo)(() => qi(h, e, f, p, m), [h, p, m, f, e]),
    _ = (0, Q.useCallback)((e) => {
      l(e);
    }, []);
  ((0, Q.useEffect)(() => {
...
function Yi(e) {
  let [t] = (0, Q.useState)(() => new Hi(e)),
    n = (0, Q.useRef)({ timeout: null, model: t });
  return (
    (0, Q.useEffect)(() => {
      let { current: e } = n;
      return (
...
function ia(e) {
  let t = (0, ta.c)(97),
    {
      ...
      onStateChange: y,
      paths: b,
      revealSelectedPath: x,
      renderRowDecoration: S,
      resetKey: C,
      selectedPath: T,
      unsafeCSS: E,
    } = e,
    ...
    N = ee(w()),
    { platform: P } = v(),
    F = s(`add-context-file`),
    te = i(),
    ne;
  t[0] !== n || t[1] !== o
    ? ((ne = { cwd: n, hostId: o }), (t[0] = n), (t[1] = o), (t[2] = ne))
    : (ne = t[2]);
  let re = k(ne),
    ie;
  t[3] === b ? (ie = t[4]) : ((ie = b.map(aa)), (t[3] = b), (t[4] = ie));
  let I = ie,
    ae;
  if (t[5] !== n || t[6] !== b || t[7] !== P) {
    ae = new Map();
    for (let e of b)
      typeof e != `string` && ae.set(e.displayPath, g(n ?? ``, e.path, P === `windows`));
    ((t[5] = n), (t[6] = b), (t[7] = P), (t[8] = ae));
  } else ae = t[8];
  let oe = ae,
    se;
  t[9] !== r || t[10] !== c
    ? ((se = sa(c, r)), (t[9] = r), (t[10] = c), (t[11] = se))
    : (se = t[11]);
  let ce = se,
    le = (0, Q.useRef)(null),
    ue;
  t[12] === l ? (ue = t[13]) : ((ue = Array.from(l ?? [])), (t[12] = l), (t[13] = ue));
  let de = (0, Q.useRef)(ue),
    fe = (0, Q.useRef)(null),
    pe = (0, Q.useRef)(null),
    L = (0, Q.useRef)(j),
    me = (0, Q.useRef)(T ?? null),
    R;
  t[14] === y
    ? (R = t[15])
    : ((R = () => {
        y?.({ expandedPaths: de.current, scrollTop: L.current, selectedPath: me.current });
      }),
      (t[14] = y),
      (t[15] = R));
  let he = p(R),
  ...
  let ye = p(ve),
    be;
  t[22] === T ? (be = t[23]) : ((be = T == null ? void 0 : [T]), (t[22] = T), (t[23] = be));
  let xe = `
      :host {
  ...
  t[31] !== I
    ? ((Se = {
        ...
        flattenEmptyDirectories: D,
        icons: ce,
        initialExpandedPaths: l,
        initialSelectedPaths: be,
        itemHeight: na,
  ...
  (t[33] !== l || t[34] !== z || t[35] !== C || t[36] !== I
    ? ((Ce = () => {
        ...
        (t != null &&
          ...
          (de.current = e),
          (pe.current = null),
          z.resetPaths(I, { initialExpandedPaths: l }));
      }),
      (we = [l, z, C, I]),
      (t[33] = l),
      (t[34] = z),
    ...
    (0, Q.useEffect)(Ce, we));
  let Te, B;
  (t[39] !== j || t[40] !== z || t[41] !== M || t[42] !== T
    ? ((Te = () => {
        let e = null,
          t = 0,
          n = () => {
            ((e = null),
              !_a(z, j) && (t >= ra || ((t += 1), (e = window.requestAnimationFrame(n)))));
          };
        return (
          j > 0 && !(M && T != null) ? ((L.current = j), n()) : (L.current = 0),
          () => {
    ...
    (0, Q.useEffect)(Te, B));
  let Ee;
  t[45] !== z || t[46] !== M || t[47] !== T
    ? ((Ee = () => {
        if (((me.current = T ?? null), pa(z, T), !M || T == null)) {
          pe.current = null;
          return;
        }
        pe.current !== T && ma(z, T) && (pe.current = T);
      }),
      (t[45] = z),
      (t[46] = M),
      (t[47] = T),
    ...
    : (Ee = t[48]);
  let De;
  (t[49] !== z || t[50] !== M || t[51] !== T || t[52] !== I
    ? ((De = [z, M, T, I]), (t[49] = z), (t[50] = M), (t[51] = T), (t[52] = I), (t[53] = De))
    : (De = t[53]),
    (0, Q.useEffect)(Ee, De));
  let Oe, ke;
  (t[54] !== ce || t[55] !== z
    ...
    (0, Q.useEffect)(Oe, ke));
  let Ae, je;
  (t[58] !== _e || t[59] !== z || t[60] !== I
    ? ((Ae = () =>
        z.subscribe(() => {
          ((L.current = ga(z)), _e(fa(z, I)));
        })),
      (je = [_e, z, I]),
      (t[58] = _e),
      (t[59] = z),
    ...
    ? ((Me = () => {
        let e = null,
          ...
          r = () => {
            ...
            t >= ra || ((t += 1), (e = window.requestAnimationFrame(r)));
          };
        return (
          r(),
          () => {
  ...
  let Pe;
  t[67] !== n || t[68] !== o
    ? ((Pe = (0, $.jsx)(A, { cwd: n, hostId: o })), (t[67] = n), (t[68] = o), (t[69] = Pe))
    : (Pe = t[69]);
  let Fe;
  t[70] !== F || t[71] !== n || t[72] !== re || t[73] !== o || t[74] !== te || t[75] !== oe
    ? ((Fe = () => {
        let e = da(oe, le.current);
        return Xi({
          ...la({ cwd: n, fallbackOpenTargets: re, hostId: o, queryClient: te, targetPath: e }),
          onAddToChat:
            o == null
              ? void 0
              : (e) => {
                  F.mutateAsync({ hostId: o, path: e });
                },
          onCopyPath: O,
          onOpenInTarget: (e, t, n) => {
            re.open(e, { appPath: t, persistPreferred: !1, path: n });
          },
          targetPath: e,
        });
      }),
    ...
    : (Fe = t[76]);
  let Ie;
  t[77] !== n || t[78] !== o || t[79] !== te || t[80] !== oe
    ? ((Ie = () => ua({ cwd: n, hostId: o, queryClient: te, targetPath: da(oe, le.current) })),
      (t[77] = n),
      (t[78] = o),
      (t[79] = te),
      (t[80] = oe),
  ...
  t[85] !== z || t[86] !== d || t[87] !== f || t[88] !== Re
    ...
    : (ze = t[89]);
  let Be;
  t[90] !== Fe || t[91] !== Ie || t[92] !== ze
    ? ((Be = (0, $.jsx)(m, { awaitBeforeOpen: !1, getItems: Fe, onBeforeOpen: Ie, children: ze })),
      (t[90] = Fe),
      (t[91] = Ie),
      (t[92] = ze),
      (t[93] = Be))
  ...
  return (
    t[94] !== Pe || t[95] !== Be
      ? ((Ve = (0, $.jsxs)($.Fragment, { children: [Pe, Be] })),
        (t[94] = Pe),
        (t[95] = Be),
        (t[96] = Ve))
      : (Ve = t[96]),
...
function sa(e, t) {
  ...
  let n = t
      ...
      .join(``),
    r = ca(typeof e == `string` ? void 0 : e?.spriteSheet, n);
  return e == null
...
function la({ cwd: e, fallbackOpenTargets: t, hostId: n, queryClient: r, targetPath: i }) {
  if (i == null) return { isLoadingOpenTargets: !1, primaryTarget: null, visibleTargets: [] };
  let a = o(`open-in-targets`, { cwd: e, hostId: n, path: i }),
    s = r.getQueryData(a),
    c = s?.targets ?? t.targets,
    l = s?.availableTargets ?? t.availableTargets,
    u = s?.preferredTarget ?? t.preferredTarget,
    d = s?.mode ?? t.mode;
  return {
    isLoadingOpenTargets:
      s == null && !t.hasLoadedTargets && r.getQueryState(a)?.status !== `error`,
    primaryTarget: D({ preferredTarget: u, targets: c, availableTargets: l, mode: d }),
    visibleTargets: E({ targets: c, availableTargets: l, includeHiddenTargets: !0, mode: d }),
  };
}
function ua({ cwd: e, hostId: t, queryClient: n, targetPath: r }) {
  if (r != null)
    return n.prefetchQuery({
      gcTime: c.INFINITE,
      queryKey: o(`open-in-targets`, { cwd: e, hostId: t, path: r }),
      queryFn: () => a(`open-in-targets`, { params: { cwd: e, hostId: t, path: r } }),
...
function fa(e, t) {
  ...
  for (let r of t) {
    ...
    let t = r.slice(0, -1),
      i = e.getItem(t);
    i == null || !va(i) || !i.isExpanded() || n.push(t);
  }
  return n;
}
function pa(e, t) {
...
function ya(e) {
  ...
  t[1] === s
    ? (p = t[2])
    : ((p = (0, $.jsx)(`label`, { className: `sr-only`, htmlFor: s, children: u })),
      (t[1] = s),
      (t[2] = p));
  let m;
  ...
  t[6] === c
    ...
    : ((v = c.formatMessage({
      ...
      (t[7] = v));
  let y;
  t[8] !== n || t[9] !== s || t[10] !== i || t[11] !== o || t[12] !== g || t[13] !== v
    ? ((y = (0, $.jsx)(`input`, {
        autoFocus: n,
        id: s,
        ref: i,
    ...
    ? ((b =
        o.length > 0
          ? (0, $.jsx)(f, {
              ...
              size: `icon`,
              onClick: () => a(``),
              children: (0, $.jsx)(h, { className: `icon-2xs` }),
            })
          : null),
      (t[15] = c),
      (t[16] = a),
...
export { ia as n, ea as r, ya as t };
