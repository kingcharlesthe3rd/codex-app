...
import { k as i, n as a, r as o, s, u as c } from "./vscode-api.js";
import { c as l, n as u, o as d } from "./lib.js";
import { t as f } from "./button-DO-oxX3-.js";
import { t as p } from "./use-stable-callback.js";
import { t as m } from "./context-menu-Cx-ZCB4Y.js";
import { k as h } from "./rpc-1.js";
import { t as g } from "./x.js";
import { t as _ } from "./use-platform.js";
import { i as v, n as y, r as b, t as x } from "./iconResolver.js";
import { t as S } from "./store.js";
import { n as C, r as w } from "./use-resolved-theme-variant.js";
...
function Oe(e, t, n) {
  ...
  if (!De(S.preparePaths(r, n == null ? {} : { sort: n }), a))
  ...
  n: if (typeof j == `function`)
    try {
      ...
      ((f.state = f.__s),
        ...
        (E = d),
        d != null && d.type === q && d.key == null && (E = Mt(d.props.children)),
        (s = St(e, pt(E) ? E : [E], t, n, r, i, a, o, s, c, l, u)),
        (t.__u &= -161),
  ...
  let {
    ...
    pe = {
      ...Mn({
        ...
        features: {
          actionLaneEnabled: oe,
          contextMenuButtonVisibility: oe ? T : null,
          contextMenuEnabled: S,
...
function Jr({
  ...
  let Qe = Qn((e, t) => {
    ...
    tt = Qn((e) => Fr(e, D.current, E.current), []),
    nt = n != null || r != null || i != null,
    { resolveIcon: rt } = Zn(() => x(a), [a]),
    it = t[qe](),
    V = it.getPath(),
    at = V != null,
    H = t.isSearchOpen(),
    ...
    wt = Qn((e) => (xn(e == null ? null : (E.current.get(e) ?? null)) ? !0 : xn(C.current)), []),
    Tt = Qn(
      (e) => {
  ...
  let At = Qn((e) => {
    ...
    Nt = Qn(
      (e, { restoreTreeFocus: n = !0, targetOffset: r = `live-overlay` } = {}) => {
        ...
        return (
          (M.current = !0), On(i, a, s, l, u, d), ee.current(), (Oe.current = n ? e : null), !0
        );
      },
      [t, s, c, K, h],
    ),
    ...
    Gt = () => {
      ...
      (o !== n.scrollTop && ((n.scrollTop = o), ee.current()),
  ...
  (Xn(() => {
    ...
    Xn(() => {
      ...
      let r = U == null ? null : (E.current.get(U) ?? null),
        i = Sn(n),
      ...
      if (st != null && st.id !== k.current) {
        ...
        if (r != null) {
          ...
          ((x = !0), (D = Dn(e, n, s, K, yt, st.offset, t)));
        }
        t.clearScrollRequest(st.id);
      }
      let O = !x && l && On(e, W, s, K, yt, u),
        A = !x && d != null && d === U && On(e, W, s, K, yt, bt),
        j = !x && m != null && m.path === U && On(e, W, s, K, yt, m.viewportOffset),
        P = !x && g != null && g.path === U && e.scrollTop !== g.scrollTop;
      if (
        (P && (e.scrollTop = g.scrollTop),
        (P || D || A || j || O || (v && y && d !== U && !b && En(e, W, s, K, bt))) && ee.current(),
        x)
      ) {
        N.current = U;
        return;
      ...
      if (r == null) {
        (l && W >= 0 && (On(e, W, s, K, yt, u), ee.current()), (N.current = U));
        return;
      }
...
function Ni(e, t, n, r, i, a, o) {
  ...
  if (typeof h == `function`) {
    ...
    if (h === q) {
      ...
      if (T) ((v = Mi(e, b)), (y = e[ei]));
      else {
        e[ei] = y = yi(e, b);
        for (var E = 0; di(y) && E++ < 25; ) {
          (ui(y), wi && wi(e));
          try {
            v = h.call(y, g, b);
          } catch (t) {
      ...
      if (
        ...
        T && V.errorBoundaries && (h.getDerivedStateFromError || y.componentDidCatch))
      ) {
        v =
...
function ia(e) {
  ...
  if (t[5] !== n || t[6] !== b || t[7] !== P) {
    ae = new Map();
    for (let e of b)
      typeof e != `string` && ae.set(e.displayPath, h(n ?? ``, e.path, P === `windows`));
  ...
  let ye = p(ve),
    be;
  t[22] === E ? (be = t[23]) : ((be = E == null ? void 0 : [E]), (t[22] = E), (t[23] = be));
  let xe = `
      :host {
  ...
  (t[39] !== j || t[40] !== z || t[41] !== M || t[42] !== E
    ? ((Te = () => {
        ...
        return (
          j > 0 && !(M && E != null) ? ((L.current = j), n()) : (L.current = 0),
          () => {
    ...
    (0, Q.useEffect)(Te, B));
  let Ee;
  t[45] !== z || t[46] !== M || t[47] !== E
    ? ((Ee = () => {
        if (((me.current = E ?? null), pa(z, E), !M || E == null)) {
          pe.current = null;
          return;
        }
        pe.current !== E && ma(z, E) && (pe.current = E);
      }),
      (t[45] = z),
      (t[46] = M),
      (t[47] = E),
    ...
    : (Ee = t[48]);
  let De;
  (t[49] !== z || t[50] !== M || t[51] !== E || t[52] !== I
    ? ((De = [z, M, E, I]), (t[49] = z), (t[50] = M), (t[51] = E), (t[52] = I), (t[53] = De))
    : (De = t[53]),
    (0, Q.useEffect)(Ee, De));
  let Oe, ke;
  (t[54] !== ce || t[55] !== z
...
function ya(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (m = t[3]);
  let h;
  t[4] === a ? (h = t[5]) : ((h = (e) => a(e.target.value)), (t[4] = a), (t[5] = h));
  let _;
  t[6] === c
    ? (_ = t[7])
    : ((_ = c.formatMessage({
      ...
      (t[7] = _));
  let v;
  t[8] !== n || t[9] !== s || t[10] !== i || t[11] !== o || t[12] !== h || t[13] !== _
    ? ((v = (0, $.jsx)(`input`, {
        autoFocus: n,
        id: s,
        ref: i,
    ...
    ? ((y =
        o.length > 0
          ? (0, $.jsx)(f, {
              ...
              size: `icon`,
              onClick: () => a(``),
              children: (0, $.jsx)(g, { className: `icon-2xs` }),
            })
          : null),
      (t[15] = c),
      (t[16] = a),
