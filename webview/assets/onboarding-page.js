...
import { i as sr, r as cr } from "./ambient-suggestions-connected-apps-consent.js";
import { n as lr, t as ur } from "./app-initial~app-main~new-thread-panel-page~onboarding-page.js";
import {
  d as dr,
  p as fr,
    ...
    (ie(),
      ...
      (Yr = r({
        state: r({
          ...
          workMode: ne(qr).nullable(),
        }),
        options: r({ focusComposer: n().optional(), prefillPrompt: o().optional() }).optional(),
      })),
      (K = {
        Start: `start`,
      ...
      (Xr = r({ step: c(K.TeenWelcome) })),
      (Zr = r({ step: c(K.TeenInterests), interests: d(ne(Wr)) })),
      (Qr = r({ step: c(K.TeenPrompts), completion: Yr })),
      ($r = r({ step: c(K.WindowsSandboxSetup) })),
      (ei = r({
        step: c(K.ConversationalOnboarding),
        roles: d(ne(Kr)),
        personalizedSuggestionsEnabled: n(),
        workMode: ne(qr).nullable(),
      })),
      (ti = r({
        step: c(K.RoleSelection),
        roles: d(ne(Kr)),
        personalizedSuggestionsEnabled: n(),
        workMode: ne(qr).nullable(),
      })),
      (ni = r({
        step: c(K.AgentMigrationSourceSelection),
        providerIds: d(ne(Jr)),
        skipped: n().optional(),
      })),
      (ri = r({ step: c(K.AgentMigrationItemSelection), action: ne([`imported`, `skipped`]) })),
      (ii = l(`step`, [Xr, Zr, Qr, $r, ei, ti, ni, ri])));
  }),
  oi,
  si,
  ci,
    ...
    e[12] !== n
      ? ((g = () => {
          ...
          if (
            ...
            return;
          let { state: g, options: _ } = e,
            v = g.personalizedSuggestionsEnabled ?? !0,
            y = hi(g.workMode);
          (n(g),
            Ve(t, x.conversationDetailMode, y.threadDetailLevel)
              .catch(mi)
              .finally(() => {
                let e = o === `welcome`;
                (s(`auto`),
            ...
            y.fontSizes != null &&
              (Ve(t, p.sansFontSize, y.fontSizes.sans), Ve(t, p.codeFontSize, y.fontSizes.code)),
            t.set(Rr, y.composerPermissionModeVisibility),
            v && t.set(cr, !0),
            (async () => {
              (await Ve(t, i.enabled, v),
                v &&
                  (await E(`ambient-suggestions-refresh`, {
                    params: { domain: null, hostId: jt, projectRoot: S(`~`) },
                  }),
                  await Promise.all([
                    a.invalidateQueries({ queryKey: j(`ambient-suggestions`) }),
                    a.invalidateQueries({ queryKey: j(`ambient-suggestions-refresh`) }),
                  ])));
            })().catch(pi));
        }),
        (e[0] = r),
...
function pi(e) {
  m.error(`Failed to refresh ambient suggestions after onboarding`, {
    safe: {},
    sensitive: { error: e },
  });
}
function mi(e) {
  m.error(`Failed to persist welcome v2 onboarding configuration`, {
    safe: {},
    sensitive: { error: e },
  });
}
...
function bi(e) {
  let t = (0, xi.c)(15),
    ...
    s = et(),
    c = y(),
    { client: l, isLoading: u } = bt(),
    d;
  t[0] === l ? (d = t[1]) : ((d = Tt(l, `2744470156`)), (t[0] = l), (t[1] = d));
  let f = d,
    p = s.authMethod === `chatgpt`,
    m;
  t[2] === p ? (m = t[3]) : ((m = { enabled: p }), (t[2] = p), (t[3] = m));
  let { isLoading: h, shouldUseTeenOnboarding: g } = _t(m),
  ...
  t[4] === n.shouldShow
    ? (x = t[5])
    : ((x = { shouldShow: n.shouldShow }), (t[4] = n.shouldShow), (t[5] = x));
  let S;
  t[6] === c
    ? (S = t[7])
    : ((S = { isSupported: !0, shouldShow: async () => Mr({ queryClient: c }) }),
      (t[6] = c),
      (t[7] = S));
  let C;
  return (
    t[8] !== g || t[9] !== _ || t[10] !== v || t[11] !== b || t[12] !== x || t[13] !== S
      ? ((C = {
          isLoading: _,
          shouldShowStandardOnboarding: v,
          shouldShowConversationalOnboarding: b,
...
function Ai(e, t) {
  switch ((m.debug(`[onboarding-flow] store result`, { safe: { resultStep: t.step } }), t.step)) {
    case K.TeenWelcome:
      return;
    case K.TeenInterests:
      e.set(li, t);
...
function Fi(e) {
  ...
  return (
    t[7] === l
      ? (u = t[8])
      : ((u = (0, Li.jsx)(Li.Fragment, { children: l })), (t[7] = l), (t[8] = u)),
    u
  );
}
var Ii,
...
function zi(e) {
  ...
  let _;
  t[9] !== f || t[10] !== l || t[11] !== i || t[12] !== r || t[13] !== a
    ? ((_ = (e) => {
  ...
  t[20] !== m
    ? ((v = (e) => {
        ...
        return (0, Ui.jsx)(Fr, {
          ...
          isPending: f.isImporting || l.status === `importing`,
          logShownOnMount: !1,
...
function Ki(e) {
  ...
  t[3] !== n.providerIds || t[4] !== u || t[5] !== i
    ? ((d = (e) => {
        u({ source: `first_time_onboarding`, action: e, ...Pr(i, Ar(i), n.providerIds) });
      }),
      (t[3] = n.providerIds),
      (t[4] = u),
      (t[5] = i),
  ...
  t[7] === f
    ...
    : ((p = () => {
      ...
      (t[7] = f),
      (t[8] = p));
  let m = (0, Ji.useEffectEvent)(p),
    h;
  t[9] === m
    ? (h = t[10])
    : ((h = () => {
        c.current || ((c.current = !0), m());
      }),
      (t[9] = m),
      (t[10] = h));
  let g;
  (t[11] === i ? (g = t[12]) : ((g = [i]), (t[11] = i), (t[12] = g)), (0, Ji.useEffect)(h, g));
  let _;
  t[13] === r
    ? (_ = t[14])
    : ((_ = (e) => {
...
function Zi(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (c = t[0]);
  let l = c,
    u = o === `checkbox` ? `py-[13px]` : `mt-7`,
    d;
  t[1] === u
    ? (d = t[2])
    : ((d = U(`relative flex items-center justify-center gap-2`, u)), (t[1] = u), (t[2] = d));
  let f;
  t[3] !== n || t[4] !== s || t[5] !== r || t[6] !== o
    ? ((f =
        o === `checkbox`
          ? (0, $i.jsx)(we, {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, $i.jsx)(ae, { className: `size-4`, "aria-hidden": `true` })), (t[15] = g))
    : (g = t[15]);
  let _;
  t[16] === h
    ? (_ = t[17])
  ...
  return (
    t[21] !== v || t[22] !== d || t[23] !== f
      ? ((y = (0, $i.jsxs)(`div`, { className: d, children: [f, v] })),
        (t[21] = v),
        (t[22] = d),
        (t[23] = f),
        (t[24] = y))
...
var Qi,
  $i,
  ea = e(() => {
    ((Qi = u()), z(), g(), at(), he(), be(), Fe(), De(), xe(), ($i = N()));
  });
function ta(e) {
  let t = (0, na.c)(10),
    {
...
function aa(e) {
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, q.jsx)(Te, { "aria-hidden": !0, className: `size-[18px] shrink-0` })), (t[16] = g))
    : (g = t[16]);
  let _;
  t[17] !== i || t[18] !== a
    ? ((_ = (e) => {
...
function oa(e) {
  ...
  t[4] === o
    ? (s = t[5])
    : ((s = U(`flex size-[18px] shrink-0 items-center justify-center rounded-full border`, o)),
      (t[4] = o),
      (t[5] = s));
  let c;
  t[6] === n
  ...
  t[11] === u
    ? (d = t[12])
    : ((d = (0, q.jsx)(`span`, { className: `truncate`, children: (0, q.jsx)(W, { ...u }) })),
      (t[11] = u),
      (t[12] = d));
  let f;
  return (
...
var sa,
  ...
  ca,
  la = e(() => {
    ((sa = u()), z(), at(), Ce(), Pt(), (q = N()), (ca = Bt.filter((e) => e !== `something_else`)));
  });
function ua(e) {
  let t = (0, da.c)(9),
          ...
          (0, fa.jsxs)(
            `button`,
            {
              ...
              children: [
                ...
                (0, fa.jsx)(`span`, { children: (0, fa.jsx)(W, { ...Bn(e).label }) }),
              ],
            },
            e,
          )),
...
function ma(e) {
  ...
  if (
    ...
    m.selectedRole === `something_else`
      ? (n = e.length > 1 ? e : F.formatMessage(Ft[m.selectedRole]))
      : m.selectedRole != null && (n = F.formatMessage(Ft[m.selectedRole]));
    let i =
    ...
    t[45] !== F || t[46] !== m.selectedTask
      ? ((h = m.selectedTask == null ? null : Bn(m.selectedTask)),
    ...
    let I = le,
      ue = `${ne} ${ie}\n\n${se}`,
      { hasContentBelow: fe, hasContentUnderTitleBar: ge } = te;
    de = fe;
    let H = c && !E,
      Se = ge ? Ma : ja;
    ((L = !H && !c && (m.phase !== `role` || O)),
      (pe = !H && !c && m.phase === `role` && O),
      (_e = `relative flex h-full min-h-0 w-full flex-col bg-token-main-surface-primary tracking-normal text-token-text-primary select-text [--codex-chat-font-size:16px]`));
    let Ce = ge
    ...
    (t[60] === Ce
      ? (we = t[61])
      : ((we = U(`pointer-events-none absolute inset-x-0 top-0 z-20 h-12 border-b-[0.5px]`, Ce)),
        (t[60] = Ce),
        (t[61] = we)),
      t[62] === we
        ? (R = t[63])
        : ((R = (0, J.jsx)(`div`, { className: we })), (t[62] = we), (t[63] = R)));
    let Te;
    t[64] === H
      ? (Te = t[65])
      : ((Te = H ? { height: Da, top: `50%`, width: Da, x: `-50%`, y: `-50%` } : !1),
        (t[64] = H),
        (t[65] = Te));
    let Ee;
    t[66] !== ge || t[67] !== r || t[68] !== H || t[69] !== Se
      ? ((Ee =
          H && !r
            ? { height: Da, top: `50%`, width: Da, x: `-50%`, y: `-50%` }
            : { height: Se, top: ge ? `0.875rem` : `1.5rem`, width: Se, x: `-50%`, y: 0 }),
        (t[66] = ge),
        (t[67] = r),
        (t[68] = H),
        (t[69] = Se),
    ...
    t[71] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (De = t[71]);
    let Oe;
    t[72] !== r || t[73] !== P || t[74] !== H
      ? ((Oe = P ? { duration: 0 } : { ...Aa, delay: H && r ? Ea : 0 }),
        (t[72] = r),
        (t[73] = P),
        (t[74] = H),
        (t[75] = Oe))
    ...
    let ke;
    t[76] !== r || t[77] !== H
      ? ((ke = H && r ? () => D(!0) : void 0), (t[76] = r), (t[77] = H), (t[78] = ke))
      : (ke = t[78]);
    let Ae;
    (t[79] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((Ae = (0, J.jsx)(Tr, { className: `block size-full` })), (t[79] = Ae))
      : (Ae = t[79]),
      t[80] !== Te || t[81] !== Ee || t[82] !== Oe || t[83] !== ke
        ? ((ve = (0, J.jsx)(Ge.div, {
            "aria-hidden": `true`,
          ...
          (t[84] = ve))
        : (ve = t[84]),
      (he = `relative flex min-h-0 flex-1`),
      (V = ae),
      (xe = `flex min-h-0 flex-1 flex-col-reverse overflow-x-hidden overflow-y-auto [overflow-anchor:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden`),
      t[85] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((me = (e) => N(e.currentTarget)), (t[85] = me))
        : (me = t[85]),
      (z = ce),
      (B = `min-h-full shrink-0 px-8 pt-[72px]`),
      (ye = `mx-auto flex w-full max-w-[736px] flex-col gap-4 pb-6 text-lg leading-6`),
      (be = H
        ? null
        : c
              ...
              children: [
                ...
                m.phase === `role` && O
                  ...
                  : m.phase === `role`
                    ...
                    : (0, J.jsxs)(J.Fragment, {
                        children: [
                          (0, J.jsx)(_a, { answer: n ?? ``, question: se }),
                          ...
                          u
                            ...
                            : (0, J.jsxs)(J.Fragment, {
                                children: [
                                  (0, J.jsx)(Pn, {
                                    animate: m.phase === `task` && M.length === 0,
                                    onComplete: () => j(!0),
                                    children: [
                                      F.formatMessage(
                                        {
...
`),
                                  ...
                                  m.phase === `task`
                                            ...
                                            (0, J.jsxs)(
                                              `div`,
                                              {
                                                ...
                                                children: [
                                                  ...
                                                  (0, J.jsx)(Pn, {
                                                    animate: t === M.length - 1,
                                                    children: Rn[e].getDeclinedRetryPrompt(F),
                                                  }),
                                                ],
                                              },
                                              `${e}-${t}`,
                                    ...
                                    : (0, J.jsxs)(J.Fragment, {
                                        children: [
                                          (0, J.jsx)(_a, { answer: S ?? ``, question: I }),
                                          S == null
                                            ? null
                                            : (0, J.jsxs)(`div`, {
  ...
  let H;
  t[86] !== ye || t[87] !== be
    ? ((H = (0, J.jsx)(`div`, { className: ye, children: be })),
      (t[86] = ye),
      (t[87] = be),
      (t[88] = H))
    : (H = t[88]);
  let Se;
  t[89] !== H || t[90] !== z || t[91] !== B
    ? ((Se = (0, J.jsx)(`div`, { ref: z, className: B, children: H })),
      (t[89] = H),
      (t[90] = z),
      (t[91] = B),
      (t[92] = Se))
    : (Se = t[92]);
  let Ce;
  t[93] !== me || t[94] !== Se || t[95] !== V || t[96] !== xe
    ? ((Ce = (0, J.jsx)(`div`, { ref: V, className: xe, onScroll: me, children: Se })),
      (t[93] = me),
      (t[94] = Se),
      (t[95] = V),
      (t[96] = xe),
      (t[97] = Ce))
    : (Ce = t[97]);
  let we = de ? `opacity-100` : `opacity-0`,
    Te;
  t[98] === we
    ? (Te = t[99])
    : ((Te = U(
  ...
  t[100] === Te
    ...
    : ((De = (0, J.jsx)(`div`, { "aria-hidden": !0, className: Te })),
      ...
      (t[101] = De));
  let Oe;
  t[102] !== he || t[103] !== Ce || t[104] !== De
    ? ((Oe = (0, J.jsxs)(`div`, { className: he, children: [Ce, De] })),
      (t[102] = he),
      (t[103] = Ce),
      (t[104] = De),
      (t[105] = Oe))
    ...
    ? ((ke =
        pe || L
          ? (0, J.jsxs)(Ge.div, {
              ...
              transition: ka,
              children: [
                pe ? (0, J.jsx)(Zi, { checked: M, onChange: ee, variant: `checkbox` }) : null,
                L
                  ? (0, J.jsx)(ta, {
                      canContinueRole: n,
                      isTaskReady: i,
                  ...
                  : null,
                L ? (0, J.jsx)(ba, { isTaskReady: i, phase: m.phase }) : null,
              ],
            })
          : null),
      (t[106] = n),
        ...
        children: [
          ...
          (0, J.jsx)(fe, {
            children: (0, J.jsxs)(Ee, {
              children: [
                Pe,
                (0, J.jsx)(I, { color: `outline`, type: `button`, onClick: S, children: Fe }),
              ],
            }),
          }),
        ],
  ...
  let Le;
  t[124] !== w || t[125] !== Ie
    ? ((Le = (0, J.jsx)(le, { open: w, size: `compact`, onOpenChange: T, children: Ie })),
      (t[124] = w),
      (t[125] = Ie),
      (t[126] = Le))
    : (Le = t[126]);
  ...
  return (
    ...
    t[131] !== Ae ||
    t[132] !== Le
      ? ((Re = (0, J.jsxs)(`div`, { className: _e, children: [R, ve, Oe, Ae, Le] })),
        (t[127] = _e),
        (t[128] = R),
        (t[129] = ve),
        (t[130] = Oe),
...
function _a(e) {
  let t = (0, xa.c)(37),
    ...
    [i, a] = (0, Sa.useState)(!1),
    { elementHeightPx: o, elementRef: s } = Kt(),
    c;
  ...
  t[6] === f
    ? (p = t[7])
    : ((p = (0, J.jsx)(Ie, { className: f, "aria-hidden": !0 })), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== i || t[9] !== c || t[10] !== p
    ? ((m = (0, J.jsxs)(`button`, {
        type: `button`,
  ...
  let v = !i,
    ...
    x;
  t[15] === b ? (x = t[16]) : ((x = U(b)), (t[15] = b), (t[16] = x));
  let S = i ? `auto` : `none`,
    C;
...
function Pa(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Ba.jsx)(D, { scope: qn, children: (0, Ba.jsx)(Fa, { onContinue: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function Fa(e) {
  ...
  t[0] !== i.accountId || t[1] !== i.userId || t[2] !== o
    ? ((s = { accountId: i.accountId, enabled: o, userId: i.userId }),
      ...
      (t[3] = s))
    : (s = t[3]);
  let { data: c, isLoading: l } = Nt(s),
    u = T(Be),
    d = A(Be),
    f;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = { conversationId: null, cwdOverride: Va, hostId: jt }), (t[4] = f))
    : (f = t[4]);
  let { isConfigDataPending: p, requirements: m } = ln(f),
    h;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = { conversationId: null, cwdOverride: Va, hostId: jt }), (t[5] = h))
    : (h = t[5]);
  let { agentMode: g, permissionProfileId: _, shouldSendPermissionOverrides: b } = cn(h),
    { serviceTierSettings: x } = Ut(null),
    S;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = { hostId: jt }), (t[6] = S))
    : (S = t[6]);
  let { data: C, isLoading: E } = Yn(S),
    D = k(pn) ?? jn(r),
    O = k(zt) === !0,
    j = D.selectedTask,
    M = k(Je),
    ee;
  t[7] === i.email ? (ee = t[8]) : ((ee = nr(i.email)), (t[7] = i.email), (t[8] = ee));
  let ne = ee,
    re = M == null,
    N;
  t[9] === re ? (N = t[10]) : ((N = { enabled: re }), (t[9] = re), (t[10] = N));
  let { data: ie, isError: ae } = v(or, ne, N),
    oe = ar({ debugOverride: M, detectedProvider: ie?.provider, emailDomain: ne, isError: ae }),
    se = a?.plan_type ?? i.planAtLogin,
    P = oe == null ? null : rr(oe, se),
    le = oe == null ? null : Ln(oe, se),
    F = P == null ? null : Dn(P),
    I;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = { hostId: jt }), (t[11] = I))
    : (I = t[11]);
  let { data: ue, isLoading: de } = ce(I),
    fe;
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((fe = { hostId: jt, marketplaceKind: `local` }), (t[12] = fe))
    : (fe = t[12]);
  let { data: L, isLoading: pe, refetch: me } = ke(fe),
    he = P == null ? null : kn(P, L),
    ge = y(),
    _e =
      ue == null || F == null
        ? []
        : F.flatMap((e) => {
            let t = In(ue, e);
            return t == null ? [] : [zn(t.id)];
          }),
    R;
  (t[13] === _e ? (R = t[14]) : ((R = { queries: _e }), (t[13] = _e), (t[14] = R)), te(R));
  let ve;
  t[15] === C?.models
    ? (ve = t[16])
    : ((ve = C?.models.some(Ia)), (t[15] = C?.models), (t[16] = ve));
  let ye = ve === !0,
    be;
  t[17] === me ? (be = t[18]) : ((be = async () => (await me()).data), (t[17] = me), (t[18] = be));
  let z;
  t[19] !== g ||
  t[20] !== ue ||
  t[21] !== de ||
  ...
  t[33] !== be
    ? ((z = {
        ...
        isModelsLoading: E,
        isPluginsLoading: pe,
        isRequiredModelAvailable: ye,
        localPlugins: L,
        mailProvider: P,
        permissionProfileId: _,
        permissionsRequirements: m,
        projectRoot: Va,
        queryClient: ge,
        refetchLocalPlugins: be,
    ...
    : (z = t[34]);
  let B = z,
    [V, xe] = (0, za.useState)(null),
    [H, Se] = (0, za.useState)(``),
    [Ce, we] = (0, za.useState)(!0),
    [Te, U] = (0, za.useState)(!1),
    [Ee, De] = (0, za.useState)(!1),
    Oe = k(Kn),
    Ae = k(On),
    je = k(wn),
    Me = v(hn, Oe?.conversationId ?? null),
    Ne = v(gn, Oe?.conversationId ?? null),
    Pe;
  t[35] === H ? (Pe = t[36]) : ((Pe = H.trim()), (t[35] = H), (t[36] = Pe));
  let Fe = Pe,
    Ie = V != null && (V !== `something_else` || Fe.length > 1),
    Le;
  t[37] !== Ae || t[38] !== j || t[39] !== Me
    ? ((Le = j != null && (Hn(j) ? Me != null : Ae)),
      (t[37] = Ae),
      (t[38] = j),
      (t[39] = Me),
      (t[40] = Le))
  ...
  t[44] !== r || t[45] !== B
    ? ((He = async (e) => {
      ...
      (t[46] = He))
    : (He = t[46]);
  let Ue = (0, za.useEffectEvent)(He),
    We;
  t[47] !== L || t[48] !== P || t[49] !== Ue
    ? ((We = () => {
        L == null || P == null || Ue(P);
      }),
      (t[47] = L),
  ...
  let Ge;
  (t[51] !== L || t[52] !== P
    ? ((Ge = [L, P]), (t[51] = L), (t[52] = P), (t[53] = Ge))
    : (Ge = t[53]),
    (0, za.useEffect)(We, Ge));
  let Ke;
  t[54] !== i.accountId ||
  t[55] !== Re ||
  t[56] !== n ||
  ...
  t[60] !== j
    ? ((Ke = async (e) => {
        ...
        (Re && i.accountId != null && j != null && on(r, i.accountId, j),
          t ? pr(r, j) : br(r, j),
          await n({
  ...
  let qe = Ke,
    Ye;
  t[62] !== Ie || t[63] !== V || t[64] !== r || t[65] !== d || t[66] !== Fe
    ? ((Ye = (e) => {
        if (!Ie || V == null) return;
        let t = [V],
          n = Lt(t);
        (d({ roles: t, personalizedSuggestionsEnabled: e, workMode: n }),
          it(r, gt, {
            step: `role`,
            option: V,
            selected: !0,
            selectedRoles: V,
            selectedWorkMode: n,
            otherRoleDescription: V === `something_else` ? Fe : void 0,
          }),
          _n(r, V),
          hr(r, V),
          U(!0));
  ...
  let Xe = Ye,
    Ze;
  t[68] !== Ne || t[69] !== je || t[70] !== Re || t[71] !== r || t[72] !== j
    ? ((Ze = () => {
        if (j != null) {
          if (Ne) {
            _r(r, j);
  ...
  let Qe = Ze,
    $e;
  t[74] !== r || t[75] !== j || t[76] !== D.permissionStatus
    ? (($e = () => {
        j == null || D.permissionStatus === `allowed` || vr(r, j);
      }),
      (t[74] = r),
      (t[75] = j),
      (t[76] = D.permissionStatus),
      (t[77] = $e))
    : ($e = t[77]);
  let tt = $e,
    rt;
  t[78] !== Qe || t[79] !== r || t[80] !== j || t[81] !== B
    ? ((rt = (e) => {
        (Qe(), Mn(jt), j != null && Rn[j].reset(r), Gn(r), vn(r, e), mr(r, e), De(!0));
        let t = Rn[e];
        (t.reset(r), t.prepare?.(r, e, B));
      }),
      (t[78] = Qe),
      (t[79] = r),
      (t[80] = j),
  ...
  let at = rt,
    ot;
  t[83] !== tt || t[84] !== Qe || t[85] !== r
    ? ((ot = (e) => {
        (Qe(), tt(), Mn(jt), Rn[e].reset(r), Gn(r), De(!1), Cn(r, e));
      }),
      (t[83] = tt),
      (t[84] = Qe),
      (t[85] = r),
  ...
  let st = ot,
    W;
  t[87] !== Qe || t[88] !== r || t[89] !== j || t[90] !== B
    ? ((W = () => {
        (Qe(), j != null && (Mn(jt), Gn(r), Rn[j].retry(r, j, B)));
      }),
      (t[87] = Qe),
      (t[88] = r),
      (t[89] = j),
  ...
  t[92] !== r || t[93] !== B
    ? ((lt = () => {
        De(!1);
        let e = jn(r).selectedTask;
        e != null && Rn[e].start?.(r, e, B);
      }),
      (t[92] = r),
      (t[93] = B),
      (t[94] = lt))
    : (lt = t[94]);
  let ut = lt,
    dt = D.permissionStatus === `denied` || Re,
    ft = j == null ? null : Rn[j].View,
    pt;
  t[95] !== ft || t[96] !== st || t[97] !== ct || t[98] !== O || t[99] !== j || t[100] !== B
    ? ((pt =
        ft == null || j == null
          ? null
          : (0, Ba.jsx)(
              ...
              {
                context: B,
                isAppWindowFocused: O,
                task: j,
                onChooseAnotherTask: () => st(j),
                onRetryTask: ct,
              },
              j,
            )),
  ...
  t[102] === c?.displayName
    ? (vt = t[103])
    : ((vt = c?.displayName?.trim().split(/\s+/)[0] || void 0),
      (t[102] = c?.displayName),
      (t[103] = vt));
  let yt;
  t[104] !== qe || t[105] !== u.personalizedSuggestionsEnabled
    ? ((yt = () => {
        qe({ isSkipped: !1, personalizedSuggestionsEnabled: u.personalizedSuggestionsEnabled });
      }),
      (t[104] = qe),
      (t[105] = u.personalizedSuggestionsEnabled),
      (t[106] = yt))
    : (yt = t[106]);
  let bt;
  ...
  t[109] !== tt ||
  t[110] !== Qe ||
  t[111] !== u.personalizedSuggestionsEnabled ||
  t[112] !== r ||
  t[113] !== D.permissionStatus ||
  t[114] !== D.phase
    ? ((xt = () => {
        (Qe(),
          tt(),
          D.permissionStatus !== `allowed` && yn(r, `denied`),
          qe({
            isSkipped: !0,
            personalizedSuggestionsEnabled:
              D.phase === `role` ? !1 : u.personalizedSuggestionsEnabled,
          }));
      }),
      (t[108] = qe),
      (t[109] = tt),
  ...
  return (
    ...
    t[134] !== D
      ? ((Ct = (0, Ba.jsx)(ma, {
          ...
          isAppWindowFocused: O,
          isTaskReady: dt,
          otherRoleDescription: H,
          roleSelection: V,
          selectedTaskContent: mt,
          showInitialThinking: ht,
          showSelectedTaskThinking: Ee,
          showTaskIntroThinking: _t,
          taskIds: le,
          taskPlugins: he,
          userFirstName: vt,
          workflow: D,
          onContinueRole: Xe,
          onGetStarted: yt,
          onInitialThinkingComplete: bt,
          onOtherRoleDescriptionChange: Se,
          onRoleSelectionChange: xe,
          onSelectTask: at,
          onSelectedTaskThinkingComplete: ut,
          onSkip: xt,
          onTaskIntroThinkingComplete: St,
        })),
        (t[117] = Ie),
        (t[118] = Xe),
        (t[119] = at),
...
function Ua(e) {
  ...
  let u = l,
    d;
  t[2] === c ? (d = t[3]) : ((d = c.get(`allow_skip`, !0)), (t[2] = c), (t[3] = d));
  let f = d,
    [p] = (0, Ka.useState)(It),
    m;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = { roles: [], personalizedSuggestionsEnabled: !0, workMode: null }), (t[4] = m))
    : (m = t[4]);
  let [h, g] = (0, Ka.useState)(m),
    _;
  t[5] !== a || t[6] !== o?.arm
    ? ((_ = (e) => {
  ...
  let b = y,
    x;
  t[11] !== u || t[12] !== h || t[13] !== v
    ? ((x = (e) => {
        let t = !u || !h.roles.includes(e),
          n = [e];
        u && (n = t ? [...h.roles, e] : h.roles.filter((t) => t !== e));
        let r = { ...h, roles: n, workMode: Lt(n) };
        (g(r), v({ role: e, selected: t, state: r }));
      }),
      (t[11] = u),
      (t[12] = h),
      (t[13] = v),
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (e) => {
        g((t) => ({ ...t, personalizedSuggestionsEnabled: e }));
      }),
      (t[15] = C))
    : (C = t[15]);
  let E = C,
    D = h.roles.length > 0 && !i,
    O = !i,
    k;
  t[16] === r
    ? (k = t[17])
  ...
  t[19] !== D ||
  t[20] !== O ||
  t[21] !== h.personalizedSuggestionsEnabled ||
  t[22] !== h.roles ||
  t[23] !== b ||
  t[24] !== p ||
  t[25] !== S
              ...
              children: [
                ...
                (0, Y.jsx)(`div`, {
                  ...
                  children: p.map((e) =>
                    (0, Y.jsx)(
                      Wa,
                      { role: e, selected: h.roles.includes(e), onClick: () => S(e) },
                      e,
                    ),
                  ),
                }),
                (0, Y.jsx)(Zi, { checked: h.personalizedSuggestionsEnabled, onChange: E }),
                (0, Y.jsxs)(`div`, {
                      ...
                      onClick: () => {
                        t({
                          result: {
                            ...
                            roles: h.roles,
                            personalizedSuggestionsEnabled: h.personalizedSuggestionsEnabled,
                            workMode: Lt(h.roles),
                          },
                        });
                      },
                    ...
                    f
                      ? (0, Y.jsx)(`button`, {
                          ...
                          onClick: () => {
                            ...
                            (b(e), t({ result: { step: K.RoleSelection, ...e }, skipped: !0 }));
                          },
                          children: (0, Y.jsx)(W, {
...
var eo,
  ...
  no,
  ro = e(() => {
    ((eo = u()), (to = t(C(), 1)), ai(), Gr(), Ri(), Qa(), (no = N()));
  });
function io(e) {
  let t = (0, so.c)(34),
...
function oo(e) {
  ...
  t[7] === n.titleMessage
    ...
    : ((s = (0, Z.jsx)(`h3`, {
        ...
        children: (0, Z.jsx)(W, { ...n.titleMessage }),
      })),
      (t[7] = n.titleMessage),
      (t[8] = s));
  let c;
  t[9] === n.descriptionMessage
    ...
    : ((c = (0, Z.jsx)(`p`, {
        ...
        children: (0, Z.jsx)(W, { ...n.descriptionMessage }),
      })),
      (t[9] = n.descriptionMessage),
      (t[10] = c));
  let l;
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsxs)(`button`, {
        ...
        children: [
          ...
          (0, Q.jsx)(Qn, { className: `icon-sm`, ExternalIcon: dn, href: bo }),
        ],
      })),
      (t[7] = l))
    : (l = t[7]);
...
function go(e) {
  Pe({ event: e, href: bo, initiator: `open_in_browser_bridge` });
}
function _o() {
  let e = (0, yo.c)(4),
    t;
...
function vo(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = U(`absolute overflow-hidden rounded-2xl border border-token-border/50 shadow-2xl`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  return (
...
function No(e) {
  ...
  t[5] !== g || t[6] !== n || t[7] !== r
    ? ((E = () => {
        g().then((e) => {
          e && (r.set(Xt, !0), n({ step: K.WindowsSandboxSetup }));
        });
      }),
      (t[5] = g),
      (t[6] = n),
  ...
  t[9] !== n || t[10] !== r || t[11] !== m
    ? ((O = () => {
        (m(), r.set(Xt, !0), n({ step: K.WindowsSandboxSetup }));
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = m),
...
function Po(e) {
  ...
  if (i) {
    let e;
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(Qt, { className: `size-10` })), (t[0] = e))
      : (e = t[0]);
    let n;
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  if (a) {
    let e;
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(Qt, { className: `size-10` })), (t[2] = e))
      : (e = t[2]);
    let n;
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(Qt, { className: `size-10` })), (t[13] = _))
    : (_ = t[13]);
  let v;
  ...
  return (
    t[55] !== l || t[56] !== M
      ? ((ee = (0, $.jsx)(Fo, { shiftForWorkspaceRequirement: l, children: M })),
        (t[55] = l),
        (t[56] = M),
        (t[57] = ee))
      : (ee = t[57]),
...
function Fo(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = U(`relative my-auto flex w-full shrink-0 flex-col items-center gap-5 py-7`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  return (
...
function Io(e) {
  ...
  let p, m;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(ge, { className: `sr-only`, children: s })),
      (m = (0, $.jsx)(me, { className: `sr-only`, children: l })),
      (t[7] = p),
      (t[8] = m))
    : ((p = t[7]), (m = t[8]));
  let h;
  ...
  t[12] === f
    ? (v = t[13])
    : ((v = (0, $.jsxs)(oe, { as: `form`, onSubmit: f, children: [p, m, h, _] })),
      (t[12] = f),
      (t[13] = v));
  let y;
  return (
...
function Lo(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsx)(ye, { className: `size-3.5` }),
      })),
      (t[4] = l))
    : (l = t[4]);
  let u;
  ...
  t[9] === r
    ...
    : ((m = r
        ? (0, $.jsx)(`span`, {
            ...
            "aria-hidden": `true`,
            children: (0, $.jsx)(Oo, { className: U(`h-[30px] w-[25px]`, jo.uacArrow) }),
          })
        : null),
      (t[9] = r),
      (t[10] = m));
...
function Vo(e) {
  ...
  switch (n) {
    case K.Start: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Uo.jsx)(ur, { debugName: `OnboardingLoadingPage` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
...
var Ho,
  Uo,
  Wo = e(() => {
    ((Ho = u()), M(), lr(), di(), ai(), Wi(), Xi(), Ha(), qa(), ro(), mo(), Eo(), Bo(), (Uo = N()));
  });
function Go() {
  let e = (0, Ko.c)(25),
    t = w(oi),
  ...
  e[10] === p
    ...
    : ((m = () => {
      ...
      (e[10] = p),
      (e[11] = m));
  let h = (0, qo.useEffectEvent)(m),
    g;
  e[12] !== h || e[13] !== r || e[14] !== d.isLoading
    ? ((g = () => {
        r !== K.Start || d.isLoading || h();
      }),
      (e[12] = h),
      (e[13] = r),
      (e[14] = d.isLoading),
  ...
  let y = v,
    b;
  return (
    e[21] !== r || e[22] !== y || e[23] !== d
      ? ((b = (0, Jo.jsx)(Vo, { currentStep: r, onboardingContext: d, onContinue: y })),
        (e[21] = r),
        (e[22] = y),
        (e[23] = d),
        (e[24] = b))
...
function Xo() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $o.jsx)(D, { scope: oi, children: (0, $o.jsx)(Zo, {}) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function Zo() {
  let e = (0, Qo.c)(3),
    t = k(si),
    n = a.ChatGPT === `codex` && t !== K.ConversationalOnboarding,
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $o.jsx)(Go, {})), (e[0] = r))
    : (r = e[0]);
  ...
  return (
    e[1] === n
      ? (i = e[2])
      : ((i = (0, $o.jsx)(zr, { fullBleed: !0, showBrandIcon: n, children: r })),
        (e[1] = n),
        (e[2] = i)),
    i
  );
