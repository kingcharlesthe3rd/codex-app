...
import { bt as mt, yt as ht } from "./app-initial~app-main~automations-page.js";
import {
  $o as gt,
  A as _t,
  Bf as vt,
...
import { i as ir, r as ar } from "./ambient-suggestions-connected-apps-consent.js";
import {
  b as or,
  h as sr,
  m as cr,
...
import { n as Lr, r as Rr } from "./app-initial~app-main~onboarding-page~profile.js";
import { i as zr, r as Br } from "./app-initial~app-main~new-thread-panel-page.js";
import { n as Vr, t as Hr } from "./animated-icon.js";
function Ur(e, t) {
...
var Wr,
  ...
  ai = e(() => {
    (te(),
      ...
      (qr = [`coding`, `non_coding`]),
      (Jr = [`claude-code`, `claude-cowork`]),
      (Yr = o({
        state: o({
          roles: j(N(Kr)),
          personalizedSuggestionsEnabled: E(),
          workMode: N(qr).nullable(),
        }),
        options: o({ focusComposer: E().optional(), prefillPrompt: k().optional() }).optional(),
      })),
      (K = {
        Start: `start`,
      ...
      (Xr = o({ step: h(K.TeenWelcome) })),
      (Zr = o({ step: h(K.TeenInterests), interests: j(N(Wr)) })),
      (Qr = o({ step: h(K.TeenPrompts), completion: Yr })),
      ($r = o({ step: h(K.WindowsSandboxSetup) })),
      (ei = o({
        step: h(K.ConversationalOnboarding),
        roles: j(N(Kr)),
        personalizedSuggestionsEnabled: E(),
        workMode: N(qr).nullable(),
      })),
      (ti = o({
        step: h(K.RoleSelection),
        roles: j(N(Kr)),
        personalizedSuggestionsEnabled: E(),
        workMode: N(qr).nullable(),
      })),
      (ni = o({
        step: h(K.AgentMigrationSourceSelection),
        providerIds: j(N(Jr)),
        skipped: E().optional(),
      })),
      (ri = o({ step: h(K.AgentMigrationItemSelection), action: N([`imported`, `skipped`]) })),
      (ii = ie(`step`, [Xr, Zr, Qr, $r, ei, ti, ni, ri])));
  }),
  oi,
  si,
  ci,
    ...
    e[12] !== n
      ? ((g = () => {
          ...
          if (
            ...
            return;
          let { state: l, options: u } = e,
            g = l.personalizedSuggestionsEnabled ?? !0,
            _ = hi(l.workMode);
          (n(l),
            ge(t, y.conversationDetailMode, _.threadDetailLevel)
              .catch(mi)
              .finally(() => {
                let e = a === `welcome`;
                (o(`auto`),
                  ...
                  r(`/?${Gn}=1`, {
                    replace: !0,
                    state:
                      u?.focusComposer !== !0 && u?.prefillPrompt == null
                        ? void 0
                        : { focusComposerNonce: Date.now(), prefillPrompt: u.prefillPrompt },
                  }));
              }),
            _.fontSizes != null &&
              (ge(t, ne.sansFontSize, _.fontSizes.sans), ge(t, ne.codeFontSize, _.fontSizes.code)),
            t.set(An, _.composerPermissionModeVisibility),
            g && t.set(ar, !0),
            (async () => {
              (await ge(t, w.enabled, g),
                g &&
                  (await D(`ambient-suggestions-refresh`, {
                    params: { domain: null, hostId: it, projectRoot: re(`~`) },
                  }),
                  await Promise.all([
                    i.invalidateQueries({ queryKey: x(`ambient-suggestions`) }),
                    i.invalidateQueries({ queryKey: x(`ambient-suggestions-refresh`) }),
                  ])));
            })().catch(pi));
        }),
        (e[0] = r),
...
function pi(e) {
  r.error(`Failed to refresh ambient suggestions after onboarding`, {
    safe: {},
    sensitive: { error: e },
  });
}
function mi(e) {
  r.error(`Failed to persist welcome v2 onboarding configuration`, {
    safe: {},
    sensitive: { error: e },
  });
}
...
function bi(e) {
  let t = (0, xi.c)(15),
    ...
    s = ye(),
    c = C(),
    { client: l, isLoading: u } = at(),
    d;
  t[0] === l ? (d = t[1]) : ((d = Qe(l, `2744470156`)), (t[0] = l), (t[1] = d));
  let f = d,
    p = s.authMethod === `chatgpt`,
    m;
  t[2] === p ? (m = t[3]) : ((m = { enabled: p }), (t[2] = p), (t[3] = m));
  let { isLoading: h, shouldUseTeenOnboarding: g } = Kn(m),
  ...
  t[6] === c
    ? (x = t[7])
    : ((x = { isSupported: !0, shouldShow: async () => Er({ queryClient: c }) }),
      (t[6] = c),
      (t[7] = x));
  let S;
  return (
...
async function Ci(
  ...
  let o = e.get(si);
  if (o === K.Complete) return;
  let s = a == null ? void 0 : ii.parse(a);
  s != null && Ai(e, s);
  let c = await wi({ currentStep: o, onboardingContext: i, result: s });
  e.get(si) === o && (c !== o && (o === K.Start && n(), ki(e, c, r)), c === K.Complete && t());
}
async function wi({ currentStep: e, onboardingContext: t, result: n }) {
  if (t.isLoading) return e;
  switch (e) {
    case K.Start:
      return t.shouldShowStandardOnboarding ? Ti(t) : Oi(t);
    case K.WindowsSandboxSetup:
      return K.Complete;
    case K.TeenWelcome:
...
function Ti(e) {
  return e.shouldShowTeenOnboarding
    ...
    : e.shouldShowConversationalOnboarding
      ? K.ConversationalOnboarding
      : K.RoleSelection;
}
async function Ei(e, t) {
  return (t?.step === K.ConversationalOnboarding || t?.step === K.RoleSelection) &&
    t.workMode === `non_coding`
    ? Oi(e)
    : (await e.agentMigration.shouldShow())
      ? K.AgentMigrationSourceSelection
      : Oi(e);
}
function Di({ currentStep: e, onboardingContext: t, result: n }) {
  switch (e) {
    case K.AgentMigrationSourceSelection:
      return n?.step === K.AgentMigrationSourceSelection &&
        n.skipped !== !0 &&
...
function Oi(e) {
  return e.finalStep.shouldShow ? K.WindowsSandboxSetup : K.Complete;
}
function ki(e, t, n) {
  e.set(si, t);
  let r = ji[t];
...
function Ai(e, t) {
  switch ((r.debug(`[onboarding-flow] store result`, { safe: { resultStep: t.step } }), t.step)) {
    case K.TeenWelcome:
      return;
    case K.TeenInterests:
      e.set(li, t);
  ...
  Mi = e(() => {
    (m(),
      ...
      (ji = {
        ...
        [K.WindowsSandboxSetup]: null,
        [K.ConversationalOnboarding]: null,
...
function Fi(e) {
  ...
  return (
    t[7] === l
      ? (d = t[8])
      : ((d = (0, Li.jsx)(Li.Fragment, { children: l })), (t[7] = l), (t[8] = d)),
    d
  );
}
var Ii,
...
function zi(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = { status: `idle` }), (t[0] = c))
    : (c = t[0]);
  let [d, f] = (0, Hi.useState)(c),
    p;
  t[1] === n.isSupported
    ? (p = t[2])
    : ((p = { enabled: n.isSupported }), (t[1] = n.isSupported), (t[2] = p));
  let m = Tr(p),
    h;
  t[3] !== m || t[4] !== r
    ? ((h = m.getSummaryForProviders(r)), (t[3] = m), (t[4] = r), (t[5] = h))
    : (h = t[5]);
  let g = h,
    _;
  t[6] !== o || t[7] !== s?.arm
    ? ((_ = (e) => {
        Ke(o, st, { ...e, experimentArm: s?.arm });
      }),
      (t[6] = o),
      (t[7] = s?.arm),
      (t[8] = _))
  ...
  let y;
  t[9] !== m || t[10] !== d || t[11] !== i || t[12] !== r || t[13] !== o
    ? ((y = (e) => {
        ...
        Ni({
          importSelection: () => m.importSelection(t, r),
          importStatus: d,
          onComplete: () => {
  ...
  t[20] !== g
    ? ((b = (e) => {
        ...
        return (0, Ui.jsx)(Sr, {
          appBrand: lr,
          hasError: d.status === `error`,
          isComplete: d.status === `success`,
          isPending: m.isImporting || d.status === `importing`,
          logShownOnMount: !1,
...
function Gi(e) {
  ...
  return (
    t[2] !== a || t[3] !== r
      ? ((o = (0, Yi.jsx)(Ki, { agentMigration: a, onContinue: r, summary: a.summary })),
        (t[2] = a),
        (t[3] = r),
        (t[4] = o))
      : (o = t[4]),
...
function Ki(e) {
  ...
  let f = d,
    p;
  t[3] !== n.providerIds || t[4] !== f || t[5] !== i
    ? ((p = (e) => {
        f({ source: `first_time_onboarding`, action: e, ...wr(i, yr(i), n.providerIds) });
      }),
      (t[3] = n.providerIds),
      (t[4] = f),
      (t[5] = i),
  ...
  t[7] === m
    ...
    : ((h = () => {
      ...
      (t[7] = m),
      (t[8] = h));
  let g = (0, Ji.useEffectEvent)(h),
    _;
  t[9] === g
    ? (_ = t[10])
    : ((_ = () => {
        c.current || ((c.current = !0), g());
      }),
      (t[9] = g),
      (t[10] = _));
  let v;
  (t[11] === i ? (v = t[12]) : ((v = [i]), (t[11] = i), (t[12] = v)), (0, Ji.useEffect)(_, v));
  let y;
  t[13] === r
    ? (y = t[14])
    : ((y = (e) => {
...
function Zi(e) {
  ...
  t[1] === l
    ? (u = t[2])
    : ((u = H(`relative flex items-center justify-center gap-2`, l)), (t[1] = l), (t[2] = u));
  let d;
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, $i.jsx)(ur, { className: `size-4`, "aria-hidden": `true` })), (t[15] = h))
    : (h = t[15]);
  let g;
  t[16] === m
    ? (g = t[17])
  ...
  return (
    t[21] !== _ || t[22] !== u || t[23] !== d
      ? ((v = (0, $i.jsxs)(`div`, { className: u, children: [d, _] })),
        (t[21] = _),
        (t[22] = u),
        (t[23] = d),
        (t[24] = v))
...
function aa(e) {
  ...
  let u;
  t[3] !== a || t[4] !== r
    ? ((u = ca.map((e) => (0, q.jsx)(oa, { checked: r === e, role: e, onSelect: () => a(e) }, e))),
      (t[3] = a),
      (t[4] = r),
      (t[5] = u))
    : (u = t[5]);
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, q.jsx)(dr, { "aria-hidden": !0, className: `size-[18px] shrink-0` })), (t[16] = g))
    : (g = t[16]);
  let _;
  t[17] !== i || t[18] !== a
    ? ((_ = (e) => {
...
function oa(e) {
  ...
  t[4] === o
    ? (s = t[5])
    : ((s = H(`flex size-[18px] shrink-0 items-center justify-center rounded-full border`, o)),
      (t[4] = o),
      (t[5] = s));
  let c;
  t[6] === n
    ? (c = t[7])
    : ((c = n
        ? (0, q.jsx)(`span`, { className: `size-[7px] rounded-full bg-token-main-surface-primary` })
        : null),
      (t[6] = n),
      (t[7] = c));
  let l;
  t[8] !== s || t[9] !== c
    ? ((l = (0, q.jsx)(`span`, { className: s, children: c })), (t[8] = s), (t[9] = c), (t[10] = l))
    : (l = t[10]);
  let u = Ir[r],
    d;
  t[11] === u
    ? (d = t[12])
    : ((d = (0, q.jsx)(`span`, { className: `truncate`, children: (0, q.jsx)(G, { ...u }) })),
      (t[11] = u),
      (t[12] = d));
  let f;
  return (
...
var sa,
  ...
  ca,
  la = e(() => {
    ((sa = T()), V(), Je(), fr(), Fr(), (q = A()), (ca = Pr.filter((e) => e !== `something_else`)));
  });
function ua(e) {
  let t = (0, da.c)(9),
          ...
          (0, fa.jsxs)(
            `button`,
            {
              ...
              children: [
                ...
                (0, fa.jsx)(`span`, { children: (0, fa.jsx)(G, { ...gn(e).label }) }),
              ],
            },
            e,
          )),
...
function ma(e) {
  let t = (0, xa.c)(134),
    {
      ...
      isTaskReady: i,
      otherRoleDescription: a,
      roleSelection: o,
      selectedTaskContent: s,
      showInitialThinking: c,
      showSelectedTaskThinking: l,
      showTaskIntroThinking: u,
      taskIds: d,
      taskPlugins: f,
      userFirstName: p,
      workflow: m,
      onContinueRole: h,
      onGetStarted: g,
      onInitialThinkingComplete: _,
      onOtherRoleDescriptionChange: v,
      onRoleSelectionChange: y,
      onSelectTask: b,
      onSelectedTaskThinkingComplete: x,
      onSkip: S,
      onTaskIntroThinkingComplete: C,
    } = e,
    [w, T] = (0, Sa.useState)(!1),
    [E, D] = (0, Sa.useState)(!1),
    [O, k] = (0, Sa.useState)(!1),
    [A, j] = (0, Sa.useState)(!1),
    [ee, M] = (0, Sa.useState)(!0),
    [te, ne] = (0, Sa.useState)(Ta),
    re;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = (e) => {
        let t = va(e);
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (e, t) => {
        t.parentElement != null && N(t.parentElement);
      }),
      (t[2] = oe))
    : (oe = t[2]);
  let se = P(oe),
  ...
  if (
    ...
    let e = a.trim(),
      n = null;
    m.selectedRole === `something_else`
      ? (n = e.length > 1 ? e : F.formatMessage(Ir[m.selectedRole]))
      : m.selectedRole != null && (n = F.formatMessage(Ir[m.selectedRole]));
    let i =
        m.selectedRole === `something_else` || m.selectedRole === `people_hr`
          ? n
          : n?.toLocaleLowerCase(),
      h,
      g;
    t[45] !== F || t[46] !== m.selectedTask
      ? ((h = m.selectedTask == null ? null : gn(m.selectedTask)),
        (g = h == null ? null : F.formatMessage(h.label)),
        (t[45] = F),
        (t[46] = m.selectedTask),
        (t[47] = h),
        (t[48] = g))
      : ((h = t[47]), (g = t[48]));
    let S = g,
      w = h?.SelectionAttachment ?? null,
      T;
    t[49] === m.declinedTasks
      ? (T = t[50])
      : ((T = m.declinedTasks ?? []), (t[49] = m.declinedTasks), (t[50] = T));
    let ee = T,
      M;
    t[51] !== F || t[52] !== p
      ? ((M =
    ...
    let L = me,
      Ce = `${ne} ${ie}\n\n${P}`,
      { hasContentBelow: R, hasContentUnderTitleBar: z } = te;
    le = R;
    let B = c && !E,
      we = z ? Ma : ja;
    ((ue = !B && !c && (m.phase !== `role` || O)),
      (de = !B && !c && m.phase === `role` && O),
      (I = `relative flex h-full min-h-0 w-full flex-col bg-token-main-surface-primary tracking-normal text-token-text-primary select-text [--codex-chat-font-size:16px]`));
    let Te = z
    ...
    (t[60] === Te
      ? (Ee = t[61])
      : ((Ee = H(`pointer-events-none absolute inset-x-0 top-0 z-20 h-12 border-b-[0.5px]`, Te)),
        (t[60] = Te),
        (t[61] = Ee)),
      t[62] === Ee
        ? (he = t[63])
        : ((he = (0, J.jsx)(`div`, { className: Ee })), (t[62] = Ee), (t[63] = he)));
    let De;
    t[64] === B
      ? (De = t[65])
      : ((De = B ? { height: Da, top: `50%`, width: Da, x: `-50%`, y: `-50%` } : !1),
        (t[64] = B),
        (t[65] = De));
    let Oe;
    t[66] !== z || t[67] !== r || t[68] !== B || t[69] !== we
      ? ((Oe =
          B && !r
            ? { height: Da, top: `50%`, width: Da, x: `-50%`, y: `-50%` }
            : { height: we, top: z ? `0.875rem` : `1.5rem`, width: we, x: `-50%`, y: 0 }),
        (t[66] = z),
        (t[67] = r),
        (t[68] = B),
        (t[69] = we),
    ...
    t[71] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (ke = t[71]);
    let Ae;
    t[72] !== r || t[73] !== ce || t[74] !== B
      ? ((Ae = ce ? { duration: 0 } : { ...Aa, delay: B && r ? Ea : 0 }),
        (t[72] = r),
        (t[73] = ce),
        (t[74] = B),
        (t[75] = Ae))
    ...
    let V;
    t[76] !== r || t[77] !== B
      ? ((V = B && r ? () => D(!0) : void 0), (t[76] = r), (t[77] = B), (t[78] = V))
      : (V = t[78]);
    let je;
    (t[79] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((je = (0, J.jsx)(mr, { className: `block size-full` })), (t[79] = je))
      : (je = t[79]),
      t[80] !== De || t[81] !== Oe || t[82] !== Ae || t[83] !== V
        ? ((ge = (0, J.jsx)(Me.div, {
            "aria-hidden": `true`,
          ...
          (t[84] = ge))
        : (ge = t[84]),
      (pe = `relative flex min-h-0 flex-1`),
      (xe = ae),
      (Se = `flex min-h-0 flex-1 flex-col-reverse overflow-x-hidden overflow-y-auto [overflow-anchor:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden`),
      t[85] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((fe = (e) => N(e.currentTarget)), (t[85] = fe))
        : (fe = t[85]),
      (ye = se),
      ...
      (ve = B
        ? null
        : c
          ? (0, J.jsx)(ha, { fadeIn: !0, onComplete: _ })
          : (0, J.jsxs)(J.Fragment, {
              children: [
                (0, J.jsx)(tn, {
                  animate: m.phase === `role`,
                  onComplete: () => k(!0),
                  children: Ce,
                }),
                m.phase === `role` && O
                  ...
                  : m.phase === `role`
                    ...
                    : (0, J.jsxs)(J.Fragment, {
                        children: [
                          ...
                          u
                            ? (0, J.jsx)(ha, { onComplete: C })
                            : (0, J.jsxs)(J.Fragment, {
                                children: [
                                  (0, J.jsx)(tn, {
                                    animate: m.phase === `task` && ee.length === 0,
                                    onComplete: () => j(!0),
                                    children: [
                                      F.formatMessage(
                                        {
...
`),
                                  ...
                                  m.phase === `task`
                                            ...
                                            (0, J.jsxs)(
                                              `div`,
                                              {
                                                ...
                                                children: [
                                                  ...
                                                  (0, J.jsx)(tn, {
                                                    animate: t === ee.length - 1,
                                                    children: mn[e].getDeclinedRetryPrompt(F),
                                                  }),
                                                ],
                                              },
                                              `${e}-${t}`,
                                    ...
                                    : (0, J.jsxs)(J.Fragment, {
                                        children: [
                                          (0, J.jsx)(_a, { answer: S ?? ``, question: L }),
                                          S == null
                                            ? null
                                            : (0, J.jsxs)(`div`, {
                                                className: `flex flex-col gap-2`,
                                                children: [
                                                  w == null ? null : (0, J.jsx)(w, {}),
                                                  (0, J.jsx)(ya, { children: S }),
                                                ],
                                              }),
                                          l
                                            ? (0, J.jsx)(ha, { durationSeconds: Oa, onComplete: x })
                                            : s,
                                        ],
                                      }),
                                ],
  ...
  let L;
  t[86] !== _e || t[87] !== ve
    ? ((L = (0, J.jsx)(`div`, { className: _e, children: ve })),
      (t[86] = _e),
      (t[87] = ve),
      (t[88] = L))
    : (L = t[88]);
  let Ce;
  t[89] !== L || t[90] !== ye || t[91] !== be
    ? ((Ce = (0, J.jsx)(`div`, { ref: ye, className: be, children: L })),
      (t[89] = L),
      (t[90] = ye),
      (t[91] = be),
      (t[92] = Ce))
    : (Ce = t[92]);
  let R;
  t[93] !== fe || t[94] !== Ce || t[95] !== xe || t[96] !== Se
    ? ((R = (0, J.jsx)(`div`, { ref: xe, className: Se, onScroll: fe, children: Ce })),
      (t[93] = fe),
      (t[94] = Ce),
      (t[95] = xe),
      (t[96] = Se),
      (t[97] = R))
    : (R = t[97]);
  let we = le ? `opacity-100` : `opacity-0`,
    Te;
  t[98] === we
    ? (Te = t[99])
    : ((Te = H(
  ...
  t[100] === Te
    ? (De = t[101])
    : ((De = (0, J.jsx)(`div`, { "aria-hidden": !0, className: Te })),
      (t[100] = Te),
      (t[101] = De));
  let ke;
  t[102] !== pe || t[103] !== R || t[104] !== De
    ? ((ke = (0, J.jsxs)(`div`, { className: pe, children: [R, De] })),
      (t[102] = pe),
      (t[103] = R),
      (t[104] = De),
      (t[105] = ke))
    ...
    ? ((Ae =
        de || ue
          ? (0, J.jsxs)(Me.div, {
              ...
              transition: ka,
              children: [
                de ? (0, J.jsx)(Zi, { checked: ee, onChange: M, variant: `checkbox` }) : null,
                ue
                  ? (0, J.jsx)(ta, {
                      canContinueRole: n,
                      isTaskReady: i,
                  ...
                  : null,
                ue ? (0, J.jsx)(ba, { isTaskReady: i, phase: m.phase }) : null,
              ],
            })
          : null),
      (t[106] = n),
  ...
  t[122] === S
    ...
    : ((Le = (0, J.jsxs)(Ee, {
        ...
        children: [
          ...
          Pe,
          (0, J.jsx)(Oe, {
            children: (0, J.jsxs)(ze, {
              children: [
                Fe,
                (0, J.jsx)(B, { color: `outline`, type: `button`, onClick: S, children: Ie }),
              ],
            }),
          }),
        ],
  ...
  let Re;
  t[124] !== w || t[125] !== Le
    ? ((Re = (0, J.jsx)(Ve, { open: w, size: `compact`, onOpenChange: T, children: Le })),
      (t[124] = w),
      (t[125] = Le),
      (t[126] = Re))
    : (Re = t[126]);
  let Be;
  return (
    t[127] !== I || t[128] !== he || t[129] !== ge || t[130] !== ke || t[131] !== V || t[132] !== Re
      ? ((Be = (0, J.jsxs)(`div`, { className: I, children: [he, ge, ke, V, Re] })),
        (t[127] = I),
        (t[128] = he),
        (t[129] = ge),
        (t[130] = ke),
...
function _a(e) {
  let t = (0, xa.c)(37),
    ...
    [i, a] = (0, Sa.useState)(!1),
    { elementHeightPx: o, elementRef: s } = Dt(),
    c;
  ...
  t[6] === f
    ? (p = t[7])
    : ((p = (0, J.jsx)(he, { className: f, "aria-hidden": !0 })), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== i || t[9] !== c || t[10] !== p
    ? ((m = (0, J.jsxs)(`button`, {
        type: `button`,
  ...
  let v = !i,
    y = !i,
    b = i ? `mt-1.5 overflow-visible` : `overflow-hidden`,
    x;
  t[15] === b ? (x = t[16]) : ((x = H(b)), (t[15] = b), (t[16] = x));
  let S = i ? `auto` : `none`,
    C;
  ...
  t[19] === r
    ? (T = t[20])
    : ((T = (0, J.jsx)(`p`, { className: `text-token-text-secondary`, children: r })),
      (t[19] = r),
      (t[20] = T));
  let E;
  t[21] === n ? (E = t[22]) : ((E = (0, J.jsx)(`p`, { children: n })), (t[21] = n), (t[22] = E));
  let D;
  t[23] !== w || t[24] !== T || t[25] !== E
    ? ((D = (0, J.jsxs)(`div`, {
        ref: w,
    ...
    : (D = t[26]);
  let O;
  t[27] !== _ || t[28] !== v || t[29] !== y || t[30] !== x || t[31] !== C || t[32] !== D
    ? ((O = (0, J.jsx)(Me.div, {
        initial: !1,
        animate: _,
        "aria-hidden": v,
  ...
  return (
    t[34] !== O || t[35] !== m
      ? ((k = (0, J.jsxs)(`div`, { className: `flex flex-col`, children: [m, O] })),
        (t[34] = O),
        (t[35] = m),
        (t[36] = k))
      : (k = t[36]),
...
function Pa(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Ba.jsx)(g, { scope: Tn, children: (0, Ba.jsx)(Fa, { onContinue: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function Fa(e) {
  ...
  t[0] !== i.accountId || t[1] !== i.userId || t[2] !== o
    ? ((c = { accountId: i.accountId, enabled: o, userId: i.userId }),
      (t[0] = i.accountId),
      (t[1] = i.userId),
      (t[2] = o),
      (t[3] = c))
    : (c = t[3]);
  let { data: d, isLoading: f } = Rr(c),
    p = l(Rn),
    m = v(Rn),
    h;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = { conversationId: null, cwdOverride: Va, hostId: it }), (t[4] = h))
    : (h = t[4]);
  let { isConfigDataPending: g, requirements: _ } = pn(h),
    y;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = { conversationId: null, cwdOverride: Va, hostId: it }), (t[5] = y))
    : (y = t[5]);
  let { agentMode: b, permissionProfileId: x, shouldSendPermissionOverrides: S } = Ut(y),
    { serviceTierSettings: w } = Bt(null),
    T;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = { hostId: it }), (t[6] = T))
    : (T = t[6]);
  let { data: E, isLoading: D } = Pt(T),
    O = M(_t) ?? rn(r),
    k = M(ht) === !0,
    A = O.selectedTask,
    j = M(zn),
    te;
  t[7] === i.email ? (te = t[8]) : ((te = er(i.email)), (t[7] = i.email), (t[8] = te));
  let ne = te,
    re = j == null,
    N;
  t[9] === re ? (N = t[10]) : ((N = { enabled: re }), (t[9] = re), (t[10] = N));
  let { data: ie, isError: ae } = s(rr, ne, N),
    oe = nr({ debugOverride: j, detectedProvider: ie?.provider, emailDomain: ne, isError: ae }),
    se = a?.plan_type ?? i.planAtLogin,
    P = oe == null ? null : $n(oe, se),
    ce = oe == null ? null : un(oe, se),
    F = P == null ? null : Yt(P),
    ue;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ue = { hostId: it }), (t[11] = ue))
    : (ue = t[11]);
  let { data: de, isLoading: fe } = Le(ue),
    pe;
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pe = { hostId: it, marketplaceKind: `local` }), (t[12] = pe))
    : (pe = t[12]);
  let { data: I, isLoading: me, refetch: he } = le(pe),
    ge = P == null ? null : $t(P, I),
    _e = C(),
    ve =
      de == null || F == null
        ? []
        : F.flatMap((e) => {
            let t = Wt(de, e);
            return t == null ? [] : [Ht(t.id)];
          }),
    be;
  (t[13] === ve ? (be = t[14]) : ((be = { queries: ve }), (t[13] = ve), (t[14] = be)), ee(be));
  let xe;
  t[15] === E?.models
    ? (xe = t[16])
    : ((xe = E?.models.some(Ia)), (t[15] = E?.models), (t[16] = xe));
  let Se = xe === !0,
    L;
  t[17] === he ? (L = t[18]) : ((L = async () => (await he()).data), (t[17] = he), (t[18] = L));
  let Ce;
  t[19] !== b ||
  t[20] !== de ||
  t[21] !== fe ||
  ...
  t[33] !== L
    ? ((Ce = {
        ...
        hostId: it,
        isAppsLoading: fe,
        isConfigDataPending: g,
        isModelsLoading: D,
        isPluginsLoading: me,
        isRequiredModelAvailable: Se,
        localPlugins: I,
        mailProvider: P,
        permissionProfileId: x,
        permissionsRequirements: _,
        projectRoot: Va,
        queryClient: _e,
        refetchLocalPlugins: L,
        serviceTier: w.serviceTierForRequest,
    ...
    : (Ce = t[34]);
  let R = Ce,
    [z, B] = (0, za.useState)(null),
    [we, Te] = (0, za.useState)(``),
    [Ee, De] = (0, za.useState)(!0),
    [Oe, ke] = (0, za.useState)(!1),
    [V, je] = (0, za.useState)(!1),
    Me = M(wn),
    Ne = M(Qt),
    Pe = M(It),
    Fe = s(xt, Me?.conversationId ?? null),
    H = s(St, Me?.conversationId ?? null),
    Ie;
  t[35] === we ? (Ie = t[36]) : ((Ie = we.trim()), (t[35] = we), (t[36] = Ie));
  let Re = Ie,
    ze = z != null && (z !== `something_else` || Re.length > 1),
    Be;
  t[37] !== Ne || t[38] !== A || t[39] !== Fe
    ? ((Be = A != null && (yn(A) ? Fe != null : Ne)),
      (t[37] = Ne),
      (t[38] = A),
      (t[39] = Fe),
      (t[40] = Be))
  ...
  t[44] !== r || t[45] !== R
    ? ((We = async (e) => {
      ...
      (t[46] = We))
    : (We = t[46]);
  let Ge = (0, za.useEffectEvent)(We),
    qe;
  t[47] !== I || t[48] !== P || t[49] !== Ge
    ? ((qe = () => {
        I == null || P == null || Ge(P);
      }),
      (t[47] = I),
  ...
  let Je;
  (t[51] !== I || t[52] !== P
    ? ((Je = [I, P]), (t[51] = I), (t[52] = P), (t[53] = Je))
    : (Je = t[53]),
    (0, za.useEffect)(qe, Je));
  let Ye;
  t[54] !== i.accountId ||
  t[55] !== Ve ||
  t[56] !== n ||
  ...
  t[60] !== A
    ? ((Ye = async (e) => {
        ...
        (Ve && i.accountId != null && A != null && Ar(r, i.accountId, A),
          t ? nn(r, A) : en(r, A),
          await n({
            step: K.ConversationalOnboarding,
            roles: p.roles,
  ...
  let Xe = Ye,
    U;
  t[62] !== ze || t[63] !== z || t[64] !== r || t[65] !== m || t[66] !== Re
    ? ((U = (e) => {
        if (!ze || z == null) return;
        let t = [z],
          n = Nr(t);
        (m({ roles: t, personalizedSuggestionsEnabled: e, workMode: n }),
          Ke(r, tt, {
            ...
            selectedRoles: z,
            selectedWorkMode: n,
            otherRoleDescription: z === `something_else` ? Re : void 0,
          }),
          Ct(r, z),
          hn(r, z),
          ke(!0));
  ...
  let Ze = U,
    Qe;
  t[68] !== H || t[69] !== Pe || t[70] !== Ve || t[71] !== r || t[72] !== A
    ? ((Qe = () => {
        if (A != null) {
          if (H) {
            ln(r, A);
  ...
  let W = Qe,
    $e;
  t[74] !== r || t[75] !== A || t[76] !== O.permissionStatus
    ? (($e = () => {
        A == null || O.permissionStatus === `allowed` || gt(r, A);
      }),
      (t[74] = r),
      (t[75] = A),
      (t[76] = O.permissionStatus),
      (t[77] = $e))
    : ($e = t[77]);
  let et = $e,
    nt;
  t[78] !== W || t[79] !== r || t[80] !== A || t[81] !== R
    ? ((nt = (e) => {
        (W(), an(it), A != null && mn[A].reset(r), Sn(r), Et(r, e), fn(r, e), je(!0));
        let t = mn[e];
        (t.reset(r), t.prepare?.(r, e, R));
      }),
      (t[78] = W),
      (t[79] = r),
      (t[80] = A),
  ...
  let rt = nt,
    at;
  t[83] !== et || t[84] !== W || t[85] !== r
    ? ((at = (e) => {
        (W(), et(), an(it), mn[e].reset(r), Sn(r), je(!1), Nt(r, e));
      }),
      (t[83] = et),
      (t[84] = W),
      (t[85] = r),
  ...
  let ot = at,
    st;
  t[87] !== W || t[88] !== r || t[89] !== A || t[90] !== R
    ? ((st = () => {
        (W(), A != null && (an(it), Sn(r), mn[A].retry(r, A, R)));
      }),
      (t[87] = W),
      (t[88] = r),
      (t[89] = A),
  ...
  t[92] !== r || t[93] !== R
    ...
    : (lt = t[94]);
  let ut = lt,
    dt = O.permissionStatus === `denied` || Ve,
    ft = A == null ? null : mn[A].View,
    pt;
  t[95] !== ft || t[96] !== ot || t[97] !== ct || t[98] !== k || t[99] !== A || t[100] !== R
    ? ((pt =
        ft == null || A == null
          ? null
          : (0, Ba.jsx)(
              ...
              {
                context: R,
                isAppWindowFocused: k,
                task: A,
                onChooseAnotherTask: () => ot(A),
                onRetryTask: ct,
              },
              A,
            )),
  ...
  t[102] === d?.displayName
    ? (yt = t[103])
    : ((yt = d?.displayName?.trim().split(/\s+/)[0] || void 0),
      (t[102] = d?.displayName),
      (t[103] = yt));
  let bt;
  t[104] !== Xe || t[105] !== p.personalizedSuggestionsEnabled
    ? ((bt = () => {
        Xe({ isSkipped: !1, personalizedSuggestionsEnabled: p.personalizedSuggestionsEnabled });
      }),
      (t[104] = Xe),
      (t[105] = p.personalizedSuggestionsEnabled),
      (t[106] = bt))
    : (bt = t[106]);
  let wt;
  ...
  t[109] !== et ||
  t[110] !== W ||
  t[111] !== p.personalizedSuggestionsEnabled ||
  t[112] !== r ||
  t[113] !== O.permissionStatus ||
  t[114] !== O.phase
    ? ((Tt = () => {
        (W(),
          et(),
          O.permissionStatus !== `allowed` && Ot(r, `denied`),
          Xe({
            isSkipped: !0,
            personalizedSuggestionsEnabled:
              O.phase === `role` ? !1 : p.personalizedSuggestionsEnabled,
          }));
      }),
      (t[108] = Xe),
      (t[109] = et),
  ...
  return (
    ...
    t[134] !== O
      ? ((kt = (0, Ba.jsx)(ma, {
          ...
          isAppWindowFocused: k,
          isTaskReady: dt,
          otherRoleDescription: we,
          roleSelection: z,
          selectedTaskContent: G,
          showInitialThinking: mt,
          showSelectedTaskThinking: V,
          ...
          onContinueRole: Ze,
          onGetStarted: bt,
          onInitialThinkingComplete: wt,
          onOtherRoleDescriptionChange: Te,
          onRoleSelectionChange: B,
          onSelectTask: rt,
          onSelectedTaskThinkingComplete: ut,
          onSkip: Tt,
          onTaskIntroThinkingComplete: Dt,
        })),
        (t[117] = ze),
        (t[118] = Ze),
        (t[119] = rt),
...
function Ua(e) {
  let t = (0, Ga.c)(30),
    ...
    c = ot(`4147559047`),
    d;
  t[0] === c ? (d = t[1]) : ((d = c.get(`allow_multi_select`, !0)), (t[0] = c), (t[1] = d));
  let f = d,
    p;
  t[2] === c ? (p = t[3]) : ((p = c.get(`allow_skip`, !0)), (t[2] = c), (t[3] = p));
  let m = p,
    [h] = (0, Ka.useState)(Mr),
    g;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = { roles: [], personalizedSuggestionsEnabled: !0, workMode: null }), (t[4] = g))
    : (g = t[4]);
  let [_, v] = (0, Ka.useState)(g),
    y;
  t[5] !== o || t[6] !== s?.arm
    ? ((y = (e) => {
              ...
              children: [
                ...
                (0, Y.jsx)(`div`, {
                  ...
                  children: h.map((e) =>
                    (0, Y.jsx)(
                      Wa,
                      { role: e, selected: _.roles.includes(e), onClick: () => w(e) },
                      e,
                    ),
                  ),
                }),
                (0, Y.jsx)(Zi, { checked: _.personalizedSuggestionsEnabled, onChange: E }),
                (0, Y.jsxs)(`div`, {
                      ...
                      onClick: () => {
                        t({
                          result: {
                            ...
                            roles: _.roles,
                            personalizedSuggestionsEnabled: _.personalizedSuggestionsEnabled,
                            workMode: Nr(_.roles),
                          },
                        });
                      },
                    ...
                    m
                      ? (0, Y.jsx)(`button`, {
                          ...
                          onClick: () => {
                            ...
                            (S(e), t({ result: { step: K.RoleSelection, ...e }, skipped: !0 }));
                          },
                          children: (0, Y.jsx)(G, {
  ...
  return (
    t[27] !== A || t[28] !== k
      ? ((j = (0, Y.jsx)(Fi, { name: `role_selection`, onComplete: k, children: A })),
        (t[27] = A),
        (t[28] = k),
        (t[29] = j))
      : (j = t[29]),
...
function $a(e) {
  ...
  return (
    t[6] !== c || t[7] !== l
      ? ((u = (0, no.jsx)(Fi, { name: `teen_interests`, onComplete: c, children: l })),
        (t[6] = c),
        (t[7] = l),
        (t[8] = u))
      : (u = t[8]),
...
var eo,
  ...
  no,
  ro = e(() => {
    ((eo = T()), (to = t(b(), 1)), ai(), Gr(), Ri(), Qa(), (no = A()));
  });
function io(e) {
  let t = (0, so.c)(34),
...
function oo(e) {
  ...
  t[7] === n.titleMessage
    ...
    : ((s = (0, Z.jsx)(`h3`, {
        ...
        children: (0, Z.jsx)(G, { ...n.titleMessage }),
      })),
      (t[7] = n.titleMessage),
      (t[8] = s));
  let c;
  t[9] === n.descriptionMessage
    ...
    : ((c = (0, Z.jsx)(`p`, {
        ...
        children: (0, Z.jsx)(G, { ...n.descriptionMessage }),
      })),
      (t[9] = n.descriptionMessage),
      (t[10] = c));
  let l;
...
function uo(e) {
  ...
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, po.jsx)(Fi, { name: `teen_prompts`, onComplete: i, children: a })),
        (t[4] = i),
        (t[5] = a),
        (t[6] = o))
      : (o = t[6]),
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsxs)(`button`, {
        ...
        children: [
          ...
          (0, Q.jsx)(xe, { className: `icon-sm`, ExternalIcon: Vt, href: bo }),
        ],
      })),
      (t[7] = l))
    : (l = t[7]);
...
function go(e) {
  Ne({ event: e, href: bo, initiator: `open_in_browser_bridge` });
}
function _o() {
  let e = (0, yo.c)(4),
    t;
...
function No(e) {
  let t = (0, Ro.c)(27),
    ...
    r = u(a),
    {
      ...
      requiresElevatedSandboxByPolicy: f,
      showUnelevatedSetupAlternative: p,
      allowUnelevatedFallback: m,
      setLimitedAccessMode: h,
      enableElevated: g,
      enableUnelevated: _,
      retryRequirements: v,
    } = Ln(),
    { hasError: y, retry: b } = Fn(),
    x;
  t[0] === n
    ? (x = t[1])
    : ((x = (e) => {
        e && n({ step: K.WindowsSandboxSetup });
      }),
      (t[0] = n),
      (t[1] = x));
  let S = x,
  ...
  t[5] !== _ || t[6] !== n || t[7] !== r
    ? ((E = () => {
        _().then((e) => {
          e && (r.set(jn, !0), n({ step: K.WindowsSandboxSetup }));
        });
      }),
      (t[5] = _),
      (t[6] = n),
  ...
  t[9] !== n || t[10] !== r || t[11] !== h
    ? ((O = () => {
        (h(), r.set(jn, !0), n({ step: K.WindowsSandboxSetup }));
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = h),
...
function Po(e) {
  ...
  if (i) {
    let e;
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(xn, { className: `size-10` })), (t[0] = e))
      : (e = t[0]);
    let n;
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  if (a) {
    let e;
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(xn, { className: `size-10` })), (t[2] = e))
      : (e = t[2]);
    let n;
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(xn, { className: `size-10` })), (t[13] = _))
    : (_ = t[13]);
  let v;
  ...
  t[18] !== r || t[19] !== d || t[20] !== S
    ? ((C = (0, $.jsx)(Lo, { disabled: r, showArrow: S, onElevatedSetup: d })),
      (t[18] = r),
      (t[19] = d),
      (t[20] = S),
      (t[21] = C))
  ...
  t[40] !== r || t[41] !== m || t[42] !== l
    ? ((k = l ? (0, $.jsx)(Io, { disabled: r, onConfirm: m }) : null),
      (t[40] = r),
      (t[41] = m),
      (t[42] = l),
      (t[43] = k))
  ...
  return (
    t[55] !== l || t[56] !== ee
      ? ((M = (0, $.jsx)(Fo, { shiftForWorkspaceRequirement: l, children: ee })),
        (t[55] = l),
        (t[56] = ee),
        (t[57] = M))
      : (M = t[57]),
...
function Fo(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = H(`relative my-auto flex w-full shrink-0 flex-col items-center gap-5 py-7`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  return (
...
function Io(e) {
  ...
  let p, m;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(me, { className: `sr-only`, children: s })),
      (m = (0, $.jsx)(we, { className: `sr-only`, children: l })),
      (t[7] = p),
      (t[8] = m))
    : ((p = t[7]), (m = t[8]));
  let h;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, $.jsx)(Oe, {
        className: `!pt-0`,
        children: (0, $.jsx)(Ue, { title: s, subtitle: l, subtitleSize: `sm` }),
      })),
      (t[9] = h))
    : (h = t[9]);
  let g;
  ...
  t[12] === f
    ? (v = t[13])
    : ((v = (0, $.jsxs)(Ee, { as: `form`, onSubmit: f, children: [p, m, h, _] })),
      (t[12] = f),
      (t[13] = v));
  let y;
  return (
...
function Lo(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsx)(De, { className: `size-3.5` }),
      })),
      (t[4] = l))
    : (l = t[4]);
  let u;
  ...
  t[9] === r
    ...
    : ((m = r
        ? (0, $.jsx)(`span`, {
            ...
            "aria-hidden": `true`,
            children: (0, $.jsx)(Oo, { className: H(`h-[30px] w-[25px]`, jo.uacArrow) }),
          })
        : null),
      (t[9] = r),
      (t[10] = m));
...
function Vo(e) {
  ...
  switch (n) {
    case K.Start: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Uo.jsx)(Br, { debugName: `OnboardingLoadingPage` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
    ...
    case K.AgentMigrationSourceSelection: {
      ...
      return (
        t[21] !== r.agentMigration || t[22] !== e
          ? ((n = (0, Uo.jsx)(Gi, { agentMigrationContext: r.agentMigration, onContinue: e })),
...
var Ho,
  Uo,
  Wo = e(() => {
    ((Ho = T()), _(), zr(), di(), ai(), Wi(), Xi(), Ha(), qa(), ro(), mo(), Eo(), Bo(), (Uo = A()));
  });
function Go() {
  let e = (0, Ko.c)(25),
    t = u(oi),
  ...
  e[10] === h
    ...
    : ((g = () => {
      ...
      (e[10] = h),
      (e[11] = g));
  let _ = (0, qo.useEffectEvent)(g),
    v;
  e[12] !== _ || e[13] !== r || e[14] !== p.isLoading
    ? ((v = () => {
        r !== K.Start || p.isLoading || _();
      }),
      (e[12] = _),
      (e[13] = r),
      (e[14] = p.isLoading),
    ...
    : (v = e[15]);
  let y;
  (e[16] !== r || e[17] !== p.isLoading
    ? ((y = [r, p.isLoading]), (e[16] = r), (e[17] = p.isLoading), (e[18] = y))
    : (y = e[18]),
    (0, qo.useEffect)(v, y));
  let b;
  e[19] === h
  ...
  let x = b,
    S;
  return (
    e[21] !== r || e[22] !== x || e[23] !== p
      ? ((S = (0, Jo.jsx)(Vo, { currentStep: r, onboardingContext: p, onContinue: x })),
        (e[21] = r),
        (e[22] = x),
        (e[23] = p),
        (e[24] = S))
...
function Xo() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $o.jsx)(g, { scope: oi, children: (0, $o.jsx)(Zo, {}) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function Zo() {
  let e = (0, Qo.c)(3),
    t = M(si),
    n = O.ChatGPT === `codex` && t !== K.ConversationalOnboarding,
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $o.jsx)(Go, {})), (e[0] = r))
    : (r = e[0]);
  ...
  return (
    e[1] === n
      ? (i = e[2])
      : ((i = (0, $o.jsx)(Cr, { fullBleed: !0, showBrandIcon: n, children: r })),
        (e[1] = n),
        (e[2] = i)),
    i
  );
