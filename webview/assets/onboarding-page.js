...
import { i as Wn, r as Gn } from "./ambient-suggestions-connected-apps-consent.js";
import {
  b as Kn,
  h as qn,
  m as Jn,
...
import { n as mr, r as hr } from "./app-initial~app-main~onboarding-page~profile.js";
import {
  a as gr,
  c as _r,
  h as vr,
...
var Wr,
  ...
  ai = e(() => {
    (S(),
      ...
      (Yr = M({
        state: M({
          roles: ne(s(Kr)),
          personalizedSuggestionsEnabled: O(),
          workMode: s(qr).nullable(),
        }),
        options: M({ focusComposer: O().optional(), prefillPrompt: A().optional() }).optional(),
      })),
      (K = {
        Start: `start`,
      ...
      (Xr = M({ step: j(K.TeenWelcome) })),
      (Zr = M({ step: j(K.TeenInterests), interests: ne(s(Wr)) })),
      (Qr = M({ step: j(K.TeenPrompts), completion: Yr })),
      ($r = M({ step: j(K.WindowsSandboxSetup) })),
      (ei = M({
        step: j(K.ConversationalOnboarding),
        roles: ne(s(Kr)),
        personalizedSuggestionsEnabled: O(),
        workMode: s(qr).nullable(),
      })),
      (ti = M({
        step: j(K.RoleSelection),
        roles: ne(s(Kr)),
        personalizedSuggestionsEnabled: O(),
        workMode: s(qr).nullable(),
      })),
      (ni = M({
        step: j(K.AgentMigrationSourceSelection),
        providerIds: ne(s(Jr)),
        skipped: O().optional(),
      })),
      (ri = M({ step: j(K.AgentMigrationItemSelection), action: s([`imported`, `skipped`]) })),
      (ii = re(`step`, [Xr, Zr, Qr, $r, ei, ti, ni, ri])));
  }),
  oi,
  si,
  ci,
  ...
  di = e(() => {
    (c(),
      Pt(),
      ai(),
      (oi = d(`OnboardingScope`, { parent: Ft })),
      (si = u(oi, () => K.Start)),
      (ci = u(oi, () => null)),
      (li = u(oi, () => null)),
      (ui = u(oi, () => null)));
    ...
    e[12] !== n
      ? ((_ = () => {
          ...
          if (
            ...
            return;
          let { state: f, options: h } = e,
            _ = f.personalizedSuggestionsEnabled ?? !0,
            v = hi(f.workMode);
          (n(f),
            kt(t, l.conversationDetailMode, v.threadDetailLevel)
              .catch(mi)
              .finally(() => {
                let e = a === `welcome`;
                (o(`auto`),
                  ...
                  r(`/?${Ln}=1`, {
                    replace: !0,
                    state:
                      h?.focusComposer !== !0 && h?.prefillPrompt == null
                        ? void 0
                        : { focusComposerNonce: Date.now(), prefillPrompt: h.prefillPrompt },
                  }));
              }),
            v.fontSizes != null &&
              (kt(t, x.sansFontSize, v.fontSizes.sans), kt(t, x.codeFontSize, v.fontSizes.code)),
            t.set(Tr, v.composerPermissionModeVisibility),
            _ && t.set(Gn, !0),
            (async () => {
              (await kt(t, w.enabled, _),
                _ &&
                  (await D(`ambient-suggestions-refresh`, {
                    params: { domain: null, hostId: Lt, projectRoot: b(`~`) },
                  }),
                  await Promise.all([
                    i.invalidateQueries({ queryKey: te(`ambient-suggestions`) }),
                    i.invalidateQueries({ queryKey: te(`ambient-suggestions-refresh`) }),
                  ])));
            })().catch(pi));
        }),
        (e[0] = r),
...
function pi(e) {
  a.error(`Failed to refresh ambient suggestions after onboarding`, {
    safe: {},
    sensitive: { error: e },
  });
}
function mi(e) {
  a.error(`Failed to persist welcome v2 onboarding configuration`, {
    safe: {},
    sensitive: { error: e },
  });
}
...
function bi(e) {
  let t = (0, xi.c)(15),
    ...
    s = tn(),
    c = T(),
    { client: l, isLoading: u } = ut(),
    d;
  t[0] === l ? (d = t[1]) : ((d = ot(l, `2744470156`)), (t[0] = l), (t[1] = d));
  let f = d,
    p = s.authMethod === `chatgpt`,
    m;
  t[2] === p ? (m = t[3]) : ((m = { enabled: p }), (t[2] = p), (t[3] = m));
  let { isLoading: h, shouldUseTeenOnboarding: g } = zt(m),
  ...
  t[6] === c
    ? (x = t[7])
    : ((x = { isSupported: !0, shouldShow: async () => Fr({ queryClient: c }) }),
      (t[6] = c),
      (t[7] = x));
  let S;
  return (
...
function Ai(e, t) {
  switch ((a.debug(`[onboarding-flow] store result`, { safe: { resultStep: t.step } }), t.step)) {
    case K.TeenWelcome:
      return;
    case K.TeenInterests:
      e.set(li, t);
...
function Fi(e) {
  ...
  return (
    t[7] === c
      ? (l = t[8])
      : ((l = (0, Li.jsx)(Li.Fragment, { children: c })), (t[7] = c), (t[8] = l)),
    l
  );
}
var Ii,
...
function zi(e) {
  ...
  let d = Mr(u),
    p;
  t[3] !== d || t[4] !== r
    ? ((p = d.getSummaryForProviders(r)), (t[3] = d), (t[4] = r), (t[5] = p))
    : (p = t[5]);
  let m = p,
    g;
  t[6] !== a || t[7] !== o?.arm
    ? ((g = (e) => {
        wt(a, st, { ...e, experimentArm: o?.arm });
      }),
      (t[6] = a),
      (t[7] = o?.arm),
      (t[8] = g))
...
function Ki(e) {
  ...
  t[3] !== n.providerIds || t[4] !== l || t[5] !== i
    ? ((u = (e) => {
        l({ source: `first_time_onboarding`, action: e, ...Lr(i, Nr(i), n.providerIds) });
      }),
      (t[3] = n.providerIds),
      (t[4] = l),
      (t[5] = i),
  ...
  t[9] === m
    ...
    : ((g = () => {
      ...
      (t[10] = g));
  let _;
  (t[11] === i ? (_ = t[12]) : ((_ = [i]), (t[11] = i), (t[12] = _)), (0, Ji.useEffect)(g, _));
  let v;
  t[13] === r
    ? (v = t[14])
    : ((v = (e) => {
...
function Zi(e) {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, $i.jsx)(Xn, { className: `size-4`, "aria-hidden": `true` })), (t[15] = h))
    : (h = t[15]);
  let g;
  t[16] === m
    ? (g = t[17])
...
var Qi,
  $i,
  ea = e(() => {
    ((Qi = r()), Yt(), E(), Nt(), qn(), xn(), Zt(), yt(), Kn(), ($i = n()));
  });
function ta(e) {
  let t = (0, na.c)(10),
    {
...
function aa(e) {
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, q.jsx)(Cn, { "aria-hidden": !0, className: `size-[18px] shrink-0` })), (t[16] = g))
    : (g = t[16]);
  let _;
  t[17] !== i || t[18] !== a
    ? ((_ = (e) => {
...
var sa,
  ...
  la = e(() => {
    ((sa = r()),
      ...
      qt(),
      (q = n()),
      (ca = Gt.filter((e) => e !== `something_else`)));
  });
function ua(e) {
  let t = (0, da.c)(9),
          ...
          (0, fa.jsxs)(
            `button`,
            {
              ...
              children: [
                ...
                (0, fa.jsx)(`span`, { children: (0, fa.jsx)(W, { ...Ye(e).label }) }),
              ],
            },
            e,
          )),
...
function ma(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (e, t) => {
        t.parentElement != null && ie(t.parentElement);
      }),
      (t[2] = se))
    : (se = t[2]);
  let ce = wn(se),
  ...
  if (
    ...
    m.selectedRole === `something_else`
      ? (n = e.length > 1 ? e : N.formatMessage(Bt[m.selectedRole]))
      : m.selectedRole != null && (n = N.formatMessage(Bt[m.selectedRole]));
    let i =
      ...
      h,
      g;
    t[45] !== N || t[46] !== m.selectedTask
      ? ((h = m.selectedTask == null ? null : Ye(m.selectedTask)),
        (g = h == null ? null : N.formatMessage(h.label)),
        (t[45] = N),
        (t[46] = m.selectedTask),
        (t[47] = h),
        (t[48] = g))
    ...
    let we = F,
      Te = `${ne} ${ae}\n\n${Ce}`,
      { hasContentBelow: Ee, hasContentUnderTitleBar: I } = te;
    ue = Ee;
    let L = c && !E,
      De = I ? Ma : ja;
    ((de = !L && !c && (m.phase !== `role` || O)),
      (fe = !L && !c && m.phase === `role` && O),
      (me = `relative flex h-full min-h-0 w-full flex-col bg-token-main-surface-primary tracking-normal text-token-text-primary select-text [--codex-chat-font-size:16px]`));
    let Oe = I
    ...
    (t[60] === Oe
      ? (ke = t[61])
      : ((ke = G(`pointer-events-none absolute inset-x-0 top-0 z-20 h-12 border-b-[0.5px]`, Oe)),
        (t[60] = Oe),
        (t[61] = ke)),
      t[62] === ke
        ? (he = t[63])
        : ((he = (0, J.jsx)(`div`, { className: ke })), (t[62] = ke), (t[63] = he)));
    let je;
    t[64] === L
      ? (je = t[65])
      : ((je = L ? { height: Da, top: `50%`, width: Da, x: `-50%`, y: `-50%` } : !1),
        (t[64] = L),
        (t[65] = je));
    let Me;
    t[66] !== I || t[67] !== r || t[68] !== L || t[69] !== De
      ? ((Me =
          L && !r
            ? { height: Da, top: `50%`, width: Da, x: `-50%`, y: `-50%` }
            : { height: De, top: I ? `0.875rem` : `1.5rem`, width: De, x: `-50%`, y: 0 }),
        (t[66] = I),
        (t[67] = r),
        (t[68] = L),
        (t[69] = De),
    ...
    t[71] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (Ne = t[71]);
    let Pe;
    t[72] !== r || t[73] !== le || t[74] !== L
      ? ((Pe = le ? { duration: 0 } : { ...Aa, delay: L && r ? Ea : 0 }),
        (t[72] = r),
        (t[73] = le),
        (t[74] = L),
        (t[75] = Pe))
    ...
    let Fe;
    t[76] !== r || t[77] !== L
      ? ((Fe = L && r ? () => D(!0) : void 0), (t[76] = r), (t[77] = L), (t[78] = Fe))
      : (Fe = t[78]);
    let R;
    (t[79] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((R = (0, J.jsx)(Dr, { className: `block size-full` })), (t[79] = R))
      : (R = t[79]),
      t[80] !== je || t[81] !== Me || t[82] !== Pe || t[83] !== Fe
        ? ((ge = (0, J.jsx)(vn.div, {
            "aria-hidden": `true`,
              ...
              children: [
                ...
                m.phase === `role` && O
                  ...
                  : m.phase === `role`
                    ...
                    : (0, J.jsxs)(J.Fragment, {
                        children: [
                          (0, J.jsx)(_a, { answer: n ?? ``, question: Ce }),
...
`),
                                  ...
                                  m.phase === `task`
                                              ...
                                              `div`,
                                              {
                                                ...
                                                children: [
                                                  ...
                                                  (0, J.jsx)(Ae, {
                                                    ...
                                                    children: qe[e].getDeclinedRetryPrompt(N),
                                                  }),
                                                ],
                                              },
                                              `${e}-${t}`,
                                    ...
                                    : (0, J.jsxs)(J.Fragment, {
                                        children: [
                                          (0, J.jsx)(_a, { answer: S ?? ``, question: we }),
                                          S == null
                                            ? null
                                            : (0, J.jsxs)(`div`, {
  ...
  let Ce;
  t[86] !== _e || t[87] !== ve
    ? ((Ce = (0, J.jsx)(`div`, { className: _e, children: ve })),
      (t[86] = _e),
      (t[87] = ve),
      (t[88] = Ce))
    : (Ce = t[88]);
  let F;
  t[89] !== Ce || t[90] !== ye || t[91] !== be
    ? ((F = (0, J.jsx)(`div`, { ref: ye, className: be, children: Ce })),
      (t[89] = Ce),
      (t[90] = ye),
      (t[91] = be),
      (t[92] = F))
    : (F = t[92]);
  let we;
  t[93] !== P || t[94] !== F || t[95] !== xe || t[96] !== Se
    ? ((we = (0, J.jsx)(`div`, { ref: xe, className: Se, onScroll: P, children: F })),
      (t[93] = P),
      (t[94] = F),
      (t[95] = xe),
      (t[96] = Se),
      (t[97] = we))
    : (we = t[97]);
  let Te = ue ? `opacity-100` : `opacity-0`,
    Ee;
  t[98] === Te
    ? (Ee = t[99])
    : ((Ee = G(
  ...
  t[100] === Ee
    ? (I = t[101])
    : ((I = (0, J.jsx)(`div`, { "aria-hidden": !0, className: Ee })), (t[100] = Ee), (t[101] = I));
  let L;
  t[102] !== pe || t[103] !== we || t[104] !== I
    ? ((L = (0, J.jsxs)(`div`, { className: pe, children: [we, I] })),
      (t[102] = pe),
      (t[103] = we),
      (t[104] = I),
      (t[105] = L))
    ...
    ? ((De =
        fe || de
          ? (0, J.jsxs)(vn.div, {
              ...
              transition: ka,
              children: [
                fe ? (0, J.jsx)(Zi, { checked: M, onChange: ee, variant: `checkbox` }) : null,
                de
                  ? (0, J.jsx)(ta, {
                      canContinueRole: n,
                      isTaskReady: i,
                  ...
                  : null,
                de ? (0, J.jsx)(ba, { isTaskReady: i, phase: m.phase }) : null,
              ],
            })
          : null),
      (t[106] = n),
  ...
  t[122] === S
    ...
    : ((Fe = (0, J.jsxs)(ar, {
        ...
        children: [
          ...
          Me,
          (0, J.jsx)(er, {
            children: (0, J.jsxs)(nr, {
              children: [
                Ne,
                (0, J.jsx)(V, { color: `outline`, type: `button`, onClick: S, children: Pe }),
              ],
            }),
          }),
        ],
  ...
  let R;
  t[124] !== w || t[125] !== Fe
    ? ((R = (0, J.jsx)(Qn, { open: w, size: `compact`, onOpenChange: T, children: Fe })),
      (t[124] = w),
      (t[125] = Fe),
      (t[126] = R))
    : (R = t[126]);
  let Ie;
  return (
    t[127] !== me || t[128] !== he || t[129] !== ge || t[130] !== L || t[131] !== Oe || t[132] !== R
      ? ((Ie = (0, J.jsxs)(`div`, { className: me, children: [he, ge, L, Oe, R] })),
        (t[127] = me),
        (t[128] = he),
        (t[129] = ge),
        (t[130] = L),
...
function _a(e) {
  let t = (0, xa.c)(37),
    ...
    [i, a] = (0, Sa.useState)(!1),
    { elementHeightPx: o, elementRef: s } = pr(),
    c;
  ...
  t[6] === f
    ? (p = t[7])
    : ((p = (0, J.jsx)(Ot, { className: f, "aria-hidden": !0 })), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== i || t[9] !== c || t[10] !== p
    ? ((m = (0, J.jsxs)(`button`, {
        type: `button`,
  ...
  let v = !i,
    ...
    x;
  t[15] === b ? (x = t[16]) : ((x = G(b)), (t[15] = b), (t[16] = x));
  let S = i ? `auto` : `none`,
    C;
...
function Pa(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Ba.jsx)(g, { scope: Ze, children: (0, Ba.jsx)(Fa, { onContinue: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function Fa(e) {
  ...
  t[0] !== i.accountId || t[1] !== i.userId || t[2] !== o
    ? ((s = { accountId: i.accountId, enabled: o, userId: i.userId }),
      ...
      (t[3] = s))
    : (s = t[3]);
  let { data: c, isLoading: l } = hr(s),
    u = h(An),
    d = y(An),
    p;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = { conversationId: null, cwdOverride: Va, hostId: Lt }), (t[4] = p))
    : (p = t[4]);
  let { isConfigDataPending: g, requirements: v } = Fe(p),
    b;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = { conversationId: null, cwdOverride: Va, hostId: Lt }), (t[5] = b))
    : (b = t[5]);
  let { agentMode: x, permissionProfileId: S, shouldSendPermissionOverrides: w } = We(b),
    { serviceTierSettings: E } = $e(null),
    D;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = { hostId: Lt }), (t[6] = D))
    : (D = t[6]);
  let { data: O, isLoading: k } = ge(D),
    A = m(Be) ?? oe(r),
    j = m(Jt) === !0,
    M = A.selectedTask,
    ee = m(Rn),
    te;
  t[7] === i.email ? (te = t[8]) : ((te = Bn(i.email)), (t[7] = i.email), (t[8] = te));
  let ne = te,
    re = ee == null,
    ie;
  t[9] === re ? (ie = t[10]) : ((ie = { enabled: re }), (t[9] = re), (t[10] = ie));
  let { data: ae, isError: le } = _(Un, ne, ie),
    N = Hn({ debugOverride: ee, detectedProvider: ae?.provider, emailDomain: ne, isError: le }),
    ue = a?.plan_type ?? i.planAtLogin,
    P = N == null ? null : zn(N, ue),
    F = N == null ? null : Ge(N, ue),
    we = P == null ? null : Me(P),
    Te;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Te = { hostId: Lt }), (t[11] = Te))
    : (Te = t[11]);
  let { data: I, isLoading: L } = fn(Te),
    Ae;
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ae = { hostId: Lt, marketplaceKind: `local` }), (t[12] = Ae))
    : (Ae = t[12]);
  let { data: R, isLoading: Ie, refetch: Le } = en(Ae),
    Re = P == null ? null : Pe(P, R),
    ze = T(),
    Ve =
      I == null || we == null
        ? []
        : we.flatMap((e) => {
            let t = ye(I, e);
            return t == null ? [] : [xe(t.id)];
          }),
    He;
  (t[13] === Ve ? (He = t[14]) : ((He = { queries: Ve }), (t[13] = Ve), (t[14] = He)), C(He));
  let Ue;
  t[15] === O?.models
    ? (Ue = t[16])
    : ((Ue = O?.models.some(Ia)), (t[15] = O?.models), (t[16] = Ue));
  let Ke = Ue === !0,
    Je;
  t[17] === Le ? (Je = t[18]) : ((Je = async () => (await Le()).data), (t[17] = Le), (t[18] = Je));
  let Ye;
  t[19] !== x ||
  t[20] !== I ||
  t[21] !== L ||
  ...
  t[33] !== Je
    ? ((Ye = {
        ...
        isModelsLoading: k,
        isPluginsLoading: Ie,
        isRequiredModelAvailable: Ke,
        localPlugins: R,
        mailProvider: P,
        permissionProfileId: S,
        permissionsRequirements: v,
        projectRoot: Va,
        queryClient: ze,
        refetchLocalPlugins: Je,
        serviceTier: E.serviceTierForRequest,
    ...
    : (Ye = t[34]);
  let z = Ye,
    [B, rt] = (0, za.useState)(null),
    [it, at] = (0, za.useState)(``),
    [ot, st] = (0, za.useState)(!0),
    [ct, lt] = (0, za.useState)(!1),
    [ut, dt] = (0, za.useState)(!1),
    ft = m(Ne),
    pt = m(tt),
    mt = m(et),
    V = _(de, ft?.conversationId ?? null),
    gt = _(De, ft?.conversationId ?? null),
    _t;
  t[35] === it ? (_t = t[36]) : ((_t = it.trim()), (t[35] = it), (t[36] = _t));
  let vt = _t,
    yt = B != null && (B !== `something_else` || vt.length > 1),
    bt;
  t[37] !== pt || t[38] !== M || t[39] !== V
    ? ((bt = M != null && (Xe(M) ? V != null : pt)),
      (t[37] = pt),
      (t[38] = M),
      (t[39] = V),
      (t[40] = bt))
  ...
  t[44] !== r || t[45] !== z
    ? ((Tt = async (e) => {
      ...
      (t[46] = Tt))
    : (Tt = t[46]);
  let Et = (0, za.useEffectEvent)(Tt),
    Dt;
  t[47] !== R || t[48] !== P || t[49] !== Et
    ? ((Dt = () => {
        R == null || P == null || Et(P);
      }),
      (t[47] = R),
  ...
  let Ot;
  (t[51] !== R || t[52] !== P
    ? ((Ot = [R, P]), (t[51] = R), (t[52] = P), (t[53] = Ot))
    : (Ot = t[53]),
    (0, za.useEffect)(Dt, Ot));
  let kt;
  t[54] !== i.accountId ||
  t[55] !== xt ||
  t[56] !== n ||
  ...
  t[60] !== M
    ? ((kt = async (e) => {
        ...
        (xt && i.accountId != null && M != null && cr(r, i.accountId, M),
          t ? ke(r, M) : _e(r, M),
          await n({
  ...
  let At = kt,
    jt;
  t[62] !== yt || t[63] !== B || t[64] !== r || t[65] !== d || t[66] !== vt
    ? ((jt = (e) => {
        if (!yt || B == null) return;
        let t = [B],
          n = Ht(t);
        (d({ roles: t, personalizedSuggestionsEnabled: e, workMode: n }),
          wt(r, ht, {
            ...
            selectedRoles: B,
            selectedWorkMode: n,
            otherRoleDescription: B === `something_else` ? vt : void 0,
          }),
          Ce(r, B),
          se(r, B),
          lt(!0));
  ...
  let Mt = jt,
    Nt;
  t[68] !== gt || t[69] !== mt || t[70] !== xt || t[71] !== r || t[72] !== M
    ? ((Nt = () => {
        if (M != null) {
          if (gt) {
            nt(r, M);
  ...
  let H = Nt,
    U;
  t[74] !== r || t[75] !== M || t[76] !== A.permissionStatus
    ? ((U = () => {
        M == null || A.permissionStatus === `allowed` || he(r, M);
      }),
      (t[74] = r),
      (t[75] = M),
      (t[76] = A.permissionStatus),
      (t[77] = U))
    : (U = t[77]);
  let W = U,
    Pt;
  t[78] !== H || t[79] !== r || t[80] !== M || t[81] !== z
    ? ((Pt = (e) => {
        (H(), Se(Lt), M != null && qe[M].reset(r), ce(r), fe(r, e), Oe(r, e), dt(!0));
        let t = qe[e];
        (t.reset(r), t.prepare?.(r, e, z));
      }),
      (t[78] = H),
      (t[79] = r),
      (t[80] = M),
  ...
  let Ft = Pt,
    It;
  t[83] !== W || t[84] !== H || t[85] !== r
    ? ((It = (e) => {
        (H(), W(), Se(Lt), qe[e].reset(r), ce(r), dt(!1), be(r, e));
      }),
      (t[83] = W),
      (t[84] = H),
      (t[85] = r),
  ...
  let Rt = It,
    zt;
  t[87] !== H || t[88] !== r || t[89] !== M || t[90] !== z
    ? ((zt = () => {
        (H(), M != null && (Se(Lt), ce(r), qe[M].retry(r, M, z)));
      }),
      (t[87] = H),
      (t[88] = r),
      (t[89] = M),
  ...
  t[92] !== r || t[93] !== z
    ? ((Vt = () => {
        dt(!1);
        let e = oe(r).selectedTask;
        e != null && qe[e].start?.(r, e, z);
      }),
      (t[92] = r),
      (t[93] = z),
      (t[94] = Vt))
    : (Vt = t[94]);
  let Ut = Vt,
    Wt = A.permissionStatus === `denied` || xt,
    Gt = M == null ? null : qe[M].View,
    Kt;
  t[95] !== Gt || t[96] !== Rt || t[97] !== Bt || t[98] !== j || t[99] !== M || t[100] !== z
    ? ((Kt =
        Gt == null || M == null
          ? null
          : (0, Ba.jsx)(
              ...
              {
                context: z,
                isAppWindowFocused: j,
                task: M,
                onChooseAnotherTask: () => Rt(M),
                onRetryTask: Bt,
              },
              M,
            )),
  ...
  t[102] === c?.displayName
    ? (Xt = t[103])
    : ((Xt = c?.displayName?.trim().split(/\s+/)[0] || void 0),
      (t[102] = c?.displayName),
      (t[103] = Xt));
  let Zt;
  t[104] !== At || t[105] !== u.personalizedSuggestionsEnabled
    ? ((Zt = () => {
        At({ isSkipped: !1, personalizedSuggestionsEnabled: u.personalizedSuggestionsEnabled });
      }),
      (t[104] = At),
  ...
  t[112] !== r ||
  t[113] !== A.permissionStatus ||
  t[114] !== A.phase
    ? (($t = () => {
        (H(),
          W(),
          A.permissionStatus !== `allowed` && me(r, `denied`),
          At({
            isSkipped: !0,
            personalizedSuggestionsEnabled:
              A.phase === `role` ? !1 : u.personalizedSuggestionsEnabled,
          }));
      }),
      (t[108] = At),
      (t[109] = W),
  ...
  return (
    ...
    t[134] !== A
      ? ((rn = (0, Ba.jsx)(ma, {
          ...
          isAppWindowFocused: j,
          isTaskReady: Wt,
          otherRoleDescription: it,
          roleSelection: B,
          selectedTaskContent: qt,
          showInitialThinking: G,
          showSelectedTaskThinking: ut,
          showTaskIntroThinking: Yt,
          taskIds: F,
          taskPlugins: Re,
          userFirstName: Xt,
          workflow: A,
          onContinueRole: Mt,
          onGetStarted: Zt,
          onInitialThinkingComplete: Qt,
          onOtherRoleDescriptionChange: at,
          onRoleSelectionChange: rt,
          onSelectTask: Ft,
          onSelectedTaskThinkingComplete: Ut,
          onSkip: $t,
          onTaskIntroThinkingComplete: nn,
        })),
        (t[117] = yt),
        (t[118] = Mt),
        (t[119] = Ft),
...
function Ua(e) {
  let t = (0, Ga.c)(30),
    ...
    s = ct(`4147559047`),
    c;
  t[0] === s ? (c = t[1]) : ((c = s.get(`allow_multi_select`, !0)), (t[0] = s), (t[1] = c));
  let l = c,
    u;
  t[2] === s ? (u = t[3]) : ((u = s.get(`allow_skip`, !0)), (t[2] = s), (t[3] = u));
  let d = u,
    [p] = (0, Ka.useState)(Ut),
    m;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
          ...
          children: (0, Y.jsx)(`div`, {
            ...
            children: (0, Y.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, Y.jsx)(Zi, { checked: g.personalizedSuggestionsEnabled, onChange: T }),
                (0, Y.jsxs)(`div`, {
                    ...
                    d
                      ? (0, Y.jsx)(`button`, {
                          ...
                          onClick: () => {
                            ...
                            (x(e), t({ result: { step: K.RoleSelection, ...e }, skipped: !0 }));
                          },
                          children: (0, Y.jsx)(W, {
  ...
  return (
    t[27] !== k || t[28] !== O
      ? ((A = (0, Y.jsx)(Fi, { name: `role_selection`, onComplete: O, children: k })),
        (t[27] = k),
        (t[28] = O),
        (t[29] = A))
      : (A = t[29]),
...
var eo,
  ...
  no,
  ro = e(() => {
    ((eo = r()), (to = t(o(), 1)), ai(), Gr(), Ri(), Qa(), (no = n()));
  });
function io(e) {
  let t = (0, so.c)(34),
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsxs)(`button`, {
        ...
        children: [
          ...
          (0, Q.jsx)(an, { className: `icon-sm`, ExternalIcon: ie, href: bo }),
        ],
      })),
      (t[7] = l))
    : (l = t[7]);
...
function go(e) {
  dn({ event: e, href: bo, initiator: `open_in_browser_bridge` });
}
function _o() {
  let e = (0, yo.c)(4),
    t;
...
function No(e) {
  ...
  t[5] !== g || t[6] !== n || t[7] !== r
    ? ((T = () => {
        g().then((e) => {
          e && (r.set(vr, !0), n({ step: K.WindowsSandboxSetup }));
        });
      }),
      (t[5] = g),
      (t[6] = n),
  ...
  t[9] !== n || t[10] !== r || t[11] !== m
    ? ((D = () => {
        (m(), r.set(vr, !0), n({ step: K.WindowsSandboxSetup }));
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = m),
...
function Po(e) {
  ...
  if (i) {
    let e;
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(ae, { className: `size-10` })), (t[0] = e))
      : (e = t[0]);
    let n;
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  if (a) {
    let e;
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(ae, { className: `size-10` })), (t[2] = e))
      : (e = t[2]);
    let n;
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(ae, { className: `size-10` })), (t[13] = _))
    : (_ = t[13]);
  let v;
...
function Io(e) {
  ...
  let p, m;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(rr, { className: `sr-only`, children: s })),
      (m = (0, $.jsx)($n, { className: `sr-only`, children: l })),
      (t[7] = p),
      (t[8] = m))
    : ((p = t[7]), (m = t[8]));
  let h;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, $.jsx)(er, {
        className: `!pt-0`,
        children: (0, $.jsx)(ir, { title: s, subtitle: l, subtitleSize: `sm` }),
      })),
      (t[9] = h))
    : (h = t[9]);
  let g;
  ...
  t[12] === f
    ? (v = t[13])
    : ((v = (0, $.jsxs)(ar, { as: `form`, onSubmit: f, children: [p, m, h, _] })),
      (t[12] = f),
      (t[13] = v));
  let y;
  return (
...
function Lo(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsx)(ln, { className: `size-3.5` }),
      })),
      (t[4] = l))
    : (l = t[4]);
  let u;
...
function Vo(e) {
  ...
  switch (n) {
    case K.Start: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Uo.jsx)(Kt, { debugName: `OnboardingLoadingPage` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
...
var Ho,
  Uo,
  Wo = e(() => {
    ((Ho = r()), c(), Wt(), di(), ai(), Wi(), Xi(), Ha(), qa(), ro(), mo(), Eo(), Bo(), (Uo = n()));
  });
function Go() {
  let e = (0, Ko.c)(25),
    t = f(oi),
  ...
  e[10] === g
    ...
    : ((_ = () => {
      ...
      (e[10] = g),
      (e[11] = _));
  let v = (0, qo.useEffectEvent)(_),
    y;
  e[12] !== v || e[13] !== r || e[14] !== d.isLoading
    ? ((y = () => {
        r !== K.Start || d.isLoading || v();
      }),
      (e[12] = v),
      (e[13] = r),
      (e[14] = d.isLoading),
  ...
  (e[16] !== r || e[17] !== d.isLoading
    ? ((b = [r, d.isLoading]), (e[16] = r), (e[17] = d.isLoading), (e[18] = b))
    : (b = e[18]),
    (0, qo.useEffect)(y, b));
  let x;
  e[19] === g
  ...
  let S = x,
    C;
  return (
    e[21] !== r || e[22] !== S || e[23] !== d
      ? ((C = (0, Jo.jsx)(Vo, { currentStep: r, onboardingContext: d, onContinue: S })),
        (e[21] = r),
        (e[22] = S),
        (e[23] = d),
        (e[24] = C))
...
function Zo() {
  let e = (0, Qo.c)(3),
    t = m(si),
    n = k.ChatGPT === `codex` && t !== K.ConversationalOnboarding,
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $o.jsx)(Go, {})), (e[0] = r))
    : (r = e[0]);
  ...
  return (
    e[1] === n
      ? (i = e[2])
      : ((i = (0, $o.jsx)(Er, { fullBleed: !0, showBrandIcon: n, children: r })),
        (e[1] = n),
        (e[2] = i)),
    i
  );
