...
import { R as r, h as i, m as a, o, r as s, s as c, t as l } from "./app-scope.js";
import { f as u, k as d, m as f, n as p, r as m } from "./vscode-api.js";
...
import { Ii as O, Li as k, Ri as A, us as ee } from "./app-server-manager-signals.js";
import "./react-dom.js";
import { c as j, n as M, o as N } from "./lib-1.js";
import { Gt as P, Qt as te, Wt as ne, Zt as re, o as F } from "./persisted-signal.js";
import { t as I } from "./clsx.js";
import "./app-shell-state.js";
import { t as L } from "./button.js";
import { i as R } from "./setting-storage.js";
...
import "./rpc-2.js";
import { l as oe } from "./statsig-DoZ-0xit.js";
import "./request.js";
import "./platform.js";
...
import "./globe.js";
import "./sortBy.js";
import { t as Se } from "./arrow-up-right-lg.js";
import { t as Ce } from "./toggle.js";
import { t as we } from "./permissions-mode-visibility.js";
import "./workspace-onboarding-experiment.js";
import { r as Te } from "./workspace-onboarding-controller.js";
import { t as Ee } from "./app-preloader.js";
import {
  a as De,
  b as Oe,
  c as ke,
...
import { t as V } from "./codex-app-ga-logo.js";
import { a as Ne } from "./onboarding-shell.js";
import "./hooks.js";
import { t as Pe } from "./animated-icon.js";
import "./tasks.js";
import { i as H, n as Fe, t as Ie } from "./onboarding-roles.js";
var U = r(),
  Le = [
    `animals`,
    `fitness`,
...
var ze = [
  ...
  Be = [`coding`, `non_coding`],
  Ve = [`claude-code`, `claude-cowork`],
  W = {
    Start: `start`,
  ...
  He = y(`step`, [
    S({ step: v(W.TeenWelcome) }),
    S({ step: v(W.TeenInterests), interests: T(x(Le)) }),
    S({ step: v(W.TeenPrompts), prompt: _().optional() }),
    S({
      step: v(W.RoleSelection),
      roles: T(x(ze)),
      personalizedSuggestionsEnabled: C(),
      workMode: x(Be).nullable(),
    }),
    S({ step: v(W.AgentMigrationSourceSelection), providerIds: T(x(Ve)), skipped: C().optional() }),
    S({ step: v(W.AgentMigrationItemSelection), action: x([`imported`, `skipped`]) }),
  ]),
  G = a(`OnboardingScope`, { parent: l }),
  K = i(G, () => W.Start),
  q = i(G, () => null),
  J = i(G, () => null),
  Y = i(G, () => null),
...
function Ge() {
  ...
  return (
    ...
    e[11] !== y
      ? ((x = (e, o) => {
          let l = e.personalizedSuggestionsEnabled ?? !0,
            d = e.workMode !== `non_coding`,
            h = Je(e.workMode);
          (n(e),
            F(t, ne, {
              selectedWorkspacesCount: 0,
              experimentArm: y,
              personalizedSuggestionsEnabled: l,
            }),
            R(t, D.conversationDetailMode, h.threadDetailLevel)
              .catch(qe)
              .finally(() => {
                let e = a === `welcome`;
                (s(`auto`),
                  ...
                  r(`/?${ge}=1`, {
                    replace: !0,
                    state:
                      o?.focusComposer !== !0 && o?.prefillPrompt == null
                        ? void 0
                        : { focusComposerNonce: Date.now(), prefillPrompt: o.prefillPrompt },
                  }));
              }),
            h.fontSizes != null &&
              (R(t, b.sansFontSize, h.fontSizes.sans), R(t, b.codeFontSize, h.fontSizes.code)),
            t.set(we, { "guardian-approvals": d, "full-access": d }),
            l && t.set(ve, !0),
            (async () => {
              (await R(t, w.enabled, l),
                l &&
                  (await p(`ambient-suggestions-refresh`, {
                    params: { hostId: ee, projectRoot: E(`~`) },
                  }),
                  await Promise.all([
                    i.invalidateQueries({ queryKey: m(`ambient-suggestions`) }),
                    i.invalidateQueries({ queryKey: m(`ambient-suggestions-refresh`) }),
                  ])));
            })().catch(Ke));
        }),
        (e[0] = r),
...
function Ke(e) {
  f.error(`Failed to refresh ambient suggestions after onboarding`, {
    safe: {},
    sensitive: { error: e },
  });
}
function qe(e) {
  f.error(`Failed to persist welcome v2 onboarding configuration`, {
    safe: {},
    sensitive: { error: e },
  });
}
...
function Ye(e) {
  ...
  let { isLoading: s, shouldUseTeenOnboarding: c } = Te(o),
    l = s || n,
    u;
  t[2] === i
    ? (u = t[3])
    : ((u = { isSupported: !0, shouldShow: async () => ke({ queryClient: i }) }),
      (t[2] = i),
      (t[3] = u));
  let f;
  return (
    t[4] !== c || t[5] !== l || t[6] !== u
      ? ((f = { isLoading: l, shouldShowTeenOnboarding: c, agentMigration: u }),
        (t[4] = c),
        (t[5] = l),
        (t[6] = u),
        (t[7] = f))
...
function it(e, t) {
  switch ((f.debug(`[onboarding-flow] store result`, { safe: { resultStep: t.step } }), t.step)) {
    case W.TeenWelcome:
      return;
    case W.TeenInterests:
      e.set(J, t);
...
function Q(e) {
  ...
  let c = s,
    u;
  t[4] !== i || t[5] !== c
    ? ((u = i({ completeStep: c })), (t[4] = i), (t[5] = c), (t[6] = u))
    : (u = t[6]);
  let d;
  return (
    t[7] === u
      ? (d = t[8])
      : ((d = (0, Z.jsx)(Z.Fragment, { children: u })), (t[7] = u), (t[8] = d)),
    d
  );
}
function ot(e) {
  ...
  let y;
  t[9] !== p || t[10] !== u || t[11] !== i || t[12] !== r || t[13] !== a
    ? ((y = (e) => {
...
function lt(e) {
  ...
  t[3] !== n.providerIds || t[4] !== d || t[5] !== i
    ? ((f = (e) => {
        d({ source: `first_time_onboarding`, action: e, ...De(i, je(i), n.providerIds) });
      }),
      (t[3] = n.providerIds),
      (t[4] = d),
      (t[5] = i),
  ...
  t[9] === h
    ...
    : ((_ = () => {
      ...
      (t[10] = _));
  let v;
  (t[11] === i ? (v = t[12]) : ((v = [i]), (t[11] = i), (t[12] = v)), (0, X.useEffect)(_, v));
  let y;
  t[13] === r
    ? (y = t[14])
    : ((y = (e) => {
...
function dt(e) {
  let t = (0, U.c)(29),
    ...
    c = oe(`4147559047`),
    u;
  t[0] === c ? (u = t[1]) : ((u = c.get(`allow_multi_select`, !0)), (t[0] = c), (t[1] = u));
  let d = u,
    f;
  ...
  let x = b,
    S;
  t[11] !== d || t[12] !== h || t[13] !== y
    ? ((S = (e) => {
        let t = !d || !h.roles.includes(e),
          n = [e];
        d && (n = t ? [...h.roles, e] : h.roles.filter((t) => t !== e));
        let r = { ...h, roles: n, workMode: H(n) };
              ...
              children: [
                ...
                (0, Z.jsx)(`div`, {
                  ...
                  children: Fe.map((e) =>
                    (0, Z.jsx)(
                      ft,
                      { role: e, selected: h.roles.includes(e), onClick: () => C(e) },
                      e,
                    ),
                  ),
                }),
                (0, Z.jsx)(pt, { checked: h.personalizedSuggestionsEnabled, onChange: T }),
                (0, Z.jsxs)(`div`, {
  ...
  return (
    t[26] !== k || t[27] !== O
      ? ((A = (0, Z.jsx)(Q, { name: `role_selection`, onComplete: O, children: k })),
        (t[26] = k),
        (t[27] = O),
        (t[28] = A))
      : (A = t[28]),
...
function pt(e) {
  ...
  let o;
  t[2] !== n || t[3] !== r || t[4] !== a
    ? ((o = (0, Z.jsx)(Ce, { checked: n, ariaLabel: a, onChange: r })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = a),
      (t[5] = o))
...
function wt() {
  u.dispatchMessage(`open-in-browser`, { url: `https://openai.com/codex/` });
}
function Tt() {
  let e = (0, U.c)(4),
    t;
...
function $(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = I(`absolute overflow-hidden rounded-2xl border border-token-border/50 shadow-2xl`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  return (
...
function Ot(e) {
  ...
  switch (n) {
    case W.Start: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Z.jsx)(Ee, { debugName: `OnboardingLoadingPage` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
...
function kt() {
  let e = (0, U.c)(21),
    ...
    [i, a] = (0, X.useState)(!1),
    s;
  e[0] === i ? (s = e[1]) : ((s = { isAdvancingOnboarding: i }), (e[0] = i), (e[1] = s));
  let l = Ye(s),
    u;
  e[2] !== r || e[3] !== l || e[4] !== t
    ? ((u = (e) =>
  ...
  let p = (0, X.useEffectEvent)(f),
    m;
  e[8] !== p || e[9] !== n || e[10] !== l.isLoading
    ? ((m = () => {
        n !== W.Start || l.isLoading || p();
      }),
      (e[8] = p),
      (e[9] = n),
      (e[10] = l.isLoading),
  ...
  (e[12] !== n || e[13] !== l.isLoading
    ? ((h = [n, l.isLoading]), (e[12] = n), (e[13] = l.isLoading), (e[14] = h))
    : (h = e[14]),
    (0, X.useEffect)(m, h));
  let g;
  e[15] === d
  ...
  let _ = g,
    v;
  return (
    e[17] !== n || e[18] !== _ || e[19] !== l
      ? ((v = (0, Z.jsx)(Ot, { currentStep: n, onboardingContext: l, onContinue: _ })),
        (e[17] = n),
        (e[18] = _),
        (e[19] = l),
        (e[20] = v))
...
function At() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(Ne, {
          fullBleed: !0,
          children: (0, Z.jsx)(s, { scope: G, children: (0, Z.jsx)(kt, {}) }),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
