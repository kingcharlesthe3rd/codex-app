...
import { Gs as f, Mi as p, Ni as m, Wo as h, ji as g } from "./app-server-manager-signals.js";
...
import { i as M, r as N } from "./react.js";
import { c as P, n as F, o as I } from "./lib-2.js";
import { m as ee } from "./chunk-12.js";
import { g as L, h as te } from "./persisted-signal-CweW-bgN.js";
import "./rpc-1.js";
import { c as ne, d as re, n as R, u as ie } from "./statsig.js";
import "./request.js";
...
import { t as ae } from "./use-auth-6.js";
import "./_baseEach.js";
...
import { i as B } from "./setting-storage.js";
...
import { n as se, t as ce } from "./thread-detail-level.js";
...
import { r as ge } from "./ambient-suggestions-connected-apps-consent.js";
...
import { t as ve } from "./check-md.js";
import { t as ye } from "./select-project.js";
import "./_defineProperty.js";
import "./homepage-logo.js";
import "./loading-page.js";
import "./checkbox.js";
import "./minus.js";
import "./external-agent-config-gates.js";
import { n as be, r as xe } from "./external-agent-onboarding-import-status.js";
import "./clock.js";
...
import { t as Ee } from "./arrow-up-right-lg.js";
import "./folders.js";
import {
  a as De,
  b as Oe,
...
import "./hooks.js";
import { t as W } from "./codex-app-ga-logo.js";
import { a as Me } from "./onboarding-shell.js";
import { t as Ne } from "./animated-icon.js";
import "./tasks.js";
import { i as G, n as Pe, t as Fe } from "./onboarding-roles.js";
var K = k(),
  Ie = [
    `animals`,
    `fitness`,
...
var Re = [
  ...
  ze = [`coding`, `non_coding`],
  Be = [`claude-code`, `claude-cowork`],
  q = {
    Start: `start`,
  ...
  Ve = r(`step`, [
    l({ step: s(q.TeenWelcome) }),
    l({ step: s(q.TeenInterests), interests: c(t(Ie)) }),
    l({ step: s(q.TeenPrompts), prompt: u().optional() }),
    l({
      step: s(q.RoleSelection),
      roles: c(t(Re)),
      personalizedSuggestionsEnabled: i(),
      workMode: t(ze).nullable(),
    }),
    l({ step: s(q.AgentMigrationSourceSelection), providerIds: c(t(Be)), skipped: i().optional() }),
    l({ step: s(q.AgentMigrationItemSelection), action: t([`imported`, `skipped`]) }),
  ]),
  J = w(`OnboardingScope`, { parent: O }),
  Y = T(J, () => q.Start),
  He = T(J, () => null),
  Ue = T(J, () => null),
  We = T(J, () => null),
    ...
    e[11] !== v
      ? ((y = (e, y) => {
          ...
          (r(e),
            ...
            B(t, d.conversationDetailMode, S.threadDetailLevel)
              .catch(Ye)
              .finally(() => {
                let e = c === `welcome`;
                (l(`auto`),
            ...
            S.fontSizes != null &&
              (B(t, n.sansFontSize, S.fontSizes.sans), B(t, n.codeFontSize, S.fontSizes.code)),
            t.set(Ce, { "guardian-approvals": x, "full-access": x }),
            b && t.set(ge, !0),
            (async () => {
              (await B(t, o.enabled, b),
                b &&
                  (await A(`ambient-suggestions-refresh`, {
                    params: { hostId: h, projectRoot: a(`~`) },
                  }),
                  await Promise.all([
                    s.invalidateQueries({ queryKey: j(`ambient-suggestions`) }),
                    s.invalidateQueries({ queryKey: j(`ambient-suggestions-refresh`) }),
                  ])));
            })().catch(Je));
        }),
        (e[0] = i),
...
function Xe(e) {
  return e === `non_coding`
    ? { threadDetailLevel: se, fontSizes: { sans: Ge, code: Ke } }
    : { threadDetailLevel: ce, fontSizes: null };
}
function Ze(e) {
  let t = (0, K.c)(24),
  ...
  let { isLoading: l, shouldUseTeenOnboarding: u } = we(c),
    d = !o,
    f;
  t[2] !== d || t[3] !== a
    ? ((f = d && R(a, `2900529421`)), (t[2] = d), (t[3] = a), (t[4] = f))
    : (f = t[4]);
  let p = f,
    m;
  t[5] !== d || t[6] !== a
    ? ((m = d && R(a, `816842483`)), (t[5] = d), (t[6] = a), (t[7] = m))
    : (m = t[7]);
  let h = m,
    g = o || l || n,
    _;
  t[8] !== d || t[9] !== a
    ? ((_ = d && R(a, `2711149772`)), (t[8] = d), (t[9] = a), (t[10] = _))
    : (_ = t[10]);
  let v;
  t[11] !== h || t[12] !== p || t[13] !== i
    ? ((v = async () => (p ? ke({ isCoworkMigrationEnabled: h, queryClient: i }) : !1)),
      (t[11] = h),
      (t[12] = p),
      (t[13] = i),
      (t[14] = v))
    : (v = t[14]);
  let y;
  t[15] !== h || t[16] !== p || t[17] !== _ || t[18] !== v
    ? ((y = {
        isImportEnabled: p,
        isCoworkMigrationEnabled: h,
        awaitsCompletion: _,
        shouldShow: v,
      }),
      (t[15] = h),
  ...
  let x;
  return (
    t[20] !== u || t[21] !== g || t[22] !== y
      ? ((x = { isLoading: g, shouldShowTeenOnboarding: u, agentMigration: y }),
        (t[20] = u),
        (t[21] = g),
        (t[22] = y),
        (t[23] = x))
...
var Qe = { roles: [`student`], personalizedSuggestionsEnabled: !1, workMode: `coding` },
  $e = {
    [q.Start]: null,
...
async function et(e, { completeOnboarding: t, logStepViewed: n, onboardingContext: r, result: i }) {
  let a = e.get(Y);
  if (a === q.Complete) return;
  let o;
  (i != null && (o = Ve.parse(i)), o != null && ot(e, o));
  let s = await tt({ currentStep: a, onboardingContext: r, result: o });
  if (e.get(Y) !== a || (s !== a && rt(e, s, n), s !== q.Complete)) return;
  if (o?.step === q.TeenPrompts) {
    t(Qe, { focusComposer: !0, prefillPrompt: o.prompt });
    return;
  }
  let c = e.get(He);
  (o?.step === q.RoleSelection && (c = o), c != null && t(at(c)));
}
async function tt({ currentStep: e, onboardingContext: t, result: n }) {
  if (t.isLoading) return e;
  switch (e) {
    case q.Start:
      return t.shouldShowTeenOnboarding ? q.TeenWelcome : q.RoleSelection;
    case q.TeenWelcome:
    ...
    case q.RoleSelection:
      return (await t.agentMigration.shouldShow()) ? q.AgentMigrationSourceSelection : q.Complete;
    case q.AgentMigrationSourceSelection:
    case q.AgentMigrationItemSelection:
      return nt({ currentStep: e, result: n });
    case q.Complete:
      return q.Complete;
  }
}
function nt({ currentStep: e, result: t }) {
  switch (e) {
    case q.AgentMigrationSourceSelection:
      return t?.step === q.AgentMigrationSourceSelection &&
        t.skipped !== !0 &&
...
function ot(e, t) {
  switch ((D.debug(`[onboarding-flow] store result`, { safe: { resultStep: t.step } }), t.step)) {
    case q.TeenWelcome:
      return;
    case q.TeenInterests:
      e.set(Ue, t);
...
function ut(e) {
  ...
  return (
    t[3] !== a || t[4] !== r
      ? ((o = (0, Z.jsx)(dt, { agentMigration: a, onContinue: r, summary: a.summary })),
        (t[3] = a),
        (t[4] = r),
        (t[5] = o))
      : (o = t[5]),
...
function dt(e) {
  ...
  t[3] !== n.providerIds || t[4] !== l || t[5] !== i
    ? ((u = (e) => {
        l({ source: `first_time_onboarding`, action: e, ...De(i, Ae(i), n.providerIds) });
      }),
      (t[3] = n.providerIds),
      (t[4] = l),
      (t[5] = i),
...
function pt(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = { roles: [], personalizedSuggestionsEnabled: !0, workMode: null }), (t[4] = f))
    : (f = t[4]);
  let [p, m] = (0, X.useState)(f),
    h;
  t[5] !== a || t[6] !== o?.arm
    ? ((h = (e) => {
  ...
  let v = _,
    b;
  t[11] !== l || t[12] !== p || t[13] !== g
    ? ((b = (e) => {
        let t = !l || !p.roles.includes(e),
          n = [e];
        l && (n = t ? [...p.roles, e] : p.roles.filter((t) => t !== e));
        let r = { ...p, roles: n, workMode: G(n) };
        (m(r), g({ role: e, selected: t, state: r }));
      }),
      (t[11] = l),
      (t[12] = p),
      (t[13] = g),
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (e) => {
        m((t) => ({ ...t, personalizedSuggestionsEnabled: e }));
      }),
      (t[15] = C))
    : (C = t[15]);
  let w = C,
    T = p.roles.length > 0 && !i,
    E = !i,
    D;
  t[16] === r
    ? (D = t[17])
  ...
  t[19] !== T ||
  t[20] !== E ||
  t[21] !== p.personalizedSuggestionsEnabled ||
  t[22] !== p.roles ||
  t[23] !== v ||
  t[24] !== S
    ? ((k = (e) => {
              ...
              children: [
                ...
                (0, Z.jsx)(`div`, {
                  ...
                  children: Pe.map((e) =>
                    (0, Z.jsx)(
                      mt,
                      { role: e, selected: p.roles.includes(e), onClick: () => S(e) },
                      e,
                    ),
                  ),
                }),
                (0, Z.jsx)(ht, { checked: p.personalizedSuggestionsEnabled, onChange: w }),
                (0, Z.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    d
                      ? (0, Z.jsx)(`button`, {
                          ...
                          onClick: () => {
                            let e = [ft],
                              n = { roles: e, personalizedSuggestionsEnabled: !1, workMode: G(e) };
                            (v(n),
                              t({
                                result: {
                                  step: q.RoleSelection,
  ...
  return (
    t[26] !== k || t[27] !== D
      ? ((A = (0, Z.jsx)(Q, { name: `role_selection`, onComplete: D, children: k })),
        (t[26] = k),
        (t[27] = D),
        (t[28] = A))
      : (A = t[28]),
...
function ht(e) {
  ...
  let o;
  t[2] !== n || t[3] !== r || t[4] !== a
    ? ((o = (0, Z.jsx)(Se, { checked: n, ariaLabel: a, onChange: r })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = a),
      (t[5] = o))
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Z.jsx)(_e, { className: `size-4`, "aria-hidden": `true` })), (t[16] = f))
    : (f = t[16]);
  let p;
  t[17] === d
    ? (p = t[18])
...
function Ct(e) {
  ...
  t[7] === n.titleMessage
    ...
    : ((s = (0, Z.jsx)(`h3`, {
        ...
        children: (0, Z.jsx)(I, { ...n.titleMessage }),
      })),
      (t[7] = n.titleMessage),
      (t[8] = s));
  let c;
  t[9] === n.descriptionMessage
    ...
    : ((c = (0, Z.jsx)(`p`, {
        ...
        children: (0, Z.jsx)(I, { ...n.descriptionMessage }),
      })),
      (t[9] = n.descriptionMessage),
      (t[10] = c));
  let l;
  ...
  t[2] === n
    ...
    : ((a = (e) => {
        ...
        return (0, Z.jsx)(xt, {
          ...
          onContinue: (e) => {
            t({
              result: e == null ? { step: q.TeenPrompts } : { step: q.TeenPrompts, prompt: e },
              skipped: e == null,
            });
          },
        });
...
function Et() {
  E.dispatchMessage(`open-in-browser`, { url: `https://openai.com/codex/` });
}
function Dt() {
  let e = (0, K.c)(4),
    t;
...
function At(e) {
  ...
  switch (n) {
    ...
    case q.TeenWelcome: {
      let e;
      return (
        t[1] === i ? (e = t[2]) : ((e = (0, Z.jsx)(Ot, { onContinue: i })), (t[1] = i), (t[2] = e)),
        e
      );
    }
    case q.TeenInterests: {
      let e;
      return (
        t[3] === i ? (e = t[4]) : ((e = (0, Z.jsx)(yt, { onContinue: i })), (t[3] = i), (t[4] = e)),
        e
      );
    }
    case q.TeenPrompts: {
      ...
      return (
        t[5] !== i || t[6] !== a.interests
          ? ((e = (0, Z.jsx)(wt, { selectedInterests: a.interests, onContinue: i })),
            (t[5] = i),
            (t[6] = a.interests),
            (t[7] = e))
          : (e = t[7]),
    ...
    case q.RoleSelection: {
      ...
      return (
        t[8] !== i || t[9] !== r.isLoading
          ? ((e = (0, Z.jsx)(pt, { isAdvancePending: r.isLoading, onContinue: i })),
            (t[8] = i),
            (t[9] = r.isLoading),
            (t[10] = e))
          : (e = t[10]),
    ...
    case q.AgentMigrationSourceSelection: {
      ...
      return (
        t[11] !== i || t[12] !== r.agentMigration
          ? ((e = (0, Z.jsx)(ut, { agentMigrationContext: r.agentMigration, onContinue: i })),
            (t[11] = i),
...
function jt() {
  ...
  return (
    e[17] !== n || e[18] !== g || e[19] !== s
      ? ((_ = (0, Z.jsx)(At, { currentStep: n, onboardingContext: s, onContinue: g })),
        (e[17] = n),
        (e[18] = g),
        (e[19] = s),
        (e[20] = _))
...
function Mt() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(Me, {
          fullBleed: !0,
          children: (0, Z.jsx)(C, { scope: J, children: (0, Z.jsx)(jt, {}) }),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
