...
import { ec as f, po as p, tc as m } from "./app-server-manager-signals.js";
...
import { t as k } from "./product-logger.js";
import "./rpc.js";
import { c as oe, d as se, n as A } from "./statsig.js";
import "./request.js";
...
import { n as xe, r as Se } from "./external-agent-onboarding-import-status.js";
import "./clock.js";
import "./search.js";
import "./skills.js";
import "./globe.js";
...
import { t as Te } from "./arrow-up-right-lg.js";
...
var Le = [
  ...
  Be = r(`step`, [
    ...
    i({ step: s(H.AgentMigrationSourceSelection), providerIds: c(n(ze)), skipped: a().optional() }),
    i({ step: s(H.AgentMigrationItemSelection), action: n([`imported`, `skipped`]) }),
  ]),
...
function He(e, t) {
  k(e, { eventName: `codex_onboarding_step_continue_clicked`, metadata: { step: t } });
}
function Ue(e, t) {
                  ...
                  i(`/?${F}=1`, {
                    ...
                    state:
                      f?.focusComposer !== !0 && f?.prefillPrompt == null
                        ? void 0
                        : { focusComposerNonce: Date.now(), prefillPrompt: f.prefillPrompt },
                  }));
              }),
            x.fontSizes != null &&
              (D(n, t.sansFontSize, x.fontSizes.sans), D(n, t.codeFontSize, x.fontSizes.code)),
              ...
              (await D(n, o.enabled, m),
                m &&
                  ...
                  await Promise.all([
                    ...
                    a.invalidateQueries({ queryKey: O(`ambient-suggestions-refresh`) }),
                  ])));
            })().catch(qe));
        }),
        (e[0] = i),
...
function Xe(e) {
  ...
  let _;
  t[8] !== m || t[9] !== f || t[10] !== i
    ? ((_ = async () => (f ? Ae({ isCoworkMigrationEnabled: m, queryClient: i }) : !1)),
      (t[8] = m),
      (t[9] = f),
      (t[10] = i),
      (t[11] = _))
...
var Ze = { roles: [`student`], personalizedSuggestionsEnabled: !1, workMode: `coding` },
  Qe = {
    [H.Start]: null,
...
async function $e(e, { completeOnboarding: t, logStepViewed: n, onboardingContext: r, result: i }) {
  let a = e.get(W);
...
async function et({ currentStep: e, onboardingContext: t, result: n }) {
  ...
  switch (e) {
    ...
    case H.RoleSelection:
      return (await t.agentMigration.shouldShow()) ? H.AgentMigrationSourceSelection : H.Complete;
...
function it(e, t) {
  switch ((y.debug(`[onboarding-flow] store result`, { safe: { resultStep: t.step } }), t.step)) {
    case H.TeenWelcome:
      return;
    case H.TeenInterests:
      e.set(K, t);
...
function ct(e) {
  ...
  return (
    t[3] !== a || t[4] !== r
      ? ((o = (0, Y.jsx)(lt, { agentMigration: a, onContinue: r, summary: a.summary })),
        (t[3] = a),
        (t[4] = r),
        (t[5] = o))
      : (o = t[5]),
...
function lt(e) {
  ...
  t[3] !== n.providerIds || t[4] !== l || t[5] !== i
    ? ((u = (e) => {
        l({ source: `first_time_onboarding`, action: e, ...Oe(i, je(i), n.providerIds) });
      }),
      (t[3] = n.providerIds),
      (t[4] = l),
      (t[5] = i),
  ...
  t[9] === m
    ...
    : ((h = () => {
      ...
      (t[10] = h));
  let g;
  (t[11] === i ? (g = t[12]) : ((g = [i]), (t[11] = i), (t[12] = g)), (0, J.useEffect)(h, g));
  let _;
  t[13] === r
    ? (_ = t[14])
    : ((_ = (e) => {
    ...
    ? ((v = (e) => {
        ...
        return (0, Y.jsx)(ke, {
          ...
          onSkip: () => {
            (d(`skipped`),
              t({
                result: { step: H.AgentMigrationSourceSelection, providerIds: [], skipped: !0 },
                skipped: !0,
              }));
          },
        });
...
function pt(e) {
              ...
              children: [
                ...
                (0, Y.jsx)(`div`, {
                  ...
                  children: ut.map((e) =>
                    (0, Y.jsx)(
                      mt,
                      { option: e, selected: c.roles.includes(e.id), onClick: () => g(e.id) },
                      e.id,
                    ),
                  ),
                }),
                (0, Y.jsx)(ht, { checked: c.personalizedSuggestionsEnabled, onChange: y }),
                (0, Y.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, Y.jsx)(`button`, {
                      ...
                      onClick: () => {
                        let e = [dt],
                          n = { roles: e, personalizedSuggestionsEnabled: !1, workMode: Z(e) };
                        (m(n),
                          t({
                            result: {
                              step: H.RoleSelection,
  ...
  return (
    t[20] !== T || t[21] !== E
      ? ((D = (0, Y.jsx)(X, { name: `role_selection`, onComplete: T, children: E })),
        (t[20] = T),
        (t[21] = E),
        (t[22] = D))
      : (D = t[22]),
...
function mt(e) {
  ...
  t[2] === n.label
    ? (s = t[3])
    : ((s = (0, Y.jsx)(`span`, { className: `min-w-0 truncate`, children: n.label })),
      (t[2] = n.label),
      (t[3] = s));
  let c;
  t[4] === r
...
function ht(e) {
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Y.jsx)(R, { className: `size-4`, "aria-hidden": `true` })), (t[16] = f))
    : (f = t[16]);
  let p;
  t[17] === d
    ? (p = t[18])
  ...
  let m;
  t[19] !== l || t[20] !== p
    ? ((m = (0, Y.jsxs)(`div`, { className: `flex min-w-0 items-center gap-2`, children: [l, p] })),
      (t[19] = l),
      (t[20] = p),
      (t[21] = m))
    : (m = t[21]);
...
function Q(e) {
  ...
  return (
    t[6] !== c || t[7] !== l
      ? ((u = (0, Y.jsx)(X, { name: `teen_interests`, onComplete: c, children: l })),
        (t[6] = c),
        (t[7] = l),
        (t[8] = u))
      : (u = t[8]),
...
function St(e) {
  ...
  let o;
  t[4] !== i || t[5] !== a
    ? ((o = (0, Y.jsx)(`div`, { className: i, "aria-hidden": `true`, children: a })),
      (t[4] = i),
      (t[5] = a),
      (t[6] = o))
    : (o = t[6]);
...
function Ct(e) {
  ...
  t[2] === n
    ...
    : ((a = (e) => {
        ...
        return (0, Y.jsx)(bt, {
          ...
          onContinue: (e) => {
            t({
              result: e == null ? { step: H.TeenPrompts } : { step: H.TeenPrompts, prompt: e },
              skipped: e == null,
            });
          },
        });
  ...
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, Y.jsx)(X, { name: `teen_prompts`, onComplete: i, children: a })),
        (t[4] = i),
        (t[5] = a),
        (t[6] = o))
      : (o = t[6]),
...
function Et() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, Y.jsxs)($, {
        ...
        children: [
          (0, Y.jsx)(`div`, { className: `absolute inset-x-5 top-5 h-10 rounded bg-[#FFF8FC]` }),
          (0, Y.jsx)(`div`, {
  ...
  e[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((n = (0, Y.jsxs)($, {
        ...
        children: [
          (0, Y.jsx)(`div`, { className: `absolute inset-x-4 top-4 h-12 rounded bg-[#FFFFF0]` }),
          (0, Y.jsx)(`div`, {
...
function $(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = _(`absolute overflow-hidden rounded-2xl border border-token-border/50 shadow-2xl`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  return (
...
function kt(e) {
  ...
  switch (n) {
    case H.Start: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(De, { debugName: `OnboardingLoadingPage` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
    case H.TeenWelcome: {
      let e;
      return (
        t[1] === i ? (e = t[2]) : ((e = (0, Y.jsx)(Dt, { onContinue: i })), (t[1] = i), (t[2] = e)),
        e
      );
    }
    case H.TeenInterests: {
      let e;
      return (
        t[3] === i ? (e = t[4]) : ((e = (0, Y.jsx)(Q, { onContinue: i })), (t[3] = i), (t[4] = e)),
        e
      );
    }
    case H.TeenPrompts: {
      ...
      return (
        t[5] !== i || t[6] !== a.interests
          ? ((e = (0, Y.jsx)(Ct, { selectedInterests: a.interests, onContinue: i })),
            (t[5] = i),
            (t[6] = a.interests),
            (t[7] = e))
          : (e = t[7]),
    ...
    case H.RoleSelection: {
      ...
      return (
        t[8] !== i || t[9] !== r.isLoading
          ? ((e = (0, Y.jsx)(pt, { isAdvancePending: r.isLoading, onContinue: i })),
            (t[8] = i),
            (t[9] = r.isLoading),
            (t[10] = e))
          : (e = t[10]),
    ...
    case H.AgentMigrationSourceSelection: {
      ...
      return (
        t[11] !== i || t[12] !== r.agentMigration
          ? ((e = (0, Y.jsx)(ct, { agentMigrationContext: r.agentMigration, onContinue: i })),
            (t[11] = i),
...
function At() {
  ...
  return (
    e[17] !== n || e[18] !== h || e[19] !== s
      ? ((g = (0, Y.jsx)(kt, { currentStep: n, onboardingContext: s, onContinue: h })),
        (e[17] = n),
        (e[18] = h),
        (e[19] = s),
        (e[20] = g))
