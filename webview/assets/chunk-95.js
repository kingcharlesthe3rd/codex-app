import { i as e, n as t, o as n, r, s as i, t as a } from "./rolldown-runtime.js";
import {
  A as o,
  D as s,
  O as c,
...
import { n as x, t as te } from "./isEmpty-2.js";
import {
  a as S,
  c as C,
  i as ne,
    ...
    ((de = class e {
      ...
      join(e = `,`) {
        let t = this.iterator(),
          ...
          r,
          i = !1;
        do ((r = t.next()), r.done || (i && (n += e), (n += le(r.value))), (i = !0));
        while (!r.done);
        return n;
      }
      indexOf(e, t = 0) {
  ...
  for (let [n, r] of Object.entries(e))
    n.startsWith(`$`) ||
      (Array.isArray(r)
        ...
        : O(r) && ((r.$container = e), (r.$containerProperty = n), t.deep && he(r, t)));
}
function ge(e, t) {
  let n = e;
  for (; n; ) {
...
var Dt,
  ...
  Dn = t(() => {
    (ce(),
      ...
      (Nt = { $type: `Alternatives`, cardinality: `cardinality`, elements: `elements` }),
      ...
      (sn = { $type: `ReferenceType`, isMulti: `isMulti`, referenceType: `referenceType` }),
      (cn = {
        $type: `RegexToken`,
        cardinality: `cardinality`,
        lookahead: `lookahead`,
      ...
      (Sn = { $type: `UnorderedGroup`, cardinality: `cardinality`, elements: `elements` }),
      (Cn = {
        $type: `UntilToken`,
        cardinality: `cardinality`,
        lookahead: `lookahead`,
        ...
        constructor() {
          (super(...arguments),
            (this.types = {
              ...
              ArrayLiteral: {
                name: Pt.$type,
                properties: { elements: { name: Pt.elements, defaultValue: [] } },
                superTypes: [wn.$type],
              },
              ArrayType: {
                name: Ft.$type,
              ...
              Conjunction: {
                name: Bt.$type,
                properties: { left: { name: Bt.left }, right: { name: Bt.right } },
                superTypes: [zt.$type],
              },
              CrossReference: {
                name: Vt.$type,
                properties: {
                  ...
                  deprecatedSyntax: { name: Vt.deprecatedSyntax, defaultValue: !1 },
              ...
              Disjunction: {
                name: Ht.$type,
                properties: { left: { name: Ht.left }, right: { name: Ht.right } },
                superTypes: [zt.$type],
              },
              EndOfFile: {
                name: Ut.$type,
              ...
              InfixRuleOperators: {
                name: Xt.$type,
                properties: { precedences: { name: Xt.precedences, defaultValue: [] } },
                superTypes: [],
              },
              Interface: {
                name: Zt.$type,
                properties: {
                  ...
                  name: { name: Zt.name },
                  superTypes: { name: Zt.superTypes, defaultValue: [], referenceType: jt.$type },
                },
                superTypes: [jt.$type],
              },
              Keyword: {
              ...
              ParameterReference: {
                name: an.$type,
                properties: { parameter: { name: an.parameter, referenceType: rn.$type } },
                superTypes: [zt.$type],
              },
              ParserRule: {
                name: on.$type,
              ...
              Type: {
                name: vn.$type,
                properties: { name: { name: vn.name }, type: { name: vn.type } },
                superTypes: [jt.$type],
              },
              TypeAttribute: {
                name: yn.$type,
              ...
              TypeDefinition: { name: bn.$type, properties: {}, superTypes: [] },
              UnionType: {
                name: xn.$type,
...
function Fn(e, t) {
  ...
  return n && r ? Yn.Inside : n ? Yn.OverlapBack : r ? Yn.OverlapFront : Yn.Outside;
}
function In(e, t) {
...
function xr(e) {
  try {
    ...
    for (let r of t.value.value)
      (Ar.reset(e), Ar.visit(r), n.push({ start: Ar.startRegexp, end: Ar.endRegex }));
    return n;
  } catch {
    return [];
  }
  ...
  return (
    Se(e).forEach((e) => {
      Ue(e) &&
        ...
        Ye(e.type.ref) && st(e.type.ref.$container) && t.add(e.type.ref.$container));
    }),
    t
  );
}
...
function Ur(e, t, n, r) {
  ...
  return N(e) && e.astNode === n ? e.content.flatMap((e) => Ur(e, t, n, !1)) : [];
}
function Wr(e, t) {
...
function Kr(e, t, n) {
  ...
  do
    if (((i = r.next()), !i.done)) {
      let e = i.value;
      e.astNode === n ? et(e.grammarSource) && e.grammarSource.value === t && a.push(e) : r.prune();
    }
  while (!i.done);
  return a;
}
...
function ti(e, t) {
  ...
  for (let n of Se(e))
    if (dt(n)) {
      if (!n.rule.ref || (st(n.rule.ref) && !ti(n.rule.ref, t)) || Xe(n.rule.ref)) return !1;
...
function si(e) {
  return _t(e) ? (e.type?.name ?? `string`) : st(e) && ei(e) ? e.name : (ii(e) ?? e.name);
}
function ci(e) {
...
function Ni(e) {
  ...
  } else if (e instanceof Ri) return { type: `Alternative`, definition: t(e.definition) };
  else if (e instanceof H) return { type: `Option`, idx: e.idx, definition: t(e.definition) };
  ...
  else if (e instanceof U) return { type: `Repetition`, idx: e.idx, definition: t(e.definition) };
  else if (e instanceof Hi) return { type: `Alternation`, idx: e.idx, definition: t(e.definition) };
  else if (e instanceof W) {
    let t = { type: `Terminal`, name: e.terminalType.name, label: Ai(e.terminalType), idx: e.idx };
...
var Fi,
  ...
  Ui = t(() => {
    ((Fi = class {
      ...
      (Li = class extends Fi {
        constructor(e) {
          (super(e.definition), (this.orgText = ``), Object.assign(this, Pi(e)));
        }
      }),
      (Ri = class extends Fi {
        constructor(e) {
          (super(e.definition), (this.ignoreAmbiguities = !1), Object.assign(this, Pi(e)));
        }
      }),
      (H = class extends Fi {
        constructor(e) {
...
function Qi(e, t, n) {
  return [
    new H({ definition: [new W({ terminalType: e.separator })].concat(e.definition) }),
  ].concat(t, n);
}
var $i,
  ea = t(() => {
...
function na(e) {
  let t = [],
    ...
    a,
    o = !0;
  for (; i && o; ) ((a = n[r]), (o = qi(a)), (t = t.concat(ta(a))), (r += 1), (i = n.length > r));
  return [...new Set(t)];
}
function ra(e) {
  ...
  switch (e.type) {
    ...
    case `Alternative`:
      ...
      for (let e = 0; e < r.length; e++) {
        ...
        if ((a.type === `Group` && Sa(a) === !1) || (a.type !== `Group` && o === !1)) break;
      }
      break;
    default:
      throw Error(`non exhaustive match!`);
  ...
  n(`Line Terminator Handling`, () => {
    ...
    ((d = r.map((e) => !1)),
      t.positionTracking !== `onlyOffset` &&
        (d = r.map((t) =>
          Object.hasOwn(t, `LINE_BREAKS`) ? !!t.LINE_BREAKS : Xa(t, e) === !1 && Ca(e, t.PATTERN),
        )));
  });
  let f, p, m, h;
  n(`Misc Mapping #2`, () => {
  ...
  return (
    t.safeMode ||
      n(`First Char Optimization`, () => {
        _ = r.reduce((e, n, r) => {
          if (typeof n.PATTERN == `string`) $a(e, eo(n.PATTERN.charCodeAt(0)), h[r]);
...
function La(e) {
  let t = [],
    n = e.map((n) =>
      e.reduce(
        (e, r) =>
          n.PATTERN.source === r.PATTERN.source && !t.includes(r) && r.PATTERN !== Ao.NA
            ? (t.push(r), e.push(r), e)
            : e,
        [],
      ),
      ...
      return (
        r === Ao.NA ||
          (typeof r == `string`
            ...
            : r instanceof RegExp && Ha(r) && e.push({ str: r.source, idx: n, tokenType: t })),
        e
      );
    }, []);
  return (
    e.forEach((e, r) => {
      n.forEach(({ str: n, idx: i, tokenType: a }) => {
        if (r < i && Va(n, e.PATTERN)) {
          ...
          t.push({ message: n, type: G.UNREACHABLE_PATTERN, tokenTypes: [e, a] });
        }
      });
    }),
    t
          ...
          (n === !0
            ...
            this.TRACE_INIT(`Lexer Constructor`, () => {
              ...
              (this.TRACE_INIT(`Lexer Config handling`, () => {
                if (this.config.lineTerminatorsPattern === ko.lineTerminatorsPattern)
                  this.config.lineTerminatorsPattern = so;
                else if (this.config.lineTerminatorCharacters === ko.lineTerminatorCharacters)
                ...
                this.config.skipValidations === !1 &&
                  (this.TRACE_INIT(`performRuntimeChecks`, () => {
                    this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(
                      Ga(n, this.trackStartLines, this.config.lineTerminatorCharacters),
                    );
                  }),
                  this.TRACE_INIT(`performWarningRuntimeChecks`, () => {
                    this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(
                      Ka(n, this.trackStartLines, this.config.lineTerminatorCharacters),
                    );
                  })),
                    ...
                    if (
                      ...
                      this.config.skipValidations === !1 &&
                        this.TRACE_INIT(`validatePatterns`, () => {
                          this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(ka(n, i));
                        }),
          ...
          for (; y < v; ) {
            ...
            if (u !== -1) {
              ...
              if (
                ...
                te.push({ offset: t, line: n, column: i, length: m, message: h }),
                M === !1)
              )
                break;
            }
          }
          return (this.hasCustom || (x.length = ee), { tokens: x, groups: ne, errors: te });
        }
        handleModes(e, t, n, r) {
          if (e.pop === !0) {
            let i = e.push;
...
function Fo(e) {
  let t = e.pattern,
    n = {};
  if (((n.name = e.name), t !== void 0 && (n.PATTERN = t), Object.hasOwn(e, Ro)))
...
inside top level rule: ->` +
      ...
      (Zo = {
        buildDuplicateFoundError(e, t) {
          function n(e) {
            return e instanceof W ? e.terminalType.name : e instanceof Ii ? e.nonTerminalName : ``;
          }
          let r = e.name,
            i = t[0],
            a = i.idx,
...
For Further details.`),
        ...
        buildDuplicateRuleNameError(e) {
          let t;
          return (
            (t = e.topLevelRule instanceof Li ? e.topLevelRule.name : e.topLevelRule),
...
function ns(e, t, n = []) {
  ...
  for (; n.length < t && i < e.length; ) {
    ...
    else if (t instanceof zi) return o(t.definition.concat([new U({ definition: t.definition })]));
    else if (t instanceof Bi)
      return o([
        new Ri({ definition: t.definition }),
        new U({ definition: [new W({ terminalType: t.separator })].concat(t.definition) }),
      ]);
    ...
    else if (t instanceof U) r = o(t.definition.concat([new U({ definition: t.definition })]));
...
function rs(e, t, n, r) {
  ...
  for (d.push({ idx: -1, def: e, ruleStack: [], occurrenceStack: [] }); d.length !== 0; ) {
    ...
    if (h === i) {
      ...
      let e = new U({
          definition: [new W({ terminalType: h.separator })].concat(h.definition),
          idx: h.idx,
        }),
        t = { idx: f, def: h.definition.concat([e], r.slice(1)), ruleStack: p, occurrenceStack: m };
      d.push(t);
      ...
      (os = class extends as {
        ...
        walkTerminal(e, t, n) {
          this.isAtEndOfPath &&
            ...
            !this.found &&
            ((this.possibleTokTypes = ta(new Ri({ definition: t.concat(n) }))), (this.found = !0));
        }
      }),
      (ss = class extends $i {
        constructor(e, t) {
...
function ps(e) {
  ...
  if (e instanceof zi || e === `RepetitionMandatory`) return K.REPETITION_MANDATORY;
  if (e instanceof Bi || e === `RepetitionMandatoryWithSeparator`)
    return K.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (e instanceof Vi || e === `RepetitionWithSeparator`) return K.REPETITION_WITH_SEPARATOR;
  ...
  As = t(() => {
    (fs(),
      ...
      (Os = class extends $i {
        ...
        walkAtLeastOne(e, t, n) {
          this.checkIsTarget(e, K.REPETITION_MANDATORY, t, n) || super.walkOption(e, t, n);
        }
        walkAtLeastOneSep(e, t, n) {
        ...
        walkManySep(e, t, n) {
          this.checkIsTarget(e, K.REPETITION_WITH_SEPARATOR, t, n) || super.walkOption(e, t, n);
        }
      }),
      (ks = class extends Wi {
        constructor(e, t, n) {
...
function zs(e) {
  ...
  else if (n instanceof Hi) t = n.definition.map((e) => zs(e.definition)).flat();
      ...
      (e.accept(i),
        i.allProductions.forEach((i) => {
          ...
          if (ws(s, e, a, o)[0].flat().length === 0) {
            ...
            r.push({ message: t, type: xl.NO_NON_EMPTY_LOOKAHEAD, ruleName: e.name });
          }
        }));
    }),
    r
      ...
      (n, r, a) => (
        t.definition[a].ignoreAmbiguities === !0 ||
          r.forEach((r) => {
            let o = [a];
            (e.forEach((e, n) => {
              a !== n && Ts(e, r) && t.definition[n].ignoreAmbiguities !== !0 && o.push(n);
            }),
              o.length > 1 && !Ts(i, r) && (i.push(r), n.push({ alts: o, path: r })));
          }),
        n
      ),
      [],
...
function Gs(e, t, n, r) {
  ...
  return i.flatMap((e) => {
    ...
    let a = e.idx,
      o = e.path;
    return i
      .filter((e) => t.definition[e.idx].ignoreAmbiguities !== !0 && e.idx < a && Es(e.path, o))
      .map((e) => {
        let i = [e.idx + 1, a + 1],
          o = t.idx === 0 ? `` : t.idx;
        return {
  ...
  return (
    e.forEach((e) => {
      ...
      if (i.includes(t)) {
        ...
        r.push({ message: i, type: xl.CONFLICT_TOKENS_RULES_NAMESPACE, ruleName: t });
      }
    }),
    r
  );
          ...
          e.forEach((e) => {
            this.TRACE_INIT(`${e.name} Rule Lookahead`, () => {
              ...
              (t.forEach((t) => {
                ...
                n.forEach((t) => {
                  this.computeLookaheadFunc(e, t.idx, 768, `Repetition`, t.maxLookahead, Yi(t));
                }),
                r.forEach((t) => {
                  this.computeLookaheadFunc(e, t.idx, 512, `Option`, t.maxLookahead, Yi(t));
                }),
                i.forEach((t) => {
...
var Pc = t(() => {});
function Fc(e, t) {
  Object.defineProperty(e, Ic, { enumerable: !1, configurable: !0, writable: !1, value: t });
}
var Ic,
  Lc = t(() => {
    Ic = `name`;
...
var Uc,
  ...
  Qc = t(() => {
	...
	For Further details.`);
          ...
          else if (Object.hasOwn(e, `modes`) && Object.values(e.modes).flat().every(Co)) {
        ...
        defineRule(e, t, n) {
          ...
          let r = Object.hasOwn(n, `resyncEnabled`) ? n.resyncEnabled : bl.resyncEnabled,
            i = Object.hasOwn(n, `recoveryValueFunc`) ? n.recoveryValueFunc : bl.recoveryValueFunc,
        ...
        atLeastOneInternalLogic(e, t, n) {
          ...
          } else throw this.raiseEarlyExitException(e, K.REPETITION_MANDATORY, t.ERR_MSG);
          this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, t], r, yc, e, us);
        }
        ...
        atLeastOneSepFirstInternalLogic(e, t, n) {
          ...
          if (this.getLaFuncFromCache(n).call(this) === !0) {
            ...
            throw this.raiseEarlyExitException(e, K.REPETITION_MANDATORY_WITH_SEPARATOR, t.ERR_MSG);
        }
        manyInternal(e, t) {
        ...
        manyInternalLogic(e, t, n) {
          ...
          this.attemptInRepetitionRecovery(this.manyInternal, [e, t], r, 768, e, cs, a);
        }
        ...
        consumeInternal(e, t, n) {
          ...
          return (
            this.cstPostTerminal(n !== void 0 && n.LABEL !== void 0 ? n.LABEL : e.name, r), r
          );
        }
        ...
        onBeforeParse(e) {
          for (let e = 0; e < this.maxLookahead + 1; e++) this.tokVector.push(vl);
        }
        onAfterParse(e) {
...
function nl(e, t) {
  ...
  let n = this.recordingProdStack.at(-1),
    r = Array.isArray(e) === !1,
    i = r === !1 ? e : e.DEF,
    a = new Hi({ definition: [], idx: t, ignoreAmbiguities: r && e.IGNORE_AMBIGUITIES === !0 });
  return (
...
var al,
  ...
  fl = t(() => {
    (Zi(),
      ...
      wl(),
      Sc(),
      (al = { description: `This Object indicates the Parser is during Recording Phase` }),
      Object.freeze(al),
      (ol = !0),
      (sl = 2 ** 8 - 1),
	...
	https://chevrotain.io/docs/guide/internals.html#grammar-recording`;
        ...
        subruleInternalRecord(e, t, n) {
          ...
          let r = this.recordingProdStack.at(-1),
            i = e.ruleName,
            a = new Ii({ idx: t, nonTerminalName: i, label: n?.LABEL, referencedRule: void 0 });
    ...
    (ki(),
      ...
      (pl = class {
        initPerformanceTracer(e) {
          ...
          } else ((this.traceInitMaxIdent = 0), (this.traceInitPerf = yl.traceInitPerf));
          this.traceInitIndent = -1;
        }
        TRACE_INIT(e, t) {
          if (this.traceInitPerf === !0) {
...
var vl,
  ...
  wl = t(() => {
    (ki(),
      ...
      (bl = Object.freeze({ recoveryValueFunc: () => void 0, resyncEnabled: !0 })),
      (function (e) {
              ...
              this.definitionErrors.length === 0 &&
                (this.recoveryEnabled &&
                  this.TRACE_INIT(`computeAllProdsFollows`, () => {
                    this.resyncFollows = ca(Object.values(this.gastProductionsCache));
                  }),
...
function jl(e, t, n) {
  let r = J(e, t, n, { type: 5 });
  return (Bl(e, r), Rl(e, t, n, Vl(e, t, r, n, Il(e, t, n)), Wl(e, t, n.separator, n)));
}
function Ml(e, t, n) {
...
function Nl(e, t, n) {
  let r = J(e, t, n, { type: 4 });
  return (Bl(e, r), Ll(e, t, n, Vl(e, t, r, n, Il(e, t, n)), Wl(e, t, n.separator, n)));
}
function Pl(e, t, n) {
...
function Ll(e, t, n, r, i) {
  ...
  return (
    (a.loopback = s),
    (c.loopback = s),
    (e.decisionMap[El(t, i ? `RepetitionMandatoryWithSeparator` : `RepetitionMandatory`, n.idx)] =
      s),
    q(o, s),
...
function Rl(e, t, n, r, i) {
  ...
  return (
    ...
    (e.decisionMap[El(t, i ? `RepetitionWithSeparator` : `Repetition`, n.idx)] = s),
    { left: s, right: c }
  );
}
function zl(e, t, n, r) {
...
function cu(e, t, n, r) {
  ...
  for (;;) {
    let t = mu(i, s);
    if ((t === void 0 && (t = lu.apply(this, [e, i, s, a, n, r])), t === tu)) return pu(o, i, s);
...
function xu(e) {
  ...
  for (let r = 0; r < n; r++) Su({ state: e.transitions[r].target, alt: r, stack: [] }, t);
  return t;
}
function Su(e, t) {
  let n = e.state;
  ...
  Nu = t(() => {
    (Tl(),
      ...
      (Mu = class extends Cc {
        ...
        buildLookaheadForAlternation(e) {
          let { prodOccurrence: t, rule: n, hasPredicates: r, dynamicTokensEnabled: i } = e,
            a = this.dfas,
            s = this.logging,
            c = El(n, `Alternation`, t),
            l = this.atn.decisionMap[c].decision,
            u = o(ms({ maxLookahead: 1, occurrence: t, prodType: `Alternation`, rule: n }), (e) =>
              o(e, (e) => e[0]),
            );
          if (au(u, !1) && !i) {
            let e = g(
        ...
        buildLookaheadForOptional(e) {
          let { prodOccurrence: t, rule: n, prodType: r, dynamicTokensEnabled: i } = e,
            a = this.dfas,
            s = this.logging,
            c = El(n, r, t),
            l = this.atn.decisionMap[c].decision,
            u = o(ms({ maxLookahead: 1, occurrence: t, prodType: r, rule: n }), (e) =>
              o(e, (e) => e[0]),
            );
          if (au(u) && u[0][0] && !i) {
            let e = u[0],
    ...
    (re(),
      ...
      (Fu = class {
        ...
        addHiddenNodes(e) {
          let t = [];
          for (let n of e) {
            let e = new Lu(n.startOffset, n.image.length, Nn(n), n.tokenType, !0);
  ...
  ed = t(() => {
    (Dn(),
      ...
      (qu = class extends Ku {
        ...
        startImplementation(e, t, n) {
          return (r) => {
            ...
            if (i) {
              let n = { $type: e };
              (this.stack.push(n), e === Uu ? (n.value = ``) : t !== void 0 && (n.$infixName = t));
            }
        ...
        consume(e, t, n) {
          ...
          if (!this.isRecording() && this.isValidToken(r)) {
            ...
            if (i) {
              ...
              let e = r.image;
              (et(n) || (e = this.converter.convert(e, t).toString()), (o.value += e));
            }
          }
        }
        isValidToken(e) {
        ...
        getAssignment(e) {
          if (!this.assignmentMap.has(e)) {
            ...
            this.assignmentMap.set(e, {
              assignment: t,
              crossRef: t && Ue(t.terminal) ? (t.terminal.isMulti ? `multi` : `single`) : void 0,
            });
          }
      ...
      (Xu = class extends Ku {
        ...
        rule(e, t) {
          let n = this.wrapper.DEFINE_RULE(Gu(e.name), this.startImplementation(t).bind(this));
...
function sd(e, t) {
  if (t.some((e) => e.calledByName)) {
    let e = t.map((e) => ({ parameterName: e.parameter?.ref?.name, predicate: cd(e.value) }));
    return (t) => {
      let n = {};
...
function pd(e, t, n = t.terminal) {
  if (!n) {
    ...
    if (!n) throw Error(`Could not find name assignment for type: ` + ai(t.type.ref));
    return pd(e, t, n);
...
function _d(e, t) {
  ...
  if (e.ruleNames.has(t)) return e.ruleNames.get(t);
  {
    let n = t,
      ...
      i = t.$type;
    for (; !st(r); )
      ((Je(r) || Fe(r) || Ct(r)) && (i = r.elements.indexOf(n).toString() + `:` + i),
        (n = r),
        (r = r.$container));
    ...
    (Tl(),
      ...
      (Td = class {
        ...
        findLongerAlt(e, t) {
          return t.reduce((t, n) => {
            let r = n?.PATTERN;
            return (r?.source && Tr(`^` + r.source + `$`, e.value) && t.push(n), t);
          }, []);
        }
      }));
  }),
...
async function Fd(e) {
  ...
  if ((t - Id >= Ld && ((Id = t), await jd(), (Id = performance.now())), e.isCancellationRequested))
    throw Rd;
}
var Id,
  Ld,
    ...
    ((() => {
          ...
          975: (e) => {
            ...
            var r = {
              resolve: function () {
                ...
                return (
                  (r = n(r, !i)), i ? (r.length > 0 ? `/` + r : `/`) : r.length > 0 ? r : `.`
                );
              },
                ...
                if (n !== void 0 && n.length > 0 && n.length <= e.length) {
                  ...
                  for (r = e.length - 1; r >= 0; --r) {
                    ...
                    if (l === 47) {
                      ...
                      (c === -1 && ((o = !1), (c = r + 1)),
                        s >= 0 &&
                          (l === n.charCodeAt(s) ? --s == -1 && (a = r) : ((s = -1), (a = c))));
                  }
      ...
      class u {
        ...
        static parse(e, t = !1) {
          let n = l.exec(e);
          return n
            ? new f(n[2] || ``, ee(n[4] || ``), ee(n[5] || ``), ee(n[7] || ``), ee(n[9] || ``), t)
            : new f(``, ``, ``, ``, ``);
        }
        static file(e) {
          let t = ``;
    ...
    (w(),
      ...
      (Yd = class {
        ...
        async getOrCreateDocument(e, t) {
          ...
          return (
            n || ((n = await this.langiumDocumentFactory.fromUri(e, t)), this.addDocument(n), n)
          );
        }
          ...
          let i = this,
            a = {
              ...
              get items() {
                ...
                } else this._items === Zd && i.throwCyclicReferenceError(e, t, r);
      ...
      (rf = class {
        constructor(e) {
          ((this.nameProvider = e.references.NameProvider),
            ...
            (this.hasMultiReference = Ce(e.Grammar).some((e) => Ue(e) && e.isMulti)));
        }
        findDeclarations(e) {
          if (e) {
            let t = qr(e),
        ...
        getSelfNodes(e) {
          if (this.hasMultiReference) {
            ...
            if (n) {
              for (let t of Te(n))
                if (A(t.reference) && t.reference.items.some((t) => t.ref === e))
        ...
        findReferences(e, t) {
          ...
          return (
            t.documentUri && (r = r.filter((e) => Gd.equals(e.sourceUri, t.documentUri))),
            n.push(...r),
            F(n)
          );
        }
  ...
  cf = t(() => {
    (R(),
      (of = class {
        ...
        addAll(e, t) {
          return (
            this.map.has(e) ? this.map.get(e).push(...t) : this.map.set(e, Array.from(t)), this
          );
        }
        forEach(e) {
  ...
  uf = t(() => {
    (z(),
      ...
      (lf = class {
        ...
        async collectExportedSymbolsForNode(e, t, n = xe, r = Y.CancellationToken.None) {
          let i = [];
      ...
      (Sf = class {
        ...
        getScope(e) {
          ...
          if (r) {
            ...
            do
              (r.has(i) &&
                t.push(r.getStream(i).filter((e) => this.reflection.isSubtype(e.type, n))),
                (i = i.$container));
            while (i);
          }
        ...
        getGlobalScope(e, t) {
          return this.globalScopeCache.get(e, () => new pf(this.indexManager.allElements(e)));
        }
      }));
  });
function wf(e) {
      ...
      (Ef = class {
        ...
        serialize(e, t) {
          let n = t ?? {},
            ...
            a = r ? (e, t) => r(e, t, i) : i;
          try {
            return ((this.currentDocument = ve(e)), JSON.stringify(e, a, t?.space));
          } finally {
        ...
        replacer(
          e,
          t,
          { refText: n, sourceText: r, textRegions: i, comments: a, uriConverter: o },
        ) {
          if (!this.ignoreProperties.has(e))
            if (k(t)) {
              ...
              if (e) {
                ...
                return { $error: t.error?.message ?? `Could not resolve reference`, $refText: r };
            } else if (A(t)) {
        ...
        reviveReference(e, t, n, r, i) {
          ...
          if (r.$ref) {
            ...
            if (O(e)) return ((a ||= this.nameProvider.getName(e)), { $refText: a ?? ``, ref: e });
            o = e;
          } else if (r.$refs) {
            let e = [];
            for (let t of r.$refs) {
...
function Pf(e) {
  ...
  return (
    typeof e.property == `string`
      ...
      : typeof e.keyword == `string` && (t = Gr(e.node.$cstNode, e.keyword, e.index)),
    (t ??= e.node.$cstNode),
        ...
        async validateDocument(e, t = {}, n = Y.CancellationToken.None) {
          ...
          if (
            ...
            (!t.categories || t.categories.includes(`built-in`)) &&
              ...
              (t.stopAfterLexingErrors && i.some((e) => e.data?.code === zf.LexingError)) ||
                (this.processParsingErrors(r, i, t),
                t.stopAfterParsingErrors && i.some((e) => e.data?.code === zf.ParsingError)) ||
                (this.processLinkingErrors(e, i, t),
                t.stopAfterLinkingErrors && i.some((e) => e.data?.code === zf.LinkingError))))
          )
            return i;
          try {
    ...
    (Ad(),
      ...
      (Vf = class {
        ...
        createDescription(e, t, n) {
          ...
          let a,
            o = () => (a ??= Pn(this.nameProvider.getNameNode(e) ?? e.$cstNode));
          return {
            node: e,
            name: t,
            get nameSegment() {
      ...
      (Hf = class {
        ...
        createInfoDescriptions(e) {
          ...
          k(t) && t.$nodeDescription
            ? (n = [t.$nodeDescription])
            : A(t) && (n = t.items.map((e) => e.$nodeDescription).filter((e) => e !== void 0));
        ...
        async initialized(e) {
          if (this.workspaceConfig) {
            if (e.register) {
              ...
              e.register({
                section: t.map((e) => this.toSectionName(e.LanguageMetaData.languageId)),
              });
            }
          ...
          return this.writeSemaphore.lock(async () =>
            this.options.contentTypeEncoder
              ...
              .then(
                (t) => {
                  let n = [];
                  return (n.push(a, t.byteLength.toString(), o), n.push(o), this.doWrite(e, n, t));
                },
                (e) => {
  ...
  ip = a((e) => {
    ...
    (function (e) {
      function t(e) {
        ...
        return (
          t &&
          (te.is(t.cancellationStrategy) || v.is(t.connectionStrategy) || C.is(t.messageStrategy))
        );
      }
      e.is = t;
    ...
    function D(f, v, ee, b) {
      ...
      function ve() {
        (se === w.New || se === w.Listening) && ((se = w.Closed), le.fire(void 0));
      }
      function ye(e) {
          ...
          if (r.Message.isNotification(e) && e.method === s.type.method) {
            ...
            if (r.Message.isRequest(i)) {
              let r = b?.connectionStrategy,
                a = r && r.cancelUndispatched ? r.cancelUndispatched(i, me) : void 0;
              if (a && (a.error !== void 0 || a.result !== void 0)) {
                (k.delete(n),
                  M.delete(t),
                  (a.id = i.id),
                  je(a, e.method, Date.now()),
                  v.write(a).catch(() => x.error(`Sending response for canceled message failed.`)));
                return;
              }
            }
            let a = M.get(t);
      ...
      function Te(e) {
        ...
        function i(t, n, r) {
          ...
          (je(i, n, r), v.write(i).catch(() => x.error(`Sending response failed.`)));
        }
        function a(t, n, r) {
          t === void 0 && (t = null);
        ...
        if (c || T) {
          ...
          (e.id !== null && j.has(e.id) && u.cancel(), e.id !== null && M.set(o, u));
          try {
            let d;
            if (c)
              if (e.params === void 0) {
          ...
          if (e.id === null)
            ...
            if ((Pe(e, n), n !== void 0)) {
              ...
              try {
                ...
                e.message
                  ? x.error(`Response handler '${n.method}' failed with message: ${e.message}`)
                  : x.error(`Response handler '${n.method}' failed unexpectedly.`);
              }
            }
          }
      }
      function De(e) {
        ...
        if (n || D)
          try {
            ...
            t.message
              ? x.error(`Notification handler '${e.method}' failed with message: ${t.message}`)
              : x.error(`Notification handler '${e.method}' failed unexpectedly.`);
          }
        else ue.fire(e);
      }
      function Oe(e) {
      ...
      function ke(e) {
        if (!(N === d.Off || !P))
          if (oe === p.Text) {
            let t;
            ((N === d.Verbose || N === d.Compact) && e.params && (t = `Params: ${z(e.params)}\n\n`),
...
`)),
      ...
      function Le() {
        if (he()) throw new _(g.AlreadyListening, `Connection is already listening`);
      }
      function Re() {
      ...
      let We = {
            ...
            n.func(e)
              ...
              : t &&
                (n.string(e)
                  ...
                  : ((r = e.method), ie.set(e.method, { type: e, handler: t }))),
            {
              dispose: () => {
        ...
        sendProgress: (e, t, n) => We.sendNotification(l.type, { token: t, value: n }),
        ...
        sendRequest: (e, ...t) => {
          ...
          s &&
            (l = s.onCancellationRequested(() => {
              ...
              return e === void 0
                ? (x.log(`Received no promise from cancellation strategy when cancelling id ${c}`),
                  Promise.resolve())
                : e.catch(() => {
          ...
          return (
            ke(u),
            typeof I.sender.enableCancellation == `function` && I.sender.enableCancellation(u),
        ...
        onRequest: (e, t) => {
          ...
          return (
            u.is(e)
              ? ((r = void 0), (T = e))
              : n.string(e)
                ? ((r = null), t !== void 0 && ((r = e), E.set(e, { handler: t, type: void 0 })))
                : t !== void 0 && ((r = e.method), E.set(e.method, { type: e, handler: t })),
            {
              dispose: () => {
        ...
        trace: async (e, t, r) => {
          ...
          (r !== void 0 &&
            ...
            (oe = a),
            (P = N === d.Off ? void 0 : t),
            i && !ge() && !_e() && (await We.sendNotification(m.type, { value: d.toString(e) })));
        },
        onError: ce.event,
        onClose: le.event,
  ...
  jp = a((e) => {
    ...
    (function (e) {
      function t(e) {
        ...
        return (
          i.objectLiteral(t) &&
          (i.string(t.notebookType) || i.string(t.scheme) || i.string(t.pattern))
        );
      }
      e.is = t;
    ...
    (function (e) {
      function t(e) {
        let t = e;
        return (
          i.objectLiteral(t) && (t.workDoneProgress === void 0 || i.boolean(t.workDoneProgress))
        );
      }
      e.is = t;
      function n(e) {
    ...
    ((Lp = Pp()),
      ...
      (Rp = class {
        ...
        async runCancelable(e, t, n, r) {
          for (let i of e)
            i.state < t &&
              (await Fd(n), await r(i), (i.state = t), await this.notifyDocumentPhase(i, t, n));
                ...
                : this.currentState >= e && e > r.state
                  ...
                  : new Promise((r, i) => {
                      let a = this.onDocumentPhase(e, (e) => {
                          Gd.equals(e.uri, t) && (a.dispose(), o.dispose(), r(e.uri));
                        }),
    ...
    (Ad(),
      ...
      (Hp = class {
        ...
        async initializeWorkspace(e, t = Y.CancellationToken.None) {
          ...
          (await Fd(t), await this.documentBuilder.build(n, this.initialBuildOptions, t));
        }
...
function Zp(e, t, n) {
  ...
  let a = $p(e),
    o = dm(r);
  return im({ index: 0, tokens: em({ lines: a, position: i, options: o }), position: i });
}
function Qp(e, t) {
  let n = dm(t),
    r = $p(e);
    ...
    for (let o of e) {
      ...
      if (
        (i.push({
          type: `inline-tag`,
          content: l,
          range: C.create(D.create(n, a + c + r), D.create(n, a + c + l.length + r)),
        }),
        (c += l.length),
        o.length === 4)
      ) {
        ...
        i.push({
          type: `text`,
          content: e,
          range: C.create(D.create(n, a + c + r), D.create(n, a + c + e.length + r)),
        });
      } else
        i.push({
          type: `text`,
...
function lm(e, t) {
  ...
  if (e.tokens[e.index]?.type === `text`)
    if (t) {
      let i = um(e);
      return new xm(r, new Sm([i], i.range), t, C.create(n.range.start, i.range.end));
    } else {
      let i = sm(e);
    ...
    (Vu(),
      ...
      (Fm = class {
        ...
        createGrammarElementIdMap() {
          let e = 0;
          for (let t of Ce(this.grammar)) Ae(t) && this.grammarElementIdMap.set(t, e++);
        }
      }));
  });
function Lm(e) {
  return {
    documentation: { CommentProvider: (e) => new Dm(e), DocumentationProvider: (e) => new Tm(e) },
    parser: {
    ...
    serializer: { Hydrator: (e) => new Fm(e), JsonSerializer: (e) => new Ef(e) },
    validation: { DocumentValidator: (e) => new Rf(e), ValidationRegistry: (e) => new Mf(e) },
    shared: () => e.shared,
  };
}
function Rm(e) {
    ...
    (Tl(),
      ...
      (th = class extends Td {
        ...
        buildTokens(e, t) {
          ...
          return o.length > 0
            ? {
                modes: { [eh.REGULAR]: [s, c, ...u, l], [eh.IGNORE_INDENTATION]: [...u, l] },
...
`.includes(e[t - 1])
        ...
        buildTerminalToken(e) {
          let t = super.buildTerminalToken(e),
            { indentTokenName: n, dedentTokenName: r, whitespaceTokenName: i } = this.options;
          return t.name === n
            ? this.indentTokenType
            : t.name === r
              ? this.dedentTokenType
              : t.name === i
                ? Po({ name: i, pattern: this.whitespaceRegExp, group: Ao.SKIPPED })
                : t;
        }
        flushRemainingDedents(e) {
          let t = [];
          for (; this.indentationStack.length > 1; )
            (t.push(this.createIndentationTokenInstance(this.dedentTokenType, e, ``, e.length)),
      ...
      (nh = class extends Yp {
        ...
        tokenize(e, t = Jp) {
          ...
          let { indentTokenType: i, dedentTokenType: a } = this.indentationTokenBuilder,
            o = i.tokenTypeIdx,
            s = a.tokenTypeIdx,
            c = [],
            l = n.tokens.length - 1;
...
var ph,
  ...
  _h = t(() => {
    (xf(), qf(), e(gh, Kf), cf(), Ip(), tr(), hh(), Bd(), R(), qd(), z(), Ad(), Zn(), yi(), Mr());
  }),
  vh = t(() => {
    (Bf(), Nf());
  }),
        ...
        dumpRecord(e, t) {
          ...
          for (let e of t.entries.keys()) {
            let r = t.entries.get(e),
              i = r.reduce((e, t) => e + t);
            n.push({ name: `${t.identifier}.${e}`, count: r.length, duration: i });
          }
  ...
  wh = t(() => {
    (zm(), Jm(), kf(), Ym(), ce(), Xm(), Qm(), ah(), oh(), sh(), _h(), e(Ch, gh), vh(), Sh(), Dn());
  });
function Th(e) {
...
var Lh,
  ...
  k_ = t(() => {
    (wh(),
      ...
      (Jh = { $type: `Anchor`, evolution: `evolution`, name: `name`, visibility: `visibility` }),
      (Yh = { $type: `Annotation`, number: `number`, text: `text`, x: `x`, y: `y` }),
      ...
      (tg = { $type: `CherryPicking`, id: `id`, parent: `parent`, tags: `tags` }),
      (ng = { $type: `ClassDefStatement`, className: `className`, styleText: `styleText` }),
      (rg = { $type: `Commit`, id: `id`, message: `message`, tags: `tags`, type: `type` }),
      Q(Dh, `isCommit`),
      (ig = {
        $type: `Component`,
        decorator: `decorator`,
      ...
      (ag = { $type: `Curve`, entries: `entries`, label: `label`, name: `name` }),
      ...
      Q(Oh, `isGitGraph`),
      (hg = { $type: `Group`, icon: `icon`, id: `id`, in: `in`, title: `title` }),
      (gg = { $type: `Info`, accDescr: `accDescr`, accTitle: `accTitle`, title: `title` }),
      Q(kh, `isInfo`),
      (_g = { $type: `Item`, classSelector: `classSelector`, name: `name` }),
      (vg = { $type: `Junction`, id: `id`, in: `in` }),
      (yg = { $type: `Label`, negX: `negX`, negY: `negY`, offsetX: `offsetX`, offsetY: `offsetY` }),
      (bg = { $type: `Leaf`, classSelector: `classSelector`, name: `name`, value: `value` }),
      (xg = {
        $type: `Link`,
        arrow: `arrow`,
        from: `from`,
      ...
      (Sg = { $type: `Merge`, branch: `branch`, id: `id`, tags: `tags`, type: `type` }),
      Q(Ah, `isMerge`),
      (Cg = { $type: `Note`, evolution: `evolution`, text: `text`, visibility: `visibility` }),
      ...
      Q(jh, `isPacket`),
      (Eg = { $type: `PacketBlock`, bits: `bits`, end: `end`, label: `label`, start: `start` }),
      Q(Mh, `isPacketBlock`),
      (Dg = {
        $type: `Pie`,
        accDescr: `accDescr`,
      ...
      (Ag = { $type: `PipelineComponent`, evolution: `evolution`, label: `label`, name: `name` }),
      (jg = {
        $type: `Radar`,
        accDescr: `accDescr`,
        accTitle: `accTitle`,
        ...
        constructor() {
          (super(...arguments),
            (this.types = {
              Accelerator: {
                name: qh.$type,
                properties: { name: { name: qh.name }, x: { name: qh.x }, y: { name: qh.y } },
                superTypes: [],
              },
              Anchor: {
                name: Jh.$type,
              ...
              Axis: {
                name: Qh.$type,
                properties: { label: { name: Qh.label }, name: { name: Qh.name } },
                superTypes: [],
              },
              Branch: {
                name: $h.$type,
                properties: { name: { name: $h.name }, order: { name: $h.order } },
                superTypes: [Fg.$type],
              },
              Checkout: {
                name: eg.$type,
              ...
              Deaccelerator: {
                name: og.$type,
                properties: { name: { name: og.name }, x: { name: og.x }, y: { name: og.y } },
                superTypes: [],
              },
              Decorator: {
                name: sg.$type,
              ...
              Evolve: {
                name: pg.$type,
                properties: { component: { name: pg.component }, target: { name: pg.target } },
                superTypes: [],
              },
              GitGraph: {
                name: mg.$type,
              ...
              Item: {
                name: _g.$type,
                properties: { classSelector: { name: _g.classSelector }, name: { name: _g.name } },
                superTypes: [],
              },
              Junction: {
                name: vg.$type,
              ...
              PieSection: {
                name: Og.$type,
                properties: { label: { name: Og.label }, value: { name: Og.value } },
                superTypes: [],
              },
              Pipeline: {
                name: kg.$type,
              ...
              Section: {
                name: Mg.$type,
                properties: { classSelector: { name: Mg.classSelector }, name: { name: Mg.name } },
                superTypes: [_g.$type],
              },
              Service: {
                name: Ng.$type,
              ...
              Size: {
                name: Pg.$type,
                properties: { height: { name: Pg.height }, width: { name: Pg.width } },
                superTypes: [],
              },
              Statement: { name: Fg.$type, properties: {}, superTypes: [] },
              TreeNode: {
                name: Rg.$type,
                properties: { indent: { name: Rg.indent }, name: { name: Rg.name } },
                superTypes: [],
              },
              TreeView: {
                name: zg.$type,
              ...
              TreemapRow: {
                name: Lg.$type,
                properties: { indent: { name: Lg.indent }, item: { name: Lg.item } },
                superTypes: [],
              },
              Wardley: {
                name: $.$type,
