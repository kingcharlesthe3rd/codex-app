...
function n(e, { count: n, kind: r }) {
  switch (r) {
    case `annotation`:
      return e.formatMessage(t.annotationCount, { count: n });
    case `comment`:
      return e.formatMessage(t.commentCount, { count: n });
  }
}
function r(e, t, r) {
  return n(e, { count: r, kind: t });
}
function i(e, n) {
  switch (n) {
    case `annotation`:
      return e.formatMessage(t.removeAnnotations);
    case `comment`:
      return e.formatMessage(t.removeComments);
  }
}
function a(e, { annotationCount: r, commentCount: i, designTweakCount: a = 0 }) {
  let o = r + a;
  return o > 0 && i > 0
    ? e.formatMessage(t.mixedSummary, {
        annotations: n(e, { count: o, kind: `annotation` }),
        comments: n(e, { count: i, kind: `comment` }),
      })
    : o > 0
      ? n(e, { count: o, kind: `annotation` })
      : i > 0
        ? n(e, { count: i, kind: `comment` })
        : ``;
}
export { a as n, i as r, r as t };
//# sourceMappingURL=comment-attachment-labels.js.map
