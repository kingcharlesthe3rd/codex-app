import { m as e, p as t, t as n } from "./app-scope-CWE-zIhQ.js";
import { Bt as r } from "./use-host-config-C.js";
import { M as i } from "./thread-context-inputs.js";
...
function l(e) {
  return {
    ...
    queryFn: async () => c((await r(`list-collaboration-modes`, { hostId: e })).data, o),
  };
}
var u = t(n, (e) => l(e)),
  d = e(n, ({ get: e }) => l(e(i)));
