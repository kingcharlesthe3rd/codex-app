...
import { i as S, n as C, r as w, t as T } from "./src-1.js";
import { t as E } from "./dist-3.js";
import { i as D, n as O, o as k, r as A } from "./chunk-66.js";
import {
  A as j,
  C as M,
  G as ee,
...
import { g as ce, u as le } from "./chunk-1.js";
var ue = n((e, t) => {
    (function (n, r) {
...
` +
    ...
    (Ct = { monday: x, tuesday: f, wednesday: y, thursday: a, friday: i, saturday: h, sunday: o }),
    (wt = O((e, t) => {
      let n = [...e].map(() => -1 / 0),
    ...
    (Tt = {
      ...
      renderer: {
        ...
        draw: O(function (e, t, n, i) {
          let a = N().gantt;
          i.db.setDiagramId(t);
          let o = N().securityLevel,
            f;
          o === `sandbox` && (f = C(`#i` + t));
          let h = C(o === `sandbox` ? f.nodes()[0].contentDocument.body : `body`),
            y = o === `sandbox` ? f.nodes()[0].contentDocument : document,
            x = y.getElementById(t);
          ...
          function te(e, t, n) {
            let r = a.barHeight,
              ...
              s = a.topPadding,
              l = a.leftPadding,
              u = c().domain([0, E.length]).range([`#00B9FA`, `#F95002`]).interpolate(g);
          ...
          function ne(e, n, r, o, s, c, l) {
            ...
            j.append(`g`)
              ...
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e.type === n) return `section section` + (t % a.numberSectionStyles);
            ...
            if (
              (d
                ...
                .attr(`x`, function (e) {
                  return e.milestone
                    ? M(e.startTime) + o + 0.5 * (M(e.endTime) - M(e.startTime)) - 0.5 * s
                    : M(e.startTime) + o;
                })
                .attr(`y`, function (e, t) {
                ...
                .attr(`height`, function (e) {
                  return e.vert ? T.length * (a.barHeight + a.barGap) + a.barHeight * 2 : s;
                })
                .attr(`transform-origin`, function (e, t) {
                  return (
                    (t = e.order),
                    (M(e.startTime) + o + 0.5 * (M(e.endTime) - M(e.startTime))).toString() +
                      `px ` +
                ...
                .attr(`class`, function (e) {
                  ...
                  let n = 0;
                  for (let [t, r] of E.entries()) e.type === r && (n = t % a.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              d
                ...
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? a.gridLineStartPadding + T.length * (a.barHeight + a.barGap) + 60
                    : ((t = e.order), t * n + a.barHeight / 2 + (a.fontSize / 2 - 2) + r);
                })
                .attr(`text-height`, s)
                .attr(`class`, function (e) {
                  let t = M(e.startTime),
                  ...
                  let o = 0;
                  for (let [t, n] of E.entries()) e.type === n && (o = t % a.numberSectionStyles);
                  let c = ``;
                  return (
                    e.active && (c = e.crit ? `activeCritText` + o : `activeText` + o),
                    e.done
                      ? (c = e.crit ? c + ` doneCritText` + o : c + ` doneText` + o)
                    ...
                    r > n - t
                      ? n + r + 1.5 * a.leftPadding > l
                        ...
                        : i + ` taskTextOutsideRight taskTextOutside` + o + ` ` + c + ` width-` + r
          ...
          function se(e, t, n, o) {
            let s = i.db.getDateFormat(),
              c = i.db.getAxisFormat(),
              l;
            l = c || (s === `D` ? `%d` : (a.axisFormat ?? `%Y-%m-%d`));
            let f = w(M)
                .tickSize(-o + t + a.gridLineStartPadding)
                .tickFormat(_(l)),
              h = /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(
                i.db.getTickInterval() || a.tickInterval,
              );
            if (h !== null) {
              let e = parseInt(h[1], 10);
              if (isNaN(e) || e <= 0)
                D.warn(`Invalid tick interval value: "${h[1]}". Skipping custom tick interval.`);
              else {
                let t = h[2],
            ...
            if (
              (j
                .append(`g`)
                .attr(`class`, `grid`)
                .attr(`transform`, `translate(` + e + `, ` + (o - 50) + `)`)
                .call(f)
                .selectAll(`text`)
            ...
            j.append(`g`)
              ...
              .append(function (e) {
                ...
                for (let [e, n] of t.entries()) {
                  let t = y.createElementNS(`http://www.w3.org/2000/svg`, `tspan`);
              ...
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e[0] === n) return `sectionTitle sectionTitle` + (t % a.numberSectionStyles);
                return `sectionTitle`;
              });
          }
          O(ce, `vertLabels`);
