...
import { t as r } from "./progress-step-row.js";
var i = t(),
  a = e();
function o(e) {
  let t = (0, i.c)(10),
    { compact: n, direction: o, localBranch: c, sourceBranch: l, step: u, worktreeBranch: d } = e,
    f = n === void 0 ? !1 : n,
    p = u.status,
    m;
  t[0] !== o || t[1] !== c || t[2] !== l || t[3] !== u.id || t[4] !== d
    ? ((m = s(u.id, o, c, l, d)),
      (t[0] = o),
      (t[1] = c),
      (t[2] = l),
  ...
  let h;
  return (
    t[6] !== f || t[7] !== u.status || t[8] !== m
      ? ((h = (0, a.jsx)(r, { compact: f, status: p, children: m })),
        (t[6] = f),
        (t[7] = u.status),
        (t[8] = m),
        (t[9] = h))
