...
function f(e) {
  let t = (0, u.c)(22),
    { compact: n, direction: i, localBranch: a, sourceBranch: o, step: s, worktreeBranch: c } = e,
    l = n === void 0 ? !1 : n,
    f = l ? `gap-2` : `gap-3`,
    h;
  t[0] === f ? (h = t[1]) : ((h = r(`flex items-center`, f)), (t[0] = f), (t[1] = h));
  let g;
  t[2] !== l || t[3] !== s.status
  ...
  t[5] !== l || t[6] !== s.status || t[7] !== _
    ...
    : (v = t[8]);
  let y;
  t[9] !== i || t[10] !== a || t[11] !== o || t[12] !== s.id || t[13] !== c
    ? ((y = m(s.id, i, a, o, c)),
      (t[9] = i),
      (t[10] = a),
      (t[11] = o),
