import{s as e}from"./chunk-Bj-mKKzh.js";import{$ as t,Br as n,Dr as r,Er as i,Fr as a,Ir as o,Pr as s,Rr as c,et as l,ft as u,wr as d}from"./src-BOCweS1p.js";import{$ as ee,fs as f,po as p}from"./app-server-manager-signals-Yn0WSnoY.js";import{A as te,I as ne,g as m,lt as h,n as re,r as g,u as ie,v as ae}from"./vscode-api-DjORcpSo.js";import{o as oe}from"./statsig-BP9zNYqZ.js";import{t as se}from"./invalidate-queries-and-broadcast-CivBKbpC.js";import{d as ce}from"./thread-context-inputs-C9hcxtXy.js";import{n as le}from"./use-auth-CI-WraL2.js";import{t as ue}from"./use-codex-home-_jJnkmXS.js";import{i as de,n as fe,r as pe,t as me}from"./use-is-plugins-enabled-CJvW81OO.js";function he(){return window.electronBridge?.getBuildFlavor?.()||`prod`}var _=`<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`].map(e=>`data:image/svg+xml,${encodeURIComponent(e)}`);function k(e){let t=0;for(let n=0;n<e.length;n+=1)t=(t*31+e.charCodeAt(n))%O.length;return O[t]??``}var A=e(n(),1),j={".svg":`image/svg+xml`,".png":`image/png`,".jpg":`image/jpeg`,".jpeg":`image/jpeg`,".webp":`image/webp`,".gif":`image/gif`,".avif":`image/avif`};async function M(e,t,n){let r=N(e);if(r==null)return null;try{let e={path:r,hostId:t},i=await n.fetchQuery({queryFn:({signal:t})=>re(`read-file-binary`,{params:e,signal:t}),queryKey:g(`read-file-binary`,e),retry:!1,gcTime:1/0,staleTime:ie.INFINITE});return i.contentsBase64?`data:${P(r)};base64,${i.contentsBase64}`:null}catch(e){return m.warning(`Failed to inline local image`,{safe:{},sensitive:{error:e,resolvedImagePath:r}}),null}}function N(e){if(e==null)return null;let t=e.trim();if(t.length===0)return null;let n=t.toLowerCase();if(n.startsWith(`data:`)||n.startsWith(`http:`)||n.startsWith(`https:`)||n.startsWith(`file:`)||n.startsWith(`vscode-resource:`)||n.startsWith(`vscode-webview:`)||n.startsWith(`vscode-file:`))return null;let r=c(t);return s(r)?r:null}function P(e){return j[A.default.extname(e).toLowerCase()]??`application/octet-stream`}var _e=h(),F=[`plugins`],I=`openai-curated-marketplaces-hidden`,L=4,R=[],ve=[],z=[],ye=[],be=[],B=[],xe=[t],Se=[t,l],V=`computer-use`,H=`.tmp/marketplaces/openai-internal-testing`,U=[`datadog`,`statsig`],W=new Set([`codex-official`,d,t,l,`openai-primary-runtime`].map(Ue));function G(e){return{...Ze(e.summary),description:e.summary.interface?.shortDescription??e.description??null,displayName:e.summary.interface?.displayName??null,marketplaceDisplayName:null,marketplaceName:e.marketplaceName,plugin:e.summary,keywords:e.summary.keywords,...Q({marketplaceName:e.marketplaceName,marketplacePath:e.marketplacePath})}}function K({marketplacePath:e,remoteMarketplaceName:t}){if(e!=null&&t!=null)throw Error(`plugin marketplace request requires one marketplace source`);if(e!=null)return{marketplacePath:e};if(t!=null)return{remoteMarketplaceName:t};throw Error(`plugin marketplace request requires a marketplace source`)}function q(e){return e.marketplacePath??`remote:${e.remoteMarketplaceName}`}function Ce(e){return e.filter(e=>{let t=$(e).toLowerCase();return!U.some(e=>t===e||t.startsWith(`${e}-`))})}function J(e){return e.marketplacePath==null?X(e.plugin):e.plugin.name}function Y(e){return e.marketplacePath==null?X(e.plugin):e.plugin.id}function X(e){if(e.remotePluginId==null)throw Error(`remote plugin ${e.id} is missing remotePluginId`);return e.remotePluginId}function Z(e){return{...K(e),pluginName:J(e)}}function Q({marketplaceName:e,marketplacePath:t}){return t==null?{marketplacePath:null,remoteMarketplaceName:e}:{marketplacePath:t,remoteMarketplaceName:null}}function we(e,t,n){let r=(0,_e.c)(54),i;r[0]===e?i=r[1]:(i={hostId:e},r[0]=e,r[1]=i);let a=me(i)&&(n?.enabled??!0),o=n?.additionalMarketplaceKinds??z,s=n?.installSuggestionPluginNames??null,c=oe(`4218407052`),l=ge(le(e)?.authMethod??null),u=ye;l?u=Se:c&&(u=xe);let d=Ae({additionalMarketplaceKinds:o,includeRemoteCatalog:n?.includeRemoteCatalog??!0,includeVerticalCatalog:!c}),p=se(),m=te(),h=ne(ce),re=ue(e),g=ne(ee),_;r[2]!==e||r[3]!==g?(_=g.includes(e),r[2]=e,r[3]=g,r[4]=_):_=r[4];let v=_,y=a&&v,b;r[5]!==e||r[6]!==y?(b={enabled:y,hostId:e},r[5]=e,r[6]=y,r[7]=b):b=r[7];let x=de(b),S;r[8]===e?S=r[9]:(S={hostId:e},r[8]=e,r[9]=S);let C=fe(S),w;r[10]===e?w=r[11]:(w={hostId:e},r[10]=e,r[11]=w);let T=pe(w),E=t===void 0,D=qe({codexHome:re,hostId:e,rootsOverrideCwd:t,workspaceRoots:h.data?.roots}),O=a&&v&&(t!==void 0||h.isFetched),k;r[12]===Symbol.for(`react.memo_cache_sentinel`)?(k=he(),r[12]=k):k=r[12];let A=k,j=s==null?je(e,D,d,c,l):Oe(e,D,z,s,c,l),M;r[13]!==A||r[14]!==u||r[15]!==e||r[16]!==s||r[17]!==d||r[18]!==m||r[19]!==D?(M=async()=>{if(s!=null){let t=await f(`send-cli-request-for-host`,{hostId:e,method:`plugin/installed`,params:{...D.length>0?{cwds:D}:{},installSuggestionPluginNames:s}}),n=Ne(t.marketplaces,u),r=Xe(n);return{featuredPluginIds:R,marketplaceLoadErrors:t.marketplaceLoadErrors,marketplaces:Ge(n),plugins:await Ke({hostId:e,plugins:r,queryClient:m})}}let t=await f(`list-plugins`,d==null?{hostId:e,...D.length>0?{cwds:D}:{}}:{hostId:e,...D.length>0?{cwds:D}:{},marketplaceKinds:d}),n=Ne(t.marketplaces,u),r=Xe(n),i=A==null?r:He({buildFlavor:A,plugins:r}),a=Ce(t.featuredPluginIds).filter(e=>!u.some(t=>e.endsWith(`@${t}`)));return{featuredPluginIds:A==null?a:Ve({buildFlavor:A,featuredPluginIds:a}),marketplaceLoadErrors:t.marketplaceLoadErrors,marketplaces:Ge(n),plugins:await Ke({hostId:e,plugins:i,queryClient:m})}},r[13]=A,r[14]=u,r[15]=e,r[16]=s,r[17]=d,r[18]=m,r[19]=D,r[20]=M):M=r[20];let N;r[21]!==O||r[22]!==j||r[23]!==M?(N={queryKey:j,queryFn:M,enabled:O,staleTime:ie.FIVE_MINUTES,gcTime:1/0},r[21]=O,r[22]=j,r[23]=M,r[24]=N):N=r[24];let P=ae(N),I;r[25]!==p||r[26]!==P?(I=async function(){await p(F),await P.refetch()},r[25]=p,r[26]=P,r[27]=I):I=r[27];let L=I;if(!a||!v){let e;return r[28]===Symbol.for(`react.memo_cache_sentinel`)?(e={availablePlugins:B,featuredPluginIds:R,installedPlugins:B,marketplaceLoadErrors:ve,marketplaces:be,errorMessage:null,isLoading:!1,isFetching:!1,refetch:Ee,forceReload:Te},r[28]=e):e=r[28],e}let V,H,U,W;r[29]!==x.available||r[30]!==T.available||r[31]!==C.available||r[32]!==P.data?.featuredPluginIds||r[33]!==P.data?.plugins?(V={isComputerUseAvailable:x.available,isExternalBrowserUseAvailable:T.available,isInAppBrowserUseAvailable:C.available},H=P.data?.plugins??B,U=Fe({plugins:H,...V}),W=Pe({featuredPluginIds:P.data?.featuredPluginIds??R,...V}),r[29]=x.available,r[30]=T.available,r[31]=C.available,r[32]=P.data?.featuredPluginIds,r[33]=P.data?.plugins,r[34]=V,r[35]=H,r[36]=U,r[37]=W):(V=r[34],H=r[35],U=r[36],W=r[37]);let G;r[38]===H?G=r[39]:(G=Ie(H),r[38]=H,r[39]=G);let K=P.data?.marketplaceLoadErrors??ve,q=P.data?.marketplaces??be,J=P.error?String(P.error.message):null,Y=E&&h.isLoading||P.isLoading||C.isLoading||T.isLoading||x.isLoading,X=E&&h.isFetching||P.isFetching||x.isFetching,Z;r[40]!==V||r[41]!==P?(Z=async()=>{let e=(await P.refetch()).data?.plugins??B;return{availablePlugins:Fe({plugins:e,...V}),installedPlugins:Ie(e)}},r[40]=V,r[41]=P,r[42]=Z):Z=r[42];let Q;return r[43]!==L||r[44]!==U||r[45]!==W||r[46]!==G||r[47]!==K||r[48]!==q||r[49]!==J||r[50]!==Y||r[51]!==X||r[52]!==Z?(Q={availablePlugins:U,featuredPluginIds:W,installedPlugins:G,marketplaceLoadErrors:K,marketplaces:q,errorMessage:J,isLoading:Y,isFetching:X,refetch:Z,forceReload:L},r[43]=L,r[44]=U,r[45]=W,r[46]=G,r[47]=K,r[48]=q,r[49]=J,r[50]=Y,r[51]=X,r[52]=Z,r[53]=Q):Q=r[53],Q}async function Te(){}async function Ee(){return{availablePlugins:B,installedPlugins:B}}function De(e){let t=(0,_e.c)(10),{enabled:n,hostId:r,marketplaceKind:i}=e,a=n===void 0?!0:n,o;t[0]===r?o=t[1]:(o={hostId:r},t[0]=r,t[1]=o);let s=me(o),c,l;t[2]!==r||t[3]!==i?(c=[...F,`marketplace-kind`,r,i],l=async()=>Xe((await f(`list-plugins`,{hostId:r,marketplaceKinds:[i]})).marketplaces),t[2]=r,t[3]=i,t[4]=c,t[5]=l):(c=t[4],l=t[5]);let u=a&&s,d;return t[6]!==c||t[7]!==l||t[8]!==u?(d={queryKey:c,queryFn:l,enabled:u,staleTime:ie.FIVE_MINUTES},t[6]=c,t[7]=l,t[8]=u,t[9]=d):d=t[9],ae(d)}function Oe(e,t,n=z,r=null,i=!1,a=!1){return r==null?je(e,t,Ae({additionalMarketplaceKinds:n,includeRemoteCatalog:!0,includeVerticalCatalog:!i}),i,a):ke([...F,e,t,`installed`,r,`curated-marketplace`,Me(i)],a)}function ke(e,t){return t?[...e,I]:e}function Ae({additionalMarketplaceKinds:e,includeRemoteCatalog:t,includeVerticalCatalog:n}){return t&&!n&&e.length===0?null:n?[`local`,`vertical`,...e]:[`local`,...e]}function je(e,t,n,r,i){let a=Me(r);return ke(n==null?[...F,e,t,`curated-marketplace`,a]:[...F,e,t,`marketplace-kinds`,n,`curated-marketplace`,a],i)}function Me(e){return e?l:t}function Ne(e,t){return t.length===0?e:e.filter(e=>!t.includes(e.name))}function Pe({featuredPluginIds:e,...t}){return e.filter(e=>Le(e,t))}function Fe({plugins:e,...t}){return e.filter(e=>Le(e.plugin.id,t))}function Ie(e){return e.filter(e=>e.plugin.installed)}function Le(e,{isComputerUseAvailable:t,isExternalBrowserUseAvailable:n,isInAppBrowserUseAvailable:r}){return!(!r&&Re(e)||!n&&ze(e)||!t&&Be(e))}function Re(e){let t=$(e);return t===`browser`||t===`browser-use`}function ze(e){let t=$(e);return t===`chrome`||t===`chrome-dev`||t===`chrome-internal`}function Be(e){return $(e)===V}function $(e){return e.split(`@`)[0]}function Ve({buildFlavor:e,featuredPluginIds:t}){let n=i(e);return t.filter(e=>{let t=u(e);return t==null?!0:!r(t)||t===n})}function He({buildFlavor:e,plugins:t}){let n=i(e);return t.filter(e=>!r(e.marketplaceName)||e.marketplaceName===n)}function Ue(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function We(e){return W.has(Ue(e))}function Ge(e){let t=new Map;for(let n of e){let e=`${n.name}\u0000${n.path??``}`;if(t.has(e))continue;let r=We(n.name);t.set(e,{displayName:n.interface?.displayName??null,isBuiltIn:r,name:n.name,path:n.path,pluginCount:n.plugins.length})}return Array.from(t.values()).sort((e,t)=>{let n=e.displayName?.trim()||e.name,r=t.displayName?.trim()||t.name;return n.localeCompare(r)})}async function Ke({hostId:e,plugins:t,queryClient:n}){let r=[...t];async function i(a){let o=t[a];if(o==null)return;let[s,c]=await Promise.all([M(o.composerIconPath,e,n),M(o.logoPath,e,n)]);(s!=null||c!=null)&&(r[a]={...o,composerIconPath:s??o.composerIconPath,logoPath:c??o.logoPath,plugin:o.plugin.interface?{...o.plugin,interface:{...o.plugin.interface,...s==null?{}:{composerIcon:s},...c==null?{}:{logo:c}}}:o.plugin}),await i(a+L)}return await Promise.all(Array.from({length:Math.min(L,t.length)},(e,t)=>i(t))),r}function qe({codexHome:e,hostId:t,rootsOverrideCwd:n,workspaceRoots:r}){let i=t===`local`&&e!=null?p(e,H):null;return Je([...typeof n==`string`?[n]:n??r??[],...i==null?[]:[i]],e)}function Je(e,t){return Array.from(new Set(e.map(e=>e.trim()).filter(e=>s(e)&&Ye(e,t))))}function Ye(e,t){return t==null?!0:a(t)||o(t)?a(e)||o(e):e.startsWith(`/`)&&!e.startsWith(`//`)}function Xe(e){let t=new Map;for(let n of e)for(let e of n.plugins)t.has(e.id)||t.set(e.id,{...Ze(e),description:e.interface?.shortDescription??null,displayName:e.interface?.displayName??null,marketplaceDisplayName:n.interface?.displayName??null,marketplaceName:n.name,plugin:e,keywords:e.keywords,...Q({marketplaceName:n.name,marketplacePath:n.path})});return Array.from(t.values())}function Ze(e){let t=w(e);if(t!=null)return{composerIconPath:t,logoPath:t};let n=e.interface?.composerIcon??e.interface?.composerIconUrl??null,r=e.interface?.logo??e.interface?.logoUrl??null;if(n!=null||r!=null)return{composerIconPath:n,logoPath:r};let i=k(e.id);return{composerIconPath:i,logoPath:i}}export{M as _,K as a,Y as c,Be as d,ze as f,N as g,De as h,q as i,X as l,we as m,G as n,Z as o,Re as p,Ze as r,J as s,F as t,We as u,ge as v,he as y};
//# sourceMappingURL=use-plugins-C_eNkElf.js.map