...
function h(e) {
  ...
  if (r != null) {
    ...
    return (
      t[2] !== n || t[3] !== e
        ? ((i = (0, c.jsx)(_, { dateString: n, now: e })), (t[2] = n), (t[3] = e), (t[4] = i))
        : (i = t[4]),
      i
    );
  }
  let i;
  return (
    t[5] === n ? (i = t[6]) : ((i = (0, c.jsx)(g, { dateString: n })), (t[5] = n), (t[6] = i)), i
  );
}
function g(e) {
  let t = (0, o.c)(3),
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, c.jsx)(_, { dateString: n, now: r })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
function _(e) {
  ...
  if (t[0] !== n || t[1] !== i) {
    let e = new Date(n);
    ((s = m(i, e)), (c = p(i, e)), (t[0] = n), (t[1] = i), (t[2] = s), (t[3] = c));
  } else ((s = t[2]), (c = t[3]));
  let f = c,
    h = Math.max(1, f);
  if (h < 60) {
