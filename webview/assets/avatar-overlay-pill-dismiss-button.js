...
function xe({
  ...
  return {
    ...
    source: o,
    showInNotificationTray: !c || s === `waiting` || s === `failed` || f != null,
    sortAtMs: l(e)?.turnStartedAtMs ?? e.updatedAt,
    status: s,
    subtitle: f,
    title: d(e) ?? r.formatMessage(W.newThread),
    turnKey: String(ee(e)),
    updatedAtMs: e.updatedAt,
    waitingRequest: he(p, r, {
      includeMcpElicitationCancelAction: n,
...
function Ee(e) {
  let t = e.resumeState === `needs_resume` ? e.threadRuntimeStatus : null,
    ...
    i = ie(e).some((e) => e.items.some((e) => e.type === `planImplementation` && !e.isCompleted)),
...
var K,
  ...
  Ne = e(() => {
    ((K = m()),
      ...
      (Y = 80),
      (X = 224),
      (Z = c(`avatar-overlay-mascot-width-px`, null)));
  });
function Pe(e) {
  let t = (0, Q.c)(4),
    { ariaLabel: r, onClick: i } = e,
    a;
