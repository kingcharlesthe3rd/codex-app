...
function xe({
  ...
  return {
    ...
    source: o,
    showInNotificationTray: !c || s === `waiting` || s === `failed` || u != null,
    sortAtMs: p(e)?.turnStartedAtMs ?? e.updatedAt,
    status: s,
    subtitle: u,
    title: re(e) ?? r.formatMessage(W.newThread),
    turnKey: String(d(e)),
...
function Ee(e) {
  let t = e.resumeState === `needs_resume` ? e.threadRuntimeStatus : null,
    ...
    i = te(e).some((e) => e.items.some((e) => e.type === `planImplementation` && !e.isCompleted)),
    a = e.resumeState === `needs_resume` ? t?.type === `systemError` : p(e)?.status === `failed`;
  return ie(e) || r || i
    ? `waiting`
    : a
      ? `failed`
...
function je() {
  let e = (0, K.c)(7),
    [t, n] = r(Z),
    i;
  e[0] === t ? (i = e[1]) : ((i = t == null ? null : G(t)), (e[0] = t), (e[1] = i));
  let a;
  e[2] === n
    ? (a = e[3])
    : ((a = (e) => {
...
var K,
  ...
  Ne = e(() => {
    ((K = t()),
      ...
      (Y = 80),
      (X = 224),
      (Z = i(`avatar-overlay-mascot-width-px`, null)));
  });
function Pe(e) {
  let t = (0, Q.c)(4),
