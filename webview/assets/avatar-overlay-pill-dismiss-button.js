...
import { n as fe, t as pe } from "./permission-request-model.js";
  ...
  let o = new AbortController(),
    ...
    u = new ResizeObserver((n) => {
      n.forEach((n) => {
        ...
        if (((l = !1), d))
          if (!t) r({ width: i, height: u, previousWidth: s, previousHeight: c }, n);
          else {
            (o.abort(), (o = new AbortController()));
            let e = o.signal;
            requestAnimationFrame(() => {
              e.aborted || r({ width: i, height: u, previousWidth: s, previousHeight: c }, n);
            });
          }
      });
    });
...
function Ee(e) {
  let t = e.resumeState === `needs_resume` ? e.threadRuntimeStatus : null,
    ...
    i = d(e).some((e) => e.items.some((e) => e.type === `planImplementation` && !e.isCompleted)),
    a = e.resumeState === `needs_resume` ? t?.type === `systemError` : h(e)?.status === `failed`;
  return oe(e) || r || i
    ? `waiting`
    : a
      ? `failed`
