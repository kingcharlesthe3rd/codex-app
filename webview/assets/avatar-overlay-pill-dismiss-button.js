...
import { Cw as o, Sw as s } from "./app-initial~app-main~onboarding-page.js";
import {
  Cy as c,
  Ey as l,
  Ty as u,
...
import { n as pe, t as h } from "./permission-request-model.js";
function g({ axis: e, debounce: t, initialSize: n = !0, onChange: r, target: i }) {
  ...
  let a = new AbortController(),
    ...
    u = new ResizeObserver((n) => {
      n.forEach((n) => {
        ...
        if (((l = !1), d))
          if (!t) r({ width: i, height: u, previousWidth: o, previousHeight: c }, n);
          else {
            (a.abort(), (a = new AbortController()));
            let e = a.signal;
            requestAnimationFrame(() => {
              e.aborted || r({ width: i, height: u, previousWidth: o, previousHeight: c }, n);
            });
          }
      });
    });
...
function xe({
  ...
  return {
    ...
    source: o,
    showInNotificationTray: !c || s === `waiting` || s === `failed` || l != null,
    sortAtMs: m(e)?.turnStartedAtMs ?? e.updatedAt,
    status: s,
    subtitle: l,
    title: ae(e) ?? r.formatMessage(W.newThread),
    turnKey: String(ee(e)),
    updatedAtMs: e.updatedAt,
    waitingRequest: _e(u, r, {
      includeMcpElicitationCancelAction: n,
...
function we(e) {
  ...
  for (let e = t.length - 1; e >= 0; --e) {
    ...
    let r = l(n.text);
    if (r != null)
      return r.decision === `DONT_NOTIFY` ? null : U(r.notificationMessage ?? r.visibleText);
...
function Te(e, t) {
  ...
  if (e.type === `commandExecution`) {
    ...
    if (n == null) return r ? t.formatMessage(W.runningCommand) : t.formatMessage(W.ranCommand);
    switch (n.type) {
      case `read`:
        return r
      ...
      case `listFiles`:
        return r ? t.formatMessage(W.listingFiles) : t.formatMessage(W.listedFiles);
      case `search`: {
        let e = U(n.query ?? ``);
        return e == null
          ? r
      ...
      case `unknown`:
        return r ? t.formatMessage(W.runningCommand) : t.formatMessage(W.ranCommand);
    }
  }
...
function Ee(e) {
  let t = e.resumeState === `needs_resume` ? e.threadRuntimeStatus : null,
    ...
    i = ce(e).some((e) => e.items.some((e) => e.type === `planImplementation` && !e.isCompleted)),
    a = e.resumeState === `needs_resume` ? t?.type === `systemError` : m(e)?.status === `failed`;
  return ne(e) || r || i
    ? `waiting`
    : a
      ? `failed`
...
function je() {
  let e = (0, K.c)(7),
    [t, n] = i(Z),
    r;
  e[0] === t ? (r = e[1]) : ((r = t == null ? null : G(t)), (e[0] = t), (e[1] = r));
  let a;
  e[2] === n
    ? (a = e[3])
    : ((a = (e) => {
  ...
  return (
    e[4] !== r || e[5] !== a
      ? ((o = { mascotWidthPx: r, setMascotWidthPx: a }), (e[4] = r), (e[5] = a), (e[6] = o))
      : (o = e[6]),
    o
  );
}
...
var K,
  ...
  Ne = e(() => {
    ((K = t()),
      ...
      (Y = 80),
      (X = 224),
      (Z = le(`avatar-overlay-mascot-width-px`, null)));
  });
function Pe(e) {
  let t = (0, Q.c)(4),
