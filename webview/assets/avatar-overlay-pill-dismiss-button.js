...
import { i as oe } from "./app-initial~app-main~remote-conversation-page~onboarding-page~projects-index-page~hotkey-wi~nek76pmq.js";
import {
  cu as se,
  su as ce,
...
function Se({
  ...
  return {
    ...
    source: c,
    showInNotificationTray: !u || l === `waiting` || l === `failed` || d != null,
...
function Ee(e) {
  let t = e.resumeState === `needs_resume` ? e.threadRuntimeStatus : null,
    ...
    i = ne(e).some((e) => e.items.some((e) => e.type === `planImplementation` && !e.isCompleted)),
