    ...
    n = (function (e) {
      ...
      for (; e !== ``; )
        if (e.match(/^([ \t\r\n,]+)/)) e = e.substr(RegExp.$1.length);
          ...
          ((t[t.length] = { type: p, text: RegExp.$1 }), (e = e.substr(RegExp.$1.length)));
        else {
...
function S(e, t, n, r, i, a, o, s, c, l) {
  ...
  if (Math.abs(_) > (120 * Math.PI) / 180) {
    ...
    ((m = c && m > p ? p + ((120 * Math.PI) / 180) * 1 : p + ((120 * Math.PI) / 180) * -1),
      (f = S((n = h + i * Math.cos(m)), (r = g + a * Math.sin(m)), t, s, i, a, o, 0, c, [
        m,
        e,
        h,
        g,
...
function T(e, t, n) {
  ...
  if (r > 2) {
    ...
    return (
      t && i.push(...R(e[r - 1][0], e[r - 1][1], e[0][0], e[0][1], n)), { type: `path`, ops: i }
    );
  }
  return r === 2 ? w(e[0][0], e[0][1], e[1][0], e[1][1], n) : { type: `path`, ops: [] };
}
...
function D(e, t) {
  if (e.length) {
    let n = typeof e[0][0] == `number` ? [e] : e,
      ...
      i = t.disableMultiStroke ? [] : B(n[0], 1.5 * (1 + 0.22 * t.roughness), P(t));
    for (let e = 1; e < n.length; e++) {
      let a = n[e];
      if (a.length) {
        let e = B(a, 1 * (1 + 0.2 * t.roughness), t),
          n = t.disableMultiStroke ? [] : B(a, 1.5 * (1 + 0.22 * t.roughness), P(t));
...
function O(e, t, n) {
  let r = Math.sqrt(2 * Math.PI * Math.sqrt(((e / 2) ** 2 + (t / 2) ** 2) / 2)),
    ...
    s = Math.abs(t / 2),
    c = 1 - n.curveFitting;
  return ((o += L(o * c, n)), (s += L(s * c, n)), { increment: a, rx: o, ry: s });
}
function k(e, t, n, r) {
  let [i, a] = H(r.increment, e, t, r.rx, r.ry, 1, r.increment * I(0.1, I(0.4, 1, n), n), n),
    o = V(i, null, n);
  ...
  for (let r of e)
    if (r.length) {
      ...
      if (i > 2) {
        ...
        for (let a = 1; a < i; a++)
          n.push({ op: `lineTo`, data: [r[a][0] + L(e, t), r[a][1] + L(e, t)] });
      }
    }
  ...
  return (
    a &&
      (o
        ...
        : h.push({ op: `move`, data: [e + (v ? 0 : L(u, i, l)), t + (v ? 0 : L(u, i, l))] })),
    o
      ? h.push({
          op: `bcurveTo`,
          data: [
...
function H(e, t, n, r, i, a, o, s) {
  ...
  if (s.roughness === 0) {
    ...
    l.push([L(a, s) + t + 0.9 * r * Math.cos(u - e), L(a, s) + n + 0.9 * i * Math.sin(u - e)]);
    ...
    (l.push([
      ...
      l.push([L(a, s) + t + 0.98 * r * Math.cos(u + o), L(a, s) + n + 0.98 * i * Math.sin(u + o)]),
      l.push([
...
function U(e, t, n, r, i, a, o, s, c) {
  let l = a + L(0.1, c),
    u = [];
  u.push([L(s, c) + t + 0.9 * r * Math.cos(l - e), L(s, c) + n + 0.9 * i * Math.sin(l - e)]);
  for (let a = l; a <= o; a += e)
...
function ee(e, t, n, r, i, a, o, s) {
  ...
  for (let p = 0; p < d; p++)
    (p === 0
      ...
      : c.push({ op: `move`, data: [o[0] + (f ? 0 : L(l[0], s)), o[1] + (f ? 0 : L(l[0], s))] }),
      (u = f ? [i, a] : [i + L(l[p], s), a + L(l[p], s)]),
      c.push({
        op: `bcurveTo`,
        data: [e + L(l[p], s), t + L(l[p], s), n + L(l[p], s), r + L(l[p], s), u[0], u[1]],
      }));
  return c;
}
function W(e) {
...
function J(e, t, n, r) {
  ...
  if (
    ...
    let n = e[t + 0];
    (i.length ? ((a = i[i.length - 1]), (o = n), Math.sqrt(K(a, o))) > 1 && i.push(n) : i.push(n),
      i.push(e[t + 3]));
  } else {
    let r = 0.5,
      a = e[t + 0],
  ...
  Q = class {
        ...
        if (c.fillStyle === `solid`) {
          ...
          l.push(
            (function (e, t, n, r, i, a, o) {
              ...
              return (
                m.push([s + l * Math.cos(f), c + u * Math.sin(f)]), m.push([s, c]), N([m], o)
              );
            })(e, t, n, r, i, a, c),
          );
          ...
          if (i.length) {
            ...
            for (let r of e)
              r.length < 3
                ? t.push(...r)
                : r.length === 3
                  ? t.push(...X(G([r[0], r[0], r[1], r[2]]), 10, (1 + n.roughness) / 2))
    ...
    polygon(e, t) {
      let n = this._o(t),
        ...
        i = T(e, !0, n);
      return (
        n.fill && (n.fillStyle === `solid` ? r.push(M([e], n)) : r.push(N([e], n))),
        n.stroke !== Z && r.push(i),
        this._d(`polygon`, r, n)
      );
    }
