...
function r(e, r, i, a = 1) {
  ...
  let u = (function (e, t, r) {
    ...
    for (let t of e) {
      let e = [...t];
      (n(e[0], e[e.length - 1]) || e.push([e[0][0], e[0][1]]), e.length > 2 && i.push(e));
    }
    let a = [];
    t = Math.max(t, 0.1);
    let o = [];
...
function i(e, t) {
  ...
  let a = 1;
  return (
    t.roughness >= 1 && (t.randomizer?.next() || Math.random()) > 0.7 && (a = i), r(e, i, n, a || 1)
  );
}
function a(e) {
  let t = e[0],
...
function s(e) {
    ...
    n = (function (e) {
      ...
      for (; e !== ``;)
        if (e.match(/^([ \t\r\n,]+)/)) e = e.substr(RegExp.$1.length);
          ...
          ((t[t.length] = { type: K, text: RegExp.$1 }), (e = e.substr(RegExp.$1.length)));
        else {
  ...
  for (; !o(a, J);) {
    ...
    {
      let e = { key: r, data: l };
      (t.push(e), (i += c), (a = n[i]), r === `M` && (r = `L`), r === `m` && (r = `l`));
    }
  }
  return t;
}
  ...
  for (let { key: l, data: u } of e) {
    switch (l) {
      case `M`:
        ...
        break;
      case `C`:
        (t.push({ key: `C`, data: [...u] }), (r = u[4]), (i = u[5]), (s = u[2]), (c = u[3]));
        break;
      case `L`:
      ...
      case `S`: {
        let e = 0,
          a = 0;
        (n === `C` || n === `S` ? ((e = r + (r - s)), (a = i + (i - c))) : ((e = r), (a = i)),
      ...
      case `T`: {
        ...
        let d = r + (2 * (o - r)) / 3,
          ...
          p = e + (2 * (o - e)) / 3,
          m = a + (2 * (l - a)) / 3;
        (t.push({ key: `C`, data: [d, f, p, m, e, a] }), (s = o), (c = l), (r = e), (i = a));
        break;
      }
      case `Q`: {
        let [e, n, a, o] = u,
          ...
          f = a + (2 * (e - a)) / 3,
          p = o + (2 * (n - o)) / 3;
        (t.push({ key: `C`, data: [l, d, f, p, a, o] }), (s = e), (c = n), (r = a), (i = o));
        break;
      }
      case `A`: {
        let e = Math.abs(u[0]),
...
function d(e, t, n, r, i, a, o, s, c, l) {
  ...
  if (Math.abs(y) > (120 * Math.PI) / 180) {
    let e = g,
      t = n,
      s = r;
    ((g = c && g > h ? h + ((120 * Math.PI) / 180) * 1 : h + ((120 * Math.PI) / 180) * -1),
      (m = d((n = _ + i * Math.cos(g)), (r = v + a * Math.sin(g)), t, s, i, a, o, 0, c, [
        g,
        e,
        _,
        v,
  ...
  let b = Math.cos(h),
    ...
    k = [n + T * C, r - E * S],
    A = [n, r];
  if (((O[0] = 2 * D[0] - O[0]), (O[1] = 2 * D[1] - O[1]), l)) return [O, k, A].concat(m);
  {
    m = [O, k, A].concat(m);
    let e = [];
...
function p(e, t, n) {
  ...
  if (r > 2) {
    let i = [];
    for (let t = 0; t < r - 1; t++) i.push(...E(e[t][0], e[t][1], e[t + 1][0], e[t + 1][1], n));
    return (
      t && i.push(...E(e[r - 1][0], e[r - 1][1], e[0][0], e[0][1], n)), { type: `path`, ops: i }
    );
  }
  return r === 2 ? f(e[0][0], e[0][1], e[1][0], e[1][1], n) : { type: `path`, ops: [] };
}
...
function h(e, t) {
  if (e.length) {
    let n = typeof e[0][0] == `number` ? [e] : e,
      ...
      i = t.disableMultiStroke ? [] : O(n[0], 1.5 * (1 + 0.22 * t.roughness), S(t));
    for (let e = 1; e < n.length; e++) {
      let a = n[e];
      if (a.length) {
        let e = O(a, 1 * (1 + 0.2 * t.roughness), t),
          n = t.disableMultiStroke ? [] : O(a, 1.5 * (1 + 0.22 * t.roughness), S(t));
...
function g(e, t, n) {
  let r = Math.sqrt(2 * Math.PI * Math.sqrt(((e / 2) ** 2 + (t / 2) ** 2) / 2)),
    ...
    s = Math.abs(t / 2),
    c = 1 - n.curveFitting;
  return ((o += T(o * c, n)), (s += T(s * c, n)), { increment: a, rx: o, ry: s });
}
function _(e, t, n, r) {
  let [i, a] = A(r.increment, e, t, r.rx, r.ry, 1, r.increment * w(0.1, w(0.4, 1, n), n), n),
    o = k(i, null, n);
  ...
  for (let r of e)
    if (r.length) {
      ...
      if (i > 2) {
        ...
        for (let a = 1; a < i; a++)
          n.push({ op: `lineTo`, data: [r[a][0] + T(e, t), r[a][1] + T(e, t)] });
      }
    }
  ...
  return (
    a &&
      (o
        ...
        : h.push({ op: `move`, data: [e + (v ? 0 : T(u, i, l)), t + (v ? 0 : T(u, i, l))] })),
    o
      ? h.push({
          op: `bcurveTo`,
          data: [
...
function O(e, t, n) {
  if (!e.length) return [];
  let r = [];
  (r.push([e[0][0] + T(t, n), e[0][1] + T(t, n)]), r.push([e[0][0] + T(t, n), e[0][1] + T(t, n)]));
  ...
  if (r > 3) {
    ...
    for (let t = 1; t + 2 < r; t++) {
      ...
      ((a[0] = [n[0], n[1]]),
        ...
        (a[3] = [e[t + 1][0], e[t + 1][1]]),
        i.push({ op: `bcurveTo`, data: [a[1][0], a[1][1], a[2][0], a[2][1], a[3][0], a[3][1]] }));
    }
    if (t && t.length === 2) {
...
function A(e, t, n, r, i, a, o, s) {
  ...
  if (s.roughness === 0) {
    ...
    l.push([T(a, s) + t + 0.9 * r * Math.cos(u - e), T(a, s) + n + 0.9 * i * Math.sin(u - e)]);
    ...
    (l.push([
      ...
      l.push([T(a, s) + t + 0.98 * r * Math.cos(u + o), T(a, s) + n + 0.98 * i * Math.sin(u + o)]),
      l.push([
...
function j(e, t, n, r, i, a, o, s, c) {
  let l = a + T(0.1, c),
    u = [];
  u.push([T(s, c) + t + 0.9 * r * Math.cos(l - e), T(s, c) + n + 0.9 * i * Math.sin(l - e)]);
  for (let a = l; a <= o; a += e)
...
function ee(e, t, n, r, i, a, o, s) {
  ...
  for (let p = 0; p < d; p++)
    (p === 0
      ...
      : c.push({ op: `move`, data: [o[0] + (f ? 0 : T(l[0], s)), o[1] + (f ? 0 : T(l[0], s))] }),
      (u = f ? [i, a] : [i + T(l[p], s), a + T(l[p], s)]),
      c.push({
        op: `bcurveTo`,
        data: [e + T(l[p], s), t + T(l[p], s), n + T(l[p], s), r + T(l[p], s), u[0], u[1]],
      }));
  return c;
}
function M(e) {
...
function F(e, t, n, r) {
  ...
  if (
    ...
    let n = e[t + 0];
    (i.length ? ((a = i[i.length - 1]), (o = n), Math.sqrt(N(a, o))) > 1 && i.push(n) : i.push(n),
      i.push(e[t + 3]));
  } else {
    let r = 0.5,
      a = e[t + 0],
  ...
  se = e(() => {
    ((R = class {
      ...
      renderLines(e, t) {
        let n = [];
        for (let r of e)
          n.push(...this.helper.doubleLineOps(r[0][0], r[0][1], r[1][0], r[1][1], t));
        return n;
      }
    }),
      (z = class extends R {
        fillPolygons(e, t) {
          ...
          let r = i(e, Object.assign({}, t, { hachureGap: n })),
            ...
            l = 0.5 * n * Math.sin(o);
          for (let [e, t] of r)
            a([e, t]) && s.push([[e[0] - c, e[1] + l], [...t]], [[e[0] + c, e[1] - l], [...t]]);
            ...
            e.forEach((e) => {
              ...
              for (let e = 0; e < o; e++) {
                let i = 2 * e * t,
                  ...
                  d = [c[0] + o * Math.cos(l + Math.PI / 4), c[1] + o * Math.sin(l + Math.PI / 4)];
                r.push(
      ...
      (Q = class {
            ...
            if (c.fillStyle === `solid`) {
              ...
              l.push(
                (function (e, t, n, r, i, a, o) {
                  ...
                  return (
                    m.push([s + l * Math.cos(f), c + u * Math.sin(f)]), m.push([s, c]), x([m], o)
                  );
                })(e, t, n, r, i, a, c),
              );
              ...
              if (i.length) {
                ...
                for (let r of e)
                  r.length < 3
                    ? t.push(...r)
                    : r.length === 3
                      ? t.push(...L(te([r[0], r[0], r[1], r[2]]), 10, (1 + n.roughness) / 2))
        ...
        polygon(e, t) {
          let n = this._o(t),
            ...
            i = p(e, !0, n);
          return (
            n.fill && (n.fillStyle === `solid` ? r.push(b([e], n)) : r.push(x([e], n))),
            n.stroke !== Z && r.push(i),
            this._d(`polygon`, r, n)
          );
        }
              ...
              for (let { key: e, data: t } of r)
                switch (e) {
                  ...
                  case `C`:
                    ...
                    (u.push([t[0], t[1]]), u.push([t[2], t[3]]), u.push([t[4], t[5]]));
                    break;
                  case `Z`:
                    (d(), a.push([o[0], o[1]]));
                }
        ...
        toPaths(e) {
          ...
          for (let e of t) {
            ...
            switch (e.type) {
              case `path`:
                t = { d: this.opsToPath(e), stroke: n.stroke, strokeWidth: n.strokeWidth, fill: Z };
                break;
              case `fillPath`:
                t = { d: this.opsToPath(e), stroke: Z, strokeWidth: 0, fill: n.fill || Z };
                break;
              case `fillSketch`:
            ...
            switch (a.type) {
              case `path`:
                (r.save(),
                  ...
                  n.strokeLineDashOffset && (r.lineDashOffset = n.strokeLineDashOffset),
      ...
      (ae = class {
            ...
            switch (o.type) {
              case `path`:
                ((t = r.createElementNS($, `path`)),
                  ...
                  n.strokeLineDash &&
                    t.setAttribute(`stroke-dasharray`, n.strokeLineDash.join(` `).trim()),
        ...
        fillSketch(e, t, n) {
          ...
          return (
            ...
            n.fillLineDash && i.setAttribute(`stroke-dasharray`, n.fillLineDash.join(` `).trim()),
            n.fillLineDashOffset && i.setAttribute(`stroke-dashoffset`, `${n.fillLineDashOffset}`),
            i
          );
        }
        get generator() {
...
//# sourceMappingURL=rough.esm-2.js.map
