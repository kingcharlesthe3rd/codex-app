...
import { Z as i } from "./app-scope-CWE-zIhQ.js";
import { t as a } from "./clsx.js";
import { t as o } from "./proxy.js";
import { t as s } from "./AnimatePresence.js";
import { d as c, i as l, s as u, t as d, u as f } from "./dist-12.js";
import {
  _ as p,
  a as m,
  c as h,
...
import { i as A } from "./Combination.js";
import { n as j } from "./window-zoom-context.js";
import { t as M } from "./chevron-right.js";
import { t as N } from "./tooltip-B.js";
import { n as P } from "./tooltip-dismiss.js";
...
var I = t(n()),
  ...
  G = (e) => {
    let {
      ...
      c = U(t),
      l = I.useRef(null),
      [u, f] = d({ prop: i, defaultProp: a ?? !1, onChange: o, caller: B });
    return (0, L.jsx)(ee, {
      scope: t,
      triggerId: A(),
      triggerRef: l,
      ...
      modal: s,
      children: (0, L.jsx)(_, { ...c, open: u, onOpenChange: f, dir: r, modal: s, children: n }),
    });
  };
G.displayName = B;
...
var ve = `DropdownMenuArrow`,
  ye = I.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = U(n);
    return (0, L.jsx)(C, { ...i, ...r, ref: t });
  });
ye.displayName = ve;
var be = (e) => {
    let { __scopeDropdownMenu: t, children: n, open: r, onOpenChange: i, defaultOpen: a } = e,
      o = U(t),
      [s, c] = d({ prop: r, defaultProp: a ?? !1, onChange: i, caller: `DropdownMenuSub` });
    return (0, L.jsx)(S, { ...o, open: s, onOpenChange: c, children: n });
  },
  xe = `DropdownMenuSubTrigger`,
  Se = I.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = U(n);
    return (0, L.jsx)(v, { ...i, ...r, ref: t });
  });
Se.displayName = xe;
...
function Xe(e) {
  ...
  t[0] === e
    ...
    : (({ ref: i, disabled: r, className: n, ...o } = e),
      (t[0] = e),
      (t[1] = n),
      (t[2] = r),
      (t[3] = i),
  ...
  let s = r || void 0,
    ...
    l;
  t[5] !== n || t[6] !== c
    ? ((l = a(`outline-hidden`, c, n)), (t[5] = n), (t[6] = c), (t[7] = l))
    : (l = t[7]);
  let u;
  return (
    t[8] !== i || t[9] !== o || t[10] !== s || t[11] !== l
      ? ((u = (0, L.jsx)(Ee, { ref: i, "aria-disabled": s, className: l, ...o })),
        (t[8] = i),
        (t[9] = o),
        (t[10] = s),
        (t[11] = l),
...
var Qe = (e) => {
    ...
    if (!r) {
      ...
      return (
        t[0] === n
          ? (e = t[1])
          : ((e = (0, L.jsx)(L.Fragment, { children: n })), (t[0] = n), (t[1] = e)),
        e
      );
    }
    let d;
    t[2] === o ? (d = t[3]) : ((d = a(`max-w-64 text-pretty`, o)), (t[2] = o), (t[3] = d));
    let f;
    t[4] !== d || t[5] !== r
      ? ((f = (0, L.jsx)(`div`, { className: d, children: r })), (t[4] = d), (t[5] = r), (t[6] = f))
      : (f = t[6]);
    let p = !s,
      m = c ?? `right`,
      h;
...
function tt(e) {
  ...
  let E = _ === void 0 ? !1 : _,
    ...
    j;
  if (t[24] !== o) {
    let e = I.Children.toArray(o);
    ((A = I.isValidElement(e[0]) && e[0].type === nt ? e[0] : null),
      (j = A ? e.slice(1) : o),
      (t[24] = o),
      (t[25] = A),
      (t[26] = j));
  ...
  t[27] !== n || t[28] !== N || t[29] !== A || t[30] !== d
    ? ((P = A ?? (n ? (0, L.jsx)(n, { className: a(d ?? N, $.icon) }) : null)),
      (t[27] = n),
      (t[28] = N),
      (t[29] = A),
      (t[30] = d),
  ...
  let F = P,
    R = g ?? `icon-xs`,
    z;
  t[32] === R ? (z = t[33]) : ((z = a(R, $.icon)), (t[32] = R), (t[33] = z));
  let B = z,
    V;
  t[34] !== r || t[35] !== h || t[36] !== B
    ? ((V = h ?? (r ? (0, L.jsx)(r, { className: B }) : null)),
      (t[34] = r),
      (t[35] = h),
      (t[36] = B),
      (t[37] = V))
          ...
          ? (0, L.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, L.jsx)(`span`, {
                  ...
                  className: a(`flex-1 min-w-0`, E ? `whitespace-normal` : `truncate`),
                  children: M,
                }),
                ee,
              ],
              ...
              children: [
                ...
                (0, L.jsxs)(`div`, {
                  ...
                  children: [
                    (0, L.jsx)(`span`, {
                      "data-tooltip-overflow-target": S === `trigger-overflows` ? `` : void 0,
                      className: a(`min-w-0`, E ? `whitespace-normal` : `truncate`),
                      children: M,
                    }),
                    (0, L.jsx)(`span`, {
                      className: a(`min-w-0`, D ? `whitespace-normal` : `truncate`),
                      children: i,
                    }),
                  ],
                }),
  ...
  let G = W,
    ...
    K;
  t[49] !== s || t[50] !== te
    ? ((K = a(`no-drag`, $.itemBase, te, s)), (t[49] = s), (t[50] = te), (t[51] = K))
    : (K = t[51]);
  let ne = c ? void 0 : f,
    q = c ? void 0 : p,
    re = l && `!text-token-foreground focus:!outline-none`,
    J;
  t[52] === re ? (J = t[53]) : ((J = a(re, `flex flex-col`)), (t[52] = re), (t[53] = J));
  let Y;
  t[54] !== O || t[55] !== l || t[56] !== G || t[57] !== J
    ? ((Y = (0, L.jsx)(O, { href: l, className: J, children: G })),
      (t[54] = O),
      (t[55] = l),
      (t[56] = G),
      (t[57] = J),
...
function nt(e) {
  let t = (0, Q.c)(6),
    ...
    s;
  t[0] !== r || t[1] !== o
    ? ((s = a(`inline-flex items-center justify-center leading-none`, o, $.icon, r)),
      (t[0] = r),
      (t[1] = o),
      (t[2] = s))
    : (s = t[2]);
  ...
  return (
    t[3] !== n || t[4] !== s
      ? ((c = (0, L.jsx)(`span`, { className: s, children: n })),
        (t[3] = n),
        (t[4] = s),
        (t[5] = c))
      : (c = t[5]),
...
function rt(e) {
  ...
  return (
    t[8] !== i || t[9] !== o || t[10] !== s
      ? ((c = (0, L.jsx)(`input`, { className: o, autoFocus: !0, onKeyDown: s, ...i })),
        (t[8] = i),
        (t[9] = o),
        (t[10] = s),
        (t[11] = c))
...
function it(e) {
  let t = (0, Q.c)(23),
    ...
    s;
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (i = t[3]), (o = t[4]), (s = t[5]))
    : (({ className: n, inputClassName: r, onKeyDown: i, trailingContent: s, ...o } = e),
      (t[0] = e),
      (t[1] = n),
      (t[2] = r),
      (t[3] = i),
  ...
  t[6] === n
    ? (c = t[7])
    : ((c = a($.content, `px-[var(--padding-row-x)] py-[var(--padding-row-y)]`, n)),
      (t[6] = n),
      (t[7] = c));
  let l;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, L.jsx)(R, { className: `icon-2xs shrink-0 text-token-text-tertiary` })), (t[8] = l))
    : (l = t[8]);
  let u;
  t[9] === r
    ? (u = t[10])
  ...
  t[13] !== o || t[14] !== u || t[15] !== d
    ? ((f = (0, L.jsx)(rt, { className: u, onKeyDown: d, ...o })),
      (t[13] = o),
      (t[14] = u),
      (t[15] = d),
      (t[16] = f))
  ...
  t[17] === s
    ? (p = t[18])
    : ((p = s ? (0, L.jsx)(`div`, { className: `shrink-0`, children: s }) : null),
      (t[17] = s),
      (t[18] = p));
  let m;
  return (
    t[19] !== c || t[20] !== f || t[21] !== p
      ? ((m = (0, L.jsxs)(`div`, { className: c, children: [l, f, p] })),
        (t[19] = c),
        (t[20] = f),
        (t[21] = p),
        (t[22] = m))
...
function ot(e) {
  let t = (0, Q.c)(6),
    ...
    o;
  t[0] !== n || t[1] !== i
    ? ((o = a(`w-full px-[var(--padding-row-x)]`, i, n)), (t[0] = n), (t[1] = i), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, L.jsx)(`div`, { className: `h-[1px] w-full bg-token-menu-border` })), (t[3] = s))
    : (s = t[3]);
  let c;
  return (
    t[4] === o
      ? (c = t[5])
      : ((c = (0, L.jsx)(`div`, { className: o, children: s })), (t[4] = o), (t[5] = c)),
    c
  );
}
function st(e) {
  let t = (0, Q.c)(5),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = a($e.sectionLabel, r)), (t[0] = r), (t[1] = i));
  let o;
  return (
    t[2] !== n || t[3] !== i
      ? ((o = (0, L.jsx)(`div`, { className: i, children: n })), (t[2] = n), (t[3] = i), (t[4] = o))
      : (o = t[4]),
    o
  );
}
function ct(e) {
  let t = (0, Q.c)(8),
    { children: n, className: r, tone: i, compact: o, centered: s } = e,
    c = i === void 0 ? `muted` : i,
    l = o === void 0 ? !1 : o,
    u = s === void 0 ? !1 : s,
    d = l ? `py-2` : `py-3`,
  ...
  return (
    t[5] !== n || t[6] !== m
      ? ((h = (0, L.jsx)(`div`, { className: m, children: n })), (t[5] = n), (t[6] = m), (t[7] = h))
      : (h = t[7]),
    h
  );
}
function lt(e) {
  ...
  let F = N,
    ...
    V;
  t[3] !== r || t[4] !== n
    ? ((V = (0, L.jsx)(ht.Trigger, { asChild: !0, disabled: r, children: n })),
      (t[3] = r),
      (t[4] = n),
      (t[5] = V))
    : (V = t[5]);
  let H =
      ...
      (0, L.jsx)(De, {
        ...
        children: (0, L.jsx)(ht.Content, {
          ...
          style: { zoom: S == null && M !== 1 ? M : void 0 },
          children: i,
        }),
      }),
    U;
  return (
    t[6] !== c || t[7] !== F || t[8] !== R.Root || t[9] !== B || t[10] !== V || t[11] !== H
      ? ((U = (0, L.jsxs)(R.Root, {
          dir: c,
          modal: !1,
          open: B,
...
function ut(e) {
  let t = (0, Q.c)(28),
    ...
    c = i === void 0 ? !1 : i,
    l = n.props.disabled ?? !1,
    [u, d] = (0, I.useState)(l ? !1 : c),
    f = u && !l,
    p;
  if (t[0] !== l || t[1] !== f || t[2] !== n) {
    let e;
    t[4] !== l || t[5] !== n.props
      ? ((e = (e) => {
          (n.props.onSelect?.(e),
            !e.defaultPrevented && (e.preventDefault(), e.stopPropagation(), !l && d(dt)));
        }),
        (t[4] = l),
        (t[5] = n.props),
        (t[6] = e))
    ...
    let s = n.props.rightIconClassName ?? `icon-xs`,
      c;
    t[9] === s ? (c = t[10]) : ((c = a(s, $.icon)), (t[9] = s), (t[10] = c));
    let u;
    t[11] === c ? (u = t[12]) : ((u = (0, L.jsx)(M, { className: c })), (t[11] = c), (t[12] = u));
    let m;
    t[13] !== i || t[14] !== u
      ? ((m = (0, L.jsx)(o.span, {
          "aria-hidden": !0,
    ...
    let h;
    (t[16] !== e || t[17] !== m
      ? ((h = { onSelect: e, rightIcon: m }), (t[16] = e), (t[17] = m), (t[18] = h))
      : (h = t[18]),
      (p = I.cloneElement(n, h)),
      (t[0] = l),
      (t[1] = f),
      (t[2] = n),
      (t[3] = p));
  ...
  t[22] === g
    ? (_ = t[23])
    : ((_ = (0, L.jsx)(s, { initial: !1, children: g })), (t[22] = g), (t[23] = _));
  let v;
  return (
    t[24] !== m || t[25] !== h || t[26] !== _
      ? ((v = (0, L.jsxs)(`div`, {
...
function ft(e) {
  ...
  if (
    ...
    let e =
      S === `bare`
        ? a(Z.content, `z-50 m-0 flex min-w-[180px] select-none flex-col overflow-y-auto p-0`)
        : a(
            Z.content,
    ...
    let r = x ? `cursor-default opacity-50` : $.itemInteractive,
      c;
    t[23] !== s || t[24] !== r
      ? ((c = a($.itemBase, `flex w-full items-center`, r, s)),
        (t[23] = s),
        (t[24] = r),
        (t[25] = c))
      : (c = t[25]);
    ...
    t[26] !== x || t[27] !== f
      ...
      : (d = t[28]);
    let C;
    t[29] !== i || t[30] !== n || t[31] !== o || t[32] !== p
      ? ((C =
          p ??
          (0, L.jsxs)(`div`, {
            className: $.content,
            children: [
              i ? (0, L.jsx)(i, { className: a(o ?? `icon-xs`, $.icon) }) : null,
              (0, L.jsx)(`span`, { className: `min-w-0 flex-1 truncate`, children: n }),
              (0, L.jsx)(M, {
                className: a(`icon-xs text-token-input-placeholder-foreground`, $.icon),
              }),
            ],
          })),
        (t[29] = i),
    ...
    (t[34] !== x || t[35] !== c || t[36] !== d || t[37] !== C
      ? ((A = (0, L.jsx)(ze, { className: c, disabled: x, onClick: d, children: C })),
        (t[34] = x),
        (t[35] = c),
        (t[36] = d),
        (t[37] = C),
      ...
      (T = De),
      (w = Be),
      (D = a(e, l && Z.parentBottomAlignedContent, u)),
      (t[0] = i),
      (t[1] = l),
      (t[2] = s),
      (t[3] = u),
  ...
  let A = !l,
    ...
    F;
  t[47] !== N || t[48] !== P
    ? ((F = { ...N, zoom: P }), (t[47] = N), (t[48] = P), (t[49] = F))
    : (F = t[49]);
  let I;
  t[50] === r
    ? (I = t[51])
    : ((I = (0, L.jsx)(`div`, { dir: `ltr`, children: r })), (t[50] = r), (t[51] = I));
  let R;
  t[52] !== w || t[53] !== I || t[54] !== D || t[55] !== A || t[56] !== F
    ? ((R = (0, L.jsx)(w, {
        className: D,
        collisionPadding: 6,
        avoidCollisions: A,
  ...
  let z;
  t[58] !== T || t[59] !== R
    ? ((z = (0, L.jsx)(T, { children: R })), (t[58] = T), (t[59] = R), (t[60] = z))
    : (z = t[60]);
  let B;
  return (
    t[61] !== E || t[62] !== z || t[63] !== O || t[64] !== k
      ? ((B = (0, L.jsxs)(E, { onOpenChange: O, children: [k, z] })),
        (t[61] = E),
        (t[62] = z),
        (t[63] = O),
        (t[64] = k),
...
function mt(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, L.jsx)(`div`, { className: r, children: n })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
...
export { it as a, tt as i, ut as n, ot as o, ht as r, R as s, lt as t };
