...
function L(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = { "aria-describedby": void 0 }), (t[2] = y))
    : (y = t[2]);
  let b = c ?? `h-[214px]`,
    x;
  t[3] === b ? (x = t[4]) : ((x = C(`relative w-full`, b)), (t[3] = b), (t[4] = x));
  let S;
  t[5] === _
    ? (S = t[6])
    : ((S = _.formatMessage({
      ...
      (t[5] = _),
      (t[6] = S));
  let w = g === `dark` ? `text-black` : `text-white`,
    T;
  t[7] !== r || t[8] !== w
    ? ((T = C(
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, z.jsx)(ee, { className: `icon-xs` })), (t[10] = E))
    : (E = t[10]);
  let D;
  t[11] !== l || t[12] !== S || t[13] !== T
    ? ((D = (0, z.jsx)(`button`, {
        type: `button`,
        onClick: l,
        "aria-label": S,
  ...
  t[19] === h
    ? (k = t[20])
    : ((k = C(`heading-dialog font-semibold`, h)), (t[19] = h), (t[20] = k));
  let A;
  t[21] !== k || t[22] !== m
    ? ((A = (0, z.jsx)(ne, {
        asChild: !0,
        children: (0, z.jsx)(`h2`, { className: k, children: m }),
      })),
      (t[21] = k),
      (t[22] = m),
      (t[23] = A))
...
function H({ apps: e, plugins: t }) {
  let n = new Set();
  return e.flatMap((e) => {
    let r = t.find((t) => a(e, t.plugin)) ?? null;
    return r == null || n.has(r.plugin.id)
      ? []
      : (n.add(r.plugin.id), [{ app: e, plugin: K(e, r) }]);
  });
}
function U(e, t) {
  return W(t) - W(e);
...
function q(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (e) => {
        E({ event: e, href: r, initiator: `open_in_browser_bridge` });
      }),
      (t[0] = r),
      (t[1] = i));
  let a;
...
function ue() {
  let e = (0, Q.c)(4),
    { data: t, isLoading: n } = D();
  if (n) return null;
  let r;
  e[0] === t ? (r = e[1]) : ((r = _(t)), (e[0] = t), (e[1] = r));
  let i;
  return (
...
function Z(e) {
  ...
  t[0] === r
    ? ((i = t[1]), (a = t[2]))
    : ((i = () => h(r)), (a = () => h(r)), (t[0] = r), (t[1] = i), (t[2] = a));
  let o;
  return (
    t[3] !== n || t[4] !== i || t[5] !== a
      ? ((o = (0, $.jsx)(ie, { audience: n, onDismiss: i, onPrimaryAction: a })),
        (t[3] = n),
        (t[4] = i),
        (t[5] = a),
        (t[6] = o))
...
export { H as a, F as c, V as i, I as l, de as n, L as o, re as r, B as s, le as t };
