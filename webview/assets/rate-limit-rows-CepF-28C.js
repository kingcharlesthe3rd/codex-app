...
import { gr as s, ln as c, vr as l } from "./thread-context-inputs.js";
import { _ as u, f as d } from "./vscode-api.js";
import { Ra as f } from "./src-1.js";
import { l as p, s as m } from "./lib-1.js";
import { t as h } from "./clsx.js";
import { t as g } from "./button.js";
import { r as _ } from "./toast-signal.js";
import { c as v, i as y, n as b } from "./statsig.js";
import { t as x } from "./request.js";
import { et as S, nt as C, t as w, tt as T } from "./product-logger.js";
import { t as E } from "./use-auth.js";
import { r as D } from "./modal-controller-state.js";
import { a as O, d as k, i as A, l as j, n as M, r as N } from "./dialog-layout.js";
import { a as P, c as F, h as ee, o as te, s as I } from "./usage-queries.js";
import { t as L } from "./checkbox.js";
import { n as R, t as ne } from "./format-currency-B_F-I0-3.js";
import { h as z, p as B, w as re } from "./rate-limit-status.js";
var ie = [500, 1e3, 2e3],
  V = 1e3;
function ae(e) {
  if (!e.isEnabled) return String(ie[0]);
  let t = U(e.rechargeTarget ?? ``);
  return t.kind === `valid` ? String(t.value) : String(ie[0]);
}
function oe(e) {
  if (!e.isEnabled) return `125`;
  let t = U(e.rechargeThreshold ?? ``);
  return t.kind === `valid` ? String(t.value) : `125`;
}
function se(e) {
  return e.isEnabled ? (e.rechargeMonthlyLimit == null ? `` : H(e.rechargeMonthlyLimit)) : ``;
}
function ce(e) {
  let t = U(e);
  switch (t.kind) {
...
function he({ minimumBalance: e, targetBalance: t, monthlyLimit: n }) {
  if (
    ...
    return null;
  let r = Number.parseInt(H(e), 10),
    i = Number.parseInt(H(t), 10),
    a = H(n);
  return {
        ...
        : (0, J.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, J.jsx)(Ce, {
                ...
                value: r,
                pricingInfo: a,
                placeholder: W({ intl: n, creditQuantity: s, pricingInfo: a }) ?? ``,
                hasError: o != null,
...
function Ce(e) {
  ...
  if (t[0] !== p || t[1] !== n || t[2] !== i || t[3] !== f || t[4] !== r) {
    let e = f
      ? W({ intl: n, creditQuantity: Number.parseInt(H(r), 10), pricingInfo: i })
      : G({ intl: n, creditQuantity: Number.parseInt(H(r), 10), pricingInfo: i });
    ((y = p ?? e ?? r),
...
function Ee({ intl: e, value: t, pricingInfo: n }) {
  ...
  let { groupSeparator: i, decimalSeparator: a } = Oe({ intl: e, pricingInfo: n });
...
function Oe({ intl: e, pricingInfo: t }) {
  let n = e.formatters
    .getNumberFormat(e.locale, {
      style: `currency`,
...
function Y({ intl: e, value: t, pricingInfo: n }) {
  let { groupSeparator: r, decimalSeparator: i } = Oe({ intl: e, pricingInfo: n }),
...
var Ae = { duration: 3 },
  X = `https://help.openai.com/en/articles/20001106-codex-rate-card`,
  je = `min-w-[88px] justify-center`;
function Me(e) {
  let t = (0, K.c)(39),
    { source: n, creditDetails: r, pricingInfo: a, onOpenChange: s, dialogDescriptionId: c } = e,
    l = i(o),
    { email: u } = E(),
    d = v(),
    f = p(),
    [h, _] = (0, q.useState)(String(ie[0])),
    [y, b] = (0, q.useState)(`preset`),
    [x, S] = (0, q.useState)(!1),
    [C, w] = (0, q.useState)(!1),
    T;
  t[0] !== C || t[1] !== a || t[2] !== h
    ? ((T = C ? `invalid-currency-amount` : de({ value: h, pricingInfo: a })),
      (t[0] = C),
      (t[1] = a),
      (t[2] = h),
      (t[3] = T))
  ...
  t[8] === ee
    ...
    : ((I = (0, J.jsx)(N, {
      ...
      (t[9] = I));
  let L;
  t[10] !== r || t[11] !== f || t[12] !== a || t[13] !== I
    ? ((L = (0, J.jsx)(Ue, { intl: f, creditDetails: r, pricingInfo: a, actions: I })),
      (t[10] = r),
      (t[11] = f),
      (t[12] = a),
      (t[13] = I),
  ...
  t[21] !== d
    ? ((R = () => {
        (S(!0),
          D ??
            Ge({ scope: l, source: n, email: u, quantity: h, onOpenChange: s, statsigClient: d }));
      }),
      (t[15] = u),
      (t[16] = s),
      (t[17] = h),
  ...
  let ne = x ? D : null,
    z;
  t[23] === a ? (z = t[24]) : ((z = ue(a)), (t[23] = a), (t[24] = z));
  let B;
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (re = t[26]);
  let V;
  t[27] !== y || t[28] !== f || t[29] !== a || t[30] !== h || t[31] !== ne || t[32] !== z
    ? ((V = (0, J.jsx)(O, {
...
function Pe(e) {
  let t = (0, K.c)(153),
    ...
    T = p(),
    D;
  t[0] === a ? (D = t[1]) : ((D = ae(a)), (t[0] = a), (t[1] = D));
  let k = D,
    [A, j] = (0, q.useState)(k),
    [M, N] = (0, q.useState)(qe(k) ? `preset` : `custom`),
    P;
  t[2] === a ? (P = t[3]) : ((P = oe(a)), (t[2] = a), (t[3] = P));
  let [F, te] = (0, q.useState)(P),
    I;
  t[4] === a ? (I = t[5]) : ((I = () => se(a)), (t[4] = a), (t[5] = I));
  let [R, ne] = (0, q.useState)(I),
    z;
  t[6] !== C || t[7] !== r
    ? ((z = () => r !== `add-credits` || !b(C, `2317709095`)), (t[6] = C), (t[7] = r), (t[8] = z))
    : (z = t[8]);
  let [B, re] = (0, q.useState)(z),
    [ie, V] = (0, q.useState)(!1),
    [fe, pe] = (0, q.useState)(!1),
    [H, U] = (0, q.useState)(!1),
    [_e, ve] = (0, q.useState)(!1),
    [W, ye] = (0, q.useState)(!1),
    [G, xe] = (0, q.useState)(!1),
    [Ce, we] = (0, q.useState)(!1),
    [Te, Ee] = (0, q.useState)(null),
    De = l.isPending || d.isPending,
    Oe = f.isPending,
    Y = De || Oe,
    X = r === `add-credits` && !B,
    je;
  t[9] !== _e || t[10] !== X || t[11] !== F || t[12] !== c || t[13] !== A
    ? ((je = _e
        ? `invalid-currency-amount`
        : X
          ? de({ value: A, pricingInfo: c })
          : le({ minimumBalance: F, targetBalance: A })),
      (t[9] = _e),
      (t[10] = X),
      (t[11] = F),
      (t[12] = c),
  ...
  let Me = je,
    Ne;
  t[15] !== W || t[16] !== F
    ? ((Ne = W ? `invalid-currency-amount` : ce(F)), (t[15] = W), (t[16] = F), (t[17] = Ne))
    : (Ne = t[17]);
  let Pe = Ne,
    Ve;
  t[18] !== G || t[19] !== R || t[20] !== A
    ? ((Ve = G ? `invalid-currency-amount` : me({ monthlyLimit: R, targetBalance: A })),
      (t[18] = G),
      (t[19] = R),
      (t[20] = A),
      (t[21] = Ve))
  ...
  let He = Ve,
    Z,
    We;
  t[22] !== W || t[23] !== G || t[24] !== F || t[25] !== R || t[26] !== a || t[27] !== A
    ? ((Z = W || G ? null : he({ minimumBalance: F, targetBalance: A, monthlyLimit: R })),
      (We = ge({ isEnabled: !0, serverState: a, savePayload: Z })),
      (t[22] = W),
      (t[23] = G),
      (t[24] = F),
      (t[25] = R),
  ...
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? (($e = [`usage-settings`, `credit-reload`, `manage-payment`]), (t[31] = $e))
    : ($e = t[31]);
  let et;
  t[32] !== T || t[33] !== y
    ? ((et = {
  ...
  t[50] !== d
    ? ((nt = async () => {
        if ((V(!0), X)) {
          Me ??
            Ge({ scope: y, source: n, email: x, quantity: A, onOpenChange: h, statsigClient: C });
          return;
        }
        if ((pe(!0), U(!0), !(Q == null || Y)))
          try {
            if ((Qe(), Z == null)) return;
            let e = Q === `enable` ? await l.mutateAsync(Z) : await d.mutateAsync(Z);
            if ((w(y, S, { action: Q, source: n }), ee(e.immediate_top_up_status))) {
              (we(!0),
                Ee(
                  be({
                    intl: T,
            ...
            (Ke({ scope: y, intl: T, intent: Q, kind: `success` }), h(!1));
          } catch {
            Ke({ scope: y, intl: T, intent: Q, kind: `danger` });
          }
      }),
      (t[35] = s),
      (t[36] = x),
  ...
  let rt = nt,
    it;
  t[52] !== f || t[53] !== T || t[54] !== h || t[55] !== y || t[56] !== n
    ? ((it = async () => {
        try {
          (await f.mutateAsync(),
            w(y, S, { action: `disable`, source: n }),
            Ke({ scope: y, intl: T, intent: `disable`, kind: `success` }),
            h(!1));
        } catch {
          Ke({ scope: y, intl: T, intent: `disable`, kind: `danger` });
        }
      }),
      (t[52] = f),
      (t[53] = T),
  ...
  bb0: switch (r) {
    ...
    case `setup-auto-reload`: {
      ...
      (t[61] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        ($ = e));
      let n;
      (t[62] !== T || t[63] !== F || t[64] !== R || t[65] !== c || t[66] !== A
        ? ((n = (0, J.jsx)(Be, {
            intl: T,
            targetBalance: A,
            minimumBalance: F,
        ...
        (ot = n));
      let r;
      (t[68] !== T || t[69] !== F || t[70] !== R || t[71] !== c || t[72] !== A
        ? ((r = (0, J.jsx)(Be, {
            intl: T,
            targetBalance: A,
            minimumBalance: F,
    ...
    case `manage-auto-reload`: {
      ...
      (t[74] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        ($ = e));
      let n;
      (t[75] !== T || t[76] !== F || t[77] !== R || t[78] !== c || t[79] !== A
        ? ((n = (0, J.jsx)(Be, {
            intl: T,
            targetBalance: A,
            minimumBalance: F,
        ...
        (ot = n));
      let r;
      (t[81] !== T || t[82] !== F || t[83] !== R || t[84] !== c || t[85] !== A
        ? ((r = (0, J.jsx)(Be, {
            intl: T,
            targetBalance: A,
            minimumBalance: F,
  ...
  t[96] !== r
    ? ((lt = (0, J.jsx)(Re, {
        ...
        isAutoReloadSettingsSubmitDisabled: Xe,
        onTurnOff: ct,
      })),
      (t[89] = Y),
      (t[90] = Ye),
    ...
    : (lt = t[97]);
  let ut;
  t[98] !== s || t[99] !== T || t[100] !== c || t[101] !== lt
    ? ((ut = (0, J.jsx)(Ue, { intl: T, creditDetails: s, pricingInfo: c, actions: lt })),
      (t[98] = s),
      (t[99] = T),
      (t[100] = c),
      (t[101] = lt),
  ...
  let ft = ie ? Me : null,
    pt;
  t[105] !== X || t[106] !== c
    ? ((pt = X ? ue(c) : 125), (t[105] = X), (t[106] = c), (t[107] = pt))
    : (pt = t[107]);
  let mt = X ? 250 : null,
    ht,
    gt;
  ...
  t[117] !== A
    ? ((vt = (0, J.jsx)(Se, {
        ...
        quantityStep: mt,
        onChange: ht,
        onSelectionChange: gt,
        onInvalidCurrencyDraftChange: ve,
        onBlur: _t,
      })),
      (t[111] = M),
      (t[112] = T),
  ...
  t[139] !== H
    ? ((bt = X
        ...
        : (0, J.jsx)(ke, {
            ...
            monthlyLimit: R,
            pricingInfo: c,
            minimumBalanceError: fe ? Pe : null,
            monthlyLimitError: H ? He : null,
            hasImmediateTopUpFailure: Ce,
            immediateTopUpFailureAmount: Te,
            isManagePaymentPending: tt.isPending,
            ...
            onInvalidMonthlyLimitCurrencyDraftChange: xe,
            onMonthlyLimitBlur: () => {
              U(!0);
            },
            onOpenManagePayment: () => {
    ...
    : (bt = t[140]);
  let xt;
  t[141] !== vt || t[142] !== yt || t[143] !== bt
    ? ((xt = (0, J.jsxs)(O, { className: `gap-4 pt-4`, children: [vt, yt, bt] })),
      (t[141] = vt),
      (t[142] = yt),
      (t[143] = bt),
      (t[144] = xt))
...
async function Le() {
  return await x.safeGet(`/payments/customer_portal`);
}
function Re(e) {
  let t = (0, K.c)(18),
    {
  ...
  return (
    t[15] !== u || t[16] !== f
      ? ((p = (0, J.jsxs)(N, { className: `w-auto`, children: [u, f] })),
        (t[15] = u),
        (t[16] = f),
        (t[17] = p))
      : (p = t[17]),
...
function ze(e) {
  let t = (0, K.c)(16),
    ...
    s;
  t[0] !== n || t[1] !== i || t[2] !== o
    ? ((s = G({ intl: n, creditQuantity: Number.parseInt(H(i), 10), pricingInfo: o })),
      (t[0] = n),
      (t[1] = i),
      (t[2] = o),
      (t[3] = s))
  ...
  let c = s,
    l;
  t[4] !== n || t[5] !== o || t[6] !== r
    ? ((l = G({ intl: n, creditQuantity: Number.parseInt(H(r), 10), pricingInfo: o })),
      (t[4] = n),
      (t[5] = o),
      (t[6] = r),
      (t[7] = l))
  ...
  let u = l,
    d;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((d = G({ intl: n, creditQuantity: Number.parseInt(H(a), 10), pricingInfo: o })),
      (t[8] = n),
      (t[9] = a),
      (t[10] = o),
      (t[11] = d))
...
function Be(e) {
  ...
  t[6] === c
    ? (u = t[7])
    : ((u = c === `button` ? (0, J.jsx)(He, { children: (0, J.jsx)(Ve, {}) }) : (0, J.jsx)(Ve, {})),
      (t[6] = c),
      (t[7] = u));
  let d;
  return (
...
function Z() {
  d.dispatchMessage(`open-in-browser`, { url: X });
}
function Ue(e) {
  let t = (0, K.c)(12),
    ...
    o;
  t[0] !== r || t[1] !== n || t[2] !== i
    ? ((o = We({ intl: n, creditDetails: r, pricingInfo: i })),
      (t[0] = r),
      (t[1] = n),
      (t[2] = i),
      (t[3] = o))
...
function We({ intl: e, creditDetails: t, pricingInfo: n }) {
  return t == null || t.unlimited
    ? null
    : (G({ intl: e, creditQuantity: Math.floor(Number(t.balance ?? 0)), pricingInfo: n }) ??
        e.formatNumber(0));
}
function Ge({ scope: e, source: t, email: n, quantity: r, onOpenChange: i, statsigClient: a }) {
  let o = H(r);
  (w(e, C, { creditQuantity: s(o), source: t }),
    w(e, l, { checkoutKind: `standalone_credit`, entryPoint: `codex_purchase_credits_route` }),
...
function Ke({ scope: e, intl: t, intent: n, kind: r }) {
  let i;
  switch (n) {
    case `enable`:
      i =
...
function Je(e) {
  ...
  let p;
  t[7] !== o || t[8] !== a
    ? ((p = (0, J.jsx)(A, { title: a, subtitle: o })), (t[7] = o), (t[8] = a), (t[9] = p))
    : (p = t[9]);
  let m;
  t[10] !== d || t[11] !== f || t[12] !== p
    ? ((m = (0, J.jsxs)(O, { children: [d, f, p] })),
      (t[10] = d),
      (t[11] = f),
      (t[12] = p),
      (t[13] = m))
  ...
  t[14] === s
    ? (h = t[15])
    : ((h = (0, J.jsx)(O, { className: `pt-4`, children: s })), (t[14] = s), (t[15] = h));
  let g;
  return (
    t[16] !== l || t[17] !== u || t[18] !== m || t[19] !== h
      ? ((g = (0, J.jsxs)(M, { as: `form`, onSubmit: u, children: [m, l, h] })),
        (t[16] = l),
        (t[17] = u),
        (t[18] = m),
        (t[19] = h),
...
function Q(e) {
  ...
  t[15] === n
    ? (s = t[16])
    : ((s = { "aria-describedby": n, onOpenAutoFocus: Ye }), (t[15] = n), (t[16] = s));
  let c;
  t[17] !== i || t[18] !== e
    ? ((c = (t) => {
...
function Xe(e) {
  ...
  t[11] !== f || t[12] !== c
    ? ((p = (0, J.jsx)(O, {
        children: (0, J.jsx)(A, { title: c, subtitle: f, titleSize: `base` }),
      })),
      (t[11] = f),
      (t[12] = c),
      (t[13] = p))
  ...
  return (
    t[23] !== y || t[24] !== l || t[25] !== d || t[26] !== p
      ? ((b = (0, J.jsxs)(M, { className: `gap-0 px-4 py-4`, children: [l, d, p, y] })),
        (t[23] = y),
        (t[24] = l),
        (t[25] = d),
        (t[26] = p),
...
function Ze(e) {
  let t = (0, K.c)(50),
    ...
    l;
  t[0] === s ? (l = t[1]) : ((l = { enabled: s }), (t[0] = s), (t[1] = l));
  let { data: u, isError: d, refetch: f } = F(l),
    { enableAutoTopUpMutation: p, updateAutoTopUpMutation: m, disableAutoTopUpMutation: h } = I(),
    g;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = { enabled: !0 }), (t[2] = g))
    : (g = t[2]);
  let { data: _, isPending: v, isError: y, refetch: b } = P(g),
    x;
  t[3] === _ ? (x = t[4]) : ((x = { billingCurrency: _, enabled: !0 }), (t[3] = _), (t[4] = x));
  let { data: S, isPending: C, isError: w, refetch: T } = te(x),
    E = v || C,
    D;
  t[5] !== b || t[6] !== T
    ? ((D = () => {
  ...
  if (i === `one-time-purchase`) {
    ...
    let e = o?.credits ?? null,
      n;
    return (
      t[19] !== S || t[20] !== A || t[21] !== r || t[22] !== e || t[23] !== i
        ? ((n = (0, J.jsx)(Q, {
            open: !0,
            source: r,
            variant: i,
  ...
  if (u == null) {
    let e;
    return (
      t[25] !== A || t[26] !== d || t[27] !== f || t[28] !== r || t[29] !== i
        ? ((e = d
            ? (0, J.jsx)(Q, {
                open: !0,
                source: r,
...
var Qe = `1721641661`;
function $e({ intent: e, isCombinedModalEnabled: t }) {
  return t ? `combined-modal` : e === `purchase` ? `legacy-purchase` : `legacy-auto-reload`;
}
function et({ intent: e, isAutoReloadEnabled: t }) {
  return e === `purchase`
    ? t
      ? `one-time-purchase`
      : `add-credits`
...
function tt() {
  ...
  return (
    e[0] !== t || e[1] !== n
      ? ((r = (e) => {
          let r = y(n, Qe, { disableExposureLog: !1 }).get(`enabled`, !1);
          if ($e({ intent: e.intent, isCombinedModalEnabled: r }) === `combined-modal`) {
            (w(t, T, { isAutoReloadEnabledAtOpen: e.isAutoReloadEnabled, source: e.source }),
              D(t, Ze, {
                source: e.source,
                variant: et({ intent: e.intent, isAutoReloadEnabled: e.isAutoReloadEnabled }),
              }));
            return;
          }
...
export { tt as n, G as r, at as t };
//# sourceMappingURL=rate-limit-rows-CepF-28C.js.map
