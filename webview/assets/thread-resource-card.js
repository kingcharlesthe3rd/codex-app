...
function u(e) {
  ...
  return (
    t[5] !== o || t[6] !== u
      ? ((d = (0, a.jsx)(`div`, { className: u, children: o })), (t[5] = o), (t[6] = u), (t[7] = d))
      : (d = t[7]),
    d
  );
}
function d(e) {
  let t = (0, i.c)(16),
    ...
    _;
  t[0] !== r || t[1] !== g
    ? ((_ = n(`flex min-w-0 items-center gap-2.5 text-left`, g, r)),
      (t[0] = r),
      (t[1] = g),
      (t[2] = _))
    : (_ = t[2]);
...
function f(e) {
  ...
  t[0] === g
    ...
    : ((_ = n(
      ...
      (t[1] = _));
  let v;
  t[2] !== o || t[3] !== p || t[4] !== u || t[5] !== m
    ? ((v = p
        ? (0, a.jsxs)(`span`, {
            className: n(`grid`, l[m]),
            children: [
              (0, a.jsxs)(`span`, {
                "aria-hidden": !0,
        ...
        : (0, a.jsx)(`span`, { className: n(`flex items-center font-medium`, l[m]), children: o })),
      (t[2] = o),
      (t[3] = p),
      (t[4] = u),
      (t[5] = m),
...
function p(e) {
  let t = (0, i.c)(9),
    ...
    l = s && `rotate-180`,
    u;
  t[0] === l ? (u = t[1]) : ((u = n(`icon-xs`, l)), (t[0] = l), (t[1] = u));
  let d;
  t[2] === u ? (d = t[3]) : ((d = (0, a.jsx)(r, { className: u })), (t[2] = u), (t[3] = d));
  let f;
  return (
    t[4] !== o || t[5] !== s || t[6] !== c || t[7] !== d
      ? ((f = (0, a.jsxs)(`button`, {
          type: `button`,
          "aria-expanded": s,
...
//# sourceMappingURL=thread-resource-card.js.map
