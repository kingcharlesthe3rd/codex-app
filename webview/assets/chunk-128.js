...
import { ng as t, rg as n } from "./app-initial~app-main~new-thread-panel-page.js";
import { n as r, t as i } from "./src-3.js";
import { a, c as o, i as s, n as c, o as l, r as u, s as d, t as f } from "./esm-2.js";
import { i as p, n as m, r as h } from "./chunk-50.js";
import { A as g, F as _, R as v, k as y, s as b, y as x } from "./chunk-85.js";
import { i as S, u as C } from "./chunk-32.js";
...
function N(e, t, n = [], r = []) {
  ...
  let a = e.shift() ?? { content: ` `, type: `normal` },
    o = [...r];
  if ((i !== `` && o.push({ content: i, type: `normal` }), o.push(a), t(o))) return N(e, t, n, o);
...
async function F(e, t, n, r, i = !1, a = x()) {
  ...
  (o.attr(`width`, `${Math.min(10 * n, X)}px`), o.attr(`height`, `${Math.min(10 * n, X)}px`));
    ...
    (C(),
      ...
      (K = m((e) => {
        for (let t of e) {
          ...
          if ((p.debug(`Registering icon pack:`, t.name), `loader` in t)) G.set(t.name, t.loader);
      ...
      (Z = m(
        async (
          ...
          if ((p.debug(`XYZ createText`, t, n, i, a, o, c, `addSvgBackground: `, u), o)) {
            let r = await H(S(s ? O(t, d) : D(t)), d),
              i = t.replace(/\\\\/g, `\\`);
            return await F(
              e,
              { isNode: c, label: y(t) ? i : r, labelStyle: n.replace(`fill:`, `color:`) },
              l,
              a,
              u,
              d,
            ...
            let a = S(t.replace(/<br\s*\/?>/g, `<br/>`)),
              o = z(l, e, s ? E(a.replace(`<br>`, `<br/>`), d) : T(a), t ? u : !1, !c);
            if (c) {
            ...
            return (
              i
                ? r(o).selectAll(`tspan.text-outer-tspan`).classed(`title-row`, !0)
