...
import { Xs as u, v as d } from "./app-server-manager-signals.js";
...
import { t as te } from "./invalidate-queries-and-broadcast.js";
...
async function M(e) {
  try {
    ...
    return (
      m.error(`Failed to load Windows sandbox readiness`, { safe: {}, sensitive: { error: e } }),
      `notConfigured`
    );
  }
}
...
var W = p();
function G(e) {
  return typeof e == `string` ? (0, W.jsx)(W.Fragment, { children: e }) : (0, W.jsx)(v, { ...e });
}
function K(e, t) {
...
function ne({
  ...
  let u = e ? [`read-only`, `auto`, `granular`, `full-access`, `custom`] : c(t, n),
    d = l(n ?? void 0) ?? !0,
    f = i,
