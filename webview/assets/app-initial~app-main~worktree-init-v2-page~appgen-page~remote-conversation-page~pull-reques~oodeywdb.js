...
function f(e) {
  return e === `STEPS_EXECUTION` ? v : (e ?? `STEPS_COMMANDS`);
}
function p(e, t) {
  let n = f(d(e.get, r.conversationDetailMode)),
    i = u(e, r.conversationDetailMode, t);
  return (
    e
      .get(o)
      .logProductEvent(s, {
...
function m(e) {
  return f(d(e, r.conversationDetailMode)) === _;
}
function h() {
  let e = (0, g.c)(2),
    t = l(r.conversationDetailMode),
    n;
...
var g,
  ...
  v,
  y = e(() => {
    ((g = n()), i(), t(), a(), c(), (_ = `STEPS_PROSE`), (v = `STEPS_COMMANDS`));
  });
export { y as a, f as i, _ as n, p as o, m as r, h as s, v as t };
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~appgen-page~remote-conversation-page~pull-reques~oodeywdb.js.map
