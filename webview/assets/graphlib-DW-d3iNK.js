...
import { D as t, n, nt as r, r as i } from "./reduce.js";
import { K as a } from "./_baseFor-1.js";
import { n as o } from "./isEmpty-1.js";
import { f as s, i as c, p as l, t as u } from "./lodash-1.js";
import { j as d } from "./merge.js";
function f(e, t) {
  e[t] ? e[t]++ : (e[t] = 1);
}
function p(e, t) {
      ...
      (b = class {
        constructor(e = {}) {
          ((this._isDirected = Object.prototype.hasOwnProperty.call(e, `directed`)
            ...
            (this._nodes = {}),
            this._isCompound &&
              ((this._parent = {}), (this._children = {}), (this._children[v] = {})),
            (this._in = {}),
            (this._preds = {}),
            (this._out = {}),
            (this._sucs = {}),
        ...
        setNode(e, t) {
          return Object.prototype.hasOwnProperty.call(this._nodes, e)
            ...
            : ((this._nodes[e] = arguments.length > 1 ? t : this._defaultNodeLabelFn(e)),
              this._isCompound &&
                ((this._parent[e] = v), (this._children[e] = {}), (this._children[v][e] = !0)),
              (this._in[e] = {}),
              (this._preds[e] = {}),
              (this._out[e] = {}),
              (this._sucs[e] = {}),
        ...
        setParent(e, t) {
          ...
          if (s(t)) t = v;
            ...
            for (var n = t; !s(n); n = this.parent(n))
              if (n === e)
                throw Error(`Setting ` + t + ` as parent of ` + e + ` would create a cycle`);
            this.setNode(t);
          }
          return (
            this.setNode(e),
        ...
        filterNodes(e) {
          ...
          function a(e) {
            var i = n.parent(e);
            return i === void 0 || t.hasNode(i) ? ((r[e] = i), i) : i in r ? r[i] : a(i);
          }
          return (
            this._isCompound &&
...
//# sourceMappingURL=graphlib-DW-d3iNK.js.map
