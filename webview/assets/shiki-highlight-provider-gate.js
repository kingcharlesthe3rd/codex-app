const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./erlang-eAvf-lqd.js",
      "./markdown.js",
      "./fortran-fixed-form.js",
      "./fortran-free-form-1.js",
      "./fortran-free-form-2.js",
      "./fsharp.js",
      "./gdresource.js",
      "./gdscript-2.js",
      "./gdshader-2.js",
...
import { r as e, s as t, t as n } from "./chunk.js";
import { n as r, t as i } from "./jsx-runtime.js";
import { Z as a, s as o } from "./app-scope-CWE-zIhQ.js";
import { k as s } from "./src-3.js";
import { t as c } from "./preload-helper.js";
import { a as l } from "./setting-storage.js";
import { t as u } from "./ccount.js";
import { f as d, s as f } from "./diff-view-mode.js";
import {
  _ as p,
  d as m,
  f as h,
...
import { n as re, r as ie } from "./use-resolved-theme-variant.js";
import { n as ae } from "./is-compact-window-context.js";
...
var ce = new Set(),
  le = null;
function x(e) {
  (ce.add(e), (le ??= requestAnimationFrame(ue)));
}
function ue(e) {
  let t = new Set(ce);
  ce.clear();
  ...
  le = ce.size > 0 ? requestAnimationFrame(ue) : null;
}
function de(e, t, n) {
...
function pe(e, t) {
  let n = e?.theme ?? b,
    ...
    i = me(e),
    a = me(t);
  return fe(n, r) && de(e, t, [`theme`, `parseDiffOptions`]) && de(i, a);
}
function me(e) {
...
function S({ tagName: e, children: t = [], properties: n = {} }) {
  return { type: `element`, tagName: e, properties: n, children: t };
}
function ye({ name: e, width: t = 16, height: n = 16, properties: r }) {
  return S({
    tagName: `svg`,
    properties: { width: t, height: n, viewBox: `0 0 16 16`, ...r },
    children: [S({ tagName: `use`, properties: { href: `#${e.replace(/^#/, ``)}` } })],
  });
}
function be(e) {
  let t = e.children[0];
...
function xe(e) {
  return S({ tagName: `div`, properties: { "data-gutter": `` }, children: e });
}
function Se(e, t, n, r = {}) {
  return S({
    tagName: `div`,
...
function we() {
  return S({
    ...
    children: [ye({ name: `diffs-icon-plus`, properties: { "data-icon": `` } })],
  });
}
function Te(e, t) {
...
((De.prototype.normal = {}), (De.prototype.property = {}), (De.prototype.space = void 0));
function Oe(e, t) {
  let n = {},
    r = {};
...
var Fe = Object.keys(Ae),
  Ie = class extends C {
    constructor(e, t, n, r) {
      let i = -1;
      if ((super(e, t), Le(this, `space`, r), typeof n == `number`))
        for (; ++i < Fe.length; ) {
          let e = Fe[i];
          Le(this, Fe[i], (n & Ae[e]) === Ae[e]);
        }
    }
  };
...
function Xe(e, t) {
  ...
  if (n.length > 4 && n.slice(0, 4) === `data` && Ye.test(t)) {
    if (t.charAt(4) === `-`) {
      let e = t.slice(5).replace(Je, Qe);
      r = `data` + e.charAt(0).toUpperCase() + e.slice(1);
    } else {
      let e = t.slice(4);
      if (!Je.test(e)) {
        let n = e.replace(qe, Ze);
...
var $e = Oe([ze, He, We, Ge, Ke], `html`),
  et = Oe([ze, Ue, We, Ge, Ke], `svg`),
  tt = /["&'<>`]/g,
  nt = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
  rt = /[\x01-\t\v\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g,
  it = /[|\\{}()[\]^$+*?.]/g,
  at = new WeakMap();
function ot(e, t) {
  if (((e = e.replace(t.subset ? st(t.subset) : tt, r)), t.subset || t.escapeOnly)) return e;
  return e.replace(nt, n).replace(rt, r);
  function n(e, n, r) {
    return t.format(
...
function st(e) {
  let t = at.get(e);
  return (t || ((t = ct(e)), at.set(e, t)), t);
}
function ct(e) {
  let t = [],
    n = -1;
  for (; ++n < e.length; ) t.push(e[n].replace(it, `\\$&`));
...
function ft(e, t, n) {
  let r = `&#` + String(e);
  return n && t && !dt.test(String.fromCharCode(t)) ? r : r + `;`;
}
var pt =
  ...
  ht = [`cent`, `copy`, `divide`, `gt`, `lt`, `not`, `para`, `times`],
  gt = {}.hasOwnProperty,
  _t = {},
  vt;
for (vt in mt) gt.call(mt, vt) && (_t[mt[vt]] = vt);
var yt = /[^\dA-Za-z]/;
function bt(e, t, n, r) {
  ...
  if (gt.call(_t, i)) {
    ...
    return n &&
      pt.includes(e) &&
      !ht.includes(e) &&
      (!r || (t && t !== 61 && yt.test(String.fromCharCode(t))))
      ? a
      : a + `;`;
  }
  return ``;
...
function Et(e, t, n, r) {
  return r.settings.bogusComments
    ? `<?` + St(e.value, Object.assign({}, r.settings.characterReferences, { subset: wt })) + `>`
    : `<!--` + e.value.replace(Ct, i) + `-->`;
  function i(e) {
    return St(e, Object.assign({}, r.settings.characterReferences, { subset: Tt }));
  }
}
function Dt(e, t, n, r) {
  return (
...
var At = /[ \t\n\f\r]/g;
function jt(e) {
  return typeof e == `object` ? (e.type === `text` ? Mt(e.value) : !1) : Mt(e);
}
function Mt(e) {
  return e.replace(At, ``) === ``;
}
...
function Ft(e) {
  return t;
  function t(t, n, r) {
    let i = t ? t.children : Pt,
      a = (n || 0) + e,
      o = i[a];
    if (!r) for (; o && jt(o); ) ((a += e), (o = i[a]));
    return o;
  }
}
...
function Lt(e) {
  return t;
  function t(t, n, r) {
    return It.call(e, t.tagName) && e[t.tagName](t, n, r);
  }
}
var Rt = Lt({
  body: Vt,
...
function zt(e, t, n) {
  let r = k(n, t, !0);
  return !r || (r.type !== `comment` && !(r.type === `text` && jt(r.value.charAt(0))));
}
function Bt(e, t, n) {
  let r = k(n, t);
...
var en = Lt({ body: rn, colgroup: an, head: nn, html: tn, tbody: on });
function tn(e) {
  let t = k(e, -1);
...
function rn(e) {
  ...
  return (
    !t ||
    (t.type !== `comment` &&
      !(t.type === `text` && jt(t.value.charAt(0))) &&
      !(
        t.type === `element` &&
        (t.tagName === `meta` ||
          t.tagName === `link` ||
...
function cn(e, t, n, r) {
  let i = r.schema,
    ...
    s = [],
    c;
  i.space === `html` && e.tagName === `svg` && (r.schema = et);
  let l = ln(r, e.properties),
...
function un(e, t, n) {
  ...
  let c = St(
    r.attribute,
    Object.assign({}, e.settings.characterReferences, { subset: sn.name[i][a] }),
  );
  return n === !0 ||
    ((n = Array.isArray(n)
      ? (r.commaSeparated ? Ot : kt)(n, { padLeft: !e.settings.tightCommaSeparatedLists })
      : String(n)),
    ...
    : (e.settings.preferUnquoted &&
        (s = St(
          ...
          Object.assign({}, e.settings.characterReferences, {
            attribute: !0,
            subset: sn.unquoted[i][a],
          }),
        )),
      s !== n &&
        (e.settings.quoteSmart && u(n, o) > u(n, e.alternative) && (o = e.alternative),
        (s =
          o +
          St(
            n,
            Object.assign({}, e.settings.characterReferences, {
              subset: (o === `'` ? sn.single : sn.double)[i][a],
              attribute: !0,
            }),
          ) +
          o)),
...
function fn(e, t, n, r) {
  return n && n.type === `element` && (n.tagName === `script` || n.tagName === `style`)
    ? e.value
    : St(e.value, Object.assign({}, r.settings.characterReferences, { subset: dn }));
}
function pn(e, t, n, r) {
  return r.settings.allowDangerousHtml ? e.value : fn(e, t, n, r);
}
function mn(e, t, n, r) {
  return r.all(e);
}
var hn = se(`type`, {
  invalid: gn,
  unknown: _n,
  handlers: { comment: Et, doctype: Dt, element: cn, raw: pn, root: mn, text: fn },
});
function gn(e) {
...
function xn(e, t) {
  ...
  return {
    ...
    settings: {
      ...
      voids: n.voids || Ee,
      characterReferences: n.characterReferences || yn,
      closeSelfClosing: n.closeSelfClosing || !1,
      closeEmptyElements: n.closeEmptyElements || !1,
    },
    schema: n.space === `svg` ? et : $e,
    quote: r,
    alternative: i,
...
var wn = class {
  ...
  setSelection(e, t) {
    let n = !(e === this.selectedRange || he(e ?? void 0, this.selectedRange ?? void 0));
  ...
  getHoveredLine = () => {
    ...
    if (e != null) {
      ...
      if (this.mode === `file` && e.type === `line`) return { lineNumber: e.lineNumber };
    }
  };
  handlePointerClick = (e) => {
    ...
    (t == null && n == null && r == null && a == null && i == null) ||
      (this.options.onGutterUtilityClick != null && Vn(e.composedPath())) ||
      (A(this.options.__debugPointerEvents, `click`, `FileDiff.DEBUG.handlePointerClick:`, e),
  ...
  handlePointerMove = (e) => {
    ...
    (t === `disabled` && !o && n == null && r == null && i == null && a == null) ||
      (A(this.options.__debugPointerEvents, `move`, `FileDiff.DEBUG.handlePointerMove:`, e),
      this.handlePointerEvent({ eventType: `move`, event: e }));
  };
  handlePointerLeave = (e) => {
    let { __debugPointerEvents: t } = this.options;
    if (
      (A(t, `move`, `FileDiff.DEBUG.handlePointerLeave: no event`),
      this.hoveredLine == null && this.hoveredToken == null)
    ) {
      A(t, `move`, `FileDiff.DEBUG.handlePointerLeave: returned early, no hovered line or token`);
      return;
    }
  ...
  handlePointerEvent({ eventType: e, event: t }) {
    let { __debugPointerEvents: n } = this.options,
      r = t.composedPath();
    A(n, e, `FileDiff.DEBUG.handlePointerEvent:`, { eventType: e, composedPath: r });
    let i = this.resolvePointerTarget(r);
    A(n, e, `FileDiff.DEBUG.handlePointerEvent: resolvePointerTarget result:`, i);
    let {
      onLineClick: a,
      onLineNumberClick: o,
      onLineEnter: s,
    ...
    switch (e) {
      case `move`: {
        let e = kn(i) && this.hoveredLine?.lineElement === i.lineElement;
        ((On(i) && this.hoveredToken?.tokenElement === i.tokenElement) ||
          ...
          e ||
            (this.hoveredLine != null &&
              (c?.({ ...this.hoveredLine, event: t }), this.clearHoveredLine()),
            kn(i)
      ...
      case `click`: {
        ...
        if (!kn(i)) break;
        On(i) && l != null && l(this.toTokenEventBaseProps(i), t);
  ...
  syncPointerListeners(e) {
    ...
    g && !this.hasPointerListeners
      ? (e.addEventListener(`click`, this.handlePointerClick),
        ...
        A(t, `move`, `FileDiff.DEBUG.attachEventListeners: Attaching pointer move event`),
        A(t, `move`, `FileDiff.DEBUG.attachEventListeners: Attaching pointer leave event`))
      : !g &&
  ...
  handlePointerDown = (e) => {
    ...
    Vn(t) && this.options.onGutterUtilityClick != null
  ...
  startLineSelectionFromPointerDown(e) {
    ...
    if (!t) return;
    let n = this.resolveSelectionInfo(e, { source: `event-path`, requireNumberColumn: !0 });
    if (n == null) return;
    let { pre: r } = this;
    if (r == null) return;
    e.preventDefault();
    ...
    if (this.selectedRange?.start === i && this.selectedRange?.end === i) {
  ...
  startGutterSelectionFromPointerDown(e) {
    ...
    let r = this.currentSelectionEnds(),
      i = r?.bottom ?? this.resolveSelectionPoint(e, { source: `event-path`, excludeUtility: !1 }),
      a = r?.top ?? i;
    i == null ||
      a == null ||
      (e.preventDefault(),
      ...
      t &&
        ((this.selectionAnchor = { lineNumber: a.lineNumber, side: a.side }),
  ...
  handleDocumentPointerMove = (e) => {
    ...
    switch (this.pointerSession.mode) {
      ...
      case `gutterSelecting`: {
        ...
        e.preventDefault();
        let n = this.resolveSelectionPoint(e, { source: `coordinates-first` });
        if (n == null) return;
      ...
      case `pendingSingleLineUnselect`: {
        ...
        if (Te(this.pointerSession.pending, n)) return;
  ...
  handleDocumentPointerUp = (e) => {
    ...
    switch (this.pointerSession.mode) {
      ...
      case `gutterSelecting`: {
        if (e.pointerId !== this.pointerSession.pointerId) return;
        e.preventDefault();
        let r = this.resolveSelectionPoint(e, { source: `coordinates-first` });
        (r != null &&
  ...
  revealUtilityFromGutterPath(e) {
    ...
    Dn(t) && t.numberColumn && this.showUtilityOnLine(this.toEventBaseProps(t));
  }
  placeUtility() {
  ...
  placeUtilityFromSelection() {
    ...
    return (t == null ? this.hideUtility() : this.showUtilityOnLine(this.toEventBaseProps(t)), !0);
  }
  showUtilityOnLine(e) {
    this.gutterUtilityContainer != null &&
      ((this.gutterUtilityLine = e), e.numberElement.appendChild(this.gutterUtilityContainer));
  }
  hideUtility() {
    (this.gutterUtilityContainer?.remove(), (this.gutterUtilityLine = void 0));
  }
  ...
  selectionEnds(e) {
    ...
    if (!(r == null || i == null)) return r > i ? { top: n, bottom: t } : { top: t, bottom: n };
  }
  ...
  targetForSelectionPoint(e) {
    ...
    for (let t of r) {
      ...
      let n = this.resolvePointerTarget(Pn(t));
      if (Dn(n) && !(this.mode === `diff` && e.side != null && n.side !== e.side)) return n;
    }
  }
  ...
  selectionInfoFromPath(e, t) {
    ...
    if (Dn(n) && !(t && !n.numberColumn) && n.splitLineIndex != null)
      return {
  ...
  resolveSelectionInfo(e, t) {
    ...
    return n == null ? void 0 : this.selectionInfoFromPath(n, t.requireNumberColumn);
  }
  selectionPointFromPath(e) {
    let t = this.resolvePointerTarget(e);
    if (Dn(t)) return { lineNumber: t.lineNumber, side: this.mode === `diff` ? t.side : void 0 };
  }
  ...
  resolveSelectionPath(e, t) {
    ...
    switch (t.source) {
      ...
      case `coordinates-first`: {
        ...
        return t === void 0 ? this.pathFromEventPath(e.composedPath(), n) : (t ?? void 0);
      }
    }
  }
  pathFromCoordinates(e, t) {
    let n = this.hitTest(e);
    if (n !== void 0) return n === null ? null : (this.pathFromElement(n, t) ?? null);
  }
  pathFromEventPath(e, t) {
    if (!(t && Vn(e))) {
      for (let n of e) if (n instanceof Element) return this.pathFromElement(n, t);
    }
  }
  pathFromElement(e, t) {
    let n = Pn(e);
    if (t && Vn(n)) return;
    let r = Fn(e);
    return r == null ? this.pathFromAnnotationSlot(e) : Pn(r);
  }
  pathFromAnnotationSlot(e) {
    let t = Ln(In(e));
    if (t == null) return;
    let n = this.targetForSelectionPoint(t);
    return n == null ? void 0 : Pn(n.lineElement);
  }
  hitTest(e) {
    if (!Number.isFinite(e.clientX) || !Number.isFinite(e.clientY)) return;
    let t = this.pre?.getRootNode(),
      n = Rn(t) ? t : Rn(document) ? document : void 0;
  ...
  getCurrentSelectionRange() {
    return this.proposedSelectedRange === void 0 ? this.selectedRange : this.proposedSelectedRange;
  }
  ...
  resolvePointerTarget(e) {
    ...
    if (
      ((i ??= a == null ? void 0 : Nn(r, `[data-line][data-line-index="${a}"]`)),
      (o ??= a == null ? void 0 : Nn(r, `[data-column-number][data-line-index="${a}"]`)),
...
function En({ enableGutterUtility: e, renderGutterUtility: t, onGutterUtilityClick: n }) {
  if (n != null && t != null)
    throw Error(
...
function Fn(e) {
  ...
  let n = e.closest(`[data-line-annotation], [data-gutter-buffer="annotation"]`);
...
function Ln(e) {
  ...
  if (Number.isFinite(n)) return { lineNumber: n, side: t[1] };
}
function Rn(e) {
...
var Hn = class e {
  ...
  static getResizeObserver() {
    let t = e.resizeObserver ?? new ResizeObserver(e.handleSharedResizeEntries);
  ...
  setup(e, t) {
          ...
          : (this.observedNodes.set(e, n),
            ...
            n.numberElement === a
              ? n.numberElement == null
                ? (n.numberWidth = 0)
                : (i.delete(n.numberElement), this.observedNodes.set(n.numberElement, n))
              : (n.numberElement != null &&
                  (this.unobserve(n.numberElement), i.delete(n.numberElement)),
                a != null && (this.observe(a), i.delete(a), this.observedNodes.set(a, n)),
                (n.numberElement = a),
                (n.numberWidth = 0))));
    }
    if (r > 1 && !t) {
      ...
      for (let [e, t] of r) {
        ...
        let c = i.get(o);
        if (c != null) {
          (this.observedNodes.set(o, c), this.observedNodes.set(s, c), i.delete(o), i.delete(s));
          continue;
        }
        ...
        ((c = {
          ...
          n.add({ child1: o, child2: s, item: c, newHeight: Math.max(l, u) }));
      }
      for (let e of n)
    ...
    for (let [e, t] of i) (this.unobserve(e), t.type === `code` ? Gn(t) : Kn(t));
    i.clear();
  }
  cleanUp() {
  ...
  observe(t) {
    ...
    if (r !== this) {
      if (r != null && r !== this)
        throw Error(`ResizeManager.observe: element is already owned by another ResizeManager`);
  ...
  unobserve(t) {
    ...
    if (i != null) {
      if (i !== this)
        throw Error(`ResizeManager.unobserve: element is owned by another ResizeManager`);
      (n.delete(t),
        r?.unobserve(t),
        r != null && n.size === 0 && (r.disconnect(), (e.resizeObserver = void 0)));
    }
  }
  handleResizeEntries(e) {
    ...
    for (let r of e) {
      ...
      if (!(e instanceof HTMLElement)) {
        console.error(`ResizeManager.handleResizeEntries: Invalid element for ResizeObserver`, r);
        continue;
      }
      let o = this.observedNodes.get(e);
      if (o == null) {
        console.error(`ResizeManager.handleResizeEntries: Not a valid observed node`, r);
        continue;
      }
    ...
    (this.applyAnnotationUpdates(n), n.clear(), this.applyColumnUpdates(t), t.clear());
  }
  applyAnnotationUpdates(e) {
    for (let t of e) this.applyNewHeight(t, Math.max(t.column1.childHeight, t.column2.childHeight));
  }
  applyColumnUpdates = (e) => {
    for (let [t, n] of e) {
      let e = n.codeInlineSize == null ? t.codeWidth : Un(n.codeInlineSize),
        r = n.numberInlineSize == null ? t.numberWidth : Wn(n.numberInlineSize),
        i = e !== t.codeWidth,
        a = r !== t.numberWidth;
      if (
        !(!i && !a) &&
...
function Kn(e) {
  (e.column1.container.isConnected &&
    ...
    e.column2.container.isConnected &&
      e.column2.container.style.removeProperty(`--diffs-annotation-min-height`));
}
var qn = new Map(),
  Jn = new Map(),
  Yn = new Map(),
...
function Qn(e, t) {
  ...
  for (let n of e) {
    ...
    let e = qn.get(n.name);
    (e ?? ((e = n), qn.set(n.name, e)), Xn.add(e.name), t.loadLanguageSync(e.data));
  }
}
function $n() {
...
function tr(e) {
  return Array.isArray(e) ? nr(e) : e instanceof RegExp ? e : typeof e == `object` ? rr(e) : e;
}
function nr(e) {
  let t = [];
  for (let n = 0, r = e.length; n < r; n++) t[n] = tr(e[n]);
  return t;
}
function rr(e) {
  let t = {};
...
function ar(e) {
  ...
  return t === 0 ? e : ~t === e.length - 1 ? ar(e.substring(0, e.length - 1)) : e.substr(~t + 1);
}
var or = /\$(\d+)|\${(\d+):\/(downcase|upcase)}/g,
  sr = class {
    static hasCaptures(e) {
      return e === null ? !1 : ((or.lastIndex = 0), or.test(e));
    }
    static replaceCaptures(e, t, n) {
      return e.replace(or, (e, r, i, a) => {
...
var fr = class {
  ...
  pr = class {
    ...
    static createFromRawTheme(e, t) {
      return this.createFromParsedTheme(vr(e), t);
    }
    static createFromParsedTheme(e, t) {
      return br(e, t);
    }
    _cachedMatchRoot = new fr((e) => this._root.match(e));
    getColorMap() {
    ...
    match(e) {
      ...
      let t = e.scopeName,
        n = this._cachedMatchRoot.get(t).find((t) => hr(e.parent, t.parentScopes));
      return n ? new _r(n.fontStyle, n.foreground, n.background) : null;
    }
  },
  mr = class e {
    constructor(e, t) {
...
function br(e, t) {
  e.sort((e, t) => {
    let n = cr(e.scope, t.scope);
    return n !== 0 || ((n = lr(e.parentScopes, t.parentScopes)), n !== 0) ? n : e.index - t.index;
  });
  let n = 0,
    r = `#000000`,
    i = `#ffffff`;
  ...
  let a = new xr(t),
    o = new _r(n, a.getId(r), a.getId(i)),
    s = new wr(new Cr(0, null, -1, 0, 0), []);
  for (let t = 0, n = e.length; t < n; t++) {
    let n = e[t];
  ...
  wr = class e {
    ...
    insert(t, n, r, i, a, o) {
      ...
      (this._children.hasOwnProperty(c)
        ? (u = this._children[c])
        : ((u = new e(this._mainRule.clone(), Cr.cloneArr(this._rulesWithParentScopes))),
          (this._children[c] = u)),
    ...
    _doInsertHere(e, t, n, r, i) {
      ...
      (n === -1 && (n = this._mainRule.fontStyle),
        ...
        this._rulesWithParentScopes.push(new Cr(e, t, n, r, i)));
    }
  },
  Tr = class e {
  ...
  Fr = class {
    constructor(e, t) {
      ((this.repo = e),
        ...
        (this.Q = [new Mr(this.initialScopeName)]));
    }
    ...
    processQueue() {
      ...
      this.Q = [];
      let t = new Pr();
      for (let n of e) Ir(n, this.initialScopeName, this.repo, t);
...
function Ir(e, t, n, r) {
  ...
  let a = n.lookup(t);
  e instanceof Mr
    ? Rr({ baseGrammar: a, selfGrammar: i }, r)
    : Lr(e.ruleName, { baseGrammar: a, selfGrammar: i, repository: i.repository }, r);
  let o = n.injections(e.scopeName);
  if (o) for (let e of o) r.add(new Mr(e));
}
function Lr(e, t, n) {
...
function Rr(e, t) {
  (e.selfGrammar.patterns &&
    ...
    zr(e.selfGrammar.patterns, { ...e, repository: e.selfGrammar.repository }, t),
...
function zr(e, t, n) {
  for (let r of e) {
    ...
    n.visitedRule.add(r);
    let e = r.repository ? ir({}, t.repository, r.repository) : t.repository;
    Array.isArray(r.patterns) && zr(r.patterns, { ...t, repository: e }, n);
    let i = r.include;
    if (!i) continue;
    let a = Gr(i);
    switch (a.kind) {
      case 0:
        Rr({ ...t, selfGrammar: t.baseGrammar }, n);
        break;
      case 1:
        Rr(t, n);
        break;
      case 2:
        Lr(a.ruleName, { ...t, repository: e }, n);
        break;
      case 3:
      case 4:
        let r =
        ...
        if (r) {
          ...
          a.kind === 4 ? Lr(a.ruleName, i, n) : Rr(i, n);
        } else a.kind === 4 ? n.add(new Nr(a.scopeName, a.ruleName)) : n.add(new Mr(a.scopeName));
        break;
    }
  }
}
...
function Gr(e) {
  if (e === `$base`) return new Br();
  if (e === `$self`) return new Vr();
  let t = e.indexOf(`#`);
  return t === -1
    ? new Ur(e)
    : t === 0
      ? new Hr(e.substring(1))
      : new Wr(e.substring(0, t), e.substring(t + 1));
}
var Kr = /\\(\d+)/,
  qr = /\\(\d+)/g,
  Jr = -1,
...
var Qr = class {
    ...
    constructor(e, t, n, r) {
      ((this.$location = e),
        (this.id = t),
        (this._name = n || null),
        (this._nameIsCapturing = sr.hasCaptures(this._name)),
        (this._contentName = r || null),
        (this._contentNameIsCapturing = sr.hasCaptures(this._contentName)));
    }
    get debugName() {
      let e = this.$location ? `${ar(this.$location.filename)}:${this.$location.line}` : `unknown`;
      return `${this.constructor.name}#${this.id} @ ${e}`;
    }
    getName(e, t) {
      return !this._nameIsCapturing || this._name === null || e === null || t === null
        ? this._name
        : sr.replaceCaptures(this._name, e, t);
    }
    getContentName(e, t) {
      return !this._contentNameIsCapturing || this._contentName === null
        ? this._contentName
        : sr.replaceCaptures(this._contentName, e, t);
    }
  },
  $r = class extends Qr {
    ...
    _getCachedCompiledPatterns(e) {
      return (
        this._cachedCompiledPatterns ||
          ((this._cachedCompiledPatterns = new oi()),
  ...
  ni = class extends Qr {
    ...
    constructor(e, t, n, r, i, a, o, s, c, l) {
      (super(e, t, n, r),
        (this._begin = new ai(i, this.id)),
        (this.beginCaptures = a),
        (this._end = new ai(o || `￿`, -1)),
  ...
  ri = class extends Qr {
    ...
    _getCachedCompiledWhilePatterns(e, t) {
      return (
        this._cachedCompiledWhilePatterns ||
          ((this._cachedCompiledWhilePatterns = new oi()),
  ...
  ii = class e {
    static createCaptureRule(e, t, n, r, i) {
      return e.registerRule((e) => new $r(t, e, n, r, i));
    }
      ...
      return (
        t.id ||
          n.registerRule((i) => {
            ...
            if (t.begin === void 0) {
              t.repository && (r = ir({}, r, t.repository));
              let i = t.patterns;
              return (
        ...
        for (let a = 0, o = t.length; a < o; a++) {
          ...
          if (s !== -1) {
            let e = n.getRule(s),
              t = !1;
            if (
              ((e instanceof ti || e instanceof ni || e instanceof ri) &&
  ...
  ai = class e {
    ...
    constructor(e, t) {
      ...
      (this.hasAnchor ? (this._anchorCache = this._buildAnchorCache()) : (this._anchorCache = null),
        ...
        typeof this.source == `string`
          ? (this.hasBackReferences = Kr.test(this.source))
    ...
    resolveBackReferences(e, t) {
      ...
      return ((qr.lastIndex = 0), this.source.replace(qr, (e, t) => dr(n[parseInt(t, 10)] || ``)));
    }
    _buildAnchorCache() {
      if (typeof this.source != `string`)
        throw Error(`This method should only be called if the source is a string`);
...
`);
  ...
  li = class e {
    ...
    constructor(e, t) {
      ((this._defaultAttributes = new ci(e, 8)),
        (this._embeddedLanguagesMatcher = new ui(Object.entries(t || {}))));
    }
    ...
    static _NULL_SCOPE_METADATA = new ci(0, 0);
    _getBasicScopeAttributes = new fr(
      (e) => new ci(this._scopeToLanguage(e), this._toStandardTokenType(e)),
    );
    _scopeToLanguage(e) {
...
function pi(e, t, n, r, i, a, o, s) {
  let c = t.content.length,
    ...
    u = -1;
  if (o) {
    let o = mi(e, t, n, r, i, a);
    ((i = o.stack), (r = o.linePos), (n = o.isFirstLine), (u = o.anchorPosition));
  }
  let d = Date.now();
  for (; !l; ) {
    if (s !== 0 && Date.now() - d > s) return new fi(i, !0);
    f();
  }
  return new fi(i, !1);
  function f() {
    let o = hi(e, t, n, r, i, u);
    if (!o) {
      (a.produce(i, c), (l = !0));
      return;
    }
    ...
    if (d === Jr) {
      ...
      if (((i = i.push(d, r, u, s[0].end === c, null, h, h)), o instanceof ni)) {
        let r = o;
        (xi(e, t, n, i, a, r.beginCaptures, s), a.produce(i, s[0].end), (u = s[0].end));
      ...
      } else if ((xi(e, t, n, i, a, o.captures, s), a.produce(i, s[0].end), (i = i.pop()), !f)) {
...
function mi(e, t, n, r, i, a) {
  ...
  for (let t = i; t; t = t.pop()) {
    let n = t.getRule(e);
    n instanceof ri && s.push({ rule: n, stack: t });
  }
  for (let c = s.pop(); c; c = s.pop()) {
    let { ruleScanner: s, findOptions: l } = yi(c.rule, e, c.stack.endRule, n, r === o),
    ...
    if (u) {
      ...
      u.captureIndices &&
        ...
        xi(e, t, n, c.stack, a, c.rule.whileCaptures, u.captureIndices),
...
function hi(e, t, n, r, i, a) {
  let o = gi(e, t, n, r, i, a),
    s = e.getInjections();
  if (s.length === 0) return o;
  let c = _i(s, e, t, n, r, i, a);
  if (!c) return o;
  if (!o) return c;
...
function gi(e, t, n, r, i, a) {
  let { ruleScanner: o, findOptions: s } = vi(i.getRule(e), e, i.endRule, n, r === a),
...
function _i(e, t, n, r, i, a, o) {
  ...
  for (let a = 0, f = e.length; a < f; a++) {
    ...
    let { ruleScanner: p, findOptions: m } = vi(t.getRule(f.ruleId), t, null, r, i === o),
...
function vi(e, t, n, r, i) {
  return di
    ? { ruleScanner: e.compile(t, n), findOptions: bi(r, i) }
    : { ruleScanner: e.compileAG(t, n, r, i), findOptions: 0 };
}
function yi(e, t, n, r, i) {
  return di
    ? { ruleScanner: e.compileWhile(t, n), findOptions: bi(r, i) }
...
function xi(e, t, n, r, i, a, o) {
  ...
  for (let t = 0; t < c; t++) {
    ...
    if (
      ...
      (pi(e, p, n && d.start === 0, d.start, f, i, !1, 0), jr(p));
      continue;
    }
    let f = c.getName(s, o);
    if (f !== null) {
...
function Ci(e, t, n, r, i, a, o, s) {
  return new Di(e, t, n, r, i, a, o, s);
}
function wi(e, t, n, r, i) {
  let a = Or(t, Ti),
    o = ii.getCompiledRuleId(n, r, i.repository);
  for (let n of a)
...
function Ti(e, t) {
  ...
  let n = 0;
  return e.every((e) => {
    for (let r = n; r < t.length; r++) if (Ei(t[r], e)) return ((n = r + 1), !0);
    return !1;
  });
}
function Ei(e, t) {
...
var Di = class {
  ...
  _collectInjections() {
    ...
    if (r) {
      let e = r.injections;
      if (e) for (let n in e) wi(t, n, e[n], this, r);
  ...
  getExternalGrammar(e, t) {
    ...
    if (this._grammarRepository) {
      ...
      if (n) return ((this._includedGrammars[e] = Oi(n, t && t.$base)), this._includedGrammars[e]);
    }
  }
  ...
  _tokenize(e, t, n, r) {
    this._rootId === -1 &&
      ((this._rootId = ii.getCompiledRuleId(
    ...
    if (!t || t === Ai.NULL) {
      ...
      let e = this._basicScopeAttributesProvider.getDefaultAttributes(),
        ...
        r = Tr.set(0, e.languageId, e.tokenType, null, n.fontStyle, n.foregroundId, n.backgroundId),
        a = this.getRule(this._rootId).getName(null, null),
        o;
      ((o = a ? ki.createRootAndLookUpScopeName(a, r, this) : ki.createRoot(`unknown`, r)),
        (t = new Ai(null, this._rootId, -1, -1, !1, null, o, o)));
    } else ((i = !1), t.reset());
    e += `
`;
    let a = this.createOnigString(e),
      o = a.content.length,
      s = new Mi(n, e, this._tokenTypeMatchers, this.balancedBracketSelectors),
      c = pi(this, a, i, 0, t, s, !0, r);
    return (
      jr(a), { lineLength: o, lineTokens: s, ruleStack: c.stack, stoppedEarly: c.stoppedEarly }
    );
  }
};
function Oi(e, t) {
...
var ki = class e {
    ...
    static fromExtension(t, n) {
      let r = t,
        i = t?.scopePath ?? null;
      for (let t of n)
        ((i = mr.push(i, t.scopeNames)), (r = new e(r, i, t.encodedTokenAttributes)));
      return r;
    }
    static createRoot(t, n) {
      return new e(null, new mr(null, t), n);
    }
    ...
    static mergeAttributes(e, t, n) {
      ...
      return (
        ...
        Tr.set(e, t.languageId, t.tokenType, null, r, i, a)
      );
    }
    pushAttributed(t, n) {
  ...
  Ai = class e {
    ...
    static _equals(e, t) {
      return e === t
        ...
        : this._structuralEquals(e, t)
          ? ki.equals(e.contentNameScopesList, t.contentNameScopesList)
          : !1;
    }
    ...
    static pushFrame(t, n) {
      let r = ki.fromExtension(t?.nameScopesList ?? null, n.nameScopesList);
      return new e(
        t,
        Xr(n.ruleId),
        n.enterPos ?? -1,
        ...
        n.endRule,
        r,
        ki.fromExtension(r, n.contentNameScopesList),
      );
    }
  },
  ji = class {
    ...
    constructor(e, t) {
      ((this.balancedBracketScopes = e.flatMap((e) =>
        e === `*` ? ((this.allowAny = !0), []) : Or(e, Ti).map((e) => e.matcher),
      )),
        (this.unbalancedBracketScopes = t.flatMap((e) => Or(e, Ti).map((e) => e.matcher))));
    }
    get matchesAlways() {
      ...
      if (this._emitBinaryTokens) {
        ...
        if (
          ...
          for (let e of this._tokenTypeOverrides)
            e.matcher(t) && (n = Tr.set(n, 0, Er(e.type), null, -1, 0, 0));
          this.balancedBracketSelectors && (r = this.balancedBracketSelectors.match(t));
        }
        if (
          (r && (n = Tr.set(n, 0, 8, r, -1, 0, 0)),
  ...
  Ni = class {
    ...
    grammarForScopeName(e, t, n, r, i) {
      if (!this._grammars.has(e)) {
        ...
        if (!a) return null;
        this._grammars.set(e, Ci(e, a, t, n, r, i, this, this._onigLib));
      }
  ...
  Pi = class {
    ...
    constructor(e) {
      ((this._options = e),
        (this._syncRegistry = new Ni(pr.createFromRawTheme(e.theme, e.colorMap), e.onigLib)),
    ...
    setTheme(e, t) {
      this._syncRegistry.setTheme(pr.createFromRawTheme(e, t));
    }
    getColorMap() {
    ...
    loadGrammarWithConfiguration(e, t, n) {
      return this._loadGrammar(
        ...
        n.embeddedLanguages,
        n.tokenTypes,
        new ji(n.balancedBracketSelectors || [], n.unbalancedBracketSelectors || []),
      );
    }
    loadGrammar(e) {
    ...
    _loadGrammar(e, t, n, r, i) {
      let a = new Fr(this._syncRegistry, e);
      for (; a.Q.length > 0; )
    ...
    ? e.map((e) =>
        e.flatMap((e) => {
          let t = n
            ...
            .map((t) => t - e.offset)
            .sort((e, t) => e - t);
          return t.length ? Yi(e, t) : e;
        }),
      )
    : e;
}
function Zi(e, t, n, r, i = `css-vars`) {
  let a = { content: e.content, explanation: e.explanation, offset: e.offset },
    o = t.map((t) => Qi(e.variants[t])),
...
function Qi(e) {
  ...
  if (
    ...
    (e.fontStyle & M.Italic && (t[`font-style`] = `italic`),
      e.fontStyle & M.Bold && (t[`font-weight`] = `bold`));
    let n = [];
    (e.fontStyle & M.Underline && n.push(`underline`),
      e.fontStyle & M.Strikethrough && n.push(`line-through`),
...
var ra = class e {
  ...
  static initial(t, n) {
    return new e(Object.fromEntries(Li(n).map((e) => [e, Fi])), t);
  }
  constructor(...e) {
    if (e.length === 2) {
      let [t, n] = e;
...
function aa(e, t) {
  if (!(e instanceof ra)) throw new j(`Invalid grammar state`);
...
function oa() {
  ...
  function t(t) {
    if (!e.has(t.meta)) {
      let n = function (e) {
          if (typeof e == `number`) {
            if (e < 0 || e > t.source.length)
              throw new j(`Invalid decoration offset: ${e}. Code length: ${t.source.length}`);
      ...
      (sa(i), e.set(t.meta, { decorations: i, converter: r, source: t.source }));
    }
    return e.get(t.meta);
  }
  return {
    ...
    code(e) {
      ...
      function i(e, t, n, i) {
        ...
        if (c === -1)
          throw new j(`Failed to find start index for decoration ${JSON.stringify(i.start)}`);
        if (l === -1)
          throw new j(`Failed to find end index for decoration ${JSON.stringify(i.end)}`);
      ...
      function o(e, t, n) {
        ...
        return (
          ...
          t.properties?.class && Ui(e, t.properties.class),
          (e = i(e, n) || e),
          e
        );
      }
...
function ca(e) {
  return e.type === `text` ? e.value : e.type === `element` ? e.children.map(ca).join(``) : ``;
}
var la = [oa()];
function ua(e) {
  let t = da(e.transformers || []);
  return [...t.pre, ...t.normal, ...t.post, ...la];
}
function da(e) {
  let t = [],
    n = [],
...
function ga(e) {
  ...
  for (; e.length > 0; ) {
    ...
    if (!Number.isNaN(r))
      if (r === 0) t.push({ type: `resetAll` });
      else if (r <= 9) pa[r] && t.push({ type: `setDecoration`, value: pa[r] });
      else if (r <= 29) {
        let e = pa[r - 20];
        e &&
        ...
        t.push({ type: `setForegroundColor`, value: { type: `named`, name: fa[r - 30] } });
      else if (r === 38) {
        let n = ha(e);
        n && t.push({ type: `setForegroundColor`, value: n });
      } else if (r === 39) t.push({ type: `resetForegroundColor` });
      else if (r <= 47)
        t.push({ type: `setBackgroundColor`, value: { type: `named`, name: fa[r - 40] } });
      else if (r === 48) {
        let n = ha(e);
            ...
            : r === 55
              ...
              : r >= 90 && r <= 97
                ? t.push({
                    ...
                    value: { type: `named`, name: fa[r - 90 + 8] },
                  })
                : r >= 100 &&
                  r <= 107 &&
                  t.push({
                    type: `setBackgroundColor`,
                    value: { type: `named`, name: fa[r - 100 + 8] },
                  });
  }
  return t;
}
...
function ya(e = va) {
  ...
  function i() {
    if (r) return r;
    r = [];
    for (let e = 0; e < fa.length; e++) r.push(t(fa[e]));
  ...
  return i.map((t) =>
    o.parse(t[0]).map((n) => {
      ...
      (n.decorations.has(`reverse`)
        ...
        (i = N(i, r)),
        (o = N(o, r)),
        n.decorations.has(`dim`) && (i = Sa(i)));
      let s = M.None;
      return (
        n.decorations.has(`bold`) && (s |= M.Bold),
        n.decorations.has(`italic`) && (s |= M.Italic),
        n.decorations.has(`underline`) && (s |= M.Underline),
        n.decorations.has(`strikethrough`) && (s |= M.Strikethrough),
...
function Ca(e, t, n = {}) {
  ...
  if (zi(i) || Vi(r)) return Wi(t).map((e) => [{ content: e[0], offset: e[1] }]);
  let { theme: a, colorMap: o } = e.setTheme(r);
  if (i === `ansi`) return xa(a, t, n);
...
function wa(...e) {
  if (e.length === 2) return na(e[1]);
  let [t, n, r = {}] = e,
    { lang: i = `text`, theme: a = t.getLoadedThemes()[0] } = r;
  if (zi(i) || Vi(a)) throw new j(`Plain language does not have grammar state`);
  if (i === `ansi`) throw new j(`ANSI language does not have grammar state`);
  let { theme: o, colorMap: s } = t.setTheme(a),
    c = t.getLanguage(i);
  return new ra(Ea(n, c, o, s, r).stateStack, c.name, o.name);
}
function Ta(e, t, n, r, i) {
  let a = Ea(e, t, n, r, i),
    o = new ra(a.stateStack, t.name, n.name);
  return (ta(a.tokens, o), a.tokens);
}
function Ea(e, t, n, r, i) {
  let a = Ii(n, i),
    ...
    c = Wi(e),
    l = i.grammarState
      ? (aa(i.grammarState, n.name) ?? Fi)
      : i.grammarContextCode == null
        ? Fi
        : Ea(i.grammarContextCode, t, n, r, {
            ...i,
            grammarState: void 0,
      ...
      if (i.includeExplanation) {
        ...
        for (; t + r < o; ) {
          ...
          ((r += n.length),
            d.explanation.push({
              content: n,
              scopes: i.includeExplanation === `scopeName` ? Da(t.scopes) : Oa(e, t.scopes),
            }),
            (g += 1));
        }
      }
...
function Oa(e, t) {
  ...
  for (let r = 0, i = t.length; r < i; r++) {
    let i = t[r];
    n[r] = { scopeName: i, themeMatches: ja(e, i, t.slice(0, r)) };
  }
  return n;
}
function ka(e, t) {
...
function Aa(e, t, n) {
  if (!ka(e[e.length - 1], t)) return !1;
  let r = e.length - 2,
    i = n.length - 1;
  for (; r >= 0 && i >= 0; ) (ka(e[r], n[i]) && --r, --i);
  return r === -1;
}
function ja(e, t, n) {
  let r = [];
...
function Pa(e, t, n) {
  ...
  if (`themes` in n) {
    ...
    if (f.length === 0) throw new j("`themes` option must not be empty");
    let p = Ma(e, t, n);
    if (((c = na(p)), l && qi !== l && !f.find((e) => e.color === l)))
      throw new j(`\`themes\` option must contain the defaultColor key \`${l}\``);
    let m = f.map((t) => e.getTheme(t.theme)),
      h = f.map((e) => e.color);
    ((a = p.map((e) => e.map((e) => Zi(e, h, u, l, d)))), c && ta(a, c));
    let g = f.map((e) => Ii(e.theme, n));
    ((i = Fa(f, m, g, u, l, `fg`, d)),
      (r = Fa(f, m, g, u, l, `bg`, d)),
    ...
    ((r = N(l.bg, s)), (i = N(l.fg, s)), (o = l.name), (c = na(a)));
...
function Ia(
  ...
  r = {
    meta: {},
    options: n,
    codeToHast: (t, n) => Ia(e, t, n),
    codeToTokens: (t, n) => Pa(e, t, n),
  },
) {
  let i = t;
  for (let e of ua(n)) i = e.preprocess?.call(r, i, n) || i;
  let { tokens: a, fg: o, bg: s, themeName: c, rootStyle: l, grammarState: u } = Pa(e, i, n),
    { mergeWhitespaces: d = !0, mergeSameStyleTokens: f = !1 } = n;
  (d === !0 ? (a = Ra(a)) : d === `never` && (a = za(a)), f && (a = Ba(a)));
  let p = {
    ...r,
    get source() {
      return i;
  ...
  for (let e of ua(n)) a = e.tokens?.call(p, a) || a;
  return La(
    a,
...
function Ra(e) {
  return e.map((e) => {
    ...
    return (
      e.forEach((i, a) => {
        let o = !(i.fontStyle && (i.fontStyle & M.Underline || i.fontStyle & M.Strikethrough));
...
function Ba(e) {
  return e.map((e) => {
    ...
    for (let n of e) {
      ...
      let e = t[t.length - 1],
        r = $i(e.htmlStyle || Qi(e)),
        i = $i(n.htmlStyle || Qi(n)),
        a = e.fontStyle && (e.fontStyle & M.Underline || e.fontStyle & M.Strikethrough),
        o = n.fontStyle && (n.fontStyle & M.Underline || n.fontStyle & M.Strikethrough);
...
function Ha(e, t, n) {
  let r = {
    ...
    i = Va(Ia(e, t, n, r));
  for (let e of ua(n)) i = e.postprocess?.call(r, i, n) || i;
  return i;
}
var Ua = { light: `#333333`, dark: `#bbbbbb` },
  Wa = { light: `#fffffe`, dark: `#1e1e1e` },
  Ga = `__shiki_resolved`;
function Ka(e) {
  if (e?.[Ga]) return e;
  let t = { ...e };
  ...
  if (!n || !r) {
    ...
    (e?.settings?.foreground && (r = e.settings.foreground),
      ...
      (r ||= t.type === `light` ? Ua.light : Ua.dark),
      (n ||= t.type === `light` ? Wa.light : Wa.dark),
      (t.fg = r),
      (t.bg = n));
  }
  ...
  return (Object.defineProperty(t, Ga, { enumerable: !1, writable: !1, value: !0 }), t);
}
async function qa(e) {
  return Array.from(
    new Set(
      (
        await Promise.all(
          e
            .filter((e) => !Bi(e))
            .map(async (e) => await Ri(e).then((e) => (Array.isArray(e) ? e : [e]))),
        )
      ).flat(),
    ),
  );
...
async function Ja(e) {
  return (await Promise.all(e.map(async (e) => (Hi(e) ? null : Ka(await Ri(e)))))).filter(
    (e) => !!e,
  );
}
var Ya = 3,
...
function $a(e, t) {
  ...
  if (t[e]) {
    ...
    for (; t[e]; ) {
      if (((e = t[e]), n.has(e)))
        throw new Qa(`Circular alias \`${Array.from(n).join(` -> `)} -> ${e}\``);
      n.add(e);
    }
  }
  return e;
}
var eo = class extends Pi {
    constructor(e, t, n, r = {}) {
      (super(e),
        (this._resolver = e),
        (this._themes = t),
    ...
    getLoadedThemes() {
      return (
        (this._loadedThemesCache ||= [...this._resolvedThemes.keys()]), this._loadedThemesCache
      );
    }
    setTheme(e) {
      let t = this._textmateThemeCache.get(e);
      (t || ((t = pr.createFromRawTheme(e)), this._textmateThemeCache.set(e, t)),
        this._syncRegistry.setTheme(t));
    }
    getGrammar(e) {
      return ((e = $a(e, this._alias)), this._resolvedGrammars.get(e));
    }
    loadLanguage(e) {
...
function ro(e) {
  ...
  let t = !1;
  if (!e.engine) throw new Qa("`engine` option is required for synchronous mode");
  let n = (e.langs || []).flat(1),
    r = (e.themes || []).flat(1).map(Ka),
    i = new eo(new to(e.engine, n), r, n, e.langAlias),
    a;
  function o(t) {
    return $a(t, e.langAlias);
  }
  function s(e) {
    g();
    let t = i.getGrammar(typeof e == `string` ? e : e.name);
    if (!t) throw new Qa(`Language \`${e}\` not found, you may need to load it first`);
    return t;
  }
  function c(e) {
    ...
    g();
    let t = i.getTheme(e);
    if (!t) throw new Qa(`Theme \`${e}\` not found, you may need to load it first`);
    return t;
  }
  function l(e) {
    g();
  ...
  async function h(...e) {
    return (g(), m(await Ja(e)));
  }
  function g() {
    if (t) throw new Qa(`Shiki instance has been disposed`);
  }
  function _() {
    t || ((t = !0), i.dispose(), --no);
  }
...
async function io(e) {
  ...
  let [t, n, r] = await Promise.all([Ja(e.themes || []), qa(e.langs || []), e.engine]);
  return ro({ ...e, themes: t, langs: n, engine: r });
}
async function ao(e) {
  let t = await io(e);
  return {
    getLastGrammarState: (...e) => wa(t, ...e),
    codeToTokensBase: (e, n) => Ca(t, e, n),
    codeToTokensWithThemes: (e, n) => Ma(t, e, n),
    codeToTokens: (e, n) => Pa(t, e, n),
    codeToHast: (e, n) => Ia(t, e, n),
    codeToHtml: (e, n) => Ha(t, e, n),
    getBundledLanguages: () => ({}),
    getBundledThemes: () => ({}),
    ...t,
...
function oo(e) {
  ...
  async function i(e) {
    function i(n) {
      if (typeof n == `string`) {
        if (((n = e.langAlias?.[n] || n), Bi(n))) return [];
        let r = t[n];
        if (!r)
          throw new j(
    ...
    let o = (e.themes ?? []).map((e) => a(e)),
      s = (e.langs ?? []).map((e) => i(e)),
      c = await ao({ engine: e.engine ?? r(), ...e, themes: o, langs: s });
    return {
      ...c,
      loadLanguage(...e) {
...
function so(e) {
  ...
  async function n(n = {}) {
    if (t) {
      let e = await t;
      return (
        await Promise.all([e.loadTheme(...(n.themes || [])), e.loadLanguage(...(n.langs || []))]), e
      );
    } else {
      t = e({ ...n, themes: [], langs: [] });
      let r = await t;
      return (
        await Promise.all([r.loadTheme(...(n.themes || [])), r.loadLanguage(...(n.langs || []))]), r
      );
    }
  }
  return n;
...
var lo = [
    {
      id: `abap`,
      name: `ABAP`,
      import: () => c(() => import(`./abap-PDe-Zryt.js`), [], import.meta.url),
    },
    {
      id: `actionscript-3`,
      name: `ActionScript`,
      import: () => c(() => import(`./actionscript-3.js`), [], import.meta.url),
    },
    { id: `ada`, name: `Ada`, import: () => c(() => import(`./ada.js`), [], import.meta.url) },
    {
      id: `angular-html`,
      name: `Angular HTML`,
      import: () =>
        c(() => import(`./angular-html.js`), __vite__mapDeps([0, 1, 2, 3, 4]), import.meta.url),
    },
    {
      id: `angular-ts`,
      name: `Angular TypeScript`,
      import: () =>
        c(() => import(`./angular-ts.js`), __vite__mapDeps([5, 1, 2, 3, 4, 6]), import.meta.url),
    },
    {
      id: `apache`,
      name: `Apache Conf`,
      import: () => c(() => import(`./apache.js`), [], import.meta.url),
    },
    { id: `apex`, name: `Apex`, import: () => c(() => import(`./apex.js`), [], import.meta.url) },
    {
      id: `apl`,
      name: `APL`,
      import: () =>
    ...
    },
    {
      id: `applescript`,
      name: `AppleScript`,
      import: () => c(() => import(`./applescript.js`), [], import.meta.url),
    },
    {
      id: `ara`,
      name: `Ara`,
      import: () => c(() => import(`./ara.js`), [], import.meta.url),
    },
    {
      id: `asciidoc`,
      name: `AsciiDoc`,
      aliases: [`adoc`],
      import: () => c(() => import(`./asciidoc.js`), [], import.meta.url),
    },
    { id: `asm`, name: `Assembly`, import: () => c(() => import(`./asm.js`), [], import.meta.url) },
    {
      id: `astro`,
      name: `Astro`,
      import: () =>
    ...
    { id: `awk`, name: `AWK`, import: () => c(() => import(`./awk.js`), [], import.meta.url) },
    {
      id: `ballerina`,
      name: `Ballerina`,
      import: () => c(() => import(`./ballerina-cGl-whLM.js`), [], import.meta.url),
    },
    {
      id: `bat`,
      name: `Batch File`,
      aliases: [`batch`],
      import: () => c(() => import(`./bat.js`), [], import.meta.url),
    },
    {
      id: `beancount`,
      name: `Beancount`,
      import: () => c(() => import(`./beancount.js`), [], import.meta.url),
    },
    {
      id: `berry`,
      name: `Berry`,
      aliases: [`be`],
      import: () => c(() => import(`./berry.js`), [], import.meta.url),
    },
    {
      id: `bibtex`,
      name: `BibTeX`,
      import: () => c(() => import(`./bibtex.js`), [], import.meta.url),
    },
    {
      id: `bicep`,
      name: `Bicep`,
      import: () => c(() => import(`./bicep.js`), [], import.meta.url),
    },
    {
      id: `blade`,
      name: `Blade`,
    ...
    },
    {
      ...
      name: `1C (Enterprise)`,
      aliases: [`1c`],
      import: () => c(() => import(`./bsl.js`), __vite__mapDeps([18, 19]), import.meta.url),
    },
    {
      id: `c`,
      name: `C`,
      import: () => c(() => import(`./c-1.js`), __vite__mapDeps([20, 21]), import.meta.url),
    },
    {
      id: `cadence`,
      name: `Cadence`,
      aliases: [`cdc`],
      import: () => c(() => import(`./cadence.js`), [], import.meta.url),
    },
    {
      id: `cairo`,
      name: `Cairo`,
      import: () => c(() => import(`./cairo.js`), __vite__mapDeps([22, 23]), import.meta.url),
    },
    {
      id: `clarity`,
      name: `Clarity`,
      import: () => c(() => import(`./clarity.js`), [], import.meta.url),
    },
    {
      id: `clojure`,
      name: `Clojure`,
      aliases: [`clj`],
      import: () => c(() => import(`./clojure.js`), [], import.meta.url),
    },
    {
      id: `cmake`,
      name: `CMake`,
      import: () => c(() => import(`./cmake.js`), __vite__mapDeps([24, 25]), import.meta.url),
    },
    {
      id: `cobol`,
      name: `COBOL`,
      import: () =>
        c(() => import(`./cobol.js`), __vite__mapDeps([26, 2, 3, 4, 10]), import.meta.url),
    },
    {
      id: `codeowners`,
      name: `CODEOWNERS`,
      import: () => c(() => import(`./codeowners.js`), [], import.meta.url),
    },
    {
      id: `codeql`,
      name: `CodeQL`,
      aliases: [`ql`],
      import: () => c(() => import(`./codeql.js`), [], import.meta.url),
    },
    {
      id: `coffee`,
      name: `CoffeeScript`,
      aliases: [`coffeescript`],
      import: () => c(() => import(`./coffee.js`), __vite__mapDeps([27, 4]), import.meta.url),
    },
    {
      id: `common-lisp`,
      name: `Common Lisp`,
      aliases: [`lisp`],
      import: () => c(() => import(`./common-lisp.js`), [], import.meta.url),
    },
    { id: `coq`, name: `Coq`, import: () => c(() => import(`./coq.js`), [], import.meta.url) },
    {
      id: `cpp`,
      name: `C++`,
      aliases: [`c++`],
    ...
    },
    {
      ...
      aliases: [`c#`, `cs`],
      import: () =>
        c(() => import(`./csharp-1.js`), __vite__mapDeps([34, 35]), import.meta.url),
    },
    {
      id: `css`,
      name: `CSS`,
      import: () => c(() => import(`./css-2.js`), __vite__mapDeps([36, 3]), import.meta.url),
    },
    {
      id: `csv`,
      name: `CSV`,
      import: () =>
        c(() => import(`./csv-1.js`), __vite__mapDeps([37, 38]), import.meta.url),
    },
    {
      id: `cue`,
      name: `CUE`,
      import: () => c(() => import(`./cue-CNI-4Tot.js`), [], import.meta.url),
    },
    {
      id: `cypher`,
      name: `Cypher`,
      aliases: [`cql`],
      import: () => c(() => import(`./cypher-7BX-J_b8.js`), [], import.meta.url),
    },
    { id: `d`, name: `D`, import: () => c(() => import(`./d.js`), [], import.meta.url) },
    {
      id: `dart`,
      name: `Dart`,
      import: () => c(() => import(`./dart.js`), [], import.meta.url),
    },
    {
      id: `dax`,
      name: `DAX`,
      import: () => c(() => import(`./dax-CwP-KBub.js`), [], import.meta.url),
    },
    {
      id: `desktop`,
      name: `Desktop`,
      import: () => c(() => import(`./desktop.js`), [], import.meta.url),
    },
    {
      id: `diff`,
      name: `Diff`,
      import: () => c(() => import(`./diff-2.js`), __vite__mapDeps([39, 40]), import.meta.url),
    },
    {
      id: `docker`,
      name: `Dockerfile`,
      aliases: [`dockerfile`],
      import: () => c(() => import(`./docker.js`), [], import.meta.url),
    },
    {
      id: `dotenv`,
      name: `dotEnv`,
      import: () => c(() => import(`./dotenv.js`), [], import.meta.url),
    },
    {
      id: `dream-maker`,
      name: `Dream Maker`,
      import: () => c(() => import(`./dream-maker.js`), [], import.meta.url),
    },
    {
      id: `edge`,
      name: `Edge`,
      import: () =>
        c(() => import(`./edge.js`), __vite__mapDeps([41, 16, 2, 3, 4, 14]), import.meta.url),
    },
    {
      id: `elixir`,
      name: `Elixir`,
      import: () =>
        c(() => import(`./elixir.js`), __vite__mapDeps([42, 2, 3, 4]), import.meta.url),
    },
    {
      id: `elm`,
      name: `Elm`,
      import: () =>
        c(() => import(`./elm-B.js`), __vite__mapDeps([43, 30, 21]), import.meta.url),
    },
    {
      id: `emacs-lisp`,
      name: `Emacs Lisp`,
      aliases: [`elisp`],
      import: () => c(() => import(`./emacs-lisp.js`), [], import.meta.url),
    },
    {
      id: `erb`,
      name: `ERB`,
    ...
    },
    {
      ...
      aliases: [`erl`],
      import: () =>
        c(() => import(`./erlang-eAvf-lqd.js`), __vite__mapDeps([51, 52]), import.meta.url),
    },
    {
      id: `fennel`,
      name: `Fennel`,
      import: () => c(() => import(`./fennel.js`), [], import.meta.url),
    },
    {
      id: `fish`,
      name: `Fish`,
      import: () => c(() => import(`./fish.js`), [], import.meta.url),
    },
    {
      id: `fluent`,
      name: `Fluent`,
      aliases: [`ftl`],
      import: () => c(() => import(`./fluent.js`), [], import.meta.url),
    },
    {
    ...
    },
    {
      ...
      import: () =>
        c(() => import(`./fortran-free-form-2.js`), __vite__mapDeps([55, 54]), import.meta.url),
    },
    {
      id: `fsharp`,
      name: `F#`,
      aliases: [`f#`, `fs`],
      import: () => c(() => import(`./fsharp.js`), __vite__mapDeps([56, 52]), import.meta.url),
    },
    {
      id: `gdresource`,
      name: `GDResource`,
      import: () =>
        c(() => import(`./gdresource.js`), __vite__mapDeps([57, 58, 59]), import.meta.url),
    },
    {
      id: `gdscript`,
      name: `GDScript`,
      import: () => c(() => import(`./gdscript-1.js`), __vite__mapDeps([60, 58]), import.meta.url),
    },
    {
      id: `gdshader`,
      name: `GDShader`,
      import: () => c(() => import(`./gdshader-1.js`), __vite__mapDeps([61, 59]), import.meta.url),
    },
    {
      id: `genie`,
      name: `Genie`,
      import: () => c(() => import(`./genie.js`), [], import.meta.url),
    },
    {
      id: `gherkin`,
      name: `Gherkin`,
      import: () => c(() => import(`./gherkin.js`), [], import.meta.url),
    },
    {
      id: `git-commit`,
      name: `Git Commit Message`,
      import: () => c(() => import(`./git-commit.js`), __vite__mapDeps([62, 40]), import.meta.url),
    },
    {
      id: `git-rebase`,
      name: `Git Rebase Message`,
      import: () =>
        c(() => import(`./git-rebase.js`), __vite__mapDeps([63, 33]), import.meta.url),
    },
    {
      id: `gleam`,
      name: `Gleam`,
      import: () => c(() => import(`./gleam.js`), [], import.meta.url),
    },
    {
      id: `glimmer-js`,
      name: `Glimmer JS`,
    ...
    },
    {
      ...
      aliases: [`gts`],
      import: () =>
        c(() => import(`./glimmer-ts.js`), __vite__mapDeps([65, 3, 2, 4, 14]), import.meta.url),
    },
    {
      id: `glsl`,
      name: `GLSL`,
      import: () =>
        c(() => import(`./glsl-1.js`), __vite__mapDeps([66, 30, 21]), import.meta.url),
    },
    {
      id: `gnuplot`,
      name: `Gnuplot`,
      import: () => c(() => import(`./gnuplot.js`), [], import.meta.url),
    },
    {
      id: `go`,
      name: `Go`,
      import: () => c(() => import(`./go-1.js`), __vite__mapDeps([67, 68]), import.meta.url),
    },
    {
      id: `graphql`,
      name: `GraphQL`,
    ...
    },
    {
      id: `groovy`,
      name: `Groovy`,
      import: () => c(() => import(`./groovy.js`), [], import.meta.url),
    },
    {
      id: `hack`,
      name: `Hack`,
      import: () =>
        c(() => import(`./hack.js`), __vite__mapDeps([70, 2, 3, 4, 17]), import.meta.url),
    },
    {
      id: `haml`,
      name: `Ruby Haml`,
      import: () => c(() => import(`./haml.js`), __vite__mapDeps([71, 48, 3, 4]), import.meta.url),
    },
    {
      id: `handlebars`,
      name: `Handlebars`,
    ...
    },
    {
      ...
      name: `Haskell`,
      aliases: [`hs`],
      import: () => c(() => import(`./haskell.js`), [], import.meta.url),
    },
    {
      id: `haxe`,
      name: `Haxe`,
      import: () =>
        c(() => import(`./haxe-1.js`), __vite__mapDeps([73, 74]), import.meta.url),
    },
    {
      id: `hcl`,
      name: `HashiCorp HCL`,
      import: () => c(() => import(`./hcl.js`), [], import.meta.url),
    },
    {
      id: `hjson`,
      name: `Hjson`,
      import: () => c(() => import(`./hjson.js`), [], import.meta.url),
    },
    {
      id: `hlsl`,
      name: `HLSL`,
      import: () => c(() => import(`./hlsl.js`), __vite__mapDeps([75, 76]), import.meta.url),
    },
    {
      id: `html`,
      name: `HTML`,
      import: () => c(() => import(`./html-1.js`), __vite__mapDeps([77, 2, 3, 4]), import.meta.url),
    },
    {
      id: `html-derivative`,
    ...
    },
    {
      id: `hxml`,
      name: `HXML`,
      import: () => c(() => import(`./hxml.js`), __vite__mapDeps([81, 74]), import.meta.url),
    },
    { id: `hy`, name: `Hy`, import: () => c(() => import(`./hy.js`), [], import.meta.url) },
    { id: `imba`, name: `Imba`, import: () => c(() => import(`./imba.js`), [], import.meta.url) },
    {
      id: `ini`,
      name: `INI`,
      aliases: [`properties`],
      import: () => c(() => import(`./ini.js`), [], import.meta.url),
    },
    {
      id: `java`,
      name: `Java`,
      import: () => c(() => import(`./java-1.js`), __vite__mapDeps([82, 10]), import.meta.url),
    },
    {
      id: `javascript`,
      name: `JavaScript`,
      aliases: [`js`, `cjs`, `mjs`],
      import: () => c(() => import(`./javascript-1.js`), __vite__mapDeps([83, 4]), import.meta.url),
    },
    {
      id: `jinja`,
      name: `Jinja`,
      import: () => c(() => import(`./jinja.js`), __vite__mapDeps([84, 2, 3, 4]), import.meta.url),
    },
    {
      id: `jison`,
      name: `Jison`,
      import: () => c(() => import(`./jison.js`), __vite__mapDeps([85, 4]), import.meta.url),
    },
    {
      id: `json`,
      name: `JSON`,
      import: () => c(() => import(`./json-3.js`), __vite__mapDeps([86, 8]), import.meta.url),
    },
    {
      id: `json5`,
      name: `JSON5`,
      import: () => c(() => import(`./json5.js`), [], import.meta.url),
    },
    {
      id: `jsonc`,
      name: `JSON with Comments`,
      import: () => c(() => import(`./jsonc.js`), [], import.meta.url),
    },
    {
      id: `jsonl`,
      name: `JSON Lines`,
      import: () => c(() => import(`./jsonl.js`), [], import.meta.url),
    },
    {
      id: `jsonnet`,
      name: `Jsonnet`,
      import: () => c(() => import(`./jsonnet.js`), [], import.meta.url),
    },
    {
      id: `jssm`,
      name: `JSSM`,
      aliases: [`fsl`],
      import: () => c(() => import(`./jssm.js`), [], import.meta.url),
    },
    {
      id: `jsx`,
      name: `JSX`,
      import: () =>
        c(() => import(`./jsx-1.js`), __vite__mapDeps([87, 47]), import.meta.url),
    },
    {
      id: `julia`,
      name: `Julia`,
    ...
    { id: `kdl`, name: `KDL`, import: () => c(() => import(`./kdl.js`), [], import.meta.url) },
    {
      id: `kotlin`,
      name: `Kotlin`,
      aliases: [`kt`, `kts`],
      import: () => c(() => import(`./kotlin.js`), [], import.meta.url),
    },
    {
      id: `kusto`,
      name: `Kusto`,
      aliases: [`kql`],
      import: () => c(() => import(`./kusto.js`), [], import.meta.url),
    },
    {
      id: `latex`,
      name: `LaTeX`,
      import: () =>
        c(() => import(`./latex.js`), __vite__mapDeps([90, 91, 89]), import.meta.url),
    },
    {
      id: `lean`,
      name: `Lean 4`,
      aliases: [`lean4`],
      import: () => c(() => import(`./lean.js`), [], import.meta.url),
    },
    {
      id: `less`,
      name: `Less`,
      import: () => c(() => import(`./less-1.js`), __vite__mapDeps([92, 93]), import.meta.url),
    },
    {
      id: `liquid`,
      name: `Liquid`,
      import: () =>
        c(() => import(`./liquid.js`), __vite__mapDeps([94, 3, 2, 4, 8]), import.meta.url),
    },
    {
      id: `llvm`,
      name: `LLVM IR`,
      import: () => c(() => import(`./llvm.js`), [], import.meta.url),
    },
    { id: `log`, name: `Log file`, import: () => c(() => import(`./log.js`), [], import.meta.url) },
    { id: `logo`, name: `Logo`, import: () => c(() => import(`./logo.js`), [], import.meta.url) },
    {
      id: `lua`,
      name: `Lua`,
      import: () =>
        c(() => import(`./lua-1.js`), __vite__mapDeps([95, 49, 21]), import.meta.url),
    },
    { id: `luau`, name: `Luau`, import: () => c(() => import(`./luau.js`), [], import.meta.url) },
    {
      id: `make`,
      name: `Makefile`,
      aliases: [`makefile`],
      import: () => c(() => import(`./make.js`), [], import.meta.url),
    },
    {
      id: `markdown`,
      name: `Markdown`,
      aliases: [`md`],
      import: () => c(() => import(`./markdown-1.js`), __vite__mapDeps([96, 52]), import.meta.url),
    },
    {
      id: `marko`,
      name: `Marko`,
      import: () =>
        c(() => import(`./marko.js`), __vite__mapDeps([97, 3, 93, 6, 14]), import.meta.url),
    },
    {
      id: `matlab`,
      name: `MATLAB`,
      import: () => c(() => import(`./matlab.js`), [], import.meta.url),
    },
    {
      id: `mdc`,
      name: `MDC`,
    ...
    { id: `mdx`, name: `MDX`, import: () => c(() => import(`./mdx.js`), [], import.meta.url) },
    {
      id: `mermaid`,
      name: `Mermaid`,
      aliases: [`mmd`],
      import: () => c(() => import(`./mermaid.js`), [], import.meta.url),
    },
    {
      id: `mipsasm`,
      name: `MIPS Assembly`,
      aliases: [`mips`],
      import: () => c(() => import(`./mipsasm.js`), [], import.meta.url),
    },
    { id: `mojo`, name: `Mojo`, import: () => c(() => import(`./mojo.js`), [], import.meta.url) },
    {
      id: `move`,
      name: `Move`,
      import: () => c(() => import(`./move.js`), [], import.meta.url),
    },
    {
      id: `narrat`,
      name: `Narrat Language`,
      aliases: [`nar`],
      import: () => c(() => import(`./narrat.js`), [], import.meta.url),
    },
    {
      id: `nextflow`,
      name: `Nextflow`,
      aliases: [`nf`],
      import: () => c(() => import(`./nextflow-DzKS-iEs.js`), [], import.meta.url),
    },
    {
      id: `nginx`,
      name: `Nginx`,
      import: () => c(() => import(`./nginx.js`), __vite__mapDeps([99, 49, 21]), import.meta.url),
    },
    {
      id: `nim`,
      name: `Nim`,
    ...
    { id: `nix`, name: `Nix`, import: () => c(() => import(`./nix.js`), [], import.meta.url) },
    {
      id: `nushell`,
      name: `nushell`,
      aliases: [`nu`],
      import: () => c(() => import(`./nushell.js`), [], import.meta.url),
    },
    {
      id: `objective-c`,
      name: `Objective-C`,
      aliases: [`objc`],
      import: () => c(() => import(`./objective-c.js`), [], import.meta.url),
    },
    {
      id: `objective-cpp`,
      name: `Objective-C++`,
      import: () => c(() => import(`./objective-cpp.js`), [], import.meta.url),
    },
    {
      id: `ocaml`,
      name: `OCaml`,
      import: () => c(() => import(`./ocaml.js`), [], import.meta.url),
    },
    {
      id: `openscad`,
      name: `OpenSCAD`,
      aliases: [`scad`],
      import: () => c(() => import(`./openscad.js`), [], import.meta.url),
    },
    {
      id: `pascal`,
      name: `Pascal`,
      import: () => c(() => import(`./pascal.js`), [], import.meta.url),
    },
    {
      id: `perl`,
      name: `Perl`,
      import: () =>
        c(() => import(`./perl.js`), __vite__mapDeps([101, 3, 2, 4, 17, 9, 10]), import.meta.url),
    },
    {
      id: `php`,
      name: `PHP`,
    ...
    { id: `pkl`, name: `Pkl`, import: () => c(() => import(`./pkl.js`), [], import.meta.url) },
    {
      id: `plsql`,
      name: `PL/SQL`,
      import: () => c(() => import(`./plsql.js`), [], import.meta.url),
    },
    {
      id: `po`,
      name: `Gettext PO`,
      aliases: [`pot`, `potx`],
      import: () => c(() => import(`./po.js`), [], import.meta.url),
    },
    {
      id: `polar`,
      name: `Polar`,
      import: () => c(() => import(`./polar.js`), [], import.meta.url),
    },
    {
      id: `postcss`,
      name: `PostCSS`,
      import: () => c(() => import(`./postcss-1.js`), __vite__mapDeps([104, 12]), import.meta.url),
    },
    {
      id: `powerquery`,
      name: `PowerQuery`,
      import: () => c(() => import(`./powerquery.js`), [], import.meta.url),
    },
    {
      id: `powershell`,
      name: `PowerShell`,
      aliases: [`ps`, `ps1`],
      import: () => c(() => import(`./powershell.js`), [], import.meta.url),
    },
    {
      id: `prisma`,
      name: `Prisma`,
      import: () => c(() => import(`./prisma.js`), [], import.meta.url),
    },
    {
      id: `prolog`,
      name: `Prolog`,
      import: () => c(() => import(`./prolog.js`), [], import.meta.url),
    },
    {
      id: `proto`,
      name: `Protocol Buffer 3`,
      aliases: [`protobuf`],
      import: () => c(() => import(`./proto.js`), [], import.meta.url),
    },
    {
      id: `pug`,
      name: `Pug`,
      aliases: [`jade`],
      import: () => c(() => import(`./pug.js`), __vite__mapDeps([105, 3, 2, 4]), import.meta.url),
    },
    {
      id: `puppet`,
      name: `Puppet`,
      import: () => c(() => import(`./puppet.js`), [], import.meta.url),
    },
    {
      id: `purescript`,
      name: `PureScript`,
      import: () => c(() => import(`./purescript.js`), [], import.meta.url),
    },
    {
      id: `python`,
      name: `Python`,
      aliases: [`py`],
      import: () => c(() => import(`./python-1.js`), __vite__mapDeps([106, 23]), import.meta.url),
    },
    {
      id: `qml`,
      name: `QML`,
      import: () =>
        c(() => import(`./qml.js`), __vite__mapDeps([107, 4]), import.meta.url),
    },
    {
      id: `qmldir`,
      name: `QML Directory`,
      import: () => c(() => import(`./qmldir.js`), [], import.meta.url),
    },
    {
      id: `qss`,
      name: `Qt Style Sheets`,
      import: () => c(() => import(`./qss.js`), [], import.meta.url),
    },
    {
      id: `r`,
      name: `R`,
      import: () => c(() => import(`./r-1.js`), __vite__mapDeps([108, 89]), import.meta.url),
    },
    {
      id: `racket`,
      name: `Racket`,
      import: () => c(() => import(`./racket.js`), [], import.meta.url),
    },
    {
      id: `raku`,
      name: `Raku`,
      aliases: [`perl6`],
      import: () => c(() => import(`./raku.js`), [], import.meta.url),
    },
    {
      id: `razor`,
      name: `ASP.NET Razor`,
      import: () =>
        c(() => import(`./razor.js`), __vite__mapDeps([109, 35, 2, 3, 4]), import.meta.url),
    },
    {
      id: `reg`,
      name: `Windows Registry Script`,
      import: () => c(() => import(`./reg.js`), [], import.meta.url),
    },
    {
      id: `regexp`,
      name: `RegExp`,
      aliases: [`regex`],
      import: () => c(() => import(`./regexp-2.js`), __vite__mapDeps([110, 31]), import.meta.url),
    },
    { id: `rel`, name: `Rel`, import: () => c(() => import(`./rel.js`), [], import.meta.url) },
    {
      id: `riscv`,
      name: `RISC-V`,
      import: () => c(() => import(`./riscv.js`), [], import.meta.url),
    },
    {
      id: `rosmsg`,
      name: `ROS Interface`,
      import: () => c(() => import(`./rosmsg.js`), [], import.meta.url),
    },
    {
      id: `rst`,
    ...
    },
    {
      ...
      name: `Rust`,
      aliases: [`rs`],
      import: () => c(() => import(`./rust.js`), [], import.meta.url),
    },
    {
      id: `sas`,
      name: `SAS`,
      import: () =>
        c(() => import(`./sas.js`), __vite__mapDeps([113, 17]), import.meta.url),
    },
    { id: `sass`, name: `Sass`, import: () => c(() => import(`./sass.js`), [], import.meta.url) },
    {
      id: `scala`,
      name: `Scala`,
      import: () => c(() => import(`./scala.js`), [], import.meta.url),
    },
    {
      id: `scheme`,
      name: `Scheme`,
      import: () => c(() => import(`./scheme.js`), [], import.meta.url),
    },
    {
      id: `scss`,
      name: `SCSS`,
      import: () => c(() => import(`./scss-1.js`), __vite__mapDeps([114, 6, 3]), import.meta.url),
    },
    {
      id: `sdbl`,
      name: `1C (Query)`,
      aliases: [`1c-query`],
      import: () =>
        c(() => import(`./sdbl-1.js`), __vite__mapDeps([115, 19]), import.meta.url),
    },
    {
      id: `shaderlab`,
      name: `ShaderLab`,
      aliases: [`shader`],
      import: () =>
        c(() => import(`./shaderlab.js`), __vite__mapDeps([116, 76]), import.meta.url),
    },
    {
      id: `shellscript`,
      name: `Shell`,
      ...
      import: () =>
        c(() => import(`./shellscript-2.js`), __vite__mapDeps([117, 33]), import.meta.url),
    },
    {
      id: `shellsession`,
      name: `Shell Session`,
      aliases: [`console`],
      import: () =>
        c(() => import(`./shellsession.js`), __vite__mapDeps([118, 33]), import.meta.url),
    },
    {
      id: `smalltalk`,
      name: `Smalltalk`,
      import: () => c(() => import(`./smalltalk-DJ-wOC2Z.js`), [], import.meta.url),
    },
    {
      id: `solidity`,
      name: `Solidity`,
      import: () => c(() => import(`./solidity.js`), [], import.meta.url),
    },
    {
      id: `soy`,
      name: `Closure Templates`,
      aliases: [`closure-templates`],
      import: () => c(() => import(`./soy.js`), __vite__mapDeps([119, 2, 3, 4]), import.meta.url),
    },
    {
      id: `sparql`,
      name: `SPARQL`,
      import: () => c(() => import(`./sparql.js`), __vite__mapDeps([120, 121]), import.meta.url),
    },
    {
      id: `splunk`,
      name: `Splunk Query Language`,
      aliases: [`spl`],
      import: () => c(() => import(`./splunk.js`), [], import.meta.url),
    },
    {
      id: `sql`,
      name: `SQL`,
      import: () => c(() => import(`./sql-2.js`), __vite__mapDeps([122, 17]), import.meta.url),
    },
    {
      id: `ssh-config`,
      name: `SSH Config`,
      import: () => c(() => import(`./ssh-config.js`), [], import.meta.url),
    },
    {
      id: `stata`,
      name: `Stata`,
      import: () =>
        c(() => import(`./stata.js`), __vite__mapDeps([123, 17]), import.meta.url),
    },
    {
      id: `stylus`,
      name: `Stylus`,
      aliases: [`styl`],
      import: () =>
        c(() => import(`./stylus-il-x193g.js`), __vite__mapDeps([124, 125]), import.meta.url),
    },
    {
      id: `svelte`,
      name: `Svelte`,
      import: () =>
        c(() => import(`./svelte.js`), __vite__mapDeps([126, 3, 4, 12, 14]), import.meta.url),
    },
    {
      id: `swift`,
      name: `Swift`,
      import: () => c(() => import(`./swift.js`), [], import.meta.url),
    },
    {
      id: `system-verilog`,
      name: `SystemVerilog`,
      import: () => c(() => import(`./system-verilog.js`), [], import.meta.url),
    },
    {
      id: `systemd`,
      name: `Systemd Units`,
      import: () => c(() => import(`./systemd-B.js`), [], import.meta.url),
    },
    {
      id: `talonscript`,
      name: `TalonScript`,
      aliases: [`talon`],
      import: () => c(() => import(`./talonscript.js`), [], import.meta.url),
    },
    { id: `tasl`, name: `Tasl`, import: () => c(() => import(`./tasl.js`), [], import.meta.url) },
    { id: `tcl`, name: `Tcl`, import: () => c(() => import(`./tcl.js`), [], import.meta.url) },
    {
      id: `templ`,
      name: `Templ`,
      import: () =>
        c(() => import(`./templ.js`), __vite__mapDeps([127, 3, 68, 4]), import.meta.url),
    },
    {
      id: `terraform`,
      name: `Terraform`,
      aliases: [`tf`, `tfvars`],
      import: () => c(() => import(`./terraform-Ba-OT7ol.js`), [], import.meta.url),
    },
    {
      id: `tex`,
      name: `TeX`,
      import: () => c(() => import(`./tex-2.js`), __vite__mapDeps([128, 91, 89]), import.meta.url),
    },
    { id: `toml`, name: `TOML`, import: () => c(() => import(`./toml.js`), [], import.meta.url) },
    {
      id: `ts-tags`,
    ...
    },
    {
      id: `tsv`,
      name: `TSV`,
      import: () => c(() => import(`./tsv.js`), [], import.meta.url),
    },
    {
      id: `tsx`,
      name: `TSX`,
      import: () => c(() => import(`./tsx.js`), __vite__mapDeps([130, 13]), import.meta.url),
    },
    {
      id: `turtle`,
      name: `Turtle`,
      import: () =>
        c(() => import(`./turtle-D-7MiC-W.js`), __vite__mapDeps([131, 121]), import.meta.url),
    },
    {
      id: `twig`,
      name: `Twig`,
    ...
    },
    {
      ...
      name: `TypeScript`,
      aliases: [`ts`, `cts`, `mts`],
      import: () => c(() => import(`./typescript.js`), __vite__mapDeps([133, 14]), import.meta.url),
    },
    {
      id: `typespec`,
      name: `TypeSpec`,
      aliases: [`tsp`],
      import: () => c(() => import(`./typespec.js`), [], import.meta.url),
    },
    {
      id: `typst`,
      name: `Typst`,
      aliases: [`typ`],
      import: () => c(() => import(`./typst.js`), [], import.meta.url),
    },
    { id: `v`, name: `V`, import: () => c(() => import(`./v.js`), [], import.meta.url) },
    {
      id: `vala`,
      name: `Vala`,
      import: () => c(() => import(`./vala.js`), [], import.meta.url),
    },
    {
      id: `vb`,
      name: `Visual Basic`,
      aliases: [`cmd`],
      import: () => c(() => import(`./vb.js`), [], import.meta.url),
    },
    {
      id: `verilog`,
      name: `Verilog`,
      import: () => c(() => import(`./verilog.js`), [], import.meta.url),
    },
    {
      id: `vhdl`,
      name: `VHDL`,
      import: () => c(() => import(`./vhdl.js`), [], import.meta.url),
    },
    {
      id: `viml`,
      name: `Vim Script`,
      aliases: [`vim`, `vimscript`],
      import: () => c(() => import(`./viml.js`), [], import.meta.url),
    },
    {
      id: `vue`,
      name: `Vue`,
    ...
    },
    {
      ...
      name: `Vyper`,
      aliases: [`vy`],
      import: () => c(() => import(`./vyper.js`), [], import.meta.url),
    },
    {
      id: `wasm`,
      name: `WebAssembly`,
      import: () => c(() => import(`./wasm-2.js`), [], import.meta.url),
    },
    {
      id: `wenyan`,
      name: `Wenyan`,
      aliases: [`文言`],
      import: () => c(() => import(`./wenyan.js`), [], import.meta.url),
    },
    { id: `wgsl`, name: `WGSL`, import: () => c(() => import(`./wgsl.js`), [], import.meta.url) },
    {
      id: `wikitext`,
      name: `Wikitext`,
      aliases: [`mediawiki`, `wiki`],
      import: () => c(() => import(`./wikitext.js`), [], import.meta.url),
    },
    {
      id: `wit`,
      name: `WebAssembly Interface Types`,
      import: () => c(() => import(`./wit.js`), [], import.meta.url),
    },
    {
      id: `wolfram`,
      name: `Wolfram`,
      aliases: [`wl`],
      import: () => c(() => import(`./wolfram.js`), [], import.meta.url),
    },
    {
      id: `xml`,
      name: `XML`,
      import: () =>
        c(() => import(`./xml-1.js`), __vite__mapDeps([138, 9, 10]), import.meta.url),
    },
    {
      id: `xsl`,
      name: `XSL`,
      import: () =>
        c(() => import(`./xsl.js`), __vite__mapDeps([139, 9, 10]), import.meta.url),
    },
    {
      id: `yaml`,
      name: `YAML`,
      aliases: [`yml`],
      import: () => c(() => import(`./yaml.js`), __vite__mapDeps([140, 50]), import.meta.url),
    },
    {
      id: `zenscript`,
      name: `ZenScript`,
      import: () => c(() => import(`./zenscript.js`), [], import.meta.url),
    },
    { id: `zig`, name: `Zig`, import: () => c(() => import(`./zig.js`), [], import.meta.url) },
  ],
  uo = Object.fromEntries(lo.map((e) => [e.id, e.import])),
  fo = Object.fromEntries(lo.flatMap((e) => e.aliases?.map((t) => [t, e.import]) || [])),
  po = { ...uo, ...fo },
    ...
    [
      {
        ...
        type: `dark`,
        import: () => c(() => import(`./andromeeda.js`), [], import.meta.url),
      },
      {
        id: `aurora-x`,
        displayName: `Aurora X`,
        type: `dark`,
        import: () => c(() => import(`./aurora-x.js`), [], import.meta.url),
      },
      {
        id: `ayu-dark`,
        displayName: `Ayu Dark`,
        type: `dark`,
        import: () => c(() => import(`./ayu-dark.js`), [], import.meta.url),
      },
      {
        id: `catppuccin-frappe`,
        displayName: `Catppuccin Frappé`,
        type: `dark`,
        import: () => c(() => import(`./catppuccin-frappe.js`), [], import.meta.url),
      },
      {
        id: `catppuccin-latte`,
        displayName: `Catppuccin Latte`,
        type: `light`,
        import: () => c(() => import(`./catppuccin-latte.js`), [], import.meta.url),
      },
      {
        id: `catppuccin-macchiato`,
        displayName: `Catppuccin Macchiato`,
        type: `dark`,
        import: () => c(() => import(`./catppuccin-macchiato.js`), [], import.meta.url),
      },
      {
        id: `catppuccin-mocha`,
        displayName: `Catppuccin Mocha`,
        type: `dark`,
        import: () => c(() => import(`./catppuccin-mocha.js`), [], import.meta.url),
      },
      {
        id: `dark-plus`,
        displayName: `Dark Plus`,
        type: `dark`,
        import: () => c(() => import(`./dark-plus.js`), [], import.meta.url),
      },
      {
        id: `dracula`,
        displayName: `Dracula Theme`,
        type: `dark`,
        import: () => c(() => import(`./dracula.js`), [], import.meta.url),
      },
      {
        id: `dracula-soft`,
        displayName: `Dracula Theme Soft`,
        type: `dark`,
        import: () => c(() => import(`./dracula-soft.js`), [], import.meta.url),
      },
      {
        id: `everforest-dark`,
        displayName: `Everforest Dark`,
        type: `dark`,
        import: () => c(() => import(`./everforest-dark.js`), [], import.meta.url),
      },
      {
        id: `everforest-light`,
        displayName: `Everforest Light`,
        type: `light`,
        import: () => c(() => import(`./everforest-light.js`), [], import.meta.url),
      },
      {
        id: `github-dark`,
        displayName: `GitHub Dark`,
        type: `dark`,
        import: () => c(() => import(`./github-dark.js`), [], import.meta.url),
      },
      {
        id: `github-dark-default`,
        displayName: `GitHub Dark Default`,
        type: `dark`,
        import: () => c(() => import(`./github-dark-default.js`), [], import.meta.url),
      },
      {
        id: `github-dark-dimmed`,
        displayName: `GitHub Dark Dimmed`,
        type: `dark`,
        import: () => c(() => import(`./github-dark-dimmed.js`), [], import.meta.url),
      },
      {
        id: `github-dark-high-contrast`,
        displayName: `GitHub Dark High Contrast`,
        type: `dark`,
        import: () => c(() => import(`./github-dark-high-contrast.js`), [], import.meta.url),
      },
      {
        id: `github-light`,
        displayName: `GitHub Light`,
        type: `light`,
        import: () => c(() => import(`./github-light.js`), [], import.meta.url),
      },
      {
        id: `github-light-default`,
        displayName: `GitHub Light Default`,
        type: `light`,
        import: () => c(() => import(`./github-light-default.js`), [], import.meta.url),
      },
      {
        id: `github-light-high-contrast`,
        displayName: `GitHub Light High Contrast`,
        type: `light`,
        import: () => c(() => import(`./github-light-high-contrast.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-dark-hard`,
        displayName: `Gruvbox Dark Hard`,
        type: `dark`,
        import: () => c(() => import(`./gruvbox-dark-hard.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-dark-medium`,
        displayName: `Gruvbox Dark Medium`,
        type: `dark`,
        import: () => c(() => import(`./gruvbox-dark-medium.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-dark-soft`,
        displayName: `Gruvbox Dark Soft`,
        type: `dark`,
        import: () => c(() => import(`./gruvbox-dark-soft.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-light-hard`,
        displayName: `Gruvbox Light Hard`,
        type: `light`,
        import: () => c(() => import(`./gruvbox-light-hard.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-light-medium`,
        displayName: `Gruvbox Light Medium`,
        type: `light`,
        import: () => c(() => import(`./gruvbox-light-medium.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-light-soft`,
        displayName: `Gruvbox Light Soft`,
        type: `light`,
        import: () => c(() => import(`./gruvbox-light-soft-Ci-j7O4Q.js`), [], import.meta.url),
      },
      {
        id: `houston`,
        displayName: `Houston`,
        type: `dark`,
        import: () => c(() => import(`./houston.js`), [], import.meta.url),
      },
      {
        id: `kanagawa-dragon`,
        displayName: `Kanagawa Dragon`,
        type: `dark`,
        import: () => c(() => import(`./kanagawa-dragon.js`), [], import.meta.url),
      },
      {
        id: `kanagawa-lotus`,
        displayName: `Kanagawa Lotus`,
        type: `light`,
        import: () => c(() => import(`./kanagawa-lotus.js`), [], import.meta.url),
      },
      {
        id: `kanagawa-wave`,
        displayName: `Kanagawa Wave`,
        type: `dark`,
        import: () => c(() => import(`./kanagawa-wave.js`), [], import.meta.url),
      },
      {
        id: `laserwave`,
        displayName: `LaserWave`,
        type: `dark`,
        import: () => c(() => import(`./laserwave-Dwpp-WD9.js`), [], import.meta.url),
      },
      {
        id: `light-plus`,
        displayName: `Light Plus`,
        type: `light`,
        import: () => c(() => import(`./light-plus.js`), [], import.meta.url),
      },
      {
        id: `material-theme`,
        displayName: `Material Theme`,
        type: `dark`,
        import: () => c(() => import(`./material-theme.js`), [], import.meta.url),
      },
      {
        id: `material-theme-darker`,
        displayName: `Material Theme Darker`,
        type: `dark`,
        import: () => c(() => import(`./material-theme-darker.js`), [], import.meta.url),
      },
      {
        id: `material-theme-lighter`,
        displayName: `Material Theme Lighter`,
        type: `light`,
        import: () => c(() => import(`./material-theme-lighter.js`), [], import.meta.url),
      },
      {
        id: `material-theme-ocean`,
        displayName: `Material Theme Ocean`,
        type: `dark`,
        import: () => c(() => import(`./material-theme-ocean.js`), [], import.meta.url),
      },
      {
        ...
        type: `dark`,
        import: () =>
          c(() => import(`./material-theme-palenight.js`), [], import.meta.url),
      },
      {
        id: `min-dark`,
        displayName: `Min Dark`,
        type: `dark`,
        import: () => c(() => import(`./min-dark.js`), [], import.meta.url),
      },
      {
        id: `min-light`,
        displayName: `Min Light`,
        type: `light`,
        import: () => c(() => import(`./min-light.js`), [], import.meta.url),
      },
      {
        id: `monokai`,
        displayName: `Monokai`,
        type: `dark`,
        import: () => c(() => import(`./monokai.js`), [], import.meta.url),
      },
      {
        id: `night-owl`,
        displayName: `Night Owl`,
        type: `dark`,
        import: () => c(() => import(`./night-owl.js`), [], import.meta.url),
      },
      {
        id: `nord`,
        displayName: `Nord`,
        type: `dark`,
        import: () => c(() => import(`./nord.js`), [], import.meta.url),
      },
      {
        id: `one-dark-pro`,
        displayName: `One Dark Pro`,
        type: `dark`,
        import: () => c(() => import(`./one-dark-pro.js`), [], import.meta.url),
      },
      {
        id: `one-light`,
        displayName: `One Light`,
        type: `light`,
        import: () => c(() => import(`./one-light.js`), [], import.meta.url),
      },
      {
        id: `plastic`,
        displayName: `Plastic`,
        type: `dark`,
        import: () => c(() => import(`./plastic.js`), [], import.meta.url),
      },
      {
        id: `poimandres`,
        displayName: `Poimandres`,
        type: `dark`,
        import: () => c(() => import(`./poimandres.js`), [], import.meta.url),
      },
      {
        id: `red`,
        displayName: `Red`,
        type: `dark`,
        import: () => c(() => import(`./red.js`), [], import.meta.url),
      },
      {
        id: `rose-pine`,
        displayName: `Rosé Pine`,
        type: `dark`,
        import: () => c(() => import(`./rose-pine.js`), [], import.meta.url),
      },
      {
        id: `rose-pine-dawn`,
        displayName: `Rosé Pine Dawn`,
        type: `light`,
        import: () => c(() => import(`./rose-pine-dawn.js`), [], import.meta.url),
      },
      {
        id: `rose-pine-moon`,
        displayName: `Rosé Pine Moon`,
        type: `dark`,
        import: () => c(() => import(`./rose-pine-moon.js`), [], import.meta.url),
      },
      {
        id: `slack-dark`,
        displayName: `Slack Dark`,
        type: `dark`,
        import: () => c(() => import(`./slack-dark.js`), [], import.meta.url),
      },
      {
        id: `slack-ochin`,
        displayName: `Slack Ochin`,
        type: `light`,
        import: () => c(() => import(`./slack-ochin.js`), [], import.meta.url),
      },
      {
        id: `snazzy-light`,
        displayName: `Snazzy Light`,
        type: `light`,
        import: () => c(() => import(`./snazzy-light.js`), [], import.meta.url),
      },
      {
        id: `solarized-dark`,
        displayName: `Solarized Dark`,
        type: `dark`,
        import: () => c(() => import(`./solarized-dark.js`), [], import.meta.url),
      },
      {
        id: `solarized-light`,
        displayName: `Solarized Light`,
        type: `light`,
        import: () => c(() => import(`./solarized-light.js`), [], import.meta.url),
      },
      {
        id: `synthwave-84`,
        displayName: `Synthwave '84`,
        type: `dark`,
        import: () => c(() => import(`./synthwave-84-B0vq-ixW.js`), [], import.meta.url),
      },
      {
        id: `tokyo-night`,
        displayName: `Tokyo Night`,
        type: `dark`,
        import: () => c(() => import(`./tokyo-night.js`), [], import.meta.url),
      },
      {
        id: `vesper`,
        displayName: `Vesper`,
        type: `dark`,
        import: () => c(() => import(`./vesper-C.js`), [], import.meta.url),
      },
      {
        id: `vitesse-black`,
        displayName: `Vitesse Black`,
        type: `dark`,
        import: () => c(() => import(`./vitesse-black.js`), [], import.meta.url),
      },
      {
        id: `vitesse-dark`,
        displayName: `Vitesse Dark`,
        type: `dark`,
        import: () => c(() => import(`./vitesse-dark.js`), [], import.meta.url),
      },
      {
        id: `vitesse-light`,
        displayName: `Vitesse Light`,
        type: `light`,
        import: () => c(() => import(`./vitesse-light.js`), [], import.meta.url),
      },
    ].map((e) => [e.id, e.import]),
  ),
...
async function yo(e) {
  ...
  function s(e) {
    ...
    for (let r = 1; r <= 4; r *= 2) {
      let i = t * (1 + 0.2 / r);
      if (((i = Math.min(i, e + 100663296)), o(Math.min(n, vo(Math.max(e, i), 65536))))) return !0;
    }
    return !1;
  }
...
var bo = Object.defineProperty,
  xo = (e, t, n) =>
    t in e ? bo(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n),
  P = (e, t, n) => xo(e, typeof t == `symbol` ? t : t + ``, n),
  F = null;
function So(e) {
  throw new ho(e.UTF8ToString(e.getLastOnigError()));
}
var Co = class e {
    constructor(t) {
      (P(this, `utf16Length`),
  ...
  wo = class e {
    constructor(t) {
      if (
        ...
        throw new ho(`Must invoke loadWasm first.`);
      ((this._onigBinding = F), (this.content = t));
      let n = new Co(t);
      ((this.utf16Length = n.utf16Length),
        ...
        this.utf8Length < 1e4 && !e._sharedPtrInUse
          ? ((e._sharedPtr ||= F.omalloc(1e4)),
            (e._sharedPtrInUse = !0),
            F.HEAPU8.set(n.utf8Value, e._sharedPtr),
            (this.ptr = e._sharedPtr))
          : (this.ptr = n.createString(F)));
    }
...
(P(wo, `LAST_ID`, 0), P(wo, `_sharedPtr`, 0), P(wo, `_sharedPtrInUse`, !1));
var To = wo,
  Eo = class {
    constructor(e) {
      if ((P(this, `_onigBinding`), P(this, `_ptr`), !F))
        throw new ho(`Must invoke loadWasm first.`);
      let t = [],
        n = [];
      for (let r = 0, i = e.length; r < i; r++) {
        let i = new Co(e[r]);
        ((t[r] = i.createString(F)), (n[r] = i.utf8Length));
      }
      let r = F.omalloc(4 * e.length);
      F.HEAPU32.set(t, r / 4);
      let i = F.omalloc(4 * e.length);
      F.HEAPU32.set(n, i / 4);
      let a = F.createOnigScanner(r, i, e.length);
      for (let n = 0, r = e.length; n < r; n++) F.ofree(t[n]);
      (F.ofree(i), F.ofree(r), a === 0 && So(F), (this._onigBinding = F), (this._ptr = a));
    }
    dispose() {
              ...
              Ao(n)
                ? (n =
                    typeof WebAssembly.instantiateStreaming == `function`
                      ? await Fo(n)(t)
                      : await Io(n)(t))
                : jo(n) || n instanceof WebAssembly.Module
                  ? (n = await Po(n)(t))
                  : `default` in n &&
                    n.default instanceof WebAssembly.Module &&
                    (n = await Po(n.default)(t))),
...
async function Lo(e) {
  return (
    ...
    {
      createScanner(e) {
        return new Eo(e.map((e) => (typeof e == `string` ? e : e.source)));
      },
      createString(e) {
        return new To(e);
      },
...
var Ro = oo({
    langs: po,
    themes: mo,
    engine: () => Lo(c(() => import(`./wasm.js`), [], import.meta.url)),
  }),
  {
    codeToHtml: zo,
    codeToHast: Bo,
    codeToTokens: Vo,
    codeToTokensBase: Ho,
    codeToTokensWithThemes: Uo,
    getSingletonHighlighter: Wo,
    getLastGrammarState: Go,
  } = co(Ro, { guessEmbeddedLanguages: Ki });
function Ko(e) {
...
var Xo = I`\[\^?`,
  Zo = `c.? | C(?:-.?)?|${I`[pP]\{(?:\^?[-\x20_]*[A-Za-z][-\x20\w]*\})?`}|${I`x[89A-Fa-f]\p{AHex}(?:\\x[89A-Fa-f]\p{AHex})*`}|${I`u(?:\p{AHex}{4})? | x\{[^\}]*\}? | x\p{AHex}{0,2}`}|${I`o\{[^\}]*\}?`}|${I`\d{1,3}`}`,
  Qo = /[?*+][?+]?|\{(?:\d+(?:,\d*)?|,\d+)\}\??/,
  $o = new RegExp(
    I`
  \\ (?:
...
function ts(e, t = {}) {
  ...
  for ($o.lastIndex = 0; (s = $o.exec(e)); ) {
    let t = ns(a, e, s[0], $o.lastIndex);
    (t.tokens ? o.push(...t.tokens) : t.token && o.push(t.token),
      t.lastIndex !== void 0 && ($o.lastIndex = t.lastIndex));
  }
  let c = [],
    l = 0;
  (o
...
function ns(e, t, n, r) {
  ...
  if (i === `\\`) {
    if (`AbBGyYzZ`.includes(a)) return { token: ss(n, n) };
    if (/^\\g[<']/.test(n)) {
    ...
    if (a === `K`) return { token: ms(`keep`, n) };
    if (a === `N` || a === `R`) return { token: ps(`newline`, n, { negate: a === `N` }) };
    if (a === `O`) return { token: ps(`any`, n) };
    if (a === `X`) return { token: ps(`text_segment`, n) };
    let e = as(n, { inCharClass: !1 });
    return Array.isArray(e) ? { tokens: e } : { token: e };
  }
  if (i === `(`) {
    if (a === `*`) return { token: Ts(n) };
    if (n === `(?{`) throw Error(`Unsupported callout "${n}"`);
    if (n.startsWith(`(?#`)) {
      if (t[r] !== `)`) throw Error(`Unclosed comment group "(?#"`);
      return { lastIndex: r + 1 };
    }
    if (/^\(\?[-imx]+[:)]$/.test(n)) return { token: ws(n, e) };
    if (
      (e.pushModX(e.getCurrentModX()),
      e.numOpenGroups++,
      (n === `(` && !e.captureGroup) || n === `(?:`)
    )
      return { token: _s(`group`, n) };
    if (n === `(?>`) return { token: _s(`atomic`, n) };
    if (n === `(?=` || n === `(?!` || n === `(?<=` || n === `(?<!`)
      return {
        token: _s(n[2] === `<` ? `lookbehind` : `lookahead`, n, { negate: n.endsWith(`!`) }),
      };
    if (
      (n === `(` && e.captureGroup) ||
      ...
      return { token: _s(`capturing`, n, { ...(n !== `(` && { name: n.slice(3, -1) }) }) };
    if (n.startsWith(`(?~`)) {
      if (n === `(?~|`) throw Error(`Unsupported absence function kind "${n}"`);
      return { token: _s(`absence_repeater`, n) };
    }
    throw n === `(?(`
...
`,
  ...
  return n === `.`
    ? { token: ps(`dot`, n) }
    : n === `^` || n === `$`
      ? { token: ss(e.singleline ? { "^": I`\A`, $: I`\Z` }[n] : n, n) }
      : n === `|`
        ? { token: os(n) }
        : Qo.test(n)
          ? { tokens: Ns(n) }
...
function rs(e, t, n) {
  let r = [fs(t[1] === `^`, t)],
    i = 1,
    a;
  for (es.lastIndex = n; (a = es.exec(e)); ) {
    let e = a[0];
    if (e[0] === `[` && e[1] !== `:`) (i++, r.push(fs(e[1] === `^`, e)));
    else if (e === `]`) {
      if (r.at(-1).type === `CharacterClassOpen`) r.push(L(93, e));
      else if ((i--, r.push(ls(e)), !i)) break;
    } else {
      let t = is(e);
      Array.isArray(t) ? r.push(...t) : r.push(t);
    }
  }
  return { tokens: r, lastIndex: es.lastIndex || e.length };
}
function is(e) {
  if (e[0] === `\\`) return as(e, { inCharClass: !0 });
  if (e[0] === `[`) {
    let t = /\[:(?<negate>\^?)(?<name>[a-z]+):\]/.exec(e);
    if (!t || !Jo.has(t.groups.name)) throw Error(`Invalid POSIX class "${e}"`);
    return ps(`posix`, e, { value: t.groups.name, negate: !!t.groups.negate });
  }
  return e === `-` ? us(e) : e === `&&` ? ds(e) : L(Ko(e), e);
}
function as(e, { inCharClass: t }) {
  let n = e[1];
  if (n === `c` || n === `C`) return Cs(e);
  if (`dDhHsSwW`.includes(n)) return Ds(e);
  if (e.startsWith(I`\o{`))
  ...
  if (n === `u` || n === `x`) return L(js(e), e);
  if (Ss.has(n)) return L(Ss.get(n), e);
  if (/\d/.test(n)) return hs(t, e);
  if (e === `\\`) throw Error(I`Incomplete escape "\"`);
...
function ms(e, t, n = {}) {
  return e === `keep`
    ...
    : { type: `Directive`, kind: e, flags: Yo(n.flags), raw: t };
}
function hs(e, t) {
...
var xs = new Set([`COUNT`, `CMP`, `ERROR`, `FAIL`, `MAX`, `MISMATCH`, `SKIP`, `TOTAL_COUNT`]),
  Ss = new Map([
    [`a`, 7],
    [`b`, 8],
    [`e`, 27],
...
function Cs(e) {
  ...
  return L(Ko(t.toUpperCase()) - 64, e);
}
function ws(e, t) {
  ...
  if ((a && (s.enable = a), o && (s.disable = o), e.endsWith(`)`)))
    return (t.replaceCurrentModX(i), ms(`flags`, e, { flags: s }));
  if (e.endsWith(`:`))
    return (t.pushModX(i), t.numOpenGroups++, _s(`group`, e, { ...((a || o) && { flags: s }) }));
...
function Ts(e) {
  ...
  let a = i
      ...
      : [],
    [o, s, c] = a,
    l = xs.has(n) ? n.toLowerCase() : `custom`;
  switch (l) {
    case `fail`:
    case `mismatch`:
    case `skip`:
  ...
  return vs(l, r ?? null, i?.split(`,`) ?? null, e);
}
function Es(e) {
  let t = null,
    n,
...
function Ds(e) {
  ...
  return ps({ d: `digit`, h: `hex`, s: `space`, w: `word` }[t], e, { negate: e[1] !== t });
}
function Os(e) {
  let { p: t, neg: n, value: r } = /^\\(?<p>[pP])\{(?<neg>\^?)(?<value>[^}]+)/.exec(e).groups;
  return ps(`property`, e, { value: r, negate: (t === `P` && !n) || (t === `p` && !!n) });
}
function ks(e) {
  let t = {};
  return (
...
function Ms(e, t) {
  let { raw: n, inCharClass: r } = e,
    i = n.slice(1);
  if (!r && ((i !== `0` && i.length === 1) || (i[0] !== `0` && +i <= t))) return [cs(n)];
  let a = [],
    o = i.match(/^[0-7]+|\d/g);
  for (let e = 0; e < o.length; e++) {
    ...
    if (e === 0 && t !== `8` && t !== `9`) {
      if (((r = parseInt(t, 8)), r > 127))
        throw Error(I`Octal encoded byte above 177 unsupported "${n}"`);
    } else r = Ko(t);
    a.push(L(r, (e === 0 ? `\\` : ``) + t));
  }
  return a;
  ...
  for (; (r = n.exec(e)); ) {
    ...
    if (e[0] === `{`) {
      ...
      if (r) {
        ...
        if (+i > +a && e.endsWith(`?`)) {
          (n.lastIndex--, t.push(Es(e.slice(0, -1))));
          continue;
        }
      }
    }
...
function Ls(e, t = {}) {
    ...
    i = (e, t) => {
      ...
      switch (((a.parent = e), a.nextIndex++, n.type)) {
        ...
        case `Backreference`:
          return zs(n, a);
        case `Character`:
          return Zs(n.value, { useLastValid: !!t.isCheckingRangeEnd });
        ...
        case `CharacterSet`:
          return Hs(n, a);
        case `Directive`:
          return tc(n.kind, { flags: n.flags });
        case `GroupOpen`:
          return Us(n, a, t);
        case `NamedCallout`:
          return ic(n.kind, n.tag, n.arguments);
        case `Quantifier`:
          return Ws(n, a);
        case `Subroutine`:
          return Gs(n, a);
  ...
  for (let { ref: e } of d)
    if (typeof e == `number`) {
      ...
      if (u.get(e).length > 1) throw Error(I`Subroutine uses a duplicate group name "\g<${e}>"`);
      u.get(e)[0].isSubroutined = !0;
    } else throw Error(I`Subroutine uses a group name that's not defined "\g<${e}>"`);
  return o;
}
function Rs({ kind: e }) {
  return Js(
...
function zs({ raw: e }, t) {
  let n = /^\\k[<']/.test(e),
    ...
    i = (n, r = !1) => {
      ...
      return ((t.hasNumberedRef = !0), Ys(r ? i + 1 - n : n, { orphan: a }));
    };
  if (n) {
...
function Bs(e, t, n) {
  ...
  if (
    ...
    if (o.type === `Character` && e.type === `Character`) return (a.body.pop(), $s(o, e));
    throw Error(`Invalid character class range`);
  }
  return Zs(Ko(`-`));
}
function Vs({ negate: e }, t, n) {
  let { tokens: r, walk: i } = t,
    a = r[t.nextIndex],
    o = [Qs()],
    s = vc(a);
  for (; s.type !== `CharacterClassClose`; ) {
    if (s.type === `CharacterClassIntersector`) (o.push(Qs()), t.nextIndex++);
    else {
      let e = o.at(-1);
      e.body.push(i(e, n));
    }
    s = vc(r[t.nextIndex], a);
  }
  let c = Qs({ negate: e });
  return (
    o.length === 1
...
function Hs({ kind: e, negate: t, value: n }, r) {
  let {
  ...
  if (e === `property`) {
    let r = _c(n);
    if (Jo.has(r) && !o?.has(r)) ((e = `posix`), (n = r));
    else
      return lc(n, {
        negate: t,
        normalizeUnknownPropertyNames: i,
  ...
  return e === `posix` ? ac(n, { negate: t }) : ec(e, { negate: t });
}
function Us(e, t, n) {
  let {
      tokens: r,
    ...
    d = u && c.negate;
  if (
    (c.type === `CapturingGroup` && (i.push(c), c.name && qo(a, c.name, []).push(c)),
    l && n.isInAbsenceFunction)
  )
    throw Error(`Nested absence function not supported by Oniguruma`);
  let f = yc(r[t.nextIndex]);
  for (; f.type !== `GroupClose`; ) {
    if (f.type === `Alternator`) (c.body.push(qs()), t.nextIndex++);
    else {
      let e = c.body.at(-1),
        t = s(e, {
          ...n,
      ...
      if ((e.body.push(t), (u || n.isInLookbehind) && !o)) {
        ...
        if (d || n.isInNegLookbehind) {
          if (pc(t) || t.type === `CapturingGroup`) throw Error(e);
        } else if (pc(t) || (mc(t) && t.negate)) throw Error(e);
      }
    }
    f = yc(r[t.nextIndex]);
  }
...
function Ws({ kind: e, min: t, max: n }, r) {
  let i = r.parent,
    a = i.body.at(-1);
  if (!a || !Fs(a)) throw Error(`Quantifier requires a repeatable token`);
  let o = oc(e, t, n, a);
  return (i.body.pop(), o);
}
function Gs({ raw: e }, t) {
...
function Ks(e, t) {
  ...
  return { type: `AbsenceFunction`, kind: e, body: dc(t?.body) };
}
function qs(e) {
  return { type: `Alternative`, body: fc(e?.body) };
}
function Js(e, t) {
...
function Xs(e, t) {
  ...
  if (n.name !== void 0 && !hc(n.name)) throw Error(`Group name "${n.name}" invalid in Oniguruma`);
  return {
    type: `CapturingGroup`,
    number: e,
    ...(n.name && { name: n.name }),
...
function Qs(e) {
  ...
  return { type: `CharacterClass`, kind: t.kind, negate: t.negate, body: fc(e?.body) };
}
function $s(e, t) {
...
function tc(e, t = {}) {
  ...
  if (e === `flags`) return { type: `Directive`, kind: e, flags: Yo(t.flags) };
...
function R(e) {
  ...
  return { type: `Group`, ...(t && { atomic: t }), ...(n && { flags: n }), body: dc(e?.body) };
}
function rc(e) {
...
function ac(e, t) {
  let n = !!t?.negate;
  if (!Jo.has(e)) throw Error(`Invalid POSIX class "${e}"`);
...
function sc(e, t) {
  return { type: `Regex`, body: dc(t?.body), flags: e };
}
function cc(e) {
...
function lc(e, t) {
  let n = {
    ...
    r = n.unicodePropertyMap?.get(_c(e));
  if (!r) {
    if (n.normalizeUnknownPropertyNames) r = gc(e);
    else if (n.unicodePropertyMap && !n.skipPropertyNameValidation)
      throw Error(I`Invalid Unicode property "\p{${e}}"`);
  }
  return { type: `CharacterSet`, kind: `property`, value: r ?? e, negate: n.negate };
}
function uc({ flags: e, kind: t, name: n, negate: r, number: i }) {
  switch (t) {
    ...
    case `lookahead`:
    case `lookbehind`:
      return rc({ behind: t === `lookbehind`, negate: r });
    default:
  ...
  function i(a, o = null, s = null, c = null) {
    let l = 0,
      ...
      d = {
        ...
        root: e,
        remove() {
          (xc(c).splice(Math.max(0, Sc(s) + l), 1), l--, (u = !0));
        },
        removeAllNextSiblings() {
          return xc(c).splice(Sc(s) + 1);
        },
        removeAllPrevSiblings() {
          let e = Sc(s) + l;
          return ((l -= e), xc(c).splice(0, Math.max(0, e)));
        },
        replaceWith(e, t = {}) {
          let n = !!t.traverse;
          (c ? (c[Math.max(0, Sc(s) + l)] = e) : (Yo(o, `Can't replace root node`)[s] = e),
            n && i(e, o, s, c),
            (u = !0));
        },
        replaceWithMultiple(e, t = {}) {
          let n = !!t.traverse;
          if ((xc(c).splice(Math.max(0, Sc(s) + l), 1, ...e), (l += e.length - 1), n)) {
            let t = 0;
            for (let n = 0; n < e.length; n++) t += i(e[n], o, Sc(s) + n + t, c);
          }
          u = !0;
        },
        skip() {
...
var Cc = String.raw`\(\?(?:[:=!>A-Za-z\-]|<[=!]|\(DEFINE\))`;
function wc(e, t) {
...
var z = Object.freeze({ DEFAULT: `DEFAULT`, CHAR_CLASS: `CHAR_CLASS` });
function Ec(e, t, n, r) {
  ...
  for (let t of e.matchAll(i)) {
    ...
    if (!i && (!r || (r === z.DEFAULT) == !o)) {
      n instanceof Function
        ? (s += n(t, { context: o ? z.CHAR_CLASS : z.DEFAULT, negated: a[a.length - 1] }))
        : (s += n);
      continue;
    }
...
var jc = new RegExp(
  String.raw`(?<noncapturingStart>${Cc})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`,
  `gsu`,
);
function Mc(e, t) {
  ...
  do {
    ...
    let t = 0,
      ...
      d = !1,
      f;
    for (jc.lastIndex = Number.isNaN(c) ? 0 : c + 7; (f = jc.exec(e)); ) {
      let {
        0: p,
        index: m,
...
| (?<qBase>${Nc})(?<qMod>[?+]?)(?<invalidQ>[?*+\{]?)
| \\?.
`.replace(/\s+/g, ``),
    `gsu`,
  );
function Fc(e) {
  if (!RegExp(`${Nc}\\+`).test(e)) return { pattern: e };
  let t = [],
    n = null,
    r = null,
    i = ``,
    a = 0,
    o;
  for (Pc.lastIndex = 0; (o = Pc.exec(e)); ) {
    let {
      0: s,
      index: c,
    ...
    if (s === `[`) (a || (r = c), a++);
      ...
      if (u === `+` && i && !i.startsWith(`(`)) {
        ...
        let t = -1;
        if (/^\{\d+\}$/.test(l)) e = Tc(e, c + l.length, u, ``);
        else {
          if (i === `)` || i === `]`) {
            let t = i === `)` ? n : r;
...
var B = String.raw,
  Ic = B`\(\?R=(?<rDepth>[^\)]+)\)|${B`\\g<(?<gRNameOrNum>[^>&]+)&R=(?<gRDepth>[^>]+)>`}`,
  Lc = B`\(\?<(?![=!])(?<captureName>[^>]+)>`,
  Rc = B`${Lc}|(?<unnamed>\()(?!\?)`,
  zc = new RegExp(B`${Lc}|${Ic}|\(\?|\\?.`, `gsu`),
  Bc = `Cannot use multiple overlapping recursions`;
function Vc(e, t) {
  let { hiddenCaptures: n, mode: r } = { hiddenCaptures: [], mode: `plugin`, ...t },
    i = t?.captureTransfers ?? new Map();
  if (!new RegExp(Ic, `su`).test(e)) return { pattern: e, captureTransfers: i, hiddenCaptures: n };
  if (r === `plugin` && kc(e, B`\(\?\(DEFINE\)`, z.DEFAULT))
    throw Error(`DEFINE groups cannot be used with recursion`);
  let a = [],
    o = kc(e, B`\\[1-9]`, z.DEFAULT),
    s = new Map(),
    c = [],
    l = !1,
    u = 0,
    d = 0,
    f;
  for (zc.lastIndex = 0; (f = zc.exec(e)); ) {
    let {
      0: t,
    ...
    if (t === `[`) u++;
      ...
      if ((Hc(m), l)) throw Error(Bc);
      if (o)
        throw Error(
          `${r === `external` ? `Backrefs` : `Numbered backrefs`} cannot be used with global recursion`,
        );
      let t = e.slice(0, f.index),
        s = e.slice(zc.lastIndex);
      if (kc(s, Ic, z.DEFAULT)) throw Error(Bc);
      let c = m - 1;
      ((e = Uc(t, s, c, !1, n, a, d)), (i = Kc(i, t, c, a.length, 0, d)));
      break;
    } else if (h) {
      Hc(g);
      let u = !1;
      for (let e of c)
        if (e.name === h || e.num === +h) {
          if (((u = !0), e.hasRecursedWithin)) throw Error(Bc);
          break;
        }
      if (!u)
        throw Error(
          B`Recursive \g cannot be used outside the referenced group "${r === `external` ? h : B`\g<${h}&R=${g}>`}"`,
        );
      let p = s.get(h),
        m = Ac(e, p);
      if (o && kc(m, B`${Lc}|\((?!\?)`, z.DEFAULT))
        throw Error(
      ...
      let _ = e.slice(p, f.index),
        ...
        te = g - 1,
        y = Uc(_, v, te, !0, n, a, d);
      ((i = Kc(i, _, te, a.length - ee, ee, d)),
        (e = `${e.slice(0, p)}${y}${e.slice(p + m.length)}`),
        (zc.lastIndex += y.length - t.length - _.length - v.length),
        c.forEach((e) => (e.hasRecursedWithin = !0)),
        (l = !0));
    } else if (p)
      (d++, s.set(String(d), zc.lastIndex), s.set(p, zc.lastIndex), c.push({ num: d, name: p }));
    else if (t[0] === `(`) {
      let e = t === `(`;
      (e && (d++, s.set(String(d), zc.lastIndex)), c.push(e ? { num: d } : {}));
    } else t === `)` && c.pop();
  }
...
function Uc(e, t, n, r, i, a, o) {
  ...
  return `${e}${Wc(`(?:${e}`, `forward`, ...c)}(?:)${Wc(`${t})`, `backward`, ...c)}${t}`;
}
...
((U.bugFlagVLiteralHyphenIsRange = U.unicodeSets
  ...
  : !1),
  (U.bugNestedClassIgnoresNegation = U.unicodeSets && RegExp(`[[^a]]`, `v`).test(`a`)));
function qc(e, { enable: t, disable: n }) {
  return {
...
var Zc = { ES2025: 2025, ES2024: 2024, ES2018: 2018 },
  Qc = { auto: `auto`, ES2025: `ES2025`, ES2024: `ES2024`, ES2018: `ES2018` };
function $c(e = {}) {
  if ({}.toString.call(e) !== `[object Object]`) throw Error(`Unexpected options`);
  if (e.target !== void 0 && !Qc[e.target]) throw Error(`Unexpected target "${e.target}"`);
  let t = {
    accuracy: `default`,
    avoidSubclass: !1,
    flags: ``,
  ...
  return (
    t.target === `auto` &&
      (t.target = U.flagGroups ? `ES2025` : U.unicodeSets ? `ES2024` : `ES2018`),
    t
  );
}
var el = `[	-\r ]`,
  tl = new Set([V(304), V(305)]),
  W = H`[\p{L}\p{M}\p{N}\p{Pc}]`;
function nl(e) {
  if (tl.has(e)) return [e];
  let t = new Set(),
    n = e.toLowerCase(),
    r = n.toUpperCase(),
    i = ol.get(n),
    ...
    o = al.get(n);
  return (
    [...r].length === 1 && t.add(r), o && t.add(o), i && t.add(i), t.add(n), a && t.add(a), [...t]
  );
}
var rl = new Map(
    `C Other
...
function dl(e, t) {
  ...
  let r = {
    ...
    minTargetEs2024: Yc(n.bestEffortTarget, `ES2024`),
    passedLookbehind: !1,
    strategy: null,
...
var fl = {
    AbsenceFunction({ node: e, parent: t, replaceWith: n }) {
      ...
      if (i === `repeater`) {
        let e = R();
        e.body[0].body.push(rc({ negate: !0, body: r }), lc(`Any`));
        let i = R();
        (i.body[0].body.push(oc(`greedy`, 0, 1 / 0, e)), n(q(i, t), { traverse: !0 }));
    ...
    Assertion({ node: e, parent: t, key: n, container: r, root: i, remove: a, replaceWith: o }, s) {
      ...
      if (c === `line_end`)
        o(q(rc({ body: [qs({ body: [Js(`string_end`)] }), qs({ body: [Zs(10)] })] }), t));
        ...
        if (f.has(e)) ((i.flags.sticky = !0), a());
          ...
          let e = r[n - 1];
          if (e && Ol(e)) o(q(rc({ negate: !0 }), t));
          else if (d) throw Error(H`Uses "\G" in a way that requires a subclass`);
          else (o(Ml(Js(`string_start`), t)), (s.strategy = `clip_search`));
        }
      else if (!(c === `string_end` || c === `string_start`))
        if (c === `string_end_newline`) o(q(K(H`(?=\n?\z)`), t));
    ...
    Backreference({ node: e }, { jsGroupNameMap: t }) {
      let { ref: n } = e;
      typeof n == `string` && !Al(n) && ((n = xl(n, t)), (e.ref = n));
    },
    CapturingGroup({ node: e }, { jsGroupNameMap: t, subroutineRefMap: n }) {
      let { name: r } = e;
      (r && !Al(r) && ((r = xl(r, t)), (e.name = r)), n.set(e.number, e), r && n.set(r, e));
    },
    CharacterClassRange({ node: e, parent: t, replaceWith: n }) {
      t.kind === `intersection` && n(q(Qs({ body: [e] }), t), { traverse: !0 });
    },
    CharacterSet(
      ...
      if (s && (c === `word` || u === `word`)) {
        n(Ml(ec(`word`, { negate: l }), t));
        return;
      }
      if (c === `any`) n(Ml(lc(`Any`), t));
      else if (c === `digit`) n(Ml(lc(`Nd`, { negate: l }), t));
      else if (c !== `dot`)
        if (c === `text_segment`) {
          if (r === `strict`) throw Error(H`Use of "\X" requires non-strict accuracy`);
          let e = `\\p{Emoji}(?:\\p{EMod}|\\uFE0F\\u20E3?|[\\x{E0020}-\\x{E007E}]+\\x{E007F})?`,
            a = H`\p{RI}{2}|${e}(?:\u200D${e})*`;
          n(
            q(
              K(H`(?>\r\n|${i ? H`\p{RGI_Emoji}` : a}|\P{M}\p{M}*)`, {
                skipPropertyNameValidation: !0,
              }),
              t,
            ),
          );
        } else if (c === `hex`) n(Ml(lc(`AHex`, { negate: l }), t));
        else if (c === `newline`)
          n(
            q(
              K(
...
\v\f\u2028\u2029])`,
          ...
          if (!i && (u === `graph` || u === `print`)) {
            ...
            let e = { graph: `!-~`, print: ` -~` }[u];
            (l && (e = `\0-${V(e.codePointAt(0) - 1)}${V(e.codePointAt(2) + 1)}-\u{10FFFF}`),
              n(q(K(`[${e}]`), t)));
          } else n(q(jl(K(sl.get(u)), l), t));
        else if (c === `property`) rl.has(_c(u)) || (e.key = `sc`);
        else if (c === `space`) n(Ml(lc(`space`, { negate: l }), t));
        else if (c === `word`) n(q(jl(K(W), l), t));
    ...
    Directive({
      ...
      if (s === `flags`)
        ...
        let e = n.body[0],
          r =
            n.body.length === 1 && Ps(e, { type: `Group` }) && e.body[0].body.length === 1
              ? e.body[0]
              : n;
        if (t.parent !== r || r.body.length > 1)
          throw Error(H`Uses "\K" in a way that's unsupported`);
        let o = rc({ behind: !0 });
    ...
    Regex: {
      ...
      exit(e, { accuracy: t, passedLookbehind: n, strategy: r }) {
        if (t === `strict` && n && r)
          throw Error(H`Uses "\G" in a way that requires non-strict accuracy`);
      },
    },
  ...
  pl = {
    ...
    CapturingGroup: {
      enter(
        ...
        let l = i.get(e);
        if (l && s.has(e.number)) {
          let r = Ml(yl(e.number), t);
          (c.set(r, s.get(e.number)), n(r));
          return;
        }
        (s.set(e.number, e), o.set(e.number, []), e.name && Jc(o, e.name, []));
    ...
    Group: {
      enter({ node: e }, t) {
        ((t.prevFlags = t.currentFlags), e.flags && (t.currentFlags = qc(t.currentFlags, e.flags)));
      },
      exit(e, t) {
    ...
    Subroutine({ node: e, parent: t, replaceWith: n }, r) {
      ...
      let o = r.subroutineRefMap.get(a),
        s = a === 0,
        c = s ? yl(0) : vl(o, r.groupOriginByCopy, null),
        l = c;
      if (!s) {
        let e = Sl(bl(o, (e) => e.type === `Group` && !!e.flags)),
          t = e ? qc(r.globalFlags, e) : r.globalFlags;
        gl(t, r.currentFlags) || ((l = R({ flags: Cl(t) })), l.body[0].body.push(c));
      }
      n(q(l, t), { traverse: !s });
    },
  },
  ml = {
    Backreference({ node: e, parent: t, replaceWith: n }, r) {
      ...
      let i = r.reffedNodesByReferencer.get(e).filter((t) => _l(t, e));
      i.length
        ? i.length > 1
          ? n(q(R({ atomic: !0, body: i.reverse().map((e) => qs({ body: [Ys(e.number)] })) }), t))
          : (e.ref = i[0].number)
        : n(q(rc({ negate: !0 }), t));
    },
...
function Cl({ dotAll: e, ignoreCase: t }) {
  let n = {};
  return (
...
function Tl(e) {
  let t = e.find((e) => e.kind === `search_start` || kl(e, { negate: !1 }) || !Dl(e));
  if (!t) return null;
...
function El(e, t) {
  let n = wl(e) ?? [];
  for (let e of n) if (e === t || El(e, t)) return !0;
  return !1;
}
function Dl({ type: e }) {
...
function kl(e, t) {
  ...
  return (
    ...
    e.body.length === 1 &&
    Ps(e.body[0], { type: `Assertion`, kind: `search_start` })
  );
}
function Al(e) {
...
function K(e, t) {
  let n = Ls(e, { ...t, unicodePropertyMap: rl }).body;
...
function q(e, t) {
  return (hl(e), (e.parent = t), e);
}
function Nl(e, t) {
  let n = $c(t),
    r = Yc(n.target, `ES2024`),
    i = Yc(n.target, `ES2025`),
  ...
  function d(e) {
    return ((u.lastNode = l), (l = e), Xc(Fl[e.type], `Unexpected node type "${e.type}"`)(e, u, d));
  }
  ...
  return (
    ...
    u.captureMap.forEach((e, t) => {
      (e.hidden && f._hiddenCaptures.push(t),
        e.transferTo && Jc(f._captureTransfers, e.transferTo, []).push(t));
    }),
    f
  );
}
var Pl = {
    "*": {
      enter({ node: e }, t) {
        if (ql(e)) {
          ...
          t.pushModI(e.flags ? qc({ ignoreCase: n }, e.flags).ignoreCase : n);
        }
      },
      exit({ node: e }, t) {
        ql(e) && t.popModI();
  ...
  Fl = {
    ...
    Character({ value: e }, t) {
      ...
      if (r !== n) return r;
      if (t.useAppliedIgnoreCase && t.currentFlags.ignoreCase && Vl(n)) {
        let e = nl(n);
    ...
    CharacterClass(e, t, n) {
      ...
      U.bugFlagVLiteralHyphenIsRange &&
        t.useFlagV &&
        o.some(Yl) &&
        (o = [Zs(45), ...o.filter((e) => !Yl(e))]);
      let s = () => `[${i ? `^` : ``}${o.map(n).join(r === `intersection` ? `&&` : ``)}]`;
      if (!t.inCharClass) {
        if ((!t.useFlagV || U.bugNestedClassIgnoresNegation) && !i) {
      ...
      if (
        ...
        (((!t.useFlagV || !t.verbose) &&
          a.kind === `union` &&
          !(U.bugFlagVLiteralHyphenIsRange && t.useFlagV)) ||
          (!t.verbose &&
            a.kind === `intersection` &&
            o.length === 1 &&
    ...
    CharacterClassRange(e, t) {
      ...
      return (
        t.useAppliedIgnoreCase &&
          t.currentFlags.ignoreCase &&
          Wl(Hl(e)).forEach((e) => {
            s.add(Array.isArray(e) ? `${Ul(e[0], i)}-${Ul(e[1], i)}` : Ul(e, i));
          }),
        `${a}-${o}${[...s].join(``)}`
      );
    },
    CharacterSet({ kind: e, negate: t, value: n, key: r }, i) {
      ...
      if (e === `property`) {
        if (i.useAppliedIgnoreCase && i.currentFlags.ignoreCase && ul.has(n))
          throw Error(
            `Unicode property "${n}" can't be case-insensitive when other chars have specific case`,
          );
        return `${t ? H`\P` : H`\p`}{${r ? `${r}=` : ``}${n}}`;
      }
...
function Ul(e, { escDigit: t, inCharClass: n, useFlagV: r }) {
  if (zl.has(e)) return zl.get(e);
  if (e < 32 || (e > 126 && e < 160) || e > 262143 || (t && Jl(e)))
    return e > 255
...
function Kl({ kind: e, max: t, min: n }) {
  let r;
  return (
    (r =
      !n && t === 1
...
var Xl = class e extends RegExp {
  ...
  constructor(t, n, r) {
    ...
    if (t instanceof RegExp) {
      ...
      (super(i ? `` : t, n),
        (this.#n = t),
        (this.#e = Ql(e.hiddenCaptures, e.transfers)),
        (this.#i = e.strategy),
        (this.rawOptions = r ?? {}));
    }
    i || (this.#t = this);
  ...
  exec(t) {
    ...
    if (this.#i === `clip_search` && n && r) {
      ...
      return (e && (Zl(e, r, t, this.hasIndices), (this.lastIndex += r)), e);
    }
    return this.#a(t);
  }
  #a(e) {
...
function Ql(e, t) {
  ...
  for (let [e, r] of t) for (let t of r) Jc(n, t, {}).transferTo = e;
  return n;
}
function $l(e) {
...
function eu(e, t) {
  let n = tu(e, t);
  return n.options ? new Xl(n.pattern, n.flags, n.options) : new RegExp(n.pattern, n.flags);
}
function tu(e, t) {
  let n = $c(t),
    r = dl(
...
function au(e = {}) {
  ...
  return (
    (t.regexConstructor ||= (e) => iu(e, { target: t.target })),
    {
      createScanner(e) {
        return new ru(e, t);
      },
...
async function ou(e) {
  ...
  try {
    let t = Yn.get(e);
    if ((t == null && Object.prototype.hasOwnProperty.call(po, e) && (t = po[e]), t == null))
      throw Error(`resolveLanguage: "${e}" not found in bundled or custom languages`);
    let n = t().then(({ default: t }) => {
      let n = { name: e, data: t };
      return (qn.has(e) || qn.set(e, n), n);
    });
    return (Jn.set(e, n), await n);
  } finally {
    Jn.delete(e);
  }
}
function su(e) {
  return qn.get(e) ?? ou(e);
}
var J = new Map(),
  cu = new Map(),
  lu = new Map(),
...
function du(e, t) {
  ...
  for (let n of e) {
    ...
    } else ((e = n), (n = n.name), J.has(n) || J.set(n, e));
    uu.has(n) || (uu.add(n), t.loadThemeSync(e));
  }
}
async function fu(e) {
  if ($n())
  ...
  try {
    ...
    let n = t().then((t) => pu(e, `default` in t ? t.default : t));
    cu.set(e, n);
    let r = await n;
    if (r.name !== e)
      throw Error(`resolvedTheme: themeName: ${e} does not match theme.name: ${r.name}`);
    return (J.set(r.name, r), r);
  } finally {
    cu.delete(e);
  }
}
function pu(e, t) {
  return J.get(e) ?? ((t = Ka(t)), J.set(e, t), t);
}
function mu(e) {
  return J.get(e) ?? fu(e);
}
...
var Y;
async function gu({ themes: e, langs: t, preferredHighlighter: n = `shiki-js` }) {
  Y ??= Ro({
    themes: [],
    langs: [`text`],
    engine: n === `shiki-wasm` ? Lo(c(() => import(`./wasm.js`), [], import.meta.url)) : au(),
  });
  let r = vu(Y) ? await Y : Y;
  Y = r;
  let i = [];
  for (let e of t) {
    if (e === `text` || e === `ansi`) continue;
    let t = su(e);
    `then` in t ? i.push(t) : Qn(t, r);
  }
  let a = [];
  for (let t of e) {
    let e = mu(t);
    `then` in e ? a.push(e) : du(e, Y);
  }
  return (
...
function _u() {
  if (Y != null && !(`then` in Y)) return Y;
}
function vu(e = Y) {
  return e != null && `then` in e;
}
(hu(`pierre-dark`, async () => {
  let { default: e } = await c(
    async () => {
      let { default: e } = await import(`./pierre-dark.js`);
      return { default: e };
    },
    [],
    import.meta.url,
  ...
  hu(`pierre-dark-soft`, async () => {
    let { default: e } = await c(
      async () => {
        let { default: e } = await import(`./pierre-dark-soft-D.js`);
        return { default: e };
      },
      [],
      import.meta.url,
    );
    return { ...e, name: `pierre-dark-soft` };
  }),
  hu(`pierre-light`, async () => {
    let { default: e } = await c(
      async () => {
        let { default: e } = await import(`./pierre-light.js`);
        return { default: e };
      },
      [],
      import.meta.url,
  ...
  hu(`pierre-light-soft`, async () => {
    let { default: e } = await c(
      async () => {
        let { default: e } = await import(`./pierre-light-soft.js`);
        return { default: e };
      },
      [],
      import.meta.url,
    );
    return { ...e, name: `pierre-light-soft` };
  }));
function yu(e = b) {
  let t = [];
...
function bu(e) {
  for (let t of yu(e)) if (!uu.has(t)) return !1;
  return !0;
}
function xu(e) {
  for (let t of e) if (!J.has(t)) return !1;
  return !0;
}
function Su(e, t) {
  return (
...
function wu(e) {
  return S({
    ...
    children: [
      S({
        tagName: `div`,
        children: e.annotations?.map((e) => S({ tagName: `slot`, properties: { name: e } })),
...
function Eu({ fileOrDiff: e, mode: t, stickyHeader: n }) {
  let r = `type` in e ? e : void 0,
    i = { "data-diffs-header": t, "data-change-type": r?.type, "data-sticky": n ? `` : void 0 };
  return S({
    tagName: `div`,
    children: [
      t === `custom`
        ? S({ tagName: `slot`, properties: { name: v } })
        : Du({
            name: e.name,
...
function Du({ name: e, prevName: t, iconType: n }) {
  let r = [
    S({ tagName: `slot`, properties: { name: _ } }),
    ye({ name: Tu(n), properties: { "data-change-icon": n } }),
  ];
  return (
    t != null &&
      (r.push(
        S({
          tagName: `div`,
          children: [S({ tagName: `bdi`, children: [ve(t)] })],
          properties: { "data-prev-name": `` },
        }),
      ),
      r.push(ye({ name: `diffs-icon-arrow-right-short`, properties: { "data-rename-icon": `` } }))),
    r.push(
      S({
        tagName: `div`,
        children: [S({ tagName: `bdi`, children: [ve(e)] })],
        properties: { "data-title": `` },
      }),
    ),
    S({ tagName: `div`, children: r, properties: { "data-header-content": `` } })
  );
}
function Ou(e) {
  let t = [];
  if (e != null) {
    ...
    ((r > 0 || n === 0) &&
      t.push(
        S({ tagName: `span`, children: [ve(`-${r}`)], properties: { "data-deletions-count": `` } }),
      ),
      (n > 0 || r === 0) &&
        t.push(
          S({
  ...
  return (
    t.push(S({ tagName: `slot`, properties: { name: te } })),
    S({ tagName: `div`, children: t, properties: { "data-metadata": `` } })
  );
}
function ku(e) {
  return S({ tagName: `pre`, properties: Au(e) });
}
function Au({
  diffIndicators: e,
  disableBackground: t,
...
function X(e) {
  if (ju.has(e)) return ju.get(e) ?? `text`;
  if (Nu[e] != null) return Nu[e];
  let t = e.match(/\.([^/\\]+\.[^/\\]+)$/);
  if (t != null) {
    if (ju.has(t[1])) return ju.get(t[1]) ?? `text`;
    if (Nu[t[1]] != null) return Nu[t[1]] ?? `text`;
  }
  let n = e.match(/\.([^.]+)$/)?.[1] ?? ``;
  return ju.has(n) ? (ju.get(n) ?? `text`) : (Nu[n] ?? `text`);
}
function Pu() {
  return Mu;
}
function Fu() {
  return Object.fromEntries(ju);
}
function Iu(e, { theme: t, preferredHighlighter: n = `shiki-js` }) {
  return { langs: [e ?? `text`], themes: yu(t), preferredHighlighter: n };
}
function Lu(e) {
...
var zu = Symbol(`no-token`),
  Bu = Symbol(`multiple-tokens`);
function Vu(e) {
  let t = Hu(e);
  if (t != null) return t;
  let n = zu,
    ...
    o = () => {
      ...
      if (i.length === 1) {
        ...
        if (e?.type === `element`) {
          Wu(e, a);
          for (let t of e.children) Uu(t);
        } else Uu(e);
        (r.push(e), (i = []), (a = void 0));
        return;
      }
      for (let e of i) Uu(e);
      (r.push(S({ tagName: `span`, properties: { "data-char": a }, children: i })),
        (i = []),
        (a = void 0));
    },
    s = (e) => {
...
function Gu(e = {}) {
  ...
  function o(e) {
    let o = t + Ku(typeof e == `string` ? e : a(e)) + n;
        ...
        pre(t) {
          ...
          if (r != null) {
            ...
            for (let a of r.children)
              a.type === `element` && (e && Vu(a), i.push(Ru(a, t, n)), t++);
            r.children = i;
          }
          return t;
        },
    ...
    e &&
      r.push({
        line: (e) => (
          e.type === `element` &&
            e.children.length === 0 &&
            e.children.push({ type: `element`, tagName: `br`, properties: {}, children: [] }),
          e
        ),
      }),
    { state: n, transformers: r, toClass: Ju }
  );
}
var Ju = Gu({ classPrefix: `hl-` }),
  Yu = {
...
function Xu({ theme: e = b, highlighter: t, prefix: n }) {
  let r = ``;
  if (typeof e == `string`) {
    let i = t.getTheme(e);
    ((r += `color:${i.fg};`),
    ...
    ((r += `${Z(`global`)}dark:${n.fg};`),
      (r += `${Z(`global`)}dark-bg:${n.bg};`),
      (r += Zu(n, `dark`)),
      (n = t.getTheme(e.light)),
      (r += `${Z(`global`)}light:${n.fg};`),
      (r += `${Z(`global`)}light-bg:${n.bg};`),
      (r += Zu(n, `light`)));
  }
  return r;
}
...
function td(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    (r === $u || r === ed) &&
      (r === ed && n + 1 < e.length && e.charCodeAt(n + 1) === $u && n++, t.push(n + 1));
  }
  return t;
}
function nd(e) {
...
var rd = { forcePlainText: !1 };
function id(
  e,
  t,
  { theme: n = b, tokenizeMaxLineLength: r, useTokenTransformer: i },
  { forcePlainText: a, startingLine: o, totalLines: s, lines: c } = rd,
) {
  a ? ((o ??= 0), (s ??= 1 / 0)) : ((o = 0), (s = 1 / 0));
  let l = o > 0 || s < 1 / 0,
    { state: u, transformers: d } = qu(i),
    f = a ? `text` : (e.lang ?? X(e.name)),
    p = typeof n == `string` ? t.getTheme(n).type : void 0,
    m = Xu({ theme: n, highlighter: t });
  ...
  let h =
    ...
    g = Qu(t.codeToHast(l ? ad(c ?? nd(e.contents), o, s) : e.contents, h)),
    _ = l ? Array(o) : g;
...
var ld = `<svg data-icon-sprite aria-hidden="true" width="0" height="0">
...
function ud(e, t) {
  return e == null || t == null
    ? e === t
    : fd(e.customProperties, t.customProperties) &&
        e.type === t.type &&
...
function vd(e) {
  ...
  return (
    ...
    n.appendChild(r),
    e.appendChild(n),
    (_d = Math.max(n.offsetHeight - n.clientHeight, 0)),
    n.remove(),
    _d
  );
}
function yd(e) {
  return `${ne}: ${e == null ? `var(--diffs-scrollbar-gutter-fallback)` : `${e}px`};`;
}
var bd = `@layer base, theme, rendered, unsafe;`,
  xd = RegExp(`${Td(ne)}\\s*:\\s*[^;]+;`);
function Sd(e) {
  return `${bd}
@layer unsafe {
...
function Ad({ shadowRoot: e, currentNode: t, themeCSS: n }) {
  if (n.trim() === ``) {
    t?.remove();
    return;
  }
  return ((t ??= jd()), (t.textContent = n), t.parentNode !== e && e.appendChild(t), t);
}
function jd() {
  let e = document.createElement(`style`);
  return (e.setAttribute(g, ``), e);
}
if (typeof HTMLElement < `u` && customElements.get(`diffs-container`) == null) {
  ...
  class t extends HTMLElement {
    constructor() {
      ...
      (e ?? ((e = new CSSStyleSheet()), e.replaceSync(gd)), (t.adoptedStyleSheets = [e]));
    }
    connectedCallback() {
      vd(this.shadowRoot ?? this.attachShadow({ mode: `open` }));
    }
  }
...
var Rd = class {
  ...
  zd = new (class extends Rd {})();
function Bd(e, t, n) {
  return zd.diff(e, t, n);
}
function Vd(e, t) {
  let n;
...
var Zd = `a-zA-Z0-9_\\u{AD}\\u{C0}-\\u{D6}\\u{D8}-\\u{F6}\\u{F8}-\\u{2C6}\\u{2C8}-\\u{2D7}\\u{2DE}-\\u{2FF}\\u{1E00}-\\u{1EFF}`,
  Qd = RegExp(`[${Zd}]+|\\s+|[^${Zd}]`, `ug`);
new (class extends Rd {
  equals(e, t, n) {
    ...
    return (
      e.forEach((e) => {
        e.added
          ...
          : e.removed
            ? (i = e)
            : ((r || i) && $d(n, i, r, e), (n = e), (r = null), (i = null));
      }),
      (r || i) && $d(n, i, r, null),
      e
    );
...
function $d(e, t, n, r) {
  if (t && n) {
    ...
    if (e) {
      let r = Vd(i, o);
      ((e.value = Wd(e.value, o, r)), (t.value = Gd(t.value, r)), (n.value = Gd(n.value, r)));
    }
    if (r) {
      let e = Hd(a, s);
      ((r.value = Ud(r.value, s, e)), (t.value = Kd(t.value, e)), (n.value = Kd(n.value, e)));
    }
  } else if (n) {
    if (e) {
      let e = Xd(n.value);
    ...
    let n = Xd(r.value),
      ...
      a = Yd(t.value),
      o = Vd(n, i);
    t.value = Gd(t.value, o);
    let s = Hd(Gd(n, o), a);
    ((t.value = Kd(t.value, s)),
      (r.value = Ud(r.value, n, s)),
      (e.value = Wd(e.value, n, n.slice(0, n.length - s.length))));
  } else if (r) {
    let e = Xd(r.value),
      n = qd(Yd(t.value), e);
    t.value = Kd(t.value, n);
  } else if (e) {
    let n = qd(Yd(e.value), Xd(t.value));
    t.value = Gd(t.value, n);
  }
}
var ef = new (class extends Rd {
  tokenize(e) {
    let t = RegExp(`(\\r?\\n)|[${Zd}]+|[^\\S\\n\\r]+|[^${Zd}]`, `ug`);
    return e.match(t) || [];
  }
...
var nf = new (class extends Rd {
  constructor() {
    (super(...arguments), (this.tokenize = af));
  }
  equals(e, t, n) {
    return (
      n.ignoreWhitespace
...
(new (class extends Rd {
  ...
  new (class extends Rd {
    ...
    castInput(e, t) {
      ...
      return typeof e == `string` ? e : JSON.stringify(sf(e, null, null, r), null, `  `);
    }
    equals(e, t, n) {
...
function sf(e, t, n, r, i) {
  ...
  if ((e && e.toJSON && (e = e.toJSON()), typeof e == `object` && e)) {
    ...
    for (i.sort(), a = 0; a < i.length; a += 1) ((s = i[a]), (o[s] = sf(e[s], t, n, r, s)));
    (t.pop(), n.pop());
  } else o = e;
  return o;
}
...
var cf = { includeIndex: !0, includeUnderline: !0, includeFileHeaders: !0 };
  ...
  if ((typeof o == `function` && (o = { callback: o }), o?.callback)) {
    ...
    lf(
      ...
      Object.assign(Object.assign({}, o), {
        callback: (e) => {
          s(e ? uf(e, o.headerOptions) : void 0);
        },
      }),
    );
  } else {
    let s = lf(e, t, n, r, i, a, o);
    return s ? uf(s, o?.headerOptions) : void 0;
  }
}
function ff(e) {
  let t = e.endsWith(`
...
function mf({ line: e, spanStart: t, spanLength: n }) {
  return {
...
function hf({ item: e, arr: t, enableJoin: n, isNeutral: r = !1, isLastItem: i = !1 }) {
  let a = t[t.length - 1];
  if (a == null || i || !n) {
...
function gf({
  ...
  let a = Math.max(t, 0);
  if (a === 0 || e)
    return { fromStart: 0, fromEnd: 0, rangeSize: a, collapsedLines: a, renderAll: !1 };
  if (n === !0 || a <= i)
    return { fromStart: a, fromEnd: 0, rangeSize: a, collapsedLines: 0, renderAll: !0 };
  let o = n?.get(r),
...
function _f({ fileDiff: e, errorPrefix: t }) {
  ...
  if (r <= 0 && i <= 0) return 0;
  if (r !== i)
    throw Error(`${t}: trailing context mismatch (additions=${r}, deletions=${i}) for ${e.name}`);
  return Math.min(r, i);
}
function vf({
  fileDiff: e,
  ...
  let a = _f({ fileDiff: e, errorPrefix: i });
  if (a <= 0) return;
  if (n === !0 || a <= r)
    return { fromStart: a, fromEnd: 0, rangeSize: a, collapsedLines: 0, renderAll: !0 };
  let o = n?.get(e.hunks.length),
    s = Math.min(Math.max(o?.fromStart ?? 0, 0), a);
  return { fromStart: s, fromEnd: 0, rangeSize: a, collapsedLines: a - s, renderAll: s >= a };
}
function yf({ type: e, metrics: t }) {
  return t.hunkSeparatorHeight ?? Id(e);
}
function bf({ type: e, metrics: t }) {
  return e === `simple` || e === `metadata` || e === `line-info-basic` ? 0 : t.spacing;
}
function xf({ type: e, hunkIndex: t, hunkSpecs: n }) {
  switch (e) {
    case `simple`:
      return t > 0;
    case `metadata`:
...
function Cf({ type: e, metrics: t, hunkIndex: n, hunkSpecs: r }) {
  if (!xf({ type: e, hunkIndex: n, hunkSpecs: r })) return;
  let i = yf({ type: e, metrics: t }),
    a = bf({ type: e, metrics: t }),
    o = n > 0 ? a : 0,
    s = a;
  return { height: i, gapBefore: o, gapAfter: s, totalHeight: o + i + s };
}
function wf({ type: e, metrics: t }) {
  if (!Sf(e)) return;
  let n = yf({ type: e, metrics: t }),
    r = bf({ type: e, metrics: t });
...
function Tf({
  ...
  hunkIterator: for (let n = s.hunkIndex; n < e.hunks.length; n++) {
    ...
    for (let e of r.hunkContent) {
      ...
      let i = e === ee;
      if (e.type === `context`) {
        if (c.shouldSkip(e.lines, e.lines)) (c.incrementCounts(e.lines, e.lines), f());
        else if (
          kf(
            c,
            e.lines,
        ...
        if (!c.shouldSkip(o, a)) {
          ...
          for (let [l, d] of s)
            for (let s = l; s < d; s++) {
              let l = u(
                p + s,
                t === `unified` ? m + (s < e.deletions ? s : s - e.deletions) : m + s,
              );
              if (
                c.emit(
                  jf({
...
function Ef({
  ...
  let a = Df({ diff: e, expandedHunks: r, collapsedContextThreshold: i }),
    o = 0,
    s = e.hunks.length - 1,
    c = e.hunks.length;
  for (; o <= s; ) {
...
function Df({ diff: e, expandedHunks: t, collapsedContextThreshold: n }) {
  let r = 0,
    i = 0,
    a = e.hunks.length - 1,
...
function Of(e, t, n) {
  ...
  if ((n !== `split` && i(e.unifiedCount), n !== `unified` && i(e.splitCount), r.length === 0))
    return [0, 0];
  let a = r[0][0],
    o = r[0][1];
...
function jf({
  ...
  let g = a < f.deletions ? o + a : void 0,
    ...
    ie =
      ee != null && te != null && g != null
        ? { lineNumber: te, lineIndex: ee, noEOFCR: ne, unifiedLineIndex: g, splitLineIndex: v }
        : void 0,
    ae =
      y != null && b != null && _ != null
        ? { unifiedLineIndex: _, splitLineIndex: v, lineIndex: y, lineNumber: b, noEOFCR: re }
        : void 0;
  if (ie == null && ae != null)
    return {
      type: `change`,
  ...
  if (ie == null || ae == null) throw Error(`iterateOverDiff: missing change line data`);
  return {
    type: `change`,
    hunkIndex: e,
    hunk: t,
...
function Nf(
  ...
  for (let i of g.values()) {
    ...
    let a = { name: e.prevName ?? e.name, contents: i.deletionContent.value },
      ...
      { deletionLines: s, additionLines: c } = If({
        deletionFile: a,
...
function Pf({
  ...
  if (
    ...
    t == null ||
    o === `none` ||
    ((e = y(e)), (t = y(t)), e.length > s || t.length > s)
  )
    return;
  let c = o === `char` ? Bd(e, t) : tf(e, t),
    l = [],
    u = [],
    d = o === `word-alt`,
    f = c.at(-1);
  for (let e of c) {
    let t = e === f;
    !e.added && !e.removed
      ? (hf({ item: e, arr: l, enableJoin: d, isNeutral: !0, isLastItem: t }),
        hf({ item: e, arr: u, enableJoin: d, isNeutral: !0, isLastItem: t }))
      : e.removed
        ? hf({ item: e, arr: l, enableJoin: d, isLastItem: t })
        : hf({ item: e, arr: u, enableJoin: d, isLastItem: t });
  }
  let p = 0;
  for (let e of l)
    (e[0] === 1 && i.push(mf({ line: n, spanStart: p, spanLength: e[1].length })),
      (p += e[1].length));
  p = 0;
  for (let e of u)
    (e[0] === 1 && a.push(mf({ line: r, spanStart: p, spanLength: e[1].length })),
      (p += e[1].length));
}
function Ff() {
  return {
...
function If({
  ...
  let u = s ?? X(e.name),
    d = s ?? X(t.name),
    { state: f, transformers: p } = qu(l.useTokenTransformer),
    m =
      typeof c == `string`
        ? {
            ...l,
  ...
  return {
    deletionLines:
      e.contents === ``
        ? []
        : ((m.lang = u), (f.lineInfo = n), (m.decorations = a), Qu(i.codeToHast(y(e.contents), m))),
    additionLines:
      t.contents === ``
        ? []
        : ((m.lang = d), (m.decorations = o), (f.lineInfo = r), Qu(i.codeToHast(y(t.contents), m))),
  };
}
function Lf(e) {
  let t = e.lang ?? X(e.name),
    n = e.lang ?? (e.prevName == null ? `text` : X(e.prevName));
...
var zf = 1e3,
  Bf = zf * 4,
  Vf = [0, 1e-6, 0.99999, 1],
  Hf = { overscrollSize: zf, intersectionObserverMargin: Bf, resizeDebugging: !1 },
  Uf = 0,
  Wf = -1,
  Gf = class e {
    static __STOP = !1;
          ...
          (window.__TOGGLE = () => {
            e.__STOP
              ? ((e.__STOP = !1),
                ...
                x(this.computeRenderRangeAndEmit))
              : ((e.__lastScrollPosition = this.getScrollTop()), (e.__STOP = !0));
          }));
        for (let [e, t] of this.connectQueue.entries()) this.connect(e, t);
        (this.connectQueue.clear(), this.markDOMDirty(), x(this.computeRenderRangeAndEmit));
      }
    }
    instanceChanged(e, t) {
      (this.instancesChanged.add(e), t && this.markDOMDirty(), x(this.computeRenderRangeAndEmit));
    }
    getWindowSpecs() {
      return (
    ...
    handleContainerResize = (e) => {
      ...
      t && x(this.computeRenderRangeAndEmit);
    };
    setupWindow() {
    ...
    getOffsetInScrollContainer(e) {
      return this.getScrollTop() + Kf(e, this.getScrollContainerElement());
    }
    connect(e, t) {
    ...
    handleWindowResize = () => {
      e.__STOP ||
        ...
        ((this.heightDirty = !0), x(this.computeRenderRangeAndEmit));
    };
    handleWindowScroll = () => {
      e.__STOP ||
        this.root == null ||
        !(this.root instanceof Document) ||
        ((this.scrollDirty = !0), x(this.computeRenderRangeAndEmit));
    };
    handleElementScroll = () => {
      e.__STOP ||
        this.root == null ||
    ...
    computeRenderRangeAndEmit = () => {
      ...
      for (let e of this.instancesChanged) i.has(e) || (e.onRender(t) && i.add(e));
      this.scrollFix(r);
      for (let e of i) e.reconcileHeights();
      ((n ||= this.instancesChanged.size > 0),
        n && this.markDOMDirty(),
        (n || t) && x(this.computeRenderRangeAndEmit),
        i.clear(),
        this.instancesChanged.clear());
    };
    scrollFix(e) {
    ...
    handleIntersectionChange = (e) => {
      ...
      this.visibleInstancesDirty && x(this.computeRenderRangeAndEmit);
    };
    getScrollTop() {
...
function Jf(e) {
  for (let t of Array.isArray(e) ? e : [e]) if (!qn.has(t)) return !1;
  return !0;
}
async function Yf(e) {
  let t = [],
...
function tp(e) {
  let t = (0, Q.useRef)(e);
  return (
    (0, Q.useInsertionEffect)(() => void (t.current = e)),
    (0, Q.useCallback)((...e) => t.current(...e), [])
  );
}
var np = t(
    n((e, t) => {
  ...
  ap = class {
    ...
    constructor(
      ...
      ((this.options = e),
        ...
        (this.fileCache = new np.default.LRUMap(e.totalASTLRUCacheSize ?? 100)),
        (this.diffCache = new np.default.LRUMap(e.totalASTLRUCacheSize ?? 100)),
    ...
    async setRenderOptions({
      theme: e = this.renderOptions.theme ?? b,
      ...
      tokenizeMaxLineLength: i = this.renderOptions.tokenizeMaxLineLength ?? 1e3,
    }) {
      let { lifecycleGeneration: a } = this,
        o = ++this.renderOptionsRequestVersion,
        s = () => this.isCurrentLifecycle(a) && this.renderOptionsRequestVersion === o;
      try {
        let a = {
          theme: e,
        ...
        if ((this.isInitialized() || (await this.initialize()), !s() || pf(a, this.renderOptions)))
          return;
        let o = yu(e),
          c = [];
        if ((fe(a.theme, this.renderOptions.theme) || (c = xu(o) ? Xf(o) : await Zf(o)), !s()))
          return;
        if (this.highlighter != null) du(c, this.highlighter);
        else {
          let e = await gu({
            themes: o,
            langs: [`text`],
      ...
      if (t != null) {
        ...
        cp(n)
          ? (this.detachInstanceFromRenderTask(n, e),
            !n.primeCache && n.instances.size === 0 && this.removeActiveTask(n))
          : this.activeTaskById.delete(t);
      }
      (this.activeRequestByInstance.delete(e), this.queueBroadcastStateChanges());
    }
    isInitialized() {
      ...
      if (this.initialized !== !0)
        if (this.initialized === !1) {
          ...
          ((this.initialized = new Promise((n, r) => {
            (async () => {
              try {
                let r = yu(this.renderOptions.theme),
                  i = [];
                if (((i = xu(r) ? Xf(r) : await Zf(r)), !this.isCurrentLifecycle(t))) {
                  n();
                  return;
                }
                let a = [];
                if (((a = Jf(e) ? qf(e) : await Yf(e)), !this.isCurrentLifecycle(t))) {
                  n();
                  return;
                }
                ...
                if (e instanceof ip || !this.isCurrentLifecycle(t)) {
                  n();
                  return;
                }
                ((this.initialized = !1),
    ...
    drainQueue = () => {
      if (
        ((this._queuedDrain = void 0), !(this.initialized !== !0 || this.queuedTasks.length === 0))
      ) {
    ...
    highlightFileAST(e, t) {
      ...
      sd(t) ||
        (n != null && Su(n.options, this.getFileRenderOptions())) ||
    ...
    primeFileHighlightCache(e) {
      ...
      if (n == null || sd(e) || (t != null && Su(t.options, this.getFileRenderOptions()))) return;
      let r = this.getTaskByHighlightKey(n);
      r == null ? this.submitCacheTask({ type: `file`, file: e }, n) : (r.primeCache = !0);
    }
    getPlainFileAST(e, t, n, r) {
      ...
      return id(e, this.highlighter, this.renderOptions, {
        forcePlainText: !0,
        startingLine: t,
        totalLines: n,
        lines: r,
    ...
    highlightDiffAST(e, t) {
      ...
      Lf(t) ||
        (n != null && pf(n.options, this.getDiffRenderOptions())) ||
    ...
    primeDiffHighlightCache(e) {
      ...
      if (n == null || Lf(e) || (t != null && pf(t.options, this.getDiffRenderOptions()))) return;
      let r = this.getTaskByHighlightKey(n);
      r == null ? this.submitCacheTask({ type: `diff`, diff: e }, n) : (r.primeCache = !0);
    }
    getPlainDiffAST(e, t, n, r, i) {
      return this.highlighter == null
        ? void 0
        : Nf(e, this.highlighter, this.renderOptions, {
            forcePlainText: !0,
            startingLine: t,
            totalLines: n,
            expandedHunks: r,
    ...
    cancelActiveWorkerTasks() {
      let e = new ip();
      for (let t of this.activeTaskById.values()) `reject` in t && t.reject(e);
    }
    terminateWorkers() {
    ...
    submitCacheTask(e, t) {
      ...
      this.enqueueRenderTask(a);
    }
    enqueueRenderTask(e, t) {
      (this.queuedTasks.push(e),
        t != null && this.queuedTaskByInstance.set(t, e),
        e.highlightKey != null && this.taskByHighlightKey.set(e.highlightKey, e),
        this.queueDrain());
    }
    async resolveLanguagesAndExecuteTask(e, t, n) {
      try {
        ...
        if (
          (r.length > 0 &&
            (Jf(r)
              ? (t.request.resolvedLanguages = qf(r))
              : (t.request.resolvedLanguages = await Yf(r))),
    ...
    handleWorkerMessage(e, t) {
      ...
      try {
        ...
        if (t.type === `error`) {
          ...
          else if (cp(n)) this.notifyHighlightError(n, e);
          ...
          switch (t.requestType) {
            ...
            case `file`: {
              ...
              if (!this.isCurrentRenderTask(n) || !Su(i, this.getFileRenderOptions())) throw rp;
              let { request: a } = n;
              (this.syncCustomExtensionVersion(e, a),
                a.file.cacheKey != null &&
                  this.fileCache.set(a.file.cacheKey, { result: r, options: i }),
            ...
            case `diff`: {
              ...
              let { result: r, options: i } = t;
              if (!this.isCurrentRenderTask(n) || !pf(i, this.getDiffRenderOptions())) throw rp;
              let { request: a } = n;
              (this.syncCustomExtensionVersion(e, a),
                a.diff.cacheKey != null &&
                  this.diffCache.set(a.diff.cacheKey, { result: r, options: i }),
                this.notifyDiffInstances(n, r, i));
              break;
            }
          }
      } catch (e) {
        e !== rp && console.error(e, n, t);
      }
    ...
    assignWorkerToTask(e, t) {
      ((t.requestId = e.id),
        cp(e) && (this.clearQueuedInstanceRequests(e), this.trackInstanceRequests(e)),
    ...
    cleanWorkerAndTask(e, t, n = t?.id) {
      (e.requestId === n && (e.requestId = void 0),
        ...
        t != null &&
          (cp(t) && (this.clearInstanceRequests(t), this.clearHighlightKey(t)),
          this.activeTaskById.delete(t.id)));
    }
    executeTask(e, t) {
      (op(t.request) && this.maybeAttachCustomExtensions(e, t.request),
        this.activeTaskById.has(t.id) || this.assignWorkerToTask(t, e));
      for (let n of sp(t)) e.langs.add(n);
      try {
        e.worker.postMessage(t.request);
      } catch (n) {
        (console.error(`Failed to post message to worker:`, n),
          cp(t) ? this.notifyHighlightError(t, n) : `reject` in t && t.reject(n),
          this.cleanWorkerAndTask(e, t),
          this.queuedTasks.length > 0 && this.queueDrain());
      }
      this.queueBroadcastStateChanges();
    ...
    maybeAttachCustomExtensions(e, t) {
      ...
      e.customExtensionsVersion >= n ||
        ((t.customExtensionsVersion = n), (t.customExtensionMap = Fu()));
    }
    ...
    getAvailableWorker(e) {
      ...
      for (let n of this.workers) {
        if (n.requestId != null || n.pendingSetupRequestId != null || !n.initialized) continue;
    ...
    getFileHighlightKey(e) {
      if (e.cacheKey != null) return `file:${e.cacheKey}:${this.renderOptionsVersion}`;
    }
    getDiffHighlightKey(e) {
      if (e.cacheKey != null) return `diff:${e.cacheKey}:${this.renderOptionsVersion}`;
    }
    ...
    hasActiveRequest(e) {
      for (let t of lp(e)) if (this.activeRequestByInstance.has(t)) return !0;
      return !1;
    }
    ...
    detachInstanceFromQueuedTasks(e, t) {
      ...
      n == null ||
        ...
        this.detachInstanceFromRenderTask(n, e),
        !n.primeCache && n.instances.size === 0 && this.removeQueuedTask(n));
    }
    ...
    removeActiveTask(e) {
      (this.clearInstanceRequests(e), this.clearHighlightKey(e), this.activeTaskById.delete(e.id));
    }
    invalidateRenderTasks() {
      for (let e = this.queuedTasks.length - 1; e >= 0; e--) {
        let t = this.queuedTasks[e];
        t.renderOptionsVersion !== this.renderOptionsVersion && this.removeQueuedTask(t);
      }
      for (let e of Array.from(this.activeTaskById.values()))
        cp(e) && e.renderOptionsVersion !== this.renderOptionsVersion && this.removeActiveTask(e);
    }
    clearQueuedInstanceRequests(e) {
      for (let t of lp(e))
        this.queuedTaskByInstance.get(t) === e && this.queuedTaskByInstance.delete(t);
    }
    clearHighlightKey(e) {
      e.highlightKey != null &&
    ...
    trackInstanceRequests(e) {
      for (let t of lp(e)) this.activeRequestByInstance.set(t, e.id);
    }
    clearInstanceRequests(e) {
      for (let t of lp(e))
        this.activeRequestByInstance.get(t) === e.id && this.activeRequestByInstance.delete(t);
    }
    notifyFileInstances(e, t, n) {
      for (let r of e.instances)
        this.activeRequestByInstance.get(r) === e.id && r.onHighlightSuccess(e.request.file, t, n);
    }
    notifyDiffInstances(e, t, n) {
      for (let r of e.instances)
        this.activeRequestByInstance.get(r) === e.id && r.onHighlightSuccess(e.request.diff, t, n);
    }
    notifyHighlightError(e, t) {
      for (let n of lp(e)) this.activeRequestByInstance.get(n) === e.id && n.onHighlightError(t);
    }
    ...
    *iterateRenderTasks() {
      ...
      for (let e of this.activeTaskById.values()) cp(e) && (yield e);
    }
    generateRequestId() {
...
function sp(e) {
  ...
  switch (e.type) {
    case `file`:
      t.add(e.request.file.lang ?? X(e.request.file.name));
      break;
    case `diff`:
      (t.add(e.request.diff.lang ?? X(e.request.diff.name)),
        t.add(e.request.diff.lang ?? X(e.request.diff.prevName ?? `-`)));
      break;
  }
...
var up;
function dp({ poolOptions: e, highlighterOptions: t }) {
  return ((up ??= new ap(e, t)), up);
}
function fp() {
  up != null && (up.terminate(), (up = void 0));
}
var $ = i(),
  pp = (0, Q.createContext)(void 0),
  mp = 0;
function hp({ children: e, poolOptions: t, highlighterOptions: n }) {
  let [r] = (0, Q.useState)(() => {
    if (!(typeof window > `u`)) return dp({ poolOptions: t, highlighterOptions: n });
  });
  return (
    ...
    (0, $.jsx)(pp.Provider, { value: r, children: e })
  );
}
function gp() {
  return (0, Q.useContext)(pp);
}
var _p = (0, Q.createContext)(void 0);
function vp() {
  return (0, Q.useContext)(_p);
}
function yp(e, t) {
...
var bp = (0, Q.createContext)(void 0);
function xp() {
  return (0, Q.useContext)(bp);
}
var Sp = `var(--color-token-main-surface-primary)`,
  Cp = `var(--color-token-diff-surface)`,
  wp = `
  --codex-diffs-surface: ${Sp};
...
function Ep(e, t) {
  return e ? (t === `diff` ? Cp : Sp) : `var(--color-token-side-bar-background)`;
}
var Dp = `` + new URL(`worker.js`, import.meta.url).href;
function Op() {
  return new Worker(Dp, { type: `module` });
}
var kp = a(),
  Ap = 4,
  jp = 100,
  Mp = [`typescript`, `javascript`, `css`, `html`, `python`];
function Np(e) {
  let t = (0, kp.c)(13),
    { children: n } = e,
    r = ie(re()),
    i = l(s.lightCodeThemeId),
    a = l(s.darkCodeThemeId),
    c = o(f),
    u;
  t[0] !== r || t[1] !== a || t[2] !== i
    ? ((u = r === `light` ? d(i, `light`) : d(a, `dark`)),
      (t[0] = r),
      (t[1] = a),
      (t[2] = i),
      (t[3] = u))
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = { workerFactory: Op, poolSize: Ap, totalASTLRUCacheSize: jp }), (t[4] = h))
    : (h = t[4]);
  let g, _;
  t[5] !== m || t[6] !== p
    ? ((g = { theme: p, lineDiffType: m, langs: Mp }),
      (_ = (0, $.jsx)(Pp, { lineDiffType: m, theme: p })),
      (t[5] = m),
      (t[6] = p),
      (t[7] = g),
      (t[8] = _))
  ...
  return (
    t[9] !== n || t[10] !== g || t[11] !== _
      ? ((v = (0, $.jsxs)(hp, { poolOptions: h, highlighterOptions: g, children: [_, n] })),
        (t[9] = n),
        (t[10] = g),
        (t[11] = _),
        (t[12] = v))
...
function Ip(e) {
  ...
  let r;
  return (
    t[0] === n ? (r = t[1]) : ((r = (0, $.jsx)(Np, { children: n })), (t[0] = n), (t[1] = r)), r
  );
}
export {
  wu as $,
...
//# sourceMappingURL=shiki-highlight-provider-gate.js.map
