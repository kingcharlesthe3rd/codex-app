...
import { n as ne, r as re } from "./use-resolved-theme-variant.js";
import { n as ie } from "./is-compact-window-context.js";
...
`;
    ...
    return (
      fr(a), { lineLength: o, lineTokens: s, ruleStack: c.stack, stoppedEarly: c.stoppedEarly }
    );
  }
};
function li(e, t) {
...
var Ga = [
    ...
    },
    {
      ...
      name: `JSON`,
      import: () =>
        i(() => import(`./json-2.js`), __vite__mapDeps([86, 8]), import.meta.url),
    },
    {
      id: `json5`,
      name: `JSON5`,
...
var bo = Ha({
    langs: Ja,
    themes: Ya,
    engine: () => yo(i(() => import(`./wasm-2.js`), [], import.meta.url)),
  }),
  {
    codeToHtml: xo,
    codeToHast: So,
...
async function Zl({ themes: e, langs: t, preferredHighlighter: n = `shiki-js` }) {
  q ??= bo({
    themes: [],
    langs: [`text`],
    engine: n === `shiki-wasm` ? yo(i(() => import(`./wasm-2.js`), [], import.meta.url)) : Bl(),
  });
  let r = $l(q) ? await q : q;
  q = r;
  let a = [];
...
function qf(e) {
  let t = (0, Uf.c)(13),
    { children: n } = e,
    i = re(ne()),
    a = l(r.lightCodeThemeId),
    o = l(r.darkCodeThemeId),
    s = c(y),
    u;
  t[0] !== i || t[1] !== o || t[2] !== a
    ? ((u = i === `light` ? f(a, `light`) : f(o, `dark`)),
      (t[0] = i),
      (t[1] = o),
      (t[2] = a),
      (t[3] = u))
