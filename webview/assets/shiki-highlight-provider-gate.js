...
import { R as a, s as o } from "./app-scope.js";
import { O as s } from "./src-4.js";
...
import { n as te, r as ne } from "./use-resolved-theme-variant.js";
import { n as re } from "./is-compact-window-context.js";
...
function x({ tagName: e, children: t = [], properties: n = {} }) {
  return { type: `element`, tagName: e, properties: n, children: t };
}
function ce({ name: e, width: t = 16, height: n = 16, properties: r }) {
  return x({
    tagName: `svg`,
    properties: { width: t, height: n, viewBox: `0 0 16 16`, ...r },
    children: [x({ tagName: `use`, properties: { href: `#${e.replace(/^#/, ``)}` } })],
  });
}
function le(e) {
  let t = e.children[0];
...
function ue(e) {
  return x({ tagName: `div`, properties: { "data-gutter": `` }, children: e });
}
function de(e, t, n, r = {}) {
  return x({
    tagName: `div`,
...
function pe() {
  return x({
    ...
    children: [ce({ name: `diffs-icon-plus`, properties: { "data-icon": `` } })],
  });
}
function me(e, t) {
...
((ge.prototype.normal = {}), (ge.prototype.property = {}), (ge.prototype.space = void 0));
function _e(e, t) {
  let n = {},
    r = {};
...
var we = Object.keys(ye),
  Te = class extends S {
    constructor(e, t, n, r) {
      let i = -1;
      if ((super(e, t), Ee(this, `space`, r), typeof n == `number`))
        for (; ++i < we.length; ) {
          let e = we[i];
          Ee(this, we[i], (n & ye[e]) === ye[e]);
        }
    }
  };
Te.prototype.defined = !0;
function Ee(e, t, n) {
  n && (e[t] = n);
}
function De(e) {
  ...
  for (let [r, i] of Object.entries(e.properties)) {
    let a = new Te(r, e.transform(e.attributes || {}, r), i, e.space);
    (e.mustUseProperty && e.mustUseProperty.includes(r) && (a.mustUseProperty = !0),
      (t[r] = a),
      (n[ve(r)] = r),
      (n[ve(a.attribute)] = r));
  }
  return new ge(t, n, e.space);
}
var Oe = De({
  properties: {
...
function ze(e, t) {
  ...
  if (n.length > 4 && n.slice(0, 4) === `data` && Re.test(t)) {
    if (t.charAt(4) === `-`) {
      let e = t.slice(5).replace(Le, Ve);
      r = `data` + e.charAt(0).toUpperCase() + e.slice(1);
    } else {
      let e = t.slice(4);
      if (!Le.test(e)) {
        let n = e.replace(Ie, Be);
...
var He = _e([Oe, je, Ne, Pe, Fe], `html`),
  Ue = _e([Oe, Me, Ne, Pe, Fe], `svg`),
  We = /["&'<>`]/g,
  Ge = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
  Ke = /[\x01-\t\v\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g,
  qe = /[|\\{}()[\]^$+*?.]/g,
  Je = new WeakMap();
function Ye(e, t) {
  if (((e = e.replace(t.subset ? Xe(t.subset) : We, r)), t.subset || t.escapeOnly)) return e;
  return e.replace(Ge, n).replace(Ke, r);
  function n(e, n, r) {
    return t.format(
...
function Xe(e) {
  let t = Je.get(e);
  return (t || ((t = Ze(e)), Je.set(e, t)), t);
}
function Ze(e) {
  let t = [],
    n = -1;
  for (; ++n < e.length; ) t.push(e[n].replace(qe, `\\$&`));
  return RegExp(`(?:` + t.join(`|`) + `)`, `g`);
}
var Qe = /[\dA-Fa-f]/;
function $e(e, t, n) {
  let r = `&#x` + e.toString(16).toUpperCase();
  return n && t && !Qe.test(String.fromCharCode(t)) ? r : r + `;`;
}
var et = /\d/;
function tt(e, t, n) {
  let r = `&#` + String(e);
  return n && t && !et.test(String.fromCharCode(t)) ? r : r + `;`;
}
var nt =
  ...
  it = [`cent`, `copy`, `divide`, `gt`, `lt`, `not`, `para`, `times`],
  at = {}.hasOwnProperty,
  ot = {},
  st;
for (st in rt) at.call(rt, st) && (ot[rt[st]] = st);
var ct = /[^\dA-Za-z]/;
function lt(e, t, n, r) {
...
function ut(e, t, n) {
  ...
  if (
    ((n.useNamedReferences || n.useShortestReferences) &&
      (i = lt(e, t, n.omitOptionalSemicolons, n.attribute)),
...
function dt(e, t) {
  return Ye(e, Object.assign({ format: ut }, t));
}
var ft = /^>|^->|<!--|-->|--!>|<!-$/g,
  pt = [`>`],
  mt = [`<`, `>`];
function ht(e, t, n, r) {
  return r.settings.bogusComments
    ? `<?` + dt(e.value, Object.assign({}, r.settings.characterReferences, { subset: pt })) + `>`
    : `<!--` + e.value.replace(ft, i) + `-->`;
  function i(e) {
    return dt(e, Object.assign({}, r.settings.characterReferences, { subset: mt }));
  }
}
function gt(e, t, n, r) {
  return (
...
function wt(e) {
  return t;
  function t(t, n, r) {
    let i = t ? t.children : Ct,
      a = (n || 0) + e,
      o = i[a];
    if (!r) for (; o && bt(o); ) ((a += e), (o = i[a]));
    return o;
  }
}
...
function Et(e) {
  return t;
  function t(t, n, r) {
    return Tt.call(e, t.tagName) && e[t.tagName](t, n, r);
  }
}
var Dt = Et({
  body: At,
...
function Ot(e, t, n) {
  let r = O(n, t, !0);
  return !r || (r.type !== `comment` && !(r.type === `text` && bt(r.value.charAt(0))));
}
function kt(e, t, n) {
  let r = O(n, t);
...
var Ut = Et({ body: Kt, colgroup: qt, head: Gt, html: Wt, tbody: Jt });
function Wt(e) {
  let t = O(e, -1);
...
function Kt(e) {
  ...
  return (
    !t ||
    (t.type !== `comment` &&
      !(t.type === `text` && bt(t.value.charAt(0))) &&
      !(
        t.type === `element` &&
        (t.tagName === `meta` ||
          t.tagName === `link` ||
...
function Xt(e, t, n, r) {
  let i = r.schema,
    ...
    s = [],
    c;
  i.space === `html` && e.tagName === `svg` && (r.schema = Ue);
  let l = Zt(r, e.properties),
...
function Qt(e, t, n) {
  ...
  let c = dt(
    r.attribute,
    Object.assign({}, e.settings.characterReferences, { subset: Yt.name[i][a] }),
  );
  return n === !0 ||
    ((n = Array.isArray(n)
      ? (r.commaSeparated ? _t : vt)(n, { padLeft: !e.settings.tightCommaSeparatedLists })
      : String(n)),
      ...
      s !== n &&
        ...
        (s =
          ...
          dt(
            n,
            Object.assign({}, e.settings.characterReferences, {
              subset: (o === `'` ? Yt.single : Yt.double)[i][a],
              attribute: !0,
            }),
          ) +
          o)),
...
function en(e, t, n, r) {
  return n && n.type === `element` && (n.tagName === `script` || n.tagName === `style`)
    ? e.value
    : dt(e.value, Object.assign({}, r.settings.characterReferences, { subset: $t }));
}
function tn(e, t, n, r) {
  return r.settings.allowDangerousHtml ? e.value : en(e, t, n, r);
}
function nn(e, t, n, r) {
  return r.all(e);
}
var rn = ae(`type`, {
  invalid: an,
  unknown: on,
  handlers: { comment: ht, doctype: gt, element: Xt, raw: tn, root: nn, text: en },
});
function an(e) {
...
function un(e, t) {
  ...
  return {
    ...
    settings: {
      ...
      voids: n.voids || he,
      characterReferences: n.characterReferences || cn,
      closeSelfClosing: n.closeSelfClosing || !1,
      closeEmptyElements: n.closeEmptyElements || !1,
    },
    schema: n.space === `svg` ? Ue : He,
    quote: r,
    alternative: i,
  }.one(Array.isArray(e) ? { type: `root`, children: e } : e, void 0, void 0);
}
function dn(e, t, n) {
  return rn(e, t, n, this);
}
function fn(e) {
  let t = [],
    n = (e && e.children) || ln,
...
var pn = class {
  ...
  setSelection(e) {
    let t = !(e === this.selectedRange || oe(e ?? void 0, this.selectedRange ?? void 0));
  ...
  handlePointerClick = (e) => {
    ...
    (t == null && n == null && r == null && a == null && i == null) ||
      (this.options.onGutterUtilityClick != null && Tn(e.composedPath())) ||
      (k(this.options.__debugPointerEvents, `click`, `FileDiff.DEBUG.handlePointerClick:`, e),
  ...
  handlePointerMove = (e) => {
    ...
    (t === `disabled` && !o && n == null && r == null && i == null && a == null) ||
      (k(this.options.__debugPointerEvents, `move`, `FileDiff.DEBUG.handlePointerMove:`, e),
  ...
  handlePointerLeave = (e) => {
    ...
    if (
      ...
      k(t, `move`, `FileDiff.DEBUG.handlePointerLeave: returned early, no hovered line or token`);
      return;
    }
    (this.gutterUtilityContainer?.remove(),
  ...
  handlePointerEvent({ eventType: e, event: t }) {
    let { __debugPointerEvents: n } = this.options,
      r = t.composedPath();
    k(n, e, `FileDiff.DEBUG.handlePointerEvent:`, { eventType: e, composedPath: r });
    let i = this.resolvePointerTarget(r);
    k(n, e, `FileDiff.DEBUG.handlePointerEvent: resolvePointerTarget result:`, i);
    let {
      onLineClick: a,
      onLineNumberClick: o,
      onLineEnter: s,
    ...
    switch (e) {
      case `move`: {
        let e = vn(i) && this.hoveredLine?.lineElement === i.lineElement;
        ((_n(i) && this.hoveredToken?.tokenElement === i.tokenElement) ||
      ...
      case `click`: {
        ...
        if (!vn(i)) break;
        _n(i) && l != null && l(this.toTokenEventBaseProps(i), t);
  ...
  syncPointerListeners(e) {
    ...
    g && !this.hasPointerListeners
      ? (e.addEventListener(`click`, this.handlePointerClick),
        ...
        k(t, `move`, `FileDiff.DEBUG.attachEventListeners: Attaching pointer move event`),
        k(t, `move`, `FileDiff.DEBUG.attachEventListeners: Attaching pointer leave event`))
      : !g &&
  ...
  handlePointerDown = (e) => {
    ...
    Tn(t) && this.options.onGutterUtilityClick != null
  ...
  getSelectionPointerInfo(e, t) {
    ...
    if (gn(n) && !(t && !n.numberColumn) && n.splitLineIndex != null)
      return {
  ...
  getSelectionPointFromPath(e) {
    ...
    if (gn(t)) return { lineNumber: t.lineNumber, side: this.mode === `diff` ? t.side : void 0 };
  }
  getLineIndex(e, t) {
  ...
  resolvePointerTarget(e) {
    ...
    if (
      ((i ??= a == null ? void 0 : Sn(r, `[data-line][data-line-index="${a}"]`)),
      (o ??= a == null ? void 0 : Sn(r, `[data-column-number][data-line-index="${a}"]`)),
...
function jn(e) {
  for (let t of Array.isArray(e) ? e : [e])
    if (!(t === `text` || t === `ansi`) && !An.has(t)) return !1;
  return !0;
}
function Mn(e, t) {
  e = Array.isArray(e) ? e : [e];
  for (let n of e) {
    if (An.has(n.name)) continue;
    let e = Dn.get(n.name);
    (e ?? ((e = n), Dn.set(n.name, e)), An.add(e.name), t.loadLanguageSync(e.data));
  }
}
function Nn() {
...
function Fn(e) {
  return Array.isArray(e) ? In(e) : e instanceof RegExp ? e : typeof e == `object` ? Ln(e) : e;
}
function In(e) {
  let t = [];
  for (let n = 0, r = e.length; n < r; n++) t[n] = Fn(e[n]);
  return t;
}
function Ln(e) {
  let t = {};
...
function zn(e) {
  ...
  return t === 0 ? e : ~t === e.length - 1 ? zn(e.substring(0, e.length - 1)) : e.substr(~t + 1);
}
var Bn = /\$(\d+)|\${(\d+):\/(downcase|upcase)}/g,
  Vn = class {
    static hasCaptures(e) {
      return e === null ? !1 : ((Bn.lastIndex = 0), Bn.test(e));
    }
    static replaceCaptures(e, t, n) {
      return e.replace(Bn, (e, r, i, a) => {
...
var Kn = class {
  ...
  qn = class {
    ...
    static createFromRawTheme(e, t) {
      return this.createFromParsedTheme(Qn(e), t);
    }
    static createFromParsedTheme(e, t) {
      return er(e, t);
    }
    _cachedMatchRoot = new Kn((e) => this._root.match(e));
    getColorMap() {
    ...
    match(e) {
      ...
      let t = e.scopeName,
        n = this._cachedMatchRoot.get(t).find((t) => Yn(e.parent, t.parentScopes));
      return n ? new Zn(n.fontStyle, n.foreground, n.background) : null;
    }
  },
  Jn = class e {
    constructor(e, t) {
...
function er(e, t) {
  e.sort((e, t) => {
    let n = Hn(e.scope, t.scope);
    return n !== 0 || ((n = Un(e.parentScopes, t.parentScopes)), n !== 0) ? n : e.index - t.index;
  });
  let n = 0,
    r = `#000000`,
    i = `#ffffff`;
  ...
  let a = new tr(t),
    o = new Zn(n, a.getId(r), a.getId(i)),
    s = new ir(new rr(0, null, -1, 0, 0), []);
  for (let t = 0, n = e.length; t < n; t++) {
    let n = e[t];
  ...
  ir = class e {
    ...
    insert(t, n, r, i, a, o) {
      ...
      (this._children.hasOwnProperty(c)
        ? (u = this._children[c])
        : ((u = new e(this._mainRule.clone(), rr.cloneArr(this._rulesWithParentScopes))),
          (this._children[c] = u)),
    ...
    _doInsertHere(e, t, n, r, i) {
      ...
      (n === -1 && (n = this._mainRule.fontStyle),
        ...
        this._rulesWithParentScopes.push(new rr(e, t, n, r, i)));
    }
  },
  ar = class e {
  ...
  hr = class {
    constructor(e, t) {
      ((this.repo = e),
        ...
        (this.Q = [new fr(this.initialScopeName)]));
    }
    ...
    processQueue() {
      ...
      this.Q = [];
      let t = new mr();
      for (let n of e) gr(n, this.initialScopeName, this.repo, t);
...
function gr(e, t, n, r) {
  ...
  let a = n.lookup(t);
  e instanceof fr
    ? vr({ baseGrammar: a, selfGrammar: i }, r)
    : _r(e.ruleName, { baseGrammar: a, selfGrammar: i, repository: i.repository }, r);
  let o = n.injections(e.scopeName);
  if (o) for (let e of o) r.add(new fr(e));
}
function _r(e, t, n) {
...
function vr(e, t) {
  (e.selfGrammar.patterns &&
    ...
    yr(e.selfGrammar.patterns, { ...e, repository: e.selfGrammar.repository }, t),
...
function yr(e, t, n) {
  for (let r of e) {
    ...
    n.visitedRule.add(r);
    let e = r.repository ? Rn({}, t.repository, r.repository) : t.repository;
    Array.isArray(r.patterns) && yr(r.patterns, { ...t, repository: e }, n);
    let i = r.include;
    if (!i) continue;
    let a = Tr(i);
    switch (a.kind) {
      case 0:
        vr({ ...t, selfGrammar: t.baseGrammar }, n);
        break;
      case 1:
        vr(t, n);
        break;
      case 2:
        _r(a.ruleName, { ...t, repository: e }, n);
        break;
      case 3:
      case 4:
        let r =
        ...
        if (r) {
          ...
          a.kind === 4 ? _r(a.ruleName, i, n) : vr(i, n);
        } else a.kind === 4 ? n.add(new pr(a.scopeName, a.ruleName)) : n.add(new fr(a.scopeName));
        break;
    }
  }
}
...
function Tr(e) {
  ...
  if (e === `$self`) return new xr();
  let t = e.indexOf(`#`);
  return t === -1
    ? new Cr(e)
    : t === 0
      ? new Sr(e.substring(1))
...
var Mr = class {
    ...
    constructor(e, t, n, r) {
      ((this.$location = e),
        ...
        (this._contentNameIsCapturing = Vn.hasCaptures(this._contentName)));
    }
    get debugName() {
      let e = this.$location ? `${zn(this.$location.filename)}:${this.$location.line}` : `unknown`;
    ...
    _getCachedCompiledPatterns(e) {
      return (
        this._cachedCompiledPatterns ||
          ((this._cachedCompiledPatterns = new Br()),
  ...
  Ir = class extends Mr {
    ...
    constructor(e, t, n, r, i, a, o, s, c, l) {
      (super(e, t, n, r),
        (this._begin = new zr(i, this.id)),
        (this.beginCaptures = a),
        (this._end = new zr(o || `￿`, -1)),
  ...
  Lr = class extends Mr {
    ...
    _getCachedCompiledWhilePatterns(e, t) {
      return (
        this._cachedCompiledWhilePatterns ||
          ((this._cachedCompiledWhilePatterns = new Br()),
  ...
  Rr = class e {
    static createCaptureRule(e, t, n, r, i) {
      return e.registerRule((e) => new Nr(t, e, n, r, i));
    }
      ...
      return (
        t.id ||
          n.registerRule((i) => {
            ...
            if (t.begin === void 0) {
              t.repository && (r = Rn({}, r, t.repository));
              let i = t.patterns;
              return (
        ...
        for (let a = 0, o = t.length; a < o; a++) {
          ...
          if (s !== -1) {
            let e = n.getRule(s),
              t = !1;
            if (
              ((e instanceof Fr || e instanceof Ir || e instanceof Lr) &&
  ...
  zr = class e {
    ...
    constructor(e, t) {
      ...
      (this.hasAnchor ? (this._anchorCache = this._buildAnchorCache()) : (this._anchorCache = null),
        ...
        typeof this.source == `string`
          ? (this.hasBackReferences = Er.test(this.source))
    ...
    resolveBackReferences(e, t) {
      ...
      return ((Dr.lastIndex = 0), this.source.replace(Dr, (e, t) => Gn(n[parseInt(t, 10)] || ``)));
    }
    _buildAnchorCache() {
      if (typeof this.source != `string`)
        throw Error(`This method should only be called if the source is a string`);
...
`);
  ...
  Ur = class e {
    ...
    constructor(e, t) {
      ((this._defaultAttributes = new Hr(e, 8)),
    ...
    static _NULL_SCOPE_METADATA = new Hr(0, 0);
    _getBasicScopeAttributes = new Kn(
      (e) => new Hr(this._scopeToLanguage(e), this._toStandardTokenType(e)),
    );
    _scopeToLanguage(e) {
...
function qr(e, t, n, r, i, a, o, s) {
  let c = t.content.length,
    ...
    u = -1;
  if (o) {
    let o = Jr(e, t, n, r, i, a);
    ((i = o.stack), (r = o.linePos), (n = o.isFirstLine), (u = o.anchorPosition));
  }
  let d = Date.now();
  for (; !l; ) {
    if (s !== 0 && Date.now() - d > s) return new Kr(i, !0);
    f();
  }
  return new Kr(i, !1);
  function f() {
    let o = Yr(e, t, n, r, i, u);
    if (!o) {
      (a.produce(i, c), (l = !0));
      return;
    }
    ...
    if (d === Or) {
      ...
      if (((i = i.push(d, r, u, s[0].end === c, null, h, h)), o instanceof Ir)) {
        let r = o;
        (ti(e, t, n, i, a, r.beginCaptures, s), a.produce(i, s[0].end), (u = s[0].end));
      ...
      } else if ((ti(e, t, n, i, a, o.captures, s), a.produce(i, s[0].end), (i = i.pop()), !f)) {
...
function Jr(e, t, n, r, i, a) {
  ...
  for (let t = i; t; t = t.pop()) {
    let n = t.getRule(e);
    n instanceof Lr && s.push({ rule: n, stack: t });
  }
  for (let c = s.pop(); c; c = s.pop()) {
    let { ruleScanner: s, findOptions: l } = $r(c.rule, e, c.stack.endRule, n, r === o),
    ...
    if (u) {
      ...
      u.captureIndices &&
        ...
        ti(e, t, n, c.stack, a, c.rule.whileCaptures, u.captureIndices),
...
function Yr(e, t, n, r, i, a) {
  let o = Xr(e, t, n, r, i, a),
    s = e.getInjections();
  if (s.length === 0) return o;
  let c = Zr(s, e, t, n, r, i, a);
  if (!c) return o;
  if (!o) return c;
...
function Xr(e, t, n, r, i, a) {
  let { ruleScanner: o, findOptions: s } = Qr(i.getRule(e), e, i.endRule, n, r === a),
...
function Zr(e, t, n, r, i, a, o) {
  ...
  for (let a = 0, f = e.length; a < f; a++) {
    ...
    let { ruleScanner: p, findOptions: m } = Qr(t.getRule(f.ruleId), t, null, r, i === o),
...
function Qr(e, t, n, r, i) {
  return Gr
    ? { ruleScanner: e.compile(t, n), findOptions: ei(r, i) }
    : { ruleScanner: e.compileAG(t, n, r, i), findOptions: 0 };
}
function $r(e, t, n, r, i) {
  return Gr
    ? { ruleScanner: e.compileWhile(t, n), findOptions: ei(r, i) }
...
function ti(e, t, n, r, i, a, o) {
  ...
  for (let t = 0; t < c; t++) {
    ...
    if (
      ...
      (qr(e, p, n && d.start === 0, d.start, f, i, !1, 0), dr(p));
      continue;
    }
    let f = c.getName(s, o);
    if (f !== null) {
...
function ri(e, t, n, r, i, a, o, s) {
  return new si(e, t, n, r, i, a, o, s);
}
function ii(e, t, n, r, i) {
  let a = cr(t, ai),
    o = Rr.getCompiledRuleId(n, r, i.repository);
  for (let n of a)
...
function ai(e, t) {
  ...
  let n = 0;
  return e.every((e) => {
    for (let r = n; r < t.length; r++) if (oi(t[r], e)) return ((n = r + 1), !0);
    return !1;
  });
}
function oi(e, t) {
...
var si = class {
  constructor(e, t, n, r, i, a, o, s) {
    if (
      ...
      (this._onigLib = s),
      (this._basicScopeAttributesProvider = new Ur(n, r)),
      (this._rootId = -1),
      (this._lastRuleId = 0),
      (this._ruleId2desc = [null]),
      (this._includedGrammars = {}),
      (this._grammarRepository = o),
      (this._grammar = ci(t, null)),
  ...
  _collectInjections() {
    ...
    if (r) {
      let e = r.injections;
      if (e) for (let n in e) ii(t, n, e[n], this, r);
  ...
  getExternalGrammar(e, t) {
    ...
    if (this._grammarRepository) {
      ...
      if (n) return ((this._includedGrammars[e] = ci(n, t && t.$base)), this._includedGrammars[e]);
    }
  }
  ...
  _tokenize(e, t, n, r) {
    this._rootId === -1 &&
      ((this._rootId = Rr.getCompiledRuleId(
    ...
    if (!t || t === ui.NULL) {
      ...
      let e = this._basicScopeAttributesProvider.getDefaultAttributes(),
        ...
        r = ar.set(0, e.languageId, e.tokenType, null, n.fontStyle, n.foregroundId, n.backgroundId),
        a = this.getRule(this._rootId).getName(null, null),
        o;
      ((o = a ? li.createRootAndLookUpScopeName(a, r, this) : li.createRoot(`unknown`, r)),
        (t = new ui(null, this._rootId, -1, -1, !1, null, o, o)));
    } else ((i = !1), t.reset());
    e += `
`;
    let a = this.createOnigString(e),
      o = a.content.length,
      s = new fi(n, e, this._tokenTypeMatchers, this.balancedBracketSelectors),
      c = qr(this, a, i, 0, t, s, !0, r);
    return (
      dr(a), { lineLength: o, lineTokens: s, ruleStack: c.stack, stoppedEarly: c.stoppedEarly }
    );
  }
};
function ci(e, t) {
...
var li = class e {
    ...
    static fromExtension(t, n) {
      let r = t,
        i = t?.scopePath ?? null;
      for (let t of n)
        ((i = Jn.push(i, t.scopeNames)), (r = new e(r, i, t.encodedTokenAttributes)));
      return r;
    }
    static createRoot(t, n) {
      return new e(null, new Jn(null, t), n);
    }
    ...
    static mergeAttributes(e, t, n) {
      ...
      return (
        ...
        ar.set(e, t.languageId, t.tokenType, null, r, i, a)
      );
    }
    pushAttributed(t, n) {
  ...
  ui = class e {
    ...
    static _equals(e, t) {
      return e === t
        ...
        : this._structuralEquals(e, t)
          ? li.equals(e.contentNameScopesList, t.contentNameScopesList)
          : !1;
    }
    ...
    static pushFrame(t, n) {
      let r = li.fromExtension(t?.nameScopesList ?? null, n.nameScopesList);
      return new e(
        t,
        Ar(n.ruleId),
        n.enterPos ?? -1,
        ...
        n.endRule,
        r,
        li.fromExtension(r, n.contentNameScopesList),
      );
    }
  },
  di = class {
    ...
    constructor(e, t) {
      ((this.balancedBracketScopes = e.flatMap((e) =>
        e === `*` ? ((this.allowAny = !0), []) : cr(e, ai).map((e) => e.matcher),
      )),
        (this.unbalancedBracketScopes = t.flatMap((e) => cr(e, ai).map((e) => e.matcher))));
    }
    get matchesAlways() {
      ...
      if (this._emitBinaryTokens) {
        ...
        if (
          ...
          for (let e of this._tokenTypeOverrides)
            e.matcher(t) && (n = ar.set(n, 0, or(e.type), null, -1, 0, 0));
          this.balancedBracketSelectors && (r = this.balancedBracketSelectors.match(t));
        }
        if (
          (r && (n = ar.set(n, 0, 8, r, -1, 0, 0)),
  ...
  pi = class {
    ...
    grammarForScopeName(e, t, n, r, i) {
      if (!this._grammars.has(e)) {
        ...
        if (!a) return null;
        this._grammars.set(e, ri(e, a, t, n, r, i, this, this._onigLib));
      }
  ...
  mi = class {
    ...
    constructor(e) {
      ((this._options = e),
        (this._syncRegistry = new pi(qn.createFromRawTheme(e.theme, e.colorMap), e.onigLib)),
    ...
    setTheme(e, t) {
      this._syncRegistry.setTheme(qn.createFromRawTheme(e, t));
    }
    getColorMap() {
    ...
    loadGrammarWithConfiguration(e, t, n) {
      return this._loadGrammar(
        ...
        n.embeddedLanguages,
        n.tokenTypes,
        new di(n.balancedBracketSelectors || [], n.unbalancedBracketSelectors || []),
      );
    }
    loadGrammar(e) {
    ...
    _loadGrammar(e, t, n, r, i) {
      let a = new hr(this._syncRegistry, e);
      for (; a.Q.length > 0; )
...
var Ri = class e {
  ...
  static initial(t, n) {
    return new e(Object.fromEntries(vi(n).map((e) => [e, hi])), t);
  }
  constructor(...e) {
    if (e.length === 2) {
      let [t, n] = e;
...
function Bi(e, t) {
  if (!(e instanceof Ri)) throw new A(`Invalid grammar state`);
...
function Vi() {
  ...
  function t(t) {
    if (!e.has(t.meta)) {
      ...
      (Hi(i), e.set(t.meta, { decorations: i, converter: r, source: t.source }));
    }
    return e.get(t.meta);
  }
  return {
    ...
    code(e) {
      ...
      function i(e, t, n, i) {
        ...
        if (c === -1)
          throw new A(`Failed to find start index for decoration ${JSON.stringify(i.start)}`);
        if (l === -1)
          throw new A(`Failed to find end index for decoration ${JSON.stringify(i.end)}`);
      ...
      function o(e, t, n) {
        ...
        return (
          ...
          t.properties?.class && wi(e, t.properties.class),
          (e = i(e, n) || e),
          e
        );
      }
...
function Ui(e) {
  return e.type === `text` ? e.value : e.type === `element` ? e.children.map(Ui).join(``) : ``;
}
var Wi = [Vi()];
function Gi(e) {
  let t = Ki(e.transformers || []);
  return [...t.pre, ...t.normal, ...t.post, ...Wi];
}
function Ki(e) {
  let t = [],
    n = [],
...
function Zi(e) {
  ...
  for (; e.length > 0; ) {
    ...
    if (!Number.isNaN(r))
      if (r === 0) t.push({ type: `resetAll` });
      else if (r <= 9) Ji[r] && t.push({ type: `setDecoration`, value: Ji[r] });
      else if (r <= 29) {
        let e = Ji[r - 20];
        e &&
        ...
        t.push({ type: `setForegroundColor`, value: { type: `named`, name: qi[r - 30] } });
      else if (r === 38) {
        let n = Xi(e);
        n && t.push({ type: `setForegroundColor`, value: n });
      } else if (r === 39) t.push({ type: `resetForegroundColor` });
      else if (r <= 47)
        t.push({ type: `setBackgroundColor`, value: { type: `named`, name: qi[r - 40] } });
      else if (r === 48) {
        let n = Xi(e);
            ...
            : r === 55
              ...
              : r >= 90 && r <= 97
                ? t.push({
                    ...
                    value: { type: `named`, name: qi[r - 90 + 8] },
                  })
                : r >= 100 &&
                  r <= 107 &&
                  t.push({
                    type: `setBackgroundColor`,
                    value: { type: `named`, name: qi[r - 100 + 8] },
                  });
  }
  return t;
}
...
function ea(e = $i) {
  ...
  function i() {
    if (r) return r;
    r = [];
    for (let e = 0; e < qi.length; e++) r.push(t(qi[e]));
...
function ia(e, t, n = {}) {
  ...
  if (bi(i) || Si(r)) return Ti(t).map((e) => [{ content: e[0], offset: e[1] }]);
  let { theme: a, colorMap: o } = e.setTheme(r);
  if (i === `ansi`) return na(a, t, n);
...
function aa(...e) {
  if (e.length === 2) return Li(e[1]);
  let [t, n, r = {}] = e,
    { lang: i = `text`, theme: a = t.getLoadedThemes()[0] } = r;
  if (bi(i) || Si(a)) throw new A(`Plain language does not have grammar state`);
  if (i === `ansi`) throw new A(`ANSI language does not have grammar state`);
  let { theme: o, colorMap: s } = t.setTheme(a),
    c = t.getLanguage(i);
  return new Ri(sa(n, c, o, s, r).stateStack, c.name, o.name);
}
function oa(e, t, n, r, i) {
  let a = sa(e, t, n, r, i),
    o = new Ri(a.stateStack, t.name, n.name);
  return (Ii(a.tokens, o), a.tokens);
}
function sa(e, t, n, r, i) {
  let a = gi(n, i),
    ...
    c = Ti(e),
    l = i.grammarState
      ? (Bi(i.grammarState, n.name) ?? hi)
      : i.grammarContextCode == null
        ? hi
        : sa(i.grammarContextCode, t, n, r, {
            ...i,
            grammarState: void 0,
      ...
      if (i.includeExplanation) {
        ...
        for (; t + r < o; ) {
          ...
          ((r += n.length),
            d.explanation.push({
              content: n,
              scopes: i.includeExplanation === `scopeName` ? ca(t.scopes) : la(e, t.scopes),
            }),
            (g += 1));
        }
      }
...
function la(e, t) {
  ...
  for (let r = 0, i = t.length; r < i; r++) {
    let i = t[r];
    n[r] = { scopeName: i, themeMatches: fa(e, i, t.slice(0, r)) };
  }
  return n;
}
function ua(e, t) {
...
function da(e, t, n) {
  if (!ua(e[e.length - 1], t)) return !1;
  let r = e.length - 2,
    i = n.length - 1;
  for (; r >= 0 && i >= 0; ) (ua(e[r], n[i]) && --r, --i);
  return r === -1;
}
function fa(e, t, n) {
  let r = [];
...
function ha(e, t, n) {
  ...
  if (`themes` in n) {
    ...
    let p = pa(e, t, n);
    if (((c = Li(p)), l && Oi !== l && !f.find((e) => e.color === l)))
      throw new A(`\`themes\` option must contain the defaultColor key \`${l}\``);
    let m = f.map((t) => e.getTheme(t.theme)),
      h = f.map((e) => e.color);
    ((a = p.map((e) => e.map((e) => Mi(e, h, u, l, d)))), c && Ii(a, c));
    let g = f.map((e) => gi(e.theme, n));
    ((i = ga(f, m, g, u, l, `fg`, d)),
      (r = ga(f, m, g, u, l, `bg`, d)),
    ...
    ((r = _i(l.bg, s)), (i = _i(l.fg, s)), (o = l.name), (c = Li(a)));
    ...
    .map((s, c) => {
      ...
      if (c === 0 && i) {
        if (i === Oi && e.length > 1) {
          ...
          return `light-dark(${_i(t[r][a], n[r]) || `inherit`}, ${_i(t[i][a], n[i]) || `inherit`});${u}`;
        }
        return l;
      }
...
function _a(
  ...
  r = {
    meta: {},
    options: n,
    codeToHast: (t, n) => _a(e, t, n),
    codeToTokens: (t, n) => ha(e, t, n),
  },
) {
  let i = t;
  for (let e of Gi(n)) i = e.preprocess?.call(r, i, n) || i;
  let { tokens: a, fg: o, bg: s, themeName: c, rootStyle: l, grammarState: u } = ha(e, i, n),
    { mergeWhitespaces: d = !0, mergeSameStyleTokens: f = !1 } = n;
  (d === !0 ? (a = ya(a)) : d === `never` && (a = ba(a)), f && (a = xa(a)));
  let p = {
    ...r,
    get source() {
      return i;
  ...
  for (let e of Gi(n)) a = e.tokens?.call(p, a) || a;
  return va(
    a,
...
function ya(e) {
  return e.map((e) => {
    ...
    return (
      e.forEach((i, a) => {
        let o = !(i.fontStyle && (i.fontStyle & j.Underline || i.fontStyle & j.Strikethrough));
...
function xa(e) {
  return e.map((e) => {
    ...
    for (let n of e) {
      ...
      let e = t[t.length - 1],
        r = Pi(e.htmlStyle || Ni(e)),
        i = Pi(n.htmlStyle || Ni(n)),
        a = e.fontStyle && (e.fontStyle & j.Underline || e.fontStyle & j.Strikethrough),
        o = n.fontStyle && (n.fontStyle & j.Underline || n.fontStyle & j.Strikethrough);
...
function Ca(e, t, n) {
  let r = {
    ...
    i = Sa(_a(e, t, n, r));
  for (let e of Gi(n)) i = e.postprocess?.call(r, i, n) || i;
  return i;
}
var wa = { light: `#333333`, dark: `#bbbbbb` },
  Ta = { light: `#fffffe`, dark: `#1e1e1e` },
  Ea = `__shiki_resolved`;
function Da(e) {
  if (e?.[Ea]) return e;
  let t = { ...e };
  ...
  if (!n || !r) {
    ...
    (e?.settings?.foreground && (r = e.settings.foreground),
      ...
      (r ||= t.type === `light` ? wa.light : wa.dark),
      (n ||= t.type === `light` ? Ta.light : Ta.dark),
      (t.fg = r),
      (t.bg = n));
  }
  ...
  return (Object.defineProperty(t, Ea, { enumerable: !1, writable: !1, value: !0 }), t);
}
async function Oa(e) {
  return Array.from(
    new Set(
      (
        await Promise.all(
          e
            .filter((e) => !xi(e))
            .map(async (e) => await yi(e).then((e) => (Array.isArray(e) ? e : [e]))),
        )
      ).flat(),
    ),
  );
...
async function ka(e) {
  return (await Promise.all(e.map(async (e) => (Ci(e) ? null : Da(await yi(e)))))).filter(
    (e) => !!e,
  );
}
var Aa = 3,
  ja = !1;
function Ma(e, t = 3) {
  if (Aa && !(typeof Aa == `number` && t > Aa)) {
    if (ja) throw Error(`[SHIKI DEPRECATE]: ${e}`);
...
function Pa(e, t) {
  ...
  if (t[e]) {
    ...
    for (; t[e]; ) {
      if (((e = t[e]), n.has(e)))
        throw new Na(`Circular alias \`${Array.from(n).join(` -> `)} -> ${e}\``);
      n.add(e);
    }
  }
  return e;
}
var Fa = class extends mi {
    constructor(e, t, n, r = {}) {
      (super(e),
        (this._resolver = e),
        (this._themes = t),
    ...
    setTheme(e) {
      ...
      (t || ((t = qn.createFromRawTheme(e)), this._textmateThemeCache.set(e, t)),
        this._syncRegistry.setTheme(t));
    }
    getGrammar(e) {
      return ((e = Pa(e, this._alias)), this._resolvedGrammars.get(e));
    }
    loadLanguage(e) {
...
function Ra(e) {
  ((La += 1),
    e.warnings !== !1 &&
      ...
      La % 10 == 0 &&
      console.warn(
        `[Shiki] ${La} instances have been created. Shiki is supposed to be used as a singleton, consider refactoring your code to cache your highlighter instance; Or call \`highlighter.dispose()\` to release unused instances.`,
      ));
  let t = !1;
  if (!e.engine) throw new Na("`engine` option is required for synchronous mode");
  let n = (e.langs || []).flat(1),
    r = (e.themes || []).flat(1).map(Da),
    i = new Fa(new Ia(e.engine, n), r, n, e.langAlias),
    a;
  function o(t) {
    return Pa(t, e.langAlias);
  }
  function s(e) {
    g();
    let t = i.getGrammar(typeof e == `string` ? e : e.name);
    if (!t) throw new Na(`Language \`${e}\` not found, you may need to load it first`);
    return t;
  }
  function c(e) {
    ...
    g();
    let t = i.getTheme(e);
    if (!t) throw new Na(`Theme \`${e}\` not found, you may need to load it first`);
    return t;
  }
  function l(e) {
    g();
  ...
  async function h(...e) {
    return (g(), m(await ka(e)));
  }
  function g() {
    if (t) throw new Na(`Shiki instance has been disposed`);
  }
  function _() {
    t || ((t = !0), i.dispose(), --La);
  }
...
async function za(e) {
  ...
  let [t, n, r] = await Promise.all([ka(e.themes || []), Oa(e.langs || []), e.engine]);
  return Ra({ ...e, themes: t, langs: n, engine: r });
}
async function Ba(e) {
  let t = await za(e);
  return {
    getLastGrammarState: (...e) => aa(t, ...e),
    codeToTokensBase: (e, n) => ia(t, e, n),
    codeToTokensWithThemes: (e, n) => pa(t, e, n),
    codeToTokens: (e, n) => ha(t, e, n),
    codeToHast: (e, n) => _a(t, e, n),
    codeToHtml: (e, n) => Ca(t, e, n),
    getBundledLanguages: () => ({}),
    getBundledThemes: () => ({}),
    ...t,
...
function Va(e) {
  ...
  async function i(e) {
    function i(n) {
      if (typeof n == `string`) {
        if (((n = e.langAlias?.[n] || n), xi(n))) return [];
        let r = t[n];
        if (!r)
          throw new A(
    ...
    let o = (e.themes ?? []).map((e) => a(e)),
      s = (e.langs ?? []).map((e) => i(e)),
      c = await Ba({ engine: e.engine ?? r(), ...e, themes: o, langs: s });
    return {
      ...c,
      loadLanguage(...e) {
...
var Wa = [
    { id: `abap`, name: `ABAP`, import: () => c(() => import(`./abap.js`), [], import.meta.url) },
    {
      id: `actionscript-3`,
      name: `ActionScript`,
    ...
    },
    {
      id: `ada`,
      name: `Ada`,
      import: () => c(() => import(`./ada.js`), [], import.meta.url),
    },
    {
      id: `angular-html`,
      name: `Angular HTML`,
      import: () =>
        c(() => import(`./angular-html-2.js`), __vite__mapDeps([0, 1, 2, 3, 4]), import.meta.url),
    },
    {
      id: `angular-ts`,
    ...
    },
    {
      id: `apex`,
      name: `Apex`,
      import: () => c(() => import(`./apex.js`), [], import.meta.url),
    },
    {
      id: `apl`,
      name: `APL`,
    ...
    { id: `ara`, name: `Ara`, import: () => c(() => import(`./ara.js`), [], import.meta.url) },
    {
      id: `asciidoc`,
      name: `AsciiDoc`,
      aliases: [`adoc`],
    ...
    { id: `asm`, name: `Assembly`, import: () => c(() => import(`./asm.js`), [], import.meta.url) },
    {
      ...
      name: `Astro`,
      import: () =>
        c(() => import(`./astro.js`), __vite__mapDeps([11, 3, 4, 8, 12, 13, 14]), import.meta.url),
    },
    { id: `awk`, name: `AWK`, import: () => c(() => import(`./awk.js`), [], import.meta.url) },
    {
      id: `ballerina`,
      name: `Ballerina`,
      import: () => c(() => import(`./ballerina.js`), [], import.meta.url),
    },
    {
      id: `bat`,
      name: `Batch File`,
    ...
    },
    {
      id: `c`,
      name: `C`,
      import: () => c(() => import(`./c.js`), __vite__mapDeps([20, 21]), import.meta.url),
    },
    {
      id: `cadence`,
      name: `Cadence`,
    ...
    },
    {
      id: `cmake`,
      name: `CMake`,
      import: () => c(() => import(`./cmake-1.js`), __vite__mapDeps([24, 25]), import.meta.url),
    },
    {
      id: `cobol`,
      name: `COBOL`,
    ...
    },
    {
      ...
      name: `CodeQL`,
      aliases: [`ql`],
      import: () => c(() => import(`./codeql-CJPC-MIg.js`), [], import.meta.url),
    },
    {
      id: `coffee`,
      name: `CoffeeScript`,
    ...
    { id: `coq`, name: `Coq`, import: () => c(() => import(`./coq.js`), [], import.meta.url) },
    {
      ...
      aliases: [`c++`],
      import: () =>
        c(() => import(`./cpp.js`), __vite__mapDeps([28, 29, 30, 21, 31, 17]), import.meta.url),
    },
    {
      id: `crystal`,
      name: `Crystal`,
    ...
    },
    {
      ...
      name: `C#`,
      aliases: [`c#`, `cs`],
      import: () => c(() => import(`./csharp-2.js`), __vite__mapDeps([34, 35]), import.meta.url),
    },
    {
      id: `css`,
      name: `CSS`,
      import: () => c(() => import(`./css.js`), __vite__mapDeps([36, 3]), import.meta.url),
    },
    {
      id: `csv`,
      name: `CSV`,
      import: () => c(() => import(`./csv.js`), __vite__mapDeps([37, 38]), import.meta.url),
    },
    {
      id: `cue`,
      name: `CUE`,
      import: () => c(() => import(`./cue.js`), [], import.meta.url),
    },
    {
      id: `cypher`,
      name: `Cypher`,
      aliases: [`cql`],
      import: () => c(() => import(`./cypher.js`), [], import.meta.url),
    },
    { id: `d`, name: `D`, import: () => c(() => import(`./d.js`), [], import.meta.url) },
    { id: `dart`, name: `Dart`, import: () => c(() => import(`./dart.js`), [], import.meta.url) },
    {
      id: `dax`,
      name: `DAX`,
      import: () => c(() => import(`./dax.js`), [], import.meta.url),
    },
    {
      id: `desktop`,
      name: `Desktop`,
    ...
    },
    {
      ...
      name: `Diff`,
      import: () =>
        c(() => import(`./diff-1.js`), __vite__mapDeps([39, 40]), import.meta.url),
    },
    {
      id: `docker`,
      name: `Dockerfile`,
    ...
    },
    {
      ...
      name: `Elm`,
      import: () =>
        c(() => import(`./elm.js`), __vite__mapDeps([43, 30, 21]), import.meta.url),
    },
    {
      id: `emacs-lisp`,
      name: `Emacs Lisp`,
    ...
    },
    {
      ...
      name: `Erlang`,
      aliases: [`erl`],
      import: () => c(() => import(`./erlang.js`), __vite__mapDeps([51, 52]), import.meta.url),
    },
    {
      id: `fennel`,
      name: `Fennel`,
    ...
    },
    {
      ...
      name: `Fluent`,
      aliases: [`ftl`],
      import: () => c(() => import(`./fluent-iaZ-V1I0.js`), [], import.meta.url),
    },
    {
      ...
      aliases: [`f`, `for`, `f77`],
      import: () =>
        c(() => import(`./fortran-fixed-form.js`), __vite__mapDeps([53, 54]), import.meta.url),
    },
    {
      ...
      import: () =>
        c(() => import(`./fortran-free-form.js`), __vite__mapDeps([55, 54]), import.meta.url),
    },
    {
      id: `fsharp`,
      name: `F#`,
      aliases: [`f#`, `fs`],
      import: () =>
        c(() => import(`./fsharp-BKb-mrXf.js`), __vite__mapDeps([56, 52]), import.meta.url),
    },
    {
      id: `gdresource`,
      name: `GDResource`,
    ...
    },
    {
      id: `gdscript`,
      name: `GDScript`,
      import: () => c(() => import(`./gdscript-2.js`), __vite__mapDeps([60, 58]), import.meta.url),
    },
    {
      id: `gdshader`,
      name: `GDShader`,
      import: () =>
        c(() => import(`./gdshader-1.js`), __vite__mapDeps([61, 59]), import.meta.url),
    },
    {
      id: `genie`,
      name: `Genie`,
    ...
    },
    {
      ...
      aliases: [`gjs`],
      import: () =>
        c(() => import(`./glimmer-js.js`), __vite__mapDeps([64, 3, 2, 4, 14]), import.meta.url),
    },
    {
      id: `glimmer-ts`,
      name: `Glimmer TS`,
    ...
    },
    {
      ...
      name: `GLSL`,
      import: () =>
        c(() => import(`./glsl-Du6-Gfop.js`), __vite__mapDeps([66, 30, 21]), import.meta.url),
    },
    {
      id: `gnuplot`,
      name: `Gnuplot`,
    ...
    },
    {
      id: `go`,
      name: `Go`,
      import: () => c(() => import(`./go-2.js`), __vite__mapDeps([67, 68]), import.meta.url),
    },
    {
      id: `graphql`,
      name: `GraphQL`,
    ...
    },
    {
      ...
      name: `Ruby Haml`,
      import: () =>
        c(() => import(`./haml-1.js`), __vite__mapDeps([71, 48, 3, 4]), import.meta.url),
    },
    {
      id: `handlebars`,
      name: `Handlebars`,
      aliases: [`hbs`],
      import: () =>
        c(() => import(`./handlebars.js`), __vite__mapDeps([72, 3, 2, 4, 50]), import.meta.url),
    },
    {
      id: `haskell`,
      name: `Haskell`,
    ...
    },
    {
      id: `hlsl`,
      name: `HLSL`,
      import: () => c(() => import(`./hlsl-1.js`), __vite__mapDeps([75, 76]), import.meta.url),
    },
    {
      id: `html`,
      name: `HTML`,
      import: () =>
        c(() => import(`./html-1.js`), __vite__mapDeps([77, 2, 3, 4]), import.meta.url),
    },
    {
      id: `html-derivative`,
    ...
    },
    {
      ...
      name: `HXML`,
      import: () =>
        c(() => import(`./hxml.js`), __vite__mapDeps([81, 74]), import.meta.url),
    },
    {
      id: `hy`,
      name: `Hy`,
      import: () => c(() => import(`./hy.js`), [], import.meta.url),
    },
    ...
    },
    {
      ...
      name: `JavaScript`,
      aliases: [`js`, `cjs`, `mjs`],
      import: () => c(() => import(`./javascript.js`), __vite__mapDeps([83, 4]), import.meta.url),
    },
    {
      id: `jinja`,
      name: `Jinja`,
    ...
    },
    {
      id: `json`,
      name: `JSON`,
      import: () => c(() => import(`./json.js`), __vite__mapDeps([86, 8]), import.meta.url),
    },
    {
      id: `json5`,
      name: `JSON5`,
    ...
    { id: `kdl`, name: `KDL`, import: () => c(() => import(`./kdl-C.js`), [], import.meta.url) },
    {
      id: `kotlin`,
      name: `Kotlin`,
      aliases: [`kt`, `kts`],
    ...
    },
    {
      id: `latex`,
      name: `LaTeX`,
      import: () => c(() => import(`./latex.js`), __vite__mapDeps([90, 91, 89]), import.meta.url),
    },
    {
      id: `lean`,
      name: `Lean 4`,
    ...
    },
    {
      id: `less`,
      name: `Less`,
      import: () => c(() => import(`./less.js`), __vite__mapDeps([92, 93]), import.meta.url),
    },
    {
      id: `liquid`,
      name: `Liquid`,
    ...
    { id: `log`, name: `Log file`, import: () => c(() => import(`./log.js`), [], import.meta.url) },
    {
      id: `logo`,
      name: `Logo`,
      import: () => c(() => import(`./logo.js`), [], import.meta.url),
    },
    {
      id: `lua`,
      name: `Lua`,
      import: () => c(() => import(`./lua-2.js`), __vite__mapDeps([95, 49, 21]), import.meta.url),
    },
    {
      id: `luau`,
      name: `Luau`,
      import: () => c(() => import(`./luau.js`), [], import.meta.url),
    },
    {
      id: `make`,
      name: `Makefile`,
    ...
    },
    {
      ...
      aliases: [`md`],
      import: () =>
        c(() => import(`./markdown-t.js`), __vite__mapDeps([96, 52]), import.meta.url),
    },
    {
      id: `marko`,
      name: `Marko`,
    ...
    },
    {
      ...
      name: `MDC`,
      import: () =>
        c(() => import(`./mdc.js`), __vite__mapDeps([98, 16, 2, 3, 4, 52, 50]), import.meta.url),
    },
    ...
    { id: `move`, name: `Move`, import: () => c(() => import(`./move-l.js`), [], import.meta.url) },
    {
      id: `narrat`,
    ...
    },
    {
      ...
      name: `Nextflow`,
      aliases: [`nf`],
      import: () => c(() => import(`./nextflow.js`), [], import.meta.url),
    },
    {
      id: `nginx`,
      name: `Nginx`,
    ...
    },
    {
      id: `postcss`,
      name: `PostCSS`,
      import: () => c(() => import(`./postcss-2.js`), __vite__mapDeps([104, 12]), import.meta.url),
    },
    {
      id: `powerquery`,
      name: `PowerQuery`,
    ...
    },
    {
      id: `prolog`,
      name: `Prolog`,
      import: () => c(() => import(`./prolog-Q.js`), [], import.meta.url),
    },
    {
      id: `proto`,
    ...
    },
    {
      id: `purescript`,
      name: `PureScript`,
      import: () => c(() => import(`./purescript-DS-XzqdL.js`), [], import.meta.url),
    },
    {
      id: `python`,
      name: `Python`,
    ...
    },
    {
      id: `qml`,
      name: `QML`,
      import: () => c(() => import(`./qml.js`), __vite__mapDeps([107, 4]), import.meta.url),
    },
    {
      id: `qmldir`,
      name: `QML Directory`,
    ...
    },
    {
      id: `r`,
      name: `R`,
      import: () => c(() => import(`./r-2.js`), __vite__mapDeps([108, 89]), import.meta.url),
    },
    {
      id: `racket`,
      name: `Racket`,
    ...
    },
    {
      id: `sas`,
      name: `SAS`,
      import: () => c(() => import(`./sas.js`), __vite__mapDeps([113, 17]), import.meta.url),
    },
    {
      id: `sass`,
      name: `Sass`,
      import: () => c(() => import(`./sass.js`), [], import.meta.url),
    },
    {
      id: `scala`,
      name: `Scala`,
    ...
    },
    {
      ...
      name: `SCSS`,
      import: () =>
        c(() => import(`./scss-1.js`), __vite__mapDeps([114, 6, 3]), import.meta.url),
    },
    {
      id: `sdbl`,
      name: `1C (Query)`,
      aliases: [`1c-query`],
      import: () => c(() => import(`./sdbl.js`), __vite__mapDeps([115, 19]), import.meta.url),
    },
    {
      id: `shaderlab`,
      name: `ShaderLab`,
      aliases: [`shader`],
      import: () => c(() => import(`./shaderlab.js`), __vite__mapDeps([116, 76]), import.meta.url),
    },
    {
      id: `shellscript`,
      name: `Shell`,
    ...
    },
    {
      id: `smalltalk`,
      name: `Smalltalk`,
      import: () => c(() => import(`./smalltalk.js`), [], import.meta.url),
    },
    {
      id: `solidity`,
      name: `Solidity`,
    ...
    },
    {
      ...
      import: () =>
        c(() => import(`./soy.js`), __vite__mapDeps([119, 2, 3, 4]), import.meta.url),
    },
    {
      id: `sparql`,
      name: `SPARQL`,
      import: () =>
        c(() => import(`./sparql-3uEO-0uN.js`), __vite__mapDeps([120, 121]), import.meta.url),
    },
    {
      id: `splunk`,
    ...
    },
    {
      id: `stata`,
      name: `Stata`,
      import: () => c(() => import(`./stata.js`), __vite__mapDeps([123, 17]), import.meta.url),
    },
    {
      id: `stylus`,
      name: `Stylus`,
      aliases: [`styl`],
      import: () => c(() => import(`./stylus-1.js`), __vite__mapDeps([124, 125]), import.meta.url),
    },
    {
      id: `svelte`,
      name: `Svelte`,
    ...
    },
    {
      id: `systemd`,
      name: `Systemd Units`,
      import: () => c(() => import(`./systemd.js`), [], import.meta.url),
    },
    {
      id: `talonscript`,
      name: `TalonScript`,
    ...
    },
    {
      ...
      name: `Terraform`,
      aliases: [`tf`, `tfvars`],
      import: () => c(() => import(`./terraform.js`), [], import.meta.url),
    },
    {
      id: `tex`,
      name: `TeX`,
      import: () =>
        c(() => import(`./tex-1.js`), __vite__mapDeps([128, 91, 89]), import.meta.url),
    },
    ...
    { id: `tsv`, name: `TSV`, import: () => c(() => import(`./tsv.js`), [], import.meta.url) },
    {
      id: `tsx`,
      name: `TSX`,
      import: () => c(() => import(`./tsx-2.js`), __vite__mapDeps([130, 13]), import.meta.url),
    },
    {
      id: `turtle`,
      name: `Turtle`,
      import: () =>
        c(() => import(`./turtle-1.js`), __vite__mapDeps([131, 121]), import.meta.url),
    },
    {
      id: `twig`,
      name: `Twig`,
    ...
    },
    {
      ...
      aliases: [`ts`, `cts`, `mts`],
      import: () =>
        c(() => import(`./typescript-CUD-6BMs.js`), __vite__mapDeps([133, 14]), import.meta.url),
    },
    {
      id: `typespec`,
      name: `TypeSpec`,
    ...
    { id: `vala`, name: `Vala`, import: () => c(() => import(`./vala.js`), [], import.meta.url) },
    {
      id: `vb`,
      name: `Visual Basic`,
      aliases: [`cmd`],
    ...
    { id: `vhdl`, name: `VHDL`, import: () => c(() => import(`./vhdl.js`), [], import.meta.url) },
    {
      id: `viml`,
      name: `Vim Script`,
    ...
    },
    {
      ...
      name: `Vyper`,
      aliases: [`vy`],
      import: () => c(() => import(`./vyper-mT-eXX6K.js`), [], import.meta.url),
    },
    {
      id: `wasm`,
      name: `WebAssembly`,
      import: () => c(() => import(`./wasm-B.js`), [], import.meta.url),
    },
    {
      id: `wenyan`,
      name: `Wenyan`,
    ...
    },
    {
      id: `wgsl`,
      name: `WGSL`,
      import: () => c(() => import(`./wgsl.js`), [], import.meta.url),
    },
    {
      id: `wikitext`,
      name: `Wikitext`,
    ...
    },
    {
      id: `xsl`,
      name: `XSL`,
      import: () => c(() => import(`./xsl-D.js`), __vite__mapDeps([139, 9, 10]), import.meta.url),
    },
    {
      id: `yaml`,
      name: `YAML`,
      aliases: [`yml`],
      import: () =>
        c(() => import(`./yaml-1.js`), __vite__mapDeps([140, 50]), import.meta.url),
    },
    {
      id: `zenscript`,
      name: `ZenScript`,
  ...
  Ga = Object.fromEntries(Wa.map((e) => [e.id, e.import])),
  Ka = Object.fromEntries(Wa.flatMap((e) => e.aliases?.map((t) => [t, e.import]) || [])),
  qa = { ...Ga, ...Ka },
  Ja = Object.fromEntries(
    [
      ...
      },
      {
        ...
        type: `light`,
        import: () => c(() => import(`./catppuccin-latte-cD-br84u.js`), [], import.meta.url),
      },
      {
      ...
      },
      {
        ...
        type: `dark`,
        import: () => c(() => import(`./dracula-soft-B7jP-cbA.js`), [], import.meta.url),
      },
      {
        id: `everforest-dark`,
        displayName: `Everforest Dark`,
        type: `dark`,
        import: () => c(() => import(`./everforest-dark-CZb-XGJ9.js`), [], import.meta.url),
      },
      {
        id: `everforest-light`,
      ...
      },
      {
        ...
        type: `dark`,
        import: () => c(() => import(`./github-dark-C.js`), [], import.meta.url),
      },
      {
      ...
      },
      {
        ...
        type: `dark`,
        import: () =>
          c(() => import(`./github-dark-high-contrast.js`), [], import.meta.url),
      },
      {
        id: `github-light`,
      ...
      },
      {
        ...
        type: `light`,
        import: () => c(() => import(`./gruvbox-light-soft.js`), [], import.meta.url),
      },
      {
        id: `houston`,
        displayName: `Houston`,
      ...
      },
      {
        ...
        type: `dark`,
        import: () => c(() => import(`./laserwave.js`), [], import.meta.url),
      },
      {
        id: `light-plus`,
      ...
      },
      {
        ...
        type: `dark`,
        import: () => c(() => import(`./solarized-dark-DG-g-dud.js`), [], import.meta.url),
      },
      {
        id: `solarized-light`,
      ...
      },
      {
        ...
        type: `dark`,
        import: () => c(() => import(`./synthwave-84.js`), [], import.meta.url),
      },
      {
        id: `tokyo-night`,
      ...
      },
      {
        ...
        displayName: `Vesper`,
        type: `dark`,
        import: () => c(() => import(`./vesper.js`), [], import.meta.url),
      },
      {
        id: `vitesse-black`,
      ...
      },
      {
        ...
        type: `dark`,
        import: () => c(() => import(`./vitesse-dark-D6-GjylP.js`), [], import.meta.url),
      },
      {
        id: `vitesse-light`,
...
async function $a(e) {
  ...
  function s(e) {
    ...
    for (let r = 1; r <= 4; r *= 2) {
      let i = t * (1 + 0.2 / r);
      if (((i = Math.min(i, e + 100663296)), o(Math.min(n, Qa(Math.max(e, i), 65536))))) return !0;
    }
    return !1;
  }
...
var eo = Object.defineProperty,
  to = (e, t, n) =>
    t in e ? eo(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n),
  M = (e, t, n) => to(e, typeof t == `symbol` ? t : t + ``, n),
  N = null;
function no(e) {
  throw new Ya(e.UTF8ToString(e.getLastOnigError()));
}
var ro = class e {
    constructor(t) {
      (M(this, `utf16Length`),
        ...
        M(this, `utf16Value`),
        M(this, `utf8Value`),
        M(this, `utf16OffsetToUtf8`),
        M(this, `utf8OffsetToUtf16`));
      let n = t.length,
  ...
  io = class e {
    constructor(t) {
      if (
        ...
        throw new Ya(`Must invoke loadWasm first.`);
      ...
      ((this.utf16Length = n.utf16Length),
        ...
        this.utf8Length < 1e4 && !e._sharedPtrInUse
          ? ((e._sharedPtr ||= N.omalloc(1e4)),
            (e._sharedPtrInUse = !0),
            N.HEAPU8.set(n.utf8Value, e._sharedPtr),
            (this.ptr = e._sharedPtr))
          : (this.ptr = n.createString(N)));
    }
...
(M(io, `LAST_ID`, 0), M(io, `_sharedPtr`, 0), M(io, `_sharedPtrInUse`, !1));
var ao = io,
  oo = class {
    constructor(e) {
      if ((M(this, `_onigBinding`), M(this, `_ptr`), !N))
        throw new Ya(`Must invoke loadWasm first.`);
      let t = [],
        n = [];
      ...
      (N.ofree(i), N.ofree(r), a === 0 && no(N), (this._onigBinding = N), (this._ptr = a));
    }
    dispose() {
              ...
              uo(n)
                ? (n =
                    typeof WebAssembly.instantiateStreaming == `function`
                      ? await go(n)(t)
                      : await _o(n)(t))
                : fo(n) || n instanceof WebAssembly.Module
                  ? (n = await ho(n)(t))
                  : `default` in n &&
                    n.default instanceof WebAssembly.Module &&
                    (n = await ho(n.default)(t))),
...
async function vo(e) {
  return (
    ...
    {
      createScanner(e) {
        return new oo(e.map((e) => (typeof e == `string` ? e : e.source)));
      },
      createString(e) {
        return new ao(e);
      },
...
var yo = Va({
    langs: qa,
    themes: Ja,
    engine: () => vo(c(() => import(`./wasm-D.js`), [], import.meta.url)),
  }),
  {
    codeToHtml: bo,
    codeToHast: xo,
    codeToTokens: So,
    codeToTokensBase: Co,
    codeToTokensWithThemes: wo,
    getSingletonHighlighter: To,
    getLastGrammarState: Eo,
  } = Ua(yo, { guessEmbeddedLanguages: Di });
function Do(e) {
...
var jo = P`\[\^?`,
  Mo = `c.? | C(?:-.?)?|${P`[pP]\{(?:\^?[-\x20_]*[A-Za-z][-\x20\w]*\})?`}|${P`x[89A-Fa-f]\p{AHex}(?:\\x[89A-Fa-f]\p{AHex})*`}|${P`u(?:\p{AHex}{4})? | x\{[^\}]*\}? | x\p{AHex}{0,2}`}|${P`o\{[^\}]*\}?`}|${P`\d{1,3}`}`,
  No = /[?*+][?+]?|\{(?:\d+(?:,\d*)?|,\d+)\}\??/,
  Po = new RegExp(
    P`
  \\ (?:
...
function Io(e, t = {}) {
  ...
  let r = ds(n.flags),
    ...
    o = [],
    s;
  for (Po.lastIndex = 0; (s = Po.exec(e)); ) {
    let t = Lo(a, e, s[0], Po.lastIndex);
    (t.tokens ? o.push(...t.tokens) : t.token && o.push(t.token),
      t.lastIndex !== void 0 && (Po.lastIndex = t.lastIndex));
  }
  let c = [],
    l = 0;
  (o
  ...
  let u = l || c.length;
  return { tokens: o.map((e) => (e.type === `EscapedNumber` ? ps(e, u) : e)).flat(), flags: r };
}
function Lo(e, t, n, r) {
  let [i, a] = n;
  if (n === `[` || n === `[^`) {
  ...
  if (i === `\\`) {
    if (`AbBGyYzZ`.includes(a)) return { token: Ho(n, n) };
    if (/^\\g[<']/.test(n)) {
    ...
    if (a === `K`) return { token: Yo(`keep`, n) };
    if (a === `N` || a === `R`) return { token: Jo(`newline`, n, { negate: a === `N` }) };
    if (a === `O`) return { token: Jo(`any`, n) };
    if (a === `X`) return { token: Jo(`text_segment`, n) };
    let e = Bo(n, { inCharClass: !1 });
    return Array.isArray(e) ? { tokens: e } : { token: e };
  }
  if (i === `(`) {
    if (a === `*`) return { token: os(n) };
    if (n === `(?{`) throw Error(`Unsupported callout "${n}"`);
    if (n.startsWith(`(?#`)) {
      if (t[r] !== `)`) throw Error(`Unclosed comment group "(?#"`);
      return { lastIndex: r + 1 };
    }
    if (/^\(\?[-imx]+[:)]$/.test(n)) return { token: as(n, e) };
    if (
      (e.pushModX(e.getCurrentModX()),
      e.numOpenGroups++,
      (n === `(` && !e.captureGroup) || n === `(?:`)
    )
      return { token: Qo(`group`, n) };
    if (n === `(?>`) return { token: Qo(`atomic`, n) };
    if (n === `(?=` || n === `(?!` || n === `(?<=` || n === `(?<!`)
      return {
        token: Qo(n[2] === `<` ? `lookbehind` : `lookahead`, n, { negate: n.endsWith(`!`) }),
      };
    if (
      (n === `(` && e.captureGroup) ||
      ...
      return { token: Qo(`capturing`, n, { ...(n !== `(` && { name: n.slice(3, -1) }) }) };
    if (n.startsWith(`(?~`)) {
      if (n === `(?~|`) throw Error(`Unsupported absence function kind "${n}"`);
      return { token: Qo(`absence_repeater`, n) };
    }
    throw n === `(?(`
...
`,
  ...
  return n === `.`
    ? { token: Jo(`dot`, n) }
    : n === `^` || n === `$`
      ? { token: Ho(e.singleline ? { "^": P`\A`, $: P`\Z` }[n] : n, n) }
      : n === `|`
        ? { token: Vo(n) }
        : No.test(n)
          ? { tokens: ms(n) }
...
function Ro(e, t, n) {
  let r = [qo(t[1] === `^`, t)],
    i = 1,
    a;
  for (Fo.lastIndex = n; (a = Fo.exec(e)); ) {
    let e = a[0];
    if (e[0] === `[` && e[1] !== `:`) (i++, r.push(qo(e[1] === `^`, e)));
    else if (e === `]`) {
      if (r.at(-1).type === `CharacterClassOpen`) r.push(F(93, e));
      else if ((i--, r.push(Wo(e)), !i)) break;
    } else {
      let t = zo(e);
      Array.isArray(t) ? r.push(...t) : r.push(t);
    }
  }
  return { tokens: r, lastIndex: Fo.lastIndex || e.length };
}
function zo(e) {
  if (e[0] === `\\`) return Bo(e, { inCharClass: !0 });
  if (e[0] === `[`) {
    let t = /\[:(?<negate>\^?)(?<name>[a-z]+):\]/.exec(e);
    if (!t || !ko.has(t.groups.name)) throw Error(`Invalid POSIX class "${e}"`);
    return Jo(`posix`, e, { value: t.groups.name, negate: !!t.groups.negate });
  }
  return e === `-` ? Go(e) : e === `&&` ? Ko(e) : F(Do(e), e);
}
function Bo(e, { inCharClass: t }) {
  let n = e[1];
  if (n === `c` || n === `C`) return is(e);
  if (`dDhHsSwW`.includes(n)) return cs(e);
  if (e.startsWith(P`\o{`))
  ...
  if (n === `u` || n === `x`) return F(fs(e), e);
  if (rs.has(n)) return F(rs.get(n), e);
  if (/\d/.test(n)) return Xo(t, e);
...
function Yo(e, t, n = {}) {
  return e === `keep`
    ...
    : { type: `Directive`, kind: e, flags: Ao(n.flags), raw: t };
}
function Xo(e, t) {
...
var ns = new Set([`COUNT`, `CMP`, `ERROR`, `FAIL`, `MAX`, `MISMATCH`, `SKIP`, `TOTAL_COUNT`]),
  rs = new Map([
    [`a`, 7],
    [`b`, 8],
    [`e`, 27],
...
function is(e) {
  ...
  return F(Do(t.toUpperCase()) - 64, e);
}
function as(e, t) {
  ...
  if ((a && (s.enable = a), o && (s.disable = o), e.endsWith(`)`)))
    return (t.replaceCurrentModX(i), Yo(`flags`, e, { flags: s }));
  if (e.endsWith(`:`))
    return (t.pushModX(i), t.numOpenGroups++, Qo(`group`, e, { ...((a || o) && { flags: s }) }));
...
function os(e) {
  ...
  let a = i
      ...
      : [],
    [o, s, c] = a,
    l = ns.has(n) ? n.toLowerCase() : `custom`;
  switch (l) {
    case `fail`:
    case `mismatch`:
    case `skip`:
  ...
  return $o(l, r ?? null, i?.split(`,`) ?? null, e);
}
function ss(e) {
  let t = null,
    n,
...
function cs(e) {
  ...
  return Jo({ d: `digit`, h: `hex`, s: `space`, w: `word` }[t], e, { negate: e[1] !== t });
}
function ls(e) {
  let { p: t, neg: n, value: r } = /^\\(?<p>[pP])\{(?<neg>\^?)(?<value>[^}]+)/.exec(e).groups;
  return Jo(`property`, e, { value: r, negate: (t === `P` && !n) || (t === `p` && !!n) });
}
function us(e) {
  let t = {};
  return (
...
function ps(e, t) {
  let { raw: n, inCharClass: r } = e,
    i = n.slice(1);
  if (!r && ((i !== `0` && i.length === 1) || (i[0] !== `0` && +i <= t))) return [Uo(n)];
  let a = [],
    o = i.match(/^[0-7]+|\d/g);
  for (let e = 0; e < o.length; e++) {
    ...
    if (e === 0 && t !== `8` && t !== `9`) {
      if (((r = parseInt(t, 8)), r > 127))
        throw Error(P`Octal encoded byte above 177 unsupported "${n}"`);
    } else r = Do(t);
    a.push(F(r, (e === 0 ? `\\` : ``) + t));
  }
  return a;
  ...
  for (; (r = n.exec(e)); ) {
    ...
    if (e[0] === `{`) {
      ...
      if (r) {
        ...
        if (+i > +a && e.endsWith(`?`)) {
          (n.lastIndex--, t.push(ss(e.slice(0, -1))));
          continue;
        }
      }
    }
    ...
    i = (e, t) => {
      ...
      switch (((a.parent = e), a.nextIndex++, n.type)) {
        ...
        case `Backreference`:
          return bs(n, a);
        case `Character`:
          return Ms(n.value, { useLastValid: !!t.isCheckingRangeEnd });
        ...
        case `CharacterSet`:
          return Cs(n, a);
        case `Directive`:
          return Is(n.kind, { flags: n.flags });
        case `GroupOpen`:
          return ws(n, a, t);
        case `NamedCallout`:
          return zs(n.kind, n.tag, n.arguments);
        case `Quantifier`:
          return Ts(n, a);
        case `Subroutine`:
          return Es(n, a);
...
function bs({ raw: e }, t) {
  let n = /^\\k[<']/.test(e),
    ...
    i = (n, r = !1) => {
      ...
      return ((t.hasNumberedRef = !0), As(r ? i + 1 - n : n, { orphan: a }));
    };
  if (n) {
...
function xs(e, t, n) {
  ...
  if (
    ...
    if (o.type === `Character` && e.type === `Character`) return (a.body.pop(), Ps(o, e));
    throw Error(`Invalid character class range`);
  }
  return Ms(Do(`-`));
}
function Ss({ negate: e }, t, n) {
  let { tokens: r, walk: i } = t,
    a = r[t.nextIndex],
    o = [Ns()],
    s = $s(a);
  for (; s.type !== `CharacterClassClose`; ) {
    if (s.type === `CharacterClassIntersector`) (o.push(Ns()), t.nextIndex++);
    else {
      let e = o.at(-1);
      e.body.push(i(e, n));
    }
...
function Cs({ kind: e, negate: t, value: n }, r) {
  let {
  ...
  if (e === `property`) {
    let r = Qs(n);
    if (ko.has(r) && !o?.has(r)) ((e = `posix`), (n = r));
    else
      return Ws(n, {
        negate: t,
        normalizeUnknownPropertyNames: i,
  ...
  return e === `posix` ? Bs(n, { negate: t }) : Fs(e, { negate: t });
}
function ws(e, t, n) {
  let {
      tokens: r,
    ...
    d = u && c.negate;
  if (
    (c.type === `CapturingGroup` && (i.push(c), c.name && Oo(a, c.name, []).push(c)),
    l && n.isInAbsenceFunction)
  )
    throw Error(`Nested absence function not supported by Oniguruma`);
  let f = ec(r[t.nextIndex]);
  for (; f.type !== `GroupClose`; ) {
    if (f.type === `Alternator`) (c.body.push(Os()), t.nextIndex++);
    else {
      let e = c.body.at(-1),
        t = s(e, {
          ...n,
      ...
      if ((e.body.push(t), (u || n.isInLookbehind) && !o)) {
        ...
        if (d || n.isInNegLookbehind) {
          if (Js(t) || t.type === `CapturingGroup`) throw Error(e);
        } else if (Js(t) || (Ys(t) && t.negate)) throw Error(e);
      }
    }
    f = ec(r[t.nextIndex]);
  }
...
function Ts({ kind: e, min: t, max: n }, r) {
  let i = r.parent,
    a = i.body.at(-1);
  if (!a || !gs(a)) throw Error(`Quantifier requires a repeatable token`);
  let o = Vs(e, t, n, a);
  return (i.body.pop(), o);
}
function Es({ raw: e }, t) {
...
function Ds(e, t) {
  ...
  return { type: `AbsenceFunction`, kind: e, body: Ks(t?.body) };
}
function Os(e) {
  return { type: `Alternative`, body: qs(e?.body) };
}
function ks(e, t) {
...
function js(e, t) {
  ...
  if (n.name !== void 0 && !Xs(n.name)) throw Error(`Group name "${n.name}" invalid in Oniguruma`);
  return {
    type: `CapturingGroup`,
    number: e,
    ...(n.name && { name: n.name }),
...
function Ns(e) {
  ...
  return { type: `CharacterClass`, kind: t.kind, negate: t.negate, body: qs(e?.body) };
}
function Ps(e, t) {
...
function Is(e, t = {}) {
  ...
  if (e === `flags`) return { type: `Directive`, kind: e, flags: Ao(t.flags) };
...
function I(e) {
  ...
  return { type: `Group`, ...(t && { atomic: t }), ...(n && { flags: n }), body: Ks(e?.body) };
}
function Rs(e) {
...
function Bs(e, t) {
  let n = !!t?.negate;
  if (!ko.has(e)) throw Error(`Invalid POSIX class "${e}"`);
...
function Hs(e, t) {
  return { type: `Regex`, body: Ks(t?.body), flags: e };
}
function Us(e) {
...
function Ws(e, t) {
  let n = {
    ...
    r = n.unicodePropertyMap?.get(Qs(e));
  if (!r) {
    if (n.normalizeUnknownPropertyNames) r = Zs(e);
    else if (n.unicodePropertyMap && !n.skipPropertyNameValidation)
      throw Error(P`Invalid Unicode property "\p{${e}}"`);
  }
  return { type: `CharacterSet`, kind: `property`, value: r ?? e, negate: n.negate };
}
function Gs({ flags: e, kind: t, name: n, negate: r, number: i }) {
  switch (t) {
    ...
    case `lookahead`:
    case `lookbehind`:
      return Rs({ behind: t === `lookbehind`, negate: r });
    default:
  ...
  function i(a, o = null, s = null, c = null) {
    let l = 0,
      ...
      d = {
        ...
        root: e,
        remove() {
          (nc(c).splice(Math.max(0, rc(s) + l), 1), l--, (u = !0));
        },
        removeAllNextSiblings() {
          return nc(c).splice(rc(s) + 1);
        },
        removeAllPrevSiblings() {
          let e = rc(s) + l;
          return ((l -= e), nc(c).splice(0, Math.max(0, e)));
        },
        replaceWith(e, t = {}) {
          let n = !!t.traverse;
          (c ? (c[Math.max(0, rc(s) + l)] = e) : (Ao(o, `Can't replace root node`)[s] = e),
            n && i(e, o, s, c),
            (u = !0));
        },
        replaceWithMultiple(e, t = {}) {
          let n = !!t.traverse;
          if ((nc(c).splice(Math.max(0, rc(s) + l), 1, ...e), (l += e.length - 1), n)) {
            let t = 0;
            for (let n = 0; n < e.length; n++) t += i(e[n], o, rc(s) + n + t, c);
          }
          u = !0;
        },
        skip() {
...
var ic = String.raw`\(\?(?:[:=!>A-Za-z\-]|<[=!]|\(DEFINE\))`;
function ac(e, t) {
...
var L = Object.freeze({ DEFAULT: `DEFAULT`, CHAR_CLASS: `CHAR_CLASS` });
function sc(e, t, n, r) {
  ...
  for (let t of e.matchAll(i)) {
    ...
    if (!i && (!r || (r === L.DEFAULT) == !o)) {
      n instanceof Function
        ? (s += n(t, { context: o ? L.CHAR_CLASS : L.DEFAULT, negated: a[a.length - 1] }))
        : (s += n);
      continue;
    }
...
var fc = new RegExp(
  String.raw`(?<noncapturingStart>${ic})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`,
  `gsu`,
);
function pc(e, t) {
  ...
  do {
    ...
    let t = 0,
      ...
      d = !1,
      f;
    for (fc.lastIndex = Number.isNaN(c) ? 0 : c + 7; (f = fc.exec(e)); ) {
      let {
        0: p,
        index: m,
...
function gc(e) {
  if (!RegExp(`${mc}\\+`).test(e)) return { pattern: e };
  let t = [],
    n = null,
    r = null,
    i = ``,
    a = 0,
    o;
  for (hc.lastIndex = 0; (o = hc.exec(e)); ) {
    let {
      0: s,
      index: c,
    ...
    if (s === `[`) (a || (r = c), a++);
      ...
      if (u === `+` && i && !i.startsWith(`(`)) {
        ...
        let t = -1;
        if (/^\{\d+\}$/.test(l)) e = oc(e, c + l.length, u, ``);
        else {
          if (i === `)` || i === `]`) {
            let t = i === `)` ? n : r;
...
var R = String.raw,
  _c = R`\(\?R=(?<rDepth>[^\)]+)\)|${R`\\g<(?<gRNameOrNum>[^>&]+)&R=(?<gRDepth>[^>]+)>`}`,
  vc = R`\(\?<(?![=!])(?<captureName>[^>]+)>`,
  yc = R`${vc}|(?<unnamed>\()(?!\?)`,
  bc = new RegExp(R`${vc}|${_c}|\(\?|\\?.`, `gsu`),
  xc = `Cannot use multiple overlapping recursions`;
function Sc(e, t) {
  let { hiddenCaptures: n, mode: r } = { hiddenCaptures: [], mode: `plugin`, ...t },
    i = t?.captureTransfers ?? new Map();
  if (!new RegExp(_c, `su`).test(e)) return { pattern: e, captureTransfers: i, hiddenCaptures: n };
  if (r === `plugin` && uc(e, R`\(\?\(DEFINE\)`, L.DEFAULT))
    throw Error(`DEFINE groups cannot be used with recursion`);
  let a = [],
    o = uc(e, R`\\[1-9]`, L.DEFAULT),
    s = new Map(),
    c = [],
    l = !1,
    u = 0,
    d = 0,
    f;
  for (bc.lastIndex = 0; (f = bc.exec(e)); ) {
    let {
      0: t,
    ...
    if (t === `[`) u++;
      ...
      if ((Cc(m), l)) throw Error(xc);
      if (o)
        throw Error(
          `${r === `external` ? `Backrefs` : `Numbered backrefs`} cannot be used with global recursion`,
        );
      let t = e.slice(0, f.index),
        s = e.slice(bc.lastIndex);
      if (uc(s, _c, L.DEFAULT)) throw Error(xc);
      let c = m - 1;
      ((e = wc(t, s, c, !1, n, a, d)), (i = Dc(i, t, c, a.length, 0, d)));
      break;
    } else if (h) {
      Cc(g);
      let u = !1;
      for (let e of c)
        if (e.name === h || e.num === +h) {
          if (((u = !0), e.hasRecursedWithin)) throw Error(xc);
          break;
        }
      if (!u)
        throw Error(
          R`Recursive \g cannot be used outside the referenced group "${r === `external` ? h : R`\g<${h}&R=${g}>`}"`,
        );
      let p = s.get(h),
        m = dc(e, p);
      if (o && uc(m, R`${vc}|\((?!\?)`, L.DEFAULT))
        throw Error(
      ...
      let _ = e.slice(p, f.index),
        ...
        y = g - 1,
        b = wc(_, v, y, !0, n, a, d);
      ((i = Dc(i, _, y, a.length - ee, ee, d)),
        (e = `${e.slice(0, p)}${b}${e.slice(p + m.length)}`),
        (bc.lastIndex += b.length - t.length - _.length - v.length),
        c.forEach((e) => (e.hasRecursedWithin = !0)),
        (l = !0));
    } else if (p)
      (d++, s.set(String(d), bc.lastIndex), s.set(p, bc.lastIndex), c.push({ num: d, name: p }));
    else if (t[0] === `(`) {
      let e = t === `(`;
      (e && (d++, s.set(String(d), bc.lastIndex)), c.push(e ? { num: d } : {}));
    } else t === `)` && c.pop();
  }
...
function wc(e, t, n, r, i, a, o) {
  ...
  return `${e}${Tc(`(?:${e}`, `forward`, ...c)}(?:)${Tc(`${t})`, `backward`, ...c)}${t}`;
}
  ...
  for (let t = 0; t < n; t++) {
    ...
    c += sc(
      ...
      ({ 0: e, groups: { captureName: t, unnamed: s, backref: c } }) => {
        ...
        if (s || t) {
          let n = o + a.length + 1;
          return (a.push(n), Ec(i, n), s ? e : `(?<${t}${l}>`);
        }
        return R`\k<${c}${l}>`;
      },
      L.DEFAULT,
...
function Oc(e, { enable: t, disable: n }) {
  return {
...
var Mc = { ES2025: 2025, ES2024: 2024, ES2018: 2018 },
  Nc = { auto: `auto`, ES2025: `ES2025`, ES2024: `ES2024`, ES2018: `ES2018` };
function Pc(e = {}) {
  if ({}.toString.call(e) !== `[object Object]`) throw Error(`Unexpected options`);
  if (e.target !== void 0 && !Nc[e.target]) throw Error(`Unexpected target "${e.target}"`);
  let t = {
    accuracy: `default`,
    avoidSubclass: !1,
    flags: ``,
  ...
  return (
    t.target === `auto` &&
      (t.target = V.flagGroups ? `ES2025` : V.unicodeSets ? `ES2024` : `ES2018`),
    t
  );
}
var Fc = `[	-\r ]`,
  Ic = new Set([z(304), z(305)]),
  H = B`[\p{L}\p{M}\p{N}\p{Pc}]`;
function Lc(e) {
  if (Ic.has(e)) return [e];
  let t = new Set(),
    n = e.toLowerCase(),
    r = n.toUpperCase(),
    i = Vc.get(n),
...
function Kc(e, t) {
  ...
  let r = {
    ...
    minTargetEs2024: Ac(n.bestEffortTarget, `ES2024`),
    passedLookbehind: !1,
    strategy: null,
...
var qc = {
    AbsenceFunction({ node: e, parent: t, replaceWith: n }) {
      ...
      if (i === `repeater`) {
        let e = I();
        e.body[0].body.push(Rs({ negate: !0, body: r }), Ws(`Any`));
        let i = I();
        (i.body[0].body.push(Vs(`greedy`, 0, 1 / 0, e)), n(G(i, t), { traverse: !0 }));
    ...
    Assertion({ node: e, parent: t, key: n, container: r, root: i, remove: a, replaceWith: o }, s) {
      ...
      if (c === `line_end`)
        o(G(Rs({ body: [Os({ body: [ks(`string_end`)] }), Os({ body: [Ms(10)] })] }), t));
        ...
        if (f.has(e)) ((i.flags.sticky = !0), a());
          ...
          let e = r[n - 1];
          if (e && ll(e)) o(G(Rs({ negate: !0 }), t));
          else if (d) throw Error(B`Uses "\G" in a way that requires a subclass`);
          else (o(pl(ks(`string_start`), t)), (s.strategy = `clip_search`));
        }
      else if (!(c === `string_end` || c === `string_start`))
        if (c === `string_end_newline`) o(G(W(B`(?=\n?\z)`), t));
    ...
    Backreference({ node: e }, { jsGroupNameMap: t }) {
      let { ref: n } = e;
      typeof n == `string` && !dl(n) && ((n = nl(n, t)), (e.ref = n));
    },
    CapturingGroup({ node: e }, { jsGroupNameMap: t, subroutineRefMap: n }) {
      let { name: r } = e;
      (r && !dl(r) && ((r = nl(r, t)), (e.name = r)), n.set(e.number, e), r && n.set(r, e));
    },
    CharacterClassRange({ node: e, parent: t, replaceWith: n }) {
      t.kind === `intersection` && n(G(Ns({ body: [e] }), t), { traverse: !0 });
    },
    CharacterSet(
      ...
      if (s && (c === `word` || u === `word`)) {
        n(pl(Fs(`word`, { negate: l }), t));
        return;
      }
      if (c === `any`) n(pl(Ws(`Any`), t));
      else if (c === `digit`) n(pl(Ws(`Nd`, { negate: l }), t));
      else if (c !== `dot`)
        if (c === `text_segment`) {
        ...
        } else if (c === `hex`) n(pl(Ws(`AHex`, { negate: l }), t));
        else if (c === `newline`)
          n(
            G(
              W(
...
\v\f\u2028\u2029])`,
          ...
          if (!i && (u === `graph` || u === `print`)) {
            ...
            let e = { graph: `!-~`, print: ` -~` }[u];
            (l && (e = `\0-${z(e.codePointAt(0) - 1)}${z(e.codePointAt(2) + 1)}-\u{10FFFF}`),
              n(G(W(`[${e}]`), t)));
          } else n(G(fl(W(Hc.get(u)), l), t));
        else if (c === `property`) Rc.has(Qs(u)) || (e.key = `sc`);
        else if (c === `space`) n(pl(Ws(`space`, { negate: l }), t));
        else if (c === `word`) n(G(fl(W(H), l), t));
    ...
    Directive({
      ...
      if (s === `flags`)
        ...
        let e = n.body[0],
          r =
            n.body.length === 1 && hs(e, { type: `Group` }) && e.body[0].body.length === 1
              ? e.body[0]
              : n;
  ...
  Jc = {
    ...
    CapturingGroup: {
      enter(
        ...
        let l = i.get(e);
        if (l && s.has(e.number)) {
          let r = pl(el(e.number), t);
          (c.set(r, s.get(e.number)), n(r));
          return;
        }
        (s.set(e.number, e), o.set(e.number, []), e.name && kc(o, e.name, []));
    ...
    Group: {
      enter({ node: e }, t) {
        ((t.prevFlags = t.currentFlags), e.flags && (t.currentFlags = Oc(t.currentFlags, e.flags)));
      },
      exit(e, t) {
    ...
    Subroutine({ node: e, parent: t, replaceWith: n }, r) {
      ...
      let o = r.subroutineRefMap.get(a),
        s = a === 0,
        c = s ? el(0) : $c(o, r.groupOriginByCopy, null),
        l = c;
      if (!s) {
        let e = rl(tl(o, (e) => e.type === `Group` && !!e.flags)),
          t = e ? Oc(r.globalFlags, e) : r.globalFlags;
        Zc(t, r.currentFlags) || ((l = I({ flags: il(t) })), l.body[0].body.push(c));
      }
      n(G(l, t), { traverse: !s });
    },
  },
  Yc = {
    Backreference({ node: e, parent: t, replaceWith: n }, r) {
      ...
      let i = r.reffedNodesByReferencer.get(e).filter((t) => Qc(t, e));
      i.length
        ? i.length > 1
          ? n(G(I({ atomic: !0, body: i.reverse().map((e) => Os({ body: [As(e.number)] })) }), t))
          : (e.ref = i[0].number)
        : n(G(Rs({ negate: !0 }), t));
    },
...
function il({ dotAll: e, ignoreCase: t }) {
  let n = {};
  return (
...
function ol(e) {
  let t = e.find((e) => e.kind === `search_start` || ul(e, { negate: !1 }) || !cl(e));
  if (!t) return null;
...
function sl(e, t) {
  let n = al(e) ?? [];
  for (let e of n) if (e === t || sl(e, t)) return !0;
  return !1;
}
function cl({ type: e }) {
...
function ul(e, t) {
  ...
  return (
    ...
    e.body.length === 1 &&
    hs(e.body[0], { type: `Assertion`, kind: `search_start` })
  );
}
function dl(e) {
...
function W(e, t) {
  let n = vs(e, { ...t, unicodePropertyMap: Rc }).body;
...
function G(e, t) {
  return (Xc(e), (e.parent = t), e);
}
function ml(e, t) {
  let n = Pc(t),
    r = Ac(n.target, `ES2024`),
    i = Ac(n.target, `ES2025`),
  ...
  function d(e) {
    return ((u.lastNode = l), (l = e), jc(gl[e.type], `Unexpected node type "${e.type}"`)(e, u, d));
  }
  ...
  return (
    ...
    u.captureMap.forEach((e, t) => {
      (e.hidden && f._hiddenCaptures.push(t),
        e.transferTo && kc(f._captureTransfers, e.transferTo, []).push(t));
    }),
    f
  );
}
var hl = {
    "*": {
      enter({ node: e }, t) {
        if (Ol(e)) {
          ...
          t.pushModI(e.flags ? Oc({ ignoreCase: n }, e.flags).ignoreCase : n);
        }
      },
      exit({ node: e }, t) {
        Ol(e) && t.popModI();
  ...
  gl = {
    ...
    CharacterSet({ kind: e, negate: t, value: n, key: r }, i) {
      ...
      if (e === `property`) {
        if (i.useAppliedIgnoreCase && i.currentFlags.ignoreCase && Gc.has(n))
          throw Error(
...
function Nl(e, t) {
  ...
  for (let [e, r] of t) for (let t of r) kc(n, t, {}).transferTo = e;
  return n;
}
function Pl(e) {
...
async function Vl(e) {
  ...
  try {
    let t = kn.get(e);
    if ((t == null && Object.prototype.hasOwnProperty.call(qa, e) && (t = qa[e]), t == null))
      throw Error(`resolveLanguage: "${e}" not found in bundled or custom languages`);
    let n = t().then(({ default: t }) => {
      let n = { name: e, data: t };
      return (Dn.has(e) || Dn.set(e, n), n);
    });
    return (On.set(e, n), await n);
  } finally {
    On.delete(e);
  }
}
function Hl(e) {
  return Dn.get(e) ?? Vl(e);
}
var K = new Map(),
  Ul = new Map(),
  Wl = new Map(),
...
function Jl(e, t) {
  return K.get(e) ?? ((t = Da(t)), K.set(e, t), t);
}
function Yl(e) {
  return K.get(e) ?? ql(e);
}
...
async function Zl({ themes: e, langs: t, preferredHighlighter: n = `shiki-js` }) {
  q ??= yo({
    themes: [],
    langs: [`text`],
    engine: n === `shiki-wasm` ? vo(c(() => import(`./wasm-D.js`), [], import.meta.url)) : Bl(),
  });
  let r = $l(q) ? await q : q;
  q = r;
  let i = [];
  for (let e of t) {
    ...
    let t = Hl(e);
    `then` in t ? i.push(t) : Mn(t, r);
  }
  let a = [];
  for (let t of e) {
    let e = Yl(t);
    `then` in e ? a.push(e) : Kl(e, q);
  }
  return (
...
function au(e) {
  return x({
    ...
    children: [
      x({
        tagName: `div`,
        children: e.annotations?.map((e) => x({ tagName: `slot`, properties: { name: e } })),
...
function su({ fileOrDiff: e, mode: t }) {
  ...
  return x({
    ...
    children: [
      t === `custom`
        ? x({ tagName: `slot`, properties: { name: g } })
        : cu({
            name: e.name,
...
function cu({ name: e, prevName: t, iconType: n }) {
  let r = [
    x({ tagName: `slot`, properties: { name: m } }),
    ce({ name: ou(n), properties: { "data-change-icon": n } }),
  ];
  return (
    t != null &&
      (r.push(
        x({
          tagName: `div`,
          children: [x({ tagName: `bdi`, children: [se(t)] })],
          properties: { "data-prev-name": `` },
        }),
      ),
      r.push(ce({ name: `diffs-icon-arrow-right-short`, properties: { "data-rename-icon": `` } }))),
    r.push(
      x({
        tagName: `div`,
        children: [x({ tagName: `bdi`, children: [se(e)] })],
        properties: { "data-title": `` },
      }),
    ),
    x({ tagName: `div`, children: r, properties: { "data-header-content": `` } })
  );
}
function lu(e) {
  let t = [];
  if (e != null) {
    ...
    ((r > 0 || n === 0) &&
      t.push(
        x({ tagName: `span`, children: [se(`-${r}`)], properties: { "data-deletions-count": `` } }),
      ),
      (n > 0 || r === 0) &&
        t.push(
          x({
  ...
  return (
    t.push(x({ tagName: `slot`, properties: { name: p } })),
    x({ tagName: `div`, children: t, properties: { "data-metadata": `` } })
  );
}
function uu(e) {
  return x({ tagName: `pre`, properties: du(e) });
}
function du({
  diffIndicators: e,
  disableBackground: t,
...
function Su(e) {
  ...
  let n = bu,
    ...
    o = () => {
      ...
      for (let e of i) wu(e);
      (r.push(x({ tagName: `span`, properties: { "data-char": a }, children: i })),
        (i = []),
        (a = void 0));
    },
    s = (e) => {
...
function ju({ theme: e = b, highlighter: t, prefix: n }) {
  let r = ``;
  if (typeof e == `string`) {
    let i = t.getTheme(e);
    ((r += `color:${i.fg};`),
...
function Lu(
  ...
  let h =
    ...
    g = Nu(t.codeToHast(l ? Ru(c ?? Fu(e.contents), o, s) : y(e.contents), h)),
    _ = l ? Array(o) : g;
...
function zd({
  ...
  let g = a < f.deletions ? o + a : void 0,
    ...
    ie =
      ee != null && y != null && g != null
        ? { lineNumber: y, lineIndex: ee, noEOFCR: ne, unifiedLineIndex: g, splitLineIndex: v }
        : void 0,
    ae =
      b != null && te != null && _ != null
        ? { unifiedLineIndex: _, splitLineIndex: v, lineIndex: b, lineNumber: te, noEOFCR: re }
        : void 0;
  if (ie == null && ae != null)
    return {
      type: `change`,
...
function Wd({
  ...
  return {
    deletionLines:
      e.contents === ``
        ? []
        : ((m.lang = u), (f.lineInfo = n), (m.decorations = a), Nu(i.codeToHast(y(e.contents), m))),
    additionLines:
      t.contents === ``
        ? []
        : ((m.lang = d), (m.decorations = o), (f.lineInfo = r), Nu(i.codeToHast(y(t.contents), m))),
  };
}
function Gd(e) {
...
function lf(e) {
  for (let t of Array.isArray(e) ? e : [e]) if (!Dn.has(t)) return !1;
  return !0;
}
async function uf(e) {
  let t = [],
...
var Vf = `` + new URL(`worker.js`, import.meta.url).href;
function Hf() {
...
function qf(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = { workerFactory: Hf, poolSize: Wf, totalASTLRUCacheSize: Gf }), (t[4] = h))
    : (h = t[4]);
  let g, _;
  t[5] !== m || t[6] !== p
    ? ((g = { theme: p, lineDiffType: m, langs: Kf }),
      (_ = (0, Q.jsx)(Jf, { lineDiffType: m, theme: p })),
      (t[5] = m),
      (t[6] = p),
      (t[7] = g),
      (t[8] = _))
  ...
  return (
    t[9] !== n || t[10] !== g || t[11] !== _
      ? ((v = (0, Q.jsxs)(Nf, { poolOptions: h, highlighterOptions: g, children: [_, n] })),
        (t[9] = n),
        (t[10] = g),
        (t[11] = _),
        (t[12] = v))
...
function Xf(e) {
  ...
  let r;
  return (
    t[0] === n ? (r = t[1]) : ((r = (0, Q.jsx)(qf, { children: n })), (t[0] = n), (t[1] = r)), r
  );
}
export {
  En as $,
