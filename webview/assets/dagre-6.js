...
import { A as t } from "./reduce.js";
import { S as n, f as r, t as i } from "./lodash-1.js";
import { i as a, n as o, r as s } from "./chunk-49.js";
import { A as c, b as l } from "./chunk-87.js";
import { u } from "./chunk-33.js";
import { i as d } from "./chunk-127.js";
import { r as f } from "./chunk-56.js";
import { n as p, r as m } from "./chunk-145.js";
import { n as h, r as g, t as _ } from "./graphlib-4.js";
import { n as v } from "./chunk-133.js";
import { a as y, d as ee, i as b, l as x, n as te, o as S, t as C, u as w } from "./chunk-28.js";
import { a as T, i as E, n as D, o as O, r as k, t as A } from "./chunk-68.js";
import { n as j, t as M } from "./dagre-Bmci-A-I.js";
function N(e) {
  var t = {
...
e(() => {
  (D(),
    ...
    (V = o((e, t) => {
      let n = R.get(t) || [];
      return (a.trace(`In isDescendant`, t, ` `, e, ` = `, n.includes(e)), n.includes(e));
    }, `isDescendant`)),
    (H = o((e, t) => {
      let n = R.get(t) || [];
      return (
        ...
        i.forEach((i) => {
          if (t.children(i).length > 0) U(i, t, n, r);
            ...
            (a.info(`cp `, i, ` to `, r, ` with parent `, e),
              n.setNode(i, o),
              r !== t.parent(i) &&
                (a.warn(`Setting parent`, i, t.parent(i)), n.setParent(i, t.parent(i))),
              e !== r && i !== e
    ...
    (q = o(
      (e) => (!L.has(e) || !L.get(e).externalConnections ? e : L.has(e) ? L.get(e).id : e),
      `getAnchorId`,
    )),
    (J = o((e, t) => {
      if (!e || t > 10) {
      ...
      (e.nodes().forEach(function (t) {
        e.children(t).length > 0 &&
          (a.warn(`Cluster identified`, t, ` Replacement id in edges: `, K(t, e, t)),
          R.set(t, W(t, e)),
      ...
      for (let t of L.keys()) {
        let n = L.get(t).id,
          r = e.parent(n);
        r !== t && L.has(r) && !L.get(r).externalConnections && (L.get(t).id = r);
      }
      (e.edges().forEach(function (t) {
        let n = e.edge(t);
        (a.warn(`Edge ` + t.v + ` -> ` + t.w + `: ` + JSON.stringify(t)),
          a.warn(`Edge ` + t.v + ` -> ` + t.w + `: ` + JSON.stringify(e.edge(t))));
        let r = t.v,
          i = t.w;
        if (
          (a.warn(`Fix XXX`, L, `ids:`, t.v, t.w, `Translating: `, L.get(t.v), ` --- `, L.get(t.w)),
          L.get(t.v) || L.get(t.w))
        ) {
          if (
          ...
          (a.warn(`Fix Replacing with XXX`, r, i, t.name), e.setEdge(r, i, n, t.name));
        }
      }),
    ...
    (Y = o((e, t) => {
      ...
      for (let r of n)
        ...
        else if (!L.get(r).externalConnections && e.children(r) && e.children(r).length > 0) {
          a.warn(`Cluster without external connections, without a parent and with children`, r, t);
          let n = e.graph().rankdir === `TB` ? `LR` : `TB`;
          L.get(r)?.clusterData?.dir &&
            ((n = L.get(r).clusterData.dir), a.warn(`Fixing dir`, L.get(r).clusterData.dir, n));
    ...
    (Q = o(async (e, t, n, r, i, s) => {
      ...
      (t.nodes() ? a.info(`Recursive render XXX`, t.nodes()) : a.info(`No nodes found for`, t),
...
Parent cluster`,
              ...
              t.setNode(i.id, n),
              t.parent(e) || (a.trace(`Setting parent`, e, i.id), t.setParent(e, i.id, n)));
          }
          if (
            (a.info(`(Insert) Node XXX` + e + `: ` + JSON.stringify(t.node(e))), o?.clusterNode)
          ) {
            a.info(`Cluster identified XBX`, e, o.width, t.node(e));
            let { ranksep: i, nodesep: c } = t.graph();
            o.graph.setGraph({ ...o.graph.graph(), ranksep: i + 25, nodesep: c });
            ...
            t.children(e).length > 0
              ? (a.trace(`Cluster - the non recursive path XBX`, e, o.id, o, o.width, `Graph:`, t),
                a.trace(K(o.id, t)),
                L.set(o.id, { id: K(o.id, t), node: o }))
              : (a.trace(`Node - the non recursive path XAX`, e, m, t.node(e), c),
        ...
        await o(async () => {
          let e = t.edges().map(async function (e) {
            ...
            (a.info(`Edge ` + e.v + ` -> ` + e.w + `: ` + JSON.stringify(e)),
              a.info(`Edge ` + e.v + ` -> ` + e.w + `: `, e, ` `, JSON.stringify(t.edge(e))),
              a.info(`Fix`, L, `ids:`, e.v, e.w, `Translating: `, L.get(e.v), L.get(e.w)),
              await E(f, n));
          });
          await Promise.all(e);
        }, `processEdges`)(),
...
export { $ as render };
//# sourceMappingURL=dagre-6.js.map
