...
import { mg as o, pg as s } from "./app-initial~app-main~onboarding-page.js";
function c(e) {
  let t = null;
  return (
    e.descendants((e) => {
...
function m(e, t) {
  let { state: n, dispatch: r } = e.view,
    i = s.atEnd(n.doc),
    a = n.doc.resolve(i.from).nodeBefore,
    o = n.tr.setSelection(i);
  (a != null && (!a.isText || !/\s$/.test(a.text ?? ``)) && (o = o.insertText(` `)),
    r(o.setSelection(s.atEnd(o.doc))),
  ...
  switch (e) {
    case `document`:
      return {
        ...
        path: i(`documents@openai-primary-runtime`),
        description: ``,
        iconSmall: ``,
      };
    case `presentation`:
      return {
        ...
        path: i(`presentations@openai-primary-runtime`),
        description: ``,
        iconSmall: ``,
      };
    case `spreadsheet`:
      return {
        ...
        path: i(`spreadsheets@openai-primary-runtime`),
        description: ``,
        iconSmall: ``,
      };
  }
