...
import { lt as fe } from "./vscode-api.js";
import { t as pe } from "./use-is-dark.js";
import { a as U } from "./setting-storage.js";
import { f as me, u as he } from "./diff-view-mode.js";
import {
  a as ge,
  c as _e,
  d as ve,
  ...
  Me = class {
    ...
    constructor(e = { theme: W }, t, n) {
      ((this.options = e),
        ...
        n?.isWorkingPool() !== !0 && (this.highlighter = ne(e.theme ?? W) ? S() : void 0));
    }
    cleanUp() {
    ...
    getExpandedHunk(e) {
      return this.expandedHunks.get(e) ?? ge;
    }
    getExpandedHunksMap() {
    ...
    async initializeHighlighter() {
      return ((this.highlighter = await x(de(this.computedLang, this.options))), this.highlighter);
    }
    hydrate(e) {
      if (e == null) return;
      this.diff = e;
    ...
    getRenderOptions(e) {
      ...
      return n?.result == null || e !== n.diff || !H(t, n.options)
        ? { options: t, forceRender: !0 }
        : { options: t, forceRender: !1 };
    }
    renderDiff(e = this.renderCache?.diff, t = Ce) {
      if (e == null) return;
      ...
      if (
        ...
        let t = this.highlighter != null && ne(a.theme),
    ...
    async asyncHighlight(e) {
      this.computedLang = e.lang ?? o(e.name);
      let t = this.highlighter != null && ne(this.options.theme ?? W),
        n = this.highlighter != null && h(this.computedLang);
      return (
        ...
        b = {
          ...
          flush() {
            if (a !== `unified`) {
              ...
              (this.side === `additions`
                ? (v.pushToGutter(`additions`, V(void 0, `buffer`, this.size)),
                  f?.push(G(this.size)))
                : (v.pushToGutter(`deletions`, V(void 0, `buffer`, this.size)),
                  p?.push(G(this.size))),
                (this.size = 0),
                (this.side = void 0));
            }
        ...
        callback: ({
          ...
          if (h || m) {
            if (m) {
              ...
              a === `unified`
                ? (v.unifiedContentAST.push(K(e)), v.pushToGutter(`unified`, V(e, `metadata`, 1)))
                : (v.deletionsContentAST.push(K(e)),
                  v.pushToGutter(`deletions`, V(e, `metadata`, 1)),
                  h ||
                    (v.pushToGutter(`additions`, V(void 0, `buffer`, 1)),
            ...
            if (h) {
              ...
              a === `unified`
                ...
                : (v.additionsContentAST.push(K(e)),
                  v.pushToGutter(`additions`, V(e, `metadata`, 1)),
                  m ||
                    (v.pushToGutter(`deletions`, V(void 0, `buffer`, 1)),
...
function Ie({
  ...
  if (e === `unified`) {
    if (
      ...
      (c.unifiedContentAST.push(s(i)), c.pushToGutter(`unified`, V(e, `annotation`, 1)), (l = !0));
    }
  } else if (e === `split`) {
    if (
      ...
      (c.deletionsContentAST.push(s(a)),
        c.pushToGutter(`deletions`, V(e, `annotation`, 1)),
        (l = !0));
    }
    if (o != null) {
      let e = t === `change` ? (r == null ? `context` : `change-addition`) : t;
      (c.additionsContentAST.push(s(o)),
        c.pushToGutter(`additions`, V(e, `annotation`, 1)),
        (l = !0));
    }
  }
...
function Z(e, t, n, r = !1) {
  let i = Se(ce(e.name, t.name, e.contents, t.contents, e.header, t.header, n), {
    cacheKey: (() => {
  ...
  Ve = class {
    ...
    render({
      ...
      if (
        ...
        try {
          let e = this.hunksRenderer.renderDiff(this.fileDiff, we);
    ...
    applyHeaderToDOM(e, t) {
      ...
      if (i != null) {
        let e = i(n) ?? void 0;
        ((this.headerCustom = this.upsertHeaderSlotElement(t, this.headerCustom, be, e)),
          this.headerPrefix?.remove(),
          this.headerMetadata?.remove(),
          (this.headerPrefix = void 0),
          (this.headerMetadata = void 0));
      ...
      let s = a?.(n) ?? void 0,
        c = o?.(n) ?? void 0;
      ((this.headerPrefix = this.upsertHeaderSlotElement(t, this.headerPrefix, ye, s)),
        (this.headerMetadata = this.upsertHeaderSlotElement(t, this.headerMetadata, ve, c)),
        this.headerCustom?.remove(),
        (this.headerCustom = void 0));
    }
    clearHeaderSlots() {
    ...
    applyPreNodeAttributes(
      ...
      L(u, this.appliedPreAttributes) || (ue(e, u), (this.appliedPreAttributes = u));
    }
    applyErrorToDOM(e, t) {
      this.cleanupErrorWrapper();
  ...
  return (0, Q.jsxs)(Q.Fragment, {
    children: [
      p == null
        ...
        : (0, Q.jsx)(`div`, { slot: be, children: p }),
...
function ut(e) {
  ...
  let g = p === void 0 ? `line-info` : p,
    ...
    v = (0, $.useRef)(null),
    y = Ee(Te()),
    b = U(t.lightCodeThemeId),
    x = U(t.darkCodeThemeId),
    S = U(t.diffMarkerStyle);
  pe();
  let C = S === `symbols`,
    w;
