...
import { f as pe, u as me } from "./diff-view-mode.js";
import {
  a as he,
  c as ge,
  d as _e,
...
function q(e) {
  return V({
    tagName: `div`,
    children: [V({ tagName: `span`, children: [A(`No newline at end of file`)] })],
...
function Y({
  ...
  if (
    (e === `metadata` &&
      t != null &&
      c.push(V({ tagName: `div`, children: [A(t)], properties: { "data-separator-wrapper": `` } })),
    (e === `line-info` || e === `line-info-basic`) && t != null)
  ) {
    let e = [];
    (n != null &&
      (r
        ? (a || (e.push(J(`up`)), s++), o || (e.push(J(`down`)), s++))
        : (e.push(J(!a && !o ? `both` : a ? `down` : `up`)), s++)),
      e.push(
        V({
          tagName: `div`,
          children: [
            V({ tagName: `span`, children: [A(t)], properties: { "data-unmodified-lines": `` } }),
          ],
  ...
  return (
    e === `custom` && i != null && c.push(V({ tagName: `slot`, properties: { name: i } })),
    V({
      tagName: `div`,
      children: c,
      properties: {
...
var Ae = -1,
  je = class {
    ...
    computedLang = `text`;
    renderCache;
    constructor(e = { theme: G }, t, n) {
      ((this.options = e),
        (this.onRenderUpdate = t),
        (this.workerManager = n),
        n?.isWorkingPool() !== !0 && (this.highlighter = H(e.theme ?? G) ? w() : void 0));
    }
    cleanUp() {
    ...
    getExpandedHunk(e) {
      return this.expandedHunks.get(e) ?? he;
    }
    getExpandedHunksMap() {
    ...
    async initializeHighlighter() {
      return ((this.highlighter = await C(de(this.computedLang, this.options))), this.highlighter);
    }
    hydrate(e) {
      if (e == null) return;
      this.diff = e;
      ...
      (n != null && !W(t, n.options) && (n = void 0),
        ...
        this.workerManager?.isWorkingPool() === !0
          ...
          : (this.highlighter ??
            ((this.computedLang = e.lang ?? c(e.name)), this.initializeHighlighter())));
    }
    getRenderOptions(e) {
      let t = (() => {
        ...
        return {
          theme: e,
          useTokenTransformer: m(this.options),
          tokenizeMaxLineLength: t,
          lineDiffType: n,
          maxLineDiffLength: r,
        };
      ...
      return n?.result == null || e !== n.diff || !W(t, n.options)
        ? { options: t, forceRender: !0 }
        : { options: t, forceRender: !1 };
    }
    renderDiff(e = this.renderCache?.diff, t = Se) {
      if (e == null) return;
      ...
      let { options: a, forceRender: o } = this.getRenderOptions(e);
      if (
        ((this.renderCache ??= {
          diff: e,
          highlighted: !1,
        ...
        ((this.renderCache.result == null ||
          (!this.renderCache.highlighted &&
            (e !== this.renderCache.diff || !f(this.renderCache.renderRange, t)))) &&
          ...
          t.totalLines > 0 &&
            (!this.renderCache.highlighted || o) &&
            this.workerManager.highlightDiffAST(this, e));
      else {
        this.computedLang = e.lang ?? c(e.name);
        let t = this.highlighter != null && H(a.theme),
          n = this.highlighter != null && _(this.computedLang);
        if (
          this.highlighter != null &&
          t &&
          (o || (!this.renderCache.highlighted && n) || this.renderCache.result == null)
        ) {
    ...
    async asyncHighlight(e) {
      this.computedLang = e.lang ?? c(e.name);
      let t = this.highlighter != null && H(this.options.theme ?? G),
        n = this.highlighter != null && _(this.computedLang);
      return (
    ...
    processDiffResult(e, t, { code: n, themeStyles: r, baseThemeType: i }) {
      ...
      let d = a === `unified`,
        ...
        v = {
          ...
          unifiedContentAST: m,
          unifiedGutterAST: D(),
          deletionsGutterAST: D(),
          additionsGutterAST: D(),
          expansionLineCount: c,
          hunkData: h,
        ...
        b = {
          ...
          flush() {
            if (a !== `unified`) {
              ...
              (this.side === `additions`
                ? (v.pushToGutter(`additions`, U(void 0, `buffer`, this.size)),
                  f?.push(K(this.size)))
                : (v.pushToGutter(`deletions`, U(void 0, `buffer`, this.size)),
                  p?.push(K(this.size))),
                (this.size = 0),
                (this.side = void 0));
            }
        ...
        x = (e, t, n, r, i) => {
          v.pushToGutter(e, L(t, n, r, i));
        };
      function S(e) {
        (b.flush(),
          a === `unified` ? Ie(`unified`, e, v) : (Ie(`deletions`, e, v), Ie(`additions`, e, v)));
      }
      (T({
        diff: e,
        diffStyle: a,
        ...
        callback: ({
          ...
          if (h || m) {
            if (m) {
              ...
              a === `unified`
                ? (v.unifiedContentAST.push(q(e)), v.pushToGutter(`unified`, U(e, `metadata`, 1)))
                : (v.deletionsContentAST.push(q(e)),
                  v.pushToGutter(`deletions`, U(e, `metadata`, 1)),
                  h ||
                    (v.pushToGutter(`additions`, U(void 0, `buffer`, 1)),
                    v.additionsContentAST.push(K(1))));
            }
            if (h) {
              let e = c === `context` || c === `context-expanded` ? c : `change-addition`;
              a === `unified`
                ? (v.unifiedContentAST.push(q(e)), v.pushToGutter(`unified`, U(e, `metadata`, 1)))
                : (v.additionsContentAST.push(q(e)),
                  v.pushToGutter(`additions`, U(e, `metadata`, 1)),
                  m ||
                    (v.pushToGutter(`deletions`, U(void 0, `buffer`, 1)),
                    v.deletionsContentAST.push(K(1))));
            }
        ...
        a === `split` && b.flush());
      let C = Math.max(Oe(e.hunks), e.additionLines.length ?? 0, e.deletionLines.length ?? 0),
        w = t.bufferBefore > 0 || t.bufferAfter > 0,
        E = !d && e.type !== `deleted`,
        O = !d && e.type !== `new`,
        k = v.rowCount > 0 || w;
      ((f = E && k ? f : void 0), (p = O && k ? p : void 0), (m = d && k ? m : void 0));
      let A = this.createPreElement(p != null && f != null, C);
      return {
        unifiedGutterAST: d && k ? v.unifiedGutterAST.children : void 0,
        unifiedContentAST: m,
        deletionsGutterAST: O && k ? v.deletionsGutterAST.children : void 0,
        deletionsContentAST: p,
        additionsGutterAST: E && k ? v.additionsGutterAST.children : void 0,
        additionsContentAST: f,
        hunkData: h,
        preNode: A,
        themeStyles: r,
    ...
    renderCodeAST(e, t) {
      ...
      let i = D(n);
      return ((i.properties.style = `grid-row: span ${t.rowCount}`), [i, g(r, t.rowCount)]);
    }
    renderFullAST(e, t = []) {
    ...
    renderFullHTML(e, t = []) {
      return B(this.renderFullAST(e, t));
    }
    ...
    getAnnotations(e, t, n, r, i) {
      ...
      if (t != null) for (let e of this.deletionAnnotations[t] ?? []) a.annotations.push(v(e));
      let o = { type: `annotation`, hunkIndex: r, lineIndex: i, annotations: [] };
      if (n != null)
        for (let t of this.additionAnnotations[n] ?? [])
          (e === `unified` ? a : o).annotations.push(v(t));
...
function Fe({
  ...
  if (e === `unified`) {
    if (
      ...
      (c.unifiedContentAST.push(s(i)), c.pushToGutter(`unified`, U(e, `annotation`, 1)), (l = !0));
    }
  } else if (e === `split`) {
    if (
      ...
      (c.deletionsContentAST.push(s(a)),
        c.pushToGutter(`deletions`, U(e, `annotation`, 1)),
        (l = !0));
    }
    if (o != null) {
      let e = t === `change` ? (r == null ? `context` : `change-addition`) : t;
      (c.additionsContentAST.push(s(o)),
        c.pushToGutter(`additions`, U(e, `annotation`, 1)),
        (l = !0));
    }
  }
...
function Ie(
  ...
  if (c.hunkSeparators === `metadata`) {
    i != null &&
      (c.pushToGutter(e, Y({ type: `metadata`, content: i, isFirstHunk: a, isLastHunk: o })),
      l.push(Y({ type: `metadata`, content: i, isFirstHunk: a, isLastHunk: o })),
      e !== `additions` && c.incrementRowCount(1));
    return;
  }
  if (c.hunkSeparators === `simple`) {
    t > 0 &&
      (c.pushToGutter(e, Y({ type: `simple`, isFirstHunk: a, isLastHunk: !1 })),
      l.push(Y({ type: `simple`, isFirstHunk: a, isLastHunk: !1 })),
      e !== `additions` && c.incrementRowCount(1));
    return;
  }
  let u = De(e, t),
...
function Z(e, t, n, r = !1) {
  let i = xe(ce(e.name, t.name, e.contents, t.contents, e.header, t.header, n), {
    cacheKey: (() => {
...
var Be = -1,
  Ve = class {
    ...
    render({
      ...
      let { collapsed: u = !1 } = this.options,
        d = u ? void 0 : l,
        p = e != null && t != null && (!s(e, this.deletionFile) || !s(t, this.additionFile)),
      ...
      if (
        ...
        (o = this.getOrCreateFileContainer(o, c)),
        u)
      ) {
        (this.removeRenderedCode(), this.clearAuxiliaryNodes());
        try {
          let e = this.hunksRenderer.renderDiff(this.fileDiff, Ce);
          (e != null && this.applyThemeState(o, e.themeStyles, x, e.baseThemeType),
            e?.headerElement != null && this.applyHeaderToDOM(e.headerElement, o),
            this.renderSeparators([]),
            this.injectUnsafeCSS());
        } catch (e) {
          if (v) throw e;
          (console.error(e), e instanceof Error && this.applyErrorToDOM(e, o));
        }
        return (i || this.emitPostRender(), !0);
      }
      try {
        let e = this.getOrCreatePreNode(o);
        if (
          !(
          ...
          let t = this.hunksRenderer.renderDiff(this.fileDiff, d);
          if (t == null)
            return (
          ...
          (this.applyThemeState(o, t.themeStyles, x, t.baseThemeType),
            t.headerElement != null && this.applyHeaderToDOM(t.headerElement, o),
    ...
    applyHeaderToDOM(e, t) {
      ...
      if (i != null) {
        let e = i(n) ?? void 0;
        ((this.headerCustom = this.upsertHeaderSlotElement(t, this.headerCustom, ye, e)),
          this.headerPrefix?.remove(),
          this.headerMetadata?.remove(),
          (this.headerPrefix = void 0),
          (this.headerMetadata = void 0));
      ...
      let s = a?.(n) ?? void 0,
        c = o?.(n) ?? void 0;
      ((this.headerPrefix = this.upsertHeaderSlotElement(t, this.headerPrefix, ve, s)),
        (this.headerMetadata = this.upsertHeaderSlotElement(t, this.headerMetadata, _e, c)),
        this.headerCustom?.remove(),
        (this.headerCustom = void 0));
    }
    clearHeaderSlots() {
    ...
    applyPreNodeAttributes(
      ...
      z(u, this.appliedPreAttributes) || (ue(e, u), (this.appliedPreAttributes = u));
    }
    applyErrorToDOM(e, t) {
      this.cleanupErrorWrapper();
  ...
  $e = class extends Ve {
    ...
    computeRenderRangeFromWindow(e, t, { top: n, bottom: r }) {
      ...
      let _ = Math.ceil(Math.max(r - n, 0) / f),
        ...
        x = [],
        S = (n + r) / 2,
        C = s === `simple` || s === `metadata` || s === `line-info-basic` ? 0 : l,
        w = t + g,
        E = 0,
        D,
        O,
        ...
        (T({
          ...
          callback: ({
            ...
            let l = c == null ? o.splitLineIndex : c.splitLineIndex,
              ...
              h = i > 0 ? d + C + (e > 0 ? C : 0) : 0;
            (e === 0 && s === `simple` && (h = 0), (w += h));
            let _ = E % u === 0;
            if (_ && (x.push(w - (t + g + h)), k != null)) {
              if (k <= 0) return !0;
              k--;
            }
      ...
      return {
        ...
        totalLines: F,
        bufferBefore: I,
        bufferAfter: L < x.length ? m - g - x[L] - l : m - (w - t) - l,
      };
    }
  };
function et(e) {
  ...
  return (0, Q.jsxs)(Q.Fragment, {
    children: [
      p == null
        ...
        : (0, Q.jsx)(`div`, { slot: ye, children: p }),
      a != null && l?.map((e, t) => (0, Q.jsx)(`div`, { slot: v(e), children: a(e) }, t)),
      t != null &&
        c != null &&
        d != null &&
        t.map((t) => {
          if (t == null) return;
          let n = rt(t, e);
          return (0, Q.jsx)(`div`, { slot: n, style: j, children: c(t, d) }, n);
        }),
      f != null && (0, Q.jsx)(`div`, { slot: `gutter-utility-slot`, style: se, children: f(u) }),
    ],
  });
}
function rt(e, t) {
...
function ot({ options: e, hasCustomHeader: t, hasGutterRenderUtility: n }) {
  return n || t
    ? { ...e, renderCustomHeader: t ? N : void 0, renderGutterUtility: n ? N : void 0 }
    : e;
}
function st({
  fileDiff: e,
...
function ut(e) {
  ...
  t[0] === e
    ...
    : (({
      ...
      (t[12] = h),
      (t[13] = g));
  let _ = m === void 0 ? `line-info` : m,
    v = g === void 0 ? `scroll` : g,
    y = (0, $.useRef)(null),
    b = Te(we()),
    x = a(i.lightCodeThemeId),
    S = a(i.darkCodeThemeId),
    C = a(i.diffMarkerStyle);
  fe();
  let w = C === `symbols`,
    T;
  t[14] !== b || t[15] !== S || t[16] !== x
    ? ((T = b === `light` ? pe(x, `light`) : pe(S, `dark`)),
      (t[14] = b),
      (t[15] = S),
      (t[16] = x),
      (t[17] = T))
  ...
  (t[18] === u
    ? (D = t[19])
    : ((D = () => {
        if (u == null || y.current == null) return;
        let e = window.requestAnimationFrame(() => {
          y.current != null && u(y.current);
        });
        return () => {
  ...
  t[20] === s
    ? (k = t[21])
    : ((k = s == null ? null : (0, Q.jsx)(dt, { lineDiffType: s })), (t[20] = s), (t[21] = k));
  let A = st,
    j = b,
    M = E.name,
    N = w ? `classic` : `bars`,
  ...
  let R;
  t[41] !== n || t[42] !== L
    ? ((R = (0, Q.jsx)(`div`, { ref: y, className: n, children: L })),
      (t[41] = n),
      (t[42] = L),
      (t[43] = R))
    : (R = t[43]);
  let z;
  return (
    t[44] !== O || t[45] !== R || t[46] !== k
      ? ((z = (0, Q.jsxs)(O, { children: [k, R] })),
        (t[44] = O),
        (t[45] = R),
        (t[46] = k),
        (t[47] = z))
