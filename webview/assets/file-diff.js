...
import { f as fe, u as pe } from "./diff-view-mode.js";
import {
  a as me,
  c as he,
  d as ge,
...
import { n as Ce, r as we } from "./use-resolved-theme-variant.js";
var Te = class {
...
function J(e) {
  return H({
    tagName: `div`,
    children: [H({ tagName: `span`, children: [A(`No newline at end of file`)] })],
...
function Y({
  ...
  if (
    (e === `metadata` &&
      t != null &&
      c.push(H({ tagName: `div`, children: [A(t)], properties: { "data-separator-wrapper": `` } })),
    (e === `line-info` || e === `line-info-basic`) && t != null)
  ) {
    let e = [];
    (n != null &&
      (r
        ? (a || (e.push(Ee(`up`)), s++), o || (e.push(Ee(`down`)), s++))
        : (e.push(Ee(!a && !o ? `both` : a ? `down` : `up`)), s++)),
      e.push(
        H({
          tagName: `div`,
          children: [
            H({ tagName: `span`, children: [A(t)], properties: { "data-unmodified-lines": `` } }),
          ],
  ...
  return (
    e === `custom` && i != null && c.push(H({ tagName: `slot`, properties: { name: i } })),
    H({
      tagName: `div`,
      children: c,
      properties: {
...
var Ae = -1,
  je = class {
    ...
    computedLang = `text`;
    renderCache;
    constructor(e = { theme: K }, t, n) {
      ((this.options = e),
        (this.onRenderUpdate = t),
        (this.workerManager = n),
        n?.isWorkingPool() !== !0 && (this.highlighter = U(e.theme ?? K) ? w() : void 0));
    }
    cleanUp() {
    ...
    async initializeHighlighter() {
      return ((this.highlighter = await C(ue(this.computedLang, this.options))), this.highlighter);
    }
    hydrate(e) {
      if (e == null) return;
      this.diff = e;
    ...
    getRenderOptions(e) {
      ...
      return n?.result == null || e !== n.diff || !G(t, n.options)
    ...
    renderDiff(e = this.renderCache?.diff, t = xe) {
      ...
      if (
        ...
        let t = this.highlighter != null && U(a.theme),
    ...
    async asyncHighlight(e) {
      this.computedLang = e.lang ?? c(e.name);
      let t = this.highlighter != null && U(this.options.theme ?? K),
        n = this.highlighter != null && _(this.computedLang);
      return (
        ...
        b = {
          ...
          flush() {
            if (a !== `unified`) {
              ...
              (this.side === `additions`
                ? (v.pushToGutter(`additions`, W(void 0, `buffer`, this.size)),
                  f?.push(q(this.size)))
                : (v.pushToGutter(`deletions`, W(void 0, `buffer`, this.size)),
                  p?.push(q(this.size))),
                (this.size = 0),
                (this.side = void 0));
            }
        ...
        callback: ({
          ...
          if (h || m) {
            if (m) {
              ...
              a === `unified`
                ? (v.unifiedContentAST.push(J(e)), v.pushToGutter(`unified`, W(e, `metadata`, 1)))
                : (v.deletionsContentAST.push(J(e)),
                  v.pushToGutter(`deletions`, W(e, `metadata`, 1)),
                  h ||
                    (v.pushToGutter(`additions`, W(void 0, `buffer`, 1)),
                    v.additionsContentAST.push(q(1))));
            }
            if (h) {
              let e = c === `context` || c === `context-expanded` ? c : `change-addition`;
              a === `unified`
                ? (v.unifiedContentAST.push(J(e)), v.pushToGutter(`unified`, W(e, `metadata`, 1)))
                : (v.additionsContentAST.push(J(e)),
                  v.pushToGutter(`additions`, W(e, `metadata`, 1)),
                  m ||
                    (v.pushToGutter(`deletions`, W(void 0, `buffer`, 1)),
                    v.deletionsContentAST.push(q(1))));
            }
    ...
    renderFullHTML(e, t = []) {
      return V(this.renderFullAST(e, t));
    }
...
function Fe({
  ...
  if (e === `unified`) {
    if (
      ...
      (c.unifiedContentAST.push(s(i)), c.pushToGutter(`unified`, W(e, `annotation`, 1)), (l = !0));
    }
  } else if (e === `split`) {
    if (
      ...
      (c.deletionsContentAST.push(s(a)),
        c.pushToGutter(`deletions`, W(e, `annotation`, 1)),
        (l = !0));
    }
    if (o != null) {
      let e = t === `change` ? (r == null ? `context` : `change-addition`) : t;
      (c.additionsContentAST.push(s(o)),
        c.pushToGutter(`additions`, W(e, `annotation`, 1)),
        (l = !0));
    }
  }
...
function Z(e, t, n, r = !1) {
  let i = be(se(e.name, t.name, e.contents, t.contents, e.header, t.header, n), {
    cacheKey: (() => {
  ...
  Ve = class {
    ...
    applyHeaderToDOM(e, t) {
      ...
      ((this.headerPrefix = this.upsertHeaderSlotElement(t, this.headerPrefix, _e, s)),
        (this.headerMetadata = this.upsertHeaderSlotElement(t, this.headerMetadata, ge, c)),
        this.headerCustom?.remove(),
        (this.headerCustom = void 0));
    }
    clearHeaderSlots() {
    ...
    applyPreNodeAttributes(
      ...
      z(u, this.appliedPreAttributes) || (le(e, u), (this.appliedPreAttributes = u));
    }
    applyErrorToDOM(e, t) {
      this.cleanupErrorWrapper();
...
function ut(e) {
  ...
  let v = m === void 0 ? `line-info` : m,
    ...
    x = (0, $.useRef)(null),
    S = we(Ce()),
    C = a(i.lightCodeThemeId),
    w = a(i.darkCodeThemeId),
    T = a(i.diffMarkerStyle);
  de();
  let E = T === `symbols`,
    D;
  t[15] !== S || t[16] !== w || t[17] !== C
    ? ((D = S === `light` ? fe(C, `light`) : fe(w, `dark`)),
      (t[15] = S),
      (t[16] = w),
      (t[17] = C),
      (t[18] = D))
  ...
  (t[19] === u
    ? (k = t[20])
    : ((k = () => {
        if (u == null || x.current == null) return;
        let e = window.requestAnimationFrame(() => {
          x.current != null && u(x.current);
        });
        return () => {
  ...
  t[21] === s
    ? (j = t[22])
    : ((j = s == null ? null : (0, Q.jsx)(dt, { lineDiffType: s })), (t[21] = s), (t[22] = j));
  let M = st,
    N = S,
    P = O.name,
    F = E ? `classic` : `bars`,
  ...
  let B;
  t[44] !== n || t[45] !== z
    ? ((B = (0, Q.jsx)(`div`, { ref: x, className: n, children: z })),
      (t[44] = n),
      (t[45] = z),
      (t[46] = B))
    : (B = t[46]);
  let V;
  return (
    t[47] !== A || t[48] !== B || t[49] !== j
      ? ((V = (0, Q.jsxs)(A, { children: [j, B] })),
        (t[47] = A),
        (t[48] = B),
        (t[49] = j),
        (t[50] = V))
