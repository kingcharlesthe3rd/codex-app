...
import { G as i, S as a, U as o, X as s, Y as c, wt as l, y as u } from "./setting-storage.js";
import { a as d, g as f, m as p } from "./chunk-8.js";
...
import { t as _ } from "./app-shell.js";
import "./x.js";
...
import { a as y, d as b, i as x, l as S, n as C, r as w, u as T } from "./dialog-layout.js";
...
import { a as N, i as P, l as F, o as I, t as L } from "./appgen-url.js";
import "./lock.js";
import "./members.js";
import { t as R } from "./appgen-access-mode.js";
import { t as z } from "./appgen-share-dialog-BJ-LPm6o.js";
...
function U(e) {
  return {
    ...
    secrets: e.entries
      .filter((e) => e.is_secret)
      .map(({ key: e }) => ({ key: e, keyInputDisabledWhileValue: H, previousKey: e, value: H })),
  };
}
function W(e, t) {
...
function ie(e) {
  ...
  let m;
  t[8] !== s || t[9] !== p || t[10] !== c
    ? ((m = (0, Z.jsx)(M.Header, { actions: p, subtitle: s, title: c, titleGap: `none` })),
      (t[8] = s),
      (t[9] = p),
      (t[10] = c),
      (t[11] = m))
                  ...
                  children: i.map((e, t) =>
                    (0, Z.jsx)(
                      ae,
                      {
                        ...
                        onKeyPaste: (e) => {
                          let n = J(i, t, e.clipboardData.getData(`text/plain`));
...
function ae(e) {
  let t = (0, V.c)(39),
    { disabled: n, entry: r, onChange: a, onKeyPaste: o, onRemove: s, valueInputType: c } = e,
    l = i(),
    u;
  t[0] === l
    ? (u = t[1])
  ...
  t[4] !== r || t[5] !== a
    ...
    : (p = t[6]);
  let m;
  t[7] !== r.key || t[8] !== o || t[9] !== u || t[10] !== d || t[11] !== f || t[12] !== p
    ? ((m = (0, Z.jsx)(Q, {
        "aria-label": u,
        disabled: d,
        placeholder: f,
  ...
  t[18] !== r || t[19] !== a
    ...
    : (v = t[20]);
  let y;
  t[21] !== n || t[22] !== r.value || t[23] !== g || t[24] !== _ || t[25] !== v || t[26] !== c
    ? ((y = (0, Z.jsx)(Q, {
        "aria-label": g,
        disabled: n,
        placeholder: _,
...
function $() {
  ...
  let n;
  return (
    e[1] === t ? (n = e[2]) : ((n = (0, Z.jsx)(oe, { projectId: t })), (e[1] = t), (e[2] = n)), n
  );
}
function oe(e) {
  let t = (0, V.c)(22),
  ...
  let f = d,
    ...
    m;
  t[2] !== u || t[3] !== p
    ? ((m = (0, Z.jsx)(se, { liveUrl: u, siteTitle: p })), (t[2] = u), (t[3] = p), (t[4] = m))
    : (m = t[4]);
  let h = m,
    g;
  t[5] === h
    ? (g = t[6])
    : ((g = (0, Z.jsx)(v, { extension: !0, children: h })), (t[5] = h), (t[6] = g));
  let y;
  t[7] === h
    ? (y = t[8])
    : ((y = (0, Z.jsx)(v, {
...
function se(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Z.jsx)(E, { className: `icon-xs shrink-0 text-token-text-secondary` })), (t[5] = l))
    : (l = t[5]);
  let d;
  t[6] === r
    ? (d = t[7])
        ...
        r == null
          ...
          : (0, Z.jsxs)(Z.Fragment, {
              children: [
                ...
                (0, Z.jsx)(E, { className: `icon-xs shrink-0 text-token-text-secondary` }),
              ],
            })),
      (t[6] = r),
      (t[7] = d));
  ...
  t[14] === g
    ? (_ = t[15])
    : ((_ = (0, Z.jsx)(`div`, { className: `flex shrink-0 items-center gap-2`, children: g })),
      (t[14] = g),
      (t[15] = _));
  let v;
  return (
...
function ce(e) {
  let t = (0, V.c)(61),
    { accessPolicy: n, environment: r, projectId: l, siteSlug: u, siteTitle: d } = e,
    f = s(a),
    p = c(F, l),
    g = i(),
  ...
  t[3] === _
    ? (x = t[4])
    : ((x = _ == null ? null : W(_.baseEnvironment, _.draft)), (t[3] = _), (t[4] = x));
  let S = x,
    C;
  t[5] === r
    ? (C = t[6])
    : ((C = function (e) {
        v((t) => {
          let n = t?.baseEnvironment ?? r,
            i = U(n),
            a = e(t?.draft ?? i);
          return (0, ne.default)(a, i) ? null : { baseEnvironment: n, draft: a };
        });
      }),
      (t[5] = r),
      (t[6] = C));
  ...
  let E;
  t[12] !== n || t[13] !== l
    ? ((E = n == null ? null : (0, Z.jsx)(le, { accessPolicy: n, projectId: l })),
      (t[12] = n),
      (t[13] = l),
      (t[14] = E))
    : (E = t[14]);
  ...
  let oe;
  return (
    t[54] !== P || t[55] !== B || t[56] !== Y || t[57] !== $ || t[58] !== T || t[59] !== E
      ? ((oe = (0, Z.jsxs)(`form`, {
...
function le(e) {
  ...
  t[6] === n
    ? (f = t[7])
    : ((f = (0, Z.jsx)(R, { className: `icon-xs`, accessPolicy: n, "aria-hidden": !0 })),
      (t[6] = n),
      (t[7] = f));
  let p;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
...
function ue(e) {
  ...
  t[2] !== f.isPending || t[3] !== n
    ...
    : (A = t[4]);
  let j;
  t[5] !== v || t[6] !== f || t[7] !== g || t[8] !== _ || t[9] !== n || t[10] !== d || t[11] !== l
    ? ((j = (e) => {
        (e.preventDefault(),
          !(v !== l || f.isPending) &&
            f.mutateAsync().then(
  ...
  t[13] === D
    ? (M = t[14])
    : ((M = (0, Z.jsx)(b, { className: `contents`, children: D })), (t[13] = D), (t[14] = M));
  let N;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, Z.jsx)(T, {
        className: `contents`,
  ...
  t[16] === M
    ...
    : ((F = (0, Z.jsx)(`div`, {
        ...
        children: (0, Z.jsx)(x, { title: M, titleClassName: `truncate pr-8`, subtitle: N }),
      })),
      (t[16] = M),
      (t[17] = F));
  let I;
