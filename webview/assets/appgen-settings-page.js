...
import { ii as s, ni as c, oi as l, ri as u } from "./thread-context-inputs.js";
...
import { t as h } from "./app-shell-0b-x_r3Z.js";
...
function le(e) {
  let t = (0, G.c)(22),
    { projectId: n } = e,
    { data: r, isError: a, isLoading: o } = i(s, n),
    { data: c, isError: l, isLoading: d } = i(u, n),
...
function de(e) {
  let t = (0, G.c)(61),
    { accessPolicy: n, environment: r, projectId: s, siteSlug: c, siteTitle: u } = e,
    d = a(o),
    f = i(l, s),
    h = p(),
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((H = t[34]), (U = t[35]));
  let K;
  t[36] !== s || t[37] !== d || t[38] !== c || t[39] !== u
    ? ((K = () => {
        w(d, pe, { projectId: s, siteSlug: c, siteTitle: u });
      }),
      (t[36] = s),
      (t[37] = d),
      (t[38] = c),
...
function pe(e) {
  let t = (0, G.c)(49),
    { onClose: n, projectId: r, siteSlug: s, siteTitle: l } = e,
    u = a(o),
    d = i(c, r),
    f = p(),
    h = S(),
