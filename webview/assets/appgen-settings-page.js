...
import { Sn as R, Tn as oe } from "./app-initial~app-main~automations-page.js";
import {
  M as z,
  N as B,
  R as V,
...
function Ye(e) {
  ...
  t[5] === h
    ? (_ = t[6])
    : ((_ = (0, $.jsx)(G, { extension: !0, children: h })), (t[5] = h), (t[6] = _));
  let v;
  t[7] === h
    ? (v = t[8])
    : ((v = (0, $.jsx)(G, {
    ...
    : ((c =
        n == null
          ...
          : (0, $.jsxs)(A, {
              ...
              children: [
                (0, $.jsx)(V, { className: `icon-xs`, ExternalIcon: z, href: n }),
                (0, $.jsx)(L, {
...
function Ze(e) {
  let t = (0, Q.c)(88),
    { accessPolicy: n, environment: r, projectId: i, siteSlug: a, siteTitle: s } = e,
    l = o(ae),
    u = c(k, i),
    d = c(T, i),
    f = re(),
  ...
  let H;
  t[38] !== n || t[39] !== i
    ? ((H = n == null ? null : (0, $.jsx)(Qe, { accessPolicy: n, projectId: i })),
      (t[38] = n),
      (t[39] = i),
      (t[40] = H))
    : (H = t[40]);
...
function Qe(e) {
  ...
  t[14] !== a || t[15] !== f || t[16] !== m
    ? ((S = (0, $.jsx)(a, { ...m, values: f })), (t[14] = a), (t[15] = f), (t[16] = m), (t[17] = S))
    : (S = t[17]);
  let C;
  ...
  let w;
  t[22] !== r || t[23] !== i
    ? ((w = () => ye(i, Te, { projectId: r })), (t[22] = r), (t[23] = i), (t[24] = w))
    : (w = t[24]);
  let T, E;
  ...
  t[27] === w
    ? (D = t[28])
    : ((D = (0, $.jsxs)(A, { color: `outline`, size: `toolbar`, onClick: w, children: [E, T] })),
      (t[27] = w),
      (t[28] = D));
  let O;
  ...
  let k;
  t[34] !== c || t[35] !== O
    ? ((k = (0, $.jsx)(c, { children: O })), (t[34] = c), (t[35] = O), (t[36] = k))
    : (k = t[36]);
  let j;
  t[37] !== l || t[38] !== k
    ? ((j = (0, $.jsx)(l, { children: k })), (t[37] = l), (t[38] = k), (t[39] = j))
    : (j = t[39]);
  let M;
  return (
...
function $e(e) {
  ...
  t[2] !== l.isPending || t[3] !== n
    ...
    : (v = t[4]);
  let y;
  t[5] !== f || t[6] !== l || t[7] !== u || t[8] !== d || t[9] !== n || t[10] !== s || t[11] !== i
    ? ((y = (e) => {
        (e.preventDefault(),
          !(f !== i || l.isPending) &&
            l.mutateAsync().then(
  ...
  t[13] === h
    ? (b = t[14])
    : ((b = (0, $.jsx)(ge, { className: `contents`, children: h })), (t[13] = h), (t[14] = b));
  let x;
  t[15] === i
    ? (x = t[16])
    : ((x = (0, $.jsx)(pe, {
  ...
  t[17] !== b || t[18] !== x
    ? ((S = (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsx)(_e, { title: b, titleClassName: `truncate pr-8`, subtitle: x }),
      })),
      (t[17] = b),
      (t[18] = x),
      (t[19] = S))
