...
import { Ii as s, Mi as c, Ni as l, Pi as u } from "./app-server-manager-signals.js";
import { f as d } from "./vscode-api.js";
import { t as f } from "./isEqual.js";
import "./src-2.js";
import "./react-dom.js";
...
import { t as h } from "./app-shell.js";
...
import { r as y } from "./modal-controller-state.js";
import { a as b, d as x, i as S, l as C, n as w, r as T, u as E } from "./dialog-layout-B.js";
import { t as D } from "./with-window.js";
import "./folder.js";
...
import "./chevron.js";
import "./core.esm.js";
import { a as k, g as A, m as j } from "./chunk-9.js";
import "./_baseEach.js";
...
import "./lock.js";
import { t as N } from "./arrow-top-right.js";
import "./list-navigation.js";
import { n as P } from "./appgen-url.js";
import "./link.js";
import { r as F } from "./settings-row.js";
import { t as I } from "./settings-surface.js";
import { t as L } from "./settings-group.js";
import { t as R } from "./share-BD-tbltR.js";
import { r as z } from "./appgen-access.js";
import { i as B, t as V } from "./appgen-access-state-messages.js";
import "./use-workspace-users.js";
import { t as H } from "./appgen-share-dialog-1.js";
import { t as U } from "./toolbar-breadcrumb.js";
import { t as W } from "./settings-empty-state.js";
var G = e(f(), 1),
  K = o(),
  ee = e(t(), 1),
  q = `<REDACTED>`;
function te(e) {
  return {
    ...
    secrets: e.entries
      .filter((e) => e.is_secret)
      .map(({ key: e }) => ({ key: e, keyInputDisabledWhileValue: q, previousKey: e, value: q })),
  };
}
function ne(e, t) {
...
function J(e) {
  return e.previousKey != null && e.value === q;
}
function Y(e, t) {
...
function ae(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)(O, { className: `icon-xs` })), (t[3] = d))
    : (d = t[3]);
  let f;
  t[4] !== n || t[5] !== l || t[6] !== u
    ? ((f = (0, $.jsxs)(g, {
  ...
  let p;
  t[8] !== o || t[9] !== f || t[10] !== s
    ? ((p = (0, $.jsx)(L.Header, { actions: f, subtitle: o, title: s, titleGap: `none` })),
      (t[8] = o),
      (t[9] = f),
      (t[10] = s),
      (t[11] = p))
  ...
  return (
    t[17] !== p || t[18] !== h
      ? ((_ = (0, $.jsxs)(L, { className: `gap-2`, children: [p, h] })),
        (t[17] = p),
        (t[18] = h),
        (t[19] = _))
      : (_ = t[19]),
...
function oe(e) {
  ...
  t[18] !== r || t[19] !== i
    ...
    : (v = t[20]);
  let y;
  t[21] !== n || t[22] !== r.value || t[23] !== h || t[24] !== _ || t[25] !== v || t[26] !== s
    ? ((y = (0, $.jsx)(se, {
        "aria-label": h,
        disabled: n,
        placeholder: _,
  ...
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, $.jsx)(M, { className: `icon-2xs` })), (t[30] = x))
    : (x = t[30]);
  let S;
...
function ce() {
  ...
  if (t == null) {
    ...
    return (
      e[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, $.jsx)(k, { replace: !0, to: `/sites` })), (e[0] = t))
        : (t = e[0]),
      t
    );
  }
  let n;
  return (
    e[1] === t ? (n = e[2]) : ((n = (0, $.jsx)(le, { projectId: t })), (e[1] = t), (e[2] = n)), n
  );
}
function le(e) {
  let t = (0, K.c)(22),
    { projectId: n } = e,
    { data: i, isError: a, isLoading: o } = r(u, n),
    { data: s, isError: c, isLoading: d } = r(l, n),
    f = i?.current_live_url,
    p;
  t[0] === f ? (p = t[1]) : ((p = P(f)), (t[0] = f), (t[1] = p));
  let m = p,
    g = i?.title,
    _;
  t[2] !== f || t[3] !== g
    ? ((_ = (0, $.jsx)(ue, { liveUrl: f, siteTitle: g })), (t[2] = f), (t[3] = g), (t[4] = _))
    : (_ = t[4]);
  let v = _,
    y;
  t[5] === v
    ? (y = t[6])
    : ((y = (0, $.jsx)(D, { extension: !0, children: v })), (t[5] = v), (t[6] = y));
  let b;
  t[7] === v
    ? (b = t[8])
    : ((b = (0, $.jsx)(D, {
        ...
        chromeExtension: !0,
        electron: !0,
        children: (0, $.jsx)(h.Header, { children: v }),
      })),
      (t[7] = v),
      (t[8] = b));
  let x;
...
function ue(e) {
  ...
  let s;
  t[3] !== r || t[4] !== o
    ? ((s = (0, $.jsx)(U, { ancestors: o, current: r })), (t[3] = r), (t[4] = o), (t[5] = s))
    : (s = t[5]);
  let c;
  t[6] === n
    ? (c = t[7])
...
function de(e) {
  let t = (0, K.c)(61),
    { accessPolicy: n, environment: o, projectId: c, siteSlug: l, siteTitle: u } = e,
    d = i(a),
    f = r(s, c),
    h = p(),
    [_, b] = (0, ee.useState)(null),
    x;
  t[0] !== o || t[1] !== _?.draft
    ? ((x = _?.draft ?? te(o)), (t[0] = o), (t[1] = _?.draft), (t[2] = x))
    : (x = t[2]);
  let S = x,
    C;
  t[3] === _
    ? (C = t[4])
    : ((C = _ == null ? null : ne(_.baseEnvironment, _.draft)), (t[3] = _), (t[4] = C));
  let w = C,
    T;
  t[5] === o
    ? (T = t[6])
    : ((T = function (e) {
        b((t) => {
          let n = t?.baseEnvironment ?? o,
            r = te(n),
            i = e(t?.draft ?? r);
          return (0, G.default)(i, r) ? null : { baseEnvironment: n, draft: i };
        });
      }),
      (t[5] = o),
      (t[6] = T));
  let E = T,
    D;
  t[7] !== w || t[8] !== h || t[9] !== d || t[10] !== f
    ? ((D = (e) => {
        (e.preventDefault(),
          w != null &&
            f.mutateAsync(w).then(
              () => {
                b(null);
              },
              () => {
  ...
  let O;
  t[12] !== n || t[13] !== c
    ? ((O = n == null ? null : (0, $.jsx)(fe, { accessPolicy: n, projectId: c })),
      (t[12] = n),
      (t[13] = c),
      (t[14] = O))
    : (O = t[14]);
  ...
  t[18] === E
    ? (M = t[19])
    : ((M = (e) => {
        E((t) => ({ ...t, environmentVariables: e }));
      }),
      (t[18] = E),
      (t[19] = M));
  let N;
  t[20] !== S.environmentVariables || t[21] !== M || t[22] !== f.isPending
    ? ((N = (0, $.jsx)(ae, {
        addButtonLabel: k,
  ...
  t[27] === E
    ...
    : ((B = (e) => {
      ...
      (t[28] = B));
  let V;
  t[29] !== S.secrets || t[30] !== B || t[31] !== f.isPending
    ? ((V = (0, $.jsx)(ae, {
        addButtonLabel: P,
        disabled: f.isPending,
        entries: S.secrets,
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((U = t[34]), (W = t[35]));
  let q;
  t[36] !== c || t[37] !== d || t[38] !== l || t[39] !== u
    ? ((q = () => {
        y(d, pe, { projectId: c, siteSlug: l, siteTitle: u });
      }),
      (t[36] = c),
      (t[37] = d),
      (t[38] = l),
  ...
  let oe;
  return (
    t[54] !== N || t[55] !== V || t[56] !== Y || t[57] !== Q || t[58] !== D || t[59] !== O
      ? ((oe = (0, $.jsxs)(`form`, {
...
function fe(e) {
  ...
  t[0] === n
    ...
    : ((f = z(n)),
      ...
      (_ = (0, $.jsx)(B, { "aria-hidden": !0, accessPolicy: n, className: `icon-2xs shrink-0` })),
      (s = m),
      (p = V(f)),
      (t[0] = n),
      (t[1] = s),
  ...
  t[14] !== s || t[15] !== f || t[16] !== p
    ? ((x = (0, $.jsx)(s, { ...p, values: f })), (t[14] = s), (t[15] = f), (t[16] = p), (t[17] = x))
    : (x = t[17]);
  let S;
  t[18] !== h || t[19] !== _ || t[20] !== x
    ? ((S = (0, $.jsxs)(`span`, { className: h, children: [_, x] })),
      (t[18] = h),
      (t[19] = _),
      (t[20] = x),
      (t[21] = S))
  ...
  let C;
  t[22] !== r || t[23] !== o
    ? ((C = () => y(o, H, { projectId: r })), (t[22] = r), (t[23] = o), (t[24] = C))
    : (C = t[24]);
  let w, T;
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(R, { "aria-hidden": !0, className: `icon-xs` })),
      (w = (0, $.jsx)(m, {
  ...
  t[27] === C
    ? (E = t[28])
    : ((E = (0, $.jsxs)(g, { color: `outline`, size: `toolbar`, onClick: C, children: [T, w] })),
      (t[27] = C),
      (t[28] = E));
  let D;
  ...
  let k;
  t[37] !== u || t[38] !== O
    ? ((k = (0, $.jsx)(u, { children: O })), (t[37] = u), (t[38] = O), (t[39] = k))
    : (k = t[39]);
  let A;
  return (
    t[40] !== d || t[41] !== k || t[42] !== b
      ? ((A = (0, $.jsxs)(d, { children: [b, k] })),
        (t[40] = d),
        (t[41] = k),
        (t[42] = b),
        (t[43] = A))
...
function pe(e) {
  let t = (0, K.c)(49),
    { onClose: n, projectId: o, siteSlug: s, siteTitle: l } = e,
    u = i(a),
    d = r(c, o),
    f = p(),
    h = j(),
  ...
  t[2] !== d.isPending || t[3] !== n
    ...
    : (M = t[4]);
  let N;
  t[5] !== _ || t[6] !== d || t[7] !== f || t[8] !== h || t[9] !== n || t[10] !== u || t[11] !== s
    ? ((N = (e) => {
        (e.preventDefault(),
          !(_ !== s || d.isPending) &&
            d.mutateAsync().then(
  ...
  t[13] === O
    ? (P = t[14])
    : ((P = (0, $.jsx)(x, { className: `contents`, children: O })), (t[13] = O), (t[14] = P));
  let F;
  t[15] === s
    ? (F = t[16])
    : ((F = (0, $.jsx)(E, {
  ...
  t[17] !== P || t[18] !== F
    ? ((I = (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsx)(S, { title: P, titleClassName: `truncate pr-8`, subtitle: F }),
      })),
      (t[17] = P),
      (t[18] = F),
      (t[19] = I))
  ...
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (R = t[22]);
  let z;
  t[23] !== _ || t[24] !== d.isPending || t[25] !== s || t[26] !== L
    ? ((z = (0, $.jsx)(b, {
  ...
  let G;
  t[36] !== V || t[37] !== W
    ? ((G = (0, $.jsx)(b, { children: (0, $.jsxs)(T, { children: [V, W] }) })),
      (t[36] = V),
      (t[37] = W),
      (t[38] = G))
    : (G = t[38]);
  let q;
  t[39] !== z || t[40] !== G || t[41] !== N || t[42] !== I
    ? ((q = (0, $.jsxs)(w, {
        as: `form`,
  ...
  let te;
  return (
    t[44] !== d.isPending || t[45] !== q || t[46] !== A || t[47] !== M
      ? ((te = (0, $.jsx)(C, {
          open: !0,
          size: `compact`,
