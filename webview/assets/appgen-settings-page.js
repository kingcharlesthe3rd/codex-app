...
import { n as we, t as Te } from "./appgen-share-dialog.js";
...
function Ue(e) {
  ...
  let p;
  t[8] !== o || t[9] !== f || t[10] !== s
    ? ((p = (0, Z.jsx)(Y.Header, { actions: f, subtitle: o, title: s, titleGap: `none` })),
      (t[8] = o),
      (t[9] = f),
      (t[10] = s),
      (t[11] = p))
...
function Ye(e) {
  ...
  let m = f,
    ...
    g;
  t[2] !== u || t[3] !== h
    ? ((g = (0, $.jsx)(Xe, { liveUrl: u, siteTitle: h })), (t[2] = u), (t[3] = h), (t[4] = g))
    : (g = t[4]);
  let _ = g,
    v;
  t[5] === _
    ? (v = t[6])
    : ((v = (0, $.jsx)(N, { extension: !0, children: _ })), (t[5] = _), (t[6] = v));
  let y;
  t[7] === _
    ? (y = t[8])
    : ((y = (0, $.jsx)(N, {
    ...
    : ((c =
        n == null
          ...
          : (0, $.jsxs)(D, {
              ...
              children: [
                (0, $.jsx)(S, { className: `icon-xs`, ExternalIcon: v, href: n }),
                (0, $.jsx)(W, {
...
function Ze(e) {
  let t = (0, Q.c)(88),
    { accessPolicy: n, environment: a, projectId: s, siteSlug: c, siteTitle: l } = e,
    u = o(r),
    d = i(se, s),
    f = i(ie, s),
    p = ce(),
    ...
    : ((M = function (e) {
        h((t) => {
          let n = t?.baseEnvironment ?? a,
            r = Oe(n),
            i = e(t?.draft ?? r);
          return (0, rt.default)(i, r) ? null : { baseEnvironment: n, draft: i };
        });
      }),
      (t[9] = a),
      (t[10] = M));
  ...
  let V;
  t[38] !== n || t[39] !== s
    ? ((V = n == null ? null : (0, $.jsx)(Qe, { accessPolicy: n, projectId: s })),
      (t[38] = n),
      (t[39] = s),
      (t[40] = V))
    : (V = t[40]);
...
function Qe(e) {
  ...
  t[0] === n
    ...
    : ((f = fe(n)),
      ...
      (h = (0, $.jsx)(de, { "aria-hidden": !0, accessPolicy: n, className: `icon-2xs shrink-0` })),
      (s = W),
      (p = me(f)),
      (t[0] = n),
      (t[1] = s),
  ...
  t[14] !== s || t[15] !== f || t[16] !== p
    ? ((y = (0, $.jsx)(s, { ...p, values: f })), (t[14] = s), (t[15] = f), (t[16] = p), (t[17] = y))
    : (y = t[17]);
  let b;
  ...
  let x;
  t[22] !== i || t[23] !== a
    ? ((x = () => g(a, Te, { projectId: i })), (t[22] = i), (t[23] = a), (t[24] = x))
    : (x = t[24]);
  let S, C;
  ...
  t[27] === x
    ? (w = t[28])
    : ((w = (0, $.jsxs)(D, { color: `outline`, size: `toolbar`, onClick: x, children: [C, S] })),
      (t[27] = x),
      (t[28] = w));
  let T;
  ...
  let E;
  t[34] !== l || t[35] !== T
    ? ((E = (0, $.jsx)(l, { children: T })), (t[34] = l), (t[35] = T), (t[36] = E))
    : (E = t[36]);
  let O;
  t[37] !== u || t[38] !== E
    ? ((O = (0, $.jsx)(u, { children: E })), (t[37] = u), (t[38] = E), (t[39] = O))
    : (O = t[39]);
  let k;
  return (
...
function $e(e) {
  ...
  t[2] !== u.isPending || t[3] !== n
    ...
    : (y = t[4]);
  let b;
  t[5] !== p || t[6] !== u || t[7] !== d || t[8] !== f || t[9] !== n || t[10] !== l || t[11] !== s
    ? ((b = (e) => {
        (e.preventDefault(),
          !(p !== s || u.isPending) &&
            u.mutateAsync().then(
  ...
  t[13] === g
    ? (S = t[14])
    : ((S = (0, $.jsx)(x, { className: `contents`, children: g })), (t[13] = g), (t[14] = S));
  let C;
  t[15] === s
    ? (C = t[16])
    : ((C = (0, $.jsx)(O, {
  ...
  t[17] !== S || t[18] !== C
    ? ((w = (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsx)(re, { title: S, titleClassName: `truncate pr-8`, subtitle: C }),
      })),
      (t[17] = S),
      (t[18] = C),
      (t[19] = w))
  ...
  let I;
  t[36] !== M || t[37] !== F
    ? ((I = (0, $.jsx)(ee, { children: (0, $.jsxs)(ne, { children: [M, F] }) })),
      (t[36] = M),
      (t[37] = F),
      (t[38] = I))
    : (I = t[38]);
