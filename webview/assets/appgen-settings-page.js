...
function Ue(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Z.jsx)(v, { className: `icon-xs` })), (t[3] = f))
    : (f = t[3]);
  let p;
  t[4] !== n || t[5] !== u || t[6] !== d
    ? ((p = (0, Z.jsxs)(l, {
  ...
  let m;
  t[8] !== o || t[9] !== p || t[10] !== s
    ? ((m = (0, Z.jsx)(X.Header, { actions: p, subtitle: o, title: s, titleGap: `none` })),
      (t[8] = o),
      (t[9] = p),
      (t[10] = s),
      (t[11] = m))
  ...
  return (
    t[17] !== m || t[18] !== h
      ? ((g = (0, Z.jsxs)(X, { className: `gap-2`, children: [m, h] })),
        (t[17] = m),
        (t[18] = h),
        (t[19] = g))
      : (g = t[19]),
...
function We(e) {
  ...
  t[18] !== r || t[19] !== i
    ...
    : (_ = t[20]);
  let v;
  t[21] !== n || t[22] !== r.value || t[23] !== h || t[24] !== g || t[25] !== _ || t[26] !== s
    ? ((v = (0, Z.jsx)(Ge, {
        "aria-label": h,
        disabled: n,
        placeholder: g,
  ...
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Z.jsx)(ye, { className: `icon-2xs` })), (t[30] = b))
    : (b = t[30]);
  let x;
  ...
  if (t == null) {
    ...
    return (
      e[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, $.jsx)(ce, { replace: !0, to: `/sites` })), (e[0] = t))
        : (t = e[0]),
      t
    );
  }
...
function Ye(e) {
  let t = (0, Q.c)(22),
    { projectId: n } = e,
    { data: r, isError: i, isLoading: a } = C(P, n),
    { data: o, isError: c, isLoading: l } = C(s, n),
  ...
  let f = d,
    ...
    m;
  t[2] !== u || t[3] !== p
    ? ((m = (0, $.jsx)(Xe, { liveUrl: u, siteTitle: p })), (t[2] = u), (t[3] = p), (t[4] = m))
    : (m = t[4]);
  let h = m,
    g;
  t[5] === h
    ? (g = t[6])
    : ((g = (0, $.jsx)(O, { extension: !0, children: h })), (t[5] = h), (t[6] = g));
  let _;
  t[7] === h
    ? (_ = t[8])
    : ((_ = (0, $.jsx)(O, {
        ...
        chromeExtension: !0,
        electron: !0,
        children: (0, $.jsx)(ue.Header, { children: h }),
      })),
      (t[7] = h),
      (t[8] = _));
  let v;
...
function Xe(e) {
    ...
    : ((c =
        n == null
          ...
          : (0, $.jsxs)(l, {
              ...
              size: `toolbar`,
              onClick: (e) => {
                le({ event: e, href: n, initiator: `mcp_app_resource` });
              },
              children: [
                (0, $.jsx)(M, { className: `icon-xs`, ExternalIcon: k, href: n }),
                (0, $.jsx)(R, {
  ...
  t[8] === c
    ? (u = t[9])
    : ((u = (0, $.jsx)(`div`, { className: `flex items-center justify-end`, children: c })),
      (t[8] = c),
      (t[9] = u));
  let d;
  return (
...
function Ze(e) {
  let t = (0, Q.c)(88),
    ...
    y;
  t[0] !== r || t[1] !== p?.draft
    ? ((y = p?.draft ?? Oe(r)), (t[0] = r), (t[1] = p?.draft), (t[2] = y))
    : (y = t[2]);
  let x = y,
    S;
  t[3] === p
    ? (S = t[4])
    : ((S = p == null ? null : ke(p.baseEnvironment, p.draft)), (t[3] = p), (t[4] = S));
  let E = S,
    D;
  t[5] !== h || t[6] !== _ || t[7] !== o
    ? ((D = Fe(h, o, _)), (t[5] = h), (t[6] = _), (t[7] = o), (t[8] = D))
    : (D = t[8]);
  let { isInvalid: O, title: k, update: A } = D,
    te = p != null && E == null,
    j = c.isPending || u.isPending,
    M = j || O || te || (A == null && E == null),
    N;
  t[9] === r
    ? (N = t[10])
    : ((N = function (e) {
  ...
  t[24] === o
    ? (B = t[25])
    : ((B = (e) => {
        (v(!1), g(e.target.value === o ? null : e.target.value));
      }),
      (t[24] = o),
      (t[25] = B));
  let oe;
  t[26] !== h || t[27] !== _ || t[28] !== o
    ? ((oe = () => {
        !_ && h?.trim() === o && g(null);
      }),
      (t[26] = h),
  ...
  let ce;
  t[38] !== n || t[39] !== i
    ? ((ce = n == null ? null : (0, $.jsx)(Qe, { accessPolicy: n, projectId: i })),
      (t[38] = n),
      (t[39] = i),
      (t[40] = ce))
    : (ce = t[40]);
  ...
  t[44] === P
    ...
    : ((V = (e) => {
      ...
      (t[45] = V));
  let H;
  t[46] !== x.environmentVariables || t[47] !== j || t[48] !== V
    ? ((H = (0, $.jsx)(Ue, {
        addButtonLabel: le,
        disabled: j,
  ...
  t[62] !== i || t[63] !== s || t[64] !== a || t[65] !== o
    ? ((G = () => {
        w(s, $e, { projectId: i, siteSlug: a, siteTitle: o });
      }),
      (t[62] = i),
      (t[63] = s),
      (t[64] = a),
...
function Qe(e) {
  ...
  t[0] === n
    ...
    : ((d = he(n)),
      ...
      (h = (0, $.jsx)(U, { "aria-hidden": !0, accessPolicy: n, className: `icon-2xs shrink-0` })),
      (a = R),
      (p = fe(d)),
      (t[0] = n),
      (t[1] = a),
      ...
      (t[11] = _));
  let v;
  t[14] !== a || t[15] !== d || t[16] !== p
    ? ((v = (0, $.jsx)(a, { ...p, values: d })), (t[14] = a), (t[15] = d), (t[16] = p), (t[17] = v))
    : (v = t[17]);
  let y;
  ...
  let b;
  t[22] !== r || t[23] !== i
    ? ((b = () => w(i, Te, { projectId: r })), (t[22] = r), (t[23] = i), (t[24] = b))
    : (b = t[24]);
  let x, S;
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, $.jsx)(ve, { "aria-hidden": !0, className: `icon-xs` })),
      (x = (0, $.jsx)(R, {
  ...
  t[27] === b
    ? (C = t[28])
    : ((C = (0, $.jsxs)(l, { color: `outline`, size: `toolbar`, onClick: b, children: [S, x] })),
      (t[27] = b),
      (t[28] = C));
  let T;
  t[29] !== o || t[30] !== C || t[31] !== g || t[32] !== y
    ? ((T = (0, $.jsx)(o, { label: g, description: y, control: C })),
      (t[29] = o),
      (t[30] = C),
      (t[31] = g),
      (t[32] = y),
  ...
  let E;
  t[34] !== s || t[35] !== T
    ? ((E = (0, $.jsx)(s, { children: T })), (t[34] = s), (t[35] = T), (t[36] = E))
    : (E = t[36]);
  let D;
  t[37] !== c || t[38] !== E
    ? ((D = (0, $.jsx)(c, { children: E })), (t[37] = c), (t[38] = E), (t[39] = D))
    : (D = t[39]);
  let O;
  return (
    t[40] !== u || t[41] !== D || t[42] !== _
      ? ((O = (0, $.jsxs)(u, { children: [_, D] })),
        (t[40] = u),
        (t[41] = D),
        (t[42] = _),
        (t[43] = O))
...
function $e(e) {
  ...
  t[2] !== s.isPending || t[3] !== n
    ...
    : (b = t[4]);
  let x;
  t[5] !== m || t[6] !== s || t[7] !== c || t[8] !== p || t[9] !== n || t[10] !== o || t[11] !== i
    ? ((x = (e) => {
        (e.preventDefault(),
          !(m !== i || s.isPending) &&
            s.mutateAsync().then(
  ...
  t[13] === _
    ? (w = t[14])
    : ((w = (0, $.jsx)(te, { className: `contents`, children: _ })), (t[13] = _), (t[14] = w));
  let T;
  t[15] === i
    ? (T = t[16])
    : ((T = (0, $.jsx)(se, {
  ...
  t[17] !== w || t[18] !== T
    ? ((E = (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsx)(d, { title: w, titleClassName: `truncate pr-8`, subtitle: T }),
      })),
      (t[17] = w),
      (t[18] = T),
      (t[19] = E))
  ...
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (k = t[22]);
  let A;
  t[23] !== m || t[24] !== s.isPending || t[25] !== i || t[26] !== O
    ? ((A = (0, $.jsx)(u, {
  ...
  let I;
  t[36] !== M || t[37] !== F
    ? ((I = (0, $.jsx)(u, { children: (0, $.jsxs)(D, { children: [M, F] }) })),
      (t[36] = M),
      (t[37] = F),
      (t[38] = I))
    : (I = t[38]);
  let L;
  t[39] !== A || t[40] !== I || t[41] !== x || t[42] !== E
    ? ((L = (0, $.jsxs)(B, {
        as: `form`,
  ...
  let z;
  return (
    t[44] !== s.isPending || t[45] !== L || t[46] !== y || t[47] !== b
      ? ((z = (0, $.jsx)(ae, {
          open: !0,
          size: `compact`,
