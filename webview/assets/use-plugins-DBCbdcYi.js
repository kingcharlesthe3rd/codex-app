import{s as e}from"./chunk-Cq_f4orQ.js";import{R as t,s as n}from"./app-scope-DbsKKT7R.js";import{_ as r,k as i,m as a,n as o,r as s,u as c}from"./vscode-api-DIjwnE7x.js";import{_r as l,ar as u,hr as d,mr as f,mt as p,nt as m,or as h,pr as g,rr as _,tt as v,yr as ee}from"./src-X9SEQR78.js";import{As as te,No as y,tt as ne}from"./app-server-manager-signals-DixsiAkQ.js";import{o as re}from"./statsig-DoZ-0xit.js";import{t as ie}from"./invalidate-queries-and-broadcast-D0wkF79L.js";import{d as ae}from"./thread-context-inputs-V9X6XHXq.js";import{n as oe}from"./use-auth-DL2sxW8T.js";import{t as se}from"./use-codex-home-BagThRUG.js";import{i as ce,n as le,r as ue,t as de}from"./use-is-plugins-enabled-CXiEiMhr.js";function fe(){return window.electronBridge?.getBuildFlavor?.()||`prod`}var b=`<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`].map(e=>`data:image/svg+xml,${encodeURIComponent(e)}`);function j(e){let t=0;for(let n=0;n<e.length;n+=1)t=(t*31+e.charCodeAt(n))%A.length;return A[t]??``}var M=e(ee(),1),N={".svg":`image/svg+xml`,".png":`image/png`,".jpg":`image/jpeg`,".jpeg":`image/jpeg`,".webp":`image/webp`,".gif":`image/gif`,".avif":`image/avif`};async function P(e,t,n){let r=F(e);if(r==null)return null;try{let e={path:r,hostId:t},i=await n.fetchQuery({queryFn:({signal:t})=>o(`read-file-binary`,{params:e,signal:t}),queryKey:s(`read-file-binary`,e),retry:!1,gcTime:1/0,staleTime:c.INFINITE});return i.contentsBase64?`data:${I(r)};base64,${i.contentsBase64}`:null}catch(e){return a.warning(`Failed to inline local image`,{safe:{},sensitive:{error:e,resolvedImagePath:r}}),null}}function F(e){if(e==null)return null;let t=e.trim();if(t.length===0)return null;let n=t.toLowerCase();if(n.startsWith(`data:`)||n.startsWith(`http:`)||n.startsWith(`https:`)||n.startsWith(`file:`)||n.startsWith(`vscode-resource:`)||n.startsWith(`vscode-webview:`)||n.startsWith(`vscode-file:`))return null;let r=l(t);return g(r)?r:null}function I(e){return N[M.default.extname(e).toLowerCase()]??`application/octet-stream`}var he=t(),L=[`plugins`],R=`openai-curated-marketplaces-hidden`,z=4,ge=[],_e=[],ve=[],ye=[],be=[],B=[],xe=[v],Se=[v,m],V=`computer-use`,H=`.tmp/marketplaces/openai-internal-testing`,U=[`datadog`,`statsig`],W=new Set([`codex-official`,_,v,m,`openai-primary-runtime`].map(Ue));function G(e){return{...Ze(e.summary),description:e.summary.interface?.shortDescription??e.description??null,displayName:e.summary.interface?.displayName??null,marketplaceDisplayName:null,marketplaceName:e.marketplaceName,plugin:e.summary,keywords:e.summary.keywords,...Q({marketplaceName:e.marketplaceName,marketplacePath:e.marketplacePath})}}function K({marketplacePath:e,remoteMarketplaceName:t}){if(e!=null&&t!=null)throw Error(`plugin marketplace request requires one marketplace source`);if(e!=null)return{marketplacePath:e};if(t!=null)return{remoteMarketplaceName:t};throw Error(`plugin marketplace request requires a marketplace source`)}function q(e){return e.marketplacePath??`remote:${e.remoteMarketplaceName}`}function Ce(e){return e.filter(e=>{let t=$(e).toLowerCase();return!U.some(e=>t===e||t.startsWith(`${e}-`))})}function J(e){return e.marketplacePath==null?X(e.plugin):e.plugin.name}function Y(e){return e.marketplacePath==null?X(e.plugin):e.plugin.id}function X(e){if(e.remotePluginId==null)throw Error(`remote plugin ${e.id} is missing remotePluginId`);return e.remotePluginId}function Z(e){return{...K(e),pluginName:J(e)}}function Q({marketplaceName:e,marketplacePath:t}){return t==null?{marketplacePath:null,remoteMarketplaceName:e}:{marketplacePath:t,remoteMarketplaceName:null}}function we(e,t,a){let o=(0,he.c)(54),s;o[0]===e?s=o[1]:(s={hostId:e},o[0]=e,o[1]=s);let l=de(s)&&(a?.enabled??!0),u=a?.additionalMarketplaceKinds??ve,d=a?.installSuggestionPluginNames??null,f=re(`4218407052`),p=me(oe(e)?.authMethod??null),m=ye;p?m=Se:f&&(m=xe);let h=Ae({additionalMarketplaceKinds:u,includeRemoteCatalog:a?.includeRemoteCatalog??!0,includeVerticalCatalog:!f}),g=ie(),_=i(),v=n(ae),ee=se(e),y=n(ne),b;o[2]!==e||o[3]!==y?(b=y.includes(e),o[2]=e,o[3]=y,o[4]=b):b=o[4];let x=b,S=l&&x,C;o[5]!==e||o[6]!==S?(C={enabled:S,hostId:e},o[5]=e,o[6]=S,o[7]=C):C=o[7];let w=ce(C),T;o[8]===e?T=o[9]:(T={hostId:e},o[8]=e,o[9]=T);let E=le(T),D;o[10]===e?D=o[11]:(D={hostId:e},o[10]=e,o[11]=D);let O=ue(D),pe=t===void 0,k=qe({codexHome:ee,hostId:e,rootsOverrideCwd:t,workspaceRoots:v.data?.roots}),A=l&&x&&(t!==void 0||v.isFetched),j;o[12]===Symbol.for(`react.memo_cache_sentinel`)?(j=fe(),o[12]=j):j=o[12];let M=j,N=d==null?je(e,k,h,f,p):Oe(e,k,ve,d,f,p),P;o[13]!==M||o[14]!==m||o[15]!==e||o[16]!==d||o[17]!==h||o[18]!==_||o[19]!==k?(P=async()=>{if(d!=null){let t=await te(`send-cli-request-for-host`,{hostId:e,method:`plugin/installed`,params:{...k.length>0?{cwds:k}:{},installSuggestionPluginNames:d}}),n=Ne(t.marketplaces,m),r=Xe(n);return{featuredPluginIds:ge,marketplaceLoadErrors:t.marketplaceLoadErrors,marketplaces:Ge(n),plugins:await Ke({hostId:e,plugins:r,queryClient:_})}}let t=await te(`list-plugins`,h==null?{hostId:e,...k.length>0?{cwds:k}:{}}:{hostId:e,...k.length>0?{cwds:k}:{},marketplaceKinds:h}),n=Ne(t.marketplaces,m),r=Xe(n),i=M==null?r:He({buildFlavor:M,plugins:r}),a=Ce(t.featuredPluginIds).filter(e=>!m.some(t=>e.endsWith(`@${t}`)));return{featuredPluginIds:M==null?a:Ve({buildFlavor:M,featuredPluginIds:a}),marketplaceLoadErrors:t.marketplaceLoadErrors,marketplaces:Ge(n),plugins:await Ke({hostId:e,plugins:i,queryClient:_})}},o[13]=M,o[14]=m,o[15]=e,o[16]=d,o[17]=h,o[18]=_,o[19]=k,o[20]=P):P=o[20];let F;o[21]!==A||o[22]!==N||o[23]!==P?(F={queryKey:N,queryFn:P,enabled:A,staleTime:c.FIVE_MINUTES,gcTime:1/0},o[21]=A,o[22]=N,o[23]=P,o[24]=F):F=o[24];let I=r(F),R;o[25]!==g||o[26]!==I?(R=async function(){await g(L),await I.refetch()},o[25]=g,o[26]=I,o[27]=R):R=o[27];let z=R;if(!l||!x){let e;return o[28]===Symbol.for(`react.memo_cache_sentinel`)?(e={availablePlugins:B,featuredPluginIds:ge,installedPlugins:B,marketplaceLoadErrors:_e,marketplaces:be,errorMessage:null,isLoading:!1,isFetching:!1,refetch:Ee,forceReload:Te},o[28]=e):e=o[28],e}let V,H,U,W;o[29]!==w.available||o[30]!==O.available||o[31]!==E.available||o[32]!==I.data?.featuredPluginIds||o[33]!==I.data?.plugins?(V={isComputerUseAvailable:w.available,isExternalBrowserUseAvailable:O.available,isInAppBrowserUseAvailable:E.available},H=I.data?.plugins??B,U=Fe({plugins:H,...V}),W=Pe({featuredPluginIds:I.data?.featuredPluginIds??ge,...V}),o[29]=w.available,o[30]=O.available,o[31]=E.available,o[32]=I.data?.featuredPluginIds,o[33]=I.data?.plugins,o[34]=V,o[35]=H,o[36]=U,o[37]=W):(V=o[34],H=o[35],U=o[36],W=o[37]);let G;o[38]===H?G=o[39]:(G=Ie(H),o[38]=H,o[39]=G);let K=I.data?.marketplaceLoadErrors??_e,q=I.data?.marketplaces??be,J=I.error?String(I.error.message):null,Y=pe&&v.isLoading||I.isLoading||E.isLoading||O.isLoading||w.isLoading,X=pe&&v.isFetching||I.isFetching||w.isFetching,Z;o[40]!==V||o[41]!==I?(Z=async()=>{let e=(await I.refetch()).data?.plugins??B;return{availablePlugins:Fe({plugins:e,...V}),installedPlugins:Ie(e)}},o[40]=V,o[41]=I,o[42]=Z):Z=o[42];let Q;return o[43]!==z||o[44]!==U||o[45]!==W||o[46]!==G||o[47]!==K||o[48]!==q||o[49]!==J||o[50]!==Y||o[51]!==X||o[52]!==Z?(Q={availablePlugins:U,featuredPluginIds:W,installedPlugins:G,marketplaceLoadErrors:K,marketplaces:q,errorMessage:J,isLoading:Y,isFetching:X,refetch:Z,forceReload:z},o[43]=z,o[44]=U,o[45]=W,o[46]=G,o[47]=K,o[48]=q,o[49]=J,o[50]=Y,o[51]=X,o[52]=Z,o[53]=Q):Q=o[53],Q}async function Te(){}async function Ee(){return{availablePlugins:B,installedPlugins:B}}function De(e){let t=(0,he.c)(10),{enabled:n,hostId:i,marketplaceKind:a}=e,o=n===void 0?!0:n,s;t[0]===i?s=t[1]:(s={hostId:i},t[0]=i,t[1]=s);let l=de(s),u,d;t[2]!==i||t[3]!==a?(u=[...L,`marketplace-kind`,i,a],d=async()=>Xe((await te(`list-plugins`,{hostId:i,marketplaceKinds:[a]})).marketplaces),t[2]=i,t[3]=a,t[4]=u,t[5]=d):(u=t[4],d=t[5]);let f=o&&l,p;return t[6]!==u||t[7]!==d||t[8]!==f?(p={queryKey:u,queryFn:d,enabled:f,staleTime:c.FIVE_MINUTES},t[6]=u,t[7]=d,t[8]=f,t[9]=p):p=t[9],r(p)}function Oe(e,t,n=ve,r=null,i=!1,a=!1){return r==null?je(e,t,Ae({additionalMarketplaceKinds:n,includeRemoteCatalog:!0,includeVerticalCatalog:!i}),i,a):ke([...L,e,t,`installed`,r,`curated-marketplace`,Me(i)],a)}function ke(e,t){return t?[...e,R]:e}function Ae({additionalMarketplaceKinds:e,includeRemoteCatalog:t,includeVerticalCatalog:n}){return t&&!n&&e.length===0?null:n?[`local`,`vertical`,...e]:[`local`,...e]}function je(e,t,n,r,i){let a=Me(r);return ke(n==null?[...L,e,t,`curated-marketplace`,a]:[...L,e,t,`marketplace-kinds`,n,`curated-marketplace`,a],i)}function Me(e){return e?m:v}function Ne(e,t){return t.length===0?e:e.filter(e=>!t.includes(e.name))}function Pe({featuredPluginIds:e,...t}){return e.filter(e=>Le(e,t))}function Fe({plugins:e,...t}){return e.filter(e=>Le(e.plugin.id,t))}function Ie(e){return e.filter(e=>e.plugin.installed)}function Le(e,{isComputerUseAvailable:t,isExternalBrowserUseAvailable:n,isInAppBrowserUseAvailable:r}){return!(!r&&Re(e)||!n&&ze(e)||!t&&Be(e))}function Re(e){let t=$(e);return t===`browser`||t===`browser-use`}function ze(e){let t=$(e);return t===`chrome`||t===`chrome-dev`||t===`chrome-internal`}function Be(e){return $(e)===V}function $(e){return e.split(`@`)[0]}function Ve({buildFlavor:e,featuredPluginIds:t}){let n=u(e);return t.filter(e=>{let t=p(e);return t==null?!0:!h(t)||t===n})}function He({buildFlavor:e,plugins:t}){let n=u(e);return t.filter(e=>!h(e.marketplaceName)||e.marketplaceName===n)}function Ue(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function We(e){return W.has(Ue(e))}function Ge(e){let t=new Map;for(let n of e){let e=`${n.name}\u0000${n.path??``}`;if(t.has(e))continue;let r=We(n.name);t.set(e,{displayName:n.interface?.displayName??null,isBuiltIn:r,name:n.name,path:n.path,pluginCount:n.plugins.length})}return Array.from(t.values()).sort((e,t)=>{let n=e.displayName?.trim()||e.name,r=t.displayName?.trim()||t.name;return n.localeCompare(r)})}async function Ke({hostId:e,plugins:t,queryClient:n}){let r=[...t];async function i(a){let o=t[a];if(o==null)return;let[s,c]=await Promise.all([P(o.composerIconPath,e,n),P(o.logoPath,e,n)]);(s!=null||c!=null)&&(r[a]={...o,composerIconPath:s??o.composerIconPath,logoPath:c??o.logoPath,plugin:o.plugin.interface?{...o.plugin,interface:{...o.plugin.interface,...s==null?{}:{composerIcon:s},...c==null?{}:{logo:c}}}:o.plugin}),await i(a+z)}return await Promise.all(Array.from({length:Math.min(z,t.length)},(e,t)=>i(t))),r}function qe({codexHome:e,hostId:t,rootsOverrideCwd:n,workspaceRoots:r}){let i=t===`local`&&e!=null?y(e,H):null;return Je([...typeof n==`string`?[n]:n??r??[],...i==null?[]:[i]],e)}function Je(e,t){return Array.from(new Set(e.map(e=>e.trim()).filter(e=>g(e)&&Ye(e,t))))}function Ye(e,t){return t==null?!0:f(t)||d(t)?f(e)||d(e):e.startsWith(`/`)&&!e.startsWith(`//`)}function Xe(e){let t=new Map;for(let n of e)for(let e of n.plugins)t.has(e.id)||t.set(e.id,{...Ze(e),description:e.interface?.shortDescription??null,displayName:e.interface?.displayName??null,marketplaceDisplayName:n.interface?.displayName??null,marketplaceName:n.name,plugin:e,keywords:e.keywords,...Q({marketplaceName:n.name,marketplacePath:n.path})});return Array.from(t.values())}function Ze(e){let t=D(e);if(t!=null)return{composerIconPath:t,logoPath:t};let n=e.interface?.composerIcon??e.interface?.composerIconUrl??null,r=e.interface?.logo??e.interface?.logoUrl??null;if(n!=null||r!=null)return{composerIconPath:n,logoPath:r};let i=j(e.id);return{composerIconPath:i,logoPath:i}}export{P as _,K as a,Y as c,Be as d,ze as f,F as g,De as h,q as i,X as l,we as m,G as n,Z as o,Re as p,Ze as r,J as s,L as t,We as u,me as v,fe as y};
//# sourceMappingURL=use-plugins-DBCbdcYi.js.map