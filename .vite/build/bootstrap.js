...
async function b() {
  try {
    ...
    try {
      return await n.V.load(``);
    } catch {
      return n.V.createDefault();
    }
  }
}
...
var S = `pending-source-dmg-cleanup.json`,
  ...
  E = t
    .ks({
      images: t
        .Ss(
          t
            .ks({
              "image-path": t.Ms().optional(),
              "system-entities": t
                .Ss(t.ks({ "mount-point": t.Ms().optional() }).passthrough())
                .optional(),
            })
            .passthrough(),
        )
    ...
    .passthrough(),
  D = t.ks({ sourceDmgPath: t.Ms() }).passthrough();
async function O({
  clearPendingSourceDmgPath: e = B,
  copyAppBundleToApplicationsFolder: i = k,
  detachSourceDmg: a = G,
  getCurrentAppBundlePath: s = n.T,
...
(n.v(),
  ...
  n.C(),
  process.platform === `win32` && r.app.setAppUserModelId(n.O(Q)));
var $ = n.D({ isMacOS: Z, isPackaged: r.app.isPackaged });
