    ...
    .ji({
      images: t
        .Ci(
          t
            .ji({
              "image-path": t.Pi().optional(),
              "system-entities": t
                .Ci(t.ji({ "mount-point": t.Pi().optional() }).passthrough())
                .optional(),
            })
            .passthrough(),
        )
...
function D({ getCurrentAppBundlePath: e }) {
  try {
    ...
    n.Ir().warning(`Failed to check app Applications folder status`, {
...
function M(e) {
  try {
    ...
    n.Ir().warning(`Failed to remove staging app bundle`, {
      safe: { errorType: e instanceof Error ? e.name : typeof e },
    });
  }
}
...
function F({ setPendingSourceDmgPath: e, sourceDmgPath: t }) {
  try {
    ...
    n.Ir().warning(`Failed to remember app source DMG for cleanup`, {
      safe: { errorType: e instanceof Error ? e.name : typeof e },
    });
  }
}
...
(r.v(),
  ...
  r.C(),
  process.platform === `win32` && i.app.setAppUserModelId(r.O(Q)));
var $ = r.D({ isMacOS: Z, isPackaged: i.app.isPackaged });
