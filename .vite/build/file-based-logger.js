...
var c = t.qr(`build-flavor`),
  l = [t.Xo.Nightly, t.Xo.InternalAlpha, t.Xo.PublicBeta, t.Xo.Prod],
  u = {
    [t.Xo.Nightly]: { kind: `msix` },
    [t.Xo.InternalAlpha]: { kind: `msix` },
    [t.Xo.PublicBeta]: {
      kind: `store`,
  ...
  h = {
    ...
    readFromPackageMetadata() {
      let e = s(`codexBuildFlavor`, { parse: (e) => (h.isValid(e) ? e : null) });
      return e
    ...
    resolve() {
      let e = process.env.BUILD_FLAVOR,
        t = h.parse(e);
      return t
        ? (c().info(`Resolved build flavor from env`, { safe: { value: t }, sensitive: {} }), t)
        : (e?.trim() &&
          ...
          h.readFromPackageMetadata() ||
            (process.env.NODE_ENV === `production`
              ? (c().warning(`BUILD_FLAVOR missing; defaulting to prod in production runtime`),
                h.Prod)
              : (c().warning(`BUILD_FLAVOR missing; defaulting to dev in non-production runtime`),
                h.Dev)));
    },
    ...
    shouldIncludeUpdater(e, t, n = process.env) {
      return h.shouldIncludeSparkle(e, t, n) || h.shouldIncludeWindowsUpdater(e, t, n);
    },
...
function v(e, t = process.platform) {
  ...
  return t === `darwin`
    ...
    : t === `win32`
      ? (0, r.join)(i.LOCALAPPDATA ?? (0, r.join)(a, `AppData`, `Local`), `Codex`, `Logs`)
      : t === `linux`
        ? (0, r.join)(i.XDG_STATE_HOME ?? (0, r.join)(a, `.local`, `state`), `codex`, `logs`)
...
function T(e, t) {
  return (0, r.join)(e, t.getUTCFullYear().toString(), w(t.getUTCMonth() + 1), w(t.getUTCDate()));
}
function E(e, t, n, r) {
...
function A(e, t, n, a) {
  try {
    let a = new Date(Date.UTC(t.getUTCFullYear(), t.getUTCMonth(), t.getUTCDate())),
      o = new Date(a);
    ...
    for (let t of (0, i.readdirSync)(e)) {
      ...
      for (let e of (0, i.readdirSync)(a)) {
        ...
        (0, i.readdirSync)(s).length === 0 && (0, i.rmSync)(s, { recursive: !0, force: !0 });
      }
      (0, i.readdirSync)(a).length === 0 && (0, i.rmSync)(a, { recursive: !0, force: !0 });
    }
  } catch (t) {
...
function j(e, t = {}) {
  let n = (t, n) => e.nonFatalReporter.reportNonFatal(t, { kind: `file-based-logger`, extra: n }),
    ...
    g = C,
    _ = t.createStream ?? ((e, t) => (0, i.createWriteStream)(e, { flags: `w`, highWaterMark: t })),
...
//# sourceMappingURL=file-based-logger.js.map
