...
function ee(e, { viewport: t, viewportScale: n, zoomFactor: r = 1 }) {
  let i = w(n),
    ...
    c = 16 * i,
    l = pe * i,
    u = Math.min(fe * i, o - c * 2),
    d = O(a.x, c, o - u - c),
    f = a.y - l - me * i,
    p = a.y + a.height + me * i;
  return { x: d, y: f >= c ? f : O(p, c, s - l - c), width: u, height: l };
}
function te(e, t = _e) {
...
function re(e, t) {
  ...
  for (let t of i.values()) {
    ...
    let i = t.reduce((t, n) => t + e[n].x, 0) / t.length - ((t.length - 1) * ge) / 2,
      o = i + (t.length - 1) * ge,
      s = i < n ? n - i : o > r ? r - o : 0;
    t.forEach((t, o) => {
      a[t] = { x: O(i + o * ge + s, n, r), y: e[t].y };
    });
  }
  return a;
}
...
function le(e, t) {
  return e.kind === t.kind
    ? e.pageUrl === t.pageUrl &&
        ...
        D(e.scrollContainers, t.scrollContainers) &&
        e.isFixed === t.isFixed &&
...
var de,
  ...
  be = o(() => {
    ((de = 3),
      ...
      (he = 25),
      (ge = he / 2),
      (_e = `data-codex-browser-design-group`),
      (ve = `
...
`),
      (ye = { defaultLocale: `en-US`, locale: `en-US`, messages: {} }));
  });
function xe(e) {
  return Math.min(Te, Math.max(we, e));
}
function Se(e) {
  return xe(e) / 100;
}
var Ce,
  ...
  Te,
  Ee = o(() => {
    ((Ce = [25, 33, 50, 67, 75, 80, 90, 100, 110, 125, 150, 175, 200, 250, 300, 400, 500]),
      (we = Ce[0]),
      (Te = Ce[Ce.length - 1]));
  });
(be(), Ee());
var De = `codex_desktop:message-for-view`,
  Oe = `codex_desktop:browser-sidebar-runtime-message`;
function ke(e, t) {
  switch (t.type) {
...
var Ae = function (e, t, n) {
  ...
  Le = s((e) => {
    ...
    var ue = le(null),
      ...
      pe = le(null);
    function me(e, t) {
      switch ((A(fe, t), A(de, e), A(ue, null), t.nodeType)) {
        case 9:
        case 11:
    ...
    function ge(e) {
      e.memoizedState !== null && A(pe, e);
      var t = ue.current,
        n = Hd(t, e.type);
      t !== n && (A(de, e), A(ue, n));
    }
    function _e(e) {
      (de.current === e && (k(ue), k(de)), pe.current === e && (k(pe), (Qf._currentValue = ce)));
    }
    var ve, ye;
    function be(e) {
      if (ve === void 0)
...
` +
    ...
    var Te = Object.prototype.hasOwnProperty,
      ...
      j = null;
    function M(e) {
      if ((typeof Be == `function` && Ve(e), j && typeof j.setStrictMode == `function`))
        try {
    ...
    var ut = Math.random().toString(36).slice(2),
      ...
      mt = `__reactHandles$` + ut,
      ht = `__reactResources$` + ut,
      gt = `__reactMarker$` + ut;
    function _t(e) {
      (delete e[P], delete e[dt], delete e[pt], delete e[F], delete e[mt]);
    }
    function vt(e) {
      var t = e[P];
      if (t) return t;
        ...
        a: switch (((e = t.stateNode), t.type)) {
          case `input`:
            if (
              ...
              for (
                n = n.querySelectorAll(`input[name="` + I(`` + t) + `"][type="radio"]`), t = 0;
                t < n.length;
                t++
              ) {
                var r = n[t];
    ...
    function mi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) di(e) && (s = 1);
        ...
        s = Uf(e, n, ue.current) ? 26 : e === `html` || e === `head` || e === `body` ? 27 : 5;
      else
        a: switch (e) {
          case te:
    ...
    function bi(e, t) {
      if (typeof e == `object` && e) {
        var n = yi.get(e);
        return n === void 0 ? ((t = { value: e, source: t, stack: we(t) }), yi.set(e, t), t) : n;
      }
    ...
    function To(e) {
      ...
      if (((mo = 0), (V = B = z = null), (ho = !1), (yo = 0), (bo = null), t)) throw Error(i(300));
    ...
    function Ao(e) {
      ...
      ((mo = 0), (V = B = z = null), (go = !1), (yo = vo = 0), (bo = null));
    }
    function jo() {
    ...
    var zs = {
        ...
        useCacheRefresh: function () {
          return (jo().memoizedState = As.bind(null, z));
        },
    ...
    function Rc(e, t, n) {
      ...
      switch ((Ni(t), t.tag)) {
        ...
        case 27:
          if ((_e(t), (n = fe.current), (a = t.type), e !== null && t.stateNode != null))
            ...
            ((e = ue.current), Hi(t) ? Bi(t, e) : ((e = ff(a, r, n)), (t.stateNode = e), Nc(t)));
          }
          return (W(t), null);
        case 5:
        ...
        case 19:
          if ((k(fo), (r = t.memoizedState), r === null)) return (W(t), null);
                ...
                for (e = t.child; e !== null; ) {
                  if (((o = po(e)), o !== null)) {
                    for (
                      ...
                      (pi(n, e), (n = n.sibling));
                    return (A(fo, (fo.current & 1) | 2), R && Ai(t, r.treeForkCount), t.child);
                  }
                  e = e.sibling;
                }
              r.tail !== null &&
    ...
    var Ll = {
      ...
      fu = null;
    function pu() {
      return K & 2 && Y !== 0 ? Y & -Y : T.T === null ? ct() : dd();
    }
    function mu() {
      if (Jl === 0)
        if (!(Y & 536870912) || R) {
    ...
    function Au(e, t) {
      ...
      var r = Tu(),
        a = Eu();
      q !== e || Y !== t ? ((nu = null), (tu = Ae() + 500), Su(e, t)) : (Vl = Qe(e, t));
      a: do
        try {
          if (X !== 0 && J !== null) {
            t = J;
    ...
    function sd(e, t) {
      ...
      if (
        ...
        return (
          r !== null && r !== null && De(r), (e.callbackNode = null), (e.callbackPriority = 0)
        );
      if (!(n & 3) || Qe(e, n)) {
        ...
        return (
          (r = cd.bind(null, e)), (n = Ee(n, r)), (e.callbackPriority = t), (e.callbackNode = n), t
        );
      }
      return (
        r !== null && r !== null && De(r), (e.callbackPriority = 2), (e.callbackNode = null), 2
      );
    }
    function cd(e, t) {
    ...
    function md(e, t, n, r, i) {
      if (t === `submit` && n && n.stateNode === i) {
        var a = fd((i[dt] || null).action),
          o = r.submitter;
        o &&
          ((t = (t = o[dt] || null) ? fd(t.formAction) : o.getAttribute(`formAction`)),
          t !== null && ((a = t), (o = null)));
        ...
        if (!(t & 7)) {
          a: {
            if (
              ...
              c && n !== nn && (u = n.relatedTarget || n.fromElement) && (vt(u) || u[ft]))
            )
              break a;
            if (
              (l || c) &&
...
`,
      ...
      if (r && e && t) {
        ...
        t === `image` && n && n.imageSrcSet
          ? ((i += `[imagesrcset="` + I(n.imageSrcSet) + `"]`),
            typeof n.imageSizes == `string` && (i += `[imagesizes="` + I(n.imageSizes) + `"]`))
          : (i += `[href="` + I(e) + `"]`);
        var a = i;
        switch (t) {
          case `style`:
    ...
    function Tf(e, t) {
      ...
      if (n && e) {
        var r = t && typeof t.as == `string` ? t.as : `script`,
          i = `link[rel="modulepreload"][as="` + I(r) + `"][href="` + I(e) + `"]`,
          a = i;
        switch (r) {
          case `audioworklet`:
          case `paintworklet`:
    ...
    function Vf(e, t, n) {
      ...
      for (r.set(e, null), n = n.getElementsByTagName(e), i = 0; i < n.length; i++) {
        var a = n[i];
        if (
          !(a[gt] || a[P] || (e === `link` && a.getAttribute(`rel`) === `stylesheet`)) &&
...
var He,
  ...
  Ue = o(() => {});
function We(e, t) {
  var n = t && t.cache ? t.cache : et,
    r = t && t.serializer ? t.serializer : Qe;
  return (t && t.strategy ? t.strategy : Ye)(e, { cache: n, serializer: r });
}
function Ge(e) {
...
function Ye(e, t) {
  var n = e.length === 1 ? Ke : qe;
  return Je(e, this, n, t.cache.create(), t.serializer);
}
function Xe(e, t) {
  return Je(e, this, qe, t.cache.create(), t.serializer);
}
function Ze(e, t) {
  return Je(e, this, Ke, t.cache.create(), t.serializer);
}
var Qe,
  $e,
  et,
...
function Ct(e) {
  ...
  for (
    var t = e.split(xt).filter(function (e) {
        return e.length > 0;
      }),
      n = [],
      r = 0,
  ...
  for (var t = {}, n = 0, r = e; n < r.length; n++) {
    ...
    switch (i.stem) {
      ...
      case `integer-width`:
        ...
        i.options[0].replace(Mt, function (e, n, r, i, a, o) {
    ...
    if (At.test(i.stem)) {
      ...
      i.stem.replace(At, function (e, n, r, i, a, o) {
        return (
          r === `*`
...
var qt,
  ...
  pn = o(() => {
    (M(),
      ...
      (qt = RegExp(`^${gt.source}*`)),
      (Jt = RegExp(`${gt.source}*\$`)),
      (Yt = !!String.prototype.startsWith && `_a`.startsWith(`a`, 1)),
      (Xt = !!String.fromCodePoint),
      (Zt = !!Object.fromEntries),
      (Qt = !!String.prototype.codePointAt),
      ($t = !!String.prototype.trimStart),
      (en = !!String.prototype.trimEnd),
      (tn = Number.isSafeInteger
      ...
      (nn = !0));
    try {
      nn = Vt(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`).exec(`a`)?.[0] === `a`;
    } catch {
      nn = !1;
    }
    ((rn = Yt
      ...
      nn
        ? ((dn = Vt(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`)),
          (un = function (e, t) {
        ...
        return (
          ...
          (e.prototype.parseMessage = function (e, t, n) {
            for (var r = []; !this.isEOF(); ) {
              ...
              } else if (i === 60 && !this.ignoreTag && Ht(this.peek() || 0)) {
            ...
            if (this.bumpIf(`>`)) {
              ...
              if (this.bumpIf(`</`)) {
                if (this.isEOF() || !Ht(this.char()))
                  return this.error(N.INVALID_TAG, I(o, this.clonePosition()));
                ...
                return r === this.parseTagName()
                  ? (this.bumpSpace(),
                    this.bumpIf(`>`)
                      ...
                      : this.error(N.INVALID_TAG, I(o, this.clonePosition())))
                  : this.error(N.UNMATCHED_CLOSING_TAG, I(s, this.clonePosition()));
              } else return this.error(N.UNCLOSED_TAG, I(n, this.clonePosition()));
            } else return this.error(N.INVALID_TAG, I(n, this.clonePosition()));
          }),
          ...
          (e.prototype.tryParseLeftAngleBracket = function () {
            return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !Ut(this.peek() || 0))
              ? (this.bump(), `<`)
              : null;
          }),
          ...
          (e.prototype.parseArgument = function (e, t) {
            ...
            if ((this.bump(), this.bumpSpace(), this.isEOF()))
              return this.error(N.EXPECT_ARGUMENT_CLOSING_BRACE, I(n, this.clonePosition()));
            if (this.char() === 125)
              return (this.bump(), this.error(N.EMPTY_ARGUMENT, I(n, this.clonePosition())));
            var r = this.parseIdentifierIfPossible().value;
            if (!r) return this.error(N.MALFORMED_ARGUMENT, I(n, this.clonePosition()));
            ...
            switch (this.char()) {
              ...
              case 44:
                return (
                  ...
                  this.bumpSpace(),
                  this.isEOF()
                    ? this.error(N.EXPECT_ARGUMENT_CLOSING_BRACE, I(n, this.clonePosition()))
                    : this.parseArgumentOptions(e, t, r, n)
                );
              default:
                return this.error(N.MALFORMED_ARGUMENT, I(n, this.clonePosition()));
            }
          }),
          ...
          (e.prototype.parseArgumentOptions = function (e, t, n, r) {
            ...
            switch (a) {
              case ``:
                return this.error(N.EXPECT_ARGUMENT_TYPE, I(i, o));
              case `number`:
              case `date`:
              case `time`:
                this.bumpSpace();
                ...
                if (s && rn(s?.style, `::`, 0)) {
                  ...
                  if (a === `number`) {
                    ...
                    var m = p;
                    this.locale && (m = Rt(p, this.locale));
                    var u = {
                      type: mt.dateTime,
                      pattern: m,
                      location: s.styleLocation,
                      parsedOptions: this.shouldParseSkeletons ? vt(m) : {},
                    };
                    return {
                      val: {
              ...
              case `select`:
                ...
                if ((this.bumpSpace(), !this.bumpIf(`,`)))
                  return this.error(N.EXPECT_SELECT_ARGUMENT_OPTIONS, I(h, j({}, h)));
                this.bumpSpace();
                ...
                return a === `select`
                  ? {
                      val: { type: F.select, value: n, options: on(v.val), location: y },
                      err: null,
                    }
                  : {
                      val: {
              ...
              default:
                return this.error(N.INVALID_ARGUMENT_TYPE, I(i, o));
            }
          }),
          (e.prototype.tryParseArgumentClose = function (e) {
            return this.isEOF() || this.char() !== 125
              ? this.error(N.EXPECT_ARGUMENT_CLOSING_BRACE, I(e, this.clonePosition()))
          ...
          (e.prototype.parseNumberSkeletonFromString = function (e, t) {
            ...
            return {
              val: {
                ...
                tokens: n,
                location: t,
                parsedOptions: this.shouldParseSkeletons ? kt(n) : {},
              },
              err: null,
            };
          }),
          (e.prototype.tryParsePluralOrSelectOptions = function (e, t, n, r) {
            ...
            return o.length === 0
              ...
              : this.requiresOtherClause && !a
                ? this.error(N.MISSING_OTHER_CLAUSE, I(this.clonePosition(), this.clonePosition()))
                : { val: o, err: null };
          }),
          (e.prototype.tryParseDecimalInteger = function (e, t) {
            ...
            return i
              ? ((a *= n), tn(a) ? { val: a, err: null } : this.error(t, s))
              : this.error(e, s);
          }),
...
function hn(e) {
  e.forEach(function (e) {
    if ((delete e.location, lt(e) || ut(e)))
      for (var t in e.options) (delete e.options[t].location, hn(e.options[t].value));
    else
      (ot(e) && ft(e.style)) || ((st(e) || ct(e)) && pt(e.style))
  ...
  Cn = o(() => {
    (M(),
      ...
      (xn = (function (e) {
        ze(t, e);
        function t(t, n, r) {
          return e.call(this, `Value for "${t}" must be of type ${n}`, vn.INVALID_VALUE, r) || this;
        }
        return t;
      })(yn)),
      (Sn = (function (e) {
...
function wn(e) {
  return e.length < 2
    ...
    : e.reduce(function (e, t) {
        var n = e[e.length - 1];
        return (
          !n || n.type !== Dn.literal || t.type !== Dn.literal ? e.push(t) : (n.value += t.value), e
        );
      }, []);
}
function Tn(e) {
...
function En(e, t, n, r, i, a, o) {
  if (e.length === 1 && it(e[0])) return [{ type: Dn.literal, value: e[0].value }];
  for (var s = [], c = 0, l = e; c < l.length; c++) {
    var u = l[c];
    if (it(u)) {
      s.push({ type: Dn.literal, value: u.value });
      continue;
    }
    if (P(u)) {
      typeof a == `number` && s.push({ type: Dn.literal, value: n.getNumberFormat(t).format(a) });
      continue;
    }
    var d = u.value;
    if (!(i && d in i)) throw new Sn(d, o);
    var f = i[d];
    if (at(u)) {
      ((!f || typeof f == `string` || typeof f == `number`) &&
        (f = typeof f == `string` || typeof f == `number` ? String(f) : ``),
        s.push({ type: typeof f == `string` ? Dn.literal : Dn.object, value: f }));
      continue;
    }
    if (st(u)) {
      var p =
        typeof u.style == `string` ? r.date[u.style] : pt(u.style) ? u.style.parsedOptions : void 0;
      s.push({ type: Dn.literal, value: n.getDateTimeFormat(t, p).format(f) });
      continue;
    }
    if (ct(u)) {
      var p =
    ...
    if (ot(u)) {
      ...
      (p && p.scale && (f *= p.scale || 1),
        s.push({ type: Dn.literal, value: n.getNumberFormat(t, p).format(f) }));
      continue;
    }
    if (dt(u)) {
      var m = u.children,
        h = u.value,
        g = i[h];
      if (!Tn(g)) throw new xn(h, `function`, o);
      var _ = g(
        En(m, t, n, r, i, a).map(function (e) {
          return e.value;
        }),
      );
      (Array.isArray(_) || (_ = [_]),
        s.push.apply(
          s,
          _.map(function (e) {
            return { type: typeof e == `string` ? Dn.literal : Dn.object, value: e };
          }),
        ));
    }
    if (lt(u)) {
      var v = u.options[f] || u.options.other;
      if (!v) throw new bn(u.value, f, Object.keys(u.options), o);
      s.push.apply(s, En(v.value, t, n, r, i));
      continue;
    }
    if (ut(u)) {
      var v = u.options[`=${f}`];
...
`,
      ...
      if (!v) throw new bn(u.value, f, Object.keys(u.options), o);
      s.push.apply(s, En(v.value, t, n, r, i, f - (u.offset || 0)));
      continue;
    }
  }
  return wn(s);
  ...
  return (
    e === void 0 && (e = { number: {}, dateTime: {}, pluralRules: {} }),
    {
      getNumberFormat: We(
        ...
        { cache: jn(e.number), strategy: tt.variadic },
      ),
      getDateTimeFormat: We(
        ...
        { cache: jn(e.dateTime), strategy: tt.variadic },
      ),
      getPluralRules: We(
        function () {
          for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
        ...
        { cache: jn(e.pluralRules), strategy: tt.variadic },
      ),
    }
  );
}
          ...
          if (
            ...
            (this.format = function (e) {
              ...
              var n = t.reduce(function (e, t) {
                return (
                  !e.length || t.type !== Dn.literal || typeof e[e.length - 1] != `string`
                    ? e.push(t.value)
...
${o.stack}`
    : ``
      ...
      (Rn = (function (e) {
        ze(t, e);
        function t(t, n) {
          return e.call(this, In.UNSUPPORTED_FORMATTER, t, n) || this;
        }
        return t;
      })(Ln)),
      (zn = (function (e) {
        ze(t, e);
        function t(t, n) {
          return e.call(this, In.INVALID_CONFIG, t, n) || this;
        }
        return t;
      })(Ln)),
      (Bn = (function (e) {
        ze(t, e);
        function t(t, n) {
          return e.call(this, In.MISSING_DATA, t, n) || this;
        }
        return t;
      })(Ln)),
      (Vn = (function (e) {
...
function Yn(e) {
  ...
  return {
    ...
    getMessageFormat: We(
      ...
      { cache: Jn(e.message), strategy: tt.variadic },
    ),
    getRelativeTimeFormat: We(
      function () {
        for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        return new (t.bind.apply(t, Ve([void 0], e, !1)))();
      },
      { cache: Jn(e.relativeTime), strategy: tt.variadic },
    ),
    getPluralRules: o,
    getListFormat: We(
      function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return new (n.bind.apply(n, Ve([void 0], e, !1)))();
      },
      { cache: Jn(e.list), strategy: tt.variadic },
    ),
    getDisplayNames: We(
      function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return new (r.bind.apply(r, Ve([void 0], e, !1)))();
      },
      { cache: Jn(e.displayNames), strategy: tt.variadic },
    ),
  };
}
function Xn(e, t, n, r) {
...
function rr(e, t) {
  ...
  var n = Nn.formats;
  return j(j(j({}, n), e), {
    date: nr(tr(n.date, t), tr(e.date || {}, t)),
    time: nr(tr(n.time, t), tr(e.time || {}, t)),
  });
}
var ir,
  ar = o(() => {
...
to autofix this issue`,
        ...
        if (((r = j(j({}, p), r || {})), (o = rr(o, f)), (l = rr(l, f)), !_)) {
          if (u === !1 && _ === ``) return _;
          if (((!h || (a && a.toLowerCase() !== c.toLowerCase())) && d(new Un(n, a)), h))
            try {
...
function or(e, t, n, r) {
  ...
  r === void 0 && (r = {});
  var c = r.format,
    l = j(j({}, s && { timeZone: s }), c && Xn(a, t, c, o)),
    u = Kn(r, fr, l);
  return (
    t === `time` &&
      !u.hour &&
...
function sr(e, t) {
  ...
  try {
    return or(e, `date`, t, o).format(s);
  } catch (t) {
    e.onError(new Vn(`Error formatting date.`, e.locale, t));
  }
  return String(s);
}
function cr(e, t) {
  ...
  var i = n[0],
    ...
    s = typeof i == `string` ? new Date(i || 0) : i;
  try {
    return or(e, `time`, t, o).format(s);
  } catch (t) {
    e.onError(new Vn(`Error formatting time.`, e.locale, t));
  }
  return String(s);
}
function lr(e, t) {
  ...
  try {
    return or(e, `dateTimeRange`, t, s).formatRange(c, l);
  } catch (t) {
    e.onError(new Vn(`Error formatting date time range.`, e.locale, t));
  }
  return String(c);
}
function ur(e, t) {
  ...
  var i = n[0],
    ...
    s = typeof i == `string` ? new Date(i || 0) : i;
  try {
    return or(e, `date`, t, o).formatToParts(s);
  } catch (t) {
    e.onError(new Vn(`Error formatting date.`, e.locale, t));
  }
  return [];
...
function dr(e, t) {
  ...
  var i = n[0],
    ...
    s = typeof i == `string` ? new Date(i || 0) : i;
  try {
    return or(e, `time`, t, o).formatToParts(s);
  } catch (t) {
    e.onError(new Vn(`Error formatting time.`, e.locale, t));
  }
  return [];
...
`,
  ...
  try {
    ...
    a(new Vn(`Error formatting display name.`, i, e));
  }
}
var hr,
  gr = o(() => {
    (er(), Fn(), Wn(), (hr = [`style`, `type`, `fallback`, `languageDisplay`]));
  });
function _r(e) {
  return `${xr}_${e}_${xr}`;
}
function vr(e, t, n, r) {
  r === void 0 && (r = {});
  var i = yr(e, t, n, r).reduce(function (e, t) {
    var n = t.value;
    return (
...
`,
  ...
  try {
    ...
    a(new Vn(`Error formatting list.`, i, e));
  }
  return n;
}
var br,
  xr,
  Sr = o(() => {
    (M(), Fn(), Wn(), er(), (br = [`type`, `style`]), (xr = Date.now()));
  });
function Cr(e, t, n, r) {
  var i = e.locale,
    a = e.onError;
...
`,
  ...
  try {
    ...
    a(new Vn(`Error formatting plural.`, i, e));
  }
  return `other`;
}
var wr,
...
function Er(e, t, n) {
  ...
  n === void 0 && (n = {});
  var o = n.format,
    s = (!!o && Xn(i, `relative`, o, a)) || {};
  return t(r, Kn(n, Or, s));
}
...
`,
  ...
  try {
    return Er(e, t, i).format(n, r);
  } catch (t) {
    e.onError(new Vn(`Error formatting relative time.`, e.locale, t));
  }
  return String(n);
}
var Or,
  kr = o(() => {
    (er(), Fn(), Wn(), (Or = [`numeric`, `style`]));
  });
function Ar(e, t, n) {
  var r = e.locale,
    i = e.formats,
  ...
  var o = n.format,
    s = (o && Xn(i, `number`, o, a)) || {};
  return t(r, Kn(n, Nr, s));
}
function jr(e, t, n, r) {
  r === void 0 && (r = {});
  try {
    return Ar(e, t, r).format(n);
  } catch (t) {
    e.onError(new Vn(`Error formatting number.`, e.locale, t));
  }
  return String(n);
}
function Mr(e, t, n, r) {
  r === void 0 && (r = {});
  try {
    return Ar(e, t, r).formatToParts(n);
  } catch (t) {
    e.onError(new Vn(`Error formatting number.`, e.locale, t));
  }
  return [];
...
function Lr(e, t) {
  ...
  return (
    ...
    j(j({}, r), {
      formatters: n,
      formatNumber: jr.bind(null, r, n.getNumberFormat),
      formatNumberToParts: Mr.bind(null, r, n.getNumberFormat),
      formatRelativeTime: Dr.bind(null, r, n.getRelativeTimeFormat),
      ...
      formatDateTimeRange: lr.bind(null, r, n.getDateTimeFormat),
      formatTimeToParts: dr.bind(null, r, n.getDateTimeFormat),
      formatPlural: Cr.bind(null, r, n.getPluralRules),
      formatMessage: ir.bind(null, r, n),
      $t: ir.bind(null, r, n),
      formatList: vr.bind(null, r, n.getListFormat),
      formatListToParts: yr.bind(null, r, n.getListFormat),
      formatDisplayName: mr.bind(null, r, n.getDisplayNames),
    })
  );
}
var Rr = o(() => {
    (M(), pr(), gr(), Wn(), Sr(), ar(), Pr(), Tr(), kr(), er());
  }),
  zr = o(() => {
    (Ue(), er(), Wn(), ar(), Rr());
  });
...
var Wr,
  ...
  Jr = o(() => {
    (M(),
      (Wr = u(Me())),
      zr(),
      (Gr = j(j({}, $n), { textComponent: Wr.Fragment })),
      (Kr = function (e, t) {
        return Wr.isValidElement(e) ? Wr.cloneElement(e, { key: t }) : e;
      }),
      (qr = function (e) {
        return Wr.Children.map(e, Kr) ?? [];
      }));
  }),
  Yr = s((e) => {
      ...
      ($r =
        typeof window < `u` && !window.__REACT_INTL_BYPASS_GLOBAL_CONTEXT__
          ? window.__REACT_INTL_CONTEXT__ ||
            (window.__REACT_INTL_CONTEXT__ = Qr.createContext(null))
          : Qr.createContext(null)),
      $r.Consumer,
      (ei = $r.Provider),
      (ti = ei),
      (ni = $r));
...
function ci(e) {
  var t = function (t) {
    ...
    var s = n.textComponent || li.Fragment;
    return li.createElement(s, null, o);
  };
    ...
    (M(),
      ...
      (fi = function (e) {
        var t = ii(),
          n = e.value,
          r = e.children,
          i = Be(e, [`value`, `children`]);
        return r(t.formatNumberToParts(n, i));
      }),
      (fi.displayName = `FormattedNumberParts`),
      (fi.displayName = `FormattedNumberParts`));
  });
function mi(e) {
  return (
  ...
  _i = o(() => {
    (M(),
      ...
      (hi = function (e, t, n, r) {
        ...
        var o = mi(r),
          s = ir.apply(void 0, Ve([e, t, n, o], i, !1));
        return Array.isArray(s) ? qr(s) : s;
      }),
      (gi = function (e, t) {
        var n = e.defaultRichTextElements,
          r = Be(e, [`defaultRichTextElements`]),
          i = mi(n),
          a = Lr(j(j(j({}, Gr), r), { defaultRichTextElements: i }), t),
          o = {
            locale: a.locale,
            timeZone: a.timeZone,
        ...
        return j(j({}, a), {
          formatMessage: hi.bind(null, o, a.formatters),
          $t: hi.bind(null, o, a.formatters),
        });
      }));
  });
function vi(e, t) {
  var n = e.values,
    ...
    i = t.values,
    a = Be(t, [`values`]);
  return Ur(i, n) && Ur(r, a);
}
function yi(e) {
  var t = ii(),
    n = t.formatMessage,
    r = t.textComponent,
    i = r === void 0 ? bi.Fragment : r,
    a = e.id,
    o = e.description,
    s = e.defaultMessage,
    c = e.values,
  ...
  return typeof l == `function`
    ...
    : d
      ? bi.createElement(d, null, p)
      : bi.createElement(bi.Fragment, null, p);
}
var bi,
  xi,
  Si = o(() => {
    (M(),
      ...
      Jr(),
      oi(),
      (yi.displayName = `FormattedMessage`),
      (xi = bi.memo(yi, vi)),
      (xi.displayName = `MemoizedFormattedMessage`));
  });
function Ci(e) {
  return {
    locale: e.locale,
    ...
    (M(),
      ...
      (Ti = (function (e) {
        ...
        function t() {
          ...
          return (
            (t.cache = qn()),
            (t.state = { cache: t.cache, intl: gi(Ci(t.props), t.cache), prevConfig: Ci(t.props) }),
            t
          );
        }
        return (
          (t.getDerivedStateFromProps = function (e, t) {
            var n = t.prevConfig,
              r = t.cache,
              i = Ci(e);
            return Ur(n, i) ? null : { intl: gi(i, r), prevConfig: i };
          }),
          (t.prototype.render = function () {
            return (
              Vr(this.state.intl),
              wi.createElement(ti, { value: this.state.intl }, this.props.children)
            );
          }),
...
function Ai(e) {
  let t = e.toLowerCase();
  return t.endsWith(`.localhost`) || Mi.has(t);
}
function ji(e) {
  let t;
  try {
  ...
  return t.protocol !== `http:` && t.protocol !== `https:` ? !1 : Ai(t.hostname);
}
var Mi,
  Ni = o(() => {
    Mi = new Set([`localhost`, `127.0.0.1`, `0.0.0.0`, `[::1]`, `::1`]);
  });
function Pi(e) {
  return ji(e);
}
...
function Hi(e) {
  return e.getAttribute(`aria-label`) || Ui(e) || e.tagName.toLowerCase();
}
function Ui(e) {
  if (Ii(e)) return e.tagName.toLowerCase();
...
function Ki(e) {
  return L(e.ownerDocument.defaultView);
}
function qi(e) {
  let t = window,
    n = document;
...
function Yi(e) {
  ...
  for (; n && r < 4; ) {
    let e = n.tagName.toLowerCase(),
      i = n.tagName;
    if (n.id) return (t.unshift(`${e}#${ra(n.id)}`), t.join(` > `));
    let a = Array.from(n.classList)
      .filter((e) => /^[a-zA-Z0-9_-]+$/.test(e))
      .slice(0, 2);
    a.length > 0 && (e += `.${a.map(ra).join(`.`)}`);
    let o = n.parentElement;
    if (o != null) {
      let t = Array.from(o.children).filter((e) => Li(e) && e.tagName === i);
...
function Qi(e, t) {
  ...
  for (let i of e.scrollContainers ?? []) {
    ...
    Li(e) && ((n += e.scrollLeft - i.scrollLeft), (r += e.scrollTop - i.scrollTop));
  }
  return { x: n, y: r };
}
function $i(e) {
...
function na(e, t) {
  let n = t.getComputedStyle(e),
    r = e.scrollHeight > e.clientHeight && R(n.overflowY),
    i = e.scrollWidth > e.clientWidth && R(n.overflowX);
  return r || i;
}
function ra(e) {
...
function aa(e) {
  let t = (e ?? ``).replace(/\s+/g, ` `).trim();
  return t.length === 0 ? null : t.slice(0, pa);
}
function oa(e) {
  if (!ua(e)) return !1;
...
function da(e, t, n) {
  let r = e.createRange();
  try {
    return (r.selectNodeContents(t), Array.from(r.getClientRects()).some((e) => fa(e, n)));
  } finally {
    r.detach();
  }
}
...
var pa,
    ...
    ((pa = 2e3),
      ...
      (_a = class {
        ...
        getWindowSelectionText(e) {
          try {
            return aa(e.getSelection()?.toString()) ?? this.getActiveElementSelectionText(e);
          } catch {
            return null;
          }
        }
        getActiveElementSelectionText(e) {
          ...
          let n = t.selectionStart,
            r = t.selectionEnd;
          return n == null || r == null || r <= n ? null : aa(t.value.slice(n, r));
        }
        getVisibleTextInViewportRect(e, t) {
          ...
          let i = ``,
            a = n.createTreeWalker(r, ma, {
              acceptNode: (e) => {
                if (aa(e.textContent) == null) return ga;
                let t = e.parentElement;
                return !ua(t) || !ca(t) ? ga : ha;
              },
            }),
            o = a.nextNode();
          for (; o != null; ) {
            let e = aa(o.textContent);
            if (
              e != null &&
              da(n, o, t) &&
              ((i = i.length === 0 ? e : `${i} ${e}`), i.length >= pa)
            )
              break;
            o = a.nextNode();
          }
  ...
  xa = c({
    buildRegionAnchor: () => co,
    getBrowserCommentElementSnapshot: () => bo,
    getElementMetadataTooltipStyle: () => ns,
    getMarkerPoint: () => Ko,
    mountBrowserSidebarCommentRuntime: () => Sa,
  });
function Sa(e) {
  let t = La(),
  ...
  n.appendChild(r);
  let i = (0, Es.createRoot)(r);
  return (
    i.render((0, U.jsx)(Ca, { rootHost: t, bridge: e })),
    {
      dispose() {
        (i.unmount(), t.remove());
      },
...
function Ca({ rootHost: e, bridge: t }) {
  let [n, r] = (0, H.useState)(t.initialState),
    ...
    E = (0, H.useRef)(!1),
    ce = (0, H.useRef)(null),
    { comments: D, interactionMode: O } = n,
    k = Se(n.zoomPercent),
    A = Qo(n.viewportScale),
    ue = Pi(Ha()),
    de = n.canUseTweaks !== !1,
    fe = new Map(D.map((e, t) => [e.id, t + 1])),
    pe = D.filter(mo),
    me = Eo(e),
    he = pe.flatMap((e) => {
      let t = uo(e, me, e.id === g);
      return t == null ? [] : [t];
    }),
    ge = n.activeDesignChange,
    _e = D.flatMap((e) => (e.designChange == null ? [] : [e.designChange])),
    ve = de ? (ge == null ? _e : [..._e.filter((e) => e.id !== ge.id), ge]) : nc,
    ye = n.isOriginalViewEnabled === !0 ? nc : ve,
    be = f(D),
    xe = de && be && n.annotationEditorMode === `design`,
    Ce = ye.flatMap((e) => {
      let t = fo(e, me);
      return t == null ? [] : [t];
    }),
    we = he.some((e) => !e.anchor.isFixed),
    Te = pe.some((e) => e.anchor.kind === `element` && e.anchor.selector != null),
    Ee = (0, H.useCallback)(
      (e, n) => (
        c != null &&
          (t.sendMessageToHost({
    ...
    De = (0, H.useCallback)(
      (n) => {
        let r = Eo(e),
          i = D.find((e) => e.id === n.id) ?? n,
          a = lo(i, r) ?? null;
        (a != null && (r.set(i.id, a), i.designChange != null && zo(a, i.designChange.id)),
          c != null &&
            t.sendMessageToHost({
              type: `browser-sidebar-runtime-close-comment-preview`,
              commentId: c,
        ...
        (t.sendMessageToHost({
          ...
          w(Yo()),
          h({ target: { mode: `edit`, commentId: i.id }, anchor: Da(i, a) }),
          l(null));
      },
      [t, D, c, e, k],
    ),
    ...
    ke = (0, H.useCallback)(
      (r, i) => {
        ...
        let c = {
            ...i,
            cardViewportRect: is(e, o.rect, { viewportScale: n.viewportScale, zoomFactor: k }),
          },
          l = Co(r, c, void 0, o);
        return (
          zo(r, l.id),
    ...
    je = (0, H.useCallback)(
      (n) => {
        ...
        let r = te.current;
        if (((te.current = null), r != null && Date.now() - r.capturedAt <= Ys))
          return Ee(r.element, r.anchorState);
        let i = Wa(n.x, n.y, e);
        return i == null ? !1 : Ee(i, ja(i, n.x, n.y));
      },
      [m, t, Ee, e],
    ),
    Me = (0, H.useCallback)(
      (e) => {
        let t = 2,
          n = () => {
            je(e) || t === 0 || (--t, window.requestAnimationFrame(n));
          };
    ...
    Ne = (0, H.useCallback)(
      (n) => {
        ...
        let r = te.current;
        if (((te.current = null), r != null && Date.now() - r.capturedAt <= Ys))
          return ke(r.element, r.anchorState);
        let i = Wa(n.x, n.y, e);
        return i == null ? !1 : ke(i, ja(i, n.x, n.y));
      },
      [m, t, ke, e],
    ),
    Pe = (0, H.useCallback)(
      (e) => {
        let t = 2,
          n = () => {
            Ne(e) || t === 0 || (--t, window.requestAnimationFrame(n));
          };
        window.requestAnimationFrame(n);
      },
      [Ne],
    ...
    Fe = (0, H.useCallback)(() => {
      (oe.current != null && window.cancelAnimationFrame(oe.current),
        (oe.current = window.requestAnimationFrame(() => {
          ((oe.current = null), w(Yo()));
        })));
    }, []),
    Ie = (0, H.useEffectEvent)((e) => {
  ...
  ((0, H.useEffect)(() => {
      ...
      switch (t.type) {
        case `browser-sidebar-runtime-sync`:
          (t.interactionMode !== `comment` && (T.current = !1),
            r(
              (e) => (
                e.zoomPercent !== t.zoomPercent && Fe(),
                {
        ...
        case `browser-sidebar-runtime-design-scrub-changed`:
          ...
          return;
        case `browser-sidebar-runtime-create-comment-at-point`:
          je(t.viewportPoint) || Me(t.viewportPoint);
          return;
        case `browser-sidebar-runtime-open-design-editor-at-point`:
          if (!de) return;
          Ne(t.viewportPoint) || Pe(t.viewportPoint);
          return;
        case `browser-sidebar-runtime-restore-editor`:
          h(Ia(t, Eo(e)));
          return;
  ...
  }, [t, de, Ne, Fe, Me, Pe, e, je]),
    (0, H.useEffect)(() => {
      let t = Eo(e);
      (t.forEach((e, n) => {
        (!D.some((e) => e.id === n) || !e.isConnected) && t.delete(n);
      }),
        c != null && !pe.some((e) => e.id === c) && Ie(c),
        Le(pe));
    }, [D, c, e, pe]),
    (0, H.useEffect)(() => {
      O === `browse` && Re(c);
    ...
    (0, H.useEffect)(() => {
      let n = () => {
        ...
        r = (t, r) => {
          if (
            (s(r.altKey),
            !r.isTrusted || O !== `comment` || m != null || gs(r, e) || ne.current != null)
          ) {
            n();
            return;
          }
          if (
            (vs(r, { preventDefault: !1 }),
            ee.current ?? Va(t.document, zs),
            (ee.current = ta(t, { x: r.clientX, y: r.clientY })),
            E.current)
          ) {
            a(null);
            return;
          }
          let i = qa(ee.current, e);
          if (!i) {
            n();
            return;
          }
        ...
        i = (t, r, i) => {
          i.isTrusted && O === `comment` && m == null && !gs(i, e) && vs(i, { preventDefault: !1 });
          let a = i.relatedTarget;
          if (a instanceof Node && t.documentElement?.contains(a)) return;
          let o = ta(r, { x: i.clientX, y: i.clientY });
          (a != null && xs(o)) || n();
        },
        o = () => {
          (s(!1), n());
        ...
        c = ({ currentDragSelection: e, suppressFollowUpClick: r }) => {
          ...
          T.current = r;
          let a = e.rect,
            o = co(a, e.current, { framePath: e.framePath, frameUrl: e.frameUrl }),
            s = Na(o, k),
        ...
        l = (t, n) => {
          ...
          let r = ta(t, { x: n.clientX, y: n.clientY });
          if (
            ne.current != null &&
            c({ currentDragSelection: ws(ne.current, r), suppressFollowUpClick: !0 })
          ) {
            vs(n);
            return;
          }
        ...
        u = (t, n) => {
          ...
          (O === `comment` && vs(n),
            (te.current = { anchorState: ja(i, r.x, r.y), capturedAt: Date.now(), element: i }));
        },
        d = (e, t) => {
          ...
          vs(t);
          let i = ws(r, ta(e, { x: t.clientX, y: t.clientY }));
          ((ne.current = i), S(i), n());
        },
        f = (e, t) => {
          let n = ne.current;
          if (n == null || t.pointerId !== n.pointerId) return;
          let r = ws(n, ta(e, { x: t.clientX, y: t.clientY }));
          if (
            ((ne.current = null),
            S(null),
            t.isTrusted && (vs(t), !c({ currentDragSelection: r, suppressFollowUpClick: !0 })))
          ) {
            if (((T.current = !0), de && (xe || t.altKey))) {
              Ne(r.current);
              return;
            }
            je(r.current);
        ...
        g = (e) => {
          if (!(e.key !== `Escape` || !e.isTrusted)) {
            if (ne.current != null) {
              (vs(e), (T.current = !0), (ne.current = null), S(null), n());
              return;
            }
            m == null &&
              O === `comment` &&
              (vs(e), t.sendMessageToHost({ type: `browser-sidebar-runtime-exit-comment-mode` }));
          }
        },
        _ = (t) => {
          !t.isTrusted || O !== `comment` || m != null || gs(t, e) || vs(t);
        },
        v = (t, n) => {
          if (T.current && ((T.current = !1), O === `comment`)) {
            vs(n);
            return;
          }
          if (!n.isTrusted || gs(n, e) || O !== `comment`) return;
          if (m != null) {
            vs(n);
            return;
          }
          ...
          if ((vs(n), de && (xe || n.altKey))) {
            let t = Wa(r.x, r.y, e);
            t != null && ke(t, ja(t, r.x, r.y));
            return;
          }
          je(r);
        },
        y = (t, n) => {
          !n.isTrusted ||
            ...
            m != null ||
            gs(n, e) ||
            (Ya(ta(t, { x: n.clientX, y: n.clientY }), Xa(n, t), e) && vs(n));
        };
      return Ra((e, t) => {
        let n = (e) => {
            l(t, e);
        ...
        for (let t of Fs) e.addEventListener(t, _, !0);
        ...
        return (
          ...
          () => {
            ...
            for (let t of Fs) e.removeEventListener(t, _, !0);
    ...
    }, [m, t, de, O, xe, e, Ne, ke, ue, je, k]),
    (0, H.useEffect)(() => {
      if (O !== `comment` || m != null) return;
      let t = () => {
          let t = qa(ee.current, e);
          (a(t == null ? null : bo(t)), t != null && w(Yo()));
        },
        n = () => {
    ...
    (0, H.useEffect)(() => {
      ...
      let r = () => {
          ...
          let a,
            o = Eo(e);
          if (m == null) {
            let e = D.find((e) => e.id === c) ?? null;
            if (e == null) return;
            let t = lo(e, o) ?? null;
            (t != null && o.set(e.id, t), (a = Ma(e, t, k)));
          } else
            a =
              m.target.mode === `create` || m.target.mode === `design`
                ? Pa(m, k, n.viewportScale)
                : Fa(m, D, o, k);
          ...
          let l = D.find((e) => e.id === s.commentId) ?? null,
            u = l == null ? null : lo(l, o);
          h((e) =>
    ...
    }, [m, t, D, c, e, n.viewportScale, k]),
    (0, H.useEffect)(() => {
      let e = O === `comment` && m == null && de && o;
      se.current !== e &&
        ((se.current = e),
        t.sendMessageToHost({ type: `browser-sidebar-runtime-design-modifier-state`, pressed: e }));
    }, [m, t, de, O, o]),
    (0, H.useEffect)(() => jo(O === `comment` ? ye : nc), [O, ye]),
    (0, H.useLayoutEffect)(() => {
      if (m != null || pe.length === 0) return;
      let t = () => {
          (0, Ts.flushSync)(() => {
            w(Yo());
          });
        ...
        r = () => n();
      (window.addEventListener(`resize`, t), we && document.addEventListener(`scroll`, r, !0));
      let i = Te ? Wo(document, e, Fe) : null,
        a = Uo(window, D, r),
        o = Ra((r, i) => {
          if (i === window) return () => {};
          let a = () => n();
          (i.addEventListener(`resize`, t),
            ...
            we && r.addEventListener(`scroll`, a, !0));
          let o = Uo(i, D, a),
            s = Te ? Wo(r, e, Fe) : null;
          return () => {
            (i.removeEventListener(`resize`, t),
              i.removeEventListener(`scroll`, a),
              we && r.removeEventListener(`scroll`, a, !0),
              o(),
              s?.());
          };
        });
      return () => {
        (window.removeEventListener(`resize`, t),
          we && document.removeEventListener(`scroll`, r, !0),
          i?.(),
          a(),
          o());
      };
    }, [m, D, we, Te, Fe, e, pe.length]));
  let Be = O === `comment` && n.isOriginalViewEnabled !== !0,
    Ve = O === `comment` && m == null;
  (0, H.useLayoutEffect)(() => {
    let e = document.getElementById(Ds);
    if (e instanceof HTMLDivElement)
      return (
        (e.style.pointerEvents = Ve ? `auto` : `none`),
        () => {
          e.style.pointerEvents = `none`;
        }
      );
  }, [e, Ve]);
  let He = g == null ? null : (he.find((e) => e.id === g) ?? null),
    j = g == null ? null : (Ce.find((e) => e.id === g) ?? null),
    M =
      He == null
        ? j == null
          ? null
          : { kind: `design`, annotation: j }
        : { kind: `comment`, annotation: He },
    Ue = M?.annotation.id ?? null,
    We = M?.kind === `comment` ? [M.annotation] : he,
    Ge = M != null && g != null,
    Ke = m?.target.mode === `create` ? oo(m.anchor) : null,
    qe =
      m?.target.mode === `create` && m.anchor.type === `element` ? m.anchor.viewportSize : void 0,
    Je = Ke == null ? null : (he.find((e) => le(e.anchor, Ke)) ?? null),
    Ye = (
      Ge ? (M?.kind === `comment` ? he : []) : Je == null ? he : he.filter((e) => e.id !== Je.id)
    ).flatMap((e) => {
      let t = fe.get(e.id);
      if (t == null) return [];
      let n = Ko(e.anchor, ts(C, e.markerViewportSize));
      return qo(e.anchor, n)
        ? [
            {
              comment: e,
              commentNumber: t,
              markerPoint: os(e.anchor, C, { viewportSize: e.markerViewportSize, zoomFactor: k }),
            },
          ]
        : [];
    }),
    Xe = re(
      Ye.map(({ markerPoint: e }) => e),
      C.width * k,
    ),
    Ze = M?.kind === `comment` ? Ye.findIndex(({ comment: e }) => e.id === M.annotation.id) : -1,
    Qe = Ze === -1 ? void 0 : Xe[Ze],
    $e = Qe == null ? void 0 : { x: Qe.x / k, y: Qe.y / k },
    et =
      M?.annotation.anchor.kind === `element`
        ? M.kind === `comment`
          ? (lo(M.annotation, me) ?? null)
          : (V(M.annotation.anchor, M.annotation.id, me) ?? null)
        : null,
    tt = M?.kind === `comment` && M.annotation.anchor.kind === `element` && et == null,
    nt = c == null ? null : (he.find((e) => e.id === c) ?? null),
    N =
      Be || (Ge && M?.kind === `comment`)
        ? We.filter(
            (e) =>
              e.anchor.kind === `region` && !cs(e, m, M?.kind === `comment` ? M.annotation : null),
          )
        : [],
    rt = null,
    it = `hover-box`,
    at;
  if (Ge && M?.annotation.anchor.kind === `element`) {
    let e = et == null ? null : bo(et);
    ((rt = e?.rect ?? Go(M.annotation.anchor)),
      (at = e?.borderRadius),
      (it = ds(M.annotation.anchor, rt, C.width, C.height)));
  } else if (Ge && M?.kind === `comment` && M.annotation.anchor.kind === `region`)
    ((rt = Go(M.annotation.anchor)), (it = ls(M.annotation.anchor, rt, C.width, C.height)));
  else if (!Ge)
    if (((rt = x?.rect ?? null), rt != null)) it = ls(null, rt, C.width, C.height);
    else if (m?.anchor.type === `element`) {
      let e = m.anchor.element == null ? null : bo(m.anchor.element);
      ((rt = e?.rect ?? Go(m.anchor.value)),
        (at = e?.borderRadius),
        (it =
          m.target.mode === `design` ? `hover-box` : ds(m.anchor.value, rt, C.width, C.height)));
    } else
      m?.anchor.type === `region` && m.target.mode === `create`
        ? ((rt = Go(m.anchor.value)), (it = ls(m.anchor.value, rt, C.width, C.height)))
        : i != null &&
          ((rt = i.rect), (at = i.borderRadius), (it = ds(null, rt, C.width, C.height)));
  let ot = M == null ? null : rt,
    st = Ge ? [] : xo(v, m, ge, me),
    ct = ue && !Ge && m == null && x == null && nt == null ? i : null,
    lt =
      !Ge && Ke != null
        ? os(Ke, C, { includeElementFrameScroll: !0, viewportSize: qe, zoomFactor: k })
        : null,
    ut = lt == null ? null : Je == null ? p(D) + 1 : (fe.get(Je.id) ?? null),
    P = {
      ...rc,
      [Ns]: String(A),
      "--browser-sidebar-draft-marker-size": `${26 * A}px`,
      "--browser-sidebar-marker-label-font-size": `${10 * A}px`,
      "--browser-sidebar-marker-label-offset": `${-0.5 * A}px`,
      "--browser-sidebar-metadata-column-gap": `${12 * A}px`,
      "--browser-sidebar-metadata-height": `${ks * A}px`,
      "--browser-sidebar-metadata-padding-x": `${10 * A}px`,
      "--browser-sidebar-metadata-padding-y": `${8 * A}px`,
      "--browser-sidebar-metadata-radius": `${12 * A}px`,
      "--browser-sidebar-metadata-row-gap": `${3 * A}px`,
      "--browser-sidebar-overlay-font-size": `${13 * A}px`,
      "--browser-sidebar-saved-marker-size": `${js * A}px`,
    };
  (k !== 1 &&
    ((P.height = `${k * 100}vh`),
    (P.transform = `scale(${1 / k})`),
    (P.transformOrigin = `top left`),
    (P.width = `${k * 100}vw`)),
    O === `comment` && m == null && ((P.cursor = zs), (P.pointerEvents = `auto`)));
  let dt = (0, H.useEffectEvent)((e) => {
    t.sendMessageToHost({
      type: `browser-sidebar-runtime-comment-screenshot-ready`,
      commentId: e,
      annotationViewportRect: ot,
  ...
  let ft = (0, U.jsxs)(U.Fragment, {
    children: [
      ...
      N.map((e) => {
        let t = Go(e.anchor);
        return t == null || !qo(e.anchor)
          ? null
          : (0, U.jsx)(
              `div`,
              { className: us(e.anchor, t, C.width, C.height), style: as(t, k) },
              e.id,
            );
      }),
      rt ? (0, U.jsx)(`div`, { className: it, style: as(rt, k, at) }) : null,
      st.map((e) =>
        (0, U.jsx)(
          `div`,
          {
            ...
            style: as(e.rect, k, e.borderRadius),
          },
          e.key,
        ),
      ),
      ct == null
        ? null
        : (0, U.jsx)(Aa, { snapshot: ct, viewportScale: n.viewportScale, zoomFactor: k }),
      Be || Ge
        ? (0, U.jsxs)(`div`, {
            ...
            children: [
              ...
              Ye.map(({ comment: e, commentNumber: n }, r) =>
                (0, U.jsx)(
                  Oa,
                  {
                    commentNumber: n,
  ...
  return (0, U.jsx)(wa, {
    ...
    children: (0, U.jsxs)(`div`, {
      ...
      style: P,
      children: [(0, U.jsx)(`style`, { children: ic }), Ve ? (0, U.jsx)(Ta, { children: ft }) : ft],
    }),
  });
}
function wa({ children: e, config: t }) {
  return (0, U.jsx)(Ti, {
...
function Da(e, t) {
  return e.anchor.kind === `region`
    ? { type: `region`, themeVariant: e.themeVariant ?? Zo(), value: e.anchor }
    : {
        type: `element`,
        element: t,
        themeVariant: e.themeVariant ?? Zo(),
        value: e.anchor,
        viewportSize: Xo(),
      };
}
...
function ka({ commentNumber: e, markerPoint: t, onFocusEditor: n }) {
  let r = ii().formatMessage({
...
function Aa({ snapshot: e, viewportScale: t, zoomFactor: n }) {
  return (0, U.jsxs)(`div`, {
    className: `element-metadata-tooltip`,
    style: ns(e.rect, { viewportScale: t, zoomFactor: n }),
    children: [
      (0, U.jsx)(`div`, {
...
function ja(e, t, n) {
  let r = Xo(),
    ...
    a = { x: t, y: n };
  return {
    anchor: so(e, i ?? { x: t, y: n, width: 0, height: 0 }, a, i == null ? !1 : Xi(e), r.width),
    themeVariant: Zo(),
    viewportRect: i,
    viewportPoint: a,
    viewportSize: r,
...
function Ma(e, t, n) {
  if (e.anchor.kind === `region`) return Na(e.anchor, n, e.themeVariant);
  let r = Xo(),
    i = t == null ? e.anchor : ao(t, e.anchor, r, e.markerViewportPoint),
    a = Jo(i, n);
  return {
    anchor: i,
    themeVariant: e.themeVariant ?? Zo(),
    viewportRect: t == null ? Go(e.anchor) : vo(t),
    viewportPoint: a,
    viewportSize: r,
  };
}
function Na(e, t, n) {
  ...
  return {
    ...
    themeVariant: n ?? Zo(),
    viewportRect: Go(e),
    viewportPoint: Jo(e, t),
    viewportSize: { width: r.width, height: r.height },
  };
}
function Pa(e, t, n) {
  if (e.anchor.type === `region`) return Na(e.anchor.value, t, e.anchor.themeVariant);
  let r = e.anchor.element == null || !e.anchor.element.isConnected ? null : vo(e.anchor.element),
    i = Xo(),
    a =
      e.anchor.element == null || !e.anchor.element.isConnected
        ? e.anchor.value
        : ao(e.anchor.element, e.anchor.value, i),
    o =
      e.target.mode === `design`
        ? (e.anchor.cardViewportRect ??
          (r == null ? void 0 : rs(r, { viewportScale: n, zoomFactor: t })))
        : void 0;
  return {
    anchor: a,
    ...(o == null ? {} : { cardViewportRect: o }),
    themeVariant: e.anchor.themeVariant ?? Zo(),
    viewportRect: r,
    viewportPoint: Jo(a, t),
    viewportSize: i,
  };
}
function Fa(e, t, n, r) {
  ...
  if (e.anchor.type === `region`)
    return Na(e.anchor.value, r, a.themeVariant ?? e.anchor.themeVariant);
  let o = lo(a, n) ?? null;
  o != null && n.set(a.id, o);
  let s = Xo(),
    c = o == null ? e.anchor.value : ao(o, e.anchor.value, s, a.markerViewportPoint);
  return {
    anchor: c,
    ...(a.themeVariant == null ? {} : { themeVariant: a.themeVariant }),
    viewportRect: o == null ? Go(c) : vo(o),
    viewportPoint: Jo(c, r),
    viewportSize: s,
  };
}
function Ia(e, t) {
  ...
  let r = V(n, e.target.mode === `edit` ? e.target.commentId : void 0, t) ?? null;
  return (
...
function Ra(e) {
  let t = new Map(),
    n = () => {
      ...
      for (let i of e) {
        ...
        if (e == null) continue;
        let a = t.get(i);
        a?.document !== e && (za(a?.cleanup), t.set(i, { cleanup: r(e, i, n), document: e }));
      }
      for (let [e, n] of t) i.has(e) || (za(n.cleanup), t.delete(e));
    },
    r = (t, n, r) => {
      let i = e(t, n, r),
        a = (e) => {
  ...
  return (
    n(),
    () => {
      for (let { cleanup: e } of t.values()) za(e);
      t.clear();
    }
  );
}
...
function Va(e, t = zs) {
  let n = e.querySelector(`style[${Vs}]`);
  if (n instanceof HTMLStyleElement) return ((n.textContent = Ws(t)), n);
  let r = e.createElement(`style`);
  return (
    r.setAttribute(Vs, `true`), (r.textContent = Ws(t)), (e.head ?? e.documentElement).append(r), r
  );
}
function Ha() {
...
function Ua(e, t) {
  ...
  return Ri(r) && r.src !== `` ? r.src : n;
}
function Wa(e, t, n) {
  let r = n == null ? eo(e, t) : Ja(e, t, n);
  return r == null ? null : Ka(r);
}
function Ga(e) {
  let t = e.composedPath().find((e) => e instanceof HTMLElement);
  return t instanceof HTMLElement ? Ka(t) : null;
}
function Ka(e) {
  if (ys(e)) return null;
  if (Ii(e)) return e;
  let t = no(e);
  return t == null || Ii(t) || ys(t) ? null : t;
}
function qa(e, t) {
  return e == null ? null : Wa(e.x, e.y, t);
}
function Ja(e, t, n) {
  let r = n.shadowRoot?.querySelector(`[data-browser-comment-root]`);
  if (!(r instanceof HTMLElement)) return eo(e, t);
  let i = n.shadowRoot?.querySelector(`[${Hs}]`),
    a = n.shadowRoot?.querySelector(`[${Us}]`),
...
function Xa(e, t) {
  return e.deltaMode === Ks
    ? { x: e.deltaX * Js, y: e.deltaY * Js }
    : e.deltaMode === qs
...
function Qa(e, t, n) {
  ...
  return (
    (R(r.overflowY) && $a(t.y, e.scrollTop, e.clientHeight, e.scrollHeight)) ||
    (R(r.overflowX) && $a(t.x, e.scrollLeft, e.clientWidth, e.scrollWidth))
  );
}
function $a(e, t, n, r) {
...
function ro(e, t) {
  ...
  return [`a`, `button`, `input`, `textarea`, `select`, `label`, `img`].includes(n) ||
    ...
    ? !0
    : Ui(e) != null && t.width >= 24 && t.height >= 16;
}
function io(e, t, n, r) {
  ...
  return { x: t.x + bs(a, 0, 1) * t.width, y: t.y + bs(o, 0, 1) * t.height };
}
function ao(e, t, n, r) {
  let i = vo(e);
  return i == null ? t : so(e, i, io(t, i, n, r), Xi(e), n?.width);
}
function oo(e) {
  return e.type === `region` || e.element == null || !e.element.isConnected
    ? e.value
    : ao(e.element, e.value, e.viewportSize);
}
function so(e, t, n, r, i = window.innerWidth) {
  let a = $i(e),
    o = Ki(e),
    s = o == null ? null : Yi(e),
    c = ea(a),
    l = Zi(a, { x: n.x - c.x, y: n.y - c.y }),
    u = Ha(),
    d = Wi(e),
    f = Ui(e),
    p = new _a(u).getElementDocumentContext({
  ...
  return {
    ...
    name: e.getAttribute(`aria-label`) ?? Ui(e),
    selector: s,
    framePath: o ?? [],
    nearbyText: d,
...
function co(e, t, { framePath: n = [], frameUrl: r = null } = {}) {
  let i = qi(n) ?? window,
    a = ea(i),
    ...
    c = Zi(i, o),
    l = Ha(),
    u = new _a(l).getRegionDocumentContext({
      documentTitle: document.title,
      fallbackWindow: window,
      frameWindow: i,
      viewportRect: s,
...
function uo(e, t, n = !1) {
  ...
  let r = $o(e),
    i = V(e.anchor, e.id, t);
  return i == null
    ? !n && e.anchor.selector != null && z(e.anchor.pageUrl, Ha())
      ? null
      : r == null
        ? e
    ...
    : (t.set(e.id, i),
      {
        ...
        anchor: ao(i, e.anchor, r, e.markerViewportPoint),
      });
}
function fo(e, t) {
  if (!po(e)) return null;
  let n = V(e.anchor, e.id, t);
  return n == null
    ? null
    : (t.set(e.id, n), { ...e, anchor: ao(n, e.anchor, e.viewportSize, e.markerViewportPoint) });
}
function po(e) {
  return z(e.anchor.pageUrl, window.location.href);
}
function mo(e) {
  return z(e.anchor.pageUrl, window.location.href);
}
...
function V(e, t, n) {
  ...
  if (t != null) {
    let e = n.get(t) ?? null;
    if (e) {
      if (e.isConnected) return vo(e) == null ? null : e;
      n.delete(t);
    }
  }
  if (e.selector == null || !z(e.pageUrl, Ha())) return null;
  try {
    let t = Ji(e.framePath);
    return t == null ? null : ho(t, e);
  } catch {
    return null;
  }
}
function ho(e, t) {
  ...
  let n = Array.from(e.querySelectorAll(t.selector)).filter(Li);
  if (n.length === 0) return null;
  let r = n.filter((e) => vo(e) != null);
  if (r.length === 0) return null;
  let i = r;
  if (t.name != null) {
    let e = i.filter((e) => _o(e) === t.name);
    e.length > 0 && (i = e);
  }
  if (t.nearbyText != null) {
    let e = i.filter((e) => Wi(e) === t.nearbyText);
    e.length > 0 && (i = e);
  }
...
function go(e, t) {
  ...
  (e.name != null && r === e.name && (n += 1e3),
    e.nearbyText != null && Wi(t) === e.nearbyText && (n += 500),
    e.title === Hi(t) && (n += 250),
    e.elementPath === Gi(t) && (n += 25));
  let i = vo(t),
    a = Go(e);
  return i == null || a == null ? n : n - Math.abs(i.x - a.x) - Math.abs(i.y - a.y);
}
function _o(e) {
  return e.getAttribute(`aria-label`) ?? Ui(e);
}
function vo(e) {
  if (!e.isConnected || !yo(e)) return null;
  let t = $i(e),
...
function So(e) {
  let t = $i(e).getComputedStyle(e);
  return m(t, t.display === `flex` || t.display === `inline-flex` ? [...ec, ...tc] : ec);
}
function Co(e, t, n, r) {
  let i = r ?? bo(e),
    a = n?.id ?? Do(),
    o = ko(e),
    s = To(i?.styles ?? [], n?.declarations ?? []),
    c =
      o == null
        ? n?.text
        : n?.text == null
...
function jo(e) {
  return Ra((t) => {
    let n = () => {
      (Mo(t, e), Po(t, e), No(t, e));
    };
    n();
    let r = new MutationObserver(n);
    return (
      r.observe(t.documentElement, Ps),
      () => {
        (r.disconnect(), Io(t), t.getElementById(Qs)?.remove());
        for (let e of t.querySelectorAll(`[${Xs}]`)) e.removeAttribute(Xs);
      }
    );
  });
}
function Mo(e, t) {
  ...
  for (let t of e.querySelectorAll(`[${Xs}]`)) Li(t) && (Bo(t, n.get(t)), n.delete(t));
  for (let [e, t] of n) Bo(e, t);
}
function No(e, t) {
  let n = Ho(t),
    r = e.getElementById(Qs);
  if (n.length === 0) {
    r?.remove();
    return;
  }
...
function Po(e, t) {
  ...
  for (let t of e.querySelectorAll(`[${Xs}], [${Zs}]`)) {
    if (!Li(t)) continue;
    let e = Fo(
      Vo(t)
        .map((e) => n.get(e))
    ...
    (t.hasAttribute(Zs) || t.setAttribute(Zs, e.previousValue), Ro(t, e.value));
  }
}
function Fo(e) {
...
function Io(e) {
  for (let t of e.querySelectorAll(`[${Zs}]`)) Li(t) && Lo(t);
}
function Lo(e) {
  let t = e.getAttribute(Zs);
  t != null && (Ro(e, t), e.removeAttribute(Zs));
}
function Ro(e, t) {
...
function zo(e, t) {
  let n = new Set(Vo(e));
  (n.add(t), e.setAttribute(Xs, Array.from(n).join(` `)));
}
function Bo(e, t) {
  let n = t == null ? `` : Array.from(t).join(` `);
  if (n.length === 0) {
    e.removeAttribute(Xs);
    return;
  }
  e.getAttribute(Xs) !== n && e.setAttribute(Xs, n);
}
function Vo(e) {
  return (e.getAttribute(Xs) ?? ``).split(/\s+/).filter((e) => e.length > 0);
}
function Ho(e) {
  return te(e, Xs);
}
function Uo(e, t, n) {
  let r = new Set();
  for (let n of t)
    if (mo(n) && n.anchor.scrollContainers != null && qi(n.anchor.framePath) === e)
...
function Wo(e, t, n) {
  ...
  return (
    r.observe(e.documentElement, Ps),
    () => {
      r.disconnect();
    }
  );
...
function Ko(e, t = Yo(), { includeElementFrameScroll: n = !1, markerPointInset: r = As } = {}) {
  let i = qi(e.framePath),
    a = Qi(e, i ?? window);
  if (e.kind === `region` && i != null && i !== window) {
    let n = ea(i);
    return {
      x: bs(n.x + (e.point.xPercent / 100) * i.innerWidth - a.x, r, t.width - r),
      y: n.y + e.point.y - (e.isFixed ? 0 : i.scrollY) - a.y,
    };
  }
  let o = n && e.kind === `element` && i != null && i !== window ? i.scrollY : 0;
  return {
    x: bs((e.point.xPercent / 100) * t.width - a.x, r, t.width - r),
    y: (e.isFixed ? e.point.y : e.point.y - t.scrollY - o) - a.y,
  };
}
function qo(e, t = Ko(e)) {
...
function Jo(e, t, n) {
  let r = ts(Yo(), n),
    i = As / t,
    a = Ko(e, r, { markerPointInset: i });
  return { x: a.x, y: bs(a.y, i, r.height - i) };
}
function Yo() {
...
function $o(e) {
  let t = es(e.anchor, e.markerViewportPoint);
...
function es(e, t) {
  ...
  return {
    height: Math.max(window.innerHeight, t.y + As),
    width: Math.max(window.innerWidth, n, t.x + As, e.rect.x + e.rect.width),
  };
}
function ts(e, t) {
...
function ns(
  ...
  let i = rs(e, { viewport: t, viewportScale: n, zoomFactor: r });
  return Qo(n) === 1
...
function is(e, t, { viewportScale: n, zoomFactor: r }) {
  let i = rs(t, { viewportScale: n, zoomFactor: r }),
...
function os(e, t, { includeElementFrameScroll: n = !1, viewportSize: r, zoomFactor: i }) {
  let a = Ko(e, ts(t, r), { includeElementFrameScroll: n, markerPointInset: As / i });
...
function fs(e, t, n, r) {
  return ps(e) && ms(t, n, r);
}
function ps(e) {
  return e == null ? new _a(Ha()).isGoogleDocsPage() : _a.isGoogleDocsAnchor(e);
}
function ms(e, t, n) {
  return e == null || t <= 0 || n <= 0 ? !1 : e.width >= t * Is && e.height >= n * Ls;
}
function hs(e, t) {
...
function _s(e) {
  return e.composedPath().some((e) => e instanceof HTMLElement && e.hasAttribute(Hs));
}
function vs(e, { preventDefault: t = !0 } = {}) {
  (t && e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation?.());
}
function ys(e) {
  if (e.id === Ds || e.closest(`#${Ds}`) != null) return !0;
  let t = e.getRootNode();
  return t instanceof ShadowRoot && t.host instanceof HTMLElement && t.host.id === Ds;
}
function bs(e, t, n) {
  return Math.min(Math.max(e, t), n);
}
function xs(e) {
  return k(e, { width: window.innerWidth, height: window.innerHeight });
}
function Ss(e, t) {
  return A(e, t, Os);
}
...
function ws(e, t) {
  let n = e.isDraggingRegion || Ss(e.start, t);
  return { ...e, current: t, rect: n ? Cs(e.start, t) : null, isDraggingRegion: n };
}
var H,
  Ts,
  Es,
  ...
  ac = o(() => {
    (be(),
      ...
      va(),
      (U = ba()),
      (Ds = `codex-browser-sidebar-comments-root`),
      (Os = 4),
      (ks = 72),
      (As = 29),
      (js = 25),
      (Ms = new WeakMap()),
      (Ns = `--browser-sidebar-overlay-size-scale`),
      (Ps = {
        attributeFilter: [
          `aria-hidden`,
          `aria-expanded`,
      ...
      (Is = 0.45),
      (Ls = 0.3),
      (Rs = `data:image/svg+xml,%3Csvg%20width%3D%2226%22%20height%3D%2225%22%20viewBox%3D%220%200%2026%2025%22%20fill%3D%22none%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M12.6504%200.824799C6.21496%200.824799%200.825466%205.77554%200.825195%2012.0885C0.825245%2014.2375%201.46183%2016.2421%202.55176%2017.943L2.02148%2020.235L1.99316%2020.3756C1.77603%2021.655%202.78945%2022.7791%204.02832%2022.7691L4.0791%2022.8209L4.53418%2022.7047L7.12305%2022.0426C8.77593%2022.8778%2010.6577%2023.3531%2012.6504%2023.3531C19.086%2023.3531%2024.4754%2018.4014%2024.4756%2012.0885C24.4753%205.77554%2019.0858%200.824799%2012.6504%200.824799Z%22%20fill%3D%22%230285FF%22%20stroke%3D%22white%22%20stroke-width%3D%221.65%22%2F%3E%3C%2Fsvg%3E`),
      (zs = `url("${Rs}") 13 12, crosshair`),
      (Bs = `url("${Rs}")`),
      (Vs = `data-browser-comment-cursor-style`),
      (Hs = `data-browser-comment-interaction-blocker`),
      (Us = `data-browser-comment-interaction-layer`),
      (Ws = (e) =>
        `html, body, body *, #${Ds}, #${Ds} * { cursor: ${e} !important; -webkit-user-select: none !important; user-select: none !important; }`),
      (Gs = 100),
      (Ks = 1),
      (qs = 2),
      (Js = 16),
      (Ys = 5e3),
      (Xs = `data-codex-browser-design-group`),
      (Zs = `data-codex-browser-design-original-text`),
      (Qs = `codex-browser-design-draft-style`),
      ($s = () => {}),
      (ec = [
        `color`,
        `background-color`,
      ...
      (tc = [`flex-direction`, `justify-content`, `align-items`, `gap`, `row-gap`, `column-gap`]),
      (nc = []),
      (rc = {
        position: `fixed`,
        inset: 0,
...
.marker{position:fixed;border:0;background:transparent ${Bs} center / contain no-repeat;transform:translate(-50%,-50%);pointer-events:auto;cursor:pointer;display:flex;align-items:center;justify-content:center;padding:0}
...
(document.readyState === `loading`
  ? window.addEventListener(`DOMContentLoaded`, fc, { once: !0 })
  : fc(),
  window.addEventListener(`mousedown`, mc, !0),
  window.addEventListener(`mouseup`, pc, !0),
  window.addEventListener(`auxclick`, mc, !0),
  window.addEventListener(`dragstart`, gc, !0),
  window.addEventListener(`dragend`, _c, !0));
function fc() {
  oc ??
    Ae(
      async () => {
...
function pc(e) {
  ...
  t == null ||
    !e.isTrusted ||
    (mc(e),
    d.ipcRenderer.invoke(Oe, { type: `browser-sidebar-runtime-mouse-navigation`, direction: t }));
}
function mc(e) {
  hc(e) != null && (e.preventDefault(), e.stopPropagation());
}
function hc(e) {
...
function gc(e) {
  ...
  n == null ||
    n.length === 0 ||
    ((uc = !0),
    d.ipcRenderer.invoke(Oe, { type: `browser-sidebar-runtime-image-drag-started`, sourceUrl: n }));
}
function _c(e) {
  !e.isTrusted ||
    !uc ||
    ((uc = !1), d.ipcRenderer.invoke(Oe, { type: `browser-sidebar-runtime-image-drag-ended` }));
}
function vc(e) {
...
function yc() {
  return {
    ...
    subscribeToHostMessages(e) {
      ...
      return (
        d.ipcRenderer.on(De, t),
        lc != null && (e(lc), (lc = null)),
        () => {
          ((cc = !1), d.ipcRenderer.removeListener(De, t));
        }
      );
    },
  };
}
d.ipcRenderer.on(De, (e, t) => {
  switch (t.type) {
    case `browser-sidebar-runtime-sync`:
      bc(t);
      return;
