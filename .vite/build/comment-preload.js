...
function ee(e, { viewport: t, viewportScale: n, zoomFactor: r = 1 }) {
  let i = w(n),
    ...
    c = 16 * i,
    l = fe * i,
    u = Math.min(de * i, o - c * 2),
    d = k(a.x, c, o - u - c),
    f = a.y - l - pe * i,
    p = a.y + a.height + pe * i;
  return { x: d, y: f >= c ? f : k(p, c, s - l - c), width: u, height: l };
}
function te(e, t = ge) {
  return e.flatMap((e) => re(e, t)).join(`
...
function T(e) {
  ...
  return r == null
    ? t
    : `#${D(r.red)}${D(r.green)}${D(r.blue)}${r.alpha == null ? `` : D(r.alpha)}`;
}
function ne(e, t) {
  ...
  for (let t of i.values()) {
    ...
    let i = t.reduce((t, n) => t + e[n].x, 0) / t.length - ((t.length - 1) * he) / 2,
      o = i + (t.length - 1) * he,
      s = i < n ? n - i : o > r ? r - o : 0;
    t.forEach((t, o) => {
      a[t] = { x: k(i + o * he + s, n, r), y: e[t].y };
    });
  }
  return a;
}
...
function oe(e) {
  ...
  return [o, s, c].some(Number.isNaN)
    ? null
    : { alpha: a == null ? null : E(a), blue: c, green: s, red: o };
}
function E(e) {
  return e.endsWith(`%`) ? (Number.parseFloat(e) / 100) * 255 : Number.parseFloat(e) * 255;
}
function D(e) {
  return Math.round(k(e, 0, 255))
    .toString(16)
    .padStart(2, `0`)
    .toUpperCase();
}
...
function ce(e, t) {
  return e.kind === t.kind
    ? e.pageUrl === t.pageUrl &&
        ...
        O(e.scrollContainers, t.scrollContainers) &&
        e.isFixed === t.isFixed &&
...
var ue,
  ...
  ye = o(() => {
    ((ue = 3),
      ...
      (me = 25),
      (he = me / 2),
      (ge = `data-codex-browser-design-group`),
      (_e = `
...
`),
      (ve = { defaultLocale: `en-US`, locale: `en-US`, messages: {} }));
  });
function be(e) {
  return Math.min(we, Math.max(Ce, e));
}
function xe(e) {
  return be(e) / 100;
}
var Se,
  ...
  we,
  Te = o(() => {
    ((Se = [25, 33, 50, 67, 75, 80, 90, 100, 110, 125, 150, 175, 200, 250, 300, 400, 500]),
      (Ce = Se[0]),
      (we = Se[Se.length - 1]));
  });
(ye(), Te());
var Ee = `codex_desktop:message-for-view`,
  De = `codex_desktop:browser-sidebar-runtime-message`;
function Oe(e, t) {
  switch (t.type) {
...
var ke = function (e, t, n) {
    ...
    function E(e, r, i, a, o) {
      ...
      if (S(e))
        ...
        for (e = u.call(e), u = 0; !(a = e.next()).done; )
          ((a = a.value), (s = l + ae(a, u++)), (c += E(a, r, i, s, o)));
      else if (s === `object`) {
      ...
      (e.unstable_scheduleCallback = function (r, i, a) {
        ...
        return (
          ...
          a > o
            ...
            : ((r.sortIndex = s), t(c, r), m || p || ((m = !0), S || ((S = !0), ne()))),
          r
        );
      }),
  ...
  Ie = s((e) => {
    ...
    function A(e) {
      0 > k || ((e.current = O[k]), (O[k] = null), k--);
    }
    function j(e, t) {
      (k++, (O[k] = e.current), (e.current = t));
    }
    var le = ce(null),
      ue = ce(null),
      de = ce(null),
    ...
    function ge(e) {
      (ue.current === e && (A(le), A(ue)), fe.current === e && (A(fe), (Qf._currentValue = se)));
    }
    var _e, ve;
    function ye(e) {
      if (_e === void 0)
...
` +
    ...
    var lt = Math.random().toString(36).slice(2),
      F = `__reactFiber$` + lt,
      ut = `__reactProps$` + lt,
      dt = `__reactContainer$` + lt,
      ft = `__reactEvents$` + lt,
      I = `__reactListeners$` + lt,
      pt = `__reactHandles$` + lt,
      mt = `__reactResources$` + lt,
      ht = `__reactMarker$` + lt;
    function gt(e) {
      (delete e[F], delete e[ut], delete e[ft], delete e[I], delete e[pt]);
    }
    function _t(e) {
      var t = e[F];
      if (t) return t;
        ...
        a: switch (((e = t.stateNode), t.type)) {
          case `input`:
            if (
              ...
              for (
                n = n.querySelectorAll(`input[name="` + L(`` + t) + `"][type="radio"]`), t = 0;
                t < n.length;
                t++
              ) {
                var r = n[t];
    ...
    var xn = {
      ...
      Mn = bn(f({}, xn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Nn = bn(
        f({}, xn, {
    ...
    function pi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) ui(e) && (s = 1);
        ...
        a: switch (e) {
          case te:
            return ((e = li(31, n, t, a)), (e.elementType = te), (e.lanes = o), e);
          case g:
          ...
          case _:
            ...
            break;
          case v:
            return ((e = li(12, n, t, a | 2)), (e.elementType = v), (e.lanes = o), e);
          case S:
            return ((e = li(13, n, t, a)), (e.elementType = S), (e.lanes = o), e);
          case C:
            return ((e = li(19, n, t, a)), (e.elementType = C), (e.lanes = o), e);
          default:
    ...
    function yi(e, t) {
      if (typeof e == `object` && e) {
        var n = vi.get(e);
        return n === void 0 ? ((t = { value: e, source: t, stack: Ce(t) }), vi.set(e, t), t) : n;
      }
    ...
    function La(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === g
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` && i && i.$$typeof === ee && Oa(i) === t.type))
      ...
      function f(e, t, n) {
        ...
        if (typeof t == `object` && t) {
          switch (t.$$typeof) {
            case m:
              return (
                (n = pi(t.type, t.key, t.props, null, e.mode, n)), Fa(n, t), (n.return = e), n
              );
            case h:
                ...
                for (var l = o.key; r !== null; ) {
                  if (r.key === l) {
                    if (((l = o.type), l === g)) {
                      ...
                      r.elementType === l ||
                      (typeof l == `object` && l && l.$$typeof === ee && Oa(l) === r.type)
                    ) {
    ...
    var Qa = ce(null),
      $a = ce(0);
    function eo(e, t) {
      ((e = Ul), j($a, e), j(Qa, t), (Ul = e | t.baseLanes));
    }
    function to() {
      (j($a, Ul), j(Qa, Qa.current));
    }
    function no() {
      ((Ul = $a.current), A(Qa), A($a));
    }
    var ro = ce(null),
      io = null;
    function ao(e) {
    ...
    function is(e, t, n) {
      ...
      return (
        n !== t.memoizedState &&
          ((B.flags |= 2048), ss(9, { destroy: void 0 }, as.bind(null, i, n), null)),
        [r, a, e]
      );
    }
    function as(e, t) {
    ...
    var zs = {
        ...
        useTransition: function () {
          var e = qo(!1);
          return ((e = Cs.bind(null, B, e.queue, !0, !1)), (jo().memoizedState = e), [!1, e]);
        },
      ...
      Bs = {
        ...
        useDebugValue: ys,
        useDeferredValue: function (e, t) {
          return H(Mo(), V.memoizedState, e, t);
        },
        useTransition: function () {
          var e = Ro(Lo)[0],
            t = Mo().memoizedState;
    ...
    var Vs = {
      ...
      useDeferredValue: function (e, t) {
        var n = Mo();
        return V === null ? Ss(n, e, t) : H(n, V.memoizedState, e, t);
      },
      useTransition: function () {
        var e = Bo(Lo)[0],
          t = Mo().memoizedState;
    ...
    function pc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((oo(t), a))
          ...
          if (((r = q), r !== null && ((s = it(r, n)), s !== 0 && s !== o.retryLane)))
    ...
    function Sc(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (((s = q), s !== null && ((r = it(s, n)), r !== 0 && r !== l.retryLane)))
    ...
    function Rc(e, t, n) {
      ...
      switch ((Mi(t), t.tag)) {
        ...
        case 27:
          if ((ge(t), (n = de.current), (a = t.type), e !== null && t.stateNode != null))
            ...
            ((e = le.current), Vi(t) ? zi(t, e) : ((e = ff(a, r, n)), (t.stateNode = e), Nc(t)));
          }
          return (W(t), null);
        case 5:
        ...
        case 4:
          return (me(), e === null && Sd(t.stateNode.containerInfo), W(t), null);
        case 10:
          return (Yi(t.type), W(t), null);
        case 19:
          if ((A(uo), (r = t.memoizedState), r === null)) return (W(t), null);
    ...
    function xu() {
      if (J !== null) {
        ...
        else ((e = J), (qi = Ki = null), Ao(e), (Ma = null), (Na = 0), (e = J));
    ...
    function Au(e, t) {
      ...
      var r = Tu(),
        a = Eu();
      q !== e || Y !== t ? ((nu = null), (tu = ke() + 500), Su(e, t)) : (Vl = Ze(e, t));
      a: do
        try {
          if (X !== 0 && J !== null) {
            t = J;
    ...
    function sd(e, t) {
      ...
      if (
        ...
        return (
          r !== null && r !== null && Ee(r), (e.callbackNode = null), (e.callbackPriority = 0)
        );
      if (!(n & 3) || Ze(e, n)) {
        ...
        return (
          (r = cd.bind(null, e)), (n = Te(n, r)), (e.callbackPriority = t), (e.callbackNode = n), t
        );
      }
      return (
        r !== null && r !== null && Ee(r), (e.callbackPriority = 2), (e.callbackNode = null), 2
      );
    }
    function cd(e, t) {
              ...
              listener: function () {
                if (r.defaultPrevented) {
                  if (nd !== 0) {
                    ...
                    U(n, { pending: !0, data: e, method: i.method, action: a }, null, e);
                  }
                } else
                  typeof a == `function` &&
                    (s.preventDefault(),
                    (e = o ? pd(i, o) : new FormData(i)),
                    U(n, { pending: !0, data: e, method: i.method, action: a }, a, e));
              },
              currentTarget: i,
            },
          ],
        ...
        if (!(t & 7)) {
          a: {
            if (
              ...
              c && n !== tn && (u = n.relatedTarget || n.fromElement) && (_t(u) || u[dt]))
            )
              break a;
            if (
              (l || c) &&
...
`,
    ...
    function wf(e, t, n) {
      ...
      if (r && e && t) {
        ...
        t === `image` && n && n.imageSrcSet
          ? ((i += `[imagesrcset="` + L(n.imageSrcSet) + `"]`),
            typeof n.imageSizes == `string` && (i += `[imagesizes="` + L(n.imageSizes) + `"]`))
          : (i += `[href="` + L(e) + `"]`);
        var a = i;
        switch (t) {
          case `style`:
    ...
    function Tf(e, t) {
      ...
      if (n && e) {
        var r = t && typeof t.as == `string` ? t.as : `script`,
          i = `link[rel="modulepreload"][as="` + L(r) + `"][href="` + L(e) + `"]`,
          a = i;
        switch (r) {
          case `audioworklet`:
          case `paintworklet`:
    ...
    function Vf(e, t, n) {
      ...
      for (r.set(e, null), n = n.getElementsByTagName(e), i = 0; i < n.length; i++) {
        var a = n[i];
        if (
          !(a[ht] || a[F] || (e === `link` && a.getAttribute(`rel`) === `stylesheet`)) &&
        ...
        t.unstable_scheduleCallback(t.unstable_NormalPriority, function () {
          ...
          for (var t = 0; t < e.length; t += 3) {
            ...
            a !== null &&
              (e.splice(t, 3),
              (t -= 3),
              U(a, { pending: !0, data: i, method: n.method, action: r }, r, i));
          }
        }));
    }
    function Np(e) {
...
function Ue(e, t) {
  var n = t && t.cache ? t.cache : $e,
    r = t && t.serializer ? t.serializer : Ze;
  return (t && t.strategy ? t.strategy : Je)(e, { cache: n, serializer: r });
}
function We(e) {
...
function Xe(e, t) {
  return qe(e, this, Ge, t.cache.create(), t.serializer);
}
var Ze,
  Qe,
  $e,
...
function Ot(e) {
  for (var t = {}, n = 0, r = e; n < r.length; n++) {
    ...
    switch (i.stem) {
      ...
      case `measure-unit`:
      case `unit`:
        ((t.style = `unit`), (t.unit = Ct(i.options[0])));
        continue;
      case `compact-short`:
      case `K`:
      ...
      case `integer-width`:
        ...
        i.options[0].replace(jt, function (e, n, r, i, a, o) {
    ...
    if (kt.test(i.stem)) {
      ...
      i.stem.replace(kt, function (e, n, r, i, a, o) {
        return (
          r === `*`
...
var Kt,
  ...
  fn = o(() => {
    (N(),
      ...
      (Kt = RegExp(`^${ht.source}*`)),
      (qt = RegExp(`${ht.source}*\$`)),
      (Jt = !!String.prototype.startsWith && `_a`.startsWith(`a`, 1)),
      (Yt = !!String.fromCodePoint),
      (Xt = !!Object.fromEntries),
      (Zt = !!String.prototype.codePointAt),
      (Qt = !!String.prototype.trimStart),
      ...
      (tn = !0));
    try {
      tn = Bt(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`).exec(`a`)?.[0] === `a`;
    } catch {
      tn = !1;
    }
    ((nn = Jt
      ...
      tn
        ? ((un = Bt(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`)),
          (ln = function (e, t) {
            return ((un.lastIndex = t), un.exec(e)[1] ?? ``);
          }))
        : (ln = function (e, t) {
            for (var n = []; ; ) {
              var r = on(e, t);
              if (r === void 0 || Wt(r) || Gt(r)) break;
        ...
        return (
          ...
          (e.prototype.parseMessage = function (e, t, n) {
            for (var r = []; !this.isEOF(); ) {
              ...
              if (i === 123) {
                ...
                (this.bump(), r.push({ type: I.pound, location: L(o, this.clonePosition()) }));
          ...
          (e.prototype.parseTag = function (e, t) {
            ...
            if ((this.bumpSpace(), this.bumpIf(`/>`)))
              return {
                val: { type: I.literal, value: `<${r}/>`, location: L(n, this.clonePosition()) },
                err: null,
              };
            if (this.bumpIf(`>`)) {
              ...
              if (this.bumpIf(`</`)) {
                if (this.isEOF() || !Vt(this.char()))
                  return this.error(P.INVALID_TAG, L(o, this.clonePosition()));
                ...
                return r === this.parseTagName()
                  ? (this.bumpSpace(),
                    this.bumpIf(`>`)
                      ...
                      : this.error(P.INVALID_TAG, L(o, this.clonePosition())))
                  : this.error(P.UNMATCHED_CLOSING_TAG, L(s, this.clonePosition()));
          ...
          (e.prototype.parseTagName = function () {
            var e = this.offset();
            for (this.bump(); !this.isEOF() && Ut(this.char()); ) this.bump();
          ...
          (e.prototype.parseLiteral = function (e, t) {
            ...
            return { val: { type: I.literal, value: r, location: s }, err: null };
          }),
          (e.prototype.tryParseLeftAngleBracket = function () {
            return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !Ht(this.peek() || 0))
              ? (this.bump(), `<`)
              : null;
          }),
          ...
          (e.prototype.parseArgument = function (e, t) {
            ...
            if ((this.bump(), this.bumpSpace(), this.isEOF()))
              return this.error(P.EXPECT_ARGUMENT_CLOSING_BRACE, L(n, this.clonePosition()));
            if (this.char() === 125)
              return (this.bump(), this.error(P.EMPTY_ARGUMENT, L(n, this.clonePosition())));
            ...
            switch (this.char()) {
              case 125:
                return (
                  this.bump(),
                  {
                    val: { type: I.argument, value: r, location: L(n, this.clonePosition()) },
                    err: null,
                  }
                );
              case 44:
                return (
                  ...
                  this.bumpSpace(),
                  this.isEOF()
                    ? this.error(P.EXPECT_ARGUMENT_CLOSING_BRACE, L(n, this.clonePosition()))
                    : this.parseArgumentOptions(e, t, r, n)
                );
              default:
                return this.error(P.MALFORMED_ARGUMENT, L(n, this.clonePosition()));
            }
          }),
          (e.prototype.parseIdentifierIfPossible = function () {
            var e = this.clonePosition(),
              ...
              n = ln(this.message, t),
              r = t + n.length;
            return (this.bumpTo(r), { value: n, location: L(e, this.clonePosition()) });
          }),
          (e.prototype.parseArgumentOptions = function (e, t, n, r) {
            ...
            switch (a) {
              case ``:
                return this.error(P.EXPECT_ARGUMENT_TYPE, L(i, o));
              case `number`:
              case `date`:
              case `time`:
                this.bumpSpace();
                ...
                if (s && nn(s?.style, `::`, 0)) {
                  var p = sn(s.style.slice(2));
                  if (a === `number`) {
                    var l = this.parseNumberSkeletonFromString(p, s.styleLocation);
                    return l.err
                      ? l
                      : { val: { type: I.number, value: n, location: f, style: l.val }, err: null };
                  } else {
                    if (p.length === 0) return this.error(P.EXPECT_DATE_TIME_SKELETON, f);
                    var m = p;
                    this.locale && (m = Lt(p, this.locale));
                    var u = {
                      type: pt.dateTime,
                      pattern: m,
                      location: s.styleLocation,
                      parsedOptions: this.shouldParseSkeletons ? _t(m) : {},
                    };
                    return {
                      val: {
              ...
              case `select`:
                ...
                if ((this.bumpSpace(), !this.bumpIf(`,`)))
                  return this.error(P.EXPECT_SELECT_ARGUMENT_OPTIONS, L(h, M({}, h)));
                this.bumpSpace();
                ...
                return a === `select`
                  ? {
                      val: { type: I.select, value: n, options: an(v.val), location: y },
                      err: null,
                    }
                  : {
                      val: {
              ...
              default:
                return this.error(P.INVALID_ARGUMENT_TYPE, L(i, o));
            }
          }),
          (e.prototype.tryParseArgumentClose = function (e) {
            return this.isEOF() || this.char() !== 125
              ? this.error(P.EXPECT_ARGUMENT_CLOSING_BRACE, L(e, this.clonePosition()))
          ...
          (e.prototype.parseNumberSkeletonFromString = function (e, t) {
            ...
            return {
              val: {
                ...
                tokens: n,
                location: t,
                parsedOptions: this.shouldParseSkeletons ? Ot(n) : {},
              },
              err: null,
            };
          }),
          (e.prototype.tryParsePluralOrSelectOptions = function (e, t, n, r) {
            for (var i, a = !1, o = [], s = new Set(), c = r.value, l = r.location; ; ) {
              ...
              if (m.err) return m;
              (o.push([c, { value: p.val, location: L(f, this.clonePosition()) }]),
                s.add(c),
                this.bumpSpace(),
            ...
            return o.length === 0
              ...
              : this.requiresOtherClause && !a
                ? this.error(P.MISSING_OTHER_CLAUSE, L(this.clonePosition(), this.clonePosition()))
                : { val: o, err: null };
          }),
          (e.prototype.tryParseDecimalInteger = function (e, t) {
            ...
            return i
              ? ((a *= n), en(a) ? { val: a, err: null } : this.error(t, s))
              : this.error(e, s);
          }),
...
function mn(e) {
  e.forEach(function (e) {
    if ((delete e.location, ct(e) || lt(e)))
      for (var t in e.options) (delete e.options[t].location, mn(e.options[t].value));
    else
      (at(e) && dt(e.style)) || ((ot(e) || st(e)) && ft(e.style))
  ...
  Sn = o(() => {
    (N(),
      ...
      (bn = (function (e) {
        Re(t, e);
        function t(t, n, r) {
          return e.call(this, `Value for "${t}" must be of type ${n}`, _n.INVALID_VALUE, r) || this;
        }
        return t;
      })(vn)),
      (xn = (function (e) {
...
function Cn(e) {
  return e.length < 2
    ...
    : e.reduce(function (e, t) {
        var n = e[e.length - 1];
        return (
          !n || n.type !== En.literal || t.type !== En.literal ? e.push(t) : (n.value += t.value), e
        );
      }, []);
}
function wn(e) {
...
function Tn(e, t, n, r, i, a, o) {
  if (e.length === 1 && rt(e[0])) return [{ type: En.literal, value: e[0].value }];
  for (var s = [], c = 0, l = e; c < l.length; c++) {
    var u = l[c];
    if (rt(u)) {
      s.push({ type: En.literal, value: u.value });
      continue;
    }
    if (F(u)) {
      typeof a == `number` && s.push({ type: En.literal, value: n.getNumberFormat(t).format(a) });
      continue;
    }
    var d = u.value;
    if (!(i && d in i)) throw new xn(d, o);
    var f = i[d];
    if (it(u)) {
      ((!f || typeof f == `string` || typeof f == `number`) &&
        (f = typeof f == `string` || typeof f == `number` ? String(f) : ``),
        s.push({ type: typeof f == `string` ? En.literal : En.object, value: f }));
      continue;
    }
    if (ot(u)) {
      var p =
        typeof u.style == `string` ? r.date[u.style] : ft(u.style) ? u.style.parsedOptions : void 0;
      s.push({ type: En.literal, value: n.getDateTimeFormat(t, p).format(f) });
      continue;
    }
    if (st(u)) {
      var p =
    ...
    if (at(u)) {
      ...
      (p && p.scale && (f *= p.scale || 1),
        s.push({ type: En.literal, value: n.getNumberFormat(t, p).format(f) }));
      continue;
    }
    if (ut(u)) {
      var m = u.children,
      ...
      (Array.isArray(_) || (_ = [_]),
        s.push.apply(
          s,
          _.map(function (e) {
            return { type: typeof e == `string` ? En.literal : En.object, value: e };
          }),
        ));
    }
    if (ct(u)) {
      ...
      s.push.apply(s, Tn(v.value, t, n, r, i));
      continue;
    }
    if (lt(u)) {
      var v = u.options[`=${f}`];
...
`,
      ...
      if (!v) throw new yn(u.value, f, Object.keys(u.options), o);
      s.push.apply(s, Tn(v.value, t, n, r, i, f - (u.offset || 0)));
      continue;
    }
  }
  return Cn(s);
    ...
    e === void 0 && (e = { number: {}, dateTime: {}, pluralRules: {} }),
    {
      getNumberFormat: Ue(
        function () {
          ...
          return new ((e = Intl.NumberFormat).bind.apply(e, Be([void 0], t, !1)))();
        },
        { cache: An(e.number), strategy: et.variadic },
      ),
      getDateTimeFormat: Ue(
        function () {
          for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
          return new ((e = Intl.DateTimeFormat).bind.apply(e, Be([void 0], t, !1)))();
        },
        { cache: An(e.dateTime), strategy: et.variadic },
      ),
      getPluralRules: Ue(
        function () {
          for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
          return new ((e = Intl.PluralRules).bind.apply(e, Be([void 0], t, !1)))();
        },
        { cache: An(e.pluralRules), strategy: et.variadic },
      ),
    }
  );
}
    ...
    (N(),
      ...
      (Mn = (function () {
        function e(t, n, r, i) {
          ...
          if (
            ...
            (this.format = function (e) {
              ...
              var n = t.reduce(function (e, t) {
                return (
                  !e.length || t.type !== En.literal || typeof e[e.length - 1] != `string`
                    ? e.push(t.value)
          ...
          ((this.formats = kn(e.formats, r)),
            (this.formatters = (i && i.formatters) || jn(this.formatterCache)));
        }
        return (
...
${o.stack}`
    : ``
      ...
      (Ln = (function (e) {
        Re(t, e);
        function t(t, n) {
          return e.call(this, Fn.UNSUPPORTED_FORMATTER, t, n) || this;
        }
        return t;
      })(In)),
      (Rn = (function (e) {
        Re(t, e);
        function t(t, n) {
          return e.call(this, Fn.INVALID_CONFIG, t, n) || this;
        }
        return t;
      })(In)),
      (zn = (function (e) {
        Re(t, e);
        function t(t, n) {
          return e.call(this, Fn.MISSING_DATA, t, n) || this;
        }
        return t;
      })(In)),
      (Bn = (function (e) {
...
function Jn(e) {
  ...
  var t = Intl.RelativeTimeFormat,
    ...
    i = Ue(
      ...
      { cache: qn(e.dateTime), strategy: et.variadic },
    ),
    a = Ue(
      function () {
        for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
      ...
      { cache: qn(e.number), strategy: et.variadic },
    ),
    o = Ue(
      function () {
        for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
      ...
      { cache: qn(e.pluralRules), strategy: et.variadic },
    );
  return {
    getDateTimeFormat: i,
    getNumberFormat: a,
    getMessageFormat: Ue(
      ...
      { cache: qn(e.message), strategy: et.variadic },
    ),
    getRelativeTimeFormat: Ue(
      function () {
        for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        return new (t.bind.apply(t, Be([void 0], e, !1)))();
      },
      { cache: qn(e.relativeTime), strategy: et.variadic },
    ),
    getPluralRules: o,
    getListFormat: Ue(
      function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return new (n.bind.apply(n, Be([void 0], e, !1)))();
      },
      { cache: qn(e.list), strategy: et.variadic },
    ),
    getDisplayNames: Ue(
      function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return new (r.bind.apply(r, Be([void 0], e, !1)))();
      },
      { cache: qn(e.displayNames), strategy: et.variadic },
    ),
  };
}
function Yn(e, t, n, r) {
...
function nr(e, t) {
  ...
  var n = Mn.formats;
  return M(M(M({}, n), e), {
    date: tr(er(n.date, t), er(e.date || {}, t)),
    time: tr(er(n.time, t), er(e.time || {}, t)),
  });
}
var rr,
  ir = o(() => {
...
to autofix this issue`,
        ...
        if (Array.isArray(_) && _.length === 1 && _[0].type === I.literal) return _[0].value;
        if (!r && _ && typeof _ == `string` && !p) return _.replace(/'\{(.*?)\}'/gi, `{$1}`);
        if (((r = M(M({}, p), r || {})), (o = nr(o, f)), (l = nr(l, f)), !_)) {
          if (u === !1 && _ === ``) return _;
          if (((!h || (a && a.toLowerCase() !== c.toLowerCase())) && d(new Hn(n, a)), h))
            try {
...
function ar(e, t, n, r) {
  ...
  r === void 0 && (r = {});
  var c = r.format,
    l = M(M({}, s && { timeZone: s }), c && Yn(a, t, c, o)),
    u = Gn(r, dr, l);
  return (
    t === `time` &&
      !u.hour &&
...
function or(e, t) {
  ...
  try {
    return ar(e, `date`, t, o).format(s);
  } catch (t) {
    e.onError(new Bn(`Error formatting date.`, e.locale, t));
  }
  return String(s);
}
function sr(e, t) {
  ...
  var i = n[0],
    ...
    s = typeof i == `string` ? new Date(i || 0) : i;
  try {
    return ar(e, `time`, t, o).format(s);
  } catch (t) {
    e.onError(new Bn(`Error formatting time.`, e.locale, t));
  }
  return String(s);
}
function cr(e, t) {
  ...
  try {
    return ar(e, `dateTimeRange`, t, s).formatRange(c, l);
  } catch (t) {
    e.onError(new Bn(`Error formatting date time range.`, e.locale, t));
  }
  return String(c);
}
function lr(e, t) {
  ...
  var i = n[0],
    ...
    s = typeof i == `string` ? new Date(i || 0) : i;
  try {
    return ar(e, `date`, t, o).formatToParts(s);
  } catch (t) {
    e.onError(new Bn(`Error formatting date.`, e.locale, t));
  }
  return [];
...
function ur(e, t) {
  ...
  var i = n[0],
    ...
    s = typeof i == `string` ? new Date(i || 0) : i;
  try {
    return ar(e, `time`, t, o).formatToParts(s);
  } catch (t) {
    e.onError(new Bn(`Error formatting time.`, e.locale, t));
  }
  return [];
...
`,
  ...
  try {
    ...
    a(new Bn(`Error formatting display name.`, i, e));
  }
}
var mr,
  hr = o(() => {
    ($n(), Pn(), Un(), (mr = [`style`, `type`, `fallback`, `languageDisplay`]));
  });
function gr(e) {
  return `${br}_${e}_${br}`;
}
function _r(e, t, n, r) {
  r === void 0 && (r = {});
  var i = vr(e, t, n, r).reduce(function (e, t) {
    var n = t.value;
    return (
...
`,
  ...
  try {
    ...
    return t(i, o)
      .formatToParts(c)
      .map(function (e) {
        return e.type === `literal` ? e : M(M({}, e), { value: s[e.value] || e.value });
      });
  } catch (e) {
    a(new Bn(`Error formatting list.`, i, e));
  }
  return n;
}
var yr,
  br,
  xr = o(() => {
    (N(), Pn(), Un(), $n(), (yr = [`type`, `style`]), (br = Date.now()));
  });
function Sr(e, t, n, r) {
  var i = e.locale,
    a = e.onError;
...
`,
  ...
  try {
    ...
    a(new Bn(`Error formatting plural.`, i, e));
  }
  return `other`;
}
var Cr,
...
function Tr(e, t, n) {
  ...
  n === void 0 && (n = {});
  var o = n.format,
    s = (!!o && Yn(i, `relative`, o, a)) || {};
  return t(r, Gn(n, Dr, s));
}
...
`,
  ...
  try {
    ...
    e.onError(new Bn(`Error formatting relative time.`, e.locale, t));
  }
  return String(n);
}
var Dr,
  Or = o(() => {
    ($n(), Pn(), Un(), (Dr = [`numeric`, `style`]));
  });
function kr(e, t, n) {
  var r = e.locale,
    i = e.formats,
  ...
  var o = n.format,
    s = (o && Yn(i, `number`, o, a)) || {};
  return t(r, Gn(n, Mr, s));
}
function Ar(e, t, n, r) {
  r === void 0 && (r = {});
  try {
    return kr(e, t, r).format(n);
  } catch (t) {
    e.onError(new Bn(`Error formatting number.`, e.locale, t));
  }
  return String(n);
}
function jr(e, t, n, r) {
  r === void 0 && (r = {});
  try {
    return kr(e, t, r).formatToParts(n);
  } catch (t) {
    e.onError(new Bn(`Error formatting number.`, e.locale, t));
  }
  return [];
...
function Ir(e, t) {
  ...
  return (
    ...
    M(M({}, r), {
      ...
      formatNumberToParts: jr.bind(null, r, n.getNumberFormat),
      formatRelativeTime: Er.bind(null, r, n.getRelativeTimeFormat),
      formatDate: or.bind(null, r, n.getDateTimeFormat),
      formatDateToParts: lr.bind(null, r, n.getDateTimeFormat),
      formatTime: sr.bind(null, r, n.getDateTimeFormat),
      formatDateTimeRange: cr.bind(null, r, n.getDateTimeFormat),
      formatTimeToParts: ur.bind(null, r, n.getDateTimeFormat),
      formatPlural: Sr.bind(null, r, n.getPluralRules),
      formatMessage: rr.bind(null, r, n),
      $t: rr.bind(null, r, n),
      formatList: _r.bind(null, r, n.getListFormat),
      formatListToParts: vr.bind(null, r, n.getListFormat),
      formatDisplayName: pr.bind(null, r, n.getDisplayNames),
    })
  );
}
var Lr = o(() => {
    (N(), fr(), hr(), Un(), xr(), ir(), Nr(), wr(), Or(), $n());
  }),
  Rr = o(() => {
    (He(), $n(), Un(), ir(), Lr());
  });
...
var Ur,
  ...
  qr = o(() => {
    (N(),
      (Ur = u(je())),
      Rr(),
      (Wr = M(M({}, Qn), { textComponent: Ur.Fragment })),
      (Gr = function (e, t) {
        return Ur.isValidElement(e) ? Ur.cloneElement(e, { key: t }) : e;
      }),
      (Kr = function (e) {
        return Ur.Children.map(e, Gr) ?? [];
      }));
  }),
  Jr = s((e) => {
      ...
      (Qr =
        typeof window < `u` && !window.__REACT_INTL_BYPASS_GLOBAL_CONTEXT__
          ? window.__REACT_INTL_CONTEXT__ ||
            (window.__REACT_INTL_CONTEXT__ = Zr.createContext(null))
          : Zr.createContext(null)),
      Qr.Consumer,
      ($r = Qr.Provider),
      (ei = $r),
      (ti = Qr));
...
function si(e) {
  var t = function (t) {
    ...
    var s = n.textComponent || ci.Fragment;
    return ci.createElement(s, null, o);
  };
  return ((t.displayName = li[e]), t);
}
var ci,
  li,
  ui,
  ...
  gi = o(() => {
    (N(),
      ...
      (mi = function (e, t, n, r) {
        ...
        var o = pi(r),
          s = rr.apply(void 0, Be([e, t, n, o], i, !1));
        return Array.isArray(s) ? Kr(s) : s;
      }),
      (hi = function (e, t) {
        var n = e.defaultRichTextElements,
          r = ze(e, [`defaultRichTextElements`]),
          i = pi(n),
          a = Ir(M(M(M({}, Wr), r), { defaultRichTextElements: i }), t),
          o = {
            locale: a.locale,
            timeZone: a.timeZone,
        ...
        return M(M({}, a), {
          formatMessage: mi.bind(null, o, a.formatters),
          $t: mi.bind(null, o, a.formatters),
        });
      }));
  });
function _i(e, t) {
  var n = e.values,
    ...
    i = t.values,
    a = ze(t, [`values`]);
  return Hr(i, n) && Hr(r, a);
}
function vi(e) {
  var t = ri(),
    n = t.formatMessage,
    r = t.textComponent,
    i = r === void 0 ? yi.Fragment : r,
    a = e.id,
    o = e.description,
    s = e.defaultMessage,
    c = e.values,
  ...
  return typeof l == `function`
    ...
    : d
      ? yi.createElement(d, null, p)
      : yi.createElement(yi.Fragment, null, p);
}
var yi,
  bi,
  xi = o(() => {
    (N(),
      ...
      qr(),
      ai(),
      (vi.displayName = `FormattedMessage`),
      (bi = yi.memo(vi, _i)),
      (bi.displayName = `MemoizedFormattedMessage`));
  });
function Si(e) {
  return {
    locale: e.locale,
...
var Ci,
    ...
    (N(),
      ...
      (wi = (function (e) {
        ...
        function t() {
          ...
          return (
            (t.cache = Kn()),
            (t.state = { cache: t.cache, intl: hi(Si(t.props), t.cache), prevConfig: Si(t.props) }),
            t
          );
        }
        return (
          (t.getDerivedStateFromProps = function (e, t) {
            var n = t.prevConfig,
              r = t.cache,
              i = Si(e);
            return Hr(n, i) ? null : { intl: hi(i, r), prevConfig: i };
          }),
          (t.prototype.render = function () {
            return (
              Br(this.state.intl),
              Ci.createElement(ei, { value: this.state.intl }, this.props.children)
            );
          }),
  ...
  Ei = o(() => {
    (fi(),
      ...
      si(`formatNumber`),
      si(`formatList`),
      si(`formatDisplayName`),
      oi(`formatDate`),
      oi(`formatTime`));
  });
function Di(e) {
  let t = e.toLowerCase();
  return t.endsWith(`.localhost`) || ki.has(t);
}
function Oi(e) {
  let t;
  try {
  ...
  return t.protocol !== `http:` && t.protocol !== `https:` ? !1 : Di(t.hostname);
}
var ki,
  Ai = o(() => {
    ki = new Set([`localhost`, `127.0.0.1`, `0.0.0.0`, `[::1]`, `::1`]);
  });
function ji(e) {
  return Oi(e);
}
...
function zi(e) {
  return e.getAttribute(`aria-label`) || Bi(e) || e.tagName.toLowerCase();
}
function Bi(e) {
  if (R(e)) return e.tagName.toLowerCase();
...
function Ui(e) {
  return Ni(e.ownerDocument.defaultView);
}
function Wi(e) {
  let t = window,
    n = document;
...
function Ki(e) {
  ...
  for (; n && r < 4; ) {
    let e = n.tagName.toLowerCase(),
      i = n.tagName;
    if (n.id) return (t.unshift(`${e}#${ea(n.id)}`), t.join(` > `));
    let a = Array.from(n.classList)
      .filter((e) => /^[a-zA-Z0-9_-]+$/.test(e))
      .slice(0, 2);
    a.length > 0 && (e += `.${a.map(ea).join(`.`)}`);
    let o = n.parentElement;
    if (o != null) {
      let t = Array.from(o.children).filter((e) => z(e) && e.tagName === i);
...
function Yi(e, t) {
  ...
  for (let i of e.scrollContainers ?? []) {
    ...
    z(e) && ((n += e.scrollLeft - i.scrollLeft), (r += e.scrollTop - i.scrollTop));
  }
  return { x: n, y: r };
}
function Xi(e) {
...
function $i(e, t) {
  let n = t.getComputedStyle(e),
    r = e.scrollHeight > e.clientHeight && Pi(n.overflowY),
    i = e.scrollWidth > e.clientWidth && Pi(n.overflowX);
  return r || i;
}
function ea(e) {
...
function na(e) {
  let t = (e ?? ``).replace(/\s+/g, ` `).trim();
  return t.length === 0 ? null : t.slice(0, ua);
}
function ra(e) {
  if (!sa(e)) return !1;
...
function ca(e, t, n) {
  let r = e.createRange();
  try {
    return (r.selectNodeContents(t), Array.from(r.getClientRects()).some((e) => la(e, n)));
  } finally {
    r.detach();
  }
}
...
var ua,
    ...
    ((ua = 2e3),
      ...
      (ma = class {
        ...
        getWindowSelectionText(e) {
          try {
            return na(e.getSelection()?.toString()) ?? this.getActiveElementSelectionText(e);
          } catch {
            return null;
          }
        }
        getActiveElementSelectionText(e) {
          ...
          let n = t.selectionStart,
            r = t.selectionEnd;
          return n == null || r == null || r <= n ? null : na(t.value.slice(n, r));
        }
        getVisibleTextInViewportRect(e, t) {
          ...
          let i = ``,
            a = n.createTreeWalker(r, da, {
              acceptNode: (e) => {
                if (na(e.textContent) == null) return pa;
                let t = e.parentElement;
                return !sa(t) || !aa(t) ? pa : fa;
              },
            }),
            o = a.nextNode();
          for (; o != null; ) {
            let e = na(o.textContent);
            if (
              e != null &&
              ca(n, o, t) &&
              ((i = i.length === 0 ? e : `${i} ${e}`), i.length >= ua)
            )
              break;
            o = a.nextNode();
          }
  ...
  va = c({
    buildRegionAnchor: () => ao,
    getBrowserCommentElementSnapshot: () => vo,
    getElementMetadataTooltipStyle: () => es,
    getMarkerPoint: () => Wo,
    mountBrowserSidebarCommentRuntime: () => ya,
  });
function ya(e) {
  let t = Pa(),
  ...
  n.appendChild(r);
  let i = (0, ws.createRoot)(r);
  return (
    i.render((0, U.jsx)(ba, { rootHost: t, bridge: e })),
    {
      dispose() {
        (i.unmount(), t.remove());
      },
...
function ba({ rootHost: e, bridge: t }) {
  let [n, r] = (0, H.useState)(t.initialState),
    ...
    A = xe(n.zoomPercent),
    j = Xo(n.viewportScale),
    le = ji(za()),
    ue = n.canUseTweaks !== !1,
    de = new Map(O.map((e, t) => [e.id, t + 1])),
    fe = O.filter(uo),
    pe = wo(e),
    me = fe.flatMap((e) => {
      let t = so(e, pe, e.id === g);
      return t == null ? [] : [t];
    }),
    he = n.activeDesignChange,
    ge = O.flatMap((e) => (e.designChange == null ? [] : [e.designChange])),
    _e = ue ? (he == null ? ge : [...ge.filter((e) => e.id !== he.id), he]) : ec,
    ve = n.isOriginalViewEnabled === !0 ? ec : _e,
    ye = f(O),
    be = ue && ye && n.annotationEditorMode === `design`,
    Se = ve.flatMap((e) => {
      let t = co(e, pe);
      return t == null ? [] : [t];
    }),
    Ce = me.some((e) => !e.anchor.isFixed),
    we = fe.some((e) => e.anchor.kind === `element` && e.anchor.selector != null),
    Te = (0, H.useCallback)(
      (e, n) => (
        c != null &&
          (t.sendMessageToHost({
    ...
    Ee = (0, H.useCallback)(
      (n) => {
        let r = wo(e),
          ...
          a = oo(i, r) ?? null;
        (a != null && (r.set(i.id, a), i.designChange != null && Lo(a, i.designChange.id)),
          c != null &&
            t.sendMessageToHost({
              type: `browser-sidebar-runtime-close-comment-preview`,
              commentId: c,
        ...
        (t.sendMessageToHost({
          ...
          w(qo()),
          h({ target: { mode: `edit`, commentId: i.id }, anchor: wa(i, a) }),
          l(null));
      },
      [t, O, c, e, A],
    ),
    ...
    Oe = (0, H.useCallback)(
      (r, i) => {
        ...
        let c = {
            ...i,
            cardViewportRect: ns(e, o.rect, { viewportScale: n.viewportScale, zoomFactor: A }),
          },
          l = xo(r, c, void 0, o);
        return (
          Lo(r, l.id),
    ...
    Ae = (0, H.useCallback)(
      (n) => {
        ...
        let r = te.current;
        if (((te.current = null), r != null && Date.now() - r.capturedAt <= qs))
          return Te(r.element, r.anchorState);
        let i = Va(n.x, n.y, e);
        return i == null ? !1 : Te(i, Oa(i, n.x, n.y));
      },
      [m, t, Te, e],
    ),
    je = (0, H.useCallback)(
      (e) => {
        let t = 2,
          n = () => {
            Ae(e) || t === 0 || (--t, window.requestAnimationFrame(n));
          };
    ...
    Me = (0, H.useCallback)(
      (n) => {
        ...
        let r = te.current;
        if (((te.current = null), r != null && Date.now() - r.capturedAt <= qs))
          return Oe(r.element, r.anchorState);
        let i = Va(n.x, n.y, e);
        return i == null ? !1 : Oe(i, Oa(i, n.x, n.y));
      },
      [m, t, Oe, e],
    ),
    Ne = (0, H.useCallback)(
    ...
    Pe = (0, H.useCallback)(() => {
      (ae.current != null && window.cancelAnimationFrame(ae.current),
        (ae.current = window.requestAnimationFrame(() => {
          ((ae.current = null), w(qo()));
        })));
    }, []),
    Fe = (0, H.useEffectEvent)((e) => {
  ...
  ((0, H.useEffect)(() => {
    let n = t.subscribeToHostMessages((t) => {
      switch (t.type) {
        case `browser-sidebar-runtime-sync`:
          (t.interactionMode !== `comment` && (E.current = !1),
            r(
              (e) => (
                e.zoomPercent !== t.zoomPercent && Pe(),
                {
        ...
        case `browser-sidebar-runtime-design-scrub-changed`:
          ...
          return;
        case `browser-sidebar-runtime-create-comment-at-point`:
          Ae(t.viewportPoint) || je(t.viewportPoint);
          return;
        case `browser-sidebar-runtime-open-design-editor-at-point`:
          if (!ue) return;
    ...
    return () => {
      (ae.current != null && (window.cancelAnimationFrame(ae.current), (ae.current = null)), n());
    };
  }, [t, ue, Me, Pe, je, Ne, e, Ae]),
    (0, H.useEffect)(() => {
      let t = wo(e);
      (t.forEach((e, n) => {
        (!O.some((e) => e.id === n) || !e.isConnected) && t.delete(n);
      }),
        c != null && !fe.some((e) => e.id === c) && Fe(c),
        Ie(fe));
    }, [O, c, e, fe]),
    (0, H.useEffect)(() => {
      k === `browse` && Le(c);
    ...
    (0, H.useEffect)(() => {
      let n = () => {
        ...
        r = (t, r) => {
          if (
            (s(r.altKey),
            !r.isTrusted || k !== `comment` || m != null || ms(r, e) || T.current != null)
          ) {
            n();
            return;
          }
          if (
            (gs(r, { preventDefault: !1 }),
            ee.current ?? Ra(t.document, Ls),
            (ee.current = Qi(t, { x: r.clientX, y: r.clientY })),
            D.current)
          ) {
            a(null);
            return;
          }
          let i = Wa(ee.current, e);
          if (!i) {
            n();
            return;
          }
        ...
        i = (t, r, i) => {
          i.isTrusted && k === `comment` && m == null && !ms(i, e) && gs(i, { preventDefault: !1 });
          let a = i.relatedTarget;
          if (a instanceof Node && t.documentElement?.contains(a)) return;
          let o = Qi(r, { x: i.clientX, y: i.clientY });
          (a != null && ys(o)) || n();
        },
        o = () => {
          (s(!1), n());
        ...
        c = ({ currentDragSelection: e, suppressFollowUpClick: r }) => {
          ...
          E.current = r;
          let a = e.rect,
            o = ao(a, e.current, { framePath: e.framePath, frameUrl: e.frameUrl }),
            s = Aa(o, A),
        ...
        l = (t, n) => {
          ...
          let r = Qi(t, { x: n.clientX, y: n.clientY });
          if (
            T.current != null &&
            c({ currentDragSelection: Ss(T.current, r), suppressFollowUpClick: !0 })
          ) {
            gs(n);
            return;
          }
        ...
        u = (t, n) => {
          ...
          (k === `comment` && gs(n),
            (te.current = { anchorState: Oa(i, r.x, r.y), capturedAt: Date.now(), element: i }));
        },
        d = (e, t) => {
          ...
          gs(t);
          let i = Ss(r, Qi(e, { x: t.clientX, y: t.clientY }));
          ((T.current = i), S(i), n());
        },
        f = (e, t) => {
          let n = T.current;
          if (n == null || t.pointerId !== n.pointerId) return;
          let r = Ss(n, Qi(e, { x: t.clientX, y: t.clientY }));
          if (
            ((T.current = null),
            S(null),
            t.isTrusted && (gs(t), !c({ currentDragSelection: r, suppressFollowUpClick: !0 })))
          ) {
            if (((E.current = !0), ue && (be || t.altKey))) {
              Me(r.current);
              return;
            }
            Ae(r.current);
        ...
        p = (e) => {
          e.pointerId === T.current?.pointerId && ((T.current = null), S(null));
        },
        g = (e) => {
          if (!(e.key !== `Escape` || !e.isTrusted)) {
            if (T.current != null) {
              (gs(e), (E.current = !0), (T.current = null), S(null), n());
              return;
            }
            m == null &&
              k === `comment` &&
              (gs(e), t.sendMessageToHost({ type: `browser-sidebar-runtime-exit-comment-mode` }));
          }
        },
        _ = (t) => {
          !t.isTrusted || k !== `comment` || m != null || ms(t, e) || gs(t);
        },
        v = (t, n) => {
          if (E.current && ((E.current = !1), k === `comment`)) {
            gs(n);
            return;
          }
          if (!n.isTrusted || ms(n, e) || k !== `comment`) return;
          if (m != null) {
            gs(n);
            return;
          }
          ...
          if ((gs(n), ue && (be || n.altKey))) {
            let t = Va(r.x, r.y, e);
            t != null && Oe(t, Oa(t, r.x, r.y));
            return;
          }
          Ae(r);
        },
        y = (t, n) => {
          !n.isTrusted ||
            ...
            m != null ||
            ms(n, e) ||
            (Ka(Qi(t, { x: n.clientX, y: n.clientY }), qa(n, t), e) && gs(n));
        };
      return Fa((e, t) => {
        let n = (e) => {
            l(t, e);
        ...
        for (let t of Ns) e.addEventListener(t, _, !0);
        ...
        return (
          ...
          () => {
            ...
            for (let t of Ns) e.removeEventListener(t, _, !0);
    ...
    }, [m, t, ue, k, be, e, Me, Oe, le, Ae, A]),
    (0, H.useEffect)(() => {
      if (k !== `comment` || m != null) return;
      let t = () => {
          let t = Wa(ee.current, e);
          (a(t == null ? null : vo(t)), t != null && w(qo()));
        },
        n = () => {
    ...
    (0, H.useEffect)(() => {
      ...
      let r = () => {
          ...
          if (m == null) {
            ...
            if (e == null) return;
            let t = oo(e, o) ?? null;
            (t != null && o.set(e.id, t), (a = ka(e, t, A)));
          } else
            a =
              m.target.mode === `create` || m.target.mode === `design`
                ? ja(m, A, n.viewportScale)
                : Ma(m, O, o, A);
    ...
    (0, H.useEffect)(() => {
      let e = k === `comment` && m == null && ue && o;
      oe.current !== e &&
        ((oe.current = e),
        t.sendMessageToHost({ type: `browser-sidebar-runtime-design-modifier-state`, pressed: e }));
    }, [m, t, ue, k, o]),
    (0, H.useEffect)(() => ko(k === `comment` ? ve : ec), [k, ve]),
    (0, H.useLayoutEffect)(() => {
      if (m != null || fe.length === 0) return;
      let t = () => {
          (0, Cs.flushSync)(() => {
            w(qo());
          });
        ...
        r = () => n();
      (window.addEventListener(`resize`, t), Ce && document.addEventListener(`scroll`, r, !0));
      let i = we ? Ho(document, e, Pe) : null,
        a = Vo(window, O, r),
        o = Fa((r, i) => {
          if (i === window) return () => {};
          let a = () => n();
          (i.addEventListener(`resize`, t),
            ...
            Ce && r.addEventListener(`scroll`, a, !0));
          let o = Vo(i, O, a),
            s = we ? Ho(r, e, Pe) : null;
          return () => {
            (i.removeEventListener(`resize`, t),
              i.removeEventListener(`scroll`, a),
              Ce && r.removeEventListener(`scroll`, a, !0),
              o(),
              s?.());
          };
        });
      return () => {
        (window.removeEventListener(`resize`, t),
          Ce && document.removeEventListener(`scroll`, r, !0),
          i?.(),
          a(),
          o());
      };
    }, [m, O, Ce, we, Pe, e, fe.length]));
  let ze = k === `comment` && n.isOriginalViewEnabled !== !0,
    Be = k === `comment` && m == null;
  (0, H.useLayoutEffect)(() => {
    let e = document.getElementById(Ts);
    if (e instanceof HTMLDivElement)
      return (
        (e.style.pointerEvents = Be ? `auto` : `none`),
        () => {
          e.style.pointerEvents = `none`;
        }
      );
  }, [e, Be]);
  let Ve = g == null ? null : (me.find((e) => e.id === g) ?? null),
    M = g == null ? null : (Se.find((e) => e.id === g) ?? null),
    N =
      Ve == null
        ? M == null
          ? null
          : { kind: `design`, annotation: M }
        : { kind: `comment`, annotation: Ve },
    He = N?.annotation.id ?? null,
    Ue = N?.kind === `comment` ? [N.annotation] : me,
    We = N != null && g != null,
    Ge = m?.target.mode === `create` ? ro(m.anchor) : null,
    Ke =
      m?.target.mode === `create` && m.anchor.type === `element` ? m.anchor.viewportSize : void 0,
    qe = Ge == null ? null : (me.find((e) => ce(e.anchor, Ge)) ?? null),
    Je = (
      We ? (N?.kind === `comment` ? me : []) : qe == null ? me : me.filter((e) => e.id !== qe.id)
    ).flatMap((e) => {
      let t = de.get(e.id);
      if (t == null) return [];
      let n = Wo(e.anchor, $o(C, e.markerViewportSize));
      return Go(e.anchor, n)
        ? [
            {
              comment: e,
              commentNumber: t,
              markerPoint: is(e.anchor, C, { viewportSize: e.markerViewportSize, zoomFactor: A }),
            },
          ]
        : [];
    }),
    Ye = ne(
      Je.map(({ markerPoint: e }) => e),
      C.width * A,
    ),
    Xe = N?.kind === `comment` ? Je.findIndex(({ comment: e }) => e.id === N.annotation.id) : -1,
    Ze = Xe === -1 ? void 0 : Ye[Xe],
    Qe = Ze == null ? void 0 : { x: Ze.x / A, y: Ze.y / A },
    $e =
      N?.annotation.anchor.kind === `element`
        ? N.kind === `comment`
          ? (oo(N.annotation, pe) ?? null)
          : (B(N.annotation.anchor, N.annotation.id, pe) ?? null)
        : null,
    et = N?.kind === `comment` && N.annotation.anchor.kind === `element` && $e == null,
    tt = c == null ? null : (me.find((e) => e.id === c) ?? null),
    P =
      ze || (We && N?.kind === `comment`)
        ? Ue.filter(
            (e) =>
              e.anchor.kind === `region` && !os(e, m, N?.kind === `comment` ? N.annotation : null),
          )
        : [],
    nt = null,
    rt = `hover-box`,
    it;
  if (We && N?.annotation.anchor.kind === `element`) {
    let e = $e == null ? null : vo($e);
    ((nt = e?.rect ?? Uo(N.annotation.anchor)),
      (it = e?.borderRadius),
      (rt = ls(N.annotation.anchor, nt, C.width, C.height)));
  } else if (We && N?.kind === `comment` && N.annotation.anchor.kind === `region`)
    ((nt = Uo(N.annotation.anchor)), (rt = ss(N.annotation.anchor, nt, C.width, C.height)));
  else if (!We)
    if (((nt = x?.rect ?? null), nt != null)) rt = ss(null, nt, C.width, C.height);
    else if (m?.anchor.type === `element`) {
      let e = m.anchor.element == null ? null : vo(m.anchor.element);
      ((nt = e?.rect ?? Uo(m.anchor.value)),
        (it = e?.borderRadius),
        (rt =
          m.target.mode === `design` ? `hover-box` : ls(m.anchor.value, nt, C.width, C.height)));
    } else
      m?.anchor.type === `region` && m.target.mode === `create`
        ? ((nt = Uo(m.anchor.value)), (rt = ss(m.anchor.value, nt, C.width, C.height)))
        : i != null &&
          ((nt = i.rect), (it = i.borderRadius), (rt = ls(null, nt, C.width, C.height)));
  let at = N == null ? null : nt,
    ot = We ? [] : yo(v, m, he, pe),
    st = le && !We && m == null && x == null && tt == null ? i : null,
    ct =
      !We && Ge != null
        ? is(Ge, C, { includeElementFrameScroll: !0, viewportSize: Ke, zoomFactor: A })
        : null,
    lt = ct == null ? null : qe == null ? p(O) + 1 : (de.get(qe.id) ?? null),
    F = {
      ...tc,
      [js]: String(j),
      "--browser-sidebar-draft-marker-size": `${26 * j}px`,
      "--browser-sidebar-marker-label-font-size": `${10 * j}px`,
      "--browser-sidebar-marker-label-offset": `${-0.5 * j}px`,
      "--browser-sidebar-metadata-column-gap": `${12 * j}px`,
      "--browser-sidebar-metadata-height": `${Ds * j}px`,
      "--browser-sidebar-metadata-padding-x": `${10 * j}px`,
      "--browser-sidebar-metadata-padding-y": `${8 * j}px`,
      "--browser-sidebar-metadata-radius": `${12 * j}px`,
      "--browser-sidebar-metadata-row-gap": `${3 * j}px`,
      "--browser-sidebar-overlay-font-size": `${13 * j}px`,
      "--browser-sidebar-saved-marker-size": `${ks * j}px`,
    };
  (A !== 1 &&
    ((F.height = `${A * 100}vh`),
    (F.transform = `scale(${1 / A})`),
    (F.transformOrigin = `top left`),
    (F.width = `${A * 100}vw`)),
    k === `comment` && m == null && ((F.cursor = Ls), (F.pointerEvents = `auto`)));
  let ut = (0, H.useEffectEvent)((e) => {
    t.sendMessageToHost({
      type: `browser-sidebar-runtime-comment-screenshot-ready`,
      commentId: e,
      annotationViewportRect: at,
      ...(Qe == null ? {} : { markerViewportPoint: Qe }),
      ...(et ? { skipScreenshotCapture: !0 } : {}),
    });
  });
  (0, H.useEffect)(() => {
    if (He == null || g == null) {
  ...
  let dt = (0, U.jsxs)(U.Fragment, {
    children: [
      Be ? (0, U.jsx)(Ca, {}) : null,
      P.map((e) => {
        let t = Uo(e.anchor);
        return t == null || !Go(e.anchor)
          ? null
          : (0, U.jsx)(
              `div`,
              { className: cs(e.anchor, t, C.width, C.height), style: rs(t, A) },
              e.id,
            );
      }),
      nt ? (0, U.jsx)(`div`, { className: rt, style: rs(nt, A, it) }) : null,
      ot.map((e) =>
        (0, U.jsx)(
          `div`,
          {
            ...
            style: rs(e.rect, A, e.borderRadius),
          },
          e.key,
        ),
      ),
      st == null
        ? null
        : (0, U.jsx)(Da, { snapshot: st, viewportScale: n.viewportScale, zoomFactor: A }),
      ze || We
        ? (0, U.jsxs)(`div`, {
            ...
            children: [
              ...
              Je.map(({ comment: e, commentNumber: n }, r) =>
                (0, U.jsx)(
                  Ta,
                  {
                    commentNumber: n,
  ...
  return (0, U.jsx)(xa, {
    ...
    children: (0, U.jsxs)(`div`, {
      ...
      style: F,
      children: [(0, U.jsx)(`style`, { children: nc }), Be ? (0, U.jsx)(Sa, { children: dt }) : dt],
    }),
  });
}
function xa({ children: e, config: t }) {
  return (0, U.jsx)(wi, {
...
function wa(e, t) {
  return e.anchor.kind === `region`
    ? { type: `region`, themeVariant: e.themeVariant ?? Yo(), value: e.anchor }
    : {
        type: `element`,
        element: t,
        themeVariant: e.themeVariant ?? Yo(),
        value: e.anchor,
        viewportSize: Jo(),
      };
}
...
function Ea({ commentNumber: e, markerPoint: t, onFocusEditor: n }) {
  let r = ri().formatMessage({
...
function Da({ snapshot: e, viewportScale: t, zoomFactor: n }) {
  return (0, U.jsxs)(`div`, {
    className: `element-metadata-tooltip`,
    style: es(e.rect, { viewportScale: t, zoomFactor: n }),
    children: [
      (0, U.jsx)(`div`, {
...
function Oa(e, t, n) {
  let r = Jo(),
    ...
    a = { x: t, y: n };
  return {
    anchor: io(e, i ?? { x: t, y: n, width: 0, height: 0 }, a, i == null ? !1 : qi(e), r.width),
    themeVariant: Yo(),
    viewportRect: i,
    viewportPoint: a,
    viewportSize: r,
...
function ka(e, t, n) {
  if (e.anchor.kind === `region`) return Aa(e.anchor, n, e.themeVariant);
  let r = Jo(),
    i = t == null ? e.anchor : no(t, e.anchor, r, e.markerViewportPoint),
    a = Ko(i, n);
  return {
    anchor: i,
    themeVariant: e.themeVariant ?? Yo(),
    viewportRect: t == null ? Uo(e.anchor) : go(t),
    viewportPoint: a,
    viewportSize: r,
  };
}
function Aa(e, t, n) {
  ...
  return {
    ...
    themeVariant: n ?? Yo(),
    viewportRect: Uo(e),
    viewportPoint: Ko(e, t),
    viewportSize: { width: r.width, height: r.height },
  };
}
function ja(e, t, n) {
  if (e.anchor.type === `region`) return Aa(e.anchor.value, t, e.anchor.themeVariant);
  let r = e.anchor.element == null || !e.anchor.element.isConnected ? null : go(e.anchor.element),
    i = Jo(),
    a =
      e.anchor.element == null || !e.anchor.element.isConnected
        ? e.anchor.value
        : no(e.anchor.element, e.anchor.value, i),
    o =
      e.target.mode === `design`
        ? (e.anchor.cardViewportRect ??
          (r == null ? void 0 : ts(r, { viewportScale: n, zoomFactor: t })))
        : void 0;
  return {
    anchor: a,
    ...(o == null ? {} : { cardViewportRect: o }),
    themeVariant: e.anchor.themeVariant ?? Yo(),
    viewportRect: r,
    viewportPoint: Ko(a, t),
    viewportSize: i,
  };
}
function Ma(e, t, n, r) {
  ...
  if (e.anchor.type === `region`)
    return Aa(e.anchor.value, r, a.themeVariant ?? e.anchor.themeVariant);
  let o = oo(a, n) ?? null;
  o != null && n.set(a.id, o);
  let s = Jo(),
    c = o == null ? e.anchor.value : no(o, e.anchor.value, s, a.markerViewportPoint);
  return {
    anchor: c,
    ...(a.themeVariant == null ? {} : { themeVariant: a.themeVariant }),
    viewportRect: o == null ? Uo(c) : go(o),
    viewportPoint: Ko(c, r),
    viewportSize: s,
  };
}
function Na(e, t) {
  ...
  let r = B(n, e.target.mode === `edit` ? e.target.commentId : void 0, t) ?? null;
  return (
...
function Fa(e) {
  let t = new Map(),
    n = () => {
      ...
      for (let i of e) {
        ...
        if (e == null) continue;
        let a = t.get(i);
        a?.document !== e && (Ia(a?.cleanup), t.set(i, { cleanup: r(e, i, n), document: e }));
      }
      for (let [e, n] of t) i.has(e) || (Ia(n.cleanup), t.delete(e));
    },
    r = (t, n, r) => {
      let i = e(t, n, r),
        a = (e) => {
  ...
  return (
    n(),
    () => {
      for (let { cleanup: e } of t.values()) Ia(e);
      t.clear();
    }
  );
}
...
function Ra(e, t = Ls) {
  let n = e.querySelector(`style[${zs}]`);
  if (n instanceof HTMLStyleElement) return ((n.textContent = Hs(t)), n);
  let r = e.createElement(`style`);
  return (
    r.setAttribute(zs, `true`), (r.textContent = Hs(t)), (e.head ?? e.documentElement).append(r), r
  );
}
function za() {
...
function Ba(e, t) {
  ...
  return Fi(r) && r.src !== `` ? r.src : n;
}
function Va(e, t, n) {
  let r = n == null ? Za(e, t) : Ga(e, t, n);
  return r == null ? null : Ua(r);
}
function Ha(e) {
  let t = e.composedPath().find((e) => e instanceof HTMLElement);
  return t instanceof HTMLElement ? Ua(t) : null;
}
function Ua(e) {
  if (_s(e)) return null;
  if (R(e)) return e;
  let t = $a(e);
  return t == null || R(t) || _s(t) ? null : t;
}
function Wa(e, t) {
  return e == null ? null : Va(e.x, e.y, t);
}
function Ga(e, t, n) {
  let r = n.shadowRoot?.querySelector(`[data-browser-comment-root]`);
  if (!(r instanceof HTMLElement)) return Za(e, t);
  let i = n.shadowRoot?.querySelector(`[${Bs}]`),
    a = n.shadowRoot?.querySelector(`[${Vs}]`),
...
function qa(e, t) {
  return e.deltaMode === Ws
    ? { x: e.deltaX * Ks, y: e.deltaY * Ks }
    : e.deltaMode === Gs
...
function Ya(e, t, n) {
  ...
  return (
    (Pi(r.overflowY) && Xa(t.y, e.scrollTop, e.clientHeight, e.scrollHeight)) ||
    (Pi(r.overflowX) && Xa(t.x, e.scrollLeft, e.clientWidth, e.scrollWidth))
  );
}
function Xa(e, t, n, r) {
...
function eo(e, t) {
  ...
  return [`a`, `button`, `input`, `textarea`, `select`, `label`, `img`].includes(n) ||
    ...
    ? !0
    : Bi(e) != null && t.width >= 24 && t.height >= 16;
}
function to(e, t, n, r) {
  ...
  return { x: t.x + vs(a, 0, 1) * t.width, y: t.y + vs(o, 0, 1) * t.height };
}
function no(e, t, n, r) {
  let i = go(e);
  return i == null ? t : io(e, i, to(t, i, n, r), qi(e), n?.width);
}
function ro(e) {
  return e.type === `region` || e.element == null || !e.element.isConnected
    ? e.value
    : no(e.element, e.value, e.viewportSize);
}
function io(e, t, n, r, i = window.innerWidth) {
  let a = Xi(e),
    o = Ui(e),
    s = o == null ? null : Ki(e),
    c = Zi(a),
    l = Ji(a, { x: n.x - c.x, y: n.y - c.y }),
    u = za(),
    d = Vi(e),
    f = Bi(e),
    p = new ma(u).getElementDocumentContext({
  ...
  return {
    ...
    name: e.getAttribute(`aria-label`) ?? Bi(e),
    selector: s,
    framePath: o ?? [],
    nearbyText: d,
...
function ao(e, t, { framePath: n = [], frameUrl: r = null } = {}) {
  let i = Wi(n) ?? window,
    a = Zi(i),
    ...
    c = Ji(i, o),
    l = za(),
    u = new ma(l).getRegionDocumentContext({
      documentTitle: document.title,
      fallbackWindow: window,
      frameWindow: i,
      viewportRect: s,
...
function so(e, t, n = !1) {
  ...
  let r = Zo(e),
    i = B(e.anchor, e.id, t);
  return i == null
    ? !n && e.anchor.selector != null && fo(e.anchor.pageUrl, za())
      ? null
      : r == null
        ? e
    ...
    : (t.set(e.id, i),
      {
        ...
        anchor: no(i, e.anchor, r, e.markerViewportPoint),
      });
}
function co(e, t) {
  if (!lo(e)) return null;
  let n = B(e.anchor, e.id, t);
  return n == null
    ? null
    : (t.set(e.id, n), { ...e, anchor: no(n, e.anchor, e.viewportSize, e.markerViewportPoint) });
}
function lo(e) {
  return fo(e.anchor.pageUrl, window.location.href);
}
function uo(e) {
  return fo(e.anchor.pageUrl, window.location.href);
}
...
function B(e, t, n) {
  ...
  if (t != null) {
    let e = n.get(t) ?? null;
    if (e) {
      if (e.isConnected) return go(e) == null ? null : e;
      n.delete(t);
    }
  }
  if (e.selector == null || !fo(e.pageUrl, za())) return null;
  try {
    let t = Gi(e.framePath);
...
function V(e, t) {
  ...
  let r = n.filter((e) => go(e) != null);
  if (r.length === 0) return null;
  let i = r;
  if (t.name != null) {
    let e = i.filter((e) => ho(e) === t.name);
    e.length > 0 && (i = e);
  }
  if (t.nearbyText != null) {
    let e = i.filter((e) => Vi(e) === t.nearbyText);
    e.length > 0 && (i = e);
  }
...
function mo(e, t) {
  ...
  (e.name != null && r === e.name && (n += 1e3),
    e.nearbyText != null && Vi(t) === e.nearbyText && (n += 500),
    e.title === zi(t) && (n += 250),
    e.elementPath === Hi(t) && (n += 25));
  let i = go(t),
    a = Uo(e);
  return i == null || a == null ? n : n - Math.abs(i.x - a.x) - Math.abs(i.y - a.y);
}
function ho(e) {
  return e.getAttribute(`aria-label`) ?? Bi(e);
}
function go(e) {
  if (!e.isConnected || !_o(e)) return null;
  let t = Xi(e),
...
function bo(e) {
  let t = Xi(e).getComputedStyle(e);
  return m(t, t.display === `flex` || t.display === `inline-flex` ? [...Qs, ...$s] : Qs);
}
function xo(e, t, n, r) {
  let i = r ?? vo(e),
    a = n?.id ?? To(),
    o = Do(e),
    s = Co(i?.styles ?? [], n?.declarations ?? []),
    c =
      o == null
        ? n?.text
        : n?.text == null
...
function ko(e) {
  return Fa((t) => {
    let n = () => {
      (Ao(t, e), Mo(t, e), jo(t, e));
    };
    n();
    let r = new MutationObserver(n);
    return (
      r.observe(t.documentElement, Ms),
      () => {
        (r.disconnect(), Po(t), t.getElementById(Xs)?.remove());
        for (let e of t.querySelectorAll(`[${Js}]`)) e.removeAttribute(Js);
      }
    );
  });
}
function Ao(e, t) {
  ...
  for (let t of e.querySelectorAll(`[${Js}]`)) z(t) && (Ro(t, n.get(t)), n.delete(t));
  for (let [e, t] of n) Ro(e, t);
}
function jo(e, t) {
  let n = Bo(t),
    r = e.getElementById(Xs);
  if (n.length === 0) {
    r?.remove();
    return;
  }
...
function Mo(e, t) {
  ...
  for (let t of e.querySelectorAll(`[${Js}], [${Ys}]`)) {
    if (!z(t)) continue;
    let e = No(
      zo(t)
        .map((e) => n.get(e))
    ...
    (t.hasAttribute(Ys) || t.setAttribute(Ys, e.previousValue), Io(t, e.value));
  }
}
function No(e) {
...
function Po(e) {
  for (let t of e.querySelectorAll(`[${Ys}]`)) z(t) && Fo(t);
}
function Fo(e) {
  let t = e.getAttribute(Ys);
  t != null && (Io(e, t), e.removeAttribute(Ys));
}
function Io(e, t) {
...
function Lo(e, t) {
  let n = new Set(zo(e));
  (n.add(t), e.setAttribute(Js, Array.from(n).join(` `)));
}
function Ro(e, t) {
  ...
  e.getAttribute(Js) !== n && e.setAttribute(Js, n);
}
function zo(e) {
  return (e.getAttribute(Js) ?? ``).split(/\s+/).filter((e) => e.length > 0);
}
function Bo(e) {
  return te(e, Js);
}
function Vo(e, t, n) {
  let r = new Set();
  for (let n of t)
    if (uo(n) && n.anchor.scrollContainers != null && Wi(n.anchor.framePath) === e)
...
function Ho(e, t, n) {
  ...
  return (
    r.observe(e.documentElement, Ms),
    () => {
      r.disconnect();
    }
  );
...
function Wo(e, t = qo(), { includeElementFrameScroll: n = !1, markerPointInset: r = Os } = {}) {
  let i = Wi(e.framePath),
    a = Yi(e, i ?? window);
  if (e.kind === `region` && i != null && i !== window) {
    let n = Zi(i);
    return {
      x: vs(n.x + (e.point.xPercent / 100) * i.innerWidth - a.x, r, t.width - r),
      y: n.y + e.point.y - (e.isFixed ? 0 : i.scrollY) - a.y,
    };
  }
  let o = n && e.kind === `element` && i != null && i !== window ? i.scrollY : 0;
  return {
    x: vs((e.point.xPercent / 100) * t.width - a.x, r, t.width - r),
    y: (e.isFixed ? e.point.y : e.point.y - t.scrollY - o) - a.y,
  };
}
function Go(e, t = Wo(e)) {
...
function Ko(e, t, n) {
  let r = $o(qo(), n),
    i = Os / t,
    a = Wo(e, r, { markerPointInset: i });
  return { x: a.x, y: vs(a.y, i, r.height - i) };
}
function qo() {
...
function Zo(e) {
  let t = Qo(e.anchor, e.markerViewportPoint);
...
function Qo(e, t) {
  ...
  return {
    height: Math.max(window.innerHeight, t.y + Os),
    width: Math.max(window.innerWidth, n, t.x + Os, e.rect.x + e.rect.width),
  };
}
function $o(e, t) {
...
function es(
  ...
  let i = ts(e, { viewport: t, viewportScale: n, zoomFactor: r });
  return Xo(n) === 1
...
function ns(e, t, { viewportScale: n, zoomFactor: r }) {
  let i = ts(t, { viewportScale: n, zoomFactor: r }),
...
function is(e, t, { includeElementFrameScroll: n = !1, viewportSize: r, zoomFactor: i }) {
  let a = Wo(e, $o(t, r), { includeElementFrameScroll: n, markerPointInset: Os / i });
...
function us(e, t, n, r) {
  return ds(e) && fs(t, n, r);
}
function ds(e) {
  return e == null ? new ma(za()).isGoogleDocsPage() : ma.isGoogleDocsAnchor(e);
}
function fs(e, t, n) {
  return e == null || t <= 0 || n <= 0 ? !1 : e.width >= t * Ps && e.height >= n * Fs;
}
function ps(e, t) {
...
function hs(e) {
  return e.composedPath().some((e) => e instanceof HTMLElement && e.hasAttribute(Bs));
}
function gs(e, { preventDefault: t = !0 } = {}) {
  (t && e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation?.());
}
function _s(e) {
  if (e.id === Ts || e.closest(`#${Ts}`) != null) return !0;
  let t = e.getRootNode();
  return t instanceof ShadowRoot && t.host instanceof HTMLElement && t.host.id === Ts;
}
function vs(e, t, n) {
  return Math.min(Math.max(e, t), n);
}
function ys(e) {
  return A(e, { width: window.innerWidth, height: window.innerHeight });
}
function bs(e, t) {
  return j(e, t, Es);
}
...
function Ss(e, t) {
  let n = e.isDraggingRegion || bs(e.start, t);
  return { ...e, current: t, rect: n ? xs(e.start, t) : null, isDraggingRegion: n };
}
var H,
  Cs,
  ws,
  ...
  rc = o(() => {
    (ye(),
      ...
      ha(),
      (U = _a()),
      (Ts = `codex-browser-sidebar-comments-root`),
      (Es = 4),
      (Ds = 72),
      (Os = 29),
      (ks = 25),
      (As = new WeakMap()),
      (js = `--browser-sidebar-overlay-size-scale`),
      (Ms = {
        attributeFilter: [
          `aria-hidden`,
          `aria-expanded`,
      ...
      (Ps = 0.45),
      (Fs = 0.3),
      (Is = `data:image/svg+xml,%3Csvg%20width%3D%2226%22%20height%3D%2225%22%20viewBox%3D%220%200%2026%2025%22%20fill%3D%22none%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M12.6504%200.824799C6.21496%200.824799%200.825466%205.77554%200.825195%2012.0885C0.825245%2014.2375%201.46183%2016.2421%202.55176%2017.943L2.02148%2020.235L1.99316%2020.3756C1.77603%2021.655%202.78945%2022.7791%204.02832%2022.7691L4.0791%2022.8209L4.53418%2022.7047L7.12305%2022.0426C8.77593%2022.8778%2010.6577%2023.3531%2012.6504%2023.3531C19.086%2023.3531%2024.4754%2018.4014%2024.4756%2012.0885C24.4753%205.77554%2019.0858%200.824799%2012.6504%200.824799Z%22%20fill%3D%22%230285FF%22%20stroke%3D%22white%22%20stroke-width%3D%221.65%22%2F%3E%3C%2Fsvg%3E`),
      (Ls = `url("${Is}") 13 12, crosshair`),
      (Rs = `url("${Is}")`),
      (zs = `data-browser-comment-cursor-style`),
      (Bs = `data-browser-comment-interaction-blocker`),
      (Vs = `data-browser-comment-interaction-layer`),
      (Hs = (e) =>
        `html, body, body *, #${Ts}, #${Ts} * { cursor: ${e} !important; -webkit-user-select: none !important; user-select: none !important; }`),
      (Us = 100),
      (Ws = 1),
      (Gs = 2),
      (Ks = 16),
      (qs = 5e3),
      (Js = `data-codex-browser-design-group`),
      (Ys = `data-codex-browser-design-original-text`),
      (Xs = `codex-browser-design-draft-style`),
      (Zs = () => {}),
      (Qs = [
        `color`,
        `background-color`,
      ...
      ($s = [`flex-direction`, `justify-content`, `align-items`, `gap`, `row-gap`, `column-gap`]),
      (ec = []),
      (tc = {
        position: `fixed`,
        inset: 0,
...
.marker{position:fixed;border:0;background:transparent ${Rs} center / contain no-repeat;transform:translate(-50%,-50%);pointer-events:auto;cursor:pointer;display:flex;align-items:center;justify-content:center;padding:0}
...
(document.readyState === `loading`
  ? window.addEventListener(`DOMContentLoaded`, uc, { once: !0 })
  : uc(),
  window.addEventListener(`mousedown`, fc, !0),
  window.addEventListener(`mouseup`, dc, !0),
  window.addEventListener(`auxclick`, fc, !0),
  window.addEventListener(`dragstart`, mc, !0),
  window.addEventListener(`dragend`, hc, !0));
function uc() {
  ic ??
    ke(
      async () => {
...
function dc(e) {
  ...
  t == null ||
    !e.isTrusted ||
    (fc(e),
    d.ipcRenderer.invoke(De, { type: `browser-sidebar-runtime-mouse-navigation`, direction: t }));
}
function fc(e) {
  pc(e) != null && (e.preventDefault(), e.stopPropagation());
}
function pc(e) {
...
function mc(e) {
  ...
  n == null ||
    n.length === 0 ||
    ((cc = !0),
    d.ipcRenderer.invoke(De, { type: `browser-sidebar-runtime-image-drag-started`, sourceUrl: n }));
}
function hc(e) {
  !e.isTrusted ||
    !cc ||
    ((cc = !1), d.ipcRenderer.invoke(De, { type: `browser-sidebar-runtime-image-drag-ended` }));
}
function gc(e) {
...
function _c() {
  return {
    ...
    subscribeToHostMessages(e) {
      ...
      return (
        d.ipcRenderer.on(Ee, t),
        sc != null && (e(sc), (sc = null)),
        () => {
          ((oc = !1), d.ipcRenderer.removeListener(Ee, t));
        }
      );
    },
  };
}
d.ipcRenderer.on(Ee, (e, t) => {
  switch (t.type) {
    case `browser-sidebar-runtime-sync`:
      vc(t);
      return;
