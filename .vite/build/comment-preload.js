...
function h(e, t) {
  ...
  return e.map((e) => {
    ...
    return t == null ? e : { ...e, previousValue: t.previousValue, value: t.value };
  });
}
function g(e) {
  let t = Array.from(e.childNodes)
    .filter((e) => e.nodeType === fe)
    .map((e) => e.textContent?.replace(/\s+/g, ` `).trim() ?? ``)
    .join(` `)
    .replace(/\s+/g, ` `)
    .trim();
  return t.length === 0 ||
    Array.from(e.children).some((e) => (e.textContent?.replace(/\s+/g, ` `).trim().length ?? 0) > 0)
    ? null
    : t;
}
function _(e) {
...
function b(e) {
  ...
  let s = S(t);
  return { documentId: o, ...(s == null ? {} : { tabId: s }) };
}
function x({ documentTitle: e, pageUrl: t, selectedText: n, visibleText: r }) {
  let i = b(t);
  if (i == null) return;
  let a = C(e),
    o = C(n),
  ...
  return {
    ...
    ...(i.tabId == null ? {} : { tabId: i.tabId }),
    ...(a == null ? {} : { documentTitle: a }),
    ...(o == null ? {} : { selectedText: o }),
    ...(s == null ? {} : { visibleText: s }),
  };
}
function S(e) {
...
function ee(e, { viewport: t, viewportScale: n, zoomFactor: r = 1 }) {
  let i = w(n),
    a = ce(e, r),
    o = t.width * r,
    s = t.height * r,
    c = 16 * i,
    l = me * i,
    u = Math.min(pe * i, o - c * 2),
    d = D(a.x, c, o - u - c),
    f = a.y - l - he * i,
    p = a.y + a.height + he * i;
  return { x: d, y: f >= c ? f : D(p, c, s - l - c), width: u, height: l };
}
function te(e, t = ve) {
  return e.flatMap((e) => ie(e, t)).join(`
...
function ne(e) {
  ...
  return r == null
    ? t
    : `#${E(r.red)}${E(r.green)}${E(r.blue)}${r.alpha == null ? `` : E(r.alpha)}`;
}
function re(e, t) {
  ...
  for (let t of i.values()) {
    ...
    let i = t.reduce((t, n) => t + e[n].x, 0) / t.length - ((t.length - 1) * _e) / 2,
      o = i + (t.length - 1) * _e,
      s = i < n ? n - i : o > r ? r - o : 0;
    t.forEach((t, o) => {
      a[t] = { x: D(i + o * _e + s, n, r), y: e[t].y };
    });
  }
  return a;
}
function ie(e, t) {
  let n = e.declarations.filter((e) => e.value.trim() !== e.previousValue.trim());
  return n.length === 0
    ? []
    : [
        [
          `[${t}~="${ae(e.draftAttribute)}"] {`,
...
function se(e) {
  ...
  return [o, s, c].some(Number.isNaN)
    ? null
    : { alpha: a == null ? null : T(a), blue: c, green: s, red: o };
}
function T(e) {
  return e.endsWith(`%`) ? (Number.parseFloat(e) / 100) * 255 : Number.parseFloat(e) * 255;
}
function E(e) {
  return Math.round(D(e, 0, 255))
    .toString(16)
    .padStart(2, `0`)
    .toUpperCase();
}
...
function ue(e, t) {
  return e.kind === t.kind
    ? e.pageUrl === t.pageUrl &&
        ...
        le(e.scrollContainers, t.scrollContainers) &&
        e.isFixed === t.isFixed &&
...
var fe,
  ...
  xe = o(() => {
    ((fe = 3),
      ...
      (ge = 25),
      (_e = ge / 2),
      (ve = `data-codex-browser-design-group`),
      (ye = `
...
`),
      (be = { defaultLocale: `en-US`, locale: `en-US`, messages: {} }));
  });
function Se(e) {
  return Math.min(Ee, Math.max(Te, e));
}
function Ce(e) {
  return Se(e) / 100;
}
var we,
  ...
  Ee,
  De = o(() => {
    ((we = [25, 33, 50, 67, 75, 80, 90, 100, 110, 125, 150, 175, 200, 250, 300, 400, 500]),
      (Te = we[0]),
      (Ee = we[we.length - 1]));
  });
(xe(), De());
var Oe = `codex_desktop:message-for-view`,
  ke = `codex_desktop:browser-sidebar-runtime-message`,
  Ae = new Set([`Meta`, `Control`, `Alt`, `AltGraph`, `Shift`]),
  je = new Map([
    [`Escape`, `Esc`],
    [`ArrowUp`, `Up`],
    [`ArrowDown`, `Down`],
...
function Pe(e) {
  ...
  return { key: r, requireAlt: i, requireCtrl: a, requireMeta: o, requireShift: s };
}
function Fe(e) {
...
function Ie(e, t) {
  let n = Le(e);
  return n === t.key || (t.requireShift && n === (Me.get(t.key) ?? t.key));
}
function Le(e) {
  return Fe(Re(e) ?? ``);
}
function Re(e) {
  ...
  return t === ` `
    ...
    : t === `+`
      ? `Plus`
      : (je.get(t) ?? (/^f\d{1,2}$/i.test(t) || t.length === 1 ? t.toUpperCase() : (ze(n) ?? t)));
}
function ze(e) {
  return e == null
    ? null
...
var Ve = function (e, t, n) {
      ...
      (e.startTransition = function (e) {
        ...
        try {
          var r = e(),
            i = w.S;
          (i !== null && i(n, r),
            typeof r == `object` && r && typeof r.then == `function` && r.then(C, le));
        } catch (e) {
          le(e);
        } finally {
  ...
  qe = s((e) => {
    ...
    function O(e) {
      0 > D || ((e.current = le[D]), (le[D] = null), D--);
    }
    function k(e, t) {
      (D++, (le[D] = e.current), (e.current = t));
    }
    var de = ue(null),
      fe = ue(null),
      pe = ue(null),
      me = ue(null);
    function he(e, t) {
      switch ((k(pe, t), k(fe, e), k(de, null), t.nodeType)) {
        case 9:
        case 11:
    ...
    function ve(e) {
      (fe.current === e && (O(de), O(fe)), me.current === e && (O(me), (Qf._currentValue = ce)));
    }
    var ye, be;
    function xe(e) {
      if (ye === void 0)
...
` +
    ...
    var We = Math.clz32 ? Math.clz32 : Je,
      Ge = Math.log,
      qe = Math.LN2;
    function Je(e) {
      return ((e >>>= 0), e === 0 ? 32 : (31 - ((Ge(e) / qe) | 0)) | 0);
    }
    var Ye = 256,
      Xe = 262144,
      Ze = 4194304;
    ...
    var dt = Math.random().toString(36).slice(2),
      N = `__reactFiber$` + dt,
      P = `__reactProps$` + dt,
      ft = `__reactContainer$` + dt,
      pt = `__reactEvents$` + dt,
      mt = `__reactListeners$` + dt,
      ht = `__reactHandles$` + dt,
      gt = `__reactResources$` + dt,
      _t = `__reactMarker$` + dt;
    function vt(e) {
    ...
    function Et(e, t) {
      for (wt[e] = t, e = 0; e < t.length; e++) F.add(t[e]);
    }
    var Dt = RegExp(
    ...
    var Sn = {
      ...
      Nn = xn(f({}, Sn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Pn = xn(
        f({}, Sn, {
    ...
    function mi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) di(e) && (s = 1);
        ...
        a: switch (e) {
          case te:
            return ((e = ui(31, n, t, a)), (e.elementType = te), (e.lanes = o), e);
          case g:
          ...
          case _:
            ...
            break;
          case v:
            return ((e = ui(12, n, t, a | 2)), (e.elementType = v), (e.lanes = o), e);
          case S:
            return ((e = ui(13, n, t, a)), (e.elementType = S), (e.lanes = o), e);
          case C:
            return ((e = ui(19, n, t, a)), (e.elementType = C), (e.lanes = o), e);
          default:
    ...
    function bi(e, t) {
      if (typeof e == `object` && e) {
        var n = yi.get(e);
        return n === void 0 ? ((t = { value: e, source: t, stack: Te(t) }), yi.set(e, t), t) : n;
      }
    ...
    function Ra(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === g
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` && i && i.$$typeof === ee && ka(i) === t.type))
      ...
      function f(e, t, n) {
        ...
        if (typeof t == `object` && t) {
          switch (t.$$typeof) {
            case m:
              return (
                (n = mi(t.type, t.key, t.props, null, e.mode, n)), Ia(n, t), (n.return = e), n
              );
            case h:
                ...
                for (var l = o.key; r !== null; ) {
                  if (r.key === l) {
                    if (((l = o.type), l === g)) {
                      ...
                      r.elementType === l ||
                      (typeof l == `object` && l && l.$$typeof === ee && ka(l) === r.type)
                    ) {
    ...
    function zo(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !wr(o, e.memoizedState) && ((rc = !0), d && ((n = ma), n !== null)))
        )
          throw n;
    ...
    function is(e, t, n) {
      ...
      return (
        n !== t.memoizedState &&
          ((z.flags |= 2048), ss(9, { destroy: void 0 }, as.bind(null, i, n), null)),
        [r, a, e]
      );
    }
    function as(e, t) {
    ...
    function Ns(e, t, n) {
      ...
      ((n = {
        ...
        Is(e) ? Ls(t, n) : ((n = ii(e, t, n, r)), n !== null && (hu(n, e, r), U(n, t, r))));
    }
    function Ps(e, t, n) {
      Fs(e, t, n, pu());
    }
    function Fs(e, t, n, r) {
      ...
      if (Is(e)) Ls(t, i);
        ...
        if (((n = ii(e, t, i, r)), n !== null)) return (hu(n, e, r), U(n, t, r), !0);
      }
      return !1;
    }
    function H(e, t, n, r) {
    ...
    var zs = {
        ...
        useTransition: function () {
          var e = qo(!1);
          return ((e = ws.bind(null, z, e.queue, !0, !1)), (jo().memoizedState = e), [!1, e]);
        },
        ...
        useOptimistic: function (e) {
          ...
          return ((t.queue = n), (t = H.bind(null, z, !0, n)), (n.dispatch = t), [e, t]);
        },
        useMemoCache: Io,
    ...
    var Vs = {
      ...
      useOptimistic: function (e, t) {
        var n = Mo();
        return B === null ? ((n.baseState = e), [e, n.queue.dispatch]) : Jo(n, B, e, t);
      },
      useMemoCache: Io,
      useCacheRefresh: js,
    };
    ...
    function tc(e, t, n, r, a) {
      ...
      if (((o = bi(o, n)), Xl === null ? (Xl = [o]) : Xl.push(o), Wl !== 4 && (Wl = 2), t === null))
        return !0;
      ((r = bi(r, n)), (n = t));
      do {
        switch (n.tag) {
    ...
    function pc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((so(t), a))
          ...
          if (((r = q), r !== null && ((s = ot(r, n)), s !== 0 && s !== o.retryLane)))
            throw ((o.retryLane = s), ai(e, s), hu(r, e, s), nc);
          (Du(), (t = fc(e, t, n)));
        } else
          ((e = o.treeContext),
            (L = cf(s.nextSibling)),
    ...
    function Sc(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (((s = q), s !== null && ((r = ot(s, n)), r !== 0 && r !== l.retryLane)))
            throw ((l.retryLane = r), ai(e, r), hu(s, e, r), nc);
          (af(c) || Du(), (t = Tc(e, t, n)));
        } else
          af(c)
    ...
    function Rc(e, t, n) {
      ...
      switch ((Ni(t), t.tag)) {
        ...
        case 27:
          if ((ve(t), (n = pe.current), (a = t.type), e !== null && t.stateNode != null))
            ...
            ((e = de.current), Hi(t) ? Bi(t, e) : ((e = ff(a, r, n)), (t.stateNode = e), Nc(t)));
          }
          return (W(t), null);
        case 5:
          ...
          return (
            W(t), Pc(t, t.type, e === null ? null : e.memoizedProps, t.pendingProps, n), null
          );
        case 6:
        ...
        case 19:
          if ((O(fo), (r = t.memoizedState), r === null)) return (W(t), null);
                ...
                for (e = t.child; e !== null; ) {
                  if (((o = po(e)), o !== null)) {
                    for (
                      ...
                      (pi(n, e), (n = n.sibling));
                    return (k(fo, (fo.current & 1) | 2), R && Ai(t, r.treeForkCount), t.child);
                  }
                  e = e.sibling;
                }
              r.tail !== null &&
        ...
        if (a === 0) {
          ...
          a: {
            ...
            if ((t & 62914560) === t && ((a = $l + 300 - je()), 10 < a)) {
              if ((yu(r, t, Jl, !Bl), j(r, 0, !0) !== 0)) break a;
              ((su = t),
                (r.timeoutHandle = Kd(
    ...
    function xu() {
      if (J !== null) {
        ...
        else ((e = J), (Ji = qi = null), Ao(e), (Na = null), (Pa = 0), (e = J));
    ...
    function Cu(e, t) {
      ((z = null),
        ...
        (zl = t),
        J === null && ((Wl = 1), Xs(e, bi(t, e.current))));
    }
    function wu() {
      var e = io.current;
      return e === null
    ...
    function Au(e, t) {
      ...
      var r = Tu(),
        a = Eu();
      q !== e || Y !== t ? ((nu = null), (tu = je() + 500), Su(e, t)) : (Vl = M(e, t));
      a: do
        try {
          if (X !== 0 && J !== null) {
            t = J;
    ...
    function sd(e, t) {
      ...
      if (
        ((t = q),
        (n = Y),
        (n = j(e, e === t ? n : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1)),
        (r = e.callbackNode),
        n === 0 || (e === t && (X === 2 || X === 9)) || e.cancelPendingCommit !== null)
      )
        return (
          r !== null && r !== null && Oe(r), (e.callbackNode = null), (e.callbackPriority = 0)
        );
      if (!(n & 3) || M(e, n)) {
        ...
        return (
          (r = cd.bind(null, e)), (n = De(n, r)), (e.callbackPriority = t), (e.callbackNode = n), t
        );
      }
      return (
        r !== null && r !== null && Oe(r), (e.callbackPriority = 2), (e.callbackNode = null), 2
      );
    }
    function cd(e, t) {
      ...
      var r = Y;
      return (
        (r = j(e, e === q ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1)),
        r === 0
          ? null
          : (gu(e, r, t),
            sd(e, je()),
    ...
    function md(e, t, n, r, i) {
      if (t === `submit` && n && n.stateNode === i) {
        var a = fd((i[P] || null).action),
          o = r.submitter;
        o &&
          ((t = (t = o[P] || null) ? fd(t.formAction) : o.getAttribute(`formAction`)),
          t !== null && ((a = t), (o = null)));
        ...
        if (!(t & 7)) {
          a: {
            if (
              ...
              c && n !== nn && (u = n.relatedTarget || n.fromElement) && (yt(u) || u[ft]))
            )
              break a;
            if (
              (l || c) &&
...
`,
    ...
    function Vf(e, t, n) {
      ...
      for (r.set(e, null), n = n.getElementsByTagName(e), i = 0; i < n.length; i++) {
        var a = n[i];
        if (
          !(a[_t] || a[N] || (e === `link` && a.getAttribute(`rel`) === `stylesheet`)) &&
...
var Qe,
  ...
  $e = o(() => {});
function et(e, t) {
  var n = t && t.cache ? t.cache : ut,
    r = t && t.serializer ? t.serializer : ct;
  return (t && t.strategy ? t.strategy : at)(e, { cache: n, serializer: r });
}
function tt(e) {
...
function at(e, t) {
  var n = e.length === 1 ? nt : rt;
  return it(e, this, n, t.cache.create(), t.serializer);
}
function ot(e, t) {
  return it(e, this, rt, t.cache.create(), t.serializer);
}
function st(e, t) {
...
function Nt(e) {
  ...
  for (
    var t = e.split(jt).filter(function (e) {
        return e.length > 0;
      }),
      n = [],
      r = 0,
...
function zt(e) {
  for (var t = {}, n = 0, r = e; n < r.length; n++) {
    ...
    switch (i.stem) {
      ...
      case `measure-unit`:
      case `unit`:
        ((t.style = `unit`), (t.unit = Pt(i.options[0])));
        continue;
      case `compact-short`:
      case `K`:
      ...
      case `integer-width`:
        ...
        i.options[0].replace(Ht, function (e, n, r, i, a, o) {
    ...
    if (Bt.test(i.stem)) {
      ...
      i.stem.replace(Bt, function (e, n, r, i, a, o) {
        return (
          r === `*`
      ...
      var a = i.options[0];
      a === `w`
        ? (t = j(j({}, t), { trailingZeroDisplay: `stripIfInteger` }))
        : a && (t = j(j({}, t), Ft(a)));
      continue;
    }
    if (Vt.test(i.stem)) {
...
var rn,
  ...
  Cn = o(() => {
    (M(),
      ...
      (rn = RegExp(`^${Et.source}*`)),
      (an = RegExp(`${Et.source}*\$`)),
      (on = !!String.prototype.startsWith && `_a`.startsWith(`a`, 1)),
      (sn = !!String.fromCodePoint),
      (cn = !!Object.fromEntries),
      (ln = !!String.prototype.codePointAt),
      (un = !!String.prototype.trimStart),
      (dn = !!String.prototype.trimEnd),
      ...
      (pn = !0));
    try {
      pn = Zt(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`).exec(`a`)?.[0] === `a`;
    } catch {
      pn = !1;
    }
    ((mn = on
      ...
      (hn = sn
        ...
        : function () {
            ...
            for (var n = ``, r = e.length, i = 0, a; r > i; ) {
              if (((a = e[i++]), a > 1114111)) throw RangeError(a + ` is not a valid code point`);
              n +=
                a < 65536
                  ? String.fromCharCode(a)
                  : String.fromCharCode(((a -= 65536) >> 10) + 55296, (a % 1024) + 56320);
            }
            return n;
          }),
      (gn = cn
      ...
      pn
        ? ((xn = Zt(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`)),
          (bn = function (e, t) {
            return ((xn.lastIndex = t), xn.exec(e)[1] ?? ``);
          }))
        : (bn = function (e, t) {
            for (var n = []; ; ) {
              var r = _n(e, t);
              if (r === void 0 || tn(r) || nn(r)) break;
        ...
        return (
          ...
          (e.prototype.parseMessage = function (e, t, n) {
            for (var r = []; !this.isEOF(); ) {
              ...
              if (i === 123) {
                ...
                (this.bump(), r.push({ type: F.pound, location: I(o, this.clonePosition()) }));
          ...
          (e.prototype.parseTag = function (e, t) {
            ...
            if ((this.bumpSpace(), this.bumpIf(`/>`)))
              return {
                val: { type: F.literal, value: `<${r}/>`, location: I(n, this.clonePosition()) },
                err: null,
              };
            if (this.bumpIf(`>`)) {
              ...
              if (this.bumpIf(`</`)) {
                ...
                return r === this.parseTagName()
                  ...
                  : this.error(P.UNMATCHED_CLOSING_TAG, I(s, this.clonePosition()));
              } else return this.error(P.UNCLOSED_TAG, I(n, this.clonePosition()));
          ...
          (e.prototype.parseLiteral = function (e, t) {
            ...
            return { val: { type: F.literal, value: r, location: s }, err: null };
          }),
          (e.prototype.tryParseLeftAngleBracket = function () {
            return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !$t(this.peek() || 0))
              ? (this.bump(), `<`)
              : null;
          }),
          ...
          (e.prototype.parseArgument = function (e, t) {
            ...
            if ((this.bump(), this.bumpSpace(), this.isEOF()))
              return this.error(P.EXPECT_ARGUMENT_CLOSING_BRACE, I(n, this.clonePosition()));
            if (this.char() === 125)
              return (this.bump(), this.error(P.EMPTY_ARGUMENT, I(n, this.clonePosition())));
            ...
            switch (this.char()) {
              case 125:
                return (
                  this.bump(),
                  {
                    val: { type: F.argument, value: r, location: I(n, this.clonePosition()) },
                    err: null,
                  }
                );
              case 44:
                return (
                  ...
                  this.bumpSpace(),
                  this.isEOF()
                    ? this.error(P.EXPECT_ARGUMENT_CLOSING_BRACE, I(n, this.clonePosition()))
                    : this.parseArgumentOptions(e, t, r, n)
                );
              default:
                return this.error(P.MALFORMED_ARGUMENT, I(n, this.clonePosition()));
            }
          }),
          (e.prototype.parseIdentifierIfPossible = function () {
            var e = this.clonePosition(),
              ...
              n = bn(this.message, t),
              r = t + n.length;
            return (this.bumpTo(r), { value: n, location: I(e, this.clonePosition()) });
          }),
          (e.prototype.parseArgumentOptions = function (e, t, n, r) {
            ...
            switch (a) {
              ...
              case `time`:
                ...
                if (s && mn(s?.style, `::`, 0)) {
                  var p = vn(s.style.slice(2));
                  if (a === `number`) {
                    var l = this.parseNumberSkeletonFromString(p, s.styleLocation);
                    return l.err
                      ? l
                      : { val: { type: F.number, value: n, location: f, style: l.val }, err: null };
                  } else {
                    if (p.length === 0) return this.error(P.EXPECT_DATE_TIME_SKELETON, f);
                    var m = p;
                    this.locale && (m = Jt(p, this.locale));
                    var u = {
                      type: wt.dateTime,
                      pattern: m,
                      location: s.styleLocation,
                      parsedOptions: this.shouldParseSkeletons ? Ot(m) : {},
                    };
                    return {
                      val: {
              ...
              case `select`:
                ...
                if ((this.bumpSpace(), !this.bumpIf(`,`)))
                  return this.error(P.EXPECT_SELECT_ARGUMENT_OPTIONS, I(h, j({}, h)));
                this.bumpSpace();
                ...
                return a === `select`
                  ? {
                      val: { type: F.select, value: n, options: gn(v.val), location: y },
                      err: null,
                    }
                  : {
                      val: {
          ...
          (e.prototype.tryParseArgumentClose = function (e) {
            return this.isEOF() || this.char() !== 125
              ? this.error(P.EXPECT_ARGUMENT_CLOSING_BRACE, I(e, this.clonePosition()))
          ...
          (e.prototype.parseNumberSkeletonFromString = function (e, t) {
            ...
            return {
              val: {
                ...
                tokens: n,
                location: t,
                parsedOptions: this.shouldParseSkeletons ? zt(n) : {},
              },
              err: null,
            };
          }),
          (e.prototype.tryParsePluralOrSelectOptions = function (e, t, n, r) {
            for (var i, a = !1, o = [], s = new Set(), c = r.value, l = r.location; ; ) {
              ...
              if (m.err) return m;
              (o.push([c, { value: p.val, location: I(f, this.clonePosition()) }]),
                s.add(c),
                this.bumpSpace(),
            ...
            return o.length === 0
              ...
              : this.requiresOtherClause && !a
                ? this.error(P.MISSING_OTHER_CLAUSE, I(this.clonePosition(), this.clonePosition()))
                : { val: o, err: null };
          }),
          (e.prototype.tryParseDecimalInteger = function (e, t) {
            ...
            return i
              ? ((a *= n), fn(a) ? { val: a, err: null } : this.error(t, s))
              : this.error(e, s);
          }),
...
function Tn(e) {
  e.forEach(function (e) {
    if ((delete e.location, vt(e) || yt(e)))
      for (var t in e.options) (delete e.options[t].location, Tn(e.options[t].value));
    else
      (ht(e) && St(e.style)) || ((gt(e) || _t(e)) && Ct(e.style))
  ...
  Nn = o(() => {
    (M(),
      ...
      (jn = (function (e) {
        Ye(t, e);
        function t(t, n, r) {
          return e.call(this, `Value for "${t}" must be of type ${n}`, On.INVALID_VALUE, r) || this;
        }
        return t;
      })(kn)),
      (Mn = (function (e) {
...
function Pn(e) {
  return e.length < 2
    ...
    : e.reduce(function (e, t) {
        var n = e[e.length - 1];
        return (
          !n || n.type !== Ln.literal || t.type !== Ln.literal ? e.push(t) : (n.value += t.value), e
        );
      }, []);
}
function Fn(e) {
...
function In(e, t, n, r, i, a, o) {
  if (e.length === 1 && pt(e[0])) return [{ type: Ln.literal, value: e[0].value }];
  for (var s = [], c = 0, l = e; c < l.length; c++) {
    var u = l[c];
    if (pt(u)) {
      s.push({ type: Ln.literal, value: u.value });
      continue;
    }
    if (bt(u)) {
      typeof a == `number` && s.push({ type: Ln.literal, value: n.getNumberFormat(t).format(a) });
      continue;
    }
    var d = u.value;
    if (!(i && d in i)) throw new Mn(d, o);
    var f = i[d];
    if (mt(u)) {
      ((!f || typeof f == `string` || typeof f == `number`) &&
        (f = typeof f == `string` || typeof f == `number` ? String(f) : ``),
        s.push({ type: typeof f == `string` ? Ln.literal : Ln.object, value: f }));
      continue;
    }
    if (gt(u)) {
      var p =
        typeof u.style == `string` ? r.date[u.style] : Ct(u.style) ? u.style.parsedOptions : void 0;
      s.push({ type: Ln.literal, value: n.getDateTimeFormat(t, p).format(f) });
      continue;
    }
    if (_t(u)) {
      var p =
    ...
    if (ht(u)) {
      ...
      (p && p.scale && (f *= p.scale || 1),
        s.push({ type: Ln.literal, value: n.getNumberFormat(t, p).format(f) }));
      continue;
    }
    if (xt(u)) {
      var m = u.children,
        h = u.value,
        g = i[h];
      if (!Fn(g)) throw new jn(h, `function`, o);
      var _ = g(
        In(m, t, n, r, i, a).map(function (e) {
          return e.value;
        }),
      );
      (Array.isArray(_) || (_ = [_]),
        s.push.apply(
          s,
          _.map(function (e) {
            return { type: typeof e == `string` ? Ln.literal : Ln.object, value: e };
          }),
        ));
    }
    if (vt(u)) {
      var v = u.options[f] || u.options.other;
      if (!v) throw new An(u.value, f, Object.keys(u.options), o);
      s.push.apply(s, In(v.value, t, n, r, i));
      continue;
    }
    if (yt(u)) {
      var v = u.options[`=${f}`];
...
`,
      ...
      if (!v) throw new An(u.value, f, Object.keys(u.options), o);
      s.push.apply(s, In(v.value, t, n, r, i, f - (u.offset || 0)));
      continue;
    }
  }
  return Pn(s);
  ...
  return (
    e === void 0 && (e = { number: {}, dateTime: {}, pluralRules: {} }),
    {
      getNumberFormat: et(
        ...
        { cache: Vn(e.number), strategy: dt.variadic },
      ),
      getDateTimeFormat: et(
        ...
        { cache: Vn(e.dateTime), strategy: dt.variadic },
      ),
      getPluralRules: et(
        function () {
          for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
        ...
        { cache: Vn(e.pluralRules), strategy: dt.variadic },
      ),
    }
  );
}
          ...
          if (
            ...
            (this.format = function (e) {
              ...
              var n = t.reduce(function (e, t) {
                return (
                  !e.length || t.type !== Ln.literal || typeof e[e.length - 1] != `string`
                    ? e.push(t.value)
            ...
            (this.formatToParts = function (e) {
              return In(a.ast, a.locales, a.formatters, a.formats, e, void 0, a.message);
            }),
...
${o.stack}`
    : ``
      ...
      (Jn = (function (e) {
        Ye(t, e);
        function t(t, n) {
          return e.call(this, Kn.UNSUPPORTED_FORMATTER, t, n) || this;
        }
        return t;
      })(qn)),
      (Yn = (function (e) {
        Ye(t, e);
        function t(t, n) {
          return e.call(this, Kn.INVALID_CONFIG, t, n) || this;
        }
        return t;
      })(qn)),
      (Xn = (function (e) {
        Ye(t, e);
        function t(t, n) {
          return e.call(this, Kn.MISSING_DATA, t, n) || this;
        }
        return t;
      })(qn)),
      (Zn = (function (e) {
...
function ar(e) {
  ...
  var t = Intl.RelativeTimeFormat,
    ...
    i = et(
      ...
      { cache: ir(e.dateTime), strategy: dt.variadic },
    ),
    a = et(
      function () {
        for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
      ...
      { cache: ir(e.number), strategy: dt.variadic },
    ),
    o = et(
      function () {
        for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
      ...
      { cache: ir(e.pluralRules), strategy: dt.variadic },
    );
  return {
    getDateTimeFormat: i,
    getNumberFormat: a,
    getMessageFormat: et(
      function (e, t, n, r) {
        return new Un(
          ...
          n,
          j(
            { formatters: { getNumberFormat: a, getDateTimeFormat: i, getPluralRules: o } },
            r || {},
          ),
        );
      },
      { cache: ir(e.message), strategy: dt.variadic },
    ),
    getRelativeTimeFormat: et(
      function () {
        for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        return new (t.bind.apply(t, Ze([void 0], e, !1)))();
      },
      { cache: ir(e.relativeTime), strategy: dt.variadic },
    ),
    getPluralRules: o,
    getListFormat: et(
      function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return new (n.bind.apply(n, Ze([void 0], e, !1)))();
      },
      { cache: ir(e.list), strategy: dt.variadic },
    ),
    getDisplayNames: et(
      function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return new (r.bind.apply(r, Ze([void 0], e, !1)))();
      },
      { cache: ir(e.displayNames), strategy: dt.variadic },
    ),
  };
}
function or(e, t, n, r) {
...
function fr(e, t) {
  return Object.keys(j(j({}, e), t)).reduce(function (n, r) {
    return ((n[r] = j(j({}, e[r] || {}), t[r] || {})), n);
  }, {});
}
function pr(e, t) {
  ...
  var n = Un.formats;
  return j(j(j({}, n), e), {
    date: fr(dr(n.date, t), dr(e.date || {}, t)),
    time: fr(dr(n.time, t), dr(e.time || {}, t)),
  });
}
var mr,
  hr = o(() => {
...
to autofix this issue`,
        ...
        if (Array.isArray(_) && _.length === 1 && _[0].type === F.literal) return _[0].value;
        if (!r && _ && typeof _ == `string` && !p) return _.replace(/'\{(.*?)\}'/gi, `{$1}`);
        if (((r = j(j({}, p), r || {})), (o = pr(o, f)), (l = pr(l, f)), !_)) {
          if (u === !1 && _ === ``) return _;
          if (((!h || (a && a.toLowerCase() !== c.toLowerCase())) && d(new $n(n, a)), h))
            try {
        ...
        try {
          var v = t.getMessageFormat(_, a, o, j({ formatters: t }, i || {}));
          return v.format(r);
        } catch (e) {
          d(
            new Qn(
...
function gr(e, t, n, r) {
  ...
  r === void 0 && (r = {});
  var c = r.format,
    l = j(j({}, s && { timeZone: s }), c && or(a, t, c, o)),
    u = nr(r, Sr, l);
  return (
    t === `time` &&
      !u.hour &&
      ...
      !u.timeStyle &&
      !u.dateStyle &&
      (u = j(j({}, u), { hour: `numeric`, minute: `numeric` })),
    n(i, u)
  );
}
function _r(e, t) {
  ...
  try {
    return gr(e, `date`, t, o).format(s);
  } catch (t) {
    e.onError(new Zn(`Error formatting date.`, e.locale, t));
  }
  return String(s);
}
function vr(e, t) {
  ...
  var i = n[0],
    ...
    s = typeof i == `string` ? new Date(i || 0) : i;
  try {
    return gr(e, `time`, t, o).format(s);
  } catch (t) {
    e.onError(new Zn(`Error formatting time.`, e.locale, t));
  }
  return String(s);
}
function yr(e, t) {
  ...
  try {
    return gr(e, `dateTimeRange`, t, s).formatRange(c, l);
  } catch (t) {
    e.onError(new Zn(`Error formatting date time range.`, e.locale, t));
  }
  return String(c);
}
function br(e, t) {
  ...
  var i = n[0],
    ...
    s = typeof i == `string` ? new Date(i || 0) : i;
  try {
    return gr(e, `date`, t, o).formatToParts(s);
  } catch (t) {
    e.onError(new Zn(`Error formatting date.`, e.locale, t));
  }
  return [];
...
function xr(e, t) {
  ...
  var i = n[0],
    ...
    s = typeof i == `string` ? new Date(i || 0) : i;
  try {
    return gr(e, `time`, t, o).formatToParts(s);
  } catch (t) {
    e.onError(new Zn(`Error formatting time.`, e.locale, t));
  }
  return [];
...
`,
  ...
  try {
    ...
    a(new Zn(`Error formatting display name.`, i, e));
  }
}
var Tr,
  Er = o(() => {
    (ur(), Gn(), er(), (Tr = [`style`, `type`, `fallback`, `languageDisplay`]));
  });
function Dr(e) {
  return `${jr}_${e}_${jr}`;
}
function Or(e, t, n, r) {
  r === void 0 && (r = {});
  var i = kr(e, t, n, r).reduce(function (e, t) {
    var n = t.value;
    return (
...
`,
  ...
  try {
    ...
    return t(i, o)
      .formatToParts(c)
      .map(function (e) {
        return e.type === `literal` ? e : j(j({}, e), { value: s[e.value] || e.value });
      });
  } catch (e) {
    a(new Zn(`Error formatting list.`, i, e));
  }
  return n;
}
var Ar,
  jr,
  Mr = o(() => {
    (M(), Gn(), er(), ur(), (Ar = [`type`, `style`]), (jr = Date.now()));
  });
function Nr(e, t, n, r) {
  var i = e.locale,
    a = e.onError;
...
`,
  ...
  try {
    ...
    a(new Zn(`Error formatting plural.`, i, e));
  }
  return `other`;
}
var Pr,
...
function Ir(e, t, n) {
  ...
  n === void 0 && (n = {});
  var o = n.format,
    s = (!!o && or(i, `relative`, o, a)) || {};
  return t(r, nr(n, Rr, s));
}
...
`,
  ...
  try {
    return Ir(e, t, i).format(n, r);
  } catch (t) {
    e.onError(new Zn(`Error formatting relative time.`, e.locale, t));
  }
  return String(n);
}
var Rr,
  zr = o(() => {
    (ur(), Gn(), er(), (Rr = [`numeric`, `style`]));
  });
function Br(e, t, n) {
  var r = e.locale,
    i = e.formats,
  ...
  var o = n.format,
    s = (o && or(i, `number`, o, a)) || {};
  return t(r, nr(n, Ur, s));
}
function Vr(e, t, n, r) {
  r === void 0 && (r = {});
  try {
    return Br(e, t, r).format(n);
  } catch (t) {
    e.onError(new Zn(`Error formatting number.`, e.locale, t));
  }
  return String(n);
}
function Hr(e, t, n, r) {
  r === void 0 && (r = {});
  try {
    return Br(e, t, r).formatToParts(n);
  } catch (t) {
    e.onError(new Zn(`Error formatting number.`, e.locale, t));
  }
  return [];
...
function qr(e, t) {
  ...
  return (
    ...
    j(j({}, r), {
      formatters: n,
      formatNumber: Vr.bind(null, r, n.getNumberFormat),
      formatNumberToParts: Hr.bind(null, r, n.getNumberFormat),
      formatRelativeTime: Lr.bind(null, r, n.getRelativeTimeFormat),
      formatDate: _r.bind(null, r, n.getDateTimeFormat),
      formatDateToParts: br.bind(null, r, n.getDateTimeFormat),
      formatTime: vr.bind(null, r, n.getDateTimeFormat),
      formatDateTimeRange: yr.bind(null, r, n.getDateTimeFormat),
      formatTimeToParts: xr.bind(null, r, n.getDateTimeFormat),
      formatPlural: Nr.bind(null, r, n.getPluralRules),
      formatMessage: mr.bind(null, r, n),
      $t: mr.bind(null, r, n),
      formatList: Or.bind(null, r, n.getListFormat),
      formatListToParts: kr.bind(null, r, n.getListFormat),
      formatDisplayName: wr.bind(null, r, n.getDisplayNames),
    })
  );
}
var Jr = o(() => {
    (M(), Cr(), Er(), er(), Mr(), hr(), Wr(), Fr(), zr(), ur());
  }),
  Yr = o(() => {
    ($e(), ur(), er(), hr(), Jr());
  });
...
var ei,
  ...
  ii = o(() => {
    (M(),
      (ei = u(Ue())),
      Yr(),
      (ti = j(j({}, lr), { textComponent: ei.Fragment })),
      (ni = function (e, t) {
        return ei.isValidElement(e) ? ei.cloneElement(e, { key: t }) : e;
      }),
      (ri = function (e) {
        return ei.Children.map(e, ni) ?? [];
      }));
  }),
  ai = s((e) => {
...
function vi(e) {
  var t = function (t) {
    ...
    var s = n.textComponent || yi.Fragment;
    return yi.createElement(s, null, o);
  };
  return ((t.displayName = bi[e]), t);
}
var yi,
  bi,
  xi,
    ...
    (M(),
      ...
      (Si = function (e) {
        var t = mi(),
          n = e.value,
          r = e.children,
          i = Xe(e, [`value`, `children`]);
        return r(t.formatNumberToParts(n, i));
      }),
      (Si.displayName = `FormattedNumberParts`),
      (Si.displayName = `FormattedNumberParts`));
  });
function wi(e) {
  return (
  ...
  Di = o(() => {
    (M(),
      ...
      (Ti = function (e, t, n, r) {
        ...
        var o = wi(r),
          s = mr.apply(void 0, Ze([e, t, n, o], i, !1));
        return Array.isArray(s) ? ri(s) : s;
      }),
      (Ei = function (e, t) {
        var n = e.defaultRichTextElements,
          r = Xe(e, [`defaultRichTextElements`]),
          i = wi(n),
          a = qr(j(j(j({}, ti), r), { defaultRichTextElements: i }), t),
          o = {
            locale: a.locale,
            timeZone: a.timeZone,
        ...
        return j(j({}, a), {
          formatMessage: Ti.bind(null, o, a.formatters),
          $t: Ti.bind(null, o, a.formatters),
        });
      }));
  });
function Oi(e, t) {
...
function ki(e) {
  ...
  return typeof l == `function`
    ...
    : d
      ? Ai.createElement(d, null, p)
      : Ai.createElement(Ai.Fragment, null, p);
}
var Ai,
  ji,
  Mi = o(() => {
    (M(),
      ...
      ii(),
      gi(),
      (ki.displayName = `FormattedMessage`),
      (ji = Ai.memo(ki, Oi)),
      (ji.displayName = `MemoizedFormattedMessage`));
  });
function Ni(e) {
  return {
    locale: e.locale,
    ...
    (M(),
      ...
      (Fi = (function (e) {
        ...
        function t() {
          ...
          return (
            (t.cache = rr()),
            (t.state = { cache: t.cache, intl: Ei(Ni(t.props), t.cache), prevConfig: Ni(t.props) }),
            t
          );
        }
        return (
          (t.getDerivedStateFromProps = function (e, t) {
            var n = t.prevConfig,
              r = t.cache,
              i = Ni(e);
            return $r(n, i) ? null : { intl: Ei(i, r), prevConfig: i };
          }),
          (t.prototype.render = function () {
            return (
              Zr(this.state.intl),
              Pi.createElement(di, { value: this.state.intl }, this.props.children)
            );
          }),
...
function Ri(e) {
  let t = e.toLowerCase();
  return t.endsWith(`.localhost`) || Bi.has(t);
}
function zi(e) {
  let t;
  try {
  ...
  return t.protocol !== `http:` && t.protocol !== `https:` ? !1 : Ri(t.hostname);
}
var Bi,
  Vi = o(() => {
    Bi = new Set([`localhost`, `127.0.0.1`, `0.0.0.0`, `[::1]`, `::1`]);
  });
function Hi(e) {
  return zi(e);
}
...
function Zi(e = window) {
  ...
  for (; n.length > 0; ) {
    ...
    let i = Yi(e);
    if (i != null)
      for (let e of Array.from(i.querySelectorAll(`iframe`))) {
        let t = Xi(e);
        t != null && n.push(t);
      }
  }
...
function Qi(e) {
  return e.getAttribute(`aria-label`) || $i(e) || e.tagName.toLowerCase();
}
function $i(e) {
  if (Ki(e)) return e.tagName.toLowerCase();
...
function na(e) {
  return Wi(e.ownerDocument.defaultView);
}
function ra(e) {
  let t = window,
    n = document;
  for (let r of e) {
    let e = n.querySelector(r);
    if (!Ji(e)) return null;
    let i = Xi(e);
    if (i == null) return null;
    ((t = i), (n = i.document));
...
function aa(e) {
  ...
  for (; n && r < 4; ) {
    let e = n.tagName.toLowerCase(),
      i = n.tagName;
    if (n.id) return (t.unshift(`${e}#${pa(n.id)}`), t.join(` > `));
    let a = Array.from(n.classList)
      .filter((e) => /^[a-zA-Z0-9_-]+$/.test(e))
      .slice(0, 2);
    a.length > 0 && (e += `.${a.map(pa).join(`.`)}`);
    let o = n.parentElement;
    if (o != null) {
      let t = Array.from(o.children).filter((e) => qi(e) && e.tagName === i);
...
function sa(e, t) {
  ...
  let n = e.document.elementFromPoint(t.x, t.y),
    r = [],
    i = n;
  for (; i != null && i !== e.document.body && i !== e.document.documentElement; ) {
    if (fa(i, e)) {
      let e = aa(i);
      e != null && r.push({ selector: e, scrollLeft: i.scrollLeft, scrollTop: i.scrollTop });
    }
    i = i.parentElement;
  }
  return r;
...
function ca(e, t) {
  ...
  for (let i of e.scrollContainers ?? []) {
    ...
    qi(e) && ((n += e.scrollLeft - i.scrollLeft), (r += e.scrollTop - i.scrollTop));
  }
  return { x: n, y: r };
}
function la(e) {
...
function fa(e, t) {
  let n = t.getComputedStyle(e),
    r = e.scrollHeight > e.clientHeight && Gi(n.overflowY),
    i = e.scrollWidth > e.clientWidth && Gi(n.overflowX);
  return r || i;
}
function pa(e) {
...
function ha(e) {
  let t = (e ?? ``).replace(/\s+/g, ` `).trim();
  return t.length === 0 ? null : t.slice(0, Ca);
}
function ga(e) {
  if (!ba(e)) return !1;
...
function va(e) {
  if (e.closest(`script,style,noscript,template,[hidden],[aria-hidden='true']`) != null) return !1;
  let t = ya(e).getComputedStyle(e);
...
function ba(e) {
  return e == null ? !1 : e instanceof (e.ownerDocument.defaultView?.HTMLElement ?? HTMLElement);
}
function xa(e, t, n) {
  let r = e.createRange();
  try {
    return (r.selectNodeContents(t), Array.from(r.getClientRects()).some((e) => Sa(e, n)));
  } finally {
    r.detach();
  }
}
function Sa(e, t) {
  return e.right >= t.x && e.left <= t.x + t.width && e.bottom >= t.y && e.top <= t.y + t.height;
}
var Ca,
  wa,
  Ta,
  ...
  Oa = o(() => {
    ((Ca = 2e3),
      ...
      (Da = class {
        ...
        getDocumentContext({ documentTitle: e, selectedText: t, visibleText: n }) {
          return x({ documentTitle: e, pageUrl: this.pageUrl, selectedText: t, visibleText: n });
        }
        getElementDocumentContext({ documentTitle: e, elementWindow: t, fallbackWindow: n }) {
          return this.getDocumentContext({
            documentTitle: e,
            selectedText: this.getWindowSelectionText(t) ?? this.getWindowSelectionText(n),
          });
        }
        getRegionDocumentContext({
          ...
          if (this.isGoogleDocsPage())
            return this.getDocumentContext({
              documentTitle: e,
              selectedText: this.getWindowSelectionText(n) ?? this.getWindowSelectionText(t),
              visibleText: this.getVisibleTextInViewportRect(n, r),
            });
        }
        static isGoogleDocsAnchor(e) {
          return e.documentContext?.kind === `google-docs` || b(e.pageUrl) != null;
        }
        getWindowSelectionText(e) {
          try {
            return ha(e.getSelection()?.toString()) ?? this.getActiveElementSelectionText(e);
          } catch {
            return null;
          }
        }
        getActiveElementSelectionText(e) {
          ...
          let n = t.selectionStart,
            r = t.selectionEnd;
          return n == null || r == null || r <= n ? null : ha(t.value.slice(n, r));
        }
        getVisibleTextInViewportRect(e, t) {
          ...
          let i = ``,
            a = n.createTreeWalker(r, wa, {
              acceptNode: (e) => {
                if (ha(e.textContent) == null) return Ea;
                let t = e.parentElement;
                return !ba(t) || !va(t) ? Ea : Ta;
              },
            }),
            o = a.nextNode();
          for (; o != null; ) {
            let e = ha(o.textContent);
            if (
              e != null &&
              xa(n, o, t) &&
              ((i = i.length === 0 ? e : `${i} ${e}`), i.length >= Ca)
            )
              break;
            o = a.nextNode();
          }
  ...
  ja = c({
    buildRegionAnchor: () => _o,
    getBrowserCommentElementSnapshot: () => Ao,
    getElementMetadataTooltipStyle: () => ps,
    getMarkerPoint: () => rs,
    mountBrowserSidebarCommentRuntime: () => Ma,
  });
function Ma(e) {
  let t = qa(),
  ...
  n.appendChild(r);
  let i = (0, Ls.createRoot)(r);
  return (
    i.render((0, U.jsx)(Na, { rootHost: t, bridge: e })),
    {
      dispose() {
        (i.unmount(), t.remove());
      },
...
function Na({ rootHost: e, bridge: t }) {
  let [n, r] = (0, H.useState)(t.initialState),
    [i, a] = (0, H.useState)(null),
    [o, s] = (0, H.useState)(t.initialState.isDesignModifierPressed === !0),
    [c, l] = (0, H.useState)(null),
    [u, d] = (0, H.useState)(null),
    [m, h] = (0, H.useState)(null),
    [g, _] = (0, H.useState)(null),
    [v, b] = (0, H.useState)(null),
    [x, S] = (0, H.useState)(null),
    [C, w] = (0, H.useState)(os),
    ee = (0, H.useRef)(null),
    te = (0, H.useRef)(null),
    ne = (0, H.useRef)(null),
    ...
    E = (0, H.useRef)(!1),
    ce = (0, H.useRef)(null),
    { comments: le, interactionMode: D } = n,
    O = Ce(n.zoomPercent),
    k = ls(n.viewportScale),
    de = Hi(Qa()),
    fe = n.canUseTweaks !== !1,
    pe = new Map(le.map((e, t) => [e.id, t + 1])),
    me = le.filter(So),
    he = Lo(e),
    ge = me.flatMap((e) => {
      let t = yo(e, he, e.id === g);
      return t == null ? [] : [t];
    }),
    _e = n.activeDesignChange,
    ve = le.flatMap((e) => (e.designChange == null ? [] : [e.designChange])),
    ye = fe ? (_e == null ? ve : [...ve.filter((e) => e.id !== _e.id), _e]) : pc,
    be = n.isOriginalViewEnabled === !0 ? pc : ye,
    xe = f(le),
    Se = fe && xe && n.annotationEditorMode === `design`,
    we = be.flatMap((e) => {
      let t = bo(e, he);
      return t == null ? [] : [t];
    }),
    Te = ge.some((e) => !e.anchor.isFixed),
    Ee = me.some((e) => e.anchor.kind === `element` && e.anchor.selector != null),
    De = (0, H.useCallback)(
      (e, n) => (
        c != null &&
          (t.sendMessageToHost({
        ...
        h({
          ...
          anchor: {
            type: `element`,
            element: e,
            ...(n.themeVariant == null ? {} : { themeVariant: n.themeVariant }),
            value: n.anchor,
    ...
    Oe = (0, H.useCallback)(
      (n) => {
        let r = Lo(e),
          i = le.find((e) => e.id === n.id) ?? n,
          a = vo(i, r) ?? null;
        (a != null && (r.set(i.id, a), i.designChange != null && Xo(a, i.designChange.id)),
          c != null &&
            t.sendMessageToHost({
              type: `browser-sidebar-runtime-close-comment-preview`,
              commentId: c,
          ...
          s =
            i.designChange != null && a == null
              ...
              : a == null || o.anchor.kind !== `element`
                ? void 0
                : Po(a, o, i.designChange);
        (t.sendMessageToHost({
          type: `browser-sidebar-runtime-open-editor`,
          target: { mode: `edit`, commentId: i.id },
          anchorState: o,
          ...(s == null ? {} : { designEditorState: s }),
        }),
          w(os()),
          h({ target: { mode: `edit`, commentId: i.id }, anchor: La(i, a) }),
          l(null));
      },
      [t, le, c, e, O],
    ),
    ...
    Ae = (0, H.useCallback)(
      (r, i) => {
        ...
        let c = {
            ...i,
            cardViewportRect: hs(e, o.rect, { viewportScale: n.viewportScale, zoomFactor: O }),
          },
          l = Po(r, c, void 0, o);
        return (
          Xo(r, l.id),
          ...
          h({
            ...
            anchor: {
              type: `element`,
              ...(c.cardViewportRect == null ? {} : { cardViewportRect: c.cardViewportRect }),
              element: r,
              ...(c.themeVariant == null ? {} : { themeVariant: c.themeVariant }),
              value: c.anchor,
    ...
    Me = (0, H.useCallback)(
      (n) => {
        if (m != null)
          return (t.sendMessageToHost({ type: `browser-sidebar-runtime-focus-editor` }), !0);
        let r = te.current;
        if (((te.current = null), r != null && Date.now() - r.capturedAt <= oc))
          return De(r.element, r.anchorState);
        let i = eo(n.x, n.y, e);
        return i == null ? !1 : De(i, Va(i, n.x, n.y));
      },
      [m, t, De, e],
    ),
    Ne = (0, H.useCallback)(
      (e) => {
        let t = 2,
          n = () => {
            Me(e) || t === 0 || (--t, window.requestAnimationFrame(n));
          };
    ...
    Pe = (0, H.useCallback)(
      (n) => {
        ...
        let i = eo(n.x, n.y, e);
        return i == null ? !1 : Ae(i, Va(i, n.x, n.y));
      },
      [m, t, Ae, e],
    ),
    Fe = (0, H.useCallback)(
      (e) => {
        let t = 2,
          n = () => {
            Pe(e) || t === 0 || (--t, window.requestAnimationFrame(n));
          };
        window.requestAnimationFrame(n);
      },
      [Pe],
    ...
    Ie = (0, H.useCallback)(() => {
      (oe.current != null && window.cancelAnimationFrame(oe.current),
        (oe.current = window.requestAnimationFrame(() => {
          ((oe.current = null), w(os()));
        })));
    }, []),
    Le = (0, H.useEffectEvent)((e) => {
      (t.sendMessageToHost({ type: `browser-sidebar-runtime-close-comment-preview`, commentId: e }),
        l(null));
    }),
    Re = (0, H.useEffectEvent)((e) => {
      h((t) => {
        if (t == null) return t;
        let n = t.target;
        return n.mode === `design` || !(`commentId` in n) || e.some((e) => e.id === n.commentId)
          ? t
          : null;
      });
    }),
    ze = (0, H.useEffectEvent)((e) => {
      (e != null &&
        t.sendMessageToHost({
          type: `browser-sidebar-runtime-close-comment-preview`,
          commentId: e,
  ...
  ((0, H.useEffect)(() => {
    let n = t.subscribeToHostMessages((t) => {
      switch (t.type) {
        case `browser-sidebar-runtime-sync`:
          (t.interactionMode !== `comment` && (T.current = !1),
            r(
              (e) => (
                e.zoomPercent !== t.zoomPercent && Ie(),
                {
            ...
            w(os()),
            s(t.interactionMode === `comment` && t.isDesignModifierPressed === !0),
            (t.interactionMode !== `comment` ||
              t.canUseTweaks === !1 ||
              t.isTweaksEditorOpen !== !0) &&
              b(null),
            _((e) => (e != null && !t.comments.some((t) => t.id === e) ? null : e)));
          return;
        case `browser-sidebar-runtime-prepare-comment-screenshot`:
          _(t.commentId);
          return;
        ...
        case `browser-sidebar-runtime-close-editor`:
          (0, Is.flushSync)(() => {
            ((ie.current += 1),
              ...
              (ne.current = null),
              S(null),
              h((e) => (e == null || t.target == null || y(e.target, t.target) ? null : e)));
          });
          return;
        case `browser-sidebar-runtime-design-scrub-changed`:
          ...
          return;
        case `browser-sidebar-runtime-create-comment-at-point`:
          Me(t.viewportPoint) || Ne(t.viewportPoint);
          return;
        case `browser-sidebar-runtime-open-design-editor-at-point`:
          if (!fe) return;
          Pe(t.viewportPoint) || Fe(t.viewportPoint);
          return;
        case `browser-sidebar-runtime-restore-editor`:
          h(Ka(t, Lo(e)));
          return;
    ...
    return () => {
      (oe.current != null && (window.cancelAnimationFrame(oe.current), (oe.current = null)), n());
    };
  }, [t, fe, Pe, Ie, Ne, Fe, e, Me]),
    (0, H.useEffect)(() => {
      let t = Lo(e);
      (t.forEach((e, n) => {
        (!le.some((e) => e.id === n) || !e.isConnected) && t.delete(n);
      }),
        c != null && !me.some((e) => e.id === c) && Le(c),
        Re(me));
    }, [le, c, e, me]),
    (0, H.useEffect)(() => {
      D === `browse` && ze(c);
    ...
    (0, H.useEffect)(() => {
      if (u == null) return;
      let e = me.find((e) => e.id === u) ?? null;
      e != null && Be(e);
    }, [u, me]),
    (0, H.useEffect)(() => {
      let n = () => {
          ((ee.current = null), a(null));
        },
        r = (t, r) => {
          if (
            (s(r.altKey),
            !r.isTrusted || D !== `comment` || m != null || Ds(r, e) || ne.current != null)
          ) {
            n();
            return;
          }
          if (
            (ks(r, { preventDefault: !1 }),
            ee.current ?? Za(t.document, Xs),
            (ee.current = da(t, { x: r.clientX, y: r.clientY })),
            E.current)
          ) {
            a(null);
            return;
          }
          let i = ro(ee.current, e);
          if (!i) {
            n();
            return;
          }
        ...
        i = (t, r, i) => {
          i.isTrusted && D === `comment` && m == null && !Ds(i, e) && ks(i, { preventDefault: !1 });
          let a = i.relatedTarget;
          if (a instanceof Node && t.documentElement?.contains(a)) return;
          let o = da(r, { x: i.clientX, y: i.clientY });
          (a != null && Ms(o)) || n();
        },
        o = () => {
          (s(!1), n());
        ...
        c = ({ currentDragSelection: e, suppressFollowUpClick: r }) => {
          ...
          T.current = r;
          let a = e.rect,
            o = _o(a, e.current, { framePath: e.framePath, frameUrl: e.frameUrl }),
            s = Ua(o, O),
            ...
            window.requestAnimationFrame(() => {
              ie.current === i &&
                ...
                h({
                  ...
                  anchor: {
                    type: `region`,
                    ...(s.themeVariant == null ? {} : { themeVariant: s.themeVariant }),
                    value: o,
                  },
                }),
                S(null),
        ...
        l = (t, n) => {
          ...
          let r = da(t, { x: n.clientX, y: n.clientY });
          if (
            ne.current != null &&
            c({ currentDragSelection: Fs(ne.current, r), suppressFollowUpClick: !0 })
          ) {
            ks(n);
            return;
          }
        ...
        u = (t, n) => {
          ...
          (D === `comment` && ks(n),
            (te.current = { anchorState: Va(i, r.x, r.y), capturedAt: Date.now(), element: i }));
        },
        d = (e, t) => {
          ...
          ks(t);
          let i = Fs(r, da(e, { x: t.clientX, y: t.clientY }));
          ((ne.current = i), S(i), n());
        },
        f = (e, t) => {
          let n = ne.current;
          if (n == null || t.pointerId !== n.pointerId) return;
          let r = Fs(n, da(e, { x: t.clientX, y: t.clientY }));
          if (
            ((ne.current = null),
            S(null),
            t.isTrusted && (ks(t), !c({ currentDragSelection: r, suppressFollowUpClick: !0 })))
          ) {
            if (((T.current = !0), fe && (Se || t.altKey))) {
              Pe(r.current);
              return;
            }
            Me(r.current);
        ...
        p = (e) => {
          e.pointerId === ne.current?.pointerId && ((ne.current = null), S(null));
        },
        g = (e) => {
          if (!(e.key !== `Escape` || !e.isTrusted)) {
            if (ne.current != null) {
              (ks(e), (T.current = !0), (ne.current = null), S(null), n());
              return;
            }
            m == null &&
              D === `comment` &&
              (ks(e), t.sendMessageToHost({ type: `browser-sidebar-runtime-exit-comment-mode` }));
          }
        },
        _ = (t) => {
          !t.isTrusted || D !== `comment` || m != null || Ds(t, e) || ks(t);
        },
        v = (t, n) => {
          if (T.current && ((T.current = !1), D === `comment`)) {
            ks(n);
            return;
          }
          if (!n.isTrusted || Ds(n, e) || D !== `comment`) return;
          if (m != null) {
            ks(n);
            return;
          }
          ...
          if ((ks(n), fe && (Se || n.altKey))) {
            let t = eo(r.x, r.y, e);
            t != null && Ae(t, Va(t, r.x, r.y));
            return;
          }
          Me(r);
        },
        y = (t, n) => {
          !n.isTrusted ||
            ...
            m != null ||
            Ds(n, e) ||
            (ao(da(t, { x: n.clientX, y: n.clientY }), oo(n, t), e) && ks(n));
        };
      return Ja((e, t) => {
        let n = (e) => {
            l(t, e);
        ...
        for (let t of Ks) e.addEventListener(t, _, !0);
        ...
        return (
          ...
          () => {
            ...
            for (let t of Ks) e.removeEventListener(t, _, !0);
            (e.removeEventListener(`pointercancel`, p, !0),
              ...
              e.removeEventListener(`wheel`, S, !0),
              t.removeEventListener(`blur`, o));
          }
        );
      });
    }, [m, t, fe, D, Se, e, Pe, Ae, de, Me, O]),
    (0, H.useEffect)(() => {
      if (D !== `comment` || m != null) return;
      let t = () => {
          let t = ro(ee.current, e);
          (a(t == null ? null : Ao(t)), t != null && w(os()));
        },
        n = () => {
        ...
        r = Ja(
          (e, r) => (
            ...
            () => {
              (r.removeEventListener(`resize`, t), e.removeEventListener(`scroll`, n, !0));
            }
          ),
        );
      return () => {
    ...
    (0, H.useEffect)(() => {
      ...
      let r = () => {
          ...
          let a,
            o = Lo(e);
          if (m == null) {
            let e = le.find((e) => e.id === c) ?? null;
            if (e == null) return;
            let t = vo(e, o) ?? null;
            (t != null && o.set(e.id, t), (a = Ha(e, t, O)));
          } else
            a =
              m.target.mode === `create` || m.target.mode === `design`
                ? Wa(m, O, n.viewportScale)
                : Ga(m, le, o, O);
          ...
          let l = le.find((e) => e.id === s.commentId) ?? null,
            u = l == null ? null : vo(l, o);
          h((e) =>
            e == null || !y(e.target, s) || e.anchor.type !== `element` || e.anchor.element === u
              ? e
    ...
    }, [m, t, le, c, e, n.viewportScale, O]),
    (0, H.useEffect)(() => {
      let e = D === `comment` && m == null && fe && o;
      se.current !== e &&
        ((se.current = e),
        t.sendMessageToHost({ type: `browser-sidebar-runtime-design-modifier-state`, pressed: e }));
    }, [m, t, fe, D, o]),
    (0, H.useEffect)(() => Ho(D === `comment` ? be : pc), [D, be]),
    (0, H.useLayoutEffect)(() => {
      if (m != null || me.length === 0) return;
      let t = () => {
          (0, Is.flushSync)(() => {
            w(os());
          });
        ...
        r = () => n();
      (window.addEventListener(`resize`, t), Te && document.addEventListener(`scroll`, r, !0));
      let i = Ee ? ts(document, e, Ie) : null,
        a = es(window, le, r),
        o = Ja((r, i) => {
          if (i === window) return () => {};
          let a = () => n();
          (i.addEventListener(`resize`, t),
            ...
            Te && r.addEventListener(`scroll`, a, !0));
          let o = es(i, le, a),
            s = Ee ? ts(r, e, Ie) : null;
          return () => {
            (i.removeEventListener(`resize`, t),
              i.removeEventListener(`scroll`, a),
              Te && r.removeEventListener(`scroll`, a, !0),
              o(),
              s?.());
          };
        });
      return () => {
        (window.removeEventListener(`resize`, t),
          Te && document.removeEventListener(`scroll`, r, !0),
          i?.(),
          a(),
          o());
      };
    }, [m, le, Te, Ee, Ie, e, me.length]));
  let Ve = D === `comment` && n.isOriginalViewEnabled !== !0,
    He = D === `comment` && m == null;
  (0, H.useLayoutEffect)(() => {
    let e = document.getElementById(Rs);
    if (e instanceof HTMLDivElement)
      return (
        (e.style.pointerEvents = He ? `auto` : `none`),
        () => {
          e.style.pointerEvents = `none`;
        }
      );
  }, [e, He]);
  let Ue = g == null ? null : (ge.find((e) => e.id === g) ?? null),
    We = g == null ? null : (we.find((e) => e.id === g) ?? null),
    A =
      Ue == null
        ? We == null
          ? null
          : { kind: `design`, annotation: We }
        : { kind: `comment`, annotation: Ue },
    Ge = A?.annotation.id ?? null,
    Ke = A?.kind === `comment` ? [A.annotation] : ge,
    qe = A != null && g != null,
    Je = m?.target.mode === `create` ? ho(m.anchor) : null,
    Ye =
      m?.target.mode === `create` && m.anchor.type === `element` ? m.anchor.viewportSize : void 0,
    Xe = Je == null ? null : (ge.find((e) => ue(e.anchor, Je)) ?? null),
    Ze = (
      qe ? (A?.kind === `comment` ? ge : []) : Xe == null ? ge : ge.filter((e) => e.id !== Xe.id)
    ).flatMap((e) => {
      let t = pe.get(e.id);
      if (t == null) return [];
      let n = rs(e.anchor, fs(C, e.markerViewportSize));
      return is(e.anchor, n)
        ? [
            {
              comment: e,
              commentNumber: t,
              markerPoint: _s(e.anchor, C, { viewportSize: e.markerViewportSize, zoomFactor: O }),
            },
          ]
        : [];
    }),
    Qe = re(
      Ze.map(({ markerPoint: e }) => e),
      C.width * O,
    ),
    j = A?.kind === `comment` ? Ze.findIndex(({ comment: e }) => e.id === A.annotation.id) : -1,
    M = j === -1 ? void 0 : Qe[j],
    $e = M == null ? void 0 : { x: M.x / O, y: M.y / O },
    et =
      A?.annotation.anchor.kind === `element`
        ? A.kind === `comment`
          ? (vo(A.annotation, he) ?? null)
          : (wo(A.annotation.anchor, A.annotation.id, he) ?? null)
        : null,
    tt = A?.kind === `comment` && A.annotation.anchor.kind === `element` && et == null,
    nt = c == null ? null : (ge.find((e) => e.id === c) ?? null),
    rt =
      Ve || (qe && A?.kind === `comment`)
        ? Ke.filter(
            (e) =>
              e.anchor.kind === `region` && !ys(e, m, A?.kind === `comment` ? A.annotation : null),
          )
        : [],
    it = null,
    at = `hover-box`,
    ot;
  if (qe && A?.annotation.anchor.kind === `element`) {
    let e = et == null ? null : Ao(et);
    ((it = e?.rect ?? ns(A.annotation.anchor)),
      (ot = e?.borderRadius),
      (at = Ss(A.annotation.anchor, it, C.width, C.height)));
  } else if (qe && A?.kind === `comment` && A.annotation.anchor.kind === `region`)
    ((it = ns(A.annotation.anchor)), (at = bs(A.annotation.anchor, it, C.width, C.height)));
  else if (!qe)
    if (((it = x?.rect ?? null), it != null)) at = bs(null, it, C.width, C.height);
    else if (m?.anchor.type === `element`) {
      let e = m.anchor.element == null ? null : Ao(m.anchor.element);
      ((it = e?.rect ?? ns(m.anchor.value)),
        (ot = e?.borderRadius),
        (at =
          m.target.mode === `design` ? `hover-box` : Ss(m.anchor.value, it, C.width, C.height)));
    } else
      m?.anchor.type === `region` && m.target.mode === `create`
        ? ((it = ns(m.anchor.value)), (at = bs(m.anchor.value, it, C.width, C.height)))
        : i != null &&
          ((it = i.rect), (ot = i.borderRadius), (at = Ss(null, it, C.width, C.height)));
  let st = A == null ? null : it,
    ct = qe ? [] : Mo(v, m, _e, he),
    lt = de && !qe && m == null && x == null && nt == null ? i : null,
    ut =
      !qe && Je != null
        ? _s(Je, C, { includeElementFrameScroll: !0, viewportSize: Ye, zoomFactor: O })
        : null,
    dt = ut == null ? null : Xe == null ? p(le) + 1 : (pe.get(Xe.id) ?? null),
    N = {
      ...mc,
      [Ws]: String(k),
      "--browser-sidebar-draft-marker-size": `${26 * k}px`,
      "--browser-sidebar-marker-label-font-size": `${10 * k}px`,
      "--browser-sidebar-marker-label-offset": `${-0.5 * k}px`,
      "--browser-sidebar-metadata-column-gap": `${12 * k}px`,
      "--browser-sidebar-metadata-height": `${Bs * k}px`,
      "--browser-sidebar-metadata-padding-x": `${10 * k}px`,
      "--browser-sidebar-metadata-padding-y": `${8 * k}px`,
      "--browser-sidebar-metadata-radius": `${12 * k}px`,
      "--browser-sidebar-metadata-row-gap": `${3 * k}px`,
      "--browser-sidebar-overlay-font-size": `${13 * k}px`,
      "--browser-sidebar-saved-marker-size": `${Hs * k}px`,
    };
  (O !== 1 &&
    ((N.height = `${O * 100}vh`),
    (N.transform = `scale(${1 / O})`),
    (N.transformOrigin = `top left`),
    (N.width = `${O * 100}vw`)),
    D === `comment` && m == null && ((N.cursor = Xs), (N.pointerEvents = `auto`)));
  let P = (0, H.useEffectEvent)((e) => {
    t.sendMessageToHost({
      type: `browser-sidebar-runtime-comment-screenshot-ready`,
      commentId: e,
      annotationViewportRect: st,
      ...($e == null ? {} : { markerViewportPoint: $e }),
      ...(tt ? { skipScreenshotCapture: !0 } : {}),
    });
  });
  (0, H.useEffect)(() => {
    if (Ge == null || g == null) {
  ...
  let ft = (0, U.jsxs)(U.Fragment, {
    children: [
      He ? (0, U.jsx)(Ia, {}) : null,
      rt.map((e) => {
        let t = ns(e.anchor);
        return t == null || !is(e.anchor)
          ? null
          : (0, U.jsx)(
              `div`,
              { className: xs(e.anchor, t, C.width, C.height), style: gs(t, O) },
              e.id,
            );
      }),
      it ? (0, U.jsx)(`div`, { className: at, style: gs(it, O, ot) }) : null,
      ct.map((e) =>
        (0, U.jsx)(
          `div`,
          {
            ...
            style: gs(e.rect, O, e.borderRadius),
          },
          e.key,
        ),
      ),
      lt == null
        ? null
        : (0, U.jsx)(Ba, { snapshot: lt, viewportScale: n.viewportScale, zoomFactor: O }),
      Ve || qe
        ? (0, U.jsxs)(`div`, {
            ...
            children: [
              ut == null
                ...
                : (0, U.jsx)(za, {
                    ...
                    markerPoint: ut,
                    onFocusEditor: () => {
                      t.sendMessageToHost({ type: `browser-sidebar-runtime-focus-editor` });
                    },
                  }),
              Ze.map(({ comment: e, commentNumber: n }, r) =>
                (0, U.jsx)(
                  Ra,
                  {
                    commentNumber: n,
                    isSelected: m?.target.mode === `edit` && m.target.commentId === e.id,
                    markerPoint: Qe[r],
                    onMouseEnter: () => {
                      m ?? ke(e);
                    },
                    ...
                    onClick: (n) => {
                      if (n.isTrusted) {
                        if ((n.preventDefault(), n.stopPropagation(), m != null)) {
                          t.sendMessageToHost({ type: `browser-sidebar-runtime-focus-editor` });
                          return;
                        }
                        Oe(e);
  ...
  return (0, U.jsx)(Pa, {
    ...
    children: (0, U.jsxs)(`div`, {
      ...
      style: N,
      children: [(0, U.jsx)(`style`, { children: hc }), He ? (0, U.jsx)(Fa, { children: ft }) : ft],
    }),
  });
}
function Pa({ children: e, config: t }) {
  return (0, U.jsx)(Fi, {
...
function La(e, t) {
  return e.anchor.kind === `region`
    ? { type: `region`, themeVariant: e.themeVariant ?? cs(), value: e.anchor }
    : {
        type: `element`,
        element: t,
        themeVariant: e.themeVariant ?? cs(),
        value: e.anchor,
        viewportSize: ss(),
      };
}
function Ra({
  ...
  return (0, U.jsx)(`button`, {
    ...
    onMouseLeave: a,
    onClick: r,
    children: (0, U.jsx)(`span`, { className: `marker-label`, children: e }),
  });
}
function za({ commentNumber: e, markerPoint: t, onFocusEditor: n }) {
  let r = mi().formatMessage({
  ...
  return (0, U.jsx)(`button`, {
    ...
    children: e == null ? null : (0, U.jsx)(`span`, { className: `marker-label`, children: e }),
  });
}
function Ba({ snapshot: e, viewportScale: t, zoomFactor: n }) {
  return (0, U.jsxs)(`div`, {
    className: `element-metadata-tooltip`,
    style: ps(e.rect, { viewportScale: t, zoomFactor: n }),
    children: [
      (0, U.jsx)(`div`, {
...
function Va(e, t, n) {
  let r = ss(),
    ...
    a = { x: t, y: n };
  return {
    anchor: go(e, i ?? { x: t, y: n, width: 0, height: 0 }, a, i == null ? !1 : oa(e), r.width),
    themeVariant: cs(),
    viewportRect: i,
    viewportPoint: a,
    viewportSize: r,
...
function Ha(e, t, n) {
  if (e.anchor.kind === `region`) return Ua(e.anchor, n, e.themeVariant);
  let r = ss(),
    i = t == null ? e.anchor : B(t, e.anchor, r, e.markerViewportPoint),
    a = as(i, n);
  return {
    anchor: i,
    themeVariant: e.themeVariant ?? cs(),
    viewportRect: t == null ? ns(e.anchor) : Oo(t),
    viewportPoint: a,
    viewportSize: r,
  };
}
function Ua(e, t, n) {
  ...
  return {
    ...
    themeVariant: n ?? cs(),
    viewportRect: ns(e),
    viewportPoint: as(e, t),
    viewportSize: { width: r.width, height: r.height },
  };
}
function Wa(e, t, n) {
  if (e.anchor.type === `region`) return Ua(e.anchor.value, t, e.anchor.themeVariant);
  let r = e.anchor.element == null || !e.anchor.element.isConnected ? null : Oo(e.anchor.element),
    i = ss(),
    a =
      e.anchor.element == null || !e.anchor.element.isConnected
        ? e.anchor.value
        : B(e.anchor.element, e.anchor.value, i),
    o =
      e.target.mode === `design`
        ? (e.anchor.cardViewportRect ??
          (r == null ? void 0 : ms(r, { viewportScale: n, zoomFactor: t })))
        : void 0;
  return {
    anchor: a,
    ...(o == null ? {} : { cardViewportRect: o }),
    themeVariant: e.anchor.themeVariant ?? cs(),
    viewportRect: r,
    viewportPoint: as(a, t),
    viewportSize: i,
  };
}
function Ga(e, t, n, r) {
  ...
  if (e.anchor.type === `region`)
    return Ua(e.anchor.value, r, a.themeVariant ?? e.anchor.themeVariant);
  let o = vo(a, n) ?? null;
  o != null && n.set(a.id, o);
  let s = ss(),
    c = o == null ? e.anchor.value : B(o, e.anchor.value, s, a.markerViewportPoint);
  return {
    anchor: c,
    ...(a.themeVariant == null ? {} : { themeVariant: a.themeVariant }),
    viewportRect: o == null ? ns(c) : Oo(o),
    viewportPoint: as(c, r),
    viewportSize: s,
  };
}
function Ka(e, t) {
  ...
  if (n.kind === `region`)
    return {
      ...
      anchor: {
        type: `region`,
        ...(e.anchorState.themeVariant == null ? {} : { themeVariant: e.anchorState.themeVariant }),
        value: n,
      },
    };
  let r = wo(n, e.target.mode === `edit` ? e.target.commentId : void 0, t) ?? null;
  return (
    r != null && e.target.mode === `edit` && t.set(e.target.commentId, r),
    {
      ...
      anchor: {
        type: `element`,
        ...(e.anchorState.cardViewportRect == null
          ? {}
...
function Ja(e) {
  let t = new Map(),
    n = () => {
      ...
      for (let i of e) {
        ...
        if (e == null) continue;
        let a = t.get(i);
        a?.document !== e && (Ya(a?.cleanup), t.set(i, { cleanup: r(e, i, n), document: e }));
      }
      for (let [e, n] of t) i.has(e) || (Ya(n.cleanup), t.delete(e));
    },
    r = (t, n, r) => {
      let i = e(t, n, r),
        a = (e) => {
  ...
  return (
    n(),
    () => {
      for (let { cleanup: e } of t.values()) Ya(e);
      t.clear();
    }
  );
}
...
function Za(e, t = Xs) {
  let n = e.querySelector(`style[${Qs}]`);
  if (n instanceof HTMLStyleElement) return ((n.textContent = tc(t)), n);
  let r = e.createElement(`style`);
  return (
    r.setAttribute(Qs, `true`), (r.textContent = tc(t)), (e.head ?? e.documentElement).append(r), r
  );
}
function Qa() {
...
function $a(e, t) {
  ...
  return Ji(r) && r.src !== `` ? r.src : n;
}
function eo(e, t, n) {
  let r = n == null ? uo(e, t) : io(e, t, n);
  return r == null ? null : no(r);
}
function to(e) {
  let t = e.composedPath().find((e) => e instanceof HTMLElement);
  return t instanceof HTMLElement ? no(t) : null;
}
function no(e) {
  if (As(e)) return null;
  if (Ki(e)) return e;
  let t = po(e);
  return t == null || Ki(t) || As(t) ? null : t;
}
function ro(e, t) {
  return e == null ? null : eo(e.x, e.y, t);
}
function io(e, t, n) {
  let r = n.shadowRoot?.querySelector(`[data-browser-comment-root]`);
  if (!(r instanceof HTMLElement)) return uo(e, t);
  let i = n.shadowRoot?.querySelector(`[${$s}]`),
    a = n.shadowRoot?.querySelector(`[${ec}]`),
...
function oo(e, t) {
  return e.deltaMode === rc
    ? { x: e.deltaX * ac, y: e.deltaY * ac }
    : e.deltaMode === ic
...
function so(e, t, n) {
  let r = e;
  for (; r != null && r !== n.document.body && r !== n.document.documentElement; ) {
    if (co(r, t, n)) return r;
    r = r.parentElement;
  }
  return null;
}
function co(e, t, n) {
  ...
  return (
    (Gi(r.overflowY) && lo(t.y, e.scrollTop, e.clientHeight, e.scrollHeight)) ||
    (Gi(r.overflowX) && lo(t.x, e.scrollLeft, e.clientWidth, e.scrollWidth))
  );
}
function lo(e, t, n, r) {
...
function mo(e, t) {
  ...
  return [`a`, `button`, `input`, `textarea`, `select`, `label`, `img`].includes(n) ||
    e.getAttribute(`role`) != null
    ? !0
    : $i(e) != null && t.width >= 24 && t.height >= 16;
}
function z(e, t, n, r) {
...
function B(e, t, n, r) {
  let i = Oo(e);
  return i == null ? t : go(e, i, z(t, i, n, r), oa(e), n?.width);
}
function ho(e) {
  return e.type === `region` || e.element == null || !e.element.isConnected
    ? e.value
    : B(e.element, e.value, e.viewportSize);
}
function go(e, t, n, r, i = window.innerWidth) {
  let a = la(e),
    o = na(e),
    s = o == null ? null : aa(e),
    c = ua(a),
    l = sa(a, { x: n.x - c.x, y: n.y - c.y }),
    u = Qa(),
    d = ea(e),
    f = jo(e),
    p = new Da(u).getElementDocumentContext({
  ...
  return {
    ...
    rect: { x: t.x, y: r ? t.y : t.y + window.scrollY, width: t.width, height: t.height },
    isFixed: r,
    role: e.getAttribute(`role`),
    name: e.getAttribute(`aria-label`) ?? $i(e),
    selector: s,
    framePath: o ?? [],
    nearbyText: d,
    ...(f == null ? {} : { immediateText: f }),
    ...(p == null ? {} : { documentContext: p }),
    ...(l.length === 0 ? {} : { scrollContainers: l }),
  };
}
function _o(e, t, { framePath: n = [], frameUrl: r = null } = {}) {
  let i = ra(n) ?? window,
    a = ua(i),
    ...
    c = sa(i, o),
    l = Qa(),
    u = new Da(l).getRegionDocumentContext({
      documentTitle: document.title,
      fallbackWindow: window,
      frameWindow: i,
      viewportRect: s,
  ...
  return {
    ...
    framePath: n,
    nearbyText: null,
    ...(u == null ? {} : { documentContext: u }),
    ...(c.length === 0 ? {} : { scrollContainers: c }),
  };
}
function vo(e, t) {
  return wo(e.anchor, e.id, t);
}
function yo(e, t, n = !1) {
  if (e.anchor.kind === `region`) return e;
  let r = us(e),
    i = wo(e.anchor, e.id, t);
  return i == null
    ? !n && e.anchor.selector != null && V(e.anchor.pageUrl, Qa())
      ? null
      : r == null
        ? e
        : { ...e, markerViewportSize: r }
    : (t.set(e.id, i),
      {
        ...e,
        ...(r == null ? {} : { markerViewportSize: r }),
        anchor: B(i, e.anchor, r, e.markerViewportPoint),
      });
}
function bo(e, t) {
  if (!xo(e)) return null;
  let n = wo(e.anchor, e.id, t);
  return n == null
    ? null
    : (t.set(e.id, n), { ...e, anchor: B(n, e.anchor, e.viewportSize, e.markerViewportPoint) });
}
function xo(e) {
  return V(e.anchor.pageUrl, window.location.href);
}
function So(e) {
  return V(e.anchor.pageUrl, window.location.href);
}
function V(e, t) {
  ...
  return n == null || r == null
    ...
    : (n.protocol === `http:` || n.protocol === `https:`) &&
      ...
      ? n.origin === r.origin && n.pathname === r.pathname && n.search === r.search
...
function wo(e, t, n) {
  if (e.kind === `region`) return null;
  if (t != null) {
    let e = n.get(t) ?? null;
    if (e) {
      if (e.isConnected) return Oo(e) == null ? null : e;
      n.delete(t);
    }
  }
  if (e.selector == null || !V(e.pageUrl, Qa())) return null;
  try {
    let t = ia(e.framePath);
    return t == null ? null : To(t, e);
  } catch {
    return null;
  }
}
function To(e, t) {
  ...
  let n = Array.from(e.querySelectorAll(t.selector)).filter(qi);
  if (n.length === 0) return null;
  let r = n.filter((e) => Oo(e) != null);
  if (r.length === 0) return null;
  let i = r;
  if (t.name != null) {
    let e = i.filter((e) => Do(e) === t.name);
    e.length > 0 && (i = e);
  }
...
function Eo(e, t) {
  ...
  (e.name != null && r === e.name && (n += 1e3),
    ...
    e.title === Qi(t) && (n += 250),
    e.elementPath === ta(t) && (n += 25));
  let i = Oo(t),
    a = ns(e);
  return i == null || a == null ? n : n - Math.abs(i.x - a.x) - Math.abs(i.y - a.y);
}
function Do(e) {
  return e.getAttribute(`aria-label`) ?? $i(e);
}
function Oo(e) {
  if (!e.isConnected || !ko(e)) return null;
  let t = la(e),
...
function Mo(e, t, n, r) {
  if (e == null || (e !== `gap` && e !== `row-gap` && e !== `column-gap`)) return [];
  let i =
    t?.anchor.type === `element` ? t.anchor.element : n == null ? null : (r.get(n.id) ?? null);
  if (i == null) return [];
  let a = la(i).getComputedStyle(i);
...
function No(e) {
  let t = la(e).getComputedStyle(e);
  return m(t, t.display === `flex` || t.display === `inline-flex` ? [...dc, ...fc] : dc);
}
function Po(e, t, n, r) {
  let i = r ?? Ao(e),
    a = n?.id ?? Ro(),
    o = Bo(e),
    s = Io(i?.styles ?? [], n?.declarations ?? []),
    c =
      o == null
        ? n?.text
        : n?.text == null
...
function Ho(e) {
  return Ja((t) => {
    let n = () => {
      (Uo(t, e), Go(t, e), Wo(t, e));
    };
    n();
    let r = new MutationObserver(n);
    return (
      r.observe(t.documentElement, Gs),
      () => {
        (r.disconnect(), qo(t), t.getElementById(lc)?.remove());
        for (let e of t.querySelectorAll(`[${sc}]`)) e.removeAttribute(sc);
      }
    );
  });
}
function Uo(e, t) {
  ...
  for (let t of e.querySelectorAll(`[${sc}]`)) qi(t) && (Zo(t, n.get(t)), n.delete(t));
  for (let [e, t] of n) Zo(e, t);
}
function Wo(e, t) {
  let n = $o(t),
    r = e.getElementById(lc);
  if (n.length === 0) {
    r?.remove();
    return;
  }
...
function Go(e, t) {
  ...
  for (let t of e.querySelectorAll(`[${sc}], [${cc}]`)) {
    if (!qi(t)) continue;
    let e = Ko(
      Qo(t)
        .map((e) => n.get(e))
    ...
    (t.hasAttribute(cc) || t.setAttribute(cc, e.previousValue), Yo(t, e.value));
  }
}
function Ko(e) {
...
function qo(e) {
  for (let t of e.querySelectorAll(`[${cc}]`)) qi(t) && Jo(t);
}
function Jo(e) {
  let t = e.getAttribute(cc);
  t != null && (Yo(e, t), e.removeAttribute(cc));
}
function Yo(e, t) {
...
function Xo(e, t) {
  let n = new Set(Qo(e));
  (n.add(t), e.setAttribute(sc, Array.from(n).join(` `)));
}
function Zo(e, t) {
  let n = t == null ? `` : Array.from(t).join(` `);
  if (n.length === 0) {
    e.removeAttribute(sc);
    return;
  }
  e.getAttribute(sc) !== n && e.setAttribute(sc, n);
}
function Qo(e) {
  return (e.getAttribute(sc) ?? ``).split(/\s+/).filter((e) => e.length > 0);
}
function $o(e) {
  return te(e, sc);
}
function es(e, t, n) {
  let r = new Set();
  for (let n of t)
    if (So(n) && n.anchor.scrollContainers != null && ra(n.anchor.framePath) === e)
...
function ts(e, t, n) {
  ...
  return (
    r.observe(e.documentElement, Gs),
    () => {
      r.disconnect();
    }
  );
...
function ns(e) {
  if (e == null) return null;
  let t = ra(e.framePath),
    n = ca(e, t ?? window);
  if (e.kind === `region` && t != null && t !== window) {
    let r = ua(t);
    return {
      x: e.rect.x + r.x - n.x,
      y: e.rect.y + r.y - (e.isFixed ? 0 : t.scrollY) - n.y,
      width: e.rect.width,
...
function rs(e, t = os(), { includeElementFrameScroll: n = !1, markerPointInset: r = Vs } = {}) {
  let i = ra(e.framePath),
    a = ca(e, i ?? window);
  if (e.kind === `region` && i != null && i !== window) {
    let n = ua(i);
    return {
      x: js(n.x + (e.point.xPercent / 100) * i.innerWidth - a.x, r, t.width - r),
      y: n.y + e.point.y - (e.isFixed ? 0 : i.scrollY) - a.y,
    };
  }
  let o = n && e.kind === `element` && i != null && i !== window ? i.scrollY : 0;
  return {
    x: js((e.point.xPercent / 100) * t.width - a.x, r, t.width - r),
    y: (e.isFixed ? e.point.y : e.point.y - t.scrollY - o) - a.y,
  };
}
function is(e, t = rs(e)) {
  ...
  for (let i of e.framePath) {
    ...
    let a = ua(r),
      ...
      s = { left: a.x + o.left, top: a.y + o.top, right: a.x + o.right, bottom: a.y + o.bottom };
    if (t.x < s.left || t.x > s.right || t.y < s.top || t.y > s.bottom) return !1;
    let c = Xi(e);
    if (c == null) return !1;
    ((r = c), (n = c.document));
  }
...
function as(e, t, n) {
  let r = fs(os(), n),
    i = Vs / t,
    a = rs(e, r, { markerPointInset: i });
  return { x: a.x, y: js(a.y, i, r.height - i) };
}
function os() {
  return { height: window.innerHeight, scrollY: window.scrollY, width: window.innerWidth };
}
function ss() {
...
function us(e) {
  let t = ds(e.anchor, e.markerViewportPoint);
...
function ds(e, t) {
  ...
  return {
    height: Math.max(window.innerHeight, t.y + Vs),
    width: Math.max(window.innerWidth, n, t.x + Vs, e.rect.x + e.rect.width),
  };
}
function fs(e, t) {
...
function ps(
  ...
  let i = ms(e, { viewport: t, viewportScale: n, zoomFactor: r });
  return ls(n) === 1
...
function ms(
  ...
  return ee(e, { viewport: t, viewportScale: n, zoomFactor: r });
}
function hs(e, t, { viewportScale: n, zoomFactor: r }) {
  let i = ms(t, { viewportScale: n, zoomFactor: r }),
...
function gs(e, t, n) {
  let r = vs(e, t);
  return { borderRadius: n, left: r.x, top: r.y, width: r.width, height: r.height };
}
function _s(e, t, { includeElementFrameScroll: n = !1, viewportSize: r, zoomFactor: i }) {
  let a = rs(e, fs(t, r), { includeElementFrameScroll: n, markerPointInset: Vs / i });
...
function Cs(e, t, n, r) {
  return ws(e) && Ts(t, n, r);
}
function ws(e) {
  return e == null ? new Da(Qa()).isGoogleDocsPage() : Da.isGoogleDocsAnchor(e);
}
function Ts(e, t, n) {
  return e == null || t <= 0 || n <= 0 ? !1 : e.width >= t * qs && e.height >= n * Js;
}
function Es(e, t) {
...
function Os(e) {
  return e.composedPath().some((e) => e instanceof HTMLElement && e.hasAttribute($s));
}
function ks(e, { preventDefault: t = !0 } = {}) {
  (t && e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation?.());
}
function As(e) {
  if (e.id === Rs || e.closest(`#${Rs}`) != null) return !0;
  let t = e.getRootNode();
  return t instanceof ShadowRoot && t.host instanceof HTMLElement && t.host.id === Rs;
}
function js(e, t, n) {
  return Math.min(Math.max(e, t), n);
}
...
function Fs(e, t) {
  let n = e.isDraggingRegion || Ns(e.start, t);
  return { ...e, current: t, rect: n ? Ps(e.start, t) : null, isDraggingRegion: n };
}
var H,
  Is,
  Ls,
  ...
  gc = o(() => {
    (xe(),
      ...
      Oa(),
      (U = Aa()),
      (Rs = `codex-browser-sidebar-comments-root`),
      (zs = 4),
      (Bs = 72),
      (Vs = 29),
      (Hs = 25),
      (Us = new WeakMap()),
      (Ws = `--browser-sidebar-overlay-size-scale`),
      (Gs = {
        attributeFilter: [
          `aria-hidden`,
          `aria-expanded`,
      ...
      (qs = 0.45),
      (Js = 0.3),
      (Ys = `data:image/svg+xml,%3Csvg%20width%3D%2226%22%20height%3D%2225%22%20viewBox%3D%220%200%2026%2025%22%20fill%3D%22none%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M12.6504%200.824799C6.21496%200.824799%200.825466%205.77554%200.825195%2012.0885C0.825245%2014.2375%201.46183%2016.2421%202.55176%2017.943L2.02148%2020.235L1.99316%2020.3756C1.77603%2021.655%202.78945%2022.7791%204.02832%2022.7691L4.0791%2022.8209L4.53418%2022.7047L7.12305%2022.0426C8.77593%2022.8778%2010.6577%2023.3531%2012.6504%2023.3531C19.086%2023.3531%2024.4754%2018.4014%2024.4756%2012.0885C24.4753%205.77554%2019.0858%200.824799%2012.6504%200.824799Z%22%20fill%3D%22%230285FF%22%20stroke%3D%22white%22%20stroke-width%3D%221.65%22%2F%3E%3C%2Fsvg%3E`),
      (Xs = `url("${Ys}") 13 12, crosshair`),
      (Zs = `url("${Ys}")`),
      (Qs = `data-browser-comment-cursor-style`),
      ($s = `data-browser-comment-interaction-blocker`),
      (ec = `data-browser-comment-interaction-layer`),
      (tc = (e) =>
        `html, body, body *, #${Rs}, #${Rs} * { cursor: ${e} !important; -webkit-user-select: none !important; user-select: none !important; }`),
      (nc = 100),
      (rc = 1),
      (ic = 2),
      (ac = 16),
      (oc = 5e3),
      (sc = `data-codex-browser-design-group`),
      (cc = `data-codex-browser-design-original-text`),
      (lc = `codex-browser-design-draft-style`),
      (uc = () => {}),
      (dc = [
        `color`,
        `background-color`,
      ...
      (fc = [`flex-direction`, `justify-content`, `align-items`, `gap`, `row-gap`, `column-gap`]),
      (pc = []),
      (mc = {
        position: `fixed`,
        inset: 0,
...
.marker{position:fixed;border:0;background:transparent ${Zs} center / contain no-repeat;transform:translate(-50%,-50%);pointer-events:auto;cursor:pointer;display:flex;align-items:center;justify-content:center;padding:0}
...
(document.readyState === `loading`
  ? window.addEventListener(`DOMContentLoaded`, wc, { once: !0 })
  : wc(),
  window.addEventListener(`mousedown`, Ec, !0),
  window.addEventListener(`mouseup`, Tc, !0),
  window.addEventListener(`auxclick`, Ec, !0),
  window.addEventListener(`dragstart`, jc, !0),
  window.addEventListener(`dragend`, Mc, !0),
  window.addEventListener(`keydown`, Ac, !0));
function wc() {
  _c ??
    Ve(
      async () => {
        let { mountBrowserSidebarCommentRuntime: e } = await Promise.resolve().then(
          () => (gc(), ja),
        );
...
function Tc(e) {
  ...
  t == null ||
    !e.isTrusted ||
    (Ec(e),
    d.ipcRenderer.invoke(ke, { type: `browser-sidebar-runtime-mouse-navigation`, direction: t }));
}
function Ec(e) {
  Dc(e) != null && (e.preventDefault(), e.stopPropagation());
}
function Dc(e) {
...
function kc(e, t) {
  return t.some((t) => !t.includes(` `) && Ne(e, t));
}
function Ac(e) {
  if (!e.isTrusted || e.defaultPrevented || Sc == null || e.composedPath().some(Oc)) return;
  let t = null;
  (kc(e, Sc.backAccelerators) ? (t = `back`) : kc(e, Sc.forwardAccelerators) && (t = `forward`),
    t != null &&
      (e.preventDefault(),
      e.stopImmediatePropagation(),
      d.ipcRenderer.invoke(ke, {
...
function jc(e) {
  ...
  n == null ||
    n.length === 0 ||
    ((xc = !0),
    d.ipcRenderer.invoke(ke, { type: `browser-sidebar-runtime-image-drag-started`, sourceUrl: n }));
}
function Mc(e) {
  !e.isTrusted ||
    !xc ||
    ((xc = !1), d.ipcRenderer.invoke(ke, { type: `browser-sidebar-runtime-image-drag-ended` }));
}
function Nc(e) {
...
function Pc() {
  return {
    ...
    subscribeToHostMessages(e) {
      ...
      return (
        d.ipcRenderer.on(Oe, t),
        bc != null && (e(bc), (bc = null)),
        () => {
          ((yc = !1), d.ipcRenderer.removeListener(Oe, t));
        }
      );
    },
  };
}
d.ipcRenderer.on(Oe, (e, t) => {
  switch (t.type) {
    case `browser-sidebar-runtime-sync`:
      Fc(t);
      return;
