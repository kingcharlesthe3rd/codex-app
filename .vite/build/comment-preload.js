...
function b(e) {
  ...
  return o == null || o.length === 0 ? null : { documentId: o, tabId: S(t) ?? void 0 };
}
function x(e) {
...
function oe(e, t) {
  ...
  for (let t of i.values()) {
    ...
    let i = t.reduce((t, n) => t + e[n].x, 0) / t.length - ((t.length - 1) * ye) / 2,
      o = i + (t.length - 1) * ye,
      s = i < n ? n - i : o > r ? r - o : 0;
    t.forEach((t, o) => {
    ...
    case `text`:
      return (
        ...
        (e.textLocator.kind === `form-control` ||
          (t.textLocator.kind === `dom` && e.textLocator.rangeText === t.textLocator.rangeText)) &&
        e.textLocator.selector === t.textLocator.selector &&
        e.textLocator.shadowHosts.length === t.textLocator.shadowHosts.length &&
        e.textLocator.shadowHosts.every((e, n) => e === t.textLocator.shadowHosts[n]) &&
        ...
        e.selectionRects.every((e, n) => {
          ...
          return (
            r != null && e.x === r.x && e.y === r.y && e.width === r.width && e.height === r.height
          );
        })
      );
  }
...
var Ee,
  ...
  Oe,
  ke = o(() => {
    ((Ee = [25, 33, 50, 67, 75, 80, 90, 100, 110, 125, 150, 175, 200, 250, 300, 400, 500]),
      (De = Ee[0]),
      (Oe = Ee[Ee.length - 1]));
  });
(Ce(), ke());
...
function Be(e) {
  ...
  return t === ` `
    ...
    : t === `+`
      ? `Plus`
      : (Ne.get(t) ?? (/^f\d{1,2}$/i.test(t) || t.length === 1 ? t.toUpperCase() : (Ve(n) ?? t)));
}
function Ve(e) {
  return e == null
    ? null
...
function Ue({ locationLike: e = location } = {}) {
  ...
  return {
    executeTool: async (e, r) => {
      ...
      return qe(await Ke({ client: n, input: i, registry: t, toolName: e?.name }));
    },
    getTools: () =>
      [...t.values()].map((t) => ({
        name: t.name,
    ...
    registerTool: (e, n) => {
      let r = Ge(e?.name),
        i = e.execute;
      if (typeof i != `function`) throw Error(`WebMCP tool ${r} is missing an execute callback.`);
...
function qe(e) {
  ...
  try {
    ...
    if (e === void 0) throw Error(`WebMCP tool result is not JSON-serializable.`);
    return e;
  } catch {
...
function $e() {
  ...
  if (t?.overrideGlobalPropertyFromIsolatedWorld != null) {
    t.overrideGlobalPropertyFromIsolatedWorld([`navigator`, `modelContext`], () => e);
    return;
  }
...
var et = function (e, t, n) {
      ...
      (e.createElement = function (e, t, n) {
        ...
        if (t != null)
          for (r in (t.key !== void 0 && (a = `` + t.key), t))
            C.call(t, r) && r !== `key` && r !== `__self` && r !== `__source` && (i[r] = t[r]);
      ...
      (e.startTransition = function (e) {
        ...
        try {
          var r = e(),
            i = S.S;
          (i !== null && i(n, r),
            typeof r == `object` && r && typeof r.then == `function` && r.then(te, ue));
        } catch (e) {
          ue(e);
        } finally {
  ...
  st = s((e) => {
    ...
    function _e(e) {
      (k.current === e && (E(O), E(k)), pe.current === e && (E(pe), (Qf._currentValue = le)));
    }
    var ve, ye;
    function be(e) {
      if (ve === void 0)
...
` +
    ...
    function mi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) di(e) && (s = 1);
        ...
        a: switch (e) {
          ...
          case ee:
            return ((e = ui(13, n, t, a)), (e.elementType = ee), (e.lanes = o), e);
          case te:
            return ((e = ui(19, n, t, a)), (e.elementType = te), (e.lanes = o), e);
          default:
    ...
    function La(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === g
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` && i && i.$$typeof === C && Oa(i) === t.type))
            ? ((t = a(t, n.props)), Fa(t, n), (t.return = e), t)
            : ((t = mi(n.type, n.key, n.props, null, e.mode, r)), Fa(t, n), (t.return = e), t);
      }
      function u(e, t, n, r) {
        return t === null ||
          t.tag !== 4 ||
      ...
      function f(e, t, n) {
        ...
        if (typeof t == `object` && t) {
          switch (t.$$typeof) {
            case m:
              return (
                (n = mi(t.type, t.key, t.props, null, e.mode, n)), Fa(n, t), (n.return = e), n
              );
            case h:
                ...
                for (var l = o.key; r !== null; ) {
                  if (r.key === l) {
                    if (((l = o.type), l === g)) {
                      ...
                      r.elementType === l ||
                      (typeof l == `object` && l && l.$$typeof === C && Oa(l) === r.type)
                    ) {
    ...
    function so(e) {
      e.tag === 22 ? (D(uo, uo.current), D(ro, e), io === null && (io = e)) : co(e);
    }
    function co() {
    ...
    function Ns(e, t, n) {
      ...
      ((n = {
        ...
        Ls(e) ? Rs(t, n) : ((n = ii(e, t, n, r)), n !== null && (hu(n, e, r), zs(n, t, r))));
    }
    function Ps(e, t, n) {
      Fs(e, t, n, pu());
    }
    function Fs(e, t, n, r) {
      ...
      if (Ls(e)) Rs(t, i);
        ...
        if (((n = ii(e, t, i, r)), n !== null)) return (hu(n, e, r), zs(n, t, r), !0);
      }
      return !1;
    }
    function Is(e, t, n, r) {
    ...
    function Rc(e, t) {
      (t !== null && (e.flags |= 4),
        e.flags & 16384 && ((t = e.tag === 22 ? 536870912 : Qe()), (e.lanes |= t), (Yl |= t)));
    }
    function zc(e, t) {
      if (!R)
        switch (e.tailMode) {
    ...
    function Bc(e, t, n) {
      ...
      switch ((Ni(t), t.tag)) {
        ...
        case 27:
          if ((_e(t), (n = A.current), (a = t.type), e !== null && t.stateNode != null))
            ...
            ((e = O.current), Hi(t) ? Bi(t, e) : ((e = ff(a, r, n)), (t.stateNode = e), Fc(t)));
          }
          return (H(t), null);
        case 5:
                ...
                for (e = t.child; e !== null; ) {
                  if (((o = fo(e)), o !== null)) {
                    for (
                      ...
                      (pi(n, e), (n = n.sibling));
                    return (D(uo, (uo.current & 1) | 2), R && Ai(t, r.treeForkCount), t.child);
                  }
                  e = e.sibling;
                }
              r.tail !== null &&
    ...
    function Au(e, t) {
      ...
      var r = Tu(),
        a = Eu();
      K !== e || J !== t ? ((nu = null), (tu = Ae() + 500), Su(e, t)) : (Hl = j(e, t));
      a: do
        try {
          if (Y !== 0 && q !== null) {
            t = q;
    ...
    function cd(e, t) {
      ...
      var r = J;
      return (
        (r = Xe(e, e === K ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1)),
        r === 0
          ? null
          : (gu(e, r, t),
            sd(e, Ae()),
    ...
    function md(e, t, n, r, i) {
      if (t === `submit` && n && n.stateNode === i) {
        var a = fd((i[N] || null).action),
          o = r.submitter;
        o &&
          ((t = (t = o[N] || null) ? fd(t.formAction) : o.getAttribute(`formAction`)),
          t !== null && ((a = t), (o = null)));
    ...
    function Cd(e, t, n, r) {
      ...
      ((n = i.bind(null, t, n, e)),
        (i = void 0),
        !I || (t !== `touchstart` && t !== `touchmove` && t !== `wheel`) || (i = !0),
        r
          ? i === void 0
        ...
        if (!(t & 7)) {
          a: {
            if (
              ...
              c && n !== rn && (u = n.relatedTarget || n.fromElement) && (bt(u) || u[pt]))
            )
              break a;
            if (
              (l || c) &&
...
`,
    ...
    function Vf(e, t, n) {
      ...
      for (r.set(e, null), n = n.getElementsByTagName(e), i = 0; i < n.length; i++) {
        var a = n[i];
        if (
          !(a[vt] || a[M] || (e === `link` && a.getAttribute(`rel`) === `stylesheet`)) &&
...
var yn,
  ...
  Rn = o(() => {
    (N(),
      ...
      (On = !0));
    try {
      On = pn(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`).exec(`a`)?.[0] === `a`;
    } catch {
      On = !1;
    }
    ((kn = xn
      ...
      (Ln = (function () {
        ...
        return (
          ...
          (e.prototype.tryParseLeftAngleBracket = function () {
            return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !hn(this.peek() || 0))
              ? (this.bump(), `<`)
              : null;
          }),
          ...
          (e.prototype.parseArgumentOptions = function (e, t, n, r) {
            ...
            switch (a) {
              ...
              case `select`:
                ...
                if ((this.bumpSpace(), !this.bumpIf(`,`)))
                  return this.error(P.EXPECT_SELECT_ARGUMENT_OPTIONS, I(h, M({}, h)));
                this.bumpSpace();
                ...
                return a === `select`
                  ? {
                      val: { type: F.select, value: n, options: jn(v.val), location: y },
                      err: null,
                    }
                  : {
                      val: {
...
function Bn(e) {
  e.forEach(function (e) {
    if ((delete e.location, Nt(e) || Pt(e)))
      for (var t in e.options) (delete e.options[t].location, Bn(e.options[t].value));
    else
  ...
  Jn = o(() => {
    (N(),
      ...
      (Kn = (function (e) {
        lt(t, e);
        function t(t, n, r) {
          return e.call(this, `Value for "${t}" must be of type ${n}`, Un.INVALID_VALUE, r) || this;
        }
        return t;
      })(Wn)),
      (qn = (function (e) {
...
function Yn(e) {
  return e.length < 2
    ...
    : e.reduce(function (e, t) {
        var n = e[e.length - 1];
        return (
          !n || n.type !== Qn.literal || t.type !== Qn.literal ? e.push(t) : (n.value += t.value), e
        );
      }, []);
}
function Xn(e) {
...
function Zn(e, t, n, r, i, a, o) {
  if (e.length === 1 && Ot(e[0])) return [{ type: Qn.literal, value: e[0].value }];
  for (var s = [], c = 0, l = e; c < l.length; c++) {
    ...
    if (Ft(u)) {
      typeof a == `number` && s.push({ type: Qn.literal, value: n.getNumberFormat(t).format(a) });
      continue;
    }
    var d = u.value;
    ...
    if (kt(u)) {
      ((!f || typeof f == `string` || typeof f == `number`) &&
        ...
        s.push({ type: typeof f == `string` ? Qn.literal : Qn.object, value: f }));
      continue;
    }
    if (jt(u)) {
      var p =
        typeof u.style == `string` ? r.date[u.style] : Rt(u.style) ? u.style.parsedOptions : void 0;
    ...
    if (It(u)) {
      ...
      (Array.isArray(_) || (_ = [_]),
        s.push.apply(
          s,
          _.map(function (e) {
            return { type: typeof e == `string` ? Qn.literal : Qn.object, value: e };
          }),
        ));
    }
    if (Nt(u)) {
          ...
          if (
            ...
            (this.format = function (e) {
              ...
              var n = t.reduce(function (e, t) {
                return (
                  !e.length || t.type !== Qn.literal || typeof e[e.length - 1] != `string`
                    ? e.push(t.value)
            ...
            (this.formatToParts = function (e) {
              return Zn(a.ast, a.locales, a.formatters, a.formats, e, void 0, a.message);
            }),
...
to autofix this issue`,
        ...
        if (((r = M(M({}, p), r || {})), (o = Or(o, f)), (l = Or(l, f)), !_)) {
          if (u === !1 && _ === ``) return _;
          if (((!h || (a && a.toLowerCase() !== c.toLowerCase())) && d(new mr(n, a)), h))
            try {
    ...
    (N(),
      ...
      (Ji = (function (e) {
        ...
        function t() {
          ...
          return (
            (t.cache = vr()),
            (t.state = { cache: t.cache, intl: zi(Ki(t.props), t.cache), prevConfig: Ki(t.props) }),
            t
          );
        }
        return (
          ...
          (t.prototype.render = function () {
            return (
              ...
              qi.createElement(Ei, { value: this.state.intl }, this.props.children)
            );
          }),
...
function ea(e) {
  ...
  return t.protocol !== `http:` && t.protocol !== `https:` ? !1 : $i(t.hostname);
}
var ta,
  na = o(() => {
...
function ha({ commentNumber: e, markerPoint: t, onFocusEditor: n }) {
  ...
  return (0, _a.jsx)(`button`, {
    ...
    children: e == null ? null : (0, _a.jsx)(`span`, { className: `marker-label`, children: e }),
  });
}
...
function Ha(e) {
  ...
  for (let n of e.querySelectorAll(`*`))
    (Sa(n) && t.push(n), z(n) && n.shadowRoot != null && t.push(...Ha(n.shadowRoot)));
  return t;
}
function Ua(e) {
  return (
...
function ro(e, t, n) {
  let r = e.createRange();
  try {
    return (r.selectNodeContents(t), Array.from(r.getClientRects()).some((e) => io(e, n)));
  } finally {
    r.detach();
  }
}
    ...
    (Ce(),
      ...
      (lo = class {
        ...
        getDocumentContext({ documentTitle: e, selectedText: t, visibleText: n }) {
          return te({ documentTitle: e, pageUrl: this.pageUrl, selectedText: t, visibleText: n });
        }
        ...
        getWindowSelectionText(e) {
          try {
            return Za(e.getSelection()?.toString()) ?? this.getActiveElementSelectionText(e);
          } catch {
            return null;
          }
        }
        getActiveElementSelectionText(e) {
          ...
          let n = t.selectionStart,
            r = t.selectionEnd;
          return n == null || r == null || r <= n ? null : Za(t.value.slice(n, r));
        }
...
function po(e) {
  ...
  switch (e.textLocator.kind) {
    ...
    case `form-control`:
      r =
        z(n) && Qo(n)
          ? jo(t, n, e.textLocator.startOffset, e.textLocator.endOffset, e.textLocator.direction)
          : null;
      break;
  }
    ...
    d = new MutationObserver((e) => {
      e.every(qo) ||
        ((a ||
          ...
          e.some((e) => e.type === `attributes` && Array.from(n).some((t) => t === e.target))) &&
          f(),
        s());
    }),
    f = () => {
      ...
      for (let s of e) {
        ...
        for (; l != null; ) (zo(l) ? (t.add(l), i.add(l)) : o.add(l), (l = l.parentNode ?? Ro(l)));
        let u = z(c) ? c : Ro(c);
        for (; u != null; ) (r.add(u), (u = u.parentElement ?? Ro(u.getRootNode())));
      }
      for (let e of t) d.observe(e, ns);
      for (let e of o)
        t.has(e) || d.observe(e, { ...(z(e) ? { attributes: !0 } : {}), childList: !0 });
...
function mo(e) {
  ...
  if (r == null || r.toString() !== e.textLocator.rangeText || !go(t)) return null;
...
function ho({ frameWindow: e, range: t, styleRoot: n }) {
  ...
  return (
    o.replaceSync(`::highlight(${ts}) { background-color: #128dff66 !important; }`),
...
function vo(e) {
  return (
    e.nodeType === Node.DOCUMENT_NODE || (e.nodeType === Node.DOCUMENT_FRAGMENT_NODE && `host` in e)
  );
}
function yo() {
  for (let e of Ta())
...
function Do(e, t, n, r) {
  let i = Oo(e, t, n);
  if (i == null || i.toString() !== n.rangeText || Vo(i, e) || r.length > 2e4) return null;
  let a = Go(i);
  return a.length === 0
    ? null
    : {
...
function ko(e) {
  ...
  return r <= n || t.value.slice(n, r).trim().length === 0
    ? null
    : jo(e, t, n, r, t.selectionDirection === `backward` ? `backward` : `forward`);
}
function Ao(e) {
...
function jo(e, t, n, r, i) {
  let a = Po(t),
    o = t.value.slice(n, r);
  if (a == null || a.selector == null || Ho(t, e) || o.trim().length === 0 || o.length > 2e4)
    return null;
  let s = Ko(t, n, r);
  return s.length === 0
    ? null
  ...
  return {
    anchor: {
      ...
      point: {
        ...
        y: e.isFixed ? e.viewportPoint.y : e.viewportPoint.y + e.frameWindow.scrollY,
      },
      rect: o,
      isFixed: e.isFixed,
      role: null,
...
function Vo(e, t) {
  ...
  if (n.nodeType === Node.TEXT_NODE) return n.parentElement != null && Ho(n.parentElement, t);
  let r = t.document.createTreeWalker(n, NodeFilter.SHOW_TEXT),
    i = r.nextNode();
  for (; i != null; ) {
    if (e.intersectsNode(i) && i.parentElement != null && Ho(i.parentElement, t)) return !0;
    i = r.nextNode();
  }
  return !1;
}
...
function Go(e) {
  ...
  return t.length > 1e3
    ...
    : Array.from(t)
        ...
        .map((e) => ({ x: e.left, y: e.top, width: e.width, height: e.height }));
}
function Ko(e, t, n) {
  ...
  (c.setAttribute(is, ``),
    ...
    (o !== 1 || s !== 1) &&
      ((c.style.transform = `scale(${o}, ${s})`), (c.style.transformOrigin = `top left`)));
...
function Jo(e, t) {
  ...
  for (; n != null; ) {
    ...
    if (r !== `` && r !== `none`) {
      ...
      if (t == null || t.length !== 6 || Math.abs(t[1] ?? 0) > 1e-6 || Math.abs(t[2] ?? 0) > 1e-6)
        return !0;
    }
...
function Zo(e, t) {
  let n = t ? e.at(-1) : e[0];
  return n == null ? { x: 0, y: 0 } : { x: t ? n.x + n.width : n.x, y: n.y + n.height / 2 };
}
function Qo(e) {
  if (e == null) return !1;
  let t = e.ownerDocument.defaultView,
    n = t?.HTMLInputElement,
    r = t?.HTMLTextAreaElement;
  return r != null && e instanceof r ? !0 : n != null && e instanceof n && $o.has(e.type);
}
var $o,
  es,
  ts,
  ...
  as = o(() => {
    (Ce(),
      ...
      (rs = [`animationcancel`, `animationend`, `load`, `transitioncancel`, `transitionend`]),
...
function cs({ rootHost: e, bridge: t }) {
  let [n, r] = (0, W.useState)(t.initialState),
    ...
    ye = _e.flatMap((e) => {
      let t = ae.get(e.id),
        n = Ks(e, ve, e.id === g, t?.sourceAnchor === e.anchor ? t.value : null);
      return n == null ? [] : [n];
    }),
    be = n.activeDesignChange,
    xe = O.flatMap((e) => (e.designChange == null ? [] : [e.designChange])),
    Se = he ? (be == null ? xe : [...xe.filter((e) => e.id !== be.id), be]) : Rl,
    ...
    ke = _e.some((e) => e.anchor.kind === `element` && e.anchor.selector != null),
    Ae = (0, W.useCallback)(
      (e, n) => (
        c != null &&
          (t.sendMessageToHost({
    ...
    Me = (0, W.useCallback)(
      (n) => {
        let r = dc(e),
          ...
          a = Gs(i, r) ?? null;
        (a != null && (r.set(i.id, a), i.designChange != null && wc(a, i.designChange.id)),
          c != null &&
            t.sendMessageToHost({
              type: `browser-sidebar-runtime-close-comment-preview`,
              commentId: c,
    ...
    Pe = (0, W.useCallback)(
      (r, i) => {
        ...
        let c = {
            ...i,
            cardViewportRect: Uc(e, o.rect, { viewportScale: n.viewportScale, zoomFactor: A }),
          },
          l = cc(r, c, void 0, o);
        return (
          wc(r, l.id),
    ...
    Re = (0, W.useCallback)(
      (e) => {
        ...
        return r == null
          ? (yo(), e.fallbackViewportPoint == null ? !1 : Ie(e.fallbackViewportPoint))
          : je(r);
      },
      [m, t, je, Ie],
    ),
  ...
  ((0, W.useEffect)(() => {
    ...
    return () => {
      (le.current != null && (window.cancelAnimationFrame(le.current), (le.current = null)), n());
    };
    ...
    (0, W.useEffect)(() => {
      let n = () => {
        ...
        r = (t, r) => {
          if (
            (s(r.altKey),
            !r.isTrusted || k !== `comment` || m != null || tl(r, e) || ce.current != null)
          ) {
            n();
            return;
          }
        ...
        i = (t, r, i) => {
          i.isTrusted && k === `comment` && m == null && !tl(i, e) && U(i, { preventDefault: !1 });
        ...
        c = ({ currentDragSelection: e, suppressFollowUpClick: r }) => {
          ...
          de.current = r;
          let a = e.rect,
            o = Ws(a, e.current, { framePath: e.framePath, frameUrl: e.frameUrl }),
            s = hs(o, A),
          ...
          return (
            ...
            window.requestAnimationFrame(() => {
              w.current === i &&
                ...
                h({
                  target: { mode: `create` },
                  anchor: { type: `region`, themeVariant: s.themeVariant, value: o },
                }),
                te(null),
                n());
            }),
        ...
        l = (t, n) => {
          ...
          if (
            ce.current != null &&
            c({ currentDragSelection: cl(ce.current, r), suppressFollowUpClick: !0 })
          ) {
            U(n);
            return;
          }
        ...
        u = (t, n) => {
          ...
          (k === `comment` && U(n),
            (re.current = { anchorState: ps(i, r.x, r.y), capturedAt: Date.now(), element: i }),
            ze(t));
        },
        d = (e, t) => {
        ...
        f = (e, t) => {
          ...
          if (
            ((ce.current = null),
            te(null),
            t.isTrusted && (U(t), !c({ currentDragSelection: r, suppressFollowUpClick: !0 })))
          ) {
        ...
        p = (e) => {
          e.pointerId === ce.current?.pointerId && ((ce.current = null), te(null));
        },
        g = (e) => {
          if (!(e.key !== `Escape` || !e.isTrusted)) {
            ...
            m == null &&
              k === `comment` &&
              (U(e), t.sendMessageToHost({ type: `browser-sidebar-runtime-exit-comment-mode` }));
          }
        },
        _ = (t) => {
    ...
    (0, W.useLayoutEffect)(() => {
      if (m != null || _e.length === 0 || (k !== `comment` && g == null)) return;
      let t = O.filter((e) => e.anchor.kind === `text` && Ys(e)),
        ...
        s = () => o();
      (window.addEventListener(`resize`, a), Oe && document.addEventListener(`scroll`, s, !0));
  ...
  let Ye = g == null ? null : (ye.find((e) => e.id === g) ?? null),
    ...
    nt =
      et == null
        ? null
        : (ye.find((e) => D(e.anchor, et)) ?? _e.find((e) => D(e.anchor, et)) ?? null),
    rt = x(Cs()),
    it = ye;
  j?.kind === `comment`
  ...
  let at = it.flatMap((e) => {
        ...
        ? [
            {
              comment: e,
              commentNumber: t,
              markerPoint: Gc(e.anchor, S, { viewportSize: e.markerViewportSize, zoomFactor: A }),
            },
          ]
        : [];
    }),
    ...
    st = j?.kind === `comment` ? at.findIndex(({ comment: e }) => e.id === j.annotation.id) : -1,
    ...
    M =
      qe || ($e && j?.kind === `comment`)
        ? Qe.filter(
            (e) =>
              e.anchor.kind === `region` && !qc(e, m, j?.kind === `comment` ? j.annotation : null),
          )
        : [],
    N = null;
  ...
  } else if ($e && j?.kind === `comment` && j.annotation.anchor.kind === `region`)
    ((gt = Ac(j.annotation.anchor)), (_t = Jc(j.annotation.anchor, gt, S.width, S.height)));
  else if (!$e)
    if (((gt = ee?.rect ?? null), gt != null)) _t = Jc(null, gt, S.width, S.height);
    else if (m?.anchor.type === `element`) {
      let e = m.anchor.element == null ? null : ic(m.anchor.element);
      ((gt = e?.rect ?? Ac(m.anchor.value)),
        (vt = e?.borderRadius),
        (_t =
          m.target.mode === `design` ? `hover-box` : Xc(m.anchor.value, gt, S.width, S.height)));
    } else
      m?.anchor.type === `region` && m.target.mode === `create`
        ? ((gt = Ac(m.anchor.value)), (_t = Jc(m.anchor.value, gt, S.width, S.height)))
        : i != null &&
          ((gt = i.rect), (vt = i.borderRadius), (_t = Xc(null, gt, S.width, S.height)));
  let yt = j == null ? null : (Mc(mt) ?? gt),
    bt = $e ? [] : oc(v, m, be, ve),
    xt = me && !$e && m == null && ee == null && ft == null ? i : null,
    St =
      !$e && et != null && (!rt || nt == null)
        ? Gc(et, S, { includeElementFrameScroll: !0, viewportSize: tt, zoomFactor: A })
        : null,
    Ct = p(O),
    wt = St == null ? null : nt == null ? (Ct === 0 ? null : Ct + 1) : (ge.get(nt.id) ?? null),
    Tt = {
      ...la,
      [vl]: String(pe),
  ...
  (A !== 1 &&
    ...
    (Tt.width = `${A * 100}vw`)),
    k === `comment` && m == null && ((Tt.cursor = ca), (Tt.pointerEvents = `auto`)));
    ...
    children: [
      ...
      M.map((e) => {
        ...
        return t == null || !Pc(e.anchor)
          ...
          : (0, dl.jsx)(
              `div`,
              { className: Yc(e.anchor, t, S.width, S.height), style: Wc(t, A) },
              e.id,
            );
      }),
      ...
      xt == null
        ? null
        : (0, dl.jsx)(ga, { snapshot: xt, viewportScale: n.viewportScale, zoomFactor: A }),
      qe || $e
        ? (0, dl.jsxs)(`div`, {
  ...
  return (0, dl.jsx)(ls, {
    ...
    children: (0, dl.jsxs)(`div`, {
      ...
      style: Tt,
      children: [(0, dl.jsx)(`style`, { children: ua }), Je ? (0, dl.jsx)(us, { children: P }) : P],
    }),
  });
}
...
function fs(e, t) {
  return e.anchor.kind === `text`
    ...
    : e.anchor.kind === `region`
      ? { type: `region`, themeVariant: e.themeVariant ?? Rc(), value: e.anchor }
      : {
          type: `element`,
          element: t,
...
function ps(e, t, n) {
  let r = Lc(),
    ...
    a = { x: t, y: n };
  return {
    anchor: Us(e, i ?? { x: t, y: n, width: 0, height: 0 }, a, i == null ? !1 : Fa(e), r.width),
    themeVariant: Rc(),
    viewportRect: i,
    viewportPoint: a,
    viewportSize: r,
...
function ms(e, t, n) {
  if (e.anchor.kind === `text`) return po(e.anchor) ?? hs(e.anchor, n, e.themeVariant);
...
function gs(e, t, n) {
  ...
  if (e.anchor.type === `region`) return hs(e.anchor.value, t, e.anchor.themeVariant);
  let r = e.anchor.element == null || !e.anchor.element.isConnected ? null : nc(e.anchor.element),
    i = Lc(),
    a =
...
function _s(e, t, n, r) {
  ...
  if (a == null) return null;
  if (e.anchor.type === `text`)
    return po(e.anchor.value) ?? hs(e.anchor.value, r, a.themeVariant ?? e.anchor.themeVariant);
  if (e.anchor.type === `region`)
    return hs(e.anchor.value, r, a.themeVariant ?? e.anchor.themeVariant);
  let o = Gs(a, n) ?? null;
  o != null && n.set(a.id, o);
  let s = Lc(),
    c = o == null ? e.anchor.value : Vs(o, e.anchor.value, s, a.markerViewportPoint);
  return {
    anchor: c,
...
function vs(e, t) {
  ...
  if (n.kind === `region`)
    return {
      target: e.target,
      anchor: { type: `region`, themeVariant: e.anchorState.themeVariant, value: n },
    };
  let r = Qs(n, e.target.mode === `edit` ? e.target.commentId : void 0, t) ?? null;
  return (
  ...
  let t = new Map(),
    n = () => {
      ...
      for (let i of e) {
        ...
        if (e == null) continue;
        let a = t.get(i);
        a?.document !== e && (xs(a?.cleanup), t.set(i, { cleanup: r(e, i, n), document: e }));
      }
...
function Ss(e, t = ca) {
  ...
  return (
    r.setAttribute(Cl, `true`), (r.textContent = El(t)), (e.head ?? e.documentElement).append(r), r
  );
}
function Cs() {
...
function Ks(e, t, n = !1, r = null) {
  ...
  return a == null
    ...
    : (t.set(e.id, a),
      { ...e, markerViewportSize: i, anchor: Vs(a, e.anchor, i, e.markerViewportPoint) });
}
function qs(e, t) {
  if (!Js(e)) return null;
  ...
  return n == null
    ? null
    : (t.set(e.id, n), { ...e, anchor: Vs(n, e.anchor, e.viewportSize, e.markerViewportPoint) });
}
function Js(e) {
...
function sc(e) {
  ...
  return m(t, t.display === `flex` || t.display === `inline-flex` ? [...Il, ...Ll] : Il);
}
function cc(e, t, n, r) {
  let i = r ?? ic(e),
    a = n?.id ?? fc(),
...
function _c(e, t) {
  ...
  for (let t of e.querySelectorAll(`[${Ml}]`)) z(t) && (Tc(t, n.get(t)), n.delete(t));
...
function Oc(e, t, n) {
  let r = new Set();
  for (let n of t)
    if (Ys(n) && n.anchor.scrollContainers != null && ja(n.anchor.framePath) === e)
...
function Nc(e, t = Ic(), { includeElementFrameScroll: n = !1, markerPointInset: r = hl } = {}) {
  ...
  let s = n && e.kind === `element` && i != null && i !== window ? i.scrollY : 0;
  return {
...
function Gc(e, t, { includeElementFrameScroll: n = !1, viewportSize: r, zoomFactor: i }) {
  let a = Nc(e, Vc(t, r), { includeElementFrameScroll: n, markerPointInset: hl / i });
...
function $c(e, t, n) {
  return e == null || t <= 0 || n <= 0 ? !1 : e.width >= t * xl && e.height >= n * Sl;
}
function el(e, t) {
...
function nl(e) {
  return e.composedPath().some((e) => e instanceof HTMLElement && e.hasAttribute(wl));
}
...
function rl(e) {
  ...
  let t = e.getRootNode();
  return t instanceof ShadowRoot && t.host instanceof HTMLElement && t.host.id === fl;
}
function il(e, t, n) {
  return Math.min(Math.max(e, t), n);
}
...
function cl(e, t) {
  ...
  return { ...e, current: t, rect: n ? sl(e.start, t) : null, isDraggingRegion: n };
}
var W,
  ll,
  ul,
  ...
  zl = o(() => {
    (Ce(),
      ...
      (Ll = [`flex-direction`, `justify-content`, `align-items`, `gap`, `row-gap`, `column-gap`]),
      (Rl = []));
  });
(Ce(), ke());
var G = null,
...
function Wl(e) {
  ...
  t == null ||
    !e.isTrusted ||
    (X(e),
    d.ipcRenderer.invoke(je, { type: `browser-sidebar-runtime-mouse-navigation`, direction: t }));
}
function X(e) {
...
function Jl(e) {
  if (!e.isTrusted || e.defaultPrevented || Vl == null || e.composedPath().some(Kl)) return;
  let t = null;
  (ql(e, Vl.backAccelerators) ? (t = `back`) : ql(e, Vl.forwardAccelerators) && (t = `forward`),
    t != null &&
      (e.preventDefault(),
...
function Yl(e) {
  ...
  n == null ||
    n.length === 0 ||
    ((Bl = !0),
    d.ipcRenderer.invoke(je, { type: `browser-sidebar-runtime-image-drag-started`, sourceUrl: n }));
}
function Xl(e) {
  !e.isTrusted ||
    !Bl ||
    ((Bl = !1), d.ipcRenderer.invoke(je, { type: `browser-sidebar-runtime-image-drag-ended` }));
}
function Zl(e) {
  ...
  return {
    ...
    subscribeToHostMessages(e) {
      ...
      return (
        ...
        (Y &&= (e({ type: `browser-sidebar-runtime-capture-text-selection` }), !1)),
        J != null && (e(J), (J = null)),
        () => {
