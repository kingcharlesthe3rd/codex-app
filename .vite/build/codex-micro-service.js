...
var n = e.Kr(`CodexMicroService`),
  ...
  m = class {
    ...
    connectPromise = null;
    lastLightingModel = { slots: _() };
    displayedLightingModel = { slots: _() };
    ...
    async connect() {
      let e;
      try {
        [e] = this.discovery.findWLDevices([i.Project2077]);
      } catch (e) {
        (n.warning(`Codex Micro discovery failed`, { safe: {}, sensitive: { error: e } }),
      ...
      this.unsubscribeConnectionEvent = t.onConnectionEvent((e) => {
        switch (e.type) {
          ...
          case r.DISCONNECTED:
            ...
            break;
          case r.ERROR:
            (n.warning(`Codex Micro transport failed`, { safe: {}, sensitive: { error: e.error } }),
      ...
      try {
        ...
        (n.warning(`Codex Micro connection failed`, { safe: {}, sensitive: { error: e } }),
          this.unsubscribeConnectionEvent?.(),
          (this.unsubscribeConnectionEvent = null),
          await t.disconnect(),
    ...
    async applyLighting(e) {
      let t = this.api;
      if (t == null) return !1;
      let n = await t.sendLightingConfig(g(e.slots)),
        r = await t.sendThreadsLighting(h(e.slots));
    ...
    handleDisconnect(e = null) {
      (this.batteryRefreshTimer != null &&
        ...
        (this.comm = null),
        (this.api = null),
        (this.displayedLightingModel = { slots: _() }),
        this.setDeviceState({
  ...
  return e.map((e) =>
    e.status === `off`
      ...
      : {
          ...
          color: v(e.status),
          brightness: 1,
          effect: e.selected ? a.breath : a.solid,
          speed: e.selected ? f : 0,
          syncKeysLighting: !1,
          syncAmbientLighting: !1,
        },
  );
...
function g(e) {
  ...
  return t == null || t.status === `off`
    ? p
    : {
        keys: { effect: a.solid, brightness: 1, speed: 0, magic: 0, color: 16777215 },
        ambient: { effect: a.solid, brightness: 1, speed: 0, magic: 0, color: v(t.status) },
      };
}
function _() {
