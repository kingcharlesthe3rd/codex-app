...
var n = e.Br(`CodexMicroService`),
  ...
  f = class {
    ...
    async connect() {
      ...
      if (e == null) {
        (this.setDeviceState({ status: `not-detected`, error: null }), this.scheduleReconnect());
        return;
      }
    ...
    handleDisconnect(e = null) {
      (this.unsubscribeConnectionEvent?.(),
        ...
        (this.comm = null),
        (this.api = null),
        this.setDeviceState({ status: e == null ? `not-detected` : `error`, error: e }),
        this.scheduleReconnect());
    }
    scheduleReconnect() {
    ...
    setDeviceState(e) {
      (this.deviceState.status === e.status && this.deviceState.error === e.error) ||
...
//# sourceMappingURL=codex-micro-service-C_n-6YP9.js.map
