...
r = e.o(r);
let i = require(`node:path`),
  a = require(`node:util`),
  o = require(`node:crypto`),
  s = require(`node:fs/promises`),
  c = require(`node:zlib`);
var l = (0, a.promisify)(c.gzip),
  u = `application/gzip`,
  d = `Desktop content trace recording`,
  f = 3e4;
async function p({
  tracePath: e,
  buildFlavor: t,
  ...
  n.i(
    {
      ...
      tags: {
        ...
        sessionId: n.t,
        preRelease: e === `prod` ? `false` : `true`,
        ...(f?.conversationId == null ? {} : { conversation_id: f.conversationId }),
        ...(f?.hostId == null ? {} : { host_id: f.hostId }),
        ...(f?.windowId == null ? {} : { window_id: String(f.windowId) }),
        ...(p?.gpuVendor == null ? {} : { gpu_vendor: p.gpuVendor }),
        ...(p == null
          ? {}
          : { hardware_acceleration: p.hardwareAccelerationEnabled ? `enabled` : `disabled` }),
      },
    },
    {
      captureContext: {
        contexts: {
          ...
          device: {
            ...
            memory_size: r.default.totalmem(),
            free_memory: r.default.freemem(),
            ...(x != null && x.length > 0 ? { model: x } : {}),
          },
          codex_feedback: { classification: `trace-recording`, description: c, correlation_id: _ },
          trace_recording: {
            duration_ms: l,
            trace_size_bytes: m,
          ...
          runtime_health: {
            load_average: r.default.loadavg(),
            uptime_seconds: b,
            ...
            hardware_acceleration_enabled: p?.hardwareAccelerationEnabled ?? null,
          },
        },
        extra: {
          classification: `trace-recording`,
          description: c,
          trace_recording_duration_ms: l,
          trace_size_bytes: m,
          trace_gzip_size_bytes: h,
          trace_event_count: g,
        },
      },
      attachments: [{ filename: o, data: s, contentType: u, attachmentType: `event.attachment` }],
    },
  );
}
function h(e) {
...
exports.uploadTraceRecordingToSentry = p;
